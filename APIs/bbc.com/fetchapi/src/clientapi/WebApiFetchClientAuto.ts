export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ListAvailability(sort: string, sort_direction: string, availability: Array<string>, descendants_of: Array<string>, media_set: Array<string>, page: number, page_size: number, territory: Array<string>, debug: boolean, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'availabilities?sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&sort_direction=' + (sort_direction == null ? '' : encodeURIComponent(sort_direction)) + '&' + availability.map(z => `availability=${encodeURIComponent(z)}`).join('&') + '&' + descendants_of.map(z => `descendants_of=${encodeURIComponent(z)}`).join('&') + '&' + media_set.map(z => `media_set=${encodeURIComponent(z)}`).join('&') + '&page=' + page + '&page_size=' + page_size + '&' + territory.map(z => `territory=${encodeURIComponent(z)}`).join('&') + '&debug=' + debug, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPeople(authority: string, has_external_id: Array<Embargoed>, id: Array<string>, id_type: string, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, pid: Array<string>, programme: string, q: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'people?authority=' + (authority == null ? '' : encodeURIComponent(authority)) + '&' + has_external_id.map(z => `has_external_id=${z}`).join('&') + '&' + id.map(z => `id=${encodeURIComponent(z)}`).join('&') + '&id_type=' + (id_type == null ? '' : encodeURIComponent(id_type)) + '&page=' + page + '&page_size=' + page_size + '&' + partner_id.map(z => `partner_id=${encodeURIComponent(z)}`).join('&') + '&' + partner_pid.map(z => `partner_pid=${encodeURIComponent(z)}`).join('&') + '&' + pid.map(z => `pid=${encodeURIComponent(z)}`).join('&') + '&programme=' + (programme == null ? '' : encodeURIComponent(programme)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPips(page: number, page_size: number, q: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'pips?page=' + page + '&page_size=' + page_size + '&q=' + (q == null ? '' : encodeURIComponent(q)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProgrammeDetails(page: number, page_size: number, partner_pid: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'programme_details?page=' + page + '&page_size=' + page_size + '&partner_pid=' + (partner_pid == null ? '' : encodeURIComponent(partner_pid)) + '&pid=' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetXSD(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'schema', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_Raw_brand(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_brand_franchises(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)) + '/franchises/', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_episode(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_ancestors(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/ancestors/', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_formats(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/formats/', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_genre_groups(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/genre_groups/', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_image(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/images/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_masterbrand(mbid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/master_brands/' + (mbid == null ? '' : encodeURIComponent(mbid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_Raw_promotion(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return fetch(this.baseUri + 'v1/promotions/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
