...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetAPI(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		ListPips(page: number, page_size: number, q: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'pips?page=' + page + '&page_size=' + page_size + '&q=' + (q == null ? '' : encodeURIComponent(q)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListProgrammeDetails(page: number, page_size: number, partner_pid: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'programme_details?page=' + page + '&page_size=' + page_size + '&partner_pid=' + (partner_pid == null ? '' : encodeURIComponent(partner_pid)) + '&pid=' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Metadata response
		 */
		GetXSD(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'schema', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Get_Raw_brand(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_brand_franchises(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)) + '/franchises/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_episode(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_ancestors(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/ancestors/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_formats(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/formats/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_genre_groups(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/genre_groups/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_image(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/images/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_masterbrand(mbid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/master_brands/' + (mbid == null ? '' : encodeURIComponent(mbid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_Raw_promotion(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return Axios.get<Nitro>(this.baseUri + 'v1/promotions/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
