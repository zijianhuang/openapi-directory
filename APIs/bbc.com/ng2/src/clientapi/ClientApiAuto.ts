...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetAPI(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		ListAvailability(sort: string, sort_direction: string, availability: Array<string>, descendants_of: Array<string>, media_set: Array<string>, page: number, page_size: number, territory: Array<string>, debug: boolean, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'availabilities?sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&sort_direction=' + (sort_direction == null ? '' : encodeURIComponent(sort_direction)) + '&' + availability.map(z => `availability=${encodeURIComponent(z)}`).join('&') + '&' + descendants_of.map(z => `descendants_of=${encodeURIComponent(z)}`).join('&') + '&' + media_set.map(z => `media_set=${encodeURIComponent(z)}`).join('&') + '&page=' + page + '&page_size=' + page_size + '&' + territory.map(z => `territory=${encodeURIComponent(z)}`).join('&') + '&debug=' + debug, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListImages(sort: string, sort_direction: string, group: string, image_type: Array<string>, is_alternate_image_for: string, is_image_for: string, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, pid: Array<string>, q: string, embargoed: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListItems(sort: string, sort_direction: string, mixin: Array<string>, authority: string, id: Array<string>, id_type: string, item_type: Array<string>, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, people: string, pid: Array<string>, programme: string, q: string, segment_event: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListMasterbrands(sort: string, sort_direction: string, mixin: Array<string>, mid: Array<string>, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, q: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListPeople(authority: string, has_external_id: Array<Embargoed>, id: Array<string>, id_type: string, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, pid: Array<string>, programme: string, q: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListPips(page: number, page_size: number, q: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'pips?page=' + page + '&page_size=' + page_size + '&q=' + (q == null ? '' : encodeURIComponent(q)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListProgrammeDetails(page: number, page_size: number, partner_pid: string, pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'programme_details?page=' + page + '&page_size=' + page_size + '&partner_pid=' + (partner_pid == null ? '' : encodeURIComponent(partner_pid)) + '&pid=' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListPromotions(mixin: Array<string>, context: string, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, pid: Array<string>, promoted_by: Array<string>, promoted_for: Array<string>, q: string, status: Array<string>, headersHandler?: () => HttpHeaders): Observable<Nitro> {
		 ...
		 * @return {void} Metadata response
		 */
		GetXSD(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'schema', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListServices(end_from: Date, end_to: Date, mid: Array<string>, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, q: string, service_type: Array<string>, sid: Array<string>, start_from: Date, start_to: Date, headersHandler?: () => HttpHeaders): Observable<Nitro> {
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_brand(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_brand_franchises(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)) + '/franchises/', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_episode(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_ancestors(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/ancestors/', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_formats(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/formats/', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_genre_groups(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/genre_groups/', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_image(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/images/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_masterbrand(mbid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/master_brands/' + (mbid == null ? '' : encodeURIComponent(mbid)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_promotion(pid: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
			return this.http.get<Nitro>(this.baseUri + 'v1/promotions/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListVersions(availability: Array<string>, descendants_of: Array<string>, media_set: Array<string>, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, payment_type: Array<string>, pid: Array<string>, embargoed: string, headersHandler?: () => HttpHeaders): Observable<Nitro> {
