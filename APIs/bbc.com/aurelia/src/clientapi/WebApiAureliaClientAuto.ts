...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetAPI(headersHandler?: () => {[header: string]: string}): Promise<Response> {
		 ...
		 */
		ListAvailability(sort: string, sort_direction: string, availability: Array<string>, descendants_of: Array<string>, media_set: Array<string>, page: number, page_size: number, territory: Array<string>, debug: boolean, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('availabilities?sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&sort_direction=' + (sort_direction == null ? '' : encodeURIComponent(sort_direction)) + '&' + availability.map(z => `availability=${encodeURIComponent(z)}`).join('&') + '&' + descendants_of.map(z => `descendants_of=${encodeURIComponent(z)}`).join('&') + '&' + media_set.map(z => `media_set=${encodeURIComponent(z)}`).join('&') + '&page=' + page + '&page_size=' + page_size + '&' + territory.map(z => `territory=${encodeURIComponent(z)}`).join('&') + '&debug=' + debug, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListGroups(sort: string, sort_direction: string, mixin: Array<string>, for_descendants_of: string, for_programme: string, group: string, group_type: Array<string>, member: string, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, pid: Array<string>, q: string, embargoed: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('groups?sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&sort_direction=' + (sort_direction == null ? '' : encodeURIComponent(sort_direction)) + '&' + mixin.map(z => `mixin=${encodeURIComponent(z)}`).join('&') + '&for_descendants_of=' + (for_descendants_of == null ? '' : encodeURIComponent(for_descendants_of)) + '&for_programme=' + (for_programme == null ? '' : encodeURIComponent(for_programme)) + '&group=' + (group == null ? '' : encodeURIComponent(group)) + '&' + group_type.map(z => `group_type=${encodeURIComponent(z)}`).join('&') + '&member=' + (member == null ? '' : encodeURIComponent(member)) + '&page=' + page + '&page_size=' + page_size + '&' + partner_id.map(z => `partner_id=${encodeURIComponent(z)}`).join('&') + '&' + partner_pid.map(z => `partner_pid=${encodeURIComponent(z)}`).join('&') + '&' + pid.map(z => `pid=${encodeURIComponent(z)}`).join('&') + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&embargoed=' + (embargoed == null ? '' : encodeURIComponent(embargoed)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListMasterbrands(sort: string, sort_direction: string, mixin: Array<string>, mid: Array<string>, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, q: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('master_brands?sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&sort_direction=' + (sort_direction == null ? '' : encodeURIComponent(sort_direction)) + '&' + mixin.map(z => `mixin=${encodeURIComponent(z)}`).join('&') + '&' + mid.map(z => `mid=${encodeURIComponent(z)}`).join('&') + '&page=' + page + '&page_size=' + page_size + '&' + partner_id.map(z => `partner_id=${encodeURIComponent(z)}`).join('&') + '&' + partner_pid.map(z => `partner_pid=${encodeURIComponent(z)}`).join('&') + '&q=' + (q == null ? '' : encodeURIComponent(q)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListPeople(authority: string, has_external_id: Array<Embargoed>, id: Array<string>, id_type: string, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, pid: Array<string>, programme: string, q: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('people?authority=' + (authority == null ? '' : encodeURIComponent(authority)) + '&' + has_external_id.map(z => `has_external_id=${z}`).join('&') + '&' + id.map(z => `id=${encodeURIComponent(z)}`).join('&') + '&id_type=' + (id_type == null ? '' : encodeURIComponent(id_type)) + '&page=' + page + '&page_size=' + page_size + '&' + partner_id.map(z => `partner_id=${encodeURIComponent(z)}`).join('&') + '&' + partner_pid.map(z => `partner_pid=${encodeURIComponent(z)}`).join('&') + '&' + pid.map(z => `pid=${encodeURIComponent(z)}`).join('&') + '&programme=' + (programme == null ? '' : encodeURIComponent(programme)) + '&q=' + (q == null ? '' : encodeURIComponent(q)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListPips(page: number, page_size: number, q: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('pips?page=' + page + '&page_size=' + page_size + '&q=' + (q == null ? '' : encodeURIComponent(q)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListProgrammeDetails(page: number, page_size: number, partner_pid: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('programme_details?page=' + page + '&page_size=' + page_size + '&partner_pid=' + (partner_pid == null ? '' : encodeURIComponent(partner_pid)) + '&pid=' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListPromotions(mixin: Array<string>, context: string, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, pid: Array<string>, promoted_by: Array<string>, promoted_for: Array<string>, q: string, status: Array<string>, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('promotions?' + mixin.map(z => `mixin=${encodeURIComponent(z)}`).join('&') + '&context=' + (context == null ? '' : encodeURIComponent(context)) + '&page=' + page + '&page_size=' + page_size + '&' + partner_id.map(z => `partner_id=${encodeURIComponent(z)}`).join('&') + '&' + partner_pid.map(z => `partner_pid=${encodeURIComponent(z)}`).join('&') + '&' + pid.map(z => `pid=${encodeURIComponent(z)}`).join('&') + '&' + promoted_by.map(z => `promoted_by=${encodeURIComponent(z)}`).join('&') + '&' + promoted_for.map(z => `promoted_for=${encodeURIComponent(z)}`).join('&') + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&' + status.map(z => `status=${encodeURIComponent(z)}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Metadata response
		 */
		GetXSD(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('schema', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListServices(end_from: Date, end_to: Date, mid: Array<string>, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, q: string, service_type: Array<string>, sid: Array<string>, start_from: Date, start_to: Date, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('services?end_from=' + end_from.toISOString() + '&end_to=' + end_to.toISOString() + '&' + mid.map(z => `mid=${encodeURIComponent(z)}`).join('&') + '&page=' + page + '&page_size=' + page_size + '&' + partner_id.map(z => `partner_id=${encodeURIComponent(z)}`).join('&') + '&' + partner_pid.map(z => `partner_pid=${encodeURIComponent(z)}`).join('&') + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&' + service_type.map(z => `service_type=${encodeURIComponent(z)}`).join('&') + '&' + sid.map(z => `sid=${encodeURIComponent(z)}`).join('&') + '&start_from=' + start_from.toISOString() + '&start_to=' + start_to.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_brand(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_brand_franchises(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/brands/' + (pid == null ? '' : encodeURIComponent(pid)) + '/franchises/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_episode(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_ancestors(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/ancestors/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_formats(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/formats/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_genre_groups(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/episodes/' + (pid == null ? '' : encodeURIComponent(pid)) + '/genre_groups/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_image(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/images/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_masterbrand(mbid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/master_brands/' + (mbid == null ? '' : encodeURIComponent(mbid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		Get_Raw_promotion(pid: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('v1/promotions/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Nitro} Nitro response
		 */
		ListVersions(availability: Array<string>, descendants_of: Array<string>, media_set: Array<string>, page: number, page_size: number, partner_id: Array<string>, partner_pid: Array<string>, payment_type: Array<string>, pid: Array<string>, embargoed: string, headersHandler?: () => {[header: string]: string}): Promise<Nitro> {
			return this.http.get('versions?' + availability.map(z => `availability=${encodeURIComponent(z)}`).join('&') + '&' + descendants_of.map(z => `descendants_of=${encodeURIComponent(z)}`).join('&') + '&' + media_set.map(z => `media_set=${encodeURIComponent(z)}`).join('&') + '&page=' + page + '&page_size=' + page_size + '&' + partner_id.map(z => `partner_id=${encodeURIComponent(z)}`).join('&') + '&' + partner_pid.map(z => `partner_pid=${encodeURIComponent(z)}`).join('&') + '&' + payment_type.map(z => `payment_type=${encodeURIComponent(z)}`).join('&') + '&' + pid.map(z => `pid=${encodeURIComponent(z)}`).join('&') + '&embargoed=' + (embargoed == null ? '' : encodeURIComponent(embargoed)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
