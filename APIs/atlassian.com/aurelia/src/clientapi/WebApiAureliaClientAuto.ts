...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Application_propertiesGetByKeyAndKeyFilterAndPermissionLevel(key: string, keyFilter: string, permissionLevel: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('application-properties?key=' + (key == null ? '' : encodeURIComponent(key)) + '&keyFilter=' + (keyFilter == null ? '' : encodeURIComponent(keyFilter)) + '&permissionLevel=' + (permissionLevel == null ? '' : encodeURIComponent(permissionLevel)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Application_propertiesAdvanced_settingsGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('application-properties/advanced-settings', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Application_propertiesPutById(id: string, requestBody: Application_propertiesPutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('application-properties/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ApplicationroleGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('applicationrole', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ApplicationroleGetByKey(key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('applicationrole/' + (key == null ? '' : encodeURIComponent(key)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AttachmentMetaGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('attachment/meta', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AttachmentDeleteById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('attachment/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AttachmentGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('attachment/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AttachmentExpandHumanGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('attachment/' + (id == null ? '' : encodeURIComponent(id)) + '/expand/human', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AttachmentExpandRawGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('attachment/' + (id == null ? '' : encodeURIComponent(id)) + '/expand/raw', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuditingRecordGetByFilterAndFromAndLimitAndOffsetAndTo(filter: string, from: string, limit: number, offset: number, to: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('auditing/record?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&from=' + (from == null ? '' : encodeURIComponent(from)) + '&limit=' + limit + '&offset=' + offset + '&to=' + (to == null ? '' : encodeURIComponent(to)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AvatarSystemGetByType(type: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('avatar/' + (type == null ? '' : encodeURIComponent(type)) + '/system', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CommentListPostByExpand(expand: string, requestBody: CommentListPostByExpandBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('comment/list?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CommentPropertiesGetByCommentId(commentId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('comment/' + (commentId == null ? '' : encodeURIComponent(commentId)) + '/properties', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CommentPropertiesDeleteByCommentIdAndPropertyKey(commentId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('comment/' + (commentId == null ? '' : encodeURIComponent(commentId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CommentPropertiesGetByCommentIdAndPropertyKey(commentId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('comment/' + (commentId == null ? '' : encodeURIComponent(commentId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CommentPropertiesPutByCommentIdAndPropertyKey(commentId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('comment/' + (commentId == null ? '' : encodeURIComponent(commentId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ComponentPost(requestBody: ComponentPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('component', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ComponentDeleteByIdAndMoveIssuesTo(id: string, moveIssuesTo: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('component/' + (id == null ? '' : encodeURIComponent(id)) + '&moveIssuesTo=' + (moveIssuesTo == null ? '' : encodeURIComponent(moveIssuesTo)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ComponentGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('component/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ComponentPutById(id: string, requestBody: ComponentPutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('component/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ComponentRelatedIssueCountsGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('component/' + (id == null ? '' : encodeURIComponent(id)) + '/relatedIssueCounts', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ConfigurationGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ConfigurationTimetrackingDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('configuration/timetracking', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ConfigurationTimetrackingGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('configuration/timetracking', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ConfigurationTimetrackingPut(requestBody: ConfigurationTimetrackingPutBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('configuration/timetracking', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ConfigurationTimetrackingListGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('configuration/timetracking/list', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ConfigurationTimetrackingOptionsGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('configuration/timetracking/options', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ConfigurationTimetrackingOptionsPut(requestBody: ConfigurationTimetrackingOptionsPutBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('configuration/timetracking/options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CustomFieldOptionGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('customFieldOption/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DashboardGetByFilterAndMaxResultsAndStartAt(filter: string, maxResults: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('dashboard?filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&maxResults=' + maxResults + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DashboardItemsPropertiesGetByDashboardIdAndItemId(dashboardId: string, itemId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('dashboard/' + (dashboardId == null ? '' : encodeURIComponent(dashboardId)) + '/items/' + (itemId == null ? '' : encodeURIComponent(itemId)) + '/properties', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DashboardItemsPropertiesDeleteByDashboardIdAndItemIdAndPropertyKey(dashboardId: string, itemId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('dashboard/' + (dashboardId == null ? '' : encodeURIComponent(dashboardId)) + '/items/' + (itemId == null ? '' : encodeURIComponent(itemId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DashboardItemsPropertiesGetByDashboardIdAndItemIdAndPropertyKey(dashboardId: string, itemId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('dashboard/' + (dashboardId == null ? '' : encodeURIComponent(dashboardId)) + '/items/' + (itemId == null ? '' : encodeURIComponent(itemId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DashboardItemsPropertiesPutByDashboardIdAndItemIdAndPropertyKey(dashboardId: string, itemId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('dashboard/' + (dashboardId == null ? '' : encodeURIComponent(dashboardId)) + '/items/' + (itemId == null ? '' : encodeURIComponent(itemId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DashboardGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('dashboard/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ExpressionEvalPostByExpand(expand: string, requestBody: ExpressionEvalPostByExpandBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('expression/eval?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FieldGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('field', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FieldPost(requestBody: FieldPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('field', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FieldOptionGetByFieldKeyAndMaxResultsAndStartAt(fieldKey: string, maxResults: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option&maxResults=' + maxResults + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FieldOptionPostByFieldKey(fieldKey: string, requestBody: FieldOptionPostByFieldKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FieldOptionSuggestionsEditGetByFieldKeyAndMaxResultsAndProjectIdAndStartAt(fieldKey: string, maxResults: number, projectId: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option/suggestions/edit&maxResults=' + maxResults + '&projectId=' + projectId + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FieldOptionSuggestionsSearchGetByFieldKeyAndMaxResultsAndProjectIdAndStartAt(fieldKey: string, maxResults: number, projectId: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option/suggestions/search&maxResults=' + maxResults + '&projectId=' + projectId + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FieldOptionDeleteByFieldKeyAndOptionId(fieldKey: string, optionId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option/' + optionId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FieldOptionGetByFieldKeyAndOptionId(fieldKey: string, optionId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option/' + optionId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FieldOptionPutByFieldKeyAndOptionId(fieldKey: string, optionId: number, requestBody: FieldOptionPutByFieldKeyAndOptionIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option/' + optionId, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FieldOptionIssueDeleteByFieldKeyAndJqlAndOptionIdAndReplaceWith(fieldKey: string, jql: string, optionId: number, replaceWith: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('field/' + (fieldKey == null ? '' : encodeURIComponent(fieldKey)) + '/option/' + optionId + '/issue&jql=' + (jql == null ? '' : encodeURIComponent(jql)) + '&replaceWith=' + replaceWith, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterGetByExpand(expand: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterPostByExpand(expand: string, requestBody: FilterPostByExpandBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('filter?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FilterDefaultShareScopeGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter/defaultShareScope', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterDefaultShareScopePut(requestBody: FilterDefaultShareScopePutBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('filter/defaultShareScope', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FilterFavouriteGetByExpand(expand: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter/favourite?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterMyGetByExpandAndIncludeFavourites(expand: string, includeFavourites: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter/my?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&includeFavourites=' + includeFavourites, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterDeleteById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('filter/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterGetByExpandAndId(expand: string, id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter/' + id + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterPutByExpandAndId(expand: string, id: number, requestBody: FilterPutByExpandAndIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('filter/' + id + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FilterColumnsDeleteById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('filter/' + id + '/columns', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterColumnsGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter/' + id + '/columns', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterColumnsPutById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('filter/' + id + '/columns', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterFavouriteDeleteByExpandAndId(expand: string, id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('filter/' + id + '/favourite?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterFavouritePutByExpandAndId(expand: string, id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('filter/' + id + '/favourite?expand=' + (expand == null ? '' : encodeURIComponent(expand)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterPermissionGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter/' + id + '/permission', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterPermissionPostById(id: number, requestBody: FilterPermissionPostByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('filter/' + id + '/permission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FilterPermissionDeleteByIdAndPermissionId(id: number, permissionId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('filter/' + id + '/permission/' + permissionId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FilterPermissionGetByIdAndPermissionId(id: number, permissionId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('filter/' + id + '/permission/' + permissionId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GroupDeleteByGroupnameAndSwapGroup(groupname: string, swapGroup: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('group?groupname=' + (groupname == null ? '' : encodeURIComponent(groupname)) + '&swapGroup=' + (swapGroup == null ? '' : encodeURIComponent(swapGroup)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GroupGetByExpandAndGroupname(expand: string, groupname: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('group?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&groupname=' + (groupname == null ? '' : encodeURIComponent(groupname)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GroupPost(requestBody: GroupPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('group', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GroupMemberGetByGroupnameAndIncludeInactiveUsersAndMaxResultsAndStartAt(groupname: string, includeInactiveUsers: boolean, maxResults: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('group/member?groupname=' + (groupname == null ? '' : encodeURIComponent(groupname)) + '&includeInactiveUsers=' + includeInactiveUsers + '&maxResults=' + maxResults + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GroupUserDeleteByAccountidAndGroupnameAndUsername(accountid: string, groupname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('group/user?accountid=' + (accountid == null ? '' : encodeURIComponent(accountid)) + '&groupname=' + (groupname == null ? '' : encodeURIComponent(groupname)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GroupUserPostByGroupname(groupname: string, requestBody: GroupUserPostByGroupnameBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('group/user?groupname=' + (groupname == null ? '' : encodeURIComponent(groupname)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GroupsPickerGetByAccountIdAndExcludeAndMaxResultsAndQueryAndUserName(accountId: string, exclude: Array<string>, maxResults: number, query: string, userName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('groups/picker?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&' + exclude.map(z => `exclude=${encodeURIComponent(z)}`).join('&') + '&maxResults=' + maxResults + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&userName=' + (userName == null ? '' : encodeURIComponent(userName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuePostByUpdateHistory(updateHistory: boolean, requestBody: IssuePostByUpdateHistoryBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue?updateHistory=' + updateHistory, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueBulkPost(requestBody: IssueBulkPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/bulk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssuePropertiesDeleteByPropertyKey(propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuePropertiesPutByPropertyKey(propertyKey: string, requestBody: IssuePropertiesPutByPropertyKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issue/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueDeleteByDeleteSubtasksAndIssueIdOrKey(deleteSubtasks: string, issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '?deleteSubtasks=' + (deleteSubtasks == null ? '' : encodeURIComponent(deleteSubtasks)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueAssigneePutByIssueIdOrKey(issueIdOrKey: string, requestBody: IssueAssigneePutByIssueIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/assignee', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueAttachmentsPostByIssueIdOrKey(issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/attachments', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueChangelogGetByIssueIdOrKeyAndMaxResultsAndStartAt(issueIdOrKey: string, maxResults: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/changelog&maxResults=' + maxResults + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueCommentGetByExpandAndIssueIdOrKeyAndMaxResultsAndOrderByAndStartAt(expand: string, issueIdOrKey: string, maxResults: number, orderBy: string, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/comment?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueCommentPostByExpandAndIssueIdOrKey(expand: string, issueIdOrKey: string, requestBody: IssueCommentPostByExpandAndIssueIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/comment?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueCommentDeleteByIdAndIssueIdOrKey(id: string, issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/comment/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueCommentGetByExpandAndIdAndIssueIdOrKey(expand: string, id: string, issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/comment/' + (id == null ? '' : encodeURIComponent(id)) + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueEditmetaGetByIssueIdOrKeyAndOverrideEditableFlagAndOverrideScreenSecurity(issueIdOrKey: string, overrideEditableFlag: boolean, overrideScreenSecurity: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/editmeta&overrideEditableFlag=' + overrideEditableFlag + '&overrideScreenSecurity=' + overrideScreenSecurity, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueNotifyPostByIssueIdOrKey(issueIdOrKey: string, requestBody: IssueNotifyPostByIssueIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/notify', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssuePropertiesGetByIssueIdOrKey(issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/properties', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuePropertiesDeleteByIssueIdOrKeyAndPropertyKey(issueIdOrKey: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuePropertiesGetByIssueIdOrKeyAndPropertyKey(issueIdOrKey: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuePropertiesPutByIssueIdOrKeyAndPropertyKey(issueIdOrKey: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueRemotelinkDeleteByGlobalIdAndIssueIdOrKey(globalId: string, issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/remotelink?globalId=' + (globalId == null ? '' : encodeURIComponent(globalId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueRemotelinkGetByGlobalIdAndIssueIdOrKey(globalId: string, issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/remotelink?globalId=' + (globalId == null ? '' : encodeURIComponent(globalId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueRemotelinkPostByIssueIdOrKey(issueIdOrKey: string, requestBody: IssueRemotelinkPostByIssueIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/remotelink', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueRemotelinkDeleteByIssueIdOrKeyAndLinkId(issueIdOrKey: string, linkId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/remotelink/' + (linkId == null ? '' : encodeURIComponent(linkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueRemotelinkGetByIssueIdOrKeyAndLinkId(issueIdOrKey: string, linkId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/remotelink/' + (linkId == null ? '' : encodeURIComponent(linkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueRemotelinkPutByIssueIdOrKeyAndLinkId(issueIdOrKey: string, linkId: string, requestBody: IssueRemotelinkPutByIssueIdOrKeyAndLinkIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/remotelink/' + (linkId == null ? '' : encodeURIComponent(linkId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueTransitionsGetByExpandAndIssueIdOrKeyAndSkipRemoteOnlyConditionAndTransitionId(expand: string, issueIdOrKey: string, skipRemoteOnlyCondition: boolean, transitionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/transitions?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&skipRemoteOnlyCondition=' + skipRemoteOnlyCondition + '&transitionId=' + (transitionId == null ? '' : encodeURIComponent(transitionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueTransitionsPostByIssueIdOrKey(issueIdOrKey: string, requestBody: IssueTransitionsPostByIssueIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/transitions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueVotesDeleteByIssueIdOrKey(issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/votes', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueVotesGetByIssueIdOrKey(issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/votes', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueVotesPostByIssueIdOrKey(issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/votes', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWatchersDeleteByAccountIdAndIssueIdOrKeyAndUsername(accountId: string, issueIdOrKey: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/watchers?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWatchersGetByIssueIdOrKey(issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/watchers', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWatchersPostByIssueIdOrKey(issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/watchers', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWorklogGetByExpandAndIssueIdOrKeyAndMaxResultsAndStartAt(expand: string, issueIdOrKey: string, maxResults: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/worklog?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&maxResults=' + maxResults + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWorklogGetByExpandAndIdAndIssueIdOrKey(expand: string, id: string, issueIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/worklog/' + (id == null ? '' : encodeURIComponent(id)) + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWorklogPropertiesGetByIssueIdOrKeyAndWorklogId(issueIdOrKey: string, worklogId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/worklog/' + (worklogId == null ? '' : encodeURIComponent(worklogId)) + '/properties', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWorklogPropertiesDeleteByIssueIdOrKeyAndPropertyKeyAndWorklogId(issueIdOrKey: string, propertyKey: string, worklogId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/worklog/' + (worklogId == null ? '' : encodeURIComponent(worklogId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWorklogPropertiesGetByIssueIdOrKeyAndPropertyKeyAndWorklogId(issueIdOrKey: string, propertyKey: string, worklogId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/worklog/' + (worklogId == null ? '' : encodeURIComponent(worklogId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueWorklogPropertiesPutByIssueIdOrKeyAndPropertyKeyAndWorklogId(issueIdOrKey: string, propertyKey: string, worklogId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issue/' + (issueIdOrKey == null ? '' : encodeURIComponent(issueIdOrKey)) + '/worklog/' + (worklogId == null ? '' : encodeURIComponent(worklogId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueLinkPost(requestBody: IssueLinkPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issueLink', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueLinkDeleteByLinkId(linkId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issueLink/' + (linkId == null ? '' : encodeURIComponent(linkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueLinkGetByLinkId(linkId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issueLink/' + (linkId == null ? '' : encodeURIComponent(linkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueLinkTypeGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issueLinkType', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueLinkTypePost(requestBody: IssueLinkTypePostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issueLinkType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueLinkTypeDeleteByIssueLinkTypeId(issueLinkTypeId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issueLinkType/' + (issueLinkTypeId == null ? '' : encodeURIComponent(issueLinkTypeId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueLinkTypeGetByIssueLinkTypeId(issueLinkTypeId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issueLinkType/' + (issueLinkTypeId == null ? '' : encodeURIComponent(issueLinkTypeId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssueLinkTypePutByIssueLinkTypeId(issueLinkTypeId: string, requestBody: IssueLinkTypePutByIssueLinkTypeIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issueLinkType/' + (issueLinkTypeId == null ? '' : encodeURIComponent(issueLinkTypeId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssuesecurityschemesGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issuesecurityschemes', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuesecurityschemesGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issuesecurityschemes/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypeGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issuetype', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypePost(requestBody: IssuetypePostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issuetype', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssuetypeDeleteByAlternativeIssueTypeIdAndId(alternativeIssueTypeId: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issuetype/' + (id == null ? '' : encodeURIComponent(id)) + '?alternativeIssueTypeId=' + (alternativeIssueTypeId == null ? '' : encodeURIComponent(alternativeIssueTypeId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypeGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issuetype/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypePutById(id: string, requestBody: IssuetypePutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issuetype/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssuetypeAlternativesGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issuetype/' + (id == null ? '' : encodeURIComponent(id)) + '/alternatives', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypeAvatar2PostByIdAndSizeAndXAndY(id: string, size: number, x: number, y: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('issuetype/' + (id == null ? '' : encodeURIComponent(id)) + '/avatar2&size=' + size + '&x=' + x + '&y=' + y, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypePropertiesGetByIssueTypeId(issueTypeId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issuetype/' + (issueTypeId == null ? '' : encodeURIComponent(issueTypeId)) + '/properties', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypePropertiesDeleteByIssueTypeIdAndPropertyKey(issueTypeId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('issuetype/' + (issueTypeId == null ? '' : encodeURIComponent(issueTypeId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypePropertiesGetByIssueTypeIdAndPropertyKey(issueTypeId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('issuetype/' + (issueTypeId == null ? '' : encodeURIComponent(issueTypeId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IssuetypePropertiesPutByIssueTypeIdAndPropertyKey(issueTypeId: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('issuetype/' + (issueTypeId == null ? '' : encodeURIComponent(issueTypeId)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		JqlAutocompletedataGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('jql/autocompletedata', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		JqlPdcleanerPost(requestBody: JqlPdcleanerPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('jql/pdcleaner', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		MypreferencesDeleteByKey(key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('mypreferences?key=' + (key == null ? '' : encodeURIComponent(key)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		MypreferencesGetByKey(key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('mypreferences?key=' + (key == null ? '' : encodeURIComponent(key)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		MypreferencesPutByKey(key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('mypreferences?key=' + (key == null ? '' : encodeURIComponent(key)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		MypreferencesLocaleDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('mypreferences/locale', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		MypreferencesLocaleGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('mypreferences/locale', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		MypreferencesLocalePut(requestBody: MypreferencesLocalePutBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('mypreferences/locale', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		MyselfGetByExpand(expand: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('myself?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		NotificationschemeGetByExpandAndMaxResultsAndStartAt(expand: string, maxResults: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('notificationscheme?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&maxResults=' + maxResults + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		NotificationschemeGetByExpandAndId(expand: string, id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('notificationscheme/' + id + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PermissionsGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('permissions', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PermissionsProjectPost(requestBody: PermissionsProjectPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('permissions/project', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PermissionschemeGetByExpand(expand: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('permissionscheme?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PermissionschemePostByExpand(expand: string, requestBody: PermissionschemePostByExpandBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('permissionscheme?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PermissionschemeDeleteBySchemeId(schemeId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('permissionscheme/' + schemeId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PermissionschemeGetByExpandAndSchemeId(expand: string, schemeId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('permissionscheme/' + schemeId + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PermissionschemePutByExpandAndSchemeId(expand: string, schemeId: number, requestBody: PermissionschemePutByExpandAndSchemeIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('permissionscheme/' + schemeId + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PermissionschemePermissionGetByExpandAndSchemeId(expand: string, schemeId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('permissionscheme/' + schemeId + '/permission?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PermissionschemePermissionPostByExpandAndSchemeId(expand: string, schemeId: number, requestBody: PermissionschemePermissionPostByExpandAndSchemeIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('permissionscheme/' + schemeId + '/permission?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PermissionschemePermissionDeleteByPermissionIdAndSchemeId(permissionId: number, schemeId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('permissionscheme/' + schemeId + '/permission/' + permissionId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PermissionschemePermissionGetByExpandAndPermissionIdAndSchemeId(expand: string, permissionId: number, schemeId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('permissionscheme/' + schemeId + '/permission/' + permissionId + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PriorityGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('priority', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PriorityGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('priority/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectGetByExpandAndRecent(expand: string, recent: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&recent=' + recent, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPost(requestBody: ProjectPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('project', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectSearchGetByActionAndCategoryIdAndExpandAndMaxResultsAndOrderByAndQueryAndStartAtAndTypeKey(action: string, categoryId: number, expand: string, maxResults: number, orderBy: string, query: string, startAt: number, typeKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/search?action=' + (action == null ? '' : encodeURIComponent(action)) + '&categoryId=' + categoryId + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt + '&typeKey=' + (typeKey == null ? '' : encodeURIComponent(typeKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectTypeGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/type', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectTypeGetByProjectTypeKey(projectTypeKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/type/' + (projectTypeKey == null ? '' : encodeURIComponent(projectTypeKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectTypeAccessibleGetByProjectTypeKey(projectTypeKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/type/' + (projectTypeKey == null ? '' : encodeURIComponent(projectTypeKey)) + '/accessible', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectDeleteByProjectIdOrKey(projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectGetByExpandAndProjectIdOrKey(expand: string, projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPutByExpandAndProjectIdOrKey(expand: string, projectIdOrKey: string, requestBody: ProjectPutByExpandAndProjectIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectAvatarPutByProjectIdOrKey(projectIdOrKey: string, requestBody: ProjectAvatarPutByProjectIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/avatar', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectAvatarDeleteByIdAndProjectIdOrKey(id: number, projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/avatar/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectAvatar2PostByProjectIdOrKeyAndSizeAndXAndY(projectIdOrKey: string, size: number, x: number, y: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/avatar2&size=' + size + '&x=' + x + '&y=' + y, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectAvatarsGetByProjectIdOrKey(projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/avatars', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectComponentGetByMaxResultsAndOrderByAndProjectIdOrKeyAndQueryAndStartAt(maxResults: number, orderBy: string, projectIdOrKey: string, query: string, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/component?maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectComponentsGetByProjectIdOrKey(projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/components', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPropertiesGetByProjectIdOrKey(projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/properties', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPropertiesDeleteByProjectIdOrKeyAndPropertyKey(projectIdOrKey: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPropertiesGetByProjectIdOrKeyAndPropertyKey(projectIdOrKey: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPropertiesPutByProjectIdOrKeyAndPropertyKey(projectIdOrKey: string, propertyKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectRoleGetByProjectIdOrKey(projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/role', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectRoleDeleteByGroupAndIdAndProjectIdOrKeyAndUser(group: string, id: number, projectIdOrKey: string, user: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/role/' + id + '?group=' + (group == null ? '' : encodeURIComponent(group)) + '&user=' + (user == null ? '' : encodeURIComponent(user)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectRoleGetByIdAndProjectIdOrKey(id: number, projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/role/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectRolePostByIdAndProjectIdOrKey(id: number, projectIdOrKey: string, requestBody: ProjectRolePostByIdAndProjectIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/role/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectRolePutByIdAndProjectIdOrKey(id: number, projectIdOrKey: string, requestBody: ProjectRolePutByIdAndProjectIdOrKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/role/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectRoledetailsGetByProjectIdOrKey(projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/roledetails', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectStatusesGetByProjectIdOrKey(projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/statuses', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectTypePutByNewProjectTypeKeyAndProjectIdOrKey(newProjectTypeKey: string, projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/type/' + (newProjectTypeKey == null ? '' : encodeURIComponent(newProjectTypeKey)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectVersionGetByExpandAndMaxResultsAndOrderByAndProjectIdOrKeyAndQueryAndStartAtAndStatus(expand: string, maxResults: number, orderBy: string, projectIdOrKey: string, query: string, startAt: number, status: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/version?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&maxResults=' + maxResults + '&orderBy=' + (orderBy == null ? '' : encodeURIComponent(orderBy)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt + '&status=' + (status == null ? '' : encodeURIComponent(status)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectVersionsGetByExpandAndProjectIdOrKey(expand: string, projectIdOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectIdOrKey == null ? '' : encodeURIComponent(projectIdOrKey)) + '/versions?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectIssuesecuritylevelschemeGetByProjectKeyOrId(projectKeyOrId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectKeyOrId == null ? '' : encodeURIComponent(projectKeyOrId)) + '/issuesecuritylevelscheme', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectNotificationschemeGetByExpandAndProjectKeyOrId(expand: string, projectKeyOrId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectKeyOrId == null ? '' : encodeURIComponent(projectKeyOrId)) + '/notificationscheme?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPermissionschemeGetByExpandAndProjectKeyOrId(expand: string, projectKeyOrId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectKeyOrId == null ? '' : encodeURIComponent(projectKeyOrId)) + '/permissionscheme?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectPermissionschemePutByExpandAndProjectKeyOrId(expand: string, projectKeyOrId: string, requestBody: ProjectPermissionschemePutByExpandAndProjectKeyOrIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('project/' + (projectKeyOrId == null ? '' : encodeURIComponent(projectKeyOrId)) + '/permissionscheme?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectSecuritylevelGetByProjectKeyOrId(projectKeyOrId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('project/' + (projectKeyOrId == null ? '' : encodeURIComponent(projectKeyOrId)) + '/securitylevel', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectCategoryGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projectCategory', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectCategoryPost(requestBody: ProjectCategoryPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('projectCategory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectCategoryDeleteById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('projectCategory/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectCategoryGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projectCategory/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectCategoryPutById(id: number, requestBody: ProjectCategoryPutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('projectCategory/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ProjectvalidateKeyGetByKey(key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projectvalidate/key?key=' + (key == null ? '' : encodeURIComponent(key)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectvalidateValidProjectKeyGetByKey(key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projectvalidate/validProjectKey?key=' + (key == null ? '' : encodeURIComponent(key)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ProjectvalidateValidProjectNameGetByName(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projectvalidate/validProjectName?name=' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ResolutionGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('resolution', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ResolutionGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('resolution/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RoleGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('role', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RolePost(requestBody: RolePostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('role', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RoleDeleteByIdAndSwap(id: number, swap: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('role/' + id + '?swap=' + swap, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RoleGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('role/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RolePostById(id: number, requestBody: RolePostByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('role/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RolePutById(id: number, requestBody: RolePutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('role/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RoleActorsDeleteByGroupAndIdAndUser(group: string, id: number, user: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('role/' + id + '/actors?group=' + (group == null ? '' : encodeURIComponent(group)) + '&user=' + (user == null ? '' : encodeURIComponent(user)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RoleActorsGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('role/' + id + '/actors', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RoleActorsPostById(id: number, requestBody: RoleActorsPostByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('role/' + id + '/actors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ScreensGetByMaxResultsAndStartAt(maxResults: number, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('screens?maxResults=' + maxResults + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ScreensAddToDefaultPostByFieldId(fieldId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('screens/addToDefault/' + (fieldId == null ? '' : encodeURIComponent(fieldId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ScreensAvailableFieldsGetByScreenId(screenId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('screens/' + screenId + '/availableFields', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ScreensTabsGetByProjectKeyAndScreenId(projectKey: string, screenId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('screens/' + screenId + '/tabs?projectKey=' + (projectKey == null ? '' : encodeURIComponent(projectKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ScreensTabsPostByScreenId(screenId: number, requestBody: ScreensTabsPostByScreenIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('screens/' + screenId + '/tabs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ScreensTabsDeleteByScreenIdAndTabId(screenId: number, tabId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('screens/' + screenId + '/tabs/' + tabId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ScreensTabsPutByScreenIdAndTabId(screenId: number, tabId: number, requestBody: ScreensTabsPutByScreenIdAndTabIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('screens/' + screenId + '/tabs/' + tabId, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ScreensTabsFieldsGetByProjectKeyAndScreenIdAndTabId(projectKey: string, screenId: number, tabId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('screens/' + screenId + '/tabs/' + tabId + '/fields?projectKey=' + (projectKey == null ? '' : encodeURIComponent(projectKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ScreensTabsFieldsPostByScreenIdAndTabId(screenId: number, tabId: number, requestBody: ScreensTabsFieldsPostByScreenIdAndTabIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('screens/' + screenId + '/tabs/' + tabId + '/fields', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ScreensTabsFieldsDeleteByIdAndScreenIdAndTabId(id: string, screenId: number, tabId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('screens/' + screenId + '/tabs/' + tabId + '/fields/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ScreensTabsFieldsMovePostByIdAndScreenIdAndTabId(id: string, screenId: number, tabId: number, requestBody: ScreensTabsFieldsMovePostByIdAndScreenIdAndTabIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('screens/' + screenId + '/tabs/' + tabId + '/fields/' + (id == null ? '' : encodeURIComponent(id)) + '/move', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ScreensTabsMovePostByPosAndScreenIdAndTabId(pos: number, screenId: number, tabId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('screens/' + screenId + '/tabs/' + tabId + '/move/' + pos, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		SearchPost(requestBody: SearchPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('search', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		SecuritylevelGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('securitylevel/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ServerInfoGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('serverInfo', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		SettingsColumnsGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('settings/columns', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		SettingsColumnsPut(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('settings/columns', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StatusGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('status', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StatusGetByIdOrName(idOrName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('status/' + (idOrName == null ? '' : encodeURIComponent(idOrName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StatuscategoryGet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('statuscategory', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StatuscategoryGetByIdOrKey(idOrKey: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('statuscategory/' + (idOrKey == null ? '' : encodeURIComponent(idOrKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		TaskGetByTaskId(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('task/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		TaskCancelPostByTaskId(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('task/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Universal_avatarTypeOwnerGetByEntityIdAndType(entityId: string, type: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('universal_avatar/type/' + (type == null ? '' : encodeURIComponent(type)) + '/owner/' + (entityId == null ? '' : encodeURIComponent(entityId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Universal_avatarTypeOwnerPostByEntityIdAndSizeAndTypeAndXAndY(entityId: string, size: number, type: string, x: number, y: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('universal_avatar/type/' + (type == null ? '' : encodeURIComponent(type)) + '/owner/' + (entityId == null ? '' : encodeURIComponent(entityId)) + '&size=' + size + '&x=' + x + '&y=' + y, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Universal_avatarTypeOwnerAvatarDeleteByIdAndOwningObjectIdAndType(id: number, owningObjectId: string, type: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('universal_avatar/type/' + (type == null ? '' : encodeURIComponent(type)) + '/owner/' + (owningObjectId == null ? '' : encodeURIComponent(owningObjectId)) + '/avatar/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserDeleteByAccountIdAndKeyAndUsername(accountId: string, key: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('user?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&key=' + (key == null ? '' : encodeURIComponent(key)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserGetByAccountIdAndExpandAndKeyAndUsername(accountId: string, expand: string, key: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&key=' + (key == null ? '' : encodeURIComponent(key)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPost(requestBody: UserPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('user', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UserAssignableMultiProjectSearchGetByMaxResultsAndProjectKeysAndQueryAndStartAtAndUsername(maxResults: number, projectKeys: string, query: string, startAt: number, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/assignable/multiProjectSearch?maxResults=' + maxResults + '&projectKeys=' + (projectKeys == null ? '' : encodeURIComponent(projectKeys)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserBulkGetByKeyAndMaxResultsAndStartAtAndUsername(key: Array<string>, maxResults: number, startAt: number, username: Array<string>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/bulk?' + key.map(z => `key=${encodeURIComponent(z)}`).join('&') + '&maxResults=' + maxResults + '&startAt=' + startAt + '&' + username.map(z => `username=${encodeURIComponent(z)}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserColumnsDeleteByAccountIdAndUsername(accountId: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('user/columns?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserColumnsGetByAccountIdAndUsername(accountId: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/columns?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserColumnsPutByAccountId(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('user/columns?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserGroupsGetByAccountIdAndKeyAndUsername(accountId: string, key: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/groups?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&key=' + (key == null ? '' : encodeURIComponent(key)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPermissionSearchGetByIssueKeyAndMaxResultsAndPermissionsAndProjectKeyAndQueryAndStartAtAndUsername(issueKey: string, maxResults: number, permissions: string, projectKey: string, query: string, startAt: number, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/permission/search?issueKey=' + (issueKey == null ? '' : encodeURIComponent(issueKey)) + '&maxResults=' + maxResults + '&permissions=' + (permissions == null ? '' : encodeURIComponent(permissions)) + '&projectKey=' + (projectKey == null ? '' : encodeURIComponent(projectKey)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPickerGetByExcludeAndExcludeAccountIdsAndMaxResultsAndQueryAndShowAvatar(exclude: Array<string>, excludeAccountIds: Array<string>, maxResults: number, query: string, showAvatar: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/picker?' + exclude.map(z => `exclude=${encodeURIComponent(z)}`).join('&') + '&' + excludeAccountIds.map(z => `excludeAccountIds=${encodeURIComponent(z)}`).join('&') + '&maxResults=' + maxResults + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&showAvatar=' + showAvatar, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPropertiesGetByAccountIdAndUserKeyAndUsername(accountId: string, userKey: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/properties?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&userKey=' + (userKey == null ? '' : encodeURIComponent(userKey)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPropertiesDeleteByAccountIdAndPropertyKeyAndUserKeyAndUsername(accountId: string, propertyKey: string, userKey: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('user/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)) + '?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&userKey=' + (userKey == null ? '' : encodeURIComponent(userKey)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPropertiesGetByAccountIdAndPropertyKeyAndUserKeyAndUsername(accountId: string, propertyKey: string, userKey: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)) + '?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&userKey=' + (userKey == null ? '' : encodeURIComponent(userKey)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPropertiesPutByAccountIdAndPropertyKeyAndUserKeyAndUsername(accountId: string, propertyKey: string, userKey: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('user/properties/' + (propertyKey == null ? '' : encodeURIComponent(propertyKey)) + '?accountId=' + (accountId == null ? '' : encodeURIComponent(accountId)) + '&userKey=' + (userKey == null ? '' : encodeURIComponent(userKey)) + '&username=' + (username == null ? '' : encodeURIComponent(username)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserSearchGetByIncludeActiveAndIncludeInactiveAndMaxResultsAndPropertyAndQueryAndStartAtAndUsername(includeActive: boolean, includeInactive: boolean, maxResults: number, property: string, query: string, startAt: number, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/search?includeActive=' + includeActive + '&includeInactive=' + includeInactive + '&maxResults=' + maxResults + '&property=' + (property == null ? '' : encodeURIComponent(property)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserSearchQueryGetByIncludeInactiveAndMaxResultsAndQueryAndStartAt(includeInactive: boolean, maxResults: number, query: string, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/search/query?includeInactive=' + includeInactive + '&maxResults=' + maxResults + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserSearchQueryKeyGetByIncludeInactiveAndMaxResultsAndQueryAndStartAt(includeInactive: boolean, maxResults: number, query: string, startAt: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/search/query/key?includeInactive=' + includeInactive + '&maxResults=' + maxResults + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserViewissueSearchGetByIssueKeyAndMaxResultsAndProjectKeyAndQueryAndStartAtAndUsername(issueKey: string, maxResults: number, projectKey: string, query: string, startAt: number, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('user/viewissue/search?issueKey=' + (issueKey == null ? '' : encodeURIComponent(issueKey)) + '&maxResults=' + maxResults + '&projectKey=' + (projectKey == null ? '' : encodeURIComponent(projectKey)) + '&query=' + (query == null ? '' : encodeURIComponent(query)) + '&startAt=' + startAt + '&username=' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionPost(requestBody: VersionPostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('version', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		VersionRemotelinkGetByGlobalId(globalId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('version/remotelink?globalId=' + (globalId == null ? '' : encodeURIComponent(globalId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionDeleteByIdAndMoveAffectedIssuesToAndMoveFixIssuesTo(id: string, moveAffectedIssuesTo: string, moveFixIssuesTo: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('version/' + (id == null ? '' : encodeURIComponent(id)) + '&moveAffectedIssuesTo=' + (moveAffectedIssuesTo == null ? '' : encodeURIComponent(moveAffectedIssuesTo)) + '&moveFixIssuesTo=' + (moveFixIssuesTo == null ? '' : encodeURIComponent(moveFixIssuesTo)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionGetByExpandAndId(expand: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('version/' + (id == null ? '' : encodeURIComponent(id)) + '?expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionPutById(id: string, requestBody: VersionPutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('version/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		VersionMergetoPutByIdAndMoveIssuesTo(id: string, moveIssuesTo: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('version/' + (id == null ? '' : encodeURIComponent(id)) + '/mergeto/' + (moveIssuesTo == null ? '' : encodeURIComponent(moveIssuesTo)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionMovePostById(id: string, requestBody: VersionMovePostByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('version/' + (id == null ? '' : encodeURIComponent(id)) + '/move', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		VersionRelatedIssueCountsGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('version/' + (id == null ? '' : encodeURIComponent(id)) + '/relatedIssueCounts', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionRemoveAndSwapPostById(id: string, requestBody: VersionRemoveAndSwapPostByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('version/' + (id == null ? '' : encodeURIComponent(id)) + '/removeAndSwap', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		VersionUnresolvedIssueCountGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('version/' + (id == null ? '' : encodeURIComponent(id)) + '/unresolvedIssueCount', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionRemotelinkDeleteByVersionId(versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('version/' + (versionId == null ? '' : encodeURIComponent(versionId)) + '/remotelink', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionRemotelinkGetByVersionId(versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('version/' + (versionId == null ? '' : encodeURIComponent(versionId)) + '/remotelink', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionRemotelinkPostByVersionId(versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('version/' + (versionId == null ? '' : encodeURIComponent(versionId)) + '/remotelink', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionRemotelinkDeleteByGlobalIdAndVersionId(globalId: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('version/' + (versionId == null ? '' : encodeURIComponent(versionId)) + '/remotelink/' + (globalId == null ? '' : encodeURIComponent(globalId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionRemotelinkGetByGlobalIdAndVersionId(globalId: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('version/' + (versionId == null ? '' : encodeURIComponent(versionId)) + '/remotelink/' + (globalId == null ? '' : encodeURIComponent(globalId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VersionRemotelinkPostByGlobalIdAndVersionId(globalId: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('version/' + (versionId == null ? '' : encodeURIComponent(versionId)) + '/remotelink/' + (globalId == null ? '' : encodeURIComponent(globalId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowGetByWorkflowName(workflowName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflow?workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowTransitionsPropertiesDeleteByKeyAndTransitionIdAndWorkflowModeAndWorkflowName(key: string, transitionId: number, workflowMode: string, workflowName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflow/transitions/' + transitionId + '/properties?key=' + (key == null ? '' : encodeURIComponent(key)) + '&workflowMode=' + (workflowMode == null ? '' : encodeURIComponent(workflowMode)) + '&workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowTransitionsPropertiesGetByIncludeReservedKeysAndKeyAndTransitionIdAndWorkflowModeAndWorkflowName(includeReservedKeys: boolean, key: string, transitionId: number, workflowMode: string, workflowName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflow/transitions/' + transitionId + '/properties?includeReservedKeys=' + includeReservedKeys + '&key=' + (key == null ? '' : encodeURIComponent(key)) + '&workflowMode=' + (workflowMode == null ? '' : encodeURIComponent(workflowMode)) + '&workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowTransitionsPropertiesPostByKeyAndTransitionIdAndWorkflowModeAndWorkflowName(key: string, transitionId: number, workflowMode: string, workflowName: string, requestBody: WorkflowTransitionsPropertiesPostByKeyAndTransitionIdAndWorkflowModeAndWorkflowNameBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('workflow/transitions/' + transitionId + '/properties?key=' + (key == null ? '' : encodeURIComponent(key)) + '&workflowMode=' + (workflowMode == null ? '' : encodeURIComponent(workflowMode)) + '&workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowTransitionsPropertiesPutByKeyAndTransitionIdAndWorkflowModeAndWorkflowName(key: string, transitionId: number, workflowMode: string, workflowName: string, requestBody: WorkflowTransitionsPropertiesPutByKeyAndTransitionIdAndWorkflowModeAndWorkflowNameBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflow/transitions/' + transitionId + '/properties?key=' + (key == null ? '' : encodeURIComponent(key)) + '&workflowMode=' + (workflowMode == null ? '' : encodeURIComponent(workflowMode)) + '&workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemePost(requestBody: WorkflowschemePostBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('workflowscheme', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeDeleteById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeGetByIdAndReturnDraftIfExists(id: number, returnDraftIfExists: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '?returnDraftIfExists=' + returnDraftIfExists, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemePutById(id: number, requestBody: WorkflowschemePutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeCreatedraftPostById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('workflowscheme/' + id + '/createdraft', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDefaultDeleteByIdAndUpdateDraftIfNeeded(id: number, updateDraftIfNeeded: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id + '/default?updateDraftIfNeeded=' + updateDraftIfNeeded, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDefaultGetByIdAndReturnDraftIfExists(id: number, returnDraftIfExists: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '/default?returnDraftIfExists=' + returnDraftIfExists, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDefaultPutById(id: number, requestBody: WorkflowschemeDefaultPutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id + '/default', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeDraftDeleteById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id + '/draft', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '/draft', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftPutById(id: number, requestBody: WorkflowschemeDraftPutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id + '/draft', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeDraftDefaultDeleteById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id + '/draft/default', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftDefaultGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '/draft/default', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftDefaultPutById(id: number, requestBody: WorkflowschemeDraftDefaultPutByIdBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id + '/draft/default', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeDraftIssuetypeDeleteByIdAndIssueType(id: number, issueType: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id + '/draft/issuetype/' + (issueType == null ? '' : encodeURIComponent(issueType)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftIssuetypeGetByIdAndIssueType(id: number, issueType: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '/draft/issuetype/' + (issueType == null ? '' : encodeURIComponent(issueType)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftIssuetypePutByIdAndIssueType(id: number, issueType: string, requestBody: WorkflowschemeDraftIssuetypePutByIdAndIssueTypeBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id + '/draft/issuetype/' + (issueType == null ? '' : encodeURIComponent(issueType)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeDraftWorkflowDeleteByIdAndWorkflowName(id: number, workflowName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id + '/draft/workflow?workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftWorkflowGetByIdAndWorkflowName(id: number, workflowName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '/draft/workflow?workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeDraftWorkflowPutByIdAndWorkflowName(id: number, workflowName: string, requestBody: WorkflowschemeDraftWorkflowPutByIdAndWorkflowNameBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id + '/draft/workflow?workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeIssuetypeDeleteByIdAndIssueTypeAndUpdateDraftIfNeeded(id: number, issueType: string, updateDraftIfNeeded: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id + '/issuetype/' + (issueType == null ? '' : encodeURIComponent(issueType)) + '&updateDraftIfNeeded=' + updateDraftIfNeeded, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeIssuetypeGetByIdAndIssueTypeAndReturnDraftIfExists(id: number, issueType: string, returnDraftIfExists: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '/issuetype/' + (issueType == null ? '' : encodeURIComponent(issueType)) + '&returnDraftIfExists=' + returnDraftIfExists, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeIssuetypePutByIdAndIssueType(id: number, issueType: string, requestBody: WorkflowschemeIssuetypePutByIdAndIssueTypeBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id + '/issuetype/' + (issueType == null ? '' : encodeURIComponent(issueType)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorkflowschemeWorkflowDeleteByIdAndUpdateDraftIfNeededAndWorkflowName(id: number, updateDraftIfNeeded: boolean, workflowName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('workflowscheme/' + id + '/workflow?updateDraftIfNeeded=' + updateDraftIfNeeded + '&workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeWorkflowGetByIdAndReturnDraftIfExistsAndWorkflowName(id: number, returnDraftIfExists: boolean, workflowName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('workflowscheme/' + id + '/workflow?returnDraftIfExists=' + returnDraftIfExists + '&workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorkflowschemeWorkflowPutByIdAndWorkflowName(id: number, workflowName: string, requestBody: WorkflowschemeWorkflowPutByIdAndWorkflowNameBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('workflowscheme/' + id + '/workflow?workflowName=' + (workflowName == null ? '' : encodeURIComponent(workflowName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorklogDeletedGetBySince(since: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('worklog/deleted?since=' + since, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		WorklogListPostByExpand(expand: string, requestBody: WorklogListPostByExpandBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('worklog/list?expand=' + (expand == null ? '' : encodeURIComponent(expand)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		WorklogUpdatedGetByExpandAndSince(expand: string, since: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('worklog/updated?expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&since=' + since, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
