...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		VisionPost(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('adult_content', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VisionGetByTaskId(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('adult_content/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CreativePost(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('artistic_image', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CreativeGetByTaskId(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('artistic_image/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		VisionPost(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('detect_object', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		VisionGetByTaskId(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('detect_object/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		VisionPost(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('face', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		VisionGetByTaskId(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('face/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		VisionPost(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('face_age', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		VisionGetByTaskId(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('face_age/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
