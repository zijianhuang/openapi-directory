export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		GetMetadataOfAllChannels(limit: number, prefix: string, by: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'channels?limit=' + limit + '&prefix=' + (prefix == null ? '' : encodeURIComponent(prefix)) + '&by=' + (by == null ? '' : encodeURIComponent(by)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetMetadataOfChannel(channel_id: string, headersHandler?: () => {[header: string]: string}): Promise<ChannelDetails> {
			return fetch(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		GetMessagesByChannel(channel_id: string, start: string, limit: number, end: string, direction: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/messages&start=' + (start == null ? '' : encodeURIComponent(start)) + '&limit=' + limit + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&direction=' + (direction == null ? '' : encodeURIComponent(direction)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PublishMessagesToChannel(channel_id: string, requestBody: Message, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/messages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetPresenceOfChannel(channel_id: string, clientId: string, connectionId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Array<PresenceMessage>> {
			return fetch(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/presence&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&connectionId=' + (connectionId == null ? '' : encodeURIComponent(connectionId)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		GetPresenceHistoryOfChannel(channel_id: string, start: string, limit: number, end: string, direction: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/presence/history&start=' + (start == null ? '' : encodeURIComponent(start)) + '&limit=' + limit + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&direction=' + (direction == null ? '' : encodeURIComponent(direction)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		RequestAccessToken(keyName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'keys/' + (keyName == null ? '' : encodeURIComponent(keyName)) + '/requestToken', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeletePushDeviceDetails(channel: string, deviceId: string, clientId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/channelSubscriptions?channel=' + (channel == null ? '' : encodeURIComponent(channel)) + '&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetPushSubscriptionsOnChannels(channel: string, deviceId: string, clientId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/channelSubscriptions?channel=' + (channel == null ? '' : encodeURIComponent(channel)) + '&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		SubscribePushDeviceToChannel(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/channelSubscriptions', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetChannelsWithPushSubscribers(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/channels', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UnregisterAllPushDevices(deviceId: string, clientId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/deviceRegistrations?deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetRegisteredPushDevices(deviceId: string, clientId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/deviceRegistrations?deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		RegisterPushDevice(requestBody: DeviceDetails, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/deviceRegistrations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		UnregisterPushDevice(device_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetPushDeviceDetails(device_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PutPushDeviceDetails(device_id: string, requestBody: DeviceDetails, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		UpdatePushDeviceDetails(device_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)) + '/resetUpdateToken', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PublishPushNotificationToDevices(requestBody: PublishPushNotificationToDevicesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'push/publish', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		GetStats(start: string, limit: number, end: string, direction: string, unit: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'stats?start=' + (start == null ? '' : encodeURIComponent(start)) + '&limit=' + limit + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&direction=' + (direction == null ? '' : encodeURIComponent(direction)) + '&unit=' + (unit == null ? '' : encodeURIComponent(unit)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetTime(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'time', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
	}
