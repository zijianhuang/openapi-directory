...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GetMetadataOfAllChannels(limit: number, prefix: string, by: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('channels?limit=' + limit + '&prefix=' + (prefix == null ? '' : encodeURIComponent(prefix)) + '&by=' + (by == null ? '' : encodeURIComponent(by)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetMetadataOfChannel(channel_id: string, headersHandler?: () => {[header: string]: string}): Promise<ChannelDetails> {
			return this.http.get('channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMessagesByChannel(channel_id: string, start: string, limit: number, end: string, direction: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/messages&start=' + (start == null ? '' : encodeURIComponent(start)) + '&limit=' + limit + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&direction=' + (direction == null ? '' : encodeURIComponent(direction)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PublishMessagesToChannel(channel_id: string, requestBody: Message, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/messages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetPresenceOfChannel(channel_id: string, clientId: string, connectionId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Array<PresenceMessage>> {
			return this.http.get('channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/presence&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&connectionId=' + (connectionId == null ? '' : encodeURIComponent(connectionId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPresenceHistoryOfChannel(channel_id: string, start: string, limit: number, end: string, direction: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/presence/history&start=' + (start == null ? '' : encodeURIComponent(start)) + '&limit=' + limit + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&direction=' + (direction == null ? '' : encodeURIComponent(direction)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RequestAccessToken(keyName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('keys/' + (keyName == null ? '' : encodeURIComponent(keyName)) + '/requestToken', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeletePushDeviceDetails(channel: string, deviceId: string, clientId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('push/channelSubscriptions?channel=' + (channel == null ? '' : encodeURIComponent(channel)) + '&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPushSubscriptionsOnChannels(channel: string, deviceId: string, clientId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('push/channelSubscriptions?channel=' + (channel == null ? '' : encodeURIComponent(channel)) + '&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		SubscribePushDeviceToChannel(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('push/channelSubscriptions', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetChannelsWithPushSubscribers(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('push/channels', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UnregisterAllPushDevices(deviceId: string, clientId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('push/deviceRegistrations?deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetRegisteredPushDevices(deviceId: string, clientId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('push/deviceRegistrations?deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RegisterPushDevice(requestBody: DeviceDetails, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('push/deviceRegistrations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UnregisterPushDevice(device_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPushDeviceDetails(device_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PutPushDeviceDetails(device_id: string, requestBody: DeviceDetails, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdatePushDeviceDetails(device_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)) + '/resetUpdateToken', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PublishPushNotificationToDevices(requestBody: PublishPushNotificationToDevicesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('push/publish', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetStats(start: string, limit: number, end: string, direction: string, unit: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('stats?start=' + (start == null ? '' : encodeURIComponent(start)) + '&limit=' + limit + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&direction=' + (direction == null ? '' : encodeURIComponent(direction)) + '&unit=' + (unit == null ? '' : encodeURIComponent(unit)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetTime(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('time', { headers: headersHandler ? headersHandler() : undefined });
		}
	}
