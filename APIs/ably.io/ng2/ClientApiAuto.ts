...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		GetMetadataOfAllChannels(limit: number, prefix: string, by: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'channels?limit=' + limit + '&prefix=' + (prefix == null ? '' : encodeURIComponent(prefix)) + '&by=' + (by == null ? '' : encodeURIComponent(by)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetMetadataOfChannel(channel_id: string, headersHandler?: () => HttpHeaders): Observable<ChannelDetails> {
			return this.http.get<ChannelDetails>(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetMessagesByChannel(channel_id: string, start: string, limit: number, end: string, direction: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PublishMessagesToChannel(channel_id: string, requestBody: Message, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/messages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetPresenceOfChannel(channel_id: string, clientId: string, connectionId: string, limit: number, headersHandler?: () => HttpHeaders): Observable<Array<PresenceMessage>> {
			return this.http.get<Array<PresenceMessage>>(this.baseUri + 'channels/' + (channel_id == null ? '' : encodeURIComponent(channel_id)) + '/presence&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&connectionId=' + (connectionId == null ? '' : encodeURIComponent(connectionId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetPresenceHistoryOfChannel(channel_id: string, start: string, limit: number, end: string, direction: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		RequestAccessToken(keyName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'keys/' + (keyName == null ? '' : encodeURIComponent(keyName)) + '/requestToken', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeletePushDeviceDetails(channel: string, deviceId: string, clientId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'push/channelSubscriptions?channel=' + (channel == null ? '' : encodeURIComponent(channel)) + '&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetPushSubscriptionsOnChannels(channel: string, deviceId: string, clientId: string, limit: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'push/channelSubscriptions?channel=' + (channel == null ? '' : encodeURIComponent(channel)) + '&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		SubscribePushDeviceToChannel(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'push/channelSubscriptions', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetChannelsWithPushSubscribers(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'push/channels', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UnregisterAllPushDevices(deviceId: string, clientId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'push/deviceRegistrations?deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetRegisteredPushDevices(deviceId: string, clientId: string, limit: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'push/deviceRegistrations?deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RegisterPushDevice(requestBody: DeviceDetails, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'push/deviceRegistrations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UnregisterPushDevice(device_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetPushDeviceDetails(device_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PutPushDeviceDetails(device_id: string, requestBody: DeviceDetails, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdatePushDeviceDetails(device_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'push/deviceRegistrations/' + (device_id == null ? '' : encodeURIComponent(device_id)) + '/resetUpdateToken', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PublishPushNotificationToDevices(requestBody: PublishPushNotificationToDevicesBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'push/publish', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetStats(start: string, limit: number, end: string, direction: string, unit: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'stats?start=' + (start == null ? '' : encodeURIComponent(start)) + '&limit=' + limit + '&end=' + (end == null ? '' : encodeURIComponent(end)) + '&direction=' + (direction == null ? '' : encodeURIComponent(direction)) + '&unit=' + (unit == null ? '' : encodeURIComponent(unit)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetTime(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'time', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
	}
