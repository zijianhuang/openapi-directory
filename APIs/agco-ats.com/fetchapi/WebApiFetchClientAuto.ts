export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {any} OK
		 */
		AftermarketServices_GetCerts(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/Certificates', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AftermarketServices_PutECU(serialNumber: string, EDTInstanceId: string, requestBody: AGCOPowerServices.Models.ECU, headersHandler?: () => {[header: string]: string}): Promise<AGCOPowerServices.Models.ECU> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/ECUs/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AftermarketServices_GetEngineIQACodes(serialNumber: string, EDTInstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/IQACodes&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_PutIQACodes(serialNumber: string, EDTInstanceId: string, requestBody: Array<string>, headersHandler?: () => {[header: string]: string}): Promise<boolean> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/IQACodes&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AftermarketServices_GetProductionData(serialNumber: string, EDTInstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AGCOPowerServices.Models.ProductionData>> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/ProductionData&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_GetConnectionStatus(headersHandler?: () => {[header: string]: string}): Promise<boolean> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/Hello', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_GetUserStatus(voucherCode: string, dealerCode: string, headersHandler?: () => {[header: string]: string}): Promise<AGCOPowerServices.Models.UserStatus> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/UserStatuses?voucherCode=' + (voucherCode == null ? '' : encodeURIComponent(voucherCode)) + '&dealerCode=' + (dealerCode == null ? '' : encodeURIComponent(dealerCode)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_UpdateUserStatus(requestBody: AGCOPowerServices.Models.UserStatus, headersHandler?: () => {[header: string]: string}): Promise<boolean> {
			return fetch(this.baseUri + 'api/v2/AftermarketServices/UserStatuses', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Authentication_PutManageTokens(UserID: number, requestBody: API.Models.TokenOptions, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AuthenticatedUsers/' + UserID + '/Tokens', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Authentication_Default(requestBody: API.Models.Credentials, headersHandler?: () => {[header: string]: string}): Promise<API.Models.AuthenticatedUser> {
			return fetch(this.baseUri + 'api/v2/Authentication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Authentication_IsAlive(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Authentication/IsAlive', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Authentication_RequestPasswordReset(requestBody: API.Models.PasswordResetRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Authentication/RequestPasswordReset', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		Authentication_ResetPasword(requestBody: API.Models.PasswordReset, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Authentication/ResetPasword', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		AuthorizationCodeDefinitionsGetByLimitAndOffsetAndNameAndCreatedByUserIDAndDeletedByUserIDAndIncludeDeleted(limit: number, offset: number, name: string, createdByUserID: number, deletedByUserID: number, includeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodeDefinitions?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&createdByUserID=' + createdByUserID + '&deletedByUserID=' + deletedByUserID + '&includeDeleted=' + includeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuthorizationCodeDefinitions_PostAuthorizationCodeDefinition(requestBody: AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodeDefinitions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodeDefinitions_DeleteAuthorizationCodeDefinition(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuthorizationCodeDefinitionsGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodeDefinitions_PutAuthorizationCodeDefinition(id: string, requestBody: AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		AuthorizationCodes_GetAuthorizationCodes(code: string, limit: number, offset: number, definitionID: string, createdByUserID: number, deletedByUserID: number, includeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodes?code=' + (code == null ? '' : encodeURIComponent(code)) + '&limit=' + limit + '&offset=' + offset + '&definitionID=' + (definitionID == null ? '' : encodeURIComponent(definitionID)) + '&createdByUserID=' + createdByUserID + '&deletedByUserID=' + deletedByUserID + '&includeDeleted=' + includeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuthorizationCodes_PostAuthorizationCode(requestBody: AuthorizationCodes.Shared.Models.AuthorizationCode, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodes_DeleteAuthorizationCode(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodes/' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuthorizationCodes_GetAuthorizationCode(id: number, headersHandler?: () => {[header: string]: string}): Promise<AuthorizationCodes.Shared.Models.AuthorizationCode> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodes/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodes_PutAuthorizationCode(id: number, requestBody: AuthorizationCodes.Shared.Models.AuthorizationCode, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/AuthorizationCodes/' + id, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Brands_Brands(headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'api/v2/Brands', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		Bundles_GetBundles(UpdateGroupID: string, Active: boolean, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Bundles?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&Active=' + Active + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Bundles_PostBundle(requestBody: UpdateSystem.Models.Bundle, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/Bundles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		Bundles_DeleteBundle(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Bundles_GetBundle(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Bundle> {
			return fetch(this.baseUri + 'api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Bundles_PutBundle(ID: string, requestBody: UpdateSystem.Models.Bundle, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		ClientsGetByTagAndLimitAndOffset(Tag: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Clients?Tag=' + (Tag == null ? '' : encodeURIComponent(Tag)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateSystem_GetCachedFiles(ClientID: string, Expired: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/CachedFiles&Expired=' + Expired, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PackageReportsGetByClientID(ClientID: string, headersHandler?: () => {[header: string]: string}): Promise<Array<UpdateSystem.Models.PackageReport>> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PackageReportsPutByClientID(ClientID: string, requestBody: UpdateSystem.Models.PackageReport, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		PackageReports_Batch(ClientID: string, requestBody: Array<UpdateSystem.Models.PackageReport>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports/Batch', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ClientsGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Client> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Clients_Put(ID: string, requestBody: UpdateSystem.Models.Client, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Clients_GetAvailableSubscriptions(ID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)) + '/AvailableUpdateGroupSubscriptions&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Clients_GetSubscriptions(ID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)) + '/UpdateGroupSubscriptions&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		ContentDefinitions_GetContentDefinitions(limit: number, offset: number, userID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentDefinitions?limit=' + limit + '&offset=' + offset + '&userID=' + userID, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentDefinitions_PostContentDefinition(requestBody: ContentSubmission.Shared.BusinessEntities.ContentDefinition, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/ContentDefinitions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentDefinitions_DeleteContentDefinition(contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentDefinitions/' + contentDefinitionID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentDefinitions_GetContentDefinition(contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentDefinition> {
			return fetch(this.baseUri + 'api/v2/ContentDefinitions/' + contentDefinitionID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentDefinitions_PutContentDefinition(contentDefinitionID: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentDefinition, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentDefinitions/' + contentDefinitionID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		ContentReleaseGetByLimitAndOffsetAndDeletedAndReleaseIDAndUserIdAndContentDefinitionIDAndVersion(limit: number, offset: number, deleted: boolean, releaseID: number, userId: number, contentDefinitionID: number, version: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentReleases?limit=' + limit + '&offset=' + offset + '&deleted=' + deleted + '&releaseID=' + releaseID + '&userId=' + userId + '&contentDefinitionID=' + contentDefinitionID + '&version=' + version, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentRelease_PostContentRelease(requestBody: ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/ContentReleases', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentRelease_DeleteContentReleaseVersionn(ContentReleaseId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentReleases/' + ContentReleaseId, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentReleaseGetByContentReleaseId(ContentReleaseId: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion> {
			return fetch(this.baseUri + 'api/v2/ContentReleases/' + ContentReleaseId, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentRelease_PutContentDefinition(ContentReleaseId: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentReleases/' + ContentReleaseId, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ContentSubmissionTypes_GetContentSubmissionTypes(enabled: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType>> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissionTypes?enabled=' + enabled, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ContentSubmissionTypes_PostContentSubmissionType(requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmissionType, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissionTypes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissionTypes_DeleteContentSubmissionType(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissionTypes/' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentSubmissionTypes_GetContentSubmissionType(id: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissionTypes/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissionTypes_PutContentSubmissionType(id: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmissionType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissionTypes/' + id, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		ContentSubmissions_GetContentSubmissions(limit: number, offset: number, userID: number, contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissions?limit=' + limit + '&offset=' + offset + '&userID=' + userID + '&contentDefinitionID=' + contentDefinitionID, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentSubmissions_PostContentSubmission(requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmission, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissions_DeleteContentSubmission(contentSubmissionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissions/' + contentSubmissionID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentSubmissions_GetContentSubmission(contentSubmissionID: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentSubmission> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissions/' + contentSubmissionID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissions_PutContentSubmission(contentSubmissionID: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmission, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/ContentSubmissions/' + contentSubmissionID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		DealerByCountry_GetCountries(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/DealerByCountry?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Dealers_GetDealers(Brand: string, ShippingCountry: string, DealerName: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Dealers?Brand=' + (Brand == null ? '' : encodeURIComponent(Brand)) + '&ShippingCountry=' + (ShippingCountry == null ? '' : encodeURIComponent(ShippingCountry)) + '&DealerName=' + (DealerName == null ? '' : encodeURIComponent(DealerName)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Dealers_GetDealerbyDealerCode(DealerCode: string, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.Dealer> {
			return fetch(this.baseUri + 'api/v2/Dealers/' + (DealerCode == null ? '' : encodeURIComponent(DealerCode)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		LicenseActivations_Post(requestBody: DealerDB.Models.LicenseActivationCreate, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.LicenseActivation> {
			return fetch(this.baseUri + 'api/v2/LicenseActivations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		LicenseActivations_PostRegisterEDTLite(requestBody: DealerDB.Models.EDTLiteRegistration, headersHandler?: () => {[header: string]: string}): Promise<boolean> {
			return fetch(this.baseUri + 'api/v2/LicenseActivations/RegisterEDTLite', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		LicenseActivations_Put(ID: string, requestBody: DealerDB.Models.LicenseActivationUpdate, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.LicenseActivation> {
			return fetch(this.baseUri + 'api/v2/LicenseActivations/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		LicenseActivations_PutConfirm(ID: string, requestBody: DealerDB.Models.LicenseActivationConfirm, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/LicenseActivations/' + (ID == null ? '' : encodeURIComponent(ID)) + '/Confirm', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		LicensesGetByVoucherCodeAndDealerCodeAndStatusAndLimitAndOffset(VoucherCode: string, DealerCode: string, Status: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Licenses?VoucherCode=' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&DealerCode=' + (DealerCode == null ? '' : encodeURIComponent(DealerCode)) + '&Status=' + (Status == null ? '' : encodeURIComponent(Status)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		LicensesGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.License> {
			return fetch(this.baseUri + 'api/v2/Licenses/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		Logs_GetLogs(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Logs?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Logs_PostLog(Message: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/Logs?Message=' + (Message == null ? '' : encodeURIComponent(Message)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Logs_GetLog(ID: string, headersHandler?: () => {[header: string]: string}): Promise<API.Models.Log> {
			return fetch(this.baseUri + 'api/v2/Logs/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Notifications_PostMail(requestBody: API.Models.Notification, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Notifications', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		PackageTypesGetByLimitAndOffset(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PackageTypes?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PackageTypes_Post(requestBody: UpdateSystem.Models.PackageType, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/PackageTypes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		PackageTypes_Delete(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PackageTypesGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.PackageType> {
			return fetch(this.baseUri + 'api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PackageTypes_Put(ID: string, requestBody: UpdateSystem.Models.PackageType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypetoBundles_Delete(BundleID: string, PackageTypeID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PackageTypetoBundles?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&PackageTypeID=' + (PackageTypeID == null ? '' : encodeURIComponent(PackageTypeID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		PackageTypetoBundles_Get(BundleID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PackageTypetoBundles?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypetoBundles_Post(requestBody: UpdateSystem.Models.PackageTypeIDtoBundle, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PackageTypetoBundles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypetoBundles_Put(requestBody: UpdateSystem.Models.PackageTypeIDtoBundle, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PackageTypetoBundles', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Packages_GetPackages(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Packages?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Packages_PostPackage(requestBody: UpdateSystem.Models.Package, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/Packages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		Packages_DeletePackage(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Packages_GetPackage(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Package> {
			return fetch(this.baseUri + 'api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Packages_PutPackage(ID: string, requestBody: UpdateSystem.Models.Package, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Permissions_GetPermissions(limit: number, offset: number, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Permissions?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Permissions_PostPermission(requestBody: API.Models.Permission, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/Permissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Permissions_DeletePermission(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Permissions/' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Permissions_GetPermission(id: number, headersHandler?: () => {[header: string]: string}): Promise<API.Models.Permission> {
			return fetch(this.baseUri + 'api/v2/Permissions/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Permissions_PutPermission(id: number, requestBody: API.Models.Permission, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Permissions/' + id, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		PriorityPackages_GetPriorityPackages(ClientID: string, Status: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PriorityPackages?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Status=' + (Status == null ? '' : encodeURIComponent(Status)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PriorityPackages_PostPriorityPackages(requestBody: UpdateSystem.Models.PriorityPackage, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/PriorityPackages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		PriorityPackages_DeletePriorityPackages(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/PriorityPackages/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PriorityPackages_GetPriorityPackage(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.PriorityPackage> {
			return fetch(this.baseUri + 'api/v2/PriorityPackages/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		Release_GetReleases(limit: number, offset: number, visible: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Releases?limit=' + limit + '&offset=' + offset + '&visible=' + visible, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Release_PostRelease(requestBody: ContentSubmission.Shared.BusinessEntities.Release, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/Releases', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Release_GetRelease(ReleaseId: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.Release> {
			return fetch(this.baseUri + 'api/v2/Releases/' + ReleaseId, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Release_PutContentDefinition(releaseId: number, requestBody: ContentSubmission.Shared.BusinessEntities.Release, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Releases/' + releaseId, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_BundleStatusSummary(BundleID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Reporting/BundleStatusSummary?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_BundlesInUpdateGroup(ID: string, IncludeInactive: boolean, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Reporting/BundlesInUpdateGroup?ID=' + (ID == null ? '' : encodeURIComponent(ID)) + '&IncludeInactive=' + IncludeInactive + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_ClientInfo(ClientID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.ClientInfo> {
			return fetch(this.baseUri + 'api/v2/Reporting/ClientInfo?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Reporting_CurrentPackagesInUpdateGroup(ID: string, SubscriptionTypeFilter: string, headersHandler?: () => {[header: string]: string}): Promise<Array<UpdateSystem.Models.Package>> {
			return fetch(this.baseUri + 'api/v2/Reporting/CurrentPackagesInUpdateGroup?ID=' + (ID == null ? '' : encodeURIComponent(ID)) + '&SubscriptionTypeFilter=' + (SubscriptionTypeFilter == null ? '' : encodeURIComponent(SubscriptionTypeFilter)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Reporting_GetClient(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Client> {
			return fetch(this.baseUri + 'api/v2/Reporting/GetClient?ID=' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_GetSubscriptions(ClientID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Reporting/GetSubscriptions?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_PackageStatusSummary(PackageID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.PackageStatusSummary> {
			return fetch(this.baseUri + 'api/v2/Reporting/PackageStatusSummary?PackageID=' + (PackageID == null ? '' : encodeURIComponent(PackageID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_UpdateGroups(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Reporting/UpdateGroups?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_UpdateMetrics(UpdateGroupID: string, bundleNumber: number, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateMetricsData> {
			return fetch(this.baseUri + 'api/v2/Reporting/UpdateMetrics?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&bundleNumber=' + bundleNumber, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		Roles_GetRoles(limit: number, offset: number, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Roles?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Roles_PostRole(requestBody: API.Models.Role, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/Roles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Roles_DeleteRole(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Roles/' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Roles_GetRole(id: number, headersHandler?: () => {[header: string]: string}): Promise<API.Models.Role> {
			return fetch(this.baseUri + 'api/v2/Roles/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Roles_PutRole(id: number, requestBody: API.Models.Role, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Roles/' + id, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Roles_GetRolePermissions(id: number, name: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Roles/' + id + '/Permissions?name=' + (name == null ? '' : encodeURIComponent(name)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Roles_PutRolePermissions(id: number, requestBody: Array<API.Models.RolePermissionChange>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Roles/' + id + '/Permissions', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissions_GetUsers(id: number, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Roles/' + id + '/Users?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UserPermissionsPutById(id: number, requestBody: Array<API.Models.RoleUserChange>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Roles/' + id + '/Users', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		UpdateGroupClientRelationships_GetSubscriptions(ClientID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupClientRelationships?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupClientRelationships_PostSubscription(requestBody: UpdateSystem.Models.UpdateGroupClientRelationship, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupClientRelationships', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupClientRelationships_PutSubscriptionByClientIDUpdateGroupID(ClientID: string, UpdateGroupID: string, Active: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupClientRelationships?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&Active=' + Active, { method: 'put', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupClientRelationships_GetSubscription(RelationshipID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateGroupClientRelationship> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupClientRelationships/' + (RelationshipID == null ? '' : encodeURIComponent(RelationshipID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupClientRelationships_PutSubscription(RelationshipID: string, requestBody: UpdateSystem.Models.UpdateGroupClientRelationship, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupClientRelationships/' + (RelationshipID == null ? '' : encodeURIComponent(RelationshipID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		UpdateGroupSubscriptions_GetUpdateGroupSubscriptions(UpdateGroupID: string, PackageTypeID: string, ClientID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupSubscriptions?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&PackageTypeID=' + (PackageTypeID == null ? '' : encodeURIComponent(PackageTypeID)) + '&ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupSubscriptions_PostUpdateGroupSubscription(requestBody: UpdateSystem.Models.UpdateGroupSubscription, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupSubscriptions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupSubscriptions_DeleteUpdateGroupSubscription(UpdateGroupSubscriptionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupSubscriptions_GetUpdateGroupSubscription(UpdateGroupSubscriptionID: number, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateGroupSubscription> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupSubscriptions_PutUpdateGroupSubscription(UpdateGroupSubscriptionID: number, requestBody: UpdateSystem.Models.UpdateGroupSubscription, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		UpdateGroupsGetByLimitAndOffset(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroups?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroups_Post(requestBody: UpdateSystem.Models.UpdateGroup, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/UpdateGroups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroups_Delete(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupsGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateGroup> {
			return fetch(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroups_Put(ID: string, requestBody: UpdateSystem.Models.UpdateGroup, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		UpdateGroups_GetUpdateGroupBundles(ID: string, IncludeInactive: boolean, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)) + '/Bundles&IncludeInactive=' + IncludeInactive + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateSystem_GetCheckin(ClientID: string, Preview: boolean, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.CheckinResult> {
			return fetch(this.baseUri + 'api/v2/UpdateSystem?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Preview=' + Preview, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		UserContentDefinitions_GetUserContentDefinitions(limit: number, offset: number, userID: number, contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UserContentDefinitions?limit=' + limit + '&offset=' + offset + '&userID=' + userID + '&contentDefinitionID=' + contentDefinitionID, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserContentDefinitions_PostUserContentDefinition(requestBody: ContentSubmission.Shared.BusinessEntities.UserContentDefinition, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/UserContentDefinitions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UserContentDefinitions_DeleteUserContentDefinition(userContentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/UserContentDefinitions/' + userContentDefinitionID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserContentDefinitions_GetUserContentDefinition(userContentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.UserContentDefinition> {
			return fetch(this.baseUri + 'api/v2/UserContentDefinitions/' + userContentDefinitionID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {any} OK
		 */
		UsersGetByUsernameAndEmailAndNameAndLimitAndOffset(username: string, email: string, name: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users?username=' + (username == null ? '' : encodeURIComponent(username)) + '&email=' + (email == null ? '' : encodeURIComponent(email)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_Post(requestBody: API.Models.User, headersHandler?: () => {[header: string]: string}): Promise<API.Models.User> {
			return fetch(this.baseUri + 'api/v2/Users', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Users_GetCurrentUser(headersHandler?: () => {[header: string]: string}): Promise<API.Models.User> {
			return fetch(this.baseUri + 'api/v2/Users/Current', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Users_PutCurrentUser(requestBody: API.Models.User, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/Current', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissionsGetByPermissionAndLimitAndOffset(Permission: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/Current/Permissions?Permission=' + (Permission == null ? '' : encodeURIComponent(Permission)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissions_GetCurrentUserRoles(Role: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/Current/Roles?Role=' + (Role == null ? '' : encodeURIComponent(Role)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Users_Delete(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UsersGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<API.Models.User> {
			return fetch(this.baseUri + 'api/v2/Users/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Users_Put(id: number, requestBody: API.Models.User, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/' + id, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissionsGetByIdAndPermissionAndLimitAndOffset(id: number, Permission: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/' + id + '/Permissions?Permission=' + (Permission == null ? '' : encodeURIComponent(Permission)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissions_GetRoles(id: number, Role: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/' + id + '/Roles?Role=' + (Role == null ? '' : encodeURIComponent(Role)) + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UserPermissionsPutById(id: number, requestBody: Array<API.Models.UserRoleChange>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Users/' + id + '/Roles', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		VoucherHistory_GetVoucherHistory(VoucherCode: string, ChangedBefore: Date, ChangedAfter: Date, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/VoucherHistory?VoucherCode=' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&ChangedBefore=' + ChangedBefore.toISOString() + '&ChangedAfter=' + ChangedAfter.toISOString() + '&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Vouchers_Post(requestBody: DealerDB.Models.Voucher, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/v2/Vouchers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		Vouchers_Delete(VoucherCode: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VouchersGetByVoucherCodeAndDeleted(VoucherCode: string, Deleted: string, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.Voucher> {
			return fetch(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&Deleted=' + (Deleted == null ? '' : encodeURIComponent(Deleted)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Vouchers_Put(VoucherCode: string, requestBody: DealerDB.Models.Voucher, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Vouchers_GetVoucherHistory(VoucherCode: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '/VoucherHistory&limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Activities_GetActivities(limit: number, offset: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/activities?limit=' + limit + '&offset=' + offset + '&isIncludeDeleted=' + isIncludeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Activities_PostActivity(requestBody: BuildSystem.Shared.DTO.Activity, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/activities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Activities_DeleteActivity(activityID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/activities/' + activityID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Activities_GetActivity(activityID: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Activity> {
			return fetch(this.baseUri + 'api/v2/activities/' + activityID + '?isIncludeDeleted=' + isIncludeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Activities_PutActivity(activityID: number, requestBody: BuildSystem.Shared.DTO.Activity, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/activities/' + activityID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		ActivityRuns_GetActivityRuns(limit: number, offset: number, status: BuildSystem.Shared.DTO.ActivityRunStatusStatus, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/activityRuns?limit=' + limit + '&offset=' + offset + '&status=' + status, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ActivityRuns_GetActivityRun(activityRunID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRun> {
			return fetch(this.baseUri + 'api/v2/activityRuns/' + activityRunID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ActivityRuns_PutActivityRun(activityRunID: number, requestBody: BuildSystem.Shared.DTO.ActivityRun, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/activityRuns/' + activityRunID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ActivityRuns_GetActivityRunStatus(activityRunID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRunStatus> {
			return fetch(this.baseUri + 'api/v2/activityRuns/' + activityRunID + '/status', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ActivityRuns_PutActivityRunStatus(activityRunID: number, requestBody: BuildSystem.Shared.DTO.ActivityRunStatus, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/activityRuns/' + activityRunID + '/status', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Agents_GetAgents(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/agents?limit=' + limit + '&offset=' + offset, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Agents_PostAgent(requestBody: BuildSystem.Shared.DTO.Agent, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/agents', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Agents_GetCurrentAgent(headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Agent> {
			return fetch(this.baseUri + 'api/v2/agents/Current', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Agents_GetCurrentAgentActivityRun(headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRun> {
			return fetch(this.baseUri + 'api/v2/agents/Current/ActivityRun', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Agents_DeleteAgent(agentID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/agents/' + agentID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Agents_GetAgent(agentID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Agent> {
			return fetch(this.baseUri + 'api/v2/agents/' + agentID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Agents_PutAgent(agentID: number, requestBody: BuildSystem.Shared.DTO.Agent, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/agents/' + agentID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Agents_GetAgentActivityRun(agentID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRun> {
			return fetch(this.baseUri + 'api/v2/agents/' + agentID + '/ActivityRun', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Agents_PutAgentActivityRun(agentID: number, requestBody: BuildSystem.Shared.DTO.ActivityRun, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/agents/' + agentID + '/ActivityRun', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		Agents_PutAgentStatus(agentID: number, requestBody: BuildSystem.Shared.DTO.AgentStatus, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/agents/' + agentID + '/Status', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		JobRuns_GetJobRuns(limit: number, offset: number, includeActivityRunDetails: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/jobRuns?limit=' + limit + '&offset=' + offset + '&includeActivityRunDetails=' + includeActivityRunDetails, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		JobRuns_PostJobRun(requestBody: BuildSystem.Shared.DTO.JobRun, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/jobRuns', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		JobRuns_DeleteJobRun(jobRunID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/jobRuns/' + jobRunID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		JobRuns_GetJobRun(jobRunID: number, includeActivityRunDetails: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.JobRun> {
			return fetch(this.baseUri + 'api/v2/jobRuns/' + jobRunID + '?includeActivityRunDetails=' + includeActivityRunDetails, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		JobRuns_PutJobRun(jobRunID: number, requestBody: BuildSystem.Shared.DTO.JobRun, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/jobRuns/' + jobRunID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Jobs_GetJobs(limit: number, offset: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/jobs?limit=' + limit + '&offset=' + offset + '&isIncludeDeleted=' + isIncludeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Jobs_PostJob(requestBody: BuildSystem.Shared.DTO.Job, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/jobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Jobs_DeleteJob(jobID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/jobs/' + jobID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Jobs_GetJob(jobID: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Job> {
			return fetch(this.baseUri + 'api/v2/jobs/' + jobID + '?isIncludeDeleted=' + isIncludeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Jobs_PutJob(jobID: number, requestBody: BuildSystem.Shared.DTO.Job, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/jobs/' + jobID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {any} OK
		 */
		Steps_GetSteps(limit: number, offset: number, includeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/steps?limit=' + limit + '&offset=' + offset + '&includeDeleted=' + includeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Steps_PostStep(requestBody: BuildSystem.Shared.DTO.Step, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return fetch(this.baseUri + 'api/v2/steps', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Steps_GetStep(stepID: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Step> {
			return fetch(this.baseUri + 'api/v2/steps/' + stepID + '?isIncludeDeleted=' + isIncludeDeleted, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Steps_PutStep(stepID: number, requestBody: BuildSystem.Shared.DTO.Step, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/v2/steps/' + stepID, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
