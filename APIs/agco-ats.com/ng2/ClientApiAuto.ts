...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {any} OK
		 */
		AftermarketServices_GetCerts(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/AftermarketServices/Certificates', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		AftermarketServices_PutECU(serialNumber: string, EDTInstanceId: string, requestBody: AGCOPowerServices.Models.ECU, headersHandler?: () => HttpHeaders): Observable<AGCOPowerServices.Models.ECU> {
			return this.http.put<AGCOPowerServices.Models.ECU>(this.baseUri + 'api/v2/AftermarketServices/ECUs/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AftermarketServices_GetEngineIQACodes(serialNumber: string, EDTInstanceId: string, headersHandler?: () => HttpHeaders): Observable<Array<string>> {
			return this.http.get<Array<string>>(this.baseUri + 'api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/IQACodes&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {boolean} OK
		 */
		AftermarketServices_PutIQACodes(serialNumber: string, EDTInstanceId: string, requestBody: Array<string>, headersHandler?: () => HttpHeaders): Observable<boolean> {
			return this.http.put<boolean>(this.baseUri + 'api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/IQACodes&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AftermarketServices_GetProductionData(serialNumber: string, EDTInstanceId: string, headersHandler?: () => HttpHeaders): Observable<Array<AGCOPowerServices.Models.ProductionData>> {
			return this.http.get<Array<AGCOPowerServices.Models.ProductionData>>(this.baseUri + 'api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/ProductionData&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {boolean} OK
		 */
		AftermarketServices_GetConnectionStatus(headersHandler?: () => HttpHeaders): Observable<boolean> {
			return this.http.get<boolean>(this.baseUri + 'api/v2/AftermarketServices/Hello', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		AftermarketServices_GetUserStatus(voucherCode: string, dealerCode: string, headersHandler?: () => HttpHeaders): Observable<AGCOPowerServices.Models.UserStatus> {
			return this.http.get<AGCOPowerServices.Models.UserStatus>(this.baseUri + 'api/v2/AftermarketServices/UserStatuses?voucherCode=' + (voucherCode == null ? '' : encodeURIComponent(voucherCode)) + '&dealerCode=' + (dealerCode == null ? '' : encodeURIComponent(dealerCode)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {boolean} OK
		 */
		AftermarketServices_UpdateUserStatus(requestBody: AGCOPowerServices.Models.UserStatus, headersHandler?: () => HttpHeaders): Observable<boolean> {
			return this.http.put<boolean>(this.baseUri + 'api/v2/AftermarketServices/UserStatuses', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Authentication_PutManageTokens(UserID: number, requestBody: API.Models.TokenOptions, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/AuthenticatedUsers/' + UserID + '/Tokens', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Authentication_Default(requestBody: API.Models.Credentials, headersHandler?: () => HttpHeaders): Observable<API.Models.AuthenticatedUser> {
			return this.http.post<API.Models.AuthenticatedUser>(this.baseUri + 'api/v2/Authentication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Authentication_IsAlive(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Authentication/IsAlive', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Authentication_RequestPasswordReset(requestBody: API.Models.PasswordResetRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'api/v2/Authentication/RequestPasswordReset', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Authentication_ResetPasword(requestBody: API.Models.PasswordReset, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'api/v2/Authentication/ResetPasword', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		AuthorizationCodeDefinitionsGetByLimitAndOffsetAndNameAndCreatedByUserIDAndDeletedByUserIDAndIncludeDeleted(limit: number, offset: number, name: string, createdByUserID: number, deletedByUserID: number, includeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/AuthorizationCodeDefinitions?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&createdByUserID=' + createdByUserID + '&deletedByUserID=' + deletedByUserID + '&includeDeleted=' + includeDeleted, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		AuthorizationCodeDefinitions_PostAuthorizationCodeDefinition(requestBody: AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/AuthorizationCodeDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodeDefinitions_DeleteAuthorizationCodeDefinition(id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		AuthorizationCodeDefinitionsGetById(id: string, headersHandler?: () => HttpHeaders): Observable<AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition> {
			return this.http.get<AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition>(this.baseUri + 'api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodeDefinitions_PutAuthorizationCodeDefinition(id: string, requestBody: AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {any} OK
		 */
		AuthorizationCodes_GetAuthorizationCodes(code: string, limit: number, offset: number, definitionID: string, createdByUserID: number, deletedByUserID: number, includeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {number} OK
		 */
		AuthorizationCodes_PostAuthorizationCode(requestBody: AuthorizationCodes.Shared.Models.AuthorizationCode, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/AuthorizationCodes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodes_DeleteAuthorizationCode(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/AuthorizationCodes/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		AuthorizationCodes_GetAuthorizationCode(id: number, headersHandler?: () => HttpHeaders): Observable<AuthorizationCodes.Shared.Models.AuthorizationCode> {
			return this.http.get<AuthorizationCodes.Shared.Models.AuthorizationCode>(this.baseUri + 'api/v2/AuthorizationCodes/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		AuthorizationCodes_PutAuthorizationCode(id: number, requestBody: AuthorizationCodes.Shared.Models.AuthorizationCode, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/AuthorizationCodes/' + id, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {Array<string>} OK
		 */
		Brands_Brands(headersHandler?: () => HttpHeaders): Observable<Array<string>> {
			return this.http.get<Array<string>>(this.baseUri + 'api/v2/Brands', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Bundles_GetBundles(UpdateGroupID: string, Active: boolean, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Bundles?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&Active=' + Active + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		Bundles_PostBundle(requestBody: UpdateSystem.Models.Bundle, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/Bundles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Bundles_DeleteBundle(ID: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Bundles_GetBundle(ID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.Bundle> {
			return this.http.get<UpdateSystem.Models.Bundle>(this.baseUri + 'api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Bundles_PutBundle(ID: string, requestBody: UpdateSystem.Models.Bundle, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		ClientsGetByTagAndLimitAndOffset(Tag: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Clients?Tag=' + (Tag == null ? '' : encodeURIComponent(Tag)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {Array<string>} OK
		 */
		UpdateSystem_GetCachedFiles(ClientID: string, Expired: boolean, headersHandler?: () => HttpHeaders): Observable<Array<string>> {
			return this.http.get<Array<string>>(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/CachedFiles&Expired=' + Expired, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		PackageReportsGetByClientID(ClientID: string, headersHandler?: () => HttpHeaders): Observable<Array<UpdateSystem.Models.PackageReport>> {
			return this.http.get<Array<UpdateSystem.Models.PackageReport>>(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PackageReportsPutByClientID(ClientID: string, requestBody: UpdateSystem.Models.PackageReport, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PackageReports_Batch(ClientID: string, requestBody: Array<UpdateSystem.Models.PackageReport>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports/Batch', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ClientsGetByID(ID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.Client> {
			return this.http.get<UpdateSystem.Models.Client>(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Clients_Put(ID: string, requestBody: UpdateSystem.Models.Client, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Clients_GetAvailableSubscriptions(ID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)) + '/AvailableUpdateGroupSubscriptions&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Clients_GetSubscriptions(ID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)) + '/UpdateGroupSubscriptions&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		ContentDefinitions_GetContentDefinitions(limit: number, offset: number, userID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/ContentDefinitions?limit=' + limit + '&offset=' + offset + '&userID=' + userID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		ContentDefinitions_PostContentDefinition(requestBody: ContentSubmission.Shared.BusinessEntities.ContentDefinition, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/ContentDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		ContentDefinitions_DeleteContentDefinition(contentDefinitionID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/ContentDefinitions/' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ContentDefinitions_GetContentDefinition(contentDefinitionID: number, headersHandler?: () => HttpHeaders): Observable<ContentSubmission.Shared.BusinessEntities.ContentDefinition> {
			return this.http.get<ContentSubmission.Shared.BusinessEntities.ContentDefinition>(this.baseUri + 'api/v2/ContentDefinitions/' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		ContentDefinitions_PutContentDefinition(contentDefinitionID: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentDefinition, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/ContentDefinitions/' + contentDefinitionID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		ContentReleaseGetByLimitAndOffsetAndDeletedAndReleaseIDAndUserIdAndContentDefinitionIDAndVersion(limit: number, offset: number, deleted: boolean, releaseID: number, userId: number, contentDefinitionID: number, version: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/ContentReleases?limit=' + limit + '&offset=' + offset + '&deleted=' + deleted + '&releaseID=' + releaseID + '&userId=' + userId + '&contentDefinitionID=' + contentDefinitionID + '&version=' + version, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		ContentRelease_PostContentRelease(requestBody: ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/ContentReleases', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		ContentRelease_DeleteContentReleaseVersionn(ContentReleaseId: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/ContentReleases/' + ContentReleaseId, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ContentReleaseGetByContentReleaseId(ContentReleaseId: number, headersHandler?: () => HttpHeaders): Observable<ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion> {
			return this.http.get<ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion>(this.baseUri + 'api/v2/ContentReleases/' + ContentReleaseId, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		ContentRelease_PutContentDefinition(ContentReleaseId: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/ContentReleases/' + ContentReleaseId, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ContentSubmissionTypes_GetContentSubmissionTypes(enabled: boolean, headersHandler?: () => HttpHeaders): Observable<Array<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType>> {
			return this.http.get<Array<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType>>(this.baseUri + 'api/v2/ContentSubmissionTypes?enabled=' + enabled, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {number} OK
		 */
		ContentSubmissionTypes_PostContentSubmissionType(requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmissionType, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/ContentSubmissionTypes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissionTypes_DeleteContentSubmissionType(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/ContentSubmissionTypes/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ContentSubmissionTypes_GetContentSubmissionType(id: number, headersHandler?: () => HttpHeaders): Observable<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType> {
			return this.http.get<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType>(this.baseUri + 'api/v2/ContentSubmissionTypes/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissionTypes_PutContentSubmissionType(id: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmissionType, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/ContentSubmissionTypes/' + id, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		ContentSubmissions_GetContentSubmissions(limit: number, offset: number, userID: number, contentDefinitionID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/ContentSubmissions?limit=' + limit + '&offset=' + offset + '&userID=' + userID + '&contentDefinitionID=' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		ContentSubmissions_PostContentSubmission(requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmission, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/ContentSubmissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissions_DeleteContentSubmission(contentSubmissionID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/ContentSubmissions/' + contentSubmissionID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ContentSubmissions_GetContentSubmission(contentSubmissionID: number, headersHandler?: () => HttpHeaders): Observable<ContentSubmission.Shared.BusinessEntities.ContentSubmission> {
			return this.http.get<ContentSubmission.Shared.BusinessEntities.ContentSubmission>(this.baseUri + 'api/v2/ContentSubmissions/' + contentSubmissionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		ContentSubmissions_PutContentSubmission(contentSubmissionID: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmission, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/ContentSubmissions/' + contentSubmissionID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		DealerByCountry_GetCountries(limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/DealerByCountry?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Dealers_GetDealers(Brand: string, ShippingCountry: string, DealerName: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Dealers?Brand=' + (Brand == null ? '' : encodeURIComponent(Brand)) + '&ShippingCountry=' + (ShippingCountry == null ? '' : encodeURIComponent(ShippingCountry)) + '&DealerName=' + (DealerName == null ? '' : encodeURIComponent(DealerName)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Dealers_GetDealerbyDealerCode(DealerCode: string, headersHandler?: () => HttpHeaders): Observable<DealerDB.Models.Dealer> {
			return this.http.get<DealerDB.Models.Dealer>(this.baseUri + 'api/v2/Dealers/' + (DealerCode == null ? '' : encodeURIComponent(DealerCode)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		LicenseActivations_Post(requestBody: DealerDB.Models.LicenseActivationCreate, headersHandler?: () => HttpHeaders): Observable<DealerDB.Models.LicenseActivation> {
			return this.http.post<DealerDB.Models.LicenseActivation>(this.baseUri + 'api/v2/LicenseActivations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {boolean} OK
		 */
		LicenseActivations_PostRegisterEDTLite(requestBody: DealerDB.Models.EDTLiteRegistration, headersHandler?: () => HttpHeaders): Observable<boolean> {
			return this.http.post<boolean>(this.baseUri + 'api/v2/LicenseActivations/RegisterEDTLite', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {DealerDB.Models.LicenseActivation} OK
		 */
		LicenseActivations_Put(ID: string, requestBody: DealerDB.Models.LicenseActivationUpdate, headersHandler?: () => HttpHeaders): Observable<DealerDB.Models.LicenseActivation> {
			return this.http.put<DealerDB.Models.LicenseActivation>(this.baseUri + 'api/v2/LicenseActivations/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		LicenseActivations_PutConfirm(ID: string, requestBody: DealerDB.Models.LicenseActivationConfirm, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/LicenseActivations/' + (ID == null ? '' : encodeURIComponent(ID)) + '/Confirm', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		LicensesGetByVoucherCodeAndDealerCodeAndStatusAndLimitAndOffset(VoucherCode: string, DealerCode: string, Status: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Licenses?VoucherCode=' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&DealerCode=' + (DealerCode == null ? '' : encodeURIComponent(DealerCode)) + '&Status=' + (Status == null ? '' : encodeURIComponent(Status)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		LicensesGetByID(ID: string, headersHandler?: () => HttpHeaders): Observable<DealerDB.Models.License> {
			return this.http.get<DealerDB.Models.License>(this.baseUri + 'api/v2/Licenses/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Logs_GetLogs(limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Logs?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		Logs_PostLog(Message: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/Logs?Message=' + (Message == null ? '' : encodeURIComponent(Message)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Logs_GetLog(ID: string, headersHandler?: () => HttpHeaders): Observable<API.Models.Log> {
			return this.http.get<API.Models.Log>(this.baseUri + 'api/v2/Logs/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Notifications_PostMail(requestBody: API.Models.Notification, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'api/v2/Notifications', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		PackageTypesGetByLimitAndOffset(limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/PackageTypes?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		PackageTypes_Post(requestBody: UpdateSystem.Models.PackageType, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/PackageTypes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypes_Delete(ID: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PackageTypesGetByID(ID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.PackageType> {
			return this.http.get<UpdateSystem.Models.PackageType>(this.baseUri + 'api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypes_Put(ID: string, requestBody: UpdateSystem.Models.PackageType, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypetoBundles_Delete(BundleID: string, PackageTypeID: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/PackageTypetoBundles?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&PackageTypeID=' + (PackageTypeID == null ? '' : encodeURIComponent(PackageTypeID)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		PackageTypetoBundles_Get(BundleID: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/PackageTypetoBundles?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypetoBundles_Post(requestBody: UpdateSystem.Models.PackageTypeIDtoBundle, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'api/v2/PackageTypetoBundles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PackageTypetoBundles_Put(requestBody: UpdateSystem.Models.PackageTypeIDtoBundle, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/PackageTypetoBundles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Packages_GetPackages(limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Packages?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		Packages_PostPackage(requestBody: UpdateSystem.Models.Package, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/Packages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Packages_DeletePackage(ID: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Packages_GetPackage(ID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.Package> {
			return this.http.get<UpdateSystem.Models.Package>(this.baseUri + 'api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Packages_PutPackage(ID: string, requestBody: UpdateSystem.Models.Package, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Permissions_GetPermissions(limit: number, offset: number, name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Permissions?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		Permissions_PostPermission(requestBody: API.Models.Permission, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/Permissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Permissions_DeletePermission(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/Permissions/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Permissions_GetPermission(id: number, headersHandler?: () => HttpHeaders): Observable<API.Models.Permission> {
			return this.http.get<API.Models.Permission>(this.baseUri + 'api/v2/Permissions/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Permissions_PutPermission(id: number, requestBody: API.Models.Permission, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Permissions/' + id, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		PriorityPackages_GetPriorityPackages(ClientID: string, Status: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/PriorityPackages?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Status=' + (Status == null ? '' : encodeURIComponent(Status)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		PriorityPackages_PostPriorityPackages(requestBody: UpdateSystem.Models.PriorityPackage, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/PriorityPackages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PriorityPackages_DeletePriorityPackages(ID: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/PriorityPackages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PriorityPackages_GetPriorityPackage(ID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.PriorityPackage> {
			return this.http.get<UpdateSystem.Models.PriorityPackage>(this.baseUri + 'api/v2/PriorityPackages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Release_GetReleases(limit: number, offset: number, visible: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Releases?limit=' + limit + '&offset=' + offset + '&visible=' + visible, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		Release_PostRelease(requestBody: ContentSubmission.Shared.BusinessEntities.Release, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/Releases', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Release_GetRelease(ReleaseId: number, headersHandler?: () => HttpHeaders): Observable<ContentSubmission.Shared.BusinessEntities.Release> {
			return this.http.get<ContentSubmission.Shared.BusinessEntities.Release>(this.baseUri + 'api/v2/Releases/' + ReleaseId, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Release_PutContentDefinition(releaseId: number, requestBody: ContentSubmission.Shared.BusinessEntities.Release, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Releases/' + releaseId, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_BundleStatusSummary(BundleID: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Reporting/BundleStatusSummary?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_BundlesInUpdateGroup(ID: string, IncludeInactive: boolean, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Reporting/BundlesInUpdateGroup?ID=' + (ID == null ? '' : encodeURIComponent(ID)) + '&IncludeInactive=' + IncludeInactive + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Reporting_ClientInfo(ClientID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.ClientInfo> {
			return this.http.get<UpdateSystem.Models.ClientInfo>(this.baseUri + 'api/v2/Reporting/ClientInfo?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Reporting_CurrentPackagesInUpdateGroup(ID: string, SubscriptionTypeFilter: string, headersHandler?: () => HttpHeaders): Observable<Array<UpdateSystem.Models.Package>> {
			return this.http.get<Array<UpdateSystem.Models.Package>>(this.baseUri + 'api/v2/Reporting/CurrentPackagesInUpdateGroup?ID=' + (ID == null ? '' : encodeURIComponent(ID)) + '&SubscriptionTypeFilter=' + (SubscriptionTypeFilter == null ? '' : encodeURIComponent(SubscriptionTypeFilter)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {UpdateSystem.Models.Client} OK
		 */
		Reporting_GetClient(ID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.Client> {
			return this.http.get<UpdateSystem.Models.Client>(this.baseUri + 'api/v2/Reporting/GetClient?ID=' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_GetSubscriptions(ClientID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Reporting/GetSubscriptions?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Reporting_PackageStatusSummary(PackageID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.PackageStatusSummary> {
			return this.http.get<UpdateSystem.Models.PackageStatusSummary>(this.baseUri + 'api/v2/Reporting/PackageStatusSummary?PackageID=' + (PackageID == null ? '' : encodeURIComponent(PackageID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Reporting_RegisteredClients(UpdateGroupID: string, ClientID: string, Tag: string, ReportResult: string, ReportResultIsValid: boolean, ReportValue: string, LastCheckInBefore: Date, LastCheckInAfter: Date, OrderBy: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {any} OK
		 */
		Reporting_UpdateGroups(limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Reporting/UpdateGroups?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Reporting_UpdateMetrics(UpdateGroupID: string, bundleNumber: number, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.UpdateMetricsData> {
			return this.http.get<UpdateSystem.Models.UpdateMetricsData>(this.baseUri + 'api/v2/Reporting/UpdateMetrics?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&bundleNumber=' + bundleNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		Roles_GetRoles(limit: number, offset: number, name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Roles?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		Roles_PostRole(requestBody: API.Models.Role, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/Roles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Roles_DeleteRole(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/Roles/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Roles_GetRole(id: number, headersHandler?: () => HttpHeaders): Observable<API.Models.Role> {
			return this.http.get<API.Models.Role>(this.baseUri + 'api/v2/Roles/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Roles_PutRole(id: number, requestBody: API.Models.Role, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Roles/' + id, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Roles_GetRolePermissions(id: number, name: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Roles/' + id + '/Permissions?name=' + (name == null ? '' : encodeURIComponent(name)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Roles_PutRolePermissions(id: number, requestBody: Array<API.Models.RolePermissionChange>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Roles/' + id + '/Permissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissions_GetUsers(id: number, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Roles/' + id + '/Users?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UserPermissionsPutById(id: number, requestBody: Array<API.Models.RoleUserChange>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Roles/' + id + '/Users', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UpdateGroupClientRelationships_GetSubscriptions(ClientID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/UpdateGroupClientRelationships?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		UpdateGroupClientRelationships_PostSubscription(requestBody: UpdateSystem.Models.UpdateGroupClientRelationship, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/UpdateGroupClientRelationships', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupClientRelationships_PutSubscriptionByClientIDUpdateGroupID(ClientID: string, UpdateGroupID: string, Active: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/UpdateGroupClientRelationships?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&Active=' + Active, null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateGroupClientRelationships_GetSubscription(RelationshipID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.UpdateGroupClientRelationship> {
			return this.http.get<UpdateSystem.Models.UpdateGroupClientRelationship>(this.baseUri + 'api/v2/UpdateGroupClientRelationships/' + (RelationshipID == null ? '' : encodeURIComponent(RelationshipID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupClientRelationships_PutSubscription(RelationshipID: string, requestBody: UpdateSystem.Models.UpdateGroupClientRelationship, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/UpdateGroupClientRelationships/' + (RelationshipID == null ? '' : encodeURIComponent(RelationshipID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UpdateGroupSubscriptions_GetUpdateGroupSubscriptions(UpdateGroupID: string, PackageTypeID: string, ClientID: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {number} OK
		 */
		UpdateGroupSubscriptions_PostUpdateGroupSubscription(requestBody: UpdateSystem.Models.UpdateGroupSubscription, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/UpdateGroupSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupSubscriptions_DeleteUpdateGroupSubscription(UpdateGroupSubscriptionID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateGroupSubscriptions_GetUpdateGroupSubscription(UpdateGroupSubscriptionID: number, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.UpdateGroupSubscription> {
			return this.http.get<UpdateSystem.Models.UpdateGroupSubscription>(this.baseUri + 'api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroupSubscriptions_PutUpdateGroupSubscription(UpdateGroupSubscriptionID: number, requestBody: UpdateSystem.Models.UpdateGroupSubscription, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {any} OK
		 */
		UpdateGroupsGetByLimitAndOffset(limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/UpdateGroups?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		UpdateGroups_Post(requestBody: UpdateSystem.Models.UpdateGroup, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/UpdateGroups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroups_Delete(ID: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateGroupsGetByID(ID: string, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.UpdateGroup> {
			return this.http.get<UpdateSystem.Models.UpdateGroup>(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateGroups_Put(ID: string, requestBody: UpdateSystem.Models.UpdateGroup, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UpdateGroups_GetUpdateGroupBundles(ID: string, IncludeInactive: boolean, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)) + '/Bundles&IncludeInactive=' + IncludeInactive + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateSystem_GetCheckin(ClientID: string, Preview: boolean, headersHandler?: () => HttpHeaders): Observable<UpdateSystem.Models.CheckinResult> {
			return this.http.get<UpdateSystem.Models.CheckinResult>(this.baseUri + 'api/v2/UpdateSystem?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Preview=' + Preview, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		UserContentDefinitions_GetUserContentDefinitions(limit: number, offset: number, userID: number, contentDefinitionID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/UserContentDefinitions?limit=' + limit + '&offset=' + offset + '&userID=' + userID + '&contentDefinitionID=' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		UserContentDefinitions_PostUserContentDefinition(requestBody: ContentSubmission.Shared.BusinessEntities.UserContentDefinition, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/UserContentDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		UserContentDefinitions_DeleteUserContentDefinition(userContentDefinitionID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/UserContentDefinitions/' + userContentDefinitionID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UserContentDefinitions_GetUserContentDefinition(userContentDefinitionID: number, headersHandler?: () => HttpHeaders): Observable<ContentSubmission.Shared.BusinessEntities.UserContentDefinition> {
			return this.http.get<ContentSubmission.Shared.BusinessEntities.UserContentDefinition>(this.baseUri + 'api/v2/UserContentDefinitions/' + userContentDefinitionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {any} OK
		 */
		UsersGetByUsernameAndEmailAndNameAndLimitAndOffset(username: string, email: string, name: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Users?username=' + (username == null ? '' : encodeURIComponent(username)) + '&email=' + (email == null ? '' : encodeURIComponent(email)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Users_Post(requestBody: API.Models.User, headersHandler?: () => HttpHeaders): Observable<API.Models.User> {
			return this.http.post<API.Models.User>(this.baseUri + 'api/v2/Users', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {API.Models.User} OK
		 */
		Users_GetCurrentUser(headersHandler?: () => HttpHeaders): Observable<API.Models.User> {
			return this.http.get<API.Models.User>(this.baseUri + 'api/v2/Users/Current', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Users_PutCurrentUser(requestBody: API.Models.User, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Users/Current', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissionsGetByPermissionAndLimitAndOffset(Permission: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Users/Current/Permissions?Permission=' + (Permission == null ? '' : encodeURIComponent(Permission)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissions_GetCurrentUserRoles(Role: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Users/Current/Roles?Role=' + (Role == null ? '' : encodeURIComponent(Role)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Users_Delete(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/Users/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {API.Models.User} OK
		 */
		UsersGetById(id: number, headersHandler?: () => HttpHeaders): Observable<API.Models.User> {
			return this.http.get<API.Models.User>(this.baseUri + 'api/v2/Users/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Users_Put(id: number, requestBody: API.Models.User, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Users/' + id, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissionsGetByIdAndPermissionAndLimitAndOffset(id: number, Permission: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Users/' + id + '/Permissions?Permission=' + (Permission == null ? '' : encodeURIComponent(Permission)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		UserPermissions_GetRoles(id: number, Role: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Users/' + id + '/Roles?Role=' + (Role == null ? '' : encodeURIComponent(Role)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UserPermissionsPutById(id: number, requestBody: Array<API.Models.UserRoleChange>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Users/' + id + '/Roles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		VoucherHistory_GetVoucherHistory(VoucherCode: string, ChangedBefore: Date, ChangedAfter: Date, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/VoucherHistory?VoucherCode=' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&ChangedBefore=' + ChangedBefore.toISOString() + '&ChangedAfter=' + ChangedAfter.toISOString() + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} OK
		 */
		Vouchers_Post(requestBody: DealerDB.Models.Voucher, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/v2/Vouchers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Vouchers_Delete(VoucherCode: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		VouchersGetByVoucherCodeAndDeleted(VoucherCode: string, Deleted: string, headersHandler?: () => HttpHeaders): Observable<DealerDB.Models.Voucher> {
			return this.http.get<DealerDB.Models.Voucher>(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&Deleted=' + (Deleted == null ? '' : encodeURIComponent(Deleted)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Vouchers_Put(VoucherCode: string, requestBody: DealerDB.Models.Voucher, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Vouchers_GetVoucherHistory(VoucherCode: string, limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '/VoucherHistory&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Activities_GetActivities(limit: number, offset: number, isIncludeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/activities?limit=' + limit + '&offset=' + offset + '&isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		Activities_PostActivity(requestBody: BuildSystem.Shared.DTO.Activity, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/activities', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Activities_DeleteActivity(activityID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/activities/' + activityID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Activities_GetActivity(activityID: number, isIncludeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.Activity> {
			return this.http.get<BuildSystem.Shared.DTO.Activity>(this.baseUri + 'api/v2/activities/' + activityID + '?isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Activities_PutActivity(activityID: number, requestBody: BuildSystem.Shared.DTO.Activity, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/activities/' + activityID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		ActivityRuns_GetActivityRuns(limit: number, offset: number, status: BuildSystem.Shared.DTO.ActivityRunStatusStatus, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/activityRuns?limit=' + limit + '&offset=' + offset + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ActivityRuns_GetActivityRun(activityRunID: number, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.ActivityRun> {
			return this.http.get<BuildSystem.Shared.DTO.ActivityRun>(this.baseUri + 'api/v2/activityRuns/' + activityRunID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		ActivityRuns_PutActivityRun(activityRunID: number, requestBody: BuildSystem.Shared.DTO.ActivityRun, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/activityRuns/' + activityRunID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ActivityRuns_GetActivityRunStatus(activityRunID: number, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.ActivityRunStatus> {
			return this.http.get<BuildSystem.Shared.DTO.ActivityRunStatus>(this.baseUri + 'api/v2/activityRuns/' + activityRunID + '/status', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		ActivityRuns_PutActivityRunStatus(activityRunID: number, requestBody: BuildSystem.Shared.DTO.ActivityRunStatus, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/activityRuns/' + activityRunID + '/status', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Agents_GetAgents(limit: number, offset: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/agents?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		Agents_PostAgent(requestBody: BuildSystem.Shared.DTO.Agent, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/agents', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Agents_GetCurrentAgent(headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.Agent> {
			return this.http.get<BuildSystem.Shared.DTO.Agent>(this.baseUri + 'api/v2/agents/Current', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {BuildSystem.Shared.DTO.ActivityRun} OK
		 */
		Agents_GetCurrentAgentActivityRun(headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.ActivityRun> {
			return this.http.get<BuildSystem.Shared.DTO.ActivityRun>(this.baseUri + 'api/v2/agents/Current/ActivityRun', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Agents_DeleteAgent(agentID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/agents/' + agentID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {BuildSystem.Shared.DTO.Agent} OK
		 */
		Agents_GetAgent(agentID: number, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.Agent> {
			return this.http.get<BuildSystem.Shared.DTO.Agent>(this.baseUri + 'api/v2/agents/' + agentID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Agents_PutAgent(agentID: number, requestBody: BuildSystem.Shared.DTO.Agent, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/agents/' + agentID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {BuildSystem.Shared.DTO.ActivityRun} OK
		 */
		Agents_GetAgentActivityRun(agentID: number, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.ActivityRun> {
			return this.http.get<BuildSystem.Shared.DTO.ActivityRun>(this.baseUri + 'api/v2/agents/' + agentID + '/ActivityRun', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Agents_PutAgentActivityRun(agentID: number, requestBody: BuildSystem.Shared.DTO.ActivityRun, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/agents/' + agentID + '/ActivityRun', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Agents_PutAgentStatus(agentID: number, requestBody: BuildSystem.Shared.DTO.AgentStatus, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/agents/' + agentID + '/Status', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		JobRuns_GetJobRuns(limit: number, offset: number, includeActivityRunDetails: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/jobRuns?limit=' + limit + '&offset=' + offset + '&includeActivityRunDetails=' + includeActivityRunDetails, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		JobRuns_PostJobRun(requestBody: BuildSystem.Shared.DTO.JobRun, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/jobRuns', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		JobRuns_DeleteJobRun(jobRunID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/jobRuns/' + jobRunID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		JobRuns_GetJobRun(jobRunID: number, includeActivityRunDetails: boolean, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.JobRun> {
			return this.http.get<BuildSystem.Shared.DTO.JobRun>(this.baseUri + 'api/v2/jobRuns/' + jobRunID + '?includeActivityRunDetails=' + includeActivityRunDetails, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		JobRuns_PutJobRun(jobRunID: number, requestBody: BuildSystem.Shared.DTO.JobRun, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/jobRuns/' + jobRunID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Jobs_GetJobs(limit: number, offset: number, isIncludeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/jobs?limit=' + limit + '&offset=' + offset + '&isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		Jobs_PostJob(requestBody: BuildSystem.Shared.DTO.Job, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/jobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Jobs_DeleteJob(jobID: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'api/v2/jobs/' + jobID, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Jobs_GetJob(jobID: number, isIncludeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.Job> {
			return this.http.get<BuildSystem.Shared.DTO.Job>(this.baseUri + 'api/v2/jobs/' + jobID + '?isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Jobs_PutJob(jobID: number, requestBody: BuildSystem.Shared.DTO.Job, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/jobs/' + jobID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {any} OK
		 */
		Steps_GetSteps(limit: number, offset: number, includeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/v2/steps?limit=' + limit + '&offset=' + offset + '&includeDeleted=' + includeDeleted, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {number} OK
		 */
		Steps_PostStep(requestBody: BuildSystem.Shared.DTO.Step, headersHandler?: () => HttpHeaders): Observable<number> {
			return this.http.post<number>(this.baseUri + 'api/v2/steps', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Steps_GetStep(stepID: number, isIncludeDeleted: boolean, headersHandler?: () => HttpHeaders): Observable<BuildSystem.Shared.DTO.Step> {
			return this.http.get<BuildSystem.Shared.DTO.Step>(this.baseUri + 'api/v2/steps/' + stepID + '?isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Steps_PutStep(stepID: number, requestBody: BuildSystem.Shared.DTO.Step, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'api/v2/steps/' + stepID, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
