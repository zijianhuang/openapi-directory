...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AftermarketServices_GetCerts(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/AftermarketServices/Certificates', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AftermarketServices_GetEngineIQACodes(serialNumber: string, EDTInstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/IQACodes&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_GetProductionData(serialNumber: string, EDTInstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AGCOPowerServices.Models.ProductionData>> {
			return this.http.get('api/v2/AftermarketServices/Engines/' + (serialNumber == null ? '' : encodeURIComponent(serialNumber)) + '/ProductionData&EDTInstanceId=' + (EDTInstanceId == null ? '' : encodeURIComponent(EDTInstanceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_GetConnectionStatus(headersHandler?: () => {[header: string]: string}): Promise<boolean> {
			return this.http.get('api/v2/AftermarketServices/Hello', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_GetUserStatus(voucherCode: string, dealerCode: string, headersHandler?: () => {[header: string]: string}): Promise<AGCOPowerServices.Models.UserStatus> {
			return this.http.get('api/v2/AftermarketServices/UserStatuses?voucherCode=' + (voucherCode == null ? '' : encodeURIComponent(voucherCode)) + '&dealerCode=' + (dealerCode == null ? '' : encodeURIComponent(dealerCode)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AftermarketServices_UpdateUserStatus(requestBody: AGCOPowerServices.Models.UserStatus, headersHandler?: () => {[header: string]: string}): Promise<boolean> {
			return this.http.put('api/v2/AftermarketServices/UserStatuses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Authentication_PutManageTokens(UserID: number, requestBody: API.Models.TokenOptions, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/AuthenticatedUsers/' + UserID + '/Tokens', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Authentication_Default(requestBody: API.Models.Credentials, headersHandler?: () => {[header: string]: string}): Promise<API.Models.AuthenticatedUser> {
			return this.http.post('api/v2/Authentication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Authentication_IsAlive(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Authentication/IsAlive', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Authentication_RequestPasswordReset(requestBody: API.Models.PasswordResetRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('api/v2/Authentication/RequestPasswordReset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Authentication_ResetPasword(requestBody: API.Models.PasswordReset, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('api/v2/Authentication/ResetPasword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		AuthorizationCodeDefinitionsGetByLimitAndOffsetAndNameAndCreatedByUserIDAndDeletedByUserIDAndIncludeDeleted(limit: number, offset: number, name: string, createdByUserID: number, deletedByUserID: number, includeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/AuthorizationCodeDefinitions?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&createdByUserID=' + createdByUserID + '&deletedByUserID=' + deletedByUserID + '&includeDeleted=' + includeDeleted, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuthorizationCodeDefinitions_PostAuthorizationCodeDefinition(requestBody: AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/AuthorizationCodeDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		AuthorizationCodeDefinitions_DeleteAuthorizationCodeDefinition(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuthorizationCodeDefinitionsGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition> {
			return this.http.get('api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AuthorizationCodeDefinitions_PutAuthorizationCodeDefinition(id: string, requestBody: AuthorizationCodes.Shared.Models.AuthorizationCodeDefinition, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/AuthorizationCodeDefinitions/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		AuthorizationCodes_PostAuthorizationCode(requestBody: AuthorizationCodes.Shared.Models.AuthorizationCode, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/AuthorizationCodes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AuthorizationCodes_DeleteAuthorizationCode(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/AuthorizationCodes/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AuthorizationCodes_GetAuthorizationCode(id: number, headersHandler?: () => {[header: string]: string}): Promise<AuthorizationCodes.Shared.Models.AuthorizationCode> {
			return this.http.get('api/v2/AuthorizationCodes/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AuthorizationCodes_PutAuthorizationCode(id: number, requestBody: AuthorizationCodes.Shared.Models.AuthorizationCode, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/AuthorizationCodes/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Brands_Brands(headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('api/v2/Brands', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Bundles_GetBundles(UpdateGroupID: string, Active: boolean, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Bundles?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&Active=' + Active + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Bundles_PostBundle(requestBody: UpdateSystem.Models.Bundle, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/Bundles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		Bundles_DeleteBundle(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Bundles_GetBundle(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Bundle> {
			return this.http.get('api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Bundles_PutBundle(ID: string, requestBody: UpdateSystem.Models.Bundle, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Bundles/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ClientsGetByTagAndLimitAndOffset(Tag: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Clients?Tag=' + (Tag == null ? '' : encodeURIComponent(Tag)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateSystem_GetCachedFiles(ClientID: string, Expired: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/CachedFiles&Expired=' + Expired, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PackageReportsGetByClientID(ClientID: string, headersHandler?: () => {[header: string]: string}): Promise<Array<UpdateSystem.Models.PackageReport>> {
			return this.http.get('api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PackageReportsPutByClientID(ClientID: string, requestBody: UpdateSystem.Models.PackageReport, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PackageReports_Batch(ClientID: string, requestBody: Array<UpdateSystem.Models.PackageReport>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Clients/' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '/PackageReports/Batch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ClientsGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Client> {
			return this.http.get('api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Clients_Put(ID: string, requestBody: UpdateSystem.Models.Client, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Clients_GetAvailableSubscriptions(ID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)) + '/AvailableUpdateGroupSubscriptions&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Clients_GetSubscriptions(ID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Clients/' + (ID == null ? '' : encodeURIComponent(ID)) + '/UpdateGroupSubscriptions&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentDefinitions_GetContentDefinitions(limit: number, offset: number, userID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/ContentDefinitions?limit=' + limit + '&offset=' + offset + '&userID=' + userID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentDefinitions_PostContentDefinition(requestBody: ContentSubmission.Shared.BusinessEntities.ContentDefinition, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/ContentDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ContentDefinitions_DeleteContentDefinition(contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/ContentDefinitions/' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentDefinitions_GetContentDefinition(contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentDefinition> {
			return this.http.get('api/v2/ContentDefinitions/' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ContentDefinitions_PutContentDefinition(contentDefinitionID: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentDefinition, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/ContentDefinitions/' + contentDefinitionID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ContentReleaseGetByLimitAndOffsetAndDeletedAndReleaseIDAndUserIdAndContentDefinitionIDAndVersion(limit: number, offset: number, deleted: boolean, releaseID: number, userId: number, contentDefinitionID: number, version: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/ContentReleases?limit=' + limit + '&offset=' + offset + '&deleted=' + deleted + '&releaseID=' + releaseID + '&userId=' + userId + '&contentDefinitionID=' + contentDefinitionID + '&version=' + version, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentRelease_PostContentRelease(requestBody: ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/ContentReleases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ContentRelease_DeleteContentReleaseVersionn(ContentReleaseId: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/ContentReleases/' + ContentReleaseId, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentReleaseGetByContentReleaseId(ContentReleaseId: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion> {
			return this.http.get('api/v2/ContentReleases/' + ContentReleaseId, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ContentRelease_PutContentDefinition(ContentReleaseId: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentReleaseVersion, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/ContentReleases/' + ContentReleaseId, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ContentSubmissionTypes_GetContentSubmissionTypes(enabled: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType>> {
			return this.http.get('api/v2/ContentSubmissionTypes?enabled=' + enabled, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ContentSubmissionTypes_PostContentSubmissionType(requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmissionType, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/ContentSubmissionTypes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ContentSubmissionTypes_DeleteContentSubmissionType(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/ContentSubmissionTypes/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentSubmissionTypes_GetContentSubmissionType(id: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentSubmissionType> {
			return this.http.get('api/v2/ContentSubmissionTypes/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ContentSubmissionTypes_PutContentSubmissionType(id: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmissionType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/ContentSubmissionTypes/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ContentSubmissions_GetContentSubmissions(limit: number, offset: number, userID: number, contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/ContentSubmissions?limit=' + limit + '&offset=' + offset + '&userID=' + userID + '&contentDefinitionID=' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentSubmissions_PostContentSubmission(requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmission, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/ContentSubmissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ContentSubmissions_DeleteContentSubmission(contentSubmissionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/ContentSubmissions/' + contentSubmissionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ContentSubmissions_GetContentSubmission(contentSubmissionID: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.ContentSubmission> {
			return this.http.get('api/v2/ContentSubmissions/' + contentSubmissionID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ContentSubmissions_PutContentSubmission(contentSubmissionID: number, requestBody: ContentSubmission.Shared.BusinessEntities.ContentSubmission, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/ContentSubmissions/' + contentSubmissionID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DealerByCountry_GetCountries(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/DealerByCountry?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Dealers_GetDealers(Brand: string, ShippingCountry: string, DealerName: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Dealers?Brand=' + (Brand == null ? '' : encodeURIComponent(Brand)) + '&ShippingCountry=' + (ShippingCountry == null ? '' : encodeURIComponent(ShippingCountry)) + '&DealerName=' + (DealerName == null ? '' : encodeURIComponent(DealerName)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Dealers_GetDealerbyDealerCode(DealerCode: string, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.Dealer> {
			return this.http.get('api/v2/Dealers/' + (DealerCode == null ? '' : encodeURIComponent(DealerCode)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		LicenseActivations_Post(requestBody: DealerDB.Models.LicenseActivationCreate, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.LicenseActivation> {
			return this.http.post('api/v2/LicenseActivations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		LicenseActivations_PostRegisterEDTLite(requestBody: DealerDB.Models.EDTLiteRegistration, headersHandler?: () => {[header: string]: string}): Promise<boolean> {
			return this.http.post('api/v2/LicenseActivations/RegisterEDTLite', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		LicenseActivations_Put(ID: string, requestBody: DealerDB.Models.LicenseActivationUpdate, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.LicenseActivation> {
			return this.http.put('api/v2/LicenseActivations/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		LicenseActivations_PutConfirm(ID: string, requestBody: DealerDB.Models.LicenseActivationConfirm, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/LicenseActivations/' + (ID == null ? '' : encodeURIComponent(ID)) + '/Confirm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		LicensesGetByVoucherCodeAndDealerCodeAndStatusAndLimitAndOffset(VoucherCode: string, DealerCode: string, Status: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Licenses?VoucherCode=' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&DealerCode=' + (DealerCode == null ? '' : encodeURIComponent(DealerCode)) + '&Status=' + (Status == null ? '' : encodeURIComponent(Status)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		LicensesGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.License> {
			return this.http.get('api/v2/Licenses/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Logs_GetLogs(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Logs?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Logs_PostLog(Message: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/Logs?Message=' + (Message == null ? '' : encodeURIComponent(Message)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Logs_GetLog(ID: string, headersHandler?: () => {[header: string]: string}): Promise<API.Models.Log> {
			return this.http.get('api/v2/Logs/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Notifications_PostMail(requestBody: API.Models.Notification, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('api/v2/Notifications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PackageTypesGetByLimitAndOffset(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/PackageTypes?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PackageTypes_Post(requestBody: UpdateSystem.Models.PackageType, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/PackageTypes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		PackageTypes_Delete(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PackageTypesGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.PackageType> {
			return this.http.get('api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PackageTypes_Put(ID: string, requestBody: UpdateSystem.Models.PackageType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/PackageTypes/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PackageTypetoBundles_Delete(BundleID: string, PackageTypeID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/PackageTypetoBundles?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&PackageTypeID=' + (PackageTypeID == null ? '' : encodeURIComponent(PackageTypeID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PackageTypetoBundles_Get(BundleID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/PackageTypetoBundles?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PackageTypetoBundles_Post(requestBody: UpdateSystem.Models.PackageTypeIDtoBundle, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('api/v2/PackageTypetoBundles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PackageTypetoBundles_Put(requestBody: UpdateSystem.Models.PackageTypeIDtoBundle, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/PackageTypetoBundles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Packages_GetPackages(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Packages?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Packages_PostPackage(requestBody: UpdateSystem.Models.Package, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/Packages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		Packages_DeletePackage(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Packages_GetPackage(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Package> {
			return this.http.get('api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Packages_PutPackage(ID: string, requestBody: UpdateSystem.Models.Package, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Packages/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Permissions_GetPermissions(limit: number, offset: number, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Permissions?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Permissions_PostPermission(requestBody: API.Models.Permission, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/Permissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Permissions_DeletePermission(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/Permissions/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Permissions_GetPermission(id: number, headersHandler?: () => {[header: string]: string}): Promise<API.Models.Permission> {
			return this.http.get('api/v2/Permissions/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Permissions_PutPermission(id: number, requestBody: API.Models.Permission, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Permissions/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PriorityPackages_GetPriorityPackages(ClientID: string, Status: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/PriorityPackages?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Status=' + (Status == null ? '' : encodeURIComponent(Status)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PriorityPackages_PostPriorityPackages(requestBody: UpdateSystem.Models.PriorityPackage, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/PriorityPackages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		PriorityPackages_DeletePriorityPackages(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/PriorityPackages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PriorityPackages_GetPriorityPackage(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.PriorityPackage> {
			return this.http.get('api/v2/PriorityPackages/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Release_GetReleases(limit: number, offset: number, visible: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Releases?limit=' + limit + '&offset=' + offset + '&visible=' + visible, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Release_PostRelease(requestBody: ContentSubmission.Shared.BusinessEntities.Release, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/Releases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Release_GetRelease(ReleaseId: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.Release> {
			return this.http.get('api/v2/Releases/' + ReleaseId, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Release_PutContentDefinition(releaseId: number, requestBody: ContentSubmission.Shared.BusinessEntities.Release, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Releases/' + releaseId, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Reporting_BundleStatusSummary(BundleID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Reporting/BundleStatusSummary?BundleID=' + (BundleID == null ? '' : encodeURIComponent(BundleID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_BundlesInUpdateGroup(ID: string, IncludeInactive: boolean, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Reporting/BundlesInUpdateGroup?ID=' + (ID == null ? '' : encodeURIComponent(ID)) + '&IncludeInactive=' + IncludeInactive + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_ClientInfo(ClientID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.ClientInfo> {
			return this.http.get('api/v2/Reporting/ClientInfo?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Reporting_CurrentPackagesInUpdateGroup(ID: string, SubscriptionTypeFilter: string, headersHandler?: () => {[header: string]: string}): Promise<Array<UpdateSystem.Models.Package>> {
			return this.http.get('api/v2/Reporting/CurrentPackagesInUpdateGroup?ID=' + (ID == null ? '' : encodeURIComponent(ID)) + '&SubscriptionTypeFilter=' + (SubscriptionTypeFilter == null ? '' : encodeURIComponent(SubscriptionTypeFilter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Reporting_GetClient(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.Client> {
			return this.http.get('api/v2/Reporting/GetClient?ID=' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Reporting_GetSubscriptions(ClientID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Reporting/GetSubscriptions?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_PackageStatusSummary(PackageID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.PackageStatusSummary> {
			return this.http.get('api/v2/Reporting/PackageStatusSummary?PackageID=' + (PackageID == null ? '' : encodeURIComponent(PackageID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Reporting_RegisteredClients(UpdateGroupID: string, ClientID: string, Tag: string, ReportResult: string, ReportResultIsValid: boolean, ReportValue: string, LastCheckInBefore: Date, LastCheckInAfter: Date, OrderBy: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Reporting/RegisteredClients?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Tag=' + (Tag == null ? '' : encodeURIComponent(Tag)) + '&ReportResult=' + (ReportResult == null ? '' : encodeURIComponent(ReportResult)) + '&ReportResultIsValid=' + ReportResultIsValid + '&ReportValue=' + (ReportValue == null ? '' : encodeURIComponent(ReportValue)) + '&LastCheckInBefore=' + LastCheckInBefore.toISOString() + '&LastCheckInAfter=' + LastCheckInAfter.toISOString() + '&OrderBy=' + (OrderBy == null ? '' : encodeURIComponent(OrderBy)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_UpdateGroups(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Reporting/UpdateGroups?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Reporting_UpdateMetrics(UpdateGroupID: string, bundleNumber: number, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateMetricsData> {
			return this.http.get('api/v2/Reporting/UpdateMetrics?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&bundleNumber=' + bundleNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Roles_GetRoles(limit: number, offset: number, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Roles?limit=' + limit + '&offset=' + offset + '&name=' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Roles_PostRole(requestBody: API.Models.Role, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/Roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Roles_DeleteRole(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/Roles/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Roles_GetRole(id: number, headersHandler?: () => {[header: string]: string}): Promise<API.Models.Role> {
			return this.http.get('api/v2/Roles/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Roles_PutRole(id: number, requestBody: API.Models.Role, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Roles/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Roles_GetRolePermissions(id: number, name: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Roles/' + id + '/Permissions?name=' + (name == null ? '' : encodeURIComponent(name)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Roles_PutRolePermissions(id: number, requestBody: Array<API.Models.RolePermissionChange>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Roles/' + id + '/Permissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UserPermissions_GetUsers(id: number, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Roles/' + id + '/Users?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPermissionsPutById(id: number, requestBody: Array<API.Models.RoleUserChange>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Roles/' + id + '/Users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateGroupClientRelationships_GetSubscriptions(ClientID: string, UpdateGroupID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/UpdateGroupClientRelationships?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupClientRelationships_PostSubscription(requestBody: UpdateSystem.Models.UpdateGroupClientRelationship, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/UpdateGroupClientRelationships', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		UpdateGroupClientRelationships_PutSubscriptionByClientIDUpdateGroupID(ClientID: string, UpdateGroupID: string, Active: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/UpdateGroupClientRelationships?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&Active=' + Active, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupClientRelationships_GetSubscription(RelationshipID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateGroupClientRelationship> {
			return this.http.get('api/v2/UpdateGroupClientRelationships/' + (RelationshipID == null ? '' : encodeURIComponent(RelationshipID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGroupClientRelationships_PutSubscription(RelationshipID: string, requestBody: UpdateSystem.Models.UpdateGroupClientRelationship, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/UpdateGroupClientRelationships/' + (RelationshipID == null ? '' : encodeURIComponent(RelationshipID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateGroupSubscriptions_GetUpdateGroupSubscriptions(UpdateGroupID: string, PackageTypeID: string, ClientID: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/UpdateGroupSubscriptions?UpdateGroupID=' + (UpdateGroupID == null ? '' : encodeURIComponent(UpdateGroupID)) + '&PackageTypeID=' + (PackageTypeID == null ? '' : encodeURIComponent(PackageTypeID)) + '&ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupSubscriptions_PostUpdateGroupSubscription(requestBody: UpdateSystem.Models.UpdateGroupSubscription, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/UpdateGroupSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateGroupSubscriptions_DeleteUpdateGroupSubscription(UpdateGroupSubscriptionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupSubscriptions_GetUpdateGroupSubscription(UpdateGroupSubscriptionID: number, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateGroupSubscription> {
			return this.http.get('api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGroupSubscriptions_PutUpdateGroupSubscription(UpdateGroupSubscriptionID: number, requestBody: UpdateSystem.Models.UpdateGroupSubscription, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/UpdateGroupSubscriptions/' + UpdateGroupSubscriptionID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateGroupsGetByLimitAndOffset(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/UpdateGroups?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroups_Post(requestBody: UpdateSystem.Models.UpdateGroup, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/UpdateGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		UpdateGroups_Delete(ID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateGroupsGetByID(ID: string, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.UpdateGroup> {
			return this.http.get('api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGroups_Put(ID: string, requestBody: UpdateSystem.Models.UpdateGroup, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateGroups_GetUpdateGroupBundles(ID: string, IncludeInactive: boolean, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/UpdateGroups/' + (ID == null ? '' : encodeURIComponent(ID)) + '/Bundles&IncludeInactive=' + IncludeInactive + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateSystem_GetCheckin(ClientID: string, Preview: boolean, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystem.Models.CheckinResult> {
			return this.http.get('api/v2/UpdateSystem?ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Preview=' + Preview, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UserContentDefinitions_GetUserContentDefinitions(limit: number, offset: number, userID: number, contentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/UserContentDefinitions?limit=' + limit + '&offset=' + offset + '&userID=' + userID + '&contentDefinitionID=' + contentDefinitionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserContentDefinitions_PostUserContentDefinition(requestBody: ContentSubmission.Shared.BusinessEntities.UserContentDefinition, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/UserContentDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UserContentDefinitions_DeleteUserContentDefinition(userContentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/UserContentDefinitions/' + userContentDefinitionID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserContentDefinitions_GetUserContentDefinition(userContentDefinitionID: number, headersHandler?: () => {[header: string]: string}): Promise<ContentSubmission.Shared.BusinessEntities.UserContentDefinition> {
			return this.http.get('api/v2/UserContentDefinitions/' + userContentDefinitionID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UsersGetByUsernameAndEmailAndNameAndLimitAndOffset(username: string, email: string, name: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Users?username=' + (username == null ? '' : encodeURIComponent(username)) + '&email=' + (email == null ? '' : encodeURIComponent(email)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_Post(requestBody: API.Models.User, headersHandler?: () => {[header: string]: string}): Promise<API.Models.User> {
			return this.http.post('api/v2/Users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Users_GetCurrentUser(headersHandler?: () => {[header: string]: string}): Promise<API.Models.User> {
			return this.http.get('api/v2/Users/Current', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Users_PutCurrentUser(requestBody: API.Models.User, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Users/Current', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UserPermissionsGetByPermissionAndLimitAndOffset(Permission: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Users/Current/Permissions?Permission=' + (Permission == null ? '' : encodeURIComponent(Permission)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPermissions_GetCurrentUserRoles(Role: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Users/Current/Roles?Role=' + (Role == null ? '' : encodeURIComponent(Role)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Users_Delete(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/Users/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UsersGetById(id: number, headersHandler?: () => {[header: string]: string}): Promise<API.Models.User> {
			return this.http.get('api/v2/Users/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Users_Put(id: number, requestBody: API.Models.User, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Users/' + id, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UserPermissionsGetByIdAndPermissionAndLimitAndOffset(id: number, Permission: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Users/' + id + '/Permissions?Permission=' + (Permission == null ? '' : encodeURIComponent(Permission)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPermissions_GetRoles(id: number, Role: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Users/' + id + '/Roles?Role=' + (Role == null ? '' : encodeURIComponent(Role)) + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UserPermissionsPutById(id: number, requestBody: Array<API.Models.UserRoleChange>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Users/' + id + '/Roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		VoucherHistory_GetVoucherHistory(VoucherCode: string, ChangedBefore: Date, ChangedAfter: Date, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/VoucherHistory?VoucherCode=' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&ChangedBefore=' + ChangedBefore.toISOString() + '&ChangedAfter=' + ChangedAfter.toISOString() + '&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Vouchers_Post(requestBody: DealerDB.Models.Voucher, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/v2/Vouchers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		Vouchers_Delete(VoucherCode: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		VouchersGetByVoucherCodeAndDeleted(VoucherCode: string, Deleted: string, headersHandler?: () => {[header: string]: string}): Promise<DealerDB.Models.Voucher> {
			return this.http.get('api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '&Deleted=' + (Deleted == null ? '' : encodeURIComponent(Deleted)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Vouchers_Put(VoucherCode: string, requestBody: DealerDB.Models.Voucher, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Vouchers_GetVoucherHistory(VoucherCode: string, limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/Vouchers/' + (VoucherCode == null ? '' : encodeURIComponent(VoucherCode)) + '/VoucherHistory&limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Activities_GetActivities(limit: number, offset: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/activities?limit=' + limit + '&offset=' + offset + '&isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Activities_PostActivity(requestBody: BuildSystem.Shared.DTO.Activity, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/activities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Activities_DeleteActivity(activityID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/activities/' + activityID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Activities_GetActivity(activityID: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Activity> {
			return this.http.get('api/v2/activities/' + activityID + '?isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Activities_PutActivity(activityID: number, requestBody: BuildSystem.Shared.DTO.Activity, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/activities/' + activityID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ActivityRuns_GetActivityRuns(limit: number, offset: number, status: BuildSystem.Shared.DTO.ActivityRunStatusStatus, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/activityRuns?limit=' + limit + '&offset=' + offset + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ActivityRuns_GetActivityRun(activityRunID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRun> {
			return this.http.get('api/v2/activityRuns/' + activityRunID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ActivityRuns_PutActivityRun(activityRunID: number, requestBody: BuildSystem.Shared.DTO.ActivityRun, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/activityRuns/' + activityRunID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ActivityRuns_GetActivityRunStatus(activityRunID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRunStatus> {
			return this.http.get('api/v2/activityRuns/' + activityRunID + '/status', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ActivityRuns_PutActivityRunStatus(activityRunID: number, requestBody: BuildSystem.Shared.DTO.ActivityRunStatus, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/activityRuns/' + activityRunID + '/status', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Agents_GetAgents(limit: number, offset: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/agents?limit=' + limit + '&offset=' + offset, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Agents_PostAgent(requestBody: BuildSystem.Shared.DTO.Agent, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/agents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Agents_GetCurrentAgent(headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Agent> {
			return this.http.get('api/v2/agents/Current', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Agents_GetCurrentAgentActivityRun(headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRun> {
			return this.http.get('api/v2/agents/Current/ActivityRun', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Agents_DeleteAgent(agentID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/agents/' + agentID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Agents_GetAgent(agentID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Agent> {
			return this.http.get('api/v2/agents/' + agentID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Agents_PutAgent(agentID: number, requestBody: BuildSystem.Shared.DTO.Agent, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/agents/' + agentID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Agents_GetAgentActivityRun(agentID: number, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.ActivityRun> {
			return this.http.get('api/v2/agents/' + agentID + '/ActivityRun', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Agents_PutAgentActivityRun(agentID: number, requestBody: BuildSystem.Shared.DTO.ActivityRun, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/agents/' + agentID + '/ActivityRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Agents_PutAgentStatus(agentID: number, requestBody: BuildSystem.Shared.DTO.AgentStatus, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/agents/' + agentID + '/Status', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		JobRuns_GetJobRuns(limit: number, offset: number, includeActivityRunDetails: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/jobRuns?limit=' + limit + '&offset=' + offset + '&includeActivityRunDetails=' + includeActivityRunDetails, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		JobRuns_PostJobRun(requestBody: BuildSystem.Shared.DTO.JobRun, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/jobRuns', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		JobRuns_DeleteJobRun(jobRunID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/jobRuns/' + jobRunID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		JobRuns_GetJobRun(jobRunID: number, includeActivityRunDetails: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.JobRun> {
			return this.http.get('api/v2/jobRuns/' + jobRunID + '?includeActivityRunDetails=' + includeActivityRunDetails, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		JobRuns_PutJobRun(jobRunID: number, requestBody: BuildSystem.Shared.DTO.JobRun, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/jobRuns/' + jobRunID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Jobs_GetJobs(limit: number, offset: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/jobs?limit=' + limit + '&offset=' + offset + '&isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Jobs_PostJob(requestBody: BuildSystem.Shared.DTO.Job, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Jobs_DeleteJob(jobID: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('api/v2/jobs/' + jobID, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Jobs_GetJob(jobID: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Job> {
			return this.http.get('api/v2/jobs/' + jobID + '?isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Jobs_PutJob(jobID: number, requestBody: BuildSystem.Shared.DTO.Job, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/jobs/' + jobID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Steps_GetSteps(limit: number, offset: number, includeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/v2/steps?limit=' + limit + '&offset=' + offset + '&includeDeleted=' + includeDeleted, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Steps_PostStep(requestBody: BuildSystem.Shared.DTO.Step, headersHandler?: () => {[header: string]: string}): Promise<number> {
			return this.http.post('api/v2/steps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Steps_GetStep(stepID: number, isIncludeDeleted: boolean, headersHandler?: () => {[header: string]: string}): Promise<BuildSystem.Shared.DTO.Step> {
			return this.http.get('api/v2/steps/' + stepID + '?isIncludeDeleted=' + isIncludeDeleted, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Steps_PutStep(stepID: number, requestBody: BuildSystem.Shared.DTO.Step, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('api/v2/steps/' + stepID, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
