...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Post_token(callback: (data : string) => any, requestBody: Post_tokenBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/oauth/v1/token', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Get_endpoints(callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_asset_categories(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/asset-categories?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_asset_categories(callback: (data : void) => any, requestBody: Post_asset_categoriesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/asset-categories', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_asset_categories__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/asset-categories/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_asset_tags(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/asset-tags?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_asset_tags__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/asset-tags/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_assets(pagination_type: string, page: number, search_after: string, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/assets?pagination_type=' + (pagination_type == null ? '' : encodeURIComponent(pagination_type)) + '&page=' + page + '&search_after=' + (search_after == null ? '' : encodeURIComponent(search_after)) + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_assets(callback: (data : void) => any, requestBody: Post_assetsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/assets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_reference_files__locale_code_(asset_code: string, locale_code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_reference_files__locale_code_(asset_code: string, locale_code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} OK
		 */
		Get_reference_files__channel_code__locale_code__download(asset_code: string, locale_code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)) + '/download', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_variation_files__channel_code__locale_code(asset_code: string, channel_code: string, locale_code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_variation_files__channel_code__locale_code_(asset_code: string, channel_code: string, locale_code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} OK
		 */
		Get_variation_files__channel_code__locale_code__download(asset_code: string, channel_code: string, locale_code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)) + '/download', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_assets__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/assets/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Association_types_get_list(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/association-types?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Association_types_post(callback: (data : void) => any, requestBody: Association_types_postBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/association-types', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Association_types_get(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/association-types/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Attribute_groups_get_list(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/attribute-groups?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Attribute_groups_post(callback: (data : void) => any, requestBody: Attribute_groups_postBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/attribute-groups', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Attribute_groups_get(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/attribute-groups/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_attributes(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/attributes?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_attributes(callback: (data : void) => any, requestBody: Post_attributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/attributes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Get_attributes__attribute_code__options(attribute_code: string, page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options&page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_attributes__attribute_code__options(attribute_code: string, callback: (data : void) => any, requestBody: Post_attributes__attribute_code__optionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_attributes__attribute_code__options__code_(attribute_code: string, code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_attributes__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/attributes/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_categories(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/categories?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_categories(callback: (data : void) => any, requestBody: Post_categoriesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/categories', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_categories__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/categories/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_channels(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/channels?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Channels_post(callback: (data : void) => any, requestBody: Channels_postBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/channels', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_channels__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/channels/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Currencies_get_list(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/currencies?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Currencies_get(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/currencies/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_families(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/families?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_families(callback: (data : void) => any, requestBody: Post_familiesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/families', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_families__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/families/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_families__family_code__variants(family_code: string, page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants&page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_families__family_code__variants(family_code: string, callback: (data : void) => any, requestBody: Post_families__family_code__variantsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_families__family_code__variants__code__(family_code: string, code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_locales(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/locales?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_locales__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/locales/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Measure_families_get_list(callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/measure-families', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Measure_families_get(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/measure-families/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_media_files(page: number, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/media-files?page=' + page + '&limit=' + limit + '&with_count=' + with_count, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_media_files(callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/media-files', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} OK
		 */
		Get_media_files__code_(code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/media-files/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} OK
		 */
		Get_media_files__code__download(code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/media-files/' + (code == null ? '' : encodeURIComponent(code)) + '/download', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_product_models(callback: (data : void) => any, requestBody: Post_product_modelsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/product-models', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_product_models__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_product_model_draft__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)) + '/draft', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_product_model_proposal(code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)) + '/proposal', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Get_products(search: string, scope: string, locales: string, attributes: string, pagination_type: string, page: number, search_after: string, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} 
		 */
		Post_products(callback: (data : void) => any, requestBody: Post_productsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/products', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Delete_products__code_(code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_products__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_draft__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)) + '/draft', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_proposal(code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)) + '/proposal', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Get_published_products(search: string, scope: string, locales: string, attributes: string, pagination_type: string, page: number, search_after: string, limit: number, with_count: boolean, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {string} OK
		 */
		Get_published_products__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/published-products/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_reference_entities(search_after: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities?search_after=' + (search_after == null ? '' : encodeURIComponent(search_after)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Post_reference_entity_media_files(callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/rest/v1/reference-entities-media-files', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} OK
		 */
		Get_reference_entity_media_files__code(code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities-media-files/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_reference_entities__code_(code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_reference_entities__code__attributes(reference_entity_code: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_reference_entity_attributes__attribute_code__options(reference_entity_code: string, attribute_code: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_reference_entity_attributes__attribute_code__options__code_(reference_entity_code: string, attribute_code: string, code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_reference_entity_attributes__code_(reference_entity_code: string, code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_reference_entity_records(search: string, channel: string, locales: string, reference_entity_code: string, search_after: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/records?search=' + (search == null ? '' : encodeURIComponent(search)) + '&channel=' + (channel == null ? '' : encodeURIComponent(channel)) + '&locales=' + (locales == null ? '' : encodeURIComponent(locales)) + '&search_after=' + (search_after == null ? '' : encodeURIComponent(search_after)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Get_reference_entity_records__code_(reference_entity_code: string, code: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/records/' + (code == null ? '' : encodeURIComponent(code)), callback, this.error, this.statusCode, headersHandler);
		}
	}
