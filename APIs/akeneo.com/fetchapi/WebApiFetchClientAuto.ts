export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Post_token(requestBody: Post_tokenBody, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/oauth/v1/token', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		Get_endpoints(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_asset_categories(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/asset-categories?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_asset_categories(requestBody: Post_asset_categoriesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/asset-categories', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_asset_categories__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/asset-categories/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_asset_tags(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/asset-tags?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_asset_tags__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/asset-tags/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_assets(pagination_type: string, page: number, search_after: string, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/assets?pagination_type=' + (pagination_type == null ? '' : encodeURIComponent(pagination_type)) + '&page=' + page + '&search_after=' + (search_after == null ? '' : encodeURIComponent(search_after)) + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_assets(requestBody: Post_assetsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/assets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_reference_files__locale_code_(asset_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_reference_files__locale_code_(asset_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_reference_files__channel_code__locale_code__download(asset_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)) + '/download', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_variation_files__channel_code__locale_code(asset_code: string, channel_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_variation_files__channel_code__locale_code_(asset_code: string, channel_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_variation_files__channel_code__locale_code__download(asset_code: string, channel_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)) + '/download', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_assets__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/assets/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Association_types_get_list(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/association-types?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Association_types_post(requestBody: Association_types_postBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/association-types', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Association_types_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/association-types/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Attribute_groups_get_list(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/attribute-groups?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Attribute_groups_post(requestBody: Attribute_groups_postBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/attribute-groups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Attribute_groups_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/attribute-groups/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_attributes(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/attributes?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_attributes(requestBody: Post_attributesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/attributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_attributes__attribute_code__options(attribute_code: string, page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options&page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_attributes__attribute_code__options(attribute_code: string, requestBody: Post_attributes__attribute_code__optionsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_attributes__attribute_code__options__code_(attribute_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_attributes__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/attributes/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_categories(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/categories?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_categories(requestBody: Post_categoriesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/categories', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_categories__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/categories/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_channels(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/channels?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Channels_post(requestBody: Channels_postBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/channels', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_channels__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/channels/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Currencies_get_list(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/currencies?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Currencies_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/currencies/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_families(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/families?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_families(requestBody: Post_familiesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/families', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_families__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/families/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_families__family_code__variants(family_code: string, page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants&page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_families__family_code__variants(family_code: string, requestBody: Post_families__family_code__variantsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_families__family_code__variants__code__(family_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_locales(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/locales?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_locales__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/locales/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Measure_families_get_list(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/measure-families', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Measure_families_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/measure-families/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_media_files(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/media-files?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_media_files(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/media-files', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_media_files__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/media-files/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_media_files__code__download(code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/media-files/' + (code == null ? '' : encodeURIComponent(code)) + '/download', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Post_product_models(requestBody: Post_product_modelsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/product-models', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Get_product_models__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_product_model_draft__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)) + '/draft', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_product_model_proposal(code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)) + '/proposal', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Post_products(requestBody: Post_productsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/products', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Delete_products__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_products__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_draft__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)) + '/draft', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_proposal(code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)) + '/proposal', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_published_products__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/published-products/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_reference_entities(search_after: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities?search_after=' + (search_after == null ? '' : encodeURIComponent(search_after)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Post_reference_entity_media_files(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities-media-files', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_reference_entity_media_files__code(code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities-media-files/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_reference_entities__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_reference_entities__code__attributes(reference_entity_code: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_reference_entity_attributes__attribute_code__options(reference_entity_code: string, attribute_code: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_reference_entity_attributes__code_(reference_entity_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_reference_entity_records__code_(reference_entity_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/records/' + (code == null ? '' : encodeURIComponent(code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
	}
