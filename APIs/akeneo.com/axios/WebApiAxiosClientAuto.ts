...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Post_token(requestBody: Post_tokenBody, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'api/oauth/v1/token', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		Get_endpoints(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_asset_categories(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/asset-categories?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_asset_categories(requestBody: Post_asset_categoriesBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/asset-categories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_asset_categories__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/asset-categories/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_asset_tags(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/asset-tags?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_asset_tags__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/asset-tags/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_assets(requestBody: Post_assetsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/assets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_reference_files__locale_code_(asset_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_reference_files__locale_code_(asset_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Get_reference_files__channel_code__locale_code__download(asset_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/reference-files/' + (locale_code == null ? '' : encodeURIComponent(locale_code)) + '/download', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Get_variation_files__channel_code__locale_code(asset_code: string, channel_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_variation_files__channel_code__locale_code_(asset_code: string, channel_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Get_variation_files__channel_code__locale_code__download(asset_code: string, channel_code: string, locale_code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'api/rest/v1/assets/' + (asset_code == null ? '' : encodeURIComponent(asset_code)) + '/variation-files/' + (channel_code == null ? '' : encodeURIComponent(channel_code)) + '/' + (locale_code == null ? '' : encodeURIComponent(locale_code)) + '/download', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Get_assets__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/assets/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Association_types_get_list(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/association-types?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Association_types_post(requestBody: Association_types_postBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/association-types', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Association_types_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/association-types/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Attribute_groups_get_list(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/attribute-groups?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Attribute_groups_post(requestBody: Attribute_groups_postBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/attribute-groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Attribute_groups_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/attribute-groups/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_attributes(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/attributes?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_attributes(requestBody: Post_attributesBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/attributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_attributes__attribute_code__options(attribute_code: string, page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options&page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_attributes__attribute_code__options(attribute_code: string, requestBody: Post_attributes__attribute_code__optionsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_attributes__attribute_code__options__code_(attribute_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_attributes__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/attributes/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_categories(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/categories?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_categories(requestBody: Post_categoriesBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/categories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_categories__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/categories/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_channels(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/channels?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Channels_post(requestBody: Channels_postBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/channels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_channels__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/channels/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Currencies_get_list(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/currencies?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Currencies_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/currencies/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_families(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/families?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_families(requestBody: Post_familiesBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/families', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_families__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/families/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_families__family_code__variants(family_code: string, page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants&page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_families__family_code__variants(family_code: string, requestBody: Post_families__family_code__variantsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_families__family_code__variants__code__(family_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/families/' + (family_code == null ? '' : encodeURIComponent(family_code)) + '/variants/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_locales(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/locales?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_locales__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/locales/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Measure_families_get_list(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/measure-families', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Measure_families_get(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/measure-families/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_media_files(page: number, limit: number, with_count: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/media-files?page=' + page + '&limit=' + limit + '&with_count=' + with_count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_media_files(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/media-files', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Get_media_files__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'api/rest/v1/media-files/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Get_media_files__code__download(code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'api/rest/v1/media-files/' + (code == null ? '' : encodeURIComponent(code)) + '/download', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Post_product_models(requestBody: Post_product_modelsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/product-models', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		Get_product_models__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_product_model_draft__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)) + '/draft', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_product_model_proposal(code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/product-models/' + (code == null ? '' : encodeURIComponent(code)) + '/proposal', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Post_products(requestBody: Post_productsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/products', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Delete_products__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Get_products__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_draft__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)) + '/draft', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_proposal(code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/products/' + (code == null ? '' : encodeURIComponent(code)) + '/proposal', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Get_published_products__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/published-products/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_reference_entities(search_after: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/reference-entities?search_after=' + (search_after == null ? '' : encodeURIComponent(search_after)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Post_reference_entity_media_files(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'api/rest/v1/reference-entities-media-files', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		Get_reference_entity_media_files__code(code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'api/rest/v1/reference-entities-media-files/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Get_reference_entities__code_(code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/reference-entities/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_reference_entities__code__attributes(reference_entity_code: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.get<Array<string>>(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_reference_entity_attributes__attribute_code__options(reference_entity_code: string, attribute_code: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.get<Array<string>>(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes/' + (attribute_code == null ? '' : encodeURIComponent(attribute_code)) + '/options', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Get_reference_entity_attributes__code_(reference_entity_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/attributes/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		Get_reference_entity_records__code_(reference_entity_code: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'api/rest/v1/reference-entities/' + (reference_entity_code == null ? '' : encodeURIComponent(reference_entity_code)) + '/records/' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
	}
