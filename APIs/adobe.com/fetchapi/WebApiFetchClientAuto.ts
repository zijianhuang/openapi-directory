export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		PostCqActions(authorizableId: string, changelog: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '.cqactions.html?authorizableId=' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '&changelog=' + (changelog == null ? '' : encodeURIComponent(changelog)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostConfigAemPasswordReset(pwdreset.authorizables: Array<string>, pwdreset.authorizables@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apps/system/config/com.shinesolutions.aem.passwordreset.Activator?' + pwdreset.authorizables.map(z => `pwdreset.authorizables=${encodeURIComponent(z)}`).join('&') + '&pwdreset.authorizables@TypeHint=' + (pwdreset.authorizables@TypeHint == null ? '' : encodeURIComponent(pwdreset.authorizables@TypeHint)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostConfigAemHealthCheckServlet(bundles.ignored: Array<string>, bundles.ignored@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apps/system/config/com.shinesolutions.healthcheck.hc.impl.ActiveBundleHealthCheck?' + bundles.ignored.map(z => `bundles.ignored=${encodeURIComponent(z)}`).join('&') + '&bundles.ignored@TypeHint=' + (bundles.ignored@TypeHint == null ? '' : encodeURIComponent(bundles.ignored@TypeHint)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostConfigApacheHttpComponentsProxyConfiguration(proxy.host: string, proxy.host@TypeHint: string, proxy.port: number, proxy.port@TypeHint: string, proxy.exceptions: Array<string>, proxy.exceptions@TypeHint: string, proxy.enabled: boolean, proxy.enabled@TypeHint: string, proxy.user: string, proxy.user@TypeHint: string, proxy.password: string, proxy.password@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apps/system/config/org.apache.http.proxyconfigurator.config?proxy.host=' + (proxy.host == null ? '' : encodeURIComponent(proxy.host)) + '&proxy.host@TypeHint=' + (proxy.host@TypeHint == null ? '' : encodeURIComponent(proxy.host@TypeHint)) + '&proxy.port=' + proxy.port + '&proxy.port@TypeHint=' + (proxy.port@TypeHint == null ? '' : encodeURIComponent(proxy.port@TypeHint)) + '&' + proxy.exceptions.map(z => `proxy.exceptions=${encodeURIComponent(z)}`).join('&') + '&proxy.exceptions@TypeHint=' + (proxy.exceptions@TypeHint == null ? '' : encodeURIComponent(proxy.exceptions@TypeHint)) + '&proxy.enabled=' + proxy.enabled + '&proxy.enabled@TypeHint=' + (proxy.enabled@TypeHint == null ? '' : encodeURIComponent(proxy.enabled@TypeHint)) + '&proxy.user=' + (proxy.user == null ? '' : encodeURIComponent(proxy.user)) + '&proxy.user@TypeHint=' + (proxy.user@TypeHint == null ? '' : encodeURIComponent(proxy.user@TypeHint)) + '&proxy.password=' + (proxy.password == null ? '' : encodeURIComponent(proxy.password)) + '&proxy.password@TypeHint=' + (proxy.password@TypeHint == null ? '' : encodeURIComponent(proxy.password@TypeHint)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostConfigApacheSlingDavExServlet(alias: string, alias@TypeHint: string, dav.create-absolute-uri: boolean, dav.create-absolute-uri@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apps/system/config/org.apache.sling.jcr.davex.impl.servlets.SlingDavExServlet?alias=' + (alias == null ? '' : encodeURIComponent(alias)) + '&alias@TypeHint=' + (alias@TypeHint == null ? '' : encodeURIComponent(alias@TypeHint)) + '&dav.create-absolute-uri=' + dav.create-absolute-uri + '&dav.create-absolute-uri@TypeHint=' + (dav.create-absolute-uri@TypeHint == null ? '' : encodeURIComponent(dav.create-absolute-uri@TypeHint)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostConfigApacheSlingReferrerFilter(allow.empty: boolean, allow.empty@TypeHint: string, allow.hosts: string, allow.hosts@TypeHint: string, allow.hosts.regexp: string, allow.hosts.regexp@TypeHint: string, filter.methods: string, filter.methods@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apps/system/config/org.apache.sling.security.impl.ReferrerFilter?allow.empty=' + allow.empty + '&allow.empty@TypeHint=' + (allow.empty@TypeHint == null ? '' : encodeURIComponent(allow.empty@TypeHint)) + '&allow.hosts=' + (allow.hosts == null ? '' : encodeURIComponent(allow.hosts)) + '&allow.hosts@TypeHint=' + (allow.hosts@TypeHint == null ? '' : encodeURIComponent(allow.hosts@TypeHint)) + '&allow.hosts.regexp=' + (allow.hosts.regexp == null ? '' : encodeURIComponent(allow.hosts.regexp)) + '&allow.hosts.regexp@TypeHint=' + (allow.hosts.regexp@TypeHint == null ? '' : encodeURIComponent(allow.hosts.regexp@TypeHint)) + '&filter.methods=' + (filter.methods == null ? '' : encodeURIComponent(filter.methods)) + '&filter.methods@TypeHint=' + (filter.methods@TypeHint == null ? '' : encodeURIComponent(filter.methods@TypeHint)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostConfigApacheSlingGetServlet(json.maximumresults: string, json.maximumresults@TypeHint: string, enable.html: boolean, enable.html@TypeHint: string, enable.txt: boolean, enable.txt@TypeHint: string, enable.xml: boolean, enable.xml@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apps/system/config/org.apache.sling.servlets.get.DefaultGetServlet?json.maximumresults=' + (json.maximumresults == null ? '' : encodeURIComponent(json.maximumresults)) + '&json.maximumresults@TypeHint=' + (json.maximumresults@TypeHint == null ? '' : encodeURIComponent(json.maximumresults@TypeHint)) + '&enable.html=' + enable.html + '&enable.html@TypeHint=' + (enable.html@TypeHint == null ? '' : encodeURIComponent(enable.html@TypeHint)) + '&enable.txt=' + enable.txt + '&enable.txt@TypeHint=' + (enable.txt@TypeHint == null ? '' : encodeURIComponent(enable.txt@TypeHint)) + '&enable.xml=' + enable.xml + '&enable.xml@TypeHint=' + (enable.xml@TypeHint == null ? '' : encodeURIComponent(enable.xml@TypeHint)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetQuery(path: string, p.limit: number, 1_property: string, 1_property.value: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'bin/querybuilder.json?path=' + (path == null ? '' : encodeURIComponent(path)) + '&p.limit=' + p.limit + '&1_property=' + (1_property == null ? '' : encodeURIComponent(1_property)) + '&1_property.value=' + (1_property.value == null ? '' : encodeURIComponent(1_property.value)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostQuery(path: string, p.limit: number, 1_property: string, 1_property.value: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'bin/querybuilder.json?path=' + (path == null ? '' : encodeURIComponent(path)) + '&p.limit=' + p.limit + '&1_property=' + (1_property == null ? '' : encodeURIComponent(1_property)) + '&1_property.value=' + (1_property.value == null ? '' : encodeURIComponent(1_property.value)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostSetPassword(old: string, plain: string, verify: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'crx/explorer/ui/setpassword.jsp?old=' + (old == null ? '' : encodeURIComponent(old)) + '&plain=' + (plain == null ? '' : encodeURIComponent(plain)) + '&verify=' + (verify == null ? '' : encodeURIComponent(verify)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetInstallStatus(headersHandler?: () => {[header: string]: string}): Promise<InstallStatus> {
			return fetch(this.baseUri + 'crx/packmgr/installstatus.jsp', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PostPackageService(cmd: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'crx/packmgr/service.jsp?cmd=' + (cmd == null ? '' : encodeURIComponent(cmd)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetPackageManagerServlet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'crx/packmgr/service/script.html', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetCrxdeStatus(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'crx/server/crx.default/jcr:root/.1.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetPackage(group: string, name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'etc/packages/' + (group == null ? '' : encodeURIComponent(group)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '-' + (version == null ? '' : encodeURIComponent(version)) + '.zip', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetPackageFilter(group: string, name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'etc/packages/' + (group == null ? '' : encodeURIComponent(group)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '-' + (version == null ? '' : encodeURIComponent(version)) + '.zip/jcr:content/vlt:definition/filter.tidy.2.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetAgents(runmode: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '.-1.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAgent(runmode: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '/' + (name == null ? '' : encodeURIComponent(name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetAgent(runmode: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '/' + (name == null ? '' : encodeURIComponent(name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostTreeActivation(ignoredeactivated: boolean, onlymodified: boolean, path: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'etc/replication/treeactivation.html?ignoredeactivated=' + ignoredeactivated + '&onlymodified=' + onlymodified + '&path=' + (path == null ? '' : encodeURIComponent(path)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetTruststore(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'etc/truststore/truststore.p12', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetLoginPage(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'libs/granite/core/content/login.html', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostAuthorizables(authorizableId: string, intermediatePath: string, createUser: string, createGroup: string, rep:password: string, profile/givenName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'libs/granite/security/post/authorizables?authorizableId=' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '&intermediatePath=' + (intermediatePath == null ? '' : encodeURIComponent(intermediatePath)) + '&createUser=' + (createUser == null ? '' : encodeURIComponent(createUser)) + '&createGroup=' + (createGroup == null ? '' : encodeURIComponent(createGroup)) + '&rep:password=' + (rep:password == null ? '' : encodeURIComponent(rep:password)) + '&profile/givenName=' + (profile/givenName == null ? '' : encodeURIComponent(profile/givenName)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetTruststoreInfo(headersHandler?: () => {[header: string]: string}): Promise<TruststoreInfo> {
			return fetch(this.baseUri + 'libs/granite/security/truststore.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PostBundle(name: string, action: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'system/console/bundles/' + (name == null ? '' : encodeURIComponent(name)) + '&action=' + (action == null ? '' : encodeURIComponent(action)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostJmxRepository(action: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'system/console/jmx/com.adobe.granite:type=Repository/op/' + (action == null ? '' : encodeURIComponent(action)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetAemProductInfo(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'system/console/status-productinfo.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetAemHealthCheck(tags: string, combineTagsOr: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'system/health?tags=' + (tags == null ? '' : encodeURIComponent(tags)) + '&combineTagsOr=' + combineTagsOr, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetAuthorizableKeystore(intermediatePath: string, authorizableId: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + (intermediatePath == null ? '' : encodeURIComponent(intermediatePath)) + '/' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '.ks.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {void} 
		 */
		GetKeystore(intermediatePath: string, authorizableId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + (intermediatePath == null ? '' : encodeURIComponent(intermediatePath)) + '/' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '/keystore/store.p12', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostPath(path: string, jcr:primaryType: string, :name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/&jcr:primaryType=' + (jcr:primaryType == null ? '' : encodeURIComponent(jcr:primaryType)) + '&:name=' + (:name == null ? '' : encodeURIComponent(:name)) + '', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteNode(path: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		GetNode(path: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostNodeRw(path: string, name: string, addMembers: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '.rw.html&addMembers=' + (addMembers == null ? '' : encodeURIComponent(addMembers)) + '', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
	}
