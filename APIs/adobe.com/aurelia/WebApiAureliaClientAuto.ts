...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		PostCqActions(authorizableId: string, changelog: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('.cqactions.html?authorizableId=' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '&changelog=' + (changelog == null ? '' : encodeURIComponent(changelog)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostConfigAemPasswordReset(pwdreset.authorizables: Array<string>, pwdreset.authorizables@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('apps/system/config/com.shinesolutions.aem.passwordreset.Activator?' + pwdreset.authorizables.map(z => `pwdreset.authorizables=${encodeURIComponent(z)}`).join('&') + '&pwdreset.authorizables@TypeHint=' + (pwdreset.authorizables@TypeHint == null ? '' : encodeURIComponent(pwdreset.authorizables@TypeHint)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostConfigAemHealthCheckServlet(bundles.ignored: Array<string>, bundles.ignored@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('apps/system/config/com.shinesolutions.healthcheck.hc.impl.ActiveBundleHealthCheck?' + bundles.ignored.map(z => `bundles.ignored=${encodeURIComponent(z)}`).join('&') + '&bundles.ignored@TypeHint=' + (bundles.ignored@TypeHint == null ? '' : encodeURIComponent(bundles.ignored@TypeHint)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostConfigApacheSlingReferrerFilter(allow.empty: boolean, allow.empty@TypeHint: string, allow.hosts: string, allow.hosts@TypeHint: string, allow.hosts.regexp: string, allow.hosts.regexp@TypeHint: string, filter.methods: string, filter.methods@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('apps/system/config/org.apache.sling.security.impl.ReferrerFilter?allow.empty=' + allow.empty + '&allow.empty@TypeHint=' + (allow.empty@TypeHint == null ? '' : encodeURIComponent(allow.empty@TypeHint)) + '&allow.hosts=' + (allow.hosts == null ? '' : encodeURIComponent(allow.hosts)) + '&allow.hosts@TypeHint=' + (allow.hosts@TypeHint == null ? '' : encodeURIComponent(allow.hosts@TypeHint)) + '&allow.hosts.regexp=' + (allow.hosts.regexp == null ? '' : encodeURIComponent(allow.hosts.regexp)) + '&allow.hosts.regexp@TypeHint=' + (allow.hosts.regexp@TypeHint == null ? '' : encodeURIComponent(allow.hosts.regexp@TypeHint)) + '&filter.methods=' + (filter.methods == null ? '' : encodeURIComponent(filter.methods)) + '&filter.methods@TypeHint=' + (filter.methods@TypeHint == null ? '' : encodeURIComponent(filter.methods@TypeHint)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostConfigApacheSlingGetServlet(json.maximumresults: string, json.maximumresults@TypeHint: string, enable.html: boolean, enable.html@TypeHint: string, enable.txt: boolean, enable.txt@TypeHint: string, enable.xml: boolean, enable.xml@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('apps/system/config/org.apache.sling.servlets.get.DefaultGetServlet?json.maximumresults=' + (json.maximumresults == null ? '' : encodeURIComponent(json.maximumresults)) + '&json.maximumresults@TypeHint=' + (json.maximumresults@TypeHint == null ? '' : encodeURIComponent(json.maximumresults@TypeHint)) + '&enable.html=' + enable.html + '&enable.html@TypeHint=' + (enable.html@TypeHint == null ? '' : encodeURIComponent(enable.html@TypeHint)) + '&enable.txt=' + enable.txt + '&enable.txt@TypeHint=' + (enable.txt@TypeHint == null ? '' : encodeURIComponent(enable.txt@TypeHint)) + '&enable.xml=' + enable.xml + '&enable.xml@TypeHint=' + (enable.xml@TypeHint == null ? '' : encodeURIComponent(enable.xml@TypeHint)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetQuery(path: string, p.limit: number, 1_property: string, 1_property.value: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('bin/querybuilder.json?path=' + (path == null ? '' : encodeURIComponent(path)) + '&p.limit=' + p.limit + '&1_property=' + (1_property == null ? '' : encodeURIComponent(1_property)) + '&1_property.value=' + (1_property.value == null ? '' : encodeURIComponent(1_property.value)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostQuery(path: string, p.limit: number, 1_property: string, 1_property.value: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('bin/querybuilder.json?path=' + (path == null ? '' : encodeURIComponent(path)) + '&p.limit=' + p.limit + '&1_property=' + (1_property == null ? '' : encodeURIComponent(1_property)) + '&1_property.value=' + (1_property.value == null ? '' : encodeURIComponent(1_property.value)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostSetPassword(old: string, plain: string, verify: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('crx/explorer/ui/setpassword.jsp?old=' + (old == null ? '' : encodeURIComponent(old)) + '&plain=' + (plain == null ? '' : encodeURIComponent(plain)) + '&verify=' + (verify == null ? '' : encodeURIComponent(verify)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetInstallStatus(headersHandler?: () => {[header: string]: string}): Promise<InstallStatus> {
			return this.http.get('crx/packmgr/installstatus.jsp', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPackageService(cmd: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('crx/packmgr/service.jsp?cmd=' + (cmd == null ? '' : encodeURIComponent(cmd)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPackageManagerServlet(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('crx/packmgr/service/script.html', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetCrxdeStatus(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('crx/server/crx.default/jcr:root/.1.json', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPackage(group: string, name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('etc/packages/' + (group == null ? '' : encodeURIComponent(group)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '-' + (version == null ? '' : encodeURIComponent(version)) + '.zip', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPackageFilter(group: string, name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('etc/packages/' + (group == null ? '' : encodeURIComponent(group)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '-' + (version == null ? '' : encodeURIComponent(version)) + '.zip/jcr:content/vlt:definition/filter.tidy.2.json', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAgents(runmode: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '.-1.json', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteAgent(runmode: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAgent(runmode: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostTreeActivation(ignoredeactivated: boolean, onlymodified: boolean, path: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('etc/replication/treeactivation.html?ignoredeactivated=' + ignoredeactivated + '&onlymodified=' + onlymodified + '&path=' + (path == null ? '' : encodeURIComponent(path)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetTruststore(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('etc/truststore/truststore.p12', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetLoginPage(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('libs/granite/core/content/login.html', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetTruststoreInfo(headersHandler?: () => {[header: string]: string}): Promise<TruststoreInfo> {
			return this.http.get('libs/granite/security/truststore.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostBundle(name: string, action: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('system/console/bundles/' + (name == null ? '' : encodeURIComponent(name)) + '&action=' + (action == null ? '' : encodeURIComponent(action)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostJmxRepository(action: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('system/console/jmx/com.adobe.granite:type=Repository/op/' + (action == null ? '' : encodeURIComponent(action)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAemProductInfo(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('system/console/status-productinfo.json', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAemHealthCheck(tags: string, combineTagsOr: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('system/health?tags=' + (tags == null ? '' : encodeURIComponent(tags)) + '&combineTagsOr=' + combineTagsOr, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAuthorizableKeystore(intermediatePath: string, authorizableId: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('' + (intermediatePath == null ? '' : encodeURIComponent(intermediatePath)) + '/' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '.ks.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetKeystore(intermediatePath: string, authorizableId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('' + (intermediatePath == null ? '' : encodeURIComponent(intermediatePath)) + '/' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '/keystore/store.p12', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostPath(path: string, jcr:primaryType: string, :name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('' + (path == null ? '' : encodeURIComponent(path)) + '/&jcr:primaryType=' + (jcr:primaryType == null ? '' : encodeURIComponent(jcr:primaryType)) + '&:name=' + (:name == null ? '' : encodeURIComponent(:name)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteNode(path: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('' + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetNode(path: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('' + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PostNodeRw(path: string, name: string, addMembers: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('' + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '.rw.html&addMembers=' + (addMembers == null ? '' : encodeURIComponent(addMembers)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
