...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		PostCqActions(authorizableId: string, changelog: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '.cqactions.html?authorizableId=' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '&changelog=' + (changelog == null ? '' : encodeURIComponent(changelog)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PostConfigAemPasswordReset(pwdreset.authorizables: Array<string>, pwdreset.authorizables@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PostConfigAemHealthCheckServlet(bundles.ignored: Array<string>, bundles.ignored@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PostConfigApacheHttpComponentsProxyConfiguration(proxy.host: string, proxy.host@TypeHint: string, proxy.port: number, proxy.port@TypeHint: string, proxy.exceptions: Array<string>, proxy.exceptions@TypeHint: string, proxy.enabled: boolean, proxy.enabled@TypeHint: string, proxy.user: string, proxy.user@TypeHint: string, proxy.password: string, proxy.password@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PostConfigApacheSlingDavExServlet(alias: string, alias@TypeHint: string, dav.create-absolute-uri: boolean, dav.create-absolute-uri@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PostConfigApacheSlingReferrerFilter(allow.empty: boolean, allow.empty@TypeHint: string, allow.hosts: string, allow.hosts@TypeHint: string, allow.hosts.regexp: string, allow.hosts.regexp@TypeHint: string, filter.methods: string, filter.methods@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PostConfigApacheSlingGetServlet(json.maximumresults: string, json.maximumresults@TypeHint: string, enable.html: boolean, enable.html@TypeHint: string, enable.txt: boolean, enable.txt@TypeHint: string, enable.xml: boolean, enable.xml@TypeHint: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		GetQuery(path: string, p.limit: number, 1_property: string, 1_property.value: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PostQuery(path: string, p.limit: number, 1_property: string, 1_property.value: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		PostSetPassword(old: string, plain: string, verify: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'crx/explorer/ui/setpassword.jsp?old=' + (old == null ? '' : encodeURIComponent(old)) + '&plain=' + (plain == null ? '' : encodeURIComponent(plain)) + '&verify=' + (verify == null ? '' : encodeURIComponent(verify)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetInstallStatus(headersHandler?: () => {[header: string]: string}): Promise<InstallStatus> {
			return Axios.get<InstallStatus>(this.baseUri + 'crx/packmgr/installstatus.jsp', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PostPackageService(cmd: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'crx/packmgr/service.jsp?cmd=' + (cmd == null ? '' : encodeURIComponent(cmd)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetPackageManagerServlet(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'crx/packmgr/service/script.html', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PostPackageUpdate(groupName: string, packageName: string, version: string, path: string, filter: string, _charset_: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 */
		GetCrxdeStatus(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'crx/server/crx.default/jcr:root/.1.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetPackage(group: string, name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'etc/packages/' + (group == null ? '' : encodeURIComponent(group)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '-' + (version == null ? '' : encodeURIComponent(version)) + '.zip', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetPackageFilter(group: string, name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'etc/packages/' + (group == null ? '' : encodeURIComponent(group)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '-' + (version == null ? '' : encodeURIComponent(version)) + '.zip/jcr:content/vlt:definition/filter.tidy.2.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetAgents(runmode: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '.-1.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAgent(runmode: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetAgent(runmode: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'etc/replication/agents.' + (runmode == null ? '' : encodeURIComponent(runmode)) + '/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PostTreeActivation(ignoredeactivated: boolean, onlymodified: boolean, path: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'etc/replication/treeactivation.html?ignoredeactivated=' + ignoredeactivated + '&onlymodified=' + onlymodified + '&path=' + (path == null ? '' : encodeURIComponent(path)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetTruststore(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'etc/truststore/truststore.p12', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetLoginPage(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'libs/granite/core/content/login.html', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PostAuthorizables(authorizableId: string, intermediatePath: string, createUser: string, createGroup: string, rep:password: string, profile/givenName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		GetTruststoreInfo(headersHandler?: () => {[header: string]: string}): Promise<TruststoreInfo> {
			return Axios.get<TruststoreInfo>(this.baseUri + 'libs/granite/security/truststore.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PostBundle(name: string, action: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'system/console/bundles/' + (name == null ? '' : encodeURIComponent(name)) + '&action=' + (action == null ? '' : encodeURIComponent(action)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PostJmxRepository(action: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'system/console/jmx/com.adobe.granite:type=Repository/op/' + (action == null ? '' : encodeURIComponent(action)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetAemProductInfo(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'system/console/status-productinfo.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetAemHealthCheck(tags: string, combineTagsOr: boolean, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'system/health?tags=' + (tags == null ? '' : encodeURIComponent(tags)) + '&combineTagsOr=' + combineTagsOr, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetAuthorizableKeystore(intermediatePath: string, authorizableId: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + (intermediatePath == null ? '' : encodeURIComponent(intermediatePath)) + '/' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '.ks.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		GetKeystore(intermediatePath: string, authorizableId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + (intermediatePath == null ? '' : encodeURIComponent(intermediatePath)) + '/' + (authorizableId == null ? '' : encodeURIComponent(authorizableId)) + '/keystore/store.p12', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PostPath(path: string, jcr:primaryType: string, :name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/&jcr:primaryType=' + (jcr:primaryType == null ? '' : encodeURIComponent(jcr:primaryType)) + '&:name=' + (:name == null ? '' : encodeURIComponent(:name)) + '', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteNode(path: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GetNode(path: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PostNodeRw(path: string, name: string, addMembers: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + (path == null ? '' : encodeURIComponent(path)) + '/' + (name == null ? '' : encodeURIComponent(name)) + '.rw.html&addMembers=' + (addMembers == null ? '' : encodeURIComponent(addMembers)) + '', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
	}
