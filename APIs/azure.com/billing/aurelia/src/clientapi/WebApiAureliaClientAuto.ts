...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BillingAccounts_List(api_version: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<BillingAccountListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		BillingAccounts_Get(api_version: string, billingAccountName: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<BillingAccount> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Agreements_ListByBillingAccount(api_version: string, billingAccountName: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<AgreementListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/agreements?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Agreements_Get(api_version: string, billingAccountName: string, agreementName: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<Agreement> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/agreements/' + (agreementName == null ? '' : encodeURIComponent(agreementName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		BillingPermissions_ListByBillingAccount(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		BillingProfiles_ListByBillingAccount(api_version: string, billingAccountName: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<BillingProfileListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		BillingProfiles_Get(api_version: string, billingAccountName: string, billingProfileName: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<BillingProfile> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {BillingProfile} OK. The request has succeeded.
		 */
		BillingProfiles_Create(api_version: string, billingAccountName: string, billingProfileName: string, requestBody: BillingProfileCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<BillingProfile> {
			return this.http.put('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		AvailableBalances_GetByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<AvailableBalance> {
		 ...
		 * @return {BillingPermissionsListResult} OK. The request has succeeded.
		 */
		BillingPermissions_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
		 ...
		 */
		BillingRoleAssignments_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignmentListResult> {
		 ...
		 */
		BillingRoleAssignments_GetByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_DeleteByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return this.http.delete('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		BillingRoleDefinitions_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinitionListResult> {
		 ...
		 */
		BillingRoleDefinitions_GetByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleDefinitionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinition> {
		 ...
		 */
		BillingSubscriptions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		Customers_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, filter: string, skiptoken: string, headersHandler?: () => {[header: string]: string}): Promise<CustomerListResult> {
		 ...
		 */
		PartnerTransfers_Initiate(billingAccountName: string, billingProfileName: string, customerName: string, requestBody: InitiateTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/initiateTransfer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		PartnerTransfers_List(billingAccountName: string, billingProfileName: string, customerName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetailsListResult> {
		 ...
		 */
		PartnerTransfers_Get(billingAccountName: string, billingProfileName: string, customerName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
		 ...
		 */
		PartnerTransfers_Cancel(billingAccountName: string, billingProfileName: string, customerName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return this.http.delete('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Instructions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<InstructionListResult> {
		 ...
		 */
		Instructions_Get(api_version: string, billingAccountName: string, billingProfileName: string, instructionName: string, headersHandler?: () => {[header: string]: string}): Promise<Instruction> {
		 ...
		 * @return {Instruction} OK. The request has succeeded.
		 */
		Instructions_Put(api_version: string, billingAccountName: string, billingProfileName: string, instructionName: string, requestBody: Instruction, headersHandler?: () => {[header: string]: string}): Promise<Instruction> {
			return this.http.put('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/instructions/' + (instructionName == null ? '' : encodeURIComponent(instructionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		InvoiceSections_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceSectionListResult> {
		 ...
		 */
		InvoiceSections_Get(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceSection> {
		 ...
		 * @return {InvoiceSection} OK. The request has succeeded.
		 */
		InvoiceSections_Create(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, requestBody: InvoiceSectionCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<InvoiceSection> {
			return this.http.put('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {BillingPermissionsListResult} OK. The request has succeeded.
		 */
		BillingPermissions_ListByInvoiceSections(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
		 ...
		 * @return {BillingRoleAssignmentListResult} OK. The request has succeeded.
		 */
		BillingRoleAssignments_ListByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignmentListResult> {
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_GetByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_DeleteByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return this.http.delete('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {BillingRoleDefinitionListResult} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_ListByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinitionListResult> {
		 ...
		 * @return {BillingRoleDefinition} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_GetByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleDefinitionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinition> {
		 ...
		 * @return {BillingSubscriptionsListResult} OK. The request has succeeded.
		 */
		BillingSubscriptions_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
		 ...
		 */
		BillingSubscriptions_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingSubscriptionName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscription> {
		 ...
		 */
		BillingSubscriptions_Transfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingSubscriptionName: string, requestBody: TransferBillingSubscriptionRequestProperties, headersHandler?: () => {[header: string]: string}): Promise<TransferBillingSubscriptionResult> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingSubscriptions/' + (billingSubscriptionName == null ? '' : encodeURIComponent(billingSubscriptionName)) + '/transfer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		BillingSubscriptions_ValidateTransfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingSubscriptionName: string, requestBody: TransferBillingSubscriptionRequestProperties, headersHandler?: () => {[header: string]: string}): Promise<ValidateSubscriptionTransferEligibilityResult> {
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		InvoiceSections_ElevateToBillingProfile(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
		 ...
		 * @return {TransferDetails} Initiated transfer details.
		 */
		Transfers_Initiate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, requestBody: InitiateTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/initiateTransfer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		Products_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<ProductsListResult> {
		 ...
		 */
		Products_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Product> {
		 ...
		 * @return {Product} OK. The request has succeeded.
		 */
		Products_Transfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, requestBody: TransferProductRequestProperties, headersHandler?: () => {[header: string]: string}): Promise<Product> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/transfer&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		Products_UpdateAutoRenewByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, requestBody: UpdateAutoRenewRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAutoRenewOperation> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/updateAutoRenew&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		Products_ValidateTransfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, requestBody: TransferProductRequestProperties, headersHandler?: () => {[header: string]: string}): Promise<ValidateProductTransferEligibilityResult> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/validateTransferEligibility', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		Transactions_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<TransactionListResult> {
		 ...
		 * @return {TransferDetailsListResult} List of transfers initiated from this invoice section.
		 */
		Transfers_List(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetailsListResult> {
		 ...
		 * @return {TransferDetails} Details of transfer.
		 */
		Transfers_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
		 ...
		 * @return {TransferDetails} Details of canceled transfer.
		 */
		Transfers_Cancel(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return this.http.delete('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Invoices_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, periodStartDate: string, periodEndDate: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceListResult> {
		 ...
		 */
		Invoices_Get(api_version: string, billingAccountName: string, billingProfileName: string, invoiceName: string, headersHandler?: () => {[header: string]: string}): Promise<Invoice> {
		 ...
		 */
		PriceSheet_Download(api_version: string, billingAccountName: string, billingProfileName: string, invoiceName: string, headersHandler?: () => {[header: string]: string}): Promise<DownloadUrl> {
		 ...
		 */
		PaymentMethods_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<PaymentMethodsListResult> {
		 ...
		 */
		Policies_GetByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Policy> {
		 ...
		 * @return {Policy} OK. The request has succeeded.
		 */
		Policies_Update(api_version: string, billingAccountName: string, billingProfileName: string, requestBody: Policy, headersHandler?: () => {[header: string]: string}): Promise<Policy> {
			return this.http.put('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/policies/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {DownloadUrl} OK. The request has succeeded.
		 */
		PriceSheet_DownloadByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DownloadUrl> {
		 ...
		 * @return {TransactionListResult} OK. The request has succeeded.
		 */
		Transactions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<TransactionListResult> {
		 ...
		 */
		Transactions_Get(billingAccountName: string, billingProfileName: string, transactionName: string, periodStartDate: string, periodEndDate: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Transaction> {
		 ...
		 * @return {BillingRoleAssignmentListResult} OK. The request has succeeded.
		 */
		BillingRoleAssignments_ListByBillingAccount(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignmentListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_GetByBillingAccount(api_version: string, billingAccountName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_DeleteByBillingAccount(api_version: string, billingAccountName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return this.http.delete('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {BillingRoleDefinitionListResult} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_ListByBillingAccount(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinitionListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleDefinitions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {BillingRoleDefinition} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_GetByBillingAccount(api_version: string, billingAccountName: string, billingRoleDefinitionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinition> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleDefinitions/' + (billingRoleDefinitionName == null ? '' : encodeURIComponent(billingRoleDefinitionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {BillingSubscriptionsListResult} OK. The request has succeeded.
		 */
		BillingSubscriptions_ListByBillingAccount(billingAccountName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {InvoiceListResult} OK. The request has succeeded.
		 */
		Invoices_ListByBillingSubscription(billingAccountName: string, billingSubscriptionName: string, periodStartDate: string, periodEndDate: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingSubscriptions/' + (billingSubscriptionName == null ? '' : encodeURIComponent(billingSubscriptionName)) + '/invoices&periodStartDate=' + (periodStartDate == null ? '' : encodeURIComponent(periodStartDate)) + '&periodEndDate=' + (periodEndDate == null ? '' : encodeURIComponent(periodEndDate)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Invoice} OK. The request has succeeded.
		 */
		Invoices_GetById(billingAccountName: string, billingSubscriptionName: string, invoiceName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Invoice> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingSubscriptions/' + (billingSubscriptionName == null ? '' : encodeURIComponent(billingSubscriptionName)) + '/invoices/' + (invoiceName == null ? '' : encodeURIComponent(invoiceName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByBillingAccount(api_version: string, billingAccountName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {CustomerListResult} OK. The request has succeeded.
		 */
		Customers_ListByBillingAccount(api_version: string, billingAccountName: string, filter: string, skiptoken: string, headersHandler?: () => {[header: string]: string}): Promise<CustomerListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&skiptoken=' + (skiptoken == null ? '' : encodeURIComponent(skiptoken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Customers_Get(api_version: string, billingAccountName: string, customerName: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<Customer> {
		 ...
		 * @return {BillingPermissionsListResult} OK. The request has succeeded.
		 */
		BillingPermissions_ListByCustomer(api_version: string, billingAccountName: string, customerName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
		 ...
		 * @return {BillingSubscriptionsListResult} OK. The request has succeeded.
		 */
		BillingSubscriptions_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
		 ...
		 * @return {BillingSubscription} OK. The request has succeeded.
		 */
		BillingSubscriptions_GetByCustomer(billingAccountName: string, customerName: string, billingSubscriptionName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscription> {
		 ...
		 */
		Policies_GetByCustomer(billingAccountName: string, customerName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<CustomerPolicy> {
		 ...
		 * @return {CustomerPolicy} OK. The request has succeeded.
		 */
		Policies_UpdateCustomer(api_version: string, billingAccountName: string, customerName: string, requestBody: CustomerPolicy, headersHandler?: () => {[header: string]: string}): Promise<CustomerPolicy> {
			return this.http.put('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/policies/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {ProductsListResult} OK. The request has succeeded.
		 */
		Products_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<ProductsListResult> {
		 ...
		 * @return {Product} OK. The request has succeeded.
		 */
		Products_GetByCustomer(billingAccountName: string, customerName: string, productName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Product> {
		 ...
		 * @return {TransactionListResult} OK. The request has succeeded.
		 */
		Transactions_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<TransactionListResult> {
		 ...
		 */
		Departments_ListByBillingAccountName(api_version: string, billingAccountName: string, expand: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<DepartmentListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/departments?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Departments_Get(api_version: string, billingAccountName: string, departmentName: string, expand: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<Department> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/departments/' + (departmentName == null ? '' : encodeURIComponent(departmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		EnrollmentAccounts_ListByBillingAccountName(api_version: string, billingAccountName: string, expand: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<EnrollmentAccountListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/enrollmentAccounts?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		EnrollmentAccounts_GetByEnrollmentAccountId(api_version: string, billingAccountName: string, enrollmentAccountName: string, expand: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<EnrollmentAccount> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/enrollmentAccounts/' + (enrollmentAccountName == null ? '' : encodeURIComponent(enrollmentAccountName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {InvoiceListResult} OK. The request has succeeded.
		 */
		Invoices_ListByBillingAccount(api_version: string, billingAccountName: string, periodStartDate: string, periodEndDate: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/invoices?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&periodStartDate=' + (periodStartDate == null ? '' : encodeURIComponent(periodStartDate)) + '&periodEndDate=' + (periodEndDate == null ? '' : encodeURIComponent(periodEndDate)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		BillingAccounts_ListInvoiceSectionsByCreateSubscriptionPermission(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceSectionListWithCreateSubPermissionResult> {
			return this.http.post('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/listInvoiceSectionsWithCreateSubscriptionPermission?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {PaymentMethodsListResult} OK. The request has succeeded.
		 */
		PaymentMethods_ListByBillingAccount(billingAccountName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<PaymentMethodsListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/paymentMethods&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {ProductsListResult} OK. The request has succeeded.
		 */
		Products_ListByBillingAccount(billingAccountName: string, api_version: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<ProductsListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/products&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {TransactionListResult} OK. The request has succeeded.
		 */
		Transactions_ListByBillingAccount(billingAccountName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<TransactionListResult> {
			return this.http.get('providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/transactions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&periodStartDate=' + (periodStartDate == null ? '' : encodeURIComponent(periodStartDate)) + '&periodEndDate=' + (periodEndDate == null ? '' : encodeURIComponent(periodEndDate)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Operations_List(api_version: string, headersHandler?: () => {[header: string]: string}): Promise<OperationListResult> {
			return this.http.get('providers/Microsoft.Billing/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		RecipientTransfers_List(headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetailsListResult> {
			return this.http.get('providers/Microsoft.Billing/transfers', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		RecipientTransfers_Get(transferName: string, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return this.http.get('providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		RecipientTransfers_Accept(transferName: string, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return this.http.post('providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/acceptTransfer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RecipientTransfers_Decline(transferName: string, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return this.http.post('providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/declineTransfer', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		RecipientTransfers_Validate(transferName: string, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<ValidateTransferListResponse> {
			return this.http.post('providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/validateTransfer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		Address_Validate(api_version: string, requestBody: AddressDetails, headersHandler?: () => {[header: string]: string}): Promise<ValidateAddressResponse> {
			return this.http.post('providers/Microsoft.Billing/validateAddress?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		LineOfCredits_Get(api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<LineOfCredit> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {LineOfCredit} OK. The request has succeeded.
		 */
		LineOfCredits_Update(api_version: string, subscriptionId: string, requestBody: LineOfCredit, headersHandler?: () => {[header: string]: string}): Promise<LineOfCredit> {
			return this.http.put('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		BillingProperty_Get(subscriptionId: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingProperty> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingProperty/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
