...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BillingAccounts_List(api_version: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<BillingAccountListResult> {
			return Axios.get<BillingAccountListResult>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		BillingPermissions_ListByBillingAccount(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
			return Axios.get<BillingPermissionsListResult>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		BillingRoleAssignments_DeleteByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return Axios.delete<BillingRoleAssignment>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		BillingRoleDefinitions_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinitionListResult> {
			return Axios.get<BillingRoleDefinitionListResult>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingRoleDefinitions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		PartnerTransfers_Cancel(billingAccountName: string, billingProfileName: string, customerName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return Axios.delete<TransferDetails>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Instructions_Put(api_version: string, billingAccountName: string, billingProfileName: string, instructionName: string, requestBody: Instruction, headersHandler?: () => {[header: string]: string}): Promise<Instruction> {
			return Axios.put<Instruction>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/instructions/' + (instructionName == null ? '' : encodeURIComponent(instructionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InvoiceSections_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceSectionListResult> {
			return Axios.get<InvoiceSectionListResult>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		InvoiceSections_ElevateToBillingProfile(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		BillingSubscriptions_ListByBillingAccount(billingAccountName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
			return Axios.get<BillingSubscriptionsListResult>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByBillingAccount(api_version: string, billingAccountName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		PaymentMethods_ListByBillingAccount(billingAccountName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<PaymentMethodsListResult> {
			return Axios.get<PaymentMethodsListResult>(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/paymentMethods&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Operations_List(api_version: string, headersHandler?: () => {[header: string]: string}): Promise<OperationListResult> {
			return Axios.get<OperationListResult>(this.baseUri + 'providers/Microsoft.Billing/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RecipientTransfers_List(headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetailsListResult> {
			return Axios.get<RecipientTransferDetailsListResult>(this.baseUri + 'providers/Microsoft.Billing/transfers', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RecipientTransfers_Get(transferName: string, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return Axios.get<RecipientTransferDetails>(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RecipientTransfers_Accept(transferName: string, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return Axios.post<RecipientTransferDetails>(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/acceptTransfer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RecipientTransfers_Decline(transferName: string, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return Axios.post<RecipientTransferDetails>(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/declineTransfer', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RecipientTransfers_Validate(transferName: string, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<ValidateTransferListResponse> {
			return Axios.post<ValidateTransferListResponse>(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/validateTransfer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Address_Validate(api_version: string, requestBody: AddressDetails, headersHandler?: () => {[header: string]: string}): Promise<ValidateAddressResponse> {
			return Axios.post<ValidateAddressResponse>(this.baseUri + 'providers/Microsoft.Billing/validateAddress?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		LineOfCredits_Get(api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<LineOfCredit> {
			return Axios.get<LineOfCredit>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		LineOfCredits_Update(api_version: string, subscriptionId: string, requestBody: LineOfCredit, headersHandler?: () => {[header: string]: string}): Promise<LineOfCredit> {
			return Axios.put<LineOfCredit>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BillingProperty_Get(subscriptionId: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingProperty> {
			return Axios.get<BillingProperty>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingProperty/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
