export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BillingAccounts_List(api_version: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<BillingAccountListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingPermissions_ListByBillingAccount(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AvailableBalances_GetByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<AvailableBalance> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/availableBalance/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleAssignments_GetByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleDefinitions_GetByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleDefinitionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinition> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingRoleDefinitions/' + (billingRoleDefinitionName == null ? '' : encodeURIComponent(billingRoleDefinitionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingSubscriptions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Customers_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, filter: string, skiptoken: string, headersHandler?: () => {[header: string]: string}): Promise<CustomerListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&skiptoken=' + (skiptoken == null ? '' : encodeURIComponent(skiptoken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PartnerTransfers_Initiate(billingAccountName: string, billingProfileName: string, customerName: string, requestBody: InitiateTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/initiateTransfer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PartnerTransfers_List(billingAccountName: string, billingProfileName: string, customerName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetailsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PartnerTransfers_Get(billingAccountName: string, billingProfileName: string, customerName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PartnerTransfers_Cancel(billingAccountName: string, billingProfileName: string, customerName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Instructions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<InstructionListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/instructions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		InvoiceSections_Get(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceSection> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingPermissions_ListByInvoiceSections(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleAssignments_GetByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleDefinitions_ListByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinitionListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleDefinitions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleDefinitions_GetByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleDefinitionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinition> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleDefinitions/' + (billingRoleDefinitionName == null ? '' : encodeURIComponent(billingRoleDefinitionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingSubscriptions_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingSubscriptions_Transfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingSubscriptionName: string, requestBody: TransferBillingSubscriptionRequestProperties, headersHandler?: () => {[header: string]: string}): Promise<TransferBillingSubscriptionResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingSubscriptions/' + (billingSubscriptionName == null ? '' : encodeURIComponent(billingSubscriptionName)) + '/transfer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BillingRoleAssignments_AddByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		InvoiceSections_ElevateToBillingProfile(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/elevate', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Transfers_Initiate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, requestBody: InitiateTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/initiateTransfer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Products_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<ProductsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Products_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Product> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Products_Transfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, requestBody: TransferProductRequestProperties, headersHandler?: () => {[header: string]: string}): Promise<Product> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/transfer&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Products_UpdateAutoRenewByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, requestBody: UpdateAutoRenewRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAutoRenewOperation> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/updateAutoRenew&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Products_ValidateTransfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, requestBody: TransferProductRequestProperties, headersHandler?: () => {[header: string]: string}): Promise<ValidateProductTransferEligibilityResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/validateTransferEligibility', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Transfers_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Transfers_Cancel(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, headersHandler?: () => {[header: string]: string}): Promise<TransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Invoices_Get(api_version: string, billingAccountName: string, billingProfileName: string, invoiceName: string, headersHandler?: () => {[header: string]: string}): Promise<Invoice> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoices/' + (invoiceName == null ? '' : encodeURIComponent(invoiceName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PriceSheet_Download(api_version: string, billingAccountName: string, billingProfileName: string, invoiceName: string, headersHandler?: () => {[header: string]: string}): Promise<DownloadUrl> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoices/' + (invoiceName == null ? '' : encodeURIComponent(invoiceName)) + '/pricesheet/default/download?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PaymentMethods_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<PaymentMethodsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/paymentMethods&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Policies_GetByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Policy> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/policies/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PriceSheet_DownloadByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DownloadUrl> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/pricesheet/default/download?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleAssignments_ListByBillingAccount(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignmentListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleAssignments_GetByBillingAccount(api_version: string, billingAccountName: string, billingRoleAssignmentName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleAssignment> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleDefinitions_ListByBillingAccount(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinitionListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleDefinitions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleDefinitions_GetByBillingAccount(api_version: string, billingAccountName: string, billingRoleDefinitionName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingRoleDefinition> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleDefinitions/' + (billingRoleDefinitionName == null ? '' : encodeURIComponent(billingRoleDefinitionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingSubscriptions_ListByBillingAccount(billingAccountName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingRoleAssignments_AddByBillingAccount(api_version: string, billingAccountName: string, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Customers_ListByBillingAccount(api_version: string, billingAccountName: string, filter: string, skiptoken: string, headersHandler?: () => {[header: string]: string}): Promise<CustomerListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&skiptoken=' + (skiptoken == null ? '' : encodeURIComponent(skiptoken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingPermissions_ListByCustomer(api_version: string, billingAccountName: string, customerName: string, headersHandler?: () => {[header: string]: string}): Promise<BillingPermissionsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingSubscriptions_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingSubscriptionsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Policies_GetByCustomer(billingAccountName: string, customerName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<CustomerPolicy> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/policies/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Products_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<ProductsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/products&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Products_GetByCustomer(billingAccountName: string, customerName: string, productName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<Product> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BillingAccounts_ListInvoiceSectionsByCreateSubscriptionPermission(api_version: string, billingAccountName: string, headersHandler?: () => {[header: string]: string}): Promise<InvoiceSectionListWithCreateSubPermissionResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/listInvoiceSectionsWithCreateSubscriptionPermission?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PaymentMethods_ListByBillingAccount(billingAccountName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<PaymentMethodsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/paymentMethods&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Products_ListByBillingAccount(billingAccountName: string, api_version: string, filter: string, headersHandler?: () => {[header: string]: string}): Promise<ProductsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/products&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Operations_List(api_version: string, headersHandler?: () => {[header: string]: string}): Promise<OperationListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RecipientTransfers_List(headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetailsListResult> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/transfers', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RecipientTransfers_Get(transferName: string, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RecipientTransfers_Accept(transferName: string, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/acceptTransfer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RecipientTransfers_Decline(transferName: string, headersHandler?: () => {[header: string]: string}): Promise<RecipientTransferDetails> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/declineTransfer', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RecipientTransfers_Validate(transferName: string, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}): Promise<ValidateTransferListResponse> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/validateTransfer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Address_Validate(api_version: string, requestBody: AddressDetails, headersHandler?: () => {[header: string]: string}): Promise<ValidateAddressResponse> {
			return fetch(this.baseUri + 'providers/Microsoft.Billing/validateAddress?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		LineOfCredits_Get(api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<LineOfCredit> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		LineOfCredits_Update(api_version: string, subscriptionId: string, requestBody: LineOfCredit, headersHandler?: () => {[header: string]: string}): Promise<LineOfCredit> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BillingProperty_Get(subscriptionId: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<BillingProperty> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingProperty/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
