...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BillingAccounts_List(api_version: string, expand: string, callback: (data : BillingAccountListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		BillingAccounts_Get(api_version: string, billingAccountName: string, expand: string, callback: (data : BillingAccount) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Agreements_ListByBillingAccount(api_version: string, billingAccountName: string, expand: string, callback: (data : AgreementListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Agreements_Get(api_version: string, billingAccountName: string, agreementName: string, expand: string, callback: (data : Agreement) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingPermissions_ListByBillingAccount(api_version: string, billingAccountName: string, callback: (data : BillingPermissionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		BillingProfiles_ListByBillingAccount(api_version: string, billingAccountName: string, expand: string, callback: (data : BillingProfileListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingProfiles_Get(api_version: string, billingAccountName: string, billingProfileName: string, expand: string, callback: (data : BillingProfile) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {BillingProfile} OK. The request has succeeded.
		 */
		BillingProfiles_Create(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : BillingProfile) => any, requestBody: BillingProfileCreationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AvailableBalances_GetByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, callback: (data : AvailableBalance) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/availableBalance/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingPermissionsListResult} OK. The request has succeeded.
		 */
		BillingPermissions_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : BillingPermissionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingRoleAssignments_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : BillingRoleAssignmentListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingRoleAssignments_GetByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleAssignmentName: string, callback: (data : BillingRoleAssignment) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_DeleteByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleAssignmentName: string, callback: (data : BillingRoleAssignment) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingRoleDefinitions_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : BillingRoleDefinitionListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingRoleDefinitions_GetByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, billingRoleDefinitionName: string, callback: (data : BillingRoleDefinition) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingRoleDefinitions/' + (billingRoleDefinitionName == null ? '' : encodeURIComponent(billingRoleDefinitionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		BillingSubscriptions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, callback: (data : BillingSubscriptionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : void) => any, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Customers_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, filter: string, skiptoken: string, callback: (data : CustomerListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&skiptoken=' + (skiptoken == null ? '' : encodeURIComponent(skiptoken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PartnerTransfers_Initiate(billingAccountName: string, billingProfileName: string, customerName: string, callback: (data : TransferDetails) => any, requestBody: InitiateTransferRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/initiateTransfer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PartnerTransfers_List(billingAccountName: string, billingProfileName: string, customerName: string, callback: (data : TransferDetailsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PartnerTransfers_Get(billingAccountName: string, billingProfileName: string, customerName: string, transferName: string, callback: (data : TransferDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PartnerTransfers_Cancel(billingAccountName: string, billingProfileName: string, customerName: string, transferName: string, callback: (data : TransferDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Instructions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, callback: (data : InstructionListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/instructions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Instructions_Get(api_version: string, billingAccountName: string, billingProfileName: string, instructionName: string, callback: (data : Instruction) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {Instruction} OK. The request has succeeded.
		 */
		Instructions_Put(api_version: string, billingAccountName: string, billingProfileName: string, instructionName: string, callback: (data : Instruction) => any, requestBody: Instruction, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/instructions/' + (instructionName == null ? '' : encodeURIComponent(instructionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		InvoiceSections_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : InvoiceSectionListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		InvoiceSections_Get(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : InvoiceSection) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {InvoiceSection} OK. The request has succeeded.
		 */
		InvoiceSections_Create(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : InvoiceSection) => any, requestBody: InvoiceSectionCreationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {BillingPermissionsListResult} OK. The request has succeeded.
		 */
		BillingPermissions_ListByInvoiceSections(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : BillingPermissionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleAssignmentListResult} OK. The request has succeeded.
		 */
		BillingRoleAssignments_ListByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : BillingRoleAssignmentListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_GetByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleAssignmentName: string, callback: (data : BillingRoleAssignment) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_DeleteByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleAssignmentName: string, callback: (data : BillingRoleAssignment) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleDefinitionListResult} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_ListByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : BillingRoleDefinitionListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleDefinitions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleDefinition} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_GetByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingRoleDefinitionName: string, callback: (data : BillingRoleDefinition) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingRoleDefinitions/' + (billingRoleDefinitionName == null ? '' : encodeURIComponent(billingRoleDefinitionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingSubscriptionsListResult} OK. The request has succeeded.
		 */
		BillingSubscriptions_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, callback: (data : BillingSubscriptionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		BillingSubscriptions_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingSubscriptionName: string, api_version: string, callback: (data : BillingSubscription) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingSubscriptions_Transfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingSubscriptionName: string, callback: (data : TransferBillingSubscriptionResult) => any, requestBody: TransferBillingSubscriptionRequestProperties, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingSubscriptions/' + (billingSubscriptionName == null ? '' : encodeURIComponent(billingSubscriptionName)) + '/transfer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		BillingSubscriptions_ValidateTransfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, billingSubscriptionName: string, callback: (data : ValidateSubscriptionTransferEligibilityResult) => any, requestBody: TransferBillingSubscriptionRequestProperties, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/billingSubscriptions/' + (billingSubscriptionName == null ? '' : encodeURIComponent(billingSubscriptionName)) + '/validateTransferEligibility', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByInvoiceSection(api_version: string, billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : void) => any, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		InvoiceSections_ElevateToBillingProfile(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/elevate', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {TransferDetails} Initiated transfer details.
		 */
		Transfers_Initiate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : TransferDetails) => any, requestBody: InitiateTransferRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/initiateTransfer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Products_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, filter: string, callback: (data : ProductsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Products_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, callback: (data : Product) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Product} OK. The request has succeeded.
		 */
		Products_Transfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, callback: (data : Product) => any, requestBody: TransferProductRequestProperties, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/transfer&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Products_UpdateAutoRenewByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, api_version: string, callback: (data : UpdateAutoRenewOperation) => any, requestBody: UpdateAutoRenewRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/updateAutoRenew&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Products_ValidateTransfer(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, productName: string, callback: (data : ValidateProductTransferEligibilityResult) => any, requestBody: TransferProductRequestProperties, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '/validateTransferEligibility', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Transactions_ListByInvoiceSection(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, callback: (data : TransactionListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/transactions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&periodStartDate=' + (periodStartDate == null ? '' : encodeURIComponent(periodStartDate)) + '&periodEndDate=' + (periodEndDate == null ? '' : encodeURIComponent(periodEndDate)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {TransferDetailsListResult} List of transfers initiated from this invoice section.
		 */
		Transfers_List(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, callback: (data : TransferDetailsListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {TransferDetails} Details of transfer.
		 */
		Transfers_Get(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, callback: (data : TransferDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {TransferDetails} Details of canceled transfer.
		 */
		Transfers_Cancel(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, transferName: string, callback: (data : TransferDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoiceSections/' + (invoiceSectionName == null ? '' : encodeURIComponent(invoiceSectionName)) + '/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Invoices_ListByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, periodStartDate: string, periodEndDate: string, callback: (data : InvoiceListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Invoices_Get(api_version: string, billingAccountName: string, billingProfileName: string, invoiceName: string, callback: (data : Invoice) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoices/' + (invoiceName == null ? '' : encodeURIComponent(invoiceName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PriceSheet_Download(api_version: string, billingAccountName: string, billingProfileName: string, invoiceName: string, callback: (data : DownloadUrl) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/invoices/' + (invoiceName == null ? '' : encodeURIComponent(invoiceName)) + '/pricesheet/default/download?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PaymentMethods_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, callback: (data : PaymentMethodsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/paymentMethods&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Policies_GetByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, callback: (data : Policy) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/policies/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Policy} OK. The request has succeeded.
		 */
		Policies_Update(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : Policy) => any, requestBody: Policy, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/policies/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {DownloadUrl} OK. The request has succeeded.
		 */
		PriceSheet_DownloadByBillingProfile(api_version: string, billingAccountName: string, billingProfileName: string, callback: (data : DownloadUrl) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingProfiles/' + (billingProfileName == null ? '' : encodeURIComponent(billingProfileName)) + '/pricesheet/default/download?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {TransactionListResult} OK. The request has succeeded.
		 */
		Transactions_ListByBillingProfile(billingAccountName: string, billingProfileName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, callback: (data : TransactionListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Transactions_Get(billingAccountName: string, billingProfileName: string, transactionName: string, periodStartDate: string, periodEndDate: string, api_version: string, callback: (data : Transaction) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {BillingRoleAssignmentListResult} OK. The request has succeeded.
		 */
		BillingRoleAssignments_ListByBillingAccount(api_version: string, billingAccountName: string, callback: (data : BillingRoleAssignmentListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_GetByBillingAccount(api_version: string, billingAccountName: string, billingRoleAssignmentName: string, callback: (data : BillingRoleAssignment) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleAssignment} OK. The request has succeeded.
		 */
		BillingRoleAssignments_DeleteByBillingAccount(api_version: string, billingAccountName: string, billingRoleAssignmentName: string, callback: (data : BillingRoleAssignment) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleAssignments/' + (billingRoleAssignmentName == null ? '' : encodeURIComponent(billingRoleAssignmentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleDefinitionListResult} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_ListByBillingAccount(api_version: string, billingAccountName: string, callback: (data : BillingRoleDefinitionListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleDefinitions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingRoleDefinition} OK. The request has succeeded.
		 */
		BillingRoleDefinitions_GetByBillingAccount(api_version: string, billingAccountName: string, billingRoleDefinitionName: string, callback: (data : BillingRoleDefinition) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingRoleDefinitions/' + (billingRoleDefinitionName == null ? '' : encodeURIComponent(billingRoleDefinitionName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingSubscriptionsListResult} OK. The request has succeeded.
		 */
		BillingSubscriptions_ListByBillingAccount(billingAccountName: string, api_version: string, callback: (data : BillingSubscriptionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {InvoiceListResult} OK. The request has succeeded.
		 */
		Invoices_ListByBillingSubscription(billingAccountName: string, billingSubscriptionName: string, periodStartDate: string, periodEndDate: string, api_version: string, callback: (data : InvoiceListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {Invoice} OK. The request has succeeded.
		 */
		Invoices_GetById(billingAccountName: string, billingSubscriptionName: string, invoiceName: string, api_version: string, callback: (data : Invoice) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} 
		 */
		BillingRoleAssignments_AddByBillingAccount(api_version: string, billingAccountName: string, callback: (data : void) => any, requestBody: BillingRoleAssignmentPayload, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/createBillingRoleAssignment?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {CustomerListResult} OK. The request has succeeded.
		 */
		Customers_ListByBillingAccount(api_version: string, billingAccountName: string, filter: string, skiptoken: string, callback: (data : CustomerListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&skiptoken=' + (skiptoken == null ? '' : encodeURIComponent(skiptoken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Customers_Get(api_version: string, billingAccountName: string, customerName: string, expand: string, callback: (data : Customer) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {BillingPermissionsListResult} OK. The request has succeeded.
		 */
		BillingPermissions_ListByCustomer(api_version: string, billingAccountName: string, customerName: string, callback: (data : BillingPermissionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/billingPermissions?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingSubscriptionsListResult} OK. The request has succeeded.
		 */
		BillingSubscriptions_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, callback: (data : BillingSubscriptionsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/billingSubscriptions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {BillingSubscription} OK. The request has succeeded.
		 */
		BillingSubscriptions_GetByCustomer(billingAccountName: string, customerName: string, billingSubscriptionName: string, api_version: string, callback: (data : BillingSubscription) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Policies_GetByCustomer(billingAccountName: string, customerName: string, api_version: string, callback: (data : CustomerPolicy) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/policies/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {CustomerPolicy} OK. The request has succeeded.
		 */
		Policies_UpdateCustomer(api_version: string, billingAccountName: string, customerName: string, callback: (data : CustomerPolicy) => any, requestBody: CustomerPolicy, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/policies/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ProductsListResult} OK. The request has succeeded.
		 */
		Products_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, filter: string, callback: (data : ProductsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/products&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Product} OK. The request has succeeded.
		 */
		Products_GetByCustomer(billingAccountName: string, customerName: string, productName: string, api_version: string, callback: (data : Product) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/customers/' + (customerName == null ? '' : encodeURIComponent(customerName)) + '/products/' + (productName == null ? '' : encodeURIComponent(productName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {TransactionListResult} OK. The request has succeeded.
		 */
		Transactions_ListByCustomer(billingAccountName: string, customerName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, callback: (data : TransactionListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Departments_ListByBillingAccountName(api_version: string, billingAccountName: string, expand: string, filter: string, callback: (data : DepartmentListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/departments?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Departments_Get(api_version: string, billingAccountName: string, departmentName: string, expand: string, filter: string, callback: (data : Department) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		EnrollmentAccounts_ListByBillingAccountName(api_version: string, billingAccountName: string, expand: string, filter: string, callback: (data : EnrollmentAccountListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		EnrollmentAccounts_GetByEnrollmentAccountId(api_version: string, billingAccountName: string, enrollmentAccountName: string, expand: string, filter: string, callback: (data : EnrollmentAccount) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {InvoiceListResult} OK. The request has succeeded.
		 */
		Invoices_ListByBillingAccount(api_version: string, billingAccountName: string, periodStartDate: string, periodEndDate: string, callback: (data : InvoiceListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		BillingAccounts_ListInvoiceSectionsByCreateSubscriptionPermission(api_version: string, billingAccountName: string, callback: (data : InvoiceSectionListWithCreateSubPermissionResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/listInvoiceSectionsWithCreateSubscriptionPermission?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {PaymentMethodsListResult} OK. The request has succeeded.
		 */
		PaymentMethods_ListByBillingAccount(billingAccountName: string, api_version: string, callback: (data : PaymentMethodsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/paymentMethods&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {ProductsListResult} OK. The request has succeeded.
		 */
		Products_ListByBillingAccount(billingAccountName: string, api_version: string, filter: string, callback: (data : ProductsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/billingAccounts/' + (billingAccountName == null ? '' : encodeURIComponent(billingAccountName)) + '/products&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&filter=' + (filter == null ? '' : encodeURIComponent(filter)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {TransactionListResult} OK. The request has succeeded.
		 */
		Transactions_ListByBillingAccount(billingAccountName: string, api_version: string, periodStartDate: string, periodEndDate: string, filter: string, callback: (data : TransactionListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Operations_List(api_version: string, callback: (data : OperationListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		RecipientTransfers_List(callback: (data : RecipientTransferDetailsListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/transfers', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		RecipientTransfers_Get(transferName: string, callback: (data : RecipientTransferDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		RecipientTransfers_Accept(transferName: string, callback: (data : RecipientTransferDetails) => any, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/acceptTransfer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RecipientTransfers_Decline(transferName: string, callback: (data : RecipientTransferDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/declineTransfer', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RecipientTransfers_Validate(transferName: string, callback: (data : ValidateTransferListResponse) => any, requestBody: AcceptTransferRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/transfers/' + (transferName == null ? '' : encodeURIComponent(transferName)) + '/validateTransfer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Address_Validate(api_version: string, callback: (data : ValidateAddressResponse) => any, requestBody: AddressDetails, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'providers/Microsoft.Billing/validateAddress?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		LineOfCredits_Get(api_version: string, subscriptionId: string, callback: (data : LineOfCredit) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {LineOfCredit} OK. The request has succeeded.
		 */
		LineOfCredits_Update(api_version: string, subscriptionId: string, callback: (data : LineOfCredit) => any, requestBody: LineOfCredit, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingAccounts/default/lineOfCredit/default?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		BillingProperty_Get(subscriptionId: string, api_version: string, callback: (data : BillingProperty) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.Billing/billingProperty/default&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
	}
