...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Operations_List(api_version: string, skipToken: string, callback: (data : OperationDefinitionListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'providers/Microsoft.AppConfiguration/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&skipToken=' + (skipToken == null ? '' : encodeURIComponent(skipToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Operations_CheckNameAvailability(subscriptionId: string, api_version: string, callback: (data : NameAvailabilityStatus) => any, requestBody: CheckNameAvailabilityParameters, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppConfiguration/checkNameAvailability&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ConfigurationStores_List(subscriptionId: string, api_version: string, skipToken: string, callback: (data : ConfigurationStoreListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppConfiguration/configurationStores&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&skipToken=' + (skipToken == null ? '' : encodeURIComponent(skipToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {ConfigurationStoreListResult} The request was successful; the request was well-formed and received properly.
		 */
		ConfigurationStores_ListByResourceGroup(subscriptionId: string, resourceGroupName: string, api_version: string, skipToken: string, callback: (data : ConfigurationStoreListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ConfigurationStores_Delete(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ConfigurationStores_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, callback: (data : ConfigurationStore) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {ConfigurationStore} The request was successful; the request was well-formed and received properly.
		 */
		ConfigurationStores_Create(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, callback: (data : ConfigurationStore) => any, requestBody: ConfigurationStore, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ConfigurationStores_ListKeys(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, skipToken: string, callback: (data : ApiKeyListResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/ListKeys&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&skipToken=' + (skipToken == null ? '' : encodeURIComponent(skipToken)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ConfigurationStores_RegenerateKey(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, callback: (data : ApiKey) => any, requestBody: RegenerateKeyParameters, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/RegenerateKey&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ConfigurationStores_ListKeyValue(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, callback: (data : KeyValue) => any, requestBody: ListKeyValueParameters, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/listKeyValue&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PrivateEndpointConnections_ListByConfigurationStore(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, callback: (data : PrivateEndpointConnectionListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} The request was successful; the request was well-formed and received properly.
		 */
		PrivateEndpointConnections_Delete(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateEndpointConnections/' + (privateEndpointConnectionName == null ? '' : encodeURIComponent(privateEndpointConnectionName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PrivateEndpointConnections_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, callback: (data : PrivateEndpointConnection) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateEndpointConnections/' + (privateEndpointConnectionName == null ? '' : encodeURIComponent(privateEndpointConnectionName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {PrivateEndpointConnection} The request was successful; the request was well-formed and received properly.
		 */
		PrivateEndpointConnections_CreateOrUpdate(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, callback: (data : PrivateEndpointConnection) => any, requestBody: PrivateEndpointConnection, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateEndpointConnections/' + (privateEndpointConnectionName == null ? '' : encodeURIComponent(privateEndpointConnectionName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PrivateLinkResources_ListByConfigurationStore(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, callback: (data : PrivateLinkResourceListResult) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		PrivateLinkResources_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, groupName: string, callback: (data : PrivateLinkResource) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateLinkResources/' + (groupName == null ? '' : encodeURIComponent(groupName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), callback, this.error, this.statusCode, headersHandler);
		}
	}
