...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Operations_List(api_version: string, skipToken: string, headersHandler?: () => HttpHeaders): Observable<OperationDefinitionListResult> {
			return this.http.get<OperationDefinitionListResult>(this.baseUri + 'providers/Microsoft.AppConfiguration/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&skipToken=' + (skipToken == null ? '' : encodeURIComponent(skipToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Operations_CheckNameAvailability(subscriptionId: string, api_version: string, requestBody: CheckNameAvailabilityParameters, headersHandler?: () => HttpHeaders): Observable<NameAvailabilityStatus> {
			return this.http.post<NameAvailabilityStatus>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppConfiguration/checkNameAvailability&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ConfigurationStoreListResult} The request was successful; the request was well-formed and received properly.
		 */
		ConfigurationStores_ListByResourceGroup(subscriptionId: string, resourceGroupName: string, api_version: string, skipToken: string, headersHandler?: () => HttpHeaders): Observable<ConfigurationStoreListResult> {
		 ...
		 */
		ConfigurationStores_Delete(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		ConfigurationStores_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<ConfigurationStore> {
		 ...
		 * @return {ConfigurationStore} The request was successful; the request was well-formed and received properly.
		 */
		ConfigurationStores_Create(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, requestBody: ConfigurationStore, headersHandler?: () => HttpHeaders): Observable<ConfigurationStore> {
		 ...
		 */
		ConfigurationStores_ListKeys(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, skipToken: string, headersHandler?: () => HttpHeaders): Observable<ApiKeyListResult> {
			return this.http.post<ApiKeyListResult>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/ListKeys&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&skipToken=' + (skipToken == null ? '' : encodeURIComponent(skipToken)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ConfigurationStores_RegenerateKey(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, requestBody: RegenerateKeyParameters, headersHandler?: () => HttpHeaders): Observable<ApiKey> {
			return this.http.post<ApiKey>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/RegenerateKey&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ConfigurationStores_ListKeyValue(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, requestBody: ListKeyValueParameters, headersHandler?: () => HttpHeaders): Observable<KeyValue> {
			return this.http.post<KeyValue>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/listKeyValue&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PrivateEndpointConnections_ListByConfigurationStore(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<PrivateEndpointConnectionListResult> {
		 ...
		 * @return {void} The request was successful; the request was well-formed and received properly.
		 */
		PrivateEndpointConnections_Delete(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateEndpointConnections/' + (privateEndpointConnectionName == null ? '' : encodeURIComponent(privateEndpointConnectionName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PrivateEndpointConnections_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, headersHandler?: () => HttpHeaders): Observable<PrivateEndpointConnection> {
		 ...
		 * @return {PrivateEndpointConnection} The request was successful; the request was well-formed and received properly.
		 */
		PrivateEndpointConnections_CreateOrUpdate(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, requestBody: PrivateEndpointConnection, headersHandler?: () => HttpHeaders): Observable<PrivateEndpointConnection> {
			return this.http.put<PrivateEndpointConnection>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateEndpointConnections/' + (privateEndpointConnectionName == null ? '' : encodeURIComponent(privateEndpointConnectionName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PrivateLinkResources_ListByConfigurationStore(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<PrivateLinkResourceListResult> {
		 ...
		 */
		PrivateLinkResources_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, groupName: string, headersHandler?: () => HttpHeaders): Observable<PrivateLinkResource> {
			return this.http.get<PrivateLinkResource>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateLinkResources/' + (groupName == null ? '' : encodeURIComponent(groupName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
