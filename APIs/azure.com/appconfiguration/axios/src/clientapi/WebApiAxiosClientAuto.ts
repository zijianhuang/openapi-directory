...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Operations_List(api_version: string, skipToken: string, headersHandler?: () => {[header: string]: string}): Promise<OperationDefinitionListResult> {
			return Axios.get<OperationDefinitionListResult>(this.baseUri + 'providers/Microsoft.AppConfiguration/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&skipToken=' + (skipToken == null ? '' : encodeURIComponent(skipToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Operations_CheckNameAvailability(subscriptionId: string, api_version: string, requestBody: CheckNameAvailabilityParameters, headersHandler?: () => {[header: string]: string}): Promise<NameAvailabilityStatus> {
			return Axios.post<NameAvailabilityStatus>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppConfiguration/checkNameAvailability&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ConfigurationStores_Delete(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		ConfigurationStores_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<ConfigurationStore> {
			return Axios.get<ConfigurationStore>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} The request was successful; the request was well-formed and received properly.
		 */
		PrivateEndpointConnections_Delete(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		PrivateEndpointConnections_Get(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, privateEndpointConnectionName: string, headersHandler?: () => {[header: string]: string}): Promise<PrivateEndpointConnection> {
			return Axios.get<PrivateEndpointConnection>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateEndpointConnections/' + (privateEndpointConnectionName == null ? '' : encodeURIComponent(privateEndpointConnectionName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PrivateLinkResources_ListByConfigurationStore(subscriptionId: string, resourceGroupName: string, configStoreName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<PrivateLinkResourceListResult> {
			return Axios.get<PrivateLinkResourceListResult>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppConfiguration/configurationStores/' + (configStoreName == null ? '' : encodeURIComponent(configStoreName)) + '/privateLinkResources&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
