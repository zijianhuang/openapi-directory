...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ElevateAccess_Post(api_version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'providers/Microsoft.Authorization/elevateAccess?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		ProviderOperationsMetadata_List(api_version: string, expand: string, headersHandler?: () => {[header: string]: string}): Promise<ProviderOperationsMetadataListResult> {
			return Axios.get<ProviderOperationsMetadataListResult>(this.baseUri + 'providers/Microsoft.Authorization/providerOperations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RoleAssignments_DeleteById(roleAssignmentId: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<RoleAssignment> {
			return Axios.delete<RoleAssignment>(this.baseUri + (roleAssignmentId == null ? '' : encodeURIComponent(roleAssignmentId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RoleAssignments_GetById(roleAssignmentId: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<RoleAssignment> {
			return Axios.get<RoleAssignment>(this.baseUri + (roleAssignmentId == null ? '' : encodeURIComponent(roleAssignmentId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		RoleAssignments_CreateById(roleAssignmentId: string, api_version: string, requestBody: RoleAssignmentCreateParameters, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + (roleAssignmentId == null ? '' : encodeURIComponent(roleAssignmentId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		RoleAssignments_ListForScope(scope: string, filter: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<RoleAssignmentListResult> {
			return Axios.get<RoleAssignmentListResult>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleAssignments&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RoleAssignments_Get(scope: string, roleAssignmentName: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<RoleAssignment> {
			return Axios.get<RoleAssignment>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleAssignments/' + (roleAssignmentName == null ? '' : encodeURIComponent(roleAssignmentName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		RoleAssignments_Create(scope: string, roleAssignmentName: string, api_version: string, requestBody: RoleAssignmentCreateParameters, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleAssignments/' + (roleAssignmentName == null ? '' : encodeURIComponent(roleAssignmentName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		RoleDefinitions_List(scope: string, filter: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<RoleDefinitionListResult> {
			return Axios.get<RoleDefinitionListResult>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleDefinitions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RoleDefinitions_Get(scope: string, roleDefinitionId: string, api_version: string, headersHandler?: () => {[header: string]: string}): Promise<RoleDefinition> {
			return Axios.get<RoleDefinition>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleDefinitions/' + (roleDefinitionId == null ? '' : encodeURIComponent(roleDefinitionId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		RoleDefinitions_CreateOrUpdate(scope: string, roleDefinitionId: string, api_version: string, requestBody: RoleDefinition, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleDefinitions/' + (roleDefinitionId == null ? '' : encodeURIComponent(roleDefinitionId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
