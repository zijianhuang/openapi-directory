...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ElevateAccess_Post(api_version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'providers/Microsoft.Authorization/elevateAccess?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ProviderOperationsMetadata_List(api_version: string, expand: string, headersHandler?: () => HttpHeaders): Observable<ProviderOperationsMetadataListResult> {
			return this.http.get<ProviderOperationsMetadataListResult>(this.baseUri + 'providers/Microsoft.Authorization/providerOperations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '&expand=' + (expand == null ? '' : encodeURIComponent(expand)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RoleAssignments_List(filter: string, api_version: string, subscriptionId: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignmentListResult> {
		 ...
		 * @return {RoleAssignmentListResult} OK - Returns an array of role assignments.
		 */
		RoleAssignments_ListForResourceGroup(resourceGroupName: string, filter: string, api_version: string, subscriptionId: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignmentListResult> {
		 ...
		 */
		Permissions_ListForResourceGroup(resourceGroupName: string, api_version: string, subscriptionId: string, headersHandler?: () => HttpHeaders): Observable<PermissionGetResult> {
			return this.http.get<PermissionGetResult>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourcegroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.Authorization/permissions&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {PermissionGetResult} OK - Returns an array of permissions.
		 */
		Permissions_ListForResource(resourceGroupName: string, resourceProviderNamespace: string, parentResourcePath: string, resourceType: string, resourceName: string, api_version: string, subscriptionId: string, headersHandler?: () => HttpHeaders): Observable<PermissionGetResult> {
		 ...
		 * @return {RoleAssignmentListResult} OK - Returns an array of role assignments.
		 */
		RoleAssignments_ListForResource(resourceGroupName: string, resourceProviderNamespace: string, parentResourcePath: string, resourceType: string, resourceName: string, filter: string, api_version: string, subscriptionId: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignmentListResult> {
		 ...
		 */
		RoleAssignments_DeleteById(roleAssignmentId: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignment> {
			return this.http.delete<RoleAssignment>(this.baseUri + (roleAssignmentId == null ? '' : encodeURIComponent(roleAssignmentId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RoleAssignments_GetById(roleAssignmentId: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignment> {
			return this.http.get<RoleAssignment>(this.baseUri + (roleAssignmentId == null ? '' : encodeURIComponent(roleAssignmentId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		RoleAssignments_CreateById(roleAssignmentId: string, api_version: string, requestBody: RoleAssignmentCreateParameters, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + (roleAssignmentId == null ? '' : encodeURIComponent(roleAssignmentId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {RoleAssignmentListResult} OK - Returns an array of role assignments.
		 */
		RoleAssignments_ListForScope(scope: string, filter: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignmentListResult> {
			return this.http.get<RoleAssignmentListResult>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleAssignments&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {RoleAssignment} OK - Returns information about the role assignment.
		 */
		RoleAssignments_Delete(scope: string, roleAssignmentName: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignment> {
			return this.http.delete<RoleAssignment>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleAssignments/' + (roleAssignmentName == null ? '' : encodeURIComponent(roleAssignmentName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {RoleAssignment} OK - Returns information about the role assignment.
		 */
		RoleAssignments_Get(scope: string, roleAssignmentName: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleAssignment> {
			return this.http.get<RoleAssignment>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleAssignments/' + (roleAssignmentName == null ? '' : encodeURIComponent(roleAssignmentName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		RoleAssignments_Create(scope: string, roleAssignmentName: string, api_version: string, requestBody: RoleAssignmentCreateParameters, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleAssignments/' + (roleAssignmentName == null ? '' : encodeURIComponent(roleAssignmentName)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		RoleDefinitions_List(scope: string, filter: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleDefinitionListResult> {
			return this.http.get<RoleDefinitionListResult>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleDefinitions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RoleDefinitions_Delete(scope: string, roleDefinitionId: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleDefinition> {
			return this.http.delete<RoleDefinition>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleDefinitions/' + (roleDefinitionId == null ? '' : encodeURIComponent(roleDefinitionId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {RoleDefinition} OK - Returns information about the role definition.
		 */
		RoleDefinitions_Get(scope: string, roleDefinitionId: string, api_version: string, headersHandler?: () => HttpHeaders): Observable<RoleDefinition> {
			return this.http.get<RoleDefinition>(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleDefinitions/' + (roleDefinitionId == null ? '' : encodeURIComponent(roleDefinitionId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		RoleDefinitions_CreateOrUpdate(scope: string, roleDefinitionId: string, api_version: string, requestBody: RoleDefinition, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + (scope == null ? '' : encodeURIComponent(scope)) + '/providers/Microsoft.Authorization/roleDefinitions/' + (roleDefinitionId == null ? '' : encodeURIComponent(roleDefinitionId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)) + '', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
