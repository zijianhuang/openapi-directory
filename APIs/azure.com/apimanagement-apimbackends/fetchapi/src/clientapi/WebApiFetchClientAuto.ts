export namespace My_Demo_Client {
	export class DemoClient {
		...
		Backend_Delete(resourceGroupName: string, serviceName: string, backendId: string, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/backends/' + (backendId == null ? '' : encodeURIComponent(backendId)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Backend_Reconnect(resourceGroupName: string, serviceName: string, backendId: string, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/backends/' + (backendId == null ? '' : encodeURIComponent(backendId)) + '/reconnect&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
	}
