...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Operations_List(api_version: string, headersHandler?: () => HttpHeaders): Observable<AvailableOperations> {
			return this.http.get<AvailableOperations>(this.baseUri + 'providers/Microsoft.AppPlatform/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Services_ListBySubscription(api_version: string, subscriptionId: string, headersHandler?: () => HttpHeaders): Observable<ServiceResourceList> {
			return this.http.get<ServiceResourceList>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppPlatform/Spring?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Services_CheckNameAvailability(location: string, api_version: string, subscriptionId: string, requestBody: NameAvailabilityParameters, headersHandler?: () => HttpHeaders): Observable<NameAvailability> {
			return this.http.post<NameAvailability>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppPlatform/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/checkNameAvailability&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Services_List(api_version: string, subscriptionId: string, resourceGroupName: string, headersHandler?: () => HttpHeaders): Observable<ServiceResourceList> {
		 ...
		 * @return {void} 
		 */
		Services_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		Services_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => HttpHeaders): Observable<ServiceResource> {
		 ...
		 */
		Services_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, requestBody: ServiceResource, headersHandler?: () => HttpHeaders): Observable<ServiceResource> {
			return this.http.put<ServiceResource>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Apps_List(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => HttpHeaders): Observable<AppResourceCollection> {
		 ...
		 */
		Apps_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		Apps_Get(syncStatus: string, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => HttpHeaders): Observable<AppResource> {
		 ...
		 */
		Apps_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, requestBody: AppResource, headersHandler?: () => HttpHeaders): Observable<AppResource> {
			return this.http.put<AppResource>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Bindings_List(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => HttpHeaders): Observable<BindingResourceCollection> {
		 ...
		 * @return {void} Success. The response indicates the resource is deleted.
		 */
		Bindings_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, bindingName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		Bindings_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, bindingName: string, headersHandler?: () => HttpHeaders): Observable<BindingResource> {
		 ...
		 */
		Bindings_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, bindingName: string, requestBody: BindingResource, headersHandler?: () => HttpHeaders): Observable<BindingResource> {
			return this.http.put<BindingResource>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/bindings/' + (bindingName == null ? '' : encodeURIComponent(bindingName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Deployments_List(version: Array<string>, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => HttpHeaders): Observable<DeploymentResourceCollection> {
		 ...
		 * @return {void} Success. The response indicates the resource is deleted.
		 */
		Deployments_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		Deployments_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => HttpHeaders): Observable<DeploymentResource> {
		 ...
		 */
		Deployments_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, requestBody: DeploymentResource, headersHandler?: () => HttpHeaders): Observable<DeploymentResource> {
			return this.http.put<DeploymentResource>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Deployments_GetLogFileUrl(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => HttpHeaders): Observable<LogFileUrlResponse> {
		 ...
		 * @return {void} Success.
		 */
		Deployments_Restart(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success.
		 */
		Deployments_Start(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success.
		 */
		Deployments_Stop(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		Apps_GetResourceUploadUrl(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => HttpHeaders): Observable<ResourceUploadDefinition> {
		 ...
		 */
		Deployments_ListClusterAllDeployments(version: Array<string>, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => HttpHeaders): Observable<DeploymentResourceCollection> {
		 ...
		 * @return {void} Success
		 */
		Services_DisableTestEndpoint(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		Services_EnableTestEndpoint(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => HttpHeaders): Observable<TestKeys> {
		 ...
		 */
		Services_ListTestKeys(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => HttpHeaders): Observable<TestKeys> {
		 ...
		 * @return {TestKeys} Success.
		 */
		Services_RegenerateTestKey(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, requestBody: RegenerateTestKeyRequestPayload, headersHandler?: () => HttpHeaders): Observable<TestKeys> {
			return this.http.post<TestKeys>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/regenerateTestKey?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
