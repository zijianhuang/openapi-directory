export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Operations_List(api_version: string, headersHandler?: () => {[header: string]: string}): Promise<AvailableOperations> {
			return fetch(this.baseUri + 'providers/Microsoft.AppPlatform/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_ListBySubscription(api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<ServiceResourceList> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppPlatform/Spring?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_CheckNameAvailability(location: string, api_version: string, subscriptionId: string, requestBody: NameAvailabilityParameters, headersHandler?: () => {[header: string]: string}): Promise<NameAvailability> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppPlatform/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/checkNameAvailability&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Services_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Apps_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Apps_Get(syncStatus: string, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<AppResource> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '?syncStatus=' + (syncStatus == null ? '' : encodeURIComponent(syncStatus)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Bindings_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, bindingName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/bindings/' + (bindingName == null ? '' : encodeURIComponent(bindingName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Deployments_List(version: Array<string>, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<DeploymentResourceCollection> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments?' + version.map(z => `version=${encodeURIComponent(z)}`).join('&') + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Deployments_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Deployments_GetLogFileUrl(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<LogFileUrlResponse> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '/getLogFileUrl?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Deployments_Start(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '/start?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Deployments_Stop(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '/stop?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Apps_GetResourceUploadUrl(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<ResourceUploadDefinition> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/getResourceUploadUrl?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Deployments_ListClusterAllDeployments(version: Array<string>, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<DeploymentResourceCollection> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/deployments?' + version.map(z => `version=${encodeURIComponent(z)}`).join('&') + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_DisableTestEndpoint(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/disableTestEndpoint?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Services_EnableTestEndpoint(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<TestKeys> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/enableTestEndpoint?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_RegenerateTestKey(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, requestBody: RegenerateTestKeyRequestPayload, headersHandler?: () => {[header: string]: string}): Promise<TestKeys> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/regenerateTestKey?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
