...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Operations_List(api_version: string, headersHandler?: () => {[header: string]: string}): Promise<AvailableOperations> {
			return this.http.get('providers/Microsoft.AppPlatform/operations?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_ListBySubscription(api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<ServiceResourceList> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppPlatform/Spring?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_CheckNameAvailability(location: string, api_version: string, subscriptionId: string, requestBody: NameAvailabilityParameters, headersHandler?: () => {[header: string]: string}): Promise<NameAvailability> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/providers/Microsoft.AppPlatform/locations/' + (location == null ? '' : encodeURIComponent(location)) + '/checkNameAvailability&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Services_List(api_version: string, subscriptionId: string, resourceGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<ServiceResourceList> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Services_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Services_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<ServiceResource> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, requestBody: ServiceResource, headersHandler?: () => {[header: string]: string}): Promise<ServiceResource> {
			return this.http.put('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Apps_List(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<AppResourceCollection> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Apps_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Apps_Get(syncStatus: string, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<AppResource> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '?syncStatus=' + (syncStatus == null ? '' : encodeURIComponent(syncStatus)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Apps_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, requestBody: AppResource, headersHandler?: () => {[header: string]: string}): Promise<AppResource> {
			return this.http.put('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Bindings_List(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<BindingResourceCollection> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/bindings?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success. The response indicates the resource is deleted.
		 */
		Bindings_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, bindingName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/bindings/' + (bindingName == null ? '' : encodeURIComponent(bindingName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Bindings_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, bindingName: string, requestBody: BindingResource, headersHandler?: () => {[header: string]: string}): Promise<BindingResource> {
			return this.http.put('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/bindings/' + (bindingName == null ? '' : encodeURIComponent(bindingName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Deployments_List(version: Array<string>, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<DeploymentResourceCollection> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments?' + version.map(z => `version=${encodeURIComponent(z)}`).join('&') + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success. The response indicates the resource is deleted.
		 */
		Deployments_Delete(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Deployments_Get(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<DeploymentResource> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Deployments_CreateOrUpdate(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, requestBody: DeploymentResource, headersHandler?: () => {[header: string]: string}): Promise<DeploymentResource> {
			return this.http.put('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Deployments_GetLogFileUrl(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<LogFileUrlResponse> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '/getLogFileUrl?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success.
		 */
		Deployments_Restart(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '/restart?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success.
		 */
		Deployments_Start(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '/start?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success.
		 */
		Deployments_Stop(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, deploymentName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/deployments/' + (deploymentName == null ? '' : encodeURIComponent(deploymentName)) + '/stop?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Apps_GetResourceUploadUrl(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, appName: string, headersHandler?: () => {[header: string]: string}): Promise<ResourceUploadDefinition> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/apps/' + (appName == null ? '' : encodeURIComponent(appName)) + '/getResourceUploadUrl?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Deployments_ListClusterAllDeployments(version: Array<string>, api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<DeploymentResourceCollection> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/deployments?' + version.map(z => `version=${encodeURIComponent(z)}`).join('&') + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		Services_DisableTestEndpoint(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/disableTestEndpoint?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Services_EnableTestEndpoint(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<TestKeys> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/enableTestEndpoint?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_ListTestKeys(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, headersHandler?: () => {[header: string]: string}): Promise<TestKeys> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/listTestKeys?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Services_RegenerateTestKey(api_version: string, subscriptionId: string, resourceGroupName: string, serviceName: string, requestBody: RegenerateTestKeyRequestPayload, headersHandler?: () => {[header: string]: string}): Promise<TestKeys> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.AppPlatform/Spring/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/regenerateTestKey?api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
