...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Subscription_List(resourceGroupName: string, serviceName: string, filter: string, top: number, skip: number, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/subscriptions&filter=' + (filter == null ? '' : encodeURIComponent(filter)) + '&top=' + top + '&skip=' + skip + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Subscription_Delete(resourceGroupName: string, serviceName: string, sid: string, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/subscriptions/' + (sid == null ? '' : encodeURIComponent(sid)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Subscription_Get(resourceGroupName: string, serviceName: string, sid: string, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/subscriptions/' + (sid == null ? '' : encodeURIComponent(sid)) + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Subscription_CreateOrUpdate(resourceGroupName: string, serviceName: string, sid: string, notify: boolean, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/subscriptions/' + (sid == null ? '' : encodeURIComponent(sid)) + '&notify=' + notify + '&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Subscription_ListSecrets(resourceGroupName: string, serviceName: string, sid: string, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/subscriptions/' + (sid == null ? '' : encodeURIComponent(sid)) + '/listSecrets&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Subscription_RegeneratePrimaryKey(resourceGroupName: string, serviceName: string, sid: string, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/subscriptions/' + (sid == null ? '' : encodeURIComponent(sid)) + '/regeneratePrimaryKey&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Subscription_RegenerateSecondaryKey(resourceGroupName: string, serviceName: string, sid: string, api_version: string, subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)) + '/resourceGroups/' + (resourceGroupName == null ? '' : encodeURIComponent(resourceGroupName)) + '/providers/Microsoft.ApiManagement/service/' + (serviceName == null ? '' : encodeURIComponent(serviceName)) + '/subscriptions/' + (sid == null ? '' : encodeURIComponent(sid)) + '/regenerateSecondaryKey&api_version=' + (api_version == null ? '' : encodeURIComponent(api_version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
