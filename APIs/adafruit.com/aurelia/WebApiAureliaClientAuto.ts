...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateWebhookFeedData(requestBody: CreateWebhookFeedDataBody, headersHandler?: () => {[header: string]: string}): Promise<Data> {
			return this.http.post('webhooks/feed/:token', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateRawWebhookFeedData(headersHandler?: () => {[header: string]: string}): Promise<Data> {
			return this.http.post('webhooks/feed/:token/raw', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DestroyActivities(username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/activities', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AllActivities(username: string, start_time: Date, end_time: Date, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Array<Activity>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/activities&start_time=' + start_time.toISOString() + '&end_time=' + end_time.toISOString() + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetActivity(username: string, type: string, start_time: Date, end_time: Date, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Array<Activity>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/activities/' + (type == null ? '' : encodeURIComponent(type)) + '&start_time=' + start_time.toISOString() + '&end_time=' + end_time.toISOString() + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AllDashboards(username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Dashboard>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDashboard(username: string, requestBody: createDashboardDashboard, headersHandler?: () => {[header: string]: string}): Promise<Dashboard> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllBlocks(username: string, dashboard_id: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Block>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards/' + (dashboard_id == null ? '' : encodeURIComponent(dashboard_id)) + '/blocks', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DestroyBlock(username: string, dashboard_id: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards/' + (dashboard_id == null ? '' : encodeURIComponent(dashboard_id)) + '/blocks/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetBlock(username: string, dashboard_id: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<Block> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards/' + (dashboard_id == null ? '' : encodeURIComponent(dashboard_id)) + '/blocks/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DestroyDashboard(username: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetDashboard(username: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<Dashboard> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReplaceDashboard(username: string, id: string, requestBody: createDashboardDashboard, headersHandler?: () => {[header: string]: string}): Promise<Dashboard> {
			return this.http.put('' + (username == null ? '' : encodeURIComponent(username)) + '/dashboards/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllFeeds(username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Feed>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateFeed(username: string, group_key: string, requestBody: createFeedFeed, headersHandler?: () => {[header: string]: string}): Promise<Feed> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds&group_key=' + (group_key == null ? '' : encodeURIComponent(group_key)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DestroyFeed(username: string, feed_key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetFeed(username: string, feed_key: string, headersHandler?: () => {[header: string]: string}): Promise<Feed> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReplaceFeed(username: string, feed_key: string, requestBody: createFeedFeed, headersHandler?: () => {[header: string]: string}): Promise<Feed> {
			return this.http.put('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateData(username: string, feed_key: string, requestBody: createDataDatum, headersHandler?: () => {[header: string]: string}): Promise<Data> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchCreateData(username: string, feed_key: string, requestBody: Array<string>, headersHandler?: () => {[header: string]: string}): Promise<Array<DataResponse>> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/batch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ChartData(username: string, feed_key: string, start_time: Date, end_time: Date, resolution: number, hours: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/chart&start_time=' + start_time.toISOString() + '&end_time=' + end_time.toISOString() + '&resolution=' + resolution + '&hours=' + hours, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		FirstData(username: string, feed_key: string, include: string, headersHandler?: () => {[header: string]: string}): Promise<DataResponse> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/first&include=' + (include == null ? '' : encodeURIComponent(include)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		LastData(username: string, feed_key: string, include: string, headersHandler?: () => {[header: string]: string}): Promise<DataResponse> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/last&include=' + (include == null ? '' : encodeURIComponent(include)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		NextData(username: string, feed_key: string, include: string, headersHandler?: () => {[header: string]: string}): Promise<DataResponse> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/next&include=' + (include == null ? '' : encodeURIComponent(include)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PreviousData(username: string, feed_key: string, include: string, headersHandler?: () => {[header: string]: string}): Promise<DataResponse> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/previous&include=' + (include == null ? '' : encodeURIComponent(include)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RetainData(username: string, feed_key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/retain', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DestroyData(username: string, feed_key: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetData(username: string, feed_key: string, id: string, include: string, headersHandler?: () => {[header: string]: string}): Promise<DataResponse> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/' + (id == null ? '' : encodeURIComponent(id)) + '&include=' + (include == null ? '' : encodeURIComponent(include)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReplaceData(username: string, feed_key: string, id: string, requestBody: createDataDatum, headersHandler?: () => {[header: string]: string}): Promise<DataResponse> {
			return this.http.put('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/data/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetFeedDetails(username: string, feed_key: string, headersHandler?: () => {[header: string]: string}): Promise<Feed> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/feeds/' + (feed_key == null ? '' : encodeURIComponent(feed_key)) + '/details', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AllGroups(username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Group>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/groups', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateGroup(username: string, requestBody: createGroupGroup, headersHandler?: () => {[header: string]: string}): Promise<Group> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DestroyGroup(username: string, group_key: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetGroup(username: string, group_key: string, headersHandler?: () => {[header: string]: string}): Promise<Group> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReplaceGroup(username: string, group_key: string, requestBody: createGroupGroup, headersHandler?: () => {[header: string]: string}): Promise<Group> {
			return this.http.put('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddFeedToGroup(group_key: string, username: string, feed_key: string, headersHandler?: () => {[header: string]: string}): Promise<Group> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)) + '/add&feed_key=' + (feed_key == null ? '' : encodeURIComponent(feed_key)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateGroupData(username: string, group_key: string, requestBody: CreateGroupDataBody, headersHandler?: () => {[header: string]: string}): Promise<Array<DataResponse>> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)) + '/data', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllGroupFeeds(group_key: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Feed>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)) + '/feeds', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateGroupFeed(username: string, group_key: string, requestBody: createFeedFeed, headersHandler?: () => {[header: string]: string}): Promise<Feed> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)) + '/feeds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveFeedFromGroup(group_key: string, username: string, feed_key: string, headersHandler?: () => {[header: string]: string}): Promise<Group> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/groups/' + (group_key == null ? '' : encodeURIComponent(group_key)) + '/remove&feed_key=' + (feed_key == null ? '' : encodeURIComponent(feed_key)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCurrentUserThrottle(username: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/throttle', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AllTokens(username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Token>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/tokens', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateToken(username: string, requestBody: createTokenToken, headersHandler?: () => {[header: string]: string}): Promise<Token> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/tokens', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DestroyToken(username: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/tokens/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetToken(username: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<Token> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/tokens/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReplaceToken(username: string, id: string, requestBody: createTokenToken, headersHandler?: () => {[header: string]: string}): Promise<Token> {
			return this.http.put('' + (username == null ? '' : encodeURIComponent(username)) + '/tokens/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllTriggers(username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Trigger>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/triggers', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateTrigger(username: string, requestBody: createTriggerTrigger, headersHandler?: () => {[header: string]: string}): Promise<Trigger> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/triggers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DestroyTrigger(username: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/triggers/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetTrigger(username: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<Trigger> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/triggers/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReplaceTrigger(username: string, id: string, requestBody: createTriggerTrigger, headersHandler?: () => {[header: string]: string}): Promise<Trigger> {
			return this.http.put('' + (username == null ? '' : encodeURIComponent(username)) + '/triggers/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllPermissions(username: string, type: string, type_id: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Permission>> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (type_id == null ? '' : encodeURIComponent(type_id)) + '/acl', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePermission(username: string, type: string, type_id: string, requestBody: createPermissionPermission, headersHandler?: () => {[header: string]: string}): Promise<Permission> {
			return this.http.post('' + (username == null ? '' : encodeURIComponent(username)) + '/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (type_id == null ? '' : encodeURIComponent(type_id)) + '/acl', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DestroyPermission(username: string, type: string, type_id: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('' + (username == null ? '' : encodeURIComponent(username)) + '/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (type_id == null ? '' : encodeURIComponent(type_id)) + '/acl/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetPermission(username: string, type: string, type_id: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<Permission> {
			return this.http.get('' + (username == null ? '' : encodeURIComponent(username)) + '/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (type_id == null ? '' : encodeURIComponent(type_id)) + '/acl/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReplacePermission(username: string, type: string, type_id: string, id: string, requestBody: createPermissionPermission, headersHandler?: () => {[header: string]: string}): Promise<Permission> {
			return this.http.put('' + (username == null ? '' : encodeURIComponent(username)) + '/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (type_id == null ? '' : encodeURIComponent(type_id)) + '/acl/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
