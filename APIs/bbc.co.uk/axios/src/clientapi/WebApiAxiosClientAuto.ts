...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BroadcastsGetByOffsetAndLimitAndService_idAndDateAndSort(offset: number, limit: number, service_id: string, date: string, sort: string, headersHandler?: () => {[header: string]: string}): Promise<BroadcastsResponse> {
			return Axios.get<BroadcastsResponse>(this.baseUri + 'broadcasts?offset=' + offset + '&limit=' + limit + '&service_id=' + (service_id == null ? '' : encodeURIComponent(service_id)) + '&date=' + (date == null ? '' : encodeURIComponent(date)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBroadcastByPid(pid: string, headersHandler?: () => {[header: string]: string}): Promise<BroadcastsResponse> {
			return Axios.get<BroadcastsResponse>(this.baseUri + 'broadcasts/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CategoriesGetByKind(kind: string, headersHandler?: () => {[header: string]: string}): Promise<CategoriesResponse> {
			return Axios.get<CategoriesResponse>(this.baseUri + 'categories?kind=' + (kind == null ? '' : encodeURIComponent(kind)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CategoriesGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<CategoriesResponse> {
			return Axios.get<CategoriesResponse>(this.baseUri + 'categories/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetCollectionMembers(pid: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<ProgrammesResponse> {
			return Axios.get<ProgrammesResponse>(this.baseUri + 'collections/' + (pid == null ? '' : encodeURIComponent(pid)) + '/members&offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetExperienceHomepage(headersHandler?: () => {[header: string]: string}): Promise<ExperienceResponse> {
			return Axios.get<ExperienceResponse>(this.baseUri + 'experience/homepage', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMusicPopularArtists(since: string, until: string, decomposed: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityArtists> {
			return Axios.get<MusicPopularityArtists>(this.baseUri + 'music/popular/artists?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed + '&offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMusicPopularArtistById(since: string, until: string, decomposed: boolean, id: string, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityArtists> {
			return Axios.get<MusicPopularityArtists>(this.baseUri + 'music/popular/artists/' + (id == null ? '' : encodeURIComponent(id)) + '?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMusicPopularPlaylists(since: string, until: string, decomposed: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityPlaylists> {
			return Axios.get<MusicPopularityPlaylists>(this.baseUri + 'music/popular/playlists?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed + '&offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMusicPopularPlaylistById(since: string, until: string, decomposed: boolean, id: string, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityPlaylists> {
			return Axios.get<MusicPopularityPlaylists>(this.baseUri + 'music/popular/playlists/' + (id == null ? '' : encodeURIComponent(id)) + '?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Personalised_CategoriesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'my/categories/follows', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Personalised_CategoriesGetByOffsetAndLimit(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedCategoriesResponse> {
			return Axios.get<PersonalisedCategoriesResponse>(this.baseUri + 'my/categories/follows?offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Personalised_CategoriesPost(requestBody: Body, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'my/categories/follows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetMusicExport(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<MusicExportJob> {
			return Axios.get<MusicExportJob>(this.baseUri + 'my/music/export?offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMusicExportJobs(over16: boolean, vendor: string, headersHandler?: () => {[header: string]: string}): Promise<MusicExportJob> {
			return Axios.get<MusicExportJob>(this.baseUri + 'my/music/exports/jobs?over16=' + over16 + '&vendor=' + (vendor == null ? '' : encodeURIComponent(vendor)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostMusicExportJob(over16: boolean, vendor: string, requestBody: Array<MusicExportJob>, headersHandler?: () => {[header: string]: string}): Promise<MusicExportSuccess> {
			return Axios.post<MusicExportSuccess>(this.baseUri + 'my/music/exports/jobs?over16=' + over16 + '&vendor=' + (vendor == null ? '' : encodeURIComponent(vendor)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMusicExportTracks(over16: boolean, offset: number, limit: number, vendor: string, status: string, headersHandler?: () => {[header: string]: string}): Promise<MusicExportJob> {
			return Axios.get<MusicExportJob>(this.baseUri + 'my/music/exports/tracks?over16=' + over16 + '&offset=' + offset + '&limit=' + limit + '&vendor=' + (vendor == null ? '' : encodeURIComponent(vendor)) + '&status=' + (status == null ? '' : encodeURIComponent(status)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPersonalisedMusicFavourites(offset: number, limit: number, action: string, music_data: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return Axios.get<PersonalisedMusicResponse>(this.baseUri + 'my/music/favourites?offset=' + offset + '&limit=' + limit + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&music_data=' + music_data, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostPersonalisedMusicFavouritesBatch(requestBody: Array<PersonalisedMusicBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return Axios.post<PersonalisedMusicResponse>(this.baseUri + 'my/music/favourites', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutPersonalisedMusicFavouritesBatch(requestBody: Array<PersonalisedMusicBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return Axios.put<PersonalisedMusicSuccess>(this.baseUri + 'my/music/favourites', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPersonalisedMusicFavouritesByType(type: string, action: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return Axios.get<PersonalisedMusicResponse>(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeletePersonalisedMusicFavouritesByTypeById(type: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return Axios.delete<PersonalisedMusicSuccess>(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPersonalisedMusicFavouritesByTypeById(type: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return Axios.get<PersonalisedMusicResponse>(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostPersonalisedMusicFavouritesByTypeById(type: string, id: string, requestBody: PersonalisedMusicRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return Axios.post<PersonalisedMusicResponse>(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutPersonalisedMusicFavouritesByTypeById(type: string, id: string, requestBody: PersonalisedMusicRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return Axios.put<PersonalisedMusicSuccess>(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteMusicPreferencesExport(headersHandler?: () => {[header: string]: string}): Promise<MusicExportSuccess> {
			return Axios.delete<MusicExportSuccess>(this.baseUri + 'my/music/preferences/export', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMusicPreferencesExport(headersHandler?: () => {[header: string]: string}): Promise<MusicExportPreferencesResponse> {
			return Axios.get<MusicExportPreferencesResponse>(this.baseUri + 'my/music/preferences/export', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostMusicPreferencesExport(requestBody: MusicExportPreferences, headersHandler?: () => {[header: string]: string}): Promise<MusicExportSuccess> {
			return Axios.post<MusicExportSuccess>(this.baseUri + 'my/music/preferences/export', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} OK
		 */
		DeleteMusicPreferencesExportVendor(vendor: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetMusicPreferencesExportVendor(vendor: string, headersHandler?: () => {[header: string]: string}): Promise<MusicExportPreferencesResponse> {
			return Axios.get<MusicExportPreferencesResponse>(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} OK
		 */
		PostMusicPreferencesExportVendor(vendor: string, requestBody: MusicExportPreferences, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} OK
		 */
		PutMusicPreferencesExportVendor(vendor: string, requestBody: MusicExportPreferences, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Personalised_NetworksDeleteByOffsetAndLimit(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'my/networks/follows?offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Personalised_NetworksGetByOffsetAndLimit(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedNetworksResponse> {
			return Axios.get<PersonalisedNetworksResponse>(this.baseUri + 'my/networks/follows?offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Personalised_NetworksPostByOffsetAndLimit(offset: number, limit: number, requestBody: Body_2, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'my/networks/follows?offset=' + offset + '&limit=' + limit, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Personalised_PlaysPost(requestBody: Body_4, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'my/plays', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		SuggestContainer(previous_pid: string, previous_container: string, headersHandler?: () => {[header: string]: string}): Promise<PlayspaceContainer> {
			return Axios.get<PlayspaceContainer>(this.baseUri + 'my/playspace/containers/suggested?previous_pid=' + (previous_pid == null ? '' : encodeURIComponent(previous_pid)) + '&previous_container=' + (previous_container == null ? '' : encodeURIComponent(previous_container)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetContainer(id: string, headersHandler?: () => {[header: string]: string}): Promise<PlayspaceContainer> {
			return Axios.get<PlayspaceContainer>(this.baseUri + 'my/playspace/containers/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetRecommendations(offset: number, limit: number, rights: string, headersHandler?: () => {[header: string]: string}): Promise<ProgrammesResponse> {
			return Axios.get<ProgrammesResponse>(this.baseUri + 'my/programmes/recommendations?offset=' + offset + '&limit=' + limit + '&rights=' + (rights == null ? '' : encodeURIComponent(rights)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPersonalisedRadioFavourites(offset: number, limit: number, sort: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return Axios.get<PersonalisedRadioResponse>(this.baseUri + 'my/radio/favourites?offset=' + offset + '&limit=' + limit + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostPersonalisedRadioBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.post<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/favourites', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutPersonalisedRadioBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.put<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/favourites', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPersonalisedRadioFavouritesByType(type: string, sort: string, show_all_activity: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return Axios.get<PersonalisedRadioResponse>(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity + '&offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeletePersonalisedRadioByActivityTypeById(type: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.delete<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPersonalisedRadioByActivityTypeById(type: string, pid: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return Axios.get<PersonalisedRadioResponse>(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)) + '&show_all_activity=' + show_all_activity, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostPersonalisedRadioByActivityTypeById(type: string, pid: string, requestBody: PersonalisedRadioRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.post<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutPersonalisedRadioByActivityTypeById(type: string, pid: string, requestBody: PersonalisedRadioRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.put<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPersonalisedRadioFollows(offset: number, limit: number, sort: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return Axios.get<PersonalisedRadioResponse>(this.baseUri + 'my/radio/follows?offset=' + offset + '&limit=' + limit + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostPersonalisedRadioFollowsBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.post<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/follows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutPersonalisedRadioFollowsBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.put<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/follows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPersonalisedRadioFollowsByType(type: string, sort: string, offset: number, limit: number, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return Axios.get<PersonalisedRadioResponse>(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&offset=' + offset + '&limit=' + limit + '&show_all_activity=' + show_all_activity, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeletePersonalisedRadioFollowsByTypeById(type: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.delete<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPersonalisedRadioFollowsByTypeById(type: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return Axios.get<PersonalisedRadioResponse>(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PostPersonalisedRadioFollowsByTypeById(type: string, pid: string, requestBody: PersonalisedRadioRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return Axios.post<PersonalisedRadioSuccessResponse>(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPersonalisedRadioPlays(offset: number, limit: number, sort: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return Axios.get<PersonalisedRadioResponse>(this.baseUri + 'my/radio/plays?offset=' + offset + '&limit=' + limit + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPodcastsFeatured(headersHandler?: () => {[header: string]: string}): Promise<PodcastsFeaturedResponse> {
			return Axios.get<PodcastsFeaturedResponse>(this.baseUri + 'podcasts/featured', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPodcastByPid(pid: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PodcastsResponse> {
			return Axios.get<PodcastsResponse>(this.baseUri + 'podcasts/' + (pid == null ? '' : encodeURIComponent(pid)) + '&offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPodcastEpisodes(pid: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PodcastEpisodesResponse> {
			return Axios.get<PodcastEpisodesResponse>(this.baseUri + 'podcasts/' + (pid == null ? '' : encodeURIComponent(pid)) + '/episodes&offset=' + offset + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetRadioNetworks(preset: boolean, international: boolean, headersHandler?: () => {[header: string]: string}): Promise<NetworksResponse> {
			return Axios.get<NetworksResponse>(this.baseUri + 'radio/networks.json?preset=' + preset + '&international=' + international, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetRadioProgrammesByPid(pid: string, headersHandler?: () => {[header: string]: string}): Promise<ProgrammesResponse> {
			return Axios.get<ProgrammesResponse>(this.baseUri + 'radio/programmes/' + (pid == null ? '' : encodeURIComponent(pid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
