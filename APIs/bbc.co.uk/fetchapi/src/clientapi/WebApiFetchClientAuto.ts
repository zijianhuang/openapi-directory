export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BroadcastsGetByOffsetAndLimitAndService_idAndDateAndSort(offset: number, limit: number, service_id: string, date: string, sort: string, headersHandler?: () => {[header: string]: string}): Promise<BroadcastsResponse> {
			return fetch(this.baseUri + 'broadcasts?offset=' + offset + '&limit=' + limit + '&service_id=' + (service_id == null ? '' : encodeURIComponent(service_id)) + '&date=' + (date == null ? '' : encodeURIComponent(date)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BroadcastsGetByOffsetAndLimitAndService_idAndOn_airAndNextAndPreviousAndSort(offset: number, limit: number, service_id: string, on_air: string, next: string, previous: string, sort: string, headersHandler?: () => {[header: string]: string}): Promise<BroadcastsResponse> {
			return fetch(this.baseUri + 'broadcasts/latest?offset=' + offset + '&limit=' + limit + '&service_id=' + (service_id == null ? '' : encodeURIComponent(service_id)) + '&on_air=' + (on_air == null ? '' : encodeURIComponent(on_air)) + '&next=' + (next == null ? '' : encodeURIComponent(next)) + '&previous=' + (previous == null ? '' : encodeURIComponent(previous)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBroadcastByPid(pid: string, headersHandler?: () => {[header: string]: string}): Promise<BroadcastsResponse> {
			return fetch(this.baseUri + 'broadcasts/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CategoriesGetByKind(kind: string, headersHandler?: () => {[header: string]: string}): Promise<CategoriesResponse> {
			return fetch(this.baseUri + 'categories?kind=' + (kind == null ? '' : encodeURIComponent(kind)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CategoriesGetById(id: string, headersHandler?: () => {[header: string]: string}): Promise<CategoriesResponse> {
			return fetch(this.baseUri + 'categories/' + (id == null ? '' : encodeURIComponent(id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCollectionMembers(pid: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<ProgrammesResponse> {
			return fetch(this.baseUri + 'collections/' + (pid == null ? '' : encodeURIComponent(pid)) + '/members&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetExperienceHomepage(headersHandler?: () => {[header: string]: string}): Promise<ExperienceResponse> {
			return fetch(this.baseUri + 'experience/homepage', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicPopularArtists(since: string, until: string, decomposed: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityArtists> {
			return fetch(this.baseUri + 'music/popular/artists?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed + '&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicPopularArtistById(since: string, until: string, decomposed: boolean, id: string, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityArtists> {
			return fetch(this.baseUri + 'music/popular/artists/' + (id == null ? '' : encodeURIComponent(id)) + '?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicPopularPlaylists(since: string, until: string, decomposed: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityPlaylists> {
			return fetch(this.baseUri + 'music/popular/playlists?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed + '&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicPopularPlaylistById(since: string, until: string, decomposed: boolean, id: string, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityPlaylists> {
			return fetch(this.baseUri + 'music/popular/playlists/' + (id == null ? '' : encodeURIComponent(id)) + '?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&decomposed=' + decomposed, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicPopularTracks(since: string, until: string, network: string, programme: string, artist: string, decomposed: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityTracks> {
			return fetch(this.baseUri + 'music/popular/tracks?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&network=' + (network == null ? '' : encodeURIComponent(network)) + '&programme=' + (programme == null ? '' : encodeURIComponent(programme)) + '&artist=' + (artist == null ? '' : encodeURIComponent(artist)) + '&decomposed=' + decomposed + '&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicPopularTrackById(since: string, until: string, network: string, programme: string, artist: string, decomposed: boolean, id: string, headersHandler?: () => {[header: string]: string}): Promise<MusicPopularityTracks> {
			return fetch(this.baseUri + 'music/popular/tracks/' + (id == null ? '' : encodeURIComponent(id)) + '?since=' + (since == null ? '' : encodeURIComponent(since)) + '&until=' + (until == null ? '' : encodeURIComponent(until)) + '&network=' + (network == null ? '' : encodeURIComponent(network)) + '&programme=' + (programme == null ? '' : encodeURIComponent(programme)) + '&artist=' + (artist == null ? '' : encodeURIComponent(artist)) + '&decomposed=' + decomposed, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Personalised_CategoriesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/categories/follows', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Personalised_CategoriesGetByOffsetAndLimit(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedCategoriesResponse> {
			return fetch(this.baseUri + 'my/categories/follows?offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Personalised_CategoriesPost(requestBody: Body, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/categories/follows', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetMusicExport(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<MusicExportJob> {
			return fetch(this.baseUri + 'my/music/export?offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicExportJobs(over16: boolean, vendor: string, headersHandler?: () => {[header: string]: string}): Promise<MusicExportJob> {
			return fetch(this.baseUri + 'my/music/exports/jobs?over16=' + over16 + '&vendor=' + (vendor == null ? '' : encodeURIComponent(vendor)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicExportTracks(over16: boolean, offset: number, limit: number, vendor: string, status: string, headersHandler?: () => {[header: string]: string}): Promise<MusicExportJob> {
			return fetch(this.baseUri + 'my/music/exports/tracks?over16=' + over16 + '&offset=' + offset + '&limit=' + limit + '&vendor=' + (vendor == null ? '' : encodeURIComponent(vendor)) + '&status=' + (status == null ? '' : encodeURIComponent(status)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPersonalisedMusicFavourites(offset: number, limit: number, action: string, music_data: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return fetch(this.baseUri + 'my/music/favourites?offset=' + offset + '&limit=' + limit + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&music_data=' + music_data, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPersonalisedMusicFavouritesBatch(requestBody: Array<PersonalisedMusicBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return fetch(this.baseUri + 'my/music/favourites', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPersonalisedMusicFavouritesBatch(requestBody: Array<PersonalisedMusicBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return fetch(this.baseUri + 'my/music/favourites', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonalisedMusicFavouritesByType(type: string, action: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return fetch(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeletePersonalisedMusicFavouritesByTypeById(type: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return fetch(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPersonalisedMusicFavouritesByTypeById(type: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return fetch(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPersonalisedMusicFavouritesByTypeById(type: string, id: string, requestBody: PersonalisedMusicRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return fetch(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPersonalisedMusicFavouritesByTypeById(type: string, id: string, requestBody: PersonalisedMusicRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return fetch(this.baseUri + 'my/music/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonalisedMusicFollows(action: string, music_data: boolean, music_context: string, music_within_uk: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return fetch(this.baseUri + 'my/music/follows?action=' + (action == null ? '' : encodeURIComponent(action)) + '&music_data=' + music_data + '&music_context=' + (music_context == null ? '' : encodeURIComponent(music_context)) + '&music_within_uk=' + music_within_uk + '&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPersonalisedMusicFollowsBatch(action: string, music_data: boolean, music_context: string, music_within_uk: boolean, requestBody: Array<PersonalisedMusicBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return fetch(this.baseUri + 'my/music/follows?action=' + (action == null ? '' : encodeURIComponent(action)) + '&music_data=' + music_data + '&music_context=' + (music_context == null ? '' : encodeURIComponent(music_context)) + '&music_within_uk=' + music_within_uk, { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPersonalisedMusicFollowsBatch(action: string, music_data: boolean, music_context: string, music_within_uk: boolean, requestBody: Array<PersonalisedMusicBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicSuccess> {
			return fetch(this.baseUri + 'my/music/follows?action=' + (action == null ? '' : encodeURIComponent(action)) + '&music_data=' + music_data + '&music_context=' + (music_context == null ? '' : encodeURIComponent(music_context)) + '&music_within_uk=' + music_within_uk, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonalisedMusicFollowsByTypeById(type: string, id: string, music_data: boolean, music_context: string, music_within_uk: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedMusicResponse> {
			return fetch(this.baseUri + 'my/music/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (id == null ? '' : encodeURIComponent(id)) + '&music_data=' + music_data + '&music_context=' + (music_context == null ? '' : encodeURIComponent(music_context)) + '&music_within_uk=' + music_within_uk, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteMusicPreferencesExport(headersHandler?: () => {[header: string]: string}): Promise<MusicExportSuccess> {
			return fetch(this.baseUri + 'my/music/preferences/export', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMusicPreferencesExport(headersHandler?: () => {[header: string]: string}): Promise<MusicExportPreferencesResponse> {
			return fetch(this.baseUri + 'my/music/preferences/export', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostMusicPreferencesExport(requestBody: MusicExportPreferences, headersHandler?: () => {[header: string]: string}): Promise<MusicExportSuccess> {
			return fetch(this.baseUri + 'my/music/preferences/export', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteMusicPreferencesExportVendor(vendor: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetMusicPreferencesExportVendor(vendor: string, headersHandler?: () => {[header: string]: string}): Promise<MusicExportPreferencesResponse> {
			return fetch(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostMusicPreferencesExportVendor(vendor: string, requestBody: MusicExportPreferences, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		PutMusicPreferencesExportVendor(vendor: string, requestBody: MusicExportPreferences, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/music/preferences/export/' + (vendor == null ? '' : encodeURIComponent(vendor)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Personalised_NetworksDeleteByOffsetAndLimit(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/networks/follows?offset=' + offset + '&limit=' + limit, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Personalised_NetworksGetByOffsetAndLimit(offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedNetworksResponse> {
			return fetch(this.baseUri + 'my/networks/follows?offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Personalised_NetworksPostByOffsetAndLimit(offset: number, limit: number, requestBody: Body_2, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/networks/follows?offset=' + offset + '&limit=' + limit, { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Personalised_PlaysPost(requestBody: Body_4, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'my/plays', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		SuggestContainer(previous_pid: string, previous_container: string, headersHandler?: () => {[header: string]: string}): Promise<PlayspaceContainer> {
			return fetch(this.baseUri + 'my/playspace/containers/suggested?previous_pid=' + (previous_pid == null ? '' : encodeURIComponent(previous_pid)) + '&previous_container=' + (previous_container == null ? '' : encodeURIComponent(previous_container)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetContainer(id: string, headersHandler?: () => {[header: string]: string}): Promise<PlayspaceContainer> {
			return fetch(this.baseUri + 'my/playspace/containers/' + (id == null ? '' : encodeURIComponent(id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRecommendations(offset: number, limit: number, rights: string, headersHandler?: () => {[header: string]: string}): Promise<ProgrammesResponse> {
			return fetch(this.baseUri + 'my/programmes/recommendations?offset=' + offset + '&limit=' + limit + '&rights=' + (rights == null ? '' : encodeURIComponent(rights)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPersonalisedRadioFavourites(offset: number, limit: number, sort: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return fetch(this.baseUri + 'my/radio/favourites?offset=' + offset + '&limit=' + limit + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPersonalisedRadioBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/favourites', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPersonalisedRadioBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/favourites', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonalisedRadioFavouritesByType(type: string, sort: string, show_all_activity: boolean, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return fetch(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity + '&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeletePersonalisedRadioByActivityTypeById(type: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPersonalisedRadioByActivityTypeById(type: string, pid: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return fetch(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)) + '&show_all_activity=' + show_all_activity, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPersonalisedRadioByActivityTypeById(type: string, pid: string, requestBody: PersonalisedRadioRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPersonalisedRadioByActivityTypeById(type: string, pid: string, requestBody: PersonalisedRadioRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/favourites/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonalisedRadioFollows(offset: number, limit: number, sort: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return fetch(this.baseUri + 'my/radio/follows?offset=' + offset + '&limit=' + limit + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPersonalisedRadioFollowsBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/follows', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPersonalisedRadioFollowsBatch(requestBody: Array<PersonalisedRadioBatchRequest>, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/follows', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonalisedRadioFollowsByType(type: string, sort: string, offset: number, limit: number, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return fetch(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&offset=' + offset + '&limit=' + limit + '&show_all_activity=' + show_all_activity, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeletePersonalisedRadioFollowsByTypeById(type: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPersonalisedRadioFollowsByTypeById(type: string, pid: string, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return fetch(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostPersonalisedRadioFollowsByTypeById(type: string, pid: string, requestBody: PersonalisedRadioRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPersonalisedRadioFollowsByTypeById(type: string, pid: string, requestBody: PersonalisedRadioRequest, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioSuccessResponse> {
			return fetch(this.baseUri + 'my/radio/follows/' + (type == null ? '' : encodeURIComponent(type)) + '/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonalisedRadioPlays(offset: number, limit: number, sort: string, show_all_activity: boolean, headersHandler?: () => {[header: string]: string}): Promise<PersonalisedRadioResponse> {
			return fetch(this.baseUri + 'my/radio/plays?offset=' + offset + '&limit=' + limit + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&show_all_activity=' + show_all_activity, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPodcasts(offset: number, limit: number, sort: string, network: string, network_url_key: string, category: string, q: string, coverage: string, headersHandler?: () => {[header: string]: string}): Promise<PodcastsResponse> {
			return fetch(this.baseUri + 'podcasts?offset=' + offset + '&limit=' + limit + '&sort=' + (sort == null ? '' : encodeURIComponent(sort)) + '&network=' + (network == null ? '' : encodeURIComponent(network)) + '&network_url_key=' + (network_url_key == null ? '' : encodeURIComponent(network_url_key)) + '&category=' + (category == null ? '' : encodeURIComponent(category)) + '&q=' + (q == null ? '' : encodeURIComponent(q)) + '&coverage=' + (coverage == null ? '' : encodeURIComponent(coverage)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPodcastsFeatured(headersHandler?: () => {[header: string]: string}): Promise<PodcastsFeaturedResponse> {
			return fetch(this.baseUri + 'podcasts/featured', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPodcastByPid(pid: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PodcastsResponse> {
			return fetch(this.baseUri + 'podcasts/' + (pid == null ? '' : encodeURIComponent(pid)) + '&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPodcastEpisodes(pid: string, offset: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PodcastEpisodesResponse> {
			return fetch(this.baseUri + 'podcasts/' + (pid == null ? '' : encodeURIComponent(pid)) + '/episodes&offset=' + offset + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRadioNetworks(preset: boolean, international: boolean, headersHandler?: () => {[header: string]: string}): Promise<NetworksResponse> {
			return fetch(this.baseUri + 'radio/networks.json?preset=' + preset + '&international=' + international, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRadioProgrammesByPid(pid: string, headersHandler?: () => {[header: string]: string}): Promise<ProgrammesResponse> {
			return fetch(this.baseUri + 'radio/programmes/' + (pid == null ? '' : encodeURIComponent(pid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
