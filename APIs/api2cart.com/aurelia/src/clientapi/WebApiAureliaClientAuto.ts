...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {string} successful operation
		 */
		AccountCartList(params: string, exclude: string, request_from_date: string, request_to_date: string, store_url: string, store_key: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('account.cart.list.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&request_from_date=' + (request_from_date == null ? '' : encodeURIComponent(request_from_date)) + '&request_to_date=' + (request_to_date == null ? '' : encodeURIComponent(request_to_date)) + '&store_url=' + (store_url == null ? '' : encodeURIComponent(store_url)) + '&store_key=' + (store_key == null ? '' : encodeURIComponent(store_key)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AccountFailedWebhooks(count: number, start: number, ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('account.failed_webhooks.json?count=' + count + '&start=' + start + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AccountSupportedPlatforms(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('account.supported_platforms.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeAssignGroup(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('attribute.assign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeAssignSet(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('attribute.assign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeAttributesetList(start: number, count: number, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('attribute.attributeset.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeCount(type: string, store_id: string, lang_id: string, visible: boolean, required: boolean, system: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('attribute.count.json?type=' + (type == null ? '' : encodeURIComponent(type)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&visible=' + visible + '&required=' + required + '&system=' + system, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeDelete(store_id: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('attribute.delete.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeGroupList(start: number, count: number, params: string, exclude: string, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('attribute.group.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeInfo(id: string, store_id: string, lang_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('attribute.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeList(start: number, count: number, type: string, attribute_ids: string, store_id: string, lang_id: string, params: string, exclude: string, visible: boolean, required: boolean, system: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('attribute.list.json?start=' + start + '&count=' + count + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&attribute_ids=' + (attribute_ids == null ? '' : encodeURIComponent(attribute_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&visible=' + visible + '&required=' + required + '&system=' + system, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeTypeList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('attribute.type.list.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeUnassignGroup(id: string, group_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('attribute.unassign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeUnassignSet(id: string, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('attribute.unassign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketInfo(id: string, store_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('basket.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketItemAdd(customer_id: string, product_id: string, variant_id: string, quantity: number, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('basket.item.add.json?customer_id=' + (customer_id == null ? '' : encodeURIComponent(customer_id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&variant_id=' + (variant_id == null ? '' : encodeURIComponent(variant_id)) + '&quantity=' + quantity + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketLiveShippingServiceCreate(store_id: string, name: string, callback: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('basket.live_shipping_service.create.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&callback=' + (callback == null ? '' : encodeURIComponent(callback)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketLiveShippingServiceDelete(id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('basket.live_shipping_service.delete.json?id=' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketLiveShippingServiceList(store_id: string, start: number, count: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('basket.live_shipping_service.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		BridgeDelete(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('bridge.delete.json', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 */
		BridgeDownload(whitelabel: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('bridge.download.file?whitelabel=' + whitelabel, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {string} successful operation
		 */
		BridgeUpdate(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('bridge.update.json', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartBridge(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.bridge.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartClearCache(cache_type: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('cart.clear_cache.json?cache_type=' + (cache_type == null ? '' : encodeURIComponent(cache_type)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartConfig(params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.config.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartConfigUpdate(requestBody: CartConfigUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('cart.config.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponAdd(requestBody: CartCouponAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('cart.coupon.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponConditionAdd(store_id: string, coupon_id: string, target: string, entity: string, key: string, operator: string, value: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('cart.coupon.condition.add.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&coupon_id=' + (coupon_id == null ? '' : encodeURIComponent(coupon_id)) + '&target=' + (target == null ? '' : encodeURIComponent(target)) + '&entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&key=' + (key == null ? '' : encodeURIComponent(key)) + '&operator=' + (operator == null ? '' : encodeURIComponent(operator)) + '&value=' + (value == null ? '' : encodeURIComponent(value)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponCount(store_id: string, date_start_from: string, date_start_to: string, date_end_from: string, date_end_to: string, avail: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.coupon.count.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&date_start_from=' + (date_start_from == null ? '' : encodeURIComponent(date_start_from)) + '&date_start_to=' + (date_start_to == null ? '' : encodeURIComponent(date_start_to)) + '&date_end_from=' + (date_end_from == null ? '' : encodeURIComponent(date_end_from)) + '&date_end_to=' + (date_end_to == null ? '' : encodeURIComponent(date_end_to)) + '&avail=' + avail, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponDelete(id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('cart.coupon.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponList(start: number, count: number, coupons_ids: string, store_id: string, date_start_from: string, date_start_to: string, date_end_from: string, date_end_to: string, avail: boolean, lang_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.coupon.list.json?start=' + start + '&count=' + count + '&coupons_ids=' + (coupons_ids == null ? '' : encodeURIComponent(coupons_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&date_start_from=' + (date_start_from == null ? '' : encodeURIComponent(date_start_from)) + '&date_start_to=' + (date_start_to == null ? '' : encodeURIComponent(date_start_to)) + '&date_end_from=' + (date_end_from == null ? '' : encodeURIComponent(date_end_from)) + '&date_end_to=' + (date_end_to == null ? '' : encodeURIComponent(date_end_to)) + '&avail=' + avail + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartDelete(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('cart.delete.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartDisconnect(delete_bridge: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.disconnect.json?delete_bridge=' + delete_bridge, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartGiftcardAdd(amount: number, code: string, owner_email: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('cart.giftcard.add.json?amount=' + amount + '&code=' + (code == null ? '' : encodeURIComponent(code)) + '&owner_email=' + (owner_email == null ? '' : encodeURIComponent(owner_email)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartGiftcardCount(store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.giftcard.count.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartGiftcardList(start: number, count: number, store_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.giftcard.list.json?start=' + start + '&count=' + count + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartInfo(params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.list.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartMethods(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.methods.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartPluginList(store_key: string, store_id: string, start: number, count: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.plugin.list.json?store_key=' + (store_key == null ? '' : encodeURIComponent(store_key)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartScriptAdd(name: string, description: string, html: string, src: string, load_method: string, scope: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('cart.script.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&html=' + (html == null ? '' : encodeURIComponent(html)) + '&src=' + (src == null ? '' : encodeURIComponent(src)) + '&load_method=' + (load_method == null ? '' : encodeURIComponent(load_method)) + '&scope=' + (scope == null ? '' : encodeURIComponent(scope)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartScriptDelete(id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('cart.script.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartScriptList(start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, modified_from: string, modified_to: string, script_ids: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.script.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&script_ids=' + (script_ids == null ? '' : encodeURIComponent(script_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartShippingZonesList(store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.shipping_zones.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CartValidate(validate_version: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('cart.validate.json?validate_version=' + validate_version, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryAdd(name: string, parent_id: string, stores_ids: string, store_id: string, avail: boolean, sort_order: number, created_time: string, modified_time: string, description: string, meta_title: string, meta_description: string, meta_keywords: string, seo_url: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('category.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&avail=' + avail + '&sort_order=' + sort_order + '&created_time=' + (created_time == null ? '' : encodeURIComponent(created_time)) + '&modified_time=' + (modified_time == null ? '' : encodeURIComponent(modified_time)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&meta_title=' + (meta_title == null ? '' : encodeURIComponent(meta_title)) + '&meta_description=' + (meta_description == null ? '' : encodeURIComponent(meta_description)) + '&meta_keywords=' + (meta_keywords == null ? '' : encodeURIComponent(meta_keywords)) + '&seo_url=' + (seo_url == null ? '' : encodeURIComponent(seo_url)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryAssign(product_id: string, category_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('category.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryCount(parent_id: string, store_id: string, lang_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('category.count.json?parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('category.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryFind(find_value: string, find_where: string, find_params: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('category.find.json?find_value=' + (find_value == null ? '' : encodeURIComponent(find_value)) + '&find_where=' + (find_where == null ? '' : encodeURIComponent(find_where)) + '&find_params=' + (find_params == null ? '' : encodeURIComponent(find_params)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryImageAdd(category_id: string, image_name: string, url: string, label: string, mime: string, type: string, position: number, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('category.image.add.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&image_name=' + (image_name == null ? '' : encodeURIComponent(image_name)) + '&url=' + (url == null ? '' : encodeURIComponent(url)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&mime=' + (mime == null ? '' : encodeURIComponent(mime)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&position=' + position + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryImageDelete(category_id: string, image_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('category.image.delete.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&image_id=' + (image_id == null ? '' : encodeURIComponent(image_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryInfo(id: string, params: string, exclude: string, store_id: string, lang_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('category.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryList(start: number, count: number, parent_id: string, params: string, exclude: string, store_id: string, lang_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
		 ...
		 * @return {string} successful operation
		 */
		CategoryUnassign(category_id: string, product_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('category.unassign.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryUpdate(id: string, name: string, parent_id: string, stores_ids: string, avail: boolean, sort_order: number, modified_time: string, description: string, meta_title: string, meta_description: string, meta_keywords: string, seo_url: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('category.update.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)) + '&avail=' + avail + '&sort_order=' + sort_order + '&modified_time=' + (modified_time == null ? '' : encodeURIComponent(modified_time)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&meta_title=' + (meta_title == null ? '' : encodeURIComponent(meta_title)) + '&meta_description=' + (meta_description == null ? '' : encodeURIComponent(meta_description)) + '&meta_keywords=' + (meta_keywords == null ? '' : encodeURIComponent(meta_keywords)) + '&seo_url=' + (seo_url == null ? '' : encodeURIComponent(seo_url)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerAdd(requestBody: CustomerAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('customer.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerCount(group_id: number, created_from: string, created_to: string, modified_from: string, modified_to: string, store_id: string, customer_list_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('customer.count.json?group_id=' + group_id + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&customer_list_id=' + (customer_list_id == null ? '' : encodeURIComponent(customer_list_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerFind(find_value: string, find_where: string, find_params: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('customer.find.json?find_value=' + (find_value == null ? '' : encodeURIComponent(find_value)) + '&find_where=' + (find_where == null ? '' : encodeURIComponent(find_where)) + '&find_params=' + (find_params == null ? '' : encodeURIComponent(find_params)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerGroupAdd(name: string, store_id: string, stores_ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('customer.group.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerGroupList(start: number, count: number, store_id: string, lang_id: string, group_ids: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('customer.group.list.json?start=' + start + '&count=' + count + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&group_ids=' + (group_ids == null ? '' : encodeURIComponent(group_ids)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerInfo(id: string, params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('customer.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerList(start: number, count: number, created_from: string, created_to: string, modified_from: string, modified_to: string, params: string, exclude: string, group_id: number, store_id: string, customer_list_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('customer.list.json?start=' + start + '&count=' + count + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&group_id=' + group_id + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&customer_list_id=' + (customer_list_id == null ? '' : encodeURIComponent(customer_list_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderAbandonedList(store_id: string, customer_id: string, customer_email: string, start: number, count: number, params: string, exclude: string, created_to: string, created_from: string, modified_to: string, modified_from: string, skip_empty_email: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('order.abandoned.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&customer_id=' + (customer_id == null ? '' : encodeURIComponent(customer_id)) + '&customer_email=' + (customer_email == null ? '' : encodeURIComponent(customer_email)) + '&start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&skip_empty_email=' + skip_empty_email, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderAdd(requestBody: OrderAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('order.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderFinancialStatusList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('order.financial_status.list.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderFind(customer_id: string, customer_email: string, order_status: string, start: number, count: number, params: string, exclude: string, created_to: string, created_from: string, modified_to: string, modified_from: string, financial_status: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('order.find.json?customer_id=' + (customer_id == null ? '' : encodeURIComponent(customer_id)) + '&customer_email=' + (customer_email == null ? '' : encodeURIComponent(customer_email)) + '&order_status=' + (order_status == null ? '' : encodeURIComponent(order_status)) + '&start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&financial_status=' + (financial_status == null ? '' : encodeURIComponent(financial_status)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderInfo(order_id: string, params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('order.info.json?order_id=' + (order_id == null ? '' : encodeURIComponent(order_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderRefundAdd(requestBody: OrderRefundAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('order.refund.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentAdd(requestBody: OrderShipmentAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('order.shipment.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentList(order_id: string, start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('order.shipment.list.json?order_id=' + (order_id == null ? '' : encodeURIComponent(order_id)) + '&start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentTrackingAdd(requestBody: OrderShipmentTrackingAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('order.shipment.tracking.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentUpdate(requestBody: OrderShipmentUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('order.shipment.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderStatusList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('order.status.list.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductAdd(requestBody: ProductAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductAttributeValueSet(product_id: string, attribute_id: string, attribute_group_id: string, attribute_name: string, value: string, value_id: number, lang_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.attribute.value.set.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&attribute_id=' + (attribute_id == null ? '' : encodeURIComponent(attribute_id)) + '&attribute_group_id=' + (attribute_group_id == null ? '' : encodeURIComponent(attribute_group_id)) + '&attribute_name=' + (attribute_name == null ? '' : encodeURIComponent(attribute_name)) + '&value=' + (value == null ? '' : encodeURIComponent(value)) + '&value_id=' + value_id + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductBrandList(start: number, count: number, params: string, brand_ids: string, exclude: string, store_id: string, lang_id: string, created_from: string, created_to: string, modified_from: string, modified_to: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.brand.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&brand_ids=' + (brand_ids == null ? '' : encodeURIComponent(brand_ids)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductChildItemFind(find_value: string, find_where: string, find_params: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.child_item.find.json?find_value=' + (find_value == null ? '' : encodeURIComponent(find_value)) + '&find_where=' + (find_where == null ? '' : encodeURIComponent(find_where)) + '&find_params=' + (find_params == null ? '' : encodeURIComponent(find_params)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductChildItemInfo(params: string, exclude: string, product_id: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.child_item.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductChildItemList(start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, modified_from: string, modified_to: string, product_id: string, product_ids: string, store_id: string, lang_id: string, currency_id: string, avail_sale: boolean, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.child_item.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&product_ids=' + (product_ids == null ? '' : encodeURIComponent(product_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&currency_id=' + (currency_id == null ? '' : encodeURIComponent(currency_id)) + '&avail_sale=' + avail_sale + '&report_request_id=' + (report_request_id == null ? '' : encodeURIComponent(report_request_id)) + '&disable_report_cache=' + disable_report_cache, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductCount(category_id: string, created_from: string, created_to: string, modified_from: string, modified_to: string, avail_view: boolean, avail_sale: boolean, store_id: string, lang_id: string, product_ids: string, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.count.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&avail_view=' + avail_view + '&avail_sale=' + avail_sale + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&product_ids=' + (product_ids == null ? '' : encodeURIComponent(product_ids)) + '&report_request_id=' + (report_request_id == null ? '' : encodeURIComponent(report_request_id)) + '&disable_report_cache=' + disable_report_cache, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductCurrencyAdd(iso3: string, rate: number, name: string, avail: boolean, symbol_left: string, symbol_right: string, default: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.currency.add.json?iso3=' + (iso3 == null ? '' : encodeURIComponent(iso3)) + '&rate=' + rate + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&avail=' + avail + '&symbol_left=' + (symbol_left == null ? '' : encodeURIComponent(symbol_left)) + '&symbol_right=' + (symbol_right == null ? '' : encodeURIComponent(symbol_right)) + '&default=' + default, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductCurrencyList(start: number, count: number, params: string, exclude: string, default: boolean, avail: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.currency.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&default=' + default + '&avail=' + avail, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('product.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductFields(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.fields.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductFind(find_value: string, find_where: string, find_params: string, find_what: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.find.json?find_value=' + (find_value == null ? '' : encodeURIComponent(find_value)) + '&find_where=' + (find_where == null ? '' : encodeURIComponent(find_where)) + '&find_params=' + (find_params == null ? '' : encodeURIComponent(find_params)) + '&find_what=' + (find_what == null ? '' : encodeURIComponent(find_what)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductImageAdd(product_id: string, image_name: string, type: string, url: string, label: string, mime: string, position: number, content: string, product_variant_id: number, variant_ids: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.image.add.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&image_name=' + (image_name == null ? '' : encodeURIComponent(image_name)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&url=' + (url == null ? '' : encodeURIComponent(url)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&mime=' + (mime == null ? '' : encodeURIComponent(mime)) + '&position=' + position + '&content=' + (content == null ? '' : encodeURIComponent(content)) + '&product_variant_id=' + product_variant_id + '&variant_ids=' + (variant_ids == null ? '' : encodeURIComponent(variant_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductImageDelete(product_id: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('product.image.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductImageUpdate(product_id: string, image_name: string, type: string, label: string, position: number, id: string, store_id: string, hidden: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('product.image.update.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&image_name=' + (image_name == null ? '' : encodeURIComponent(image_name)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&position=' + position + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&hidden=' + hidden, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductInfo(id: string, params: string, exclude: string, store_id: string, lang_id: string, currency_id: string, product_variant_params: string, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&currency_id=' + (currency_id == null ? '' : encodeURIComponent(currency_id)) + '&product_variant_params=' + (product_variant_params == null ? '' : encodeURIComponent(product_variant_params)) + '&report_request_id=' + (report_request_id == null ? '' : encodeURIComponent(report_request_id)) + '&disable_report_cache=' + disable_report_cache, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductManufacturerAdd(product_id: string, manufacturer: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.manufacturer.add.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&manufacturer=' + (manufacturer == null ? '' : encodeURIComponent(manufacturer)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionAdd(name: string, type: string, product_id: string, option_values: string, description: string, avail: boolean, sort_order: number, required: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.option.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&option_values=' + (option_values == null ? '' : encodeURIComponent(option_values)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&avail=' + avail + '&sort_order=' + sort_order + '&required=' + required, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionAssign(product_id: string, option_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.option.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&option_id=' + option_id, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionList(start: number, count: number, params: string, exclude: string, product_id: string, lang_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.option.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionValueAdd(option_id: number, option_value: string, sort_order: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.option.value.add.json?option_id=' + option_id + '&option_value=' + (option_value == null ? '' : encodeURIComponent(option_value)) + '&sort_order=' + sort_order, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionValueAssign(product_option_id: number, option_value_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.option.value.assign.json?product_option_id=' + product_option_id + '&option_value_id=' + option_value_id, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionValueUpdate(option_value_id: number, price: number, quantity: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('product.option.value.update.json?option_value_id=' + option_value_id + '&price=' + price + '&quantity=' + quantity, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductPriceAdd(requestBody: ProductPriceAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.price.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductPriceDelete(product_id: string, group_prices: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('product.price.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductPriceUpdate(requestBody: ProductPriceUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('product.price.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductReviewList(start: number, count: number, product_id: string, ids: string, store_id: string, status: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.review.list.json?start=' + start + '&count=' + count + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&status=' + (status == null ? '' : encodeURIComponent(status)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductStoreAssign(product_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.store.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductTaxAdd(requestBody: ProductTaxAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.tax.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantAdd(requestBody: ProductVariantAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.variant.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantCount(created_from: string, created_to: string, modified_from: string, modified_to: string, category_id: string, product_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.variant.count.json?created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantDelete(id: string, product_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('product.variant.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantInfo(params: string, exclude: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.variant.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantList(start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, modified_from: string, modified_to: string, category_id: string, product_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('product.variant.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantPriceAdd(requestBody: ProductVariantPriceAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('product.variant.price.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantPriceDelete(id: string, group_prices: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('product.variant.price.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantPriceUpdate(requestBody: ProductVariantPriceUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('product.variant.price.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantUpdate(store_id: string, id: string, product_id: string, warehouse_id: string, reserve_quantity: number, quantity: number, increase_quantity: number, reduce_quantity: number, price: number, special_price: number, sprice_create: string, sprice_expire: string, manage_stock: boolean, in_stock: boolean, name: string, description: string, sku: string, meta_title: string, meta_description: string, meta_keywords: string, short_description: string, visible: string, status: string, weight: number, reindex: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('product.variant.update.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&warehouse_id=' + (warehouse_id == null ? '' : encodeURIComponent(warehouse_id)) + '&reserve_quantity=' + reserve_quantity + '&quantity=' + quantity + '&increase_quantity=' + increase_quantity + '&reduce_quantity=' + reduce_quantity + '&price=' + price + '&special_price=' + special_price + '&sprice_create=' + (sprice_create == null ? '' : encodeURIComponent(sprice_create)) + '&sprice_expire=' + (sprice_expire == null ? '' : encodeURIComponent(sprice_expire)) + '&manage_stock=' + manage_stock + '&in_stock=' + in_stock + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&sku=' + (sku == null ? '' : encodeURIComponent(sku)) + '&meta_title=' + (meta_title == null ? '' : encodeURIComponent(meta_title)) + '&meta_description=' + (meta_description == null ? '' : encodeURIComponent(meta_description)) + '&meta_keywords=' + (meta_keywords == null ? '' : encodeURIComponent(meta_keywords)) + '&short_description=' + (short_description == null ? '' : encodeURIComponent(short_description)) + '&visible=' + (visible == null ? '' : encodeURIComponent(visible)) + '&status=' + (status == null ? '' : encodeURIComponent(status)) + '&weight=' + weight + '&reindex=' + reindex, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		SubscriberList(start: number, count: number, subscribed: boolean, store_id: string, email: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('subscriber.list.json?start=' + start + '&count=' + count + '&subscribed=' + subscribed + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&email=' + (email == null ? '' : encodeURIComponent(email)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		TaxClassInfo(tax_class_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('tax.class.info.json?tax_class_id=' + (tax_class_id == null ? '' : encodeURIComponent(tax_class_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookCount(entity: string, action: string, active: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('webhook.count.json?entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&active=' + active, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookCreate(entity: string, action: string, callback: string, label: string, fields: string, active: boolean, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('webhook.create.json?entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&callback=' + (callback == null ? '' : encodeURIComponent(callback)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&active=' + active + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('webhook.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookEvents(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('webhook.events.json', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookList(params: string, start: number, count: number, entity: string, action: string, active: boolean, ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('webhook.list.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&start=' + start + '&count=' + count + '&entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&active=' + active + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookUpdate(id: string, callback: string, label: string, fields: string, active: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('webhook.update.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&callback=' + (callback == null ? '' : encodeURIComponent(callback)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&active=' + active, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
	}
