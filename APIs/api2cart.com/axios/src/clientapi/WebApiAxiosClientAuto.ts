...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AccountFailedWebhooks(count: number, start: number, ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'account.failed_webhooks.json?count=' + count + '&start=' + start + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AccountSupportedPlatforms(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'account.supported_platforms.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeAssignGroup(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'attribute.assign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeAssignSet(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'attribute.assign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeAttributesetList(start: number, count: number, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'attribute.attributeset.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeCount(type: string, store_id: string, lang_id: string, visible: boolean, required: boolean, system: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'attribute.count.json?type=' + (type == null ? '' : encodeURIComponent(type)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&visible=' + visible + '&required=' + required + '&system=' + system, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeDelete(store_id: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'attribute.delete.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeTypeList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'attribute.type.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeUnassignGroup(id: string, group_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'attribute.unassign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		AttributeUnassignSet(id: string, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'attribute.unassign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		BasketInfo(id: string, store_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'basket.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		BasketLiveShippingServiceCreate(store_id: string, name: string, callback: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'basket.live_shipping_service.create.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&callback=' + (callback == null ? '' : encodeURIComponent(callback)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		BasketLiveShippingServiceDelete(id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'basket.live_shipping_service.delete.json?id=' + id, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		BasketLiveShippingServiceList(store_id: string, start: number, count: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'basket.live_shipping_service.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		BridgeDelete(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'bridge.delete.json', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 */
		BridgeDownload(whitelabel: boolean, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'bridge.download.file?whitelabel=' + whitelabel, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		BridgeUpdate(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'bridge.update.json', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartBridge(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.bridge.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartClearCache(cache_type: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'cart.clear_cache.json?cache_type=' + (cache_type == null ? '' : encodeURIComponent(cache_type)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartConfig(params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.config.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartConfigUpdate(requestBody: CartConfigUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.put(this.baseUri + 'cart.config.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		CartCouponAdd(requestBody: CartCouponAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'cart.coupon.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		CartCouponDelete(id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'cart.coupon.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartDelete(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'cart.delete.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartDisconnect(delete_bridge: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.disconnect.json?delete_bridge=' + delete_bridge, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartGiftcardAdd(amount: number, code: string, owner_email: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'cart.giftcard.add.json?amount=' + amount + '&code=' + (code == null ? '' : encodeURIComponent(code)) + '&owner_email=' + (owner_email == null ? '' : encodeURIComponent(owner_email)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartGiftcardCount(store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.giftcard.count.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartGiftcardList(start: number, count: number, store_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.giftcard.list.json?start=' + start + '&count=' + count + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartInfo(params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartMethods(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.methods.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartPluginList(store_key: string, store_id: string, start: number, count: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.plugin.list.json?store_key=' + (store_key == null ? '' : encodeURIComponent(store_key)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartScriptAdd(name: string, description: string, html: string, src: string, load_method: string, scope: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'cart.script.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&html=' + (html == null ? '' : encodeURIComponent(html)) + '&src=' + (src == null ? '' : encodeURIComponent(src)) + '&load_method=' + (load_method == null ? '' : encodeURIComponent(load_method)) + '&scope=' + (scope == null ? '' : encodeURIComponent(scope)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartScriptDelete(id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'cart.script.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartShippingZonesList(store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.shipping_zones.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CartValidate(validate_version: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'cart.validate.json?validate_version=' + validate_version, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CategoryAssign(product_id: string, category_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'category.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CategoryCount(parent_id: string, store_id: string, lang_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'category.count.json?parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CategoryDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'category.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CategoryImageDelete(category_id: string, image_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'category.image.delete.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&image_id=' + (image_id == null ? '' : encodeURIComponent(image_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CategoryUnassign(category_id: string, product_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'category.unassign.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CustomerAdd(requestBody: CustomerAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'customer.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		CustomerGroupAdd(name: string, store_id: string, stores_ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'customer.group.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		CustomerInfo(id: string, params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'customer.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		OrderAdd(requestBody: OrderAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'order.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		OrderFinancialStatusList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'order.financial_status.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		OrderInfo(order_id: string, params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'order.info.json?order_id=' + (order_id == null ? '' : encodeURIComponent(order_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		OrderRefundAdd(requestBody: OrderRefundAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'order.refund.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		OrderShipmentAdd(requestBody: OrderShipmentAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'order.shipment.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		OrderShipmentTrackingAdd(requestBody: OrderShipmentTrackingAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'order.shipment.tracking.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		OrderShipmentUpdate(requestBody: OrderShipmentUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.put(this.baseUri + 'order.shipment.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		OrderStatusList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'order.status.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductAdd(requestBody: ProductAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		ProductCount(category_id: string, created_from: string, created_to: string, modified_from: string, modified_to: string, avail_view: boolean, avail_sale: boolean, store_id: string, lang_id: string, product_ids: string, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'product.count.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&avail_view=' + avail_view + '&avail_sale=' + avail_sale + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&product_ids=' + (product_ids == null ? '' : encodeURIComponent(product_ids)) + '&report_request_id=' + (report_request_id == null ? '' : encodeURIComponent(report_request_id)) + '&disable_report_cache=' + disable_report_cache, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductCurrencyList(start: number, count: number, params: string, exclude: string, default: boolean, avail: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'product.currency.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&default=' + default + '&avail=' + avail, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'product.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductFields(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'product.fields.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductImageDelete(product_id: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'product.image.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductManufacturerAdd(product_id: string, manufacturer: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.manufacturer.add.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&manufacturer=' + (manufacturer == null ? '' : encodeURIComponent(manufacturer)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductOptionAssign(product_id: string, option_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.option.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&option_id=' + option_id, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductOptionValueAdd(option_id: number, option_value: string, sort_order: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.option.value.add.json?option_id=' + option_id + '&option_value=' + (option_value == null ? '' : encodeURIComponent(option_value)) + '&sort_order=' + sort_order, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductOptionValueAssign(product_option_id: number, option_value_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.option.value.assign.json?product_option_id=' + product_option_id + '&option_value_id=' + option_value_id, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductOptionValueUpdate(option_value_id: number, price: number, quantity: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.put(this.baseUri + 'product.option.value.update.json?option_value_id=' + option_value_id + '&price=' + price + '&quantity=' + quantity, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductPriceAdd(requestBody: ProductPriceAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.price.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		ProductPriceDelete(product_id: string, group_prices: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'product.price.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductPriceUpdate(requestBody: ProductPriceUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.put(this.baseUri + 'product.price.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		ProductStoreAssign(product_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.store.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductTaxAdd(requestBody: ProductTaxAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.tax.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		ProductVariantAdd(requestBody: ProductVariantAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.variant.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		ProductVariantDelete(id: string, product_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'product.variant.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductVariantInfo(params: string, exclude: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'product.variant.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductVariantPriceAdd(requestBody: ProductVariantPriceAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'product.variant.price.add.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		ProductVariantPriceDelete(id: string, group_prices: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'product.variant.price.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		ProductVariantPriceUpdate(requestBody: ProductVariantPriceUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.put(this.baseUri + 'product.variant.price.update.json', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		TaxClassInfo(tax_class_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'tax.class.info.json?tax_class_id=' + (tax_class_id == null ? '' : encodeURIComponent(tax_class_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		WebhookCount(entity: string, action: string, active: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'webhook.count.json?entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&active=' + active, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		WebhookDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.delete(this.baseUri + 'webhook.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		WebhookEvents(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'webhook.events.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		WebhookList(params: string, start: number, count: number, entity: string, action: string, active: boolean, ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'webhook.list.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&start=' + start + '&count=' + count + '&entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&active=' + active + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
