...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {string} successful operation
		 */
		AccountCartList(params: string, exclude: string, request_from_date: string, request_to_date: string, store_url: string, store_key: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		AccountConfigUpdate(new_store_key: string, bridge_url: string, store_root: string, db_tables_prefix: string, 3dcartapi_api_key: string, amazon_access_token: string, amazon_seller_id: string, amazon_marketplaces_ids: string, amazon_secret_key: string, amazon_access_key_id: string, aspdotnetstorefront_api_user: string, aspdotnetstorefront_api_pass: string, bigcommerceapi_admin_account: string, bigcommerceapi_api_path: string, bigcommerceapi_api_key: string, bigcommerceapi_client_id: string, bigcommerceapi_access_token: string, bigcommerceapi_context: string, demandware_client_id: string, demandware_api_password: string, demandware_user_name: string, demandware_user_password: string, demandware_env_type: string, ebay_client_id: string, ebay_client_secret: string, ebay_runame: string, ebay_access_token: string, ebay_refresh_token: string, ebay_environment: string, ebay_site_id: number, ecwid_acess_token: string, ecwid_store_id: string, etsy_keystring: string, etsy_shared_secret: string, etsy_access_token: string, etsy_token_secret: string, neto_api_key: string, neto_api_username: string, shopify_api_key: string, shopify_api_password: string, shopify_shared_secret: string, shopify_access_token: string, volusion_login: string, volusion_password: string, walmart_client_id: string, walmart_client_secret: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		AccountFailedWebhooks(count: number, start: number, ids: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'account.failed_webhooks.json?count=' + count + '&start=' + start + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AccountSupportedPlatforms(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'account.supported_platforms.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeAdd(type: string, code: string, name: string, store_id: string, lang_id: string, visible: boolean, required: boolean, position: number, is_global: string, is_searchable: boolean, is_filterable: string, is_comparable: boolean, is_html_allowed_on_front: boolean, is_filterable_in_search: boolean, is_configurable: boolean, is_visible_in_advanced_search: boolean, is_used_for_promo_rules: boolean, used_in_product_listing: boolean, used_for_sort_by: boolean, apply_to: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		AttributeAssignGroup(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'attribute.assign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeAssignSet(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'attribute.assign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeAttributesetList(start: number, count: number, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'attribute.attributeset.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeCount(type: string, store_id: string, lang_id: string, visible: boolean, required: boolean, system: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		AttributeDelete(store_id: string, id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'attribute.delete.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeGroupList(start: number, count: number, params: string, exclude: string, attribute_set_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		AttributeInfo(id: string, store_id: string, lang_id: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		AttributeList(start: number, count: number, type: string, attribute_ids: string, store_id: string, lang_id: string, params: string, exclude: string, visible: boolean, required: boolean, system: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		AttributeTypeList(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'attribute.type.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeUnassignGroup(id: string, group_id: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'attribute.unassign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		AttributeUnassignSet(id: string, attribute_set_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'attribute.unassign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketInfo(id: string, store_id: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'basket.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketItemAdd(customer_id: string, product_id: string, variant_id: string, quantity: number, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		BasketLiveShippingServiceCreate(store_id: string, name: string, callback: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'basket.live_shipping_service.create.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&callback=' + (callback == null ? '' : encodeURIComponent(callback)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketLiveShippingServiceDelete(id: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'basket.live_shipping_service.delete.json?id=' + id, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		BasketLiveShippingServiceList(store_id: string, start: number, count: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'basket.live_shipping_service.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		BridgeDelete(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'bridge.delete.json', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		BridgeDownload(whitelabel: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'bridge.download.file?whitelabel=' + whitelabel, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		BridgeUpdate(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'bridge.update.json', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartBridge(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.bridge.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartClearCache(cache_type: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'cart.clear_cache.json?cache_type=' + (cache_type == null ? '' : encodeURIComponent(cache_type)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartConfig(params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.config.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartConfigUpdate(requestBody: CartConfigUpdate, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.put(this.baseUri + 'cart.config.update.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponAdd(requestBody: CartCouponAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'cart.coupon.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponConditionAdd(store_id: string, coupon_id: string, target: string, entity: string, key: string, operator: string, value: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CartCouponCount(store_id: string, date_start_from: string, date_start_to: string, date_end_from: string, date_end_to: string, avail: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CartCouponDelete(id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'cart.coupon.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartCouponList(start: number, count: number, coupons_ids: string, store_id: string, date_start_from: string, date_start_to: string, date_end_from: string, date_end_to: string, avail: boolean, lang_id: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CartDelete(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'cart.delete.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartDisconnect(delete_bridge: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.disconnect.json?delete_bridge=' + delete_bridge, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartGiftcardAdd(amount: number, code: string, owner_email: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'cart.giftcard.add.json?amount=' + amount + '&code=' + (code == null ? '' : encodeURIComponent(code)) + '&owner_email=' + (owner_email == null ? '' : encodeURIComponent(owner_email)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartGiftcardCount(store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.giftcard.count.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartGiftcardList(start: number, count: number, store_id: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.giftcard.list.json?start=' + start + '&count=' + count + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartInfo(params: string, exclude: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartList(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartMethods(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.methods.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartPluginList(store_key: string, store_id: string, start: number, count: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.plugin.list.json?store_key=' + (store_key == null ? '' : encodeURIComponent(store_key)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartScriptAdd(name: string, description: string, html: string, src: string, load_method: string, scope: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CartScriptDelete(id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'cart.script.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartScriptList(start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, modified_from: string, modified_to: string, script_ids: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CartShippingZonesList(store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.shipping_zones.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CartValidate(validate_version: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'cart.validate.json?validate_version=' + validate_version, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryAdd(name: string, parent_id: string, stores_ids: string, store_id: string, avail: boolean, sort_order: number, created_time: string, modified_time: string, description: string, meta_title: string, meta_description: string, meta_keywords: string, seo_url: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CategoryAssign(product_id: string, category_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'category.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryCount(parent_id: string, store_id: string, lang_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'category.count.json?parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryDelete(id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'category.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryFind(find_value: string, find_where: string, find_params: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'category.find.json?find_value=' + (find_value == null ? '' : encodeURIComponent(find_value)) + '&find_where=' + (find_where == null ? '' : encodeURIComponent(find_where)) + '&find_params=' + (find_params == null ? '' : encodeURIComponent(find_params)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryImageAdd(category_id: string, image_name: string, url: string, label: string, mime: string, type: string, position: number, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CategoryImageDelete(category_id: string, image_id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'category.image.delete.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&image_id=' + (image_id == null ? '' : encodeURIComponent(image_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryInfo(id: string, params: string, exclude: string, store_id: string, lang_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CategoryList(start: number, count: number, parent_id: string, params: string, exclude: string, store_id: string, lang_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CategoryUnassign(category_id: string, product_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'category.unassign.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CategoryUpdate(id: string, name: string, parent_id: string, stores_ids: string, avail: boolean, sort_order: number, modified_time: string, description: string, meta_title: string, meta_description: string, meta_keywords: string, seo_url: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CustomerAdd(requestBody: CustomerAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'customer.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerCount(group_id: number, created_from: string, created_to: string, modified_from: string, modified_to: string, store_id: string, customer_list_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CustomerFind(find_value: string, find_where: string, find_params: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CustomerGroupAdd(name: string, store_id: string, stores_ids: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'customer.group.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerGroupList(start: number, count: number, store_id: string, lang_id: string, group_ids: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		CustomerInfo(id: string, params: string, exclude: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'customer.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		CustomerList(start: number, count: number, created_from: string, created_to: string, modified_from: string, modified_to: string, params: string, exclude: string, group_id: number, store_id: string, customer_list_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		OrderAbandonedList(store_id: string, customer_id: string, customer_email: string, start: number, count: number, params: string, exclude: string, created_to: string, created_from: string, modified_to: string, modified_from: string, skip_empty_email: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		OrderAdd(requestBody: OrderAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'order.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderCount(customer_id: string, customer_email: string, order_status: string, created_to: string, created_from: string, modified_to: string, modified_from: string, store_id: string, ids: string, order_ids: string, ebay_order_status: string, financial_status: string, fulfillment_status: string, shipping_method: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		OrderFinancialStatusList(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'order.financial_status.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderFind(customer_id: string, customer_email: string, order_status: string, start: number, count: number, params: string, exclude: string, created_to: string, created_from: string, modified_to: string, modified_from: string, financial_status: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		OrderInfo(order_id: string, params: string, exclude: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		OrderRefundAdd(requestBody: OrderRefundAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'order.refund.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentAdd(requestBody: OrderShipmentAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'order.shipment.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentList(order_id: string, start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentTrackingAdd(requestBody: OrderShipmentTrackingAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'order.shipment.tracking.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderShipmentUpdate(requestBody: OrderShipmentUpdate, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.put(this.baseUri + 'order.shipment.update.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderStatusList(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'order.status.list.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		OrderUpdate(order_id: string, store_id: string, order_status: string, comment: string, date_modified: string, date_finished: string, financial_status: string, order_payment_method: string, send_notifications: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductAdd(requestBody: ProductAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductAttributeList(product_id: string, start: number, count: number, params: string, exclude: string, sort_by: string, sort_direction: string, lang_id: string, store_id: string, attribute_id: string, attribute_group_id: string, set_name: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductAttributeValueSet(product_id: string, attribute_id: string, attribute_group_id: string, attribute_name: string, value: string, value_id: number, lang_id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductBrandList(start: number, count: number, params: string, brand_ids: string, exclude: string, store_id: string, lang_id: string, created_from: string, created_to: string, modified_from: string, modified_to: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductChildItemFind(find_value: string, find_where: string, find_params: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductChildItemInfo(params: string, exclude: string, product_id: string, id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductCount(category_id: string, created_from: string, created_to: string, modified_from: string, modified_to: string, avail_view: boolean, avail_sale: boolean, store_id: string, lang_id: string, product_ids: string, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductCurrencyAdd(iso3: string, rate: number, name: string, avail: boolean, symbol_left: string, symbol_right: string, default: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductCurrencyList(start: number, count: number, params: string, exclude: string, default: boolean, avail: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'product.currency.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&default=' + default + '&avail=' + avail, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductDelete(id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'product.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductFields(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'product.fields.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductFind(find_value: string, find_where: string, find_params: string, find_what: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductImageAdd(product_id: string, image_name: string, type: string, url: string, label: string, mime: string, position: number, content: string, product_variant_id: number, variant_ids: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductImageDelete(product_id: string, id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'product.image.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductImageUpdate(product_id: string, image_name: string, type: string, label: string, position: number, id: string, store_id: string, hidden: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductInfo(id: string, params: string, exclude: string, store_id: string, lang_id: string, currency_id: string, product_variant_params: string, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductManufacturerAdd(product_id: string, manufacturer: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.manufacturer.add.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&manufacturer=' + (manufacturer == null ? '' : encodeURIComponent(manufacturer)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionAdd(name: string, type: string, product_id: string, option_values: string, description: string, avail: boolean, sort_order: number, required: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionAssign(product_id: string, option_id: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.option.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&option_id=' + option_id, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionList(start: number, count: number, params: string, exclude: string, product_id: string, lang_id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionValueAdd(option_id: number, option_value: string, sort_order: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.option.value.add.json?option_id=' + option_id + '&option_value=' + (option_value == null ? '' : encodeURIComponent(option_value)) + '&sort_order=' + sort_order, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionValueAssign(product_option_id: number, option_value_id: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.option.value.assign.json?product_option_id=' + product_option_id + '&option_value_id=' + option_value_id, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductOptionValueUpdate(option_value_id: number, price: number, quantity: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.put(this.baseUri + 'product.option.value.update.json?option_value_id=' + option_value_id + '&price=' + price + '&quantity=' + quantity, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductPriceAdd(requestBody: ProductPriceAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.price.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductPriceDelete(product_id: string, group_prices: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'product.price.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductPriceUpdate(requestBody: ProductPriceUpdate, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.put(this.baseUri + 'product.price.update.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductReviewList(start: number, count: number, product_id: string, ids: string, store_id: string, status: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductStoreAssign(product_id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.store.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductTaxAdd(requestBody: ProductTaxAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.tax.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantAdd(requestBody: ProductVariantAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.variant.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantCount(created_from: string, created_to: string, modified_from: string, modified_to: string, category_id: string, product_id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantDelete(id: string, product_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'product.variant.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantInfo(params: string, exclude: string, id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantList(start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, modified_from: string, modified_to: string, category_id: string, product_id: string, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantPriceAdd(requestBody: ProductVariantPriceAdd, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'product.variant.price.add.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantPriceDelete(id: string, group_prices: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'product.variant.price.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantPriceUpdate(requestBody: ProductVariantPriceUpdate, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.put(this.baseUri + 'product.variant.price.update.json', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }),  responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		ProductVariantUpdate(store_id: string, id: string, product_id: string, warehouse_id: string, reserve_quantity: number, quantity: number, increase_quantity: number, reduce_quantity: number, price: number, special_price: number, sprice_create: string, sprice_expire: string, manage_stock: boolean, in_stock: boolean, name: string, description: string, sku: string, meta_title: string, meta_description: string, meta_keywords: string, short_description: string, visible: string, status: string, weight: number, reindex: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		SubscriberList(start: number, count: number, subscribed: boolean, store_id: string, email: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		TaxClassInfo(tax_class_id: string, params: string, exclude: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'tax.class.info.json?tax_class_id=' + (tax_class_id == null ? '' : encodeURIComponent(tax_class_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookCount(entity: string, action: string, active: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'webhook.count.json?entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&active=' + active, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookCreate(entity: string, action: string, callback: string, label: string, fields: string, active: boolean, store_id: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		WebhookDelete(id: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'webhook.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookEvents(headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'webhook.events.json', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} successful operation
		 */
		WebhookList(params: string, start: number, count: number, entity: string, action: string, active: boolean, ids: string, headersHandler?: () => HttpHeaders): Observable<string> {
		 ...
		 * @return {string} successful operation
		 */
		WebhookUpdate(id: string, callback: string, label: string, fields: string, active: boolean, headersHandler?: () => HttpHeaders): Observable<string> {
