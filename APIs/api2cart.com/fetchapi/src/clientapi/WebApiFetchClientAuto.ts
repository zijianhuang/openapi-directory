export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AccountFailedWebhooks(count: number, start: number, ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'account.failed_webhooks.json?count=' + count + '&start=' + start + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AccountSupportedPlatforms(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'account.supported_platforms.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AttributeAssignGroup(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'attribute.assign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AttributeAssignSet(id: string, group_id: number, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'attribute.assign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AttributeAttributesetList(start: number, count: number, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'attribute.attributeset.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AttributeDelete(store_id: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'attribute.delete.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AttributeTypeList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'attribute.type.list.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AttributeUnassignGroup(id: string, group_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'attribute.unassign.group.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_id=' + group_id, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		AttributeUnassignSet(id: string, attribute_set_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'attribute.unassign.set.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&attribute_set_id=' + (attribute_set_id == null ? '' : encodeURIComponent(attribute_set_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		BasketInfo(id: string, store_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'basket.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		BasketLiveShippingServiceCreate(store_id: string, name: string, callback: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'basket.live_shipping_service.create.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&callback=' + (callback == null ? '' : encodeURIComponent(callback)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		BasketLiveShippingServiceDelete(id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'basket.live_shipping_service.delete.json?id=' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		BasketLiveShippingServiceList(store_id: string, start: number, count: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'basket.live_shipping_service.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		BridgeDelete(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'bridge.delete.json', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		BridgeDownload(whitelabel: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'bridge.download.file?whitelabel=' + whitelabel, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		BridgeUpdate(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'bridge.update.json', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartBridge(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.bridge.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartClearCache(cache_type: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.clear_cache.json?cache_type=' + (cache_type == null ? '' : encodeURIComponent(cache_type)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartConfig(params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.config.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartConfigUpdate(requestBody: CartConfigUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.config.update.json', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		CartCouponAdd(requestBody: CartCouponAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.coupon.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		CartCouponConditionAdd(store_id: string, coupon_id: string, target: string, entity: string, key: string, operator: string, value: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.coupon.condition.add.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&coupon_id=' + (coupon_id == null ? '' : encodeURIComponent(coupon_id)) + '&target=' + (target == null ? '' : encodeURIComponent(target)) + '&entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&key=' + (key == null ? '' : encodeURIComponent(key)) + '&operator=' + (operator == null ? '' : encodeURIComponent(operator)) + '&value=' + (value == null ? '' : encodeURIComponent(value)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartCouponDelete(id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.coupon.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartDelete(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.delete.json', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartDisconnect(delete_bridge: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.disconnect.json?delete_bridge=' + delete_bridge, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartGiftcardAdd(amount: number, code: string, owner_email: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.giftcard.add.json?amount=' + amount + '&code=' + (code == null ? '' : encodeURIComponent(code)) + '&owner_email=' + (owner_email == null ? '' : encodeURIComponent(owner_email)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartGiftcardCount(store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.giftcard.count.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartGiftcardList(start: number, count: number, store_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.giftcard.list.json?start=' + start + '&count=' + count + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartInfo(params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.list.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartMethods(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.methods.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartPluginList(store_key: string, store_id: string, start: number, count: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.plugin.list.json?store_key=' + (store_key == null ? '' : encodeURIComponent(store_key)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&start=' + start + '&count=' + count, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartScriptAdd(name: string, description: string, html: string, src: string, load_method: string, scope: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.script.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&html=' + (html == null ? '' : encodeURIComponent(html)) + '&src=' + (src == null ? '' : encodeURIComponent(src)) + '&load_method=' + (load_method == null ? '' : encodeURIComponent(load_method)) + '&scope=' + (scope == null ? '' : encodeURIComponent(scope)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartScriptDelete(id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.script.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartScriptList(start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, modified_from: string, modified_to: string, script_ids: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.script.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&script_ids=' + (script_ids == null ? '' : encodeURIComponent(script_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartShippingZonesList(store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.shipping_zones.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CartValidate(validate_version: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'cart.validate.json?validate_version=' + validate_version, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryAdd(name: string, parent_id: string, stores_ids: string, store_id: string, avail: boolean, sort_order: number, created_time: string, modified_time: string, description: string, meta_title: string, meta_description: string, meta_keywords: string, seo_url: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&avail=' + avail + '&sort_order=' + sort_order + '&created_time=' + (created_time == null ? '' : encodeURIComponent(created_time)) + '&modified_time=' + (modified_time == null ? '' : encodeURIComponent(modified_time)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&meta_title=' + (meta_title == null ? '' : encodeURIComponent(meta_title)) + '&meta_description=' + (meta_description == null ? '' : encodeURIComponent(meta_description)) + '&meta_keywords=' + (meta_keywords == null ? '' : encodeURIComponent(meta_keywords)) + '&seo_url=' + (seo_url == null ? '' : encodeURIComponent(seo_url)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryAssign(product_id: string, category_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryCount(parent_id: string, store_id: string, lang_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.count.json?parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryFind(find_value: string, find_where: string, find_params: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.find.json?find_value=' + (find_value == null ? '' : encodeURIComponent(find_value)) + '&find_where=' + (find_where == null ? '' : encodeURIComponent(find_where)) + '&find_params=' + (find_params == null ? '' : encodeURIComponent(find_params)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryImageAdd(category_id: string, image_name: string, url: string, label: string, mime: string, type: string, position: number, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.image.add.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&image_name=' + (image_name == null ? '' : encodeURIComponent(image_name)) + '&url=' + (url == null ? '' : encodeURIComponent(url)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&mime=' + (mime == null ? '' : encodeURIComponent(mime)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&position=' + position + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryImageDelete(category_id: string, image_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.image.delete.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&image_id=' + (image_id == null ? '' : encodeURIComponent(image_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryInfo(id: string, params: string, exclude: string, store_id: string, lang_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryUnassign(category_id: string, product_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.unassign.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CategoryUpdate(id: string, name: string, parent_id: string, stores_ids: string, avail: boolean, sort_order: number, modified_time: string, description: string, meta_title: string, meta_description: string, meta_keywords: string, seo_url: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'category.update.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&parent_id=' + (parent_id == null ? '' : encodeURIComponent(parent_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)) + '&avail=' + avail + '&sort_order=' + sort_order + '&modified_time=' + (modified_time == null ? '' : encodeURIComponent(modified_time)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&meta_title=' + (meta_title == null ? '' : encodeURIComponent(meta_title)) + '&meta_description=' + (meta_description == null ? '' : encodeURIComponent(meta_description)) + '&meta_keywords=' + (meta_keywords == null ? '' : encodeURIComponent(meta_keywords)) + '&seo_url=' + (seo_url == null ? '' : encodeURIComponent(seo_url)), { method: 'put', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CustomerAdd(requestBody: CustomerAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'customer.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		CustomerGroupAdd(name: string, store_id: string, stores_ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'customer.group.add.json?name=' + (name == null ? '' : encodeURIComponent(name)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&stores_ids=' + (stores_ids == null ? '' : encodeURIComponent(stores_ids)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		CustomerInfo(id: string, params: string, exclude: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'customer.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		OrderAbandonedList(store_id: string, customer_id: string, customer_email: string, start: number, count: number, params: string, exclude: string, created_to: string, created_from: string, modified_to: string, modified_from: string, skip_empty_email: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.abandoned.list.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&customer_id=' + (customer_id == null ? '' : encodeURIComponent(customer_id)) + '&customer_email=' + (customer_email == null ? '' : encodeURIComponent(customer_email)) + '&start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&skip_empty_email=' + skip_empty_email, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		OrderAdd(requestBody: OrderAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		OrderFinancialStatusList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.financial_status.list.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		OrderFind(customer_id: string, customer_email: string, order_status: string, start: number, count: number, params: string, exclude: string, created_to: string, created_from: string, modified_to: string, modified_from: string, financial_status: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.find.json?customer_id=' + (customer_id == null ? '' : encodeURIComponent(customer_id)) + '&customer_email=' + (customer_email == null ? '' : encodeURIComponent(customer_email)) + '&order_status=' + (order_status == null ? '' : encodeURIComponent(order_status)) + '&start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&financial_status=' + (financial_status == null ? '' : encodeURIComponent(financial_status)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		OrderRefundAdd(requestBody: OrderRefundAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.refund.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		OrderShipmentAdd(requestBody: OrderShipmentAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.shipment.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		OrderShipmentList(order_id: string, start: number, count: number, params: string, exclude: string, created_from: string, created_to: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.shipment.list.json?order_id=' + (order_id == null ? '' : encodeURIComponent(order_id)) + '&start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		OrderShipmentTrackingAdd(requestBody: OrderShipmentTrackingAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.shipment.tracking.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		OrderShipmentUpdate(requestBody: OrderShipmentUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.shipment.update.json', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		OrderStatusList(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'order.status.list.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductAdd(requestBody: ProductAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		ProductAttributeValueSet(product_id: string, attribute_id: string, attribute_group_id: string, attribute_name: string, value: string, value_id: number, lang_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.attribute.value.set.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&attribute_id=' + (attribute_id == null ? '' : encodeURIComponent(attribute_id)) + '&attribute_group_id=' + (attribute_group_id == null ? '' : encodeURIComponent(attribute_group_id)) + '&attribute_name=' + (attribute_name == null ? '' : encodeURIComponent(attribute_name)) + '&value=' + (value == null ? '' : encodeURIComponent(value)) + '&value_id=' + value_id + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductBrandList(start: number, count: number, params: string, brand_ids: string, exclude: string, store_id: string, lang_id: string, created_from: string, created_to: string, modified_from: string, modified_to: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.brand.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&brand_ids=' + (brand_ids == null ? '' : encodeURIComponent(brand_ids)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductChildItemInfo(params: string, exclude: string, product_id: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.child_item.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductCount(category_id: string, created_from: string, created_to: string, modified_from: string, modified_to: string, avail_view: boolean, avail_sale: boolean, store_id: string, lang_id: string, product_ids: string, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.count.json?category_id=' + (category_id == null ? '' : encodeURIComponent(category_id)) + '&created_from=' + (created_from == null ? '' : encodeURIComponent(created_from)) + '&created_to=' + (created_to == null ? '' : encodeURIComponent(created_to)) + '&modified_from=' + (modified_from == null ? '' : encodeURIComponent(modified_from)) + '&modified_to=' + (modified_to == null ? '' : encodeURIComponent(modified_to)) + '&avail_view=' + avail_view + '&avail_sale=' + avail_sale + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&product_ids=' + (product_ids == null ? '' : encodeURIComponent(product_ids)) + '&report_request_id=' + (report_request_id == null ? '' : encodeURIComponent(report_request_id)) + '&disable_report_cache=' + disable_report_cache, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductCurrencyList(start: number, count: number, params: string, exclude: string, default: boolean, avail: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.currency.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&default=' + default + '&avail=' + avail, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductFields(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.fields.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductImageAdd(product_id: string, image_name: string, type: string, url: string, label: string, mime: string, position: number, content: string, product_variant_id: number, variant_ids: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.image.add.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&image_name=' + (image_name == null ? '' : encodeURIComponent(image_name)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&url=' + (url == null ? '' : encodeURIComponent(url)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&mime=' + (mime == null ? '' : encodeURIComponent(mime)) + '&position=' + position + '&content=' + (content == null ? '' : encodeURIComponent(content)) + '&product_variant_id=' + product_variant_id + '&variant_ids=' + (variant_ids == null ? '' : encodeURIComponent(variant_ids)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductImageDelete(product_id: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.image.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductImageUpdate(product_id: string, image_name: string, type: string, label: string, position: number, id: string, store_id: string, hidden: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.image.update.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&image_name=' + (image_name == null ? '' : encodeURIComponent(image_name)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&label=' + (label == null ? '' : encodeURIComponent(label)) + '&position=' + position + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&hidden=' + hidden, { method: 'put', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductInfo(id: string, params: string, exclude: string, store_id: string, lang_id: string, currency_id: string, product_variant_params: string, report_request_id: string, disable_report_cache: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.info.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&currency_id=' + (currency_id == null ? '' : encodeURIComponent(currency_id)) + '&product_variant_params=' + (product_variant_params == null ? '' : encodeURIComponent(product_variant_params)) + '&report_request_id=' + (report_request_id == null ? '' : encodeURIComponent(report_request_id)) + '&disable_report_cache=' + disable_report_cache, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductManufacturerAdd(product_id: string, manufacturer: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.manufacturer.add.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&manufacturer=' + (manufacturer == null ? '' : encodeURIComponent(manufacturer)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductOptionAssign(product_id: string, option_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.option.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&option_id=' + option_id, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductOptionList(start: number, count: number, params: string, exclude: string, product_id: string, lang_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.option.list.json?start=' + start + '&count=' + count + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&lang_id=' + (lang_id == null ? '' : encodeURIComponent(lang_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductOptionValueAdd(option_id: number, option_value: string, sort_order: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.option.value.add.json?option_id=' + option_id + '&option_value=' + (option_value == null ? '' : encodeURIComponent(option_value)) + '&sort_order=' + sort_order, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductOptionValueAssign(product_option_id: number, option_value_id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.option.value.assign.json?product_option_id=' + product_option_id + '&option_value_id=' + option_value_id, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductOptionValueUpdate(option_value_id: number, price: number, quantity: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.option.value.update.json?option_value_id=' + option_value_id + '&price=' + price + '&quantity=' + quantity, { method: 'put', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductPriceAdd(requestBody: ProductPriceAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.price.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		ProductPriceDelete(product_id: string, group_prices: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.price.delete.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductPriceUpdate(requestBody: ProductPriceUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.price.update.json', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		ProductStoreAssign(product_id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.store.assign.json?product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductTaxAdd(requestBody: ProductTaxAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.tax.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		ProductVariantAdd(requestBody: ProductVariantAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.variant.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		ProductVariantDelete(id: string, product_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.variant.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductVariantInfo(params: string, exclude: string, id: string, store_id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.variant.info.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductVariantPriceAdd(requestBody: ProductVariantPriceAdd, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.variant.price.add.json', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		ProductVariantPriceDelete(id: string, group_prices: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.variant.price.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)) + '&group_prices=' + (group_prices == null ? '' : encodeURIComponent(group_prices)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		ProductVariantPriceUpdate(requestBody: ProductVariantPriceUpdate, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.variant.price.update.json', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		...
		ProductVariantUpdate(store_id: string, id: string, product_id: string, warehouse_id: string, reserve_quantity: number, quantity: number, increase_quantity: number, reduce_quantity: number, price: number, special_price: number, sprice_create: string, sprice_expire: string, manage_stock: boolean, in_stock: boolean, name: string, description: string, sku: string, meta_title: string, meta_description: string, meta_keywords: string, short_description: string, visible: string, status: string, weight: number, reindex: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'product.variant.update.json?store_id=' + (store_id == null ? '' : encodeURIComponent(store_id)) + '&id=' + (id == null ? '' : encodeURIComponent(id)) + '&product_id=' + (product_id == null ? '' : encodeURIComponent(product_id)) + '&warehouse_id=' + (warehouse_id == null ? '' : encodeURIComponent(warehouse_id)) + '&reserve_quantity=' + reserve_quantity + '&quantity=' + quantity + '&increase_quantity=' + increase_quantity + '&reduce_quantity=' + reduce_quantity + '&price=' + price + '&special_price=' + special_price + '&sprice_create=' + (sprice_create == null ? '' : encodeURIComponent(sprice_create)) + '&sprice_expire=' + (sprice_expire == null ? '' : encodeURIComponent(sprice_expire)) + '&manage_stock=' + manage_stock + '&in_stock=' + in_stock + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&description=' + (description == null ? '' : encodeURIComponent(description)) + '&sku=' + (sku == null ? '' : encodeURIComponent(sku)) + '&meta_title=' + (meta_title == null ? '' : encodeURIComponent(meta_title)) + '&meta_description=' + (meta_description == null ? '' : encodeURIComponent(meta_description)) + '&meta_keywords=' + (meta_keywords == null ? '' : encodeURIComponent(meta_keywords)) + '&short_description=' + (short_description == null ? '' : encodeURIComponent(short_description)) + '&visible=' + (visible == null ? '' : encodeURIComponent(visible)) + '&status=' + (status == null ? '' : encodeURIComponent(status)) + '&weight=' + weight + '&reindex=' + reindex, { method: 'put', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		TaxClassInfo(tax_class_id: string, params: string, exclude: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'tax.class.info.json?tax_class_id=' + (tax_class_id == null ? '' : encodeURIComponent(tax_class_id)) + '&params=' + (params == null ? '' : encodeURIComponent(params)) + '&exclude=' + (exclude == null ? '' : encodeURIComponent(exclude)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		WebhookCount(entity: string, action: string, active: boolean, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'webhook.count.json?entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&active=' + active, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		WebhookDelete(id: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'webhook.delete.json?id=' + (id == null ? '' : encodeURIComponent(id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		WebhookEvents(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'webhook.events.json', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		WebhookList(params: string, start: number, count: number, entity: string, action: string, active: boolean, ids: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'webhook.list.json?params=' + (params == null ? '' : encodeURIComponent(params)) + '&start=' + start + '&count=' + count + '&entity=' + (entity == null ? '' : encodeURIComponent(entity)) + '&action=' + (action == null ? '' : encodeURIComponent(action)) + '&active=' + active + '&ids=' + (ids == null ? '' : encodeURIComponent(ids)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
