export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		EncryptValue(requestBody: EncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'account/encrypt', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.text());
		}
		 ...
		 */
		GetBuildArtifacts(headersHandler?: () => {[header: string]: string}): Promise<Array<ArtifactModel>> {
			return fetch(this.baseUri + 'buildjobs/{jobId}/artifacts', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		GetBuildArtifact(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'buildjobs/{jobId}/artifacts/{artifactFileName}', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBuildLog(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'buildjobs/{jobId}/log', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		StartBuild(requestBody: BuildStartRequest, headersHandler?: () => {[header: string]: string}): Promise<Build> {
			return fetch(this.baseUri + 'builds', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Build} Success
		 */
		ReRunBuild(requestBody: ReRunBuildRequest, headersHandler?: () => {[header: string]: string}): Promise<Build> {
			return fetch(this.baseUri + 'builds', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CancelBuild(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'builds/{accountName}/{projectSlug}/{buildVersion}', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetCollaborators(headersHandler?: () => {[header: string]: string}): Promise<Array<UserAccount>> {
			return fetch(this.baseUri + 'collaborators', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		AddCollaborator(requestBody: CollaboratorAddition, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'collaborators', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		UpdateCollaborator(requestBody: CollaboratorUpdate, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'collaborators', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteCollaborator(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'collaborators/{userId}', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetCollaborator(headersHandler?: () => {[header: string]: string}): Promise<UserAccountRolesResults> {
			return fetch(this.baseUri + 'collaborators/{userId}', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		StartDeployment(requestBody: DeploymentStartRequest, headersHandler?: () => {[header: string]: string}): Promise<Deployment> {
			return fetch(this.baseUri + 'deployments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CancelDeployment(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'deployments/stop', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetDeployment(headersHandler?: () => {[header: string]: string}): Promise<ProjectDeployment> {
			return fetch(this.baseUri + 'deployments/{deploymentId}', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		GetEnvironments(headersHandler?: () => {[header: string]: string}): Promise<Array<DeploymentEnvironmentLookupModel>> {
			return fetch(this.baseUri + 'environments', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		AddEnvironment(requestBody: DeploymentEnvironmentAddition, headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentWithSettings> {
			return fetch(this.baseUri + 'environments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {DeploymentEnvironmentWithSettings} Success
		 */
		UpdateEnvironment(requestBody: DeploymentEnvironmentWithSettings, headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentWithSettings> {
			return fetch(this.baseUri + 'environments', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteEnvironment(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'environments/{deploymentEnvironmentId}', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetEnvironmentDeployments(headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentDeploymentsResults> {
			return fetch(this.baseUri + 'environments/{deploymentEnvironmentId}/deployments', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		GetEnvironmentSettings(headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentSettingsResults> {
			return fetch(this.baseUri + 'environments/{deploymentEnvironmentId}/settings', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		GetProjects(headersHandler?: () => {[header: string]: string}): Promise<Array<Project>> {
			return fetch(this.baseUri + 'projects', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		AddProject(requestBody: ProjectAddition, headersHandler?: () => {[header: string]: string}): Promise<Project> {
			return fetch(this.baseUri + 'projects', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateProject(requestBody: ProjectWithConfiguration, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		GetPublicProjectStatusBadge(branch: string, svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/status/{badgeRepoProvider}/{repoAccountName}/{repoSlug}?branch=' + (branch == null ? '' : encodeURIComponent(branch)) + '&svg=' + svg + '&retina=' + retina + '&passingText=' + (passingText == null ? '' : encodeURIComponent(passingText)) + '&failingText=' + (failingText == null ? '' : encodeURIComponent(failingText)) + '&pendingText=' + (pendingText == null ? '' : encodeURIComponent(pendingText)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetProjectStatusBadge(svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/status/{statusBadgeId}?svg=' + svg + '&retina=' + retina + '&passingText=' + (passingText == null ? '' : encodeURIComponent(passingText)) + '&failingText=' + (failingText == null ? '' : encodeURIComponent(failingText)) + '&pendingText=' + (pendingText == null ? '' : encodeURIComponent(pendingText)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetProjectBranchStatusBadge(svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/status/{statusBadgeId}/branch/{buildBranch}?svg=' + svg + '&retina=' + retina + '&passingText=' + (passingText == null ? '' : encodeURIComponent(passingText)) + '&failingText=' + (failingText == null ? '' : encodeURIComponent(failingText)) + '&pendingText=' + (pendingText == null ? '' : encodeURIComponent(pendingText)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteProject(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetProjectLastBuild(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		GetProjectArtifact(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/artifacts/{artifactFileName}', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {ProjectBuildResults} Success
		 */
		GetProjectLastBuildBranch(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/branch/{buildBranch}', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {ProjectBuildResults} Success
		 */
		GetProjectBuildByVersion(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/build/{buildVersion}', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteProjectBuildCache(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/buildcache', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetProjectDeployments(headersHandler?: () => {[header: string]: string}): Promise<ProjectDeploymentsResults> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/deployments', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		GetProjectHistory(recordsNumber: number, startBuildId: number, branch: string, headersHandler?: () => {[header: string]: string}): Promise<ProjectHistory> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/history?recordsNumber=' + recordsNumber + '&startBuildId=' + startBuildId + '&branch=' + (branch == null ? '' : encodeURIComponent(branch)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		GetProjectSettings(headersHandler?: () => {[header: string]: string}): Promise<ProjectSettingsResults> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/settings', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateProjectBuildNumber(requestBody: ProjectBuildNumberUpdate, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/build-number', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		GetProjectEnvironmentVariables(headersHandler?: () => {[header: string]: string}): Promise<Array<StoredNameValue>> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/environment-variables', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateProjectEnvironmentVariables(requestBody: Array<StoredNameValue>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/environment-variables', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		GetProjectSettingsYaml(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/yaml', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		 ...
		 */
		GetRoles(headersHandler?: () => {[header: string]: string}): Promise<Array<Role>> {
			return fetch(this.baseUri + 'roles', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		AddRole(requestBody: RoleAddition, headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return fetch(this.baseUri + 'roles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {RoleWithGroups} Success
		 */
		UpdateRole(requestBody: RoleWithGroups, headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return fetch(this.baseUri + 'roles', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteRole(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'roles/{roleId}', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {RoleWithGroups} Success
		 */
		GetRole(headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return fetch(this.baseUri + 'roles/{roleId}', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {Array<UserAccount>} Success
		 */
		GetUsers(headersHandler?: () => {[header: string]: string}): Promise<Array<UserAccount>> {
			return fetch(this.baseUri + 'users', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		AddUser(requestBody: UserAddition, headersHandler?: () => {[header: string]: string}): Promise<Response> {
		 ...
		 * @return {void} 
		 */
		UpdateUser(requestBody: UserAccount, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'users', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUser(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'users/{userId}', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {UserAccountRolesResults} Success
		 */
		GetUser(headersHandler?: () => {[header: string]: string}): Promise<UserAccountRolesResults> {
			return fetch(this.baseUri + 'users/{userId}', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
