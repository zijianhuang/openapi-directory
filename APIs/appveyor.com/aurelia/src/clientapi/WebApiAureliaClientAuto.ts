...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		EncryptValue(requestBody: EncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('account/encrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		GetBuildArtifacts(headersHandler?: () => {[header: string]: string}): Promise<Array<ArtifactModel>> {
			return this.http.get('buildjobs/{jobId}/artifacts', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBuildArtifact(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('buildjobs/{jobId}/artifacts/{artifactFileName}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBuildLog(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('buildjobs/{jobId}/log', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StartBuild(requestBody: BuildStartRequest, headersHandler?: () => {[header: string]: string}): Promise<Build> {
			return this.http.post('builds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ReRunBuild(requestBody: ReRunBuildRequest, headersHandler?: () => {[header: string]: string}): Promise<Build> {
			return this.http.put('builds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelBuild(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('builds/{accountName}/{projectSlug}/{buildVersion}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetCollaborators(headersHandler?: () => {[header: string]: string}): Promise<Array<UserAccount>> {
			return this.http.get('collaborators', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AddCollaborator(requestBody: CollaboratorAddition, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('collaborators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateCollaborator(requestBody: CollaboratorUpdate, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('collaborators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteCollaborator(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('collaborators/{userId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetCollaborator(headersHandler?: () => {[header: string]: string}): Promise<UserAccountRolesResults> {
			return this.http.get('collaborators/{userId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartDeployment(requestBody: DeploymentStartRequest, headersHandler?: () => {[header: string]: string}): Promise<Deployment> {
			return this.http.post('deployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelDeployment(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('deployments/stop', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDeployment(headersHandler?: () => {[header: string]: string}): Promise<ProjectDeployment> {
			return this.http.get('deployments/{deploymentId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEnvironments(headersHandler?: () => {[header: string]: string}): Promise<Array<DeploymentEnvironmentLookupModel>> {
			return this.http.get('environments', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AddEnvironment(requestBody: DeploymentEnvironmentAddition, headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentWithSettings> {
			return this.http.post('environments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateEnvironment(requestBody: DeploymentEnvironmentWithSettings, headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentWithSettings> {
			return this.http.put('environments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteEnvironment(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('environments/{deploymentEnvironmentId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEnvironmentDeployments(headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentDeploymentsResults> {
			return this.http.get('environments/{deploymentEnvironmentId}/deployments', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEnvironmentSettings(headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentSettingsResults> {
			return this.http.get('environments/{deploymentEnvironmentId}/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetProjects(headersHandler?: () => {[header: string]: string}): Promise<Array<Project>> {
			return this.http.get('projects', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AddProject(requestBody: ProjectAddition, headersHandler?: () => {[header: string]: string}): Promise<Project> {
			return this.http.post('projects', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateProject(requestBody: ProjectWithConfiguration, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('projects', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetProjectStatusBadge(svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projects/status/{statusBadgeId}?svg=' + svg + '&retina=' + retina + '&passingText=' + (passingText == null ? '' : encodeURIComponent(passingText)) + '&failingText=' + (failingText == null ? '' : encodeURIComponent(failingText)) + '&pendingText=' + (pendingText == null ? '' : encodeURIComponent(pendingText)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetProjectBranchStatusBadge(svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projects/status/{statusBadgeId}/branch/{buildBranch}?svg=' + svg + '&retina=' + retina + '&passingText=' + (passingText == null ? '' : encodeURIComponent(passingText)) + '&failingText=' + (failingText == null ? '' : encodeURIComponent(failingText)) + '&pendingText=' + (pendingText == null ? '' : encodeURIComponent(pendingText)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteProject(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('projects/{accountName}/{projectSlug}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetProjectLastBuild(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return this.http.get('projects/{accountName}/{projectSlug}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetProjectArtifact(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('projects/{accountName}/{projectSlug}/artifacts/{artifactFileName}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetProjectLastBuildBranch(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return this.http.get('projects/{accountName}/{projectSlug}/branch/{buildBranch}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetProjectBuildByVersion(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return this.http.get('projects/{accountName}/{projectSlug}/build/{buildVersion}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteProjectBuildCache(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('projects/{accountName}/{projectSlug}/buildcache', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetProjectDeployments(headersHandler?: () => {[header: string]: string}): Promise<ProjectDeploymentsResults> {
			return this.http.get('projects/{accountName}/{projectSlug}/deployments', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetProjectHistory(recordsNumber: number, startBuildId: number, branch: string, headersHandler?: () => {[header: string]: string}): Promise<ProjectHistory> {
			return this.http.get('projects/{accountName}/{projectSlug}/history?recordsNumber=' + recordsNumber + '&startBuildId=' + startBuildId + '&branch=' + (branch == null ? '' : encodeURIComponent(branch)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetProjectSettings(headersHandler?: () => {[header: string]: string}): Promise<ProjectSettingsResults> {
			return this.http.get('projects/{accountName}/{projectSlug}/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateProjectBuildNumber(requestBody: ProjectBuildNumberUpdate, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('projects/{accountName}/{projectSlug}/settings/build-number', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetProjectEnvironmentVariables(headersHandler?: () => {[header: string]: string}): Promise<Array<StoredNameValue>> {
			return this.http.get('projects/{accountName}/{projectSlug}/settings/environment-variables', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateProjectEnvironmentVariables(requestBody: Array<StoredNameValue>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('projects/{accountName}/{projectSlug}/settings/environment-variables', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetProjectSettingsYaml(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('projects/{accountName}/{projectSlug}/settings/yaml', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		GetRoles(headersHandler?: () => {[header: string]: string}): Promise<Array<Role>> {
			return this.http.get('roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AddRole(requestBody: RoleAddition, headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return this.http.post('roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateRole(requestBody: RoleWithGroups, headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return this.http.put('roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRole(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetRole(headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return this.http.get('roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetUsers(headersHandler?: () => {[header: string]: string}): Promise<Array<UserAccount>> {
			return this.http.get('users', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateUser(requestBody: UserAccount, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteUser(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('users/{userId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetUser(headersHandler?: () => {[header: string]: string}): Promise<UserAccountRolesResults> {
			return this.http.get('users/{userId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
