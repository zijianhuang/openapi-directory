...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		EncryptValue(requestBody: EncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.post(this.baseUri + 'account/encrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' },  responseType: 'text' }).then(d => d.data);
		}
		...
		GetBuildArtifacts(headersHandler?: () => {[header: string]: string}): Promise<Array<ArtifactModel>> {
			return Axios.get<Array<ArtifactModel>>(this.baseUri + 'buildjobs/{jobId}/artifacts', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		GetBuildArtifact(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'buildjobs/{jobId}/artifacts/{artifactFileName}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBuildLog(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'buildjobs/{jobId}/log', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		StartBuild(requestBody: BuildStartRequest, headersHandler?: () => {[header: string]: string}): Promise<Build> {
			return Axios.post<Build>(this.baseUri + 'builds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ReRunBuild(requestBody: ReRunBuildRequest, headersHandler?: () => {[header: string]: string}): Promise<Build> {
			return Axios.put<Build>(this.baseUri + 'builds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CancelBuild(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'builds/{accountName}/{projectSlug}/{buildVersion}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetCollaborators(headersHandler?: () => {[header: string]: string}): Promise<Array<UserAccount>> {
			return Axios.get<Array<UserAccount>>(this.baseUri + 'collaborators', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		AddCollaborator(requestBody: CollaboratorAddition, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'collaborators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateCollaborator(requestBody: CollaboratorUpdate, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'collaborators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteCollaborator(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'collaborators/{userId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetCollaborator(headersHandler?: () => {[header: string]: string}): Promise<UserAccountRolesResults> {
			return Axios.get<UserAccountRolesResults>(this.baseUri + 'collaborators/{userId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		StartDeployment(requestBody: DeploymentStartRequest, headersHandler?: () => {[header: string]: string}): Promise<Deployment> {
			return Axios.post<Deployment>(this.baseUri + 'deployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CancelDeployment(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'deployments/stop', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetDeployment(headersHandler?: () => {[header: string]: string}): Promise<ProjectDeployment> {
			return Axios.get<ProjectDeployment>(this.baseUri + 'deployments/{deploymentId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetEnvironments(headersHandler?: () => {[header: string]: string}): Promise<Array<DeploymentEnvironmentLookupModel>> {
			return Axios.get<Array<DeploymentEnvironmentLookupModel>>(this.baseUri + 'environments', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		AddEnvironment(requestBody: DeploymentEnvironmentAddition, headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentWithSettings> {
			return Axios.post<DeploymentEnvironmentWithSettings>(this.baseUri + 'environments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateEnvironment(requestBody: DeploymentEnvironmentWithSettings, headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentWithSettings> {
			return Axios.put<DeploymentEnvironmentWithSettings>(this.baseUri + 'environments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteEnvironment(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'environments/{deploymentEnvironmentId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetEnvironmentDeployments(headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentDeploymentsResults> {
			return Axios.get<DeploymentEnvironmentDeploymentsResults>(this.baseUri + 'environments/{deploymentEnvironmentId}/deployments', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetEnvironmentSettings(headersHandler?: () => {[header: string]: string}): Promise<DeploymentEnvironmentSettingsResults> {
			return Axios.get<DeploymentEnvironmentSettingsResults>(this.baseUri + 'environments/{deploymentEnvironmentId}/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetProjects(headersHandler?: () => {[header: string]: string}): Promise<Array<Project>> {
			return Axios.get<Array<Project>>(this.baseUri + 'projects', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		AddProject(requestBody: ProjectAddition, headersHandler?: () => {[header: string]: string}): Promise<Project> {
			return Axios.post<Project>(this.baseUri + 'projects', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateProject(requestBody: ProjectWithConfiguration, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'projects', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetPublicProjectStatusBadge(branch: string, svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GetProjectStatusBadge(svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GetProjectBranchStatusBadge(svg: boolean, retina: boolean, passingText: string, failingText: string, pendingText: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteProject(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'projects/{accountName}/{projectSlug}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetProjectLastBuild(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return Axios.get<ProjectBuildResults>(this.baseUri + 'projects/{accountName}/{projectSlug}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		GetProjectArtifact(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'projects/{accountName}/{projectSlug}/artifacts/{artifactFileName}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetProjectLastBuildBranch(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return Axios.get<ProjectBuildResults>(this.baseUri + 'projects/{accountName}/{projectSlug}/branch/{buildBranch}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetProjectBuildByVersion(headersHandler?: () => {[header: string]: string}): Promise<ProjectBuildResults> {
			return Axios.get<ProjectBuildResults>(this.baseUri + 'projects/{accountName}/{projectSlug}/build/{buildVersion}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteProjectBuildCache(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'projects/{accountName}/{projectSlug}/buildcache', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetProjectDeployments(headersHandler?: () => {[header: string]: string}): Promise<ProjectDeploymentsResults> {
			return Axios.get<ProjectDeploymentsResults>(this.baseUri + 'projects/{accountName}/{projectSlug}/deployments', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetProjectHistory(recordsNumber: number, startBuildId: number, branch: string, headersHandler?: () => {[header: string]: string}): Promise<ProjectHistory> {
			return Axios.get<ProjectHistory>(this.baseUri + 'projects/{accountName}/{projectSlug}/history?recordsNumber=' + recordsNumber + '&startBuildId=' + startBuildId + '&branch=' + (branch == null ? '' : encodeURIComponent(branch)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetProjectSettings(headersHandler?: () => {[header: string]: string}): Promise<ProjectSettingsResults> {
			return Axios.get<ProjectSettingsResults>(this.baseUri + 'projects/{accountName}/{projectSlug}/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateProjectBuildNumber(requestBody: ProjectBuildNumberUpdate, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/build-number', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetProjectEnvironmentVariables(headersHandler?: () => {[header: string]: string}): Promise<Array<StoredNameValue>> {
			return Axios.get<Array<StoredNameValue>>(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/environment-variables', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateProjectEnvironmentVariables(requestBody: Array<StoredNameValue>, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/environment-variables', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetProjectSettingsYaml(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + 'projects/{accountName}/{projectSlug}/settings/yaml', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		...
		GetRoles(headersHandler?: () => {[header: string]: string}): Promise<Array<Role>> {
			return Axios.get<Array<Role>>(this.baseUri + 'roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		AddRole(requestBody: RoleAddition, headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return Axios.post<RoleWithGroups>(this.baseUri + 'roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRole(requestBody: RoleWithGroups, headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return Axios.put<RoleWithGroups>(this.baseUri + 'roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteRole(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetRole(headersHandler?: () => {[header: string]: string}): Promise<RoleWithGroups> {
			return Axios.get<RoleWithGroups>(this.baseUri + 'roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetUsers(headersHandler?: () => {[header: string]: string}): Promise<Array<UserAccount>> {
			return Axios.get<Array<UserAccount>>(this.baseUri + 'users', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		AddUser(requestBody: UserAddition, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		UpdateUser(requestBody: UserAccount, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUser(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'users/{userId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetUser(headersHandler?: () => {[header: string]: string}): Promise<UserAccountRolesResults> {
			return Axios.get<UserAccountRolesResults>(this.baseUri + 'users/{userId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
