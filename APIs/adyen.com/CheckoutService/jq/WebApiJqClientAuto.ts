...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		PaymentMethodsPost(callback: (data : PaymentMethodsResponse) => any, requestBody: PaymentMethodsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'paymentMethods', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PaymentSessionPost(callback: (data : PaymentSetupResponse) => any, requestBody: PaymentSetupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'paymentSession', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PaymentsPost(callback: (data : PaymentResponse) => any, requestBody: PaymentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'payments', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {PaymentResponse} OK - the request has succeeded.
		 */
		PaymentsDetailsPost(callback: (data : PaymentResponse) => any, requestBody: DetailsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'payments/details', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PaymentsResultPost(callback: (data : PaymentVerificationResponse) => any, requestBody: PaymentVerificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'payments/result', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
