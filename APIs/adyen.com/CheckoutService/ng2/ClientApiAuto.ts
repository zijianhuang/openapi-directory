...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		PaymentMethodsPost(requestBody: PaymentMethodsRequest, headersHandler?: () => HttpHeaders): Observable<PaymentMethodsResponse> {
			return this.http.post<PaymentMethodsResponse>(this.baseUri + 'paymentMethods', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PaymentSessionPost(requestBody: PaymentSetupRequest, headersHandler?: () => HttpHeaders): Observable<PaymentSetupResponse> {
			return this.http.post<PaymentSetupResponse>(this.baseUri + 'paymentSession', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PaymentsPost(requestBody: PaymentRequest, headersHandler?: () => HttpHeaders): Observable<PaymentResponse> {
			return this.http.post<PaymentResponse>(this.baseUri + 'payments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {PaymentResponse} OK - the request has succeeded.
		 */
		PaymentsDetailsPost(requestBody: DetailsRequest, headersHandler?: () => HttpHeaders): Observable<PaymentResponse> {
			return this.http.post<PaymentResponse>(this.baseUri + 'payments/details', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PaymentsResultPost(requestBody: PaymentVerificationRequest, headersHandler?: () => HttpHeaders): Observable<PaymentVerificationResponse> {
			return this.http.post<PaymentVerificationResponse>(this.baseUri + 'payments/result', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
