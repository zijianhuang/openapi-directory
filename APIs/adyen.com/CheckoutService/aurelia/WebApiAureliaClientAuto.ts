...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		PaymentMethodsPost(requestBody: PaymentMethodsRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentMethodsResponse> {
			return this.http.post('paymentMethods', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PaymentSessionPost(requestBody: PaymentSetupRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentSetupResponse> {
			return this.http.post('paymentSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PaymentsPost(requestBody: PaymentRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentResponse> {
			return this.http.post('payments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PaymentsDetailsPost(requestBody: DetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentResponse> {
			return this.http.post('payments/details', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PaymentsResultPost(requestBody: PaymentVerificationRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentVerificationResponse> {
			return this.http.post('payments/result', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
