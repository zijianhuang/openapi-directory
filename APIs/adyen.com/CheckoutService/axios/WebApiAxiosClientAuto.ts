...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		PaymentMethodsPost(requestBody: PaymentMethodsRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentMethodsResponse> {
			return Axios.post<PaymentMethodsResponse>(this.baseUri + 'paymentMethods', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PaymentSessionPost(requestBody: PaymentSetupRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentSetupResponse> {
			return Axios.post<PaymentSetupResponse>(this.baseUri + 'paymentSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PaymentsPost(requestBody: PaymentRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentResponse> {
			return Axios.post<PaymentResponse>(this.baseUri + 'payments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PaymentsDetailsPost(requestBody: DetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentResponse> {
			return Axios.post<PaymentResponse>(this.baseUri + 'payments/details', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PaymentsResultPost(requestBody: PaymentVerificationRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentVerificationResponse> {
			return Axios.post<PaymentVerificationResponse>(this.baseUri + 'payments/result', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
