export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CloseAccountPost(requestBody: CloseAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<CloseAccountResponse> {
			return fetch(this.baseUri + 'closeAccount', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CloseAccountHolderPost(requestBody: CloseAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<CloseAccountHolderResponse> {
			return fetch(this.baseUri + 'closeAccountHolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAccountPost(requestBody: CreateAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAccountResponse> {
			return fetch(this.baseUri + 'createAccount', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAccountHolderPost(requestBody: CreateAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAccountHolderResponse> {
			return fetch(this.baseUri + 'createAccountHolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteBankAccountsPost(requestBody: DeleteBankAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return fetch(this.baseUri + 'deleteBankAccounts', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeletePayoutInstrumentTokensPost(requestBody: DeletePayoutInstrumentTokenRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return fetch(this.baseUri + 'deletePayoutInstrumentTokens', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteShareholdersPost(requestBody: DeleteShareholderRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return fetch(this.baseUri + 'deleteShareholders', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetAccountHolderPost(requestBody: GetAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountHolderResponse> {
			return fetch(this.baseUri + 'getAccountHolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetUploadedDocumentsPost(requestBody: GetUploadedDocumentsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUploadedDocumentsResponse> {
			return fetch(this.baseUri + 'getUploadedDocuments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SuspendAccountHolderPost(requestBody: SuspendAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<SuspendAccountHolderResponse> {
			return fetch(this.baseUri + 'suspendAccountHolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UnSuspendAccountHolderPost(requestBody: UnSuspendAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<UnSuspendAccountHolderResponse> {
			return fetch(this.baseUri + 'unSuspendAccountHolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateAccountPost(requestBody: UpdateAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountResponse> {
			return fetch(this.baseUri + 'updateAccount', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateAccountHolderPost(requestBody: UpdateAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountHolderResponse> {
			return fetch(this.baseUri + 'updateAccountHolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateAccountHolderStatePost(requestBody: UpdateAccountHolderStateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountHolderStatusResponse> {
			return fetch(this.baseUri + 'updateAccountHolderState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UploadDocumentPost(requestBody: UploadDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountHolderResponse> {
			return fetch(this.baseUri + 'uploadDocument', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		VerificationPost(requestBody: PerformVerificationRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return fetch(this.baseUri + 'verification', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
