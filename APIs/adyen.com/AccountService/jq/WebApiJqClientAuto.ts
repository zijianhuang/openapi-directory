...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CloseAccountPost(callback: (data : CloseAccountResponse) => any, requestBody: CloseAccountRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'closeAccount', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CloseAccountHolderPost(callback: (data : CloseAccountHolderResponse) => any, requestBody: CloseAccountHolderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'closeAccountHolder', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateAccountPost(callback: (data : CreateAccountResponse) => any, requestBody: CreateAccountRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'createAccount', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateAccountHolderPost(callback: (data : CreateAccountHolderResponse) => any, requestBody: CreateAccountHolderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'createAccountHolder', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteBankAccountsPost(callback: (data : GenericResponse) => any, requestBody: DeleteBankAccountRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'deleteBankAccounts', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {GenericResponse} OK - the request has succeeded.
		 */
		DeletePayoutInstrumentTokensPost(callback: (data : GenericResponse) => any, requestBody: DeletePayoutInstrumentTokenRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'deletePayoutInstrumentTokens', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {GenericResponse} OK - the request has succeeded.
		 */
		DeleteShareholdersPost(callback: (data : GenericResponse) => any, requestBody: DeleteShareholderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'deleteShareholders', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetAccountHolderPost(callback: (data : GetAccountHolderResponse) => any, requestBody: GetAccountHolderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'getAccountHolder', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetUploadedDocumentsPost(callback: (data : GetUploadedDocumentsResponse) => any, requestBody: GetUploadedDocumentsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'getUploadedDocuments', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SuspendAccountHolderPost(callback: (data : SuspendAccountHolderResponse) => any, requestBody: SuspendAccountHolderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'suspendAccountHolder', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UnSuspendAccountHolderPost(callback: (data : UnSuspendAccountHolderResponse) => any, requestBody: UnSuspendAccountHolderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'unSuspendAccountHolder', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateAccountPost(callback: (data : UpdateAccountResponse) => any, requestBody: UpdateAccountRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'updateAccount', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateAccountHolderPost(callback: (data : UpdateAccountHolderResponse) => any, requestBody: UpdateAccountHolderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'updateAccountHolder', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateAccountHolderStatePost(callback: (data : GetAccountHolderStatusResponse) => any, requestBody: UpdateAccountHolderStateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'updateAccountHolderState', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {UpdateAccountHolderResponse} OK - the request has succeeded.
		 */
		UploadDocumentPost(callback: (data : UpdateAccountHolderResponse) => any, requestBody: UploadDocumentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'uploadDocument', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {GenericResponse} OK - the request has succeeded.
		 */
		VerificationPost(callback: (data : GenericResponse) => any, requestBody: PerformVerificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'verification', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
