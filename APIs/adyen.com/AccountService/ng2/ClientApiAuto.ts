...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CloseAccountPost(requestBody: CloseAccountRequest, headersHandler?: () => HttpHeaders): Observable<CloseAccountResponse> {
			return this.http.post<CloseAccountResponse>(this.baseUri + 'closeAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CloseAccountHolderPost(requestBody: CloseAccountHolderRequest, headersHandler?: () => HttpHeaders): Observable<CloseAccountHolderResponse> {
			return this.http.post<CloseAccountHolderResponse>(this.baseUri + 'closeAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAccountPost(requestBody: CreateAccountRequest, headersHandler?: () => HttpHeaders): Observable<CreateAccountResponse> {
			return this.http.post<CreateAccountResponse>(this.baseUri + 'createAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAccountHolderPost(requestBody: CreateAccountHolderRequest, headersHandler?: () => HttpHeaders): Observable<CreateAccountHolderResponse> {
			return this.http.post<CreateAccountHolderResponse>(this.baseUri + 'createAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteBankAccountsPost(requestBody: DeleteBankAccountRequest, headersHandler?: () => HttpHeaders): Observable<GenericResponse> {
			return this.http.post<GenericResponse>(this.baseUri + 'deleteBankAccounts', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {GenericResponse} OK - the request has succeeded.
		 */
		DeletePayoutInstrumentTokensPost(requestBody: DeletePayoutInstrumentTokenRequest, headersHandler?: () => HttpHeaders): Observable<GenericResponse> {
			return this.http.post<GenericResponse>(this.baseUri + 'deletePayoutInstrumentTokens', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {GenericResponse} OK - the request has succeeded.
		 */
		DeleteShareholdersPost(requestBody: DeleteShareholderRequest, headersHandler?: () => HttpHeaders): Observable<GenericResponse> {
			return this.http.post<GenericResponse>(this.baseUri + 'deleteShareholders', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAccountHolderPost(requestBody: GetAccountHolderRequest, headersHandler?: () => HttpHeaders): Observable<GetAccountHolderResponse> {
			return this.http.post<GetAccountHolderResponse>(this.baseUri + 'getAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetUploadedDocumentsPost(requestBody: GetUploadedDocumentsRequest, headersHandler?: () => HttpHeaders): Observable<GetUploadedDocumentsResponse> {
			return this.http.post<GetUploadedDocumentsResponse>(this.baseUri + 'getUploadedDocuments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SuspendAccountHolderPost(requestBody: SuspendAccountHolderRequest, headersHandler?: () => HttpHeaders): Observable<SuspendAccountHolderResponse> {
			return this.http.post<SuspendAccountHolderResponse>(this.baseUri + 'suspendAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UnSuspendAccountHolderPost(requestBody: UnSuspendAccountHolderRequest, headersHandler?: () => HttpHeaders): Observable<UnSuspendAccountHolderResponse> {
			return this.http.post<UnSuspendAccountHolderResponse>(this.baseUri + 'unSuspendAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateAccountPost(requestBody: UpdateAccountRequest, headersHandler?: () => HttpHeaders): Observable<UpdateAccountResponse> {
			return this.http.post<UpdateAccountResponse>(this.baseUri + 'updateAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateAccountHolderPost(requestBody: UpdateAccountHolderRequest, headersHandler?: () => HttpHeaders): Observable<UpdateAccountHolderResponse> {
			return this.http.post<UpdateAccountHolderResponse>(this.baseUri + 'updateAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateAccountHolderStatePost(requestBody: UpdateAccountHolderStateRequest, headersHandler?: () => HttpHeaders): Observable<GetAccountHolderStatusResponse> {
			return this.http.post<GetAccountHolderStatusResponse>(this.baseUri + 'updateAccountHolderState', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {UpdateAccountHolderResponse} OK - the request has succeeded.
		 */
		UploadDocumentPost(requestBody: UploadDocumentRequest, headersHandler?: () => HttpHeaders): Observable<UpdateAccountHolderResponse> {
			return this.http.post<UpdateAccountHolderResponse>(this.baseUri + 'uploadDocument', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {GenericResponse} OK - the request has succeeded.
		 */
		VerificationPost(requestBody: PerformVerificationRequest, headersHandler?: () => HttpHeaders): Observable<GenericResponse> {
			return this.http.post<GenericResponse>(this.baseUri + 'verification', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
