...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CloseAccountPost(requestBody: CloseAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<CloseAccountResponse> {
			return Axios.post<CloseAccountResponse>(this.baseUri + 'closeAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CloseAccountHolderPost(requestBody: CloseAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<CloseAccountHolderResponse> {
			return Axios.post<CloseAccountHolderResponse>(this.baseUri + 'closeAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAccountPost(requestBody: CreateAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAccountResponse> {
			return Axios.post<CreateAccountResponse>(this.baseUri + 'createAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAccountHolderPost(requestBody: CreateAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAccountHolderResponse> {
			return Axios.post<CreateAccountHolderResponse>(this.baseUri + 'createAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteBankAccountsPost(requestBody: DeleteBankAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return Axios.post<GenericResponse>(this.baseUri + 'deleteBankAccounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeletePayoutInstrumentTokensPost(requestBody: DeletePayoutInstrumentTokenRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return Axios.post<GenericResponse>(this.baseUri + 'deletePayoutInstrumentTokens', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteShareholdersPost(requestBody: DeleteShareholderRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return Axios.post<GenericResponse>(this.baseUri + 'deleteShareholders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAccountHolderPost(requestBody: GetAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountHolderResponse> {
			return Axios.post<GetAccountHolderResponse>(this.baseUri + 'getAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUploadedDocumentsPost(requestBody: GetUploadedDocumentsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUploadedDocumentsResponse> {
			return Axios.post<GetUploadedDocumentsResponse>(this.baseUri + 'getUploadedDocuments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SuspendAccountHolderPost(requestBody: SuspendAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<SuspendAccountHolderResponse> {
			return Axios.post<SuspendAccountHolderResponse>(this.baseUri + 'suspendAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UnSuspendAccountHolderPost(requestBody: UnSuspendAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<UnSuspendAccountHolderResponse> {
			return Axios.post<UnSuspendAccountHolderResponse>(this.baseUri + 'unSuspendAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAccountPost(requestBody: UpdateAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountResponse> {
			return Axios.post<UpdateAccountResponse>(this.baseUri + 'updateAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAccountHolderPost(requestBody: UpdateAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountHolderResponse> {
			return Axios.post<UpdateAccountHolderResponse>(this.baseUri + 'updateAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAccountHolderStatePost(requestBody: UpdateAccountHolderStateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountHolderStatusResponse> {
			return Axios.post<GetAccountHolderStatusResponse>(this.baseUri + 'updateAccountHolderState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UploadDocumentPost(requestBody: UploadDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountHolderResponse> {
			return Axios.post<UpdateAccountHolderResponse>(this.baseUri + 'uploadDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		VerificationPost(requestBody: PerformVerificationRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return Axios.post<GenericResponse>(this.baseUri + 'verification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
