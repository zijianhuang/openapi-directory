...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AccountHolderBalancePost(requestBody: AccountHolderBalanceRequest, headersHandler?: () => HttpHeaders): Observable<AccountHolderBalanceResponse> {
			return this.http.post<AccountHolderBalanceResponse>(this.baseUri + 'accountHolderBalance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AccountHolderTransactionListPost(requestBody: AccountHolderTransactionListRequest, headersHandler?: () => HttpHeaders): Observable<AccountHolderTransactionListResponse> {
			return this.http.post<AccountHolderTransactionListResponse>(this.baseUri + 'accountHolderTransactionList', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PayoutAccountHolderPost(requestBody: PayoutAccountHolderRequest, headersHandler?: () => HttpHeaders): Observable<PayoutAccountHolderResponse> {
			return this.http.post<PayoutAccountHolderResponse>(this.baseUri + 'payoutAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RefundNotPaidOutTransfersPost(requestBody: RefundNotPaidOutTransfersRequest, headersHandler?: () => HttpHeaders): Observable<RefundNotPaidOutTransfersResponse> {
			return this.http.post<RefundNotPaidOutTransfersResponse>(this.baseUri + 'refundNotPaidOutTransfers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SetupBeneficiaryPost(requestBody: SetupBeneficiaryRequest, headersHandler?: () => HttpHeaders): Observable<SetupBeneficiaryResponse> {
			return this.http.post<SetupBeneficiaryResponse>(this.baseUri + 'setupBeneficiary', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TransferFundsPost(requestBody: TransferFundsRequest, headersHandler?: () => HttpHeaders): Observable<TransferFundsResponse> {
			return this.http.post<TransferFundsResponse>(this.baseUri + 'transferFunds', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
