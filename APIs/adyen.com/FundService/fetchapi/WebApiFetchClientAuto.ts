export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AccountHolderBalancePost(requestBody: AccountHolderBalanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AccountHolderBalanceResponse> {
			return fetch(this.baseUri + 'accountHolderBalance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AccountHolderTransactionListPost(requestBody: AccountHolderTransactionListRequest, headersHandler?: () => {[header: string]: string}): Promise<AccountHolderTransactionListResponse> {
			return fetch(this.baseUri + 'accountHolderTransactionList', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PayoutAccountHolderPost(requestBody: PayoutAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<PayoutAccountHolderResponse> {
			return fetch(this.baseUri + 'payoutAccountHolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RefundNotPaidOutTransfersPost(requestBody: RefundNotPaidOutTransfersRequest, headersHandler?: () => {[header: string]: string}): Promise<RefundNotPaidOutTransfersResponse> {
			return fetch(this.baseUri + 'refundNotPaidOutTransfers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SetupBeneficiaryPost(requestBody: SetupBeneficiaryRequest, headersHandler?: () => {[header: string]: string}): Promise<SetupBeneficiaryResponse> {
			return fetch(this.baseUri + 'setupBeneficiary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TransferFundsPost(requestBody: TransferFundsRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferFundsResponse> {
			return fetch(this.baseUri + 'transferFunds', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
