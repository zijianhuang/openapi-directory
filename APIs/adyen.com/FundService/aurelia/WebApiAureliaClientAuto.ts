...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AccountHolderBalancePost(requestBody: AccountHolderBalanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AccountHolderBalanceResponse> {
			return this.http.post('accountHolderBalance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AccountHolderTransactionListPost(requestBody: AccountHolderTransactionListRequest, headersHandler?: () => {[header: string]: string}): Promise<AccountHolderTransactionListResponse> {
			return this.http.post('accountHolderTransactionList', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PayoutAccountHolderPost(requestBody: PayoutAccountHolderRequest, headersHandler?: () => {[header: string]: string}): Promise<PayoutAccountHolderResponse> {
			return this.http.post('payoutAccountHolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RefundNotPaidOutTransfersPost(requestBody: RefundNotPaidOutTransfersRequest, headersHandler?: () => {[header: string]: string}): Promise<RefundNotPaidOutTransfersResponse> {
			return this.http.post('refundNotPaidOutTransfers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SetupBeneficiaryPost(requestBody: SetupBeneficiaryRequest, headersHandler?: () => {[header: string]: string}): Promise<SetupBeneficiaryResponse> {
			return this.http.post('setupBeneficiary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TransferFundsPost(requestBody: TransferFundsRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferFundsResponse> {
			return this.http.post('transferFunds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
