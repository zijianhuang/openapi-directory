...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AccountHolderBalancePost(callback: (data : AccountHolderBalanceResponse) => any, requestBody: AccountHolderBalanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'accountHolderBalance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AccountHolderTransactionListPost(callback: (data : AccountHolderTransactionListResponse) => any, requestBody: AccountHolderTransactionListRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'accountHolderTransactionList', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PayoutAccountHolderPost(callback: (data : PayoutAccountHolderResponse) => any, requestBody: PayoutAccountHolderRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'payoutAccountHolder', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RefundNotPaidOutTransfersPost(callback: (data : RefundNotPaidOutTransfersResponse) => any, requestBody: RefundNotPaidOutTransfersRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'refundNotPaidOutTransfers', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SetupBeneficiaryPost(callback: (data : SetupBeneficiaryResponse) => any, requestBody: SetupBeneficiaryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'setupBeneficiary', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TransferFundsPost(callback: (data : TransferFundsResponse) => any, requestBody: TransferFundsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'transferFunds', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
