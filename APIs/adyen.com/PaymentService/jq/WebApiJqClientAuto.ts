...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AdjustAuthorisationPost(callback: (data : ModificationResult) => any, requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'adjustAuthorisation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AuthorisePost(callback: (data : PaymentResult) => any, requestBody: PaymentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'authorise', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {PaymentResult} OK - the request has succeeded.
		 */
		Authorise3dPost(callback: (data : PaymentResult) => any, requestBody: PaymentRequest3d, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'authorise3d', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {PaymentResult} OK - the request has succeeded.
		 */
		Authorise3ds2Post(callback: (data : PaymentResult) => any, requestBody: PaymentRequest3ds2, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'authorise3ds2', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		CancelPost(callback: (data : ModificationResult) => any, requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'cancel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		CancelOrRefundPost(callback: (data : ModificationResult) => any, requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'cancelOrRefund', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		CapturePost(callback: (data : ModificationResult) => any, requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'capture', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		RefundPost(callback: (data : ModificationResult) => any, requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'refund', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Retrieve3ds2ResultPost(callback: (data : ThreeDS2ResultResponse) => any, requestBody: ThreeDS2ResultRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'retrieve3ds2Result', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		TechnicalCancelPost(callback: (data : ModificationResult) => any, requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'technicalCancel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		VoidPendingRefundPost(callback: (data : ModificationResult) => any, requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'voidPendingRefund', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
