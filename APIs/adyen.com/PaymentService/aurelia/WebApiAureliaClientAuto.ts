...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AdjustAuthorisationPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return this.http.post('adjustAuthorisation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AuthorisePost(requestBody: PaymentRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentResult> {
			return this.http.post('authorise', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Authorise3dPost(requestBody: PaymentRequest3d, headersHandler?: () => {[header: string]: string}): Promise<PaymentResult> {
			return this.http.post('authorise3d', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Authorise3ds2Post(requestBody: PaymentRequest3ds2, headersHandler?: () => {[header: string]: string}): Promise<PaymentResult> {
			return this.http.post('authorise3ds2', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return this.http.post('cancel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelOrRefundPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return this.http.post('cancelOrRefund', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CapturePost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return this.http.post('capture', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RefundPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return this.http.post('refund', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Retrieve3ds2ResultPost(requestBody: ThreeDS2ResultRequest, headersHandler?: () => {[header: string]: string}): Promise<ThreeDS2ResultResponse> {
			return this.http.post('retrieve3ds2Result', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TechnicalCancelPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return this.http.post('technicalCancel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		VoidPendingRefundPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return this.http.post('voidPendingRefund', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
