export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AdjustAuthorisationPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return fetch(this.baseUri + 'adjustAuthorisation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AuthorisePost(requestBody: PaymentRequest, headersHandler?: () => {[header: string]: string}): Promise<PaymentResult> {
			return fetch(this.baseUri + 'authorise', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Authorise3dPost(requestBody: PaymentRequest3d, headersHandler?: () => {[header: string]: string}): Promise<PaymentResult> {
			return fetch(this.baseUri + 'authorise3d', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Authorise3ds2Post(requestBody: PaymentRequest3ds2, headersHandler?: () => {[header: string]: string}): Promise<PaymentResult> {
			return fetch(this.baseUri + 'authorise3ds2', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CancelPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return fetch(this.baseUri + 'cancel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CancelOrRefundPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return fetch(this.baseUri + 'cancelOrRefund', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CapturePost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return fetch(this.baseUri + 'capture', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RefundPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return fetch(this.baseUri + 'refund', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Retrieve3ds2ResultPost(requestBody: ThreeDS2ResultRequest, headersHandler?: () => {[header: string]: string}): Promise<ThreeDS2ResultResponse> {
			return fetch(this.baseUri + 'retrieve3ds2Result', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TechnicalCancelPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return fetch(this.baseUri + 'technicalCancel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		VoidPendingRefundPost(requestBody: ModificationRequest, headersHandler?: () => {[header: string]: string}): Promise<ModificationResult> {
			return fetch(this.baseUri + 'voidPendingRefund', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
