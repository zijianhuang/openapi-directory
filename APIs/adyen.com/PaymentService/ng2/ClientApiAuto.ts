...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AdjustAuthorisationPost(requestBody: ModificationRequest, headersHandler?: () => HttpHeaders): Observable<ModificationResult> {
			return this.http.post<ModificationResult>(this.baseUri + 'adjustAuthorisation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AuthorisePost(requestBody: PaymentRequest, headersHandler?: () => HttpHeaders): Observable<PaymentResult> {
			return this.http.post<PaymentResult>(this.baseUri + 'authorise', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {PaymentResult} OK - the request has succeeded.
		 */
		Authorise3dPost(requestBody: PaymentRequest3d, headersHandler?: () => HttpHeaders): Observable<PaymentResult> {
			return this.http.post<PaymentResult>(this.baseUri + 'authorise3d', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {PaymentResult} OK - the request has succeeded.
		 */
		Authorise3ds2Post(requestBody: PaymentRequest3ds2, headersHandler?: () => HttpHeaders): Observable<PaymentResult> {
			return this.http.post<PaymentResult>(this.baseUri + 'authorise3ds2', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		CancelPost(requestBody: ModificationRequest, headersHandler?: () => HttpHeaders): Observable<ModificationResult> {
			return this.http.post<ModificationResult>(this.baseUri + 'cancel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		CancelOrRefundPost(requestBody: ModificationRequest, headersHandler?: () => HttpHeaders): Observable<ModificationResult> {
			return this.http.post<ModificationResult>(this.baseUri + 'cancelOrRefund', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		CapturePost(requestBody: ModificationRequest, headersHandler?: () => HttpHeaders): Observable<ModificationResult> {
			return this.http.post<ModificationResult>(this.baseUri + 'capture', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		RefundPost(requestBody: ModificationRequest, headersHandler?: () => HttpHeaders): Observable<ModificationResult> {
			return this.http.post<ModificationResult>(this.baseUri + 'refund', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Retrieve3ds2ResultPost(requestBody: ThreeDS2ResultRequest, headersHandler?: () => HttpHeaders): Observable<ThreeDS2ResultResponse> {
			return this.http.post<ThreeDS2ResultResponse>(this.baseUri + 'retrieve3ds2Result', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		TechnicalCancelPost(requestBody: ModificationRequest, headersHandler?: () => HttpHeaders): Observable<ModificationResult> {
			return this.http.post<ModificationResult>(this.baseUri + 'technicalCancel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ModificationResult} OK - the request has succeeded.
		 */
		VoidPendingRefundPost(requestBody: ModificationRequest, headersHandler?: () => HttpHeaders): Observable<ModificationResult> {
			return this.http.post<ModificationResult>(this.baseUri + 'voidPendingRefund', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
