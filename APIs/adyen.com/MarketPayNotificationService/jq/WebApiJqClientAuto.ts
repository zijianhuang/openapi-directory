...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ACCOUNT_CLOSEDPost(callback: (data : NotificationResponse) => any, requestBody: AccountCloseNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_CLOSED', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_CREATEDPost(callback: (data : NotificationResponse) => any, requestBody: AccountCreateNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_CREATED', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_CREATEDPost(callback: (data : NotificationResponse) => any, requestBody: AccountHolderCreateNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_HOLDER_CREATED', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_PAYOUTPost(callback: (data : NotificationResponse) => any, requestBody: AccountHolderPayoutNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_HOLDER_PAYOUT', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_STATUS_CHANGEPost(callback: (data : NotificationResponse) => any, requestBody: AccountHolderStatusChangeNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_HOLDER_STATUS_CHANGE', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_UPDATEDPost(callback: (data : NotificationResponse) => any, requestBody: AccountHolderUpdateNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_HOLDER_UPDATED', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_VERIFICATIONPost(callback: (data : NotificationResponse) => any, requestBody: AccountHolderVerificationNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_HOLDER_VERIFICATION', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_UPDATEDPost(callback: (data : NotificationResponse) => any, requestBody: AccountUpdateNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'ACCOUNT_UPDATED', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		BENEFICIARY_SETUPPost(callback: (data : NotificationResponse) => any, requestBody: BeneficiarySetupNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'BENEFICIARY_SETUP', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		COMPENSATE_NEGATIVE_BALANCEPost(callback: (data : NotificationResponse) => any, requestBody: CompensateNegativeBalanceNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'COMPENSATE_NEGATIVE_BALANCE', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		PAYMENT_FAILUREPost(callback: (data : NotificationResponse) => any, requestBody: PaymentFailureNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'PAYMENT_FAILURE', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		REPORT_AVAILABLEPost(callback: (data : NotificationResponse) => any, requestBody: ReportAvailableNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'REPORT_AVAILABLE', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		SCHEDULED_REFUNDSPost(callback: (data : NotificationResponse) => any, requestBody: ScheduledRefundsNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'SCHEDULED_REFUNDS', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		TRANSFER_FUNDSPost(callback: (data : NotificationResponse) => any, requestBody: TransferFundsNotification, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'TRANSFER_FUNDS', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
