export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ACCOUNT_CLOSEDPost(requestBody: AccountCloseNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_CLOSED', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ACCOUNT_CREATEDPost(requestBody: AccountCreateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_CREATED', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ACCOUNT_HOLDER_CREATEDPost(requestBody: AccountHolderCreateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_HOLDER_CREATED', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ACCOUNT_HOLDER_PAYOUTPost(requestBody: AccountHolderPayoutNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_HOLDER_PAYOUT', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ACCOUNT_HOLDER_STATUS_CHANGEPost(requestBody: AccountHolderStatusChangeNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_HOLDER_STATUS_CHANGE', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ACCOUNT_HOLDER_UPDATEDPost(requestBody: AccountHolderUpdateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_HOLDER_UPDATED', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ACCOUNT_HOLDER_VERIFICATIONPost(requestBody: AccountHolderVerificationNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_HOLDER_VERIFICATION', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ACCOUNT_UPDATEDPost(requestBody: AccountUpdateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'ACCOUNT_UPDATED', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BENEFICIARY_SETUPPost(requestBody: BeneficiarySetupNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'BENEFICIARY_SETUP', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		COMPENSATE_NEGATIVE_BALANCEPost(requestBody: CompensateNegativeBalanceNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'COMPENSATE_NEGATIVE_BALANCE', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PAYMENT_FAILUREPost(requestBody: PaymentFailureNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'PAYMENT_FAILURE', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		REPORT_AVAILABLEPost(requestBody: ReportAvailableNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'REPORT_AVAILABLE', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SCHEDULED_REFUNDSPost(requestBody: ScheduledRefundsNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'SCHEDULED_REFUNDS', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TRANSFER_FUNDSPost(requestBody: TransferFundsNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return fetch(this.baseUri + 'TRANSFER_FUNDS', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
