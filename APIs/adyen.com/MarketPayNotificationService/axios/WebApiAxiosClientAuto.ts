...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ACCOUNT_CLOSEDPost(requestBody: AccountCloseNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_CLOSED', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_CREATEDPost(requestBody: AccountCreateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_CREATED', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_CREATEDPost(requestBody: AccountHolderCreateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_HOLDER_CREATED', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_PAYOUTPost(requestBody: AccountHolderPayoutNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_HOLDER_PAYOUT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_STATUS_CHANGEPost(requestBody: AccountHolderStatusChangeNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_HOLDER_STATUS_CHANGE', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_UPDATEDPost(requestBody: AccountHolderUpdateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_HOLDER_UPDATED', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_HOLDER_VERIFICATIONPost(requestBody: AccountHolderVerificationNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_HOLDER_VERIFICATION', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		ACCOUNT_UPDATEDPost(requestBody: AccountUpdateNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'ACCOUNT_UPDATED', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		BENEFICIARY_SETUPPost(requestBody: BeneficiarySetupNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'BENEFICIARY_SETUP', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		COMPENSATE_NEGATIVE_BALANCEPost(requestBody: CompensateNegativeBalanceNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'COMPENSATE_NEGATIVE_BALANCE', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		PAYMENT_FAILUREPost(requestBody: PaymentFailureNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'PAYMENT_FAILURE', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		REPORT_AVAILABLEPost(requestBody: ReportAvailableNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'REPORT_AVAILABLE', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		SCHEDULED_REFUNDSPost(requestBody: ScheduledRefundsNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'SCHEDULED_REFUNDS', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {NotificationResponse} OK - the request has succeeded.
		 */
		TRANSFER_FUNDSPost(requestBody: TransferFundsNotification, headersHandler?: () => {[header: string]: string}): Promise<NotificationResponse> {
			return Axios.post<NotificationResponse>(this.baseUri + 'TRANSFER_FUNDS', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
