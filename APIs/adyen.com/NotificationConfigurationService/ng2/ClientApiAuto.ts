...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateNotificationConfigurationPost(requestBody: CreateNotificationConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<GetNotificationConfigurationResponse> {
			return this.http.post<GetNotificationConfigurationResponse>(this.baseUri + 'createNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteNotificationConfigurationsPost(requestBody: DeleteNotificationConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<GenericResponse> {
			return this.http.post<GenericResponse>(this.baseUri + 'deleteNotificationConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {GetNotificationConfigurationResponse} OK - the request has succeeded.
		 */
		GetNotificationConfigurationPost(requestBody: GetNotificationConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<GetNotificationConfigurationResponse> {
			return this.http.post<GetNotificationConfigurationResponse>(this.baseUri + 'getNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetNotificationConfigurationListPost(requestBody: EmptyRequest, headersHandler?: () => HttpHeaders): Observable<GetNotificationConfigurationListResponse> {
			return this.http.post<GetNotificationConfigurationListResponse>(this.baseUri + 'getNotificationConfigurationList', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TestNotificationConfigurationPost(requestBody: TestNotificationConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<TestNotificationConfigurationResponse> {
			return this.http.post<TestNotificationConfigurationResponse>(this.baseUri + 'testNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {GetNotificationConfigurationResponse} OK - the request has succeeded.
		 */
		UpdateNotificationConfigurationPost(requestBody: UpdateNotificationConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<GetNotificationConfigurationResponse> {
			return this.http.post<GetNotificationConfigurationResponse>(this.baseUri + 'updateNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
