...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateNotificationConfigurationPost(requestBody: CreateNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationResponse> {
			return this.http.post('createNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteNotificationConfigurationsPost(requestBody: DeleteNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return this.http.post('deleteNotificationConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetNotificationConfigurationPost(requestBody: GetNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationResponse> {
			return this.http.post('getNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetNotificationConfigurationListPost(requestBody: EmptyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationListResponse> {
			return this.http.post('getNotificationConfigurationList', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TestNotificationConfigurationPost(requestBody: TestNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<TestNotificationConfigurationResponse> {
			return this.http.post('testNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNotificationConfigurationPost(requestBody: UpdateNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationResponse> {
			return this.http.post('updateNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
