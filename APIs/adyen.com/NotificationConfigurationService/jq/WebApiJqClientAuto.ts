...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateNotificationConfigurationPost(callback: (data : GetNotificationConfigurationResponse) => any, requestBody: CreateNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'createNotificationConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteNotificationConfigurationsPost(callback: (data : GenericResponse) => any, requestBody: DeleteNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'deleteNotificationConfigurations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {GetNotificationConfigurationResponse} OK - the request has succeeded.
		 */
		GetNotificationConfigurationPost(callback: (data : GetNotificationConfigurationResponse) => any, requestBody: GetNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'getNotificationConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetNotificationConfigurationListPost(callback: (data : GetNotificationConfigurationListResponse) => any, requestBody: EmptyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'getNotificationConfigurationList', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TestNotificationConfigurationPost(callback: (data : TestNotificationConfigurationResponse) => any, requestBody: TestNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'testNotificationConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {GetNotificationConfigurationResponse} OK - the request has succeeded.
		 */
		UpdateNotificationConfigurationPost(callback: (data : GetNotificationConfigurationResponse) => any, requestBody: UpdateNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'updateNotificationConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
