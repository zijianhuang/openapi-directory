...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateNotificationConfigurationPost(requestBody: CreateNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationResponse> {
			return Axios.post<GetNotificationConfigurationResponse>(this.baseUri + 'createNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteNotificationConfigurationsPost(requestBody: DeleteNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GenericResponse> {
			return Axios.post<GenericResponse>(this.baseUri + 'deleteNotificationConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetNotificationConfigurationPost(requestBody: GetNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationResponse> {
			return Axios.post<GetNotificationConfigurationResponse>(this.baseUri + 'getNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetNotificationConfigurationListPost(requestBody: EmptyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationListResponse> {
			return Axios.post<GetNotificationConfigurationListResponse>(this.baseUri + 'getNotificationConfigurationList', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TestNotificationConfigurationPost(requestBody: TestNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<TestNotificationConfigurationResponse> {
			return Axios.post<TestNotificationConfigurationResponse>(this.baseUri + 'testNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateNotificationConfigurationPost(requestBody: UpdateNotificationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationConfigurationResponse> {
			return Axios.post<GetNotificationConfigurationResponse>(this.baseUri + 'updateNotificationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
