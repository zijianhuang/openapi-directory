...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ConfirmThirdPartyPost(requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyResponse> {
			return Axios.post<ModifyResponse>(this.baseUri + 'confirmThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {ModifyResponse} OK - the request has succeeded.
		 */
		DeclineThirdPartyPost(requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyResponse> {
			return Axios.post<ModifyResponse>(this.baseUri + 'declineThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PayoutPost(requestBody: PayoutRequest, headersHandler?: () => {[header: string]: string}): Promise<PayoutResponse> {
			return Axios.post<PayoutResponse>(this.baseUri + 'payout', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StoreDetailPost(requestBody: StoreDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<StoreDetailResponse> {
			return Axios.post<StoreDetailResponse>(this.baseUri + 'storeDetail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StoreDetailAndSubmitThirdPartyPost(requestBody: StoreDetailAndSubmitRequest, headersHandler?: () => {[header: string]: string}): Promise<StoreDetailAndSubmitResponse> {
			return Axios.post<StoreDetailAndSubmitResponse>(this.baseUri + 'storeDetailAndSubmitThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		SubmitThirdPartyPost(requestBody: SubmitRequest, headersHandler?: () => {[header: string]: string}): Promise<SubmitResponse> {
			return Axios.post<SubmitResponse>(this.baseUri + 'submitThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
