...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ConfirmThirdPartyPost(callback: (data : ModifyResponse) => any, requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'confirmThirdParty', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {ModifyResponse} OK - the request has succeeded.
		 */
		DeclineThirdPartyPost(callback: (data : ModifyResponse) => any, requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'declineThirdParty', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PayoutPost(callback: (data : PayoutResponse) => any, requestBody: PayoutRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'payout', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StoreDetailPost(callback: (data : StoreDetailResponse) => any, requestBody: StoreDetailRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'storeDetail', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StoreDetailAndSubmitThirdPartyPost(callback: (data : StoreDetailAndSubmitResponse) => any, requestBody: StoreDetailAndSubmitRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'storeDetailAndSubmitThirdParty', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SubmitThirdPartyPost(callback: (data : SubmitResponse) => any, requestBody: SubmitRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'submitThirdParty', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
