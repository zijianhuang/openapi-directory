...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ConfirmThirdPartyPost(requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyResponse> {
			return this.http.post('confirmThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeclineThirdPartyPost(requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyResponse> {
			return this.http.post('declineThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PayoutPost(requestBody: PayoutRequest, headersHandler?: () => {[header: string]: string}): Promise<PayoutResponse> {
			return this.http.post('payout', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StoreDetailPost(requestBody: StoreDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<StoreDetailResponse> {
			return this.http.post('storeDetail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StoreDetailAndSubmitThirdPartyPost(requestBody: StoreDetailAndSubmitRequest, headersHandler?: () => {[header: string]: string}): Promise<StoreDetailAndSubmitResponse> {
			return this.http.post('storeDetailAndSubmitThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SubmitThirdPartyPost(requestBody: SubmitRequest, headersHandler?: () => {[header: string]: string}): Promise<SubmitResponse> {
			return this.http.post('submitThirdParty', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
