export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ConfirmThirdPartyPost(requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyResponse> {
			return fetch(this.baseUri + 'confirmThirdParty', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeclineThirdPartyPost(requestBody: ModifyRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyResponse> {
			return fetch(this.baseUri + 'declineThirdParty', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PayoutPost(requestBody: PayoutRequest, headersHandler?: () => {[header: string]: string}): Promise<PayoutResponse> {
			return fetch(this.baseUri + 'payout', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StoreDetailPost(requestBody: StoreDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<StoreDetailResponse> {
			return fetch(this.baseUri + 'storeDetail', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StoreDetailAndSubmitThirdPartyPost(requestBody: StoreDetailAndSubmitRequest, headersHandler?: () => {[header: string]: string}): Promise<StoreDetailAndSubmitResponse> {
			return fetch(this.baseUri + 'storeDetailAndSubmitThirdParty', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SubmitThirdPartyPost(requestBody: SubmitRequest, headersHandler?: () => {[header: string]: string}): Promise<SubmitResponse> {
			return fetch(this.baseUri + 'submitThirdParty', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
