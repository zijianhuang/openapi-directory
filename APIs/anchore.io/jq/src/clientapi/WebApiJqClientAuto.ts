...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Ping(callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		Get_users_account(callback: (data : Account) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		List_accounts(state: string, callback: (data : Array<Account>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'accounts?state=' + (state == null ? '' : encodeURIComponent(state)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Create_account(callback: (data : Account) => any, requestBody: AccountCreationRequest, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} 
		 */
		Delete_account(accountname: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_account(accountname: string, callback: (data : Account) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Update_account_state(accountname: string, callback: (data : AccountStatus) => any, requestBody: AccountStatus, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/state', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		List_users(accountname: string, callback: (data : Array<User>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Create_user(accountname: string, callback: (data : User) => any, requestBody: UserCreationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Delete_user(accountname: string, username: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_account_user(accountname: string, username: string, callback: (data : User) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Delete_user_credential(accountname: string, username: string, credential_type: AccessCredentialType, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials&credential_type=' + credential_type, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_user_credentials(accountname: string, username: string, callback: (data : Array<AccessCredential>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Create_user_credential(accountname: string, username: string, callback: (data : User) => any, requestBody: AccessCredential, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		List_archives(callback: (data : ArchiveSummary) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'archives', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_analysis_archive(callback: (data : Array<ArchivedAnalysis>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'archives/images', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Archive_image_analysis(callback: (data : Array<AnalysisArchiveAddResult>) => any, requestBody: ImageAnalysisReferences, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'archives/images', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Delete_archived_analysis(imageDigest: string, force: boolean, callback: (data : ArchivedAnalysis) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_archived_analysis(imageDigest: string, callback: (data : ArchivedAnalysis) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_analysis_archive_rules(system_global: boolean, callback: (data : Array<AnalysisArchiveTransitionRule>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'archives/rules?system_global=' + system_global, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Create_analysis_archive_rule(callback: (data : AnalysisArchiveTransitionRule) => any, requestBody: AnalysisArchiveTransitionRule, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'archives/rules', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {AnalysisArchiveTransitionRule} Archive transition rule
		 */
		Delete_analysis_archive_rule(ruleId: string, callback: (data : AnalysisArchiveTransitionRule) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {AnalysisArchiveTransitionRule} Archive transition rule
		 */
		Get_analysis_archive_rule(ruleId: string, callback: (data : AnalysisArchiveTransitionRule) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_event_types(callback: (data : Array<EventCategory>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'event_types', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Delete_events(before: string, since: string, level: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'events?before=' + (before == null ? '' : encodeURIComponent(before)) + '&since=' + (since == null ? '' : encodeURIComponent(since)) + '&level=' + (level == null ? '' : encodeURIComponent(level)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_events(source_servicename: string, source_hostid: string, event_type: string, resource_type: string, resource_id: string, level: string, since: string, before: string, page: number, limit: number, callback: (data : EventsList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'events?source_servicename=' + (source_servicename == null ? '' : encodeURIComponent(source_servicename)) + '&source_hostid=' + (source_hostid == null ? '' : encodeURIComponent(source_hostid)) + '&event_type=' + (event_type == null ? '' : encodeURIComponent(event_type)) + '&resource_type=' + (resource_type == null ? '' : encodeURIComponent(resource_type)) + '&resource_id=' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '&level=' + (level == null ? '' : encodeURIComponent(level)) + '&since=' + (since == null ? '' : encodeURIComponent(since)) + '&before=' + (before == null ? '' : encodeURIComponent(before)) + '&page=' + page + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Delete_event(eventId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'events/' + (eventId == null ? '' : encodeURIComponent(eventId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_event(eventId: string, callback: (data : EventResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'events/' + (eventId == null ? '' : encodeURIComponent(eventId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Health_noop(callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'health', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_images(history: boolean, fulltag: string, callback: (data : Array<AnchoreImage>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images?history=' + history + '&fulltag=' + (fulltag == null ? '' : encodeURIComponent(fulltag)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Add_image(force: boolean, autosubscribe: boolean, callback: (data : Array<AnchoreImage>) => any, requestBody: ImageAnalysisRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'images?force=' + force + '&autosubscribe=' + autosubscribe, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Delete_image_by_imageId(imageId: string, force: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '&force=' + force, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_by_imageId(imageId: string, callback: (data : Array<AnchoreImage>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_policy_check_by_imageId(imageId: string, policyId: string, tag: string, detail: boolean, history: boolean, callback: (data : Array<PolicyEvaluation>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_image_content_by_imageid(imageId: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_content_by_type_imageId_files(imageId: string, callback: (data : ContentFilesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/files', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_content_by_type_imageId_javapackage(imageId: string, callback: (data : ContentJAVAPackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/java', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_content_by_type_imageId(imageId: string, ctype: string, callback: (data : ContentPackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_vulnerability_types_by_imageId(imageId: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_vulnerabilities_by_type_imageId(imageId: string, vtype: string, callback: (data : VulnerabilityResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Image deletion success
		 */
		Delete_image(imageDigest: string, force: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Array<AnchoreImage>} Image lookup success
		 */
		Get_image(imageDigest: string, callback: (data : Array<AnchoreImage>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_file_content_search_results(imageDigest: string, callback: (data : Array<FileContentSearchResult>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/file_content_search', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_retrieved_files(imageDigest: string, callback: (data : Array<RetrievedFile>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/retrieved_files', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_secret_search_results(imageDigest: string, callback: (data : Array<SecretSearchResult>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/secret_search', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Array<PolicyEvaluation>} Policy evaluation success
		 */
		Get_image_policy_check(imageDigest: string, policyId: string, tag: string, detail: boolean, history: boolean, interactive: boolean, callback: (data : Array<PolicyEvaluation>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history + '&interactive=' + interactive, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_image_content(imageDigest: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {ContentFilesResponse} Content of specified type from the image
		 */
		Get_image_content_by_type_files(imageDigest: string, callback: (data : ContentFilesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/files', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {ContentJAVAPackageResponse} Content of specified type from the image
		 */
		Get_image_content_by_type_javapackage(imageDigest: string, callback: (data : ContentJAVAPackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/java', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {ContentPackageResponse} Content of specified type from the image
		 */
		Get_image_content_by_type(imageDigest: string, ctype: string, callback: (data : ContentPackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_image_metadata(imageDigest: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_image_metadata_by_type(imageDigest: string, mtype: string, callback: (data : MetadataResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata/' + (mtype == null ? '' : encodeURIComponent(mtype)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Array<string>} Vulnerability listing for the image
		 */
		Get_image_vulnerability_types(imageDigest: string, callback: (data : Array<string>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {VulnerabilityResponse} Vulnerability listing for the image
		 */
		Get_image_vulnerabilities_by_type(imageDigest: string, vtype: string, force_refresh: boolean, vendor_only: boolean, callback: (data : VulnerabilityResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)) + '&force_refresh=' + force_refresh + '&vendor_only=' + vendor_only, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_oauth_token(callback: (data : TokenResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'oauth/token', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		List_policies(detail: boolean, callback: (data : Array<PolicyBundleRecord>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'policies?detail=' + detail, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Add_policy(callback: (data : PolicyBundleRecord) => any, requestBody: PolicyBundle, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'policies', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_policy(policyId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_policy(policyId: string, detail: boolean, callback: (data : Array<PolicyBundleRecord>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&detail=' + detail, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Update_policy(policyId: string, active: boolean, callback: (data : Array<PolicyBundleRecord>) => any, requestBody: PolicyBundleRecord, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&active=' + active, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Query_images_by_package(name: string, package_type: string, version: string, page: string, limit: number, callback: (data : PaginatedImageList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'query/images/by_package?name=' + (name == null ? '' : encodeURIComponent(name)) + '&package_type=' + (package_type == null ? '' : encodeURIComponent(package_type)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&page=' + (page == null ? '' : encodeURIComponent(page)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Query_images_by_vulnerability(vulnerability_id: string, namespace: string, affected_package: string, severity: StandaloneVulnerabilitySeverity, vendor_only: boolean, page: number, limit: number, callback: (data : PaginatedVulnerableImageList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'query/images/by_vulnerability?vulnerability_id=' + (vulnerability_id == null ? '' : encodeURIComponent(vulnerability_id)) + '&namespace=' + (namespace == null ? '' : encodeURIComponent(namespace)) + '&affected_package=' + (affected_package == null ? '' : encodeURIComponent(affected_package)) + '&severity=' + severity + '&vendor_only=' + vendor_only + '&page=' + page + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Query_vulnerabilities(id: Array<string>, affected_package: string, affected_package_version: string, page: string, limit: number, namespace: Array<string>, callback: (data : PaginatedVulnerabilityList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'query/vulnerabilities?' + id.map(z => `id=${encodeURIComponent(z)}`).join('&') + '&affected_package=' + (affected_package == null ? '' : encodeURIComponent(affected_package)) + '&affected_package_version=' + (affected_package_version == null ? '' : encodeURIComponent(affected_package_version)) + '&page=' + (page == null ? '' : encodeURIComponent(page)) + '&limit=' + limit + '&' + namespace.map(z => `namespace=${encodeURIComponent(z)}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_registries(callback: (data : Array<RegistryConfiguration>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'registries', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Create_registry(validate: boolean, callback: (data : Array<RegistryConfiguration>) => any, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'registries?validate=' + validate, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_registry(registry: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_registry(registry: string, callback: (data : RegistryConfiguration) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Update_registry(registry: string, validate: boolean, callback: (data : Array<RegistryConfiguration>) => any, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)) + '&validate=' + validate, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Add_repository(repository: string, autosubscribe: boolean, lookuptag: string, callback: (data : Array<Subscription>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'repositories?repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&autosubscribe=' + autosubscribe + '&lookuptag=' + (lookuptag == null ? '' : encodeURIComponent(lookuptag)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Get_status(callback: (data : StatusResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		List_subscriptions(subscription_key: string, subscription_type: string, callback: (data : Array<Subscription>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions?subscription_key=' + (subscription_key == null ? '' : encodeURIComponent(subscription_key)) + '&subscription_type=' + (subscription_type == null ? '' : encodeURIComponent(subscription_type)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Add_subscription(callback: (data : Array<Subscription>) => any, requestBody: SubscriptionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'subscriptions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_subscription(subscriptionId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_subscription(subscriptionId: string, callback: (data : Array<Subscription>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Array<Subscription>} Subscription add success
		 */
		Update_subscription(subscriptionId: string, callback: (data : Array<Subscription>) => any, requestBody: SubscriptionUpdate, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		List_imagetags(callback: (data : Array<AnchoreImageTagSummary>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'summaries/imagetags', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_service_detail(callback: (data : SystemStatusResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'system', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Describe_error_codes(callback: (data : Array<AnchoreErrorCode>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'system/error_codes', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_system_feeds(callback: (data : Array<FeedMetadata>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'system/feeds', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Post_system_feeds(flush: boolean, sync: boolean, callback: (data : Array<FeedSyncResult>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'system/feeds?flush=' + flush + '&sync=' + sync, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Describe_policy(callback: (data : Array<GateSpec>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'system/policy_spec', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		List_services(callback: (data : Array<Service>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'system/services', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_services_by_name(servicename: string, callback: (data : Array<Service>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_service(servicename: string, hostid: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_services_by_name_and_host(servicename: string, hostid: string, callback: (data : Array<Service>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Get_user(callback: (data : User) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {Array<AccessCredential>} User credential listing
		 */
		Get_credentials(callback: (data : Array<AccessCredential>) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'user/credentials', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {User} Add a credential, overwritting if already exists
		 */
		Add_credential(callback: (data : User) => any, requestBody: AccessCredential, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'user/credentials', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Version_noop(callback: (data : ServiceVersion) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'version', callback, this.error, this.statusCode, headersHandler);
		}
	}
