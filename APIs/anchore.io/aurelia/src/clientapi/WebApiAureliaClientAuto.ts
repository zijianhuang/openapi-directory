...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Ping(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		List_accounts(state: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Account>> {
			return this.http.get('accounts?state=' + (state == null ? '' : encodeURIComponent(state)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_account(requestBody: AccountCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return this.http.post('accounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_account(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_account(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return this.http.get('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_account_state(accountname: string, requestBody: AccountStatus, headersHandler?: () => {[header: string]: string}): Promise<AccountStatus> {
			return this.http.put('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/state', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		List_users(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Array<User>> {
			return this.http.get('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_user(accountname: string, requestBody: UserCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return this.http.post('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_user(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_account_user(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return this.http.get('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Delete_user_credential(accountname: string, username: string, credential_type: AccessCredentialType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials&credential_type=' + credential_type, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		List_user_credentials(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AccessCredential>> {
			return this.http.get('accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_archives(headersHandler?: () => {[header: string]: string}): Promise<ArchiveSummary> {
			return this.http.get('archives', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_analysis_archive(headersHandler?: () => {[header: string]: string}): Promise<Array<ArchivedAnalysis>> {
			return this.http.get('archives/images', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Archive_image_analysis(requestBody: ImageAnalysisReferences, headersHandler?: () => {[header: string]: string}): Promise<Array<AnalysisArchiveAddResult>> {
			return this.http.post('archives/images', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_archived_analysis(imageDigest: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<ArchivedAnalysis> {
			return this.http.delete('archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_archived_analysis(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ArchivedAnalysis> {
			return this.http.get('archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_analysis_archive_rules(system_global: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<AnalysisArchiveTransitionRule>> {
			return this.http.get('archives/rules?system_global=' + system_global, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_analysis_archive_rule(requestBody: AnalysisArchiveTransitionRule, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return this.http.post('archives/rules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_analysis_archive_rule(ruleId: string, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return this.http.delete('archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_analysis_archive_rule(ruleId: string, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return this.http.get('archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_event_types(headersHandler?: () => {[header: string]: string}): Promise<Array<EventCategory>> {
			return this.http.get('event_types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Delete_events(before: string, since: string, level: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.delete('events?before=' + (before == null ? '' : encodeURIComponent(before)) + '&since=' + (since == null ? '' : encodeURIComponent(since)) + '&level=' + (level == null ? '' : encodeURIComponent(level)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_events(source_servicename: string, source_hostid: string, event_type: string, resource_type: string, resource_id: string, level: string, since: string, before: string, page: number, limit: number, headersHandler?: () => {[header: string]: string}): Promise<EventsList> {
			return this.http.get('events?source_servicename=' + (source_servicename == null ? '' : encodeURIComponent(source_servicename)) + '&source_hostid=' + (source_hostid == null ? '' : encodeURIComponent(source_hostid)) + '&event_type=' + (event_type == null ? '' : encodeURIComponent(event_type)) + '&resource_type=' + (resource_type == null ? '' : encodeURIComponent(resource_type)) + '&resource_id=' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '&level=' + (level == null ? '' : encodeURIComponent(level)) + '&since=' + (since == null ? '' : encodeURIComponent(since)) + '&before=' + (before == null ? '' : encodeURIComponent(before)) + '&page=' + page + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Delete_event(eventId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('events/' + (eventId == null ? '' : encodeURIComponent(eventId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_event(eventId: string, headersHandler?: () => {[header: string]: string}): Promise<EventResponse> {
			return this.http.get('events/' + (eventId == null ? '' : encodeURIComponent(eventId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Health_noop(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('health', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		List_images(history: boolean, fulltag: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return this.http.get('images?history=' + history + '&fulltag=' + (fulltag == null ? '' : encodeURIComponent(fulltag)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_image(force: boolean, autosubscribe: boolean, requestBody: ImageAnalysisRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return this.http.post('images?force=' + force + '&autosubscribe=' + autosubscribe, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_image_by_imageId(imageId: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_image_by_imageId(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_policy_check_by_imageId(imageId: string, policyId: string, tag: string, detail: boolean, history: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyEvaluation>> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_image_content_by_imageid(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_imageId_files(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<ContentFilesResponse> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/files', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_imageId_javapackage(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<ContentJAVAPackageResponse> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/java', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_imageId(imageId: string, ctype: string, headersHandler?: () => {[header: string]: string}): Promise<ContentPackageResponse> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerability_types_by_imageId(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerabilities_by_type_imageId(imageId: string, vtype: string, headersHandler?: () => {[header: string]: string}): Promise<VulnerabilityResponse> {
			return this.http.get('images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Delete_image(imageDigest: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_image(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_file_content_search_results(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<FileContentSearchResult>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/file_content_search', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_retrieved_files(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<RetrievedFile>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/retrieved_files', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_secret_search_results(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<SecretSearchResult>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/secret_search', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_policy_check(imageDigest: string, policyId: string, tag: string, detail: boolean, history: boolean, interactive: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyEvaluation>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history + '&interactive=' + interactive, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_image_content(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_files(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ContentFilesResponse> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/files', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_javapackage(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ContentJAVAPackageResponse> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/java', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type(imageDigest: string, ctype: string, headersHandler?: () => {[header: string]: string}): Promise<ContentPackageResponse> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_image_metadata(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_metadata_by_type(imageDigest: string, mtype: string, headersHandler?: () => {[header: string]: string}): Promise<MetadataResponse> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata/' + (mtype == null ? '' : encodeURIComponent(mtype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerability_types(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerabilities_by_type(imageDigest: string, vtype: string, force_refresh: boolean, vendor_only: boolean, headersHandler?: () => {[header: string]: string}): Promise<VulnerabilityResponse> {
			return this.http.get('images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)) + '&force_refresh=' + force_refresh + '&vendor_only=' + vendor_only, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_oauth_token(headersHandler?: () => {[header: string]: string}): Promise<TokenResponse> {
			return this.http.post('oauth/token', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_policies(detail: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return this.http.get('policies?detail=' + detail, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_policy(requestBody: PolicyBundle, headersHandler?: () => {[header: string]: string}): Promise<PolicyBundleRecord> {
			return this.http.post('policies', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_policy(policyId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('policies/' + (policyId == null ? '' : encodeURIComponent(policyId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_policy(policyId: string, detail: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return this.http.get('policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&detail=' + detail, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_policy(policyId: string, active: boolean, requestBody: PolicyBundleRecord, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return this.http.put('policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&active=' + active, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Query_images_by_package(name: string, package_type: string, version: string, page: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PaginatedImageList> {
			return this.http.get('query/images/by_package?name=' + (name == null ? '' : encodeURIComponent(name)) + '&package_type=' + (package_type == null ? '' : encodeURIComponent(package_type)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&page=' + (page == null ? '' : encodeURIComponent(page)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_registries(headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return this.http.get('registries', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_registry(validate: boolean, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return this.http.post('registries?validate=' + validate, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_registry(registry: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('registries/' + (registry == null ? '' : encodeURIComponent(registry)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_registry(registry: string, headersHandler?: () => {[header: string]: string}): Promise<RegistryConfiguration> {
			return this.http.get('registries/' + (registry == null ? '' : encodeURIComponent(registry)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_registry(registry: string, validate: boolean, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return this.http.put('registries/' + (registry == null ? '' : encodeURIComponent(registry)) + '&validate=' + validate, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Add_repository(repository: string, autosubscribe: boolean, lookuptag: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return this.http.post('repositories?repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&autosubscribe=' + autosubscribe + '&lookuptag=' + (lookuptag == null ? '' : encodeURIComponent(lookuptag)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_status(headersHandler?: () => {[header: string]: string}): Promise<StatusResponse> {
			return this.http.get('status', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_subscriptions(subscription_key: string, subscription_type: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return this.http.get('subscriptions?subscription_key=' + (subscription_key == null ? '' : encodeURIComponent(subscription_key)) + '&subscription_type=' + (subscription_type == null ? '' : encodeURIComponent(subscription_type)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_subscription(requestBody: SubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return this.http.post('subscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Delete_subscription(subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_subscription(subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return this.http.get('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_subscription(subscriptionId: string, requestBody: SubscriptionUpdate, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return this.http.put('subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		List_imagetags(headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImageTagSummary>> {
			return this.http.get('summaries/imagetags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_service_detail(headersHandler?: () => {[header: string]: string}): Promise<SystemStatusResponse> {
			return this.http.get('system', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Describe_error_codes(headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreErrorCode>> {
			return this.http.get('system/error_codes', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_system_feeds(headersHandler?: () => {[header: string]: string}): Promise<Array<FeedMetadata>> {
			return this.http.get('system/feeds', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Post_system_feeds(flush: boolean, sync: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<FeedSyncResult>> {
			return this.http.post('system/feeds?flush=' + flush + '&sync=' + sync, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Describe_policy(headersHandler?: () => {[header: string]: string}): Promise<Array<GateSpec>> {
			return this.http.get('system/policy_spec', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_services(headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return this.http.get('system/services', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_services_by_name(servicename: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return this.http.get('system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Delete_service(servicename: string, hostid: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_services_by_name_and_host(servicename: string, hostid: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return this.http.get('system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_user(headersHandler?: () => {[header: string]: string}): Promise<User> {
			return this.http.get('user', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_credentials(headersHandler?: () => {[header: string]: string}): Promise<Array<AccessCredential>> {
			return this.http.get('user/credentials', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_credential(requestBody: AccessCredential, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return this.http.post('user/credentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Version_noop(headersHandler?: () => {[header: string]: string}): Promise<ServiceVersion> {
			return this.http.get('version', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
