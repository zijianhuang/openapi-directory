...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Ping(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return Axios.get(this.baseUri + '', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' }).then(d => d.data);
		}
		 ...
		 */
		Get_users_account(headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return Axios.get<Account>(this.baseUri + 'account', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_accounts(state: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Account>> {
			return Axios.get<Array<Account>>(this.baseUri + 'accounts?state=' + (state == null ? '' : encodeURIComponent(state)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Create_account(requestBody: AccountCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return Axios.post<Account>(this.baseUri + 'accounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Delete_account(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_account(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return Axios.get<Account>(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Update_account_state(accountname: string, requestBody: AccountStatus, headersHandler?: () => {[header: string]: string}): Promise<AccountStatus> {
			return Axios.put<AccountStatus>(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/state', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		List_users(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Array<User>> {
			return Axios.get<Array<User>>(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Create_user(accountname: string, requestBody: UserCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return Axios.post<User>(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Delete_user(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_account_user(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return Axios.get<User>(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Delete_user_credential(accountname: string, username: string, credential_type: AccessCredentialType, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials&credential_type=' + credential_type, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		List_user_credentials(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AccessCredential>> {
			return Axios.get<Array<AccessCredential>>(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_archives(headersHandler?: () => {[header: string]: string}): Promise<ArchiveSummary> {
			return Axios.get<ArchiveSummary>(this.baseUri + 'archives', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_analysis_archive(headersHandler?: () => {[header: string]: string}): Promise<Array<ArchivedAnalysis>> {
			return Axios.get<Array<ArchivedAnalysis>>(this.baseUri + 'archives/images', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Archive_image_analysis(requestBody: ImageAnalysisReferences, headersHandler?: () => {[header: string]: string}): Promise<Array<AnalysisArchiveAddResult>> {
			return Axios.post<Array<AnalysisArchiveAddResult>>(this.baseUri + 'archives/images', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Delete_archived_analysis(imageDigest: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<ArchivedAnalysis> {
			return Axios.delete<ArchivedAnalysis>(this.baseUri + 'archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_archived_analysis(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ArchivedAnalysis> {
			return Axios.get<ArchivedAnalysis>(this.baseUri + 'archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_analysis_archive_rules(system_global: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<AnalysisArchiveTransitionRule>> {
			return Axios.get<Array<AnalysisArchiveTransitionRule>>(this.baseUri + 'archives/rules?system_global=' + system_global, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Create_analysis_archive_rule(requestBody: AnalysisArchiveTransitionRule, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return Axios.post<AnalysisArchiveTransitionRule>(this.baseUri + 'archives/rules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {AnalysisArchiveTransitionRule} Archive transition rule
		 */
		Delete_analysis_archive_rule(ruleId: string, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return Axios.delete<AnalysisArchiveTransitionRule>(this.baseUri + 'archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {AnalysisArchiveTransitionRule} Archive transition rule
		 */
		Get_analysis_archive_rule(ruleId: string, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return Axios.get<AnalysisArchiveTransitionRule>(this.baseUri + 'archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_event_types(headersHandler?: () => {[header: string]: string}): Promise<Array<EventCategory>> {
			return Axios.get<Array<EventCategory>>(this.baseUri + 'event_types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Delete_events(before: string, since: string, level: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.delete<Array<string>>(this.baseUri + 'events?before=' + (before == null ? '' : encodeURIComponent(before)) + '&since=' + (since == null ? '' : encodeURIComponent(since)) + '&level=' + (level == null ? '' : encodeURIComponent(level)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Delete_event(eventId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'events/' + (eventId == null ? '' : encodeURIComponent(eventId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_event(eventId: string, headersHandler?: () => {[header: string]: string}): Promise<EventResponse> {
			return Axios.get<EventResponse>(this.baseUri + 'events/' + (eventId == null ? '' : encodeURIComponent(eventId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Health_noop(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + 'health', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		List_images(history: boolean, fulltag: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return Axios.get<Array<AnchoreImage>>(this.baseUri + 'images?history=' + history + '&fulltag=' + (fulltag == null ? '' : encodeURIComponent(fulltag)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Add_image(force: boolean, autosubscribe: boolean, requestBody: ImageAnalysisRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return Axios.post<Array<AnchoreImage>>(this.baseUri + 'images?force=' + force + '&autosubscribe=' + autosubscribe, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Delete_image_by_imageId(imageId: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_image_by_imageId(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return Axios.get<Array<AnchoreImage>>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_image_policy_check_by_imageId(imageId: string, policyId: string, tag: string, detail: boolean, history: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyEvaluation>> {
			return Axios.get<Array<PolicyEvaluation>>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_image_content_by_imageid(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.get<Array<string>>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_image_content_by_type_imageId_files(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<ContentFilesResponse> {
			return Axios.get<ContentFilesResponse>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/files', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_image_content_by_type_imageId_javapackage(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<ContentJAVAPackageResponse> {
			return Axios.get<ContentJAVAPackageResponse>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/java', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_image_content_by_type_imageId(imageId: string, ctype: string, headersHandler?: () => {[header: string]: string}): Promise<ContentPackageResponse> {
			return Axios.get<ContentPackageResponse>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_image_vulnerability_types_by_imageId(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.get<Array<string>>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_image_vulnerabilities_by_type_imageId(imageId: string, vtype: string, headersHandler?: () => {[header: string]: string}): Promise<VulnerabilityResponse> {
			return Axios.get<VulnerabilityResponse>(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Image deletion success
		 */
		Delete_image(imageDigest: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {Array<AnchoreImage>} Image lookup success
		 */
		Get_image(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return Axios.get<Array<AnchoreImage>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_file_content_search_results(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<FileContentSearchResult>> {
			return Axios.get<Array<FileContentSearchResult>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/file_content_search', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_retrieved_files(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<RetrievedFile>> {
			return Axios.get<Array<RetrievedFile>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/retrieved_files', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_secret_search_results(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<SecretSearchResult>> {
			return Axios.get<Array<SecretSearchResult>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/secret_search', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {Array<PolicyEvaluation>} Policy evaluation success
		 */
		Get_image_policy_check(imageDigest: string, policyId: string, tag: string, detail: boolean, history: boolean, interactive: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyEvaluation>> {
			return Axios.get<Array<PolicyEvaluation>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history + '&interactive=' + interactive, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_image_content(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.get<Array<string>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {ContentFilesResponse} Content of specified type from the image
		 */
		Get_image_content_by_type_files(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ContentFilesResponse> {
			return Axios.get<ContentFilesResponse>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/files', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {ContentJAVAPackageResponse} Content of specified type from the image
		 */
		Get_image_content_by_type_javapackage(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ContentJAVAPackageResponse> {
			return Axios.get<ContentJAVAPackageResponse>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/java', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {ContentPackageResponse} Content of specified type from the image
		 */
		Get_image_content_by_type(imageDigest: string, ctype: string, headersHandler?: () => {[header: string]: string}): Promise<ContentPackageResponse> {
			return Axios.get<ContentPackageResponse>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_image_metadata(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.get<Array<string>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_image_metadata_by_type(imageDigest: string, mtype: string, headersHandler?: () => {[header: string]: string}): Promise<MetadataResponse> {
			return Axios.get<MetadataResponse>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata/' + (mtype == null ? '' : encodeURIComponent(mtype)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {Array<string>} Vulnerability listing for the image
		 */
		Get_image_vulnerability_types(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return Axios.get<Array<string>>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {VulnerabilityResponse} Vulnerability listing for the image
		 */
		Get_image_vulnerabilities_by_type(imageDigest: string, vtype: string, force_refresh: boolean, vendor_only: boolean, headersHandler?: () => {[header: string]: string}): Promise<VulnerabilityResponse> {
			return Axios.get<VulnerabilityResponse>(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)) + '&force_refresh=' + force_refresh + '&vendor_only=' + vendor_only, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_oauth_token(headersHandler?: () => {[header: string]: string}): Promise<TokenResponse> {
			return Axios.post<TokenResponse>(this.baseUri + 'oauth/token', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_policies(detail: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return Axios.get<Array<PolicyBundleRecord>>(this.baseUri + 'policies?detail=' + detail, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Add_policy(requestBody: PolicyBundle, headersHandler?: () => {[header: string]: string}): Promise<PolicyBundleRecord> {
			return Axios.post<PolicyBundleRecord>(this.baseUri + 'policies', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_policy(policyId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_policy(policyId: string, detail: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return Axios.get<Array<PolicyBundleRecord>>(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&detail=' + detail, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Update_policy(policyId: string, active: boolean, requestBody: PolicyBundleRecord, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return Axios.put<Array<PolicyBundleRecord>>(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&active=' + active, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		List_registries(headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return Axios.get<Array<RegistryConfiguration>>(this.baseUri + 'registries', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Create_registry(validate: boolean, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return Axios.post<Array<RegistryConfiguration>>(this.baseUri + 'registries?validate=' + validate, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_registry(registry: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_registry(registry: string, headersHandler?: () => {[header: string]: string}): Promise<RegistryConfiguration> {
			return Axios.get<RegistryConfiguration>(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Update_registry(registry: string, validate: boolean, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return Axios.put<Array<RegistryConfiguration>>(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)) + '&validate=' + validate, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Add_repository(repository: string, autosubscribe: boolean, lookuptag: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return Axios.post<Array<Subscription>>(this.baseUri + 'repositories?repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&autosubscribe=' + autosubscribe + '&lookuptag=' + (lookuptag == null ? '' : encodeURIComponent(lookuptag)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_status(headersHandler?: () => {[header: string]: string}): Promise<StatusResponse> {
			return Axios.get<StatusResponse>(this.baseUri + 'status', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_subscriptions(subscription_key: string, subscription_type: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return Axios.get<Array<Subscription>>(this.baseUri + 'subscriptions?subscription_key=' + (subscription_key == null ? '' : encodeURIComponent(subscription_key)) + '&subscription_type=' + (subscription_type == null ? '' : encodeURIComponent(subscription_type)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Add_subscription(requestBody: SubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return Axios.post<Array<Subscription>>(this.baseUri + 'subscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_subscription(subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_subscription(subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return Axios.get<Array<Subscription>>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {Array<Subscription>} Subscription add success
		 */
		Update_subscription(subscriptionId: string, requestBody: SubscriptionUpdate, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return Axios.put<Array<Subscription>>(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		List_imagetags(headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImageTagSummary>> {
			return Axios.get<Array<AnchoreImageTagSummary>>(this.baseUri + 'summaries/imagetags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_service_detail(headersHandler?: () => {[header: string]: string}): Promise<SystemStatusResponse> {
			return Axios.get<SystemStatusResponse>(this.baseUri + 'system', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Describe_error_codes(headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreErrorCode>> {
			return Axios.get<Array<AnchoreErrorCode>>(this.baseUri + 'system/error_codes', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_system_feeds(headersHandler?: () => {[header: string]: string}): Promise<Array<FeedMetadata>> {
			return Axios.get<Array<FeedMetadata>>(this.baseUri + 'system/feeds', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Post_system_feeds(flush: boolean, sync: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<FeedSyncResult>> {
			return Axios.post<Array<FeedSyncResult>>(this.baseUri + 'system/feeds?flush=' + flush + '&sync=' + sync, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Describe_policy(headersHandler?: () => {[header: string]: string}): Promise<Array<GateSpec>> {
			return Axios.get<Array<GateSpec>>(this.baseUri + 'system/policy_spec', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		List_services(headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return Axios.get<Array<Service>>(this.baseUri + 'system/services', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_services_by_name(servicename: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return Axios.get<Array<Service>>(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_service(servicename: string, hostid: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Get_services_by_name_and_host(servicename: string, hostid: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return Axios.get<Array<Service>>(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Get_user(headersHandler?: () => {[header: string]: string}): Promise<User> {
		 ...
		 * @return {Array<AccessCredential>} User credential listing
		 */
		Get_credentials(headersHandler?: () => {[header: string]: string}): Promise<Array<AccessCredential>> {
			return Axios.get<Array<AccessCredential>>(this.baseUri + 'user/credentials', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {User} Add a credential, overwritting if already exists
		 */
		Add_credential(requestBody: AccessCredential, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return Axios.post<User>(this.baseUri + 'user/credentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Version_noop(headersHandler?: () => {[header: string]: string}): Promise<ServiceVersion> {
			return Axios.get<ServiceVersion>(this.baseUri + 'version', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
