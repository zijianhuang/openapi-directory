export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Ping(headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + '', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Get_users_account(headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return fetch(this.baseUri + 'account', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_accounts(state: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Account>> {
			return fetch(this.baseUri + 'accounts?state=' + (state == null ? '' : encodeURIComponent(state)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_account(requestBody: AccountCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return fetch(this.baseUri + 'accounts', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Delete_account(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_account(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Account> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_account_state(accountname: string, requestBody: AccountStatus, headersHandler?: () => {[header: string]: string}): Promise<AccountStatus> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/state', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		List_users(accountname: string, headersHandler?: () => {[header: string]: string}): Promise<Array<User>> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_user(accountname: string, requestBody: UserCreationRequest, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Delete_user(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_account_user(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Delete_user_credential(accountname: string, username: string, credential_type: AccessCredentialType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials&credential_type=' + credential_type, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		List_user_credentials(accountname: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AccessCredential>> {
			return fetch(this.baseUri + 'accounts/' + (accountname == null ? '' : encodeURIComponent(accountname)) + '/users/' + (username == null ? '' : encodeURIComponent(username)) + '/credentials', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_archives(headersHandler?: () => {[header: string]: string}): Promise<ArchiveSummary> {
			return fetch(this.baseUri + 'archives', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_analysis_archive(headersHandler?: () => {[header: string]: string}): Promise<Array<ArchivedAnalysis>> {
			return fetch(this.baseUri + 'archives/images', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Archive_image_analysis(requestBody: ImageAnalysisReferences, headersHandler?: () => {[header: string]: string}): Promise<Array<AnalysisArchiveAddResult>> {
			return fetch(this.baseUri + 'archives/images', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Delete_archived_analysis(imageDigest: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<ArchivedAnalysis> {
			return fetch(this.baseUri + 'archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_archived_analysis(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ArchivedAnalysis> {
			return fetch(this.baseUri + 'archives/images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_analysis_archive_rules(system_global: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<AnalysisArchiveTransitionRule>> {
			return fetch(this.baseUri + 'archives/rules?system_global=' + system_global, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_analysis_archive_rule(requestBody: AnalysisArchiveTransitionRule, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return fetch(this.baseUri + 'archives/rules', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Delete_analysis_archive_rule(ruleId: string, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return fetch(this.baseUri + 'archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_analysis_archive_rule(ruleId: string, headersHandler?: () => {[header: string]: string}): Promise<AnalysisArchiveTransitionRule> {
			return fetch(this.baseUri + 'archives/rules/' + (ruleId == null ? '' : encodeURIComponent(ruleId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_event_types(headersHandler?: () => {[header: string]: string}): Promise<Array<EventCategory>> {
			return fetch(this.baseUri + 'event_types', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Delete_events(before: string, since: string, level: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'events?before=' + (before == null ? '' : encodeURIComponent(before)) + '&since=' + (since == null ? '' : encodeURIComponent(since)) + '&level=' + (level == null ? '' : encodeURIComponent(level)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Delete_event(eventId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'events/' + (eventId == null ? '' : encodeURIComponent(eventId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_event(eventId: string, headersHandler?: () => {[header: string]: string}): Promise<EventResponse> {
			return fetch(this.baseUri + 'events/' + (eventId == null ? '' : encodeURIComponent(eventId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		Health_noop(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'health', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		List_images(history: boolean, fulltag: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return fetch(this.baseUri + 'images?history=' + history + '&fulltag=' + (fulltag == null ? '' : encodeURIComponent(fulltag)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_image(force: boolean, autosubscribe: boolean, requestBody: ImageAnalysisRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return fetch(this.baseUri + 'images?force=' + force + '&autosubscribe=' + autosubscribe, { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		Delete_image_by_imageId(imageId: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '&force=' + force, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_image_by_imageId(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_policy_check_by_imageId(imageId: string, policyId: string, tag: string, detail: boolean, history: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyEvaluation>> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_image_content_by_imageid(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_imageId_files(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<ContentFilesResponse> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/files', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_imageId_javapackage(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<ContentJAVAPackageResponse> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/java', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_imageId(imageId: string, ctype: string, headersHandler?: () => {[header: string]: string}): Promise<ContentPackageResponse> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerability_types_by_imageId(imageId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerabilities_by_type_imageId(imageId: string, vtype: string, headersHandler?: () => {[header: string]: string}): Promise<VulnerabilityResponse> {
			return fetch(this.baseUri + 'images/by_id/' + (imageId == null ? '' : encodeURIComponent(imageId)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Image deletion success
		 */
		Delete_image(imageDigest: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '&force=' + force, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_image(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImage>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_file_content_search_results(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<FileContentSearchResult>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/file_content_search', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_retrieved_files(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<RetrievedFile>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/retrieved_files', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_secret_search_results(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<SecretSearchResult>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/artifacts/secret_search', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_policy_check(imageDigest: string, policyId: string, tag: string, detail: boolean, history: boolean, interactive: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyEvaluation>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/check&policyId=' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&tag=' + (tag == null ? '' : encodeURIComponent(tag)) + '&detail=' + detail + '&history=' + history + '&interactive=' + interactive, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_image_content(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_files(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ContentFilesResponse> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/files', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type_javapackage(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<ContentJAVAPackageResponse> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/java', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_content_by_type(imageDigest: string, ctype: string, headersHandler?: () => {[header: string]: string}): Promise<ContentPackageResponse> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/content/' + (ctype == null ? '' : encodeURIComponent(ctype)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_image_metadata(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_metadata_by_type(imageDigest: string, mtype: string, headersHandler?: () => {[header: string]: string}): Promise<MetadataResponse> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/metadata/' + (mtype == null ? '' : encodeURIComponent(mtype)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerability_types(imageDigest: string, headersHandler?: () => {[header: string]: string}): Promise<Array<string>> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_image_vulnerabilities_by_type(imageDigest: string, vtype: string, force_refresh: boolean, vendor_only: boolean, headersHandler?: () => {[header: string]: string}): Promise<VulnerabilityResponse> {
			return fetch(this.baseUri + 'images/' + (imageDigest == null ? '' : encodeURIComponent(imageDigest)) + '/vuln/' + (vtype == null ? '' : encodeURIComponent(vtype)) + '&force_refresh=' + force_refresh + '&vendor_only=' + vendor_only, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_oauth_token(headersHandler?: () => {[header: string]: string}): Promise<TokenResponse> {
			return fetch(this.baseUri + 'oauth/token', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_policies(detail: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return fetch(this.baseUri + 'policies?detail=' + detail, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_policy(requestBody: PolicyBundle, headersHandler?: () => {[header: string]: string}): Promise<PolicyBundleRecord> {
			return fetch(this.baseUri + 'policies', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_policy(policyId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_policy(policyId: string, detail: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return fetch(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&detail=' + detail, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_policy(policyId: string, active: boolean, requestBody: PolicyBundleRecord, headersHandler?: () => {[header: string]: string}): Promise<Array<PolicyBundleRecord>> {
			return fetch(this.baseUri + 'policies/' + (policyId == null ? '' : encodeURIComponent(policyId)) + '&active=' + active, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Query_images_by_package(name: string, package_type: string, version: string, page: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<PaginatedImageList> {
			return fetch(this.baseUri + 'query/images/by_package?name=' + (name == null ? '' : encodeURIComponent(name)) + '&package_type=' + (package_type == null ? '' : encodeURIComponent(package_type)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&page=' + (page == null ? '' : encodeURIComponent(page)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Query_vulnerabilities(id: Array<string>, affected_package: string, affected_package_version: string, page: string, limit: number, namespace: Array<string>, headersHandler?: () => {[header: string]: string}): Promise<PaginatedVulnerabilityList> {
			return fetch(this.baseUri + 'query/vulnerabilities?' + id.map(z => `id=${encodeURIComponent(z)}`).join('&') + '&affected_package=' + (affected_package == null ? '' : encodeURIComponent(affected_package)) + '&affected_package_version=' + (affected_package_version == null ? '' : encodeURIComponent(affected_package_version)) + '&page=' + (page == null ? '' : encodeURIComponent(page)) + '&limit=' + limit + '&' + namespace.map(z => `namespace=${encodeURIComponent(z)}`).join('&'), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_registries(headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return fetch(this.baseUri + 'registries', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Create_registry(validate: boolean, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return fetch(this.baseUri + 'registries?validate=' + validate, { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_registry(registry: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_registry(registry: string, headersHandler?: () => {[header: string]: string}): Promise<RegistryConfiguration> {
			return fetch(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_registry(registry: string, validate: boolean, requestBody: RegistryConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<RegistryConfiguration>> {
			return fetch(this.baseUri + 'registries/' + (registry == null ? '' : encodeURIComponent(registry)) + '&validate=' + validate, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Add_repository(repository: string, autosubscribe: boolean, lookuptag: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return fetch(this.baseUri + 'repositories?repository=' + (repository == null ? '' : encodeURIComponent(repository)) + '&autosubscribe=' + autosubscribe + '&lookuptag=' + (lookuptag == null ? '' : encodeURIComponent(lookuptag)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_status(headersHandler?: () => {[header: string]: string}): Promise<StatusResponse> {
			return fetch(this.baseUri + 'status', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_subscriptions(subscription_key: string, subscription_type: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return fetch(this.baseUri + 'subscriptions?subscription_key=' + (subscription_key == null ? '' : encodeURIComponent(subscription_key)) + '&subscription_type=' + (subscription_type == null ? '' : encodeURIComponent(subscription_type)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_subscription(requestBody: SubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return fetch(this.baseUri + 'subscriptions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_subscription(subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_subscription(subscriptionId: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Update_subscription(subscriptionId: string, requestBody: SubscriptionUpdate, headersHandler?: () => {[header: string]: string}): Promise<Array<Subscription>> {
			return fetch(this.baseUri + 'subscriptions/' + (subscriptionId == null ? '' : encodeURIComponent(subscriptionId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		List_imagetags(headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreImageTagSummary>> {
			return fetch(this.baseUri + 'summaries/imagetags', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_service_detail(headersHandler?: () => {[header: string]: string}): Promise<SystemStatusResponse> {
			return fetch(this.baseUri + 'system', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Describe_error_codes(headersHandler?: () => {[header: string]: string}): Promise<Array<AnchoreErrorCode>> {
			return fetch(this.baseUri + 'system/error_codes', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_system_feeds(headersHandler?: () => {[header: string]: string}): Promise<Array<FeedMetadata>> {
			return fetch(this.baseUri + 'system/feeds', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Post_system_feeds(flush: boolean, sync: boolean, headersHandler?: () => {[header: string]: string}): Promise<Array<FeedSyncResult>> {
			return fetch(this.baseUri + 'system/feeds?flush=' + flush + '&sync=' + sync, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Describe_policy(headersHandler?: () => {[header: string]: string}): Promise<Array<GateSpec>> {
			return fetch(this.baseUri + 'system/policy_spec', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		List_services(headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return fetch(this.baseUri + 'system/services', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_services_by_name(servicename: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return fetch(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Delete success
		 */
		Delete_service(servicename: string, hostid: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Get_services_by_name_and_host(servicename: string, hostid: string, headersHandler?: () => {[header: string]: string}): Promise<Array<Service>> {
			return fetch(this.baseUri + 'system/services/' + (servicename == null ? '' : encodeURIComponent(servicename)) + '/' + (hostid == null ? '' : encodeURIComponent(hostid)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Get_credentials(headersHandler?: () => {[header: string]: string}): Promise<Array<AccessCredential>> {
			return fetch(this.baseUri + 'user/credentials', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Add_credential(requestBody: AccessCredential, headersHandler?: () => {[header: string]: string}): Promise<User> {
			return fetch(this.baseUri + 'user/credentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Version_noop(headersHandler?: () => {[header: string]: string}): Promise<ServiceVersion> {
			return fetch(this.baseUri + 'version', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
