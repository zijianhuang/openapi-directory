export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Account_Get(headersHandler?: () => {[header: string]: string}): Promise<AccountDetails> {
			return fetch(this.baseUri + 'api/Account', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Company_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, headersHandler?: () => {[header: string]: string}): Promise<CompanyList> {
			return fetch(this.baseUri + 'api/Company?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Company_Post(requestBody: NewCompany, headersHandler?: () => {[header: string]: string}): Promise<Company> {
			return fetch(this.baseUri + 'api/Company', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Company_Put(requestBody: UpdateCompany, headersHandler?: () => {[header: string]: string}): Promise<Company> {
			return fetch(this.baseUri + 'api/Company', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Company_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Company> {
			return fetch(this.baseUri + 'api/Company/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Contact_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<ContactList> {
			return fetch(this.baseUri + 'api/Contact?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Contact_Post(requestBody: NewCompanyContact, headersHandler?: () => {[header: string]: string}): Promise<CompanyContact> {
			return fetch(this.baseUri + 'api/Contact', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Contact_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<CompanyContact> {
			return fetch(this.baseUri + 'api/Contact/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreditNote_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => {[header: string]: string}): Promise<CreditNoteList> {
			return fetch(this.baseUri + 'api/CreditNote?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreditNote_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<CreditNote> {
			return fetch(this.baseUri + 'api/CreditNote/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Currency_Get(headersHandler?: () => {[header: string]: string}): Promise<CurrencyList> {
			return fetch(this.baseUri + 'api/Currency', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Estimate_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<EstimateList> {
			return fetch(this.baseUri + 'api/Estimate?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Estimate_Post(requestBody: NewEstimate, headersHandler?: () => {[header: string]: string}): Promise<EstimateDetails> {
			return fetch(this.baseUri + 'api/Estimate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Estimate_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/Estimate/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Expense_Get(UpdatedAfter: Date, ExpenseDateFrom: Date, ExpenseDateTo: Date, UserEmail: string, CategoryName: string, CustomerID: number, ProjectID: number, isChargeable: boolean, isInvoiced: boolean, ExpenseReimbursementIDFK: number, pageSize: number, pageNumber: number, Sort: string, headersHandler?: () => {[header: string]: string}): Promise<ExpenseList> {
			return fetch(this.baseUri + 'api/Expense?UpdatedAfter=' + UpdatedAfter.toISOString() + '&ExpenseDateFrom=' + ExpenseDateFrom.toISOString() + '&ExpenseDateTo=' + ExpenseDateTo.toISOString() + '&UserEmail=' + (UserEmail == null ? '' : encodeURIComponent(UserEmail)) + '&CategoryName=' + (CategoryName == null ? '' : encodeURIComponent(CategoryName)) + '&CustomerID=' + CustomerID + '&ProjectID=' + ProjectID + '&isChargeable=' + isChargeable + '&isInvoiced=' + isInvoiced + '&ExpenseReimbursementIDFK=' + ExpenseReimbursementIDFK + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Expense_Post(requestBody: NewExpense, headersHandler?: () => {[header: string]: string}): Promise<ExpenseDetails> {
			return fetch(this.baseUri + 'api/Expense', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Expense_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<ExpenseDetails> {
			return fetch(this.baseUri + 'api/Expense/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		FixedAmount_Get(UpdatedAfter: Date, EntryDateFrom: Date, EntryDateTo: Date, ProjectID: number, TaskID: number, isInvoiced: boolean, pageSize: number, pageNumber: number, Sort: string, headersHandler?: () => {[header: string]: string}): Promise<FixedAmountList> {
			return fetch(this.baseUri + 'api/FixedAmount?UpdatedAfter=' + UpdatedAfter.toISOString() + '&EntryDateFrom=' + EntryDateFrom.toISOString() + '&EntryDateTo=' + EntryDateTo.toISOString() + '&ProjectID=' + ProjectID + '&TaskID=' + TaskID + '&isInvoiced=' + isInvoiced + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Inventory_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => {[header: string]: string}): Promise<InventoryList> {
			return fetch(this.baseUri + 'api/Inventory?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Inventory_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/Inventory/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Invoice_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<InvoiceList> {
			return fetch(this.baseUri + 'api/Invoice?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Invoice_Post(requestBody: NewInvoice, headersHandler?: () => {[header: string]: string}): Promise<Invoice> {
			return fetch(this.baseUri + 'api/Invoice', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Invoice_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/Invoice/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Payment_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => {[header: string]: string}): Promise<PaymentList> {
			return fetch(this.baseUri + 'api/Payment?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Payment_Post(requestBody: NewPayment, headersHandler?: () => {[header: string]: string}): Promise<Payment> {
			return fetch(this.baseUri + 'api/Payment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Payment_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Payment> {
			return fetch(this.baseUri + 'api/Payment/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Project_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, TimesheetUserID: number, includeArchived: boolean, headersHandler?: () => {[header: string]: string}): Promise<ProjectList> {
			return fetch(this.baseUri + 'api/Project?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&TimesheetUserID=' + TimesheetUserID + '&includeArchived=' + includeArchived, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Project_Post(requestBody: NewProjectModel, headersHandler?: () => {[header: string]: string}): Promise<ProjectDetails> {
			return fetch(this.baseUri + 'api/Project', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ProjectLookup(pageSize: number, pageNumber: number, TimesheetUserID: number, search: string, headersHandler?: () => {[header: string]: string}): Promise<ProjectDropdownList> {
			return fetch(this.baseUri + 'api/Project/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&TimesheetUserID=' + TimesheetUserID + '&search=' + (search == null ? '' : encodeURIComponent(search)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Project_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<ProjectDetails> {
			return fetch(this.baseUri + 'api/Project/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ProjectMember_Post(requestBody: NewProjectMember, headersHandler?: () => {[header: string]: string}): Promise<ProjectMemberDetails> {
			return fetch(this.baseUri + 'api/ProjectMember', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ProjectTimesheetCategory_Get(ProjectID: number, headersHandler?: () => {[header: string]: string}): Promise<ProjectTimesheetCategoryList> {
			return fetch(this.baseUri + 'api/ProjectTimesheetCategory?ProjectID=' + ProjectID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Section_Get(ProjectID: number, headersHandler?: () => {[header: string]: string}): Promise<SectionList> {
			return fetch(this.baseUri + 'api/Section?ProjectID=' + ProjectID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Section_Post(requestBody: NewSection, headersHandler?: () => {[header: string]: string}): Promise<SectionDetails> {
			return fetch(this.baseUri + 'api/Section', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Task_Delete(TaskID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/Task?TaskID=' + TaskID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Task_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, isComplete: boolean, ProjectID: number, headersHandler?: () => {[header: string]: string}): Promise<TaskList> {
			return fetch(this.baseUri + 'api/Task?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&isComplete=' + isComplete + '&ProjectID=' + ProjectID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Task_Post(requestBody: NewTask, headersHandler?: () => {[header: string]: string}): Promise<TaskDetails> {
			return fetch(this.baseUri + 'api/Task', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Task_Put(requestBody: UpdateTask, headersHandler?: () => {[header: string]: string}): Promise<TaskDetails> {
			return fetch(this.baseUri + 'api/Task', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TaskLookup(pageSize: number, pageNumber: number, projectID: number, hideCompleted: boolean, search: string, headersHandler?: () => {[header: string]: string}): Promise<TaskDropdownList> {
			return fetch(this.baseUri + 'api/Task/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&projectID=' + projectID + '&hideCompleted=' + hideCompleted + '&search=' + (search == null ? '' : encodeURIComponent(search)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Task_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<TaskDetails> {
			return fetch(this.baseUri + 'api/Task/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TaskStatus_Get(headersHandler?: () => {[header: string]: string}): Promise<TaskStatusList> {
			return fetch(this.baseUri + 'api/TaskStatus', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TaskType_Get(headersHandler?: () => {[header: string]: string}): Promise<TaskTypeList> {
			return fetch(this.baseUri + 'api/TaskType', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Tax_Get(headersHandler?: () => {[header: string]: string}): Promise<TaxList> {
			return fetch(this.baseUri + 'api/Tax', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Timesheet_Post(requestBody: NewTimesheet, headersHandler?: () => {[header: string]: string}): Promise<TimesheetDetails> {
			return fetch(this.baseUri + 'api/Timesheet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Timesheet_Put(requestBody: UpdateTimesheetModel, headersHandler?: () => {[header: string]: string}): Promise<TimesheetDetails> {
			return fetch(this.baseUri + 'api/Timesheet', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Timesheet_Delete(id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/Timesheet/' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Timesheet_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<TimesheetDetails> {
			return fetch(this.baseUri + 'api/Timesheet/' + id, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TimesheetSubmission_Post(SendNotifications: boolean, WholeWeekOf: Date, WholeDayOf: Date, UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/TimesheetSubmission?SendNotifications=' + SendNotifications + '&WholeWeekOf=' + WholeWeekOf.toISOString() + '&WholeDayOf=' + WholeDayOf.toISOString() + '&UserID=' + UserID, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		TimesheetTimer_GetRunningTimer(UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/TimesheetTimer?UserID=' + UserID, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		TimesheetTimer_StopTimer(id: number, UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/TimesheetTimer/' + id + '?UserID=' + UserID, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		TimesheetTimer_StartTimer(id: number, UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/TimesheetTimer/' + id + '?UserID=' + UserID, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		UserProfile_Get(Roles: string, Tags: string, CurrentUserOnly: boolean, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<UserList> {
			return fetch(this.baseUri + 'api/UserProfile?Roles=' + (Roles == null ? '' : encodeURIComponent(Roles)) + '&Tags=' + (Tags == null ? '' : encodeURIComponent(Tags)) + '&CurrentUserOnly=' + CurrentUserOnly + '&CompanyIDFK=' + CompanyIDFK, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Webhook_DeleteByUrl(target_url: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/Webhook?target_url=' + (target_url == null ? '' : encodeURIComponent(target_url)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Webhook_Get(headersHandler?: () => {[header: string]: string}): Promise<WebhookList> {
			return fetch(this.baseUri + 'api/Webhook', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Webhook_Post(requestBody: CreateSubscription, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'api/Webhook', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Webhook_Delete(id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return fetch(this.baseUri + 'api/Webhook/' + id, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
	}
