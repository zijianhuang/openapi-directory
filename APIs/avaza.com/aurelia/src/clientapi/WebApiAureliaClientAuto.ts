...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Account_Get(headersHandler?: () => {[header: string]: string}): Promise<AccountDetails> {
			return this.http.get('api/Account', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Company_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, headersHandler?: () => {[header: string]: string}): Promise<CompanyList> {
			return this.http.get('api/Company?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Company_Post(requestBody: NewCompany, headersHandler?: () => {[header: string]: string}): Promise<Company> {
			return this.http.post('api/Company', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Company_Put(requestBody: UpdateCompany, headersHandler?: () => {[header: string]: string}): Promise<Company> {
			return this.http.put('api/Company', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Company_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Company> {
			return this.http.get('api/Company/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Contact_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<ContactList> {
			return this.http.get('api/Contact?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Contact_Post(requestBody: NewCompanyContact, headersHandler?: () => {[header: string]: string}): Promise<CompanyContact> {
			return this.http.post('api/Contact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Contact_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<CompanyContact> {
			return this.http.get('api/Contact/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreditNote_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => {[header: string]: string}): Promise<CreditNoteList> {
			return this.http.get('api/CreditNote?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreditNote_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<CreditNote> {
			return this.http.get('api/CreditNote/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Currency_Get(headersHandler?: () => {[header: string]: string}): Promise<CurrencyList> {
			return this.http.get('api/Currency', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Estimate_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<EstimateList> {
			return this.http.get('api/Estimate?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Estimate_Post(requestBody: NewEstimate, headersHandler?: () => {[header: string]: string}): Promise<EstimateDetails> {
			return this.http.post('api/Estimate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Estimate_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/Estimate/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Expense_Post(requestBody: NewExpense, headersHandler?: () => {[header: string]: string}): Promise<ExpenseDetails> {
			return this.http.post('api/Expense', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Expense_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<ExpenseDetails> {
			return this.http.get('api/Expense/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		FixedAmount_Get(UpdatedAfter: Date, EntryDateFrom: Date, EntryDateTo: Date, ProjectID: number, TaskID: number, isInvoiced: boolean, pageSize: number, pageNumber: number, Sort: string, headersHandler?: () => {[header: string]: string}): Promise<FixedAmountList> {
			return this.http.get('api/FixedAmount?UpdatedAfter=' + UpdatedAfter.toISOString() + '&EntryDateFrom=' + EntryDateFrom.toISOString() + '&EntryDateTo=' + EntryDateTo.toISOString() + '&ProjectID=' + ProjectID + '&TaskID=' + TaskID + '&isInvoiced=' + isInvoiced + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Inventory_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => {[header: string]: string}): Promise<InventoryList> {
			return this.http.get('api/Inventory?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Inventory_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/Inventory/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Invoice_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<InvoiceList> {
			return this.http.get('api/Invoice?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Invoice_Post(requestBody: NewInvoice, headersHandler?: () => {[header: string]: string}): Promise<Invoice> {
			return this.http.post('api/Invoice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Invoice_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('api/Invoice/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Payment_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => {[header: string]: string}): Promise<PaymentList> {
			return this.http.get('api/Payment?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Payment_Post(requestBody: NewPayment, headersHandler?: () => {[header: string]: string}): Promise<Payment> {
			return this.http.post('api/Payment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Payment_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<Payment> {
			return this.http.get('api/Payment/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Project_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, TimesheetUserID: number, includeArchived: boolean, headersHandler?: () => {[header: string]: string}): Promise<ProjectList> {
			return this.http.get('api/Project?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&TimesheetUserID=' + TimesheetUserID + '&includeArchived=' + includeArchived, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Project_Post(requestBody: NewProjectModel, headersHandler?: () => {[header: string]: string}): Promise<ProjectDetails> {
			return this.http.post('api/Project', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ProjectLookup(pageSize: number, pageNumber: number, TimesheetUserID: number, search: string, headersHandler?: () => {[header: string]: string}): Promise<ProjectDropdownList> {
			return this.http.get('api/Project/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&TimesheetUserID=' + TimesheetUserID + '&search=' + (search == null ? '' : encodeURIComponent(search)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Project_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<ProjectDetails> {
			return this.http.get('api/Project/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ProjectMember_Post(requestBody: NewProjectMember, headersHandler?: () => {[header: string]: string}): Promise<ProjectMemberDetails> {
			return this.http.post('api/ProjectMember', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ProjectTimesheetCategory_Get(ProjectID: number, headersHandler?: () => {[header: string]: string}): Promise<ProjectTimesheetCategoryList> {
			return this.http.get('api/ProjectTimesheetCategory?ProjectID=' + ProjectID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ScheduleAssignment_Get(UpdatedAfter: Date, ScheduleDateFrom: Date, ScheduleDateTo: Date, ScheduleSeriesID: number, UserID: number, UserEmail: string, pageSize: number, pageNumber: number, Sort: string, headersHandler?: () => {[header: string]: string}): Promise<ScheduleAssignmentList> {
			return this.http.get('api/ScheduleAssignment?UpdatedAfter=' + UpdatedAfter.toISOString() + '&ScheduleDateFrom=' + ScheduleDateFrom.toISOString() + '&ScheduleDateTo=' + ScheduleDateTo.toISOString() + '&ScheduleSeriesID=' + ScheduleSeriesID + '&UserID=' + UserID + '&UserEmail=' + (UserEmail == null ? '' : encodeURIComponent(UserEmail)) + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Section_Get(ProjectID: number, headersHandler?: () => {[header: string]: string}): Promise<SectionList> {
			return this.http.get('api/Section?ProjectID=' + ProjectID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Section_Post(requestBody: NewSection, headersHandler?: () => {[header: string]: string}): Promise<SectionDetails> {
			return this.http.post('api/Section', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Task_Delete(TaskID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('api/Task?TaskID=' + TaskID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Task_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, isComplete: boolean, ProjectID: number, headersHandler?: () => {[header: string]: string}): Promise<TaskList> {
			return this.http.get('api/Task?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&isComplete=' + isComplete + '&ProjectID=' + ProjectID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Task_Post(requestBody: NewTask, headersHandler?: () => {[header: string]: string}): Promise<TaskDetails> {
			return this.http.post('api/Task', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Task_Put(requestBody: UpdateTask, headersHandler?: () => {[header: string]: string}): Promise<TaskDetails> {
			return this.http.put('api/Task', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TaskLookup(pageSize: number, pageNumber: number, projectID: number, hideCompleted: boolean, search: string, headersHandler?: () => {[header: string]: string}): Promise<TaskDropdownList> {
			return this.http.get('api/Task/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&projectID=' + projectID + '&hideCompleted=' + hideCompleted + '&search=' + (search == null ? '' : encodeURIComponent(search)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Task_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<TaskDetails> {
			return this.http.get('api/Task/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TaskStatus_Get(headersHandler?: () => {[header: string]: string}): Promise<TaskStatusList> {
			return this.http.get('api/TaskStatus', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TaskType_Get(headersHandler?: () => {[header: string]: string}): Promise<TaskTypeList> {
			return this.http.get('api/TaskType', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Tax_Get(headersHandler?: () => {[header: string]: string}): Promise<TaxList> {
			return this.http.get('api/Tax', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Timesheet_Post(requestBody: NewTimesheet, headersHandler?: () => {[header: string]: string}): Promise<TimesheetDetails> {
			return this.http.post('api/Timesheet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Timesheet_Put(requestBody: UpdateTimesheetModel, headersHandler?: () => {[header: string]: string}): Promise<TimesheetDetails> {
			return this.http.put('api/Timesheet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Timesheet_Delete(id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('api/Timesheet/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Timesheet_GetByID(id: number, headersHandler?: () => {[header: string]: string}): Promise<TimesheetDetails> {
			return this.http.get('api/Timesheet/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TimesheetSubmission_Post(SendNotifications: boolean, WholeWeekOf: Date, WholeDayOf: Date, UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/TimesheetSubmission?SendNotifications=' + SendNotifications + '&WholeWeekOf=' + WholeWeekOf.toISOString() + '&WholeDayOf=' + WholeDayOf.toISOString() + '&UserID=' + UserID, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		TimesheetSummary_Get(model.groupBy: Array<string>, model.entryDateFrom: Date, model.entryDateTo: Date, model.userID: Array<number>, model.projectID: number, model.isBillable: boolean, model.isInvoiced: boolean, headersHandler?: () => {[header: string]: string}): Promise<TimesheetSummaryResult> {
			return this.http.get('api/TimesheetSummary?' + model.groupBy.map(z => `model.groupBy=${encodeURIComponent(z)}`).join('&') + '&model.entryDateFrom=' + model.entryDateFrom.toISOString() + '&model.entryDateTo=' + model.entryDateTo.toISOString() + '&' + model.userID.map(z => `model.userID=${z}`).join('&') + '&model.projectID=' + model.projectID + '&model.isBillable=' + model.isBillable + '&model.isInvoiced=' + model.isInvoiced, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TimesheetTimer_GetRunningTimer(UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('api/TimesheetTimer?UserID=' + UserID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		TimesheetTimer_StopTimer(id: number, UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('api/TimesheetTimer/' + id + '?UserID=' + UserID, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		TimesheetTimer_StartTimer(id: number, UserID: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('api/TimesheetTimer/' + id + '?UserID=' + UserID, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		UserProfile_Get(Roles: string, Tags: string, CurrentUserOnly: boolean, CompanyIDFK: number, headersHandler?: () => {[header: string]: string}): Promise<UserList> {
			return this.http.get('api/UserProfile?Roles=' + (Roles == null ? '' : encodeURIComponent(Roles)) + '&Tags=' + (Tags == null ? '' : encodeURIComponent(Tags)) + '&CurrentUserOnly=' + CurrentUserOnly + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Webhook_DeleteByUrl(target_url: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('api/Webhook?target_url=' + (target_url == null ? '' : encodeURIComponent(target_url)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Webhook_Get(headersHandler?: () => {[header: string]: string}): Promise<WebhookList> {
			return this.http.get('api/Webhook', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Webhook_Post(requestBody: CreateSubscription, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('api/Webhook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Webhook_Delete(id: number, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('api/Webhook/' + id, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
	}
