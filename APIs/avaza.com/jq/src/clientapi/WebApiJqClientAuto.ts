...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Account_Get(callback: (data : AccountDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Account', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Company_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, callback: (data : CompanyList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Company?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Company_Post(callback: (data : Company) => any, requestBody: NewCompany, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Company', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {Company} OK
		 */
		Company_Put(callback: (data : Company) => any, requestBody: UpdateCompany, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'api/Company', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {Company} Success
		 */
		Company_GetByID(id: number, callback: (data : Company) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Company/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Contact_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, callback: (data : ContactList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Contact?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Contact_Post(callback: (data : CompanyContact) => any, requestBody: NewCompanyContact, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Contact', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {CompanyContact} Success
		 */
		Contact_GetByID(id: number, callback: (data : CompanyContact) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Contact/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreditNote_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, callback: (data : CreditNoteList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/CreditNote?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreditNote_GetByID(id: number, callback: (data : CreditNote) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/CreditNote/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Currency_Get(callback: (data : CurrencyList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Currency', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Estimate_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, callback: (data : EstimateList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Estimate?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Estimate_Post(callback: (data : EstimateDetails) => any, requestBody: NewEstimate, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Estimate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Estimate_GetByID(id: number, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Estimate/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Expense_Get(UpdatedAfter: Date, ExpenseDateFrom: Date, ExpenseDateTo: Date, UserEmail: string, CategoryName: string, CustomerID: number, ProjectID: number, isChargeable: boolean, isInvoiced: boolean, ExpenseReimbursementIDFK: number, pageSize: number, pageNumber: number, Sort: string, callback: (data : ExpenseList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Expense?UpdatedAfter=' + UpdatedAfter.toISOString() + '&ExpenseDateFrom=' + ExpenseDateFrom.toISOString() + '&ExpenseDateTo=' + ExpenseDateTo.toISOString() + '&UserEmail=' + (UserEmail == null ? '' : encodeURIComponent(UserEmail)) + '&CategoryName=' + (CategoryName == null ? '' : encodeURIComponent(CategoryName)) + '&CustomerID=' + CustomerID + '&ProjectID=' + ProjectID + '&isChargeable=' + isChargeable + '&isInvoiced=' + isInvoiced + '&ExpenseReimbursementIDFK=' + ExpenseReimbursementIDFK + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Expense_Post(callback: (data : ExpenseDetails) => any, requestBody: NewExpense, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Expense', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Expense_GetByID(id: number, callback: (data : ExpenseDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Expense/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		FixedAmount_Get(UpdatedAfter: Date, EntryDateFrom: Date, EntryDateTo: Date, ProjectID: number, TaskID: number, isInvoiced: boolean, pageSize: number, pageNumber: number, Sort: string, callback: (data : FixedAmountList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/FixedAmount?UpdatedAfter=' + UpdatedAfter.toISOString() + '&EntryDateFrom=' + EntryDateFrom.toISOString() + '&EntryDateTo=' + EntryDateTo.toISOString() + '&ProjectID=' + ProjectID + '&TaskID=' + TaskID + '&isInvoiced=' + isInvoiced + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Inventory_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, callback: (data : InventoryList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Inventory?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Inventory_GetByID(id: number, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Inventory/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Invoice_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, callback: (data : InvoiceList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Invoice?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Invoice} OK
		 */
		Invoice_Post(callback: (data : Invoice) => any, requestBody: NewInvoice, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Invoice', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Invoice_GetByID(id: number, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Invoice/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Payment_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, callback: (data : PaymentList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Payment?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Payment} OK
		 */
		Payment_Post(callback: (data : Payment) => any, requestBody: NewPayment, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Payment', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Payment_GetByID(id: number, callback: (data : Payment) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Payment/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Project_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, TimesheetUserID: number, includeArchived: boolean, callback: (data : ProjectList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Project?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&TimesheetUserID=' + TimesheetUserID + '&includeArchived=' + includeArchived, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Project_Post(callback: (data : ProjectDetails) => any, requestBody: NewProjectModel, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Project', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ProjectLookup(pageSize: number, pageNumber: number, TimesheetUserID: number, search: string, callback: (data : ProjectDropdownList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Project/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&TimesheetUserID=' + TimesheetUserID + '&search=' + (search == null ? '' : encodeURIComponent(search)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {ProjectDetails} Success
		 */
		Project_GetByID(id: number, callback: (data : ProjectDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Project/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ProjectMember_Post(callback: (data : ProjectMemberDetails) => any, requestBody: NewProjectMember, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/ProjectMember', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ProjectTimesheetCategory_Get(ProjectID: number, callback: (data : ProjectTimesheetCategoryList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/ProjectTimesheetCategory?ProjectID=' + ProjectID, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ScheduleAssignment_Get(UpdatedAfter: Date, ScheduleDateFrom: Date, ScheduleDateTo: Date, ScheduleSeriesID: number, UserID: number, UserEmail: string, pageSize: number, pageNumber: number, Sort: string, callback: (data : ScheduleAssignmentList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/ScheduleAssignment?UpdatedAfter=' + UpdatedAfter.toISOString() + '&ScheduleDateFrom=' + ScheduleDateFrom.toISOString() + '&ScheduleDateTo=' + ScheduleDateTo.toISOString() + '&ScheduleSeriesID=' + ScheduleSeriesID + '&UserID=' + UserID + '&UserEmail=' + (UserEmail == null ? '' : encodeURIComponent(UserEmail)) + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Section_Get(ProjectID: number, callback: (data : SectionList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Section?ProjectID=' + ProjectID, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Section_Post(callback: (data : SectionDetails) => any, requestBody: NewSection, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Section', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Task_Delete(TaskID: number, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'api/Task?TaskID=' + TaskID, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Task_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, isComplete: boolean, ProjectID: number, callback: (data : TaskList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Task?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&isComplete=' + isComplete + '&ProjectID=' + ProjectID, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Task_Post(callback: (data : TaskDetails) => any, requestBody: NewTask, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Task', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {TaskDetails} OK
		 */
		Task_Put(callback: (data : TaskDetails) => any, requestBody: UpdateTask, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'api/Task', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TaskLookup(pageSize: number, pageNumber: number, projectID: number, hideCompleted: boolean, search: string, callback: (data : TaskDropdownList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Task/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&projectID=' + projectID + '&hideCompleted=' + hideCompleted + '&search=' + (search == null ? '' : encodeURIComponent(search)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Task_GetByID(id: number, callback: (data : TaskDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Task/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		TaskStatus_Get(callback: (data : TaskStatusList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/TaskStatus', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		TaskType_Get(callback: (data : TaskTypeList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/TaskType', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {TaxList} OK
		 */
		Tax_Get(callback: (data : TaxList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Tax', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Timesheet_Get(UpdatedAfter: Date, EntryDateFrom: Date, EntryDateTo: Date, UserID: number, UserEmail: string, CategoryName: string, ProjectID: number, isBillable: boolean, isInvoiced: boolean, isTimerRunning: boolean, pageSize: number, pageNumber: number, Sort: string, callback: (data : TimesheetList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Timesheet?UpdatedAfter=' + UpdatedAfter.toISOString() + '&EntryDateFrom=' + EntryDateFrom.toISOString() + '&EntryDateTo=' + EntryDateTo.toISOString() + '&UserID=' + UserID + '&UserEmail=' + (UserEmail == null ? '' : encodeURIComponent(UserEmail)) + '&CategoryName=' + (CategoryName == null ? '' : encodeURIComponent(CategoryName)) + '&ProjectID=' + ProjectID + '&isBillable=' + isBillable + '&isInvoiced=' + isInvoiced + '&isTimerRunning=' + isTimerRunning + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Timesheet_Post(callback: (data : TimesheetDetails) => any, requestBody: NewTimesheet, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Timesheet', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {TimesheetDetails} OK
		 */
		Timesheet_Put(callback: (data : TimesheetDetails) => any, requestBody: UpdateTimesheetModel, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'api/Timesheet', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		Timesheet_Delete(id: number, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'api/Timesheet/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Timesheet_GetByID(id: number, callback: (data : TimesheetDetails) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Timesheet/' + id, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} OK
		 */
		TimesheetSubmission_Post(SendNotifications: boolean, WholeWeekOf: Date, WholeDayOf: Date, UserID: number, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/TimesheetSubmission?SendNotifications=' + SendNotifications + '&WholeWeekOf=' + WholeWeekOf.toISOString() + '&WholeDayOf=' + WholeDayOf.toISOString() + '&UserID=' + UserID, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TimesheetSummary_Get(model.groupBy: Array<string>, model.entryDateFrom: Date, model.entryDateTo: Date, model.userID: Array<number>, model.projectID: number, model.isBillable: boolean, model.isInvoiced: boolean, callback: (data : TimesheetSummaryResult) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/TimesheetSummary?' + model.groupBy.map(z => `model.groupBy=${encodeURIComponent(z)}`).join('&') + '&model.entryDateFrom=' + model.entryDateFrom.toISOString() + '&model.entryDateTo=' + model.entryDateTo.toISOString() + '&' + model.userID.map(z => `model.userID=${z}`).join('&') + '&model.projectID=' + model.projectID + '&model.isBillable=' + model.isBillable + '&model.isInvoiced=' + model.isInvoiced, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		TimesheetTimer_GetRunningTimer(UserID: number, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/TimesheetTimer?UserID=' + UserID, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} Success
		 */
		TimesheetTimer_StopTimer(id: number, UserID: number, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'api/TimesheetTimer/' + id + '?UserID=' + UserID, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {string} Success
		 */
		TimesheetTimer_StartTimer(id: number, UserID: number, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/TimesheetTimer/' + id + '?UserID=' + UserID, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {UserList} OK
		 */
		UserProfile_Get(Roles: string, Tags: string, CurrentUserOnly: boolean, CompanyIDFK: number, callback: (data : UserList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/UserProfile?Roles=' + (Roles == null ? '' : encodeURIComponent(Roles)) + '&Tags=' + (Tags == null ? '' : encodeURIComponent(Tags)) + '&CurrentUserOnly=' + CurrentUserOnly + '&CompanyIDFK=' + CompanyIDFK, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Webhook_DeleteByUrl(target_url: string, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'api/Webhook?target_url=' + (target_url == null ? '' : encodeURIComponent(target_url)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Webhook_Get(callback: (data : WebhookList) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'api/Webhook', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Webhook_Post(callback: (data : void) => any, requestBody: CreateSubscription, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'api/Webhook', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {string} Subscription deleted ok
		 */
		Webhook_Delete(id: number, callback: (data : string) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'api/Webhook/' + id, callback, this.error, this.statusCode, headersHandler);
		}
	}
