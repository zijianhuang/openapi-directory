...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		Account_Get(headersHandler?: () => HttpHeaders): Observable<AccountDetails> {
			return this.http.get<AccountDetails>(this.baseUri + 'api/Account', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Company_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, headersHandler?: () => HttpHeaders): Observable<CompanyList> {
			return this.http.get<CompanyList>(this.baseUri + 'api/Company?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Company_Post(requestBody: NewCompany, headersHandler?: () => HttpHeaders): Observable<Company> {
			return this.http.post<Company>(this.baseUri + 'api/Company', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Company} OK
		 */
		Company_Put(requestBody: UpdateCompany, headersHandler?: () => HttpHeaders): Observable<Company> {
			return this.http.put<Company>(this.baseUri + 'api/Company', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Company} Success
		 */
		Company_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<Company> {
			return this.http.get<Company>(this.baseUri + 'api/Company/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Contact_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => HttpHeaders): Observable<ContactList> {
			return this.http.get<ContactList>(this.baseUri + 'api/Contact?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Contact_Post(requestBody: NewCompanyContact, headersHandler?: () => HttpHeaders): Observable<CompanyContact> {
			return this.http.post<CompanyContact>(this.baseUri + 'api/Contact', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {CompanyContact} Success
		 */
		Contact_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<CompanyContact> {
			return this.http.get<CompanyContact>(this.baseUri + 'api/Contact/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreditNote_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => HttpHeaders): Observable<CreditNoteList> {
			return this.http.get<CreditNoteList>(this.baseUri + 'api/CreditNote?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreditNote_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<CreditNote> {
			return this.http.get<CreditNote>(this.baseUri + 'api/CreditNote/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Currency_Get(headersHandler?: () => HttpHeaders): Observable<CurrencyList> {
			return this.http.get<CurrencyList>(this.baseUri + 'api/Currency', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Estimate_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => HttpHeaders): Observable<EstimateList> {
			return this.http.get<EstimateList>(this.baseUri + 'api/Estimate?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Estimate_Post(requestBody: NewEstimate, headersHandler?: () => HttpHeaders): Observable<EstimateDetails> {
			return this.http.post<EstimateDetails>(this.baseUri + 'api/Estimate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Estimate_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/Estimate/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Expense_Post(requestBody: NewExpense, headersHandler?: () => HttpHeaders): Observable<ExpenseDetails> {
			return this.http.post<ExpenseDetails>(this.baseUri + 'api/Expense', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Expense_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<ExpenseDetails> {
			return this.http.get<ExpenseDetails>(this.baseUri + 'api/Expense/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Inventory_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => HttpHeaders): Observable<InventoryList> {
			return this.http.get<InventoryList>(this.baseUri + 'api/Inventory?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Inventory_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/Inventory/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Invoice_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, CompanyIDFK: number, headersHandler?: () => HttpHeaders): Observable<InvoiceList> {
			return this.http.get<InvoiceList>(this.baseUri + 'api/Invoice?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Invoice} OK
		 */
		Invoice_Post(requestBody: NewInvoice, headersHandler?: () => HttpHeaders): Observable<Invoice> {
			return this.http.post<Invoice>(this.baseUri + 'api/Invoice', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Invoice_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + 'api/Invoice/' + id, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Payment_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, headersHandler?: () => HttpHeaders): Observable<PaymentList> {
			return this.http.get<PaymentList>(this.baseUri + 'api/Payment?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Payment} OK
		 */
		Payment_Post(requestBody: NewPayment, headersHandler?: () => HttpHeaders): Observable<Payment> {
			return this.http.post<Payment>(this.baseUri + 'api/Payment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Payment_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<Payment> {
			return this.http.get<Payment>(this.baseUri + 'api/Payment/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Project_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, TimesheetUserID: number, includeArchived: boolean, headersHandler?: () => HttpHeaders): Observable<ProjectList> {
			return this.http.get<ProjectList>(this.baseUri + 'api/Project?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&TimesheetUserID=' + TimesheetUserID + '&includeArchived=' + includeArchived, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Project_Post(requestBody: NewProjectModel, headersHandler?: () => HttpHeaders): Observable<ProjectDetails> {
			return this.http.post<ProjectDetails>(this.baseUri + 'api/Project', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ProjectLookup(pageSize: number, pageNumber: number, TimesheetUserID: number, search: string, headersHandler?: () => HttpHeaders): Observable<ProjectDropdownList> {
			return this.http.get<ProjectDropdownList>(this.baseUri + 'api/Project/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&TimesheetUserID=' + TimesheetUserID + '&search=' + (search == null ? '' : encodeURIComponent(search)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {ProjectDetails} Success
		 */
		Project_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<ProjectDetails> {
			return this.http.get<ProjectDetails>(this.baseUri + 'api/Project/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ProjectMember_Post(requestBody: NewProjectMember, headersHandler?: () => HttpHeaders): Observable<ProjectMemberDetails> {
			return this.http.post<ProjectMemberDetails>(this.baseUri + 'api/ProjectMember', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ProjectTimesheetCategory_Get(ProjectID: number, headersHandler?: () => HttpHeaders): Observable<ProjectTimesheetCategoryList> {
			return this.http.get<ProjectTimesheetCategoryList>(this.baseUri + 'api/ProjectTimesheetCategory?ProjectID=' + ProjectID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Section_Get(ProjectID: number, headersHandler?: () => HttpHeaders): Observable<SectionList> {
			return this.http.get<SectionList>(this.baseUri + 'api/Section?ProjectID=' + ProjectID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Section_Post(requestBody: NewSection, headersHandler?: () => HttpHeaders): Observable<SectionDetails> {
			return this.http.post<SectionDetails>(this.baseUri + 'api/Section', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {string} OK
		 */
		Task_Delete(TaskID: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'api/Task?TaskID=' + TaskID, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Task_Get(UpdatedAfter: Date, pageSize: number, pageNumber: number, Sort: string, isComplete: boolean, ProjectID: number, headersHandler?: () => HttpHeaders): Observable<TaskList> {
			return this.http.get<TaskList>(this.baseUri + 'api/Task?UpdatedAfter=' + UpdatedAfter.toISOString() + '&pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&Sort=' + (Sort == null ? '' : encodeURIComponent(Sort)) + '&isComplete=' + isComplete + '&ProjectID=' + ProjectID, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Task_Post(requestBody: NewTask, headersHandler?: () => HttpHeaders): Observable<TaskDetails> {
			return this.http.post<TaskDetails>(this.baseUri + 'api/Task', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {TaskDetails} OK
		 */
		Task_Put(requestBody: UpdateTask, headersHandler?: () => HttpHeaders): Observable<TaskDetails> {
			return this.http.put<TaskDetails>(this.baseUri + 'api/Task', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TaskLookup(pageSize: number, pageNumber: number, projectID: number, hideCompleted: boolean, search: string, headersHandler?: () => HttpHeaders): Observable<TaskDropdownList> {
			return this.http.get<TaskDropdownList>(this.baseUri + 'api/Task/Lookup?pageSize=' + pageSize + '&pageNumber=' + pageNumber + '&projectID=' + projectID + '&hideCompleted=' + hideCompleted + '&search=' + (search == null ? '' : encodeURIComponent(search)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Task_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<TaskDetails> {
			return this.http.get<TaskDetails>(this.baseUri + 'api/Task/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		TaskStatus_Get(headersHandler?: () => HttpHeaders): Observable<TaskStatusList> {
			return this.http.get<TaskStatusList>(this.baseUri + 'api/TaskStatus', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		TaskType_Get(headersHandler?: () => HttpHeaders): Observable<TaskTypeList> {
			return this.http.get<TaskTypeList>(this.baseUri + 'api/TaskType', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {TaxList} OK
		 */
		Tax_Get(headersHandler?: () => HttpHeaders): Observable<TaxList> {
			return this.http.get<TaxList>(this.baseUri + 'api/Tax', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Timesheet_Post(requestBody: NewTimesheet, headersHandler?: () => HttpHeaders): Observable<TimesheetDetails> {
			return this.http.post<TimesheetDetails>(this.baseUri + 'api/Timesheet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {TimesheetDetails} OK
		 */
		Timesheet_Put(requestBody: UpdateTimesheetModel, headersHandler?: () => HttpHeaders): Observable<TimesheetDetails> {
			return this.http.put<TimesheetDetails>(this.baseUri + 'api/Timesheet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {string} OK
		 */
		Timesheet_Delete(id: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'api/Timesheet/' + id, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Timesheet_GetByID(id: number, headersHandler?: () => HttpHeaders): Observable<TimesheetDetails> {
			return this.http.get<TimesheetDetails>(this.baseUri + 'api/Timesheet/' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {string} OK
		 */
		TimesheetSubmission_Post(SendNotifications: boolean, WholeWeekOf: Date, WholeDayOf: Date, UserID: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/TimesheetSubmission?SendNotifications=' + SendNotifications + '&WholeWeekOf=' + WholeWeekOf.toISOString() + '&WholeDayOf=' + WholeDayOf.toISOString() + '&UserID=' + UserID, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		TimesheetTimer_GetRunningTimer(UserID: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.get(this.baseUri + 'api/TimesheetTimer?UserID=' + UserID, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} Success
		 */
		TimesheetTimer_StopTimer(id: number, UserID: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'api/TimesheetTimer/' + id + '?UserID=' + UserID, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {string} Success
		 */
		TimesheetTimer_StartTimer(id: number, UserID: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.post(this.baseUri + 'api/TimesheetTimer/' + id + '?UserID=' + UserID, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {UserList} OK
		 */
		UserProfile_Get(Roles: string, Tags: string, CurrentUserOnly: boolean, CompanyIDFK: number, headersHandler?: () => HttpHeaders): Observable<UserList> {
			return this.http.get<UserList>(this.baseUri + 'api/UserProfile?Roles=' + (Roles == null ? '' : encodeURIComponent(Roles)) + '&Tags=' + (Tags == null ? '' : encodeURIComponent(Tags)) + '&CurrentUserOnly=' + CurrentUserOnly + '&CompanyIDFK=' + CompanyIDFK, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Webhook_DeleteByUrl(target_url: string, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'api/Webhook?target_url=' + (target_url == null ? '' : encodeURIComponent(target_url)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		Webhook_Get(headersHandler?: () => HttpHeaders): Observable<WebhookList> {
			return this.http.get<WebhookList>(this.baseUri + 'api/Webhook', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		Webhook_Post(requestBody: CreateSubscription, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'api/Webhook', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {string} Subscription deleted ok
		 */
		Webhook_Delete(id: number, headersHandler?: () => HttpHeaders): Observable<string> {
			return this.http.delete(this.baseUri + 'api/Webhook/' + id, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
	}
