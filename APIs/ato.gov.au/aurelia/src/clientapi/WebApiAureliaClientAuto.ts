...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name>> {
			return this.http.get('business-names', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Address TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<address-type>> {
			return this.http.get('classifications/address-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Business Name Lifecycle StatesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name-lifecycle-state>> {
			return this.http.get('classifications/business-name-lifecycle-states', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Electronic Address TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<electronic-address-type>> {
			return this.http.get('classifications/electronic-address-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GendersGet(headersHandler?: () => {[header: string]: string}): Promise<Array<gender>> {
			return this.http.get('classifications/genders', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Legal Entity TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<legal-entity-type>> {
			return this.http.get('classifications/legal-entity-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		License Lifecycle StatesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license-lifecycle-state>> {
			return this.http.get('classifications/license-lifecycle-states', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		License TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license-type>> {
			return this.http.get('classifications/license-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Name DirectionsGet(headersHandler?: () => {[header: string]: string}): Promise<Array<name-direction>> {
			return this.http.get('classifications/name-directions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Name PrefixesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<name-prefix>> {
			return this.http.get('classifications/name-prefixes', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Name TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<name-type>> {
			return this.http.get('classifications/name-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Registered Identifier TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<registered-identifier-type>> {
			return this.http.get('classifications/registered-identifier-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<role>> {
			return this.http.get('classifications/roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		IndividualsGetByDateOfBirthAndPlaceOfBirth(dateOfBirth: string, placeOfBirth: string, headersHandler?: () => {[header: string]: string}): Promise<Array<individual>> {
			return this.http.get('individuals?dateOfBirth=' + (dateOfBirth == null ? '' : encodeURIComponent(dateOfBirth)) + '&placeOfBirth=' + (placeOfBirth == null ? '' : encodeURIComponent(placeOfBirth)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		IndividualsPost(requestBody: individual, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('individuals', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IndividualsDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('individuals/{partyId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		IndividualsGet(headersHandler?: () => {[header: string]: string}): Promise<Individual> {
			return this.http.get('individuals/{partyId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		IndividualsPut(requestBody: individual, headersHandler?: () => {[header: string]: string}): Promise<Individual> {
			return this.http.put('individuals/{partyId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Individuals AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<address>> {
			return this.http.get('individuals/{partyId}/addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals AddressesPost(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('individuals/{partyId}/addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Individuals AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('individuals/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Individuals AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return this.http.get('individuals/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals AddressesPut(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return this.http.put('individuals/{partyId}/addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Individuals Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name>> {
			return this.http.get('individuals/{partyId}/business-names', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals Business NamesPost(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('individuals/{partyId}/business-names', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Individuals Business NamesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('individuals/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Individuals Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return this.http.get('individuals/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals Business NamesPut(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return this.http.put('individuals/{partyId}/business-names/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Individuals Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<electronic-address>> {
			return this.http.get('individuals/{partyId}/electronic-addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals Electronic AddressesPost(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('individuals/{partyId}/electronic-addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Individuals Electronic AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('individuals/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Individuals Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return this.http.get('individuals/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals Electronic AddressesPut(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return this.http.put('individuals/{partyId}/electronic-addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Individuals LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license>> {
			return this.http.get('individuals/{partyId}/licenses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals LicensesPost(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('individuals/{partyId}/licenses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Individuals LicensesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('individuals/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Individuals LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<License> {
			return this.http.get('individuals/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals LicensesPut(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<License> {
			return this.http.put('individuals/{partyId}/licenses/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Individuals RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<party-role>> {
			return this.http.get('individuals/{partyId}/roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals RolesPost(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('individuals/{partyId}/roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Individuals RolesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('individuals/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Individuals RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return this.http.get('individuals/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Individuals RolesPut(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return this.http.put('individuals/{partyId}/roles/{roleId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license>> {
			return this.http.get('licenses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		OrganisationsGetByRegisteredIdentifierAndIdentifier(registeredIdentifier: string, identifier: string, headersHandler?: () => {[header: string]: string}): Promise<Array<organisation>> {
			return this.http.get('organisations?registeredIdentifier=' + (registeredIdentifier == null ? '' : encodeURIComponent(registeredIdentifier)) + '&identifier=' + (identifier == null ? '' : encodeURIComponent(identifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		OrganisationsPost(requestBody: organisation, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('organisations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		OrganisationsDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('organisations/{partyId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		OrganisationsGet(headersHandler?: () => {[header: string]: string}): Promise<Organisation> {
			return this.http.get('organisations/{partyId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		OrganisationsPut(requestBody: organisation, headersHandler?: () => {[header: string]: string}): Promise<Organisation> {
			return this.http.put('organisations/{partyId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Organisations AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<address>> {
			return this.http.get('organisations/{partyId}/addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations AddressesPost(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('organisations/{partyId}/addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Organisations AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('organisations/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Organisations AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return this.http.get('organisations/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations AddressesPut(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return this.http.put('organisations/{partyId}/addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Organisations Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name>> {
			return this.http.get('organisations/{partyId}/business-names', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations Business NamesPost(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('organisations/{partyId}/business-names', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Organisations Business NamesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('organisations/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Organisations Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return this.http.get('organisations/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations Business NamesPut(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return this.http.put('organisations/{partyId}/business-names/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Organisations Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<electronic-address>> {
			return this.http.get('organisations/{partyId}/electronic-addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations Electronic AddressesPost(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('organisations/{partyId}/electronic-addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Organisations Electronic AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('organisations/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Organisations Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return this.http.get('organisations/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations Electronic AddressesPut(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return this.http.put('organisations/{partyId}/electronic-addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Organisations LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license>> {
			return this.http.get('organisations/{partyId}/licenses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations LicensesPost(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('organisations/{partyId}/licenses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Organisations LicensesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('organisations/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Organisations LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<License> {
			return this.http.get('organisations/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations LicensesPut(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<License> {
			return this.http.put('organisations/{partyId}/licenses/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Organisations RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<party-role>> {
			return this.http.get('organisations/{partyId}/roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations RolesPost(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('organisations/{partyId}/roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Organisations RolesDelete(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('organisations/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Organisations RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return this.http.get('organisations/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Organisations RolesPut(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return this.http.put('organisations/{partyId}/roles/{roleId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
