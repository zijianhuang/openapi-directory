...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name>> {
			return Axios.get<Array<business-name>>(this.baseUri + 'business-names', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Address TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<address-type>> {
			return Axios.get<Array<address-type>>(this.baseUri + 'classifications/address-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Business Name Lifecycle StatesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name-lifecycle-state>> {
			return Axios.get<Array<business-name-lifecycle-state>>(this.baseUri + 'classifications/business-name-lifecycle-states', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Electronic Address TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<electronic-address-type>> {
			return Axios.get<Array<electronic-address-type>>(this.baseUri + 'classifications/electronic-address-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GendersGet(headersHandler?: () => {[header: string]: string}): Promise<Array<gender>> {
			return Axios.get<Array<gender>>(this.baseUri + 'classifications/genders', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Legal Entity TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<legal-entity-type>> {
			return Axios.get<Array<legal-entity-type>>(this.baseUri + 'classifications/legal-entity-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		License Lifecycle StatesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license-lifecycle-state>> {
			return Axios.get<Array<license-lifecycle-state>>(this.baseUri + 'classifications/license-lifecycle-states', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		License TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license-type>> {
			return Axios.get<Array<license-type>>(this.baseUri + 'classifications/license-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Name DirectionsGet(headersHandler?: () => {[header: string]: string}): Promise<Array<name-direction>> {
			return Axios.get<Array<name-direction>>(this.baseUri + 'classifications/name-directions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Name PrefixesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<name-prefix>> {
			return Axios.get<Array<name-prefix>>(this.baseUri + 'classifications/name-prefixes', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Name TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<name-type>> {
			return Axios.get<Array<name-type>>(this.baseUri + 'classifications/name-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Registered Identifier TypesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<registered-identifier-type>> {
			return Axios.get<Array<registered-identifier-type>>(this.baseUri + 'classifications/registered-identifier-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<role>> {
			return Axios.get<Array<role>>(this.baseUri + 'classifications/roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		IndividualsGetByDateOfBirthAndPlaceOfBirth(dateOfBirth: string, placeOfBirth: string, headersHandler?: () => {[header: string]: string}): Promise<Array<individual>> {
			return Axios.get<Array<individual>>(this.baseUri + 'individuals?dateOfBirth=' + (dateOfBirth == null ? '' : encodeURIComponent(dateOfBirth)) + '&placeOfBirth=' + (placeOfBirth == null ? '' : encodeURIComponent(placeOfBirth)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		IndividualsPost(requestBody: individual, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'individuals', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		IndividualsDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'individuals/{partyId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		IndividualsGet(headersHandler?: () => {[header: string]: string}): Promise<Individual> {
			return Axios.get<Individual>(this.baseUri + 'individuals/{partyId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		IndividualsPut(requestBody: individual, headersHandler?: () => {[header: string]: string}): Promise<Individual> {
			return Axios.put<Individual>(this.baseUri + 'individuals/{partyId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Individuals AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<address>> {
			return Axios.get<Array<address>>(this.baseUri + 'individuals/{partyId}/addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Individuals AddressesPost(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'individuals/{partyId}/addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Individuals AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'individuals/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Individuals AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return Axios.get<Address>(this.baseUri + 'individuals/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Individuals AddressesPut(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return Axios.put<Address>(this.baseUri + 'individuals/{partyId}/addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Individuals Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name>> {
			return Axios.get<Array<business-name>>(this.baseUri + 'individuals/{partyId}/business-names', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Individuals Business NamesPost(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'individuals/{partyId}/business-names', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Individuals Business NamesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'individuals/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Individuals Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return Axios.get<Business-name>(this.baseUri + 'individuals/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Individuals Business NamesPut(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return Axios.put<Business-name>(this.baseUri + 'individuals/{partyId}/business-names/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Individuals Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<electronic-address>> {
			return Axios.get<Array<electronic-address>>(this.baseUri + 'individuals/{partyId}/electronic-addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Individuals Electronic AddressesPost(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'individuals/{partyId}/electronic-addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Individuals Electronic AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'individuals/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Individuals Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return Axios.get<Electronic-address>(this.baseUri + 'individuals/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Individuals Electronic AddressesPut(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return Axios.put<Electronic-address>(this.baseUri + 'individuals/{partyId}/electronic-addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Individuals LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license>> {
			return Axios.get<Array<license>>(this.baseUri + 'individuals/{partyId}/licenses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Individuals LicensesPost(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'individuals/{partyId}/licenses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Individuals LicensesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'individuals/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Individuals LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<License> {
			return Axios.get<License>(this.baseUri + 'individuals/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Individuals LicensesPut(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<License> {
			return Axios.put<License>(this.baseUri + 'individuals/{partyId}/licenses/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Individuals RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<party-role>> {
			return Axios.get<Array<party-role>>(this.baseUri + 'individuals/{partyId}/roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Individuals RolesPost(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'individuals/{partyId}/roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Individuals RolesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'individuals/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Individuals RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return Axios.get<Party-role>(this.baseUri + 'individuals/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Individuals RolesPut(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return Axios.put<Party-role>(this.baseUri + 'individuals/{partyId}/roles/{roleId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license>> {
			return Axios.get<Array<license>>(this.baseUri + 'licenses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		OrganisationsGetByRegisteredIdentifierAndIdentifier(registeredIdentifier: string, identifier: string, headersHandler?: () => {[header: string]: string}): Promise<Array<organisation>> {
			return Axios.get<Array<organisation>>(this.baseUri + 'organisations?registeredIdentifier=' + (registeredIdentifier == null ? '' : encodeURIComponent(registeredIdentifier)) + '&identifier=' + (identifier == null ? '' : encodeURIComponent(identifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		OrganisationsPost(requestBody: organisation, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'organisations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		OrganisationsDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'organisations/{partyId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		OrganisationsGet(headersHandler?: () => {[header: string]: string}): Promise<Organisation> {
			return Axios.get<Organisation>(this.baseUri + 'organisations/{partyId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		OrganisationsPut(requestBody: organisation, headersHandler?: () => {[header: string]: string}): Promise<Organisation> {
			return Axios.put<Organisation>(this.baseUri + 'organisations/{partyId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Organisations AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<address>> {
			return Axios.get<Array<address>>(this.baseUri + 'organisations/{partyId}/addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Organisations AddressesPost(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'organisations/{partyId}/addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Organisations AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'organisations/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Organisations AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return Axios.get<Address>(this.baseUri + 'organisations/{partyId}/addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Organisations AddressesPut(requestBody: address, headersHandler?: () => {[header: string]: string}): Promise<Address> {
			return Axios.put<Address>(this.baseUri + 'organisations/{partyId}/addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Organisations Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<business-name>> {
			return Axios.get<Array<business-name>>(this.baseUri + 'organisations/{partyId}/business-names', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Organisations Business NamesPost(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'organisations/{partyId}/business-names', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Organisations Business NamesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'organisations/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Organisations Business NamesGet(headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return Axios.get<Business-name>(this.baseUri + 'organisations/{partyId}/business-names/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Organisations Business NamesPut(requestBody: business-name, headersHandler?: () => {[header: string]: string}): Promise<Business-name> {
			return Axios.put<Business-name>(this.baseUri + 'organisations/{partyId}/business-names/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Organisations Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<electronic-address>> {
			return Axios.get<Array<electronic-address>>(this.baseUri + 'organisations/{partyId}/electronic-addresses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Organisations Electronic AddressesPost(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'organisations/{partyId}/electronic-addresses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Organisations Electronic AddressesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'organisations/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Organisations Electronic AddressesGet(headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return Axios.get<Electronic-address>(this.baseUri + 'organisations/{partyId}/electronic-addresses/{addressId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Organisations Electronic AddressesPut(requestBody: electronic-address, headersHandler?: () => {[header: string]: string}): Promise<Electronic-address> {
			return Axios.put<Electronic-address>(this.baseUri + 'organisations/{partyId}/electronic-addresses/{addressId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Organisations LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<license>> {
			return Axios.get<Array<license>>(this.baseUri + 'organisations/{partyId}/licenses', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Organisations LicensesPost(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'organisations/{partyId}/licenses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Organisations LicensesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'organisations/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Organisations LicensesGet(headersHandler?: () => {[header: string]: string}): Promise<License> {
			return Axios.get<License>(this.baseUri + 'organisations/{partyId}/licenses/{productId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Organisations LicensesPut(requestBody: license, headersHandler?: () => {[header: string]: string}): Promise<License> {
			return Axios.put<License>(this.baseUri + 'organisations/{partyId}/licenses/{productId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		Organisations RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Array<party-role>> {
			return Axios.get<Array<party-role>>(this.baseUri + 'organisations/{partyId}/roles', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Organisations RolesPost(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'organisations/{partyId}/roles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		Organisations RolesDelete(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'organisations/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		Organisations RolesGet(headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return Axios.get<Party-role>(this.baseUri + 'organisations/{partyId}/roles/{roleId}', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		Organisations RolesPut(requestBody: party-role, headersHandler?: () => {[header: string]: string}): Promise<Party-role> {
			return Axios.put<Party-role>(this.baseUri + 'organisations/{partyId}/roles/{roleId}', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
