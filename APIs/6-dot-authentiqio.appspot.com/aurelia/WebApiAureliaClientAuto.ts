...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		Key_revoke_nosecret(email: string, phone: string, code: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('key?email=' + (email == null ? '' : encodeURIComponent(email)) + '&phone=' + (phone == null ? '' : encodeURIComponent(phone)) + '&code=' + (code == null ? '' : encodeURIComponent(code)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Key_register(requestBody: AuthentiqID, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('key', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Key_revoke(PK: string, secret: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('key/' + (PK == null ? '' : encodeURIComponent(PK)) + '&secret=' + (secret == null ? '' : encodeURIComponent(secret)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		KeyGetByPK(PK: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('key/' + (PK == null ? '' : encodeURIComponent(PK)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Key_update(PK: string, requestBody: AuthentiqID, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('key/' + (PK == null ? '' : encodeURIComponent(PK)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		Key_bind(PK: string, requestBody: AuthentiqID, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.put('key/' + (PK == null ? '' : encodeURIComponent(PK)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		Push_login_request(callback: string, requestBody: PushToken, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.post('login?callback=' + (callback == null ? '' : encodeURIComponent(callback)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
		}
		...
		Sign_request(test: number, requestBody: Scope, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('scope?test=' + test, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Sign_delete(job: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.delete('scope/' + (job == null ? '' : encodeURIComponent(job)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Sign_retrieve(job: string, headersHandler?: () => {[header: string]: string}): Promise<string> {
			return this.http.get('scope/' + (job == null ? '' : encodeURIComponent(job)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.text());
		}
		...
		Sign_confirm(job: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('scope/' + (job == null ? '' : encodeURIComponent(job)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		Sign_update(job: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('scope/' + (job == null ? '' : encodeURIComponent(job)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
