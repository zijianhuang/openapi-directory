...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelJournalKinesisStream(name: string, streamId: string, callback: (data : CancelJournalKinesisStreamResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeJournalKinesisStream(name: string, streamId: string, callback: (data : DescribeJournalKinesisStreamResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateLedger(callback: (data : CreateLedgerResponse) => any, requestBody: CreateLedgerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/ledgers', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListLedgers(max_results: number, next_token: string, MaxResults: string, NextToken: string, callback: (data : ListLedgersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/ledgers?max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLedger(name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeLedger(name: string, callback: (data : DescribeLedgerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeJournalS3Export(name: string, exportId: string, callback: (data : DescribeJournalS3ExportResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports/' + (exportId == null ? '' : encodeURIComponent(exportId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ExportJournalToS3(name: string, callback: (data : ExportJournalToS3Response) => any, requestBody: ExportJournalToS3Body, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListJournalS3ExportsForLedger(name: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, callback: (data : ListJournalS3ExportsForLedgerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports&max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBlock(name: string, callback: (data : GetBlockResponse) => any, requestBody: GetBlockBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/block', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDigest(name: string, callback: (data : GetDigestResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/digest', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetRevision(name: string, callback: (data : GetRevisionResponse) => any, requestBody: GetRevisionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/revision', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListJournalKinesisStreamsForLedger(name: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, callback: (data : ListJournalKinesisStreamsForLedgerResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		StreamJournalToKinesis(name: string, callback: (data : StreamJournalToKinesisResponse) => any, requestBody: StreamJournalToKinesisBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListJournalS3Exports(max_results: number, next_token: string, MaxResults: string, NextToken: string, callback: (data : ListJournalS3ExportsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/journal-s3-exports?max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
