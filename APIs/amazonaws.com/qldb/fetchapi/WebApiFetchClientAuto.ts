export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJournalKinesisStream(name: string, streamId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelJournalKinesisStreamResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeJournalKinesisStream(name: string, streamId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeJournalKinesisStreamResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateLedger(requestBody: CreateLedgerBody, headersHandler?: () => {[header: string]: string}): Promise<CreateLedgerResponse> {
			return fetch(this.baseUri + '/ledgers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListLedgers(max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListLedgersResponse> {
			return fetch(this.baseUri + '/ledgers?max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteLedger(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeLedger(name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeLedgerResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeJournalS3Export(name: string, exportId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeJournalS3ExportResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports/' + (exportId == null ? '' : encodeURIComponent(exportId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportJournalToS3(name: string, requestBody: ExportJournalToS3Body, headersHandler?: () => {[header: string]: string}): Promise<ExportJournalToS3Response> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListJournalS3ExportsForLedger(name: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJournalS3ExportsForLedgerResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports&max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBlock(name: string, requestBody: GetBlockBody, headersHandler?: () => {[header: string]: string}): Promise<GetBlockResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/block', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDigest(name: string, headersHandler?: () => {[header: string]: string}): Promise<GetDigestResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/digest', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRevision(name: string, requestBody: GetRevisionBody, headersHandler?: () => {[header: string]: string}): Promise<GetRevisionResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/revision', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StreamJournalToKinesis(name: string, requestBody: StreamJournalToKinesisBody, headersHandler?: () => {[header: string]: string}): Promise<StreamJournalToKinesisResponse> {
			return fetch(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListJournalS3Exports(max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJournalS3ExportsResponse> {
			return fetch(this.baseUri + '/journal-s3-exports?max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
