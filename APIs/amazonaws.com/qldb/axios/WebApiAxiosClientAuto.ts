...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJournalKinesisStream(name: string, streamId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelJournalKinesisStreamResponse> {
			return Axios.delete<CancelJournalKinesisStreamResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeJournalKinesisStream(name: string, streamId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeJournalKinesisStreamResponse> {
			return Axios.get<DescribeJournalKinesisStreamResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateLedger(requestBody: CreateLedgerBody, headersHandler?: () => {[header: string]: string}): Promise<CreateLedgerResponse> {
			return Axios.post<CreateLedgerResponse>(this.baseUri + '/ledgers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLedger(name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeLedger(name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeLedgerResponse> {
			return Axios.get<DescribeLedgerResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeJournalS3Export(name: string, exportId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeJournalS3ExportResponse> {
			return Axios.get<DescribeJournalS3ExportResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports/' + (exportId == null ? '' : encodeURIComponent(exportId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ExportJournalToS3(name: string, requestBody: ExportJournalToS3Body, headersHandler?: () => {[header: string]: string}): Promise<ExportJournalToS3Response> {
			return Axios.post<ExportJournalToS3Response>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetBlock(name: string, requestBody: GetBlockBody, headersHandler?: () => {[header: string]: string}): Promise<GetBlockResponse> {
			return Axios.post<GetBlockResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/block', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDigest(name: string, headersHandler?: () => {[header: string]: string}): Promise<GetDigestResponse> {
			return Axios.post<GetDigestResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/digest', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetRevision(name: string, requestBody: GetRevisionBody, headersHandler?: () => {[header: string]: string}): Promise<GetRevisionResponse> {
			return Axios.post<GetRevisionResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/revision', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StreamJournalToKinesis(name: string, requestBody: StreamJournalToKinesisBody, headersHandler?: () => {[header: string]: string}): Promise<StreamJournalToKinesisResponse> {
			return Axios.post<StreamJournalToKinesisResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
