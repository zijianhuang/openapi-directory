...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelJournalKinesisStream(name: string, streamId: string, headersHandler?: () => HttpHeaders): Observable<CancelJournalKinesisStreamResponse> {
			return this.http.delete<CancelJournalKinesisStreamResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeJournalKinesisStream(name: string, streamId: string, headersHandler?: () => HttpHeaders): Observable<DescribeJournalKinesisStreamResponse> {
			return this.http.get<DescribeJournalKinesisStreamResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateLedger(requestBody: CreateLedgerBody, headersHandler?: () => HttpHeaders): Observable<CreateLedgerResponse> {
			return this.http.post<CreateLedgerResponse>(this.baseUri + '/ledgers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLedger(name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeLedger(name: string, headersHandler?: () => HttpHeaders): Observable<DescribeLedgerResponse> {
			return this.http.get<DescribeLedgerResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeJournalS3Export(name: string, exportId: string, headersHandler?: () => HttpHeaders): Observable<DescribeJournalS3ExportResponse> {
			return this.http.get<DescribeJournalS3ExportResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports/' + (exportId == null ? '' : encodeURIComponent(exportId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ExportJournalToS3(name: string, requestBody: ExportJournalToS3Body, headersHandler?: () => HttpHeaders): Observable<ExportJournalToS3Response> {
			return this.http.post<ExportJournalToS3Response>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListJournalS3ExportsForLedger(name: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListJournalS3ExportsForLedgerResponse> {
			return this.http.get<ListJournalS3ExportsForLedgerResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-s3-exports&max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBlock(name: string, requestBody: GetBlockBody, headersHandler?: () => HttpHeaders): Observable<GetBlockResponse> {
			return this.http.post<GetBlockResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/block', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDigest(name: string, headersHandler?: () => HttpHeaders): Observable<GetDigestResponse> {
			return this.http.post<GetDigestResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/digest', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetRevision(name: string, requestBody: GetRevisionBody, headersHandler?: () => HttpHeaders): Observable<GetRevisionResponse> {
			return this.http.post<GetRevisionResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/revision', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListJournalKinesisStreamsForLedger(name: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListJournalKinesisStreamsForLedgerResponse> {
		 ...
		 */
		StreamJournalToKinesis(name: string, requestBody: StreamJournalToKinesisBody, headersHandler?: () => HttpHeaders): Observable<StreamJournalToKinesisResponse> {
			return this.http.post<StreamJournalToKinesisResponse>(this.baseUri + '/ledgers/' + (name == null ? '' : encodeURIComponent(name)) + '/journal-kinesis-streams', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListJournalS3Exports(max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListJournalS3ExportsResponse> {
			return this.http.get<ListJournalS3ExportsResponse>(this.baseUri + '/journal-s3-exports?max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
