...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBackupPlan(requestBody: CreateBackupPlanBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupPlanOutput> {
			return this.http.put('/backup/plans/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListBackupPlans(nextToken: string, maxResults: number, includeDeleted: boolean, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlansOutput> {
			return this.http.get('/backup/plans/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&includeDeleted=' + includeDeleted + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBackupSelection(backupPlanId: string, requestBody: CreateBackupSelectionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupSelectionOutput> {
			return this.http.put('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListBackupSelections(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupSelectionsOutput> {
			return this.http.get('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBackupVault(backupVaultName: string, requestBody: CreateBackupVaultBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupVaultOutput> {
			return this.http.put('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVault(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeBackupVault(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupVaultOutput> {
			return this.http.get('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBackupPlan(backupPlanId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackupPlanOutput> {
			return this.http.delete('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBackupPlan(backupPlanId: string, requestBody: UpdateBackupPlanBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBackupPlanOutput> {
			return this.http.post('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupSelectionOutput> {
			return this.http.get('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupVaultAccessPolicyOutput> {
			return this.http.get('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutBackupVaultAccessPolicy(backupVaultName: string, requestBody: PutBackupVaultAccessPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVaultNotifications(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBackupVaultNotifications(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupVaultNotificationsOutput> {
			return this.http.get('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutBackupVaultNotifications(backupVaultName: string, requestBody: PutBackupVaultNotificationsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecoveryPointOutput> {
			return this.http.get('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBackupJob(backupJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupJobOutput> {
			return this.http.get('/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		StopBackupJob(backupJobId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeCopyJob(copyJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCopyJobOutput> {
			return this.http.get('/copy-jobs/' + (copyJobId == null ? '' : encodeURIComponent(copyJobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProtectedResource(resourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeProtectedResourceOutput> {
			return this.http.get('/resources/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRegionSettings(headersHandler?: () => {[header: string]: string}): Promise<DescribeRegionSettingsOutput> {
			return this.http.get('/account-settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdateRegionSettings(requestBody: UpdateRegionSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/account-settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeRestoreJob(restoreJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRestoreJobOutput> {
			return this.http.get('/restore-jobs/' + (restoreJobId == null ? '' : encodeURIComponent(restoreJobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportBackupPlanTemplate(backupPlanId: string, headersHandler?: () => {[header: string]: string}): Promise<ExportBackupPlanTemplateOutput> {
			return this.http.get('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/toTemplate/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBackupPlan(backupPlanId: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanOutput> {
			return this.http.get('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBackupPlanFromJSON(requestBody: GetBackupPlanFromJSONBody, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanFromJSONOutput> {
			return this.http.post('/backup/template/json/toPlan', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetBackupPlanFromTemplate(templateId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanFromTemplateOutput> {
			return this.http.get('/backup/template/plans/' + (templateId == null ? '' : encodeURIComponent(templateId)) + '/toPlan', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRecoveryPointRestoreMetadata(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetRecoveryPointRestoreMetadataOutput> {
			return this.http.get('/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)) + '/restore-metadata', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSupportedResourceTypes(headersHandler?: () => {[header: string]: string}): Promise<GetSupportedResourceTypesOutput> {
			return this.http.get('/supported-resource-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBackupJobs(nextToken: string, maxResults: number, resourceArn: string, state: DescribeBackupJobOutputState, backupVaultName: string, createdBefore: Date, createdAfter: Date, resourceType: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupJobsOutput> {
			return this.http.get('/backup-jobs/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&state=' + state + '&backupVaultName=' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '&createdBefore=' + createdBefore.toISOString() + '&createdAfter=' + createdAfter.toISOString() + '&resourceType=' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBackupPlanTemplates(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlanTemplatesOutput> {
			return this.http.get('/backup/template/plans?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBackupPlanVersions(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlanVersionsOutput> {
			return this.http.get('/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBackupVaults(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupVaultsOutput> {
			return this.http.get('/backup-vaults/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProtectedResources(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProtectedResourcesOutput> {
			return this.http.get('/resources/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListRestoreJobs(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRestoreJobsOutput> {
			return this.http.get('/restore-jobs/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTags(resourceArn: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsOutput> {
			return this.http.get('/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartBackupJob(requestBody: StartBackupJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartBackupJobOutput> {
			return this.http.put('/backup-jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartCopyJob(requestBody: StartCopyJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartCopyJobOutput> {
			return this.http.put('/copy-jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartRestoreJob(requestBody: StartRestoreJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartRestoreJobOutput> {
			return this.http.put('/restore-jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UntagResource(resourceArn: string, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/untag/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
