...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateBackupPlan(requestBody: CreateBackupPlanBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupPlanOutput> {
			return Axios.put<CreateBackupPlanOutput>(this.baseUri + '/backup/plans/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListBackupPlans(nextToken: string, maxResults: number, includeDeleted: boolean, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlansOutput> {
			return Axios.get<ListBackupPlansOutput>(this.baseUri + '/backup/plans/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&includeDeleted=' + includeDeleted + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateBackupSelection(backupPlanId: string, requestBody: CreateBackupSelectionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupSelectionOutput> {
			return Axios.put<CreateBackupSelectionOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListBackupSelections(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupSelectionsOutput> {
			return Axios.get<ListBackupSelectionsOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateBackupVault(backupVaultName: string, requestBody: CreateBackupVaultBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupVaultOutput> {
			return Axios.put<CreateBackupVaultOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVault(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		DescribeBackupVault(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupVaultOutput> {
			return Axios.get<DescribeBackupVaultOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteBackupPlan(backupPlanId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackupPlanOutput> {
			return Axios.delete<DeleteBackupPlanOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		UpdateBackupPlan(backupPlanId: string, requestBody: UpdateBackupPlanBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBackupPlanOutput> {
			return Axios.post<UpdateBackupPlanOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupSelectionOutput> {
			return Axios.get<GetBackupSelectionOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupVaultAccessPolicyOutput> {
			return Axios.get<GetBackupVaultAccessPolicyOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		PutBackupVaultAccessPolicy(backupVaultName: string, requestBody: PutBackupVaultAccessPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVaultNotifications(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetBackupVaultNotifications(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupVaultNotificationsOutput> {
			return Axios.get<GetBackupVaultNotificationsOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		PutBackupVaultNotifications(backupVaultName: string, requestBody: PutBackupVaultNotificationsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		DescribeRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecoveryPointOutput> {
			return Axios.get<DescribeRecoveryPointOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		UpdateRecoveryPointLifecycle(backupVaultName: string, recoveryPointArn: string, requestBody: UpdateRecoveryPointLifecycleBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRecoveryPointLifecycleOutput> {
			return Axios.post<UpdateRecoveryPointLifecycleOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeBackupJob(backupJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupJobOutput> {
			return Axios.get<DescribeBackupJobOutput>(this.baseUri + '/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		StopBackupJob(backupJobId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		DescribeCopyJob(copyJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCopyJobOutput> {
			return Axios.get<DescribeCopyJobOutput>(this.baseUri + '/copy-jobs/' + (copyJobId == null ? '' : encodeURIComponent(copyJobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeProtectedResource(resourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeProtectedResourceOutput> {
			return Axios.get<DescribeProtectedResourceOutput>(this.baseUri + '/resources/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeRegionSettings(headersHandler?: () => {[header: string]: string}): Promise<DescribeRegionSettingsOutput> {
			return Axios.get<DescribeRegionSettingsOutput>(this.baseUri + '/account-settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateRegionSettings(requestBody: UpdateRegionSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/account-settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeRestoreJob(restoreJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRestoreJobOutput> {
			return Axios.get<DescribeRestoreJobOutput>(this.baseUri + '/restore-jobs/' + (restoreJobId == null ? '' : encodeURIComponent(restoreJobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ExportBackupPlanTemplate(backupPlanId: string, headersHandler?: () => {[header: string]: string}): Promise<ExportBackupPlanTemplateOutput> {
			return Axios.get<ExportBackupPlanTemplateOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/toTemplate/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetBackupPlan(backupPlanId: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanOutput> {
			return Axios.get<GetBackupPlanOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetBackupPlanFromJSON(requestBody: GetBackupPlanFromJSONBody, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanFromJSONOutput> {
			return Axios.post<GetBackupPlanFromJSONOutput>(this.baseUri + '/backup/template/json/toPlan', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetBackupPlanFromTemplate(templateId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanFromTemplateOutput> {
			return Axios.get<GetBackupPlanFromTemplateOutput>(this.baseUri + '/backup/template/plans/' + (templateId == null ? '' : encodeURIComponent(templateId)) + '/toPlan', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetRecoveryPointRestoreMetadata(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetRecoveryPointRestoreMetadataOutput> {
			return Axios.get<GetRecoveryPointRestoreMetadataOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)) + '/restore-metadata', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetSupportedResourceTypes(headersHandler?: () => {[header: string]: string}): Promise<GetSupportedResourceTypesOutput> {
			return Axios.get<GetSupportedResourceTypesOutput>(this.baseUri + '/supported-resource-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListBackupJobs(nextToken: string, maxResults: number, resourceArn: string, state: DescribeBackupJobOutputState, backupVaultName: string, createdBefore: Date, createdAfter: Date, resourceType: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupJobsOutput> {
			return Axios.get<ListBackupJobsOutput>(this.baseUri + '/backup-jobs/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&state=' + state + '&backupVaultName=' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '&createdBefore=' + createdBefore.toISOString() + '&createdAfter=' + createdAfter.toISOString() + '&resourceType=' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListBackupPlanTemplates(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlanTemplatesOutput> {
			return Axios.get<ListBackupPlanTemplatesOutput>(this.baseUri + '/backup/template/plans?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListBackupPlanVersions(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlanVersionsOutput> {
			return Axios.get<ListBackupPlanVersionsOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListBackupVaults(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupVaultsOutput> {
			return Axios.get<ListBackupVaultsOutput>(this.baseUri + '/backup-vaults/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListCopyJobs(nextToken: string, maxResults: number, resourceArn: string, state: CopyJobState, createdBefore: Date, createdAfter: Date, resourceType: string, destinationVaultArn: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListCopyJobsOutput> {
			return Axios.get<ListCopyJobsOutput>(this.baseUri + '/copy-jobs/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&state=' + state + '&createdBefore=' + createdBefore.toISOString() + '&createdAfter=' + createdAfter.toISOString() + '&resourceType=' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '&destinationVaultArn=' + (destinationVaultArn == null ? '' : encodeURIComponent(destinationVaultArn)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListProtectedResources(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProtectedResourcesOutput> {
			return Axios.get<ListProtectedResourcesOutput>(this.baseUri + '/resources/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListRecoveryPointsByResource(resourceArn: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRecoveryPointsByResourceOutput> {
			return Axios.get<ListRecoveryPointsByResourceOutput>(this.baseUri + '/resources/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '/recovery-points/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListRestoreJobs(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRestoreJobsOutput> {
			return Axios.get<ListRestoreJobsOutput>(this.baseUri + '/restore-jobs/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListTags(resourceArn: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsOutput> {
			return Axios.get<ListTagsOutput>(this.baseUri + '/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		StartBackupJob(requestBody: StartBackupJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartBackupJobOutput> {
			return Axios.put<StartBackupJobOutput>(this.baseUri + '/backup-jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartCopyJob(requestBody: StartCopyJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartCopyJobOutput> {
			return Axios.put<StartCopyJobOutput>(this.baseUri + '/copy-jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartRestoreJob(requestBody: StartRestoreJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartRestoreJobOutput> {
			return Axios.put<StartRestoreJobOutput>(this.baseUri + '/restore-jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UntagResource(resourceArn: string, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/untag/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
