...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateBackupPlan(requestBody: CreateBackupPlanBody, headersHandler?: () => HttpHeaders): Observable<CreateBackupPlanOutput> {
			return this.http.put<CreateBackupPlanOutput>(this.baseUri + '/backup/plans/', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateBackupSelection(backupPlanId: string, requestBody: CreateBackupSelectionBody, headersHandler?: () => HttpHeaders): Observable<CreateBackupSelectionOutput> {
			return this.http.put<CreateBackupSelectionOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListBackupSelections(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListBackupSelectionsOutput> {
		 ...
		 */
		CreateBackupVault(backupVaultName: string, requestBody: CreateBackupVaultBody, headersHandler?: () => HttpHeaders): Observable<CreateBackupVaultOutput> {
			return this.http.put<CreateBackupVaultOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVault(backupVaultName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeBackupVault(backupVaultName: string, headersHandler?: () => HttpHeaders): Observable<DescribeBackupVaultOutput> {
			return this.http.get<DescribeBackupVaultOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteBackupPlan(backupPlanId: string, headersHandler?: () => HttpHeaders): Observable<DeleteBackupPlanOutput> {
			return this.http.delete<DeleteBackupPlanOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateBackupPlan(backupPlanId: string, requestBody: UpdateBackupPlanBody, headersHandler?: () => HttpHeaders): Observable<UpdateBackupPlanOutput> {
			return this.http.post<UpdateBackupPlanOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => HttpHeaders): Observable<GetBackupSelectionOutput> {
			return this.http.get<GetBackupSelectionOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => HttpHeaders): Observable<GetBackupVaultAccessPolicyOutput> {
			return this.http.get<GetBackupVaultAccessPolicyOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		PutBackupVaultAccessPolicy(backupVaultName: string, requestBody: PutBackupVaultAccessPolicyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBackupVaultNotifications(backupVaultName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBackupVaultNotifications(backupVaultName: string, headersHandler?: () => HttpHeaders): Observable<GetBackupVaultNotificationsOutput> {
			return this.http.get<GetBackupVaultNotificationsOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		PutBackupVaultNotifications(backupVaultName: string, requestBody: PutBackupVaultNotificationsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		DeleteRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => HttpHeaders): Observable<DescribeRecoveryPointOutput> {
			return this.http.get<DescribeRecoveryPointOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateRecoveryPointLifecycle(backupVaultName: string, recoveryPointArn: string, requestBody: UpdateRecoveryPointLifecycleBody, headersHandler?: () => HttpHeaders): Observable<UpdateRecoveryPointLifecycleOutput> {
			return this.http.post<UpdateRecoveryPointLifecycleOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeBackupJob(backupJobId: string, headersHandler?: () => HttpHeaders): Observable<DescribeBackupJobOutput> {
			return this.http.get<DescribeBackupJobOutput>(this.baseUri + '/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		StopBackupJob(backupJobId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeCopyJob(copyJobId: string, headersHandler?: () => HttpHeaders): Observable<DescribeCopyJobOutput> {
			return this.http.get<DescribeCopyJobOutput>(this.baseUri + '/copy-jobs/' + (copyJobId == null ? '' : encodeURIComponent(copyJobId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeProtectedResource(resourceArn: string, headersHandler?: () => HttpHeaders): Observable<DescribeProtectedResourceOutput> {
			return this.http.get<DescribeProtectedResourceOutput>(this.baseUri + '/resources/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeRegionSettings(headersHandler?: () => HttpHeaders): Observable<DescribeRegionSettingsOutput> {
			return this.http.get<DescribeRegionSettingsOutput>(this.baseUri + '/account-settings', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateRegionSettings(requestBody: UpdateRegionSettingsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/account-settings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeRestoreJob(restoreJobId: string, headersHandler?: () => HttpHeaders): Observable<DescribeRestoreJobOutput> {
			return this.http.get<DescribeRestoreJobOutput>(this.baseUri + '/restore-jobs/' + (restoreJobId == null ? '' : encodeURIComponent(restoreJobId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ExportBackupPlanTemplate(backupPlanId: string, headersHandler?: () => HttpHeaders): Observable<ExportBackupPlanTemplateOutput> {
			return this.http.get<ExportBackupPlanTemplateOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/toTemplate/', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBackupPlan(backupPlanId: string, versionId: string, headersHandler?: () => HttpHeaders): Observable<GetBackupPlanOutput> {
			return this.http.get<GetBackupPlanOutput>(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBackupPlanFromJSON(requestBody: GetBackupPlanFromJSONBody, headersHandler?: () => HttpHeaders): Observable<GetBackupPlanFromJSONOutput> {
			return this.http.post<GetBackupPlanFromJSONOutput>(this.baseUri + '/backup/template/json/toPlan', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetBackupPlanFromTemplate(templateId: string, headersHandler?: () => HttpHeaders): Observable<GetBackupPlanFromTemplateOutput> {
			return this.http.get<GetBackupPlanFromTemplateOutput>(this.baseUri + '/backup/template/plans/' + (templateId == null ? '' : encodeURIComponent(templateId)) + '/toPlan', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetRecoveryPointRestoreMetadata(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => HttpHeaders): Observable<GetRecoveryPointRestoreMetadataOutput> {
			return this.http.get<GetRecoveryPointRestoreMetadataOutput>(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)) + '/restore-metadata', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSupportedResourceTypes(headersHandler?: () => HttpHeaders): Observable<GetSupportedResourceTypesOutput> {
			return this.http.get<GetSupportedResourceTypesOutput>(this.baseUri + '/supported-resource-types', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListBackupJobs(nextToken: string, maxResults: number, resourceArn: string, state: DescribeBackupJobOutputState, backupVaultName: string, createdBefore: Date, createdAfter: Date, resourceType: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListBackupJobsOutput> {
		 ...
		 */
		ListBackupPlanVersions(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListBackupPlanVersionsOutput> {
		 ...
		 */
		ListCopyJobs(nextToken: string, maxResults: number, resourceArn: string, state: CopyJobState, createdBefore: Date, createdAfter: Date, resourceType: string, destinationVaultArn: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListCopyJobsOutput> {
		 ...
		 */
		ListRecoveryPointsByBackupVault(backupVaultName: string, nextToken: string, maxResults: number, resourceArn: string, resourceType: string, backupPlanId: string, createdBefore: Date, createdAfter: Date, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListRecoveryPointsByBackupVaultOutput> {
		 ...
		 */
		ListRecoveryPointsByResource(resourceArn: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListRecoveryPointsByResourceOutput> {
		 ...
		 */
		ListRestoreJobs(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListRestoreJobsOutput> {
		 ...
		 */
		StartBackupJob(requestBody: StartBackupJobBody, headersHandler?: () => HttpHeaders): Observable<StartBackupJobOutput> {
			return this.http.put<StartBackupJobOutput>(this.baseUri + '/backup-jobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartCopyJob(requestBody: StartCopyJobBody, headersHandler?: () => HttpHeaders): Observable<StartCopyJobOutput> {
			return this.http.put<StartCopyJobOutput>(this.baseUri + '/copy-jobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartRestoreJob(requestBody: StartRestoreJobBody, headersHandler?: () => HttpHeaders): Observable<StartRestoreJobOutput> {
			return this.http.put<StartRestoreJobOutput>(this.baseUri + '/restore-jobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		UntagResource(resourceArn: string, requestBody: UntagResourceBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/untag/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
