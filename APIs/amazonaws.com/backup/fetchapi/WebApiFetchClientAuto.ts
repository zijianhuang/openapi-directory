export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBackupPlan(requestBody: CreateBackupPlanBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupPlanOutput> {
			return fetch(this.baseUri + '/backup/plans/', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBackupPlans(nextToken: string, maxResults: number, includeDeleted: boolean, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlansOutput> {
			return fetch(this.baseUri + '/backup/plans/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&includeDeleted=' + includeDeleted + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBackupSelection(backupPlanId: string, requestBody: CreateBackupSelectionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupSelectionOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBackupSelections(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupSelectionsOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBackupVault(backupVaultName: string, requestBody: CreateBackupVaultBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupVaultOutput> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteBackupVault(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeBackupVault(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupVaultOutput> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBackupPlan(backupPlanId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackupPlanOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBackupPlan(backupPlanId: string, requestBody: UpdateBackupPlanBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBackupPlanOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBackupSelection(backupPlanId: string, selectionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupSelectionOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/selections/' + (selectionId == null ? '' : encodeURIComponent(selectionId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBackupVaultAccessPolicy(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupVaultAccessPolicyOutput> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutBackupVaultAccessPolicy(backupVaultName: string, requestBody: PutBackupVaultAccessPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/access-policy', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteBackupVaultNotifications(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBackupVaultNotifications(backupVaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupVaultNotificationsOutput> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutBackupVaultNotifications(backupVaultName: string, requestBody: PutBackupVaultNotificationsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/notification-configuration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeRecoveryPoint(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecoveryPointOutput> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBackupJob(backupJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupJobOutput> {
			return fetch(this.baseUri + '/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StopBackupJob(backupJobId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/backup-jobs/' + (backupJobId == null ? '' : encodeURIComponent(backupJobId)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeCopyJob(copyJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCopyJobOutput> {
			return fetch(this.baseUri + '/copy-jobs/' + (copyJobId == null ? '' : encodeURIComponent(copyJobId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProtectedResource(resourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeProtectedResourceOutput> {
			return fetch(this.baseUri + '/resources/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRegionSettings(headersHandler?: () => {[header: string]: string}): Promise<DescribeRegionSettingsOutput> {
			return fetch(this.baseUri + '/account-settings', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateRegionSettings(requestBody: UpdateRegionSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/account-settings', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeRestoreJob(restoreJobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRestoreJobOutput> {
			return fetch(this.baseUri + '/restore-jobs/' + (restoreJobId == null ? '' : encodeURIComponent(restoreJobId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportBackupPlanTemplate(backupPlanId: string, headersHandler?: () => {[header: string]: string}): Promise<ExportBackupPlanTemplateOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/toTemplate/', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBackupPlan(backupPlanId: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBackupPlanFromJSON(requestBody: GetBackupPlanFromJSONBody, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanFromJSONOutput> {
			return fetch(this.baseUri + '/backup/template/json/toPlan', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetBackupPlanFromTemplate(templateId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackupPlanFromTemplateOutput> {
			return fetch(this.baseUri + '/backup/template/plans/' + (templateId == null ? '' : encodeURIComponent(templateId)) + '/toPlan', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRecoveryPointRestoreMetadata(backupVaultName: string, recoveryPointArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetRecoveryPointRestoreMetadataOutput> {
			return fetch(this.baseUri + '/backup-vaults/' + (backupVaultName == null ? '' : encodeURIComponent(backupVaultName)) + '/recovery-points/' + (recoveryPointArn == null ? '' : encodeURIComponent(recoveryPointArn)) + '/restore-metadata', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSupportedResourceTypes(headersHandler?: () => {[header: string]: string}): Promise<GetSupportedResourceTypesOutput> {
			return fetch(this.baseUri + '/supported-resource-types', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBackupPlanTemplates(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlanTemplatesOutput> {
			return fetch(this.baseUri + '/backup/template/plans?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBackupPlanVersions(backupPlanId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupPlanVersionsOutput> {
			return fetch(this.baseUri + '/backup/plans/' + (backupPlanId == null ? '' : encodeURIComponent(backupPlanId)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBackupVaults(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBackupVaultsOutput> {
			return fetch(this.baseUri + '/backup-vaults/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListCopyJobs(nextToken: string, maxResults: number, resourceArn: string, state: CopyJobState, createdBefore: Date, createdAfter: Date, resourceType: string, destinationVaultArn: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListCopyJobsOutput> {
			return fetch(this.baseUri + '/copy-jobs/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&state=' + state + '&createdBefore=' + createdBefore.toISOString() + '&createdAfter=' + createdAfter.toISOString() + '&resourceType=' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '&destinationVaultArn=' + (destinationVaultArn == null ? '' : encodeURIComponent(destinationVaultArn)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProtectedResources(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProtectedResourcesOutput> {
			return fetch(this.baseUri + '/resources/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListRecoveryPointsByResource(resourceArn: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRecoveryPointsByResourceOutput> {
			return fetch(this.baseUri + '/resources/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '/recovery-points/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListRestoreJobs(nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRestoreJobsOutput> {
			return fetch(this.baseUri + '/restore-jobs/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTags(resourceArn: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsOutput> {
			return fetch(this.baseUri + '/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartBackupJob(requestBody: StartBackupJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartBackupJobOutput> {
			return fetch(this.baseUri + '/backup-jobs', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartCopyJob(requestBody: StartCopyJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartCopyJobOutput> {
			return fetch(this.baseUri + '/copy-jobs', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartRestoreJob(requestBody: StartRestoreJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartRestoreJobOutput> {
			return fetch(this.baseUri + '/restore-jobs', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(resourceArn: string, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/untag/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
