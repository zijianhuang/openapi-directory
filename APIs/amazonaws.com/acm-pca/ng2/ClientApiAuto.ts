...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateCertificateAuthority(requestBody: CreateCertificateAuthorityRequest, headersHandler?: () => HttpHeaders): Observable<CreateCertificateAuthorityResponse> {
			return this.http.post<CreateCertificateAuthorityResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateCertificateAuthorityAuditReport(requestBody: CreateCertificateAuthorityAuditReportRequest, headersHandler?: () => HttpHeaders): Observable<CreateCertificateAuthorityAuditReportResponse> {
			return this.http.post<CreateCertificateAuthorityAuditReportResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthorityAuditReport', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		CreatePermission(requestBody: CreatePermissionRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreatePermission', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificateAuthority(requestBody: DeleteCertificateAuthorityRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DeleteCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePermission(requestBody: DeletePermissionRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DeletePermission', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeCertificateAuthority(requestBody: DescribeCertificateAuthorityRequest, headersHandler?: () => HttpHeaders): Observable<DescribeCertificateAuthorityResponse> {
			return this.http.post<DescribeCertificateAuthorityResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCertificateAuthorityAuditReport(requestBody: DescribeCertificateAuthorityAuditReportRequest, headersHandler?: () => HttpHeaders): Observable<DescribeCertificateAuthorityAuditReportResponse> {
			return this.http.post<DescribeCertificateAuthorityAuditReportResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthorityAuditReport', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetCertificate(requestBody: GetCertificateRequest, headersHandler?: () => HttpHeaders): Observable<GetCertificateResponse> {
			return this.http.post<GetCertificateResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetCertificateAuthorityCertificate(requestBody: GetCertificateAuthorityCertificateRequest, headersHandler?: () => HttpHeaders): Observable<GetCertificateAuthorityCertificateResponse> {
			return this.http.post<GetCertificateAuthorityCertificateResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCertificate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetCertificateAuthorityCsr(requestBody: GetCertificateAuthorityCsrRequest, headersHandler?: () => HttpHeaders): Observable<GetCertificateAuthorityCsrResponse> {
			return this.http.post<GetCertificateAuthorityCsrResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCsr', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		ImportCertificateAuthorityCertificate(requestBody: ImportCertificateAuthorityCertificateRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ImportCertificateAuthorityCertificate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		IssueCertificate(requestBody: IssueCertificateRequest, headersHandler?: () => HttpHeaders): Observable<IssueCertificateResponse> {
			return this.http.post<IssueCertificateResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.IssueCertificate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCertificateAuthorities(MaxResults: string, NextToken: string, requestBody: ListCertificateAuthoritiesRequest, headersHandler?: () => HttpHeaders): Observable<ListCertificateAuthoritiesResponse> {
			return this.http.post<ListCertificateAuthoritiesResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ListCertificateAuthorities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListPermissions(MaxResults: string, NextToken: string, requestBody: ListPermissionsRequest, headersHandler?: () => HttpHeaders): Observable<ListPermissionsResponse> {
			return this.http.post<ListPermissionsResponse>(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ListPermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		RestoreCertificateAuthority(requestBody: RestoreCertificateAuthorityRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.RestoreCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RevokeCertificate(requestBody: RevokeCertificateRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.RevokeCertificate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		TagCertificateAuthority(requestBody: TagCertificateAuthorityRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.TagCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UntagCertificateAuthority(requestBody: UntagCertificateAuthorityRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.UntagCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificateAuthority(requestBody: UpdateCertificateAuthorityRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.UpdateCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
