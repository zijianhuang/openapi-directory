export namespace My_Demo_Client {
	...
	export interface IssueCertificateRequest {
		CertificateAuthorityArn: string;
		Csr: string;
		SigningAlgorithm: IssueCertificateRequestSigningAlgorithm;
		TemplateArn?: string;
	...
	export enum IssueCertificateRequestSigningAlgorithm { SHA256WITHECDSA = 0, SHA384WITHECDSA = 1, SHA512WITHECDSA = 2, SHA256WITHRSA = 3, SHA384WITHRSA = 4, SHA512WITHRSA = 5 }
	...
	export interface UpdateCertificateAuthorityRequest {
		...
		/**Certificate revocation information used by the <a>CreateCertificateAuthority</a> and <a>UpdateCertificateAuthority</a> actions. Your private certificate authority (CA) can create and maintain a certificate revocation list (CRL). A CRL contains information about certificates revoked by your CA. For more information, see <a>RevokeCertificate</a>. */
		RevocationConfiguration?: RevocationConfiguration;
		Status?: UpdateCertificateAuthorityRequestStatus;
	}

	export enum UpdateCertificateAuthorityRequestStatus { CREATING = 0, PENDING_CERTIFICATE = 1, ACTIVE = 2, DELETED = 3, DISABLED = 4, EXPIRED = 5, FAILED = 6 }
	...
	export class DemoClient {
		 ...
		 */
		CreateCertificateAuthority(requestBody: CreateCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCertificateAuthorityResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthority', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateCertificateAuthorityAuditReport(requestBody: CreateCertificateAuthorityAuditReportRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCertificateAuthorityAuditReportResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthorityAuditReport', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		CreatePermission(requestBody: CreatePermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreatePermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificateAuthority(requestBody: DeleteCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DeleteCertificateAuthority', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePermission(requestBody: DeletePermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DeletePermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		DescribeCertificateAuthority(requestBody: DescribeCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateAuthorityResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthority', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeCertificateAuthorityAuditReport(requestBody: DescribeCertificateAuthorityAuditReportRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateAuthorityAuditReportResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthorityAuditReport', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetCertificate(requestBody: GetCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetCertificateAuthorityCertificate(requestBody: GetCertificateAuthorityCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateAuthorityCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetCertificateAuthorityCsr(requestBody: GetCertificateAuthorityCsrRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateAuthorityCsrResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCsr', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		ImportCertificateAuthorityCertificate(requestBody: ImportCertificateAuthorityCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ImportCertificateAuthorityCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		IssueCertificate(requestBody: IssueCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<IssueCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.IssueCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListCertificateAuthorities(MaxResults: string, NextToken: string, requestBody: ListCertificateAuthoritiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCertificateAuthoritiesResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ListCertificateAuthorities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPermissions(MaxResults: string, NextToken: string, requestBody: ListPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPermissionsResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ListPermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RestoreCertificateAuthority(requestBody: RestoreCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.RestoreCertificateAuthority', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		RevokeCertificate(requestBody: RevokeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.RevokeCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		TagCertificateAuthority(requestBody: TagCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.TagCertificateAuthority', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UntagCertificateAuthority(requestBody: UntagCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.UntagCertificateAuthority', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificateAuthority(requestBody: UpdateCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=ACMPrivateCA.UpdateCertificateAuthority', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
