...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateCertificateAuthority(callback: (data : CreateCertificateAuthorityResponse) => any, requestBody: CreateCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateCertificateAuthorityAuditReport(callback: (data : CreateCertificateAuthorityAuditReportResponse) => any, requestBody: CreateCertificateAuthorityAuditReportRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthorityAuditReport', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		CreatePermission(callback: (data : void) => any, requestBody: CreatePermissionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.CreatePermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificateAuthority(callback: (data : void) => any, requestBody: DeleteCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DeleteCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeletePermission(callback: (data : void) => any, requestBody: DeletePermissionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DeletePermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCertificateAuthority(callback: (data : DescribeCertificateAuthorityResponse) => any, requestBody: DescribeCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCertificateAuthorityAuditReport(callback: (data : DescribeCertificateAuthorityAuditReportResponse) => any, requestBody: DescribeCertificateAuthorityAuditReportRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthorityAuditReport', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCertificate(callback: (data : GetCertificateResponse) => any, requestBody: GetCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCertificateAuthorityCertificate(callback: (data : GetCertificateAuthorityCertificateResponse) => any, requestBody: GetCertificateAuthorityCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCertificateAuthorityCsr(callback: (data : GetCertificateAuthorityCsrResponse) => any, requestBody: GetCertificateAuthorityCsrRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCsr', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ImportCertificateAuthorityCertificate(callback: (data : void) => any, requestBody: ImportCertificateAuthorityCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ImportCertificateAuthorityCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		IssueCertificate(callback: (data : IssueCertificateResponse) => any, requestBody: IssueCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.IssueCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCertificateAuthorities(MaxResults: string, NextToken: string, callback: (data : ListCertificateAuthoritiesResponse) => any, requestBody: ListCertificateAuthoritiesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ListCertificateAuthorities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPermissions(MaxResults: string, NextToken: string, callback: (data : ListPermissionsResponse) => any, requestBody: ListPermissionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ListPermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListTags(MaxResults: string, NextToken: string, callback: (data : ListTagsResponse) => any, requestBody: ListTagsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.ListTags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RestoreCertificateAuthority(callback: (data : void) => any, requestBody: RestoreCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.RestoreCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RevokeCertificate(callback: (data : void) => any, requestBody: RevokeCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.RevokeCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		TagCertificateAuthority(callback: (data : void) => any, requestBody: TagCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.TagCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UntagCertificateAuthority(callback: (data : void) => any, requestBody: UntagCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.UntagCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificateAuthority(callback: (data : void) => any, requestBody: UpdateCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=ACMPrivateCA.UpdateCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
