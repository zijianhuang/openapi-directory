...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCertificateAuthority(requestBody: CreateCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCertificateAuthorityResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateCertificateAuthorityAuditReport(requestBody: CreateCertificateAuthorityAuditReportRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCertificateAuthorityAuditReportResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthorityAuditReport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePermission(requestBody: CreatePermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.CreatePermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteCertificateAuthority(requestBody: DeleteCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.DeleteCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeletePermission(requestBody: DeletePermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.DeletePermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeCertificateAuthority(requestBody: DescribeCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateAuthorityResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCertificateAuthorityAuditReport(requestBody: DescribeCertificateAuthorityAuditReportRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateAuthorityAuditReportResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthorityAuditReport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCertificate(requestBody: GetCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.GetCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCertificateAuthorityCertificate(requestBody: GetCertificateAuthorityCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateAuthorityCertificateResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCertificateAuthorityCsr(requestBody: GetCertificateAuthorityCsrRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateAuthorityCsrResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCsr', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ImportCertificateAuthorityCertificate(requestBody: ImportCertificateAuthorityCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.ImportCertificateAuthorityCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		IssueCertificate(requestBody: IssueCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<IssueCertificateResponse> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.IssueCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RestoreCertificateAuthority(requestBody: RestoreCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.RestoreCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RevokeCertificate(requestBody: RevokeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.RevokeCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		TagCertificateAuthority(requestBody: TagCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.TagCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UntagCertificateAuthority(requestBody: UntagCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.UntagCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateCertificateAuthority(requestBody: UpdateCertificateAuthorityRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=ACMPrivateCA.UpdateCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
