...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateDeliveryStream(requestBody: CreateDeliveryStreamInput, headersHandler?: () => HttpHeaders): Observable<CreateDeliveryStreamOutput> {
			return this.http.post<CreateDeliveryStreamOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.CreateDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDeliveryStream(requestBody: DeleteDeliveryStreamInput, headersHandler?: () => HttpHeaders): Observable<DeleteDeliveryStreamOutput> {
			return this.http.post<DeleteDeliveryStreamOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.DeleteDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDeliveryStream(requestBody: DescribeDeliveryStreamInput, headersHandler?: () => HttpHeaders): Observable<DescribeDeliveryStreamOutput> {
			return this.http.post<DescribeDeliveryStreamOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.DescribeDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDeliveryStreams(requestBody: ListDeliveryStreamsInput, headersHandler?: () => HttpHeaders): Observable<ListDeliveryStreamsOutput> {
			return this.http.post<ListDeliveryStreamsOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.ListDeliveryStreams', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForDeliveryStream(requestBody: ListTagsForDeliveryStreamInput, headersHandler?: () => HttpHeaders): Observable<ListTagsForDeliveryStreamOutput> {
			return this.http.post<ListTagsForDeliveryStreamOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.ListTagsForDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		PutRecord(requestBody: PutRecordInput, headersHandler?: () => HttpHeaders): Observable<PutRecordOutput> {
			return this.http.post<PutRecordOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.PutRecord', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutRecordBatch(requestBody: PutRecordBatchInput, headersHandler?: () => HttpHeaders): Observable<PutRecordBatchOutput> {
			return this.http.post<PutRecordBatchOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.PutRecordBatch', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartDeliveryStreamEncryption(requestBody: StartDeliveryStreamEncryptionInput, headersHandler?: () => HttpHeaders): Observable<StartDeliveryStreamEncryptionOutput> {
			return this.http.post<StartDeliveryStreamEncryptionOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.StartDeliveryStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopDeliveryStreamEncryption(requestBody: StopDeliveryStreamEncryptionInput, headersHandler?: () => HttpHeaders): Observable<StopDeliveryStreamEncryptionOutput> {
			return this.http.post<StopDeliveryStreamEncryptionOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.StopDeliveryStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TagDeliveryStream(requestBody: TagDeliveryStreamInput, headersHandler?: () => HttpHeaders): Observable<TagDeliveryStreamOutput> {
			return this.http.post<TagDeliveryStreamOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.TagDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UntagDeliveryStream(requestBody: UntagDeliveryStreamInput, headersHandler?: () => HttpHeaders): Observable<UntagDeliveryStreamOutput> {
			return this.http.post<UntagDeliveryStreamOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.UntagDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDestination(requestBody: UpdateDestinationInput, headersHandler?: () => HttpHeaders): Observable<UpdateDestinationOutput> {
			return this.http.post<UpdateDestinationOutput>(this.baseUri + '/#X-Amz-Target=Firehose_20150804.UpdateDestination', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
