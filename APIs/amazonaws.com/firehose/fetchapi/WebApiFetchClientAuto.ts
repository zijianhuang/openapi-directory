export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateDeliveryStream(requestBody: CreateDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeliveryStreamOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.CreateDeliveryStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDeliveryStream(requestBody: DeleteDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteDeliveryStreamOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.DeleteDeliveryStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDeliveryStream(requestBody: DescribeDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeliveryStreamOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.DescribeDeliveryStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDeliveryStreams(requestBody: ListDeliveryStreamsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeliveryStreamsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.ListDeliveryStreams', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForDeliveryStream(requestBody: ListTagsForDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForDeliveryStreamOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.ListTagsForDeliveryStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutRecord(requestBody: PutRecordInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.PutRecord', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutRecordBatch(requestBody: PutRecordBatchInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordBatchOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.PutRecordBatch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartDeliveryStreamEncryption(requestBody: StartDeliveryStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<StartDeliveryStreamEncryptionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.StartDeliveryStreamEncryption', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopDeliveryStreamEncryption(requestBody: StopDeliveryStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<StopDeliveryStreamEncryptionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.StopDeliveryStreamEncryption', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagDeliveryStream(requestBody: TagDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<TagDeliveryStreamOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.TagDeliveryStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagDeliveryStream(requestBody: UntagDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<UntagDeliveryStreamOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.UntagDeliveryStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDestination(requestBody: UpdateDestinationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateDestinationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Firehose_20150804.UpdateDestination', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
