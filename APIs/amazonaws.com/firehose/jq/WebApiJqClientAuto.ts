...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateDeliveryStream(callback: (data : CreateDeliveryStreamOutput) => any, requestBody: CreateDeliveryStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.CreateDeliveryStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDeliveryStream(callback: (data : DeleteDeliveryStreamOutput) => any, requestBody: DeleteDeliveryStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.DeleteDeliveryStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDeliveryStream(callback: (data : DescribeDeliveryStreamOutput) => any, requestBody: DescribeDeliveryStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.DescribeDeliveryStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDeliveryStreams(callback: (data : ListDeliveryStreamsOutput) => any, requestBody: ListDeliveryStreamsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.ListDeliveryStreams', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForDeliveryStream(callback: (data : ListTagsForDeliveryStreamOutput) => any, requestBody: ListTagsForDeliveryStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.ListTagsForDeliveryStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		PutRecord(callback: (data : PutRecordOutput) => any, requestBody: PutRecordInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.PutRecord', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutRecordBatch(callback: (data : PutRecordBatchOutput) => any, requestBody: PutRecordBatchInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.PutRecordBatch', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartDeliveryStreamEncryption(callback: (data : StartDeliveryStreamEncryptionOutput) => any, requestBody: StartDeliveryStreamEncryptionInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.StartDeliveryStreamEncryption', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopDeliveryStreamEncryption(callback: (data : StopDeliveryStreamEncryptionOutput) => any, requestBody: StopDeliveryStreamEncryptionInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.StopDeliveryStreamEncryption', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TagDeliveryStream(callback: (data : TagDeliveryStreamOutput) => any, requestBody: TagDeliveryStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.TagDeliveryStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UntagDeliveryStream(callback: (data : UntagDeliveryStreamOutput) => any, requestBody: UntagDeliveryStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.UntagDeliveryStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDestination(callback: (data : UpdateDestinationOutput) => any, requestBody: UpdateDestinationInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Firehose_20150804.UpdateDestination', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
