...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateDeliveryStream(requestBody: CreateDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeliveryStreamOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.CreateDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDeliveryStream(requestBody: DeleteDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteDeliveryStreamOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.DeleteDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDeliveryStream(requestBody: DescribeDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeliveryStreamOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.DescribeDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDeliveryStreams(requestBody: ListDeliveryStreamsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeliveryStreamsOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.ListDeliveryStreams', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForDeliveryStream(requestBody: ListTagsForDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForDeliveryStreamOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.ListTagsForDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutRecord(requestBody: PutRecordInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.PutRecord', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutRecordBatch(requestBody: PutRecordBatchInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordBatchOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.PutRecordBatch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartDeliveryStreamEncryption(requestBody: StartDeliveryStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<StartDeliveryStreamEncryptionOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.StartDeliveryStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopDeliveryStreamEncryption(requestBody: StopDeliveryStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<StopDeliveryStreamEncryptionOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.StopDeliveryStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagDeliveryStream(requestBody: TagDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<TagDeliveryStreamOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.TagDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagDeliveryStream(requestBody: UntagDeliveryStreamInput, headersHandler?: () => {[header: string]: string}): Promise<UntagDeliveryStreamOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.UntagDeliveryStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDestination(requestBody: UpdateDestinationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateDestinationOutput> {
			return this.http.post('/#X-Amz-Target=Firehose_20150804.UpdateDestination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
