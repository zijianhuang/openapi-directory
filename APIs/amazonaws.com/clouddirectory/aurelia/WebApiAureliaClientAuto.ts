...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddFacetToObject(requestBody: AddFacetToObjectBody, headersHandler?: () => {[header: string]: string}): Promise<AddFacetToObjectResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/object/facets#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ApplySchema(requestBody: ApplySchemaBody, headersHandler?: () => {[header: string]: string}): Promise<ApplySchemaResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema/apply#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		AttachObject(requestBody: AttachObjectBody, headersHandler?: () => {[header: string]: string}): Promise<AttachObjectResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/object/attach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		AttachPolicy(requestBody: AttachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<AttachPolicyResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/policy/attach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		AttachToIndex(requestBody: AttachToIndexBody, headersHandler?: () => {[header: string]: string}): Promise<AttachToIndexResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/index/attach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		AttachTypedLink(requestBody: AttachTypedLinkBody, headersHandler?: () => {[header: string]: string}): Promise<AttachTypedLinkResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/typedlink/attach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		BatchRead(requestBody: BatchReadBody, headersHandler?: () => {[header: string]: string}): Promise<BatchReadResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/batchread#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		BatchWrite(requestBody: BatchWriteBody, headersHandler?: () => {[header: string]: string}): Promise<BatchWriteResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/batchwrite#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateDirectory(requestBody: CreateDirectoryBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectoryResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/directory/create#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateFacet(requestBody: CreateFacetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFacetResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/facet/create#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateIndex(requestBody: CreateIndexBody, headersHandler?: () => {[header: string]: string}): Promise<CreateIndexResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/index#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateObject(requestBody: CreateObjectBody, headersHandler?: () => {[header: string]: string}): Promise<CreateObjectResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/object#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateSchema(requestBody: CreateSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSchemaResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema/create', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateTypedLinkFacet(requestBody: CreateTypedLinkFacetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateTypedLinkFacetResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/typedlink/facet/create#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteDirectory(headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectoryResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/directory#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		DeleteFacet(requestBody: DeleteFacetBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteFacetResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/facet/delete#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteObject(requestBody: DeleteObjectBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteObjectResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/object/delete#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteSchema(headersHandler?: () => {[header: string]: string}): Promise<DeleteSchemaResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		DeleteTypedLinkFacet(requestBody: DeleteTypedLinkFacetBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteTypedLinkFacetResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/typedlink/facet/delete#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DetachFromIndex(requestBody: DetachFromIndexBody, headersHandler?: () => {[header: string]: string}): Promise<DetachFromIndexResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/index/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DetachObject(requestBody: DetachObjectBody, headersHandler?: () => {[header: string]: string}): Promise<DetachObjectResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/object/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DetachPolicy(requestBody: DetachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<DetachPolicyResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/policy/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DetachTypedLink(requestBody: DetachTypedLinkBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/amazonclouddirectory/2017-01-11/typedlink/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 */
		DisableDirectory(headersHandler?: () => {[header: string]: string}): Promise<DisableDirectoryResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/directory/disable#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		EnableDirectory(headersHandler?: () => {[header: string]: string}): Promise<EnableDirectoryResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/directory/enable#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		GetAppliedSchemaVersion(requestBody: GetAppliedSchemaVersionBody, headersHandler?: () => {[header: string]: string}): Promise<GetAppliedSchemaVersionResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/schema/getappliedschema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetDirectory(headersHandler?: () => {[header: string]: string}): Promise<GetDirectoryResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/directory/get#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		GetFacet(requestBody: GetFacetBody, headersHandler?: () => {[header: string]: string}): Promise<GetFacetResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/facet#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateFacet(requestBody: UpdateFacetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFacetResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/facet#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetLinkAttributes(requestBody: GetLinkAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<GetLinkAttributesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/typedlink/attributes/get#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetObjectAttributes(requestBody: GetObjectAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<GetObjectAttributesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/attributes/get#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetObjectInformation(requestBody: GetObjectInformationBody, headersHandler?: () => {[header: string]: string}): Promise<GetObjectInformationResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/information#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetSchemaAsJson(headersHandler?: () => {[header: string]: string}): Promise<GetSchemaAsJsonResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/schema/json#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		PutSchemaFromJson(requestBody: PutSchemaFromJsonBody, headersHandler?: () => {[header: string]: string}): Promise<PutSchemaFromJsonResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema/json#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetTypedLinkFacetInformation(requestBody: GetTypedLinkFacetInformationBody, headersHandler?: () => {[header: string]: string}): Promise<GetTypedLinkFacetInformationResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/typedlink/facet/get#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListAttachedIndices(MaxResults: string, NextToken: string, requestBody: ListAttachedIndicesBody, headersHandler?: () => {[header: string]: string}): Promise<ListAttachedIndicesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/indices#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListDevelopmentSchemaArns(MaxResults: string, NextToken: string, requestBody: ListDevelopmentSchemaArnsBody, headersHandler?: () => {[header: string]: string}): Promise<ListDevelopmentSchemaArnsResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/schema/development?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListDirectories(MaxResults: string, NextToken: string, requestBody: ListDirectoriesBody, headersHandler?: () => {[header: string]: string}): Promise<ListDirectoriesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/directory/list?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListFacetAttributes(MaxResults: string, NextToken: string, requestBody: ListFacetAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<ListFacetAttributesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/facet/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListFacetNames(MaxResults: string, NextToken: string, requestBody: ListFacetNamesBody, headersHandler?: () => {[header: string]: string}): Promise<ListFacetNamesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/facet/list#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListIncomingTypedLinks(requestBody: ListIncomingTypedLinksBody, headersHandler?: () => {[header: string]: string}): Promise<ListIncomingTypedLinksResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/typedlink/incoming#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListIndex(MaxResults: string, NextToken: string, requestBody: ListIndexBody, headersHandler?: () => {[header: string]: string}): Promise<ListIndexResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/index/targets#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListManagedSchemaArns(MaxResults: string, NextToken: string, requestBody: ListManagedSchemaArnsBody, headersHandler?: () => {[header: string]: string}): Promise<ListManagedSchemaArnsResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/schema/managed?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListObjectAttributes(MaxResults: string, NextToken: string, requestBody: ListObjectAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectAttributesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListObjectChildren(MaxResults: string, NextToken: string, requestBody: ListObjectChildrenBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectChildrenResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/children#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListObjectParentPaths(MaxResults: string, NextToken: string, requestBody: ListObjectParentPathsBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectParentPathsResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/parentpaths#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListObjectParents(MaxResults: string, NextToken: string, requestBody: ListObjectParentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectParentsResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/parent#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListObjectPolicies(MaxResults: string, NextToken: string, requestBody: ListObjectPoliciesBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectPoliciesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/object/policy#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListOutgoingTypedLinks(requestBody: ListOutgoingTypedLinksBody, headersHandler?: () => {[header: string]: string}): Promise<ListOutgoingTypedLinksResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/typedlink/outgoing#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListPolicyAttachments(MaxResults: string, NextToken: string, requestBody: ListPolicyAttachmentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListPolicyAttachmentsResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/policy/attachment#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListPublishedSchemaArns(MaxResults: string, NextToken: string, requestBody: ListPublishedSchemaArnsBody, headersHandler?: () => {[header: string]: string}): Promise<ListPublishedSchemaArnsResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/schema/published?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListTagsForResource(MaxResults: string, NextToken: string, requestBody: ListTagsForResourceBody, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/tags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListTypedLinkFacetAttributes(MaxResults: string, NextToken: string, requestBody: ListTypedLinkFacetAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<ListTypedLinkFacetAttributesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/typedlink/facet/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListTypedLinkFacetNames(MaxResults: string, NextToken: string, requestBody: ListTypedLinkFacetNamesBody, headersHandler?: () => {[header: string]: string}): Promise<ListTypedLinkFacetNamesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/typedlink/facet/list#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		LookupPolicy(MaxResults: string, NextToken: string, requestBody: LookupPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<LookupPolicyResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/policy/lookup#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		PublishSchema(requestBody: PublishSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<PublishSchemaResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema/publish#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RemoveFacetFromObject(requestBody: RemoveFacetFromObjectBody, headersHandler?: () => {[header: string]: string}): Promise<RemoveFacetFromObjectResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/object/facets/delete#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/tags/add', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/tags/remove', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateLinkAttributes(requestBody: UpdateLinkAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateLinkAttributesResponse> {
			return this.http.post('/amazonclouddirectory/2017-01-11/typedlink/attributes/update#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateObjectAttributes(requestBody: UpdateObjectAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateObjectAttributesResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/object/update#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateSchema(requestBody: UpdateSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSchemaResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema/update#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateTypedLinkFacet(requestBody: UpdateTypedLinkFacetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateTypedLinkFacetResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/typedlink/facet#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpgradeAppliedSchema(requestBody: UpgradeAppliedSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<UpgradeAppliedSchemaResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema/upgradeapplied', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpgradePublishedSchema(requestBody: UpgradePublishedSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<UpgradePublishedSchemaResponse> {
			return this.http.put('/amazonclouddirectory/2017-01-11/schema/upgradepublished', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
