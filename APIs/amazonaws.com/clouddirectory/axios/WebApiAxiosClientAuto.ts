...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ApplySchema(requestBody: ApplySchemaBody, headersHandler?: () => {[header: string]: string}): Promise<ApplySchemaResponse> {
			return Axios.put<ApplySchemaResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/apply#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AttachObject(requestBody: AttachObjectBody, headersHandler?: () => {[header: string]: string}): Promise<AttachObjectResponse> {
			return Axios.put<AttachObjectResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/attach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AttachPolicy(requestBody: AttachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<AttachPolicyResponse> {
			return Axios.put<AttachPolicyResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/attach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AttachToIndex(requestBody: AttachToIndexBody, headersHandler?: () => {[header: string]: string}): Promise<AttachToIndexResponse> {
			return Axios.put<AttachToIndexResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/index/attach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchRead(requestBody: BatchReadBody, headersHandler?: () => {[header: string]: string}): Promise<BatchReadResponse> {
			return Axios.post<BatchReadResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/batchread#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchWrite(requestBody: BatchWriteBody, headersHandler?: () => {[header: string]: string}): Promise<BatchWriteResponse> {
			return Axios.put<BatchWriteResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/batchwrite#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateFacet(requestBody: CreateFacetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFacetResponse> {
			return Axios.put<CreateFacetResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/create#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateIndex(requestBody: CreateIndexBody, headersHandler?: () => {[header: string]: string}): Promise<CreateIndexResponse> {
			return Axios.put<CreateIndexResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/index#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateObject(requestBody: CreateObjectBody, headersHandler?: () => {[header: string]: string}): Promise<CreateObjectResponse> {
			return Axios.put<CreateObjectResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSchema(requestBody: CreateSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSchemaResponse> {
			return Axios.put<CreateSchemaResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/create', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDirectory(headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectoryResponse> {
			return Axios.put<DeleteDirectoryResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/directory#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteFacet(requestBody: DeleteFacetBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteFacetResponse> {
			return Axios.put<DeleteFacetResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/delete#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteObject(requestBody: DeleteObjectBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteObjectResponse> {
			return Axios.put<DeleteObjectResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/delete#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSchema(headersHandler?: () => {[header: string]: string}): Promise<DeleteSchemaResponse> {
			return Axios.put<DeleteSchemaResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DetachFromIndex(requestBody: DetachFromIndexBody, headersHandler?: () => {[header: string]: string}): Promise<DetachFromIndexResponse> {
			return Axios.put<DetachFromIndexResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/index/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetachObject(requestBody: DetachObjectBody, headersHandler?: () => {[header: string]: string}): Promise<DetachObjectResponse> {
			return Axios.put<DetachObjectResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetachPolicy(requestBody: DetachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<DetachPolicyResponse> {
			return Axios.put<DetachPolicyResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DetachTypedLink(requestBody: DetachTypedLinkBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/detach#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DisableDirectory(headersHandler?: () => {[header: string]: string}): Promise<DisableDirectoryResponse> {
			return Axios.put<DisableDirectoryResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/disable#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		EnableDirectory(headersHandler?: () => {[header: string]: string}): Promise<EnableDirectoryResponse> {
			return Axios.put<EnableDirectoryResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/enable#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetAppliedSchemaVersion(requestBody: GetAppliedSchemaVersionBody, headersHandler?: () => {[header: string]: string}): Promise<GetAppliedSchemaVersionResponse> {
			return Axios.post<GetAppliedSchemaVersionResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/getappliedschema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDirectory(headersHandler?: () => {[header: string]: string}): Promise<GetDirectoryResponse> {
			return Axios.post<GetDirectoryResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/get#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetFacet(requestBody: GetFacetBody, headersHandler?: () => {[header: string]: string}): Promise<GetFacetResponse> {
			return Axios.post<GetFacetResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/facet#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateFacet(requestBody: UpdateFacetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFacetResponse> {
			return Axios.put<UpdateFacetResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/facet#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSchemaAsJson(headersHandler?: () => {[header: string]: string}): Promise<GetSchemaAsJsonResponse> {
			return Axios.post<GetSchemaAsJsonResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/json#x-amz-data-partition', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutSchemaFromJson(requestBody: PutSchemaFromJsonBody, headersHandler?: () => {[header: string]: string}): Promise<PutSchemaFromJsonResponse> {
			return Axios.put<PutSchemaFromJsonResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/json#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAttachedIndices(MaxResults: string, NextToken: string, requestBody: ListAttachedIndicesBody, headersHandler?: () => {[header: string]: string}): Promise<ListAttachedIndicesResponse> {
			return Axios.post<ListAttachedIndicesResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/indices#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDevelopmentSchemaArns(MaxResults: string, NextToken: string, requestBody: ListDevelopmentSchemaArnsBody, headersHandler?: () => {[header: string]: string}): Promise<ListDevelopmentSchemaArnsResponse> {
			return Axios.post<ListDevelopmentSchemaArnsResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/development?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListFacetAttributes(MaxResults: string, NextToken: string, requestBody: ListFacetAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<ListFacetAttributesResponse> {
			return Axios.post<ListFacetAttributesResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListFacetNames(MaxResults: string, NextToken: string, requestBody: ListFacetNamesBody, headersHandler?: () => {[header: string]: string}): Promise<ListFacetNamesResponse> {
			return Axios.post<ListFacetNamesResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/list#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListManagedSchemaArns(MaxResults: string, NextToken: string, requestBody: ListManagedSchemaArnsBody, headersHandler?: () => {[header: string]: string}): Promise<ListManagedSchemaArnsResponse> {
			return Axios.post<ListManagedSchemaArnsResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/managed?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListObjectAttributes(MaxResults: string, NextToken: string, requestBody: ListObjectAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectAttributesResponse> {
			return Axios.post<ListObjectAttributesResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListObjectChildren(MaxResults: string, NextToken: string, requestBody: ListObjectChildrenBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectChildrenResponse> {
			return Axios.post<ListObjectChildrenResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/children#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListObjectParentPaths(MaxResults: string, NextToken: string, requestBody: ListObjectParentPathsBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectParentPathsResponse> {
			return Axios.post<ListObjectParentPathsResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/parentpaths#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListObjectParents(MaxResults: string, NextToken: string, requestBody: ListObjectParentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectParentsResponse> {
			return Axios.post<ListObjectParentsResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/parent#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListObjectPolicies(MaxResults: string, NextToken: string, requestBody: ListObjectPoliciesBody, headersHandler?: () => {[header: string]: string}): Promise<ListObjectPoliciesResponse> {
			return Axios.post<ListObjectPoliciesResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/object/policy#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListPolicyAttachments(MaxResults: string, NextToken: string, requestBody: ListPolicyAttachmentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListPolicyAttachmentsResponse> {
			return Axios.post<ListPolicyAttachmentsResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/attachment#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(MaxResults: string, NextToken: string, requestBody: ListTagsForResourceBody, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/tags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTypedLinkFacetAttributes(MaxResults: string, NextToken: string, requestBody: ListTypedLinkFacetAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<ListTypedLinkFacetAttributesResponse> {
			return Axios.post<ListTypedLinkFacetAttributesResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTypedLinkFacetNames(MaxResults: string, NextToken: string, requestBody: ListTypedLinkFacetNamesBody, headersHandler?: () => {[header: string]: string}): Promise<ListTypedLinkFacetNamesResponse> {
			return Axios.post<ListTypedLinkFacetNamesResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet/list#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		LookupPolicy(MaxResults: string, NextToken: string, requestBody: LookupPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<LookupPolicyResponse> {
			return Axios.post<LookupPolicyResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/lookup#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PublishSchema(requestBody: PublishSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<PublishSchemaResponse> {
			return Axios.put<PublishSchemaResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/publish#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.put<TagResourceResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/tags/add', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.put<UntagResourceResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/tags/remove', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateSchema(requestBody: UpdateSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSchemaResponse> {
			return Axios.put<UpdateSchemaResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/update#x-amz-data-partition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpgradeAppliedSchema(requestBody: UpgradeAppliedSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<UpgradeAppliedSchemaResponse> {
			return Axios.put<UpgradeAppliedSchemaResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/upgradeapplied', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpgradePublishedSchema(requestBody: UpgradePublishedSchemaBody, headersHandler?: () => {[header: string]: string}): Promise<UpgradePublishedSchemaResponse> {
			return Axios.put<UpgradePublishedSchemaResponse>(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/upgradepublished', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
