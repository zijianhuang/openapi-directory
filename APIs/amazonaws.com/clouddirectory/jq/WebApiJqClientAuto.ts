...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddFacetToObject(callback: (data : AddFacetToObjectResponse) => any, requestBody: AddFacetToObjectBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/object/facets#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ApplySchema(callback: (data : ApplySchemaResponse) => any, requestBody: ApplySchemaBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/apply#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AttachObject(callback: (data : AttachObjectResponse) => any, requestBody: AttachObjectBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/object/attach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AttachPolicy(callback: (data : AttachPolicyResponse) => any, requestBody: AttachPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/attach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AttachToIndex(callback: (data : AttachToIndexResponse) => any, requestBody: AttachToIndexBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/index/attach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AttachTypedLink(callback: (data : AttachTypedLinkResponse) => any, requestBody: AttachTypedLinkBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/attach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		BatchRead(callback: (data : BatchReadResponse) => any, requestBody: BatchReadBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/batchread#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		BatchWrite(callback: (data : BatchWriteResponse) => any, requestBody: BatchWriteBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/batchwrite#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateDirectory(callback: (data : CreateDirectoryResponse) => any, requestBody: CreateDirectoryBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/create#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateFacet(callback: (data : CreateFacetResponse) => any, requestBody: CreateFacetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/create#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateIndex(callback: (data : CreateIndexResponse) => any, requestBody: CreateIndexBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/index#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateObject(callback: (data : CreateObjectResponse) => any, requestBody: CreateObjectBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/object#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSchema(callback: (data : CreateSchemaResponse) => any, requestBody: CreateSchemaBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/create', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTypedLinkFacet(callback: (data : CreateTypedLinkFacetResponse) => any, requestBody: CreateTypedLinkFacetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet/create#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDirectory(callback: (data : DeleteDirectoryResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/directory#x-amz-data-partition', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteFacet(callback: (data : DeleteFacetResponse) => any, requestBody: DeleteFacetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/delete#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteObject(callback: (data : DeleteObjectResponse) => any, requestBody: DeleteObjectBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/object/delete#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSchema(callback: (data : DeleteSchemaResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema#x-amz-data-partition', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTypedLinkFacet(callback: (data : DeleteTypedLinkFacetResponse) => any, requestBody: DeleteTypedLinkFacetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet/delete#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetachFromIndex(callback: (data : DetachFromIndexResponse) => any, requestBody: DetachFromIndexBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/index/detach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetachObject(callback: (data : DetachObjectResponse) => any, requestBody: DetachObjectBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/object/detach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetachPolicy(callback: (data : DetachPolicyResponse) => any, requestBody: DetachPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/detach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DetachTypedLink(callback: (data : void) => any, requestBody: DetachTypedLinkBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/detach#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisableDirectory(callback: (data : DisableDirectoryResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/disable#x-amz-data-partition', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		EnableDirectory(callback: (data : EnableDirectoryResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/enable#x-amz-data-partition', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetAppliedSchemaVersion(callback: (data : GetAppliedSchemaVersionResponse) => any, requestBody: GetAppliedSchemaVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/getappliedschema', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDirectory(callback: (data : GetDirectoryResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/get#x-amz-data-partition', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetFacet(callback: (data : GetFacetResponse) => any, requestBody: GetFacetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/facet#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateFacet(callback: (data : UpdateFacetResponse) => any, requestBody: UpdateFacetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/facet#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetLinkAttributes(callback: (data : GetLinkAttributesResponse) => any, requestBody: GetLinkAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/attributes/get#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetObjectAttributes(callback: (data : GetObjectAttributesResponse) => any, requestBody: GetObjectAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/attributes/get#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetObjectInformation(callback: (data : GetObjectInformationResponse) => any, requestBody: GetObjectInformationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/information#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSchemaAsJson(callback: (data : GetSchemaAsJsonResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/json#x-amz-data-partition', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutSchemaFromJson(callback: (data : PutSchemaFromJsonResponse) => any, requestBody: PutSchemaFromJsonBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/json#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetTypedLinkFacetInformation(callback: (data : GetTypedLinkFacetInformationResponse) => any, requestBody: GetTypedLinkFacetInformationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet/get#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAppliedSchemaArns(MaxResults: string, NextToken: string, callback: (data : ListAppliedSchemaArnsResponse) => any, requestBody: ListAppliedSchemaArnsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/applied?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAttachedIndices(MaxResults: string, NextToken: string, callback: (data : ListAttachedIndicesResponse) => any, requestBody: ListAttachedIndicesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/indices#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDevelopmentSchemaArns(MaxResults: string, NextToken: string, callback: (data : ListDevelopmentSchemaArnsResponse) => any, requestBody: ListDevelopmentSchemaArnsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/development?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDirectories(MaxResults: string, NextToken: string, callback: (data : ListDirectoriesResponse) => any, requestBody: ListDirectoriesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/directory/list?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFacetAttributes(MaxResults: string, NextToken: string, callback: (data : ListFacetAttributesResponse) => any, requestBody: ListFacetAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFacetNames(MaxResults: string, NextToken: string, callback: (data : ListFacetNamesResponse) => any, requestBody: ListFacetNamesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/facet/list#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListIncomingTypedLinks(callback: (data : ListIncomingTypedLinksResponse) => any, requestBody: ListIncomingTypedLinksBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/incoming#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListIndex(MaxResults: string, NextToken: string, callback: (data : ListIndexResponse) => any, requestBody: ListIndexBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/index/targets#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListManagedSchemaArns(MaxResults: string, NextToken: string, callback: (data : ListManagedSchemaArnsResponse) => any, requestBody: ListManagedSchemaArnsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/managed?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListObjectAttributes(MaxResults: string, NextToken: string, callback: (data : ListObjectAttributesResponse) => any, requestBody: ListObjectAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListObjectChildren(MaxResults: string, NextToken: string, callback: (data : ListObjectChildrenResponse) => any, requestBody: ListObjectChildrenBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/children#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListObjectParentPaths(MaxResults: string, NextToken: string, callback: (data : ListObjectParentPathsResponse) => any, requestBody: ListObjectParentPathsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/parentpaths#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListObjectParents(MaxResults: string, NextToken: string, callback: (data : ListObjectParentsResponse) => any, requestBody: ListObjectParentsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/parent#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListObjectPolicies(MaxResults: string, NextToken: string, callback: (data : ListObjectPoliciesResponse) => any, requestBody: ListObjectPoliciesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/object/policy#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListOutgoingTypedLinks(callback: (data : ListOutgoingTypedLinksResponse) => any, requestBody: ListOutgoingTypedLinksBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/outgoing#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPolicyAttachments(MaxResults: string, NextToken: string, callback: (data : ListPolicyAttachmentsResponse) => any, requestBody: ListPolicyAttachmentsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/attachment#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPublishedSchemaArns(MaxResults: string, NextToken: string, callback: (data : ListPublishedSchemaArnsResponse) => any, requestBody: ListPublishedSchemaArnsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/published?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForResource(MaxResults: string, NextToken: string, callback: (data : ListTagsForResourceResponse) => any, requestBody: ListTagsForResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/tags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTypedLinkFacetAttributes(MaxResults: string, NextToken: string, callback: (data : ListTypedLinkFacetAttributesResponse) => any, requestBody: ListTypedLinkFacetAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet/attributes#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTypedLinkFacetNames(MaxResults: string, NextToken: string, callback: (data : ListTypedLinkFacetNamesResponse) => any, requestBody: ListTypedLinkFacetNamesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet/list#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		LookupPolicy(MaxResults: string, NextToken: string, callback: (data : LookupPolicyResponse) => any, requestBody: LookupPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/policy/lookup#x-amz-data-partition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PublishSchema(callback: (data : PublishSchemaResponse) => any, requestBody: PublishSchemaBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/publish#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RemoveFacetFromObject(callback: (data : RemoveFacetFromObjectResponse) => any, requestBody: RemoveFacetFromObjectBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/object/facets/delete#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/tags/add', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UntagResource(callback: (data : UntagResourceResponse) => any, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/tags/remove', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateLinkAttributes(callback: (data : UpdateLinkAttributesResponse) => any, requestBody: UpdateLinkAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/attributes/update#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateObjectAttributes(callback: (data : UpdateObjectAttributesResponse) => any, requestBody: UpdateObjectAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/object/update#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSchema(callback: (data : UpdateSchemaResponse) => any, requestBody: UpdateSchemaBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/update#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateTypedLinkFacet(callback: (data : UpdateTypedLinkFacetResponse) => any, requestBody: UpdateTypedLinkFacetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/typedlink/facet#x-amz-data-partition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpgradeAppliedSchema(callback: (data : UpgradeAppliedSchemaResponse) => any, requestBody: UpgradeAppliedSchemaBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/upgradeapplied', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpgradePublishedSchema(callback: (data : UpgradePublishedSchemaResponse) => any, requestBody: UpgradePublishedSchemaBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/amazonclouddirectory/2017-01-11/schema/upgradepublished', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
