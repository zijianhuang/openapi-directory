export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GenerateDataSet(requestBody: GenerateDataSetRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataSetResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.GenerateDataSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StartSupportDataExport(requestBody: StartSupportDataExportRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSupportDataExportResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.StartSupportDataExport', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
