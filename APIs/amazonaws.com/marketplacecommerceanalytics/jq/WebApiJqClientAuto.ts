...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GenerateDataSet(callback: (data : GenerateDataSetResult) => any, requestBody: GenerateDataSetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.GenerateDataSet', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartSupportDataExport(callback: (data : StartSupportDataExportResult) => any, requestBody: StartSupportDataExportRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.StartSupportDataExport', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
