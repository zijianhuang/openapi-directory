...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GenerateDataSet(requestBody: GenerateDataSetRequest, headersHandler?: () => HttpHeaders): Observable<GenerateDataSetResult> {
			return this.http.post<GenerateDataSetResult>(this.baseUri + '/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.GenerateDataSet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartSupportDataExport(requestBody: StartSupportDataExportRequest, headersHandler?: () => HttpHeaders): Observable<StartSupportDataExportResult> {
			return this.http.post<StartSupportDataExportResult>(this.baseUri + '/#X-Amz-Target=MarketplaceCommerceAnalytics20150701.StartSupportDataExport', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
