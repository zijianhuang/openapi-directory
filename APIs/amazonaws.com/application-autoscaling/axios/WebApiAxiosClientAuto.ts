...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DeleteScalingPolicy(requestBody: DeleteScalingPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteScalingPolicyResponse> {
			return Axios.post<DeleteScalingPolicyResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteScheduledAction(requestBody: DeleteScheduledActionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteScheduledActionResponse> {
			return Axios.post<DeleteScheduledActionResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScheduledAction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeScalableTargets(MaxResults: string, NextToken: string, requestBody: DescribeScalableTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalableTargetsResponse> {
			return Axios.post<DescribeScalableTargetsResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalableTargets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeScalingActivities(MaxResults: string, NextToken: string, requestBody: DescribeScalingActivitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingActivitiesResponse> {
			return Axios.post<DescribeScalingActivitiesResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingActivities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeScalingPolicies(MaxResults: string, NextToken: string, requestBody: DescribeScalingPoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingPoliciesResponse> {
			return Axios.post<DescribeScalingPoliciesResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingPolicies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeScheduledActions(MaxResults: string, NextToken: string, requestBody: DescribeScheduledActionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScheduledActionsResponse> {
			return Axios.post<DescribeScheduledActionsResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScheduledActions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutScalingPolicy(requestBody: PutScalingPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutScalingPolicyResponse> {
			return Axios.post<PutScalingPolicyResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutScheduledAction(requestBody: PutScheduledActionRequest, headersHandler?: () => {[header: string]: string}): Promise<PutScheduledActionResponse> {
			return Axios.post<PutScheduledActionResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScheduledAction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterScalableTarget(requestBody: RegisterScalableTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterScalableTargetResponse> {
			return Axios.post<RegisterScalableTargetResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.RegisterScalableTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
