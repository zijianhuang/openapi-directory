...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DeleteScalingPolicy(callback: (data : DeleteScalingPolicyResponse) => any, requestBody: DeleteScalingPolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScalingPolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteScheduledAction(callback: (data : DeleteScheduledActionResponse) => any, requestBody: DeleteScheduledActionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScheduledAction', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeregisterScalableTarget(callback: (data : DeregisterScalableTargetResponse) => any, requestBody: DeregisterScalableTargetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeregisterScalableTarget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeScalableTargets(MaxResults: string, NextToken: string, callback: (data : DescribeScalableTargetsResponse) => any, requestBody: DescribeScalableTargetsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalableTargets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeScalingActivities(MaxResults: string, NextToken: string, callback: (data : DescribeScalingActivitiesResponse) => any, requestBody: DescribeScalingActivitiesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingActivities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeScalingPolicies(MaxResults: string, NextToken: string, callback: (data : DescribeScalingPoliciesResponse) => any, requestBody: DescribeScalingPoliciesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingPolicies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeScheduledActions(MaxResults: string, NextToken: string, callback: (data : DescribeScheduledActionsResponse) => any, requestBody: DescribeScheduledActionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScheduledActions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutScalingPolicy(callback: (data : PutScalingPolicyResponse) => any, requestBody: PutScalingPolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScalingPolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutScheduledAction(callback: (data : PutScheduledActionResponse) => any, requestBody: PutScheduledActionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScheduledAction', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterScalableTarget(callback: (data : RegisterScalableTargetResponse) => any, requestBody: RegisterScalableTargetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.RegisterScalableTarget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
