...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DeleteScalingPolicy(requestBody: DeleteScalingPolicyRequest, headersHandler?: () => HttpHeaders): Observable<DeleteScalingPolicyResponse> {
			return this.http.post<DeleteScalingPolicyResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteScheduledAction(requestBody: DeleteScheduledActionRequest, headersHandler?: () => HttpHeaders): Observable<DeleteScheduledActionResponse> {
			return this.http.post<DeleteScheduledActionResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScheduledAction', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeregisterScalableTarget(requestBody: DeregisterScalableTargetRequest, headersHandler?: () => HttpHeaders): Observable<DeregisterScalableTargetResponse> {
			return this.http.post<DeregisterScalableTargetResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeregisterScalableTarget', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeScalableTargets(MaxResults: string, NextToken: string, requestBody: DescribeScalableTargetsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeScalableTargetsResponse> {
			return this.http.post<DescribeScalableTargetsResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalableTargets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeScalingActivities(MaxResults: string, NextToken: string, requestBody: DescribeScalingActivitiesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeScalingActivitiesResponse> {
			return this.http.post<DescribeScalingActivitiesResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingActivities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeScalingPolicies(MaxResults: string, NextToken: string, requestBody: DescribeScalingPoliciesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeScalingPoliciesResponse> {
			return this.http.post<DescribeScalingPoliciesResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingPolicies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeScheduledActions(MaxResults: string, NextToken: string, requestBody: DescribeScheduledActionsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeScheduledActionsResponse> {
			return this.http.post<DescribeScheduledActionsResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScheduledActions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutScalingPolicy(requestBody: PutScalingPolicyRequest, headersHandler?: () => HttpHeaders): Observable<PutScalingPolicyResponse> {
			return this.http.post<PutScalingPolicyResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutScheduledAction(requestBody: PutScheduledActionRequest, headersHandler?: () => HttpHeaders): Observable<PutScheduledActionResponse> {
			return this.http.post<PutScheduledActionResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScheduledAction', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterScalableTarget(requestBody: RegisterScalableTargetRequest, headersHandler?: () => HttpHeaders): Observable<RegisterScalableTargetResponse> {
			return this.http.post<RegisterScalableTargetResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.RegisterScalableTarget', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
