export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DeleteScalingPolicy(requestBody: DeleteScalingPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteScalingPolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScalingPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteScheduledAction(requestBody: DeleteScheduledActionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteScheduledActionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeleteScheduledAction', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeregisterScalableTarget(requestBody: DeregisterScalableTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterScalableTargetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DeregisterScalableTarget', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeScalableTargets(MaxResults: string, NextToken: string, requestBody: DescribeScalableTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalableTargetsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalableTargets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeScalingActivities(MaxResults: string, NextToken: string, requestBody: DescribeScalingActivitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingActivitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingActivities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeScalingPolicies(MaxResults: string, NextToken: string, requestBody: DescribeScalingPoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingPoliciesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScalingPolicies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeScheduledActions(MaxResults: string, NextToken: string, requestBody: DescribeScheduledActionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScheduledActionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.DescribeScheduledActions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutScalingPolicy(requestBody: PutScalingPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutScalingPolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScalingPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutScheduledAction(requestBody: PutScheduledActionRequest, headersHandler?: () => {[header: string]: string}): Promise<PutScheduledActionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.PutScheduledAction', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterScalableTarget(requestBody: RegisterScalableTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterScalableTargetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleFrontendService.RegisterScalableTarget', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
