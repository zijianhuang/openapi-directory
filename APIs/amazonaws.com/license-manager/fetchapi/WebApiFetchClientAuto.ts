export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateLicenseConfiguration(requestBody: CreateLicenseConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLicenseConfigurationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.CreateLicenseConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteLicenseConfiguration(requestBody: DeleteLicenseConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLicenseConfigurationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.DeleteLicenseConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetLicenseConfiguration(requestBody: GetLicenseConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLicenseConfigurationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.GetLicenseConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetServiceSettings(requestBody: GetServiceSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetServiceSettingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.GetServiceSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListAssociationsForLicenseConfiguration(requestBody: ListAssociationsForLicenseConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssociationsForLicenseConfigurationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListAssociationsForLicenseConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListFailuresForLicenseConfigurationOperations(requestBody: ListFailuresForLicenseConfigurationOperationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListFailuresForLicenseConfigurationOperationsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListFailuresForLicenseConfigurationOperations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListLicenseConfigurations(requestBody: ListLicenseConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLicenseConfigurationsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListLicenseConfigurations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListLicenseSpecificationsForResource(requestBody: ListLicenseSpecificationsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLicenseSpecificationsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListLicenseSpecificationsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListResourceInventory(requestBody: ListResourceInventoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceInventoryResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListResourceInventory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListUsageForLicenseConfiguration(requestBody: ListUsageForLicenseConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUsageForLicenseConfigurationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListUsageForLicenseConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateLicenseConfiguration(requestBody: UpdateLicenseConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateLicenseConfigurationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UpdateLicenseConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateLicenseSpecificationsForResource(requestBody: UpdateLicenseSpecificationsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateLicenseSpecificationsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UpdateLicenseSpecificationsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateServiceSettings(requestBody: UpdateServiceSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServiceSettingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UpdateServiceSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
