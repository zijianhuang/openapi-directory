...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateLicenseConfiguration(requestBody: CreateLicenseConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<CreateLicenseConfigurationResponse> {
			return this.http.post<CreateLicenseConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.CreateLicenseConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteLicenseConfiguration(requestBody: DeleteLicenseConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<DeleteLicenseConfigurationResponse> {
			return this.http.post<DeleteLicenseConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.DeleteLicenseConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetLicenseConfiguration(requestBody: GetLicenseConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<GetLicenseConfigurationResponse> {
			return this.http.post<GetLicenseConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.GetLicenseConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetServiceSettings(requestBody: GetServiceSettingsRequest, headersHandler?: () => HttpHeaders): Observable<GetServiceSettingsResponse> {
			return this.http.post<GetServiceSettingsResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.GetServiceSettings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAssociationsForLicenseConfiguration(requestBody: ListAssociationsForLicenseConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<ListAssociationsForLicenseConfigurationResponse> {
			return this.http.post<ListAssociationsForLicenseConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListAssociationsForLicenseConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFailuresForLicenseConfigurationOperations(requestBody: ListFailuresForLicenseConfigurationOperationsRequest, headersHandler?: () => HttpHeaders): Observable<ListFailuresForLicenseConfigurationOperationsResponse> {
			return this.http.post<ListFailuresForLicenseConfigurationOperationsResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListFailuresForLicenseConfigurationOperations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListLicenseConfigurations(requestBody: ListLicenseConfigurationsRequest, headersHandler?: () => HttpHeaders): Observable<ListLicenseConfigurationsResponse> {
			return this.http.post<ListLicenseConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListLicenseConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListLicenseSpecificationsForResource(requestBody: ListLicenseSpecificationsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListLicenseSpecificationsForResourceResponse> {
			return this.http.post<ListLicenseSpecificationsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListLicenseSpecificationsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResourceInventory(requestBody: ListResourceInventoryRequest, headersHandler?: () => HttpHeaders): Observable<ListResourceInventoryResponse> {
			return this.http.post<ListResourceInventoryResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListResourceInventory', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListUsageForLicenseConfiguration(requestBody: ListUsageForLicenseConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<ListUsageForLicenseConfigurationResponse> {
			return this.http.post<ListUsageForLicenseConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.ListUsageForLicenseConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateLicenseConfiguration(requestBody: UpdateLicenseConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<UpdateLicenseConfigurationResponse> {
			return this.http.post<UpdateLicenseConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UpdateLicenseConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateLicenseSpecificationsForResource(requestBody: UpdateLicenseSpecificationsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<UpdateLicenseSpecificationsForResourceResponse> {
			return this.http.post<UpdateLicenseSpecificationsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UpdateLicenseSpecificationsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateServiceSettings(requestBody: UpdateServiceSettingsRequest, headersHandler?: () => HttpHeaders): Observable<UpdateServiceSettingsResponse> {
			return this.http.post<UpdateServiceSettingsResponse>(this.baseUri + '/#X-Amz-Target=AWSLicenseManager.UpdateServiceSettings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
