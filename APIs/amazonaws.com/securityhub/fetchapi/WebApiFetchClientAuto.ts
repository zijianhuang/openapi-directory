export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptInvitationResponse> {
			return fetch(this.baseUri + '/master', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchDisableStandards(requestBody: BatchDisableStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchDisableStandardsResponse> {
			return fetch(this.baseUri + '/standards/deregister', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchEnableStandards(requestBody: BatchEnableStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchEnableStandardsResponse> {
			return fetch(this.baseUri + '/standards/register', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchImportFindings(requestBody: BatchImportFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchImportFindingsResponse> {
			return fetch(this.baseUri + '/findings/import', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateActionTarget(requestBody: CreateActionTargetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateActionTargetResponse> {
			return fetch(this.baseUri + '/actionTargets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateInsight(requestBody: CreateInsightBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInsightResponse> {
			return fetch(this.baseUri + '/insights', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListMembers(OnlyAssociated: boolean, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMembersResponse> {
			return fetch(this.baseUri + '/members?OnlyAssociated=' + OnlyAssociated + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteActionTarget(ActionTargetArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteActionTargetResponse> {
			return fetch(this.baseUri + '/actionTargets/' + (ActionTargetArn == null ? '' : encodeURIComponent(ActionTargetArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteInsight(InsightArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInsightResponse> {
			return fetch(this.baseUri + '/insights/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteMembers(requestBody: DeleteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteMembersResponse> {
			return fetch(this.baseUri + '/members/delete', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeHub(HubArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeHubResponse> {
			return fetch(this.baseUri + '/accounts?HubArn=' + (HubArn == null ? '' : encodeURIComponent(HubArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableSecurityHub(headersHandler?: () => {[header: string]: string}): Promise<DisableSecurityHubResponse> {
			return fetch(this.baseUri + '/accounts', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProducts(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeProductsResponse> {
			return fetch(this.baseUri + '/products?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeStandards(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeStandardsResponse> {
			return fetch(this.baseUri + '/standards?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeStandardsControls(StandardsSubscriptionArn: string, NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeStandardsControlsResponse> {
			return fetch(this.baseUri + '/standards/controls/' + (StandardsSubscriptionArn == null ? '' : encodeURIComponent(StandardsSubscriptionArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableImportFindingsForProduct(ProductSubscriptionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DisableImportFindingsForProductResponse> {
			return fetch(this.baseUri + '/productSubscriptions/' + (ProductSubscriptionArn == null ? '' : encodeURIComponent(ProductSubscriptionArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateMembers(requestBody: DisassociateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMembersResponse> {
			return fetch(this.baseUri + '/members/disassociate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		EnableImportFindingsForProduct(requestBody: EnableImportFindingsForProductBody, headersHandler?: () => {[header: string]: string}): Promise<EnableImportFindingsForProductResponse> {
			return fetch(this.baseUri + '/productSubscriptions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEnabledProductsForImport(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListEnabledProductsForImportResponse> {
			return fetch(this.baseUri + '/productSubscriptions?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEnabledStandards(MaxResults: string, NextToken: string, requestBody: GetEnabledStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<GetEnabledStandardsResponse> {
			return fetch(this.baseUri + '/standards/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetFindings(MaxResults: string, NextToken: string, requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsResponse> {
			return fetch(this.baseUri + '/findings?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetInsightResults(InsightArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetInsightResultsResponse> {
			return fetch(this.baseUri + '/insights/results/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetInsights(MaxResults: string, NextToken: string, requestBody: GetInsightsBody, headersHandler?: () => {[header: string]: string}): Promise<GetInsightsResponse> {
			return fetch(this.baseUri + '/insights/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetMembers(requestBody: GetMembersBody, headersHandler?: () => {[header: string]: string}): Promise<GetMembersResponse> {
			return fetch(this.baseUri + '/members/get', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		InviteMembers(requestBody: InviteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<InviteMembersResponse> {
			return fetch(this.baseUri + '/members/invite', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
