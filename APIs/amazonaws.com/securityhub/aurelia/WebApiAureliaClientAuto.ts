...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptInvitationResponse> {
			return this.http.post('/master', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMasterAccount(headersHandler?: () => {[header: string]: string}): Promise<GetMasterAccountResponse> {
			return this.http.get('/master', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		BatchDisableStandards(requestBody: BatchDisableStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchDisableStandardsResponse> {
			return this.http.post('/standards/deregister', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchEnableStandards(requestBody: BatchEnableStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchEnableStandardsResponse> {
			return this.http.post('/standards/register', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchImportFindings(requestBody: BatchImportFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchImportFindingsResponse> {
			return this.http.post('/findings/import', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateActionTarget(requestBody: CreateActionTargetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateActionTargetResponse> {
			return this.http.post('/actionTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateInsight(requestBody: CreateInsightBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInsightResponse> {
			return this.http.post('/insights', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateMembers(requestBody: CreateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<CreateMembersResponse> {
			return this.http.post('/members', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListMembers(OnlyAssociated: boolean, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMembersResponse> {
			return this.http.get('/members?OnlyAssociated=' + OnlyAssociated + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeclineInvitations(requestBody: DeclineInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeclineInvitationsResponse> {
			return this.http.post('/invitations/decline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteActionTarget(ActionTargetArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteActionTargetResponse> {
			return this.http.delete('/actionTargets/' + (ActionTargetArn == null ? '' : encodeURIComponent(ActionTargetArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteInsight(InsightArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInsightResponse> {
			return this.http.delete('/insights/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteInvitations(requestBody: DeleteInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteInvitationsResponse> {
			return this.http.post('/invitations/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMembers(requestBody: DeleteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteMembersResponse> {
			return this.http.post('/members/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeActionTargets(MaxResults: string, NextToken: string, requestBody: DescribeActionTargetsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeActionTargetsResponse> {
			return this.http.post('/actionTargets/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeHub(HubArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeHubResponse> {
			return this.http.get('/accounts?HubArn=' + (HubArn == null ? '' : encodeURIComponent(HubArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableSecurityHub(headersHandler?: () => {[header: string]: string}): Promise<DisableSecurityHubResponse> {
			return this.http.delete('/accounts', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProducts(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeProductsResponse> {
			return this.http.get('/products?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeStandards(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeStandardsResponse> {
			return this.http.get('/standards?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeStandardsControls(StandardsSubscriptionArn: string, NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeStandardsControlsResponse> {
			return this.http.get('/standards/controls/' + (StandardsSubscriptionArn == null ? '' : encodeURIComponent(StandardsSubscriptionArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableImportFindingsForProduct(ProductSubscriptionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DisableImportFindingsForProductResponse> {
			return this.http.delete('/productSubscriptions/' + (ProductSubscriptionArn == null ? '' : encodeURIComponent(ProductSubscriptionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateFromMasterAccount(headersHandler?: () => {[header: string]: string}): Promise<DisassociateFromMasterAccountResponse> {
			return this.http.post('/master/disassociate', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateMembers(requestBody: DisassociateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMembersResponse> {
			return this.http.post('/members/disassociate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableImportFindingsForProduct(requestBody: EnableImportFindingsForProductBody, headersHandler?: () => {[header: string]: string}): Promise<EnableImportFindingsForProductResponse> {
			return this.http.post('/productSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListEnabledProductsForImport(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListEnabledProductsForImportResponse> {
			return this.http.get('/productSubscriptions?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEnabledStandards(MaxResults: string, NextToken: string, requestBody: GetEnabledStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<GetEnabledStandardsResponse> {
			return this.http.post('/standards/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetFindings(MaxResults: string, NextToken: string, requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsResponse> {
			return this.http.post('/findings?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInsightResults(InsightArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetInsightResultsResponse> {
			return this.http.get('/insights/results/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetInsights(MaxResults: string, NextToken: string, requestBody: GetInsightsBody, headersHandler?: () => {[header: string]: string}): Promise<GetInsightsResponse> {
			return this.http.post('/insights/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInvitationsCount(headersHandler?: () => {[header: string]: string}): Promise<GetInvitationsCountResponse> {
			return this.http.get('/invitations/count', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMembers(requestBody: GetMembersBody, headersHandler?: () => {[header: string]: string}): Promise<GetMembersResponse> {
			return this.http.post('/members/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		InviteMembers(requestBody: InviteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<InviteMembersResponse> {
			return this.http.post('/members/invite', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInvitations(MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInvitationsResponse> {
			return this.http.get('/invitations?MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
