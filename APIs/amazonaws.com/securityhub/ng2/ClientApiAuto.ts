...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(requestBody: AcceptInvitationBody, headersHandler?: () => HttpHeaders): Observable<AcceptInvitationResponse> {
			return this.http.post<AcceptInvitationResponse>(this.baseUri + '/master', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchDisableStandards(requestBody: BatchDisableStandardsBody, headersHandler?: () => HttpHeaders): Observable<BatchDisableStandardsResponse> {
			return this.http.post<BatchDisableStandardsResponse>(this.baseUri + '/standards/deregister', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchEnableStandards(requestBody: BatchEnableStandardsBody, headersHandler?: () => HttpHeaders): Observable<BatchEnableStandardsResponse> {
			return this.http.post<BatchEnableStandardsResponse>(this.baseUri + '/standards/register', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchImportFindings(requestBody: BatchImportFindingsBody, headersHandler?: () => HttpHeaders): Observable<BatchImportFindingsResponse> {
			return this.http.post<BatchImportFindingsResponse>(this.baseUri + '/findings/import', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateActionTarget(requestBody: CreateActionTargetBody, headersHandler?: () => HttpHeaders): Observable<CreateActionTargetResponse> {
			return this.http.post<CreateActionTargetResponse>(this.baseUri + '/actionTargets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateInsight(requestBody: CreateInsightBody, headersHandler?: () => HttpHeaders): Observable<CreateInsightResponse> {
			return this.http.post<CreateInsightResponse>(this.baseUri + '/insights', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateMembers(requestBody: CreateMembersBody, headersHandler?: () => HttpHeaders): Observable<CreateMembersResponse> {
			return this.http.post<CreateMembersResponse>(this.baseUri + '/members', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListMembers(OnlyAssociated: boolean, MaxResults: number, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListMembersResponse> {
			return this.http.get<ListMembersResponse>(this.baseUri + '/members?OnlyAssociated=' + OnlyAssociated + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteActionTarget(ActionTargetArn: string, headersHandler?: () => HttpHeaders): Observable<DeleteActionTargetResponse> {
			return this.http.delete<DeleteActionTargetResponse>(this.baseUri + '/actionTargets/' + (ActionTargetArn == null ? '' : encodeURIComponent(ActionTargetArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteInsight(InsightArn: string, headersHandler?: () => HttpHeaders): Observable<DeleteInsightResponse> {
			return this.http.delete<DeleteInsightResponse>(this.baseUri + '/insights/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteMembers(requestBody: DeleteMembersBody, headersHandler?: () => HttpHeaders): Observable<DeleteMembersResponse> {
			return this.http.post<DeleteMembersResponse>(this.baseUri + '/members/delete', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeActionTargets(MaxResults: string, NextToken: string, requestBody: DescribeActionTargetsBody, headersHandler?: () => HttpHeaders): Observable<DescribeActionTargetsResponse> {
			return this.http.post<DescribeActionTargetsResponse>(this.baseUri + '/actionTargets/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeHub(HubArn: string, headersHandler?: () => HttpHeaders): Observable<DescribeHubResponse> {
			return this.http.get<DescribeHubResponse>(this.baseUri + '/accounts?HubArn=' + (HubArn == null ? '' : encodeURIComponent(HubArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DisableSecurityHub(headersHandler?: () => HttpHeaders): Observable<DisableSecurityHubResponse> {
			return this.http.delete<DisableSecurityHubResponse>(this.baseUri + '/accounts', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		EnableSecurityHub(requestBody: EnableSecurityHubBody, headersHandler?: () => HttpHeaders): Observable<EnableSecurityHubResponse> {
			return this.http.post<EnableSecurityHubResponse>(this.baseUri + '/accounts', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeProducts(NextToken: string, MaxResults: number, headersHandler?: () => HttpHeaders): Observable<DescribeProductsResponse> {
			return this.http.get<DescribeProductsResponse>(this.baseUri + '/products?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeStandards(NextToken: string, MaxResults: number, headersHandler?: () => HttpHeaders): Observable<DescribeStandardsResponse> {
			return this.http.get<DescribeStandardsResponse>(this.baseUri + '/standards?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeStandardsControls(StandardsSubscriptionArn: string, NextToken: string, MaxResults: number, headersHandler?: () => HttpHeaders): Observable<DescribeStandardsControlsResponse> {
			return this.http.get<DescribeStandardsControlsResponse>(this.baseUri + '/standards/controls/' + (StandardsSubscriptionArn == null ? '' : encodeURIComponent(StandardsSubscriptionArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DisableImportFindingsForProduct(ProductSubscriptionArn: string, headersHandler?: () => HttpHeaders): Observable<DisableImportFindingsForProductResponse> {
			return this.http.delete<DisableImportFindingsForProductResponse>(this.baseUri + '/productSubscriptions/' + (ProductSubscriptionArn == null ? '' : encodeURIComponent(ProductSubscriptionArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DisassociateMembers(requestBody: DisassociateMembersBody, headersHandler?: () => HttpHeaders): Observable<DisassociateMembersResponse> {
			return this.http.post<DisassociateMembersResponse>(this.baseUri + '/members/disassociate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		EnableImportFindingsForProduct(requestBody: EnableImportFindingsForProductBody, headersHandler?: () => HttpHeaders): Observable<EnableImportFindingsForProductResponse> {
			return this.http.post<EnableImportFindingsForProductResponse>(this.baseUri + '/productSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListEnabledProductsForImport(NextToken: string, MaxResults: number, headersHandler?: () => HttpHeaders): Observable<ListEnabledProductsForImportResponse> {
			return this.http.get<ListEnabledProductsForImportResponse>(this.baseUri + '/productSubscriptions?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetEnabledStandards(MaxResults: string, NextToken: string, requestBody: GetEnabledStandardsBody, headersHandler?: () => HttpHeaders): Observable<GetEnabledStandardsResponse> {
			return this.http.post<GetEnabledStandardsResponse>(this.baseUri + '/standards/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetFindings(MaxResults: string, NextToken: string, requestBody: GetFindingsBody, headersHandler?: () => HttpHeaders): Observable<GetFindingsResponse> {
			return this.http.post<GetFindingsResponse>(this.baseUri + '/findings?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetInsightResults(InsightArn: string, headersHandler?: () => HttpHeaders): Observable<GetInsightResultsResponse> {
			return this.http.get<GetInsightResultsResponse>(this.baseUri + '/insights/results/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetInsights(MaxResults: string, NextToken: string, requestBody: GetInsightsBody, headersHandler?: () => HttpHeaders): Observable<GetInsightsResponse> {
			return this.http.post<GetInsightsResponse>(this.baseUri + '/insights/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		GetMembers(requestBody: GetMembersBody, headersHandler?: () => HttpHeaders): Observable<GetMembersResponse> {
			return this.http.post<GetMembersResponse>(this.baseUri + '/members/get', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		InviteMembers(requestBody: InviteMembersBody, headersHandler?: () => HttpHeaders): Observable<InviteMembersResponse> {
			return this.http.post<InviteMembersResponse>(this.baseUri + '/members/invite', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
