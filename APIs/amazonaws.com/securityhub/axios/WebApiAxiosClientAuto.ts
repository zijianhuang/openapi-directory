...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptInvitationResponse> {
			return Axios.post<AcceptInvitationResponse>(this.baseUri + '/master', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMasterAccount(headersHandler?: () => {[header: string]: string}): Promise<GetMasterAccountResponse> {
			return Axios.get<GetMasterAccountResponse>(this.baseUri + '/master', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		BatchDisableStandards(requestBody: BatchDisableStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchDisableStandardsResponse> {
			return Axios.post<BatchDisableStandardsResponse>(this.baseUri + '/standards/deregister', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		BatchEnableStandards(requestBody: BatchEnableStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchEnableStandardsResponse> {
			return Axios.post<BatchEnableStandardsResponse>(this.baseUri + '/standards/register', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		BatchImportFindings(requestBody: BatchImportFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<BatchImportFindingsResponse> {
			return Axios.post<BatchImportFindingsResponse>(this.baseUri + '/findings/import', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateActionTarget(requestBody: CreateActionTargetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateActionTargetResponse> {
			return Axios.post<CreateActionTargetResponse>(this.baseUri + '/actionTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateInsight(requestBody: CreateInsightBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInsightResponse> {
			return Axios.post<CreateInsightResponse>(this.baseUri + '/insights', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateMembers(requestBody: CreateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<CreateMembersResponse> {
			return Axios.post<CreateMembersResponse>(this.baseUri + '/members', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListMembers(OnlyAssociated: boolean, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMembersResponse> {
			return Axios.get<ListMembersResponse>(this.baseUri + '/members?OnlyAssociated=' + OnlyAssociated + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeclineInvitations(requestBody: DeclineInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeclineInvitationsResponse> {
			return Axios.post<DeclineInvitationsResponse>(this.baseUri + '/invitations/decline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteActionTarget(ActionTargetArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteActionTargetResponse> {
			return Axios.delete<DeleteActionTargetResponse>(this.baseUri + '/actionTargets/' + (ActionTargetArn == null ? '' : encodeURIComponent(ActionTargetArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteInsight(InsightArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInsightResponse> {
			return Axios.delete<DeleteInsightResponse>(this.baseUri + '/insights/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteInvitations(requestBody: DeleteInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteInvitationsResponse> {
			return Axios.post<DeleteInvitationsResponse>(this.baseUri + '/invitations/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteMembers(requestBody: DeleteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteMembersResponse> {
			return Axios.post<DeleteMembersResponse>(this.baseUri + '/members/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeActionTargets(MaxResults: string, NextToken: string, requestBody: DescribeActionTargetsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeActionTargetsResponse> {
			return Axios.post<DescribeActionTargetsResponse>(this.baseUri + '/actionTargets/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeHub(HubArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeHubResponse> {
			return Axios.get<DescribeHubResponse>(this.baseUri + '/accounts?HubArn=' + (HubArn == null ? '' : encodeURIComponent(HubArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DisableSecurityHub(headersHandler?: () => {[header: string]: string}): Promise<DisableSecurityHubResponse> {
			return Axios.delete<DisableSecurityHubResponse>(this.baseUri + '/accounts', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		EnableSecurityHub(requestBody: EnableSecurityHubBody, headersHandler?: () => {[header: string]: string}): Promise<EnableSecurityHubResponse> {
			return Axios.post<EnableSecurityHubResponse>(this.baseUri + '/accounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeProducts(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeProductsResponse> {
			return Axios.get<DescribeProductsResponse>(this.baseUri + '/products?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeStandards(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeStandardsResponse> {
			return Axios.get<DescribeStandardsResponse>(this.baseUri + '/standards?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeStandardsControls(StandardsSubscriptionArn: string, NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeStandardsControlsResponse> {
			return Axios.get<DescribeStandardsControlsResponse>(this.baseUri + '/standards/controls/' + (StandardsSubscriptionArn == null ? '' : encodeURIComponent(StandardsSubscriptionArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DisableImportFindingsForProduct(ProductSubscriptionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DisableImportFindingsForProductResponse> {
			return Axios.delete<DisableImportFindingsForProductResponse>(this.baseUri + '/productSubscriptions/' + (ProductSubscriptionArn == null ? '' : encodeURIComponent(ProductSubscriptionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DisassociateFromMasterAccount(headersHandler?: () => {[header: string]: string}): Promise<DisassociateFromMasterAccountResponse> {
			return Axios.post<DisassociateFromMasterAccountResponse>(this.baseUri + '/master/disassociate', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DisassociateMembers(requestBody: DisassociateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMembersResponse> {
			return Axios.post<DisassociateMembersResponse>(this.baseUri + '/members/disassociate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		EnableImportFindingsForProduct(requestBody: EnableImportFindingsForProductBody, headersHandler?: () => {[header: string]: string}): Promise<EnableImportFindingsForProductResponse> {
			return Axios.post<EnableImportFindingsForProductResponse>(this.baseUri + '/productSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListEnabledProductsForImport(NextToken: string, MaxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListEnabledProductsForImportResponse> {
			return Axios.get<ListEnabledProductsForImportResponse>(this.baseUri + '/productSubscriptions?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetEnabledStandards(MaxResults: string, NextToken: string, requestBody: GetEnabledStandardsBody, headersHandler?: () => {[header: string]: string}): Promise<GetEnabledStandardsResponse> {
			return Axios.post<GetEnabledStandardsResponse>(this.baseUri + '/standards/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetFindings(MaxResults: string, NextToken: string, requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsResponse> {
			return Axios.post<GetFindingsResponse>(this.baseUri + '/findings?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetInsightResults(InsightArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetInsightResultsResponse> {
			return Axios.get<GetInsightResultsResponse>(this.baseUri + '/insights/results/' + (InsightArn == null ? '' : encodeURIComponent(InsightArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetInsights(MaxResults: string, NextToken: string, requestBody: GetInsightsBody, headersHandler?: () => {[header: string]: string}): Promise<GetInsightsResponse> {
			return Axios.post<GetInsightsResponse>(this.baseUri + '/insights/get?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInvitationsCount(headersHandler?: () => {[header: string]: string}): Promise<GetInvitationsCountResponse> {
			return Axios.get<GetInvitationsCountResponse>(this.baseUri + '/invitations/count', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetMembers(requestBody: GetMembersBody, headersHandler?: () => {[header: string]: string}): Promise<GetMembersResponse> {
			return Axios.post<GetMembersResponse>(this.baseUri + '/members/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		InviteMembers(requestBody: InviteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<InviteMembersResponse> {
			return Axios.post<InviteMembersResponse>(this.baseUri + '/members/invite', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListInvitations(MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInvitationsResponse> {
			return Axios.get<ListInvitationsResponse>(this.baseUri + '/invitations?MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
