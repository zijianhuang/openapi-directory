...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DeleteAccessPoint(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v20180820/accesspoint/' + (name == null ? '' : encodeURIComponent(name)) + '#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAccessPoint(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/accesspoint/' + (name == null ? '' : encodeURIComponent(name)) + '#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListJobs(jobStatuses: Array<JobStatus>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/jobs#x-amz-account-id?' + jobStatuses.map(z => `jobStatuses=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteAccessPointPolicy(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v20180820/accesspoint/' + (name == null ? '' : encodeURIComponent(name)) + '/policy#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAccessPointPolicy(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/accesspoint/' + (name == null ? '' : encodeURIComponent(name)) + '/policy#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteJobTagging(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v20180820/jobs/' + (id == null ? '' : encodeURIComponent(id)) + '/tagging#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetJobTagging(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/jobs/' + (id == null ? '' : encodeURIComponent(id)) + '/tagging#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeletePublicAccessBlock(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v20180820/configuration/publicAccessBlock#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPublicAccessBlock(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/configuration/publicAccessBlock#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeJob(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/jobs/' + (id == null ? '' : encodeURIComponent(id)) + '#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAccessPointPolicyStatus(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/accesspoint/' + (name == null ? '' : encodeURIComponent(name)) + '/policyStatus#x-amz-account-id', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListAccessPoints(bucket: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/v20180820/accesspoint#x-amz-account-id?bucket=' + (bucket == null ? '' : encodeURIComponent(bucket)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateJobPriority(id: string, priority: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v20180820/jobs/' + (id == null ? '' : encodeURIComponent(id)) + '/priority#x-amz-account-id&priority&priority=' + priority, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateJobStatus(id: string, requestedJobStatus: RequestedJobStatus, statusUpdateReason: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v20180820/jobs/' + (id == null ? '' : encodeURIComponent(id)) + '/status#x-amz-account-id&requestedJobStatus&requestedJobStatus=' + requestedJobStatus + '&statusUpdateReason=' + (statusUpdateReason == null ? '' : encodeURIComponent(statusUpdateReason)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
