...
export namespace My_Demo_Client {
	...
	export interface RequestCertificateRequest {
		DomainName: string;
		ValidationMethod?: RequestCertificateRequestValidationMethod;
		SubjectAlternativeNames?: Array<DomainNameString>;
	...
	export enum RequestCertificateRequestValidationMethod { EMAIL = 0, DNS = 1 }
	...
	export interface RenewalSummary {
		...
		RenewalStatusReason?: RenewalSummaryRenewalStatusReason;
		UpdatedAt: Date;
	}

	export enum RenewalSummaryRenewalStatus { PENDING_AUTO_RENEWAL = 0, PENDING_VALIDATION = 1, SUCCESS = 2, FAILED = 3 }

	export enum RenewalSummaryRenewalStatusReason { NO_AVAILABLE_CONTACTS = 0, ADDITIONAL_VERIFICATION_REQUIRED = 1, DOMAIN_NOT_ALLOWED = 2, INVALID_PUBLIC_DOMAIN = 3, DOMAIN_VALIDATION_DENIED = 4, CAA_ERROR = 5, PCA_LIMIT_EXCEEDED = 6, PCA_INVALID_ARN = 7, PCA_INVALID_STATE = 8, PCA_REQUEST_FAILED = 9, PCA_NAME_CONSTRAINTS_VALIDATION = 10, PCA_RESOURCE_NOT_FOUND = 11, PCA_INVALID_ARGS = 12, PCA_INVALID_DURATION = 13, PCA_ACCESS_DENIED = 14, OTHER = 15 }
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToCertificate(requestBody: AddTagsToCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '#X-Amz-Target=CertificateManager.AddTagsToCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificate(requestBody: DeleteCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '#X-Amz-Target=CertificateManager.DeleteCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeCertificate(requestBody: DescribeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResponse> {
			return Axios.post<DescribeCertificateResponse>(this.baseUri + '#X-Amz-Target=CertificateManager.DescribeCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ExportCertificate(requestBody: ExportCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ExportCertificateResponse> {
			return Axios.post<ExportCertificateResponse>(this.baseUri + '#X-Amz-Target=CertificateManager.ExportCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCertificate(requestBody: GetCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateResponse> {
			return Axios.post<GetCertificateResponse>(this.baseUri + '#X-Amz-Target=CertificateManager.GetCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ImportCertificate(requestBody: ImportCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportCertificateResponse> {
			return Axios.post<ImportCertificateResponse>(this.baseUri + '#X-Amz-Target=CertificateManager.ImportCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListCertificates(MaxItems: string, NextToken: string, requestBody: ListCertificatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesResponse> {
			return Axios.post<ListCertificatesResponse>(this.baseUri + '#X-Amz-Target=CertificateManager.ListCertificates?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTagsForCertificate(requestBody: ListTagsForCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForCertificateResponse> {
			return Axios.post<ListTagsForCertificateResponse>(this.baseUri + '#X-Amz-Target=CertificateManager.ListTagsForCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromCertificate(requestBody: RemoveTagsFromCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RenewCertificate(requestBody: RenewCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '#X-Amz-Target=CertificateManager.RenewCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		RequestCertificate(requestBody: RequestCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<RequestCertificateResponse> {
			return Axios.post<RequestCertificateResponse>(this.baseUri + '#X-Amz-Target=CertificateManager.RequestCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		ResendValidationEmail(requestBody: ResendValidationEmailRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '#X-Amz-Target=CertificateManager.ResendValidationEmail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificateOptions(requestBody: UpdateCertificateOptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '#X-Amz-Target=CertificateManager.UpdateCertificateOptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
