export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToCertificate(requestBody: AddTagsToCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.AddTagsToCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificate(requestBody: DeleteCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.DeleteCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeCertificate(requestBody: DescribeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.DescribeCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ExportCertificate(requestBody: ExportCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ExportCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.ExportCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetCertificate(requestBody: GetCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.GetCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ImportCertificate(requestBody: ImportCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.ImportCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForCertificate(requestBody: ListTagsForCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.ListTagsForCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromCertificate(requestBody: RemoveTagsFromCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		RenewCertificate(requestBody: RenewCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.RenewCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RequestCertificate(requestBody: RequestCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<RequestCertificateResponse> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.RequestCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		ResendValidationEmail(requestBody: ResendValidationEmailRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.ResendValidationEmail', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificateOptions(requestBody: UpdateCertificateOptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '#X-Amz-Target=CertificateManager.UpdateCertificateOptions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
