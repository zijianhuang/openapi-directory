...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToCertificate(callback: (data : void) => any, requestBody: AddTagsToCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.AddTagsToCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificate(callback: (data : void) => any, requestBody: DeleteCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.DeleteCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCertificate(callback: (data : DescribeCertificateResponse) => any, requestBody: DescribeCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.DescribeCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ExportCertificate(callback: (data : ExportCertificateResponse) => any, requestBody: ExportCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.ExportCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		GetCertificate(callback: (data : GetCertificateResponse) => any, requestBody: GetCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.GetCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ImportCertificate(callback: (data : ImportCertificateResponse) => any, requestBody: ImportCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.ImportCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCertificates(MaxItems: string, NextToken: string, callback: (data : ListCertificatesResponse) => any, requestBody: ListCertificatesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.ListCertificates?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForCertificate(callback: (data : ListTagsForCertificateResponse) => any, requestBody: ListTagsForCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.ListTagsForCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromCertificate(callback: (data : void) => any, requestBody: RemoveTagsFromCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RenewCertificate(callback: (data : void) => any, requestBody: RenewCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.RenewCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RequestCertificate(callback: (data : RequestCertificateResponse) => any, requestBody: RequestCertificateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.RequestCertificate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ResendValidationEmail(callback: (data : void) => any, requestBody: ResendValidationEmailRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.ResendValidationEmail', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificateOptions(callback: (data : void) => any, requestBody: UpdateCertificateOptionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=CertificateManager.UpdateCertificateOptions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
