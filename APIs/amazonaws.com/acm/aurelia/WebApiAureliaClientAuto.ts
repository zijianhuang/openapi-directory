...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToCertificate(requestBody: AddTagsToCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=CertificateManager.AddTagsToCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteCertificate(requestBody: DeleteCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=CertificateManager.DeleteCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeCertificate(requestBody: DescribeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResponse> {
			return this.http.post('#X-Amz-Target=CertificateManager.DescribeCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ExportCertificate(requestBody: ExportCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ExportCertificateResponse> {
			return this.http.post('#X-Amz-Target=CertificateManager.ExportCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCertificate(requestBody: GetCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCertificateResponse> {
			return this.http.post('#X-Amz-Target=CertificateManager.GetCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ImportCertificate(requestBody: ImportCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportCertificateResponse> {
			return this.http.post('#X-Amz-Target=CertificateManager.ImportCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListCertificates(MaxItems: string, NextToken: string, requestBody: ListCertificatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesResponse> {
			return this.http.post('#X-Amz-Target=CertificateManager.ListCertificates?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForCertificate(requestBody: ListTagsForCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForCertificateResponse> {
			return this.http.post('#X-Amz-Target=CertificateManager.ListTagsForCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveTagsFromCertificate(requestBody: RemoveTagsFromCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RenewCertificate(requestBody: RenewCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=CertificateManager.RenewCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RequestCertificate(requestBody: RequestCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<RequestCertificateResponse> {
			return this.http.post('#X-Amz-Target=CertificateManager.RequestCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResendValidationEmail(requestBody: ResendValidationEmailRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=CertificateManager.ResendValidationEmail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateCertificateOptions(requestBody: UpdateCertificateOptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('#X-Amz-Target=CertificateManager.UpdateCertificateOptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
