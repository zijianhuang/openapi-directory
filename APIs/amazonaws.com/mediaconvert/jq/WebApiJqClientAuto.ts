...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AssociateCertificate(callback: (data : void) => any, requestBody: AssociateCertificateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-08-29/certificates', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		CancelJob(id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2017-08-29/jobs/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetJob(id: string, callback: (data : GetJobResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/jobs/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		CreateJob(callback: (data : void) => any, requestBody: CreateJobBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-08-29/jobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListJobs(maxResults: number, nextToken: string, order: Order, queue: string, status: JobStatus, MaxResults: string, NextToken: string, callback: (data : ListJobsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/jobs?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&order=' + order + '&queue=' + (queue == null ? '' : encodeURIComponent(queue)) + '&status=' + status + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateJobTemplate(callback: (data : void) => any, requestBody: CreateJobTemplateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-08-29/jobTemplates', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListJobTemplates(category: string, listBy: JobTemplateListBy, maxResults: number, nextToken: string, order: Order, MaxResults: string, NextToken: string, callback: (data : ListJobTemplatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/jobTemplates?category=' + (category == null ? '' : encodeURIComponent(category)) + '&listBy=' + listBy + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&order=' + order + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		CreatePreset(callback: (data : void) => any, requestBody: CreatePresetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-08-29/presets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPresets(category: string, listBy: JobTemplateListBy, maxResults: number, nextToken: string, order: Order, MaxResults: string, NextToken: string, callback: (data : ListPresetsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/presets?category=' + (category == null ? '' : encodeURIComponent(category)) + '&listBy=' + listBy + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&order=' + order + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateQueue(callback: (data : void) => any, requestBody: CreateQueueBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-08-29/queues', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListQueues(listBy: QueueListBy, maxResults: number, nextToken: string, order: Order, MaxResults: string, NextToken: string, callback: (data : ListQueuesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/queues?listBy=' + listBy + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&order=' + order + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteJobTemplate(name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2017-08-29/jobTemplates/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetJobTemplate(name: string, callback: (data : GetJobTemplateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/jobTemplates/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateJobTemplate(name: string, callback: (data : UpdateJobTemplateResponse) => any, requestBody: UpdateJobTemplateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2017-08-29/jobTemplates/' + (name == null ? '' : encodeURIComponent(name)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeletePreset(name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2017-08-29/presets/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetPreset(name: string, callback: (data : GetPresetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/presets/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdatePreset(name: string, callback: (data : UpdatePresetResponse) => any, requestBody: UpdatePresetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2017-08-29/presets/' + (name == null ? '' : encodeURIComponent(name)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteQueue(name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2017-08-29/queues/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetQueue(name: string, callback: (data : GetQueueResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/queues/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateQueue(name: string, callback: (data : UpdateQueueResponse) => any, requestBody: UpdateQueueBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2017-08-29/queues/' + (name == null ? '' : encodeURIComponent(name)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeEndpoints(MaxResults: string, NextToken: string, callback: (data : DescribeEndpointsResponse) => any, requestBody: DescribeEndpointsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-08-29/endpoints?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DisassociateCertificate(arn: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2017-08-29/certificates/' + (arn == null ? '' : encodeURIComponent(arn)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		ListTagsForResource(arn: string, callback: (data : ListTagsForResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-08-29/tags/' + (arn == null ? '' : encodeURIComponent(arn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UntagResource(arn: string, callback: (data : UntagResourceResponse) => any, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2017-08-29/tags/' + (arn == null ? '' : encodeURIComponent(arn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-08-29/tags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
