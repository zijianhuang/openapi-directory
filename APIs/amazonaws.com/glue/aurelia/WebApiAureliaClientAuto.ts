...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchCreatePartition(requestBody: BatchCreatePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchCreatePartitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchCreatePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchDeleteConnection(requestBody: BatchDeleteConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteConnectionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchDeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchDeletePartition(requestBody: BatchDeletePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeletePartitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchDeletePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchDeleteTable(requestBody: BatchDeleteTableRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteTableResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchDeleteTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchDeleteTableVersion(requestBody: BatchDeleteTableVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteTableVersionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchDeleteTableVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetCrawlers(requestBody: BatchGetCrawlersRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetCrawlersResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchGetCrawlers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetDevEndpoints(requestBody: BatchGetDevEndpointsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDevEndpointsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchGetDevEndpoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetJobs(requestBody: BatchGetJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetJobsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchGetJobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetPartition(requestBody: BatchGetPartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetPartitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchGetPartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetTriggers(requestBody: BatchGetTriggersRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetTriggersResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchGetTriggers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetWorkflows(requestBody: BatchGetWorkflowsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetWorkflowsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchGetWorkflows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchStopJobRun(requestBody: BatchStopJobRunRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchStopJobRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.BatchStopJobRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelMLTaskRun(requestBody: CancelMLTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelMLTaskRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CancelMLTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateClassifier(requestBody: CreateClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateClassifierResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateConnection(requestBody: CreateConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateConnectionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateCrawler(requestBody: CreateCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCrawlerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDatabase(requestBody: CreateDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatabaseResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDevEndpoint(requestBody: CreateDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDevEndpointResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateJob(requestBody: CreateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateJobResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateMLTransform(requestBody: CreateMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMLTransformResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePartition(requestBody: CreatePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePartitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreatePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateScript(requestBody: CreateScriptRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateScriptResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateScript', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSecurityConfiguration(requestBody: CreateSecurityConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSecurityConfigurationResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTable(requestBody: CreateTableRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTableResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTrigger(requestBody: CreateTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTriggerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateUserDefinedFunction(requestBody: CreateUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserDefinedFunctionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateWorkflow(requestBody: CreateWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkflowResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.CreateWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteClassifier(requestBody: DeleteClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteClassifierResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteConnection(requestBody: DeleteConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteConnectionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteCrawler(requestBody: DeleteCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCrawlerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDatabase(requestBody: DeleteDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDatabaseResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDevEndpoint(requestBody: DeleteDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDevEndpointResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteJob(requestBody: DeleteJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteJobResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMLTransform(requestBody: DeleteMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteMLTransformResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeletePartition(requestBody: DeletePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeletePartitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeletePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcePolicyResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSecurityConfiguration(requestBody: DeleteSecurityConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecurityConfigurationResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTable(requestBody: DeleteTableRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTableResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTableVersion(requestBody: DeleteTableVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTableVersionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteTableVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTrigger(requestBody: DeleteTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTriggerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUserDefinedFunction(requestBody: DeleteUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserDefinedFunctionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteWorkflow(requestBody: DeleteWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkflowResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.DeleteWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCatalogImportStatus(requestBody: GetCatalogImportStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCatalogImportStatusResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetCatalogImportStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetClassifier(requestBody: GetClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<GetClassifierResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetClassifiers(MaxResults: string, NextToken: string, requestBody: GetClassifiersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetClassifiersResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetClassifiers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetConnection(requestBody: GetConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConnectionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetConnections(MaxResults: string, NextToken: string, requestBody: GetConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConnectionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetConnections?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCrawler(requestBody: GetCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCrawlerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCrawlerMetrics(MaxResults: string, NextToken: string, requestBody: GetCrawlerMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCrawlerMetricsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetCrawlerMetrics?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCrawlers(MaxResults: string, NextToken: string, requestBody: GetCrawlersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCrawlersResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetCrawlers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDataCatalogEncryptionSettings(requestBody: GetDataCatalogEncryptionSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDataCatalogEncryptionSettingsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetDataCatalogEncryptionSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDatabase(requestBody: GetDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDatabaseResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDatabases(MaxResults: string, NextToken: string, requestBody: GetDatabasesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDatabasesResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetDatabases?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDataflowGraph(requestBody: GetDataflowGraphRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDataflowGraphResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetDataflowGraph', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDevEndpoint(requestBody: GetDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDevEndpointResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetJob(requestBody: GetJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetJobBookmark(requestBody: GetJobBookmarkRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobBookmarkResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetJobBookmark', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetJobRun(requestBody: GetJobRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetJobRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetJobRuns(MaxResults: string, NextToken: string, requestBody: GetJobRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobRunsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetJobRuns?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetJobs(MaxResults: string, NextToken: string, requestBody: GetJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMLTaskRun(requestBody: GetMLTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTaskRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetMLTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMLTaskRuns(MaxResults: string, NextToken: string, requestBody: GetMLTaskRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTaskRunsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetMLTaskRuns?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMLTransform(requestBody: GetMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTransformResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMLTransforms(MaxResults: string, NextToken: string, requestBody: GetMLTransformsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTransformsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetMLTransforms?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMapping(requestBody: GetMappingRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMappingResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetMapping', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPartition(requestBody: GetPartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPartitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetPartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPartitions(MaxResults: string, NextToken: string, requestBody: GetPartitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPartitionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetPartitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPlan(requestBody: GetPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPlanResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetPlan', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResourcePolicyResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSecurityConfiguration(requestBody: GetSecurityConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSecurityConfigurationResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSecurityConfigurations(MaxResults: string, NextToken: string, requestBody: GetSecurityConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSecurityConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetSecurityConfigurations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTable(requestBody: GetTableRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTableResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTableVersion(requestBody: GetTableVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTableVersionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetTableVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTables(MaxResults: string, NextToken: string, requestBody: GetTablesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTablesResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetTables?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTags(requestBody: GetTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTagsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTrigger(requestBody: GetTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTriggerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTriggers(MaxResults: string, NextToken: string, requestBody: GetTriggersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTriggersResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetTriggers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetUserDefinedFunction(requestBody: GetUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUserDefinedFunctionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetUserDefinedFunctions(MaxResults: string, NextToken: string, requestBody: GetUserDefinedFunctionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUserDefinedFunctionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetUserDefinedFunctions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetWorkflow(requestBody: GetWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetWorkflowRun(requestBody: GetWorkflowRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetWorkflowRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetWorkflowRunProperties(requestBody: GetWorkflowRunPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowRunPropertiesResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetWorkflowRunProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetWorkflowRuns(MaxResults: string, NextToken: string, requestBody: GetWorkflowRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowRunsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.GetWorkflowRuns?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ImportCatalogToGlue(requestBody: ImportCatalogToGlueRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportCatalogToGlueResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ImportCatalogToGlue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListCrawlers(MaxResults: string, NextToken: string, requestBody: ListCrawlersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCrawlersResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ListCrawlers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDevEndpoints(MaxResults: string, NextToken: string, requestBody: ListDevEndpointsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDevEndpointsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ListDevEndpoints?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListJobs(MaxResults: string, NextToken: string, requestBody: ListJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ListJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListMLTransforms(MaxResults: string, NextToken: string, requestBody: ListMLTransformsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMLTransformsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ListMLTransforms?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTriggers(MaxResults: string, NextToken: string, requestBody: ListTriggersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTriggersResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ListTriggers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListWorkflows(MaxResults: string, NextToken: string, requestBody: ListWorkflowsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkflowsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ListWorkflows?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutDataCatalogEncryptionSettings(requestBody: PutDataCatalogEncryptionSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDataCatalogEncryptionSettingsResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.PutDataCatalogEncryptionSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.PutResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutWorkflowRunProperties(requestBody: PutWorkflowRunPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<PutWorkflowRunPropertiesResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.PutWorkflowRunProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResetJobBookmark(requestBody: ResetJobBookmarkRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetJobBookmarkResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.ResetJobBookmark', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SearchTables(MaxResults: string, NextToken: string, requestBody: SearchTablesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchTablesResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.SearchTables?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartCrawler(requestBody: StartCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<StartCrawlerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartCrawlerSchedule(requestBody: StartCrawlerScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<StartCrawlerScheduleResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartCrawlerSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartExportLabelsTaskRun(requestBody: StartExportLabelsTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartExportLabelsTaskRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartExportLabelsTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartImportLabelsTaskRun(requestBody: StartImportLabelsTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartImportLabelsTaskRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartImportLabelsTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartJobRun(requestBody: StartJobRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartJobRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartJobRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartMLEvaluationTaskRun(requestBody: StartMLEvaluationTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartMLEvaluationTaskRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartMLEvaluationTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartMLLabelingSetGenerationTaskRun(requestBody: StartMLLabelingSetGenerationTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartMLLabelingSetGenerationTaskRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartMLLabelingSetGenerationTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartTrigger(requestBody: StartTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTriggerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartWorkflowRun(requestBody: StartWorkflowRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartWorkflowRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StartWorkflowRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopCrawler(requestBody: StopCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<StopCrawlerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StopCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopCrawlerSchedule(requestBody: StopCrawlerScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<StopCrawlerScheduleResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StopCrawlerSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopTrigger(requestBody: StopTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<StopTriggerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StopTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopWorkflowRun(requestBody: StopWorkflowRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StopWorkflowRunResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.StopWorkflowRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateClassifier(requestBody: UpdateClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateClassifierResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateConnection(requestBody: UpdateConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateConnectionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateCrawler(requestBody: UpdateCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCrawlerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateCrawlerSchedule(requestBody: UpdateCrawlerScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCrawlerScheduleResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateCrawlerSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDatabase(requestBody: UpdateDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDatabaseResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDevEndpoint(requestBody: UpdateDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDevEndpointResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateJob(requestBody: UpdateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateJobResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMLTransform(requestBody: UpdateMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMLTransformResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdatePartition(requestBody: UpdatePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdatePartitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdatePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTable(requestBody: UpdateTableRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTableResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTrigger(requestBody: UpdateTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTriggerResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateUserDefinedFunction(requestBody: UpdateUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserDefinedFunctionResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateWorkflow(requestBody: UpdateWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateWorkflowResponse> {
			return this.http.post('/#X-Amz-Target=AWSGlue.UpdateWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
