...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchCreatePartition(requestBody: BatchCreatePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchCreatePartitionResponse> {
			return Axios.post<BatchCreatePartitionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchCreatePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDeleteConnection(requestBody: BatchDeleteConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteConnectionResponse> {
			return Axios.post<BatchDeleteConnectionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchDeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDeletePartition(requestBody: BatchDeletePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeletePartitionResponse> {
			return Axios.post<BatchDeletePartitionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchDeletePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDeleteTable(requestBody: BatchDeleteTableRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteTableResponse> {
			return Axios.post<BatchDeleteTableResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchDeleteTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDeleteTableVersion(requestBody: BatchDeleteTableVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteTableVersionResponse> {
			return Axios.post<BatchDeleteTableVersionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchDeleteTableVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetCrawlers(requestBody: BatchGetCrawlersRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetCrawlersResponse> {
			return Axios.post<BatchGetCrawlersResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchGetCrawlers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetDevEndpoints(requestBody: BatchGetDevEndpointsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDevEndpointsResponse> {
			return Axios.post<BatchGetDevEndpointsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchGetDevEndpoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetJobs(requestBody: BatchGetJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetJobsResponse> {
			return Axios.post<BatchGetJobsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchGetJobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetPartition(requestBody: BatchGetPartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetPartitionResponse> {
			return Axios.post<BatchGetPartitionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchGetPartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetTriggers(requestBody: BatchGetTriggersRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetTriggersResponse> {
			return Axios.post<BatchGetTriggersResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchGetTriggers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetWorkflows(requestBody: BatchGetWorkflowsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetWorkflowsResponse> {
			return Axios.post<BatchGetWorkflowsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchGetWorkflows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchStopJobRun(requestBody: BatchStopJobRunRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchStopJobRunResponse> {
			return Axios.post<BatchStopJobRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.BatchStopJobRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelMLTaskRun(requestBody: CancelMLTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelMLTaskRunResponse> {
			return Axios.post<CancelMLTaskRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CancelMLTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateClassifier(requestBody: CreateClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateClassifierResponse> {
			return Axios.post<CreateClassifierResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateConnection(requestBody: CreateConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateConnectionResponse> {
			return Axios.post<CreateConnectionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateCrawler(requestBody: CreateCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCrawlerResponse> {
			return Axios.post<CreateCrawlerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDatabase(requestBody: CreateDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatabaseResponse> {
			return Axios.post<CreateDatabaseResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDevEndpoint(requestBody: CreateDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDevEndpointResponse> {
			return Axios.post<CreateDevEndpointResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateJob(requestBody: CreateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateJobResponse> {
			return Axios.post<CreateJobResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateMLTransform(requestBody: CreateMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMLTransformResponse> {
			return Axios.post<CreateMLTransformResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePartition(requestBody: CreatePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePartitionResponse> {
			return Axios.post<CreatePartitionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreatePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateScript(requestBody: CreateScriptRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateScriptResponse> {
			return Axios.post<CreateScriptResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateScript', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSecurityConfiguration(requestBody: CreateSecurityConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSecurityConfigurationResponse> {
			return Axios.post<CreateSecurityConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTable(requestBody: CreateTableRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTableResponse> {
			return Axios.post<CreateTableResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTrigger(requestBody: CreateTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTriggerResponse> {
			return Axios.post<CreateTriggerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUserDefinedFunction(requestBody: CreateUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserDefinedFunctionResponse> {
			return Axios.post<CreateUserDefinedFunctionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateWorkflow(requestBody: CreateWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkflowResponse> {
			return Axios.post<CreateWorkflowResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.CreateWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteClassifier(requestBody: DeleteClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteClassifierResponse> {
			return Axios.post<DeleteClassifierResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteConnection(requestBody: DeleteConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteConnectionResponse> {
			return Axios.post<DeleteConnectionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteCrawler(requestBody: DeleteCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCrawlerResponse> {
			return Axios.post<DeleteCrawlerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDatabase(requestBody: DeleteDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDatabaseResponse> {
			return Axios.post<DeleteDatabaseResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDevEndpoint(requestBody: DeleteDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDevEndpointResponse> {
			return Axios.post<DeleteDevEndpointResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteJob(requestBody: DeleteJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteJobResponse> {
			return Axios.post<DeleteJobResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteMLTransform(requestBody: DeleteMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteMLTransformResponse> {
			return Axios.post<DeleteMLTransformResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeletePartition(requestBody: DeletePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeletePartitionResponse> {
			return Axios.post<DeletePartitionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeletePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcePolicyResponse> {
			return Axios.post<DeleteResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSecurityConfiguration(requestBody: DeleteSecurityConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecurityConfigurationResponse> {
			return Axios.post<DeleteSecurityConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTable(requestBody: DeleteTableRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTableResponse> {
			return Axios.post<DeleteTableResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTableVersion(requestBody: DeleteTableVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTableVersionResponse> {
			return Axios.post<DeleteTableVersionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteTableVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTrigger(requestBody: DeleteTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTriggerResponse> {
			return Axios.post<DeleteTriggerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteUserDefinedFunction(requestBody: DeleteUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserDefinedFunctionResponse> {
			return Axios.post<DeleteUserDefinedFunctionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteWorkflow(requestBody: DeleteWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkflowResponse> {
			return Axios.post<DeleteWorkflowResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.DeleteWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCatalogImportStatus(requestBody: GetCatalogImportStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCatalogImportStatusResponse> {
			return Axios.post<GetCatalogImportStatusResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetCatalogImportStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetClassifier(requestBody: GetClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<GetClassifierResponse> {
			return Axios.post<GetClassifierResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetClassifiers(MaxResults: string, NextToken: string, requestBody: GetClassifiersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetClassifiersResponse> {
			return Axios.post<GetClassifiersResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetClassifiers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetConnection(requestBody: GetConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConnectionResponse> {
			return Axios.post<GetConnectionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetConnections(MaxResults: string, NextToken: string, requestBody: GetConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConnectionsResponse> {
			return Axios.post<GetConnectionsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetConnections?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCrawler(requestBody: GetCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCrawlerResponse> {
			return Axios.post<GetCrawlerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCrawlerMetrics(MaxResults: string, NextToken: string, requestBody: GetCrawlerMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCrawlerMetricsResponse> {
			return Axios.post<GetCrawlerMetricsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetCrawlerMetrics?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCrawlers(MaxResults: string, NextToken: string, requestBody: GetCrawlersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCrawlersResponse> {
			return Axios.post<GetCrawlersResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetCrawlers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDataCatalogEncryptionSettings(requestBody: GetDataCatalogEncryptionSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDataCatalogEncryptionSettingsResponse> {
			return Axios.post<GetDataCatalogEncryptionSettingsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetDataCatalogEncryptionSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDatabase(requestBody: GetDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDatabaseResponse> {
			return Axios.post<GetDatabaseResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDatabases(MaxResults: string, NextToken: string, requestBody: GetDatabasesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDatabasesResponse> {
			return Axios.post<GetDatabasesResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetDatabases?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDataflowGraph(requestBody: GetDataflowGraphRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDataflowGraphResponse> {
			return Axios.post<GetDataflowGraphResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetDataflowGraph', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDevEndpoint(requestBody: GetDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDevEndpointResponse> {
			return Axios.post<GetDevEndpointResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJob(requestBody: GetJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobResponse> {
			return Axios.post<GetJobResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJobBookmark(requestBody: GetJobBookmarkRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobBookmarkResponse> {
			return Axios.post<GetJobBookmarkResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetJobBookmark', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJobRun(requestBody: GetJobRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobRunResponse> {
			return Axios.post<GetJobRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetJobRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJobRuns(MaxResults: string, NextToken: string, requestBody: GetJobRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobRunsResponse> {
			return Axios.post<GetJobRunsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetJobRuns?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJobs(MaxResults: string, NextToken: string, requestBody: GetJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobsResponse> {
			return Axios.post<GetJobsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMLTaskRun(requestBody: GetMLTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTaskRunResponse> {
			return Axios.post<GetMLTaskRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetMLTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMLTaskRuns(MaxResults: string, NextToken: string, requestBody: GetMLTaskRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTaskRunsResponse> {
			return Axios.post<GetMLTaskRunsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetMLTaskRuns?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMLTransform(requestBody: GetMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTransformResponse> {
			return Axios.post<GetMLTransformResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMLTransforms(MaxResults: string, NextToken: string, requestBody: GetMLTransformsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMLTransformsResponse> {
			return Axios.post<GetMLTransformsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetMLTransforms?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMapping(requestBody: GetMappingRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMappingResponse> {
			return Axios.post<GetMappingResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetMapping', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPartition(requestBody: GetPartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPartitionResponse> {
			return Axios.post<GetPartitionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetPartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPartitions(MaxResults: string, NextToken: string, requestBody: GetPartitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPartitionsResponse> {
			return Axios.post<GetPartitionsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetPartitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPlan(requestBody: GetPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPlanResponse> {
			return Axios.post<GetPlanResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetPlan', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResourcePolicyResponse> {
			return Axios.post<GetResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSecurityConfiguration(requestBody: GetSecurityConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSecurityConfigurationResponse> {
			return Axios.post<GetSecurityConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSecurityConfigurations(MaxResults: string, NextToken: string, requestBody: GetSecurityConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSecurityConfigurationsResponse> {
			return Axios.post<GetSecurityConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetSecurityConfigurations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTable(requestBody: GetTableRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTableResponse> {
			return Axios.post<GetTableResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTableVersion(requestBody: GetTableVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTableVersionResponse> {
			return Axios.post<GetTableVersionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetTableVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTables(MaxResults: string, NextToken: string, requestBody: GetTablesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTablesResponse> {
			return Axios.post<GetTablesResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetTables?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTags(requestBody: GetTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTagsResponse> {
			return Axios.post<GetTagsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTrigger(requestBody: GetTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTriggerResponse> {
			return Axios.post<GetTriggerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUserDefinedFunction(requestBody: GetUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUserDefinedFunctionResponse> {
			return Axios.post<GetUserDefinedFunctionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUserDefinedFunctions(MaxResults: string, NextToken: string, requestBody: GetUserDefinedFunctionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUserDefinedFunctionsResponse> {
			return Axios.post<GetUserDefinedFunctionsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetUserDefinedFunctions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetWorkflow(requestBody: GetWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowResponse> {
			return Axios.post<GetWorkflowResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetWorkflowRun(requestBody: GetWorkflowRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowRunResponse> {
			return Axios.post<GetWorkflowRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetWorkflowRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetWorkflowRunProperties(requestBody: GetWorkflowRunPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowRunPropertiesResponse> {
			return Axios.post<GetWorkflowRunPropertiesResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetWorkflowRunProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetWorkflowRuns(MaxResults: string, NextToken: string, requestBody: GetWorkflowRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetWorkflowRunsResponse> {
			return Axios.post<GetWorkflowRunsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.GetWorkflowRuns?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ImportCatalogToGlue(requestBody: ImportCatalogToGlueRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportCatalogToGlueResponse> {
			return Axios.post<ImportCatalogToGlueResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ImportCatalogToGlue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCrawlers(MaxResults: string, NextToken: string, requestBody: ListCrawlersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCrawlersResponse> {
			return Axios.post<ListCrawlersResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ListCrawlers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDevEndpoints(MaxResults: string, NextToken: string, requestBody: ListDevEndpointsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDevEndpointsResponse> {
			return Axios.post<ListDevEndpointsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ListDevEndpoints?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListJobs(MaxResults: string, NextToken: string, requestBody: ListJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResponse> {
			return Axios.post<ListJobsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ListJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListMLTransforms(MaxResults: string, NextToken: string, requestBody: ListMLTransformsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMLTransformsResponse> {
			return Axios.post<ListMLTransformsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ListMLTransforms?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTriggers(MaxResults: string, NextToken: string, requestBody: ListTriggersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTriggersResponse> {
			return Axios.post<ListTriggersResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ListTriggers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListWorkflows(MaxResults: string, NextToken: string, requestBody: ListWorkflowsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkflowsResponse> {
			return Axios.post<ListWorkflowsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ListWorkflows?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutDataCatalogEncryptionSettings(requestBody: PutDataCatalogEncryptionSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDataCatalogEncryptionSettingsResponse> {
			return Axios.post<PutDataCatalogEncryptionSettingsResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.PutDataCatalogEncryptionSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyResponse> {
			return Axios.post<PutResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.PutResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutWorkflowRunProperties(requestBody: PutWorkflowRunPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<PutWorkflowRunPropertiesResponse> {
			return Axios.post<PutWorkflowRunPropertiesResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.PutWorkflowRunProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ResetJobBookmark(requestBody: ResetJobBookmarkRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetJobBookmarkResponse> {
			return Axios.post<ResetJobBookmarkResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.ResetJobBookmark', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchTables(MaxResults: string, NextToken: string, requestBody: SearchTablesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchTablesResponse> {
			return Axios.post<SearchTablesResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.SearchTables?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartCrawler(requestBody: StartCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<StartCrawlerResponse> {
			return Axios.post<StartCrawlerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartCrawlerSchedule(requestBody: StartCrawlerScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<StartCrawlerScheduleResponse> {
			return Axios.post<StartCrawlerScheduleResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartCrawlerSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartExportLabelsTaskRun(requestBody: StartExportLabelsTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartExportLabelsTaskRunResponse> {
			return Axios.post<StartExportLabelsTaskRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartExportLabelsTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartImportLabelsTaskRun(requestBody: StartImportLabelsTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartImportLabelsTaskRunResponse> {
			return Axios.post<StartImportLabelsTaskRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartImportLabelsTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartJobRun(requestBody: StartJobRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartJobRunResponse> {
			return Axios.post<StartJobRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartJobRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartMLEvaluationTaskRun(requestBody: StartMLEvaluationTaskRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartMLEvaluationTaskRunResponse> {
			return Axios.post<StartMLEvaluationTaskRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartMLEvaluationTaskRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartTrigger(requestBody: StartTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTriggerResponse> {
			return Axios.post<StartTriggerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartWorkflowRun(requestBody: StartWorkflowRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartWorkflowRunResponse> {
			return Axios.post<StartWorkflowRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StartWorkflowRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopCrawler(requestBody: StopCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<StopCrawlerResponse> {
			return Axios.post<StopCrawlerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StopCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopCrawlerSchedule(requestBody: StopCrawlerScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<StopCrawlerScheduleResponse> {
			return Axios.post<StopCrawlerScheduleResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StopCrawlerSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopTrigger(requestBody: StopTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<StopTriggerResponse> {
			return Axios.post<StopTriggerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StopTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopWorkflowRun(requestBody: StopWorkflowRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StopWorkflowRunResponse> {
			return Axios.post<StopWorkflowRunResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.StopWorkflowRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateClassifier(requestBody: UpdateClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateClassifierResponse> {
			return Axios.post<UpdateClassifierResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateConnection(requestBody: UpdateConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateConnectionResponse> {
			return Axios.post<UpdateConnectionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateCrawler(requestBody: UpdateCrawlerRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCrawlerResponse> {
			return Axios.post<UpdateCrawlerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateCrawler', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateCrawlerSchedule(requestBody: UpdateCrawlerScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCrawlerScheduleResponse> {
			return Axios.post<UpdateCrawlerScheduleResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateCrawlerSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDatabase(requestBody: UpdateDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDatabaseResponse> {
			return Axios.post<UpdateDatabaseResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDevEndpoint(requestBody: UpdateDevEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDevEndpointResponse> {
			return Axios.post<UpdateDevEndpointResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateDevEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateJob(requestBody: UpdateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateJobResponse> {
			return Axios.post<UpdateJobResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateMLTransform(requestBody: UpdateMLTransformRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMLTransformResponse> {
			return Axios.post<UpdateMLTransformResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateMLTransform', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdatePartition(requestBody: UpdatePartitionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdatePartitionResponse> {
			return Axios.post<UpdatePartitionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdatePartition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateTable(requestBody: UpdateTableRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTableResponse> {
			return Axios.post<UpdateTableResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateTrigger(requestBody: UpdateTriggerRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTriggerResponse> {
			return Axios.post<UpdateTriggerResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateTrigger', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateUserDefinedFunction(requestBody: UpdateUserDefinedFunctionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserDefinedFunctionResponse> {
			return Axios.post<UpdateUserDefinedFunctionResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateUserDefinedFunction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateWorkflow(requestBody: UpdateWorkflowRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateWorkflowResponse> {
			return Axios.post<UpdateWorkflowResponse>(this.baseUri + '/#X-Amz-Target=AWSGlue.UpdateWorkflow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
