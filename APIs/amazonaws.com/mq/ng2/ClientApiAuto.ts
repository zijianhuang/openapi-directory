...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateBroker(requestBody: CreateBrokerBody, headersHandler?: () => HttpHeaders): Observable<CreateBrokerResponse> {
			return this.http.post<CreateBrokerResponse>(this.baseUri + '/v1/brokers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListBrokers(maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListBrokersResponse> {
			return this.http.get<ListBrokersResponse>(this.baseUri + '/v1/brokers?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListConfigurations(maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListConfigurationsResponse> {
			return this.http.get<ListConfigurationsResponse>(this.baseUri + '/v1/configurations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTags(resource_arn: string, headersHandler?: () => HttpHeaders): Observable<ListTagsResponse> {
			return this.http.get<ListTagsResponse>(this.baseUri + '/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateUser(broker_id: string, username: string, requestBody: CreateUserBody, headersHandler?: () => HttpHeaders): Observable<CreateUserResponse> {
			return this.http.post<CreateUserResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteUser(broker_id: string, username: string, headersHandler?: () => HttpHeaders): Observable<DeleteUserResponse> {
			return this.http.delete<DeleteUserResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeUser(broker_id: string, username: string, headersHandler?: () => HttpHeaders): Observable<DescribeUserResponse> {
			return this.http.get<DescribeUserResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateUser(broker_id: string, username: string, requestBody: UpdateUserBody, headersHandler?: () => HttpHeaders): Observable<UpdateUserResponse> {
		 ...
		 */
		DeleteBroker(broker_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteBrokerResponse> {
			return this.http.delete<DeleteBrokerResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeBroker(broker_id: string, headersHandler?: () => HttpHeaders): Observable<DescribeBrokerResponse> {
			return this.http.get<DescribeBrokerResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateBroker(broker_id: string, requestBody: UpdateBrokerBody, headersHandler?: () => HttpHeaders): Observable<UpdateBrokerResponse> {
			return this.http.put<UpdateBrokerResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeBrokerEngineTypes(engineType: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<DescribeBrokerEngineTypesResponse> {
			return this.http.get<DescribeBrokerEngineTypesResponse>(this.baseUri + '/v1/broker-engine-types?engineType=' + (engineType == null ? '' : encodeURIComponent(engineType)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeBrokerInstanceOptions(engineType: string, hostInstanceType: string, maxResults: number, nextToken: string, storageType: string, headersHandler?: () => HttpHeaders): Observable<DescribeBrokerInstanceOptionsResponse> {
		 ...
		 */
		DescribeConfiguration(configuration_id: string, headersHandler?: () => HttpHeaders): Observable<DescribeConfigurationResponse> {
			return this.http.get<DescribeConfigurationResponse>(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateConfiguration(configuration_id: string, requestBody: UpdateConfigurationBody, headersHandler?: () => HttpHeaders): Observable<UpdateConfigurationResponse> {
			return this.http.put<UpdateConfigurationResponse>(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigurationRevision(configuration_id: string, configuration_revision: string, headersHandler?: () => HttpHeaders): Observable<DescribeConfigurationRevisionResponse> {
			return this.http.get<DescribeConfigurationRevisionResponse>(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)) + '/revisions/' + (configuration_revision == null ? '' : encodeURIComponent(configuration_revision)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListConfigurationRevisions(configuration_id: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListConfigurationRevisionsResponse> {
			return this.http.get<ListConfigurationRevisionsResponse>(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)) + '/revisions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListUsers(broker_id: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListUsersResponse> {
			return this.http.get<ListUsersResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RebootBroker(broker_id: string, headersHandler?: () => HttpHeaders): Observable<RebootBrokerResponse> {
			return this.http.post<RebootBrokerResponse>(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/reboot', null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
