...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBroker(requestBody: CreateBrokerBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBrokerResponse> {
			return this.http.post('/v1/brokers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListBrokers(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBrokersResponse> {
			return this.http.get('/v1/brokers?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListConfigurations(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationsResponse> {
			return this.http.get('/v1/configurations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateUser(broker_id: string, username: string, requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}): Promise<CreateUserResponse> {
			return this.http.post('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUser(broker_id: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserResponse> {
			return this.http.delete('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeUser(broker_id: string, username: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserResponse> {
			return this.http.get('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateUser(broker_id: string, username: string, requestBody: UpdateUserBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserResponse> {
			return this.http.put('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteBroker(broker_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBrokerResponse> {
			return this.http.delete('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBroker(broker_id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBrokerResponse> {
			return this.http.get('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBroker(broker_id: string, requestBody: UpdateBrokerBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBrokerResponse> {
			return this.http.put('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeBrokerEngineTypes(engineType: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBrokerEngineTypesResponse> {
			return this.http.get('/v1/broker-engine-types?engineType=' + (engineType == null ? '' : encodeURIComponent(engineType)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBrokerInstanceOptions(engineType: string, hostInstanceType: string, maxResults: number, nextToken: string, storageType: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBrokerInstanceOptionsResponse> {
			return this.http.get('/v1/broker-instance-options?engineType=' + (engineType == null ? '' : encodeURIComponent(engineType)) + '&hostInstanceType=' + (hostInstanceType == null ? '' : encodeURIComponent(hostInstanceType)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&storageType=' + (storageType == null ? '' : encodeURIComponent(storageType)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeConfiguration(configuration_id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationResponse> {
			return this.http.get('/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateConfiguration(configuration_id: string, requestBody: UpdateConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateConfigurationResponse> {
			return this.http.put('/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigurationRevision(configuration_id: string, configuration_revision: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationRevisionResponse> {
			return this.http.get('/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)) + '/revisions/' + (configuration_revision == null ? '' : encodeURIComponent(configuration_revision)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListConfigurationRevisions(configuration_id: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationRevisionsResponse> {
			return this.http.get('/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)) + '/revisions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListUsers(broker_id: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListUsersResponse> {
			return this.http.get('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RebootBroker(broker_id: string, headersHandler?: () => {[header: string]: string}): Promise<RebootBrokerResponse> {
			return this.http.post('/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/reboot', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
