...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateBroker(callback: (data : CreateBrokerResponse) => any, requestBody: CreateBrokerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/brokers', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListBrokers(maxResults: number, nextToken: string, callback: (data : ListBrokersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/brokers?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListConfigurations(maxResults: number, nextToken: string, callback: (data : ListConfigurationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/configurations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListTags(resource_arn: string, callback: (data : ListTagsResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		CreateUser(broker_id: string, username: string, callback: (data : CreateUserResponse) => any, requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteUser(broker_id: string, username: string, callback: (data : DeleteUserResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeUser(broker_id: string, username: string, callback: (data : DescribeUserResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateUser(broker_id: string, username: string, callback: (data : UpdateUserResponse) => any, requestBody: UpdateUserBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users/' + (username == null ? '' : encodeURIComponent(username)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteBroker(broker_id: string, callback: (data : DeleteBrokerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeBroker(broker_id: string, callback: (data : DescribeBrokerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateBroker(broker_id: string, callback: (data : UpdateBrokerResponse) => any, requestBody: UpdateBrokerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeBrokerEngineTypes(engineType: string, maxResults: number, nextToken: string, callback: (data : DescribeBrokerEngineTypesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/broker-engine-types?engineType=' + (engineType == null ? '' : encodeURIComponent(engineType)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeBrokerInstanceOptions(engineType: string, hostInstanceType: string, maxResults: number, nextToken: string, storageType: string, callback: (data : DescribeBrokerInstanceOptionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/broker-instance-options?engineType=' + (engineType == null ? '' : encodeURIComponent(engineType)) + '&hostInstanceType=' + (hostInstanceType == null ? '' : encodeURIComponent(hostInstanceType)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&storageType=' + (storageType == null ? '' : encodeURIComponent(storageType)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeConfiguration(configuration_id: string, callback: (data : DescribeConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateConfiguration(configuration_id: string, callback: (data : UpdateConfigurationResponse) => any, requestBody: UpdateConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeConfigurationRevision(configuration_id: string, configuration_revision: string, callback: (data : DescribeConfigurationRevisionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)) + '/revisions/' + (configuration_revision == null ? '' : encodeURIComponent(configuration_revision)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListConfigurationRevisions(configuration_id: string, maxResults: number, nextToken: string, callback: (data : ListConfigurationRevisionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/configurations/' + (configuration_id == null ? '' : encodeURIComponent(configuration_id)) + '/revisions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListUsers(broker_id: string, maxResults: number, nextToken: string, callback: (data : ListUsersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/users&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		RebootBroker(broker_id: string, callback: (data : RebootBrokerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/brokers/' + (broker_id == null ? '' : encodeURIComponent(broker_id)) + '/reboot', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
