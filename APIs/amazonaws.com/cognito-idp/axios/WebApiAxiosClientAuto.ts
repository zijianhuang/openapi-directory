...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddCustomAttributes(requestBody: AddCustomAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<AddCustomAttributesResponse> {
			return Axios.post<AddCustomAttributesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AddCustomAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		AdminAddUserToGroup(requestBody: AdminAddUserToGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminAddUserToGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		AdminConfirmSignUp(requestBody: AdminConfirmSignUpRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminConfirmSignUpResponse> {
			return Axios.post<AdminConfirmSignUpResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminConfirmSignUp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminCreateUser(requestBody: AdminCreateUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminCreateUserResponse> {
			return Axios.post<AdminCreateUserResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminCreateUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		AdminDeleteUser(requestBody: AdminDeleteUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminDeleteUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		AdminDeleteUserAttributes(requestBody: AdminDeleteUserAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminDeleteUserAttributesResponse> {
			return Axios.post<AdminDeleteUserAttributesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminDeleteUserAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminDisableProviderForUser(requestBody: AdminDisableProviderForUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminDisableProviderForUserResponse> {
			return Axios.post<AdminDisableProviderForUserResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminDisableProviderForUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminDisableUser(requestBody: AdminDisableUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminDisableUserResponse> {
			return Axios.post<AdminDisableUserResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminDisableUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminEnableUser(requestBody: AdminEnableUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminEnableUserResponse> {
			return Axios.post<AdminEnableUserResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminEnableUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		AdminForgetDevice(requestBody: AdminForgetDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminForgetDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		AdminGetDevice(requestBody: AdminGetDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminGetDeviceResponse> {
			return Axios.post<AdminGetDeviceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminGetDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminGetUser(requestBody: AdminGetUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminGetUserResponse> {
			return Axios.post<AdminGetUserResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminGetUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminInitiateAuth(requestBody: AdminInitiateAuthRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminInitiateAuthResponse> {
			return Axios.post<AdminInitiateAuthResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminInitiateAuth', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminLinkProviderForUser(requestBody: AdminLinkProviderForUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminLinkProviderForUserResponse> {
			return Axios.post<AdminLinkProviderForUserResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminLinkProviderForUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminListDevices(requestBody: AdminListDevicesRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminListDevicesResponse> {
			return Axios.post<AdminListDevicesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminListDevices', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminListUserAuthEvents(MaxResults: string, NextToken: string, requestBody: AdminListUserAuthEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminListUserAuthEventsResponse> {
			return Axios.post<AdminListUserAuthEventsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminListUserAuthEvents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		AdminRemoveUserFromGroup(requestBody: AdminRemoveUserFromGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminRemoveUserFromGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		AdminResetUserPassword(requestBody: AdminResetUserPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminResetUserPasswordResponse> {
			return Axios.post<AdminResetUserPasswordResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminResetUserPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminRespondToAuthChallenge(requestBody: AdminRespondToAuthChallengeRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminRespondToAuthChallengeResponse> {
			return Axios.post<AdminRespondToAuthChallengeResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminRespondToAuthChallenge', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminSetUserMFAPreference(requestBody: AdminSetUserMFAPreferenceRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminSetUserMFAPreferenceResponse> {
			return Axios.post<AdminSetUserMFAPreferenceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminSetUserMFAPreference', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminSetUserSettings(requestBody: AdminSetUserSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminSetUserSettingsResponse> {
			return Axios.post<AdminSetUserSettingsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminSetUserSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminUpdateAuthEventFeedback(requestBody: AdminUpdateAuthEventFeedbackRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminUpdateAuthEventFeedbackResponse> {
			return Axios.post<AdminUpdateAuthEventFeedbackResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminUpdateAuthEventFeedback', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminUpdateDeviceStatus(requestBody: AdminUpdateDeviceStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminUpdateDeviceStatusResponse> {
			return Axios.post<AdminUpdateDeviceStatusResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminUpdateDeviceStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminUpdateUserAttributes(requestBody: AdminUpdateUserAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminUpdateUserAttributesResponse> {
			return Axios.post<AdminUpdateUserAttributesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminUpdateUserAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AdminUserGlobalSignOut(requestBody: AdminUserGlobalSignOutRequest, headersHandler?: () => {[header: string]: string}): Promise<AdminUserGlobalSignOutResponse> {
			return Axios.post<AdminUserGlobalSignOutResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AdminUserGlobalSignOut', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateSoftwareToken(requestBody: AssociateSoftwareTokenRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateSoftwareTokenResponse> {
			return Axios.post<AssociateSoftwareTokenResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.AssociateSoftwareToken', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ChangePassword(requestBody: ChangePasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<ChangePasswordResponse> {
			return Axios.post<ChangePasswordResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ChangePassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmDevice(requestBody: ConfirmDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmDeviceResponse> {
			return Axios.post<ConfirmDeviceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ConfirmDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmForgotPassword(requestBody: ConfirmForgotPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmForgotPasswordResponse> {
			return Axios.post<ConfirmForgotPasswordResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ConfirmForgotPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmSignUp(requestBody: ConfirmSignUpRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmSignUpResponse> {
			return Axios.post<ConfirmSignUpResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ConfirmSignUp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateGroup(requestBody: CreateGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateGroupResponse> {
			return Axios.post<CreateGroupResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.CreateGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateResourceServer(requestBody: CreateResourceServerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceServerResponse> {
			return Axios.post<CreateResourceServerResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.CreateResourceServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUserPool(requestBody: CreateUserPoolRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserPoolResponse> {
			return Axios.post<CreateUserPoolResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.CreateUserPool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUserPoolDomain(requestBody: CreateUserPoolDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserPoolDomainResponse> {
			return Axios.post<CreateUserPoolDomainResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.CreateUserPoolDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteGroup(requestBody: DeleteGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteIdentityProvider(requestBody: DeleteIdentityProviderRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteIdentityProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteResourceServer(requestBody: DeleteResourceServerRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteResourceServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DeleteUser(requestBody: DeleteUserRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DeleteUserAttributes(requestBody: DeleteUserAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserAttributesResponse> {
			return Axios.post<DeleteUserAttributesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteUserAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteUserPool(requestBody: DeleteUserPoolRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteUserPool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteUserPoolClient(requestBody: DeleteUserPoolClientRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteUserPoolClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DeleteUserPoolDomain(requestBody: DeleteUserPoolDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserPoolDomainResponse> {
			return Axios.post<DeleteUserPoolDomainResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DeleteUserPoolDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeResourceServer(requestBody: DescribeResourceServerRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourceServerResponse> {
			return Axios.post<DescribeResourceServerResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DescribeResourceServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeRiskConfiguration(requestBody: DescribeRiskConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRiskConfigurationResponse> {
			return Axios.post<DescribeRiskConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DescribeRiskConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeUserImportJob(requestBody: DescribeUserImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserImportJobResponse> {
			return Axios.post<DescribeUserImportJobResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DescribeUserImportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeUserPool(requestBody: DescribeUserPoolRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserPoolResponse> {
			return Axios.post<DescribeUserPoolResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DescribeUserPool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeUserPoolClient(requestBody: DescribeUserPoolClientRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserPoolClientResponse> {
			return Axios.post<DescribeUserPoolClientResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DescribeUserPoolClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeUserPoolDomain(requestBody: DescribeUserPoolDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserPoolDomainResponse> {
			return Axios.post<DescribeUserPoolDomainResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.DescribeUserPoolDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		ForgetDevice(requestBody: ForgetDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ForgetDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ForgotPassword(requestBody: ForgotPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<ForgotPasswordResponse> {
			return Axios.post<ForgotPasswordResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ForgotPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCSVHeader(requestBody: GetCSVHeaderRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCSVHeaderResponse> {
			return Axios.post<GetCSVHeaderResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetCSVHeader', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDevice(requestBody: GetDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeviceResponse> {
			return Axios.post<GetDeviceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetGroup(requestBody: GetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<GetGroupResponse> {
			return Axios.post<GetGroupResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetIdentityProviderByIdentifier(requestBody: GetIdentityProviderByIdentifierRequest, headersHandler?: () => {[header: string]: string}): Promise<GetIdentityProviderByIdentifierResponse> {
			return Axios.post<GetIdentityProviderByIdentifierResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetIdentityProviderByIdentifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSigningCertificate(requestBody: GetSigningCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSigningCertificateResponse> {
			return Axios.post<GetSigningCertificateResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetSigningCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUICustomization(requestBody: GetUICustomizationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUICustomizationResponse> {
			return Axios.post<GetUICustomizationResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetUICustomization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUser(requestBody: GetUserRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUserResponse> {
			return Axios.post<GetUserResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUserAttributeVerificationCode(requestBody: GetUserAttributeVerificationCodeRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUserAttributeVerificationCodeResponse> {
			return Axios.post<GetUserAttributeVerificationCodeResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetUserAttributeVerificationCode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUserPoolMfaConfig(requestBody: GetUserPoolMfaConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUserPoolMfaConfigResponse> {
			return Axios.post<GetUserPoolMfaConfigResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GetUserPoolMfaConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GlobalSignOut(requestBody: GlobalSignOutRequest, headersHandler?: () => {[header: string]: string}): Promise<GlobalSignOutResponse> {
			return Axios.post<GlobalSignOutResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.GlobalSignOut', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InitiateAuth(requestBody: InitiateAuthRequest, headersHandler?: () => {[header: string]: string}): Promise<InitiateAuthResponse> {
			return Axios.post<InitiateAuthResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.InitiateAuth', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDevices(requestBody: ListDevicesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDevicesResponse> {
			return Axios.post<ListDevicesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListDevices', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListGroups(Limit: string, NextToken: string, requestBody: ListGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGroupsResponse> {
			return Axios.post<ListGroupsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListGroups?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListIdentityProviders(MaxResults: string, NextToken: string, requestBody: ListIdentityProvidersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListIdentityProvidersResponse> {
			return Axios.post<ListIdentityProvidersResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListIdentityProviders?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListResourceServers(MaxResults: string, NextToken: string, requestBody: ListResourceServersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceServersResponse> {
			return Axios.post<ListResourceServersResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListResourceServers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUserImportJobs(requestBody: ListUserImportJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUserImportJobsResponse> {
			return Axios.post<ListUserImportJobsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListUserImportJobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUserPoolClients(MaxResults: string, NextToken: string, requestBody: ListUserPoolClientsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUserPoolClientsResponse> {
			return Axios.post<ListUserPoolClientsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListUserPoolClients?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUserPools(MaxResults: string, NextToken: string, requestBody: ListUserPoolsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUserPoolsResponse> {
			return Axios.post<ListUserPoolsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListUserPools?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUsers(Limit: string, PaginationToken: string, requestBody: ListUsersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUsersResponse> {
			return Axios.post<ListUsersResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListUsers?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&PaginationToken=' + (PaginationToken == null ? '' : encodeURIComponent(PaginationToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUsersInGroup(Limit: string, NextToken: string, requestBody: ListUsersInGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUsersInGroupResponse> {
			return Axios.post<ListUsersInGroupResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ListUsersInGroup?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ResendConfirmationCode(requestBody: ResendConfirmationCodeRequest, headersHandler?: () => {[header: string]: string}): Promise<ResendConfirmationCodeResponse> {
			return Axios.post<ResendConfirmationCodeResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.ResendConfirmationCode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RespondToAuthChallenge(requestBody: RespondToAuthChallengeRequest, headersHandler?: () => {[header: string]: string}): Promise<RespondToAuthChallengeResponse> {
			return Axios.post<RespondToAuthChallengeResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.RespondToAuthChallenge', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SetRiskConfiguration(requestBody: SetRiskConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<SetRiskConfigurationResponse> {
			return Axios.post<SetRiskConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.SetRiskConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SetUserPoolMfaConfig(requestBody: SetUserPoolMfaConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<SetUserPoolMfaConfigResponse> {
			return Axios.post<SetUserPoolMfaConfigResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.SetUserPoolMfaConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SetUserSettings(requestBody: SetUserSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<SetUserSettingsResponse> {
			return Axios.post<SetUserSettingsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.SetUserSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SignUp(requestBody: SignUpRequest, headersHandler?: () => {[header: string]: string}): Promise<SignUpResponse> {
			return Axios.post<SignUpResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.SignUp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopUserImportJob(requestBody: StopUserImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopUserImportJobResponse> {
			return Axios.post<StopUserImportJobResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.StopUserImportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAuthEventFeedback(requestBody: UpdateAuthEventFeedbackRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAuthEventFeedbackResponse> {
			return Axios.post<UpdateAuthEventFeedbackResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.UpdateAuthEventFeedback', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateGroup(requestBody: UpdateGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateGroupResponse> {
			return Axios.post<UpdateGroupResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.UpdateGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateIdentityProvider(requestBody: UpdateIdentityProviderRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateIdentityProviderResponse> {
			return Axios.post<UpdateIdentityProviderResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.UpdateIdentityProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateUserAttributes(requestBody: UpdateUserAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserAttributesResponse> {
			return Axios.post<UpdateUserAttributesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.UpdateUserAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateUserPool(requestBody: UpdateUserPoolRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserPoolResponse> {
			return Axios.post<UpdateUserPoolResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.UpdateUserPool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateUserPoolDomain(requestBody: UpdateUserPoolDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserPoolDomainResponse> {
			return Axios.post<UpdateUserPoolDomainResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.UpdateUserPoolDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		VerifySoftwareToken(requestBody: VerifySoftwareTokenRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifySoftwareTokenResponse> {
			return Axios.post<VerifySoftwareTokenResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.VerifySoftwareToken', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		VerifyUserAttribute(requestBody: VerifyUserAttributeRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifyUserAttributeResponse> {
			return Axios.post<VerifyUserAttributeResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityProviderService.VerifyUserAttribute', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
