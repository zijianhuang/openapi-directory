...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBatchInferenceJob(requestBody: CreateBatchInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBatchInferenceJobResponse> {
			return Axios.post<CreateBatchInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateBatchInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateCampaign(requestBody: CreateCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCampaignResponse> {
			return Axios.post<CreateCampaignResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateCampaign', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDataset(requestBody: CreateDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetResponse> {
			return Axios.post<CreateDatasetResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateDataset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDatasetGroup(requestBody: CreateDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetGroupResponse> {
			return Axios.post<CreateDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDatasetImportJob(requestBody: CreateDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetImportJobResponse> {
			return Axios.post<CreateDatasetImportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateEventTracker(requestBody: CreateEventTrackerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEventTrackerResponse> {
			return Axios.post<CreateEventTrackerResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateEventTracker', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateFilter(requestBody: CreateFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFilterResponse> {
			return Axios.post<CreateFilterResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSchema(requestBody: CreateSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSchemaResponse> {
			return Axios.post<CreateSchemaResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateSchema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSolution(requestBody: CreateSolutionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSolutionResponse> {
			return Axios.post<CreateSolutionResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateSolution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSolutionVersion(requestBody: CreateSolutionVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSolutionVersionResponse> {
			return Axios.post<CreateSolutionVersionResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateSolutionVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCampaign(requestBody: DeleteCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteCampaign', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDataset(requestBody: DeleteDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteDataset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDatasetGroup(requestBody: DeleteDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEventTracker(requestBody: DeleteEventTrackerRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteEventTracker', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteFilter(requestBody: DeleteFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteSchema(requestBody: DeleteSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteSchema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteSolution(requestBody: DeleteSolutionRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteSolution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DescribeAlgorithm(requestBody: DescribeAlgorithmRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAlgorithmResponse> {
			return Axios.post<DescribeAlgorithmResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeAlgorithm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeBatchInferenceJob(requestBody: DescribeBatchInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBatchInferenceJobResponse> {
			return Axios.post<DescribeBatchInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeBatchInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeCampaign(requestBody: DescribeCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCampaignResponse> {
			return Axios.post<DescribeCampaignResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeCampaign', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDataset(requestBody: DescribeDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return Axios.post<DescribeDatasetResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeDataset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDatasetGroup(requestBody: DescribeDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetGroupResponse> {
			return Axios.post<DescribeDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDatasetImportJob(requestBody: DescribeDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetImportJobResponse> {
			return Axios.post<DescribeDatasetImportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEventTracker(requestBody: DescribeEventTrackerRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventTrackerResponse> {
			return Axios.post<DescribeEventTrackerResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeEventTracker', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeFilter(requestBody: DescribeFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFilterResponse> {
			return Axios.post<DescribeFilterResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeRecipe(requestBody: DescribeRecipeRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecipeResponse> {
			return Axios.post<DescribeRecipeResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeRecipe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSchema(requestBody: DescribeSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSchemaResponse> {
			return Axios.post<DescribeSchemaResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeSchema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSolution(requestBody: DescribeSolutionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSolutionResponse> {
			return Axios.post<DescribeSolutionResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeSolution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSolutionVersion(requestBody: DescribeSolutionVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSolutionVersionResponse> {
			return Axios.post<DescribeSolutionVersionResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeSolutionVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSolutionMetrics(requestBody: GetSolutionMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSolutionMetricsResponse> {
			return Axios.post<GetSolutionMetricsResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.GetSolutionMetrics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListBatchInferenceJobs(maxResults: string, nextToken: string, requestBody: ListBatchInferenceJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListBatchInferenceJobsResponse> {
			return Axios.post<ListBatchInferenceJobsResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListBatchInferenceJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCampaigns(maxResults: string, nextToken: string, requestBody: ListCampaignsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCampaignsResponse> {
			return Axios.post<ListCampaignsResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListCampaigns?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDatasetGroups(maxResults: string, nextToken: string, requestBody: ListDatasetGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetGroupsResponse> {
			return Axios.post<ListDatasetGroupsResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListDatasetGroups?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDatasetImportJobs(maxResults: string, nextToken: string, requestBody: ListDatasetImportJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetImportJobsResponse> {
			return Axios.post<ListDatasetImportJobsResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListDatasetImportJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEventTrackers(maxResults: string, nextToken: string, requestBody: ListEventTrackersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventTrackersResponse> {
			return Axios.post<ListEventTrackersResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListEventTrackers?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListFilters(requestBody: ListFiltersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListFiltersResponse> {
			return Axios.post<ListFiltersResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListFilters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRecipes(maxResults: string, nextToken: string, requestBody: ListRecipesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRecipesResponse> {
			return Axios.post<ListRecipesResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListRecipes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSchemas(maxResults: string, nextToken: string, requestBody: ListSchemasRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSchemasResponse> {
			return Axios.post<ListSchemasResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListSchemas?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSolutions(maxResults: string, nextToken: string, requestBody: ListSolutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSolutionsResponse> {
			return Axios.post<ListSolutionsResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListSolutions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateCampaign(requestBody: UpdateCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCampaignResponse> {
			return Axios.post<UpdateCampaignResponse>(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.UpdateCampaign', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
