export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBatchInferenceJob(requestBody: CreateBatchInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBatchInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateBatchInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateCampaign(requestBody: CreateCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCampaignResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateCampaign', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDataset(requestBody: CreateDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateDataset', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDatasetGroup(requestBody: CreateDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateDatasetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDatasetImportJob(requestBody: CreateDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetImportJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateDatasetImportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEventTracker(requestBody: CreateEventTrackerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEventTrackerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateEventTracker', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateFilter(requestBody: CreateFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFilterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSchema(requestBody: CreateSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSchemaResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateSchema', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSolution(requestBody: CreateSolutionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSolutionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateSolution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSolutionVersion(requestBody: CreateSolutionVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSolutionVersionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.CreateSolutionVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteCampaign(requestBody: DeleteCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteCampaign', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteDataset(requestBody: DeleteDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteDataset', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteDatasetGroup(requestBody: DeleteDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteDatasetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteEventTracker(requestBody: DeleteEventTrackerRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteEventTracker', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteFilter(requestBody: DeleteFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteSchema(requestBody: DeleteSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteSchema', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteSolution(requestBody: DeleteSolutionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DeleteSolution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeAlgorithm(requestBody: DescribeAlgorithmRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAlgorithmResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeAlgorithm', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeBatchInferenceJob(requestBody: DescribeBatchInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBatchInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeBatchInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeCampaign(requestBody: DescribeCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCampaignResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeCampaign', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDataset(requestBody: DescribeDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeDataset', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDatasetGroup(requestBody: DescribeDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeDatasetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDatasetImportJob(requestBody: DescribeDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetImportJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeDatasetImportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventTracker(requestBody: DescribeEventTrackerRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventTrackerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeEventTracker', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFeatureTransformation(requestBody: DescribeFeatureTransformationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFeatureTransformationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeFeatureTransformation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFilter(requestBody: DescribeFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFilterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRecipe(requestBody: DescribeRecipeRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecipeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeRecipe', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSchema(requestBody: DescribeSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSchemaResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeSchema', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSolution(requestBody: DescribeSolutionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSolutionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeSolution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSolutionVersion(requestBody: DescribeSolutionVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSolutionVersionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.DescribeSolutionVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSolutionMetrics(requestBody: GetSolutionMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSolutionMetricsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.GetSolutionMetrics', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBatchInferenceJobs(maxResults: string, nextToken: string, requestBody: ListBatchInferenceJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListBatchInferenceJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListBatchInferenceJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCampaigns(maxResults: string, nextToken: string, requestBody: ListCampaignsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCampaignsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListCampaigns?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDatasetGroups(maxResults: string, nextToken: string, requestBody: ListDatasetGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetGroupsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListDatasetGroups?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDatasetImportJobs(maxResults: string, nextToken: string, requestBody: ListDatasetImportJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetImportJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListDatasetImportJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListFilters(requestBody: ListFiltersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListFiltersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListFilters', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSchemas(maxResults: string, nextToken: string, requestBody: ListSchemasRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSchemasResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListSchemas?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSolutions(maxResults: string, nextToken: string, requestBody: ListSolutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSolutionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.ListSolutions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateCampaign(requestBody: UpdateCampaignRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCampaignResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonPersonalize.UpdateCampaign', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
