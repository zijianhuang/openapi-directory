...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<CreateChannelResponse> {
			return Axios.post<CreateChannelResponse>(this.baseUri + '/channels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListChannelsResponse> {
			return Axios.get<ListChannelsResponse>(this.baseUri + '/channels?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateHarvestJob(requestBody: CreateHarvestJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateHarvestJobResponse> {
			return Axios.post<CreateHarvestJobResponse>(this.baseUri + '/harvest_jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateOriginEndpoint(requestBody: CreateOriginEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<CreateOriginEndpointResponse> {
			return Axios.post<CreateOriginEndpointResponse>(this.baseUri + '/origin_endpoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteChannel(id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeChannel(id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeChannelResponse> {
			return Axios.get<DescribeChannelResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateChannel(id: string, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateChannelResponse> {
			return Axios.put<UpdateChannelResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteOriginEndpoint(id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeOriginEndpoint(id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeOriginEndpointResponse> {
			return Axios.get<DescribeOriginEndpointResponse>(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateOriginEndpoint(id: string, requestBody: UpdateOriginEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateOriginEndpointResponse> {
			return Axios.put<UpdateOriginEndpointResponse>(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeHarvestJob(id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeHarvestJobResponse> {
			return Axios.get<DescribeHarvestJobResponse>(this.baseUri + '/harvest_jobs/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RotateChannelCredentials(id: string, headersHandler?: () => {[header: string]: string}): Promise<RotateChannelCredentialsResponse> {
			return Axios.put<RotateChannelCredentialsResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/credentials', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RotateIngestEndpointCredentials(id: string, ingest_endpoint_id: string, headersHandler?: () => {[header: string]: string}): Promise<RotateIngestEndpointCredentialsResponse> {
			return Axios.put<RotateIngestEndpointCredentialsResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/ingest_endpoints/' + (ingest_endpoint_id == null ? '' : encodeURIComponent(ingest_endpoint_id)) + '/credentials', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
