...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => HttpHeaders): Observable<CreateChannelResponse> {
			return this.http.post<CreateChannelResponse>(this.baseUri + '/channels', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListChannelsResponse> {
			return this.http.get<ListChannelsResponse>(this.baseUri + '/channels?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateHarvestJob(requestBody: CreateHarvestJobBody, headersHandler?: () => HttpHeaders): Observable<CreateHarvestJobResponse> {
			return this.http.post<CreateHarvestJobResponse>(this.baseUri + '/harvest_jobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListHarvestJobs(includeChannelId: string, includeStatus: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListHarvestJobsResponse> {
		 ...
		 */
		CreateOriginEndpoint(requestBody: CreateOriginEndpointBody, headersHandler?: () => HttpHeaders): Observable<CreateOriginEndpointResponse> {
			return this.http.post<CreateOriginEndpointResponse>(this.baseUri + '/origin_endpoints', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListOriginEndpoints(channelId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListOriginEndpointsResponse> {
			return this.http.get<ListOriginEndpointsResponse>(this.baseUri + '/origin_endpoints?channelId=' + (channelId == null ? '' : encodeURIComponent(channelId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteChannel(id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeChannel(id: string, headersHandler?: () => HttpHeaders): Observable<DescribeChannelResponse> {
			return this.http.get<DescribeChannelResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateChannel(id: string, requestBody: UpdateChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateChannelResponse> {
			return this.http.put<UpdateChannelResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteOriginEndpoint(id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeOriginEndpoint(id: string, headersHandler?: () => HttpHeaders): Observable<DescribeOriginEndpointResponse> {
			return this.http.get<DescribeOriginEndpointResponse>(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateOriginEndpoint(id: string, requestBody: UpdateOriginEndpointBody, headersHandler?: () => HttpHeaders): Observable<UpdateOriginEndpointResponse> {
			return this.http.put<UpdateOriginEndpointResponse>(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeHarvestJob(id: string, headersHandler?: () => HttpHeaders): Observable<DescribeHarvestJobResponse> {
			return this.http.get<DescribeHarvestJobResponse>(this.baseUri + '/harvest_jobs/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListTagsForResource(resource_arn: string, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.get<ListTagsForResourceResponse>(this.baseUri + '/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		RotateChannelCredentials(id: string, headersHandler?: () => HttpHeaders): Observable<RotateChannelCredentialsResponse> {
			return this.http.put<RotateChannelCredentialsResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/credentials', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RotateIngestEndpointCredentials(id: string, ingest_endpoint_id: string, headersHandler?: () => HttpHeaders): Observable<RotateIngestEndpointCredentialsResponse> {
			return this.http.put<RotateIngestEndpointCredentialsResponse>(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/ingest_endpoints/' + (ingest_endpoint_id == null ? '' : encodeURIComponent(ingest_endpoint_id)) + '/credentials', null, { headers: headersHandler ? headersHandler() : undefined });
		}
