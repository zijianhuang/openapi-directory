...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateChannel(callback: (data : CreateChannelResponse) => any, requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}) {
		...
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListChannelsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/channels?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateHarvestJob(callback: (data : CreateHarvestJobResponse) => any, requestBody: CreateHarvestJobBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/harvest_jobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListHarvestJobs(includeChannelId: string, includeStatus: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListHarvestJobsResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		CreateOriginEndpoint(callback: (data : CreateOriginEndpointResponse) => any, requestBody: CreateOriginEndpointBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/origin_endpoints', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListOriginEndpoints(channelId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListOriginEndpointsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/origin_endpoints?channelId=' + (channelId == null ? '' : encodeURIComponent(channelId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteChannel(id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeChannel(id: string, callback: (data : DescribeChannelResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateChannel(id: string, callback: (data : UpdateChannelResponse) => any, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteOriginEndpoint(id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeOriginEndpoint(id: string, callback: (data : DescribeOriginEndpointResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateOriginEndpoint(id: string, callback: (data : UpdateOriginEndpointResponse) => any, requestBody: UpdateOriginEndpointBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeHarvestJob(id: string, callback: (data : DescribeHarvestJobResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/harvest_jobs/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		RotateChannelCredentials(id: string, callback: (data : RotateChannelCredentialsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/credentials', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RotateIngestEndpointCredentials(id: string, ingest_endpoint_id: string, callback: (data : RotateIngestEndpointCredentialsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/ingest_endpoints/' + (ingest_endpoint_id == null ? '' : encodeURIComponent(ingest_endpoint_id)) + '/credentials', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
