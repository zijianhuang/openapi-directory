...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<CreateChannelResponse> {
			return this.http.post('/channels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListChannelsResponse> {
			return this.http.get('/channels?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateHarvestJob(requestBody: CreateHarvestJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateHarvestJobResponse> {
			return this.http.post('/harvest_jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateOriginEndpoint(requestBody: CreateOriginEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<CreateOriginEndpointResponse> {
			return this.http.post('/origin_endpoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListOriginEndpoints(channelId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListOriginEndpointsResponse> {
			return this.http.get('/origin_endpoints?channelId=' + (channelId == null ? '' : encodeURIComponent(channelId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteChannel(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/channels/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeChannel(id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeChannelResponse> {
			return this.http.get('/channels/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateChannel(id: string, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateChannelResponse> {
			return this.http.put('/channels/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteOriginEndpoint(id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeOriginEndpoint(id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeOriginEndpointResponse> {
			return this.http.get('/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateOriginEndpoint(id: string, requestBody: UpdateOriginEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateOriginEndpointResponse> {
			return this.http.put('/origin_endpoints/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeHarvestJob(id: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeHarvestJobResponse> {
			return this.http.get('/harvest_jobs/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RotateChannelCredentials(id: string, headersHandler?: () => {[header: string]: string}): Promise<RotateChannelCredentialsResponse> {
			return this.http.put('/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/credentials', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RotateIngestEndpointCredentials(id: string, ingest_endpoint_id: string, headersHandler?: () => {[header: string]: string}): Promise<RotateIngestEndpointCredentialsResponse> {
			return this.http.put('/channels/' + (id == null ? '' : encodeURIComponent(id)) + '/ingest_endpoints/' + (ingest_endpoint_id == null ? '' : encodeURIComponent(ingest_endpoint_id)) + '/credentials', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
