...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AssociateApprovalRuleTemplateWithRepository(requestBody: AssociateApprovalRuleTemplateWithRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.AssociateApprovalRuleTemplateWithRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		BatchDescribeMergeConflicts(requestBody: BatchDescribeMergeConflictsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchDescribeMergeConflictsOutput> {
			return Axios.post<BatchDescribeMergeConflictsOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchDescribeMergeConflicts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDisassociateApprovalRuleTemplateFromRepositories(requestBody: BatchDisassociateApprovalRuleTemplateFromRepositoriesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput> {
			return Axios.post<BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchDisassociateApprovalRuleTemplateFromRepositories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetCommits(requestBody: BatchGetCommitsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetCommitsOutput> {
			return Axios.post<BatchGetCommitsOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchGetCommits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetRepositories(requestBody: BatchGetRepositoriesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetRepositoriesOutput> {
			return Axios.post<BatchGetRepositoriesOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchGetRepositories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateApprovalRuleTemplate(requestBody: CreateApprovalRuleTemplateInput, headersHandler?: () => {[header: string]: string}): Promise<CreateApprovalRuleTemplateOutput> {
			return Axios.post<CreateApprovalRuleTemplateOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateApprovalRuleTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		CreateBranch(requestBody: CreateBranchInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateBranch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		CreateCommit(requestBody: CreateCommitInput, headersHandler?: () => {[header: string]: string}): Promise<CreateCommitOutput> {
			return Axios.post<CreateCommitOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateCommit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePullRequest(requestBody: CreatePullRequestInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePullRequestOutput> {
			return Axios.post<CreatePullRequestOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreatePullRequest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePullRequestApprovalRule(requestBody: CreatePullRequestApprovalRuleInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePullRequestApprovalRuleOutput> {
			return Axios.post<CreatePullRequestApprovalRuleOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreatePullRequestApprovalRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRepository(requestBody: CreateRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<CreateRepositoryOutput> {
			return Axios.post<CreateRepositoryOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUnreferencedMergeCommit(requestBody: CreateUnreferencedMergeCommitInput, headersHandler?: () => {[header: string]: string}): Promise<CreateUnreferencedMergeCommitOutput> {
			return Axios.post<CreateUnreferencedMergeCommitOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateUnreferencedMergeCommit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApprovalRuleTemplate(requestBody: DeleteApprovalRuleTemplateInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteApprovalRuleTemplateOutput> {
			return Axios.post<DeleteApprovalRuleTemplateOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteApprovalRuleTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteBranch(requestBody: DeleteBranchInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteBranchOutput> {
			return Axios.post<DeleteBranchOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteBranch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteCommentContent(requestBody: DeleteCommentContentInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteCommentContentOutput> {
			return Axios.post<DeleteCommentContentOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteCommentContent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteFile(requestBody: DeleteFileInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteFileOutput> {
			return Axios.post<DeleteFileOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteFile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeletePullRequestApprovalRule(requestBody: DeletePullRequestApprovalRuleInput, headersHandler?: () => {[header: string]: string}): Promise<DeletePullRequestApprovalRuleOutput> {
			return Axios.post<DeletePullRequestApprovalRuleOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeletePullRequestApprovalRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRepository(requestBody: DeleteRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteRepositoryOutput> {
			return Axios.post<DeleteRepositoryOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMergeConflicts(maxMergeHunks: string, nextToken: string, requestBody: DescribeMergeConflictsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMergeConflictsOutput> {
			return Axios.post<DescribeMergeConflictsOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DescribeMergeConflicts?maxMergeHunks=' + (maxMergeHunks == null ? '' : encodeURIComponent(maxMergeHunks)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePullRequestEvents(maxResults: string, nextToken: string, requestBody: DescribePullRequestEventsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribePullRequestEventsOutput> {
			return Axios.post<DescribePullRequestEventsOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DescribePullRequestEvents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DisassociateApprovalRuleTemplateFromRepository(requestBody: DisassociateApprovalRuleTemplateFromRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DisassociateApprovalRuleTemplateFromRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		EvaluatePullRequestApprovalRules(requestBody: EvaluatePullRequestApprovalRulesInput, headersHandler?: () => {[header: string]: string}): Promise<EvaluatePullRequestApprovalRulesOutput> {
			return Axios.post<EvaluatePullRequestApprovalRulesOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.EvaluatePullRequestApprovalRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetApprovalRuleTemplate(requestBody: GetApprovalRuleTemplateInput, headersHandler?: () => {[header: string]: string}): Promise<GetApprovalRuleTemplateOutput> {
			return Axios.post<GetApprovalRuleTemplateOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetApprovalRuleTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetBlob(requestBody: GetBlobInput, headersHandler?: () => {[header: string]: string}): Promise<GetBlobOutput> {
			return Axios.post<GetBlobOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetBlob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetBranch(requestBody: GetBranchInput, headersHandler?: () => {[header: string]: string}): Promise<GetBranchOutput> {
			return Axios.post<GetBranchOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetBranch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetComment(requestBody: GetCommentInput, headersHandler?: () => {[header: string]: string}): Promise<GetCommentOutput> {
			return Axios.post<GetCommentOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetComment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCommit(requestBody: GetCommitInput, headersHandler?: () => {[header: string]: string}): Promise<GetCommitOutput> {
			return Axios.post<GetCommitOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetCommit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDifferences(MaxResults: string, NextToken: string, requestBody: GetDifferencesInput, headersHandler?: () => {[header: string]: string}): Promise<GetDifferencesOutput> {
			return Axios.post<GetDifferencesOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetDifferences?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFile(requestBody: GetFileInput, headersHandler?: () => {[header: string]: string}): Promise<GetFileOutput> {
			return Axios.post<GetFileOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetFile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFolder(requestBody: GetFolderInput, headersHandler?: () => {[header: string]: string}): Promise<GetFolderOutput> {
			return Axios.post<GetFolderOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetFolder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMergeCommit(requestBody: GetMergeCommitInput, headersHandler?: () => {[header: string]: string}): Promise<GetMergeCommitOutput> {
			return Axios.post<GetMergeCommitOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetMergeCommit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMergeConflicts(maxConflictFiles: string, nextToken: string, requestBody: GetMergeConflictsInput, headersHandler?: () => {[header: string]: string}): Promise<GetMergeConflictsOutput> {
			return Axios.post<GetMergeConflictsOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetMergeConflicts?maxConflictFiles=' + (maxConflictFiles == null ? '' : encodeURIComponent(maxConflictFiles)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMergeOptions(requestBody: GetMergeOptionsInput, headersHandler?: () => {[header: string]: string}): Promise<GetMergeOptionsOutput> {
			return Axios.post<GetMergeOptionsOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetMergeOptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPullRequest(requestBody: GetPullRequestInput, headersHandler?: () => {[header: string]: string}): Promise<GetPullRequestOutput> {
			return Axios.post<GetPullRequestOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetPullRequest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPullRequestApprovalStates(requestBody: GetPullRequestApprovalStatesInput, headersHandler?: () => {[header: string]: string}): Promise<GetPullRequestApprovalStatesOutput> {
			return Axios.post<GetPullRequestApprovalStatesOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetPullRequestApprovalStates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPullRequestOverrideState(requestBody: GetPullRequestOverrideStateInput, headersHandler?: () => {[header: string]: string}): Promise<GetPullRequestOverrideStateOutput> {
			return Axios.post<GetPullRequestOverrideStateOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetPullRequestOverrideState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRepository(requestBody: GetRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<GetRepositoryOutput> {
			return Axios.post<GetRepositoryOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRepositoryTriggers(requestBody: GetRepositoryTriggersInput, headersHandler?: () => {[header: string]: string}): Promise<GetRepositoryTriggersOutput> {
			return Axios.post<GetRepositoryTriggersOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetRepositoryTriggers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssociatedApprovalRuleTemplatesForRepository(maxResults: string, nextToken: string, requestBody: ListAssociatedApprovalRuleTemplatesForRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<ListAssociatedApprovalRuleTemplatesForRepositoryOutput> {
			return Axios.post<ListAssociatedApprovalRuleTemplatesForRepositoryOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.ListAssociatedApprovalRuleTemplatesForRepository?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListBranches(nextToken: string, requestBody: ListBranchesInput, headersHandler?: () => {[header: string]: string}): Promise<ListBranchesOutput> {
			return Axios.post<ListBranchesOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.ListBranches?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRepositories(nextToken: string, requestBody: ListRepositoriesInput, headersHandler?: () => {[header: string]: string}): Promise<ListRepositoriesOutput> {
			return Axios.post<ListRepositoriesOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.ListRepositories?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return Axios.post<ListTagsForResourceOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		MergeBranchesByFastForward(requestBody: MergeBranchesByFastForwardInput, headersHandler?: () => {[header: string]: string}): Promise<MergeBranchesByFastForwardOutput> {
			return Axios.post<MergeBranchesByFastForwardOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergeBranchesByFastForward', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		MergeBranchesBySquash(requestBody: MergeBranchesBySquashInput, headersHandler?: () => {[header: string]: string}): Promise<MergeBranchesBySquashOutput> {
			return Axios.post<MergeBranchesBySquashOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergeBranchesBySquash', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		MergeBranchesByThreeWay(requestBody: MergeBranchesByThreeWayInput, headersHandler?: () => {[header: string]: string}): Promise<MergeBranchesByThreeWayOutput> {
			return Axios.post<MergeBranchesByThreeWayOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergeBranchesByThreeWay', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		MergePullRequestByFastForward(requestBody: MergePullRequestByFastForwardInput, headersHandler?: () => {[header: string]: string}): Promise<MergePullRequestByFastForwardOutput> {
			return Axios.post<MergePullRequestByFastForwardOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergePullRequestByFastForward', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		MergePullRequestBySquash(requestBody: MergePullRequestBySquashInput, headersHandler?: () => {[header: string]: string}): Promise<MergePullRequestBySquashOutput> {
			return Axios.post<MergePullRequestBySquashOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergePullRequestBySquash', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		MergePullRequestByThreeWay(requestBody: MergePullRequestByThreeWayInput, headersHandler?: () => {[header: string]: string}): Promise<MergePullRequestByThreeWayOutput> {
			return Axios.post<MergePullRequestByThreeWayOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergePullRequestByThreeWay', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		OverridePullRequestApprovalRules(requestBody: OverridePullRequestApprovalRulesInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.OverridePullRequestApprovalRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		PostCommentForComparedCommit(requestBody: PostCommentForComparedCommitInput, headersHandler?: () => {[header: string]: string}): Promise<PostCommentForComparedCommitOutput> {
			return Axios.post<PostCommentForComparedCommitOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PostCommentForComparedCommit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PostCommentReply(requestBody: PostCommentReplyInput, headersHandler?: () => {[header: string]: string}): Promise<PostCommentReplyOutput> {
			return Axios.post<PostCommentReplyOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PostCommentReply', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutFile(requestBody: PutFileInput, headersHandler?: () => {[header: string]: string}): Promise<PutFileOutput> {
			return Axios.post<PutFileOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PutFile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutRepositoryTriggers(requestBody: PutRepositoryTriggersInput, headersHandler?: () => {[header: string]: string}): Promise<PutRepositoryTriggersOutput> {
			return Axios.post<PutRepositoryTriggersOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PutRepositoryTriggers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		TestRepositoryTriggers(requestBody: TestRepositoryTriggersInput, headersHandler?: () => {[header: string]: string}): Promise<TestRepositoryTriggersOutput> {
			return Axios.post<TestRepositoryTriggersOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.TestRepositoryTriggers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UpdateApprovalRuleTemplateDescription(requestBody: UpdateApprovalRuleTemplateDescriptionInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateApprovalRuleTemplateDescriptionOutput> {
			return Axios.post<UpdateApprovalRuleTemplateDescriptionOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateApprovalRuleTemplateDescription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateApprovalRuleTemplateName(requestBody: UpdateApprovalRuleTemplateNameInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateApprovalRuleTemplateNameOutput> {
			return Axios.post<UpdateApprovalRuleTemplateNameOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateApprovalRuleTemplateName', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateComment(requestBody: UpdateCommentInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateCommentOutput> {
			return Axios.post<UpdateCommentOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateComment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateDefaultBranch(requestBody: UpdateDefaultBranchInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateDefaultBranch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UpdatePullRequestApprovalRuleContent(requestBody: UpdatePullRequestApprovalRuleContentInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePullRequestApprovalRuleContentOutput> {
			return Axios.post<UpdatePullRequestApprovalRuleContentOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestApprovalRuleContent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdatePullRequestApprovalState(requestBody: UpdatePullRequestApprovalStateInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestApprovalState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UpdatePullRequestStatus(requestBody: UpdatePullRequestStatusInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePullRequestStatusOutput> {
			return Axios.post<UpdatePullRequestStatusOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdatePullRequestTitle(requestBody: UpdatePullRequestTitleInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePullRequestTitleOutput> {
			return Axios.post<UpdatePullRequestTitleOutput>(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestTitle', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateRepositoryDescription(requestBody: UpdateRepositoryDescriptionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateRepositoryDescription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateRepositoryName(requestBody: UpdateRepositoryNameInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateRepositoryName', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
