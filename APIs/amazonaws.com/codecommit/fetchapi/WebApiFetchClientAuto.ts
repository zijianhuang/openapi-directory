export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateApprovalRuleTemplateWithRepository(requestBody: AssociateApprovalRuleTemplateWithRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.AssociateApprovalRuleTemplateWithRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		BatchDescribeMergeConflicts(requestBody: BatchDescribeMergeConflictsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchDescribeMergeConflictsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchDescribeMergeConflicts', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchDisassociateApprovalRuleTemplateFromRepositories(requestBody: BatchDisassociateApprovalRuleTemplateFromRepositoriesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchDisassociateApprovalRuleTemplateFromRepositories', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetCommits(requestBody: BatchGetCommitsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetCommitsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchGetCommits', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetRepositories(requestBody: BatchGetRepositoriesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetRepositoriesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.BatchGetRepositories', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateApprovalRuleTemplate(requestBody: CreateApprovalRuleTemplateInput, headersHandler?: () => {[header: string]: string}): Promise<CreateApprovalRuleTemplateOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateApprovalRuleTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateBranch(requestBody: CreateBranchInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateBranch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateCommit(requestBody: CreateCommitInput, headersHandler?: () => {[header: string]: string}): Promise<CreateCommitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateCommit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePullRequest(requestBody: CreatePullRequestInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePullRequestOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreatePullRequest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePullRequestApprovalRule(requestBody: CreatePullRequestApprovalRuleInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePullRequestApprovalRuleOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreatePullRequestApprovalRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateRepository(requestBody: CreateRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<CreateRepositoryOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateUnreferencedMergeCommit(requestBody: CreateUnreferencedMergeCommitInput, headersHandler?: () => {[header: string]: string}): Promise<CreateUnreferencedMergeCommitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.CreateUnreferencedMergeCommit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApprovalRuleTemplate(requestBody: DeleteApprovalRuleTemplateInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteApprovalRuleTemplateOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteApprovalRuleTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteBranch(requestBody: DeleteBranchInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteBranchOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteBranch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteCommentContent(requestBody: DeleteCommentContentInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteCommentContentOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteCommentContent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteFile(requestBody: DeleteFileInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteFileOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteFile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeletePullRequestApprovalRule(requestBody: DeletePullRequestApprovalRuleInput, headersHandler?: () => {[header: string]: string}): Promise<DeletePullRequestApprovalRuleOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeletePullRequestApprovalRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteRepository(requestBody: DeleteRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteRepositoryOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DeleteRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMergeConflicts(maxMergeHunks: string, nextToken: string, requestBody: DescribeMergeConflictsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMergeConflictsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DescribeMergeConflicts?maxMergeHunks=' + (maxMergeHunks == null ? '' : encodeURIComponent(maxMergeHunks)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribePullRequestEvents(maxResults: string, nextToken: string, requestBody: DescribePullRequestEventsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribePullRequestEventsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DescribePullRequestEvents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisassociateApprovalRuleTemplateFromRepository(requestBody: DisassociateApprovalRuleTemplateFromRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.DisassociateApprovalRuleTemplateFromRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		EvaluatePullRequestApprovalRules(requestBody: EvaluatePullRequestApprovalRulesInput, headersHandler?: () => {[header: string]: string}): Promise<EvaluatePullRequestApprovalRulesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.EvaluatePullRequestApprovalRules', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetApprovalRuleTemplate(requestBody: GetApprovalRuleTemplateInput, headersHandler?: () => {[header: string]: string}): Promise<GetApprovalRuleTemplateOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetApprovalRuleTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetBlob(requestBody: GetBlobInput, headersHandler?: () => {[header: string]: string}): Promise<GetBlobOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetBlob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetBranch(requestBody: GetBranchInput, headersHandler?: () => {[header: string]: string}): Promise<GetBranchOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetBranch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetComment(requestBody: GetCommentInput, headersHandler?: () => {[header: string]: string}): Promise<GetCommentOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetComment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetCommit(requestBody: GetCommitInput, headersHandler?: () => {[header: string]: string}): Promise<GetCommitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetCommit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetFile(requestBody: GetFileInput, headersHandler?: () => {[header: string]: string}): Promise<GetFileOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetFile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetFolder(requestBody: GetFolderInput, headersHandler?: () => {[header: string]: string}): Promise<GetFolderOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetFolder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetMergeCommit(requestBody: GetMergeCommitInput, headersHandler?: () => {[header: string]: string}): Promise<GetMergeCommitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetMergeCommit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetMergeConflicts(maxConflictFiles: string, nextToken: string, requestBody: GetMergeConflictsInput, headersHandler?: () => {[header: string]: string}): Promise<GetMergeConflictsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetMergeConflicts?maxConflictFiles=' + (maxConflictFiles == null ? '' : encodeURIComponent(maxConflictFiles)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetMergeOptions(requestBody: GetMergeOptionsInput, headersHandler?: () => {[header: string]: string}): Promise<GetMergeOptionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetMergeOptions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPullRequest(requestBody: GetPullRequestInput, headersHandler?: () => {[header: string]: string}): Promise<GetPullRequestOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetPullRequest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPullRequestApprovalStates(requestBody: GetPullRequestApprovalStatesInput, headersHandler?: () => {[header: string]: string}): Promise<GetPullRequestApprovalStatesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetPullRequestApprovalStates', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPullRequestOverrideState(requestBody: GetPullRequestOverrideStateInput, headersHandler?: () => {[header: string]: string}): Promise<GetPullRequestOverrideStateOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetPullRequestOverrideState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetRepository(requestBody: GetRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<GetRepositoryOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetRepositoryTriggers(requestBody: GetRepositoryTriggersInput, headersHandler?: () => {[header: string]: string}): Promise<GetRepositoryTriggersOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.GetRepositoryTriggers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBranches(nextToken: string, requestBody: ListBranchesInput, headersHandler?: () => {[header: string]: string}): Promise<ListBranchesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.ListBranches?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRepositories(nextToken: string, requestBody: ListRepositoriesInput, headersHandler?: () => {[header: string]: string}): Promise<ListRepositoriesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.ListRepositories?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		MergeBranchesByFastForward(requestBody: MergeBranchesByFastForwardInput, headersHandler?: () => {[header: string]: string}): Promise<MergeBranchesByFastForwardOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergeBranchesByFastForward', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		MergeBranchesBySquash(requestBody: MergeBranchesBySquashInput, headersHandler?: () => {[header: string]: string}): Promise<MergeBranchesBySquashOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergeBranchesBySquash', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		MergeBranchesByThreeWay(requestBody: MergeBranchesByThreeWayInput, headersHandler?: () => {[header: string]: string}): Promise<MergeBranchesByThreeWayOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergeBranchesByThreeWay', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		MergePullRequestByFastForward(requestBody: MergePullRequestByFastForwardInput, headersHandler?: () => {[header: string]: string}): Promise<MergePullRequestByFastForwardOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergePullRequestByFastForward', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		MergePullRequestBySquash(requestBody: MergePullRequestBySquashInput, headersHandler?: () => {[header: string]: string}): Promise<MergePullRequestBySquashOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergePullRequestBySquash', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		MergePullRequestByThreeWay(requestBody: MergePullRequestByThreeWayInput, headersHandler?: () => {[header: string]: string}): Promise<MergePullRequestByThreeWayOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.MergePullRequestByThreeWay', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		OverridePullRequestApprovalRules(requestBody: OverridePullRequestApprovalRulesInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.OverridePullRequestApprovalRules', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		PostCommentForComparedCommit(requestBody: PostCommentForComparedCommitInput, headersHandler?: () => {[header: string]: string}): Promise<PostCommentForComparedCommitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PostCommentForComparedCommit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PostCommentForPullRequest(requestBody: PostCommentForPullRequestInput, headersHandler?: () => {[header: string]: string}): Promise<PostCommentForPullRequestOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PostCommentForPullRequest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PostCommentReply(requestBody: PostCommentReplyInput, headersHandler?: () => {[header: string]: string}): Promise<PostCommentReplyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PostCommentReply', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutFile(requestBody: PutFileInput, headersHandler?: () => {[header: string]: string}): Promise<PutFileOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PutFile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutRepositoryTriggers(requestBody: PutRepositoryTriggersInput, headersHandler?: () => {[header: string]: string}): Promise<PutRepositoryTriggersOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.PutRepositoryTriggers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		TestRepositoryTriggers(requestBody: TestRepositoryTriggersInput, headersHandler?: () => {[header: string]: string}): Promise<TestRepositoryTriggersOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.TestRepositoryTriggers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateApprovalRuleTemplateContent(requestBody: UpdateApprovalRuleTemplateContentInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateApprovalRuleTemplateContentOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateApprovalRuleTemplateContent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateApprovalRuleTemplateDescription(requestBody: UpdateApprovalRuleTemplateDescriptionInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateApprovalRuleTemplateDescriptionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateApprovalRuleTemplateDescription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateApprovalRuleTemplateName(requestBody: UpdateApprovalRuleTemplateNameInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateApprovalRuleTemplateNameOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateApprovalRuleTemplateName', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateComment(requestBody: UpdateCommentInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateCommentOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateComment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDefaultBranch(requestBody: UpdateDefaultBranchInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateDefaultBranch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdatePullRequestApprovalRuleContent(requestBody: UpdatePullRequestApprovalRuleContentInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePullRequestApprovalRuleContentOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestApprovalRuleContent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdatePullRequestApprovalState(requestBody: UpdatePullRequestApprovalStateInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestApprovalState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdatePullRequestDescription(requestBody: UpdatePullRequestDescriptionInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePullRequestDescriptionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestDescription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdatePullRequestStatus(requestBody: UpdatePullRequestStatusInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePullRequestStatusOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdatePullRequestTitle(requestBody: UpdatePullRequestTitleInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePullRequestTitleOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdatePullRequestTitle', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateRepositoryDescription(requestBody: UpdateRepositoryDescriptionInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateRepositoryDescription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateRepositoryName(requestBody: UpdateRepositoryNameInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeCommit_20150413.UpdateRepositoryName', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
