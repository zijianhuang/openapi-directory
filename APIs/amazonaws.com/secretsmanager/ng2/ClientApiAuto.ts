...
export namespace My_Demo_Client {
	...
	export interface GetSecretValueResponse {
		...
		SecretBinary?: string;
		SecretString?: string;
		VersionStages?: Array<SecretVersionStageType>;
		CreatedDate?: Date;
	}
	...
	export class DemoClient {
		 ...
		 */
		CancelRotateSecret(requestBody: CancelRotateSecretRequest, headersHandler?: () => HttpHeaders): Observable<CancelRotateSecretResponse> {
			return this.http.post<CancelRotateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.CancelRotateSecret', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSecret(requestBody: CreateSecretRequest, headersHandler?: () => HttpHeaders): Observable<CreateSecretResponse> {
			return this.http.post<CreateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.CreateSecret', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => HttpHeaders): Observable<DeleteResourcePolicyResponse> {
			return this.http.post<DeleteResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSecret(requestBody: DeleteSecretRequest, headersHandler?: () => HttpHeaders): Observable<DeleteSecretResponse> {
			return this.http.post<DeleteSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteSecret', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSecret(requestBody: DescribeSecretRequest, headersHandler?: () => HttpHeaders): Observable<DescribeSecretResponse> {
			return this.http.post<DescribeSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.DescribeSecret', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetRandomPassword(requestBody: GetRandomPasswordRequest, headersHandler?: () => HttpHeaders): Observable<GetRandomPasswordResponse> {
			return this.http.post<GetRandomPasswordResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.GetRandomPassword', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyRequest, headersHandler?: () => HttpHeaders): Observable<GetResourcePolicyResponse> {
			return this.http.post<GetResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.GetResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSecretValue(requestBody: GetSecretValueRequest, headersHandler?: () => HttpHeaders): Observable<GetSecretValueResponse> {
			return this.http.post<GetSecretValueResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.GetSecretValue', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSecretVersionIds(MaxResults: string, NextToken: string, requestBody: ListSecretVersionIdsRequest, headersHandler?: () => HttpHeaders): Observable<ListSecretVersionIdsResponse> {
			return this.http.post<ListSecretVersionIdsResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecretVersionIds?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSecrets(MaxResults: string, NextToken: string, requestBody: ListSecretsRequest, headersHandler?: () => HttpHeaders): Observable<ListSecretsResponse> {
			return this.http.post<ListSecretsResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecrets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => HttpHeaders): Observable<PutResourcePolicyResponse> {
			return this.http.post<PutResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.PutResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutSecretValue(requestBody: PutSecretValueRequest, headersHandler?: () => HttpHeaders): Observable<PutSecretValueResponse> {
			return this.http.post<PutSecretValueResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.PutSecretValue', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RestoreSecret(requestBody: RestoreSecretRequest, headersHandler?: () => HttpHeaders): Observable<RestoreSecretResponse> {
			return this.http.post<RestoreSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.RestoreSecret', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RotateSecret(requestBody: RotateSecretRequest, headersHandler?: () => HttpHeaders): Observable<RotateSecretResponse> {
			return this.http.post<RotateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.RotateSecret', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=secretsmanager.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=secretsmanager.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateSecret(requestBody: UpdateSecretRequest, headersHandler?: () => HttpHeaders): Observable<UpdateSecretResponse> {
			return this.http.post<UpdateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecret', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSecretVersionStage(requestBody: UpdateSecretVersionStageRequest, headersHandler?: () => HttpHeaders): Observable<UpdateSecretVersionStageResponse> {
			return this.http.post<UpdateSecretVersionStageResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecretVersionStage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
