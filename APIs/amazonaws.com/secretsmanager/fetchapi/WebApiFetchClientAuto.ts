export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelRotateSecret(requestBody: CancelRotateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelRotateSecretResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.CancelRotateSecret', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSecret(requestBody: CreateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSecretResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.CreateSecret', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcePolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSecret(requestBody: DeleteSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecretResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteSecret', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSecret(requestBody: DescribeSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSecretResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.DescribeSecret', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetRandomPassword(requestBody: GetRandomPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRandomPasswordResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.GetRandomPassword', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResourcePolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.GetResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSecretValue(requestBody: GetSecretValueRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSecretValueResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.GetSecretValue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSecretVersionIds(MaxResults: string, NextToken: string, requestBody: ListSecretVersionIdsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSecretVersionIdsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecretVersionIds?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSecrets(MaxResults: string, NextToken: string, requestBody: ListSecretsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSecretsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecrets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.PutResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutSecretValue(requestBody: PutSecretValueRequest, headersHandler?: () => {[header: string]: string}): Promise<PutSecretValueResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.PutSecretValue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RestoreSecret(requestBody: RestoreSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreSecretResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.RestoreSecret', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RotateSecret(requestBody: RotateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<RotateSecretResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.RotateSecret', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateSecret(requestBody: UpdateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSecretResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecret', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateSecretVersionStage(requestBody: UpdateSecretVersionStageRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSecretVersionStageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecretVersionStage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
