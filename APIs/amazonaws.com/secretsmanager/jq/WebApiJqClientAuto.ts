...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelRotateSecret(callback: (data : CancelRotateSecretResponse) => any, requestBody: CancelRotateSecretRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.CancelRotateSecret', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSecret(callback: (data : CreateSecretResponse) => any, requestBody: CreateSecretRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.CreateSecret', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DeleteResourcePolicy(callback: (data : DeleteResourcePolicyResponse) => any, requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteResourcePolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSecret(callback: (data : DeleteSecretResponse) => any, requestBody: DeleteSecretRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteSecret', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSecret(callback: (data : DescribeSecretResponse) => any, requestBody: DescribeSecretRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.DescribeSecret', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetRandomPassword(callback: (data : GetRandomPasswordResponse) => any, requestBody: GetRandomPasswordRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.GetRandomPassword', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		GetResourcePolicy(callback: (data : GetResourcePolicyResponse) => any, requestBody: GetResourcePolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.GetResourcePolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSecretValue(callback: (data : GetSecretValueResponse) => any, requestBody: GetSecretValueRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.GetSecretValue', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListSecretVersionIds(MaxResults: string, NextToken: string, callback: (data : ListSecretVersionIdsResponse) => any, requestBody: ListSecretVersionIdsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecretVersionIds?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListSecrets(MaxResults: string, NextToken: string, callback: (data : ListSecretsResponse) => any, requestBody: ListSecretsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecrets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		PutResourcePolicy(callback: (data : PutResourcePolicyResponse) => any, requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.PutResourcePolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutSecretValue(callback: (data : PutSecretValueResponse) => any, requestBody: PutSecretValueRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.PutSecretValue', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RestoreSecret(callback: (data : RestoreSecretResponse) => any, requestBody: RestoreSecretRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.RestoreSecret', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RotateSecret(callback: (data : RotateSecretResponse) => any, requestBody: RotateSecretRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.RotateSecret', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : void) => any, requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.TagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UntagResource(callback: (data : void) => any, requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.UntagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSecret(callback: (data : UpdateSecretResponse) => any, requestBody: UpdateSecretRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecret', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSecretVersionStage(callback: (data : UpdateSecretVersionStageResponse) => any, requestBody: UpdateSecretVersionStageRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecretVersionStage', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
