...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelRotateSecret(requestBody: CancelRotateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelRotateSecretResponse> {
			return Axios.post<CancelRotateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.CancelRotateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateSecret(requestBody: CreateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSecretResponse> {
			return Axios.post<CreateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.CreateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcePolicyResponse> {
			return Axios.post<DeleteResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteSecret(requestBody: DeleteSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecretResponse> {
			return Axios.post<DeleteSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.DeleteSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeSecret(requestBody: DescribeSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSecretResponse> {
			return Axios.post<DescribeSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.DescribeSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetRandomPassword(requestBody: GetRandomPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRandomPasswordResponse> {
			return Axios.post<GetRandomPasswordResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.GetRandomPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResourcePolicyResponse> {
			return Axios.post<GetResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.GetResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetSecretValue(requestBody: GetSecretValueRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSecretValueResponse> {
			return Axios.post<GetSecretValueResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.GetSecretValue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListSecretVersionIds(MaxResults: string, NextToken: string, requestBody: ListSecretVersionIdsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSecretVersionIdsResponse> {
			return Axios.post<ListSecretVersionIdsResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecretVersionIds?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListSecrets(MaxResults: string, NextToken: string, requestBody: ListSecretsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSecretsResponse> {
			return Axios.post<ListSecretsResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.ListSecrets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyResponse> {
			return Axios.post<PutResourcePolicyResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.PutResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutSecretValue(requestBody: PutSecretValueRequest, headersHandler?: () => {[header: string]: string}): Promise<PutSecretValueResponse> {
			return Axios.post<PutSecretValueResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.PutSecretValue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RestoreSecret(requestBody: RestoreSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreSecretResponse> {
			return Axios.post<RestoreSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.RestoreSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RotateSecret(requestBody: RotateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<RotateSecretResponse> {
			return Axios.post<RotateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.RotateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=secretsmanager.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=secretsmanager.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		UpdateSecret(requestBody: UpdateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSecretResponse> {
			return Axios.post<UpdateSecretResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateSecretVersionStage(requestBody: UpdateSecretVersionStageRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSecretVersionStageResponse> {
			return Axios.post<UpdateSecretVersionStageResponse>(this.baseUri + '/#X-Amz-Target=secretsmanager.UpdateSecretVersionStage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
