...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelRotateSecret(requestBody: CancelRotateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelRotateSecretResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.CancelRotateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSecret(requestBody: CreateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSecretResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.CreateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcePolicyResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.DeleteResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSecret(requestBody: DeleteSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecretResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.DeleteSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSecret(requestBody: DescribeSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSecretResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.DescribeSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRandomPassword(requestBody: GetRandomPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRandomPasswordResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.GetRandomPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResourcePolicyResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.GetResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSecretValue(requestBody: GetSecretValueRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSecretValueResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.GetSecretValue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListSecretVersionIds(MaxResults: string, NextToken: string, requestBody: ListSecretVersionIdsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSecretVersionIdsResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.ListSecretVersionIds?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListSecrets(MaxResults: string, NextToken: string, requestBody: ListSecretsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSecretsResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.ListSecrets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.PutResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutSecretValue(requestBody: PutSecretValueRequest, headersHandler?: () => {[header: string]: string}): Promise<PutSecretValueResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.PutSecretValue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RestoreSecret(requestBody: RestoreSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreSecretResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.RestoreSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RotateSecret(requestBody: RotateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<RotateSecretResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.RotateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=secretsmanager.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=secretsmanager.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateSecret(requestBody: UpdateSecretRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSecretResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.UpdateSecret', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSecretVersionStage(requestBody: UpdateSecretVersionStageRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSecretVersionStageResponse> {
			return this.http.post('/#X-Amz-Target=secretsmanager.UpdateSecretVersionStage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
