...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateDomain(callback: (data : AssociateDomainResponse) => any, requestBody: AssociateDomainBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/associateDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociateWebsiteAuthorizationProvider(callback: (data : AssociateWebsiteAuthorizationProviderResponse) => any, requestBody: AssociateWebsiteAuthorizationProviderBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/associateWebsiteAuthorizationProvider', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociateWebsiteCertificateAuthority(callback: (data : AssociateWebsiteCertificateAuthorityResponse) => any, requestBody: AssociateWebsiteCertificateAuthorityBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/associateWebsiteCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAuditStreamConfiguration(callback: (data : DescribeAuditStreamConfigurationResponse) => any, requestBody: DescribeAuditStreamConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeAuditStreamConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCompanyNetworkConfiguration(callback: (data : DescribeCompanyNetworkConfigurationResponse) => any, requestBody: DescribeCompanyNetworkConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeCompanyNetworkConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDevice(callback: (data : DescribeDeviceResponse) => any, requestBody: DescribeDeviceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeDevice', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDevicePolicyConfiguration(callback: (data : DescribeDevicePolicyConfigurationResponse) => any, requestBody: DescribeDevicePolicyConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeDevicePolicyConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDomain(callback: (data : DescribeDomainResponse) => any, requestBody: DescribeDomainBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeFleetMetadata(callback: (data : DescribeFleetMetadataResponse) => any, requestBody: DescribeFleetMetadataBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeFleetMetadata', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeIdentityProviderConfiguration(callback: (data : DescribeIdentityProviderConfigurationResponse) => any, requestBody: DescribeIdentityProviderConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeIdentityProviderConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeWebsiteCertificateAuthority(callback: (data : DescribeWebsiteCertificateAuthorityResponse) => any, requestBody: DescribeWebsiteCertificateAuthorityBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeWebsiteCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateDomain(callback: (data : DisassociateDomainResponse) => any, requestBody: DisassociateDomainBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/disassociateDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateWebsiteAuthorizationProvider(callback: (data : DisassociateWebsiteAuthorizationProviderResponse) => any, requestBody: DisassociateWebsiteAuthorizationProviderBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/disassociateWebsiteAuthorizationProvider', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateWebsiteCertificateAuthority(callback: (data : DisassociateWebsiteCertificateAuthorityResponse) => any, requestBody: DisassociateWebsiteCertificateAuthorityBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/disassociateWebsiteCertificateAuthority', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDevices(MaxResults: string, NextToken: string, callback: (data : ListDevicesResponse) => any, requestBody: ListDevicesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listDevices?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDomains(MaxResults: string, NextToken: string, callback: (data : ListDomainsResponse) => any, requestBody: ListDomainsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listDomains?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListWebsiteAuthorizationProviders(MaxResults: string, NextToken: string, callback: (data : ListWebsiteAuthorizationProvidersResponse) => any, requestBody: ListWebsiteAuthorizationProvidersBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listWebsiteAuthorizationProviders?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListWebsiteCertificateAuthorities(MaxResults: string, NextToken: string, callback: (data : ListWebsiteCertificateAuthoritiesResponse) => any, requestBody: ListWebsiteCertificateAuthoritiesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listWebsiteCertificateAuthorities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RestoreDomainAccess(callback: (data : RestoreDomainAccessResponse) => any, requestBody: RestoreDomainAccessBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/restoreDomainAccess', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RevokeDomainAccess(callback: (data : RevokeDomainAccessResponse) => any, requestBody: RevokeDomainAccessBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/revokeDomainAccess', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SignOutUser(callback: (data : SignOutUserResponse) => any, requestBody: SignOutUserBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/signOutUser', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateAuditStreamConfiguration(callback: (data : UpdateAuditStreamConfigurationResponse) => any, requestBody: UpdateAuditStreamConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateAuditStreamConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateCompanyNetworkConfiguration(callback: (data : UpdateCompanyNetworkConfigurationResponse) => any, requestBody: UpdateCompanyNetworkConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateCompanyNetworkConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDevicePolicyConfiguration(callback: (data : UpdateDevicePolicyConfigurationResponse) => any, requestBody: UpdateDevicePolicyConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateDevicePolicyConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDomainMetadata(callback: (data : UpdateDomainMetadataResponse) => any, requestBody: UpdateDomainMetadataBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateDomainMetadata', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateFleetMetadata(callback: (data : UpdateFleetMetadataResponse) => any, requestBody: UpdateFleetMetadataBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/UpdateFleetMetadata', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateIdentityProviderConfiguration(callback: (data : UpdateIdentityProviderConfigurationResponse) => any, requestBody: UpdateIdentityProviderConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateIdentityProviderConfiguration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
