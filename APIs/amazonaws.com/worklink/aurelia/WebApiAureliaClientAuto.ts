...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateDomain(requestBody: AssociateDomainBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateDomainResponse> {
			return this.http.post('/associateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateWebsiteAuthorizationProvider(requestBody: AssociateWebsiteAuthorizationProviderBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateWebsiteAuthorizationProviderResponse> {
			return this.http.post('/associateWebsiteAuthorizationProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateWebsiteCertificateAuthority(requestBody: AssociateWebsiteCertificateAuthorityBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateWebsiteCertificateAuthorityResponse> {
			return this.http.post('/associateWebsiteCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAuditStreamConfiguration(requestBody: DescribeAuditStreamConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuditStreamConfigurationResponse> {
			return this.http.post('/describeAuditStreamConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCompanyNetworkConfiguration(requestBody: DescribeCompanyNetworkConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeCompanyNetworkConfigurationResponse> {
			return this.http.post('/describeCompanyNetworkConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDevice(requestBody: DescribeDeviceBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeviceResponse> {
			return this.http.post('/describeDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDevicePolicyConfiguration(requestBody: DescribeDevicePolicyConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeDevicePolicyConfigurationResponse> {
			return this.http.post('/describeDevicePolicyConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDomain(requestBody: DescribeDomainBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainResponse> {
			return this.http.post('/describeDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeFleetMetadata(requestBody: DescribeFleetMetadataBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetMetadataResponse> {
			return this.http.post('/describeFleetMetadata', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeIdentityProviderConfiguration(requestBody: DescribeIdentityProviderConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeIdentityProviderConfigurationResponse> {
			return this.http.post('/describeIdentityProviderConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWebsiteCertificateAuthority(requestBody: DescribeWebsiteCertificateAuthorityBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeWebsiteCertificateAuthorityResponse> {
			return this.http.post('/describeWebsiteCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateDomain(requestBody: DisassociateDomainBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateDomainResponse> {
			return this.http.post('/disassociateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateWebsiteAuthorizationProvider(requestBody: DisassociateWebsiteAuthorizationProviderBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateWebsiteAuthorizationProviderResponse> {
			return this.http.post('/disassociateWebsiteAuthorizationProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateWebsiteCertificateAuthority(requestBody: DisassociateWebsiteCertificateAuthorityBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateWebsiteCertificateAuthorityResponse> {
			return this.http.post('/disassociateWebsiteCertificateAuthority', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDomains(MaxResults: string, NextToken: string, requestBody: ListDomainsBody, headersHandler?: () => {[header: string]: string}): Promise<ListDomainsResponse> {
			return this.http.post('/listDomains?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListWebsiteAuthorizationProviders(MaxResults: string, NextToken: string, requestBody: ListWebsiteAuthorizationProvidersBody, headersHandler?: () => {[header: string]: string}): Promise<ListWebsiteAuthorizationProvidersResponse> {
			return this.http.post('/listWebsiteAuthorizationProviders?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListWebsiteCertificateAuthorities(MaxResults: string, NextToken: string, requestBody: ListWebsiteCertificateAuthoritiesBody, headersHandler?: () => {[header: string]: string}): Promise<ListWebsiteCertificateAuthoritiesResponse> {
			return this.http.post('/listWebsiteCertificateAuthorities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RestoreDomainAccess(requestBody: RestoreDomainAccessBody, headersHandler?: () => {[header: string]: string}): Promise<RestoreDomainAccessResponse> {
			return this.http.post('/restoreDomainAccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RevokeDomainAccess(requestBody: RevokeDomainAccessBody, headersHandler?: () => {[header: string]: string}): Promise<RevokeDomainAccessResponse> {
			return this.http.post('/revokeDomainAccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SignOutUser(requestBody: SignOutUserBody, headersHandler?: () => {[header: string]: string}): Promise<SignOutUserResponse> {
			return this.http.post('/signOutUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateAuditStreamConfiguration(requestBody: UpdateAuditStreamConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAuditStreamConfigurationResponse> {
			return this.http.post('/updateAuditStreamConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateCompanyNetworkConfiguration(requestBody: UpdateCompanyNetworkConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateCompanyNetworkConfigurationResponse> {
			return this.http.post('/updateCompanyNetworkConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDevicePolicyConfiguration(requestBody: UpdateDevicePolicyConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDevicePolicyConfigurationResponse> {
			return this.http.post('/updateDevicePolicyConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDomainMetadata(requestBody: UpdateDomainMetadataBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainMetadataResponse> {
			return this.http.post('/updateDomainMetadata', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateFleetMetadata(requestBody: UpdateFleetMetadataBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetMetadataResponse> {
			return this.http.post('/UpdateFleetMetadata', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateIdentityProviderConfiguration(requestBody: UpdateIdentityProviderConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateIdentityProviderConfigurationResponse> {
			return this.http.post('/updateIdentityProviderConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
