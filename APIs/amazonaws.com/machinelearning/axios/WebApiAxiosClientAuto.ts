...
export namespace My_Demo_Client {
	...
	export interface AddTagsInput {
		Tags: Array<Tag>;
		ResourceId: string;
		ResourceType: AddTagsInputResourceType;
	}

	export enum AddTagsInputResourceType { BatchPrediction = 0, DataSource = 1, Evaluation = 2, MLModel = 3 }
	...
	export interface DeleteTagsOutput {
		ResourceId?: string;
		ResourceType?: DeleteTagsOutputResourceType;
	}

	export enum DeleteTagsOutputResourceType { BatchPrediction = 0, DataSource = 1, Evaluation = 2, MLModel = 3 }

	export interface DeleteTagsInput {
		TagKeys: Array<TagKey>;
		ResourceId: string;
		ResourceType: DeleteTagsInputResourceType;
	}

	export enum DeleteTagsInputResourceType { BatchPrediction = 0, DataSource = 1, Evaluation = 2, MLModel = 3 }
	...
	export interface DescribeDataSourcesInput {
		...
		/**<p>The sort order specified in a listing condition. Possible values include the following:</p> <ul> <li> <code>asc</code> - Present the information in ascending order (from A-Z).</li> <li> <code>dsc</code> - Present the information in descending order (from Z-A).</li> </ul> */
		SortOrder?: DescribeDataSourcesInputSortOrder;
	...
	export enum DescribeDataSourcesInputSortOrder { asc = 0, dsc = 1 }
	...
	export interface DescribeEvaluationsInput {
		...
		FilterVariable?: DescribeEvaluationsInputFilterVariable;
		...
		/**<p>The sort order specified in a listing condition. Possible values include the following:</p> <ul> <li> <code>asc</code> - Present the information in ascending order (from A-Z).</li> <li> <code>dsc</code> - Present the information in descending order (from Z-A).</li> </ul> */
		SortOrder?: DescribeEvaluationsInputSortOrder;
	...
	export enum DescribeEvaluationsInputFilterVariable { CreatedAt = 0, LastUpdatedAt = 1, Status = 2, Name = 3, IAMUser = 4, MLModelId = 5, DataSourceId = 6, DataURI = 7 }

	export enum DescribeEvaluationsInputSortOrder { asc = 0, dsc = 1 }
	...
	export interface DescribeMLModelsInput {
		...
		/**<p>The sort order specified in a listing condition. Possible values include the following:</p> <ul> <li> <code>asc</code> - Present the information in ascending order (from A-Z).</li> <li> <code>dsc</code> - Present the information in descending order (from Z-A).</li> </ul> */
		SortOrder?: DescribeMLModelsInputSortOrder;
	...
	export enum DescribeMLModelsInputSortOrder { asc = 0, dsc = 1 }


	/**Amazon ML returns the following elements.  */
	export interface DescribeTagsOutput {
		ResourceId?: string;
		ResourceType?: DescribeTagsOutputResourceType;
		Tags?: Array<Tag>;
	}

	export enum DescribeTagsOutputResourceType { BatchPrediction = 0, DataSource = 1, Evaluation = 2, MLModel = 3 }

	export interface DescribeTagsInput {
		ResourceId: string;
		ResourceType: DescribeTagsInputResourceType;
	}

	export enum DescribeTagsInputResourceType { BatchPrediction = 0, DataSource = 1, Evaluation = 2, MLModel = 3 }
	...
	export interface GetBatchPredictionOutput {
		...
		Status?: GetBatchPredictionOutputStatus;
	...
	export enum GetBatchPredictionOutputStatus { PENDING = 0, INPROGRESS = 1, FAILED = 2, COMPLETED = 3, DELETED = 4 }
	...
	export interface GetDataSourceOutput {
		...
		/**<p>Object status with the following possible values:</p> <ul> <li><code>PENDING</code></li> <li><code>INPROGRESS</code></li> <li><code>FAILED</code></li> <li><code>COMPLETED</code></li> <li><code>DELETED</code></li> </ul> */
		Status?: GetDataSourceOutputStatus;
		LogUri?: string;
	...
	export enum GetDataSourceOutputStatus { PENDING = 0, INPROGRESS = 1, FAILED = 2, COMPLETED = 3, DELETED = 4 }
	...
	export interface GetEvaluationOutput {
		...
		/**<p>Object status with the following possible values:</p> <ul> <li><code>PENDING</code></li> <li><code>INPROGRESS</code></li> <li><code>FAILED</code></li> <li><code>COMPLETED</code></li> <li><code>DELETED</code></li> </ul> */
		Status?: GetEvaluationOutputStatus;
	...
	export enum GetEvaluationOutputStatus { PENDING = 0, INPROGRESS = 1, FAILED = 2, COMPLETED = 3, DELETED = 4 }
	...
	export interface GetMLModelOutput {
		 ...
		 */
		InputDataLocationS3?: string;
		MLModelType?: GetMLModelOutputMLModelType;
	...
	export enum GetMLModelOutputStatus { PENDING = 0, INPROGRESS = 1, FAILED = 2, COMPLETED = 3, DELETED = 4 }

	export enum GetMLModelOutputMLModelType { REGRESSION = 0, BINARY = 1, MULTICLASS = 2 }
	...
	export interface RDSDataSpec {
		...
		ServiceRole: string;
		SubnetId: string;
		SecurityGroupIds: Array<EDPSecurityGroupId>;
	}
	...
	export enum DataSourceStatus { PENDING = 0, INPROGRESS = 1, FAILED = 2, COMPLETED = 3, DELETED = 4 }
	...
	export enum EvaluationStatus { PENDING = 0, INPROGRESS = 1, FAILED = 2, COMPLETED = 3, DELETED = 4 }
	...
	export interface MLModel {
		...
		MLModelType?: MLModelMLModelType;
		ScoreThreshold?: number;
	...
	export enum MLModelStatus { PENDING = 0, INPROGRESS = 1, FAILED = 2, COMPLETED = 3, DELETED = 4 }

	export enum MLModelAlgorithm { sgd = 0 }

	export enum MLModelMLModelType { REGRESSION = 0, BINARY = 1, MULTICLASS = 2 }
	...
	export class DemoClient {
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsOutput> {
			return Axios.post<AddTagsOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateBatchPrediction(requestBody: CreateBatchPredictionInput, headersHandler?: () => {[header: string]: string}): Promise<CreateBatchPredictionOutput> {
			return Axios.post<CreateBatchPredictionOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.CreateBatchPrediction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateDataSourceFromRDS(requestBody: CreateDataSourceFromRDSInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceFromRDSOutput> {
			return Axios.post<CreateDataSourceFromRDSOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.CreateDataSourceFromRDS', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateDataSourceFromRedshift(requestBody: CreateDataSourceFromRedshiftInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceFromRedshiftOutput> {
			return Axios.post<CreateDataSourceFromRedshiftOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.CreateDataSourceFromRedshift', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateDataSourceFromS3(requestBody: CreateDataSourceFromS3Input, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceFromS3Output> {
			return Axios.post<CreateDataSourceFromS3Output>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.CreateDataSourceFromS3', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateEvaluation(requestBody: CreateEvaluationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateEvaluationOutput> {
			return Axios.post<CreateEvaluationOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.CreateEvaluation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateMLModel(requestBody: CreateMLModelInput, headersHandler?: () => {[header: string]: string}): Promise<CreateMLModelOutput> {
			return Axios.post<CreateMLModelOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.CreateMLModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateRealtimeEndpoint(requestBody: CreateRealtimeEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<CreateRealtimeEndpointOutput> {
			return Axios.post<CreateRealtimeEndpointOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.CreateRealtimeEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteBatchPrediction(requestBody: DeleteBatchPredictionInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteBatchPredictionOutput> {
			return Axios.post<DeleteBatchPredictionOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DeleteBatchPrediction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteDataSource(requestBody: DeleteDataSourceInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteDataSourceOutput> {
			return Axios.post<DeleteDataSourceOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DeleteDataSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteEvaluation(requestBody: DeleteEvaluationInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteEvaluationOutput> {
			return Axios.post<DeleteEvaluationOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DeleteEvaluation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteMLModel(requestBody: DeleteMLModelInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteMLModelOutput> {
			return Axios.post<DeleteMLModelOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DeleteMLModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteRealtimeEndpoint(requestBody: DeleteRealtimeEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteRealtimeEndpointOutput> {
			return Axios.post<DeleteRealtimeEndpointOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DeleteRealtimeEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTags(requestBody: DeleteTagsInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsOutput> {
			return Axios.post<DeleteTagsOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeBatchPredictions(Limit: string, NextToken: string, requestBody: DescribeBatchPredictionsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeBatchPredictionsOutput> {
			return Axios.post<DescribeBatchPredictionsOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DescribeBatchPredictions?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeDataSources(Limit: string, NextToken: string, requestBody: DescribeDataSourcesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSourcesOutput> {
			return Axios.post<DescribeDataSourcesOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DescribeDataSources?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEvaluations(Limit: string, NextToken: string, requestBody: DescribeEvaluationsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeEvaluationsOutput> {
			return Axios.post<DescribeEvaluationsOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DescribeEvaluations?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeMLModels(Limit: string, NextToken: string, requestBody: DescribeMLModelsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMLModelsOutput> {
			return Axios.post<DescribeMLModelsOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DescribeMLModels?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeTags(requestBody: DescribeTagsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsOutput> {
			return Axios.post<DescribeTagsOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetBatchPrediction(requestBody: GetBatchPredictionInput, headersHandler?: () => {[header: string]: string}): Promise<GetBatchPredictionOutput> {
			return Axios.post<GetBatchPredictionOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.GetBatchPrediction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetDataSource(requestBody: GetDataSourceInput, headersHandler?: () => {[header: string]: string}): Promise<GetDataSourceOutput> {
			return Axios.post<GetDataSourceOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.GetDataSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetEvaluation(requestBody: GetEvaluationInput, headersHandler?: () => {[header: string]: string}): Promise<GetEvaluationOutput> {
			return Axios.post<GetEvaluationOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.GetEvaluation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetMLModel(requestBody: GetMLModelInput, headersHandler?: () => {[header: string]: string}): Promise<GetMLModelOutput> {
			return Axios.post<GetMLModelOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.GetMLModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Predict(requestBody: PredictInput, headersHandler?: () => {[header: string]: string}): Promise<PredictOutput> {
			return Axios.post<PredictOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.Predict', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateBatchPrediction(requestBody: UpdateBatchPredictionInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateBatchPredictionOutput> {
			return Axios.post<UpdateBatchPredictionOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.UpdateBatchPrediction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateDataSource(requestBody: UpdateDataSourceInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataSourceOutput> {
			return Axios.post<UpdateDataSourceOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.UpdateDataSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateEvaluation(requestBody: UpdateEvaluationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateEvaluationOutput> {
			return Axios.post<UpdateEvaluationOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.UpdateEvaluation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateMLModel(requestBody: UpdateMLModelInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateMLModelOutput> {
			return Axios.post<UpdateMLModelOutput>(this.baseUri + '/#X-Amz-Target=AmazonML_20141212.UpdateMLModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
