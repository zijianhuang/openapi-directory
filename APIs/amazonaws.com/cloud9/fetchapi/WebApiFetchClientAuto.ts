export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateEnvironmentEC2(requestBody: CreateEnvironmentEC2Request, headersHandler?: () => {[header: string]: string}): Promise<CreateEnvironmentEC2Result> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.CreateEnvironmentEC2', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEnvironmentMembership(requestBody: CreateEnvironmentMembershipRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEnvironmentMembershipResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.CreateEnvironmentMembership', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEnvironment(requestBody: DeleteEnvironmentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEnvironmentResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.DeleteEnvironment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEnvironmentMembership(requestBody: DeleteEnvironmentMembershipRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEnvironmentMembershipResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.DeleteEnvironmentMembership', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEnvironmentMemberships(maxResults: string, nextToken: string, requestBody: DescribeEnvironmentMembershipsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEnvironmentMembershipsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.DescribeEnvironmentMemberships?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEnvironmentStatus(requestBody: DescribeEnvironmentStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEnvironmentStatusResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.DescribeEnvironmentStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEnvironments(requestBody: DescribeEnvironmentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEnvironmentsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.DescribeEnvironments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEnvironments(maxResults: string, nextToken: string, requestBody: ListEnvironmentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEnvironmentsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.ListEnvironments?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateEnvironment(requestBody: UpdateEnvironmentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEnvironmentResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.UpdateEnvironment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateEnvironmentMembership(requestBody: UpdateEnvironmentMembershipRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEnvironmentMembershipResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCloud9WorkspaceManagementService.UpdateEnvironmentMembership', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
