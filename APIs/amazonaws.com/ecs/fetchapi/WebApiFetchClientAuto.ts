export namespace My_Demo_Client {
	...
	export interface CreateServiceRequest {
		...
		desiredCount?: number;
		clientToken?: string;
		launchType?: CreateServiceRequestLaunchType;
		...
		schedulingStrategy?: CreateServiceRequestSchedulingStrategy;
		...
		propagateTags?: CreateServiceRequestPropagateTags;
	}

	export enum CreateServiceRequestLaunchType { EC2 = 0, FARGATE = 1 }

	export enum CreateServiceRequestSchedulingStrategy { REPLICA = 0, DAEMON = 1 }

	export enum CreateServiceRequestPropagateTags { TASK_DEFINITION = 0, SERVICE = 1 }
	...
	export interface CreateTaskSetRequest {
		...
		loadBalancers?: Array<LoadBalancer>;
		serviceRegistries?: Array<ServiceRegistry>;
		launchType?: CreateTaskSetRequestLaunchType;
		capacityProviderStrategy?: Array<CapacityProviderStrategyItem>;
		platformVersion?: string;
	...
	export enum CreateTaskSetRequestLaunchType { EC2 = 0, FARGATE = 1 }
	...
	export interface DeleteAccountSettingRequest {
		name: DeleteAccountSettingRequestName;
		principalArn?: string;
	}

	export enum DeleteAccountSettingRequestName { serviceLongArnFormat = 0, taskLongArnFormat = 1, containerInstanceLongArnFormat = 2, awsvpcTrunking = 3, containerInsights = 4 }
	...
	export interface ListAccountSettingsRequest {
		name?: ListAccountSettingsRequestName;
		value?: string;
		principalArn?: string;
	...
	export enum ListAccountSettingsRequestName { serviceLongArnFormat = 0, taskLongArnFormat = 1, containerInstanceLongArnFormat = 2, awsvpcTrunking = 3, containerInsights = 4 }
	...
	export enum ListAttributesRequestTargetType { container-instance = 0 }
	...
	export interface ListServicesRequest {
		...
		nextToken?: string;
		maxResults?: number;
		launchType?: ListServicesRequestLaunchType;
		schedulingStrategy?: ListServicesRequestSchedulingStrategy;
	}

	export enum ListServicesRequestLaunchType { EC2 = 0, FARGATE = 1 }

	export enum ListServicesRequestSchedulingStrategy { REPLICA = 0, DAEMON = 1 }
	...
	export interface ListTaskDefinitionsRequest {
		familyPrefix?: string;
		status?: ListTaskDefinitionsRequestStatus;
		sort?: ListTaskDefinitionsRequestSort;
		nextToken?: string;
		maxResults?: number;
	}

	export enum ListTaskDefinitionsRequestStatus { ACTIVE = 0, INACTIVE = 1 }
	...
	export interface ListTasksRequest {
		...
		launchType?: ListTasksRequestLaunchType;
	}

	export enum ListTasksRequestDesiredStatus { RUNNING = 0, PENDING = 1, STOPPED = 2 }

	export enum ListTasksRequestLaunchType { EC2 = 0, FARGATE = 1 }
	...
	export interface PutAccountSettingRequest {
		name: PutAccountSettingRequestName;
		value: string;
		principalArn?: string;
	}

	export enum PutAccountSettingRequestName { serviceLongArnFormat = 0, taskLongArnFormat = 1, containerInstanceLongArnFormat = 2, awsvpcTrunking = 3, containerInsights = 4 }
	...
	export interface PutAccountSettingDefaultRequest {
		name: PutAccountSettingDefaultRequestName;
		value: string;
	}

	export enum PutAccountSettingDefaultRequestName { serviceLongArnFormat = 0, taskLongArnFormat = 1, containerInstanceLongArnFormat = 2, awsvpcTrunking = 3, containerInsights = 4 }
	...
	export interface RegisterTaskDefinitionRequest {
		...
		networkMode?: RegisterTaskDefinitionRequestNetworkMode;
		...
		memory?: string;
		tags?: Array<Tag>;
		pidMode?: RegisterTaskDefinitionRequestPidMode;
		ipcMode?: RegisterTaskDefinitionRequestIpcMode;
	...
	export enum RegisterTaskDefinitionRequestNetworkMode { bridge = 0, host = 1, awsvpc = 2, none = 3 }

	export enum RegisterTaskDefinitionRequestPidMode { host = 0, task = 1 }

	export enum RegisterTaskDefinitionRequestIpcMode { host = 0, task = 1, none = 2 }
	...
	export interface RunTaskRequest {
		...
		enableECSManagedTags?: boolean;
		group?: string;
		launchType?: RunTaskRequestLaunchType;
		...
		placementStrategy?: Array<PlacementStrategy>;
		platformVersion?: string;
		propagateTags?: RunTaskRequestPropagateTags;
		referenceId?: string;
		startedBy?: string;
		tags?: Array<Tag>;
		taskDefinition: string;
	...
	export enum RunTaskRequestLaunchType { EC2 = 0, FARGATE = 1 }

	export enum RunTaskRequestPropagateTags { TASK_DEFINITION = 0, SERVICE = 1 }
	...
	export interface StartTaskRequest {
		...
		/**The overrides associated with a task. */
		overrides?: TaskOverride;
		propagateTags?: StartTaskRequestPropagateTags;
		referenceId?: string;
		startedBy?: string;
		tags?: Array<Tag>;
		taskDefinition: string;
	...
	export enum StartTaskRequestPropagateTags { TASK_DEFINITION = 0, SERVICE = 1 }
	...
	export interface UpdateContainerInstancesStateRequest {
		cluster?: string;
		containerInstances: Array<String>;
		status: UpdateContainerInstancesStateRequestStatus;
	}

	export enum UpdateContainerInstancesStateRequestStatus { ACTIVE = 0, DRAINING = 1, REGISTERING = 2, DEREGISTERING = 3, REGISTRATION_FAILED = 4 }
	...
	export interface AutoScalingGroupProvider {
		...
		managedTerminationProtection?: AutoScalingGroupProviderManagedTerminationProtection;
	}

	export enum AutoScalingGroupProviderManagedTerminationProtection { ENABLED = 0, DISABLED = 1 }
	...
	export enum AwsVpcConfigurationAssignPublicIp { ENABLED = 0, DISABLED = 1 }
	...
	export enum TaskSetLaunchType { EC2 = 0, FARGATE = 1 }
	...
	export interface Deployment {
		...
		updatedAt?: Date;
		capacityProviderStrategy?: Array<CapacityProviderStrategyItem>;
		launchType?: DeploymentLaunchType;
		platformVersion?: string;
	...
	export enum DeploymentLaunchType { EC2 = 0, FARGATE = 1 }
	...
	export enum EFSVolumeConfigurationTransitEncryption { ENABLED = 0, DISABLED = 1 }
	...
	export interface NetworkBinding {
		...
		containerPort?: number;
		hostPort?: number;
		protocol?: NetworkBindingProtocol;
	}

	export enum NetworkBindingProtocol { tcp = 0, udp = 1 }
	...
	export enum TaskConnectivity { CONNECTED = 0, DISCONNECTED = 1 }

	export enum TaskHealthStatus { HEALTHY = 0, UNHEALTHY = 1, UNKNOWN = 2 }

	export enum TaskLaunchType { EC2 = 0, FARGATE = 1 }
	...
	export class DemoClient {
		 ...
		 */
		CreateCapacityProvider(requestBody: CreateCapacityProviderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCapacityProviderResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateCapacityProvider', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateCluster(requestBody: CreateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateService(requestBody: CreateServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateServiceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateService', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateTaskSet(requestBody: CreateTaskSetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTaskSetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateTaskSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteAccountSetting(requestBody: DeleteAccountSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAccountSettingResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteAccountSetting', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteAttributes(requestBody: DeleteAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAttributesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteCluster(requestBody: DeleteClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteClusterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteService(requestBody: DeleteServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteServiceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteService', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteTaskSet(requestBody: DeleteTaskSetRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTaskSetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteTaskSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeregisterContainerInstance(requestBody: DeregisterContainerInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterContainerInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeregisterContainerInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeregisterTaskDefinition(requestBody: DeregisterTaskDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterTaskDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeregisterTaskDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeCapacityProviders(requestBody: DescribeCapacityProvidersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCapacityProvidersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeCapacityProviders', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeClusters(requestBody: DescribeClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeClustersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeClusters', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeContainerInstances(requestBody: DescribeContainerInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeContainerInstancesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeContainerInstances', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeServices(requestBody: DescribeServicesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeServicesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeServices', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeTaskDefinition(requestBody: DescribeTaskDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTaskDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeTaskDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeTaskSets(requestBody: DescribeTaskSetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTaskSetsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeTaskSets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeTasks(requestBody: DescribeTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTasksResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeTasks', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DiscoverPollEndpoint(requestBody: DiscoverPollEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DiscoverPollEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DiscoverPollEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListAccountSettings(maxResults: string, nextToken: string, requestBody: ListAccountSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAccountSettingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListAccountSettings?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListAttributes(maxResults: string, nextToken: string, requestBody: ListAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAttributesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListAttributes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListClusters(maxResults: string, nextToken: string, requestBody: ListClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListClustersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListClusters?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListContainerInstances(maxResults: string, nextToken: string, requestBody: ListContainerInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListContainerInstancesResponse> {
		 ...
		 */
		ListServices(maxResults: string, nextToken: string, requestBody: ListServicesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListServicesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListServices?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListTaskDefinitionFamilies(maxResults: string, nextToken: string, requestBody: ListTaskDefinitionFamiliesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTaskDefinitionFamiliesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListTaskDefinitionFamilies?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListTaskDefinitions(maxResults: string, nextToken: string, requestBody: ListTaskDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTaskDefinitionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListTaskDefinitions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		PutAccountSetting(requestBody: PutAccountSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAccountSettingResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAccountSetting', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		PutAccountSettingDefault(requestBody: PutAccountSettingDefaultRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAccountSettingDefaultResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAccountSettingDefault', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		PutAttributes(requestBody: PutAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAttributesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		PutClusterCapacityProviders(requestBody: PutClusterCapacityProvidersRequest, headersHandler?: () => {[header: string]: string}): Promise<PutClusterCapacityProvidersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutClusterCapacityProviders', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RegisterContainerInstance(requestBody: RegisterContainerInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterContainerInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.RegisterContainerInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RegisterTaskDefinition(requestBody: RegisterTaskDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterTaskDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.RegisterTaskDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RunTask(requestBody: RunTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<RunTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.RunTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StartTask(requestBody: StartTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.StartTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StopTask(requestBody: StopTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<StopTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.StopTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		SubmitAttachmentStateChanges(requestBody: SubmitAttachmentStateChangesRequest, headersHandler?: () => {[header: string]: string}): Promise<SubmitAttachmentStateChangesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitAttachmentStateChanges', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		SubmitContainerStateChange(requestBody: SubmitContainerStateChangeRequest, headersHandler?: () => {[header: string]: string}): Promise<SubmitContainerStateChangeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitContainerStateChange', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		SubmitTaskStateChange(requestBody: SubmitTaskStateChangeRequest, headersHandler?: () => {[header: string]: string}): Promise<SubmitTaskStateChangeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitTaskStateChange', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateClusterSettings(requestBody: UpdateClusterSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterSettingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateClusterSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateContainerAgent(requestBody: UpdateContainerAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateContainerAgentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateContainerAgent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateContainerInstancesState(requestBody: UpdateContainerInstancesStateRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateContainerInstancesStateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateContainerInstancesState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateService(requestBody: UpdateServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServiceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateService', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateServicePrimaryTaskSet(requestBody: UpdateServicePrimaryTaskSetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServicePrimaryTaskSetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateServicePrimaryTaskSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateTaskSet(requestBody: UpdateTaskSetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTaskSetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateTaskSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
