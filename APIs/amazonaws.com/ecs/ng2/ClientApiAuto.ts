...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateCapacityProvider(requestBody: CreateCapacityProviderRequest, headersHandler?: () => HttpHeaders): Observable<CreateCapacityProviderResponse> {
			return this.http.post<CreateCapacityProviderResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateCapacityProvider', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateCluster(requestBody: CreateClusterRequest, headersHandler?: () => HttpHeaders): Observable<CreateClusterResponse> {
			return this.http.post<CreateClusterResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateService(requestBody: CreateServiceRequest, headersHandler?: () => HttpHeaders): Observable<CreateServiceResponse> {
			return this.http.post<CreateServiceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateService', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTaskSet(requestBody: CreateTaskSetRequest, headersHandler?: () => HttpHeaders): Observable<CreateTaskSetResponse> {
			return this.http.post<CreateTaskSetResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.CreateTaskSet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteAccountSetting(requestBody: DeleteAccountSettingRequest, headersHandler?: () => HttpHeaders): Observable<DeleteAccountSettingResponse> {
			return this.http.post<DeleteAccountSettingResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteAccountSetting', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteAttributes(requestBody: DeleteAttributesRequest, headersHandler?: () => HttpHeaders): Observable<DeleteAttributesResponse> {
			return this.http.post<DeleteAttributesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DeleteCluster(requestBody: DeleteClusterRequest, headersHandler?: () => HttpHeaders): Observable<DeleteClusterResponse> {
			return this.http.post<DeleteClusterResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteService(requestBody: DeleteServiceRequest, headersHandler?: () => HttpHeaders): Observable<DeleteServiceResponse> {
			return this.http.post<DeleteServiceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteService', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTaskSet(requestBody: DeleteTaskSetRequest, headersHandler?: () => HttpHeaders): Observable<DeleteTaskSetResponse> {
			return this.http.post<DeleteTaskSetResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeleteTaskSet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeregisterContainerInstance(requestBody: DeregisterContainerInstanceRequest, headersHandler?: () => HttpHeaders): Observable<DeregisterContainerInstanceResponse> {
			return this.http.post<DeregisterContainerInstanceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeregisterContainerInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeregisterTaskDefinition(requestBody: DeregisterTaskDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<DeregisterTaskDefinitionResponse> {
			return this.http.post<DeregisterTaskDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DeregisterTaskDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCapacityProviders(requestBody: DescribeCapacityProvidersRequest, headersHandler?: () => HttpHeaders): Observable<DescribeCapacityProvidersResponse> {
			return this.http.post<DescribeCapacityProvidersResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeCapacityProviders', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DescribeClusters(requestBody: DescribeClustersRequest, headersHandler?: () => HttpHeaders): Observable<DescribeClustersResponse> {
			return this.http.post<DescribeClustersResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeClusters', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeContainerInstances(requestBody: DescribeContainerInstancesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeContainerInstancesResponse> {
			return this.http.post<DescribeContainerInstancesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeContainerInstances', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeServices(requestBody: DescribeServicesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeServicesResponse> {
			return this.http.post<DescribeServicesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeServices', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTaskDefinition(requestBody: DescribeTaskDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTaskDefinitionResponse> {
			return this.http.post<DescribeTaskDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeTaskDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTaskSets(requestBody: DescribeTaskSetsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTaskSetsResponse> {
			return this.http.post<DescribeTaskSetsResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeTaskSets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTasks(requestBody: DescribeTasksRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTasksResponse> {
			return this.http.post<DescribeTasksResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DescribeTasks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DiscoverPollEndpoint(requestBody: DiscoverPollEndpointRequest, headersHandler?: () => HttpHeaders): Observable<DiscoverPollEndpointResponse> {
			return this.http.post<DiscoverPollEndpointResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.DiscoverPollEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAccountSettings(maxResults: string, nextToken: string, requestBody: ListAccountSettingsRequest, headersHandler?: () => HttpHeaders): Observable<ListAccountSettingsResponse> {
			return this.http.post<ListAccountSettingsResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListAccountSettings?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAttributes(maxResults: string, nextToken: string, requestBody: ListAttributesRequest, headersHandler?: () => HttpHeaders): Observable<ListAttributesResponse> {
			return this.http.post<ListAttributesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListAttributes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListClusters(maxResults: string, nextToken: string, requestBody: ListClustersRequest, headersHandler?: () => HttpHeaders): Observable<ListClustersResponse> {
			return this.http.post<ListClustersResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListClusters?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListContainerInstances(maxResults: string, nextToken: string, requestBody: ListContainerInstancesRequest, headersHandler?: () => HttpHeaders): Observable<ListContainerInstancesResponse> {
		 ...
		 */
		ListServices(maxResults: string, nextToken: string, requestBody: ListServicesRequest, headersHandler?: () => HttpHeaders): Observable<ListServicesResponse> {
			return this.http.post<ListServicesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListServices?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTaskDefinitionFamilies(maxResults: string, nextToken: string, requestBody: ListTaskDefinitionFamiliesRequest, headersHandler?: () => HttpHeaders): Observable<ListTaskDefinitionFamiliesResponse> {
			return this.http.post<ListTaskDefinitionFamiliesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListTaskDefinitionFamilies?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTaskDefinitions(maxResults: string, nextToken: string, requestBody: ListTaskDefinitionsRequest, headersHandler?: () => HttpHeaders): Observable<ListTaskDefinitionsResponse> {
			return this.http.post<ListTaskDefinitionsResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListTaskDefinitions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTasks(maxResults: string, nextToken: string, requestBody: ListTasksRequest, headersHandler?: () => HttpHeaders): Observable<ListTasksResponse> {
			return this.http.post<ListTasksResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.ListTasks?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutAccountSetting(requestBody: PutAccountSettingRequest, headersHandler?: () => HttpHeaders): Observable<PutAccountSettingResponse> {
			return this.http.post<PutAccountSettingResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAccountSetting', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutAccountSettingDefault(requestBody: PutAccountSettingDefaultRequest, headersHandler?: () => HttpHeaders): Observable<PutAccountSettingDefaultResponse> {
			return this.http.post<PutAccountSettingDefaultResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAccountSettingDefault', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutAttributes(requestBody: PutAttributesRequest, headersHandler?: () => HttpHeaders): Observable<PutAttributesResponse> {
			return this.http.post<PutAttributesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutClusterCapacityProviders(requestBody: PutClusterCapacityProvidersRequest, headersHandler?: () => HttpHeaders): Observable<PutClusterCapacityProvidersResponse> {
			return this.http.post<PutClusterCapacityProvidersResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.PutClusterCapacityProviders', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterContainerInstance(requestBody: RegisterContainerInstanceRequest, headersHandler?: () => HttpHeaders): Observable<RegisterContainerInstanceResponse> {
			return this.http.post<RegisterContainerInstanceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.RegisterContainerInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterTaskDefinition(requestBody: RegisterTaskDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<RegisterTaskDefinitionResponse> {
			return this.http.post<RegisterTaskDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.RegisterTaskDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RunTask(requestBody: RunTaskRequest, headersHandler?: () => HttpHeaders): Observable<RunTaskResponse> {
			return this.http.post<RunTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.RunTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartTask(requestBody: StartTaskRequest, headersHandler?: () => HttpHeaders): Observable<StartTaskResponse> {
			return this.http.post<StartTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.StartTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopTask(requestBody: StopTaskRequest, headersHandler?: () => HttpHeaders): Observable<StopTaskResponse> {
			return this.http.post<StopTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.StopTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SubmitAttachmentStateChanges(requestBody: SubmitAttachmentStateChangesRequest, headersHandler?: () => HttpHeaders): Observable<SubmitAttachmentStateChangesResponse> {
			return this.http.post<SubmitAttachmentStateChangesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitAttachmentStateChanges', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SubmitContainerStateChange(requestBody: SubmitContainerStateChangeRequest, headersHandler?: () => HttpHeaders): Observable<SubmitContainerStateChangeResponse> {
			return this.http.post<SubmitContainerStateChangeResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitContainerStateChange', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SubmitTaskStateChange(requestBody: SubmitTaskStateChangeRequest, headersHandler?: () => HttpHeaders): Observable<SubmitTaskStateChangeResponse> {
			return this.http.post<SubmitTaskStateChangeResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.SubmitTaskStateChange', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateClusterSettings(requestBody: UpdateClusterSettingsRequest, headersHandler?: () => HttpHeaders): Observable<UpdateClusterSettingsResponse> {
			return this.http.post<UpdateClusterSettingsResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateClusterSettings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateContainerAgent(requestBody: UpdateContainerAgentRequest, headersHandler?: () => HttpHeaders): Observable<UpdateContainerAgentResponse> {
			return this.http.post<UpdateContainerAgentResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateContainerAgent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateContainerInstancesState(requestBody: UpdateContainerInstancesStateRequest, headersHandler?: () => HttpHeaders): Observable<UpdateContainerInstancesStateResponse> {
			return this.http.post<UpdateContainerInstancesStateResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateContainerInstancesState', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateService(requestBody: UpdateServiceRequest, headersHandler?: () => HttpHeaders): Observable<UpdateServiceResponse> {
			return this.http.post<UpdateServiceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateService', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateServicePrimaryTaskSet(requestBody: UpdateServicePrimaryTaskSetRequest, headersHandler?: () => HttpHeaders): Observable<UpdateServicePrimaryTaskSetResponse> {
			return this.http.post<UpdateServicePrimaryTaskSetResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateServicePrimaryTaskSet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTaskSet(requestBody: UpdateTaskSetRequest, headersHandler?: () => HttpHeaders): Observable<UpdateTaskSetResponse> {
			return this.http.post<UpdateTaskSetResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerServiceV20141113.UpdateTaskSet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
