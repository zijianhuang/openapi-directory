...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateDetectorModel(callback: (data : CreateDetectorModelResponse) => any, requestBody: CreateDetectorModelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/detector-models', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDetectorModels(nextToken: string, maxResults: number, callback: (data : ListDetectorModelsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/detector-models?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		...
		CreateInput(callback: (data : void) => any, requestBody: CreateInputBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/inputs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListInputs(nextToken: string, maxResults: number, callback: (data : ListInputsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/inputs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDetectorModel(detectorModelName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDetectorModel(detectorModelName: string, version: string, callback: (data : DescribeDetectorModelResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)) + '&version=' + (version == null ? '' : encodeURIComponent(version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDetectorModel(detectorModelName: string, callback: (data : UpdateDetectorModelResponse) => any, requestBody: UpdateDetectorModelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteInput(inputName: string, callback: (data : DeleteInputResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeInput(inputName: string, callback: (data : DescribeInputResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateInput(inputName: string, callback: (data : UpdateInputResponse) => any, requestBody: UpdateInputBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDetectorModelVersions(detectorModelName: string, nextToken: string, maxResults: number, callback: (data : ListDetectorModelVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)) + '/versions&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
