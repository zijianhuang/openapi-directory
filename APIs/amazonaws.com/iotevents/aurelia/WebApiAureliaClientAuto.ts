...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateDetectorModel(requestBody: CreateDetectorModelBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDetectorModelResponse> {
			return this.http.post('/detector-models', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDetectorModels(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDetectorModelsResponse> {
			return this.http.get('/detector-models?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateInput(requestBody: CreateInputBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/inputs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListInputs(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListInputsResponse> {
			return this.http.get('/inputs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDetectorModel(detectorModelName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeDetectorModel(detectorModelName: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDetectorModelResponse> {
			return this.http.get('/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)) + '&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDetectorModel(detectorModelName: string, requestBody: UpdateDetectorModelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorModelResponse> {
			return this.http.post('/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInput(inputName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInputResponse> {
			return this.http.delete('/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeInput(inputName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeInputResponse> {
			return this.http.get('/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateInput(inputName: string, requestBody: UpdateInputBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInputResponse> {
			return this.http.put('/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDetectorModelVersions(detectorModelName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDetectorModelVersionsResponse> {
			return this.http.get('/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)) + '/versions&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
