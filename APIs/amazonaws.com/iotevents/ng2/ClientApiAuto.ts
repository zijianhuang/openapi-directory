...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateDetectorModel(requestBody: CreateDetectorModelBody, headersHandler?: () => HttpHeaders): Observable<CreateDetectorModelResponse> {
			return this.http.post<CreateDetectorModelResponse>(this.baseUri + '/detector-models', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDetectorModels(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListDetectorModelsResponse> {
			return this.http.get<ListDetectorModelsResponse>(this.baseUri + '/detector-models?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CreateInput(requestBody: CreateInputBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/inputs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListInputs(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListInputsResponse> {
			return this.http.get<ListInputsResponse>(this.baseUri + '/inputs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDetectorModel(detectorModelName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeDetectorModel(detectorModelName: string, version: string, headersHandler?: () => HttpHeaders): Observable<DescribeDetectorModelResponse> {
			return this.http.get<DescribeDetectorModelResponse>(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)) + '&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDetectorModel(detectorModelName: string, requestBody: UpdateDetectorModelBody, headersHandler?: () => HttpHeaders): Observable<UpdateDetectorModelResponse> {
			return this.http.post<UpdateDetectorModelResponse>(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteInput(inputName: string, headersHandler?: () => HttpHeaders): Observable<DeleteInputResponse> {
			return this.http.delete<DeleteInputResponse>(this.baseUri + '/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeInput(inputName: string, headersHandler?: () => HttpHeaders): Observable<DescribeInputResponse> {
			return this.http.get<DescribeInputResponse>(this.baseUri + '/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateInput(inputName: string, requestBody: UpdateInputBody, headersHandler?: () => HttpHeaders): Observable<UpdateInputResponse> {
			return this.http.put<UpdateInputResponse>(this.baseUri + '/inputs/' + (inputName == null ? '' : encodeURIComponent(inputName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDetectorModelVersions(detectorModelName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListDetectorModelVersionsResponse> {
			return this.http.get<ListDetectorModelVersionsResponse>(this.baseUri + '/detector-models/' + (detectorModelName == null ? '' : encodeURIComponent(detectorModelName)) + '/versions&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
