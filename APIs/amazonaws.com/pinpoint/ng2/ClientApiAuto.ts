...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateApp(requestBody: CreateAppBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/apps', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetApps(page_size: string, token: string, headersHandler?: () => HttpHeaders): Observable<GetAppsResponse> {
			return this.http.get<GetAppsResponse>(this.baseUri + '/v1/apps?page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateCampaign(application_id: string, requestBody: CreateCampaignBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetCampaigns(application_id: string, page_size: string, token: string, headersHandler?: () => HttpHeaders): Observable<GetCampaignsResponse> {
			return this.http.get<GetCampaignsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateEmailTemplate(template_name: string, requestBody: CreateEmailTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteEmailTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetEmailTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetEmailTemplateResponse> {
			return this.http.get<GetEmailTemplateResponse>(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateEmailTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdateEmailTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email?create_new_version=' + create_new_version + '&version=' + (version == null ? '' : encodeURIComponent(version)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateExportJob(application_id: string, requestBody: CreateExportJobBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetExportJobs(application_id: string, page_size: string, token: string, headersHandler?: () => HttpHeaders): Observable<GetExportJobsResponse> {
			return this.http.get<GetExportJobsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateImportJob(application_id: string, requestBody: CreateImportJobBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetImportJobs(application_id: string, page_size: string, token: string, headersHandler?: () => HttpHeaders): Observable<GetImportJobsResponse> {
			return this.http.get<GetImportJobsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateJourney(application_id: string, requestBody: CreateJourneyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListJourneys(application_id: string, page_size: string, token: string, headersHandler?: () => HttpHeaders): Observable<ListJourneysResponse> {
			return this.http.get<ListJourneysResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreatePushTemplate(template_name: string, requestBody: CreatePushTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeletePushTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetPushTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetPushTemplateResponse> {
			return this.http.get<GetPushTemplateResponse>(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdatePushTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdatePushTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		CreateRecommenderConfiguration(requestBody: CreateRecommenderConfigurationBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/recommenders', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetRecommenderConfigurations(page_size: string, token: string, headersHandler?: () => HttpHeaders): Observable<GetRecommenderConfigurationsResponse> {
			return this.http.get<GetRecommenderConfigurationsResponse>(this.baseUri + '/v1/recommenders?page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateSegment(application_id: string, requestBody: CreateSegmentBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetSegments(application_id: string, page_size: string, token: string, headersHandler?: () => HttpHeaders): Observable<GetSegmentsResponse> {
			return this.http.get<GetSegmentsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateSmsTemplate(template_name: string, requestBody: CreateSmsTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteSmsTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetSmsTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetSmsTemplateResponse> {
			return this.http.get<GetSmsTemplateResponse>(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateSmsTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdateSmsTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		CreateVoiceTemplate(template_name: string, requestBody: CreateVoiceTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetVoiceTemplate(template_name: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetVoiceTemplateResponse> {
			return this.http.get<GetVoiceTemplateResponse>(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateVoiceTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdateVoiceTemplateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		DeleteAdmChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteAdmChannelResponse> {
			return this.http.delete<DeleteAdmChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetAdmChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetAdmChannelResponse> {
			return this.http.get<GetAdmChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateAdmChannel(application_id: string, requestBody: UpdateAdmChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateAdmChannelResponse> {
			return this.http.put<UpdateAdmChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApnsChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteApnsChannelResponse> {
			return this.http.delete<DeleteApnsChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetApnsChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetApnsChannelResponse> {
			return this.http.get<GetApnsChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateApnsChannel(application_id: string, requestBody: UpdateApnsChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateApnsChannelResponse> {
			return this.http.put<UpdateApnsChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApnsSandboxChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteApnsSandboxChannelResponse> {
			return this.http.delete<DeleteApnsSandboxChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetApnsSandboxChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetApnsSandboxChannelResponse> {
			return this.http.get<GetApnsSandboxChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateApnsSandboxChannel(application_id: string, requestBody: UpdateApnsSandboxChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateApnsSandboxChannelResponse> {
			return this.http.put<UpdateApnsSandboxChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApnsVoipChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteApnsVoipChannelResponse> {
			return this.http.delete<DeleteApnsVoipChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetApnsVoipChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetApnsVoipChannelResponse> {
			return this.http.get<GetApnsVoipChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateApnsVoipChannel(application_id: string, requestBody: UpdateApnsVoipChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateApnsVoipChannelResponse> {
			return this.http.put<UpdateApnsVoipChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApnsVoipSandboxChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteApnsVoipSandboxChannelResponse> {
			return this.http.delete<DeleteApnsVoipSandboxChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetApnsVoipSandboxChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetApnsVoipSandboxChannelResponse> {
			return this.http.get<GetApnsVoipSandboxChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateApnsVoipSandboxChannel(application_id: string, requestBody: UpdateApnsVoipSandboxChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateApnsVoipSandboxChannelResponse> {
			return this.http.put<UpdateApnsVoipSandboxChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApp(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteAppResponse> {
			return this.http.delete<DeleteAppResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetApp(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetAppResponse> {
			return this.http.get<GetAppResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteBaiduChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteBaiduChannelResponse> {
			return this.http.delete<DeleteBaiduChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBaiduChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetBaiduChannelResponse> {
			return this.http.get<GetBaiduChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateBaiduChannel(application_id: string, requestBody: UpdateBaiduChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateBaiduChannelResponse> {
			return this.http.put<UpdateBaiduChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteCampaign(application_id: string, campaign_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteCampaignResponse> {
			return this.http.delete<DeleteCampaignResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetCampaign(application_id: string, campaign_id: string, headersHandler?: () => HttpHeaders): Observable<GetCampaignResponse> {
			return this.http.get<GetCampaignResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateCampaign(application_id: string, campaign_id: string, requestBody: UpdateCampaignBody, headersHandler?: () => HttpHeaders): Observable<UpdateCampaignResponse> {
			return this.http.put<UpdateCampaignResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteEmailChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteEmailChannelResponse> {
			return this.http.delete<DeleteEmailChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetEmailChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetEmailChannelResponse> {
			return this.http.get<GetEmailChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateEmailChannel(application_id: string, requestBody: UpdateEmailChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateEmailChannelResponse> {
			return this.http.put<UpdateEmailChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteEndpoint(application_id: string, endpoint_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints/' + (endpoint_id == null ? '' : encodeURIComponent(endpoint_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetEndpoint(application_id: string, endpoint_id: string, headersHandler?: () => HttpHeaders): Observable<GetEndpointResponse> {
			return this.http.get<GetEndpointResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints/' + (endpoint_id == null ? '' : encodeURIComponent(endpoint_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateEndpoint(application_id: string, endpoint_id: string, requestBody: UpdateEndpointBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		DeleteEventStream(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteEventStreamResponse> {
			return this.http.delete<DeleteEventStreamResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetEventStream(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetEventStreamResponse> {
			return this.http.get<GetEventStreamResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		PutEventStream(application_id: string, requestBody: PutEventStreamBody, headersHandler?: () => HttpHeaders): Observable<PutEventStreamResponse> {
			return this.http.post<PutEventStreamResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteGcmChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteGcmChannelResponse> {
			return this.http.delete<DeleteGcmChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetGcmChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetGcmChannelResponse> {
			return this.http.get<GetGcmChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateGcmChannel(application_id: string, requestBody: UpdateGcmChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateGcmChannelResponse> {
			return this.http.put<UpdateGcmChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteJourney(application_id: string, journey_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteJourneyResponse> {
			return this.http.delete<DeleteJourneyResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetJourney(application_id: string, journey_id: string, headersHandler?: () => HttpHeaders): Observable<GetJourneyResponse> {
			return this.http.get<GetJourneyResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateJourney(application_id: string, journey_id: string, requestBody: UpdateJourneyBody, headersHandler?: () => HttpHeaders): Observable<UpdateJourneyResponse> {
			return this.http.put<UpdateJourneyResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRecommenderConfiguration(recommender_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteRecommenderConfigurationResponse> {
			return this.http.delete<DeleteRecommenderConfigurationResponse>(this.baseUri + '/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetRecommenderConfiguration(recommender_id: string, headersHandler?: () => HttpHeaders): Observable<GetRecommenderConfigurationResponse> {
			return this.http.get<GetRecommenderConfigurationResponse>(this.baseUri + '/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateRecommenderConfiguration(recommender_id: string, requestBody: UpdateRecommenderConfigurationBody, headersHandler?: () => HttpHeaders): Observable<UpdateRecommenderConfigurationResponse> {
			return this.http.put<UpdateRecommenderConfigurationResponse>(this.baseUri + '/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSegment(application_id: string, segment_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteSegmentResponse> {
			return this.http.delete<DeleteSegmentResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSegment(application_id: string, segment_id: string, headersHandler?: () => HttpHeaders): Observable<GetSegmentResponse> {
			return this.http.get<GetSegmentResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateSegment(application_id: string, segment_id: string, requestBody: UpdateSegmentBody, headersHandler?: () => HttpHeaders): Observable<UpdateSegmentResponse> {
			return this.http.put<UpdateSegmentResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSmsChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteSmsChannelResponse> {
			return this.http.delete<DeleteSmsChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSmsChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetSmsChannelResponse> {
			return this.http.get<GetSmsChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateSmsChannel(application_id: string, requestBody: UpdateSmsChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateSmsChannelResponse> {
			return this.http.put<UpdateSmsChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUserEndpoints(application_id: string, user_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users/' + (user_id == null ? '' : encodeURIComponent(user_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetUserEndpoints(application_id: string, user_id: string, headersHandler?: () => HttpHeaders): Observable<GetUserEndpointsResponse> {
			return this.http.get<GetUserEndpointsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users/' + (user_id == null ? '' : encodeURIComponent(user_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteVoiceChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<DeleteVoiceChannelResponse> {
			return this.http.delete<DeleteVoiceChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetVoiceChannel(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetVoiceChannelResponse> {
			return this.http.get<GetVoiceChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateVoiceChannel(application_id: string, requestBody: UpdateVoiceChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateVoiceChannelResponse> {
			return this.http.put<UpdateVoiceChannelResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetApplicationDateRangeKpi(application_id: string, end_time: Date, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => HttpHeaders): Observable<GetApplicationDateRangeKpiResponse> {
		 ...
		 */
		GetApplicationSettings(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetApplicationSettingsResponse> {
			return this.http.get<GetApplicationSettingsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/settings', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateApplicationSettings(application_id: string, requestBody: UpdateApplicationSettingsBody, headersHandler?: () => HttpHeaders): Observable<UpdateApplicationSettingsResponse> {
			return this.http.put<UpdateApplicationSettingsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/settings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetCampaignDateRangeKpi(application_id: string, campaign_id: string, end_time: Date, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => HttpHeaders): Observable<GetCampaignDateRangeKpiResponse> {
		 ...
		 */
		GetCampaignVersion(application_id: string, campaign_id: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetCampaignVersionResponse> {
			return this.http.get<GetCampaignVersionResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetChannels(application_id: string, headersHandler?: () => HttpHeaders): Observable<GetChannelsResponse> {
			return this.http.get<GetChannelsResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetExportJob(application_id: string, job_id: string, headersHandler?: () => HttpHeaders): Observable<GetExportJobResponse> {
			return this.http.get<GetExportJobResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export/' + (job_id == null ? '' : encodeURIComponent(job_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetImportJob(application_id: string, job_id: string, headersHandler?: () => HttpHeaders): Observable<GetImportJobResponse> {
			return this.http.get<GetImportJobResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import/' + (job_id == null ? '' : encodeURIComponent(job_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetJourneyDateRangeKpi(application_id: string, end_time: Date, journey_id: string, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => HttpHeaders): Observable<GetJourneyDateRangeKpiResponse> {
		 ...
		 */
		GetJourneyExecutionActivityMetrics(application_id: string, journey_activity_id: string, journey_id: string, next_token: string, page_size: string, headersHandler?: () => HttpHeaders): Observable<GetJourneyExecutionActivityMetricsResponse> {
		 ...
		 */
		GetJourneyExecutionMetrics(application_id: string, journey_id: string, next_token: string, page_size: string, headersHandler?: () => HttpHeaders): Observable<GetJourneyExecutionMetricsResponse> {
		 ...
		 */
		GetSegmentVersion(application_id: string, segment_id: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetSegmentVersionResponse> {
			return this.http.get<GetSegmentVersionResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTagsForResource(resource_arn: string, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.get<ListTagsForResourceResponse>(this.baseUri + '/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListTemplateVersions(next_token: string, page_size: string, template_name: string, template_type: string, headersHandler?: () => HttpHeaders): Observable<ListTemplateVersionsResponse> {
		 ...
		 */
		ListTemplates(next_token: string, page_size: string, prefix: string, template_type: string, headersHandler?: () => HttpHeaders): Observable<ListTemplatesResponse> {
		 ...
		 */
		PhoneNumberValidate(requestBody: PhoneNumberValidateBody, headersHandler?: () => HttpHeaders): Observable<PhoneNumberValidateResponse> {
			return this.http.post<PhoneNumberValidateResponse>(this.baseUri + '/v1/phone/number/validate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		PutEvents(application_id: string, requestBody: PutEventsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/events', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		RemoveAttributes(application_id: string, attribute_type: string, requestBody: RemoveAttributesBody, headersHandler?: () => HttpHeaders): Observable<RemoveAttributesResponse> {
			return this.http.put<RemoveAttributesResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/attributes/' + (attribute_type == null ? '' : encodeURIComponent(attribute_type)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendMessages(application_id: string, requestBody: SendMessagesBody, headersHandler?: () => HttpHeaders): Observable<SendMessagesResponse> {
			return this.http.post<SendMessagesResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/messages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendUsersMessages(application_id: string, requestBody: SendUsersMessagesBody, headersHandler?: () => HttpHeaders): Observable<SendUsersMessagesResponse> {
			return this.http.post<SendUsersMessagesResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users-messages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(resource_arn: string, tagKeys: Array<__string>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateEndpointsBatch(application_id: string, requestBody: UpdateEndpointsBatchBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateJourneyState(application_id: string, journey_id: string, requestBody: UpdateJourneyStateBody, headersHandler?: () => HttpHeaders): Observable<UpdateJourneyStateResponse> {
			return this.http.put<UpdateJourneyStateResponse>(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/state', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTemplateActiveVersion(template_name: string, template_type: string, requestBody: UpdateTemplateActiveVersionBody, headersHandler?: () => HttpHeaders): Observable<UpdateTemplateActiveVersionResponse> {
			return this.http.put<UpdateTemplateActiveVersionResponse>(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/' + (template_type == null ? '' : encodeURIComponent(template_type)) + '/active-version', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
