...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateApp(requestBody: CreateAppBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/apps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetApps(page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetAppsResponse> {
			return this.http.get('/v1/apps?page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateCampaign(application_id: string, requestBody: CreateCampaignBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetCampaigns(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateEmailTemplate(template_name: string, requestBody: CreateEmailTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteEmailTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEmailTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetEmailTemplateResponse> {
			return this.http.get('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateEmailTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdateEmailTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email?create_new_version=' + create_new_version + '&version=' + (version == null ? '' : encodeURIComponent(version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		CreateExportJob(application_id: string, requestBody: CreateExportJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetExportJobs(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetExportJobsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateImportJob(application_id: string, requestBody: CreateImportJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetImportJobs(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetImportJobsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateJourney(application_id: string, requestBody: CreateJourneyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListJourneys(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<ListJourneysResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreatePushTemplate(template_name: string, requestBody: CreatePushTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeletePushTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPushTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetPushTemplateResponse> {
			return this.http.get('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdatePushTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdatePushTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push?create_new_version=' + create_new_version + '&version=' + (version == null ? '' : encodeURIComponent(version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		CreateRecommenderConfiguration(requestBody: CreateRecommenderConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/recommenders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetRecommenderConfigurations(page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetRecommenderConfigurationsResponse> {
			return this.http.get('/v1/recommenders?page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateSegment(application_id: string, requestBody: CreateSegmentBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetSegments(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateSmsTemplate(template_name: string, requestBody: CreateSmsTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteSmsTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetSmsTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetSmsTemplateResponse> {
			return this.http.get('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateSmsTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdateSmsTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms?create_new_version=' + create_new_version + '&version=' + (version == null ? '' : encodeURIComponent(version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		CreateVoiceTemplate(template_name: string, requestBody: CreateVoiceTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceTemplateResponse> {
			return this.http.get('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice&version=' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateVoiceTemplate(create_new_version: boolean, template_name: string, version: string, requestBody: UpdateVoiceTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice?create_new_version=' + create_new_version + '&version=' + (version == null ? '' : encodeURIComponent(version)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteAdmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAdmChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetAdmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetAdmChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateAdmChannel(application_id: string, requestBody: UpdateAdmChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAdmChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApnsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsChannel(application_id: string, requestBody: UpdateApnsChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApnsSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsSandboxChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsSandboxChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsSandboxChannel(application_id: string, requestBody: UpdateApnsSandboxChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsSandboxChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApnsVoipChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsVoipChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsVoipChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsVoipChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsVoipChannel(application_id: string, requestBody: UpdateApnsVoipChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsVoipChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApnsVoipSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsVoipSandboxChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsVoipSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsVoipSandboxChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsVoipSandboxChannel(application_id: string, requestBody: UpdateApnsVoipSandboxChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsVoipSandboxChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApp(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAppResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApp(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetAppResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBaiduChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBaiduChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBaiduChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetBaiduChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBaiduChannel(application_id: string, requestBody: UpdateBaiduChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBaiduChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteCampaign(application_id: string, campaign_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteCampaignResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCampaign(application_id: string, campaign_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateCampaign(application_id: string, campaign_id: string, requestBody: UpdateCampaignBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateCampaignResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteEmailChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteEmailChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEmailChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetEmailChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateEmailChannel(application_id: string, requestBody: UpdateEmailChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateEmailChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteEndpoint(application_id: string, endpoint_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints/' + (endpoint_id == null ? '' : encodeURIComponent(endpoint_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEndpoint(application_id: string, endpoint_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetEndpointResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints/' + (endpoint_id == null ? '' : encodeURIComponent(endpoint_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateEndpoint(application_id: string, endpoint_id: string, requestBody: UpdateEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints/' + (endpoint_id == null ? '' : encodeURIComponent(endpoint_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteEventStream(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteEventStreamResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEventStream(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetEventStreamResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutEventStream(application_id: string, requestBody: PutEventStreamBody, headersHandler?: () => {[header: string]: string}): Promise<PutEventStreamResponse> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteGcmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGcmChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetGcmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetGcmChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGcmChannel(application_id: string, requestBody: UpdateGcmChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateGcmChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteJourney(application_id: string, journey_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteJourneyResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourney(application_id: string, journey_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateJourney(application_id: string, journey_id: string, requestBody: UpdateJourneyBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateJourneyResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRecommenderConfiguration(recommender_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteRecommenderConfigurationResponse> {
			return this.http.delete('/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRecommenderConfiguration(recommender_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetRecommenderConfigurationResponse> {
			return this.http.get('/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateRecommenderConfiguration(recommender_id: string, requestBody: UpdateRecommenderConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRecommenderConfigurationResponse> {
			return this.http.put('/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSegment(application_id: string, segment_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteSegmentResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegment(application_id: string, segment_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateSegment(application_id: string, segment_id: string, requestBody: UpdateSegmentBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSegmentResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSmsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteSmsChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSmsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetSmsChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateSmsChannel(application_id: string, requestBody: UpdateSmsChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSmsChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteUserEndpoints(application_id: string, user_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users/' + (user_id == null ? '' : encodeURIComponent(user_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetUserEndpoints(application_id: string, user_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetUserEndpointsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users/' + (user_id == null ? '' : encodeURIComponent(user_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteVoiceChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteVoiceChannelResponse> {
			return this.http.delete('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetVoiceChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceChannelResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateVoiceChannel(application_id: string, requestBody: UpdateVoiceChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateVoiceChannelResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetApplicationDateRangeKpi(application_id: string, end_time: Date, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationDateRangeKpiResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/kpis/daterange/' + (kpi_name == null ? '' : encodeURIComponent(kpi_name)) + '&end_time=' + end_time.toISOString() + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&start_time=' + start_time.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApplicationSettings(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationSettingsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApplicationSettings(application_id: string, requestBody: UpdateApplicationSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApplicationSettingsResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCampaignActivities(application_id: string, campaign_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignActivitiesResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/activities&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCampaignDateRangeKpi(application_id: string, campaign_id: string, end_time: Date, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignDateRangeKpiResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/kpis/daterange/' + (kpi_name == null ? '' : encodeURIComponent(kpi_name)) + '&end_time=' + end_time.toISOString() + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&start_time=' + start_time.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCampaignVersion(application_id: string, campaign_id: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignVersionResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCampaignVersions(application_id: string, campaign_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignVersionsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/versions&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetChannels(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetChannelsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetExportJob(application_id: string, job_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetExportJobResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export/' + (job_id == null ? '' : encodeURIComponent(job_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImportJob(application_id: string, job_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetImportJobResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import/' + (job_id == null ? '' : encodeURIComponent(job_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourneyDateRangeKpi(application_id: string, end_time: Date, journey_id: string, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyDateRangeKpiResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/kpis/daterange/' + (kpi_name == null ? '' : encodeURIComponent(kpi_name)) + '&end_time=' + end_time.toISOString() + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&start_time=' + start_time.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourneyExecutionActivityMetrics(application_id: string, journey_activity_id: string, journey_id: string, next_token: string, page_size: string, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyExecutionActivityMetricsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/activities/' + (journey_activity_id == null ? '' : encodeURIComponent(journey_activity_id)) + '/execution-metrics&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourneyExecutionMetrics(application_id: string, journey_id: string, next_token: string, page_size: string, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyExecutionMetricsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/execution-metrics&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentExportJobs(application_id: string, page_size: string, segment_id: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentExportJobsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/jobs/export&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentImportJobs(application_id: string, page_size: string, segment_id: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentImportJobsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/jobs/import&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentVersion(application_id: string, segment_id: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentVersionResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentVersions(application_id: string, page_size: string, segment_id: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentVersionsResponse> {
			return this.http.get('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/versions&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(resource_arn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.get('/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListTemplateVersions(next_token: string, page_size: string, template_name: string, template_type: string, headersHandler?: () => {[header: string]: string}): Promise<ListTemplateVersionsResponse> {
			return this.http.get('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/' + (template_type == null ? '' : encodeURIComponent(template_type)) + '/versions?next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTemplates(next_token: string, page_size: string, prefix: string, template_type: string, headersHandler?: () => {[header: string]: string}): Promise<ListTemplatesResponse> {
			return this.http.get('/v1/templates?next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&prefix=' + (prefix == null ? '' : encodeURIComponent(prefix)) + '&template_type=' + (template_type == null ? '' : encodeURIComponent(template_type)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PhoneNumberValidate(requestBody: PhoneNumberValidateBody, headersHandler?: () => {[header: string]: string}): Promise<PhoneNumberValidateResponse> {
			return this.http.post('/v1/phone/number/validate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PutEvents(application_id: string, requestBody: PutEventsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/events', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RemoveAttributes(application_id: string, attribute_type: string, requestBody: RemoveAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<RemoveAttributesResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/attributes/' + (attribute_type == null ? '' : encodeURIComponent(attribute_type)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendMessages(application_id: string, requestBody: SendMessagesBody, headersHandler?: () => {[header: string]: string}): Promise<SendMessagesResponse> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/messages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendUsersMessages(application_id: string, requestBody: SendUsersMessagesBody, headersHandler?: () => {[header: string]: string}): Promise<SendUsersMessagesResponse> {
			return this.http.post('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users-messages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(resource_arn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateEndpointsBatch(application_id: string, requestBody: UpdateEndpointsBatchBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateJourneyState(application_id: string, journey_id: string, requestBody: UpdateJourneyStateBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateJourneyStateResponse> {
			return this.http.put('/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/state', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTemplateActiveVersion(template_name: string, template_type: string, requestBody: UpdateTemplateActiveVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateTemplateActiveVersionResponse> {
			return this.http.put('/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/' + (template_type == null ? '' : encodeURIComponent(template_type)) + '/active-version', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
