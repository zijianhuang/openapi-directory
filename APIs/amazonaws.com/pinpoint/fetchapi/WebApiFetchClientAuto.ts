export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApp(requestBody: CreateAppBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetApps(page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetAppsResponse> {
			return fetch(this.baseUri + '/v1/apps?page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateCampaign(application_id: string, requestBody: CreateCampaignBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetCampaigns(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateEmailTemplate(template_name: string, requestBody: CreateEmailTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteEmailTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEmailTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetEmailTemplateResponse> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/email&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateExportJob(application_id: string, requestBody: CreateExportJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetExportJobs(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetExportJobsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateImportJob(application_id: string, requestBody: CreateImportJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetImportJobs(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetImportJobsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateJourney(application_id: string, requestBody: CreateJourneyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListJourneys(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<ListJourneysResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePushTemplate(template_name: string, requestBody: CreatePushTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeletePushTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPushTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetPushTemplateResponse> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/push&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateRecommenderConfiguration(requestBody: CreateRecommenderConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/recommenders', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetRecommenderConfigurations(page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetRecommenderConfigurationsResponse> {
			return fetch(this.baseUri + '/v1/recommenders?page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateSegment(application_id: string, requestBody: CreateSegmentBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetSegments(application_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateSmsTemplate(template_name: string, requestBody: CreateSmsTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteSmsTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetSmsTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetSmsTemplateResponse> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/sms&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateVoiceTemplate(template_name: string, requestBody: CreateVoiceTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteVoiceTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceTemplate(template_name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceTemplateResponse> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/voice&version=' + (version == null ? '' : encodeURIComponent(version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteAdmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAdmChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetAdmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetAdmChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateAdmChannel(application_id: string, requestBody: UpdateAdmChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAdmChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/adm', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApnsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsChannel(application_id: string, requestBody: UpdateApnsChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApnsSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsSandboxChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsSandboxChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsSandboxChannel(application_id: string, requestBody: UpdateApnsSandboxChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsSandboxChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_sandbox', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApnsVoipChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsVoipChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsVoipChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsVoipChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsVoipChannel(application_id: string, requestBody: UpdateApnsVoipChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsVoipChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApnsVoipSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApnsVoipSandboxChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApnsVoipSandboxChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApnsVoipSandboxChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApnsVoipSandboxChannel(application_id: string, requestBody: UpdateApnsVoipSandboxChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApnsVoipSandboxChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/apns_voip_sandbox', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApp(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAppResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApp(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetAppResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBaiduChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBaiduChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBaiduChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetBaiduChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBaiduChannel(application_id: string, requestBody: UpdateBaiduChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBaiduChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/baidu', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteCampaign(application_id: string, campaign_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteCampaignResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCampaign(application_id: string, campaign_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateCampaign(application_id: string, campaign_id: string, requestBody: UpdateCampaignBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateCampaignResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEmailChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteEmailChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEmailChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetEmailChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateEmailChannel(application_id: string, requestBody: UpdateEmailChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateEmailChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/email', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEndpoint(application_id: string, endpoint_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints/' + (endpoint_id == null ? '' : encodeURIComponent(endpoint_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEndpoint(application_id: string, endpoint_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetEndpointResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints/' + (endpoint_id == null ? '' : encodeURIComponent(endpoint_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteEventStream(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteEventStreamResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEventStream(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetEventStreamResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutEventStream(application_id: string, requestBody: PutEventStreamBody, headersHandler?: () => {[header: string]: string}): Promise<PutEventStreamResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/eventstream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteGcmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGcmChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetGcmChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetGcmChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGcmChannel(application_id: string, requestBody: UpdateGcmChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateGcmChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/gcm', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteJourney(application_id: string, journey_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteJourneyResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourney(application_id: string, journey_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateJourney(application_id: string, journey_id: string, requestBody: UpdateJourneyBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateJourneyResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteRecommenderConfiguration(recommender_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteRecommenderConfigurationResponse> {
			return fetch(this.baseUri + '/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRecommenderConfiguration(recommender_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetRecommenderConfigurationResponse> {
			return fetch(this.baseUri + '/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateRecommenderConfiguration(recommender_id: string, requestBody: UpdateRecommenderConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRecommenderConfigurationResponse> {
			return fetch(this.baseUri + '/v1/recommenders/' + (recommender_id == null ? '' : encodeURIComponent(recommender_id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSegment(application_id: string, segment_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteSegmentResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegment(application_id: string, segment_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateSegment(application_id: string, segment_id: string, requestBody: UpdateSegmentBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSegmentResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSmsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteSmsChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSmsChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetSmsChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateSmsChannel(application_id: string, requestBody: UpdateSmsChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSmsChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/sms', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteUserEndpoints(application_id: string, user_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users/' + (user_id == null ? '' : encodeURIComponent(user_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetUserEndpoints(application_id: string, user_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetUserEndpointsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users/' + (user_id == null ? '' : encodeURIComponent(user_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteVoiceChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteVoiceChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetVoiceChannel(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateVoiceChannel(application_id: string, requestBody: UpdateVoiceChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateVoiceChannelResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels/voice', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetApplicationDateRangeKpi(application_id: string, end_time: Date, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationDateRangeKpiResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/kpis/daterange/' + (kpi_name == null ? '' : encodeURIComponent(kpi_name)) + '&end_time=' + end_time.toISOString() + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&start_time=' + start_time.toISOString(), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApplicationSettings(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationSettingsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/settings', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApplicationSettings(application_id: string, requestBody: UpdateApplicationSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApplicationSettingsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/settings', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetCampaignDateRangeKpi(application_id: string, campaign_id: string, end_time: Date, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignDateRangeKpiResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/kpis/daterange/' + (kpi_name == null ? '' : encodeURIComponent(kpi_name)) + '&end_time=' + end_time.toISOString() + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&start_time=' + start_time.toISOString(), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCampaignVersion(application_id: string, campaign_id: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignVersionResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCampaignVersions(application_id: string, campaign_id: string, page_size: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetCampaignVersionsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/campaigns/' + (campaign_id == null ? '' : encodeURIComponent(campaign_id)) + '/versions&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetChannels(application_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetChannelsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/channels', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetExportJob(application_id: string, job_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetExportJobResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/export/' + (job_id == null ? '' : encodeURIComponent(job_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImportJob(application_id: string, job_id: string, headersHandler?: () => {[header: string]: string}): Promise<GetImportJobResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/jobs/import/' + (job_id == null ? '' : encodeURIComponent(job_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourneyDateRangeKpi(application_id: string, end_time: Date, journey_id: string, kpi_name: string, next_token: string, page_size: string, start_time: Date, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyDateRangeKpiResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/kpis/daterange/' + (kpi_name == null ? '' : encodeURIComponent(kpi_name)) + '&end_time=' + end_time.toISOString() + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&start_time=' + start_time.toISOString(), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourneyExecutionActivityMetrics(application_id: string, journey_activity_id: string, journey_id: string, next_token: string, page_size: string, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyExecutionActivityMetricsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/activities/' + (journey_activity_id == null ? '' : encodeURIComponent(journey_activity_id)) + '/execution-metrics&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJourneyExecutionMetrics(application_id: string, journey_id: string, next_token: string, page_size: string, headersHandler?: () => {[header: string]: string}): Promise<GetJourneyExecutionMetricsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/execution-metrics&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentExportJobs(application_id: string, page_size: string, segment_id: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentExportJobsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/jobs/export&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentImportJobs(application_id: string, page_size: string, segment_id: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentImportJobsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/jobs/import&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentVersion(application_id: string, segment_id: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentVersionResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSegmentVersions(application_id: string, page_size: string, segment_id: string, token: string, headersHandler?: () => {[header: string]: string}): Promise<GetSegmentVersionsResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/segments/' + (segment_id == null ? '' : encodeURIComponent(segment_id)) + '/versions&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&token=' + (token == null ? '' : encodeURIComponent(token)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(resource_arn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListTemplates(next_token: string, page_size: string, prefix: string, template_type: string, headersHandler?: () => {[header: string]: string}): Promise<ListTemplatesResponse> {
			return fetch(this.baseUri + '/v1/templates?next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&page_size=' + (page_size == null ? '' : encodeURIComponent(page_size)) + '&prefix=' + (prefix == null ? '' : encodeURIComponent(prefix)) + '&template_type=' + (template_type == null ? '' : encodeURIComponent(template_type)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PhoneNumberValidate(requestBody: PhoneNumberValidateBody, headersHandler?: () => {[header: string]: string}): Promise<PhoneNumberValidateResponse> {
			return fetch(this.baseUri + '/v1/phone/number/validate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutEvents(application_id: string, requestBody: PutEventsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/events', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RemoveAttributes(application_id: string, attribute_type: string, requestBody: RemoveAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<RemoveAttributesResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/attributes/' + (attribute_type == null ? '' : encodeURIComponent(attribute_type)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SendMessages(application_id: string, requestBody: SendMessagesBody, headersHandler?: () => {[header: string]: string}): Promise<SendMessagesResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/messages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SendUsersMessages(application_id: string, requestBody: SendUsersMessagesBody, headersHandler?: () => {[header: string]: string}): Promise<SendUsersMessagesResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/users-messages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(resource_arn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateEndpointsBatch(application_id: string, requestBody: UpdateEndpointsBatchBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/endpoints', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateJourneyState(application_id: string, journey_id: string, requestBody: UpdateJourneyStateBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateJourneyStateResponse> {
			return fetch(this.baseUri + '/v1/apps/' + (application_id == null ? '' : encodeURIComponent(application_id)) + '/journeys/' + (journey_id == null ? '' : encodeURIComponent(journey_id)) + '/state', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateTemplateActiveVersion(template_name: string, template_type: string, requestBody: UpdateTemplateActiveVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateTemplateActiveVersionResponse> {
			return fetch(this.baseUri + '/v1/templates/' + (template_name == null ? '' : encodeURIComponent(template_name)) + '/' + (template_type == null ? '' : encodeURIComponent(template_type)) + '/active-version', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
