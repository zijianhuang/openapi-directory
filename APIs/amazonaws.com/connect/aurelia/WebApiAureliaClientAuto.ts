...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateUser(InstanceId: string, requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}): Promise<CreateUserResponse> {
			return this.http.put('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUser(InstanceId: string, UserId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeUser(UserId: string, InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserResponse> {
			return this.http.get('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeUserHierarchyGroup(HierarchyGroupId: string, InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserHierarchyGroupResponse> {
			return this.http.get('/user-hierarchy-groups/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (HierarchyGroupId == null ? '' : encodeURIComponent(HierarchyGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeUserHierarchyStructure(InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserHierarchyStructureResponse> {
			return this.http.get('/user-hierarchy-structure/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetContactAttributes(InstanceId: string, InitialContactId: string, headersHandler?: () => {[header: string]: string}): Promise<GetContactAttributesResponse> {
			return this.http.get('/contact/attributes/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (InitialContactId == null ? '' : encodeURIComponent(InitialContactId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFederationToken(InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<GetFederationTokenResponse> {
			return this.http.get('/user/federate/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMetricData(InstanceId: string, MaxResults: string, NextToken: string, requestBody: GetMetricDataBody, headersHandler?: () => {[header: string]: string}): Promise<GetMetricDataResponse> {
			return this.http.post('/metrics/historical/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListContactFlows(InstanceId: string, contactFlowTypes: Array<ContactFlowType>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListContactFlowsResponse> {
			return this.http.get('/contact-flows-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + contactFlowTypes.map(z => `contactFlowTypes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListHoursOfOperations(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListHoursOfOperationsResponse> {
			return this.http.get('/hours-of-operations-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPhoneNumbers(InstanceId: string, phoneNumberTypes: Array<PhoneNumberType>, phoneNumberCountryCodes: Array<PhoneNumberCountryCode>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPhoneNumbersResponse> {
			return this.http.get('/phone-numbers-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + phoneNumberTypes.map(z => `phoneNumberTypes=${z}`).join('&') + '&' + phoneNumberCountryCodes.map(z => `phoneNumberCountryCodes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListQueues(InstanceId: string, queueTypes: Array<QueueType>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListQueuesResponse> {
			return this.http.get('/queues-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + queueTypes.map(z => `queueTypes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListRoutingProfiles(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRoutingProfilesResponse> {
			return this.http.get('/routing-profiles-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListSecurityProfiles(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListSecurityProfilesResponse> {
			return this.http.get('/security-profiles-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListUserHierarchyGroups(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListUserHierarchyGroupsResponse> {
			return this.http.get('/user-hierarchy-groups-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListUsers(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListUsersResponse> {
			return this.http.get('/users-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartChatContact(requestBody: StartChatContactBody, headersHandler?: () => {[header: string]: string}): Promise<StartChatContactResponse> {
			return this.http.put('/contact/chat', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartOutboundVoiceContact(requestBody: StartOutboundVoiceContactBody, headersHandler?: () => {[header: string]: string}): Promise<StartOutboundVoiceContactResponse> {
			return this.http.put('/contact/outbound-voice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopContact(requestBody: StopContactBody, headersHandler?: () => {[header: string]: string}): Promise<StopContactResponse> {
			return this.http.post('/contact/stop', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateContactAttributes(requestBody: UpdateContactAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateContactAttributesResponse> {
			return this.http.post('/contact/attributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateUserHierarchy(UserId: string, InstanceId: string, requestBody: UpdateUserHierarchyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/hierarchy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateUserIdentityInfo(UserId: string, InstanceId: string, requestBody: UpdateUserIdentityInfoBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/identity-info', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateUserPhoneConfig(UserId: string, InstanceId: string, requestBody: UpdateUserPhoneConfigBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/phone-config', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateUserRoutingProfile(UserId: string, InstanceId: string, requestBody: UpdateUserRoutingProfileBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/routing-profile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateUserSecurityProfiles(UserId: string, InstanceId: string, requestBody: UpdateUserSecurityProfilesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/security-profiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
