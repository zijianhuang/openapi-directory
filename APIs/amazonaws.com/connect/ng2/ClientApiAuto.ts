...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateUser(InstanceId: string, requestBody: CreateUserBody, headersHandler?: () => HttpHeaders): Observable<CreateUserResponse> {
			return this.http.put<CreateUserResponse>(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteUser(InstanceId: string, UserId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeUser(UserId: string, InstanceId: string, headersHandler?: () => HttpHeaders): Observable<DescribeUserResponse> {
			return this.http.get<DescribeUserResponse>(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeUserHierarchyGroup(HierarchyGroupId: string, InstanceId: string, headersHandler?: () => HttpHeaders): Observable<DescribeUserHierarchyGroupResponse> {
			return this.http.get<DescribeUserHierarchyGroupResponse>(this.baseUri + '/user-hierarchy-groups/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (HierarchyGroupId == null ? '' : encodeURIComponent(HierarchyGroupId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeUserHierarchyStructure(InstanceId: string, headersHandler?: () => HttpHeaders): Observable<DescribeUserHierarchyStructureResponse> {
			return this.http.get<DescribeUserHierarchyStructureResponse>(this.baseUri + '/user-hierarchy-structure/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetContactAttributes(InstanceId: string, InitialContactId: string, headersHandler?: () => HttpHeaders): Observable<GetContactAttributesResponse> {
			return this.http.get<GetContactAttributesResponse>(this.baseUri + '/contact/attributes/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (InitialContactId == null ? '' : encodeURIComponent(InitialContactId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetCurrentMetricData(InstanceId: string, MaxResults: string, NextToken: string, requestBody: GetCurrentMetricDataBody, headersHandler?: () => HttpHeaders): Observable<GetCurrentMetricDataResponse> {
		 ...
		 */
		GetFederationToken(InstanceId: string, headersHandler?: () => HttpHeaders): Observable<GetFederationTokenResponse> {
			return this.http.get<GetFederationTokenResponse>(this.baseUri + '/user/federate/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetMetricData(InstanceId: string, MaxResults: string, NextToken: string, requestBody: GetMetricDataBody, headersHandler?: () => HttpHeaders): Observable<GetMetricDataResponse> {
		 ...
		 */
		ListContactFlows(InstanceId: string, contactFlowTypes: Array<ContactFlowType>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListContactFlowsResponse> {
			return this.http.get<ListContactFlowsResponse>(this.baseUri + '/contact-flows-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + contactFlowTypes.map(z => `contactFlowTypes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListHoursOfOperations(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListHoursOfOperationsResponse> {
			return this.http.get<ListHoursOfOperationsResponse>(this.baseUri + '/hours-of-operations-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListPhoneNumbers(InstanceId: string, phoneNumberTypes: Array<PhoneNumberType>, phoneNumberCountryCodes: Array<PhoneNumberCountryCode>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListPhoneNumbersResponse> {
			return this.http.get<ListPhoneNumbersResponse>(this.baseUri + '/phone-numbers-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + phoneNumberTypes.map(z => `phoneNumberTypes=${z}`).join('&') + '&' + phoneNumberCountryCodes.map(z => `phoneNumberCountryCodes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListQueues(InstanceId: string, queueTypes: Array<QueueType>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListQueuesResponse> {
			return this.http.get<ListQueuesResponse>(this.baseUri + '/queues-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + queueTypes.map(z => `queueTypes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListRoutingProfiles(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListRoutingProfilesResponse> {
			return this.http.get<ListRoutingProfilesResponse>(this.baseUri + '/routing-profiles-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListSecurityProfiles(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListSecurityProfilesResponse> {
			return this.http.get<ListSecurityProfilesResponse>(this.baseUri + '/security-profiles-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListUserHierarchyGroups(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListUserHierarchyGroupsResponse> {
			return this.http.get<ListUserHierarchyGroupsResponse>(this.baseUri + '/user-hierarchy-groups-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListUsers(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListUsersResponse> {
			return this.http.get<ListUsersResponse>(this.baseUri + '/users-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		StartChatContact(requestBody: StartChatContactBody, headersHandler?: () => HttpHeaders): Observable<StartChatContactResponse> {
			return this.http.put<StartChatContactResponse>(this.baseUri + '/contact/chat', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartOutboundVoiceContact(requestBody: StartOutboundVoiceContactBody, headersHandler?: () => HttpHeaders): Observable<StartOutboundVoiceContactResponse> {
			return this.http.put<StartOutboundVoiceContactResponse>(this.baseUri + '/contact/outbound-voice', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopContact(requestBody: StopContactBody, headersHandler?: () => HttpHeaders): Observable<StopContactResponse> {
			return this.http.post<StopContactResponse>(this.baseUri + '/contact/stop', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateContactAttributes(requestBody: UpdateContactAttributesBody, headersHandler?: () => HttpHeaders): Observable<UpdateContactAttributesResponse> {
			return this.http.post<UpdateContactAttributesResponse>(this.baseUri + '/contact/attributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserHierarchy(UserId: string, InstanceId: string, requestBody: UpdateUserHierarchyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		UpdateUserIdentityInfo(UserId: string, InstanceId: string, requestBody: UpdateUserIdentityInfoBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/identity-info', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserPhoneConfig(UserId: string, InstanceId: string, requestBody: UpdateUserPhoneConfigBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/phone-config', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserRoutingProfile(UserId: string, InstanceId: string, requestBody: UpdateUserRoutingProfileBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		UpdateUserSecurityProfiles(UserId: string, InstanceId: string, requestBody: UpdateUserSecurityProfilesBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/security-profiles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
