...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateUser(InstanceId: string, requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}): Promise<CreateUserResponse> {
			return Axios.put<CreateUserResponse>(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteUser(InstanceId: string, UserId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeUser(UserId: string, InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserResponse> {
			return Axios.get<DescribeUserResponse>(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeUserHierarchyGroup(HierarchyGroupId: string, InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserHierarchyGroupResponse> {
			return Axios.get<DescribeUserHierarchyGroupResponse>(this.baseUri + '/user-hierarchy-groups/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (HierarchyGroupId == null ? '' : encodeURIComponent(HierarchyGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeUserHierarchyStructure(InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserHierarchyStructureResponse> {
			return Axios.get<DescribeUserHierarchyStructureResponse>(this.baseUri + '/user-hierarchy-structure/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetContactAttributes(InstanceId: string, InitialContactId: string, headersHandler?: () => {[header: string]: string}): Promise<GetContactAttributesResponse> {
			return Axios.get<GetContactAttributesResponse>(this.baseUri + '/contact/attributes/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (InitialContactId == null ? '' : encodeURIComponent(InitialContactId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetFederationToken(InstanceId: string, headersHandler?: () => {[header: string]: string}): Promise<GetFederationTokenResponse> {
			return Axios.get<GetFederationTokenResponse>(this.baseUri + '/user/federate/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		StartChatContact(requestBody: StartChatContactBody, headersHandler?: () => {[header: string]: string}): Promise<StartChatContactResponse> {
			return Axios.put<StartChatContactResponse>(this.baseUri + '/contact/chat', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartOutboundVoiceContact(requestBody: StartOutboundVoiceContactBody, headersHandler?: () => {[header: string]: string}): Promise<StartOutboundVoiceContactResponse> {
			return Axios.put<StartOutboundVoiceContactResponse>(this.baseUri + '/contact/outbound-voice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopContact(requestBody: StopContactBody, headersHandler?: () => {[header: string]: string}): Promise<StopContactResponse> {
			return Axios.post<StopContactResponse>(this.baseUri + '/contact/stop', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateContactAttributes(requestBody: UpdateContactAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateContactAttributesResponse> {
			return Axios.post<UpdateContactAttributesResponse>(this.baseUri + '/contact/attributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserHierarchy(UserId: string, InstanceId: string, requestBody: UpdateUserHierarchyBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		UpdateUserIdentityInfo(UserId: string, InstanceId: string, requestBody: UpdateUserIdentityInfoBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/identity-info', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserPhoneConfig(UserId: string, InstanceId: string, requestBody: UpdateUserPhoneConfigBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		UpdateUserRoutingProfile(UserId: string, InstanceId: string, requestBody: UpdateUserRoutingProfileBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		UpdateUserSecurityProfiles(UserId: string, InstanceId: string, requestBody: UpdateUserSecurityProfilesBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
