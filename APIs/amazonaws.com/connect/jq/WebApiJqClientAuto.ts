...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateUser(InstanceId: string, callback: (data : CreateUserResponse) => any, requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteUser(InstanceId: string, UserId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeUser(UserId: string, InstanceId: string, callback: (data : DescribeUserResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeUserHierarchyGroup(HierarchyGroupId: string, InstanceId: string, callback: (data : DescribeUserHierarchyGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/user-hierarchy-groups/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (HierarchyGroupId == null ? '' : encodeURIComponent(HierarchyGroupId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeUserHierarchyStructure(InstanceId: string, callback: (data : DescribeUserHierarchyStructureResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/user-hierarchy-structure/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetContactAttributes(InstanceId: string, InitialContactId: string, callback: (data : GetContactAttributesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/contact/attributes/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (InitialContactId == null ? '' : encodeURIComponent(InitialContactId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetCurrentMetricData(InstanceId: string, MaxResults: string, NextToken: string, callback: (data : GetCurrentMetricDataResponse) => any, requestBody: GetCurrentMetricDataBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/metrics/current/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetFederationToken(InstanceId: string, callback: (data : GetFederationTokenResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/user/federate/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetMetricData(InstanceId: string, MaxResults: string, NextToken: string, callback: (data : GetMetricDataResponse) => any, requestBody: GetMetricDataBody, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ListContactFlows(InstanceId: string, contactFlowTypes: Array<ContactFlowType>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListContactFlowsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/contact-flows-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + contactFlowTypes.map(z => `contactFlowTypes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListHoursOfOperations(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListHoursOfOperationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/hours-of-operations-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListPhoneNumbers(InstanceId: string, phoneNumberTypes: Array<PhoneNumberType>, phoneNumberCountryCodes: Array<PhoneNumberCountryCode>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListPhoneNumbersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/phone-numbers-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + phoneNumberTypes.map(z => `phoneNumberTypes=${z}`).join('&') + '&' + phoneNumberCountryCodes.map(z => `phoneNumberCountryCodes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListQueues(InstanceId: string, queueTypes: Array<QueueType>, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListQueuesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/queues-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&' + queueTypes.map(z => `queueTypes=${z}`).join('&') + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListRoutingProfiles(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListRoutingProfilesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/routing-profiles-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListSecurityProfiles(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListSecurityProfilesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/security-profiles-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListUserHierarchyGroups(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListUserHierarchyGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/user-hierarchy-groups-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListUsers(InstanceId: string, nextToken: string, maxResults: number, MaxResults: string, NextToken: string, callback: (data : ListUsersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/users-summary/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		StartChatContact(callback: (data : StartChatContactResponse) => any, requestBody: StartChatContactBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/contact/chat', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartOutboundVoiceContact(callback: (data : StartOutboundVoiceContactResponse) => any, requestBody: StartOutboundVoiceContactBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/contact/outbound-voice', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopContact(callback: (data : StopContactResponse) => any, requestBody: StopContactBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/contact/stop', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateContactAttributes(callback: (data : UpdateContactAttributesResponse) => any, requestBody: UpdateContactAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/contact/attributes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserHierarchy(UserId: string, InstanceId: string, callback: (data : void) => any, requestBody: UpdateUserHierarchyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/hierarchy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserIdentityInfo(UserId: string, InstanceId: string, callback: (data : void) => any, requestBody: UpdateUserIdentityInfoBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/identity-info', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserPhoneConfig(UserId: string, InstanceId: string, callback: (data : void) => any, requestBody: UpdateUserPhoneConfigBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/phone-config', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserRoutingProfile(UserId: string, InstanceId: string, callback: (data : void) => any, requestBody: UpdateUserRoutingProfileBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/routing-profile', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserSecurityProfiles(UserId: string, InstanceId: string, callback: (data : void) => any, requestBody: UpdateUserSecurityProfilesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/users/' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/security-profiles', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
