export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateConfigurationSet(requestBody: CreateConfigurationSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateConfigurationSetResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListConfigurationSets(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationSetsResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetConfigurationSetEventDestinations(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<GetConfigurationSetEventDestinationsResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDedicatedIpPool(requestBody: CreateDedicatedIpPoolBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDedicatedIpPoolResponse> {
			return fetch(this.baseUri + '/v2/email/dedicated-ip-pools', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDedicatedIpPools(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListDedicatedIpPoolsResponse> {
			return fetch(this.baseUri + '/v2/email/dedicated-ip-pools?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDeliverabilityTestReport(requestBody: CreateDeliverabilityTestReportBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDeliverabilityTestReportResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard/test', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEmailIdentity(requestBody: CreateEmailIdentityBody, headersHandler?: () => {[header: string]: string}): Promise<CreateEmailIdentityResponse> {
			return fetch(this.baseUri + '/v2/email/identities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEmailIdentities(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListEmailIdentitiesResponse> {
			return fetch(this.baseUri + '/v2/email/identities?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteConfigurationSet(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteConfigurationSetResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetConfigurationSet(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<GetConfigurationSetResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteConfigurationSetEventDestination(ConfigurationSetName: string, EventDestinationName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteConfigurationSetEventDestinationResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations/' + (EventDestinationName == null ? '' : encodeURIComponent(EventDestinationName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateConfigurationSetEventDestination(ConfigurationSetName: string, EventDestinationName: string, requestBody: UpdateConfigurationSetEventDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateConfigurationSetEventDestinationResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations/' + (EventDestinationName == null ? '' : encodeURIComponent(EventDestinationName)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDedicatedIpPool(PoolName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDedicatedIpPoolResponse> {
			return fetch(this.baseUri + '/v2/email/dedicated-ip-pools/' + (PoolName == null ? '' : encodeURIComponent(PoolName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteEmailIdentity(EmailIdentity: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteEmailIdentityResponse> {
			return fetch(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEmailIdentity(EmailIdentity: string, headersHandler?: () => {[header: string]: string}): Promise<GetEmailIdentityResponse> {
			return fetch(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteSuppressedDestination(EmailAddress: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteSuppressedDestinationResponse> {
			return fetch(this.baseUri + '/v2/email/suppression/addresses/' + (EmailAddress == null ? '' : encodeURIComponent(EmailAddress)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSuppressedDestination(EmailAddress: string, headersHandler?: () => {[header: string]: string}): Promise<GetSuppressedDestinationResponse> {
			return fetch(this.baseUri + '/v2/email/suppression/addresses/' + (EmailAddress == null ? '' : encodeURIComponent(EmailAddress)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetAccount(headersHandler?: () => {[header: string]: string}): Promise<GetAccountResponse> {
			return fetch(this.baseUri + '/v2/email/account', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBlacklistReports(BlacklistItemNames: Array<BlacklistItemName>, headersHandler?: () => {[header: string]: string}): Promise<GetBlacklistReportsResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard/blacklist-report#BlacklistItemNames?' + BlacklistItemNames.map(z => `BlacklistItemNames=${z}`).join('&'), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDedicatedIp(IP: string, headersHandler?: () => {[header: string]: string}): Promise<GetDedicatedIpResponse> {
			return fetch(this.baseUri + '/v2/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDedicatedIps(PoolName: string, NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<GetDedicatedIpsResponse> {
			return fetch(this.baseUri + '/v2/email/dedicated-ips?PoolName=' + (PoolName == null ? '' : encodeURIComponent(PoolName)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDeliverabilityDashboardOptions(headersHandler?: () => {[header: string]: string}): Promise<GetDeliverabilityDashboardOptionsResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutDeliverabilityDashboardOption(requestBody: PutDeliverabilityDashboardOptionBody, headersHandler?: () => {[header: string]: string}): Promise<PutDeliverabilityDashboardOptionResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDeliverabilityTestReport(ReportId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDeliverabilityTestReportResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard/test-reports/' + (ReportId == null ? '' : encodeURIComponent(ReportId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDomainDeliverabilityCampaign(CampaignId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDomainDeliverabilityCampaignResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard/campaigns/' + (CampaignId == null ? '' : encodeURIComponent(CampaignId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDomainStatisticsReport(Domain: string, StartDate: Date, EndDate: Date, headersHandler?: () => {[header: string]: string}): Promise<GetDomainStatisticsReportResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard/statistics-report/' + (Domain == null ? '' : encodeURIComponent(Domain)) + '#StartDate&EndDate&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString(), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListDeliverabilityTestReports(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListDeliverabilityTestReportsResponse> {
			return fetch(this.baseUri + '/v2/email/deliverability-dashboard/test-reports?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListSuppressedDestinations(Reason: Array<SuppressionListReason>, StartDate: Date, EndDate: Date, NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListSuppressedDestinationsResponse> {
			return fetch(this.baseUri + '/v2/email/suppression/addresses?' + Reason.map(z => `Reason=${z}`).join('&') + '&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString() + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutSuppressedDestination(requestBody: PutSuppressedDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<PutSuppressedDestinationResponse> {
			return fetch(this.baseUri + '/v2/email/suppression/addresses', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(ResourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/v2/email/tags#ResourceArn?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutAccountDedicatedIpWarmupAttributes(requestBody: PutAccountDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutAccountDedicatedIpWarmupAttributesResponse> {
			return fetch(this.baseUri + '/v2/email/account/dedicated-ips/warmup', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutAccountSendingAttributes(requestBody: PutAccountSendingAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutAccountSendingAttributesResponse> {
			return fetch(this.baseUri + '/v2/email/account/sending', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutAccountSuppressionAttributes(requestBody: PutAccountSuppressionAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutAccountSuppressionAttributesResponse> {
			return fetch(this.baseUri + '/v2/email/account/suppression', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutConfigurationSetDeliveryOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetDeliveryOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetDeliveryOptionsResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/delivery-options', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutConfigurationSetReputationOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetReputationOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetReputationOptionsResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/reputation-options', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutConfigurationSetSendingOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetSendingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetSendingOptionsResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/sending', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutConfigurationSetSuppressionOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetSuppressionOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetSuppressionOptionsResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/suppression-options', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutConfigurationSetTrackingOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetTrackingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetTrackingOptionsResponse> {
			return fetch(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/tracking-options', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutDedicatedIpInPool(IP: string, requestBody: PutDedicatedIpInPoolBody, headersHandler?: () => {[header: string]: string}): Promise<PutDedicatedIpInPoolResponse> {
			return fetch(this.baseUri + '/v2/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/pool', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutDedicatedIpWarmupAttributes(IP: string, requestBody: PutDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutDedicatedIpWarmupAttributesResponse> {
			return fetch(this.baseUri + '/v2/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/warmup', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutEmailIdentityDkimAttributes(EmailIdentity: string, requestBody: PutEmailIdentityDkimAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutEmailIdentityDkimAttributesResponse> {
			return fetch(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/dkim', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutEmailIdentityDkimSigningAttributes(EmailIdentity: string, requestBody: PutEmailIdentityDkimSigningAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutEmailIdentityDkimSigningAttributesResponse> {
			return fetch(this.baseUri + '/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/dkim/signing', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SendEmail(requestBody: SendEmailBody, headersHandler?: () => {[header: string]: string}): Promise<SendEmailResponse> {
			return fetch(this.baseUri + '/v2/email/outbound-emails', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/v2/email/tags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(ResourceArn: string, TagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/v2/email/tags#ResourceArn&TagKeys?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&'), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
