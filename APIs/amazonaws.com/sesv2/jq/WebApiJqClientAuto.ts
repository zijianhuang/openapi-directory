...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateConfigurationSet(callback: (data : CreateConfigurationSetResponse) => any, requestBody: CreateConfigurationSetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2/email/configuration-sets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListConfigurationSets(NextToken: string, PageSize: number, callback: (data : ListConfigurationSetsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/configuration-sets?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateConfigurationSetEventDestination(ConfigurationSetName: string, callback: (data : CreateConfigurationSetEventDestinationResponse) => any, requestBody: CreateConfigurationSetEventDestinationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetConfigurationSetEventDestinations(ConfigurationSetName: string, callback: (data : GetConfigurationSetEventDestinationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateDedicatedIpPool(callback: (data : CreateDedicatedIpPoolResponse) => any, requestBody: CreateDedicatedIpPoolBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2/email/dedicated-ip-pools', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDedicatedIpPools(NextToken: string, PageSize: number, callback: (data : ListDedicatedIpPoolsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/dedicated-ip-pools?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateDeliverabilityTestReport(callback: (data : CreateDeliverabilityTestReportResponse) => any, requestBody: CreateDeliverabilityTestReportBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2/email/deliverability-dashboard/test', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateEmailIdentity(callback: (data : CreateEmailIdentityResponse) => any, requestBody: CreateEmailIdentityBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2/email/identities', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEmailIdentities(NextToken: string, PageSize: number, callback: (data : ListEmailIdentitiesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/identities?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteConfigurationSet(ConfigurationSetName: string, callback: (data : DeleteConfigurationSetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetConfigurationSet(ConfigurationSetName: string, callback: (data : GetConfigurationSetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteConfigurationSetEventDestination(ConfigurationSetName: string, EventDestinationName: string, callback: (data : DeleteConfigurationSetEventDestinationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations/' + (EventDestinationName == null ? '' : encodeURIComponent(EventDestinationName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateConfigurationSetEventDestination(ConfigurationSetName: string, EventDestinationName: string, callback: (data : UpdateConfigurationSetEventDestinationResponse) => any, requestBody: UpdateConfigurationSetEventDestinationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations/' + (EventDestinationName == null ? '' : encodeURIComponent(EventDestinationName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDedicatedIpPool(PoolName: string, callback: (data : DeleteDedicatedIpPoolResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v2/email/dedicated-ip-pools/' + (PoolName == null ? '' : encodeURIComponent(PoolName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteEmailIdentity(EmailIdentity: string, callback: (data : DeleteEmailIdentityResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetEmailIdentity(EmailIdentity: string, callback: (data : GetEmailIdentityResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteSuppressedDestination(EmailAddress: string, callback: (data : DeleteSuppressedDestinationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v2/email/suppression/addresses/' + (EmailAddress == null ? '' : encodeURIComponent(EmailAddress)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSuppressedDestination(EmailAddress: string, callback: (data : GetSuppressedDestinationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/suppression/addresses/' + (EmailAddress == null ? '' : encodeURIComponent(EmailAddress)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetAccount(callback: (data : GetAccountResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/account', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBlacklistReports(BlacklistItemNames: Array<BlacklistItemName>, callback: (data : GetBlacklistReportsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/deliverability-dashboard/blacklist-report#BlacklistItemNames?' + BlacklistItemNames.map(z => `BlacklistItemNames=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDedicatedIp(IP: string, callback: (data : GetDedicatedIpResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDedicatedIps(PoolName: string, NextToken: string, PageSize: number, callback: (data : GetDedicatedIpsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/dedicated-ips?PoolName=' + (PoolName == null ? '' : encodeURIComponent(PoolName)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDeliverabilityDashboardOptions(callback: (data : GetDeliverabilityDashboardOptionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/deliverability-dashboard', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PutDeliverabilityDashboardOption(callback: (data : PutDeliverabilityDashboardOptionResponse) => any, requestBody: PutDeliverabilityDashboardOptionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/deliverability-dashboard', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDeliverabilityTestReport(ReportId: string, callback: (data : GetDeliverabilityTestReportResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/deliverability-dashboard/test-reports/' + (ReportId == null ? '' : encodeURIComponent(ReportId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDomainDeliverabilityCampaign(CampaignId: string, callback: (data : GetDomainDeliverabilityCampaignResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/deliverability-dashboard/campaigns/' + (CampaignId == null ? '' : encodeURIComponent(CampaignId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDomainStatisticsReport(Domain: string, StartDate: Date, EndDate: Date, callback: (data : GetDomainStatisticsReportResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/deliverability-dashboard/statistics-report/' + (Domain == null ? '' : encodeURIComponent(Domain)) + '#StartDate&EndDate&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString(), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListDeliverabilityTestReports(NextToken: string, PageSize: number, callback: (data : ListDeliverabilityTestReportsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/deliverability-dashboard/test-reports?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListDomainDeliverabilityCampaigns(StartDate: Date, EndDate: Date, SubscribedDomain: string, NextToken: string, PageSize: number, callback: (data : ListDomainDeliverabilityCampaignsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/deliverability-dashboard/domains/' + (SubscribedDomain == null ? '' : encodeURIComponent(SubscribedDomain)) + '/campaigns#StartDate&EndDate?StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString() + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListSuppressedDestinations(Reason: Array<SuppressionListReason>, StartDate: Date, EndDate: Date, NextToken: string, PageSize: number, callback: (data : ListSuppressedDestinationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/suppression/addresses?' + Reason.map(z => `Reason=${z}`).join('&') + '&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString() + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PutSuppressedDestination(callback: (data : PutSuppressedDestinationResponse) => any, requestBody: PutSuppressedDestinationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/suppression/addresses', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListTagsForResource(ResourceArn: string, callback: (data : ListTagsForResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2/email/tags#ResourceArn?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PutAccountDedicatedIpWarmupAttributes(callback: (data : PutAccountDedicatedIpWarmupAttributesResponse) => any, requestBody: PutAccountDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/account/dedicated-ips/warmup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutAccountSendingAttributes(callback: (data : PutAccountSendingAttributesResponse) => any, requestBody: PutAccountSendingAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/account/sending', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutAccountSuppressionAttributes(callback: (data : PutAccountSuppressionAttributesResponse) => any, requestBody: PutAccountSuppressionAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/account/suppression', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutConfigurationSetDeliveryOptions(ConfigurationSetName: string, callback: (data : PutConfigurationSetDeliveryOptionsResponse) => any, requestBody: PutConfigurationSetDeliveryOptionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/delivery-options', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutConfigurationSetReputationOptions(ConfigurationSetName: string, callback: (data : PutConfigurationSetReputationOptionsResponse) => any, requestBody: PutConfigurationSetReputationOptionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/reputation-options', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutConfigurationSetSendingOptions(ConfigurationSetName: string, callback: (data : PutConfigurationSetSendingOptionsResponse) => any, requestBody: PutConfigurationSetSendingOptionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/sending', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutConfigurationSetSuppressionOptions(ConfigurationSetName: string, callback: (data : PutConfigurationSetSuppressionOptionsResponse) => any, requestBody: PutConfigurationSetSuppressionOptionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/suppression-options', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutConfigurationSetTrackingOptions(ConfigurationSetName: string, callback: (data : PutConfigurationSetTrackingOptionsResponse) => any, requestBody: PutConfigurationSetTrackingOptionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/tracking-options', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutDedicatedIpInPool(IP: string, callback: (data : PutDedicatedIpInPoolResponse) => any, requestBody: PutDedicatedIpInPoolBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/pool', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutDedicatedIpWarmupAttributes(IP: string, callback: (data : PutDedicatedIpWarmupAttributesResponse) => any, requestBody: PutDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/warmup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutEmailIdentityDkimAttributes(EmailIdentity: string, callback: (data : PutEmailIdentityDkimAttributesResponse) => any, requestBody: PutEmailIdentityDkimAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/dkim', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutEmailIdentityDkimSigningAttributes(EmailIdentity: string, callback: (data : PutEmailIdentityDkimSigningAttributesResponse) => any, requestBody: PutEmailIdentityDkimSigningAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/dkim/signing', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutEmailIdentityFeedbackAttributes(EmailIdentity: string, callback: (data : PutEmailIdentityFeedbackAttributesResponse) => any, requestBody: PutEmailIdentityFeedbackAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/feedback', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutEmailIdentityMailFromAttributes(EmailIdentity: string, callback: (data : PutEmailIdentityMailFromAttributesResponse) => any, requestBody: PutEmailIdentityMailFromAttributesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v2/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/mail-from', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SendEmail(callback: (data : SendEmailResponse) => any, requestBody: SendEmailBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2/email/outbound-emails', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2/email/tags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UntagResource(ResourceArn: string, TagKeys: Array<TagKey>, callback: (data : UntagResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v2/email/tags#ResourceArn&TagKeys?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
	}
