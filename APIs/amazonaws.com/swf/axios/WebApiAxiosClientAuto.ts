...
export namespace My_Demo_Client {
	...
	export interface ListActivityTypesInput {
		domain: string;
		name?: string;
		registrationStatus: ListActivityTypesInputRegistrationStatus;
		nextPageToken?: string;
		maximumPageSize?: number;
		reverseOrder?: boolean;
	}

	export enum ListActivityTypesInputRegistrationStatus { REGISTERED = 0, DEPRECATED = 1 }
	...
	export interface ListDomainsInput {
		nextPageToken?: string;
		registrationStatus: ListDomainsInputRegistrationStatus;
		maximumPageSize?: number;
		reverseOrder?: boolean;
	}

	export enum ListDomainsInputRegistrationStatus { REGISTERED = 0, DEPRECATED = 1 }
	...
	export interface ListWorkflowTypesInput {
		domain: string;
		name?: string;
		registrationStatus: ListWorkflowTypesInputRegistrationStatus;
		nextPageToken?: string;
		maximumPageSize?: number;
		reverseOrder?: boolean;
	}

	export enum ListWorkflowTypesInputRegistrationStatus { REGISTERED = 0, DEPRECATED = 1 }
	...
	export interface RegisterWorkflowTypeInput {
		...
		defaultTaskList?: TaskList;
		defaultTaskPriority?: string;
		defaultChildPolicy?: RegisterWorkflowTypeInputDefaultChildPolicy;
		defaultLambdaRole?: string;
	}

	export enum RegisterWorkflowTypeInputDefaultChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface StartWorkflowExecutionInput {
		...
		childPolicy?: StartWorkflowExecutionInputChildPolicy;
		lambdaRole?: string;
	}

	export enum StartWorkflowExecutionInputChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface TerminateWorkflowExecutionInput {
		...
		reason?: string;
		details?: string;
		childPolicy?: TerminateWorkflowExecutionInputChildPolicy;
	}

	export enum TerminateWorkflowExecutionInputChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface CancelWorkflowExecutionFailedEventAttributes {
		cause: CancelWorkflowExecutionFailedEventAttributesCause;
		decisionTaskCompletedEventId: number;
	}

	export enum CancelWorkflowExecutionFailedEventAttributesCause { UNHANDLED_DECISION = 0, OPERATION_NOT_PERMITTED = 1 }
	...
	export interface ChildWorkflowExecutionTimedOutEventAttributes {
		...
		/**Represents a workflow type. */
		workflowType: WorkflowType;
		timeoutType: ChildWorkflowExecutionTimedOutEventAttributesTimeoutType;
		initiatedEventId: number;
		startedEventId: number;
	}

	export enum ChildWorkflowExecutionTimedOutEventAttributesTimeoutType { START_TO_CLOSE = 0 }
	...
	export interface ContinueAsNewWorkflowExecutionDecisionAttributes {
		...
		taskPriority?: string;
		taskStartToCloseTimeout?: string;
		childPolicy?: ContinueAsNewWorkflowExecutionDecisionAttributesChildPolicy;
		tagList?: Array<Tag>;
		workflowTypeVersion?: string;
		lambdaRole?: string;
	}

	export enum ContinueAsNewWorkflowExecutionDecisionAttributesChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface StartChildWorkflowExecutionDecisionAttributes {
		...
		taskPriority?: string;
		taskStartToCloseTimeout?: string;
		childPolicy?: StartChildWorkflowExecutionDecisionAttributesChildPolicy;
		tagList?: Array<Tag>;
		lambdaRole?: string;
	}

	export enum StartChildWorkflowExecutionDecisionAttributesChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface DecisionTaskTimedOutEventAttributes {
		timeoutType: DecisionTaskTimedOutEventAttributesTimeoutType;
		scheduledEventId: number;
		startedEventId: number;
	}

	export enum DecisionTaskTimedOutEventAttributesTimeoutType { START_TO_CLOSE = 0 }
	...
	export enum DomainInfoStatus { REGISTERED = 0, DEPRECATED = 1 }
	...
	export interface FailWorkflowExecutionFailedEventAttributes {
		cause: FailWorkflowExecutionFailedEventAttributesCause;
		decisionTaskCompletedEventId: number;
	}

	export enum FailWorkflowExecutionFailedEventAttributesCause { UNHANDLED_DECISION = 0, OPERATION_NOT_PERMITTED = 1 }
	...
	export interface WorkflowExecutionStartedEventAttributes {
		...
		executionStartToCloseTimeout?: string;
		taskStartToCloseTimeout?: string;
		childPolicy: WorkflowExecutionStartedEventAttributesChildPolicy;
	...
	export enum WorkflowExecutionStartedEventAttributesChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface WorkflowExecutionTimedOutEventAttributes {
		...
		childPolicy: WorkflowExecutionTimedOutEventAttributesChildPolicy;
	}

	export enum WorkflowExecutionTimedOutEventAttributesTimeoutType { START_TO_CLOSE = 0 }

	export enum WorkflowExecutionTimedOutEventAttributesChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface WorkflowExecutionContinuedAsNewEventAttributes {
		...
		taskPriority?: string;
		taskStartToCloseTimeout?: string;
		childPolicy: WorkflowExecutionContinuedAsNewEventAttributesChildPolicy;
		tagList?: Array<Tag>;
	...
	export enum WorkflowExecutionContinuedAsNewEventAttributesChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface WorkflowExecutionTerminatedEventAttributes {
		reason?: string;
		details?: string;
		childPolicy: WorkflowExecutionTerminatedEventAttributesChildPolicy;
		cause?: WorkflowExecutionTerminatedEventAttributesCause;
	}

	export enum WorkflowExecutionTerminatedEventAttributesChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface StartChildWorkflowExecutionInitiatedEventAttributes {
		...
		taskPriority?: string;
		decisionTaskCompletedEventId: number;
		childPolicy: StartChildWorkflowExecutionInitiatedEventAttributesChildPolicy;
		taskStartToCloseTimeout?: string;
		tagList?: Array<Tag>;
		lambdaRole?: string;
	}

	export enum StartChildWorkflowExecutionInitiatedEventAttributesChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface LambdaFunctionTimedOutEventAttributes {
		scheduledEventId: number;
		startedEventId: number;
		timeoutType?: LambdaFunctionTimedOutEventAttributesTimeoutType;
	}

	export enum LambdaFunctionTimedOutEventAttributesTimeoutType { START_TO_CLOSE = 0 }
	...
	export interface WorkflowExecutionInfo {
		...
		closeStatus?: WorkflowExecutionInfoCloseStatus;
	...
	export enum WorkflowExecutionInfoCloseStatus { COMPLETED = 0, FAILED = 1, CANCELED = 2, TERMINATED = 3, CONTINUED_AS_NEW = 4, TIMED_OUT = 5 }
	...
	export interface WorkflowTypeConfiguration {
		...
		defaultTaskList?: TaskList;
		defaultTaskPriority?: string;
		defaultChildPolicy?: WorkflowTypeConfigurationDefaultChildPolicy;
		defaultLambdaRole?: string;
	}

	export enum WorkflowTypeConfigurationDefaultChildPolicy { TERMINATE = 0, REQUEST_CANCEL = 1, ABANDON = 2 }
	...
	export interface WorkflowTypeInfo {
		...
		/**Represents a workflow type. */
		workflowType: WorkflowType;
		status: WorkflowTypeInfoStatus;
		description?: string;
		creationDate: Date;
		deprecationDate?: Date;
	}

	export enum WorkflowTypeInfoStatus { REGISTERED = 0, DEPRECATED = 1 }
	...
	export class DemoClient {
		 ...
		 */
		CountClosedWorkflowExecutions(requestBody: CountClosedWorkflowExecutionsInput, headersHandler?: () => {[header: string]: string}): Promise<WorkflowExecutionCount> {
			return Axios.post<WorkflowExecutionCount>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.CountClosedWorkflowExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {WorkflowExecutionCount} Success
		 */
		CountOpenWorkflowExecutions(requestBody: CountOpenWorkflowExecutionsInput, headersHandler?: () => {[header: string]: string}): Promise<WorkflowExecutionCount> {
			return Axios.post<WorkflowExecutionCount>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.CountOpenWorkflowExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CountPendingActivityTasks(requestBody: CountPendingActivityTasksInput, headersHandler?: () => {[header: string]: string}): Promise<PendingTaskCount> {
			return Axios.post<PendingTaskCount>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.CountPendingActivityTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {PendingTaskCount} Success
		 */
		CountPendingDecisionTasks(requestBody: CountPendingDecisionTasksInput, headersHandler?: () => {[header: string]: string}): Promise<PendingTaskCount> {
			return Axios.post<PendingTaskCount>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.CountPendingDecisionTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeprecateActivityType(requestBody: DeprecateActivityTypeInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.DeprecateActivityType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeprecateDomain(requestBody: DeprecateDomainInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.DeprecateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeprecateWorkflowType(requestBody: DeprecateWorkflowTypeInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.DeprecateWorkflowType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeActivityType(requestBody: DescribeActivityTypeInput, headersHandler?: () => {[header: string]: string}): Promise<ActivityTypeDetail> {
			return Axios.post<ActivityTypeDetail>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.DescribeActivityType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeDomain(requestBody: DescribeDomainInput, headersHandler?: () => {[header: string]: string}): Promise<DomainDetail> {
			return Axios.post<DomainDetail>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.DescribeDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeWorkflowExecution(requestBody: DescribeWorkflowExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<WorkflowExecutionDetail> {
			return Axios.post<WorkflowExecutionDetail>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.DescribeWorkflowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeWorkflowType(requestBody: DescribeWorkflowTypeInput, headersHandler?: () => {[header: string]: string}): Promise<WorkflowTypeDetail> {
			return Axios.post<WorkflowTypeDetail>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.DescribeWorkflowType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetWorkflowExecutionHistory(maximumPageSize: string, nextPageToken: string, requestBody: GetWorkflowExecutionHistoryInput, headersHandler?: () => {[header: string]: string}): Promise<History> {
			return Axios.post<History>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.GetWorkflowExecutionHistory?maximumPageSize=' + (maximumPageSize == null ? '' : encodeURIComponent(maximumPageSize)) + '&nextPageToken=' + (nextPageToken == null ? '' : encodeURIComponent(nextPageToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListActivityTypes(maximumPageSize: string, nextPageToken: string, requestBody: ListActivityTypesInput, headersHandler?: () => {[header: string]: string}): Promise<ActivityTypeInfos> {
			return Axios.post<ActivityTypeInfos>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.ListActivityTypes?maximumPageSize=' + (maximumPageSize == null ? '' : encodeURIComponent(maximumPageSize)) + '&nextPageToken=' + (nextPageToken == null ? '' : encodeURIComponent(nextPageToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListClosedWorkflowExecutions(maximumPageSize: string, nextPageToken: string, requestBody: ListClosedWorkflowExecutionsInput, headersHandler?: () => {[header: string]: string}): Promise<WorkflowExecutionInfos> {
			return Axios.post<WorkflowExecutionInfos>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.ListClosedWorkflowExecutions?maximumPageSize=' + (maximumPageSize == null ? '' : encodeURIComponent(maximumPageSize)) + '&nextPageToken=' + (nextPageToken == null ? '' : encodeURIComponent(nextPageToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListDomains(maximumPageSize: string, nextPageToken: string, requestBody: ListDomainsInput, headersHandler?: () => {[header: string]: string}): Promise<DomainInfos> {
			return Axios.post<DomainInfos>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.ListDomains?maximumPageSize=' + (maximumPageSize == null ? '' : encodeURIComponent(maximumPageSize)) + '&nextPageToken=' + (nextPageToken == null ? '' : encodeURIComponent(nextPageToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {WorkflowExecutionInfos} Success
		 */
		ListOpenWorkflowExecutions(maximumPageSize: string, nextPageToken: string, requestBody: ListOpenWorkflowExecutionsInput, headersHandler?: () => {[header: string]: string}): Promise<WorkflowExecutionInfos> {
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return Axios.post<ListTagsForResourceOutput>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListWorkflowTypes(maximumPageSize: string, nextPageToken: string, requestBody: ListWorkflowTypesInput, headersHandler?: () => {[header: string]: string}): Promise<WorkflowTypeInfos> {
			return Axios.post<WorkflowTypeInfos>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.ListWorkflowTypes?maximumPageSize=' + (maximumPageSize == null ? '' : encodeURIComponent(maximumPageSize)) + '&nextPageToken=' + (nextPageToken == null ? '' : encodeURIComponent(nextPageToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PollForActivityTask(requestBody: PollForActivityTaskInput, headersHandler?: () => {[header: string]: string}): Promise<ActivityTask> {
			return Axios.post<ActivityTask>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.PollForActivityTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PollForDecisionTask(maximumPageSize: string, nextPageToken: string, requestBody: PollForDecisionTaskInput, headersHandler?: () => {[header: string]: string}): Promise<DecisionTask> {
			return Axios.post<DecisionTask>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.PollForDecisionTask?maximumPageSize=' + (maximumPageSize == null ? '' : encodeURIComponent(maximumPageSize)) + '&nextPageToken=' + (nextPageToken == null ? '' : encodeURIComponent(nextPageToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RecordActivityTaskHeartbeat(requestBody: RecordActivityTaskHeartbeatInput, headersHandler?: () => {[header: string]: string}): Promise<ActivityTaskStatus> {
			return Axios.post<ActivityTaskStatus>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RecordActivityTaskHeartbeat', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RegisterActivityType(requestBody: RegisterActivityTypeInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RegisterActivityType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RegisterDomain(requestBody: RegisterDomainInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RegisterDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RegisterWorkflowType(requestBody: RegisterWorkflowTypeInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RegisterWorkflowType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RequestCancelWorkflowExecution(requestBody: RequestCancelWorkflowExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RequestCancelWorkflowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RespondActivityTaskCanceled(requestBody: RespondActivityTaskCanceledInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RespondActivityTaskCanceled', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RespondActivityTaskCompleted(requestBody: RespondActivityTaskCompletedInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RespondActivityTaskCompleted', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RespondActivityTaskFailed(requestBody: RespondActivityTaskFailedInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RespondActivityTaskFailed', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RespondDecisionTaskCompleted(requestBody: RespondDecisionTaskCompletedInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.RespondDecisionTaskCompleted', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SignalWorkflowExecution(requestBody: SignalWorkflowExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.SignalWorkflowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {Run} Success
		 */
		StartWorkflowExecution(requestBody: StartWorkflowExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<Run> {
			return Axios.post<Run>(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.StartWorkflowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		TerminateWorkflowExecution(requestBody: TerminateWorkflowExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.TerminateWorkflowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UndeprecateActivityType(requestBody: UndeprecateActivityTypeInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.UndeprecateActivityType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UndeprecateDomain(requestBody: UndeprecateDomainInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.UndeprecateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UndeprecateWorkflowType(requestBody: UndeprecateWorkflowTypeInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.UndeprecateWorkflowType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=SimpleWorkflowService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
