...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AcceptInvitation(callback: (data : void) => any, requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/invitation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateGraph(callback: (data : CreateGraphResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graph', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		CreateMembers(callback: (data : CreateMembersResponse) => any, requestBody: CreateMembersBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graph/members', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteGraph(callback: (data : void) => any, requestBody: DeleteGraphBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graph/removal', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DeleteMembers(callback: (data : DeleteMembersResponse) => any, requestBody: DeleteMembersBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graph/members/removal', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DisassociateMembership(callback: (data : void) => any, requestBody: DisassociateMembershipBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/membership/removal', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		GetMembers(callback: (data : GetMembersResponse) => any, requestBody: GetMembersBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graph/members/get', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListGraphs(MaxResults: string, NextToken: string, callback: (data : ListGraphsResponse) => any, requestBody: ListGraphsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graphs/list?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListInvitations(MaxResults: string, NextToken: string, callback: (data : ListInvitationsResponse) => any, requestBody: ListInvitationsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/invitations/list?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMembers(MaxResults: string, NextToken: string, callback: (data : ListMembersResponse) => any, requestBody: ListMembersBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graph/members/list?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RejectInvitation(callback: (data : void) => any, requestBody: RejectInvitationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/invitation/removal', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StartMonitoringMember(callback: (data : void) => any, requestBody: StartMonitoringMemberBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/graph/member/monitoringstate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
