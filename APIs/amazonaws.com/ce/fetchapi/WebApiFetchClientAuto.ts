export namespace My_Demo_Client {
	...
	export interface GetCostAndUsageWithResourcesRequest {
		...
		/**The time period that you want the usage and costs for. */
		TimePeriod: DateInterval;
		Granularity?: GetCostAndUsageWithResourcesRequestGranularity;
	...
	export enum GetCostAndUsageWithResourcesRequestGranularity { DAILY = 0, MONTHLY = 1, HOURLY = 2 }
	...
	export interface GetCostForecastRequest {
		...
		Granularity: GetCostForecastRequestGranularity;
	...
	export enum GetCostForecastRequestGranularity { DAILY = 0, MONTHLY = 1, HOURLY = 2 }
	...
	export interface GetDimensionValuesRequest {
		...
		/**The time period that you want the usage and costs for. */
		TimePeriod: DateInterval;
		Dimension: GetDimensionValuesRequestDimension;
		Context?: GetDimensionValuesRequestContext;
		NextPageToken?: string;
	}

	export enum GetDimensionValuesRequestDimension { AZ = 0, INSTANCE_TYPE = 1, LINKED_ACCOUNT = 2, LINKED_ACCOUNT_NAME = 3, OPERATION = 4, PURCHASE_TYPE = 5, REGION = 6, SERVICE = 7, SERVICE_CODE = 8, USAGE_TYPE = 9, USAGE_TYPE_GROUP = 10, RECORD_TYPE = 11, OPERATING_SYSTEM = 12, TENANCY = 13, SCOPE = 14, PLATFORM = 15, SUBSCRIPTION_ID = 16, LEGAL_ENTITY_NAME = 17, DEPLOYMENT_OPTION = 18, DATABASE_ENGINE = 19, CACHE_ENGINE = 20, INSTANCE_TYPE_FAMILY = 21, BILLING_ENTITY = 22, RESERVATION_ID = 23, RESOURCE_ID = 24, RIGHTSIZING_TYPE = 25, SAVINGS_PLANS_TYPE = 26, SAVINGS_PLAN_ARN = 27, PAYMENT_OPTION = 28 }
	...
	export interface GetReservationCoverageRequest {
		...
		TimePeriod: DateInterval;
		GroupBy?: Array<GroupDefinition>;
		Granularity?: GetReservationCoverageRequestGranularity;
	...
	export enum GetReservationCoverageRequestGranularity { DAILY = 0, MONTHLY = 1, HOURLY = 2 }
	...
	export interface GetReservationPurchaseRecommendationRequest {
		AccountId?: string;
		Service: string;
		AccountScope?: GetReservationPurchaseRecommendationRequestAccountScope;
		LookbackPeriodInDays?: GetReservationPurchaseRecommendationRequestLookbackPeriodInDays;
		TermInYears?: GetReservationPurchaseRecommendationRequestTermInYears;
		PaymentOption?: GetReservationPurchaseRecommendationRequestPaymentOption;
	...
	export enum GetReservationPurchaseRecommendationRequestAccountScope { PAYER = 0, LINKED = 1 }

	export enum GetReservationPurchaseRecommendationRequestLookbackPeriodInDays { SEVEN_DAYS = 0, THIRTY_DAYS = 1, SIXTY_DAYS = 2 }

	export enum GetReservationPurchaseRecommendationRequestTermInYears { ONE_YEAR = 0, THREE_YEARS = 1 }

	export enum GetReservationPurchaseRecommendationRequestPaymentOption { NO_UPFRONT = 0, PARTIAL_UPFRONT = 1, ALL_UPFRONT = 2, LIGHT_UTILIZATION = 3, MEDIUM_UTILIZATION = 4, HEAVY_UTILIZATION = 5 }
	...
	export interface GetReservationUtilizationRequest {
		...
		TimePeriod: DateInterval;
		GroupBy?: Array<GroupDefinition>;
		Granularity?: GetReservationUtilizationRequestGranularity;
	...
	export enum GetReservationUtilizationRequestGranularity { DAILY = 0, MONTHLY = 1, HOURLY = 2 }
	...
	export interface GetSavingsPlansCoverageRequest {
		...
		TimePeriod: DateInterval;
		GroupBy?: Array<GroupDefinition>;
		Granularity?: GetSavingsPlansCoverageRequestGranularity;
	...
	export enum GetSavingsPlansCoverageRequestGranularity { DAILY = 0, MONTHLY = 1, HOURLY = 2 }
	...
	export interface GetSavingsPlansPurchaseRecommendationRequest {
		SavingsPlansType: GetSavingsPlansPurchaseRecommendationRequestSavingsPlansType;
		TermInYears: GetSavingsPlansPurchaseRecommendationRequestTermInYears;
		PaymentOption: GetSavingsPlansPurchaseRecommendationRequestPaymentOption;
		AccountScope?: GetSavingsPlansPurchaseRecommendationRequestAccountScope;
		NextPageToken?: string;
		PageSize?: number;
		LookbackPeriodInDays: GetSavingsPlansPurchaseRecommendationRequestLookbackPeriodInDays;

		/**<p>Use <code>Expression</code> to filter by cost or by usage. There are two patterns: </p> <ul> <li> <p>Simple dimension values - You can set the dimension name and values for the filters that you plan to use. For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. The <code>Expression</code> for that looks like this:</p> <p> <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }</code> </p> <p>The list of dimension values are OR'd together to retrieve cost or usage data. You can create <code>Expression</code> and <code>DimensionValues</code> objects using either <code>with*</code> methods or <code>set*</code> methods in multiple lines. </p> </li> <li> <p>Compound dimension values with logical operations - You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. This allows you to filter on more advanced options. For example, you can filter on <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>. The <code>Expression</code> for that looks like this:</p> <p> <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> <note> <p>Because each <code>Expression</code> can have only one operator, the service returns an error if more than one is specified. The following example shows an <code>Expression</code> object that creates an error.</p> </note> <p> <code> { "And": [ ... ], "DimensionValues": { "Dimension": "USAGE_TYPE", "Values": [ "DataTransfer" ] } } </code> </p> </li> </ul> <note> <p>For <code>GetRightsizingRecommendation</code> action, a combination of OR and NOT is not supported. OR is not supported between different dimensions, or dimensions and tags. NOT operators aren't supported. Dimensions are also limited to <code>LINKED_ACCOUNT</code>, <code>REGION</code>, or <code>RIGHTSIZING_TYPE</code>.</p> </note> */
		Filter?: Expression;
	}

	export enum GetSavingsPlansPurchaseRecommendationRequestSavingsPlansType { COMPUTE_SP = 0, EC2_INSTANCE_SP = 1 }

	export enum GetSavingsPlansPurchaseRecommendationRequestTermInYears { ONE_YEAR = 0, THREE_YEARS = 1 }

	export enum GetSavingsPlansPurchaseRecommendationRequestPaymentOption { NO_UPFRONT = 0, PARTIAL_UPFRONT = 1, ALL_UPFRONT = 2, LIGHT_UTILIZATION = 3, MEDIUM_UTILIZATION = 4, HEAVY_UTILIZATION = 5 }

	export enum GetSavingsPlansPurchaseRecommendationRequestAccountScope { PAYER = 0, LINKED = 1 }

	export enum GetSavingsPlansPurchaseRecommendationRequestLookbackPeriodInDays { SEVEN_DAYS = 0, THIRTY_DAYS = 1, SIXTY_DAYS = 2 }
	...
	export interface GetSavingsPlansUtilizationRequest {
		...
		/**The time period that you want the usage and costs for. */
		TimePeriod: DateInterval;
		Granularity?: GetSavingsPlansUtilizationRequestGranularity;

		/**<p>Use <code>Expression</code> to filter by cost or by usage. There are two patterns: </p> <ul> <li> <p>Simple dimension values - You can set the dimension name and values for the filters that you plan to use. For example, you can filter for <code>REGION==us-east-1 OR REGION==us-west-1</code>. The <code>Expression</code> for that looks like this:</p> <p> <code>{ "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }</code> </p> <p>The list of dimension values are OR'd together to retrieve cost or usage data. You can create <code>Expression</code> and <code>DimensionValues</code> objects using either <code>with*</code> methods or <code>set*</code> methods in multiple lines. </p> </li> <li> <p>Compound dimension values with logical operations - You can use multiple <code>Expression</code> types and the logical operators <code>AND/OR/NOT</code> to create a list of one or more <code>Expression</code> objects. This allows you to filter on more advanced options. For example, you can filter on <code>((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE != DataTransfer)</code>. The <code>Expression</code> for that looks like this:</p> <p> <code>{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [ "us-east-1", "us-west-1" ] }}, {"Tags": { "Key": "TagName", "Values": ["Value1"] } } ]}, {"Not": {"Dimensions": { "Key": "USAGE_TYPE", "Values": ["DataTransfer"] }}} ] } </code> </p> <note> <p>Because each <code>Expression</code> can have only one operator, the service returns an error if more than one is specified. The following example shows an <code>Expression</code> object that creates an error.</p> </note> <p> <code> { "And": [ ... ], "DimensionValues": { "Dimension": "USAGE_TYPE", "Values": [ "DataTransfer" ] } } </code> </p> </li> </ul> <note> <p>For <code>GetRightsizingRecommendation</code> action, a combination of OR and NOT is not supported. OR is not supported between different dimensions, or dimensions and tags. NOT operators aren't supported. Dimensions are also limited to <code>LINKED_ACCOUNT</code>, <code>REGION</code>, or <code>RIGHTSIZING_TYPE</code>.</p> </note> */
		Filter?: Expression;
	}

	export enum GetSavingsPlansUtilizationRequestGranularity { DAILY = 0, MONTHLY = 1, HOURLY = 2 }
	...
	export interface GetUsageForecastRequest {
		...
		/**The time period that you want the usage and costs for. */
		TimePeriod: DateInterval;
		Metric: GetUsageForecastRequestMetric;
		Granularity: GetUsageForecastRequestGranularity;
	...
	export enum GetUsageForecastRequestMetric { BLENDED_COST = 0, UNBLENDED_COST = 1, AMORTIZED_COST = 2, NET_UNBLENDED_COST = 3, NET_AMORTIZED_COST = 4, USAGE_QUANTITY = 5, NORMALIZED_USAGE_AMOUNT = 6 }

	export enum GetUsageForecastRequestGranularity { DAILY = 0, MONTHLY = 1, HOURLY = 2 }
	...
	export enum UpdateCostCategoryDefinitionRequestRuleVersion { CostCategoryExpression.v1 = 0 }
	...
	export interface RightsizingRecommendationMetadata {
		RecommendationId?: string;
		GenerationTimestamp?: string;
		LookbackPeriodInDays?: RightsizingRecommendationMetadataLookbackPeriodInDays;
	}

	export enum RightsizingRecommendationMetadataLookbackPeriodInDays { SEVEN_DAYS = 0, THIRTY_DAYS = 1, SIXTY_DAYS = 2 }
	...
	export interface SavingsPlansPurchaseRecommendation {
		AccountScope?: SavingsPlansPurchaseRecommendationAccountScope;
		SavingsPlansType?: SavingsPlansPurchaseRecommendationSavingsPlansType;
		TermInYears?: SavingsPlansPurchaseRecommendationTermInYears;
		PaymentOption?: SavingsPlansPurchaseRecommendationPaymentOption;
		LookbackPeriodInDays?: SavingsPlansPurchaseRecommendationLookbackPeriodInDays;
	...
	export enum SavingsPlansPurchaseRecommendationAccountScope { PAYER = 0, LINKED = 1 }

	export enum SavingsPlansPurchaseRecommendationSavingsPlansType { COMPUTE_SP = 0, EC2_INSTANCE_SP = 1 }

	export enum SavingsPlansPurchaseRecommendationTermInYears { ONE_YEAR = 0, THREE_YEARS = 1 }

	export enum SavingsPlansPurchaseRecommendationPaymentOption { NO_UPFRONT = 0, PARTIAL_UPFRONT = 1, ALL_UPFRONT = 2, LIGHT_UTILIZATION = 3, MEDIUM_UTILIZATION = 4, HEAVY_UTILIZATION = 5 }

	export enum SavingsPlansPurchaseRecommendationLookbackPeriodInDays { SEVEN_DAYS = 0, THIRTY_DAYS = 1, SIXTY_DAYS = 2 }
	...
	export class DemoClient {
		 ...
		 */
		CreateCostCategoryDefinition(requestBody: CreateCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCostCategoryDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.CreateCostCategoryDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteCostCategoryDefinition(requestBody: DeleteCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCostCategoryDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.DeleteCostCategoryDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeCostCategoryDefinition(requestBody: DescribeCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCostCategoryDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.DescribeCostCategoryDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetCostAndUsage(requestBody: GetCostAndUsageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCostAndUsageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetCostAndUsage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetCostAndUsageWithResources(requestBody: GetCostAndUsageWithResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCostAndUsageWithResourcesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetCostAndUsageWithResources', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetCostForecast(requestBody: GetCostForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCostForecastResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetCostForecast', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetDimensionValues(requestBody: GetDimensionValuesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDimensionValuesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetDimensionValues', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetReservationCoverage(requestBody: GetReservationCoverageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetReservationCoverageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetReservationCoverage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetReservationPurchaseRecommendation(requestBody: GetReservationPurchaseRecommendationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetReservationPurchaseRecommendationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetReservationPurchaseRecommendation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetReservationUtilization(requestBody: GetReservationUtilizationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetReservationUtilizationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetReservationUtilization', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetRightsizingRecommendation(requestBody: GetRightsizingRecommendationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRightsizingRecommendationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetRightsizingRecommendation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetSavingsPlansCoverage(MaxResults: string, NextToken: string, requestBody: GetSavingsPlansCoverageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSavingsPlansCoverageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetSavingsPlansCoverage?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetSavingsPlansPurchaseRecommendation(requestBody: GetSavingsPlansPurchaseRecommendationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSavingsPlansPurchaseRecommendationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetSavingsPlansPurchaseRecommendation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetSavingsPlansUtilization(requestBody: GetSavingsPlansUtilizationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSavingsPlansUtilizationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetSavingsPlansUtilization', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetSavingsPlansUtilizationDetails(MaxResults: string, NextToken: string, requestBody: GetSavingsPlansUtilizationDetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSavingsPlansUtilizationDetailsResponse> {
		...
		GetTags(requestBody: GetTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTagsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetTags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetUsageForecast(requestBody: GetUsageForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUsageForecastResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.GetUsageForecast', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListCostCategoryDefinitions(MaxResults: string, NextToken: string, requestBody: ListCostCategoryDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCostCategoryDefinitionsResponse> {
		 ...
		 */
		UpdateCostCategoryDefinition(requestBody: UpdateCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCostCategoryDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSInsightsIndexService.UpdateCostCategoryDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
