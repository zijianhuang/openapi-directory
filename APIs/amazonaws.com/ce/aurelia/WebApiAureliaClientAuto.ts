...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCostCategoryDefinition(requestBody: CreateCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCostCategoryDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.CreateCostCategoryDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteCostCategoryDefinition(requestBody: DeleteCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCostCategoryDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.DeleteCostCategoryDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCostCategoryDefinition(requestBody: DescribeCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCostCategoryDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.DescribeCostCategoryDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCostAndUsage(requestBody: GetCostAndUsageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCostAndUsageResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetCostAndUsage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCostAndUsageWithResources(requestBody: GetCostAndUsageWithResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCostAndUsageWithResourcesResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetCostAndUsageWithResources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCostForecast(requestBody: GetCostForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCostForecastResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetCostForecast', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDimensionValues(requestBody: GetDimensionValuesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDimensionValuesResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetDimensionValues', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetReservationCoverage(requestBody: GetReservationCoverageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetReservationCoverageResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetReservationCoverage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetReservationPurchaseRecommendation(requestBody: GetReservationPurchaseRecommendationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetReservationPurchaseRecommendationResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetReservationPurchaseRecommendation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetReservationUtilization(requestBody: GetReservationUtilizationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetReservationUtilizationResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetReservationUtilization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRightsizingRecommendation(requestBody: GetRightsizingRecommendationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRightsizingRecommendationResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetRightsizingRecommendation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSavingsPlansCoverage(MaxResults: string, NextToken: string, requestBody: GetSavingsPlansCoverageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSavingsPlansCoverageResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetSavingsPlansCoverage?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSavingsPlansPurchaseRecommendation(requestBody: GetSavingsPlansPurchaseRecommendationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSavingsPlansPurchaseRecommendationResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetSavingsPlansPurchaseRecommendation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSavingsPlansUtilization(requestBody: GetSavingsPlansUtilizationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSavingsPlansUtilizationResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetSavingsPlansUtilization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTags(requestBody: GetTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTagsResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetUsageForecast(requestBody: GetUsageForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUsageForecastResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.GetUsageForecast', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListCostCategoryDefinitions(MaxResults: string, NextToken: string, requestBody: ListCostCategoryDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCostCategoryDefinitionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.ListCostCategoryDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateCostCategoryDefinition(requestBody: UpdateCostCategoryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCostCategoryDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=AWSInsightsIndexService.UpdateCostCategoryDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
