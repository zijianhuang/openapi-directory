...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateIpGroups(requestBody: AssociateIpGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateIpGroupsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.AssociateIpGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AuthorizeIpRules(requestBody: AuthorizeIpRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<AuthorizeIpRulesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.AuthorizeIpRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CopyWorkspaceImage(requestBody: CopyWorkspaceImageRequest, headersHandler?: () => {[header: string]: string}): Promise<CopyWorkspaceImageResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.CopyWorkspaceImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateIpGroup(requestBody: CreateIpGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateIpGroupResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.CreateIpGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTags(requestBody: CreateTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTagsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.CreateTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateWorkspaces(requestBody: CreateWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkspacesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.CreateWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteIpGroup(requestBody: DeleteIpGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteIpGroupResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DeleteIpGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTags(requestBody: DeleteTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteWorkspaceImage(requestBody: DeleteWorkspaceImageRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkspaceImageResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DeleteWorkspaceImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterWorkspaceDirectory(requestBody: DeregisterWorkspaceDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterWorkspaceDirectoryResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DeregisterWorkspaceDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAccount(requestBody: DescribeAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAccountModifications(requestBody: DescribeAccountModificationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountModificationsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeAccountModifications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeClientProperties(requestBody: DescribeClientPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeClientPropertiesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeClientProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeIpGroups(requestBody: DescribeIpGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeIpGroupsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeIpGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkspaceBundles(NextToken: string, requestBody: DescribeWorkspaceBundlesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceBundlesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeWorkspaceBundles?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkspaceDirectories(NextToken: string, requestBody: DescribeWorkspaceDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceDirectoriesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeWorkspaceDirectories?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkspaceImages(requestBody: DescribeWorkspaceImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceImagesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeWorkspaceImages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkspaceSnapshots(requestBody: DescribeWorkspaceSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceSnapshotsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeWorkspaceSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkspaces(Limit: string, NextToken: string, requestBody: DescribeWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspacesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeWorkspaces?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkspacesConnectionStatus(requestBody: DescribeWorkspacesConnectionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspacesConnectionStatusResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DescribeWorkspacesConnectionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateIpGroups(requestBody: DisassociateIpGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateIpGroupsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.DisassociateIpGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ImportWorkspaceImage(requestBody: ImportWorkspaceImageRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportWorkspaceImageResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ImportWorkspaceImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAvailableManagementCidrRanges(requestBody: ListAvailableManagementCidrRangesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAvailableManagementCidrRangesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ListAvailableManagementCidrRanges', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		MigrateWorkspace(requestBody: MigrateWorkspaceRequest, headersHandler?: () => {[header: string]: string}): Promise<MigrateWorkspaceResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.MigrateWorkspace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyAccount(requestBody: ModifyAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyAccountResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ModifyAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyClientProperties(requestBody: ModifyClientPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyClientPropertiesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ModifyClientProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifySelfservicePermissions(requestBody: ModifySelfservicePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifySelfservicePermissionsResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ModifySelfservicePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyWorkspaceAccessProperties(requestBody: ModifyWorkspaceAccessPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspaceAccessPropertiesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ModifyWorkspaceAccessProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyWorkspaceCreationProperties(requestBody: ModifyWorkspaceCreationPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspaceCreationPropertiesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ModifyWorkspaceCreationProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyWorkspaceProperties(requestBody: ModifyWorkspacePropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspacePropertiesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ModifyWorkspaceProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyWorkspaceState(requestBody: ModifyWorkspaceStateRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspaceStateResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.ModifyWorkspaceState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RebootWorkspaces(requestBody: RebootWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootWorkspacesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.RebootWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RebuildWorkspaces(requestBody: RebuildWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<RebuildWorkspacesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.RebuildWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterWorkspaceDirectory(requestBody: RegisterWorkspaceDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterWorkspaceDirectoryResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.RegisterWorkspaceDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RestoreWorkspace(requestBody: RestoreWorkspaceRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreWorkspaceResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.RestoreWorkspace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RevokeIpRules(requestBody: RevokeIpRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<RevokeIpRulesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.RevokeIpRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartWorkspaces(requestBody: StartWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<StartWorkspacesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.StartWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopWorkspaces(requestBody: StopWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<StopWorkspacesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.StopWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TerminateWorkspaces(requestBody: TerminateWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<TerminateWorkspacesResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.TerminateWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateRulesOfIpGroup(requestBody: UpdateRulesOfIpGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRulesOfIpGroupResult> {
			return this.http.post('/#X-Amz-Target=WorkspacesService.UpdateRulesOfIpGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
