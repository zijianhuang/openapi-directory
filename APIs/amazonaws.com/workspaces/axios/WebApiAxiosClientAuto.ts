...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateIpGroups(requestBody: AssociateIpGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateIpGroupsResult> {
			return Axios.post<AssociateIpGroupsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.AssociateIpGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AuthorizeIpRules(requestBody: AuthorizeIpRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<AuthorizeIpRulesResult> {
			return Axios.post<AuthorizeIpRulesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.AuthorizeIpRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CopyWorkspaceImage(requestBody: CopyWorkspaceImageRequest, headersHandler?: () => {[header: string]: string}): Promise<CopyWorkspaceImageResult> {
			return Axios.post<CopyWorkspaceImageResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.CopyWorkspaceImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateIpGroup(requestBody: CreateIpGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateIpGroupResult> {
			return Axios.post<CreateIpGroupResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.CreateIpGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTags(requestBody: CreateTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTagsResult> {
			return Axios.post<CreateTagsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.CreateTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateWorkspaces(requestBody: CreateWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkspacesResult> {
			return Axios.post<CreateWorkspacesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.CreateWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteIpGroup(requestBody: DeleteIpGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteIpGroupResult> {
			return Axios.post<DeleteIpGroupResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DeleteIpGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTags(requestBody: DeleteTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsResult> {
			return Axios.post<DeleteTagsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteWorkspaceImage(requestBody: DeleteWorkspaceImageRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkspaceImageResult> {
			return Axios.post<DeleteWorkspaceImageResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DeleteWorkspaceImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAccount(requestBody: DescribeAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountResult> {
			return Axios.post<DescribeAccountResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAccountModifications(requestBody: DescribeAccountModificationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountModificationsResult> {
			return Axios.post<DescribeAccountModificationsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeAccountModifications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeClientProperties(requestBody: DescribeClientPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeClientPropertiesResult> {
			return Axios.post<DescribeClientPropertiesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeClientProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeIpGroups(requestBody: DescribeIpGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeIpGroupsResult> {
			return Axios.post<DescribeIpGroupsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeIpGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResult> {
			return Axios.post<DescribeTagsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeWorkspaceBundles(NextToken: string, requestBody: DescribeWorkspaceBundlesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceBundlesResult> {
			return Axios.post<DescribeWorkspaceBundlesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeWorkspaceBundles?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeWorkspaceDirectories(NextToken: string, requestBody: DescribeWorkspaceDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceDirectoriesResult> {
			return Axios.post<DescribeWorkspaceDirectoriesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeWorkspaceDirectories?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeWorkspaceImages(requestBody: DescribeWorkspaceImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceImagesResult> {
			return Axios.post<DescribeWorkspaceImagesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeWorkspaceImages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeWorkspaceSnapshots(requestBody: DescribeWorkspaceSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspaceSnapshotsResult> {
			return Axios.post<DescribeWorkspaceSnapshotsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeWorkspaceSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeWorkspaces(Limit: string, NextToken: string, requestBody: DescribeWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspacesResult> {
			return Axios.post<DescribeWorkspacesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeWorkspaces?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeWorkspacesConnectionStatus(requestBody: DescribeWorkspacesConnectionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkspacesConnectionStatusResult> {
			return Axios.post<DescribeWorkspacesConnectionStatusResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DescribeWorkspacesConnectionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateIpGroups(requestBody: DisassociateIpGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateIpGroupsResult> {
			return Axios.post<DisassociateIpGroupsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.DisassociateIpGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ImportWorkspaceImage(requestBody: ImportWorkspaceImageRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportWorkspaceImageResult> {
			return Axios.post<ImportWorkspaceImageResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ImportWorkspaceImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAvailableManagementCidrRanges(requestBody: ListAvailableManagementCidrRangesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAvailableManagementCidrRangesResult> {
			return Axios.post<ListAvailableManagementCidrRangesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ListAvailableManagementCidrRanges', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		MigrateWorkspace(requestBody: MigrateWorkspaceRequest, headersHandler?: () => {[header: string]: string}): Promise<MigrateWorkspaceResult> {
			return Axios.post<MigrateWorkspaceResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.MigrateWorkspace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyAccount(requestBody: ModifyAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyAccountResult> {
			return Axios.post<ModifyAccountResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ModifyAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyClientProperties(requestBody: ModifyClientPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyClientPropertiesResult> {
			return Axios.post<ModifyClientPropertiesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ModifyClientProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifySelfservicePermissions(requestBody: ModifySelfservicePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifySelfservicePermissionsResult> {
			return Axios.post<ModifySelfservicePermissionsResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ModifySelfservicePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyWorkspaceAccessProperties(requestBody: ModifyWorkspaceAccessPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspaceAccessPropertiesResult> {
			return Axios.post<ModifyWorkspaceAccessPropertiesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ModifyWorkspaceAccessProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyWorkspaceCreationProperties(requestBody: ModifyWorkspaceCreationPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspaceCreationPropertiesResult> {
			return Axios.post<ModifyWorkspaceCreationPropertiesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ModifyWorkspaceCreationProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyWorkspaceProperties(requestBody: ModifyWorkspacePropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspacePropertiesResult> {
			return Axios.post<ModifyWorkspacePropertiesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ModifyWorkspaceProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyWorkspaceState(requestBody: ModifyWorkspaceStateRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyWorkspaceStateResult> {
			return Axios.post<ModifyWorkspaceStateResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.ModifyWorkspaceState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RebootWorkspaces(requestBody: RebootWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootWorkspacesResult> {
			return Axios.post<RebootWorkspacesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.RebootWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RebuildWorkspaces(requestBody: RebuildWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<RebuildWorkspacesResult> {
			return Axios.post<RebuildWorkspacesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.RebuildWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterWorkspaceDirectory(requestBody: RegisterWorkspaceDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterWorkspaceDirectoryResult> {
			return Axios.post<RegisterWorkspaceDirectoryResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.RegisterWorkspaceDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RestoreWorkspace(requestBody: RestoreWorkspaceRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreWorkspaceResult> {
			return Axios.post<RestoreWorkspaceResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.RestoreWorkspace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RevokeIpRules(requestBody: RevokeIpRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<RevokeIpRulesResult> {
			return Axios.post<RevokeIpRulesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.RevokeIpRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartWorkspaces(requestBody: StartWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<StartWorkspacesResult> {
			return Axios.post<StartWorkspacesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.StartWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopWorkspaces(requestBody: StopWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<StopWorkspacesResult> {
			return Axios.post<StopWorkspacesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.StopWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TerminateWorkspaces(requestBody: TerminateWorkspacesRequest, headersHandler?: () => {[header: string]: string}): Promise<TerminateWorkspacesResult> {
			return Axios.post<TerminateWorkspacesResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.TerminateWorkspaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRulesOfIpGroup(requestBody: UpdateRulesOfIpGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRulesOfIpGroupResult> {
			return Axios.post<UpdateRulesOfIpGroupResult>(this.baseUri + '/#X-Amz-Target=WorkspacesService.UpdateRulesOfIpGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
