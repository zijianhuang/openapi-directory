...
export namespace My_Demo_Client {
	...
	export interface AcceptMatchInput {
		TicketId: string;
		PlayerIds: Array<NonZeroAndMaxString>;
	...
	export interface CreateBuildInput {
		...
		/**The location in S3 where build or script files are stored for access by Amazon GameLift. This location is specified in <a>CreateBuild</a>, <a>CreateScript</a>, and <a>UpdateScript</a> requests. */
		StorageLocation?: S3Location;
		OperatingSystem?: CreateBuildInputOperatingSystem;
		Tags?: Array<Tag>;
	}

	export enum CreateBuildInputOperatingSystem { WINDOWS_2012 = 0, AMAZON_LINUX = 1, AMAZON_LINUX_2 = 2 }
	...
	export interface CreateFleetInput {
		...
		LogPaths?: Array<NonZeroAndMaxString>;
		EC2InstanceType: CreateFleetInputEC2InstanceType;
		EC2InboundPermissions?: Array<IpPermission>;
		NewGameSessionProtectionPolicy?: CreateFleetInputNewGameSessionProtectionPolicy;
		...
		PeerVpcId?: string;
		FleetType?: CreateFleetInputFleetType;
	...
	export enum CreateFleetInputEC2InstanceType { t2.micro = 0, t2.small = 1, t2.medium = 2, t2.large = 3, c3.large = 4, c3.xlarge = 5, c3.2xlarge = 6, c3.4xlarge = 7, c3.8xlarge = 8, c4.large = 9, c4.xlarge = 10, c4.2xlarge = 11, c4.4xlarge = 12, c4.8xlarge = 13, c5.large = 14, c5.xlarge = 15, c5.2xlarge = 16, c5.4xlarge = 17, c5.9xlarge = 18, c5.12xlarge = 19, c5.18xlarge = 20, c5.24xlarge = 21, r3.large = 22, r3.xlarge = 23, r3.2xlarge = 24, r3.4xlarge = 25, r3.8xlarge = 26, r4.large = 27, r4.xlarge = 28, r4.2xlarge = 29, r4.4xlarge = 30, r4.8xlarge = 31, r4.16xlarge = 32, r5.large = 33, r5.xlarge = 34, r5.2xlarge = 35, r5.4xlarge = 36, r5.8xlarge = 37, r5.12xlarge = 38, r5.16xlarge = 39, r5.24xlarge = 40, m3.medium = 41, m3.large = 42, m3.xlarge = 43, m3.2xlarge = 44, m4.large = 45, m4.xlarge = 46, m4.2xlarge = 47, m4.4xlarge = 48, m4.10xlarge = 49, m5.large = 50, m5.xlarge = 51, m5.2xlarge = 52, m5.4xlarge = 53, m5.8xlarge = 54, m5.12xlarge = 55, m5.16xlarge = 56, m5.24xlarge = 57 }

	export enum CreateFleetInputNewGameSessionProtectionPolicy { NoProtection = 0, FullProtection = 1 }

	export enum CreateFleetInputFleetType { ON_DEMAND = 0, SPOT = 1 }
	...
	export interface CreateGameServerGroupInput {
		...
		BalancingStrategy?: CreateGameServerGroupInputBalancingStrategy;
		GameServerProtectionPolicy?: CreateGameServerGroupInputGameServerProtectionPolicy;
		VpcSubnets?: Array<VpcSubnet>;
		Tags?: Array<Tag>;
	}

	export enum CreateGameServerGroupInputBalancingStrategy { SPOT_ONLY = 0, SPOT_PREFERRED = 1 }

	export enum CreateGameServerGroupInputGameServerProtectionPolicy { NO_PROTECTION = 0, FULL_PROTECTION = 1 }
	...
	export interface CreateMatchmakingConfigurationInput {
		Name: string;
		Description?: string;
		GameSessionQueueArns: Array<ArnStringModel>;
		...
		GameProperties?: Array<GameProperty>;
		GameSessionData?: string;
		BackfillMode?: CreateMatchmakingConfigurationInputBackfillMode;
		Tags?: Array<Tag>;
	}

	export enum CreateMatchmakingConfigurationInputBackfillMode { AUTOMATIC = 0, MANUAL = 1 }
	...
	export enum DescribeEC2InstanceLimitsInputEC2InstanceType { t2.micro = 0, t2.small = 1, t2.medium = 2, t2.large = 3, c3.large = 4, c3.xlarge = 5, c3.2xlarge = 6, c3.4xlarge = 7, c3.8xlarge = 8, c4.large = 9, c4.xlarge = 10, c4.2xlarge = 11, c4.4xlarge = 12, c4.8xlarge = 13, c5.large = 14, c5.xlarge = 15, c5.2xlarge = 16, c5.4xlarge = 17, c5.9xlarge = 18, c5.12xlarge = 19, c5.18xlarge = 20, c5.24xlarge = 21, r3.large = 22, r3.xlarge = 23, r3.2xlarge = 24, r3.4xlarge = 25, r3.8xlarge = 26, r4.large = 27, r4.xlarge = 28, r4.2xlarge = 29, r4.4xlarge = 30, r4.8xlarge = 31, r4.16xlarge = 32, r5.large = 33, r5.xlarge = 34, r5.2xlarge = 35, r5.4xlarge = 36, r5.8xlarge = 37, r5.12xlarge = 38, r5.16xlarge = 39, r5.24xlarge = 40, m3.medium = 41, m3.large = 42, m3.xlarge = 43, m3.2xlarge = 44, m4.large = 45, m4.xlarge = 46, m4.2xlarge = 47, m4.4xlarge = 48, m4.10xlarge = 49, m5.large = 50, m5.xlarge = 51, m5.2xlarge = 52, m5.4xlarge = 53, m5.8xlarge = 54, m5.12xlarge = 55, m5.16xlarge = 56, m5.24xlarge = 57 }
	...
	export interface DescribeGameSessionQueuesInput {
		Names?: Array<GameSessionQueueNameOrArn>;
		Limit?: number;
		NextToken?: string;
	}
	...
	export interface DescribeMatchmakingInput {
		TicketIds: Array<MatchmakingIdStringModel>;
	}
	...
	export interface DescribeMatchmakingConfigurationsInput {
		Names?: Array<MatchmakingConfigurationName>;
		RuleSetName?: string;
		Limit?: number;
		NextToken?: string;
	}
	...
	export interface DescribeMatchmakingRuleSetsInput {
		Names?: Array<MatchmakingRuleSetName>;
		Limit?: number;
		NextToken?: string;
	}
	...
	export interface DescribeScalingPoliciesInput {
		FleetId: string;
		StatusFilter?: DescribeScalingPoliciesInputStatusFilter;
		Limit?: number;
		NextToken?: string;
	}

	export enum DescribeScalingPoliciesInputStatusFilter { ACTIVE = 0, UPDATE_REQUESTED = 1, UPDATING = 2, DELETE_REQUESTED = 3, DELETING = 4, DELETED = 5, ERROR = 6 }
	...
	export interface ListAliasesInput {
		RoutingStrategyType?: ListAliasesInputRoutingStrategyType;
		Name?: string;
		Limit?: number;
		NextToken?: string;
	}

	export enum ListAliasesInputRoutingStrategyType { SIMPLE = 0, TERMINAL = 1 }
	...
	export interface ListBuildsInput {
		Status?: ListBuildsInputStatus;
		Limit?: number;
		NextToken?: string;
	}

	export enum ListBuildsInputStatus { INITIALIZED = 0, READY = 1, FAILED = 2 }
	...
	export interface PutScalingPolicyInput {
		...
		ScalingAdjustmentType?: PutScalingPolicyInputScalingAdjustmentType;
		Threshold?: number;
		ComparisonOperator?: PutScalingPolicyInputComparisonOperator;
		EvaluationPeriods?: number;
		MetricName: PutScalingPolicyInputMetricName;
		PolicyType?: PutScalingPolicyInputPolicyType;
	...
	export enum PutScalingPolicyInputScalingAdjustmentType { ChangeInCapacity = 0, ExactCapacity = 1, PercentChangeInCapacity = 2 }

	export enum PutScalingPolicyInputComparisonOperator { GreaterThanOrEqualToThreshold = 0, GreaterThanThreshold = 1, LessThanThreshold = 2, LessThanOrEqualToThreshold = 3 }

	export enum PutScalingPolicyInputMetricName { ActivatingGameSessions = 0, ActiveGameSessions = 1, ActiveInstances = 2, AvailableGameSessions = 3, AvailablePlayerSessions = 4, CurrentPlayerSessions = 5, IdleInstances = 6, PercentAvailableGameSessions = 7, PercentIdleInstances = 8, QueueDepth = 9, WaitTime = 10 }

	export enum PutScalingPolicyInputPolicyType { RuleBased = 0, TargetBased = 1 }
	...
	export interface UpdateFleetAttributesInput {
		...
		Name?: string;
		Description?: string;
		NewGameSessionProtectionPolicy?: UpdateFleetAttributesInputNewGameSessionProtectionPolicy;
	...
	export enum UpdateFleetAttributesInputNewGameSessionProtectionPolicy { NoProtection = 0, FullProtection = 1 }
	...
	export interface UpdateGameServerInput {
		...
		GameServerData?: string;
		CustomSortKey?: string;
		UtilizationStatus?: UpdateGameServerInputUtilizationStatus;
		HealthCheck?: UpdateGameServerInputHealthCheck;
	}

	export enum UpdateGameServerInputUtilizationStatus { AVAILABLE = 0, UTILIZED = 1 }
	...
	export interface UpdateGameServerGroupInput {
		...
		RoleArn?: string;
		InstanceDefinitions?: Array<InstanceDefinition>;
		GameServerProtectionPolicy?: UpdateGameServerGroupInputGameServerProtectionPolicy;
		BalancingStrategy?: UpdateGameServerGroupInputBalancingStrategy;
	}

	export enum UpdateGameServerGroupInputGameServerProtectionPolicy { NO_PROTECTION = 0, FULL_PROTECTION = 1 }

	export enum UpdateGameServerGroupInputBalancingStrategy { SPOT_ONLY = 0, SPOT_PREFERRED = 1 }
	...
	export interface UpdateGameSessionInput {
		...
		MaximumPlayerSessionCount?: number;
		Name?: string;
		PlayerSessionCreationPolicy?: UpdateGameSessionInputPlayerSessionCreationPolicy;
		ProtectionPolicy?: UpdateGameSessionInputProtectionPolicy;
	}

	export enum UpdateGameSessionInputPlayerSessionCreationPolicy { ACCEPT_ALL = 0, DENY_ALL = 1 }

	export enum UpdateGameSessionInputProtectionPolicy { NoProtection = 0, FullProtection = 1 }
	...
	export interface UpdateMatchmakingConfigurationInput {
		...
		GameProperties?: Array<GameProperty>;
		GameSessionData?: string;
		BackfillMode?: UpdateMatchmakingConfigurationInputBackfillMode;
	}

	export enum UpdateMatchmakingConfigurationInputBackfillMode { AUTOMATIC = 0, MANUAL = 1 }
	...
	export enum EC2InstanceType { t2.micro = 0, t2.small = 1, t2.medium = 2, t2.large = 3, c3.large = 4, c3.xlarge = 5, c3.2xlarge = 6, c3.4xlarge = 7, c3.8xlarge = 8, c4.large = 9, c4.xlarge = 10, c4.2xlarge = 11, c4.4xlarge = 12, c4.8xlarge = 13, c5.large = 14, c5.xlarge = 15, c5.2xlarge = 16, c5.4xlarge = 17, c5.9xlarge = 18, c5.12xlarge = 19, c5.18xlarge = 20, c5.24xlarge = 21, r3.large = 22, r3.xlarge = 23, r3.2xlarge = 24, r3.4xlarge = 25, r3.8xlarge = 26, r4.large = 27, r4.xlarge = 28, r4.2xlarge = 29, r4.4xlarge = 30, r4.8xlarge = 31, r4.16xlarge = 32, r5.large = 33, r5.xlarge = 34, r5.2xlarge = 35, r5.4xlarge = 36, r5.8xlarge = 37, r5.12xlarge = 38, r5.16xlarge = 39, r5.24xlarge = 40, m3.medium = 41, m3.large = 42, m3.xlarge = 43, m3.2xlarge = 44, m4.large = 45, m4.xlarge = 46, m4.2xlarge = 47, m4.4xlarge = 48, m4.10xlarge = 49, m5.large = 50, m5.xlarge = 51, m5.2xlarge = 52, m5.4xlarge = 53, m5.8xlarge = 54, m5.12xlarge = 55, m5.16xlarge = 56, m5.24xlarge = 57 }
	...
	export interface FleetAttributes {
		...
		OperatingSystem?: FleetAttributesOperatingSystem;
	...
	export enum FleetAttributesInstanceType { t2.micro = 0, t2.small = 1, t2.medium = 2, t2.large = 3, c3.large = 4, c3.xlarge = 5, c3.2xlarge = 6, c3.4xlarge = 7, c3.8xlarge = 8, c4.large = 9, c4.xlarge = 10, c4.2xlarge = 11, c4.4xlarge = 12, c4.8xlarge = 13, c5.large = 14, c5.xlarge = 15, c5.2xlarge = 16, c5.4xlarge = 17, c5.9xlarge = 18, c5.12xlarge = 19, c5.18xlarge = 20, c5.24xlarge = 21, r3.large = 22, r3.xlarge = 23, r3.2xlarge = 24, r3.4xlarge = 25, r3.8xlarge = 26, r4.large = 27, r4.xlarge = 28, r4.2xlarge = 29, r4.4xlarge = 30, r4.8xlarge = 31, r4.16xlarge = 32, r5.large = 33, r5.xlarge = 34, r5.2xlarge = 35, r5.4xlarge = 36, r5.8xlarge = 37, r5.12xlarge = 38, r5.16xlarge = 39, r5.24xlarge = 40, m3.medium = 41, m3.large = 42, m3.xlarge = 43, m3.2xlarge = 44, m4.large = 45, m4.xlarge = 46, m4.2xlarge = 47, m4.4xlarge = 48, m4.10xlarge = 49, m5.large = 50, m5.xlarge = 51, m5.2xlarge = 52, m5.4xlarge = 53, m5.8xlarge = 54, m5.12xlarge = 55, m5.16xlarge = 56, m5.24xlarge = 57 }
	...
	export enum FleetAttributesOperatingSystem { WINDOWS_2012 = 0, AMAZON_LINUX = 1, AMAZON_LINUX_2 = 2 }
	...
	export enum EC2InstanceLimitEC2InstanceType { t2.micro = 0, t2.small = 1, t2.medium = 2, t2.large = 3, c3.large = 4, c3.xlarge = 5, c3.2xlarge = 6, c3.4xlarge = 7, c3.8xlarge = 8, c4.large = 9, c4.xlarge = 10, c4.2xlarge = 11, c4.4xlarge = 12, c4.8xlarge = 13, c5.large = 14, c5.xlarge = 15, c5.2xlarge = 16, c5.4xlarge = 17, c5.9xlarge = 18, c5.12xlarge = 19, c5.18xlarge = 20, c5.24xlarge = 21, r3.large = 22, r3.xlarge = 23, r3.2xlarge = 24, r3.4xlarge = 25, r3.8xlarge = 26, r4.large = 27, r4.xlarge = 28, r4.2xlarge = 29, r4.4xlarge = 30, r4.8xlarge = 31, r4.16xlarge = 32, r5.large = 33, r5.xlarge = 34, r5.2xlarge = 35, r5.4xlarge = 36, r5.8xlarge = 37, r5.12xlarge = 38, r5.16xlarge = 39, r5.24xlarge = 40, m3.medium = 41, m3.large = 42, m3.xlarge = 43, m3.2xlarge = 44, m4.large = 45, m4.xlarge = 46, m4.2xlarge = 47, m4.4xlarge = 48, m4.10xlarge = 49, m5.large = 50, m5.xlarge = 51, m5.2xlarge = 52, m5.4xlarge = 53, m5.8xlarge = 54, m5.12xlarge = 55, m5.16xlarge = 56, m5.24xlarge = 57 }
	...
	export enum FleetCapacityInstanceType { t2.micro = 0, t2.small = 1, t2.medium = 2, t2.large = 3, c3.large = 4, c3.xlarge = 5, c3.2xlarge = 6, c3.4xlarge = 7, c3.8xlarge = 8, c4.large = 9, c4.xlarge = 10, c4.2xlarge = 11, c4.4xlarge = 12, c4.8xlarge = 13, c5.large = 14, c5.xlarge = 15, c5.2xlarge = 16, c5.4xlarge = 17, c5.9xlarge = 18, c5.12xlarge = 19, c5.18xlarge = 20, c5.24xlarge = 21, r3.large = 22, r3.xlarge = 23, r3.2xlarge = 24, r3.4xlarge = 25, r3.8xlarge = 26, r4.large = 27, r4.xlarge = 28, r4.2xlarge = 29, r4.4xlarge = 30, r4.8xlarge = 31, r4.16xlarge = 32, r5.large = 33, r5.xlarge = 34, r5.2xlarge = 35, r5.4xlarge = 36, r5.8xlarge = 37, r5.12xlarge = 38, r5.16xlarge = 39, r5.24xlarge = 40, m3.medium = 41, m3.large = 42, m3.xlarge = 43, m3.2xlarge = 44, m4.large = 45, m4.xlarge = 46, m4.2xlarge = 47, m4.4xlarge = 48, m4.10xlarge = 49, m5.large = 50, m5.xlarge = 51, m5.2xlarge = 52, m5.4xlarge = 53, m5.8xlarge = 54, m5.12xlarge = 55, m5.16xlarge = 56, m5.24xlarge = 57 }
	...
	export enum GameServerGroupInstanceType { c4.large = 0, c4.xlarge = 1, c4.2xlarge = 2, c4.4xlarge = 3, c4.8xlarge = 4, c5.large = 5, c5.xlarge = 6, c5.2xlarge = 7, c5.4xlarge = 8, c5.9xlarge = 9, c5.12xlarge = 10, c5.18xlarge = 11, c5.24xlarge = 12, r4.large = 13, r4.xlarge = 14, r4.2xlarge = 15, r4.4xlarge = 16, r4.8xlarge = 17, r4.16xlarge = 18, r5.large = 19, r5.xlarge = 20, r5.2xlarge = 21, r5.4xlarge = 22, r5.8xlarge = 23, r5.12xlarge = 24, r5.16xlarge = 25, r5.24xlarge = 26, m4.large = 27, m4.xlarge = 28, m4.2xlarge = 29, m4.4xlarge = 30, m4.10xlarge = 31, m5.large = 32, m5.xlarge = 33, m5.2xlarge = 34, m5.4xlarge = 35, m5.8xlarge = 36, m5.12xlarge = 37, m5.16xlarge = 38, m5.24xlarge = 39 }
	...
	export interface GameSessionDetail {
		...
		/**<p>Properties describing a game session.</p> <p>A game session in ACTIVE status can host players. When a game session ends, its status is set to <code>TERMINATED</code>. </p> <p>Once the session ends, the game session object is retained for 30 days. This means you can reuse idempotency token values after this time. Game session logs are retained for 14 days.</p> <ul> <li> <p> <a>CreateGameSession</a> </p> </li> <li> <p> <a>DescribeGameSessions</a> </p> </li> <li> <p> <a>DescribeGameSessionDetails</a> </p> </li> <li> <p> <a>SearchGameSessions</a> </p> </li> <li> <p> <a>UpdateGameSession</a> </p> </li> <li> <p> <a>GetGameSessionLogUrl</a> </p> </li> <li> <p>Game session placements</p> <ul> <li> <p> <a>StartGameSessionPlacement</a> </p> </li> <li> <p> <a>DescribeGameSessionPlacement</a> </p> </li> <li> <p> <a>StopGameSessionPlacement</a> </p> </li> </ul> </li> </ul> */
		GameSession?: GameSession;
		ProtectionPolicy?: GameSessionDetailProtectionPolicy;
	}

	export enum GameSessionDetailProtectionPolicy { NoProtection = 0, FullProtection = 1 }
	...
	export interface InstanceAccess {
		...
		InstanceId?: string;
		IpAddress?: string;
		OperatingSystem?: InstanceAccessOperatingSystem;
	...
	export enum InstanceAccessOperatingSystem { WINDOWS_2012 = 0, AMAZON_LINUX = 1, AMAZON_LINUX_2 = 2 }
	...
	export interface Instance {
		...
		IpAddress?: string;
		DnsName?: string;
		OperatingSystem?: InstanceOperatingSystem;
		Type?: InstanceType;
		Status?: InstanceStatus;
		CreationTime?: Date;
	}

	export enum InstanceOperatingSystem { WINDOWS_2012 = 0, AMAZON_LINUX = 1, AMAZON_LINUX_2 = 2 }

	export enum InstanceType { t2.micro = 0, t2.small = 1, t2.medium = 2, t2.large = 3, c3.large = 4, c3.xlarge = 5, c3.2xlarge = 6, c3.4xlarge = 7, c3.8xlarge = 8, c4.large = 9, c4.xlarge = 10, c4.2xlarge = 11, c4.4xlarge = 12, c4.8xlarge = 13, c5.large = 14, c5.xlarge = 15, c5.2xlarge = 16, c5.4xlarge = 17, c5.9xlarge = 18, c5.12xlarge = 19, c5.18xlarge = 20, c5.24xlarge = 21, r3.large = 22, r3.xlarge = 23, r3.2xlarge = 24, r3.4xlarge = 25, r3.8xlarge = 26, r4.large = 27, r4.xlarge = 28, r4.2xlarge = 29, r4.4xlarge = 30, r4.8xlarge = 31, r4.16xlarge = 32, r5.large = 33, r5.xlarge = 34, r5.2xlarge = 35, r5.4xlarge = 36, r5.8xlarge = 37, r5.12xlarge = 38, r5.16xlarge = 39, r5.24xlarge = 40, m3.medium = 41, m3.large = 42, m3.xlarge = 43, m3.2xlarge = 44, m4.large = 45, m4.xlarge = 46, m4.2xlarge = 47, m4.4xlarge = 48, m4.10xlarge = 49, m5.large = 50, m5.xlarge = 51, m5.2xlarge = 52, m5.4xlarge = 53, m5.8xlarge = 54, m5.12xlarge = 55, m5.16xlarge = 56, m5.24xlarge = 57 }
	...
	export enum InstanceDefinitionInstanceType { c4.large = 0, c4.xlarge = 1, c4.2xlarge = 2, c4.4xlarge = 3, c4.8xlarge = 4, c5.large = 5, c5.xlarge = 6, c5.2xlarge = 7, c5.4xlarge = 8, c5.9xlarge = 9, c5.12xlarge = 10, c5.18xlarge = 11, c5.24xlarge = 12, r4.large = 13, r4.xlarge = 14, r4.2xlarge = 15, r4.4xlarge = 16, r4.8xlarge = 17, r4.16xlarge = 18, r5.large = 19, r5.xlarge = 20, r5.2xlarge = 21, r5.4xlarge = 22, r5.8xlarge = 23, r5.12xlarge = 24, r5.16xlarge = 25, r5.24xlarge = 26, m4.large = 27, m4.xlarge = 28, m4.2xlarge = 29, m4.4xlarge = 30, m4.10xlarge = 31, m5.large = 32, m5.xlarge = 33, m5.2xlarge = 34, m5.4xlarge = 35, m5.8xlarge = 36, m5.12xlarge = 37, m5.16xlarge = 38, m5.24xlarge = 39 }
	...
	export class DemoClient {
		 ...
		 */
		AcceptMatch(requestBody: AcceptMatchInput, headersHandler?: () => {[header: string]: string}): Promise<AcceptMatchOutput> {
			return Axios.post<AcceptMatchOutput>(this.baseUri + '/#X-Amz-Target=GameLift.AcceptMatch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ClaimGameServer(requestBody: ClaimGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<ClaimGameServerOutput> {
			return Axios.post<ClaimGameServerOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ClaimGameServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateAlias(requestBody: CreateAliasInput, headersHandler?: () => {[header: string]: string}): Promise<CreateAliasOutput> {
			return Axios.post<CreateAliasOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateBuild(requestBody: CreateBuildInput, headersHandler?: () => {[header: string]: string}): Promise<CreateBuildOutput> {
			return Axios.post<CreateBuildOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateBuild', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateFleet(requestBody: CreateFleetInput, headersHandler?: () => {[header: string]: string}): Promise<CreateFleetOutput> {
			return Axios.post<CreateFleetOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateGameServerGroup(requestBody: CreateGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<CreateGameServerGroupOutput> {
			return Axios.post<CreateGameServerGroupOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateGameServerGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateGameSession(requestBody: CreateGameSessionInput, headersHandler?: () => {[header: string]: string}): Promise<CreateGameSessionOutput> {
			return Axios.post<CreateGameSessionOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateGameSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateGameSessionQueue(requestBody: CreateGameSessionQueueInput, headersHandler?: () => {[header: string]: string}): Promise<CreateGameSessionQueueOutput> {
			return Axios.post<CreateGameSessionQueueOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateGameSessionQueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateMatchmakingConfiguration(requestBody: CreateMatchmakingConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateMatchmakingConfigurationOutput> {
			return Axios.post<CreateMatchmakingConfigurationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateMatchmakingConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateMatchmakingRuleSet(requestBody: CreateMatchmakingRuleSetInput, headersHandler?: () => {[header: string]: string}): Promise<CreateMatchmakingRuleSetOutput> {
			return Axios.post<CreateMatchmakingRuleSetOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateMatchmakingRuleSet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreatePlayerSession(requestBody: CreatePlayerSessionInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePlayerSessionOutput> {
			return Axios.post<CreatePlayerSessionOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreatePlayerSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreatePlayerSessions(requestBody: CreatePlayerSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePlayerSessionsOutput> {
			return Axios.post<CreatePlayerSessionsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreatePlayerSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateScript(requestBody: CreateScriptInput, headersHandler?: () => {[header: string]: string}): Promise<CreateScriptOutput> {
			return Axios.post<CreateScriptOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateScript', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateVpcPeeringAuthorization(requestBody: CreateVpcPeeringAuthorizationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateVpcPeeringAuthorizationOutput> {
			return Axios.post<CreateVpcPeeringAuthorizationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateVpcPeeringAuthorization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateVpcPeeringConnection(requestBody: CreateVpcPeeringConnectionInput, headersHandler?: () => {[header: string]: string}): Promise<CreateVpcPeeringConnectionOutput> {
			return Axios.post<CreateVpcPeeringConnectionOutput>(this.baseUri + '/#X-Amz-Target=GameLift.CreateVpcPeeringConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlias(requestBody: DeleteAliasInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GameLift.DeleteAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBuild(requestBody: DeleteBuildInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GameLift.DeleteBuild', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteFleet(requestBody: DeleteFleetInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GameLift.DeleteFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DeleteGameServerGroup(requestBody: DeleteGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGameServerGroupOutput> {
			return Axios.post<DeleteGameServerGroupOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DeleteGameServerGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteGameSessionQueue(requestBody: DeleteGameSessionQueueInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGameSessionQueueOutput> {
			return Axios.post<DeleteGameSessionQueueOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DeleteGameSessionQueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteMatchmakingConfiguration(requestBody: DeleteMatchmakingConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteMatchmakingConfigurationOutput> {
			return Axios.post<DeleteMatchmakingConfigurationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DeleteMatchmakingConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteMatchmakingRuleSet(requestBody: DeleteMatchmakingRuleSetInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteMatchmakingRuleSetOutput> {
			return Axios.post<DeleteMatchmakingRuleSetOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DeleteMatchmakingRuleSet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteScalingPolicy(requestBody: DeleteScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GameLift.DeleteScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteScript(requestBody: DeleteScriptInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GameLift.DeleteScript', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DeleteVpcPeeringAuthorization(requestBody: DeleteVpcPeeringAuthorizationInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteVpcPeeringAuthorizationOutput> {
			return Axios.post<DeleteVpcPeeringAuthorizationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DeleteVpcPeeringAuthorization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteVpcPeeringConnection(requestBody: DeleteVpcPeeringConnectionInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteVpcPeeringConnectionOutput> {
			return Axios.post<DeleteVpcPeeringConnectionOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DeleteVpcPeeringConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterGameServer(requestBody: DeregisterGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GameLift.DeregisterGameServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeAlias(requestBody: DescribeAliasInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeAliasOutput> {
			return Axios.post<DescribeAliasOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeBuild(requestBody: DescribeBuildInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeBuildOutput> {
			return Axios.post<DescribeBuildOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeBuild', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEC2InstanceLimits(requestBody: DescribeEC2InstanceLimitsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeEC2InstanceLimitsOutput> {
			return Axios.post<DescribeEC2InstanceLimitsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeEC2InstanceLimits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeFleetAttributes(requestBody: DescribeFleetAttributesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetAttributesOutput> {
			return Axios.post<DescribeFleetAttributesOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeFleetCapacity(requestBody: DescribeFleetCapacityInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetCapacityOutput> {
			return Axios.post<DescribeFleetCapacityOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetCapacity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeFleetEvents(requestBody: DescribeFleetEventsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetEventsOutput> {
			return Axios.post<DescribeFleetEventsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeFleetPortSettings(requestBody: DescribeFleetPortSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetPortSettingsOutput> {
			return Axios.post<DescribeFleetPortSettingsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetPortSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeFleetUtilization(requestBody: DescribeFleetUtilizationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetUtilizationOutput> {
			return Axios.post<DescribeFleetUtilizationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetUtilization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGameServer(requestBody: DescribeGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameServerOutput> {
			return Axios.post<DescribeGameServerOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGameServerGroup(requestBody: DescribeGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameServerGroupOutput> {
			return Axios.post<DescribeGameServerGroupOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameServerGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGameSessionDetails(requestBody: DescribeGameSessionDetailsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionDetailsOutput> {
			return Axios.post<DescribeGameSessionDetailsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessionDetails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGameSessionPlacement(requestBody: DescribeGameSessionPlacementInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionPlacementOutput> {
			return Axios.post<DescribeGameSessionPlacementOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessionPlacement', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGameSessionQueues(requestBody: DescribeGameSessionQueuesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionQueuesOutput> {
			return Axios.post<DescribeGameSessionQueuesOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessionQueues', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGameSessions(requestBody: DescribeGameSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionsOutput> {
			return Axios.post<DescribeGameSessionsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeInstances(requestBody: DescribeInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancesOutput> {
			return Axios.post<DescribeInstancesOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeMatchmaking(requestBody: DescribeMatchmakingInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMatchmakingOutput> {
			return Axios.post<DescribeMatchmakingOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeMatchmaking', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeMatchmakingConfigurations(requestBody: DescribeMatchmakingConfigurationsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMatchmakingConfigurationsOutput> {
			return Axios.post<DescribeMatchmakingConfigurationsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeMatchmakingConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeMatchmakingRuleSets(requestBody: DescribeMatchmakingRuleSetsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMatchmakingRuleSetsOutput> {
			return Axios.post<DescribeMatchmakingRuleSetsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeMatchmakingRuleSets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribePlayerSessions(requestBody: DescribePlayerSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribePlayerSessionsOutput> {
			return Axios.post<DescribePlayerSessionsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribePlayerSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeRuntimeConfiguration(requestBody: DescribeRuntimeConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeRuntimeConfigurationOutput> {
			return Axios.post<DescribeRuntimeConfigurationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeRuntimeConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeScalingPolicies(requestBody: DescribeScalingPoliciesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingPoliciesOutput> {
			return Axios.post<DescribeScalingPoliciesOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeScalingPolicies', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeScript(requestBody: DescribeScriptInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeScriptOutput> {
			return Axios.post<DescribeScriptOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeScript', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeVpcPeeringAuthorizations(requestBody: DescribeVpcPeeringAuthorizationsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeVpcPeeringAuthorizationsOutput> {
			return Axios.post<DescribeVpcPeeringAuthorizationsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeVpcPeeringAuthorizations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeVpcPeeringConnections(requestBody: DescribeVpcPeeringConnectionsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeVpcPeeringConnectionsOutput> {
			return Axios.post<DescribeVpcPeeringConnectionsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.DescribeVpcPeeringConnections', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetGameSessionLogUrl(requestBody: GetGameSessionLogUrlInput, headersHandler?: () => {[header: string]: string}): Promise<GetGameSessionLogUrlOutput> {
			return Axios.post<GetGameSessionLogUrlOutput>(this.baseUri + '/#X-Amz-Target=GameLift.GetGameSessionLogUrl', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetInstanceAccess(requestBody: GetInstanceAccessInput, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceAccessOutput> {
			return Axios.post<GetInstanceAccessOutput>(this.baseUri + '/#X-Amz-Target=GameLift.GetInstanceAccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListAliases(requestBody: ListAliasesInput, headersHandler?: () => {[header: string]: string}): Promise<ListAliasesOutput> {
			return Axios.post<ListAliasesOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ListAliases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListBuilds(requestBody: ListBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<ListBuildsOutput> {
			return Axios.post<ListBuildsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ListBuilds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListFleets(requestBody: ListFleetsInput, headersHandler?: () => {[header: string]: string}): Promise<ListFleetsOutput> {
			return Axios.post<ListFleetsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ListFleets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListGameServerGroups(requestBody: ListGameServerGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListGameServerGroupsOutput> {
			return Axios.post<ListGameServerGroupsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ListGameServerGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListGameServers(requestBody: ListGameServersInput, headersHandler?: () => {[header: string]: string}): Promise<ListGameServersOutput> {
			return Axios.post<ListGameServersOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ListGameServers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListScripts(requestBody: ListScriptsInput, headersHandler?: () => {[header: string]: string}): Promise<ListScriptsOutput> {
			return Axios.post<ListScriptsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ListScripts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=GameLift.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutScalingPolicy(requestBody: PutScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutScalingPolicyOutput> {
			return Axios.post<PutScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=GameLift.PutScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RegisterGameServer(requestBody: RegisterGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<RegisterGameServerOutput> {
			return Axios.post<RegisterGameServerOutput>(this.baseUri + '/#X-Amz-Target=GameLift.RegisterGameServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RequestUploadCredentials(requestBody: RequestUploadCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<RequestUploadCredentialsOutput> {
			return Axios.post<RequestUploadCredentialsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.RequestUploadCredentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ResolveAlias(requestBody: ResolveAliasInput, headersHandler?: () => {[header: string]: string}): Promise<ResolveAliasOutput> {
			return Axios.post<ResolveAliasOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ResolveAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ResumeGameServerGroup(requestBody: ResumeGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<ResumeGameServerGroupOutput> {
			return Axios.post<ResumeGameServerGroupOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ResumeGameServerGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		SearchGameSessions(requestBody: SearchGameSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<SearchGameSessionsOutput> {
			return Axios.post<SearchGameSessionsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.SearchGameSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartFleetActions(requestBody: StartFleetActionsInput, headersHandler?: () => {[header: string]: string}): Promise<StartFleetActionsOutput> {
			return Axios.post<StartFleetActionsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.StartFleetActions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartGameSessionPlacement(requestBody: StartGameSessionPlacementInput, headersHandler?: () => {[header: string]: string}): Promise<StartGameSessionPlacementOutput> {
			return Axios.post<StartGameSessionPlacementOutput>(this.baseUri + '/#X-Amz-Target=GameLift.StartGameSessionPlacement', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartMatchBackfill(requestBody: StartMatchBackfillInput, headersHandler?: () => {[header: string]: string}): Promise<StartMatchBackfillOutput> {
			return Axios.post<StartMatchBackfillOutput>(this.baseUri + '/#X-Amz-Target=GameLift.StartMatchBackfill', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartMatchmaking(requestBody: StartMatchmakingInput, headersHandler?: () => {[header: string]: string}): Promise<StartMatchmakingOutput> {
			return Axios.post<StartMatchmakingOutput>(this.baseUri + '/#X-Amz-Target=GameLift.StartMatchmaking', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StopFleetActions(requestBody: StopFleetActionsInput, headersHandler?: () => {[header: string]: string}): Promise<StopFleetActionsOutput> {
			return Axios.post<StopFleetActionsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.StopFleetActions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StopGameSessionPlacement(requestBody: StopGameSessionPlacementInput, headersHandler?: () => {[header: string]: string}): Promise<StopGameSessionPlacementOutput> {
			return Axios.post<StopGameSessionPlacementOutput>(this.baseUri + '/#X-Amz-Target=GameLift.StopGameSessionPlacement', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StopMatchmaking(requestBody: StopMatchmakingInput, headersHandler?: () => {[header: string]: string}): Promise<StopMatchmakingOutput> {
			return Axios.post<StopMatchmakingOutput>(this.baseUri + '/#X-Amz-Target=GameLift.StopMatchmaking', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		SuspendGameServerGroup(requestBody: SuspendGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<SuspendGameServerGroupOutput> {
			return Axios.post<SuspendGameServerGroupOutput>(this.baseUri + '/#X-Amz-Target=GameLift.SuspendGameServerGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=GameLift.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=GameLift.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateAlias(requestBody: UpdateAliasInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateAliasOutput> {
			return Axios.post<UpdateAliasOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateBuild(requestBody: UpdateBuildInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateBuildOutput> {
			return Axios.post<UpdateBuildOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateBuild', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateFleetAttributes(requestBody: UpdateFleetAttributesInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetAttributesOutput> {
			return Axios.post<UpdateFleetAttributesOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateFleetAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateFleetCapacity(requestBody: UpdateFleetCapacityInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetCapacityOutput> {
			return Axios.post<UpdateFleetCapacityOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateFleetCapacity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateFleetPortSettings(requestBody: UpdateFleetPortSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetPortSettingsOutput> {
			return Axios.post<UpdateFleetPortSettingsOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateFleetPortSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateGameServer(requestBody: UpdateGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameServerOutput> {
			return Axios.post<UpdateGameServerOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateGameServerGroup(requestBody: UpdateGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameServerGroupOutput> {
			return Axios.post<UpdateGameServerGroupOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameServerGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateGameSession(requestBody: UpdateGameSessionInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameSessionOutput> {
			return Axios.post<UpdateGameSessionOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateGameSessionQueue(requestBody: UpdateGameSessionQueueInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameSessionQueueOutput> {
			return Axios.post<UpdateGameSessionQueueOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameSessionQueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateMatchmakingConfiguration(requestBody: UpdateMatchmakingConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateMatchmakingConfigurationOutput> {
			return Axios.post<UpdateMatchmakingConfigurationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateMatchmakingConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateRuntimeConfiguration(requestBody: UpdateRuntimeConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateRuntimeConfigurationOutput> {
			return Axios.post<UpdateRuntimeConfigurationOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateRuntimeConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateScript(requestBody: UpdateScriptInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateScriptOutput> {
			return Axios.post<UpdateScriptOutput>(this.baseUri + '/#X-Amz-Target=GameLift.UpdateScript', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ValidateMatchmakingRuleSet(requestBody: ValidateMatchmakingRuleSetInput, headersHandler?: () => {[header: string]: string}): Promise<ValidateMatchmakingRuleSetOutput> {
			return Axios.post<ValidateMatchmakingRuleSetOutput>(this.baseUri + '/#X-Amz-Target=GameLift.ValidateMatchmakingRuleSet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
