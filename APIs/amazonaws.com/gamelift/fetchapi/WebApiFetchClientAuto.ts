export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptMatch(requestBody: AcceptMatchInput, headersHandler?: () => {[header: string]: string}): Promise<AcceptMatchOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.AcceptMatch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ClaimGameServer(requestBody: ClaimGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<ClaimGameServerOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ClaimGameServer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAlias(requestBody: CreateAliasInput, headersHandler?: () => {[header: string]: string}): Promise<CreateAliasOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateBuild(requestBody: CreateBuildInput, headersHandler?: () => {[header: string]: string}): Promise<CreateBuildOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateBuild', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateFleet(requestBody: CreateFleetInput, headersHandler?: () => {[header: string]: string}): Promise<CreateFleetOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateFleet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateGameServerGroup(requestBody: CreateGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<CreateGameServerGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateGameServerGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateGameSession(requestBody: CreateGameSessionInput, headersHandler?: () => {[header: string]: string}): Promise<CreateGameSessionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateGameSession', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateGameSessionQueue(requestBody: CreateGameSessionQueueInput, headersHandler?: () => {[header: string]: string}): Promise<CreateGameSessionQueueOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateGameSessionQueue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateMatchmakingConfiguration(requestBody: CreateMatchmakingConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateMatchmakingConfigurationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateMatchmakingConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateMatchmakingRuleSet(requestBody: CreateMatchmakingRuleSetInput, headersHandler?: () => {[header: string]: string}): Promise<CreateMatchmakingRuleSetOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateMatchmakingRuleSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePlayerSession(requestBody: CreatePlayerSessionInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePlayerSessionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreatePlayerSession', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePlayerSessions(requestBody: CreatePlayerSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePlayerSessionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreatePlayerSessions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateScript(requestBody: CreateScriptInput, headersHandler?: () => {[header: string]: string}): Promise<CreateScriptOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateScript', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateVpcPeeringAuthorization(requestBody: CreateVpcPeeringAuthorizationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateVpcPeeringAuthorizationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateVpcPeeringAuthorization', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateVpcPeeringConnection(requestBody: CreateVpcPeeringConnectionInput, headersHandler?: () => {[header: string]: string}): Promise<CreateVpcPeeringConnectionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.CreateVpcPeeringConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlias(requestBody: DeleteAliasInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteBuild(requestBody: DeleteBuildInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteBuild', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteFleet(requestBody: DeleteFleetInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteFleet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteGameServerGroup(requestBody: DeleteGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGameServerGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteGameServerGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteGameSessionQueue(requestBody: DeleteGameSessionQueueInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGameSessionQueueOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteGameSessionQueue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteMatchmakingConfiguration(requestBody: DeleteMatchmakingConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteMatchmakingConfigurationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteMatchmakingConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteMatchmakingRuleSet(requestBody: DeleteMatchmakingRuleSetInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteMatchmakingRuleSetOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteMatchmakingRuleSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteScalingPolicy(requestBody: DeleteScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteScalingPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteScript(requestBody: DeleteScriptInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteScript', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteVpcPeeringAuthorization(requestBody: DeleteVpcPeeringAuthorizationInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteVpcPeeringAuthorizationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteVpcPeeringAuthorization', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteVpcPeeringConnection(requestBody: DeleteVpcPeeringConnectionInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteVpcPeeringConnectionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeleteVpcPeeringConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterGameServer(requestBody: DeregisterGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DeregisterGameServer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeAlias(requestBody: DescribeAliasInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeAliasOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeBuild(requestBody: DescribeBuildInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeBuildOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeBuild', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEC2InstanceLimits(requestBody: DescribeEC2InstanceLimitsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeEC2InstanceLimitsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeEC2InstanceLimits', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFleetAttributes(requestBody: DescribeFleetAttributesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetAttributesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFleetCapacity(requestBody: DescribeFleetCapacityInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetCapacityOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetCapacity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFleetEvents(requestBody: DescribeFleetEventsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetEventsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetEvents', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFleetPortSettings(requestBody: DescribeFleetPortSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetPortSettingsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetPortSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFleetUtilization(requestBody: DescribeFleetUtilizationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetUtilizationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeFleetUtilization', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeGameServer(requestBody: DescribeGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameServerOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameServer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeGameServerGroup(requestBody: DescribeGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameServerGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameServerGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeGameSessionDetails(requestBody: DescribeGameSessionDetailsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionDetailsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessionDetails', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeGameSessionPlacement(requestBody: DescribeGameSessionPlacementInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionPlacementOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessionPlacement', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeGameSessionQueues(requestBody: DescribeGameSessionQueuesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionQueuesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessionQueues', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeGameSessions(requestBody: DescribeGameSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGameSessionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeGameSessions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeInstances(requestBody: DescribeInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeInstances', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMatchmaking(requestBody: DescribeMatchmakingInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMatchmakingOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeMatchmaking', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMatchmakingConfigurations(requestBody: DescribeMatchmakingConfigurationsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMatchmakingConfigurationsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeMatchmakingConfigurations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMatchmakingRuleSets(requestBody: DescribeMatchmakingRuleSetsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMatchmakingRuleSetsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeMatchmakingRuleSets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribePlayerSessions(requestBody: DescribePlayerSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribePlayerSessionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribePlayerSessions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRuntimeConfiguration(requestBody: DescribeRuntimeConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeRuntimeConfigurationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeRuntimeConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeScalingPolicies(requestBody: DescribeScalingPoliciesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingPoliciesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeScalingPolicies', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeScript(requestBody: DescribeScriptInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeScriptOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeScript', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeVpcPeeringAuthorizations(requestBody: DescribeVpcPeeringAuthorizationsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeVpcPeeringAuthorizationsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeVpcPeeringAuthorizations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeVpcPeeringConnections(requestBody: DescribeVpcPeeringConnectionsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeVpcPeeringConnectionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.DescribeVpcPeeringConnections', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetGameSessionLogUrl(requestBody: GetGameSessionLogUrlInput, headersHandler?: () => {[header: string]: string}): Promise<GetGameSessionLogUrlOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.GetGameSessionLogUrl', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetInstanceAccess(requestBody: GetInstanceAccessInput, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceAccessOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.GetInstanceAccess', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListAliases(requestBody: ListAliasesInput, headersHandler?: () => {[header: string]: string}): Promise<ListAliasesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ListAliases', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBuilds(requestBody: ListBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<ListBuildsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ListBuilds', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListFleets(requestBody: ListFleetsInput, headersHandler?: () => {[header: string]: string}): Promise<ListFleetsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ListFleets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListGameServerGroups(requestBody: ListGameServerGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListGameServerGroupsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ListGameServerGroups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListGameServers(requestBody: ListGameServersInput, headersHandler?: () => {[header: string]: string}): Promise<ListGameServersOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ListGameServers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListScripts(requestBody: ListScriptsInput, headersHandler?: () => {[header: string]: string}): Promise<ListScriptsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ListScripts', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutScalingPolicy(requestBody: PutScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutScalingPolicyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.PutScalingPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterGameServer(requestBody: RegisterGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<RegisterGameServerOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.RegisterGameServer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RequestUploadCredentials(requestBody: RequestUploadCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<RequestUploadCredentialsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.RequestUploadCredentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ResolveAlias(requestBody: ResolveAliasInput, headersHandler?: () => {[header: string]: string}): Promise<ResolveAliasOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ResolveAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ResumeGameServerGroup(requestBody: ResumeGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<ResumeGameServerGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ResumeGameServerGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SearchGameSessions(requestBody: SearchGameSessionsInput, headersHandler?: () => {[header: string]: string}): Promise<SearchGameSessionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.SearchGameSessions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartFleetActions(requestBody: StartFleetActionsInput, headersHandler?: () => {[header: string]: string}): Promise<StartFleetActionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.StartFleetActions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartGameSessionPlacement(requestBody: StartGameSessionPlacementInput, headersHandler?: () => {[header: string]: string}): Promise<StartGameSessionPlacementOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.StartGameSessionPlacement', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartMatchBackfill(requestBody: StartMatchBackfillInput, headersHandler?: () => {[header: string]: string}): Promise<StartMatchBackfillOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.StartMatchBackfill', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartMatchmaking(requestBody: StartMatchmakingInput, headersHandler?: () => {[header: string]: string}): Promise<StartMatchmakingOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.StartMatchmaking', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopFleetActions(requestBody: StopFleetActionsInput, headersHandler?: () => {[header: string]: string}): Promise<StopFleetActionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.StopFleetActions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopGameSessionPlacement(requestBody: StopGameSessionPlacementInput, headersHandler?: () => {[header: string]: string}): Promise<StopGameSessionPlacementOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.StopGameSessionPlacement', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopMatchmaking(requestBody: StopMatchmakingInput, headersHandler?: () => {[header: string]: string}): Promise<StopMatchmakingOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.StopMatchmaking', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SuspendGameServerGroup(requestBody: SuspendGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<SuspendGameServerGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.SuspendGameServerGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateAlias(requestBody: UpdateAliasInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateAliasOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateBuild(requestBody: UpdateBuildInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateBuildOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateBuild', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateFleetAttributes(requestBody: UpdateFleetAttributesInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetAttributesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateFleetAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateFleetCapacity(requestBody: UpdateFleetCapacityInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetCapacityOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateFleetCapacity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateFleetPortSettings(requestBody: UpdateFleetPortSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetPortSettingsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateFleetPortSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateGameServer(requestBody: UpdateGameServerInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameServerOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameServer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateGameServerGroup(requestBody: UpdateGameServerGroupInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameServerGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameServerGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateGameSession(requestBody: UpdateGameSessionInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameSessionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameSession', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateGameSessionQueue(requestBody: UpdateGameSessionQueueInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGameSessionQueueOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateGameSessionQueue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateMatchmakingConfiguration(requestBody: UpdateMatchmakingConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateMatchmakingConfigurationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateMatchmakingConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateRuntimeConfiguration(requestBody: UpdateRuntimeConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateRuntimeConfigurationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateRuntimeConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateScript(requestBody: UpdateScriptInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateScriptOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.UpdateScript', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ValidateMatchmakingRuleSet(requestBody: ValidateMatchmakingRuleSetInput, headersHandler?: () => {[header: string]: string}): Promise<ValidateMatchmakingRuleSetOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=GameLift.ValidateMatchmakingRuleSet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
