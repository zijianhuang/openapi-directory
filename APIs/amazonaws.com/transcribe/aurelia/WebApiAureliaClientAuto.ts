...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateMedicalVocabulary(requestBody: CreateMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMedicalVocabularyResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.CreateMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateVocabulary(requestBody: CreateVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVocabularyResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.CreateVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateVocabularyFilter(requestBody: CreateVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVocabularyFilterResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.CreateVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMedicalTranscriptionJob(requestBody: DeleteMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Transcribe.DeleteMedicalTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteMedicalVocabulary(requestBody: DeleteMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Transcribe.DeleteMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteTranscriptionJob(requestBody: DeleteTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Transcribe.DeleteTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteVocabulary(requestBody: DeleteVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Transcribe.DeleteVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteVocabularyFilter(requestBody: DeleteVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Transcribe.DeleteVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetMedicalTranscriptionJob(requestBody: GetMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMedicalTranscriptionJobResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.GetMedicalTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMedicalVocabulary(requestBody: GetMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMedicalVocabularyResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.GetMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTranscriptionJob(requestBody: GetTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTranscriptionJobResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.GetTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetVocabulary(requestBody: GetVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVocabularyResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.GetVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetVocabularyFilter(requestBody: GetVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVocabularyFilterResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.GetVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartMedicalTranscriptionJob(requestBody: StartMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartMedicalTranscriptionJobResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.StartMedicalTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartTranscriptionJob(requestBody: StartTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTranscriptionJobResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.StartTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMedicalVocabulary(requestBody: UpdateMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMedicalVocabularyResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.UpdateMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateVocabulary(requestBody: UpdateVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVocabularyResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.UpdateVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateVocabularyFilter(requestBody: UpdateVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVocabularyFilterResponse> {
			return this.http.post('/#X-Amz-Target=Transcribe.UpdateVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
