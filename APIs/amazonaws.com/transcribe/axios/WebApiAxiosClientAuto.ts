...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateMedicalVocabulary(requestBody: CreateMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMedicalVocabularyResponse> {
			return Axios.post<CreateMedicalVocabularyResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.CreateMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateVocabulary(requestBody: CreateVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVocabularyResponse> {
			return Axios.post<CreateVocabularyResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.CreateVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateVocabularyFilter(requestBody: CreateVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVocabularyFilterResponse> {
			return Axios.post<CreateVocabularyFilterResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.CreateVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMedicalTranscriptionJob(requestBody: DeleteMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteMedicalTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMedicalVocabulary(requestBody: DeleteMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteTranscriptionJob(requestBody: DeleteTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteVocabulary(requestBody: DeleteVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteVocabularyFilter(requestBody: DeleteVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		GetMedicalTranscriptionJob(requestBody: GetMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMedicalTranscriptionJobResponse> {
			return Axios.post<GetMedicalTranscriptionJobResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.GetMedicalTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetMedicalVocabulary(requestBody: GetMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMedicalVocabularyResponse> {
			return Axios.post<GetMedicalVocabularyResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.GetMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetTranscriptionJob(requestBody: GetTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTranscriptionJobResponse> {
			return Axios.post<GetTranscriptionJobResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.GetTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetVocabulary(requestBody: GetVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVocabularyResponse> {
			return Axios.post<GetVocabularyResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.GetVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetVocabularyFilter(requestBody: GetVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVocabularyFilterResponse> {
			return Axios.post<GetVocabularyFilterResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.GetVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListMedicalTranscriptionJobs(MaxResults: string, NextToken: string, requestBody: ListMedicalTranscriptionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMedicalTranscriptionJobsResponse> {
			return Axios.post<ListMedicalTranscriptionJobsResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.ListMedicalTranscriptionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListMedicalVocabularies(MaxResults: string, NextToken: string, requestBody: ListMedicalVocabulariesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMedicalVocabulariesResponse> {
			return Axios.post<ListMedicalVocabulariesResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.ListMedicalVocabularies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTranscriptionJobs(MaxResults: string, NextToken: string, requestBody: ListTranscriptionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTranscriptionJobsResponse> {
			return Axios.post<ListTranscriptionJobsResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.ListTranscriptionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListVocabularies(MaxResults: string, NextToken: string, requestBody: ListVocabulariesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVocabulariesResponse> {
			return Axios.post<ListVocabulariesResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.ListVocabularies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListVocabularyFilters(MaxResults: string, NextToken: string, requestBody: ListVocabularyFiltersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVocabularyFiltersResponse> {
			return Axios.post<ListVocabularyFiltersResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.ListVocabularyFilters?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartMedicalTranscriptionJob(requestBody: StartMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartMedicalTranscriptionJobResponse> {
			return Axios.post<StartMedicalTranscriptionJobResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.StartMedicalTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartTranscriptionJob(requestBody: StartTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTranscriptionJobResponse> {
			return Axios.post<StartTranscriptionJobResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.StartTranscriptionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateMedicalVocabulary(requestBody: UpdateMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMedicalVocabularyResponse> {
			return Axios.post<UpdateMedicalVocabularyResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.UpdateMedicalVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateVocabulary(requestBody: UpdateVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVocabularyResponse> {
			return Axios.post<UpdateVocabularyResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.UpdateVocabulary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateVocabularyFilter(requestBody: UpdateVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVocabularyFilterResponse> {
			return Axios.post<UpdateVocabularyFilterResponse>(this.baseUri + '/#X-Amz-Target=Transcribe.UpdateVocabularyFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
