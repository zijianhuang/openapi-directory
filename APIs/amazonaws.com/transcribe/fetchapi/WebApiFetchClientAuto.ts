export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateMedicalVocabulary(requestBody: CreateMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMedicalVocabularyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.CreateMedicalVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateVocabulary(requestBody: CreateVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVocabularyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.CreateVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateVocabularyFilter(requestBody: CreateVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVocabularyFilterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.CreateVocabularyFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMedicalTranscriptionJob(requestBody: DeleteMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteMedicalTranscriptionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMedicalVocabulary(requestBody: DeleteMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteMedicalVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteTranscriptionJob(requestBody: DeleteTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteTranscriptionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteVocabulary(requestBody: DeleteVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteVocabularyFilter(requestBody: DeleteVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.DeleteVocabularyFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetMedicalTranscriptionJob(requestBody: GetMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMedicalTranscriptionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.GetMedicalTranscriptionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetMedicalVocabulary(requestBody: GetMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMedicalVocabularyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.GetMedicalVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetTranscriptionJob(requestBody: GetTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTranscriptionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.GetTranscriptionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetVocabulary(requestBody: GetVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVocabularyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.GetVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetVocabularyFilter(requestBody: GetVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVocabularyFilterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.GetVocabularyFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTranscriptionJobs(MaxResults: string, NextToken: string, requestBody: ListTranscriptionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTranscriptionJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.ListTranscriptionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListVocabularies(MaxResults: string, NextToken: string, requestBody: ListVocabulariesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVocabulariesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.ListVocabularies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartMedicalTranscriptionJob(requestBody: StartMedicalTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartMedicalTranscriptionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.StartMedicalTranscriptionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartTranscriptionJob(requestBody: StartTranscriptionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTranscriptionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.StartTranscriptionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateMedicalVocabulary(requestBody: UpdateMedicalVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMedicalVocabularyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.UpdateMedicalVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateVocabulary(requestBody: UpdateVocabularyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVocabularyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.UpdateVocabulary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateVocabularyFilter(requestBody: UpdateVocabularyFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVocabularyFilterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Transcribe.UpdateVocabularyFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
