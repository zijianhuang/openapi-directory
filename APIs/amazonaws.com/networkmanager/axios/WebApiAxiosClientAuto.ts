...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateCustomerGateway(globalNetworkId: string, requestBody: AssociateCustomerGatewayBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateCustomerGatewayResponse> {
			return Axios.post<AssociateCustomerGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/customer-gateway-associations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateLink(globalNetworkId: string, requestBody: AssociateLinkBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateLinkResponse> {
			return Axios.post<AssociateLinkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/link-associations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateGlobalNetwork(requestBody: CreateGlobalNetworkBody, headersHandler?: () => {[header: string]: string}): Promise<CreateGlobalNetworkResponse> {
			return Axios.post<CreateGlobalNetworkResponse>(this.baseUri + '/global-networks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateLink(globalNetworkId: string, requestBody: CreateLinkBody, headersHandler?: () => {[header: string]: string}): Promise<CreateLinkResponse> {
			return Axios.post<CreateLinkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/links', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSite(globalNetworkId: string, requestBody: CreateSiteBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSiteResponse> {
			return Axios.post<CreateSiteResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/sites', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDevice(globalNetworkId: string, deviceId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDeviceResponse> {
			return Axios.delete<DeleteDeviceResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/devices/' + (deviceId == null ? '' : encodeURIComponent(deviceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteGlobalNetwork(globalNetworkId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGlobalNetworkResponse> {
			return Axios.delete<DeleteGlobalNetworkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteLink(globalNetworkId: string, linkId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteLinkResponse> {
			return Axios.delete<DeleteLinkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/links/' + (linkId == null ? '' : encodeURIComponent(linkId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteSite(globalNetworkId: string, siteId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteSiteResponse> {
			return Axios.delete<DeleteSiteResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/sites/' + (siteId == null ? '' : encodeURIComponent(siteId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeregisterTransitGateway(globalNetworkId: string, transitGatewayArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeregisterTransitGatewayResponse> {
			return Axios.delete<DeregisterTransitGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/transit-gateway-registrations/' + (transitGatewayArn == null ? '' : encodeURIComponent(transitGatewayArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DisassociateCustomerGateway(globalNetworkId: string, customerGatewayArn: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateCustomerGatewayResponse> {
			return Axios.delete<DisassociateCustomerGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/customer-gateway-associations/' + (customerGatewayArn == null ? '' : encodeURIComponent(customerGatewayArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RegisterTransitGateway(globalNetworkId: string, requestBody: RegisterTransitGatewayBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterTransitGatewayResponse> {
			return Axios.post<RegisterTransitGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/transit-gateway-registrations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
