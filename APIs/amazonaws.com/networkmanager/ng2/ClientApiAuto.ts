...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateCustomerGateway(globalNetworkId: string, requestBody: AssociateCustomerGatewayBody, headersHandler?: () => HttpHeaders): Observable<AssociateCustomerGatewayResponse> {
			return this.http.post<AssociateCustomerGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/customer-gateway-associations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetCustomerGatewayAssociations(globalNetworkId: string, customerGatewayArns: Array<String>, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<GetCustomerGatewayAssociationsResponse> {
			return this.http.get<GetCustomerGatewayAssociationsResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/customer-gateway-associations&' + customerGatewayArns.map(z => `customerGatewayArns=${z}`).join('&') + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		AssociateLink(globalNetworkId: string, requestBody: AssociateLinkBody, headersHandler?: () => HttpHeaders): Observable<AssociateLinkResponse> {
			return this.http.post<AssociateLinkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/link-associations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetLinkAssociations(globalNetworkId: string, deviceId: string, linkId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<GetLinkAssociationsResponse> {
			return this.http.get<GetLinkAssociationsResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/link-associations&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&linkId=' + (linkId == null ? '' : encodeURIComponent(linkId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateDevice(globalNetworkId: string, requestBody: CreateDeviceBody, headersHandler?: () => HttpHeaders): Observable<CreateDeviceResponse> {
			return this.http.post<CreateDeviceResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/devices', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDevices(globalNetworkId: string, deviceIds: Array<String>, siteId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<GetDevicesResponse> {
		 ...
		 */
		CreateGlobalNetwork(requestBody: CreateGlobalNetworkBody, headersHandler?: () => HttpHeaders): Observable<CreateGlobalNetworkResponse> {
			return this.http.post<CreateGlobalNetworkResponse>(this.baseUri + '/global-networks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeGlobalNetworks(globalNetworkIds: Array<String>, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<DescribeGlobalNetworksResponse> {
			return this.http.get<DescribeGlobalNetworksResponse>(this.baseUri + '/global-networks?' + globalNetworkIds.map(z => `globalNetworkIds=${z}`).join('&') + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateLink(globalNetworkId: string, requestBody: CreateLinkBody, headersHandler?: () => HttpHeaders): Observable<CreateLinkResponse> {
			return this.http.post<CreateLinkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/links', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetLinks(globalNetworkId: string, linkIds: Array<String>, siteId: string, type: string, provider: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<GetLinksResponse> {
			return this.http.get<GetLinksResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/links&' + linkIds.map(z => `linkIds=${z}`).join('&') + '&siteId=' + (siteId == null ? '' : encodeURIComponent(siteId)) + '&type=' + (type == null ? '' : encodeURIComponent(type)) + '&provider=' + (provider == null ? '' : encodeURIComponent(provider)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateSite(globalNetworkId: string, requestBody: CreateSiteBody, headersHandler?: () => HttpHeaders): Observable<CreateSiteResponse> {
			return this.http.post<CreateSiteResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/sites', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSites(globalNetworkId: string, siteIds: Array<String>, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<GetSitesResponse> {
			return this.http.get<GetSitesResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/sites&' + siteIds.map(z => `siteIds=${z}`).join('&') + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteDevice(globalNetworkId: string, deviceId: string, headersHandler?: () => HttpHeaders): Observable<DeleteDeviceResponse> {
			return this.http.delete<DeleteDeviceResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/devices/' + (deviceId == null ? '' : encodeURIComponent(deviceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteGlobalNetwork(globalNetworkId: string, headersHandler?: () => HttpHeaders): Observable<DeleteGlobalNetworkResponse> {
			return this.http.delete<DeleteGlobalNetworkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteLink(globalNetworkId: string, linkId: string, headersHandler?: () => HttpHeaders): Observable<DeleteLinkResponse> {
			return this.http.delete<DeleteLinkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/links/' + (linkId == null ? '' : encodeURIComponent(linkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteSite(globalNetworkId: string, siteId: string, headersHandler?: () => HttpHeaders): Observable<DeleteSiteResponse> {
			return this.http.delete<DeleteSiteResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/sites/' + (siteId == null ? '' : encodeURIComponent(siteId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeregisterTransitGateway(globalNetworkId: string, transitGatewayArn: string, headersHandler?: () => HttpHeaders): Observable<DeregisterTransitGatewayResponse> {
			return this.http.delete<DeregisterTransitGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/transit-gateway-registrations/' + (transitGatewayArn == null ? '' : encodeURIComponent(transitGatewayArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DisassociateCustomerGateway(globalNetworkId: string, customerGatewayArn: string, headersHandler?: () => HttpHeaders): Observable<DisassociateCustomerGatewayResponse> {
			return this.http.delete<DisassociateCustomerGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/customer-gateway-associations/' + (customerGatewayArn == null ? '' : encodeURIComponent(customerGatewayArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DisassociateLink(globalNetworkId: string, deviceId: string, linkId: string, headersHandler?: () => HttpHeaders): Observable<DisassociateLinkResponse> {
			return this.http.delete<DisassociateLinkResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/link-associations#deviceId&linkId&deviceId=' + (deviceId == null ? '' : encodeURIComponent(deviceId)) + '&linkId=' + (linkId == null ? '' : encodeURIComponent(linkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetTransitGatewayRegistrations(globalNetworkId: string, transitGatewayArns: Array<String>, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<GetTransitGatewayRegistrationsResponse> {
		 ...
		 */
		RegisterTransitGateway(globalNetworkId: string, requestBody: RegisterTransitGatewayBody, headersHandler?: () => HttpHeaders): Observable<RegisterTransitGatewayResponse> {
			return this.http.post<RegisterTransitGatewayResponse>(this.baseUri + '/global-networks/' + (globalNetworkId == null ? '' : encodeURIComponent(globalNetworkId)) + '/transit-gateway-registrations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
