...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		QueryForecast(requestBody: QueryForecastRequest, headersHandler?: () => HttpHeaders): Observable<QueryForecastResponse> {
			return this.http.post<QueryForecastResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecastRuntime.QueryForecast', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
