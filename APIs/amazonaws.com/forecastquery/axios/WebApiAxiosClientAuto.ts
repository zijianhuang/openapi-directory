...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		QueryForecast(requestBody: QueryForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<QueryForecastResponse> {
			return Axios.post<QueryForecastResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecastRuntime.QueryForecast', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
