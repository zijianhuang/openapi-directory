...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptSharedDirectory(requestBody: AcceptSharedDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptSharedDirectoryResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.AcceptSharedDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddIpRoutes(requestBody: AddIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<AddIpRoutesResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.AddIpRoutes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddTagsToResource(requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelSchemaExtension(requestBody: CancelSchemaExtensionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelSchemaExtensionResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CancelSchemaExtension', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ConnectDirectory(requestBody: ConnectDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ConnectDirectoryResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ConnectDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAliasResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateComputer(requestBody: CreateComputerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateComputerResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateComputer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateConditionalForwarder(requestBody: CreateConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateConditionalForwarderResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateConditionalForwarder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDirectory(requestBody: CreateDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectoryResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLogSubscription(requestBody: CreateLogSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLogSubscriptionResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateLogSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateMicrosoftAD(requestBody: CreateMicrosoftADRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMicrosoftADResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateMicrosoftAD', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSnapshot(requestBody: CreateSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSnapshotResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTrust(requestBody: CreateTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrustResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.CreateTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteConditionalForwarder(requestBody: DeleteConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteConditionalForwarderResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DeleteConditionalForwarder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDirectory(requestBody: DeleteDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectoryResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DeleteDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLogSubscription(requestBody: DeleteLogSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLogSubscriptionResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DeleteLogSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSnapshot(requestBody: DeleteSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSnapshotResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DeleteSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTrust(requestBody: DeleteTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrustResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DeleteTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterCertificate(requestBody: DeregisterCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterCertificateResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DeregisterCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterEventTopic(requestBody: DeregisterEventTopicRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterEventTopicResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DeregisterEventTopic', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCertificate(requestBody: DescribeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConditionalForwarders(requestBody: DescribeConditionalForwardersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConditionalForwardersResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeConditionalForwarders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDirectories(requestBody: DescribeDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectoriesResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeDirectories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDomainControllers(Limit: string, NextToken: string, requestBody: DescribeDomainControllersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainControllersResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeDomainControllers?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeEventTopics(requestBody: DescribeEventTopicsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventTopicsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeEventTopics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLDAPSSettings(requestBody: DescribeLDAPSSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLDAPSSettingsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeLDAPSSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSharedDirectories(requestBody: DescribeSharedDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSharedDirectoriesResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeSharedDirectories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSnapshots(requestBody: DescribeSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSnapshotsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTrusts(requestBody: DescribeTrustsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrustsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DescribeTrusts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableLDAPS(requestBody: DisableLDAPSRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableLDAPSResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DisableLDAPS', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableRadius(requestBody: DisableRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableRadiusResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DisableRadius', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableSso(requestBody: DisableSsoRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableSsoResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.DisableSso', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableLDAPS(requestBody: EnableLDAPSRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableLDAPSResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.EnableLDAPS', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableRadius(requestBody: EnableRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableRadiusResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.EnableRadius', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableSso(requestBody: EnableSsoRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableSsoResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.EnableSso', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDirectoryLimits(requestBody: GetDirectoryLimitsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDirectoryLimitsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.GetDirectoryLimits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSnapshotLimits(requestBody: GetSnapshotLimitsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSnapshotLimitsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.GetSnapshotLimits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListCertificates(requestBody: ListCertificatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ListCertificates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListIpRoutes(requestBody: ListIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListIpRoutesResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ListIpRoutes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListLogSubscriptions(requestBody: ListLogSubscriptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLogSubscriptionsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ListLogSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListSchemaExtensions(requestBody: ListSchemaExtensionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSchemaExtensionsResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ListSchemaExtensions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterCertificate(requestBody: RegisterCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterCertificateResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.RegisterCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterEventTopic(requestBody: RegisterEventTopicRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterEventTopicResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.RegisterEventTopic', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RejectSharedDirectory(requestBody: RejectSharedDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectSharedDirectoryResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.RejectSharedDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveIpRoutes(requestBody: RemoveIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveIpRoutesResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.RemoveIpRoutes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResetUserPassword(requestBody: ResetUserPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetUserPasswordResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ResetUserPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RestoreFromSnapshot(requestBody: RestoreFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreFromSnapshotResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.RestoreFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ShareDirectory(requestBody: ShareDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ShareDirectoryResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.ShareDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartSchemaExtension(requestBody: StartSchemaExtensionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSchemaExtensionResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.StartSchemaExtension', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UnshareDirectory(requestBody: UnshareDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<UnshareDirectoryResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.UnshareDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateConditionalForwarder(requestBody: UpdateConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateConditionalForwarderResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.UpdateConditionalForwarder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNumberOfDomainControllers(requestBody: UpdateNumberOfDomainControllersRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNumberOfDomainControllersResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.UpdateNumberOfDomainControllers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateRadius(requestBody: UpdateRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRadiusResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.UpdateRadius', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTrust(requestBody: UpdateTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrustResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.UpdateTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		VerifyTrust(requestBody: VerifyTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifyTrustResult> {
			return this.http.post('/#X-Amz-Target=DirectoryService_20150416.VerifyTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
