export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptSharedDirectory(requestBody: AcceptSharedDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptSharedDirectoryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.AcceptSharedDirectory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AddIpRoutes(requestBody: AddIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<AddIpRoutesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.AddIpRoutes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AddTagsToResource(requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.AddTagsToResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CancelSchemaExtension(requestBody: CancelSchemaExtensionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelSchemaExtensionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CancelSchemaExtension', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ConnectDirectory(requestBody: ConnectDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ConnectDirectoryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ConnectDirectory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAliasResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateComputer(requestBody: CreateComputerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateComputerResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateComputer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateConditionalForwarder(requestBody: CreateConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateConditionalForwarderResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateConditionalForwarder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateDirectory(requestBody: CreateDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectoryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateDirectory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateLogSubscription(requestBody: CreateLogSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLogSubscriptionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateLogSubscription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateMicrosoftAD(requestBody: CreateMicrosoftADRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMicrosoftADResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateMicrosoftAD', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateSnapshot(requestBody: CreateSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSnapshotResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateSnapshot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateTrust(requestBody: CreateTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrustResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateTrust', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteConditionalForwarder(requestBody: DeleteConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteConditionalForwarderResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteConditionalForwarder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteDirectory(requestBody: DeleteDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectoryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteDirectory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteLogSubscription(requestBody: DeleteLogSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLogSubscriptionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteLogSubscription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteSnapshot(requestBody: DeleteSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSnapshotResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteSnapshot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteTrust(requestBody: DeleteTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrustResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteTrust', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeregisterCertificate(requestBody: DeregisterCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterCertificateResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeregisterCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeregisterEventTopic(requestBody: DeregisterEventTopicRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterEventTopicResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeregisterEventTopic', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeCertificate(requestBody: DescribeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeConditionalForwarders(requestBody: DescribeConditionalForwardersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConditionalForwardersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeConditionalForwarders', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeDirectories(requestBody: DescribeDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectoriesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeDirectories', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeDomainControllers(Limit: string, NextToken: string, requestBody: DescribeDomainControllersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainControllersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeDomainControllers?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeEventTopics(requestBody: DescribeEventTopicsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventTopicsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeEventTopics', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeLDAPSSettings(requestBody: DescribeLDAPSSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLDAPSSettingsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeLDAPSSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeSharedDirectories(requestBody: DescribeSharedDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSharedDirectoriesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeSharedDirectories', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeSnapshots(requestBody: DescribeSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSnapshotsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeSnapshots', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeTrusts(requestBody: DescribeTrustsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrustsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeTrusts', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DisableLDAPS(requestBody: DisableLDAPSRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableLDAPSResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DisableLDAPS', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DisableRadius(requestBody: DisableRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableRadiusResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DisableRadius', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DisableSso(requestBody: DisableSsoRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableSsoResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DisableSso', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		EnableLDAPS(requestBody: EnableLDAPSRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableLDAPSResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.EnableLDAPS', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		EnableRadius(requestBody: EnableRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableRadiusResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.EnableRadius', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		EnableSso(requestBody: EnableSsoRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableSsoResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.EnableSso', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetDirectoryLimits(requestBody: GetDirectoryLimitsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDirectoryLimitsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.GetDirectoryLimits', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetSnapshotLimits(requestBody: GetSnapshotLimitsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSnapshotLimitsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.GetSnapshotLimits', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListCertificates(requestBody: ListCertificatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListCertificates', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListIpRoutes(requestBody: ListIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListIpRoutesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListIpRoutes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListLogSubscriptions(requestBody: ListLogSubscriptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLogSubscriptionsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListLogSubscriptions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListSchemaExtensions(requestBody: ListSchemaExtensionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSchemaExtensionsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListSchemaExtensions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RegisterCertificate(requestBody: RegisterCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterCertificateResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RegisterCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RegisterEventTopic(requestBody: RegisterEventTopicRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterEventTopicResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RegisterEventTopic', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RejectSharedDirectory(requestBody: RejectSharedDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectSharedDirectoryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RejectSharedDirectory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RemoveIpRoutes(requestBody: RemoveIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveIpRoutesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RemoveIpRoutes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RemoveTagsFromResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ResetUserPassword(requestBody: ResetUserPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetUserPasswordResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ResetUserPassword', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RestoreFromSnapshot(requestBody: RestoreFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreFromSnapshotResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RestoreFromSnapshot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ShareDirectory(requestBody: ShareDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ShareDirectoryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ShareDirectory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StartSchemaExtension(requestBody: StartSchemaExtensionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSchemaExtensionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.StartSchemaExtension', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UnshareDirectory(requestBody: UnshareDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<UnshareDirectoryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UnshareDirectory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateConditionalForwarder(requestBody: UpdateConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateConditionalForwarderResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateConditionalForwarder', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateNumberOfDomainControllers(requestBody: UpdateNumberOfDomainControllersRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNumberOfDomainControllersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateNumberOfDomainControllers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateRadius(requestBody: UpdateRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRadiusResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateRadius', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateTrust(requestBody: UpdateTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrustResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateTrust', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		VerifyTrust(requestBody: VerifyTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifyTrustResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.VerifyTrust', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
