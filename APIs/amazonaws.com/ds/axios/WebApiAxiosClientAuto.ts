...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptSharedDirectory(requestBody: AcceptSharedDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptSharedDirectoryResult> {
			return Axios.post<AcceptSharedDirectoryResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.AcceptSharedDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddIpRoutes(requestBody: AddIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<AddIpRoutesResult> {
			return Axios.post<AddIpRoutesResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.AddIpRoutes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddTagsToResource(requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResult> {
			return Axios.post<AddTagsToResourceResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelSchemaExtension(requestBody: CancelSchemaExtensionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelSchemaExtensionResult> {
			return Axios.post<CancelSchemaExtensionResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CancelSchemaExtension', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConnectDirectory(requestBody: ConnectDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ConnectDirectoryResult> {
			return Axios.post<ConnectDirectoryResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ConnectDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAliasResult> {
			return Axios.post<CreateAliasResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateComputer(requestBody: CreateComputerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateComputerResult> {
			return Axios.post<CreateComputerResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateComputer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateConditionalForwarder(requestBody: CreateConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateConditionalForwarderResult> {
			return Axios.post<CreateConditionalForwarderResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateConditionalForwarder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDirectory(requestBody: CreateDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectoryResult> {
			return Axios.post<CreateDirectoryResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateLogSubscription(requestBody: CreateLogSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLogSubscriptionResult> {
			return Axios.post<CreateLogSubscriptionResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateLogSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateMicrosoftAD(requestBody: CreateMicrosoftADRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMicrosoftADResult> {
			return Axios.post<CreateMicrosoftADResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateMicrosoftAD', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSnapshot(requestBody: CreateSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSnapshotResult> {
			return Axios.post<CreateSnapshotResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTrust(requestBody: CreateTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrustResult> {
			return Axios.post<CreateTrustResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.CreateTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteConditionalForwarder(requestBody: DeleteConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteConditionalForwarderResult> {
			return Axios.post<DeleteConditionalForwarderResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteConditionalForwarder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDirectory(requestBody: DeleteDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectoryResult> {
			return Axios.post<DeleteDirectoryResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteLogSubscription(requestBody: DeleteLogSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLogSubscriptionResult> {
			return Axios.post<DeleteLogSubscriptionResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteLogSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSnapshot(requestBody: DeleteSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSnapshotResult> {
			return Axios.post<DeleteSnapshotResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTrust(requestBody: DeleteTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrustResult> {
			return Axios.post<DeleteTrustResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeleteTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeregisterCertificate(requestBody: DeregisterCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterCertificateResult> {
			return Axios.post<DeregisterCertificateResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeregisterCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeregisterEventTopic(requestBody: DeregisterEventTopicRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterEventTopicResult> {
			return Axios.post<DeregisterEventTopicResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DeregisterEventTopic', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeCertificate(requestBody: DescribeCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResult> {
			return Axios.post<DescribeCertificateResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeConditionalForwarders(requestBody: DescribeConditionalForwardersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConditionalForwardersResult> {
			return Axios.post<DescribeConditionalForwardersResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeConditionalForwarders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDirectories(requestBody: DescribeDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectoriesResult> {
			return Axios.post<DescribeDirectoriesResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeDirectories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDomainControllers(Limit: string, NextToken: string, requestBody: DescribeDomainControllersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainControllersResult> {
			return Axios.post<DescribeDomainControllersResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeDomainControllers?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEventTopics(requestBody: DescribeEventTopicsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventTopicsResult> {
			return Axios.post<DescribeEventTopicsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeEventTopics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeLDAPSSettings(requestBody: DescribeLDAPSSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLDAPSSettingsResult> {
			return Axios.post<DescribeLDAPSSettingsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeLDAPSSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSharedDirectories(requestBody: DescribeSharedDirectoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSharedDirectoriesResult> {
			return Axios.post<DescribeSharedDirectoriesResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeSharedDirectories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSnapshots(requestBody: DescribeSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSnapshotsResult> {
			return Axios.post<DescribeSnapshotsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeTrusts(requestBody: DescribeTrustsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrustsResult> {
			return Axios.post<DescribeTrustsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DescribeTrusts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableLDAPS(requestBody: DisableLDAPSRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableLDAPSResult> {
			return Axios.post<DisableLDAPSResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DisableLDAPS', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableRadius(requestBody: DisableRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableRadiusResult> {
			return Axios.post<DisableRadiusResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DisableRadius', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableSso(requestBody: DisableSsoRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableSsoResult> {
			return Axios.post<DisableSsoResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.DisableSso', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableLDAPS(requestBody: EnableLDAPSRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableLDAPSResult> {
			return Axios.post<EnableLDAPSResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.EnableLDAPS', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableRadius(requestBody: EnableRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableRadiusResult> {
			return Axios.post<EnableRadiusResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.EnableRadius', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableSso(requestBody: EnableSsoRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableSsoResult> {
			return Axios.post<EnableSsoResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.EnableSso', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDirectoryLimits(requestBody: GetDirectoryLimitsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDirectoryLimitsResult> {
			return Axios.post<GetDirectoryLimitsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.GetDirectoryLimits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSnapshotLimits(requestBody: GetSnapshotLimitsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSnapshotLimitsResult> {
			return Axios.post<GetSnapshotLimitsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.GetSnapshotLimits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCertificates(requestBody: ListCertificatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesResult> {
			return Axios.post<ListCertificatesResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListCertificates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListIpRoutes(requestBody: ListIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListIpRoutesResult> {
			return Axios.post<ListIpRoutesResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListIpRoutes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListLogSubscriptions(requestBody: ListLogSubscriptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLogSubscriptionsResult> {
			return Axios.post<ListLogSubscriptionsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListLogSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSchemaExtensions(requestBody: ListSchemaExtensionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSchemaExtensionsResult> {
			return Axios.post<ListSchemaExtensionsResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListSchemaExtensions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return Axios.post<ListTagsForResourceResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterCertificate(requestBody: RegisterCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterCertificateResult> {
			return Axios.post<RegisterCertificateResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RegisterCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterEventTopic(requestBody: RegisterEventTopicRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterEventTopicResult> {
			return Axios.post<RegisterEventTopicResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RegisterEventTopic', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RejectSharedDirectory(requestBody: RejectSharedDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectSharedDirectoryResult> {
			return Axios.post<RejectSharedDirectoryResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RejectSharedDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveIpRoutes(requestBody: RemoveIpRoutesRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveIpRoutesResult> {
			return Axios.post<RemoveIpRoutesResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RemoveIpRoutes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResult> {
			return Axios.post<RemoveTagsFromResourceResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ResetUserPassword(requestBody: ResetUserPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetUserPasswordResult> {
			return Axios.post<ResetUserPasswordResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ResetUserPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RestoreFromSnapshot(requestBody: RestoreFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreFromSnapshotResult> {
			return Axios.post<RestoreFromSnapshotResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.RestoreFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ShareDirectory(requestBody: ShareDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ShareDirectoryResult> {
			return Axios.post<ShareDirectoryResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.ShareDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartSchemaExtension(requestBody: StartSchemaExtensionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSchemaExtensionResult> {
			return Axios.post<StartSchemaExtensionResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.StartSchemaExtension', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UnshareDirectory(requestBody: UnshareDirectoryRequest, headersHandler?: () => {[header: string]: string}): Promise<UnshareDirectoryResult> {
			return Axios.post<UnshareDirectoryResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UnshareDirectory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateConditionalForwarder(requestBody: UpdateConditionalForwarderRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateConditionalForwarderResult> {
			return Axios.post<UpdateConditionalForwarderResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateConditionalForwarder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateNumberOfDomainControllers(requestBody: UpdateNumberOfDomainControllersRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNumberOfDomainControllersResult> {
			return Axios.post<UpdateNumberOfDomainControllersResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateNumberOfDomainControllers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRadius(requestBody: UpdateRadiusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRadiusResult> {
			return Axios.post<UpdateRadiusResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateRadius', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateTrust(requestBody: UpdateTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrustResult> {
			return Axios.post<UpdateTrustResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.UpdateTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		VerifyTrust(requestBody: VerifyTrustRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifyTrustResult> {
			return Axios.post<VerifyTrustResult>(this.baseUri + '/#X-Amz-Target=DirectoryService_20150416.VerifyTrust', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
