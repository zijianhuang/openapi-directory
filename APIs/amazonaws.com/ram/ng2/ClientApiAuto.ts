...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptResourceShareInvitation(requestBody: AcceptResourceShareInvitationBody, headersHandler?: () => HttpHeaders): Observable<AcceptResourceShareInvitationResponse> {
			return this.http.post<AcceptResourceShareInvitationResponse>(this.baseUri + '/acceptresourceshareinvitation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssociateResourceShare(requestBody: AssociateResourceShareBody, headersHandler?: () => HttpHeaders): Observable<AssociateResourceShareResponse> {
			return this.http.post<AssociateResourceShareResponse>(this.baseUri + '/associateresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssociateResourceSharePermission(requestBody: AssociateResourceSharePermissionBody, headersHandler?: () => HttpHeaders): Observable<AssociateResourceSharePermissionResponse> {
			return this.http.post<AssociateResourceSharePermissionResponse>(this.baseUri + '/associateresourcesharepermission', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateResourceShare(requestBody: CreateResourceShareBody, headersHandler?: () => HttpHeaders): Observable<CreateResourceShareResponse> {
			return this.http.post<CreateResourceShareResponse>(this.baseUri + '/createresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteResourceShare(resourceShareArn: string, clientToken: string, headersHandler?: () => HttpHeaders): Observable<DeleteResourceShareResponse> {
			return this.http.delete<DeleteResourceShareResponse>(this.baseUri + '/deleteresourceshare#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DisassociateResourceShare(requestBody: DisassociateResourceShareBody, headersHandler?: () => HttpHeaders): Observable<DisassociateResourceShareResponse> {
			return this.http.post<DisassociateResourceShareResponse>(this.baseUri + '/disassociateresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateResourceSharePermission(requestBody: DisassociateResourceSharePermissionBody, headersHandler?: () => HttpHeaders): Observable<DisassociateResourceSharePermissionResponse> {
			return this.http.post<DisassociateResourceSharePermissionResponse>(this.baseUri + '/disassociateresourcesharepermission', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		EnableSharingWithAwsOrganization(headersHandler?: () => HttpHeaders): Observable<EnableSharingWithAwsOrganizationResponse> {
			return this.http.post<EnableSharingWithAwsOrganizationResponse>(this.baseUri + '/enablesharingwithawsorganization', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetPermission(requestBody: GetPermissionBody, headersHandler?: () => HttpHeaders): Observable<GetPermissionResponse> {
			return this.http.post<GetPermissionResponse>(this.baseUri + '/getpermission', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResourcePolicies(maxResults: string, nextToken: string, requestBody: GetResourcePoliciesBody, headersHandler?: () => HttpHeaders): Observable<GetResourcePoliciesResponse> {
			return this.http.post<GetResourcePoliciesResponse>(this.baseUri + '/getresourcepolicies?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResourceShareAssociations(maxResults: string, nextToken: string, requestBody: GetResourceShareAssociationsBody, headersHandler?: () => HttpHeaders): Observable<GetResourceShareAssociationsResponse> {
			return this.http.post<GetResourceShareAssociationsResponse>(this.baseUri + '/getresourceshareassociations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResourceShareInvitations(maxResults: string, nextToken: string, requestBody: GetResourceShareInvitationsBody, headersHandler?: () => HttpHeaders): Observable<GetResourceShareInvitationsResponse> {
			return this.http.post<GetResourceShareInvitationsResponse>(this.baseUri + '/getresourceshareinvitations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResourceShares(maxResults: string, nextToken: string, requestBody: GetResourceSharesBody, headersHandler?: () => HttpHeaders): Observable<GetResourceSharesResponse> {
			return this.http.post<GetResourceSharesResponse>(this.baseUri + '/getresourceshares?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPendingInvitationResources(maxResults: string, nextToken: string, requestBody: ListPendingInvitationResourcesBody, headersHandler?: () => HttpHeaders): Observable<ListPendingInvitationResourcesResponse> {
			return this.http.post<ListPendingInvitationResourcesResponse>(this.baseUri + '/listpendinginvitationresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPermissions(requestBody: ListPermissionsBody, headersHandler?: () => HttpHeaders): Observable<ListPermissionsResponse> {
			return this.http.post<ListPermissionsResponse>(this.baseUri + '/listpermissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPrincipals(maxResults: string, nextToken: string, requestBody: ListPrincipalsBody, headersHandler?: () => HttpHeaders): Observable<ListPrincipalsResponse> {
			return this.http.post<ListPrincipalsResponse>(this.baseUri + '/listprincipals?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResourceSharePermissions(requestBody: ListResourceSharePermissionsBody, headersHandler?: () => HttpHeaders): Observable<ListResourceSharePermissionsResponse> {
			return this.http.post<ListResourceSharePermissionsResponse>(this.baseUri + '/listresourcesharepermissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResourceTypes(requestBody: ListResourceTypesBody, headersHandler?: () => HttpHeaders): Observable<ListResourceTypesResponse> {
			return this.http.post<ListResourceTypesResponse>(this.baseUri + '/listresourcetypes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResources(maxResults: string, nextToken: string, requestBody: ListResourcesBody, headersHandler?: () => HttpHeaders): Observable<ListResourcesResponse> {
			return this.http.post<ListResourcesResponse>(this.baseUri + '/listresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PromoteResourceShareCreatedFromPolicy(resourceShareArn: string, headersHandler?: () => HttpHeaders): Observable<PromoteResourceShareCreatedFromPolicyResponse> {
			return this.http.post<PromoteResourceShareCreatedFromPolicyResponse>(this.baseUri + '/promoteresourcesharecreatedfrompolicy#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RejectResourceShareInvitation(requestBody: RejectResourceShareInvitationBody, headersHandler?: () => HttpHeaders): Observable<RejectResourceShareInvitationResponse> {
			return this.http.post<RejectResourceShareInvitationResponse>(this.baseUri + '/rejectresourceshareinvitation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/tagresource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/untagresource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateResourceShare(requestBody: UpdateResourceShareBody, headersHandler?: () => HttpHeaders): Observable<UpdateResourceShareResponse> {
			return this.http.post<UpdateResourceShareResponse>(this.baseUri + '/updateresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
