...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptResourceShareInvitation(callback: (data : AcceptResourceShareInvitationResponse) => any, requestBody: AcceptResourceShareInvitationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/acceptresourceshareinvitation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociateResourceShare(callback: (data : AssociateResourceShareResponse) => any, requestBody: AssociateResourceShareBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/associateresourceshare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociateResourceSharePermission(callback: (data : AssociateResourceSharePermissionResponse) => any, requestBody: AssociateResourceSharePermissionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/associateresourcesharepermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateResourceShare(callback: (data : CreateResourceShareResponse) => any, requestBody: CreateResourceShareBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/createresourceshare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteResourceShare(resourceShareArn: string, clientToken: string, callback: (data : DeleteResourceShareResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/deleteresourceshare#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DisassociateResourceShare(callback: (data : DisassociateResourceShareResponse) => any, requestBody: DisassociateResourceShareBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/disassociateresourceshare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateResourceSharePermission(callback: (data : DisassociateResourceSharePermissionResponse) => any, requestBody: DisassociateResourceSharePermissionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/disassociateresourcesharepermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		EnableSharingWithAwsOrganization(callback: (data : EnableSharingWithAwsOrganizationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/enablesharingwithawsorganization', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetPermission(callback: (data : GetPermissionResponse) => any, requestBody: GetPermissionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getpermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResourcePolicies(maxResults: string, nextToken: string, callback: (data : GetResourcePoliciesResponse) => any, requestBody: GetResourcePoliciesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getresourcepolicies?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResourceShareAssociations(maxResults: string, nextToken: string, callback: (data : GetResourceShareAssociationsResponse) => any, requestBody: GetResourceShareAssociationsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getresourceshareassociations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResourceShareInvitations(maxResults: string, nextToken: string, callback: (data : GetResourceShareInvitationsResponse) => any, requestBody: GetResourceShareInvitationsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getresourceshareinvitations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResourceShares(maxResults: string, nextToken: string, callback: (data : GetResourceSharesResponse) => any, requestBody: GetResourceSharesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getresourceshares?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPendingInvitationResources(maxResults: string, nextToken: string, callback: (data : ListPendingInvitationResourcesResponse) => any, requestBody: ListPendingInvitationResourcesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listpendinginvitationresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPermissions(callback: (data : ListPermissionsResponse) => any, requestBody: ListPermissionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listpermissions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPrincipals(maxResults: string, nextToken: string, callback: (data : ListPrincipalsResponse) => any, requestBody: ListPrincipalsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listprincipals?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResourceSharePermissions(callback: (data : ListResourceSharePermissionsResponse) => any, requestBody: ListResourceSharePermissionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listresourcesharepermissions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResourceTypes(callback: (data : ListResourceTypesResponse) => any, requestBody: ListResourceTypesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listresourcetypes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResources(maxResults: string, nextToken: string, callback: (data : ListResourcesResponse) => any, requestBody: ListResourcesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PromoteResourceShareCreatedFromPolicy(resourceShareArn: string, callback: (data : PromoteResourceShareCreatedFromPolicyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/promoteresourcesharecreatedfrompolicy#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RejectResourceShareInvitation(callback: (data : RejectResourceShareInvitationResponse) => any, requestBody: RejectResourceShareInvitationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/rejectresourceshareinvitation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateResourceShare(callback: (data : UpdateResourceShareResponse) => any, requestBody: UpdateResourceShareBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateresourceshare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
