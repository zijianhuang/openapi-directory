export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptResourceShareInvitation(requestBody: AcceptResourceShareInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptResourceShareInvitationResponse> {
			return fetch(this.baseUri + '/acceptresourceshareinvitation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AssociateResourceShare(requestBody: AssociateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateResourceShareResponse> {
			return fetch(this.baseUri + '/associateresourceshare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AssociateResourceSharePermission(requestBody: AssociateResourceSharePermissionBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateResourceSharePermissionResponse> {
			return fetch(this.baseUri + '/associateresourcesharepermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateResourceShare(requestBody: CreateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceShareResponse> {
			return fetch(this.baseUri + '/createresourceshare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteResourceShare(resourceShareArn: string, clientToken: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourceShareResponse> {
			return fetch(this.baseUri + '/deleteresourceshare#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateResourceShare(requestBody: DisassociateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateResourceShareResponse> {
			return fetch(this.baseUri + '/disassociateresourceshare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisassociateResourceSharePermission(requestBody: DisassociateResourceSharePermissionBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateResourceSharePermissionResponse> {
			return fetch(this.baseUri + '/disassociateresourcesharepermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		EnableSharingWithAwsOrganization(headersHandler?: () => {[header: string]: string}): Promise<EnableSharingWithAwsOrganizationResponse> {
			return fetch(this.baseUri + '/enablesharingwithawsorganization', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPermission(requestBody: GetPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<GetPermissionResponse> {
			return fetch(this.baseUri + '/getpermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetResourceShareInvitations(maxResults: string, nextToken: string, requestBody: GetResourceShareInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<GetResourceShareInvitationsResponse> {
			return fetch(this.baseUri + '/getresourceshareinvitations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetResourceShares(maxResults: string, nextToken: string, requestBody: GetResourceSharesBody, headersHandler?: () => {[header: string]: string}): Promise<GetResourceSharesResponse> {
			return fetch(this.baseUri + '/getresourceshares?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPendingInvitationResources(maxResults: string, nextToken: string, requestBody: ListPendingInvitationResourcesBody, headersHandler?: () => {[header: string]: string}): Promise<ListPendingInvitationResourcesResponse> {
			return fetch(this.baseUri + '/listpendinginvitationresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPermissions(requestBody: ListPermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<ListPermissionsResponse> {
			return fetch(this.baseUri + '/listpermissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListResourceSharePermissions(requestBody: ListResourceSharePermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<ListResourceSharePermissionsResponse> {
			return fetch(this.baseUri + '/listresourcesharepermissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListResourceTypes(requestBody: ListResourceTypesBody, headersHandler?: () => {[header: string]: string}): Promise<ListResourceTypesResponse> {
			return fetch(this.baseUri + '/listresourcetypes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListResources(maxResults: string, nextToken: string, requestBody: ListResourcesBody, headersHandler?: () => {[header: string]: string}): Promise<ListResourcesResponse> {
			return fetch(this.baseUri + '/listresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PromoteResourceShareCreatedFromPolicy(resourceShareArn: string, headersHandler?: () => {[header: string]: string}): Promise<PromoteResourceShareCreatedFromPolicyResponse> {
			return fetch(this.baseUri + '/promoteresourcesharecreatedfrompolicy#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RejectResourceShareInvitation(requestBody: RejectResourceShareInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<RejectResourceShareInvitationResponse> {
			return fetch(this.baseUri + '/rejectresourceshareinvitation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/tagresource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/untagresource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateResourceShare(requestBody: UpdateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateResourceShareResponse> {
			return fetch(this.baseUri + '/updateresourceshare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
