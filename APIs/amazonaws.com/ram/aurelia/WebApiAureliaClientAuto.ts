...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptResourceShareInvitation(requestBody: AcceptResourceShareInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptResourceShareInvitationResponse> {
			return this.http.post('/acceptresourceshareinvitation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateResourceShare(requestBody: AssociateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateResourceShareResponse> {
			return this.http.post('/associateresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateResourceSharePermission(requestBody: AssociateResourceSharePermissionBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateResourceSharePermissionResponse> {
			return this.http.post('/associateresourcesharepermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateResourceShare(requestBody: CreateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceShareResponse> {
			return this.http.post('/createresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResourceShare(resourceShareArn: string, clientToken: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourceShareResponse> {
			return this.http.delete('/deleteresourceshare#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateResourceShare(requestBody: DisassociateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateResourceShareResponse> {
			return this.http.post('/disassociateresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateResourceSharePermission(requestBody: DisassociateResourceSharePermissionBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateResourceSharePermissionResponse> {
			return this.http.post('/disassociateresourcesharepermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableSharingWithAwsOrganization(headersHandler?: () => {[header: string]: string}): Promise<EnableSharingWithAwsOrganizationResponse> {
			return this.http.post('/enablesharingwithawsorganization', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPermission(requestBody: GetPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<GetPermissionResponse> {
			return this.http.post('/getpermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResourceShareAssociations(maxResults: string, nextToken: string, requestBody: GetResourceShareAssociationsBody, headersHandler?: () => {[header: string]: string}): Promise<GetResourceShareAssociationsResponse> {
			return this.http.post('/getresourceshareassociations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResourceShareInvitations(maxResults: string, nextToken: string, requestBody: GetResourceShareInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<GetResourceShareInvitationsResponse> {
			return this.http.post('/getresourceshareinvitations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResourceShares(maxResults: string, nextToken: string, requestBody: GetResourceSharesBody, headersHandler?: () => {[header: string]: string}): Promise<GetResourceSharesResponse> {
			return this.http.post('/getresourceshares?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPendingInvitationResources(maxResults: string, nextToken: string, requestBody: ListPendingInvitationResourcesBody, headersHandler?: () => {[header: string]: string}): Promise<ListPendingInvitationResourcesResponse> {
			return this.http.post('/listpendinginvitationresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPermissions(requestBody: ListPermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<ListPermissionsResponse> {
			return this.http.post('/listpermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPrincipals(maxResults: string, nextToken: string, requestBody: ListPrincipalsBody, headersHandler?: () => {[header: string]: string}): Promise<ListPrincipalsResponse> {
			return this.http.post('/listprincipals?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResourceSharePermissions(requestBody: ListResourceSharePermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<ListResourceSharePermissionsResponse> {
			return this.http.post('/listresourcesharepermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResourceTypes(requestBody: ListResourceTypesBody, headersHandler?: () => {[header: string]: string}): Promise<ListResourceTypesResponse> {
			return this.http.post('/listresourcetypes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResources(maxResults: string, nextToken: string, requestBody: ListResourcesBody, headersHandler?: () => {[header: string]: string}): Promise<ListResourcesResponse> {
			return this.http.post('/listresources?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PromoteResourceShareCreatedFromPolicy(resourceShareArn: string, headersHandler?: () => {[header: string]: string}): Promise<PromoteResourceShareCreatedFromPolicyResponse> {
			return this.http.post('/promoteresourcesharecreatedfrompolicy#resourceShareArn?resourceShareArn=' + (resourceShareArn == null ? '' : encodeURIComponent(resourceShareArn)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RejectResourceShareInvitation(requestBody: RejectResourceShareInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<RejectResourceShareInvitationResponse> {
			return this.http.post('/rejectresourceshareinvitation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/tagresource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/untagresource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateResourceShare(requestBody: UpdateResourceShareBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateResourceShareResponse> {
			return this.http.post('/updateresourceshare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
