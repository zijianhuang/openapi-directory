...
namespace My_Demo_Client {
	...
	export interface ReceiveMessageRequest {
		QueueUrl: string;
		AttributeNames?: Array<QueueAttributeName>;
		MessageAttributeNames?: Array<MessageAttributeName>;
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AddPermission(Label: string, AWSAccountIds: Array<String>, Actions: Array<String>, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=AddPermission?Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&' + AWSAccountIds.map(z => `AWSAccountIds=${z}`).join('&') + '&' + Actions.map(z => `Actions=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {number} VisibilityTimeout The new value for the message's visibility timeout (in seconds). Values values: <code>0</code> to <code>43200</code>. Maximum: 12 hours.
		 * @param {number} AccountNumber The AWS account number
		 * @param {string} QueueName The name of the queue
		 * @return {void} Success
		 */
		GET_ChangeMessageVisibility(ReceiptHandle: string, VisibilityTimeout: number, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ChangeMessageVisibility?ReceiptHandle=' + (ReceiptHandle == null ? '' : encodeURIComponent(ReceiptHandle)) + '&VisibilityTimeout=' + VisibilityTimeout + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {Array<ChangeMessageVisibilityBatchRequestEntry>} Entries A list of receipt handles of the messages for which the visibility timeout must be changed.
		 * @param {number} AccountNumber The AWS account number
		 * @param {string} QueueName The name of the queue
		 * @return {void} Success
		 */
		GET_ChangeMessageVisibilityBatch(Entries: Array<ChangeMessageVisibilityBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ChangeMessageVisibilityBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteMessage(ReceiptHandle: string, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=DeleteMessage?ReceiptHandle=' + (ReceiptHandle == null ? '' : encodeURIComponent(ReceiptHandle)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {Array<DeleteMessageBatchRequestEntry>} Entries A list of receipt handles for the messages to be deleted.
		 * @param {number} AccountNumber The AWS account number
		 * @param {string} QueueName The name of the queue
		 * @return {void} Success
		 */
		GET_DeleteMessageBatch(Entries: Array<DeleteMessageBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=DeleteMessageBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteQueue(AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=DeleteQueue&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetQueueUrl(QueueName: string, QueueOwnerAWSAccountId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetQueueUrl?QueueName=' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '&QueueOwnerAWSAccountId=' + (QueueOwnerAWSAccountId == null ? '' : encodeURIComponent(QueueOwnerAWSAccountId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListDeadLetterSourceQueues(AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ListDeadLetterSourceQueues&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListQueueTags(AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ListQueueTags&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListQueues(QueueNamePrefix: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListQueues?QueueNamePrefix=' + (QueueNamePrefix == null ? '' : encodeURIComponent(QueueNamePrefix)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_PurgeQueue(AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=PurgeQueue&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {number} WaitTimeSeconds The duration (in seconds) for which the call waits for a message to arrive in the queue before returning. If a message is available, the call returns sooner than <code>WaitTimeSeconds</code>. If no messages are available and the wait time expires, the call returns successfully with an empty list of messages.
		 ...
		 * @return {void} Success
		 */
		GET_ReceiveMessage(AttributeNames: Array<QueueAttributeName>, MessageAttributeNames: Array<MessageAttributeName>, MaxNumberOfMessages: number, VisibilityTimeout: number, WaitTimeSeconds: number, ReceiveRequestAttemptId: string, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ReceiveMessage?' + AttributeNames.map(z => `AttributeNames=${z}`).join('&') + '&' + MessageAttributeNames.map(z => `MessageAttributeNames=${z}`).join('&') + '&MaxNumberOfMessages=' + MaxNumberOfMessages + '&VisibilityTimeout=' + VisibilityTimeout + '&WaitTimeSeconds=' + WaitTimeSeconds + '&ReceiveRequestAttemptId=' + (ReceiveRequestAttemptId == null ? '' : encodeURIComponent(ReceiveRequestAttemptId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemovePermission(Label: string, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=RemovePermission?Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {string} MessageBody <p>The message to send. The maximum string size is 256 KB.</p> <important> <p>A message can include only XML, JSON, and unformatted text. The following Unicode characters are allowed:</p> <p> <code>#x9</code> | <code>#xA</code> | <code>#xD</code> | <code>#x20</code> to <code>#xD7FF</code> | <code>#xE000</code> to <code>#xFFFD</code> | <code>#x10000</code> to <code>#x10FFFF</code> </p> <p>Any characters not included in this list will be rejected. For more information, see the <a href="http://www.w3.org/TR/REC-xml/#charsets">W3C specification for characters</a>.</p> </important>
		 ...
		 * @return {void} Success
		 */
		GET_SendMessage(MessageBody: string, DelaySeconds: number, MessageAttribute: string, MessageSystemAttribute: string, MessageDeduplicationId: string, MessageGroupId: string, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=SendMessage?MessageBody=' + (MessageBody == null ? '' : encodeURIComponent(MessageBody)) + '&DelaySeconds=' + DelaySeconds + '&MessageAttribute=' + (MessageAttribute == null ? '' : encodeURIComponent(MessageAttribute)) + '&MessageSystemAttribute=' + (MessageSystemAttribute == null ? '' : encodeURIComponent(MessageSystemAttribute)) + '&MessageDeduplicationId=' + (MessageDeduplicationId == null ? '' : encodeURIComponent(MessageDeduplicationId)) + '&MessageGroupId=' + (MessageGroupId == null ? '' : encodeURIComponent(MessageGroupId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {Array<SendMessageBatchRequestEntry>} Entries A list of <code> <a>SendMessageBatchRequestEntry</a> </code> items.
		 * @param {number} AccountNumber The AWS account number
		 * @param {string} QueueName The name of the queue
		 * @return {void} Success
		 */
		GET_SendMessageBatch(Entries: Array<SendMessageBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=SendMessageBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetQueueAttributes(Attribute: string, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=SetQueueAttributes?Attribute=' + (Attribute == null ? '' : encodeURIComponent(Attribute)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {string} Tags The list of tags to be added to the specified queue.
		 * @param {number} AccountNumber The AWS account number
		 * @param {string} QueueName The name of the queue
		 * @return {void} Success
		 */
		GET_TagQueue(Tags: string, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=TagQueue?Tags=' + (Tags == null ? '' : encodeURIComponent(Tags)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @param {Array<TagKey>} TagKeys The list of tags to be removed from the specified queue.
		 * @param {number} AccountNumber The AWS account number
		 * @param {string} QueueName The name of the queue
		 * @return {void} Success
		 */
		GET_UntagQueue(TagKeys: Array<TagKey>, AccountNumber: number, QueueName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=UntagQueue?' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
	}
