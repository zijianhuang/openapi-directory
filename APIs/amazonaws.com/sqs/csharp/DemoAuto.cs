...
namespace My.Demo.Client
{
	...
	public class ChangeMessageVisibilityBatchResult
	{
		...
		public ChangeMessageVisibilityBatchResultEntry[] Successful { get; set; }
	...
	public class ChangeMessageVisibilityBatchRequestEntry
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> VisibilityTimeout { get; set; }
	}
	...
	public class DeleteMessageBatchResult
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public DeleteMessageBatchResultEntry[] Successful { get; set; }
	...
	public class GetQueueAttributesResult
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public QueueAttributeMap Attributes { get; set; }
	}
	...
	public enum QueueAttributeName
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		ContentBasedDeduplication = 15,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		KmsMasterKeyId = 16,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		KmsDataKeyReusePeriodSeconds = 17,
	}
	...
	public class ListDeadLetterSourceQueuesResult
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public String[] QueueUrls { get; set; }
	}
	...
	public class MessageAttributeValue
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public String[] StringListValues { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public Binary[] BinaryListValues { get; set; }
	...
	public class SendMessageBatchResult
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public SendMessageBatchResultEntry[] Successful { get; set; }
	...
	public class SendMessageBatchRequestEntry
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> DelaySeconds { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public MessageBodyAttributeMap MessageAttributes { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public MessageBodySystemAttributeMap MessageSystemAttributes { get; set; }
	...
	public class ChangeMessageVisibilityBatchRequest
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public ChangeMessageVisibilityBatchRequestEntry[] Entries { get; set; }
	}
	...
	public class GetQueueAttributesRequest
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public QueueAttributeName[] AttributeNames { get; set; }
	}
	...
	public class Message
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public MessageSystemAttributeMap Attributes { get; set; }
	...
	public enum MessageSystemAttributeName
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		ApproximateFirstReceiveTimestamp = 3,
	...
	public class ReceiveMessageRequest
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public MessageAttributeName[] MessageAttributeNames { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> MaxNumberOfMessages { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> VisibilityTimeout { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> WaitTimeSeconds { get; set; }
	...
	public class SendMessageBatchRequest
	{
		...
		[System.ComponentModel.DataAnnotations.Required()]
		[System.Runtime.Serialization.DataMember()]
		public SendMessageBatchRequestEntry[] Entries { get; set; }
	}
	...
	public partial class DemoClient
	{
		...
		/// GET_AddPermission /{AccountNumber}/{QueueName}/#Action=AddPermission
		/// </summary>
		...
		/// <param name="Actions"><p>The action the client wants to allow for the specified principal. Valid values: the name of any action or <code>*</code>.</p> <p>For more information about these actions, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-overview-of-managing-access.html">Overview of Managing Access Permissions to Your Amazon Simple Queue Service Resource</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</p> <p>Specifying <code>SendMessage</code>, <code>DeleteMessage</code>, or <code>ChangeMessageVisibility</code> for <code>ActionName.n</code> also grants permissions for the corresponding batch versions of those actions: <code>SendMessageBatch</code>, <code>DeleteMessageBatch</code>, and <code>ChangeMessageVisibilityBatch</code>.</p></param>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_AddPermissionAsync(string Label, String[] AWSAccountIds, String[] Actions, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=AddPermission?Label=" + (Label==null? "" : Uri.EscapeDataString(Label))+"&"+String.Join("&", AWSAccountIds.Select(z => $"AWSAccountIds={z}"))+"&"+String.Join("&", Actions.Select(z => $"Actions={z}"))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
		...
		/// GET_ChangeMessageVisibility /{AccountNumber}/{QueueName}/#Action=ChangeMessageVisibility
		/// </summary>
		...
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_ChangeMessageVisibilityAsync(string ReceiptHandle, int VisibilityTimeout, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=ChangeMessageVisibility?ReceiptHandle=" + (ReceiptHandle==null? "" : Uri.EscapeDataString(ReceiptHandle))+"&VisibilityTimeout="+VisibilityTimeout+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_ChangeMessageVisibilityBatch /{AccountNumber}/{QueueName}/#Action=ChangeMessageVisibilityBatch
		/// </summary>
		/// <param name="Entries">A list of receipt handles of the messages for which the visibility timeout must be changed.</param>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_ChangeMessageVisibilityBatchAsync(ChangeMessageVisibilityBatchRequestEntry[] Entries, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=ChangeMessageVisibilityBatch?"+String.Join("&", Entries.Select(z => $"Entries={z}"))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_DeleteMessage /{AccountNumber}/{QueueName}/#Action=DeleteMessage
		/// </summary>
		/// <param name="ReceiptHandle">The receipt handle associated with the message to delete.</param>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_DeleteMessageAsync(string ReceiptHandle, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=DeleteMessage?ReceiptHandle=" + (ReceiptHandle==null? "" : Uri.EscapeDataString(ReceiptHandle))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_DeleteMessageBatch /{AccountNumber}/{QueueName}/#Action=DeleteMessageBatch
		/// </summary>
		/// <param name="Entries">A list of receipt handles for the messages to be deleted.</param>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_DeleteMessageBatchAsync(DeleteMessageBatchRequestEntry[] Entries, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=DeleteMessageBatch?"+String.Join("&", Entries.Select(z => $"Entries={z}"))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_DeleteQueue /{AccountNumber}/{QueueName}/#Action=DeleteQueue
		/// </summary>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_DeleteQueueAsync(int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=DeleteQueue&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_GetQueueUrl /#Action=GetQueueUrl
		/// </summary>
		/// <param name="QueueName"><p>The name of the queue whose URL must be fetched. Maximum 80 characters. Valid values: alphanumeric characters, hyphens (<code>-</code>), and underscores (<code>_</code>).</p> <p>Queue URLs and names are case-sensitive.</p></param>
		/// <param name="QueueOwnerAWSAccountId">The AWS account ID of the account that created the queue.</param>
		/// <returns>Success</returns>
		public async Task GET_GetQueueUrlAsync(string QueueName, string QueueOwnerAWSAccountId, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/#Action=GetQueueUrl?QueueName=" + (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"&QueueOwnerAWSAccountId=" + (QueueOwnerAWSAccountId==null? "" : Uri.EscapeDataString(QueueOwnerAWSAccountId))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_ListDeadLetterSourceQueues /{AccountNumber}/{QueueName}/#Action=ListDeadLetterSourceQueues
		/// </summary>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_ListDeadLetterSourceQueuesAsync(int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=ListDeadLetterSourceQueues&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_ListQueueTags /{AccountNumber}/{QueueName}/#Action=ListQueueTags
		/// </summary>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_ListQueueTagsAsync(int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=ListQueueTags&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_ListQueues /#Action=ListQueues
		/// </summary>
		/// <param name="QueueNamePrefix"><p>A string to use for filtering the list results. Only those queues whose name begins with the specified string are returned.</p> <p>Queue URLs and names are case-sensitive.</p></param>
		/// <returns>Success</returns>
		public async Task GET_ListQueuesAsync(string QueueNamePrefix, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/#Action=ListQueues?QueueNamePrefix=" + (QueueNamePrefix==null? "" : Uri.EscapeDataString(QueueNamePrefix))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_PurgeQueue /{AccountNumber}/{QueueName}/#Action=PurgeQueue
		/// </summary>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_PurgeQueueAsync(int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=PurgeQueue&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_RemovePermission /{AccountNumber}/{QueueName}/#Action=RemovePermission
		/// </summary>
		...
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_RemovePermissionAsync(string Label, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=RemovePermission?Label=" + (Label==null? "" : Uri.EscapeDataString(Label))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_SendMessage /{AccountNumber}/{QueueName}/#Action=SendMessage
		/// </summary>
		/// <param name="MessageBody"><p>The message to send. The maximum string size is 256 KB.</p> <important> <p>A message can include only XML, JSON, and unformatted text. The following Unicode characters are allowed:</p> <p> <code>#x9</code> | <code>#xA</code> | <code>#xD</code> | <code>#x20</code> to <code>#xD7FF</code> | <code>#xE000</code> to <code>#xFFFD</code> | <code>#x10000</code> to <code>#x10FFFF</code> </p> <p>Any characters not included in this list will be rejected. For more information, see the <a href="http://www.w3.org/TR/REC-xml/#charsets">W3C specification for characters</a>.</p> </important></param>
		/// <param name="DelaySeconds"><p> The length of time, in seconds, for which to delay a specific message. Valid values: 0 to 900. Maximum: 15 minutes. Messages with a positive <code>DelaySeconds</code> value become available for processing after the delay period is finished. If you don't specify a value, the default value for the queue applies. </p> <note> <p>When you set <code>FifoQueue</code>, you can't set <code>DelaySeconds</code> per message. You can set this parameter only on a queue level.</p> </note></param>
		/// <param name="MessageAttribute">Each message attribute consists of a <code>Name</code>, <code>Type</code>, and <code>Value</code>. For more information, see <a href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-message-attributes.html">Amazon SQS Message Attributes</a> in the <i>Amazon Simple Queue Service Developer Guide</i>.</param>
		/// <param name="MessageSystemAttribute"><p>The message system attribute to send. Each message system attribute consists of a <code>Name</code>, <code>Type</code>, and <code>Value</code>.</p> <important> <ul> <li> <p>Currently, the only supported message system attribute is <code>AWSTraceHeader</code>. Its type must be <code>String</code> and its value must be a correctly formatted AWS X-Ray trace string.</p> </li> <li> <p>The size of a message system attribute doesn't count towards the total size of a message.</p> </li> </ul> </important></param>
		...
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_SendMessageAsync(string MessageBody, int DelaySeconds, string MessageAttribute, string MessageSystemAttribute, string MessageDeduplicationId, string MessageGroupId, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=SendMessage?MessageBody=" + (MessageBody==null? "" : Uri.EscapeDataString(MessageBody))+"&DelaySeconds="+DelaySeconds+"&MessageAttribute=" + (MessageAttribute==null? "" : Uri.EscapeDataString(MessageAttribute))+"&MessageSystemAttribute=" + (MessageSystemAttribute==null? "" : Uri.EscapeDataString(MessageSystemAttribute))+"&MessageDeduplicationId=" + (MessageDeduplicationId==null? "" : Uri.EscapeDataString(MessageDeduplicationId))+"&MessageGroupId=" + (MessageGroupId==null? "" : Uri.EscapeDataString(MessageGroupId))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_SendMessageBatch /{AccountNumber}/{QueueName}/#Action=SendMessageBatch
		/// </summary>
		/// <param name="Entries">A list of <code> <a>SendMessageBatchRequestEntry</a> </code> items.</param>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_SendMessageBatchAsync(SendMessageBatchRequestEntry[] Entries, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=SendMessageBatch?"+String.Join("&", Entries.Select(z => $"Entries={z}"))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_SetQueueAttributes /{AccountNumber}/{QueueName}/#Action=SetQueueAttributes
		/// </summary>
		...
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_SetQueueAttributesAsync(string Attribute, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=SetQueueAttributes?Attribute=" + (Attribute==null? "" : Uri.EscapeDataString(Attribute))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_TagQueue /{AccountNumber}/{QueueName}/#Action=TagQueue
		/// </summary>
		/// <param name="Tags">The list of tags to be added to the specified queue.</param>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_TagQueueAsync(string Tags, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=TagQueue?Tags=" + (Tags==null? "" : Uri.EscapeDataString(Tags))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET_UntagQueue /{AccountNumber}/{QueueName}/#Action=UntagQueue
		/// </summary>
		/// <param name="TagKeys">The list of tags to be removed from the specified queue.</param>
		/// <param name="AccountNumber">The AWS account number</param>
		/// <param name="QueueName">The name of the queue</param>
		/// <returns>Success</returns>
		public async Task GET_UntagQueueAsync(TagKey[] TagKeys, int AccountNumber, string QueueName, string Action, string Version, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/"+AccountNumber+"/"+ (QueueName==null? "" : Uri.EscapeDataString(QueueName))+"/#Action=UntagQueue?"+String.Join("&", TagKeys.Select(z => $"TagKeys={z}"))+"&Action=" + (Action==null? "" : Uri.EscapeDataString(Action))+"&Version=" + (Version==null? "" : Uri.EscapeDataString(Version));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
