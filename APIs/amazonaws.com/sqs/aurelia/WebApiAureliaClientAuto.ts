...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AddPermission(Label: string, AWSAccountIds: Array<String>, Actions: Array<String>, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=AddPermission?Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&' + AWSAccountIds.map(z => `AWSAccountIds=${z}`).join('&') + '&' + Actions.map(z => `Actions=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ChangeMessageVisibility(ReceiptHandle: string, VisibilityTimeout: number, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ChangeMessageVisibility?ReceiptHandle=' + (ReceiptHandle == null ? '' : encodeURIComponent(ReceiptHandle)) + '&VisibilityTimeout=' + VisibilityTimeout + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ChangeMessageVisibilityBatch(Entries: Array<ChangeMessageVisibilityBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ChangeMessageVisibilityBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateQueue(QueueName: string, Attribute: string, Tag: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreateQueue?QueueName=' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '&Attribute=' + (Attribute == null ? '' : encodeURIComponent(Attribute)) + '&Tag=' + (Tag == null ? '' : encodeURIComponent(Tag)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteMessage(ReceiptHandle: string, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=DeleteMessage?ReceiptHandle=' + (ReceiptHandle == null ? '' : encodeURIComponent(ReceiptHandle)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteMessageBatch(Entries: Array<DeleteMessageBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=DeleteMessageBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteQueue(AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=DeleteQueue&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetQueueAttributes(AttributeNames: Array<QueueAttributeName>, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=GetQueueAttributes?' + AttributeNames.map(z => `AttributeNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetQueueUrl(QueueName: string, QueueOwnerAWSAccountId: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetQueueUrl?QueueName=' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '&QueueOwnerAWSAccountId=' + (QueueOwnerAWSAccountId == null ? '' : encodeURIComponent(QueueOwnerAWSAccountId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListDeadLetterSourceQueues(AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ListDeadLetterSourceQueues&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListQueueTags(AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ListQueueTags&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListQueues(QueueNamePrefix: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListQueues?QueueNamePrefix=' + (QueueNamePrefix == null ? '' : encodeURIComponent(QueueNamePrefix)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_PurgeQueue(AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=PurgeQueue&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ReceiveMessage(AttributeNames: Array<QueueAttributeName>, MessageAttributeNames: Array<MessageAttributeName>, MaxNumberOfMessages: number, VisibilityTimeout: number, WaitTimeSeconds: number, ReceiveRequestAttemptId: string, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=ReceiveMessage?' + AttributeNames.map(z => `AttributeNames=${z}`).join('&') + '&' + MessageAttributeNames.map(z => `MessageAttributeNames=${z}`).join('&') + '&MaxNumberOfMessages=' + MaxNumberOfMessages + '&VisibilityTimeout=' + VisibilityTimeout + '&WaitTimeSeconds=' + WaitTimeSeconds + '&ReceiveRequestAttemptId=' + (ReceiveRequestAttemptId == null ? '' : encodeURIComponent(ReceiveRequestAttemptId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemovePermission(Label: string, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=RemovePermission?Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SendMessage(MessageBody: string, DelaySeconds: number, MessageAttribute: string, MessageSystemAttribute: string, MessageDeduplicationId: string, MessageGroupId: string, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=SendMessage?MessageBody=' + (MessageBody == null ? '' : encodeURIComponent(MessageBody)) + '&DelaySeconds=' + DelaySeconds + '&MessageAttribute=' + (MessageAttribute == null ? '' : encodeURIComponent(MessageAttribute)) + '&MessageSystemAttribute=' + (MessageSystemAttribute == null ? '' : encodeURIComponent(MessageSystemAttribute)) + '&MessageDeduplicationId=' + (MessageDeduplicationId == null ? '' : encodeURIComponent(MessageDeduplicationId)) + '&MessageGroupId=' + (MessageGroupId == null ? '' : encodeURIComponent(MessageGroupId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SendMessageBatch(Entries: Array<SendMessageBatchRequestEntry>, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=SendMessageBatch?' + Entries.map(z => `Entries=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetQueueAttributes(Attribute: string, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=SetQueueAttributes?Attribute=' + (Attribute == null ? '' : encodeURIComponent(Attribute)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_TagQueue(Tags: string, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=TagQueue?Tags=' + (Tags == null ? '' : encodeURIComponent(Tags)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_UntagQueue(TagKeys: Array<TagKey>, AccountNumber: number, QueueName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + AccountNumber + '/' + (QueueName == null ? '' : encodeURIComponent(QueueName)) + '/#Action=UntagQueue?' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
