...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateConfigurationItemsToApplication(requestBody: AssociateConfigurationItemsToApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateConfigurationItemsToApplicationResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchDeleteImportData(requestBody: BatchDeleteImportDataRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteImportDataResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.BatchDeleteImportData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateApplication(requestBody: CreateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateApplicationResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTags(requestBody: CreateTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTagsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApplications(requestBody: DeleteApplicationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteApplications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTags(requestBody: DeleteTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAgents(requestBody: DescribeAgentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAgentsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeAgents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigurations(requestBody: DescribeConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeContinuousExports(maxResults: string, nextToken: string, requestBody: DescribeContinuousExportsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeContinuousExportsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeContinuousExports?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeExportConfigurations(requestBody: DescribeExportConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExportConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeExportConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeExportTasks(requestBody: DescribeExportTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExportTasksResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeExportTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeImportTasks(maxResults: string, nextToken: string, requestBody: DescribeImportTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImportTasksResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeImportTasks?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateConfigurationItemsFromApplication(requestBody: DisassociateConfigurationItemsFromApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateConfigurationItemsFromApplicationResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DisassociateConfigurationItemsFromApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ExportConfigurations(headersHandler?: () => {[header: string]: string}): Promise<ExportConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ExportConfigurations', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDiscoverySummary(requestBody: GetDiscoverySummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiscoverySummaryResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.GetDiscoverySummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListConfigurations(requestBody: ListConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListServerNeighbors(requestBody: ListServerNeighborsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListServerNeighborsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListServerNeighbors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartContinuousExport(requestBody: StartContinuousExportRequest, headersHandler?: () => {[header: string]: string}): Promise<StartContinuousExportResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartContinuousExport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartDataCollectionByAgentIds(requestBody: StartDataCollectionByAgentIdsRequest, headersHandler?: () => {[header: string]: string}): Promise<StartDataCollectionByAgentIdsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartDataCollectionByAgentIds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartExportTask(requestBody: StartExportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<StartExportTaskResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartExportTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartImportTask(requestBody: StartImportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<StartImportTaskResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartImportTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopContinuousExport(requestBody: StopContinuousExportRequest, headersHandler?: () => {[header: string]: string}): Promise<StopContinuousExportResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopContinuousExport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopDataCollectionByAgentIds(requestBody: StopDataCollectionByAgentIdsRequest, headersHandler?: () => {[header: string]: string}): Promise<StopDataCollectionByAgentIdsResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopDataCollectionByAgentIds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateApplication(requestBody: UpdateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateApplicationResponse> {
			return this.http.post('/#X-Amz-Target=AWSPoseidonService_V2015_11_01.UpdateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
