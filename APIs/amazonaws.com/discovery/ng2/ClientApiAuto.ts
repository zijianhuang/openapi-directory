...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateConfigurationItemsToApplication(requestBody: AssociateConfigurationItemsToApplicationRequest, headersHandler?: () => HttpHeaders): Observable<AssociateConfigurationItemsToApplicationResponse> {
			return this.http.post<AssociateConfigurationItemsToApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchDeleteImportData(requestBody: BatchDeleteImportDataRequest, headersHandler?: () => HttpHeaders): Observable<BatchDeleteImportDataResponse> {
			return this.http.post<BatchDeleteImportDataResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.BatchDeleteImportData', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateApplication(requestBody: CreateApplicationRequest, headersHandler?: () => HttpHeaders): Observable<CreateApplicationResponse> {
			return this.http.post<CreateApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTags(requestBody: CreateTagsRequest, headersHandler?: () => HttpHeaders): Observable<CreateTagsResponse> {
			return this.http.post<CreateTagsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApplications(requestBody: DeleteApplicationsRequest, headersHandler?: () => HttpHeaders): Observable<DeleteApplicationsResponse> {
			return this.http.post<DeleteApplicationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteApplications', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTags(requestBody: DeleteTagsRequest, headersHandler?: () => HttpHeaders): Observable<DeleteTagsResponse> {
			return this.http.post<DeleteTagsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAgents(requestBody: DescribeAgentsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAgentsResponse> {
			return this.http.post<DescribeAgentsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeAgents', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigurations(requestBody: DescribeConfigurationsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConfigurationsResponse> {
			return this.http.post<DescribeConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeContinuousExports(maxResults: string, nextToken: string, requestBody: DescribeContinuousExportsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeContinuousExportsResponse> {
			return this.http.post<DescribeContinuousExportsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeContinuousExports?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeExportConfigurations(requestBody: DescribeExportConfigurationsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeExportConfigurationsResponse> {
			return this.http.post<DescribeExportConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeExportConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DescribeExportTasks(requestBody: DescribeExportTasksRequest, headersHandler?: () => HttpHeaders): Observable<DescribeExportTasksResponse> {
			return this.http.post<DescribeExportTasksResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeExportTasks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeImportTasks(maxResults: string, nextToken: string, requestBody: DescribeImportTasksRequest, headersHandler?: () => HttpHeaders): Observable<DescribeImportTasksResponse> {
			return this.http.post<DescribeImportTasksResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeImportTasks?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTagsResponse> {
			return this.http.post<DescribeTagsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateConfigurationItemsFromApplication(requestBody: DisassociateConfigurationItemsFromApplicationRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateConfigurationItemsFromApplicationResponse> {
			return this.http.post<DisassociateConfigurationItemsFromApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DisassociateConfigurationItemsFromApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ExportConfigurations(headersHandler?: () => HttpHeaders): Observable<ExportConfigurationsResponse> {
			return this.http.post<ExportConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ExportConfigurations', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetDiscoverySummary(requestBody: GetDiscoverySummaryRequest, headersHandler?: () => HttpHeaders): Observable<GetDiscoverySummaryResponse> {
			return this.http.post<GetDiscoverySummaryResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.GetDiscoverySummary', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListConfigurations(requestBody: ListConfigurationsRequest, headersHandler?: () => HttpHeaders): Observable<ListConfigurationsResponse> {
			return this.http.post<ListConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListServerNeighbors(requestBody: ListServerNeighborsRequest, headersHandler?: () => HttpHeaders): Observable<ListServerNeighborsResponse> {
			return this.http.post<ListServerNeighborsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListServerNeighbors', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartContinuousExport(requestBody: StartContinuousExportRequest, headersHandler?: () => HttpHeaders): Observable<StartContinuousExportResponse> {
			return this.http.post<StartContinuousExportResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartContinuousExport', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartDataCollectionByAgentIds(requestBody: StartDataCollectionByAgentIdsRequest, headersHandler?: () => HttpHeaders): Observable<StartDataCollectionByAgentIdsResponse> {
			return this.http.post<StartDataCollectionByAgentIdsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartDataCollectionByAgentIds', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartExportTask(requestBody: StartExportTaskRequest, headersHandler?: () => HttpHeaders): Observable<StartExportTaskResponse> {
			return this.http.post<StartExportTaskResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartExportTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartImportTask(requestBody: StartImportTaskRequest, headersHandler?: () => HttpHeaders): Observable<StartImportTaskResponse> {
			return this.http.post<StartImportTaskResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartImportTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopContinuousExport(requestBody: StopContinuousExportRequest, headersHandler?: () => HttpHeaders): Observable<StopContinuousExportResponse> {
			return this.http.post<StopContinuousExportResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopContinuousExport', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopDataCollectionByAgentIds(requestBody: StopDataCollectionByAgentIdsRequest, headersHandler?: () => HttpHeaders): Observable<StopDataCollectionByAgentIdsResponse> {
			return this.http.post<StopDataCollectionByAgentIdsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopDataCollectionByAgentIds', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UpdateApplication(requestBody: UpdateApplicationRequest, headersHandler?: () => HttpHeaders): Observable<UpdateApplicationResponse> {
			return this.http.post<UpdateApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.UpdateApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
