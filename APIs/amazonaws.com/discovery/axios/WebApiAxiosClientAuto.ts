...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateConfigurationItemsToApplication(requestBody: AssociateConfigurationItemsToApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateConfigurationItemsToApplicationResponse> {
			return Axios.post<AssociateConfigurationItemsToApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDeleteImportData(requestBody: BatchDeleteImportDataRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteImportDataResponse> {
			return Axios.post<BatchDeleteImportDataResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.BatchDeleteImportData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateApplication(requestBody: CreateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateApplicationResponse> {
			return Axios.post<CreateApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTags(requestBody: CreateTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTagsResponse> {
			return Axios.post<CreateTagsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApplications(requestBody: DeleteApplicationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationsResponse> {
			return Axios.post<DeleteApplicationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteApplications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTags(requestBody: DeleteTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsResponse> {
			return Axios.post<DeleteTagsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAgents(requestBody: DescribeAgentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAgentsResponse> {
			return Axios.post<DescribeAgentsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeAgents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeConfigurations(requestBody: DescribeConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationsResponse> {
			return Axios.post<DescribeConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeContinuousExports(maxResults: string, nextToken: string, requestBody: DescribeContinuousExportsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeContinuousExportsResponse> {
			return Axios.post<DescribeContinuousExportsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeContinuousExports?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeImportTasks(maxResults: string, nextToken: string, requestBody: DescribeImportTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImportTasksResponse> {
			return Axios.post<DescribeImportTasksResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeImportTasks?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResponse> {
			return Axios.post<DescribeTagsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateConfigurationItemsFromApplication(requestBody: DisassociateConfigurationItemsFromApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateConfigurationItemsFromApplicationResponse> {
			return Axios.post<DisassociateConfigurationItemsFromApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DisassociateConfigurationItemsFromApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ExportConfigurations(headersHandler?: () => {[header: string]: string}): Promise<ExportConfigurationsResponse> {
			return Axios.post<ExportConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ExportConfigurations', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetDiscoverySummary(requestBody: GetDiscoverySummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiscoverySummaryResponse> {
			return Axios.post<GetDiscoverySummaryResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.GetDiscoverySummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListConfigurations(requestBody: ListConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationsResponse> {
			return Axios.post<ListConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListServerNeighbors(requestBody: ListServerNeighborsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListServerNeighborsResponse> {
			return Axios.post<ListServerNeighborsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListServerNeighbors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartDataCollectionByAgentIds(requestBody: StartDataCollectionByAgentIdsRequest, headersHandler?: () => {[header: string]: string}): Promise<StartDataCollectionByAgentIdsResponse> {
			return Axios.post<StartDataCollectionByAgentIdsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartDataCollectionByAgentIds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartExportTask(requestBody: StartExportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<StartExportTaskResponse> {
			return Axios.post<StartExportTaskResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartExportTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartImportTask(requestBody: StartImportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<StartImportTaskResponse> {
			return Axios.post<StartImportTaskResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartImportTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopContinuousExport(requestBody: StopContinuousExportRequest, headersHandler?: () => {[header: string]: string}): Promise<StopContinuousExportResponse> {
			return Axios.post<StopContinuousExportResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopContinuousExport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopDataCollectionByAgentIds(requestBody: StopDataCollectionByAgentIdsRequest, headersHandler?: () => {[header: string]: string}): Promise<StopDataCollectionByAgentIdsResponse> {
			return Axios.post<StopDataCollectionByAgentIdsResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopDataCollectionByAgentIds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateApplication(requestBody: UpdateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateApplicationResponse> {
			return Axios.post<UpdateApplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.UpdateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
