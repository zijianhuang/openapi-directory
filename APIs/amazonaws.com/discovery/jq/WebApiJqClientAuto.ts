...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateConfigurationItemsToApplication(callback: (data : AssociateConfigurationItemsToApplicationResponse) => any, requestBody: AssociateConfigurationItemsToApplicationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		BatchDeleteImportData(callback: (data : BatchDeleteImportDataResponse) => any, requestBody: BatchDeleteImportDataRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.BatchDeleteImportData', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		CreateApplication(callback: (data : CreateApplicationResponse) => any, requestBody: CreateApplicationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateApplication', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTags(callback: (data : CreateTagsResponse) => any, requestBody: CreateTagsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.CreateTags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteApplications(callback: (data : DeleteApplicationsResponse) => any, requestBody: DeleteApplicationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteApplications', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTags(callback: (data : DeleteTagsResponse) => any, requestBody: DeleteTagsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DeleteTags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAgents(callback: (data : DescribeAgentsResponse) => any, requestBody: DescribeAgentsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeAgents', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeConfigurations(callback: (data : DescribeConfigurationsResponse) => any, requestBody: DescribeConfigurationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeConfigurations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeContinuousExports(maxResults: string, nextToken: string, callback: (data : DescribeContinuousExportsResponse) => any, requestBody: DescribeContinuousExportsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeContinuousExports?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeExportConfigurations(callback: (data : DescribeExportConfigurationsResponse) => any, requestBody: DescribeExportConfigurationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeExportConfigurations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DescribeExportTasks(callback: (data : DescribeExportTasksResponse) => any, requestBody: DescribeExportTasksRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeExportTasks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeImportTasks(maxResults: string, nextToken: string, callback: (data : DescribeImportTasksResponse) => any, requestBody: DescribeImportTasksRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeImportTasks?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DescribeTags(callback: (data : DescribeTagsResponse) => any, requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DescribeTags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateConfigurationItemsFromApplication(callback: (data : DisassociateConfigurationItemsFromApplicationResponse) => any, requestBody: DisassociateConfigurationItemsFromApplicationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.DisassociateConfigurationItemsFromApplication', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ExportConfigurations(callback: (data : ExportConfigurationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ExportConfigurations', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDiscoverySummary(callback: (data : GetDiscoverySummaryResponse) => any, requestBody: GetDiscoverySummaryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.GetDiscoverySummary', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListConfigurations(callback: (data : ListConfigurationsResponse) => any, requestBody: ListConfigurationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListConfigurations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListServerNeighbors(callback: (data : ListServerNeighborsResponse) => any, requestBody: ListServerNeighborsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.ListServerNeighbors', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartContinuousExport(callback: (data : StartContinuousExportResponse) => any, requestBody: StartContinuousExportRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartContinuousExport', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartDataCollectionByAgentIds(callback: (data : StartDataCollectionByAgentIdsResponse) => any, requestBody: StartDataCollectionByAgentIdsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartDataCollectionByAgentIds', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartExportTask(callback: (data : StartExportTaskResponse) => any, requestBody: StartExportTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartExportTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartImportTask(callback: (data : StartImportTaskResponse) => any, requestBody: StartImportTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StartImportTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopContinuousExport(callback: (data : StopContinuousExportResponse) => any, requestBody: StopContinuousExportRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopContinuousExport', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopDataCollectionByAgentIds(callback: (data : StopDataCollectionByAgentIdsResponse) => any, requestBody: StopDataCollectionByAgentIdsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.StopDataCollectionByAgentIds', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UpdateApplication(callback: (data : UpdateApplicationResponse) => any, requestBody: UpdateApplicationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSPoseidonService_V2015_11_01.UpdateApplication', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
