...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetSnapshotBlock(snapshotId: string, blockIndex: number, blockToken: string, headersHandler?: () => HttpHeaders): Observable<GetSnapshotBlockResponse> {
			return this.http.get<GetSnapshotBlockResponse>(this.baseUri + '/snapshots/' + (snapshotId == null ? '' : encodeURIComponent(snapshotId)) + '/blocks/' + blockIndex + '#blockToken&blockToken=' + (blockToken == null ? '' : encodeURIComponent(blockToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListChangedBlocks(firstSnapshotId: string, secondSnapshotId: string, pageToken: string, maxResults: number, startingBlockIndex: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListChangedBlocksResponse> {
		 ...
		 */
		ListSnapshotBlocks(snapshotId: string, pageToken: string, maxResults: number, startingBlockIndex: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListSnapshotBlocksResponse> {
