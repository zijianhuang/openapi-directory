...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelImageCreation(requestBody: CancelImageCreationBody, headersHandler?: () => {[header: string]: string}): Promise<CancelImageCreationResponse> {
			return Axios.put<CancelImageCreationResponse>(this.baseUri + '/CancelImageCreation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateComponent(requestBody: CreateComponentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateComponentResponse> {
			return Axios.put<CreateComponentResponse>(this.baseUri + '/CreateComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateDistributionConfiguration(requestBody: CreateDistributionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDistributionConfigurationResponse> {
			return Axios.put<CreateDistributionConfigurationResponse>(this.baseUri + '/CreateDistributionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateImage(requestBody: CreateImageBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImageResponse> {
			return Axios.put<CreateImageResponse>(this.baseUri + '/CreateImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateImagePipeline(requestBody: CreateImagePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImagePipelineResponse> {
			return Axios.put<CreateImagePipelineResponse>(this.baseUri + '/CreateImagePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateImageRecipe(requestBody: CreateImageRecipeBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImageRecipeResponse> {
			return Axios.put<CreateImageRecipeResponse>(this.baseUri + '/CreateImageRecipe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateInfrastructureConfiguration(requestBody: CreateInfrastructureConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInfrastructureConfigurationResponse> {
			return Axios.put<CreateInfrastructureConfigurationResponse>(this.baseUri + '/CreateInfrastructureConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteComponent(componentBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteComponentResponse> {
			return Axios.delete<DeleteComponentResponse>(this.baseUri + '/DeleteComponent#componentBuildVersionArn?componentBuildVersionArn=' + (componentBuildVersionArn == null ? '' : encodeURIComponent(componentBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteDistributionConfiguration(distributionConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDistributionConfigurationResponse> {
			return Axios.delete<DeleteDistributionConfigurationResponse>(this.baseUri + '/DeleteDistributionConfiguration#distributionConfigurationArn?distributionConfigurationArn=' + (distributionConfigurationArn == null ? '' : encodeURIComponent(distributionConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteImage(imageBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageResponse> {
			return Axios.delete<DeleteImageResponse>(this.baseUri + '/DeleteImage#imageBuildVersionArn?imageBuildVersionArn=' + (imageBuildVersionArn == null ? '' : encodeURIComponent(imageBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteImagePipeline(imagePipelineArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImagePipelineResponse> {
			return Axios.delete<DeleteImagePipelineResponse>(this.baseUri + '/DeleteImagePipeline#imagePipelineArn?imagePipelineArn=' + (imagePipelineArn == null ? '' : encodeURIComponent(imagePipelineArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteImageRecipe(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageRecipeResponse> {
			return Axios.delete<DeleteImageRecipeResponse>(this.baseUri + '/DeleteImageRecipe#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteInfrastructureConfiguration(infrastructureConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInfrastructureConfigurationResponse> {
			return Axios.delete<DeleteInfrastructureConfigurationResponse>(this.baseUri + '/DeleteInfrastructureConfiguration#infrastructureConfigurationArn?infrastructureConfigurationArn=' + (infrastructureConfigurationArn == null ? '' : encodeURIComponent(infrastructureConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetComponent(componentBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetComponentResponse> {
			return Axios.get<GetComponentResponse>(this.baseUri + '/GetComponent#componentBuildVersionArn?componentBuildVersionArn=' + (componentBuildVersionArn == null ? '' : encodeURIComponent(componentBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetComponentPolicy(componentArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetComponentPolicyResponse> {
			return Axios.get<GetComponentPolicyResponse>(this.baseUri + '/GetComponentPolicy#componentArn?componentArn=' + (componentArn == null ? '' : encodeURIComponent(componentArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetDistributionConfiguration(distributionConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetDistributionConfigurationResponse> {
			return Axios.get<GetDistributionConfigurationResponse>(this.baseUri + '/GetDistributionConfiguration#distributionConfigurationArn?distributionConfigurationArn=' + (distributionConfigurationArn == null ? '' : encodeURIComponent(distributionConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetImage(imageBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageResponse> {
			return Axios.get<GetImageResponse>(this.baseUri + '/GetImage#imageBuildVersionArn?imageBuildVersionArn=' + (imageBuildVersionArn == null ? '' : encodeURIComponent(imageBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetImagePipeline(imagePipelineArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImagePipelineResponse> {
			return Axios.get<GetImagePipelineResponse>(this.baseUri + '/GetImagePipeline#imagePipelineArn?imagePipelineArn=' + (imagePipelineArn == null ? '' : encodeURIComponent(imagePipelineArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetImagePolicy(imageArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImagePolicyResponse> {
			return Axios.get<GetImagePolicyResponse>(this.baseUri + '/GetImagePolicy#imageArn?imageArn=' + (imageArn == null ? '' : encodeURIComponent(imageArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetImageRecipe(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageRecipeResponse> {
			return Axios.get<GetImageRecipeResponse>(this.baseUri + '/GetImageRecipe#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetImageRecipePolicy(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageRecipePolicyResponse> {
			return Axios.get<GetImageRecipePolicyResponse>(this.baseUri + '/GetImageRecipePolicy#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetInfrastructureConfiguration(infrastructureConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetInfrastructureConfigurationResponse> {
			return Axios.get<GetInfrastructureConfigurationResponse>(this.baseUri + '/GetInfrastructureConfiguration#infrastructureConfigurationArn?infrastructureConfigurationArn=' + (infrastructureConfigurationArn == null ? '' : encodeURIComponent(infrastructureConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ImportComponent(requestBody: ImportComponentBody, headersHandler?: () => {[header: string]: string}): Promise<ImportComponentResponse> {
			return Axios.put<ImportComponentResponse>(this.baseUri + '/ImportComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListComponentBuildVersions(maxResults: string, nextToken: string, requestBody: ListComponentBuildVersionsBody, headersHandler?: () => {[header: string]: string}): Promise<ListComponentBuildVersionsResponse> {
			return Axios.post<ListComponentBuildVersionsResponse>(this.baseUri + '/ListComponentBuildVersions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListComponents(maxResults: string, nextToken: string, requestBody: ListComponentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListComponentsResponse> {
			return Axios.post<ListComponentsResponse>(this.baseUri + '/ListComponents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListDistributionConfigurations(maxResults: string, nextToken: string, requestBody: ListDistributionConfigurationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListDistributionConfigurationsResponse> {
			return Axios.post<ListDistributionConfigurationsResponse>(this.baseUri + '/ListDistributionConfigurations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListImageBuildVersions(maxResults: string, nextToken: string, requestBody: ListImageBuildVersionsBody, headersHandler?: () => {[header: string]: string}): Promise<ListImageBuildVersionsResponse> {
			return Axios.post<ListImageBuildVersionsResponse>(this.baseUri + '/ListImageBuildVersions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListImagePipelineImages(maxResults: string, nextToken: string, requestBody: ListImagePipelineImagesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagePipelineImagesResponse> {
			return Axios.post<ListImagePipelineImagesResponse>(this.baseUri + '/ListImagePipelineImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListImagePipelines(maxResults: string, nextToken: string, requestBody: ListImagePipelinesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagePipelinesResponse> {
			return Axios.post<ListImagePipelinesResponse>(this.baseUri + '/ListImagePipelines?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListImageRecipes(maxResults: string, nextToken: string, requestBody: ListImageRecipesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImageRecipesResponse> {
			return Axios.post<ListImageRecipesResponse>(this.baseUri + '/ListImageRecipes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListImages(maxResults: string, nextToken: string, requestBody: ListImagesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagesResponse> {
			return Axios.post<ListImagesResponse>(this.baseUri + '/ListImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListInfrastructureConfigurations(maxResults: string, nextToken: string, requestBody: ListInfrastructureConfigurationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListInfrastructureConfigurationsResponse> {
			return Axios.post<ListInfrastructureConfigurationsResponse>(this.baseUri + '/ListInfrastructureConfigurations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutComponentPolicy(requestBody: PutComponentPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutComponentPolicyResponse> {
			return Axios.put<PutComponentPolicyResponse>(this.baseUri + '/PutComponentPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutImagePolicy(requestBody: PutImagePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutImagePolicyResponse> {
			return Axios.put<PutImagePolicyResponse>(this.baseUri + '/PutImagePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutImageRecipePolicy(requestBody: PutImageRecipePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutImageRecipePolicyResponse> {
			return Axios.put<PutImageRecipePolicyResponse>(this.baseUri + '/PutImageRecipePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartImagePipelineExecution(requestBody: StartImagePipelineExecutionBody, headersHandler?: () => {[header: string]: string}): Promise<StartImagePipelineExecutionResponse> {
			return Axios.put<StartImagePipelineExecutionResponse>(this.baseUri + '/StartImagePipelineExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateDistributionConfiguration(requestBody: UpdateDistributionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDistributionConfigurationResponse> {
			return Axios.put<UpdateDistributionConfigurationResponse>(this.baseUri + '/UpdateDistributionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateImagePipeline(requestBody: UpdateImagePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateImagePipelineResponse> {
			return Axios.put<UpdateImagePipelineResponse>(this.baseUri + '/UpdateImagePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateInfrastructureConfiguration(requestBody: UpdateInfrastructureConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInfrastructureConfigurationResponse> {
			return Axios.put<UpdateInfrastructureConfigurationResponse>(this.baseUri + '/UpdateInfrastructureConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
