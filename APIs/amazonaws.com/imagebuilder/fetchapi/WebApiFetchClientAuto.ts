export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelImageCreation(requestBody: CancelImageCreationBody, headersHandler?: () => {[header: string]: string}): Promise<CancelImageCreationResponse> {
			return fetch(this.baseUri + '/CancelImageCreation', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateComponent(requestBody: CreateComponentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateComponentResponse> {
			return fetch(this.baseUri + '/CreateComponent', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDistributionConfiguration(requestBody: CreateDistributionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDistributionConfigurationResponse> {
			return fetch(this.baseUri + '/CreateDistributionConfiguration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateImage(requestBody: CreateImageBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImageResponse> {
			return fetch(this.baseUri + '/CreateImage', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateImagePipeline(requestBody: CreateImagePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImagePipelineResponse> {
			return fetch(this.baseUri + '/CreateImagePipeline', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateImageRecipe(requestBody: CreateImageRecipeBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImageRecipeResponse> {
			return fetch(this.baseUri + '/CreateImageRecipe', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateInfrastructureConfiguration(requestBody: CreateInfrastructureConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInfrastructureConfigurationResponse> {
			return fetch(this.baseUri + '/CreateInfrastructureConfiguration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteComponent(componentBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteComponentResponse> {
			return fetch(this.baseUri + '/DeleteComponent#componentBuildVersionArn?componentBuildVersionArn=' + (componentBuildVersionArn == null ? '' : encodeURIComponent(componentBuildVersionArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDistributionConfiguration(distributionConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDistributionConfigurationResponse> {
			return fetch(this.baseUri + '/DeleteDistributionConfiguration#distributionConfigurationArn?distributionConfigurationArn=' + (distributionConfigurationArn == null ? '' : encodeURIComponent(distributionConfigurationArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteImage(imageBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageResponse> {
			return fetch(this.baseUri + '/DeleteImage#imageBuildVersionArn?imageBuildVersionArn=' + (imageBuildVersionArn == null ? '' : encodeURIComponent(imageBuildVersionArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteImagePipeline(imagePipelineArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImagePipelineResponse> {
			return fetch(this.baseUri + '/DeleteImagePipeline#imagePipelineArn?imagePipelineArn=' + (imagePipelineArn == null ? '' : encodeURIComponent(imagePipelineArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteImageRecipe(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageRecipeResponse> {
			return fetch(this.baseUri + '/DeleteImageRecipe#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteInfrastructureConfiguration(infrastructureConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInfrastructureConfigurationResponse> {
			return fetch(this.baseUri + '/DeleteInfrastructureConfiguration#infrastructureConfigurationArn?infrastructureConfigurationArn=' + (infrastructureConfigurationArn == null ? '' : encodeURIComponent(infrastructureConfigurationArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetComponent(componentBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetComponentResponse> {
			return fetch(this.baseUri + '/GetComponent#componentBuildVersionArn?componentBuildVersionArn=' + (componentBuildVersionArn == null ? '' : encodeURIComponent(componentBuildVersionArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetComponentPolicy(componentArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetComponentPolicyResponse> {
			return fetch(this.baseUri + '/GetComponentPolicy#componentArn?componentArn=' + (componentArn == null ? '' : encodeURIComponent(componentArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDistributionConfiguration(distributionConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetDistributionConfigurationResponse> {
			return fetch(this.baseUri + '/GetDistributionConfiguration#distributionConfigurationArn?distributionConfigurationArn=' + (distributionConfigurationArn == null ? '' : encodeURIComponent(distributionConfigurationArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImage(imageBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageResponse> {
			return fetch(this.baseUri + '/GetImage#imageBuildVersionArn?imageBuildVersionArn=' + (imageBuildVersionArn == null ? '' : encodeURIComponent(imageBuildVersionArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImagePipeline(imagePipelineArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImagePipelineResponse> {
			return fetch(this.baseUri + '/GetImagePipeline#imagePipelineArn?imagePipelineArn=' + (imagePipelineArn == null ? '' : encodeURIComponent(imagePipelineArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImagePolicy(imageArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImagePolicyResponse> {
			return fetch(this.baseUri + '/GetImagePolicy#imageArn?imageArn=' + (imageArn == null ? '' : encodeURIComponent(imageArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImageRecipe(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageRecipeResponse> {
			return fetch(this.baseUri + '/GetImageRecipe#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImageRecipePolicy(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageRecipePolicyResponse> {
			return fetch(this.baseUri + '/GetImageRecipePolicy#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetInfrastructureConfiguration(infrastructureConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetInfrastructureConfigurationResponse> {
			return fetch(this.baseUri + '/GetInfrastructureConfiguration#infrastructureConfigurationArn?infrastructureConfigurationArn=' + (infrastructureConfigurationArn == null ? '' : encodeURIComponent(infrastructureConfigurationArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ImportComponent(requestBody: ImportComponentBody, headersHandler?: () => {[header: string]: string}): Promise<ImportComponentResponse> {
			return fetch(this.baseUri + '/ImportComponent', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListComponents(maxResults: string, nextToken: string, requestBody: ListComponentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListComponentsResponse> {
			return fetch(this.baseUri + '/ListComponents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDistributionConfigurations(maxResults: string, nextToken: string, requestBody: ListDistributionConfigurationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListDistributionConfigurationsResponse> {
			return fetch(this.baseUri + '/ListDistributionConfigurations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListImagePipelineImages(maxResults: string, nextToken: string, requestBody: ListImagePipelineImagesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagePipelineImagesResponse> {
			return fetch(this.baseUri + '/ListImagePipelineImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListImagePipelines(maxResults: string, nextToken: string, requestBody: ListImagePipelinesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagePipelinesResponse> {
			return fetch(this.baseUri + '/ListImagePipelines?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListImageRecipes(maxResults: string, nextToken: string, requestBody: ListImageRecipesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImageRecipesResponse> {
			return fetch(this.baseUri + '/ListImageRecipes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListImages(maxResults: string, nextToken: string, requestBody: ListImagesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagesResponse> {
			return fetch(this.baseUri + '/ListImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListInfrastructureConfigurations(maxResults: string, nextToken: string, requestBody: ListInfrastructureConfigurationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListInfrastructureConfigurationsResponse> {
			return fetch(this.baseUri + '/ListInfrastructureConfigurations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutComponentPolicy(requestBody: PutComponentPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutComponentPolicyResponse> {
			return fetch(this.baseUri + '/PutComponentPolicy', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutImagePolicy(requestBody: PutImagePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutImagePolicyResponse> {
			return fetch(this.baseUri + '/PutImagePolicy', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutImageRecipePolicy(requestBody: PutImageRecipePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutImageRecipePolicyResponse> {
			return fetch(this.baseUri + '/PutImageRecipePolicy', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartImagePipelineExecution(requestBody: StartImagePipelineExecutionBody, headersHandler?: () => {[header: string]: string}): Promise<StartImagePipelineExecutionResponse> {
			return fetch(this.baseUri + '/StartImagePipelineExecution', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDistributionConfiguration(requestBody: UpdateDistributionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDistributionConfigurationResponse> {
			return fetch(this.baseUri + '/UpdateDistributionConfiguration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateImagePipeline(requestBody: UpdateImagePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateImagePipelineResponse> {
			return fetch(this.baseUri + '/UpdateImagePipeline', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateInfrastructureConfiguration(requestBody: UpdateInfrastructureConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInfrastructureConfigurationResponse> {
			return fetch(this.baseUri + '/UpdateInfrastructureConfiguration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
