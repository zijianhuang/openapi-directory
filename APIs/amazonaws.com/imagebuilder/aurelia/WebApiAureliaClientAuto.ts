...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelImageCreation(requestBody: CancelImageCreationBody, headersHandler?: () => {[header: string]: string}): Promise<CancelImageCreationResponse> {
			return this.http.put('/CancelImageCreation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateComponent(requestBody: CreateComponentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateComponentResponse> {
			return this.http.put('/CreateComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDistributionConfiguration(requestBody: CreateDistributionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDistributionConfigurationResponse> {
			return this.http.put('/CreateDistributionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateImage(requestBody: CreateImageBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImageResponse> {
			return this.http.put('/CreateImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateImagePipeline(requestBody: CreateImagePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImagePipelineResponse> {
			return this.http.put('/CreateImagePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateImageRecipe(requestBody: CreateImageRecipeBody, headersHandler?: () => {[header: string]: string}): Promise<CreateImageRecipeResponse> {
			return this.http.put('/CreateImageRecipe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateInfrastructureConfiguration(requestBody: CreateInfrastructureConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInfrastructureConfigurationResponse> {
			return this.http.put('/CreateInfrastructureConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteComponent(componentBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteComponentResponse> {
			return this.http.delete('/DeleteComponent#componentBuildVersionArn?componentBuildVersionArn=' + (componentBuildVersionArn == null ? '' : encodeURIComponent(componentBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDistributionConfiguration(distributionConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDistributionConfigurationResponse> {
			return this.http.delete('/DeleteDistributionConfiguration#distributionConfigurationArn?distributionConfigurationArn=' + (distributionConfigurationArn == null ? '' : encodeURIComponent(distributionConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteImage(imageBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageResponse> {
			return this.http.delete('/DeleteImage#imageBuildVersionArn?imageBuildVersionArn=' + (imageBuildVersionArn == null ? '' : encodeURIComponent(imageBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteImagePipeline(imagePipelineArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImagePipelineResponse> {
			return this.http.delete('/DeleteImagePipeline#imagePipelineArn?imagePipelineArn=' + (imagePipelineArn == null ? '' : encodeURIComponent(imagePipelineArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteImageRecipe(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageRecipeResponse> {
			return this.http.delete('/DeleteImageRecipe#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteInfrastructureConfiguration(infrastructureConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInfrastructureConfigurationResponse> {
			return this.http.delete('/DeleteInfrastructureConfiguration#infrastructureConfigurationArn?infrastructureConfigurationArn=' + (infrastructureConfigurationArn == null ? '' : encodeURIComponent(infrastructureConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetComponent(componentBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetComponentResponse> {
			return this.http.get('/GetComponent#componentBuildVersionArn?componentBuildVersionArn=' + (componentBuildVersionArn == null ? '' : encodeURIComponent(componentBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetComponentPolicy(componentArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetComponentPolicyResponse> {
			return this.http.get('/GetComponentPolicy#componentArn?componentArn=' + (componentArn == null ? '' : encodeURIComponent(componentArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDistributionConfiguration(distributionConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetDistributionConfigurationResponse> {
			return this.http.get('/GetDistributionConfiguration#distributionConfigurationArn?distributionConfigurationArn=' + (distributionConfigurationArn == null ? '' : encodeURIComponent(distributionConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImage(imageBuildVersionArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageResponse> {
			return this.http.get('/GetImage#imageBuildVersionArn?imageBuildVersionArn=' + (imageBuildVersionArn == null ? '' : encodeURIComponent(imageBuildVersionArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImagePipeline(imagePipelineArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImagePipelineResponse> {
			return this.http.get('/GetImagePipeline#imagePipelineArn?imagePipelineArn=' + (imagePipelineArn == null ? '' : encodeURIComponent(imagePipelineArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImagePolicy(imageArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImagePolicyResponse> {
			return this.http.get('/GetImagePolicy#imageArn?imageArn=' + (imageArn == null ? '' : encodeURIComponent(imageArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImageRecipe(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageRecipeResponse> {
			return this.http.get('/GetImageRecipe#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImageRecipePolicy(imageRecipeArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetImageRecipePolicyResponse> {
			return this.http.get('/GetImageRecipePolicy#imageRecipeArn?imageRecipeArn=' + (imageRecipeArn == null ? '' : encodeURIComponent(imageRecipeArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetInfrastructureConfiguration(infrastructureConfigurationArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetInfrastructureConfigurationResponse> {
			return this.http.get('/GetInfrastructureConfiguration#infrastructureConfigurationArn?infrastructureConfigurationArn=' + (infrastructureConfigurationArn == null ? '' : encodeURIComponent(infrastructureConfigurationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ImportComponent(requestBody: ImportComponentBody, headersHandler?: () => {[header: string]: string}): Promise<ImportComponentResponse> {
			return this.http.put('/ImportComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListComponents(maxResults: string, nextToken: string, requestBody: ListComponentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListComponentsResponse> {
			return this.http.post('/ListComponents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDistributionConfigurations(maxResults: string, nextToken: string, requestBody: ListDistributionConfigurationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListDistributionConfigurationsResponse> {
			return this.http.post('/ListDistributionConfigurations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListImagePipelineImages(maxResults: string, nextToken: string, requestBody: ListImagePipelineImagesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagePipelineImagesResponse> {
			return this.http.post('/ListImagePipelineImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListImagePipelines(maxResults: string, nextToken: string, requestBody: ListImagePipelinesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagePipelinesResponse> {
			return this.http.post('/ListImagePipelines?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListImageRecipes(maxResults: string, nextToken: string, requestBody: ListImageRecipesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImageRecipesResponse> {
			return this.http.post('/ListImageRecipes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListImages(maxResults: string, nextToken: string, requestBody: ListImagesBody, headersHandler?: () => {[header: string]: string}): Promise<ListImagesResponse> {
			return this.http.post('/ListImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInfrastructureConfigurations(maxResults: string, nextToken: string, requestBody: ListInfrastructureConfigurationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListInfrastructureConfigurationsResponse> {
			return this.http.post('/ListInfrastructureConfigurations?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutComponentPolicy(requestBody: PutComponentPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutComponentPolicyResponse> {
			return this.http.put('/PutComponentPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutImagePolicy(requestBody: PutImagePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutImagePolicyResponse> {
			return this.http.put('/PutImagePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutImageRecipePolicy(requestBody: PutImageRecipePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<PutImageRecipePolicyResponse> {
			return this.http.put('/PutImageRecipePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartImagePipelineExecution(requestBody: StartImagePipelineExecutionBody, headersHandler?: () => {[header: string]: string}): Promise<StartImagePipelineExecutionResponse> {
			return this.http.put('/StartImagePipelineExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDistributionConfiguration(requestBody: UpdateDistributionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDistributionConfigurationResponse> {
			return this.http.put('/UpdateDistributionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateImagePipeline(requestBody: UpdateImagePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateImagePipelineResponse> {
			return this.http.put('/UpdateImagePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateInfrastructureConfiguration(requestBody: UpdateInfrastructureConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInfrastructureConfigurationResponse> {
			return this.http.put('/UpdateInfrastructureConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
