...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJob(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ReadJob(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadJobResponse> {
			return this.http.get('/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateJob(requestBody: CreateJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2012-09-25/jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreatePipeline(requestBody: CreatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2012-09-25/pipelines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListPipelines(Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesResponse> {
			return this.http.get('/2012-09-25/pipelines?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePreset(requestBody: CreatePresetBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2012-09-25/presets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListPresets(Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPresetsResponse> {
			return this.http.get('/2012-09-25/presets?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeletePipeline(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ReadPipeline(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadPipelineResponse> {
			return this.http.get('/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdatePipeline(Id: string, requestBody: UpdatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineResponse> {
			return this.http.put('/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeletePreset(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ReadPreset(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadPresetResponse> {
			return this.http.get('/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListJobsByPipeline(PipelineId: string, Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobsByPipelineResponse> {
			return this.http.get('/2012-09-25/jobsByPipeline/' + (PipelineId == null ? '' : encodeURIComponent(PipelineId)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListJobsByStatus(Status: string, Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobsByStatusResponse> {
			return this.http.get('/2012-09-25/jobsByStatus/' + (Status == null ? '' : encodeURIComponent(Status)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TestRole(requestBody: TestRoleBody, headersHandler?: () => {[header: string]: string}): Promise<TestRoleResponse> {
			return this.http.post('/2012-09-25/roleTests', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdatePipelineNotifications(Id: string, requestBody: UpdatePipelineNotificationsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineNotificationsResponse> {
			return this.http.post('/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/notifications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdatePipelineStatus(Id: string, requestBody: UpdatePipelineStatusBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineStatusResponse> {
			return this.http.post('/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/status', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
