export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJob(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ReadJob(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadJobResponse> {
			return fetch(this.baseUri + '/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateJob(requestBody: CreateJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2012-09-25/jobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreatePipeline(requestBody: CreatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2012-09-25/pipelines', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		ListPipelines(Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesResponse> {
			return fetch(this.baseUri + '/2012-09-25/pipelines?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePreset(requestBody: CreatePresetBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2012-09-25/presets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		ListPresets(Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPresetsResponse> {
			return fetch(this.baseUri + '/2012-09-25/presets?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeletePipeline(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ReadPipeline(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadPipelineResponse> {
			return fetch(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		UpdatePipeline(Id: string, requestBody: UpdatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineResponse> {
			return fetch(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeletePreset(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ReadPreset(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadPresetResponse> {
			return fetch(this.baseUri + '/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		ListJobsByPipeline(PipelineId: string, Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobsByPipelineResponse> {
			return fetch(this.baseUri + '/2012-09-25/jobsByPipeline/' + (PipelineId == null ? '' : encodeURIComponent(PipelineId)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		ListJobsByStatus(Status: string, Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobsByStatusResponse> {
			return fetch(this.baseUri + '/2012-09-25/jobsByStatus/' + (Status == null ? '' : encodeURIComponent(Status)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		TestRole(requestBody: TestRoleBody, headersHandler?: () => {[header: string]: string}): Promise<TestRoleResponse> {
			return fetch(this.baseUri + '/2012-09-25/roleTests', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdatePipelineNotifications(Id: string, requestBody: UpdatePipelineNotificationsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineNotificationsResponse> {
			return fetch(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/notifications', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdatePipelineStatus(Id: string, requestBody: UpdatePipelineStatusBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineStatusResponse> {
			return fetch(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/status', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
