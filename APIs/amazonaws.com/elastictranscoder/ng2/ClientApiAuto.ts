...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJob(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ReadJob(Id: string, headersHandler?: () => HttpHeaders): Observable<ReadJobResponse> {
			return this.http.get<ReadJobResponse>(this.baseUri + '/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CreateJob(requestBody: CreateJobBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2012-09-25/jobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		CreatePipeline(requestBody: CreatePipelineBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2012-09-25/pipelines', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListPipelines(Ascending: string, PageToken: string, headersHandler?: () => HttpHeaders): Observable<ListPipelinesResponse> {
			return this.http.get<ListPipelinesResponse>(this.baseUri + '/2012-09-25/pipelines?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CreatePreset(requestBody: CreatePresetBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2012-09-25/presets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListPresets(Ascending: string, PageToken: string, headersHandler?: () => HttpHeaders): Observable<ListPresetsResponse> {
			return this.http.get<ListPresetsResponse>(this.baseUri + '/2012-09-25/presets?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeletePipeline(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ReadPipeline(Id: string, headersHandler?: () => HttpHeaders): Observable<ReadPipelineResponse> {
			return this.http.get<ReadPipelineResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdatePipeline(Id: string, requestBody: UpdatePipelineBody, headersHandler?: () => HttpHeaders): Observable<UpdatePipelineResponse> {
			return this.http.put<UpdatePipelineResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeletePreset(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ReadPreset(Id: string, headersHandler?: () => HttpHeaders): Observable<ReadPresetResponse> {
			return this.http.get<ReadPresetResponse>(this.baseUri + '/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListJobsByPipeline(PipelineId: string, Ascending: string, PageToken: string, headersHandler?: () => HttpHeaders): Observable<ListJobsByPipelineResponse> {
			return this.http.get<ListJobsByPipelineResponse>(this.baseUri + '/2012-09-25/jobsByPipeline/' + (PipelineId == null ? '' : encodeURIComponent(PipelineId)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListJobsByStatus(Status: string, Ascending: string, PageToken: string, headersHandler?: () => HttpHeaders): Observable<ListJobsByStatusResponse> {
			return this.http.get<ListJobsByStatusResponse>(this.baseUri + '/2012-09-25/jobsByStatus/' + (Status == null ? '' : encodeURIComponent(Status)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		TestRole(requestBody: TestRoleBody, headersHandler?: () => HttpHeaders): Observable<TestRoleResponse> {
			return this.http.post<TestRoleResponse>(this.baseUri + '/2012-09-25/roleTests', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdatePipelineNotifications(Id: string, requestBody: UpdatePipelineNotificationsBody, headersHandler?: () => HttpHeaders): Observable<UpdatePipelineNotificationsResponse> {
			return this.http.post<UpdatePipelineNotificationsResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/notifications', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdatePipelineStatus(Id: string, requestBody: UpdatePipelineStatusBody, headersHandler?: () => HttpHeaders): Observable<UpdatePipelineStatusResponse> {
			return this.http.post<UpdatePipelineStatusResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/status', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
