...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJob(Id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		ReadJob(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadJobResponse> {
			return Axios.get<ReadJobResponse>(this.baseUri + '/2012-09-25/jobs/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateJob(requestBody: CreateJobBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2012-09-25/jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		CreatePipeline(requestBody: CreatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2012-09-25/pipelines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListPipelines(Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesResponse> {
			return Axios.get<ListPipelinesResponse>(this.baseUri + '/2012-09-25/pipelines?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreatePreset(requestBody: CreatePresetBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2012-09-25/presets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListPresets(Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPresetsResponse> {
			return Axios.get<ListPresetsResponse>(this.baseUri + '/2012-09-25/presets?Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeletePipeline(Id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		ReadPipeline(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadPipelineResponse> {
			return Axios.get<ReadPipelineResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdatePipeline(Id: string, requestBody: UpdatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineResponse> {
			return Axios.put<UpdatePipelineResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeletePreset(Id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		ReadPreset(Id: string, headersHandler?: () => {[header: string]: string}): Promise<ReadPresetResponse> {
			return Axios.get<ReadPresetResponse>(this.baseUri + '/2012-09-25/presets/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListJobsByPipeline(PipelineId: string, Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobsByPipelineResponse> {
			return Axios.get<ListJobsByPipelineResponse>(this.baseUri + '/2012-09-25/jobsByPipeline/' + (PipelineId == null ? '' : encodeURIComponent(PipelineId)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListJobsByStatus(Status: string, Ascending: string, PageToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobsByStatusResponse> {
			return Axios.get<ListJobsByStatusResponse>(this.baseUri + '/2012-09-25/jobsByStatus/' + (Status == null ? '' : encodeURIComponent(Status)) + '&Ascending=' + (Ascending == null ? '' : encodeURIComponent(Ascending)) + '&PageToken=' + (PageToken == null ? '' : encodeURIComponent(PageToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		TestRole(requestBody: TestRoleBody, headersHandler?: () => {[header: string]: string}): Promise<TestRoleResponse> {
			return Axios.post<TestRoleResponse>(this.baseUri + '/2012-09-25/roleTests', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdatePipelineNotifications(Id: string, requestBody: UpdatePipelineNotificationsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineNotificationsResponse> {
			return Axios.post<UpdatePipelineNotificationsResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/notifications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdatePipelineStatus(Id: string, requestBody: UpdatePipelineStatusBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineStatusResponse> {
			return Axios.post<UpdatePipelineStatusResponse>(this.baseUri + '/2012-09-25/pipelines/' + (Id == null ? '' : encodeURIComponent(Id)) + '/status', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
