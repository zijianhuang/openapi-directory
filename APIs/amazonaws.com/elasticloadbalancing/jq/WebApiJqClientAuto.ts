...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AddTags(LoadBalancerNames: Array<AccessPointName>, Tags: Array<Tag>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AddTags?' + LoadBalancerNames.map(z => `LoadBalancerNames=${z}`).join('&') + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ApplySecurityGroupsToLoadBalancer(LoadBalancerName: string, SecurityGroups: Array<SecurityGroupId>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_AttachLoadBalancerToSubnets(LoadBalancerName: string, Subnets: Array<SubnetId>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AttachLoadBalancerToSubnets?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + Subnets.map(z => `Subnets=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ConfigureHealthCheck(LoadBalancerName: string, HealthCheck: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ConfigureHealthCheck?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&HealthCheck=' + (HealthCheck == null ? '' : encodeURIComponent(HealthCheck)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateAppCookieStickinessPolicy(LoadBalancerName: string, PolicyName: string, CookieName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_CreateLBCookieStickinessPolicy(LoadBalancerName: string, PolicyName: string, CookieExpirationPeriod: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateLBCookieStickinessPolicy?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&CookieExpirationPeriod=' + CookieExpirationPeriod + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateLoadBalancer(LoadBalancerName: string, Listeners: Array<Listener>, AvailabilityZones: Array<AvailabilityZone>, Subnets: Array<SubnetId>, SecurityGroups: Array<SecurityGroupId>, Scheme: string, Tags: Array<Tag>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateLoadBalancer?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + Listeners.map(z => `Listeners=${z}`).join('&') + '&' + AvailabilityZones.map(z => `AvailabilityZones=${z}`).join('&') + '&' + Subnets.map(z => `Subnets=${z}`).join('&') + '&' + SecurityGroups.map(z => `SecurityGroups=${z}`).join('&') + '&Scheme=' + (Scheme == null ? '' : encodeURIComponent(Scheme)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateLoadBalancerListeners(LoadBalancerName: string, Listeners: Array<Listener>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateLoadBalancerListeners?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + Listeners.map(z => `Listeners=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateLoadBalancerPolicy(LoadBalancerName: string, PolicyName: string, PolicyTypeName: string, PolicyAttributes: Array<PolicyAttribute>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateLoadBalancerPolicy?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&PolicyTypeName=' + (PolicyTypeName == null ? '' : encodeURIComponent(PolicyTypeName)) + '&' + PolicyAttributes.map(z => `PolicyAttributes=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteLoadBalancer(LoadBalancerName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteLoadBalancer?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteLoadBalancerListeners(LoadBalancerName: string, LoadBalancerPorts: Array<AccessPointPort>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteLoadBalancerListeners?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + LoadBalancerPorts.map(z => `LoadBalancerPorts=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteLoadBalancerPolicy(LoadBalancerName: string, PolicyName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteLoadBalancerPolicy?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeregisterInstancesFromLoadBalancer(LoadBalancerName: string, Instances: Array<Instance>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeregisterInstancesFromLoadBalancer?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + Instances.map(z => `Instances=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeInstanceHealth(LoadBalancerName: string, Instances: Array<Instance>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeInstanceHealth?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + Instances.map(z => `Instances=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeLoadBalancerAttributes(LoadBalancerName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeLoadBalancerAttributes?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeLoadBalancerPolicies(LoadBalancerName: string, PolicyNames: Array<PolicyName>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeLoadBalancerPolicies?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + PolicyNames.map(z => `PolicyNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeLoadBalancerPolicyTypes(PolicyTypeNames: Array<PolicyTypeName>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeLoadBalancerPolicyTypes?' + PolicyTypeNames.map(z => `PolicyTypeNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeLoadBalancers(LoadBalancerNames: Array<AccessPointName>, Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeLoadBalancers?' + LoadBalancerNames.map(z => `LoadBalancerNames=${z}`).join('&') + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeTags(LoadBalancerNames: Array<AccessPointName>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeTags?' + LoadBalancerNames.map(z => `LoadBalancerNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DetachLoadBalancerFromSubnets(LoadBalancerName: string, Subnets: Array<SubnetId>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DetachLoadBalancerFromSubnets?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + Subnets.map(z => `Subnets=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DisableAvailabilityZonesForLoadBalancer(LoadBalancerName: string, AvailabilityZones: Array<AvailabilityZone>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DisableAvailabilityZonesForLoadBalancer?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + AvailabilityZones.map(z => `AvailabilityZones=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_EnableAvailabilityZonesForLoadBalancer(LoadBalancerName: string, AvailabilityZones: Array<AvailabilityZone>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=EnableAvailabilityZonesForLoadBalancer?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&' + AvailabilityZones.map(z => `AvailabilityZones=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ModifyLoadBalancerAttributes(LoadBalancerName: string, LoadBalancerAttributes: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ModifyLoadBalancerAttributes?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&LoadBalancerAttributes=' + (LoadBalancerAttributes == null ? '' : encodeURIComponent(LoadBalancerAttributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RegisterInstancesWithLoadBalancer(LoadBalancerName: string, Instances: Array<Instance>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_RemoveTags(LoadBalancerNames: Array<AccessPointName>, Tags: Array<TagKeyOnly>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RemoveTags?' + LoadBalancerNames.map(z => `LoadBalancerNames=${z}`).join('&') + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetLoadBalancerListenerSSLCertificate(LoadBalancerName: string, LoadBalancerPort: number, SSLCertificateId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetLoadBalancerListenerSSLCertificate?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&LoadBalancerPort=' + LoadBalancerPort + '&SSLCertificateId=' + (SSLCertificateId == null ? '' : encodeURIComponent(SSLCertificateId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetLoadBalancerPoliciesForBackendServer(LoadBalancerName: string, InstancePort: number, PolicyNames: Array<PolicyName>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetLoadBalancerPoliciesForBackendServer?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&InstancePort=' + InstancePort + '&' + PolicyNames.map(z => `PolicyNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetLoadBalancerPoliciesOfListener(LoadBalancerName: string, LoadBalancerPort: number, PolicyNames: Array<PolicyName>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetLoadBalancerPoliciesOfListener?LoadBalancerName=' + (LoadBalancerName == null ? '' : encodeURIComponent(LoadBalancerName)) + '&LoadBalancerPort=' + LoadBalancerPort + '&' + PolicyNames.map(z => `PolicyNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
	}
