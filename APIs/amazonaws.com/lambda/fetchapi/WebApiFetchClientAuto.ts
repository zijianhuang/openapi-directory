export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GetLayerVersionPolicy(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionPolicyResponse> {
			return fetch(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AddPermission(FunctionName: string, Qualifier: string, requestBody: AddPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetPolicy(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateAlias(FunctionName: string, requestBody: CreateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateEventSourceMapping(requestBody: CreateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/event-source-mappings/', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateFunction(requestBody: CreateFunctionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/functions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteAlias(FunctionName: string, Name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAlias(FunctionName: string, Name: string, headersHandler?: () => {[header: string]: string}): Promise<AliasConfiguration> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateAlias(FunctionName: string, Name: string, requestBody: UpdateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<AliasConfiguration> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEventSourceMapping(UUID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEventSourceMapping(UUID: string, headersHandler?: () => {[header: string]: string}): Promise<EventSourceMappingConfiguration> {
			return fetch(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateEventSourceMapping(UUID: string, requestBody: UpdateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteFunction(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetFunction(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionResponse> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteFunctionConcurrency(FunctionName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PutFunctionConcurrency(FunctionName: string, requestBody: PutFunctionConcurrencyBody, headersHandler?: () => {[header: string]: string}): Promise<Concurrency> {
			return fetch(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return fetch(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: PutFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return fetch(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: UpdateFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return fetch(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionResponse> {
			return fetch(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetProvisionedConcurrencyConfigResponse> {
			return fetch(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, requestBody: PutProvisionedConcurrencyConfigBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetAccountSettings(headersHandler?: () => {[header: string]: string}): Promise<GetAccountSettingsResponse> {
			return fetch(this.baseUri + '/2016-08-19/account-settings/', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFunctionConcurrency(FunctionName: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionConcurrencyResponse> {
			return fetch(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFunctionConfiguration(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateFunctionConfiguration(FunctionName: string, requestBody: UpdateFunctionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetLayerVersionByArn(Arn: string, find: string, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionResponse> {
			return fetch(this.baseUri + '/2018-10-31/layers#find=LayerVersion&Arn?Arn=' + (Arn == null ? '' : encodeURIComponent(Arn)) + '&find=' + (find == null ? '' : encodeURIComponent(find)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Invoke(FunctionName: string, Qualifier: string, requestBody: InvokeBody, headersHandler?: () => {[header: string]: string}): Promise<InvocationResponse> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invocations&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Invoke(FunctionName: string, requestBody: InvokeAsyncBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2014-11-13/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invoke-async/', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListFunctionEventInvokeConfigs(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionEventInvokeConfigsResponse> {
			return fetch(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config/list&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListFunctions(MasterRegion: string, FunctionVersion: FunctionVersion, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionsResponse> {
			return fetch(this.baseUri + '/2015-03-31/functions/?MasterRegion=' + (MasterRegion == null ? '' : encodeURIComponent(MasterRegion)) + '&FunctionVersion=' + FunctionVersion + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListLayerVersions(CompatibleRuntime: FunctionConfigurationRuntime, LayerName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListLayerVersionsResponse> {
			return fetch(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PublishLayerVersion(LayerName: string, requestBody: PublishLayerVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListLayers(CompatibleRuntime: FunctionConfigurationRuntime, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListLayersResponse> {
			return fetch(this.baseUri + '/2018-10-31/layers?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProvisionedConcurrencyConfigs(FunctionName: string, Marker: string, MaxItems: number, List: FunctionVersion, headersHandler?: () => {[header: string]: string}): Promise<ListProvisionedConcurrencyConfigsResponse> {
			return fetch(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#List=ALL&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&List=' + List, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTags(ARN: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return fetch(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(ARN: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListVersionsByFunction(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListVersionsByFunctionResponse> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PublishVersion(FunctionName: string, requestBody: PublishVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RemoveLayerVersionPermission(LayerName: string, VersionNumber: number, StatementId: string, RevisionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy/' + (StatementId == null ? '' : encodeURIComponent(StatementId)) + '&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UntagResource(ARN: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateFunctionCode(FunctionName: string, requestBody: UpdateFunctionCodeBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return fetch(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/code', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
