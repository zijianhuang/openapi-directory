...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AddLayerVersionPermission(LayerName: string, VersionNumber: number, RevisionId: string, requestBody: AddLayerVersionPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetLayerVersionPolicy(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionPolicyResponse> {
			return this.http.get('/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		AddPermission(FunctionName: string, Qualifier: string, requestBody: AddPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetPolicy(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return this.http.get('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateAlias(FunctionName: string, requestBody: CreateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListAliases(FunctionName: string, FunctionVersion: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListAliasesResponse> {
			return this.http.get('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases&FunctionVersion=' + (FunctionVersion == null ? '' : encodeURIComponent(FunctionVersion)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateEventSourceMapping(requestBody: CreateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-03-31/event-source-mappings/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		CreateFunction(requestBody: CreateFunctionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-03-31/functions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAlias(FunctionName: string, Name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAlias(FunctionName: string, Name: string, headersHandler?: () => {[header: string]: string}): Promise<AliasConfiguration> {
			return this.http.get('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateAlias(FunctionName: string, Name: string, requestBody: UpdateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<AliasConfiguration> {
			return this.http.put('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteEventSourceMapping(UUID: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEventSourceMapping(UUID: string, headersHandler?: () => {[header: string]: string}): Promise<EventSourceMappingConfiguration> {
			return this.http.get('/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UpdateEventSourceMapping(UUID: string, requestBody: UpdateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunction(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetFunction(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionResponse> {
			return this.http.get('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionConcurrency(FunctionName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		PutFunctionConcurrency(FunctionName: string, requestBody: PutFunctionConcurrencyBody, headersHandler?: () => {[header: string]: string}): Promise<Concurrency> {
			return this.http.put('/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return this.http.get('/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: PutFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return this.http.put('/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: UpdateFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return this.http.post('/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionResponse> {
			return this.http.get('/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetProvisionedConcurrencyConfigResponse> {
			return this.http.get('/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PutProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, requestBody: PutProvisionedConcurrencyConfigBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetAccountSettings(headersHandler?: () => {[header: string]: string}): Promise<GetAccountSettingsResponse> {
			return this.http.get('/2016-08-19/account-settings/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFunctionConcurrency(FunctionName: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionConcurrencyResponse> {
			return this.http.get('/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFunctionConfiguration(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return this.http.get('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateFunctionConfiguration(FunctionName: string, requestBody: UpdateFunctionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return this.http.put('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLayerVersionByArn(Arn: string, find: string, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionResponse> {
			return this.http.get('/2018-10-31/layers#find=LayerVersion&Arn?Arn=' + (Arn == null ? '' : encodeURIComponent(Arn)) + '&find=' + (find == null ? '' : encodeURIComponent(find)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		Invoke(FunctionName: string, Qualifier: string, requestBody: InvokeBody, headersHandler?: () => {[header: string]: string}): Promise<InvocationResponse> {
			return this.http.post('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invocations&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		Invoke(FunctionName: string, requestBody: InvokeAsyncBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2014-11-13/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invoke-async/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListFunctionEventInvokeConfigs(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionEventInvokeConfigsResponse> {
			return this.http.get('/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config/list&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListFunctions(MasterRegion: string, FunctionVersion: FunctionVersion, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionsResponse> {
			return this.http.get('/2015-03-31/functions/?MasterRegion=' + (MasterRegion == null ? '' : encodeURIComponent(MasterRegion)) + '&FunctionVersion=' + FunctionVersion + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListLayerVersions(CompatibleRuntime: FunctionConfigurationRuntime, LayerName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListLayerVersionsResponse> {
			return this.http.get('/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PublishLayerVersion(LayerName: string, requestBody: PublishLayerVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListLayers(CompatibleRuntime: FunctionConfigurationRuntime, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListLayersResponse> {
			return this.http.get('/2018-10-31/layers?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProvisionedConcurrencyConfigs(FunctionName: string, Marker: string, MaxItems: number, List: FunctionVersion, headersHandler?: () => {[header: string]: string}): Promise<ListProvisionedConcurrencyConfigsResponse> {
			return this.http.get('/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#List=ALL&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&List=' + List, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTags(ARN: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return this.http.get('/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		TagResource(ARN: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListVersionsByFunction(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListVersionsByFunctionResponse> {
			return this.http.get('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PublishVersion(FunctionName: string, requestBody: PublishVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		RemoveLayerVersionPermission(LayerName: string, VersionNumber: number, StatementId: string, RevisionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy/' + (StatementId == null ? '' : encodeURIComponent(StatementId)) + '&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		RemovePermission(FunctionName: string, StatementId: string, Qualifier: string, RevisionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy/' + (StatementId == null ? '' : encodeURIComponent(StatementId)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)) + '&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(ARN: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateFunctionCode(FunctionName: string, requestBody: UpdateFunctionCodeBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return this.http.put('/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/code', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
