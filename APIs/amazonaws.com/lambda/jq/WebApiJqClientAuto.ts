...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AddLayerVersionPermission(LayerName: string, VersionNumber: number, RevisionId: string, callback: (data : void) => any, requestBody: AddLayerVersionPermissionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetLayerVersionPolicy(LayerName: string, VersionNumber: number, callback: (data : GetLayerVersionPolicyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		AddPermission(FunctionName: string, Qualifier: string, callback: (data : void) => any, requestBody: AddPermissionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetPolicy(FunctionName: string, Qualifier: string, callback: (data : GetPolicyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateAlias(FunctionName: string, callback: (data : void) => any, requestBody: CreateAliasBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAliases(FunctionName: string, FunctionVersion: string, Marker: string, MaxItems: number, callback: (data : ListAliasesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases&FunctionVersion=' + (FunctionVersion == null ? '' : encodeURIComponent(FunctionVersion)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateEventSourceMapping(callback: (data : void) => any, requestBody: CreateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-03-31/event-source-mappings/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEventSourceMappings(EventSourceArn: string, FunctionName: string, Marker: string, MaxItems: number, callback: (data : ListEventSourceMappingsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/event-source-mappings/?EventSourceArn=' + (EventSourceArn == null ? '' : encodeURIComponent(EventSourceArn)) + '&FunctionName=' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateFunction(callback: (data : void) => any, requestBody: CreateFunctionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-03-31/functions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteAlias(FunctionName: string, Name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetAlias(FunctionName: string, Name: string, callback: (data : AliasConfiguration) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {AliasConfiguration} Success
		 */
		UpdateAlias(FunctionName: string, Name: string, callback: (data : AliasConfiguration) => any, requestBody: UpdateAliasBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteEventSourceMapping(UUID: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetEventSourceMapping(UUID: string, callback: (data : EventSourceMappingConfiguration) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UpdateEventSourceMapping(UUID: string, callback: (data : void) => any, requestBody: UpdateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunction(FunctionName: string, Qualifier: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetFunction(FunctionName: string, Qualifier: string, callback: (data : GetFunctionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionConcurrency(FunctionName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PutFunctionConcurrency(FunctionName: string, callback: (data : Concurrency) => any, requestBody: PutFunctionConcurrencyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, callback: (data : FunctionEventInvokeConfig) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {FunctionEventInvokeConfig} Success
		 */
		PutFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, callback: (data : FunctionEventInvokeConfig) => any, requestBody: PutFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {FunctionEventInvokeConfig} Success
		 */
		UpdateFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, callback: (data : FunctionEventInvokeConfig) => any, requestBody: UpdateFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteLayerVersion(LayerName: string, VersionNumber: number, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetLayerVersion(LayerName: string, VersionNumber: number, callback: (data : GetLayerVersionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, callback: (data : GetProvisionedConcurrencyConfigResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PutProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, callback: (data : void) => any, requestBody: PutProvisionedConcurrencyConfigBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetAccountSettings(callback: (data : GetAccountSettingsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2016-08-19/account-settings/', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetFunctionConcurrency(FunctionName: string, callback: (data : GetFunctionConcurrencyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetFunctionConfiguration(FunctionName: string, Qualifier: string, callback: (data : FunctionConfiguration) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {FunctionConfiguration} Success
		 */
		UpdateFunctionConfiguration(FunctionName: string, callback: (data : FunctionConfiguration) => any, requestBody: UpdateFunctionConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {GetLayerVersionResponse} Success
		 */
		GetLayerVersionByArn(Arn: string, find: string, callback: (data : GetLayerVersionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2018-10-31/layers#find=LayerVersion&Arn?Arn=' + (Arn == null ? '' : encodeURIComponent(Arn)) + '&find=' + (find == null ? '' : encodeURIComponent(find)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		Invoke(FunctionName: string, Qualifier: string, callback: (data : InvocationResponse) => any, requestBody: InvokeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invocations&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		Invoke(FunctionName: string, callback: (data : void) => any, requestBody: InvokeAsyncBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2014-11-13/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invoke-async/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFunctionEventInvokeConfigs(FunctionName: string, Marker: string, MaxItems: number, callback: (data : ListFunctionEventInvokeConfigsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config/list&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListFunctions(MasterRegion: string, FunctionVersion: FunctionVersion, Marker: string, MaxItems: number, callback: (data : ListFunctionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/functions/?MasterRegion=' + (MasterRegion == null ? '' : encodeURIComponent(MasterRegion)) + '&FunctionVersion=' + FunctionVersion + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListLayerVersions(CompatibleRuntime: FunctionConfigurationRuntime, LayerName: string, Marker: string, MaxItems: number, callback: (data : ListLayerVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PublishLayerVersion(LayerName: string, callback: (data : void) => any, requestBody: PublishLayerVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListLayers(CompatibleRuntime: FunctionConfigurationRuntime, Marker: string, MaxItems: number, callback: (data : ListLayersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2018-10-31/layers?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListProvisionedConcurrencyConfigs(FunctionName: string, Marker: string, MaxItems: number, List: FunctionVersion, callback: (data : ListProvisionedConcurrencyConfigsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#List=ALL&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&List=' + List, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListTags(ARN: string, callback: (data : ListTagsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		TagResource(ARN: string, callback: (data : void) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListVersionsByFunction(FunctionName: string, Marker: string, MaxItems: number, callback: (data : ListVersionsByFunctionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PublishVersion(FunctionName: string, callback: (data : void) => any, requestBody: PublishVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		RemoveLayerVersionPermission(LayerName: string, VersionNumber: number, StatementId: string, RevisionId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy/' + (StatementId == null ? '' : encodeURIComponent(StatementId)) + '&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		RemovePermission(FunctionName: string, StatementId: string, Qualifier: string, RevisionId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} 
		 */
		UntagResource(ARN: string, tagKeys: Array<TagKey>, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {FunctionConfiguration} Success
		 */
		UpdateFunctionCode(FunctionName: string, callback: (data : FunctionConfiguration) => any, requestBody: UpdateFunctionCodeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/code', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
