...
export namespace My_Demo_Client {
	...
	export enum FunctionConfigurationRuntime { nodejs = 0, nodejs4.3 = 1, nodejs6.10 = 2, nodejs8.10 = 3, nodejs10.x = 4, nodejs12.x = 5, java8 = 6, java11 = 7, python2.7 = 8, python3.6 = 9, python3.7 = 10, python3.8 = 11, dotnetcore1.0 = 12, dotnetcore2.0 = 13, dotnetcore2.1 = 14, dotnetcore3.1 = 15, nodejs4.3-edge = 16, go1.x = 17, ruby2.5 = 18, ruby2.7 = 19, provided = 20 }
	...
	export enum Runtime { nodejs = 0, nodejs4.3 = 1, nodejs6.10 = 2, nodejs8.10 = 3, nodejs10.x = 4, nodejs12.x = 5, java8 = 6, java11 = 7, python2.7 = 8, python3.6 = 9, python3.7 = 10, python3.8 = 11, dotnetcore1.0 = 12, dotnetcore2.0 = 13, dotnetcore2.1 = 14, dotnetcore3.1 = 15, nodejs4.3-edge = 16, go1.x = 17, ruby2.5 = 18, ruby2.7 = 19, provided = 20 }
	...
	export interface PutProvisionedConcurrencyConfigResponse {
		...
		AvailableProvisionedConcurrentExecutions?: number;
		AllocatedProvisionedConcurrentExecutions?: number;
		Status?: PutProvisionedConcurrencyConfigResponseStatus;
		StatusReason?: string;
		LastModified?: string;
	}

	export enum PutProvisionedConcurrencyConfigResponseStatus { IN_PROGRESS = 0, READY = 1, FAILED = 2 }
	...
	export interface CreateEventSourceMappingRequest {
		...
		MaximumBatchingWindowInSeconds?: number;
		ParallelizationFactor?: number;
		StartingPosition?: CreateEventSourceMappingRequestStartingPosition;
	...
	export enum CreateEventSourceMappingRequestStartingPosition { TRIM_HORIZON = 0, LATEST = 1, AT_TIMESTAMP = 2 }
	...
	export enum TracingConfigMode { Active = 0, PassThrough = 1 }
	...
	export interface CreateFunctionRequest {
		...
		Tags?: Tags;
		Layers?: Array<LayerVersionArn>;
	}

	export enum CreateFunctionRequestRuntime { nodejs = 0, nodejs4.3 = 1, nodejs6.10 = 2, nodejs8.10 = 3, nodejs10.x = 4, nodejs12.x = 5, java8 = 6, java11 = 7, python2.7 = 8, python3.6 = 9, python3.7 = 10, python3.8 = 11, dotnetcore1.0 = 12, dotnetcore2.0 = 13, dotnetcore2.1 = 14, dotnetcore3.1 = 15, nodejs4.3-edge = 16, go1.x = 17, ruby2.5 = 18, ruby2.7 = 19, provided = 20 }
	...
	export interface ProvisionedConcurrencyConfigListItem {
		...
		AvailableProvisionedConcurrentExecutions?: number;
		AllocatedProvisionedConcurrentExecutions?: number;
		Status?: ProvisionedConcurrencyConfigListItemStatus;
		StatusReason?: string;
		LastModified?: string;
	}

	export enum ProvisionedConcurrencyConfigListItemStatus { IN_PROGRESS = 0, READY = 1, FAILED = 2 }
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AddLayerVersionPermission(LayerName: string, VersionNumber: number, RevisionId: string, requestBody: AddLayerVersionPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		GetLayerVersionPolicy(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionPolicyResponse> {
			return Axios.get<GetLayerVersionPolicyResponse>(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		AddPermission(FunctionName: string, Qualifier: string, requestBody: AddPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		GetPolicy(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return Axios.get<GetPolicyResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateAlias(FunctionName: string, requestBody: CreateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ListAliases(FunctionName: string, FunctionVersion: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListAliasesResponse> {
			return Axios.get<ListAliasesResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases&FunctionVersion=' + (FunctionVersion == null ? '' : encodeURIComponent(FunctionVersion)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateEventSourceMapping(requestBody: CreateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-03-31/event-source-mappings/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ListEventSourceMappings(EventSourceArn: string, FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListEventSourceMappingsResponse> {
			return Axios.get<ListEventSourceMappingsResponse>(this.baseUri + '/2015-03-31/event-source-mappings/?EventSourceArn=' + (EventSourceArn == null ? '' : encodeURIComponent(EventSourceArn)) + '&FunctionName=' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateFunction(requestBody: CreateFunctionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-03-31/functions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAlias(FunctionName: string, Name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetAlias(FunctionName: string, Name: string, headersHandler?: () => {[header: string]: string}): Promise<AliasConfiguration> {
			return Axios.get<AliasConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {AliasConfiguration} Success
		 */
		UpdateAlias(FunctionName: string, Name: string, requestBody: UpdateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<AliasConfiguration> {
			return Axios.put<AliasConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteEventSourceMapping(UUID: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetEventSourceMapping(UUID: string, headersHandler?: () => {[header: string]: string}): Promise<EventSourceMappingConfiguration> {
			return Axios.get<EventSourceMappingConfiguration>(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateEventSourceMapping(UUID: string, requestBody: UpdateEventSourceMappingBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunction(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetFunction(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionResponse> {
			return Axios.get<GetFunctionResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionConcurrency(FunctionName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		PutFunctionConcurrency(FunctionName: string, requestBody: PutFunctionConcurrencyBody, headersHandler?: () => {[header: string]: string}): Promise<Concurrency> {
			return Axios.put<Concurrency>(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return Axios.get<FunctionEventInvokeConfig>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {FunctionEventInvokeConfig} Success
		 */
		PutFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: PutFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return Axios.put<FunctionEventInvokeConfig>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {FunctionEventInvokeConfig} Success
		 */
		UpdateFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: UpdateFunctionEventInvokeConfigBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionEventInvokeConfig> {
			return Axios.post<FunctionEventInvokeConfig>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionResponse> {
			return Axios.get<GetLayerVersionResponse>(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		GetProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<GetProvisionedConcurrencyConfigResponse> {
			return Axios.get<GetProvisionedConcurrencyConfigResponse>(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, requestBody: PutProvisionedConcurrencyConfigBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		GetAccountSettings(headersHandler?: () => {[header: string]: string}): Promise<GetAccountSettingsResponse> {
			return Axios.get<GetAccountSettingsResponse>(this.baseUri + '/2016-08-19/account-settings/', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetFunctionConcurrency(FunctionName: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionConcurrencyResponse> {
			return Axios.get<GetFunctionConcurrencyResponse>(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetFunctionConfiguration(FunctionName: string, Qualifier: string, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return Axios.get<FunctionConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {FunctionConfiguration} Success
		 */
		UpdateFunctionConfiguration(FunctionName: string, requestBody: UpdateFunctionConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return Axios.put<FunctionConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {GetLayerVersionResponse} Success
		 */
		GetLayerVersionByArn(Arn: string, find: string, headersHandler?: () => {[header: string]: string}): Promise<GetLayerVersionResponse> {
			return Axios.get<GetLayerVersionResponse>(this.baseUri + '/2018-10-31/layers#find=LayerVersion&Arn?Arn=' + (Arn == null ? '' : encodeURIComponent(Arn)) + '&find=' + (find == null ? '' : encodeURIComponent(find)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		Invoke(FunctionName: string, Qualifier: string, requestBody: InvokeBody, headersHandler?: () => {[header: string]: string}): Promise<InvocationResponse> {
			return Axios.post<InvocationResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invocations&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		Invoke(FunctionName: string, requestBody: InvokeAsyncBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2014-11-13/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invoke-async/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ListFunctionEventInvokeConfigs(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionEventInvokeConfigsResponse> {
			return Axios.get<ListFunctionEventInvokeConfigsResponse>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config/list&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListFunctions(MasterRegion: string, FunctionVersion: FunctionVersion, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionsResponse> {
			return Axios.get<ListFunctionsResponse>(this.baseUri + '/2015-03-31/functions/?MasterRegion=' + (MasterRegion == null ? '' : encodeURIComponent(MasterRegion)) + '&FunctionVersion=' + FunctionVersion + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @param {FunctionConfigurationRuntime} CompatibleRuntime A runtime identifier. For example, <code>go1.x</code>.
		 * @param {string} LayerName The name or Amazon Resource Name (ARN) of the layer.
		 * @param {string} Marker A pagination token returned by a previous call.
		 * @param {number} MaxItems The maximum number of versions to return.
		 * @return {ListLayerVersionsResponse} Success
		 */
		ListLayerVersions(CompatibleRuntime: FunctionConfigurationRuntime, LayerName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListLayerVersionsResponse> {
			return Axios.get<ListLayerVersionsResponse>(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PublishLayerVersion(LayerName: string, requestBody: PublishLayerVersionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ListLayers(CompatibleRuntime: FunctionConfigurationRuntime, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListLayersResponse> {
			return Axios.get<ListLayersResponse>(this.baseUri + '/2018-10-31/layers?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListProvisionedConcurrencyConfigs(FunctionName: string, Marker: string, MaxItems: number, List: FunctionVersion, headersHandler?: () => {[header: string]: string}): Promise<ListProvisionedConcurrencyConfigsResponse> {
			return Axios.get<ListProvisionedConcurrencyConfigsResponse>(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#List=ALL&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&List=' + List, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListTags(ARN: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return Axios.get<ListTagsResponse>(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		TagResource(ARN: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ListVersionsByFunction(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => {[header: string]: string}): Promise<ListVersionsByFunctionResponse> {
			return Axios.get<ListVersionsByFunctionResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PublishVersion(FunctionName: string, requestBody: PublishVersionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RemoveLayerVersionPermission(LayerName: string, VersionNumber: number, StatementId: string, RevisionId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy/' + (StatementId == null ? '' : encodeURIComponent(StatementId)) + '&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RemovePermission(FunctionName: string, StatementId: string, Qualifier: string, RevisionId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @param {string} ARN The function's Amazon Resource Name (ARN).
		 * @param {Array<TagKey>} tagKeys A list of tag keys to remove from the function.
		 * @return {void} 
		 */
		UntagResource(ARN: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {FunctionConfiguration} Success
		 */
		UpdateFunctionCode(FunctionName: string, requestBody: UpdateFunctionCodeBody, headersHandler?: () => {[header: string]: string}): Promise<FunctionConfiguration> {
			return Axios.put<FunctionConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/code', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}

	export interface AddLayerVersionPermissionBody {
	...
	export interface CreateEventSourceMappingBody {
		...
		StartingPosition?: CreateEventSourceMappingBodyStartingPosition;
	...
	export enum CreateEventSourceMappingBodyStartingPosition { TRIM_HORIZON = 0, LATEST = 1, AT_TIMESTAMP = 2 }
	...
	export enum CreateFunctionBodyRuntime { nodejs = 0, nodejs4.3 = 1, nodejs6.10 = 2, nodejs8.10 = 3, nodejs10.x = 4, nodejs12.x = 5, java8 = 6, java11 = 7, python2.7 = 8, python3.6 = 9, python3.7 = 10, python3.8 = 11, dotnetcore1.0 = 12, dotnetcore2.0 = 13, dotnetcore2.1 = 14, dotnetcore3.1 = 15, nodejs4.3-edge = 16, go1.x = 17, ruby2.5 = 18, ruby2.7 = 19, provided = 20 }
	...
	export interface UpdateEventSourceMappingBody {
	...
	export interface PutFunctionConcurrencyBody {
	...
	export interface PutFunctionEventInvokeConfigBody {
	...
	export interface UpdateFunctionEventInvokeConfigBody {
	...
	export interface PutProvisionedConcurrencyConfigBody {
	...
	export interface UpdateFunctionConfigurationBody {
		...
		/**The identifier of the function's <a href="https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html">runtime</a>. */
		Runtime?: UpdateFunctionConfigurationBodyRuntime;
	...
	export enum UpdateFunctionConfigurationBodyRuntime { nodejs = 0, nodejs4.3 = 1, nodejs6.10 = 2, nodejs8.10 = 3, nodejs10.x = 4, nodejs12.x = 5, java8 = 6, java11 = 7, python2.7 = 8, python3.6 = 9, python3.7 = 10, python3.8 = 11, dotnetcore1.0 = 12, dotnetcore2.0 = 13, dotnetcore2.1 = 14, dotnetcore3.1 = 15, nodejs4.3-edge = 16, go1.x = 17, ruby2.5 = 18, ruby2.7 = 19, provided = 20 }
	...
	export interface InvokeAsyncBody {

		/**The JSON that you want to provide to your Lambda function as input. */
		InvokeArgs: string;
	}

	export interface PublishLayerVersionBody {
	...
	export interface UpdateFunctionCodeBody {
