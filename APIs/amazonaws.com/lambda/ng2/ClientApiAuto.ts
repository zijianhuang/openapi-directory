...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AddLayerVersionPermission(LayerName: string, VersionNumber: number, RevisionId: string, requestBody: AddLayerVersionPermissionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		GetLayerVersionPolicy(LayerName: string, VersionNumber: number, headersHandler?: () => HttpHeaders): Observable<GetLayerVersionPolicyResponse> {
			return this.http.get<GetLayerVersionPolicyResponse>(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		AddPermission(FunctionName: string, Qualifier: string, requestBody: AddPermissionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetPolicy(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<GetPolicyResponse> {
			return this.http.get<GetPolicyResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/policy&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateAlias(FunctionName: string, requestBody: CreateAliasBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateEventSourceMapping(requestBody: CreateEventSourceMappingBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2015-03-31/event-source-mappings/', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateFunction(requestBody: CreateFunctionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2015-03-31/functions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAlias(FunctionName: string, Name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetAlias(FunctionName: string, Name: string, headersHandler?: () => HttpHeaders): Observable<AliasConfiguration> {
			return this.http.get<AliasConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {AliasConfiguration} Success
		 */
		UpdateAlias(FunctionName: string, Name: string, requestBody: UpdateAliasBody, headersHandler?: () => HttpHeaders): Observable<AliasConfiguration> {
			return this.http.put<AliasConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/aliases/' + (Name == null ? '' : encodeURIComponent(Name)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteEventSourceMapping(UUID: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetEventSourceMapping(UUID: string, headersHandler?: () => HttpHeaders): Observable<EventSourceMappingConfiguration> {
			return this.http.get<EventSourceMappingConfiguration>(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateEventSourceMapping(UUID: string, requestBody: UpdateEventSourceMappingBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/2015-03-31/event-source-mappings/' + (UUID == null ? '' : encodeURIComponent(UUID)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunction(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetFunction(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<GetFunctionResponse> {
			return this.http.get<GetFunctionResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionConcurrency(FunctionName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutFunctionConcurrency(FunctionName: string, requestBody: PutFunctionConcurrencyBody, headersHandler?: () => HttpHeaders): Observable<Concurrency> {
			return this.http.put<Concurrency>(this.baseUri + '/2017-10-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<FunctionEventInvokeConfig> {
			return this.http.get<FunctionEventInvokeConfig>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {FunctionEventInvokeConfig} Success
		 */
		PutFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: PutFunctionEventInvokeConfigBody, headersHandler?: () => HttpHeaders): Observable<FunctionEventInvokeConfig> {
			return this.http.put<FunctionEventInvokeConfig>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {FunctionEventInvokeConfig} Success
		 */
		UpdateFunctionEventInvokeConfig(FunctionName: string, Qualifier: string, requestBody: UpdateFunctionEventInvokeConfigBody, headersHandler?: () => HttpHeaders): Observable<FunctionEventInvokeConfig> {
			return this.http.post<FunctionEventInvokeConfig>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetLayerVersion(LayerName: string, VersionNumber: number, headersHandler?: () => HttpHeaders): Observable<GetLayerVersionResponse> {
			return this.http.get<GetLayerVersionResponse>(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<GetProvisionedConcurrencyConfigResponse> {
			return this.http.get<GetProvisionedConcurrencyConfigResponse>(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PutProvisionedConcurrencyConfig(FunctionName: string, Qualifier: string, requestBody: PutProvisionedConcurrencyConfigBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#Qualifier&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetAccountSettings(headersHandler?: () => HttpHeaders): Observable<GetAccountSettingsResponse> {
			return this.http.get<GetAccountSettingsResponse>(this.baseUri + '/2016-08-19/account-settings/', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetFunctionConcurrency(FunctionName: string, headersHandler?: () => HttpHeaders): Observable<GetFunctionConcurrencyResponse> {
			return this.http.get<GetFunctionConcurrencyResponse>(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/concurrency', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetFunctionConfiguration(FunctionName: string, Qualifier: string, headersHandler?: () => HttpHeaders): Observable<FunctionConfiguration> {
			return this.http.get<FunctionConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/configuration&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {FunctionConfiguration} Success
		 */
		UpdateFunctionConfiguration(FunctionName: string, requestBody: UpdateFunctionConfigurationBody, headersHandler?: () => HttpHeaders): Observable<FunctionConfiguration> {
		 ...
		 * @return {GetLayerVersionResponse} Success
		 */
		GetLayerVersionByArn(Arn: string, find: string, headersHandler?: () => HttpHeaders): Observable<GetLayerVersionResponse> {
			return this.http.get<GetLayerVersionResponse>(this.baseUri + '/2018-10-31/layers#find=LayerVersion&Arn?Arn=' + (Arn == null ? '' : encodeURIComponent(Arn)) + '&find=' + (find == null ? '' : encodeURIComponent(find)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		Invoke(FunctionName: string, Qualifier: string, requestBody: InvokeBody, headersHandler?: () => HttpHeaders): Observable<InvocationResponse> {
			return this.http.post<InvocationResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invocations&Qualifier=' + (Qualifier == null ? '' : encodeURIComponent(Qualifier)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		Invoke(FunctionName: string, requestBody: InvokeAsyncBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2014-11-13/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/invoke-async/', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListFunctionEventInvokeConfigs(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => HttpHeaders): Observable<ListFunctionEventInvokeConfigsResponse> {
			return this.http.get<ListFunctionEventInvokeConfigsResponse>(this.baseUri + '/2019-09-25/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/event-invoke-config/list&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListFunctions(MasterRegion: string, FunctionVersion: FunctionVersion, Marker: string, MaxItems: number, headersHandler?: () => HttpHeaders): Observable<ListFunctionsResponse> {
			return this.http.get<ListFunctionsResponse>(this.baseUri + '/2015-03-31/functions/?MasterRegion=' + (MasterRegion == null ? '' : encodeURIComponent(MasterRegion)) + '&FunctionVersion=' + FunctionVersion + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListLayerVersions(CompatibleRuntime: FunctionConfigurationRuntime, LayerName: string, Marker: string, MaxItems: number, headersHandler?: () => HttpHeaders): Observable<ListLayerVersionsResponse> {
			return this.http.get<ListLayerVersionsResponse>(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PublishLayerVersion(LayerName: string, requestBody: PublishLayerVersionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListLayers(CompatibleRuntime: FunctionConfigurationRuntime, Marker: string, MaxItems: number, headersHandler?: () => HttpHeaders): Observable<ListLayersResponse> {
			return this.http.get<ListLayersResponse>(this.baseUri + '/2018-10-31/layers?CompatibleRuntime=' + CompatibleRuntime + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListProvisionedConcurrencyConfigs(FunctionName: string, Marker: string, MaxItems: number, List: FunctionVersion, headersHandler?: () => HttpHeaders): Observable<ListProvisionedConcurrencyConfigsResponse> {
			return this.http.get<ListProvisionedConcurrencyConfigsResponse>(this.baseUri + '/2019-09-30/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/provisioned-concurrency#List=ALL&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&List=' + List, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTags(ARN: string, headersHandler?: () => HttpHeaders): Observable<ListTagsResponse> {
			return this.http.get<ListTagsResponse>(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		TagResource(ARN: string, requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListVersionsByFunction(FunctionName: string, Marker: string, MaxItems: number, headersHandler?: () => HttpHeaders): Observable<ListVersionsByFunctionResponse> {
			return this.http.get<ListVersionsByFunctionResponse>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PublishVersion(FunctionName: string, requestBody: PublishVersionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RemoveLayerVersionPermission(LayerName: string, VersionNumber: number, StatementId: string, RevisionId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2018-10-31/layers/' + (LayerName == null ? '' : encodeURIComponent(LayerName)) + '/versions/' + VersionNumber + '/policy/' + (StatementId == null ? '' : encodeURIComponent(StatementId)) + '&RevisionId=' + (RevisionId == null ? '' : encodeURIComponent(RevisionId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RemovePermission(FunctionName: string, StatementId: string, Qualifier: string, RevisionId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		UntagResource(ARN: string, tagKeys: Array<TagKey>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2017-03-31/tags/' + (ARN == null ? '' : encodeURIComponent(ARN)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {FunctionConfiguration} Success
		 */
		UpdateFunctionCode(FunctionName: string, requestBody: UpdateFunctionCodeBody, headersHandler?: () => HttpHeaders): Observable<FunctionConfiguration> {
			return this.http.put<FunctionConfiguration>(this.baseUri + '/2015-03-31/functions/' + (FunctionName == null ? '' : encodeURIComponent(FunctionName)) + '/code', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
