export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AssignInstance(requestBody: AssignInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AssignInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		AssignVolume(requestBody: AssignVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AssignVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		AssociateElasticIp(requestBody: AssociateElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AssociateElasticIp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		AttachElasticLoadBalancer(requestBody: AttachElasticLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AttachElasticLoadBalancer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CloneStack(requestBody: CloneStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CloneStackResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CloneStack', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateApp(requestBody: CreateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAppResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateApp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDeployment(requestBody: CreateDeploymentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateDeployment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateInstance(requestBody: CreateInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstanceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateLayer(requestBody: CreateLayerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLayerResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateLayer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateStack(requestBody: CreateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStackResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateStack', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateUserProfile(requestBody: CreateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserProfileResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApp(requestBody: DeleteAppRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteApp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteInstance(requestBody: DeleteInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLayer(requestBody: DeleteLayerRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteLayer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteStack(requestBody: DeleteStackRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteStack', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteUserProfile(requestBody: DeleteUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterEcsCluster(requestBody: DeregisterEcsClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterEcsCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterElasticIp(requestBody: DeregisterElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterElasticIp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterInstance(requestBody: DeregisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterRdsDbInstance(requestBody: DeregisterRdsDbInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterRdsDbInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterVolume(requestBody: DeregisterVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeAgentVersions(requestBody: DescribeAgentVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAgentVersionsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeAgentVersions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeApps(requestBody: DescribeAppsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAppsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeApps', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeCommands(requestBody: DescribeCommandsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCommandsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeCommands', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDeployments(requestBody: DescribeDeploymentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeploymentsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeDeployments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEcsClusters(MaxResults: string, NextToken: string, requestBody: DescribeEcsClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEcsClustersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeEcsClusters?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeElasticIps(requestBody: DescribeElasticIpsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticIpsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeElasticIps', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeElasticLoadBalancers(requestBody: DescribeElasticLoadBalancersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticLoadBalancersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeElasticLoadBalancers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeInstances(requestBody: DescribeInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeInstances', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLayers(requestBody: DescribeLayersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLayersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeLayers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLoadBasedAutoScaling(requestBody: DescribeLoadBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLoadBasedAutoScalingResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeLoadBasedAutoScaling', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMyUserProfile(headersHandler?: () => {[header: string]: string}): Promise<DescribeMyUserProfileResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeMyUserProfile', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeOperatingSystems(headersHandler?: () => {[header: string]: string}): Promise<DescribeOperatingSystemsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeOperatingSystems', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribePermissions(requestBody: DescribePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePermissionsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribePermissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRaidArrays(requestBody: DescribeRaidArraysRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRaidArraysResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeRaidArrays', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRdsDbInstances(requestBody: DescribeRdsDbInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRdsDbInstancesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeRdsDbInstances', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeServiceErrors(requestBody: DescribeServiceErrorsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeServiceErrorsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeServiceErrors', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeStackProvisioningParameters(requestBody: DescribeStackProvisioningParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStackProvisioningParametersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeStackProvisioningParameters', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeStackSummary(requestBody: DescribeStackSummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStackSummaryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeStackSummary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeStacks(requestBody: DescribeStacksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStacksResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeStacks', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTimeBasedAutoScaling(requestBody: DescribeTimeBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTimeBasedAutoScalingResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeTimeBasedAutoScaling', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeUserProfiles(requestBody: DescribeUserProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserProfilesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeUserProfiles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeVolumes(requestBody: DescribeVolumesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeVolumesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeVolumes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DetachElasticLoadBalancer(requestBody: DetachElasticLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DetachElasticLoadBalancer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DisassociateElasticIp(requestBody: DisassociateElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DisassociateElasticIp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetHostnameSuggestion(requestBody: GetHostnameSuggestionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetHostnameSuggestionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.GetHostnameSuggestion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GrantAccess(requestBody: GrantAccessRequest, headersHandler?: () => {[header: string]: string}): Promise<GrantAccessResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.GrantAccess', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTags(requestBody: ListTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.ListTags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RebootInstance(requestBody: RebootInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RebootInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RegisterEcsCluster(requestBody: RegisterEcsClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterEcsClusterResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterEcsCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterElasticIp(requestBody: RegisterElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterElasticIpResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterElasticIp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterInstance(requestBody: RegisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterInstanceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RegisterRdsDbInstance(requestBody: RegisterRdsDbInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterRdsDbInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RegisterVolume(requestBody: RegisterVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterVolumeResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		SetLoadBasedAutoScaling(requestBody: SetLoadBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.SetLoadBasedAutoScaling', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		SetPermission(requestBody: SetPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.SetPermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		SetTimeBasedAutoScaling(requestBody: SetTimeBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.SetTimeBasedAutoScaling', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StartInstance(requestBody: StartInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StartInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StartStack(requestBody: StartStackRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StartStack', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopInstance(requestBody: StopInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StopInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopStack(requestBody: StopStackRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StopStack', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UnassignInstance(requestBody: UnassignInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UnassignInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UnassignVolume(requestBody: UnassignVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UnassignVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateApp(requestBody: UpdateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateApp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateElasticIp(requestBody: UpdateElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateElasticIp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateInstance(requestBody: UpdateInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateLayer(requestBody: UpdateLayerRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateLayer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateMyUserProfile(requestBody: UpdateMyUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateMyUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateRdsDbInstance(requestBody: UpdateRdsDbInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateRdsDbInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateStack(requestBody: UpdateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateStack', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserProfile(requestBody: UpdateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateVolume(requestBody: UpdateVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
