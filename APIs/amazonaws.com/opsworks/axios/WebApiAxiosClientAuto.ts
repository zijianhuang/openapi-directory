...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AssignInstance(requestBody: AssignInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AssignInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		AssignVolume(requestBody: AssignVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AssignVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		AssociateElasticIp(requestBody: AssociateElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AssociateElasticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		AttachElasticLoadBalancer(requestBody: AttachElasticLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.AttachElasticLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		CloneStack(requestBody: CloneStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CloneStackResult> {
			return Axios.post<CloneStackResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CloneStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateApp(requestBody: CreateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAppResult> {
			return Axios.post<CreateAppResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateDeployment(requestBody: CreateDeploymentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentResult> {
			return Axios.post<CreateDeploymentResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateInstance(requestBody: CreateInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstanceResult> {
			return Axios.post<CreateInstanceResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateLayer(requestBody: CreateLayerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLayerResult> {
			return Axios.post<CreateLayerResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateLayer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateStack(requestBody: CreateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStackResult> {
			return Axios.post<CreateStackResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUserProfile(requestBody: CreateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserProfileResult> {
			return Axios.post<CreateUserProfileResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.CreateUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApp(requestBody: DeleteAppRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteInstance(requestBody: DeleteInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLayer(requestBody: DeleteLayerRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteLayer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteStack(requestBody: DeleteStackRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DeleteUserProfile(requestBody: DeleteUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeleteUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterEcsCluster(requestBody: DeregisterEcsClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterEcsCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterElasticIp(requestBody: DeregisterElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterElasticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterInstance(requestBody: DeregisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterRdsDbInstance(requestBody: DeregisterRdsDbInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterRdsDbInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterVolume(requestBody: DeregisterVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DeregisterVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeAgentVersions(requestBody: DescribeAgentVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAgentVersionsResult> {
			return Axios.post<DescribeAgentVersionsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeAgentVersions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeApps(requestBody: DescribeAppsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAppsResult> {
			return Axios.post<DescribeAppsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeApps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeCommands(requestBody: DescribeCommandsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCommandsResult> {
			return Axios.post<DescribeCommandsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeCommands', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeDeployments(requestBody: DescribeDeploymentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeploymentsResult> {
			return Axios.post<DescribeDeploymentsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeDeployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEcsClusters(MaxResults: string, NextToken: string, requestBody: DescribeEcsClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEcsClustersResult> {
			return Axios.post<DescribeEcsClustersResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeEcsClusters?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeElasticIps(requestBody: DescribeElasticIpsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticIpsResult> {
			return Axios.post<DescribeElasticIpsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeElasticIps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeElasticLoadBalancers(requestBody: DescribeElasticLoadBalancersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticLoadBalancersResult> {
			return Axios.post<DescribeElasticLoadBalancersResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeElasticLoadBalancers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeInstances(requestBody: DescribeInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancesResult> {
			return Axios.post<DescribeInstancesResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeLayers(requestBody: DescribeLayersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLayersResult> {
			return Axios.post<DescribeLayersResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeLayers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeLoadBasedAutoScaling(requestBody: DescribeLoadBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLoadBasedAutoScalingResult> {
			return Axios.post<DescribeLoadBasedAutoScalingResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeLoadBasedAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeMyUserProfile(headersHandler?: () => {[header: string]: string}): Promise<DescribeMyUserProfileResult> {
			return Axios.post<DescribeMyUserProfileResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeMyUserProfile', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeOperatingSystems(headersHandler?: () => {[header: string]: string}): Promise<DescribeOperatingSystemsResponse> {
			return Axios.post<DescribeOperatingSystemsResponse>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeOperatingSystems', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribePermissions(requestBody: DescribePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePermissionsResult> {
			return Axios.post<DescribePermissionsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeRaidArrays(requestBody: DescribeRaidArraysRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRaidArraysResult> {
			return Axios.post<DescribeRaidArraysResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeRaidArrays', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeRdsDbInstances(requestBody: DescribeRdsDbInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRdsDbInstancesResult> {
			return Axios.post<DescribeRdsDbInstancesResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeRdsDbInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeServiceErrors(requestBody: DescribeServiceErrorsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeServiceErrorsResult> {
			return Axios.post<DescribeServiceErrorsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeServiceErrors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeStackProvisioningParameters(requestBody: DescribeStackProvisioningParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStackProvisioningParametersResult> {
			return Axios.post<DescribeStackProvisioningParametersResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeStackProvisioningParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeStackSummary(requestBody: DescribeStackSummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStackSummaryResult> {
			return Axios.post<DescribeStackSummaryResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeStackSummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeStacks(requestBody: DescribeStacksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStacksResult> {
			return Axios.post<DescribeStacksResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeStacks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeTimeBasedAutoScaling(requestBody: DescribeTimeBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTimeBasedAutoScalingResult> {
			return Axios.post<DescribeTimeBasedAutoScalingResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeTimeBasedAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeUserProfiles(requestBody: DescribeUserProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserProfilesResult> {
			return Axios.post<DescribeUserProfilesResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeUserProfiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeVolumes(requestBody: DescribeVolumesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeVolumesResult> {
			return Axios.post<DescribeVolumesResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DescribeVolumes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DetachElasticLoadBalancer(requestBody: DetachElasticLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DetachElasticLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DisassociateElasticIp(requestBody: DisassociateElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.DisassociateElasticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		GetHostnameSuggestion(requestBody: GetHostnameSuggestionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetHostnameSuggestionResult> {
			return Axios.post<GetHostnameSuggestionResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.GetHostnameSuggestion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GrantAccess(requestBody: GrantAccessRequest, headersHandler?: () => {[header: string]: string}): Promise<GrantAccessResult> {
			return Axios.post<GrantAccessResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.GrantAccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTags(requestBody: ListTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResult> {
			return Axios.post<ListTagsResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.ListTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RebootInstance(requestBody: RebootInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RebootInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		RegisterEcsCluster(requestBody: RegisterEcsClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterEcsClusterResult> {
			return Axios.post<RegisterEcsClusterResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterEcsCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RegisterElasticIp(requestBody: RegisterElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterElasticIpResult> {
			return Axios.post<RegisterElasticIpResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterElasticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RegisterInstance(requestBody: RegisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterInstanceResult> {
			return Axios.post<RegisterInstanceResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RegisterRdsDbInstance(requestBody: RegisterRdsDbInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterRdsDbInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		RegisterVolume(requestBody: RegisterVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterVolumeResult> {
			return Axios.post<RegisterVolumeResult>(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.RegisterVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		SetLoadBasedAutoScaling(requestBody: SetLoadBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.SetLoadBasedAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SetPermission(requestBody: SetPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.SetPermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SetTimeBasedAutoScaling(requestBody: SetTimeBasedAutoScalingRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.SetTimeBasedAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StartInstance(requestBody: StartInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StartInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StartStack(requestBody: StartStackRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StartStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopInstance(requestBody: StopInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StopInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopStack(requestBody: StopStackRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.StopStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UnassignInstance(requestBody: UnassignInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UnassignInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UnassignVolume(requestBody: UnassignVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UnassignVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateApp(requestBody: UpdateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateElasticIp(requestBody: UpdateElasticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateElasticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateInstance(requestBody: UpdateInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateLayer(requestBody: UpdateLayerRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateLayer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateMyUserProfile(requestBody: UpdateMyUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateMyUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateRdsDbInstance(requestBody: UpdateRdsDbInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateRdsDbInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateStack(requestBody: UpdateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateUserProfile(requestBody: UpdateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateVolume(requestBody: UpdateVolumeRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=OpsWorks_20130218.UpdateVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
