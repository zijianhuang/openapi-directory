...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptQualificationRequest(requestBody: AcceptQualificationRequestRequest, headersHandler?: () => HttpHeaders): Observable<AcceptQualificationRequestResponse> {
			return this.http.post<AcceptQualificationRequestResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.AcceptQualificationRequest', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ApproveAssignment(requestBody: ApproveAssignmentRequest, headersHandler?: () => HttpHeaders): Observable<ApproveAssignmentResponse> {
			return this.http.post<ApproveAssignmentResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ApproveAssignment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssociateQualificationWithWorker(requestBody: AssociateQualificationWithWorkerRequest, headersHandler?: () => HttpHeaders): Observable<AssociateQualificationWithWorkerResponse> {
			return this.http.post<AssociateQualificationWithWorkerResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.AssociateQualificationWithWorker', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAdditionalAssignmentsForHIT(requestBody: CreateAdditionalAssignmentsForHITRequest, headersHandler?: () => HttpHeaders): Observable<CreateAdditionalAssignmentsForHITResponse> {
			return this.http.post<CreateAdditionalAssignmentsForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateAdditionalAssignmentsForHIT', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateHIT(requestBody: CreateHITRequest, headersHandler?: () => HttpHeaders): Observable<CreateHITResponse> {
			return this.http.post<CreateHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHIT', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateHITType(requestBody: CreateHITTypeRequest, headersHandler?: () => HttpHeaders): Observable<CreateHITTypeResponse> {
			return this.http.post<CreateHITTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateHITWithHITType(requestBody: CreateHITWithHITTypeRequest, headersHandler?: () => HttpHeaders): Observable<CreateHITWithHITTypeResponse> {
			return this.http.post<CreateHITWithHITTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITWithHITType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateQualificationType(requestBody: CreateQualificationTypeRequest, headersHandler?: () => HttpHeaders): Observable<CreateQualificationTypeResponse> {
			return this.http.post<CreateQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateWorkerBlock(requestBody: CreateWorkerBlockRequest, headersHandler?: () => HttpHeaders): Observable<CreateWorkerBlockResponse> {
			return this.http.post<CreateWorkerBlockResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateWorkerBlock', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteHIT(requestBody: DeleteHITRequest, headersHandler?: () => HttpHeaders): Observable<DeleteHITResponse> {
			return this.http.post<DeleteHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteHIT', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteQualificationType(requestBody: DeleteQualificationTypeRequest, headersHandler?: () => HttpHeaders): Observable<DeleteQualificationTypeResponse> {
			return this.http.post<DeleteQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteWorkerBlock(requestBody: DeleteWorkerBlockRequest, headersHandler?: () => HttpHeaders): Observable<DeleteWorkerBlockResponse> {
			return this.http.post<DeleteWorkerBlockResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteWorkerBlock', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateQualificationFromWorker(requestBody: DisassociateQualificationFromWorkerRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateQualificationFromWorkerResponse> {
			return this.http.post<DisassociateQualificationFromWorkerResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DisassociateQualificationFromWorker', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAccountBalance(requestBody: GetAccountBalanceRequest, headersHandler?: () => HttpHeaders): Observable<GetAccountBalanceResponse> {
			return this.http.post<GetAccountBalanceResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAccountBalance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAssignment(requestBody: GetAssignmentRequest, headersHandler?: () => HttpHeaders): Observable<GetAssignmentResponse> {
			return this.http.post<GetAssignmentResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAssignment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetFileUploadURL(requestBody: GetFileUploadURLRequest, headersHandler?: () => HttpHeaders): Observable<GetFileUploadURLResponse> {
			return this.http.post<GetFileUploadURLResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetFileUploadURL', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetHIT(requestBody: GetHITRequest, headersHandler?: () => HttpHeaders): Observable<GetHITResponse> {
			return this.http.post<GetHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetHIT', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetQualificationScore(requestBody: GetQualificationScoreRequest, headersHandler?: () => HttpHeaders): Observable<GetQualificationScoreResponse> {
			return this.http.post<GetQualificationScoreResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationScore', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetQualificationType(requestBody: GetQualificationTypeRequest, headersHandler?: () => HttpHeaders): Observable<GetQualificationTypeResponse> {
			return this.http.post<GetQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAssignmentsForHIT(MaxResults: string, NextToken: string, requestBody: ListAssignmentsForHITRequest, headersHandler?: () => HttpHeaders): Observable<ListAssignmentsForHITResponse> {
			return this.http.post<ListAssignmentsForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListAssignmentsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListBonusPayments(MaxResults: string, NextToken: string, requestBody: ListBonusPaymentsRequest, headersHandler?: () => HttpHeaders): Observable<ListBonusPaymentsResponse> {
			return this.http.post<ListBonusPaymentsResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListBonusPayments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListHITsForQualificationType(MaxResults: string, NextToken: string, requestBody: ListHITsForQualificationTypeRequest, headersHandler?: () => HttpHeaders): Observable<ListHITsForQualificationTypeResponse> {
			return this.http.post<ListHITsForQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListHITsForQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListQualificationRequests(MaxResults: string, NextToken: string, requestBody: ListQualificationRequestsRequest, headersHandler?: () => HttpHeaders): Observable<ListQualificationRequestsResponse> {
			return this.http.post<ListQualificationRequestsResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationRequests?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListQualificationTypes(MaxResults: string, NextToken: string, requestBody: ListQualificationTypesRequest, headersHandler?: () => HttpHeaders): Observable<ListQualificationTypesResponse> {
			return this.http.post<ListQualificationTypesResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationTypes?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListReviewPolicyResultsForHIT(MaxResults: string, NextToken: string, requestBody: ListReviewPolicyResultsForHITRequest, headersHandler?: () => HttpHeaders): Observable<ListReviewPolicyResultsForHITResponse> {
			return this.http.post<ListReviewPolicyResultsForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewPolicyResultsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListReviewableHITs(MaxResults: string, NextToken: string, requestBody: ListReviewableHITsRequest, headersHandler?: () => HttpHeaders): Observable<ListReviewableHITsResponse> {
			return this.http.post<ListReviewableHITsResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewableHITs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListWorkerBlocks(MaxResults: string, NextToken: string, requestBody: ListWorkerBlocksRequest, headersHandler?: () => HttpHeaders): Observable<ListWorkerBlocksResponse> {
			return this.http.post<ListWorkerBlocksResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkerBlocks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListWorkersWithQualificationType(MaxResults: string, NextToken: string, requestBody: ListWorkersWithQualificationTypeRequest, headersHandler?: () => HttpHeaders): Observable<ListWorkersWithQualificationTypeResponse> {
			return this.http.post<ListWorkersWithQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkersWithQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		NotifyWorkers(requestBody: NotifyWorkersRequest, headersHandler?: () => HttpHeaders): Observable<NotifyWorkersResponse> {
			return this.http.post<NotifyWorkersResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.NotifyWorkers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RejectAssignment(requestBody: RejectAssignmentRequest, headersHandler?: () => HttpHeaders): Observable<RejectAssignmentResponse> {
			return this.http.post<RejectAssignmentResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectAssignment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RejectQualificationRequest(requestBody: RejectQualificationRequestRequest, headersHandler?: () => HttpHeaders): Observable<RejectQualificationRequestResponse> {
			return this.http.post<RejectQualificationRequestResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectQualificationRequest', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendBonus(requestBody: SendBonusRequest, headersHandler?: () => HttpHeaders): Observable<SendBonusResponse> {
			return this.http.post<SendBonusResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.SendBonus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendTestEventNotification(requestBody: SendTestEventNotificationRequest, headersHandler?: () => HttpHeaders): Observable<SendTestEventNotificationResponse> {
			return this.http.post<SendTestEventNotificationResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.SendTestEventNotification', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateExpirationForHIT(requestBody: UpdateExpirationForHITRequest, headersHandler?: () => HttpHeaders): Observable<UpdateExpirationForHITResponse> {
			return this.http.post<UpdateExpirationForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateExpirationForHIT', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateHITReviewStatus(requestBody: UpdateHITReviewStatusRequest, headersHandler?: () => HttpHeaders): Observable<UpdateHITReviewStatusResponse> {
			return this.http.post<UpdateHITReviewStatusResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITReviewStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateHITTypeOfHIT(requestBody: UpdateHITTypeOfHITRequest, headersHandler?: () => HttpHeaders): Observable<UpdateHITTypeOfHITResponse> {
			return this.http.post<UpdateHITTypeOfHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITTypeOfHIT', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateNotificationSettings(requestBody: UpdateNotificationSettingsRequest, headersHandler?: () => HttpHeaders): Observable<UpdateNotificationSettingsResponse> {
			return this.http.post<UpdateNotificationSettingsResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateNotificationSettings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateQualificationType(requestBody: UpdateQualificationTypeRequest, headersHandler?: () => HttpHeaders): Observable<UpdateQualificationTypeResponse> {
			return this.http.post<UpdateQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
