...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptQualificationRequest(requestBody: AcceptQualificationRequestRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptQualificationRequestResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.AcceptQualificationRequest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ApproveAssignment(requestBody: ApproveAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<ApproveAssignmentResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ApproveAssignment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		AssociateQualificationWithWorker(requestBody: AssociateQualificationWithWorkerRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateQualificationWithWorkerResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.AssociateQualificationWithWorker', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateAdditionalAssignmentsForHIT(requestBody: CreateAdditionalAssignmentsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAdditionalAssignmentsForHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateAdditionalAssignmentsForHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateHIT(requestBody: CreateHITRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateHITType(requestBody: CreateHITTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateHITWithHITType(requestBody: CreateHITWithHITTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITWithHITTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITWithHITType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateQualificationType(requestBody: CreateQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateQualificationTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateWorkerBlock(requestBody: CreateWorkerBlockRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkerBlockResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateWorkerBlock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteHIT(requestBody: DeleteHITRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteQualificationType(requestBody: DeleteQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteQualificationTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteWorkerBlock(requestBody: DeleteWorkerBlockRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkerBlockResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteWorkerBlock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DisassociateQualificationFromWorker(requestBody: DisassociateQualificationFromWorkerRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateQualificationFromWorkerResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.DisassociateQualificationFromWorker', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetAccountBalance(requestBody: GetAccountBalanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountBalanceResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAccountBalance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetAssignment(requestBody: GetAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAssignmentResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAssignment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetFileUploadURL(requestBody: GetFileUploadURLRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFileUploadURLResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.GetFileUploadURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetHIT(requestBody: GetHITRequest, headersHandler?: () => {[header: string]: string}): Promise<GetHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.GetHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetQualificationScore(requestBody: GetQualificationScoreRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQualificationScoreResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationScore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetQualificationType(requestBody: GetQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQualificationTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListAssignmentsForHIT(MaxResults: string, NextToken: string, requestBody: ListAssignmentsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssignmentsForHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListAssignmentsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListBonusPayments(MaxResults: string, NextToken: string, requestBody: ListBonusPaymentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListBonusPaymentsResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListBonusPayments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListHITs(MaxResults: string, NextToken: string, requestBody: ListHITsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHITsResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListHITs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListHITsForQualificationType(MaxResults: string, NextToken: string, requestBody: ListHITsForQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHITsForQualificationTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListHITsForQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListQualificationRequests(MaxResults: string, NextToken: string, requestBody: ListQualificationRequestsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListQualificationRequestsResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationRequests?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListQualificationTypes(MaxResults: string, NextToken: string, requestBody: ListQualificationTypesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListQualificationTypesResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationTypes?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListReviewPolicyResultsForHIT(MaxResults: string, NextToken: string, requestBody: ListReviewPolicyResultsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<ListReviewPolicyResultsForHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewPolicyResultsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListReviewableHITs(MaxResults: string, NextToken: string, requestBody: ListReviewableHITsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListReviewableHITsResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewableHITs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListWorkerBlocks(MaxResults: string, NextToken: string, requestBody: ListWorkerBlocksRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkerBlocksResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkerBlocks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListWorkersWithQualificationType(MaxResults: string, NextToken: string, requestBody: ListWorkersWithQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkersWithQualificationTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkersWithQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		NotifyWorkers(requestBody: NotifyWorkersRequest, headersHandler?: () => {[header: string]: string}): Promise<NotifyWorkersResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.NotifyWorkers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RejectAssignment(requestBody: RejectAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectAssignmentResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectAssignment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RejectQualificationRequest(requestBody: RejectQualificationRequestRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectQualificationRequestResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectQualificationRequest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		SendBonus(requestBody: SendBonusRequest, headersHandler?: () => {[header: string]: string}): Promise<SendBonusResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.SendBonus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		SendTestEventNotification(requestBody: SendTestEventNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<SendTestEventNotificationResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.SendTestEventNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateExpirationForHIT(requestBody: UpdateExpirationForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateExpirationForHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateExpirationForHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateHITReviewStatus(requestBody: UpdateHITReviewStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateHITReviewStatusResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITReviewStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateHITTypeOfHIT(requestBody: UpdateHITTypeOfHITRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateHITTypeOfHITResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITTypeOfHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateNotificationSettings(requestBody: UpdateNotificationSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotificationSettingsResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateNotificationSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateQualificationType(requestBody: UpdateQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateQualificationTypeResponse> {
			return this.http.post('/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
