...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ApproveAssignment(requestBody: ApproveAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<ApproveAssignmentResponse> {
			return Axios.post<ApproveAssignmentResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ApproveAssignment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAdditionalAssignmentsForHIT(requestBody: CreateAdditionalAssignmentsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAdditionalAssignmentsForHITResponse> {
			return Axios.post<CreateAdditionalAssignmentsForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateAdditionalAssignmentsForHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateHIT(requestBody: CreateHITRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITResponse> {
			return Axios.post<CreateHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateHITType(requestBody: CreateHITTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITTypeResponse> {
			return Axios.post<CreateHITTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateHITWithHITType(requestBody: CreateHITWithHITTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITWithHITTypeResponse> {
			return Axios.post<CreateHITWithHITTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITWithHITType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateQualificationType(requestBody: CreateQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateQualificationTypeResponse> {
			return Axios.post<CreateQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateWorkerBlock(requestBody: CreateWorkerBlockRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkerBlockResponse> {
			return Axios.post<CreateWorkerBlockResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateWorkerBlock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteHIT(requestBody: DeleteHITRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteHITResponse> {
			return Axios.post<DeleteHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteQualificationType(requestBody: DeleteQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteQualificationTypeResponse> {
			return Axios.post<DeleteQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteWorkerBlock(requestBody: DeleteWorkerBlockRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkerBlockResponse> {
			return Axios.post<DeleteWorkerBlockResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteWorkerBlock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateQualificationFromWorker(requestBody: DisassociateQualificationFromWorkerRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateQualificationFromWorkerResponse> {
			return Axios.post<DisassociateQualificationFromWorkerResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DisassociateQualificationFromWorker', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAccountBalance(requestBody: GetAccountBalanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountBalanceResponse> {
			return Axios.post<GetAccountBalanceResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAccountBalance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAssignment(requestBody: GetAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAssignmentResponse> {
			return Axios.post<GetAssignmentResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAssignment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFileUploadURL(requestBody: GetFileUploadURLRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFileUploadURLResponse> {
			return Axios.post<GetFileUploadURLResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetFileUploadURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetHIT(requestBody: GetHITRequest, headersHandler?: () => {[header: string]: string}): Promise<GetHITResponse> {
			return Axios.post<GetHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetQualificationScore(requestBody: GetQualificationScoreRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQualificationScoreResponse> {
			return Axios.post<GetQualificationScoreResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationScore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetQualificationType(requestBody: GetQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQualificationTypeResponse> {
			return Axios.post<GetQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssignmentsForHIT(MaxResults: string, NextToken: string, requestBody: ListAssignmentsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssignmentsForHITResponse> {
			return Axios.post<ListAssignmentsForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListAssignmentsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListBonusPayments(MaxResults: string, NextToken: string, requestBody: ListBonusPaymentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListBonusPaymentsResponse> {
			return Axios.post<ListBonusPaymentsResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListBonusPayments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListHITsForQualificationType(MaxResults: string, NextToken: string, requestBody: ListHITsForQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHITsForQualificationTypeResponse> {
			return Axios.post<ListHITsForQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListHITsForQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListQualificationRequests(MaxResults: string, NextToken: string, requestBody: ListQualificationRequestsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListQualificationRequestsResponse> {
			return Axios.post<ListQualificationRequestsResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationRequests?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListQualificationTypes(MaxResults: string, NextToken: string, requestBody: ListQualificationTypesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListQualificationTypesResponse> {
			return Axios.post<ListQualificationTypesResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationTypes?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListReviewPolicyResultsForHIT(MaxResults: string, NextToken: string, requestBody: ListReviewPolicyResultsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<ListReviewPolicyResultsForHITResponse> {
			return Axios.post<ListReviewPolicyResultsForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewPolicyResultsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListReviewableHITs(MaxResults: string, NextToken: string, requestBody: ListReviewableHITsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListReviewableHITsResponse> {
			return Axios.post<ListReviewableHITsResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewableHITs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListWorkerBlocks(MaxResults: string, NextToken: string, requestBody: ListWorkerBlocksRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkerBlocksResponse> {
			return Axios.post<ListWorkerBlocksResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkerBlocks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListWorkersWithQualificationType(MaxResults: string, NextToken: string, requestBody: ListWorkersWithQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkersWithQualificationTypeResponse> {
			return Axios.post<ListWorkersWithQualificationTypeResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkersWithQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		NotifyWorkers(requestBody: NotifyWorkersRequest, headersHandler?: () => {[header: string]: string}): Promise<NotifyWorkersResponse> {
			return Axios.post<NotifyWorkersResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.NotifyWorkers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RejectAssignment(requestBody: RejectAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectAssignmentResponse> {
			return Axios.post<RejectAssignmentResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectAssignment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendBonus(requestBody: SendBonusRequest, headersHandler?: () => {[header: string]: string}): Promise<SendBonusResponse> {
			return Axios.post<SendBonusResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.SendBonus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateExpirationForHIT(requestBody: UpdateExpirationForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateExpirationForHITResponse> {
			return Axios.post<UpdateExpirationForHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateExpirationForHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateHITReviewStatus(requestBody: UpdateHITReviewStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateHITReviewStatusResponse> {
			return Axios.post<UpdateHITReviewStatusResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITReviewStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateHITTypeOfHIT(requestBody: UpdateHITTypeOfHITRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateHITTypeOfHITResponse> {
			return Axios.post<UpdateHITTypeOfHITResponse>(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITTypeOfHIT', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
