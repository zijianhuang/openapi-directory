export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptQualificationRequest(requestBody: AcceptQualificationRequestRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptQualificationRequestResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.AcceptQualificationRequest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ApproveAssignment(requestBody: ApproveAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<ApproveAssignmentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ApproveAssignment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AssociateQualificationWithWorker(requestBody: AssociateQualificationWithWorkerRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateQualificationWithWorkerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.AssociateQualificationWithWorker', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateHIT(requestBody: CreateHITRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHIT', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateHITType(requestBody: CreateHITTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateHITWithHITType(requestBody: CreateHITWithHITTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHITWithHITTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateHITWithHITType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateQualificationType(requestBody: CreateQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateQualificationTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateQualificationType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateWorkerBlock(requestBody: CreateWorkerBlockRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkerBlockResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.CreateWorkerBlock', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteHIT(requestBody: DeleteHITRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteHITResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteHIT', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteQualificationType(requestBody: DeleteQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteQualificationTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteQualificationType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteWorkerBlock(requestBody: DeleteWorkerBlockRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkerBlockResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DeleteWorkerBlock', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisassociateQualificationFromWorker(requestBody: DisassociateQualificationFromWorkerRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateQualificationFromWorkerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.DisassociateQualificationFromWorker', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetAccountBalance(requestBody: GetAccountBalanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountBalanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAccountBalance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetAssignment(requestBody: GetAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAssignmentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetAssignment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetFileUploadURL(requestBody: GetFileUploadURLRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFileUploadURLResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetFileUploadURL', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetHIT(requestBody: GetHITRequest, headersHandler?: () => {[header: string]: string}): Promise<GetHITResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetHIT', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetQualificationScore(requestBody: GetQualificationScoreRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQualificationScoreResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationScore', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetQualificationType(requestBody: GetQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQualificationTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.GetQualificationType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListAssignmentsForHIT(MaxResults: string, NextToken: string, requestBody: ListAssignmentsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssignmentsForHITResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListAssignmentsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBonusPayments(MaxResults: string, NextToken: string, requestBody: ListBonusPaymentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListBonusPaymentsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListBonusPayments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListHITsForQualificationType(MaxResults: string, NextToken: string, requestBody: ListHITsForQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHITsForQualificationTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListHITsForQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListQualificationRequests(MaxResults: string, NextToken: string, requestBody: ListQualificationRequestsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListQualificationRequestsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationRequests?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListQualificationTypes(MaxResults: string, NextToken: string, requestBody: ListQualificationTypesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListQualificationTypesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListQualificationTypes?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListReviewPolicyResultsForHIT(MaxResults: string, NextToken: string, requestBody: ListReviewPolicyResultsForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<ListReviewPolicyResultsForHITResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewPolicyResultsForHIT?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListReviewableHITs(MaxResults: string, NextToken: string, requestBody: ListReviewableHITsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListReviewableHITsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListReviewableHITs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListWorkerBlocks(MaxResults: string, NextToken: string, requestBody: ListWorkerBlocksRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkerBlocksResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkerBlocks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListWorkersWithQualificationType(MaxResults: string, NextToken: string, requestBody: ListWorkersWithQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkersWithQualificationTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.ListWorkersWithQualificationType?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		NotifyWorkers(requestBody: NotifyWorkersRequest, headersHandler?: () => {[header: string]: string}): Promise<NotifyWorkersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.NotifyWorkers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RejectAssignment(requestBody: RejectAssignmentRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectAssignmentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectAssignment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RejectQualificationRequest(requestBody: RejectQualificationRequestRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectQualificationRequestResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.RejectQualificationRequest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SendBonus(requestBody: SendBonusRequest, headersHandler?: () => {[header: string]: string}): Promise<SendBonusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.SendBonus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SendTestEventNotification(requestBody: SendTestEventNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<SendTestEventNotificationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.SendTestEventNotification', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateExpirationForHIT(requestBody: UpdateExpirationForHITRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateExpirationForHITResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateExpirationForHIT', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateHITReviewStatus(requestBody: UpdateHITReviewStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateHITReviewStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITReviewStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateHITTypeOfHIT(requestBody: UpdateHITTypeOfHITRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateHITTypeOfHITResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateHITTypeOfHIT', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateNotificationSettings(requestBody: UpdateNotificationSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotificationSettingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateNotificationSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateQualificationType(requestBody: UpdateQualificationTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateQualificationTypeResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=MTurkRequesterServiceV20170117.UpdateQualificationType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
