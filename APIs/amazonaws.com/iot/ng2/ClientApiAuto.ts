...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddThingToBillingGroup(requestBody: AddThingToBillingGroupBody, headersHandler?: () => HttpHeaders): Observable<AddThingToBillingGroupResponse> {
			return this.http.put<AddThingToBillingGroupResponse>(this.baseUri + '/billing-groups/addThingToBillingGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AddThingToThingGroup(requestBody: AddThingToThingGroupBody, headersHandler?: () => HttpHeaders): Observable<AddThingToThingGroupResponse> {
			return this.http.put<AddThingToThingGroupResponse>(this.baseUri + '/thing-groups/addThingToThingGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssociateTargetsWithJob(jobId: string, requestBody: AssociateTargetsWithJobBody, headersHandler?: () => HttpHeaders): Observable<AssociateTargetsWithJobResponse> {
			return this.http.post<AssociateTargetsWithJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/targets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		AttachPolicy(policyName: string, requestBody: AttachPolicyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/target-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DetachPolicy(policyName: string, requestBody: DetachPolicyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		AttachPrincipalPolicy(policyName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DetachPrincipalPolicy(policyName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		AttachSecurityProfile(securityProfileName: string, securityProfileTargetArn: string, headersHandler?: () => HttpHeaders): Observable<AttachSecurityProfileResponse> {
			return this.http.put<AttachSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets#securityProfileTargetArn&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DetachSecurityProfile(securityProfileName: string, securityProfileTargetArn: string, headersHandler?: () => HttpHeaders): Observable<DetachSecurityProfileResponse> {
			return this.http.delete<DetachSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets#securityProfileTargetArn&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		AttachThingPrincipal(thingName: string, headersHandler?: () => HttpHeaders): Observable<AttachThingPrincipalResponse> {
			return this.http.put<AttachThingPrincipalResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DetachThingPrincipal(thingName: string, headersHandler?: () => HttpHeaders): Observable<DetachThingPrincipalResponse> {
			return this.http.delete<DetachThingPrincipalResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CancelAuditMitigationActionsTask(taskId: string, headersHandler?: () => HttpHeaders): Observable<CancelAuditMitigationActionsTaskResponse> {
			return this.http.put<CancelAuditMitigationActionsTaskResponse>(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CancelAuditTask(taskId: string, headersHandler?: () => HttpHeaders): Observable<CancelAuditTaskResponse> {
			return this.http.put<CancelAuditTaskResponse>(this.baseUri + '/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CancelJob(jobId: string, force: boolean, requestBody: CancelJobBody, headersHandler?: () => HttpHeaders): Observable<CancelJobResponse> {
			return this.http.put<CancelJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		CancelJobExecution(jobId: string, thingName: string, force: boolean, requestBody: CancelJobExecutionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ClearDefaultAuthorizer(headersHandler?: () => HttpHeaders): Observable<ClearDefaultAuthorizerResponse> {
			return this.http.delete<ClearDefaultAuthorizerResponse>(this.baseUri + '/default-authorizer', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDefaultAuthorizer(headersHandler?: () => HttpHeaders): Observable<DescribeDefaultAuthorizerResponse> {
			return this.http.get<DescribeDefaultAuthorizerResponse>(this.baseUri + '/default-authorizer', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		SetDefaultAuthorizer(requestBody: SetDefaultAuthorizerBody, headersHandler?: () => HttpHeaders): Observable<SetDefaultAuthorizerResponse> {
			return this.http.post<SetDefaultAuthorizerResponse>(this.baseUri + '/default-authorizer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ConfirmTopicRuleDestination(confirmationToken: string, headersHandler?: () => HttpHeaders): Observable<ConfirmTopicRuleDestinationResponse> {
			return this.http.get<ConfirmTopicRuleDestinationResponse>(this.baseUri + '/confirmdestination/' + (confirmationToken == null ? '' : encodeURIComponent(confirmationToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateAuthorizer(authorizerName: string, requestBody: CreateAuthorizerBody, headersHandler?: () => HttpHeaders): Observable<CreateAuthorizerResponse> {
			return this.http.post<CreateAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteAuthorizer(authorizerName: string, headersHandler?: () => HttpHeaders): Observable<DeleteAuthorizerResponse> {
			return this.http.delete<DeleteAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeAuthorizer(authorizerName: string, headersHandler?: () => HttpHeaders): Observable<DescribeAuthorizerResponse> {
			return this.http.get<DescribeAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateAuthorizer(authorizerName: string, requestBody: UpdateAuthorizerBody, headersHandler?: () => HttpHeaders): Observable<UpdateAuthorizerResponse> {
			return this.http.put<UpdateAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateBillingGroup(billingGroupName: string, requestBody: CreateBillingGroupBody, headersHandler?: () => HttpHeaders): Observable<CreateBillingGroupResponse> {
			return this.http.post<CreateBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteBillingGroup(billingGroupName: string, expectedVersion: number, headersHandler?: () => HttpHeaders): Observable<DeleteBillingGroupResponse> {
			return this.http.delete<DeleteBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeBillingGroup(billingGroupName: string, headersHandler?: () => HttpHeaders): Observable<DescribeBillingGroupResponse> {
			return this.http.get<DescribeBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateCertificateFromCsr(setAsActive: boolean, requestBody: CreateCertificateFromCsrBody, headersHandler?: () => HttpHeaders): Observable<CreateCertificateFromCsrResponse> {
			return this.http.post<CreateCertificateFromCsrResponse>(this.baseUri + '/certificates?setAsActive=' + setAsActive, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListCertificatesResponse> {
			return this.http.get<ListCertificatesResponse>(this.baseUri + '/certificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateDimension(name: string, requestBody: CreateDimensionBody, headersHandler?: () => HttpHeaders): Observable<CreateDimensionResponse> {
			return this.http.post<CreateDimensionResponse>(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDimension(name: string, headersHandler?: () => HttpHeaders): Observable<DeleteDimensionResponse> {
			return this.http.delete<DeleteDimensionResponse>(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDimension(name: string, headersHandler?: () => HttpHeaders): Observable<DescribeDimensionResponse> {
			return this.http.get<DescribeDimensionResponse>(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateDomainConfiguration(domainConfigurationName: string, requestBody: CreateDomainConfigurationBody, headersHandler?: () => HttpHeaders): Observable<CreateDomainConfigurationResponse> {
			return this.http.post<CreateDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDomainConfiguration(domainConfigurationName: string, headersHandler?: () => HttpHeaders): Observable<DeleteDomainConfigurationResponse> {
			return this.http.delete<DeleteDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDomainConfiguration(domainConfigurationName: string, headersHandler?: () => HttpHeaders): Observable<DescribeDomainConfigurationResponse> {
			return this.http.get<DescribeDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDomainConfiguration(domainConfigurationName: string, requestBody: UpdateDomainConfigurationBody, headersHandler?: () => HttpHeaders): Observable<UpdateDomainConfigurationResponse> {
			return this.http.put<UpdateDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDynamicThingGroup(thingGroupName: string, requestBody: CreateDynamicThingGroupBody, headersHandler?: () => HttpHeaders): Observable<CreateDynamicThingGroupResponse> {
			return this.http.post<CreateDynamicThingGroupResponse>(this.baseUri + '/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDynamicThingGroup(thingGroupName: string, expectedVersion: number, headersHandler?: () => HttpHeaders): Observable<DeleteDynamicThingGroupResponse> {
			return this.http.delete<DeleteDynamicThingGroupResponse>(this.baseUri + '/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateJob(jobId: string, requestBody: CreateJobBody, headersHandler?: () => HttpHeaders): Observable<CreateJobResponse> {
			return this.http.put<CreateJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteJob(jobId: string, force: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeJob(jobId: string, headersHandler?: () => HttpHeaders): Observable<DescribeJobResponse> {
			return this.http.get<DescribeJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateKeysAndCertificate(setAsActive: boolean, headersHandler?: () => HttpHeaders): Observable<CreateKeysAndCertificateResponse> {
			return this.http.post<CreateKeysAndCertificateResponse>(this.baseUri + '/keys-and-certificate?setAsActive=' + setAsActive, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateMitigationAction(actionName: string, requestBody: CreateMitigationActionBody, headersHandler?: () => HttpHeaders): Observable<CreateMitigationActionResponse> {
			return this.http.post<CreateMitigationActionResponse>(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteMitigationAction(actionName: string, headersHandler?: () => HttpHeaders): Observable<DeleteMitigationActionResponse> {
			return this.http.delete<DeleteMitigationActionResponse>(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeMitigationAction(actionName: string, headersHandler?: () => HttpHeaders): Observable<DescribeMitigationActionResponse> {
			return this.http.get<DescribeMitigationActionResponse>(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateOTAUpdate(otaUpdateId: string, requestBody: CreateOTAUpdateBody, headersHandler?: () => HttpHeaders): Observable<CreateOTAUpdateResponse> {
			return this.http.post<CreateOTAUpdateResponse>(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteOTAUpdate(otaUpdateId: string, deleteStream: boolean, forceDeleteAWSJob: boolean, headersHandler?: () => HttpHeaders): Observable<DeleteOTAUpdateResponse> {
			return this.http.delete<DeleteOTAUpdateResponse>(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)) + '&deleteStream=' + deleteStream + '&forceDeleteAWSJob=' + forceDeleteAWSJob, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetOTAUpdate(otaUpdateId: string, headersHandler?: () => HttpHeaders): Observable<GetOTAUpdateResponse> {
			return this.http.get<GetOTAUpdateResponse>(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreatePolicy(policyName: string, requestBody: CreatePolicyBody, headersHandler?: () => HttpHeaders): Observable<CreatePolicyResponse> {
			return this.http.post<CreatePolicyResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePolicy(policyName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetPolicy(policyName: string, headersHandler?: () => HttpHeaders): Observable<GetPolicyResponse> {
			return this.http.get<GetPolicyResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreatePolicyVersion(policyName: string, setAsDefault: boolean, requestBody: CreatePolicyVersionBody, headersHandler?: () => HttpHeaders): Observable<CreatePolicyVersionResponse> {
			return this.http.post<CreatePolicyVersionResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version&setAsDefault=' + setAsDefault, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPolicyVersions(policyName: string, headersHandler?: () => HttpHeaders): Observable<ListPolicyVersionsResponse> {
			return this.http.get<ListPolicyVersionsResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateProvisioningClaim(templateName: string, headersHandler?: () => HttpHeaders): Observable<CreateProvisioningClaimResponse> {
			return this.http.post<CreateProvisioningClaimResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/provisioning-claim', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateProvisioningTemplate(requestBody: CreateProvisioningTemplateBody, headersHandler?: () => HttpHeaders): Observable<CreateProvisioningTemplateResponse> {
			return this.http.post<CreateProvisioningTemplateResponse>(this.baseUri + '/provisioning-templates', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListProvisioningTemplates(maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListProvisioningTemplatesResponse> {
			return this.http.get<ListProvisioningTemplatesResponse>(this.baseUri + '/provisioning-templates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateProvisioningTemplateVersion(templateName: string, setAsDefault: boolean, requestBody: CreateProvisioningTemplateVersionBody, headersHandler?: () => HttpHeaders): Observable<CreateProvisioningTemplateVersionResponse> {
			return this.http.post<CreateProvisioningTemplateVersionResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&setAsDefault=' + setAsDefault, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListProvisioningTemplateVersions(templateName: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListProvisioningTemplateVersionsResponse> {
			return this.http.get<ListProvisioningTemplateVersionsResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateRoleAlias(roleAlias: string, requestBody: CreateRoleAliasBody, headersHandler?: () => HttpHeaders): Observable<CreateRoleAliasResponse> {
			return this.http.post<CreateRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRoleAlias(roleAlias: string, headersHandler?: () => HttpHeaders): Observable<DeleteRoleAliasResponse> {
			return this.http.delete<DeleteRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeRoleAlias(roleAlias: string, headersHandler?: () => HttpHeaders): Observable<DescribeRoleAliasResponse> {
			return this.http.get<DescribeRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateRoleAlias(roleAlias: string, requestBody: UpdateRoleAliasBody, headersHandler?: () => HttpHeaders): Observable<UpdateRoleAliasResponse> {
			return this.http.put<UpdateRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateScheduledAudit(scheduledAuditName: string, requestBody: CreateScheduledAuditBody, headersHandler?: () => HttpHeaders): Observable<CreateScheduledAuditResponse> {
			return this.http.post<CreateScheduledAuditResponse>(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteScheduledAudit(scheduledAuditName: string, headersHandler?: () => HttpHeaders): Observable<DeleteScheduledAuditResponse> {
			return this.http.delete<DeleteScheduledAuditResponse>(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeScheduledAudit(scheduledAuditName: string, headersHandler?: () => HttpHeaders): Observable<DescribeScheduledAuditResponse> {
			return this.http.get<DescribeScheduledAuditResponse>(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateSecurityProfile(securityProfileName: string, requestBody: CreateSecurityProfileBody, headersHandler?: () => HttpHeaders): Observable<CreateSecurityProfileResponse> {
			return this.http.post<CreateSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSecurityProfile(securityProfileName: string, expectedVersion: number, headersHandler?: () => HttpHeaders): Observable<DeleteSecurityProfileResponse> {
			return this.http.delete<DeleteSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeSecurityProfile(securityProfileName: string, headersHandler?: () => HttpHeaders): Observable<DescribeSecurityProfileResponse> {
			return this.http.get<DescribeSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateStream(streamId: string, requestBody: CreateStreamBody, headersHandler?: () => HttpHeaders): Observable<CreateStreamResponse> {
			return this.http.post<CreateStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteStream(streamId: string, headersHandler?: () => HttpHeaders): Observable<DeleteStreamResponse> {
			return this.http.delete<DeleteStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeStream(streamId: string, headersHandler?: () => HttpHeaders): Observable<DescribeStreamResponse> {
			return this.http.get<DescribeStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateStream(streamId: string, requestBody: UpdateStreamBody, headersHandler?: () => HttpHeaders): Observable<UpdateStreamResponse> {
			return this.http.put<UpdateStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateThing(thingName: string, requestBody: CreateThingBody, headersHandler?: () => HttpHeaders): Observable<CreateThingResponse> {
			return this.http.post<CreateThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteThing(thingName: string, expectedVersion: number, headersHandler?: () => HttpHeaders): Observable<DeleteThingResponse> {
			return this.http.delete<DeleteThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeThing(thingName: string, headersHandler?: () => HttpHeaders): Observable<DescribeThingResponse> {
			return this.http.get<DescribeThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateThingGroup(thingGroupName: string, requestBody: CreateThingGroupBody, headersHandler?: () => HttpHeaders): Observable<CreateThingGroupResponse> {
			return this.http.post<CreateThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteThingGroup(thingGroupName: string, expectedVersion: number, headersHandler?: () => HttpHeaders): Observable<DeleteThingGroupResponse> {
			return this.http.delete<DeleteThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeThingGroup(thingGroupName: string, headersHandler?: () => HttpHeaders): Observable<DescribeThingGroupResponse> {
			return this.http.get<DescribeThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateThingType(thingTypeName: string, requestBody: CreateThingTypeBody, headersHandler?: () => HttpHeaders): Observable<CreateThingTypeResponse> {
			return this.http.post<CreateThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteThingType(thingTypeName: string, headersHandler?: () => HttpHeaders): Observable<DeleteThingTypeResponse> {
			return this.http.delete<DeleteThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeThingType(thingTypeName: string, headersHandler?: () => HttpHeaders): Observable<DescribeThingTypeResponse> {
			return this.http.get<DescribeThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		CreateTopicRule(ruleName: string, requestBody: CreateTopicRuleBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteTopicRule(ruleName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetTopicRule(ruleName: string, headersHandler?: () => HttpHeaders): Observable<GetTopicRuleResponse> {
			return this.http.get<GetTopicRuleResponse>(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateTopicRuleDestination(requestBody: CreateTopicRuleDestinationBody, headersHandler?: () => HttpHeaders): Observable<CreateTopicRuleDestinationResponse> {
			return this.http.post<CreateTopicRuleDestinationResponse>(this.baseUri + '/destinations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTopicRuleDestinations(maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListTopicRuleDestinationsResponse> {
			return this.http.get<ListTopicRuleDestinationsResponse>(this.baseUri + '/destinations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteAccountAuditConfiguration(deleteScheduledAudits: boolean, headersHandler?: () => HttpHeaders): Observable<DeleteAccountAuditConfigurationResponse> {
			return this.http.delete<DeleteAccountAuditConfigurationResponse>(this.baseUri + '/audit/configuration?deleteScheduledAudits=' + deleteScheduledAudits, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeAccountAuditConfiguration(headersHandler?: () => HttpHeaders): Observable<DescribeAccountAuditConfigurationResponse> {
			return this.http.get<DescribeAccountAuditConfigurationResponse>(this.baseUri + '/audit/configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteCACertificate(caCertificateId: string, headersHandler?: () => HttpHeaders): Observable<DeleteCACertificateResponse> {
			return this.http.delete<DeleteCACertificateResponse>(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeCACertificate(caCertificateId: string, headersHandler?: () => HttpHeaders): Observable<DescribeCACertificateResponse> {
			return this.http.get<DescribeCACertificateResponse>(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCACertificate(caCertificateId: string, newStatus: AuthorizerStatus, newAutoRegistrationStatus: AutoRegistrationStatus, requestBody: UpdateCACertificateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)) + '&newStatus=' + newStatus + '&newAutoRegistrationStatus=' + newAutoRegistrationStatus, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificate(certificateId: string, forceDelete: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '&forceDelete=' + forceDelete, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeCertificate(certificateId: string, headersHandler?: () => HttpHeaders): Observable<DescribeCertificateResponse> {
			return this.http.get<DescribeCertificateResponse>(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteJobExecution(jobId: string, thingName: string, executionNumber: number, force: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/executionNumber/' + executionNumber + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePolicyVersion(policyName: string, policyVersionId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetPolicyVersion(policyName: string, policyVersionId: string, headersHandler?: () => HttpHeaders): Observable<GetPolicyVersionResponse> {
			return this.http.get<GetPolicyVersionResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteProvisioningTemplate(templateName: string, headersHandler?: () => HttpHeaders): Observable<DeleteProvisioningTemplateResponse> {
			return this.http.delete<DeleteProvisioningTemplateResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeProvisioningTemplate(templateName: string, headersHandler?: () => HttpHeaders): Observable<DescribeProvisioningTemplateResponse> {
			return this.http.get<DescribeProvisioningTemplateResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteProvisioningTemplateVersion(templateName: string, versionId: number, headersHandler?: () => HttpHeaders): Observable<DeleteProvisioningTemplateVersionResponse> {
			return this.http.delete<DeleteProvisioningTemplateVersionResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeProvisioningTemplateVersion(templateName: string, versionId: number, headersHandler?: () => HttpHeaders): Observable<DescribeProvisioningTemplateVersionResponse> {
			return this.http.get<DescribeProvisioningTemplateVersionResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteRegistrationCode(headersHandler?: () => HttpHeaders): Observable<DeleteRegistrationCodeResponse> {
			return this.http.delete<DeleteRegistrationCodeResponse>(this.baseUri + '/registrationcode', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetRegistrationCode(headersHandler?: () => HttpHeaders): Observable<GetRegistrationCodeResponse> {
			return this.http.get<GetRegistrationCodeResponse>(this.baseUri + '/registrationcode', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteTopicRuleDestination(arn: string, headersHandler?: () => HttpHeaders): Observable<DeleteTopicRuleDestinationResponse> {
			return this.http.delete<DeleteTopicRuleDestinationResponse>(this.baseUri + '/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetTopicRuleDestination(arn: string, headersHandler?: () => HttpHeaders): Observable<GetTopicRuleDestinationResponse> {
			return this.http.get<GetTopicRuleDestinationResponse>(this.baseUri + '/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteV2LoggingLevel(targetType: LogTargetType, targetName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/v2LoggingLevel#targetType&targetName?targetType=' + targetType + '&targetName=' + (targetName == null ? '' : encodeURIComponent(targetName)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeprecateThingType(thingTypeName: string, requestBody: DeprecateThingTypeBody, headersHandler?: () => HttpHeaders): Observable<DeprecateThingTypeResponse> {
			return this.http.post<DeprecateThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)) + '/deprecate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAuditFinding(findingId: string, headersHandler?: () => HttpHeaders): Observable<DescribeAuditFindingResponse> {
			return this.http.get<DescribeAuditFindingResponse>(this.baseUri + '/audit/findings/' + (findingId == null ? '' : encodeURIComponent(findingId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeAuditMitigationActionsTask(taskId: string, headersHandler?: () => HttpHeaders): Observable<DescribeAuditMitigationActionsTaskResponse> {
			return this.http.get<DescribeAuditMitigationActionsTaskResponse>(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		StartAuditMitigationActionsTask(taskId: string, requestBody: StartAuditMitigationActionsTaskBody, headersHandler?: () => HttpHeaders): Observable<StartAuditMitigationActionsTaskResponse> {
			return this.http.post<StartAuditMitigationActionsTaskResponse>(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAuditTask(taskId: string, headersHandler?: () => HttpHeaders): Observable<DescribeAuditTaskResponse> {
			return this.http.get<DescribeAuditTaskResponse>(this.baseUri + '/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeEndpoint(endpointType: string, headersHandler?: () => HttpHeaders): Observable<DescribeEndpointResponse> {
			return this.http.get<DescribeEndpointResponse>(this.baseUri + '/endpoint?endpointType=' + (endpointType == null ? '' : encodeURIComponent(endpointType)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeEventConfigurations(headersHandler?: () => HttpHeaders): Observable<DescribeEventConfigurationsResponse> {
			return this.http.get<DescribeEventConfigurationsResponse>(this.baseUri + '/event-configurations', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeIndex(indexName: string, headersHandler?: () => HttpHeaders): Observable<DescribeIndexResponse> {
			return this.http.get<DescribeIndexResponse>(this.baseUri + '/indices/' + (indexName == null ? '' : encodeURIComponent(indexName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeJobExecution(jobId: string, thingName: string, executionNumber: number, headersHandler?: () => HttpHeaders): Observable<DescribeJobExecutionResponse> {
			return this.http.get<DescribeJobExecutionResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&executionNumber=' + executionNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeThingRegistrationTask(taskId: string, headersHandler?: () => HttpHeaders): Observable<DescribeThingRegistrationTaskResponse> {
			return this.http.get<DescribeThingRegistrationTaskResponse>(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		DisableTopicRule(ruleName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/disable', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		EnableTopicRule(ruleName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/enable', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetCardinality(requestBody: GetCardinalityBody, headersHandler?: () => HttpHeaders): Observable<GetCardinalityResponse> {
			return this.http.post<GetCardinalityResponse>(this.baseUri + '/indices/cardinality', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetEffectivePolicies(thingName: string, requestBody: GetEffectivePoliciesBody, headersHandler?: () => HttpHeaders): Observable<GetEffectivePoliciesResponse> {
			return this.http.post<GetEffectivePoliciesResponse>(this.baseUri + '/effective-policies?thingName=' + (thingName == null ? '' : encodeURIComponent(thingName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetIndexingConfiguration(headersHandler?: () => HttpHeaders): Observable<GetIndexingConfigurationResponse> {
			return this.http.get<GetIndexingConfigurationResponse>(this.baseUri + '/indexing/config', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateIndexingConfiguration(requestBody: UpdateIndexingConfigurationBody, headersHandler?: () => HttpHeaders): Observable<UpdateIndexingConfigurationResponse> {
			return this.http.post<UpdateIndexingConfigurationResponse>(this.baseUri + '/indexing/config', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetJobDocument(jobId: string, headersHandler?: () => HttpHeaders): Observable<GetJobDocumentResponse> {
			return this.http.get<GetJobDocumentResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/job-document', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetLoggingOptions(headersHandler?: () => HttpHeaders): Observable<GetLoggingOptionsResponse> {
			return this.http.get<GetLoggingOptionsResponse>(this.baseUri + '/loggingOptions', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		SetLoggingOptions(requestBody: SetLoggingOptionsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/loggingOptions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetPercentiles(requestBody: GetPercentilesBody, headersHandler?: () => HttpHeaders): Observable<GetPercentilesResponse> {
			return this.http.post<GetPercentilesResponse>(this.baseUri + '/indices/percentiles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetStatistics(requestBody: GetStatisticsBody, headersHandler?: () => HttpHeaders): Observable<GetStatisticsResponse> {
			return this.http.post<GetStatisticsResponse>(this.baseUri + '/indices/statistics', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetV2LoggingOptions(headersHandler?: () => HttpHeaders): Observable<GetV2LoggingOptionsResponse> {
			return this.http.get<GetV2LoggingOptionsResponse>(this.baseUri + '/v2LoggingOptions', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		SetV2LoggingOptions(requestBody: SetV2LoggingOptionsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v2LoggingOptions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListActiveViolations(thingName: string, securityProfileName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListActiveViolationsResponse> {
			return this.http.get<ListActiveViolationsResponse>(this.baseUri + '/active-violations?thingName=' + (thingName == null ? '' : encodeURIComponent(thingName)) + '&securityProfileName=' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListAttachedPolicies(target: string, recursive: boolean, marker: string, pageSize: number, headersHandler?: () => HttpHeaders): Observable<ListAttachedPoliciesResponse> {
			return this.http.post<ListAttachedPoliciesResponse>(this.baseUri + '/attached-policies/' + (target == null ? '' : encodeURIComponent(target)) + '&recursive=' + recursive + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListAuditFindings(requestBody: ListAuditFindingsBody, headersHandler?: () => HttpHeaders): Observable<ListAuditFindingsResponse> {
			return this.http.post<ListAuditFindingsResponse>(this.baseUri + '/audit/findings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAuditMitigationActionsExecutions(taskId: string, actionStatus: AuditMitigationActionsExecutionStatus, findingId: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListAuditMitigationActionsExecutionsResponse> {
			return this.http.get<ListAuditMitigationActionsExecutionsResponse>(this.baseUri + '/audit/mitigationactions/executions#taskId&findingId?taskId=' + (taskId == null ? '' : encodeURIComponent(taskId)) + '&actionStatus=' + actionStatus + '&findingId=' + (findingId == null ? '' : encodeURIComponent(findingId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListAuditMitigationActionsTasks(auditTaskId: string, findingId: string, taskStatus: DescribeAuditMitigationActionsTaskResponseTaskStatus, maxResults: number, nextToken: string, startTime: Date, endTime: Date, headersHandler?: () => HttpHeaders): Observable<ListAuditMitigationActionsTasksResponse> {
		 ...
		 */
		ListAuditTasks(startTime: Date, endTime: Date, taskType: DescribeAuditTaskResponseTaskType, taskStatus: DescribeAuditMitigationActionsTaskResponseTaskStatus, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListAuditTasksResponse> {
			return this.http.get<ListAuditTasksResponse>(this.baseUri + '/audit/tasks#startTime&endTime?startTime=' + startTime.toISOString() + '&endTime=' + endTime.toISOString() + '&taskType=' + taskType + '&taskStatus=' + taskStatus + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListAuthorizers(pageSize: number, marker: string, isAscendingOrder: boolean, status: AuthorizerStatus, headersHandler?: () => HttpHeaders): Observable<ListAuthorizersResponse> {
			return this.http.get<ListAuthorizersResponse>(this.baseUri + '/authorizers/?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListBillingGroups(nextToken: string, maxResults: number, namePrefixFilter: string, headersHandler?: () => HttpHeaders): Observable<ListBillingGroupsResponse> {
			return this.http.get<ListBillingGroupsResponse>(this.baseUri + '/billing-groups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&namePrefixFilter=' + (namePrefixFilter == null ? '' : encodeURIComponent(namePrefixFilter)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListCACertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListCACertificatesResponse> {
			return this.http.get<ListCACertificatesResponse>(this.baseUri + '/cacertificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListCertificatesByCA(caCertificateId: string, pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListCertificatesByCAResponse> {
			return this.http.get<ListCertificatesByCAResponse>(this.baseUri + '/certificates-by-ca/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)) + '&pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListDimensions(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListDimensionsResponse> {
			return this.http.get<ListDimensionsResponse>(this.baseUri + '/dimensions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListDomainConfigurations(marker: string, pageSize: number, serviceType: DescribeDomainConfigurationResponseServiceType, headersHandler?: () => HttpHeaders): Observable<ListDomainConfigurationsResponse> {
			return this.http.get<ListDomainConfigurationsResponse>(this.baseUri + '/domainConfigurations?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&serviceType=' + serviceType, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListIndices(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListIndicesResponse> {
			return this.http.get<ListIndicesResponse>(this.baseUri + '/indices?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListJobExecutionsForJob(jobId: string, status: JobExecutionStatus, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListJobExecutionsForJobResponse> {
			return this.http.get<ListJobExecutionsForJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/things&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListJobExecutionsForThing(thingName: string, status: JobExecutionStatus, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListJobExecutionsForThingResponse> {
			return this.http.get<ListJobExecutionsForThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListJobs(status: JobStatus, targetSelection: TargetSelection, maxResults: number, nextToken: string, thingGroupName: string, thingGroupId: string, headersHandler?: () => HttpHeaders): Observable<ListJobsResponse> {
			return this.http.get<ListJobsResponse>(this.baseUri + '/jobs?status=' + status + '&targetSelection=' + targetSelection + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&thingGroupName=' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&thingGroupId=' + (thingGroupId == null ? '' : encodeURIComponent(thingGroupId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListMitigationActions(actionType: DescribeMitigationActionResponseActionType, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListMitigationActionsResponse> {
			return this.http.get<ListMitigationActionsResponse>(this.baseUri + '/mitigationactions/actions?actionType=' + actionType + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListOTAUpdates(maxResults: number, nextToken: string, otaUpdateStatus: CreateOTAUpdateResponseOtaUpdateStatus, headersHandler?: () => HttpHeaders): Observable<ListOTAUpdatesResponse> {
			return this.http.get<ListOTAUpdatesResponse>(this.baseUri + '/otaUpdates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&otaUpdateStatus=' + otaUpdateStatus, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListOutgoingCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListOutgoingCertificatesResponse> {
			return this.http.get<ListOutgoingCertificatesResponse>(this.baseUri + '/certificates-out-going?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListPoliciesResponse> {
			return this.http.get<ListPoliciesResponse>(this.baseUri + '/policies?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListPolicyPrincipals(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListPolicyPrincipalsResponse> {
			return this.http.get<ListPolicyPrincipalsResponse>(this.baseUri + '/policy-principals#x-amzn-iot-policy?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListPrincipalPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListPrincipalPoliciesResponse> {
			return this.http.get<ListPrincipalPoliciesResponse>(this.baseUri + '/principal-policies#x-amzn-iot-principal?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListPrincipalThings(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListPrincipalThingsResponse> {
			return this.http.get<ListPrincipalThingsResponse>(this.baseUri + '/principals/things#x-amzn-principal?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListRoleAliases(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListRoleAliasesResponse> {
			return this.http.get<ListRoleAliasesResponse>(this.baseUri + '/role-aliases?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListScheduledAudits(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListScheduledAuditsResponse> {
			return this.http.get<ListScheduledAuditsResponse>(this.baseUri + '/audit/scheduledaudits?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListSecurityProfiles(nextToken: string, maxResults: number, dimensionName: string, headersHandler?: () => HttpHeaders): Observable<ListSecurityProfilesResponse> {
			return this.http.get<ListSecurityProfilesResponse>(this.baseUri + '/security-profiles?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&dimensionName=' + (dimensionName == null ? '' : encodeURIComponent(dimensionName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListSecurityProfilesForTarget(nextToken: string, maxResults: number, recursive: boolean, securityProfileTargetArn: string, headersHandler?: () => HttpHeaders): Observable<ListSecurityProfilesForTargetResponse> {
			return this.http.get<ListSecurityProfilesForTargetResponse>(this.baseUri + '/security-profiles-for-target#securityProfileTargetArn?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&recursive=' + recursive + '&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListStreams(maxResults: number, nextToken: string, isAscendingOrder: boolean, headersHandler?: () => HttpHeaders): Observable<ListStreamsResponse> {
			return this.http.get<ListStreamsResponse>(this.baseUri + '/streams?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTagsForResource(resourceArn: string, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.get<ListTagsForResourceResponse>(this.baseUri + '/tags#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTargetsForPolicy(policyName: string, marker: string, pageSize: number, headersHandler?: () => HttpHeaders): Observable<ListTargetsForPolicyResponse> {
			return this.http.post<ListTargetsForPolicyResponse>(this.baseUri + '/policy-targets/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTargetsForSecurityProfile(securityProfileName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListTargetsForSecurityProfileResponse> {
			return this.http.get<ListTargetsForSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListThingGroups(nextToken: string, maxResults: number, parentGroup: string, namePrefixFilter: string, recursive: boolean, headersHandler?: () => HttpHeaders): Observable<ListThingGroupsResponse> {
			return this.http.get<ListThingGroupsResponse>(this.baseUri + '/thing-groups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&parentGroup=' + (parentGroup == null ? '' : encodeURIComponent(parentGroup)) + '&namePrefixFilter=' + (namePrefixFilter == null ? '' : encodeURIComponent(namePrefixFilter)) + '&recursive=' + recursive, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListThingGroupsForThing(thingName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListThingGroupsForThingResponse> {
			return this.http.get<ListThingGroupsForThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/thing-groups&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListThingPrincipals(thingName: string, headersHandler?: () => HttpHeaders): Observable<ListThingPrincipalsResponse> {
			return this.http.get<ListThingPrincipalsResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListThingRegistrationTaskReports(taskId: string, reportType: ListThingRegistrationTaskReportsResponseReportType, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListThingRegistrationTaskReportsResponse> {
			return this.http.get<ListThingRegistrationTaskReportsResponse>(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/reports#reportType&reportType=' + reportType + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListThingRegistrationTasks(nextToken: string, maxResults: number, status: DescribeThingRegistrationTaskResponseStatus, headersHandler?: () => HttpHeaders): Observable<ListThingRegistrationTasksResponse> {
			return this.http.get<ListThingRegistrationTasksResponse>(this.baseUri + '/thing-registration-tasks?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		StartThingRegistrationTask(requestBody: StartThingRegistrationTaskBody, headersHandler?: () => HttpHeaders): Observable<StartThingRegistrationTaskResponse> {
			return this.http.post<StartThingRegistrationTaskResponse>(this.baseUri + '/thing-registration-tasks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListThingTypes(nextToken: string, maxResults: number, thingTypeName: string, headersHandler?: () => HttpHeaders): Observable<ListThingTypesResponse> {
			return this.http.get<ListThingTypesResponse>(this.baseUri + '/thing-types?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&thingTypeName=' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RegisterThing(requestBody: RegisterThingBody, headersHandler?: () => HttpHeaders): Observable<RegisterThingResponse> {
			return this.http.post<RegisterThingResponse>(this.baseUri + '/things', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListThingsInBillingGroup(billingGroupName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListThingsInBillingGroupResponse> {
			return this.http.get<ListThingsInBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '/things&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListThingsInThingGroup(thingGroupName: string, recursive: boolean, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListThingsInThingGroupResponse> {
			return this.http.get<ListThingsInThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '/things&recursive=' + recursive + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTopicRules(topic: string, maxResults: number, nextToken: string, ruleDisabled: boolean, headersHandler?: () => HttpHeaders): Observable<ListTopicRulesResponse> {
			return this.http.get<ListTopicRulesResponse>(this.baseUri + '/rules?topic=' + (topic == null ? '' : encodeURIComponent(topic)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&ruleDisabled=' + ruleDisabled, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListV2LoggingLevels(targetType: LogTargetType, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListV2LoggingLevelsResponse> {
			return this.http.get<ListV2LoggingLevelsResponse>(this.baseUri + '/v2LoggingLevel?targetType=' + targetType + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		SetV2LoggingLevel(requestBody: SetV2LoggingLevelBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/v2LoggingLevel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListViolationEvents(startTime: Date, endTime: Date, thingName: string, securityProfileName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListViolationEventsResponse> {
		 ...
		 */
		RegisterCACertificate(setAsActive: boolean, allowAutoRegistration: boolean, requestBody: RegisterCACertificateBody, headersHandler?: () => HttpHeaders): Observable<RegisterCACertificateResponse> {
			return this.http.post<RegisterCACertificateResponse>(this.baseUri + '/cacertificate?setAsActive=' + setAsActive + '&allowAutoRegistration=' + allowAutoRegistration, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterCertificate(setAsActive: boolean, requestBody: RegisterCertificateBody, headersHandler?: () => HttpHeaders): Observable<RegisterCertificateResponse> {
			return this.http.post<RegisterCertificateResponse>(this.baseUri + '/certificate/register?setAsActive=' + setAsActive, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterCertificateWithoutCA(requestBody: RegisterCertificateWithoutCABody, headersHandler?: () => HttpHeaders): Observable<RegisterCertificateWithoutCAResponse> {
			return this.http.post<RegisterCertificateWithoutCAResponse>(this.baseUri + '/certificate/register-no-ca', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveThingFromBillingGroup(requestBody: RemoveThingFromBillingGroupBody, headersHandler?: () => HttpHeaders): Observable<RemoveThingFromBillingGroupResponse> {
			return this.http.put<RemoveThingFromBillingGroupResponse>(this.baseUri + '/billing-groups/removeThingFromBillingGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveThingFromThingGroup(requestBody: RemoveThingFromThingGroupBody, headersHandler?: () => HttpHeaders): Observable<RemoveThingFromThingGroupResponse> {
			return this.http.put<RemoveThingFromThingGroupResponse>(this.baseUri + '/thing-groups/removeThingFromThingGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SearchIndex(requestBody: SearchIndexBody, headersHandler?: () => HttpHeaders): Observable<SearchIndexResponse> {
			return this.http.post<SearchIndexResponse>(this.baseUri + '/indices/search', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartOnDemandAuditTask(requestBody: StartOnDemandAuditTaskBody, headersHandler?: () => HttpHeaders): Observable<StartOnDemandAuditTaskResponse> {
			return this.http.post<StartOnDemandAuditTaskResponse>(this.baseUri + '/audit/tasks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopThingRegistrationTask(taskId: string, headersHandler?: () => HttpHeaders): Observable<StopThingRegistrationTaskResponse> {
			return this.http.put<StopThingRegistrationTaskResponse>(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/tags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TestAuthorization(clientId: string, requestBody: TestAuthorizationBody, headersHandler?: () => HttpHeaders): Observable<TestAuthorizationResponse> {
			return this.http.post<TestAuthorizationResponse>(this.baseUri + '/test-authorization?clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TestInvokeAuthorizer(authorizerName: string, requestBody: TestInvokeAuthorizerBody, headersHandler?: () => HttpHeaders): Observable<TestInvokeAuthorizerResponse> {
			return this.http.post<TestInvokeAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)) + '/test', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/untag', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificate(certificateId: string, newStatus: CertificateStatus, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '#newStatus&newStatus=' + newStatus, null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateThingGroupsForThing(requestBody: UpdateThingGroupsForThingBody, headersHandler?: () => HttpHeaders): Observable<UpdateThingGroupsForThingResponse> {
			return this.http.put<UpdateThingGroupsForThingResponse>(this.baseUri + '/thing-groups/updateThingGroupsForThing', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ValidateSecurityProfileBehaviors(requestBody: ValidateSecurityProfileBehaviorsBody, headersHandler?: () => HttpHeaders): Observable<ValidateSecurityProfileBehaviorsResponse> {
			return this.http.post<ValidateSecurityProfileBehaviorsResponse>(this.baseUri + '/security-profile-behaviors/validate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
