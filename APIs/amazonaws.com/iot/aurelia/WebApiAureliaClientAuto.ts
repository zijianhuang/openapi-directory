...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddThingToBillingGroup(requestBody: AddThingToBillingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AddThingToBillingGroupResponse> {
			return this.http.put('/billing-groups/addThingToBillingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddThingToThingGroup(requestBody: AddThingToThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AddThingToThingGroupResponse> {
			return this.http.put('/thing-groups/addThingToThingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateTargetsWithJob(jobId: string, requestBody: AssociateTargetsWithJobBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateTargetsWithJobResponse> {
			return this.http.post('/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/targets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AttachPolicy(policyName: string, requestBody: AttachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/target-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DetachPolicy(policyName: string, requestBody: DetachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/target-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		AttachPrincipalPolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DetachPrincipalPolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DetachSecurityProfile(securityProfileName: string, securityProfileTargetArn: string, headersHandler?: () => {[header: string]: string}): Promise<DetachSecurityProfileResponse> {
			return this.http.delete('/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets#securityProfileTargetArn&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AttachThingPrincipal(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<AttachThingPrincipalResponse> {
			return this.http.put('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DetachThingPrincipal(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<DetachThingPrincipalResponse> {
			return this.http.delete('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CancelAuditMitigationActionsTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelAuditMitigationActionsTaskResponse> {
			return this.http.put('/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CancelAuditTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelAuditTaskResponse> {
			return this.http.put('/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CancelJob(jobId: string, force: boolean, requestBody: CancelJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelJobResponse> {
			return this.http.put('/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelJobExecution(jobId: string, thingName: string, force: boolean, requestBody: CancelJobExecutionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ClearDefaultAuthorizer(headersHandler?: () => {[header: string]: string}): Promise<ClearDefaultAuthorizerResponse> {
			return this.http.delete('/default-authorizer', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDefaultAuthorizer(headersHandler?: () => {[header: string]: string}): Promise<DescribeDefaultAuthorizerResponse> {
			return this.http.get('/default-authorizer', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetDefaultAuthorizer(requestBody: SetDefaultAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<SetDefaultAuthorizerResponse> {
			return this.http.post('/default-authorizer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ConfirmTopicRuleDestination(confirmationToken: string, headersHandler?: () => {[header: string]: string}): Promise<ConfirmTopicRuleDestinationResponse> {
			return this.http.get('/confirmdestination/' + (confirmationToken == null ? '' : encodeURIComponent(confirmationToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateAuthorizer(authorizerName: string, requestBody: CreateAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<CreateAuthorizerResponse> {
			return this.http.post('/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAuthorizer(authorizerName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAuthorizerResponse> {
			return this.http.delete('/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeAuthorizer(authorizerName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuthorizerResponse> {
			return this.http.get('/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateAuthorizer(authorizerName: string, requestBody: UpdateAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAuthorizerResponse> {
			return this.http.put('/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateBillingGroup(billingGroupName: string, requestBody: CreateBillingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBillingGroupResponse> {
			return this.http.post('/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteBillingGroup(billingGroupName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteBillingGroupResponse> {
			return this.http.delete('/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBillingGroup(billingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBillingGroupResponse> {
			return this.http.get('/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateCertificateFromCsr(setAsActive: boolean, requestBody: CreateCertificateFromCsrBody, headersHandler?: () => {[header: string]: string}): Promise<CreateCertificateFromCsrResponse> {
			return this.http.post('/certificates?setAsActive=' + setAsActive, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesResponse> {
			return this.http.get('/certificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDimension(name: string, requestBody: CreateDimensionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDimensionResponse> {
			return this.http.post('/dimensions/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDimension(name: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDimensionResponse> {
			return this.http.delete('/dimensions/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDimension(name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDimensionResponse> {
			return this.http.get('/dimensions/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDomainConfiguration(domainConfigurationName: string, requestBody: CreateDomainConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainConfigurationResponse> {
			return this.http.post('/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDomainConfiguration(domainConfigurationName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainConfigurationResponse> {
			return this.http.delete('/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDomainConfiguration(domainConfigurationName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainConfigurationResponse> {
			return this.http.get('/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDomainConfiguration(domainConfigurationName: string, requestBody: UpdateDomainConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainConfigurationResponse> {
			return this.http.put('/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDynamicThingGroup(thingGroupName: string, requestBody: CreateDynamicThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDynamicThingGroupResponse> {
			return this.http.post('/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDynamicThingGroup(thingGroupName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteDynamicThingGroupResponse> {
			return this.http.delete('/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateJob(jobId: string, requestBody: CreateJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateJobResponse> {
			return this.http.put('/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteJob(jobId: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeJob(jobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobResponse> {
			return this.http.get('/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateKeysAndCertificate(setAsActive: boolean, headersHandler?: () => {[header: string]: string}): Promise<CreateKeysAndCertificateResponse> {
			return this.http.post('/keys-and-certificate?setAsActive=' + setAsActive, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateMitigationAction(actionName: string, requestBody: CreateMitigationActionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateMitigationActionResponse> {
			return this.http.post('/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMitigationAction(actionName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteMitigationActionResponse> {
			return this.http.delete('/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeMitigationAction(actionName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMitigationActionResponse> {
			return this.http.get('/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateOTAUpdate(otaUpdateId: string, requestBody: CreateOTAUpdateBody, headersHandler?: () => {[header: string]: string}): Promise<CreateOTAUpdateResponse> {
			return this.http.post('/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteOTAUpdate(otaUpdateId: string, deleteStream: boolean, forceDeleteAWSJob: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteOTAUpdateResponse> {
			return this.http.delete('/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)) + '&deleteStream=' + deleteStream + '&forceDeleteAWSJob=' + forceDeleteAWSJob, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetOTAUpdate(otaUpdateId: string, headersHandler?: () => {[header: string]: string}): Promise<GetOTAUpdateResponse> {
			return this.http.get('/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePolicy(policyName: string, requestBody: CreatePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<CreatePolicyResponse> {
			return this.http.post('/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeletePolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return this.http.get('/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePolicyVersion(policyName: string, setAsDefault: boolean, requestBody: CreatePolicyVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreatePolicyVersionResponse> {
			return this.http.post('/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version&setAsDefault=' + setAsDefault, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPolicyVersions(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<ListPolicyVersionsResponse> {
			return this.http.get('/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateProvisioningClaim(templateName: string, headersHandler?: () => {[header: string]: string}): Promise<CreateProvisioningClaimResponse> {
			return this.http.post('/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/provisioning-claim', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateProvisioningTemplate(requestBody: CreateProvisioningTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<CreateProvisioningTemplateResponse> {
			return this.http.post('/provisioning-templates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListProvisioningTemplates(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProvisioningTemplatesResponse> {
			return this.http.get('/provisioning-templates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateProvisioningTemplateVersion(templateName: string, setAsDefault: boolean, requestBody: CreateProvisioningTemplateVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateProvisioningTemplateVersionResponse> {
			return this.http.post('/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&setAsDefault=' + setAsDefault, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListProvisioningTemplateVersions(templateName: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProvisioningTemplateVersionsResponse> {
			return this.http.get('/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateRoleAlias(roleAlias: string, requestBody: CreateRoleAliasBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRoleAliasResponse> {
			return this.http.post('/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRoleAlias(roleAlias: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteRoleAliasResponse> {
			return this.http.delete('/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRoleAlias(roleAlias: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRoleAliasResponse> {
			return this.http.get('/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateRoleAlias(roleAlias: string, requestBody: UpdateRoleAliasBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRoleAliasResponse> {
			return this.http.put('/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateScheduledAudit(scheduledAuditName: string, requestBody: CreateScheduledAuditBody, headersHandler?: () => {[header: string]: string}): Promise<CreateScheduledAuditResponse> {
			return this.http.post('/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteScheduledAudit(scheduledAuditName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteScheduledAuditResponse> {
			return this.http.delete('/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeScheduledAudit(scheduledAuditName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeScheduledAuditResponse> {
			return this.http.get('/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateSecurityProfile(securityProfileName: string, requestBody: CreateSecurityProfileBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSecurityProfileResponse> {
			return this.http.post('/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSecurityProfile(securityProfileName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecurityProfileResponse> {
			return this.http.delete('/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeSecurityProfile(securityProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeSecurityProfileResponse> {
			return this.http.get('/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateStream(streamId: string, requestBody: CreateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamResponse> {
			return this.http.post('/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteStream(streamId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteStreamResponse> {
			return this.http.delete('/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeStream(streamId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamResponse> {
			return this.http.get('/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateStream(streamId: string, requestBody: UpdateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateStreamResponse> {
			return this.http.put('/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateThing(thingName: string, requestBody: CreateThingBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThingResponse> {
			return this.http.post('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteThing(thingName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteThingResponse> {
			return this.http.delete('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeThing(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingResponse> {
			return this.http.get('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateThingGroup(thingGroupName: string, requestBody: CreateThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThingGroupResponse> {
			return this.http.post('/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteThingGroup(thingGroupName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteThingGroupResponse> {
			return this.http.delete('/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeThingGroup(thingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingGroupResponse> {
			return this.http.get('/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateThingType(thingTypeName: string, requestBody: CreateThingTypeBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThingTypeResponse> {
			return this.http.post('/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteThingType(thingTypeName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteThingTypeResponse> {
			return this.http.delete('/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeThingType(thingTypeName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingTypeResponse> {
			return this.http.get('/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateTopicRule(ruleName: string, requestBody: CreateTopicRuleBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<GetTopicRuleResponse> {
			return this.http.get('/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateTopicRuleDestination(requestBody: CreateTopicRuleDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateTopicRuleDestinationResponse> {
			return this.http.post('/destinations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTopicRuleDestinations(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTopicRuleDestinationsResponse> {
			return this.http.get('/destinations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteAccountAuditConfiguration(deleteScheduledAudits: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteAccountAuditConfigurationResponse> {
			return this.http.delete('/audit/configuration?deleteScheduledAudits=' + deleteScheduledAudits, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeAccountAuditConfiguration(headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountAuditConfigurationResponse> {
			return this.http.get('/audit/configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteCACertificate(caCertificateId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteCACertificateResponse> {
			return this.http.delete('/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeCACertificate(caCertificateId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCACertificateResponse> {
			return this.http.get('/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteCertificate(certificateId: string, forceDelete: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '&forceDelete=' + forceDelete, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeCertificate(certificateId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResponse> {
			return this.http.get('/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteJobExecution(jobId: string, thingName: string, executionNumber: number, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/executionNumber/' + executionNumber + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeletePolicyVersion(policyName: string, policyVersionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPolicyVersion(policyName: string, policyVersionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyVersionResponse> {
			return this.http.get('/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteProvisioningTemplate(templateName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteProvisioningTemplateResponse> {
			return this.http.delete('/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProvisioningTemplate(templateName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeProvisioningTemplateResponse> {
			return this.http.get('/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteProvisioningTemplateVersion(templateName: string, versionId: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteProvisioningTemplateVersionResponse> {
			return this.http.delete('/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProvisioningTemplateVersion(templateName: string, versionId: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeProvisioningTemplateVersionResponse> {
			return this.http.get('/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteRegistrationCode(headersHandler?: () => {[header: string]: string}): Promise<DeleteRegistrationCodeResponse> {
			return this.http.delete('/registrationcode', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetRegistrationCode(headersHandler?: () => {[header: string]: string}): Promise<GetRegistrationCodeResponse> {
			return this.http.get('/registrationcode', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteTopicRuleDestination(arn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteTopicRuleDestinationResponse> {
			return this.http.delete('/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetTopicRuleDestination(arn: string, headersHandler?: () => {[header: string]: string}): Promise<GetTopicRuleDestinationResponse> {
			return this.http.get('/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteV2LoggingLevel(targetType: LogTargetType, targetName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2LoggingLevel#targetType&targetName?targetType=' + targetType + '&targetName=' + (targetName == null ? '' : encodeURIComponent(targetName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeprecateThingType(thingTypeName: string, requestBody: DeprecateThingTypeBody, headersHandler?: () => {[header: string]: string}): Promise<DeprecateThingTypeResponse> {
			return this.http.post('/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)) + '/deprecate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAuditFinding(findingId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuditFindingResponse> {
			return this.http.get('/audit/findings/' + (findingId == null ? '' : encodeURIComponent(findingId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeAuditMitigationActionsTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuditMitigationActionsTaskResponse> {
			return this.http.get('/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartAuditMitigationActionsTask(taskId: string, requestBody: StartAuditMitigationActionsTaskBody, headersHandler?: () => {[header: string]: string}): Promise<StartAuditMitigationActionsTaskResponse> {
			return this.http.post('/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAuditTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuditTaskResponse> {
			return this.http.get('/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeEndpoint(endpointType: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointResponse> {
			return this.http.get('/endpoint?endpointType=' + (endpointType == null ? '' : encodeURIComponent(endpointType)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeEventConfigurations(headersHandler?: () => {[header: string]: string}): Promise<DescribeEventConfigurationsResponse> {
			return this.http.get('/event-configurations', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeIndex(indexName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIndexResponse> {
			return this.http.get('/indices/' + (indexName == null ? '' : encodeURIComponent(indexName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeJobExecution(jobId: string, thingName: string, executionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobExecutionResponse> {
			return this.http.get('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&executionNumber=' + executionNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeThingRegistrationTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingRegistrationTaskResponse> {
			return this.http.get('/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/disable', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		EnableTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/enable', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetCardinality(requestBody: GetCardinalityBody, headersHandler?: () => {[header: string]: string}): Promise<GetCardinalityResponse> {
			return this.http.post('/indices/cardinality', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetEffectivePolicies(thingName: string, requestBody: GetEffectivePoliciesBody, headersHandler?: () => {[header: string]: string}): Promise<GetEffectivePoliciesResponse> {
			return this.http.post('/effective-policies?thingName=' + (thingName == null ? '' : encodeURIComponent(thingName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetIndexingConfiguration(headersHandler?: () => {[header: string]: string}): Promise<GetIndexingConfigurationResponse> {
			return this.http.get('/indexing/config', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateIndexingConfiguration(requestBody: UpdateIndexingConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateIndexingConfigurationResponse> {
			return this.http.post('/indexing/config', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetJobDocument(jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GetJobDocumentResponse> {
			return this.http.get('/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/job-document', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetLoggingOptions(headersHandler?: () => {[header: string]: string}): Promise<GetLoggingOptionsResponse> {
			return this.http.get('/loggingOptions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetLoggingOptions(requestBody: SetLoggingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/loggingOptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetPercentiles(requestBody: GetPercentilesBody, headersHandler?: () => {[header: string]: string}): Promise<GetPercentilesResponse> {
			return this.http.post('/indices/percentiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetStatistics(requestBody: GetStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetStatisticsResponse> {
			return this.http.post('/indices/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetV2LoggingOptions(headersHandler?: () => {[header: string]: string}): Promise<GetV2LoggingOptionsResponse> {
			return this.http.get('/v2LoggingOptions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetV2LoggingOptions(requestBody: SetV2LoggingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2LoggingOptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListActiveViolations(thingName: string, securityProfileName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListActiveViolationsResponse> {
			return this.http.get('/active-violations?thingName=' + (thingName == null ? '' : encodeURIComponent(thingName)) + '&securityProfileName=' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListAttachedPolicies(target: string, recursive: boolean, marker: string, pageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListAttachedPoliciesResponse> {
			return this.http.post('/attached-policies/' + (target == null ? '' : encodeURIComponent(target)) + '&recursive=' + recursive + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListAuditFindings(requestBody: ListAuditFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ListAuditFindingsResponse> {
			return this.http.post('/audit/findings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAuditMitigationActionsTasks(auditTaskId: string, findingId: string, taskStatus: DescribeAuditMitigationActionsTaskResponseTaskStatus, maxResults: number, nextToken: string, startTime: Date, endTime: Date, headersHandler?: () => {[header: string]: string}): Promise<ListAuditMitigationActionsTasksResponse> {
			return this.http.get('/audit/mitigationactions/tasks#startTime&endTime?auditTaskId=' + (auditTaskId == null ? '' : encodeURIComponent(auditTaskId)) + '&findingId=' + (findingId == null ? '' : encodeURIComponent(findingId)) + '&taskStatus=' + taskStatus + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&startTime=' + startTime.toISOString() + '&endTime=' + endTime.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListAuditTasks(startTime: Date, endTime: Date, taskType: DescribeAuditTaskResponseTaskType, taskStatus: DescribeAuditMitigationActionsTaskResponseTaskStatus, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListAuditTasksResponse> {
			return this.http.get('/audit/tasks#startTime&endTime?startTime=' + startTime.toISOString() + '&endTime=' + endTime.toISOString() + '&taskType=' + taskType + '&taskStatus=' + taskStatus + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListAuthorizers(pageSize: number, marker: string, isAscendingOrder: boolean, status: AuthorizerStatus, headersHandler?: () => {[header: string]: string}): Promise<ListAuthorizersResponse> {
			return this.http.get('/authorizers/?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBillingGroups(nextToken: string, maxResults: number, namePrefixFilter: string, headersHandler?: () => {[header: string]: string}): Promise<ListBillingGroupsResponse> {
			return this.http.get('/billing-groups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&namePrefixFilter=' + (namePrefixFilter == null ? '' : encodeURIComponent(namePrefixFilter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListCACertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListCACertificatesResponse> {
			return this.http.get('/cacertificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListCertificatesByCA(caCertificateId: string, pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesByCAResponse> {
			return this.http.get('/certificates-by-ca/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)) + '&pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListDimensions(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDimensionsResponse> {
			return this.http.get('/dimensions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListDomainConfigurations(marker: string, pageSize: number, serviceType: DescribeDomainConfigurationResponseServiceType, headersHandler?: () => {[header: string]: string}): Promise<ListDomainConfigurationsResponse> {
			return this.http.get('/domainConfigurations?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&serviceType=' + serviceType, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListIndices(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListIndicesResponse> {
			return this.http.get('/indices?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListJobExecutionsForJob(jobId: string, status: JobExecutionStatus, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobExecutionsForJobResponse> {
			return this.http.get('/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/things&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListJobExecutionsForThing(thingName: string, status: JobExecutionStatus, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobExecutionsForThingResponse> {
			return this.http.get('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListMitigationActions(actionType: DescribeMitigationActionResponseActionType, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMitigationActionsResponse> {
			return this.http.get('/mitigationactions/actions?actionType=' + actionType + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListOTAUpdates(maxResults: number, nextToken: string, otaUpdateStatus: CreateOTAUpdateResponseOtaUpdateStatus, headersHandler?: () => {[header: string]: string}): Promise<ListOTAUpdatesResponse> {
			return this.http.get('/otaUpdates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&otaUpdateStatus=' + otaUpdateStatus, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListOutgoingCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListOutgoingCertificatesResponse> {
			return this.http.get('/certificates-out-going?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListPoliciesResponse> {
			return this.http.get('/policies?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPolicyPrincipals(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListPolicyPrincipalsResponse> {
			return this.http.get('/policy-principals#x-amzn-iot-policy?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPrincipalPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListPrincipalPoliciesResponse> {
			return this.http.get('/principal-policies#x-amzn-iot-principal?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPrincipalThings(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListPrincipalThingsResponse> {
			return this.http.get('/principals/things#x-amzn-principal?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListRoleAliases(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListRoleAliasesResponse> {
			return this.http.get('/role-aliases?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListScheduledAudits(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListScheduledAuditsResponse> {
			return this.http.get('/audit/scheduledaudits?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListSecurityProfiles(nextToken: string, maxResults: number, dimensionName: string, headersHandler?: () => {[header: string]: string}): Promise<ListSecurityProfilesResponse> {
			return this.http.get('/security-profiles?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&dimensionName=' + (dimensionName == null ? '' : encodeURIComponent(dimensionName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListSecurityProfilesForTarget(nextToken: string, maxResults: number, recursive: boolean, securityProfileTargetArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListSecurityProfilesForTargetResponse> {
			return this.http.get('/security-profiles-for-target#securityProfileTargetArn?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&recursive=' + recursive + '&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListStreams(maxResults: number, nextToken: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListStreamsResponse> {
			return this.http.get('/streams?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(resourceArn: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.get('/tags#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTargetsForPolicy(policyName: string, marker: string, pageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsForPolicyResponse> {
			return this.http.post('/policy-targets/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTargetsForSecurityProfile(securityProfileName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsForSecurityProfileResponse> {
			return this.http.get('/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListThingGroupsForThing(thingName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListThingGroupsForThingResponse> {
			return this.http.get('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/thing-groups&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListThingPrincipals(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<ListThingPrincipalsResponse> {
			return this.http.get('/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListThingRegistrationTaskReports(taskId: string, reportType: ListThingRegistrationTaskReportsResponseReportType, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListThingRegistrationTaskReportsResponse> {
			return this.http.get('/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/reports#reportType&reportType=' + reportType + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListThingRegistrationTasks(nextToken: string, maxResults: number, status: DescribeThingRegistrationTaskResponseStatus, headersHandler?: () => {[header: string]: string}): Promise<ListThingRegistrationTasksResponse> {
			return this.http.get('/thing-registration-tasks?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartThingRegistrationTask(requestBody: StartThingRegistrationTaskBody, headersHandler?: () => {[header: string]: string}): Promise<StartThingRegistrationTaskResponse> {
			return this.http.post('/thing-registration-tasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListThingTypes(nextToken: string, maxResults: number, thingTypeName: string, headersHandler?: () => {[header: string]: string}): Promise<ListThingTypesResponse> {
			return this.http.get('/thing-types?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&thingTypeName=' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListThings(nextToken: string, maxResults: number, attributeName: string, attributeValue: string, thingTypeName: string, headersHandler?: () => {[header: string]: string}): Promise<ListThingsResponse> {
			return this.http.get('/things?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&attributeName=' + (attributeName == null ? '' : encodeURIComponent(attributeName)) + '&attributeValue=' + (attributeValue == null ? '' : encodeURIComponent(attributeValue)) + '&thingTypeName=' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RegisterThing(requestBody: RegisterThingBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterThingResponse> {
			return this.http.post('/things', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListThingsInBillingGroup(billingGroupName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListThingsInBillingGroupResponse> {
			return this.http.get('/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '/things&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListThingsInThingGroup(thingGroupName: string, recursive: boolean, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListThingsInThingGroupResponse> {
			return this.http.get('/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '/things&recursive=' + recursive + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTopicRules(topic: string, maxResults: number, nextToken: string, ruleDisabled: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListTopicRulesResponse> {
			return this.http.get('/rules?topic=' + (topic == null ? '' : encodeURIComponent(topic)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&ruleDisabled=' + ruleDisabled, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListV2LoggingLevels(targetType: LogTargetType, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListV2LoggingLevelsResponse> {
			return this.http.get('/v2LoggingLevel?targetType=' + targetType + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetV2LoggingLevel(requestBody: SetV2LoggingLevelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2LoggingLevel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RegisterCACertificate(setAsActive: boolean, allowAutoRegistration: boolean, requestBody: RegisterCACertificateBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterCACertificateResponse> {
			return this.http.post('/cacertificate?setAsActive=' + setAsActive + '&allowAutoRegistration=' + allowAutoRegistration, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterCertificate(setAsActive: boolean, requestBody: RegisterCertificateBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterCertificateResponse> {
			return this.http.post('/certificate/register?setAsActive=' + setAsActive, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterCertificateWithoutCA(requestBody: RegisterCertificateWithoutCABody, headersHandler?: () => {[header: string]: string}): Promise<RegisterCertificateWithoutCAResponse> {
			return this.http.post('/certificate/register-no-ca', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveThingFromBillingGroup(requestBody: RemoveThingFromBillingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<RemoveThingFromBillingGroupResponse> {
			return this.http.put('/billing-groups/removeThingFromBillingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveThingFromThingGroup(requestBody: RemoveThingFromThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<RemoveThingFromThingGroupResponse> {
			return this.http.put('/thing-groups/removeThingFromThingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SearchIndex(requestBody: SearchIndexBody, headersHandler?: () => {[header: string]: string}): Promise<SearchIndexResponse> {
			return this.http.post('/indices/search', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartOnDemandAuditTask(requestBody: StartOnDemandAuditTaskBody, headersHandler?: () => {[header: string]: string}): Promise<StartOnDemandAuditTaskResponse> {
			return this.http.post('/audit/tasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopThingRegistrationTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<StopThingRegistrationTaskResponse> {
			return this.http.put('/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/tags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TestAuthorization(clientId: string, requestBody: TestAuthorizationBody, headersHandler?: () => {[header: string]: string}): Promise<TestAuthorizationResponse> {
			return this.http.post('/test-authorization?clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TestInvokeAuthorizer(authorizerName: string, requestBody: TestInvokeAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<TestInvokeAuthorizerResponse> {
			return this.http.post('/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)) + '/test', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/untag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateCertificate(certificateId: string, newStatus: CertificateStatus, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '#newStatus&newStatus=' + newStatus, null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateThingGroupsForThing(requestBody: UpdateThingGroupsForThingBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateThingGroupsForThingResponse> {
			return this.http.put('/thing-groups/updateThingGroupsForThing', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ValidateSecurityProfileBehaviors(requestBody: ValidateSecurityProfileBehaviorsBody, headersHandler?: () => {[header: string]: string}): Promise<ValidateSecurityProfileBehaviorsResponse> {
			return this.http.post('/security-profile-behaviors/validate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
