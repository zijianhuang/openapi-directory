...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddThingToBillingGroup(requestBody: AddThingToBillingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AddThingToBillingGroupResponse> {
			return Axios.put<AddThingToBillingGroupResponse>(this.baseUri + '/billing-groups/addThingToBillingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddThingToThingGroup(requestBody: AddThingToThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AddThingToThingGroupResponse> {
			return Axios.put<AddThingToThingGroupResponse>(this.baseUri + '/thing-groups/addThingToThingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateTargetsWithJob(jobId: string, requestBody: AssociateTargetsWithJobBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateTargetsWithJobResponse> {
			return Axios.post<AssociateTargetsWithJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/targets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		AttachPolicy(policyName: string, requestBody: AttachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/target-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DetachPolicy(policyName: string, requestBody: DetachPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/target-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		AttachPrincipalPolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DetachPrincipalPolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		AttachThingPrincipal(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<AttachThingPrincipalResponse> {
			return Axios.put<AttachThingPrincipalResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DetachThingPrincipal(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<DetachThingPrincipalResponse> {
			return Axios.delete<DetachThingPrincipalResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CancelAuditMitigationActionsTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelAuditMitigationActionsTaskResponse> {
			return Axios.put<CancelAuditMitigationActionsTaskResponse>(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CancelAuditTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelAuditTaskResponse> {
			return Axios.put<CancelAuditTaskResponse>(this.baseUri + '/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CancelJob(jobId: string, force: boolean, requestBody: CancelJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelJobResponse> {
			return Axios.put<CancelJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		CancelJobExecution(jobId: string, thingName: string, force: boolean, requestBody: CancelJobExecutionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ClearDefaultAuthorizer(headersHandler?: () => {[header: string]: string}): Promise<ClearDefaultAuthorizerResponse> {
			return Axios.delete<ClearDefaultAuthorizerResponse>(this.baseUri + '/default-authorizer', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeDefaultAuthorizer(headersHandler?: () => {[header: string]: string}): Promise<DescribeDefaultAuthorizerResponse> {
			return Axios.get<DescribeDefaultAuthorizerResponse>(this.baseUri + '/default-authorizer', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		SetDefaultAuthorizer(requestBody: SetDefaultAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<SetDefaultAuthorizerResponse> {
			return Axios.post<SetDefaultAuthorizerResponse>(this.baseUri + '/default-authorizer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmTopicRuleDestination(confirmationToken: string, headersHandler?: () => {[header: string]: string}): Promise<ConfirmTopicRuleDestinationResponse> {
			return Axios.get<ConfirmTopicRuleDestinationResponse>(this.baseUri + '/confirmdestination/' + (confirmationToken == null ? '' : encodeURIComponent(confirmationToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateAuthorizer(authorizerName: string, requestBody: CreateAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<CreateAuthorizerResponse> {
			return Axios.post<CreateAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteAuthorizer(authorizerName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAuthorizerResponse> {
			return Axios.delete<DeleteAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeAuthorizer(authorizerName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuthorizerResponse> {
			return Axios.get<DescribeAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateAuthorizer(authorizerName: string, requestBody: UpdateAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAuthorizerResponse> {
			return Axios.put<UpdateAuthorizerResponse>(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateBillingGroup(billingGroupName: string, requestBody: CreateBillingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBillingGroupResponse> {
			return Axios.post<CreateBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteBillingGroup(billingGroupName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteBillingGroupResponse> {
			return Axios.delete<DeleteBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeBillingGroup(billingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBillingGroupResponse> {
			return Axios.get<DescribeBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateCertificateFromCsr(setAsActive: boolean, requestBody: CreateCertificateFromCsrBody, headersHandler?: () => {[header: string]: string}): Promise<CreateCertificateFromCsrResponse> {
			return Axios.post<CreateCertificateFromCsrResponse>(this.baseUri + '/certificates?setAsActive=' + setAsActive, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesResponse> {
			return Axios.get<ListCertificatesResponse>(this.baseUri + '/certificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateDimension(name: string, requestBody: CreateDimensionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDimensionResponse> {
			return Axios.post<CreateDimensionResponse>(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDimension(name: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDimensionResponse> {
			return Axios.delete<DeleteDimensionResponse>(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeDimension(name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDimensionResponse> {
			return Axios.get<DescribeDimensionResponse>(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateDomainConfiguration(domainConfigurationName: string, requestBody: CreateDomainConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainConfigurationResponse> {
			return Axios.post<CreateDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDomainConfiguration(domainConfigurationName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainConfigurationResponse> {
			return Axios.delete<DeleteDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeDomainConfiguration(domainConfigurationName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainConfigurationResponse> {
			return Axios.get<DescribeDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDomainConfiguration(domainConfigurationName: string, requestBody: UpdateDomainConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainConfigurationResponse> {
			return Axios.put<UpdateDomainConfigurationResponse>(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDynamicThingGroup(thingGroupName: string, requestBody: CreateDynamicThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDynamicThingGroupResponse> {
			return Axios.post<CreateDynamicThingGroupResponse>(this.baseUri + '/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDynamicThingGroup(thingGroupName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteDynamicThingGroupResponse> {
			return Axios.delete<DeleteDynamicThingGroupResponse>(this.baseUri + '/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateJob(jobId: string, requestBody: CreateJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateJobResponse> {
			return Axios.put<CreateJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteJob(jobId: string, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeJob(jobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobResponse> {
			return Axios.get<DescribeJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateKeysAndCertificate(setAsActive: boolean, headersHandler?: () => {[header: string]: string}): Promise<CreateKeysAndCertificateResponse> {
			return Axios.post<CreateKeysAndCertificateResponse>(this.baseUri + '/keys-and-certificate?setAsActive=' + setAsActive, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteMitigationAction(actionName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteMitigationActionResponse> {
			return Axios.delete<DeleteMitigationActionResponse>(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeMitigationAction(actionName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMitigationActionResponse> {
			return Axios.get<DescribeMitigationActionResponse>(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateOTAUpdate(otaUpdateId: string, requestBody: CreateOTAUpdateBody, headersHandler?: () => {[header: string]: string}): Promise<CreateOTAUpdateResponse> {
			return Axios.post<CreateOTAUpdateResponse>(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteOTAUpdate(otaUpdateId: string, deleteStream: boolean, forceDeleteAWSJob: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteOTAUpdateResponse> {
			return Axios.delete<DeleteOTAUpdateResponse>(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)) + '&deleteStream=' + deleteStream + '&forceDeleteAWSJob=' + forceDeleteAWSJob, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetOTAUpdate(otaUpdateId: string, headersHandler?: () => {[header: string]: string}): Promise<GetOTAUpdateResponse> {
			return Axios.get<GetOTAUpdateResponse>(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreatePolicy(policyName: string, requestBody: CreatePolicyBody, headersHandler?: () => {[header: string]: string}): Promise<CreatePolicyResponse> {
			return Axios.post<CreatePolicyResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeletePolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetPolicy(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return Axios.get<GetPolicyResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreatePolicyVersion(policyName: string, setAsDefault: boolean, requestBody: CreatePolicyVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreatePolicyVersionResponse> {
			return Axios.post<CreatePolicyVersionResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version&setAsDefault=' + setAsDefault, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListPolicyVersions(policyName: string, headersHandler?: () => {[header: string]: string}): Promise<ListPolicyVersionsResponse> {
			return Axios.get<ListPolicyVersionsResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateProvisioningClaim(templateName: string, headersHandler?: () => {[header: string]: string}): Promise<CreateProvisioningClaimResponse> {
			return Axios.post<CreateProvisioningClaimResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/provisioning-claim', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateProvisioningTemplate(requestBody: CreateProvisioningTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<CreateProvisioningTemplateResponse> {
			return Axios.post<CreateProvisioningTemplateResponse>(this.baseUri + '/provisioning-templates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListProvisioningTemplates(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProvisioningTemplatesResponse> {
			return Axios.get<ListProvisioningTemplatesResponse>(this.baseUri + '/provisioning-templates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateProvisioningTemplateVersion(templateName: string, setAsDefault: boolean, requestBody: CreateProvisioningTemplateVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateProvisioningTemplateVersionResponse> {
			return Axios.post<CreateProvisioningTemplateVersionResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&setAsDefault=' + setAsDefault, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListProvisioningTemplateVersions(templateName: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProvisioningTemplateVersionsResponse> {
			return Axios.get<ListProvisioningTemplateVersionsResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateRoleAlias(roleAlias: string, requestBody: CreateRoleAliasBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRoleAliasResponse> {
			return Axios.post<CreateRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRoleAlias(roleAlias: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteRoleAliasResponse> {
			return Axios.delete<DeleteRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeRoleAlias(roleAlias: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRoleAliasResponse> {
			return Axios.get<DescribeRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateRoleAlias(roleAlias: string, requestBody: UpdateRoleAliasBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRoleAliasResponse> {
			return Axios.put<UpdateRoleAliasResponse>(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateScheduledAudit(scheduledAuditName: string, requestBody: CreateScheduledAuditBody, headersHandler?: () => {[header: string]: string}): Promise<CreateScheduledAuditResponse> {
			return Axios.post<CreateScheduledAuditResponse>(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteScheduledAudit(scheduledAuditName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteScheduledAuditResponse> {
			return Axios.delete<DeleteScheduledAuditResponse>(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeScheduledAudit(scheduledAuditName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeScheduledAuditResponse> {
			return Axios.get<DescribeScheduledAuditResponse>(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateSecurityProfile(securityProfileName: string, requestBody: CreateSecurityProfileBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSecurityProfileResponse> {
			return Axios.post<CreateSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSecurityProfile(securityProfileName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecurityProfileResponse> {
			return Axios.delete<DeleteSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeSecurityProfile(securityProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeSecurityProfileResponse> {
			return Axios.get<DescribeSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateStream(streamId: string, requestBody: CreateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamResponse> {
			return Axios.post<CreateStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteStream(streamId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteStreamResponse> {
			return Axios.delete<DeleteStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeStream(streamId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamResponse> {
			return Axios.get<DescribeStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateStream(streamId: string, requestBody: UpdateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateStreamResponse> {
			return Axios.put<UpdateStreamResponse>(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateThing(thingName: string, requestBody: CreateThingBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThingResponse> {
			return Axios.post<CreateThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteThing(thingName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteThingResponse> {
			return Axios.delete<DeleteThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeThing(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingResponse> {
			return Axios.get<DescribeThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateThingGroup(thingGroupName: string, requestBody: CreateThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThingGroupResponse> {
			return Axios.post<CreateThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteThingGroup(thingGroupName: string, expectedVersion: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteThingGroupResponse> {
			return Axios.delete<DeleteThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeThingGroup(thingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingGroupResponse> {
			return Axios.get<DescribeThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateThingType(thingTypeName: string, requestBody: CreateThingTypeBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThingTypeResponse> {
			return Axios.post<CreateThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteThingType(thingTypeName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteThingTypeResponse> {
			return Axios.delete<DeleteThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeThingType(thingTypeName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingTypeResponse> {
			return Axios.get<DescribeThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		CreateTopicRule(ruleName: string, requestBody: CreateTopicRuleBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<GetTopicRuleResponse> {
			return Axios.get<GetTopicRuleResponse>(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateTopicRuleDestination(requestBody: CreateTopicRuleDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateTopicRuleDestinationResponse> {
			return Axios.post<CreateTopicRuleDestinationResponse>(this.baseUri + '/destinations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTopicRuleDestinations(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTopicRuleDestinationsResponse> {
			return Axios.get<ListTopicRuleDestinationsResponse>(this.baseUri + '/destinations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteAccountAuditConfiguration(deleteScheduledAudits: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteAccountAuditConfigurationResponse> {
			return Axios.delete<DeleteAccountAuditConfigurationResponse>(this.baseUri + '/audit/configuration?deleteScheduledAudits=' + deleteScheduledAudits, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeAccountAuditConfiguration(headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountAuditConfigurationResponse> {
			return Axios.get<DescribeAccountAuditConfigurationResponse>(this.baseUri + '/audit/configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteCACertificate(caCertificateId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteCACertificateResponse> {
			return Axios.delete<DeleteCACertificateResponse>(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeCACertificate(caCertificateId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCACertificateResponse> {
			return Axios.get<DescribeCACertificateResponse>(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCACertificate(caCertificateId: string, newStatus: AuthorizerStatus, newAutoRegistrationStatus: AutoRegistrationStatus, requestBody: UpdateCACertificateBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)) + '&newStatus=' + newStatus + '&newAutoRegistrationStatus=' + newAutoRegistrationStatus, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificate(certificateId: string, forceDelete: boolean, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '&forceDelete=' + forceDelete, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeCertificate(certificateId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificateResponse> {
			return Axios.get<DescribeCertificateResponse>(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteJobExecution(jobId: string, thingName: string, executionNumber: number, force: boolean, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/executionNumber/' + executionNumber + '&force=' + force, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePolicyVersion(policyName: string, policyVersionId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetPolicyVersion(policyName: string, policyVersionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyVersionResponse> {
			return Axios.get<GetPolicyVersionResponse>(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteProvisioningTemplate(templateName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteProvisioningTemplateResponse> {
			return Axios.delete<DeleteProvisioningTemplateResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeProvisioningTemplate(templateName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeProvisioningTemplateResponse> {
			return Axios.get<DescribeProvisioningTemplateResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteProvisioningTemplateVersion(templateName: string, versionId: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteProvisioningTemplateVersionResponse> {
			return Axios.delete<DeleteProvisioningTemplateVersionResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeProvisioningTemplateVersion(templateName: string, versionId: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeProvisioningTemplateVersionResponse> {
			return Axios.get<DescribeProvisioningTemplateVersionResponse>(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteRegistrationCode(headersHandler?: () => {[header: string]: string}): Promise<DeleteRegistrationCodeResponse> {
			return Axios.delete<DeleteRegistrationCodeResponse>(this.baseUri + '/registrationcode', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetRegistrationCode(headersHandler?: () => {[header: string]: string}): Promise<GetRegistrationCodeResponse> {
			return Axios.get<GetRegistrationCodeResponse>(this.baseUri + '/registrationcode', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteTopicRuleDestination(arn: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteTopicRuleDestinationResponse> {
			return Axios.delete<DeleteTopicRuleDestinationResponse>(this.baseUri + '/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetTopicRuleDestination(arn: string, headersHandler?: () => {[header: string]: string}): Promise<GetTopicRuleDestinationResponse> {
			return Axios.get<GetTopicRuleDestinationResponse>(this.baseUri + '/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteV2LoggingLevel(targetType: LogTargetType, targetName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/v2LoggingLevel#targetType&targetName?targetType=' + targetType + '&targetName=' + (targetName == null ? '' : encodeURIComponent(targetName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DeprecateThingType(thingTypeName: string, requestBody: DeprecateThingTypeBody, headersHandler?: () => {[header: string]: string}): Promise<DeprecateThingTypeResponse> {
			return Axios.post<DeprecateThingTypeResponse>(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)) + '/deprecate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAuditFinding(findingId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuditFindingResponse> {
			return Axios.get<DescribeAuditFindingResponse>(this.baseUri + '/audit/findings/' + (findingId == null ? '' : encodeURIComponent(findingId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeAuditMitigationActionsTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuditMitigationActionsTaskResponse> {
			return Axios.get<DescribeAuditMitigationActionsTaskResponse>(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		StartAuditMitigationActionsTask(taskId: string, requestBody: StartAuditMitigationActionsTaskBody, headersHandler?: () => {[header: string]: string}): Promise<StartAuditMitigationActionsTaskResponse> {
			return Axios.post<StartAuditMitigationActionsTaskResponse>(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAuditTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAuditTaskResponse> {
			return Axios.get<DescribeAuditTaskResponse>(this.baseUri + '/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeEndpoint(endpointType: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointResponse> {
			return Axios.get<DescribeEndpointResponse>(this.baseUri + '/endpoint?endpointType=' + (endpointType == null ? '' : encodeURIComponent(endpointType)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeEventConfigurations(headersHandler?: () => {[header: string]: string}): Promise<DescribeEventConfigurationsResponse> {
			return Axios.get<DescribeEventConfigurationsResponse>(this.baseUri + '/event-configurations', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeIndex(indexName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIndexResponse> {
			return Axios.get<DescribeIndexResponse>(this.baseUri + '/indices/' + (indexName == null ? '' : encodeURIComponent(indexName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeJobExecution(jobId: string, thingName: string, executionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobExecutionResponse> {
			return Axios.get<DescribeJobExecutionResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&executionNumber=' + executionNumber, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeThingRegistrationTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeThingRegistrationTaskResponse> {
			return Axios.get<DescribeThingRegistrationTaskResponse>(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DisableTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/disable', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		EnableTopicRule(ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/enable', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetCardinality(requestBody: GetCardinalityBody, headersHandler?: () => {[header: string]: string}): Promise<GetCardinalityResponse> {
			return Axios.post<GetCardinalityResponse>(this.baseUri + '/indices/cardinality', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetEffectivePolicies(thingName: string, requestBody: GetEffectivePoliciesBody, headersHandler?: () => {[header: string]: string}): Promise<GetEffectivePoliciesResponse> {
			return Axios.post<GetEffectivePoliciesResponse>(this.baseUri + '/effective-policies?thingName=' + (thingName == null ? '' : encodeURIComponent(thingName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetIndexingConfiguration(headersHandler?: () => {[header: string]: string}): Promise<GetIndexingConfigurationResponse> {
			return Axios.get<GetIndexingConfigurationResponse>(this.baseUri + '/indexing/config', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateIndexingConfiguration(requestBody: UpdateIndexingConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateIndexingConfigurationResponse> {
			return Axios.post<UpdateIndexingConfigurationResponse>(this.baseUri + '/indexing/config', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJobDocument(jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GetJobDocumentResponse> {
			return Axios.get<GetJobDocumentResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/job-document', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetLoggingOptions(headersHandler?: () => {[header: string]: string}): Promise<GetLoggingOptionsResponse> {
			return Axios.get<GetLoggingOptionsResponse>(this.baseUri + '/loggingOptions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		SetLoggingOptions(requestBody: SetLoggingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/loggingOptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetPercentiles(requestBody: GetPercentilesBody, headersHandler?: () => {[header: string]: string}): Promise<GetPercentilesResponse> {
			return Axios.post<GetPercentilesResponse>(this.baseUri + '/indices/percentiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetStatistics(requestBody: GetStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetStatisticsResponse> {
			return Axios.post<GetStatisticsResponse>(this.baseUri + '/indices/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetV2LoggingOptions(headersHandler?: () => {[header: string]: string}): Promise<GetV2LoggingOptionsResponse> {
			return Axios.get<GetV2LoggingOptionsResponse>(this.baseUri + '/v2LoggingOptions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		SetV2LoggingOptions(requestBody: SetV2LoggingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v2LoggingOptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListAttachedPolicies(target: string, recursive: boolean, marker: string, pageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListAttachedPoliciesResponse> {
			return Axios.post<ListAttachedPoliciesResponse>(this.baseUri + '/attached-policies/' + (target == null ? '' : encodeURIComponent(target)) + '&recursive=' + recursive + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListAuditFindings(requestBody: ListAuditFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ListAuditFindingsResponse> {
			return Axios.post<ListAuditFindingsResponse>(this.baseUri + '/audit/findings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAuthorizers(pageSize: number, marker: string, isAscendingOrder: boolean, status: AuthorizerStatus, headersHandler?: () => {[header: string]: string}): Promise<ListAuthorizersResponse> {
			return Axios.get<ListAuthorizersResponse>(this.baseUri + '/authorizers/?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListBillingGroups(nextToken: string, maxResults: number, namePrefixFilter: string, headersHandler?: () => {[header: string]: string}): Promise<ListBillingGroupsResponse> {
			return Axios.get<ListBillingGroupsResponse>(this.baseUri + '/billing-groups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&namePrefixFilter=' + (namePrefixFilter == null ? '' : encodeURIComponent(namePrefixFilter)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListCACertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListCACertificatesResponse> {
			return Axios.get<ListCACertificatesResponse>(this.baseUri + '/cacertificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListCertificatesByCA(caCertificateId: string, pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListCertificatesByCAResponse> {
			return Axios.get<ListCertificatesByCAResponse>(this.baseUri + '/certificates-by-ca/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)) + '&pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListDimensions(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDimensionsResponse> {
			return Axios.get<ListDimensionsResponse>(this.baseUri + '/dimensions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListDomainConfigurations(marker: string, pageSize: number, serviceType: DescribeDomainConfigurationResponseServiceType, headersHandler?: () => {[header: string]: string}): Promise<ListDomainConfigurationsResponse> {
			return Axios.get<ListDomainConfigurationsResponse>(this.baseUri + '/domainConfigurations?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&serviceType=' + serviceType, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListIndices(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListIndicesResponse> {
			return Axios.get<ListIndicesResponse>(this.baseUri + '/indices?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListJobExecutionsForJob(jobId: string, status: JobExecutionStatus, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobExecutionsForJobResponse> {
			return Axios.get<ListJobExecutionsForJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/things&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListJobExecutionsForThing(thingName: string, status: JobExecutionStatus, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobExecutionsForThingResponse> {
			return Axios.get<ListJobExecutionsForThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListMitigationActions(actionType: DescribeMitigationActionResponseActionType, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMitigationActionsResponse> {
			return Axios.get<ListMitigationActionsResponse>(this.baseUri + '/mitigationactions/actions?actionType=' + actionType + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListOTAUpdates(maxResults: number, nextToken: string, otaUpdateStatus: CreateOTAUpdateResponseOtaUpdateStatus, headersHandler?: () => {[header: string]: string}): Promise<ListOTAUpdatesResponse> {
			return Axios.get<ListOTAUpdatesResponse>(this.baseUri + '/otaUpdates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&otaUpdateStatus=' + otaUpdateStatus, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListOutgoingCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListOutgoingCertificatesResponse> {
			return Axios.get<ListOutgoingCertificatesResponse>(this.baseUri + '/certificates-out-going?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListPoliciesResponse> {
			return Axios.get<ListPoliciesResponse>(this.baseUri + '/policies?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListPolicyPrincipals(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListPolicyPrincipalsResponse> {
			return Axios.get<ListPolicyPrincipalsResponse>(this.baseUri + '/policy-principals#x-amzn-iot-policy?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListPrincipalPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListPrincipalPoliciesResponse> {
			return Axios.get<ListPrincipalPoliciesResponse>(this.baseUri + '/principal-policies#x-amzn-iot-principal?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListPrincipalThings(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListPrincipalThingsResponse> {
			return Axios.get<ListPrincipalThingsResponse>(this.baseUri + '/principals/things#x-amzn-principal?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListRoleAliases(pageSize: number, marker: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListRoleAliasesResponse> {
			return Axios.get<ListRoleAliasesResponse>(this.baseUri + '/role-aliases?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListScheduledAudits(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListScheduledAuditsResponse> {
			return Axios.get<ListScheduledAuditsResponse>(this.baseUri + '/audit/scheduledaudits?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListSecurityProfiles(nextToken: string, maxResults: number, dimensionName: string, headersHandler?: () => {[header: string]: string}): Promise<ListSecurityProfilesResponse> {
			return Axios.get<ListSecurityProfilesResponse>(this.baseUri + '/security-profiles?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&dimensionName=' + (dimensionName == null ? '' : encodeURIComponent(dimensionName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListStreams(maxResults: number, nextToken: string, isAscendingOrder: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListStreamsResponse> {
			return Axios.get<ListStreamsResponse>(this.baseUri + '/streams?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&isAscendingOrder=' + isAscendingOrder, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListTagsForResource(resourceArn: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.get<ListTagsForResourceResponse>(this.baseUri + '/tags#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListTargetsForPolicy(policyName: string, marker: string, pageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsForPolicyResponse> {
			return Axios.post<ListTargetsForPolicyResponse>(this.baseUri + '/policy-targets/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListTargetsForSecurityProfile(securityProfileName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsForSecurityProfileResponse> {
			return Axios.get<ListTargetsForSecurityProfileResponse>(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListThingGroupsForThing(thingName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListThingGroupsForThingResponse> {
			return Axios.get<ListThingGroupsForThingResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/thing-groups&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListThingPrincipals(thingName: string, headersHandler?: () => {[header: string]: string}): Promise<ListThingPrincipalsResponse> {
			return Axios.get<ListThingPrincipalsResponse>(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListThingRegistrationTasks(nextToken: string, maxResults: number, status: DescribeThingRegistrationTaskResponseStatus, headersHandler?: () => {[header: string]: string}): Promise<ListThingRegistrationTasksResponse> {
			return Axios.get<ListThingRegistrationTasksResponse>(this.baseUri + '/thing-registration-tasks?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&status=' + status, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		StartThingRegistrationTask(requestBody: StartThingRegistrationTaskBody, headersHandler?: () => {[header: string]: string}): Promise<StartThingRegistrationTaskResponse> {
			return Axios.post<StartThingRegistrationTaskResponse>(this.baseUri + '/thing-registration-tasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListThingTypes(nextToken: string, maxResults: number, thingTypeName: string, headersHandler?: () => {[header: string]: string}): Promise<ListThingTypesResponse> {
			return Axios.get<ListThingTypesResponse>(this.baseUri + '/thing-types?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&thingTypeName=' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RegisterThing(requestBody: RegisterThingBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterThingResponse> {
			return Axios.post<RegisterThingResponse>(this.baseUri + '/things', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListThingsInBillingGroup(billingGroupName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListThingsInBillingGroupResponse> {
			return Axios.get<ListThingsInBillingGroupResponse>(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '/things&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListThingsInThingGroup(thingGroupName: string, recursive: boolean, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListThingsInThingGroupResponse> {
			return Axios.get<ListThingsInThingGroupResponse>(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '/things&recursive=' + recursive + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListTopicRules(topic: string, maxResults: number, nextToken: string, ruleDisabled: boolean, headersHandler?: () => {[header: string]: string}): Promise<ListTopicRulesResponse> {
			return Axios.get<ListTopicRulesResponse>(this.baseUri + '/rules?topic=' + (topic == null ? '' : encodeURIComponent(topic)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&ruleDisabled=' + ruleDisabled, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListV2LoggingLevels(targetType: LogTargetType, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListV2LoggingLevelsResponse> {
			return Axios.get<ListV2LoggingLevelsResponse>(this.baseUri + '/v2LoggingLevel?targetType=' + targetType + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		SetV2LoggingLevel(requestBody: SetV2LoggingLevelBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v2LoggingLevel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		RegisterCACertificate(setAsActive: boolean, allowAutoRegistration: boolean, requestBody: RegisterCACertificateBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterCACertificateResponse> {
			return Axios.post<RegisterCACertificateResponse>(this.baseUri + '/cacertificate?setAsActive=' + setAsActive + '&allowAutoRegistration=' + allowAutoRegistration, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterCertificate(setAsActive: boolean, requestBody: RegisterCertificateBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterCertificateResponse> {
			return Axios.post<RegisterCertificateResponse>(this.baseUri + '/certificate/register?setAsActive=' + setAsActive, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterCertificateWithoutCA(requestBody: RegisterCertificateWithoutCABody, headersHandler?: () => {[header: string]: string}): Promise<RegisterCertificateWithoutCAResponse> {
			return Axios.post<RegisterCertificateWithoutCAResponse>(this.baseUri + '/certificate/register-no-ca', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveThingFromBillingGroup(requestBody: RemoveThingFromBillingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<RemoveThingFromBillingGroupResponse> {
			return Axios.put<RemoveThingFromBillingGroupResponse>(this.baseUri + '/billing-groups/removeThingFromBillingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveThingFromThingGroup(requestBody: RemoveThingFromThingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<RemoveThingFromThingGroupResponse> {
			return Axios.put<RemoveThingFromThingGroupResponse>(this.baseUri + '/thing-groups/removeThingFromThingGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchIndex(requestBody: SearchIndexBody, headersHandler?: () => {[header: string]: string}): Promise<SearchIndexResponse> {
			return Axios.post<SearchIndexResponse>(this.baseUri + '/indices/search', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartOnDemandAuditTask(requestBody: StartOnDemandAuditTaskBody, headersHandler?: () => {[header: string]: string}): Promise<StartOnDemandAuditTaskResponse> {
			return Axios.post<StartOnDemandAuditTaskResponse>(this.baseUri + '/audit/tasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopThingRegistrationTask(taskId: string, headersHandler?: () => {[header: string]: string}): Promise<StopThingRegistrationTaskResponse> {
			return Axios.put<StopThingRegistrationTaskResponse>(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/tags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TestAuthorization(clientId: string, requestBody: TestAuthorizationBody, headersHandler?: () => {[header: string]: string}): Promise<TestAuthorizationResponse> {
			return Axios.post<TestAuthorizationResponse>(this.baseUri + '/test-authorization?clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/untag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificate(certificateId: string, newStatus: CertificateStatus, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '#newStatus&newStatus=' + newStatus, null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		UpdateThingGroupsForThing(requestBody: UpdateThingGroupsForThingBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateThingGroupsForThingResponse> {
			return Axios.put<UpdateThingGroupsForThingResponse>(this.baseUri + '/thing-groups/updateThingGroupsForThing', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ValidateSecurityProfileBehaviors(requestBody: ValidateSecurityProfileBehaviorsBody, headersHandler?: () => {[header: string]: string}): Promise<ValidateSecurityProfileBehaviorsResponse> {
			return Axios.post<ValidateSecurityProfileBehaviorsResponse>(this.baseUri + '/security-profile-behaviors/validate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
