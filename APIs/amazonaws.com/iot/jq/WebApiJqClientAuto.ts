...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddThingToBillingGroup(callback: (data : AddThingToBillingGroupResponse) => any, requestBody: AddThingToBillingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/billing-groups/addThingToBillingGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AddThingToThingGroup(callback: (data : AddThingToThingGroupResponse) => any, requestBody: AddThingToThingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/thing-groups/addThingToThingGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociateTargetsWithJob(jobId: string, callback: (data : AssociateTargetsWithJobResponse) => any, requestBody: AssociateTargetsWithJobBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/targets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		AttachPolicy(policyName: string, callback: (data : void) => any, requestBody: AttachPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/target-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DetachPolicy(policyName: string, callback: (data : void) => any, requestBody: DetachPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/target-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		AttachPrincipalPolicy(policyName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DetachPrincipalPolicy(policyName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/principal-policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '#x-amzn-iot-principal', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		AttachSecurityProfile(securityProfileName: string, securityProfileTargetArn: string, callback: (data : AttachSecurityProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets#securityProfileTargetArn&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetachSecurityProfile(securityProfileName: string, securityProfileTargetArn: string, callback: (data : DetachSecurityProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets#securityProfileTargetArn&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		AttachThingPrincipal(thingName: string, callback: (data : AttachThingPrincipalResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetachThingPrincipal(thingName: string, callback: (data : DetachThingPrincipalResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals#x-amzn-principal', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CancelAuditMitigationActionsTask(taskId: string, callback: (data : CancelAuditMitigationActionsTaskResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelAuditTask(taskId: string, callback: (data : CancelAuditTaskResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelJob(jobId: string, force: boolean, callback: (data : CancelJobResponse) => any, requestBody: CancelJobBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		CancelJobExecution(jobId: string, thingName: string, force: boolean, callback: (data : void) => any, requestBody: CancelJobExecutionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/cancel&force=' + force, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ClearDefaultAuthorizer(callback: (data : ClearDefaultAuthorizerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/default-authorizer', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDefaultAuthorizer(callback: (data : DescribeDefaultAuthorizerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/default-authorizer', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		SetDefaultAuthorizer(callback: (data : SetDefaultAuthorizerResponse) => any, requestBody: SetDefaultAuthorizerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/default-authorizer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ConfirmTopicRuleDestination(confirmationToken: string, callback: (data : ConfirmTopicRuleDestinationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/confirmdestination/' + (confirmationToken == null ? '' : encodeURIComponent(confirmationToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateAuthorizer(authorizerName: string, callback: (data : CreateAuthorizerResponse) => any, requestBody: CreateAuthorizerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteAuthorizer(authorizerName: string, callback: (data : DeleteAuthorizerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeAuthorizer(authorizerName: string, callback: (data : DescribeAuthorizerResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateAuthorizer(authorizerName: string, callback: (data : UpdateAuthorizerResponse) => any, requestBody: UpdateAuthorizerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateBillingGroup(billingGroupName: string, callback: (data : CreateBillingGroupResponse) => any, requestBody: CreateBillingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteBillingGroup(billingGroupName: string, expectedVersion: number, callback: (data : DeleteBillingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '&expectedVersion=' + expectedVersion, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeBillingGroup(billingGroupName: string, callback: (data : DescribeBillingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateCertificateFromCsr(setAsActive: boolean, callback: (data : CreateCertificateFromCsrResponse) => any, requestBody: CreateCertificateFromCsrBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/certificates?setAsActive=' + setAsActive, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, callback: (data : ListCertificatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/certificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateDimension(name: string, callback: (data : CreateDimensionResponse) => any, requestBody: CreateDimensionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDimension(name: string, callback: (data : DeleteDimensionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDimension(name: string, callback: (data : DescribeDimensionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/dimensions/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateDomainConfiguration(domainConfigurationName: string, callback: (data : CreateDomainConfigurationResponse) => any, requestBody: CreateDomainConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDomainConfiguration(domainConfigurationName: string, callback: (data : DeleteDomainConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDomainConfiguration(domainConfigurationName: string, callback: (data : DescribeDomainConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDomainConfiguration(domainConfigurationName: string, callback: (data : UpdateDomainConfigurationResponse) => any, requestBody: UpdateDomainConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/domainConfigurations/' + (domainConfigurationName == null ? '' : encodeURIComponent(domainConfigurationName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateDynamicThingGroup(thingGroupName: string, callback: (data : CreateDynamicThingGroupResponse) => any, requestBody: CreateDynamicThingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDynamicThingGroup(thingGroupName: string, expectedVersion: number, callback: (data : DeleteDynamicThingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/dynamic-thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateJob(jobId: string, callback: (data : CreateJobResponse) => any, requestBody: CreateJobBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteJob(jobId: string, force: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&force=' + force, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeJob(jobId: string, callback: (data : DescribeJobResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateKeysAndCertificate(setAsActive: boolean, callback: (data : CreateKeysAndCertificateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/keys-and-certificate?setAsActive=' + setAsActive, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateMitigationAction(actionName: string, callback: (data : CreateMitigationActionResponse) => any, requestBody: CreateMitigationActionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteMitigationAction(actionName: string, callback: (data : DeleteMitigationActionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeMitigationAction(actionName: string, callback: (data : DescribeMitigationActionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/mitigationactions/actions/' + (actionName == null ? '' : encodeURIComponent(actionName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateOTAUpdate(otaUpdateId: string, callback: (data : CreateOTAUpdateResponse) => any, requestBody: CreateOTAUpdateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteOTAUpdate(otaUpdateId: string, deleteStream: boolean, forceDeleteAWSJob: boolean, callback: (data : DeleteOTAUpdateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)) + '&deleteStream=' + deleteStream + '&forceDeleteAWSJob=' + forceDeleteAWSJob, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetOTAUpdate(otaUpdateId: string, callback: (data : GetOTAUpdateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/otaUpdates/' + (otaUpdateId == null ? '' : encodeURIComponent(otaUpdateId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreatePolicy(policyName: string, callback: (data : CreatePolicyResponse) => any, requestBody: CreatePolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeletePolicy(policyName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetPolicy(policyName: string, callback: (data : GetPolicyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreatePolicyVersion(policyName: string, setAsDefault: boolean, callback: (data : CreatePolicyVersionResponse) => any, requestBody: CreatePolicyVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version&setAsDefault=' + setAsDefault, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPolicyVersions(policyName: string, callback: (data : ListPolicyVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateProvisioningClaim(templateName: string, callback: (data : CreateProvisioningClaimResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/provisioning-claim', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateProvisioningTemplate(callback: (data : CreateProvisioningTemplateResponse) => any, requestBody: CreateProvisioningTemplateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/provisioning-templates', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListProvisioningTemplates(maxResults: number, nextToken: string, callback: (data : ListProvisioningTemplatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/provisioning-templates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateProvisioningTemplateVersion(templateName: string, setAsDefault: boolean, callback: (data : CreateProvisioningTemplateVersionResponse) => any, requestBody: CreateProvisioningTemplateVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&setAsDefault=' + setAsDefault, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListProvisioningTemplateVersions(templateName: string, maxResults: number, nextToken: string, callback: (data : ListProvisioningTemplateVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateRoleAlias(roleAlias: string, callback: (data : CreateRoleAliasResponse) => any, requestBody: CreateRoleAliasBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteRoleAlias(roleAlias: string, callback: (data : DeleteRoleAliasResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeRoleAlias(roleAlias: string, callback: (data : DescribeRoleAliasResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateRoleAlias(roleAlias: string, callback: (data : UpdateRoleAliasResponse) => any, requestBody: UpdateRoleAliasBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/role-aliases/' + (roleAlias == null ? '' : encodeURIComponent(roleAlias)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateScheduledAudit(scheduledAuditName: string, callback: (data : CreateScheduledAuditResponse) => any, requestBody: CreateScheduledAuditBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteScheduledAudit(scheduledAuditName: string, callback: (data : DeleteScheduledAuditResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeScheduledAudit(scheduledAuditName: string, callback: (data : DescribeScheduledAuditResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/scheduledaudits/' + (scheduledAuditName == null ? '' : encodeURIComponent(scheduledAuditName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateSecurityProfile(securityProfileName: string, callback: (data : CreateSecurityProfileResponse) => any, requestBody: CreateSecurityProfileBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSecurityProfile(securityProfileName: string, expectedVersion: number, callback: (data : DeleteSecurityProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '&expectedVersion=' + expectedVersion, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeSecurityProfile(securityProfileName: string, callback: (data : DescribeSecurityProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateStream(streamId: string, callback: (data : CreateStreamResponse) => any, requestBody: CreateStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteStream(streamId: string, callback: (data : DeleteStreamResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeStream(streamId: string, callback: (data : DescribeStreamResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateStream(streamId: string, callback: (data : UpdateStreamResponse) => any, requestBody: UpdateStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/streams/' + (streamId == null ? '' : encodeURIComponent(streamId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateThing(thingName: string, callback: (data : CreateThingResponse) => any, requestBody: CreateThingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteThing(thingName: string, expectedVersion: number, callback: (data : DeleteThingResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '&expectedVersion=' + expectedVersion, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeThing(thingName: string, callback: (data : DescribeThingResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateThingGroup(thingGroupName: string, callback: (data : CreateThingGroupResponse) => any, requestBody: CreateThingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteThingGroup(thingGroupName: string, expectedVersion: number, callback: (data : DeleteThingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&expectedVersion=' + expectedVersion, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeThingGroup(thingGroupName: string, callback: (data : DescribeThingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateThingType(thingTypeName: string, callback: (data : CreateThingTypeResponse) => any, requestBody: CreateThingTypeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteThingType(thingTypeName: string, callback: (data : DeleteThingTypeResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeThingType(thingTypeName: string, callback: (data : DescribeThingTypeResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		CreateTopicRule(ruleName: string, callback: (data : void) => any, requestBody: CreateTopicRuleBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteTopicRule(ruleName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetTopicRule(ruleName: string, callback: (data : GetTopicRuleResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateTopicRuleDestination(callback: (data : CreateTopicRuleDestinationResponse) => any, requestBody: CreateTopicRuleDestinationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/destinations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTopicRuleDestinations(maxResults: number, nextToken: string, callback: (data : ListTopicRuleDestinationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/destinations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteAccountAuditConfiguration(deleteScheduledAudits: boolean, callback: (data : DeleteAccountAuditConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/audit/configuration?deleteScheduledAudits=' + deleteScheduledAudits, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeAccountAuditConfiguration(callback: (data : DescribeAccountAuditConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/configuration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteCACertificate(caCertificateId: string, callback: (data : DeleteCACertificateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeCACertificate(caCertificateId: string, callback: (data : DescribeCACertificateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCACertificate(caCertificateId: string, newStatus: AuthorizerStatus, newAutoRegistrationStatus: AutoRegistrationStatus, callback: (data : void) => any, requestBody: UpdateCACertificateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/cacertificate/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)) + '&newStatus=' + newStatus + '&newAutoRegistrationStatus=' + newAutoRegistrationStatus, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCertificate(certificateId: string, forceDelete: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '&forceDelete=' + forceDelete, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeCertificate(certificateId: string, callback: (data : DescribeCertificateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteJobExecution(jobId: string, thingName: string, executionNumber: number, force: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/executionNumber/' + executionNumber + '&force=' + force, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeletePolicyVersion(policyName: string, policyVersionId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetPolicyVersion(policyName: string, policyVersionId: string, callback: (data : GetPolicyVersionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/policies/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '/version/' + (policyVersionId == null ? '' : encodeURIComponent(policyVersionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteProvisioningTemplate(templateName: string, callback: (data : DeleteProvisioningTemplateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeProvisioningTemplate(templateName: string, callback: (data : DescribeProvisioningTemplateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteProvisioningTemplateVersion(templateName: string, versionId: number, callback: (data : DeleteProvisioningTemplateVersionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeProvisioningTemplateVersion(templateName: string, versionId: number, callback: (data : DescribeProvisioningTemplateVersionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/provisioning-templates/' + (templateName == null ? '' : encodeURIComponent(templateName)) + '/versions/' + versionId, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteRegistrationCode(callback: (data : DeleteRegistrationCodeResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/registrationcode', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetRegistrationCode(callback: (data : GetRegistrationCodeResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/registrationcode', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteTopicRuleDestination(arn: string, callback: (data : DeleteTopicRuleDestinationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetTopicRuleDestination(arn: string, callback: (data : GetTopicRuleDestinationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/destinations/' + (arn == null ? '' : encodeURIComponent(arn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteV2LoggingLevel(targetType: LogTargetType, targetName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v2LoggingLevel#targetType&targetName?targetType=' + targetType + '&targetName=' + (targetName == null ? '' : encodeURIComponent(targetName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeprecateThingType(thingTypeName: string, callback: (data : DeprecateThingTypeResponse) => any, requestBody: DeprecateThingTypeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/thing-types/' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)) + '/deprecate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAuditFinding(findingId: string, callback: (data : DescribeAuditFindingResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/findings/' + (findingId == null ? '' : encodeURIComponent(findingId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeAuditMitigationActionsTask(taskId: string, callback: (data : DescribeAuditMitigationActionsTaskResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		StartAuditMitigationActionsTask(taskId: string, callback: (data : StartAuditMitigationActionsTaskResponse) => any, requestBody: StartAuditMitigationActionsTaskBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/audit/mitigationactions/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAuditTask(taskId: string, callback: (data : DescribeAuditTaskResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeEndpoint(endpointType: string, callback: (data : DescribeEndpointResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/endpoint?endpointType=' + (endpointType == null ? '' : encodeURIComponent(endpointType)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeEventConfigurations(callback: (data : DescribeEventConfigurationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/event-configurations', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeIndex(indexName: string, callback: (data : DescribeIndexResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/indices/' + (indexName == null ? '' : encodeURIComponent(indexName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeJobExecution(jobId: string, thingName: string, executionNumber: number, callback: (data : DescribeJobExecutionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '&executionNumber=' + executionNumber, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeThingRegistrationTask(taskId: string, callback: (data : DescribeThingRegistrationTaskResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DisableTopicRule(ruleName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/disable', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		EnableTopicRule(ruleName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/rules/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '/enable', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCardinality(callback: (data : GetCardinalityResponse) => any, requestBody: GetCardinalityBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/indices/cardinality', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetEffectivePolicies(thingName: string, callback: (data : GetEffectivePoliciesResponse) => any, requestBody: GetEffectivePoliciesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/effective-policies?thingName=' + (thingName == null ? '' : encodeURIComponent(thingName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetIndexingConfiguration(callback: (data : GetIndexingConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/indexing/config', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateIndexingConfiguration(callback: (data : UpdateIndexingConfigurationResponse) => any, requestBody: UpdateIndexingConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/indexing/config', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetJobDocument(jobId: string, callback: (data : GetJobDocumentResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/job-document', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetLoggingOptions(callback: (data : GetLoggingOptionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/loggingOptions', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		SetLoggingOptions(callback: (data : void) => any, requestBody: SetLoggingOptionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/loggingOptions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetPercentiles(callback: (data : GetPercentilesResponse) => any, requestBody: GetPercentilesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/indices/percentiles', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetStatistics(callback: (data : GetStatisticsResponse) => any, requestBody: GetStatisticsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/indices/statistics', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetV2LoggingOptions(callback: (data : GetV2LoggingOptionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2LoggingOptions', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		SetV2LoggingOptions(callback: (data : void) => any, requestBody: SetV2LoggingOptionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2LoggingOptions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListActiveViolations(thingName: string, securityProfileName: string, nextToken: string, maxResults: number, callback: (data : ListActiveViolationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/active-violations?thingName=' + (thingName == null ? '' : encodeURIComponent(thingName)) + '&securityProfileName=' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListAttachedPolicies(target: string, recursive: boolean, marker: string, pageSize: number, callback: (data : ListAttachedPoliciesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/attached-policies/' + (target == null ? '' : encodeURIComponent(target)) + '&recursive=' + recursive + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAuditFindings(callback: (data : ListAuditFindingsResponse) => any, requestBody: ListAuditFindingsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/audit/findings', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAuditMitigationActionsExecutions(taskId: string, actionStatus: AuditMitigationActionsExecutionStatus, findingId: string, maxResults: number, nextToken: string, callback: (data : ListAuditMitigationActionsExecutionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/mitigationactions/executions#taskId&findingId?taskId=' + (taskId == null ? '' : encodeURIComponent(taskId)) + '&actionStatus=' + actionStatus + '&findingId=' + (findingId == null ? '' : encodeURIComponent(findingId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListAuditMitigationActionsTasks(auditTaskId: string, findingId: string, taskStatus: DescribeAuditMitigationActionsTaskResponseTaskStatus, maxResults: number, nextToken: string, startTime: Date, endTime: Date, callback: (data : ListAuditMitigationActionsTasksResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ListAuditTasks(startTime: Date, endTime: Date, taskType: DescribeAuditTaskResponseTaskType, taskStatus: DescribeAuditMitigationActionsTaskResponseTaskStatus, nextToken: string, maxResults: number, callback: (data : ListAuditTasksResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/tasks#startTime&endTime?startTime=' + startTime.toISOString() + '&endTime=' + endTime.toISOString() + '&taskType=' + taskType + '&taskStatus=' + taskStatus + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListAuthorizers(pageSize: number, marker: string, isAscendingOrder: boolean, status: AuthorizerStatus, callback: (data : ListAuthorizersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/authorizers/?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder + '&status=' + status, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListBillingGroups(nextToken: string, maxResults: number, namePrefixFilter: string, callback: (data : ListBillingGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/billing-groups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&namePrefixFilter=' + (namePrefixFilter == null ? '' : encodeURIComponent(namePrefixFilter)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListCACertificates(pageSize: number, marker: string, isAscendingOrder: boolean, callback: (data : ListCACertificatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/cacertificates?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListCertificatesByCA(caCertificateId: string, pageSize: number, marker: string, isAscendingOrder: boolean, callback: (data : ListCertificatesByCAResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/certificates-by-ca/' + (caCertificateId == null ? '' : encodeURIComponent(caCertificateId)) + '&pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListDimensions(nextToken: string, maxResults: number, callback: (data : ListDimensionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/dimensions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListDomainConfigurations(marker: string, pageSize: number, serviceType: DescribeDomainConfigurationResponseServiceType, callback: (data : ListDomainConfigurationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/domainConfigurations?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&serviceType=' + serviceType, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListIndices(nextToken: string, maxResults: number, callback: (data : ListIndicesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/indices?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListJobExecutionsForJob(jobId: string, status: JobExecutionStatus, maxResults: number, nextToken: string, callback: (data : ListJobExecutionsForJobResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/things&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListJobExecutionsForThing(thingName: string, status: JobExecutionStatus, maxResults: number, nextToken: string, callback: (data : ListJobExecutionsForThingResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/jobs&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListJobs(status: JobStatus, targetSelection: TargetSelection, maxResults: number, nextToken: string, thingGroupName: string, thingGroupId: string, callback: (data : ListJobsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/jobs?status=' + status + '&targetSelection=' + targetSelection + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&thingGroupName=' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '&thingGroupId=' + (thingGroupId == null ? '' : encodeURIComponent(thingGroupId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListMitigationActions(actionType: DescribeMitigationActionResponseActionType, maxResults: number, nextToken: string, callback: (data : ListMitigationActionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/mitigationactions/actions?actionType=' + actionType + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListOTAUpdates(maxResults: number, nextToken: string, otaUpdateStatus: CreateOTAUpdateResponseOtaUpdateStatus, callback: (data : ListOTAUpdatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/otaUpdates?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&otaUpdateStatus=' + otaUpdateStatus, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListOutgoingCertificates(pageSize: number, marker: string, isAscendingOrder: boolean, callback: (data : ListOutgoingCertificatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/certificates-out-going?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, callback: (data : ListPoliciesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/policies?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListPolicyPrincipals(marker: string, pageSize: number, isAscendingOrder: boolean, callback: (data : ListPolicyPrincipalsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/policy-principals#x-amzn-iot-policy?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListPrincipalPolicies(marker: string, pageSize: number, isAscendingOrder: boolean, callback: (data : ListPrincipalPoliciesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/principal-policies#x-amzn-iot-principal?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListPrincipalThings(nextToken: string, maxResults: number, callback: (data : ListPrincipalThingsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/principals/things#x-amzn-principal?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListRoleAliases(pageSize: number, marker: string, isAscendingOrder: boolean, callback: (data : ListRoleAliasesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/role-aliases?pageSize=' + pageSize + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListScheduledAudits(nextToken: string, maxResults: number, callback: (data : ListScheduledAuditsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/audit/scheduledaudits?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListSecurityProfiles(nextToken: string, maxResults: number, dimensionName: string, callback: (data : ListSecurityProfilesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/security-profiles?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&dimensionName=' + (dimensionName == null ? '' : encodeURIComponent(dimensionName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListSecurityProfilesForTarget(nextToken: string, maxResults: number, recursive: boolean, securityProfileTargetArn: string, callback: (data : ListSecurityProfilesForTargetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/security-profiles-for-target#securityProfileTargetArn?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&recursive=' + recursive + '&securityProfileTargetArn=' + (securityProfileTargetArn == null ? '' : encodeURIComponent(securityProfileTargetArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListStreams(maxResults: number, nextToken: string, isAscendingOrder: boolean, callback: (data : ListStreamsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/streams?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&isAscendingOrder=' + isAscendingOrder, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListTagsForResource(resourceArn: string, nextToken: string, callback: (data : ListTagsForResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/tags#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListTargetsForPolicy(policyName: string, marker: string, pageSize: number, callback: (data : ListTargetsForPolicyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/policy-targets/' + (policyName == null ? '' : encodeURIComponent(policyName)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&pageSize=' + pageSize, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTargetsForSecurityProfile(securityProfileName: string, nextToken: string, maxResults: number, callback: (data : ListTargetsForSecurityProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/security-profiles/' + (securityProfileName == null ? '' : encodeURIComponent(securityProfileName)) + '/targets&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListThingGroups(nextToken: string, maxResults: number, parentGroup: string, namePrefixFilter: string, recursive: boolean, callback: (data : ListThingGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-groups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&parentGroup=' + (parentGroup == null ? '' : encodeURIComponent(parentGroup)) + '&namePrefixFilter=' + (namePrefixFilter == null ? '' : encodeURIComponent(namePrefixFilter)) + '&recursive=' + recursive, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListThingGroupsForThing(thingName: string, nextToken: string, maxResults: number, callback: (data : ListThingGroupsForThingResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/thing-groups&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListThingPrincipals(thingName: string, callback: (data : ListThingPrincipalsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/things/' + (thingName == null ? '' : encodeURIComponent(thingName)) + '/principals', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListThingRegistrationTaskReports(taskId: string, reportType: ListThingRegistrationTaskReportsResponseReportType, nextToken: string, maxResults: number, callback: (data : ListThingRegistrationTaskReportsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/reports#reportType&reportType=' + reportType + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListThingRegistrationTasks(nextToken: string, maxResults: number, status: DescribeThingRegistrationTaskResponseStatus, callback: (data : ListThingRegistrationTasksResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-registration-tasks?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&status=' + status, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		StartThingRegistrationTask(callback: (data : StartThingRegistrationTaskResponse) => any, requestBody: StartThingRegistrationTaskBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/thing-registration-tasks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListThingTypes(nextToken: string, maxResults: number, thingTypeName: string, callback: (data : ListThingTypesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-types?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&thingTypeName=' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListThings(nextToken: string, maxResults: number, attributeName: string, attributeValue: string, thingTypeName: string, callback: (data : ListThingsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/things?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&attributeName=' + (attributeName == null ? '' : encodeURIComponent(attributeName)) + '&attributeValue=' + (attributeValue == null ? '' : encodeURIComponent(attributeValue)) + '&thingTypeName=' + (thingTypeName == null ? '' : encodeURIComponent(thingTypeName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		RegisterThing(callback: (data : RegisterThingResponse) => any, requestBody: RegisterThingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/things', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListThingsInBillingGroup(billingGroupName: string, nextToken: string, maxResults: number, callback: (data : ListThingsInBillingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/billing-groups/' + (billingGroupName == null ? '' : encodeURIComponent(billingGroupName)) + '/things&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListThingsInThingGroup(thingGroupName: string, recursive: boolean, nextToken: string, maxResults: number, callback: (data : ListThingsInThingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/thing-groups/' + (thingGroupName == null ? '' : encodeURIComponent(thingGroupName)) + '/things&recursive=' + recursive + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListTopicRules(topic: string, maxResults: number, nextToken: string, ruleDisabled: boolean, callback: (data : ListTopicRulesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/rules?topic=' + (topic == null ? '' : encodeURIComponent(topic)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&ruleDisabled=' + ruleDisabled, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListV2LoggingLevels(targetType: LogTargetType, nextToken: string, maxResults: number, callback: (data : ListV2LoggingLevelsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v2LoggingLevel?targetType=' + targetType + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		SetV2LoggingLevel(callback: (data : void) => any, requestBody: SetV2LoggingLevelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v2LoggingLevel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListViolationEvents(startTime: Date, endTime: Date, thingName: string, securityProfileName: string, nextToken: string, maxResults: number, callback: (data : ListViolationEventsResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		RegisterCACertificate(setAsActive: boolean, allowAutoRegistration: boolean, callback: (data : RegisterCACertificateResponse) => any, requestBody: RegisterCACertificateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/cacertificate?setAsActive=' + setAsActive + '&allowAutoRegistration=' + allowAutoRegistration, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterCertificate(setAsActive: boolean, callback: (data : RegisterCertificateResponse) => any, requestBody: RegisterCertificateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/certificate/register?setAsActive=' + setAsActive, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterCertificateWithoutCA(callback: (data : RegisterCertificateWithoutCAResponse) => any, requestBody: RegisterCertificateWithoutCABody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/certificate/register-no-ca', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RemoveThingFromBillingGroup(callback: (data : RemoveThingFromBillingGroupResponse) => any, requestBody: RemoveThingFromBillingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/billing-groups/removeThingFromBillingGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RemoveThingFromThingGroup(callback: (data : RemoveThingFromThingGroupResponse) => any, requestBody: RemoveThingFromThingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/thing-groups/removeThingFromThingGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SearchIndex(callback: (data : SearchIndexResponse) => any, requestBody: SearchIndexBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/indices/search', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartOnDemandAuditTask(callback: (data : StartOnDemandAuditTaskResponse) => any, requestBody: StartOnDemandAuditTaskBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/audit/tasks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopThingRegistrationTask(taskId: string, callback: (data : StopThingRegistrationTaskResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/thing-registration-tasks/' + (taskId == null ? '' : encodeURIComponent(taskId)) + '/cancel', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/tags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TestAuthorization(clientId: string, callback: (data : TestAuthorizationResponse) => any, requestBody: TestAuthorizationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/test-authorization?clientId=' + (clientId == null ? '' : encodeURIComponent(clientId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TestInvokeAuthorizer(authorizerName: string, callback: (data : TestInvokeAuthorizerResponse) => any, requestBody: TestInvokeAuthorizerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/authorizer/' + (authorizerName == null ? '' : encodeURIComponent(authorizerName)) + '/test', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UntagResource(callback: (data : UntagResourceResponse) => any, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/untag', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateCertificate(certificateId: string, newStatus: CertificateStatus, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/certificates/' + (certificateId == null ? '' : encodeURIComponent(certificateId)) + '#newStatus&newStatus=' + newStatus, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateThingGroupsForThing(callback: (data : UpdateThingGroupsForThingResponse) => any, requestBody: UpdateThingGroupsForThingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/thing-groups/updateThingGroupsForThing', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ValidateSecurityProfileBehaviors(callback: (data : ValidateSecurityProfileBehaviorsResponse) => any, requestBody: ValidateSecurityProfileBehaviorsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/security-profile-behaviors/validate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
