export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApp(requestBody: CreateAppBody, headersHandler?: () => {[header: string]: string}): Promise<CreateAppResult> {
			return fetch(this.baseUri + 'apps', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListApps(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListAppsResult> {
			return fetch(this.baseUri + 'apps?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBackendEnvironment(appId: string, requestBody: CreateBackendEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackendEnvironmentResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBackendEnvironments(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListBackendEnvironmentsResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBranch(appId: string, requestBody: CreateBranchBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBranchResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBranches(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListBranchesResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDomainAssociation(appId: string, requestBody: CreateDomainAssociationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainAssociationResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDomainAssociations(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDomainAssociationsResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateWebhook(appId: string, requestBody: CreateWebhookBody, headersHandler?: () => {[header: string]: string}): Promise<CreateWebhookResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/webhooks', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListWebhooks(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListWebhooksResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/webhooks&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteApp(appId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAppResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApp(appId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAppResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApp(appId: string, requestBody: UpdateAppBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAppResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteBackendEnvironment(appId: string, environmentName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackendEnvironmentResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments/' + (environmentName == null ? '' : encodeURIComponent(environmentName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBackendEnvironment(appId: string, environmentName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackendEnvironmentResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments/' + (environmentName == null ? '' : encodeURIComponent(environmentName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBranch(appId: string, branchName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBranchResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBranch(appId: string, branchName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBranchResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBranch(appId: string, branchName: string, requestBody: UpdateBranchBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBranchResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDomainAssociation(appId: string, domainName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainAssociationResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains/' + (domainName == null ? '' : encodeURIComponent(domainName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDomainAssociation(appId: string, domainName: string, headersHandler?: () => {[header: string]: string}): Promise<GetDomainAssociationResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains/' + (domainName == null ? '' : encodeURIComponent(domainName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDomainAssociation(appId: string, domainName: string, requestBody: UpdateDomainAssociationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainAssociationResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains/' + (domainName == null ? '' : encodeURIComponent(domainName)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteJob(appId: string, branchName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteJobResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJob(appId: string, branchName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GetJobResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteWebhook(webhookId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteWebhookResult> {
			return fetch(this.baseUri + 'webhooks/' + (webhookId == null ? '' : encodeURIComponent(webhookId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetWebhook(webhookId: string, headersHandler?: () => {[header: string]: string}): Promise<GetWebhookResult> {
			return fetch(this.baseUri + 'webhooks/' + (webhookId == null ? '' : encodeURIComponent(webhookId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateWebhook(webhookId: string, requestBody: UpdateWebhookBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateWebhookResult> {
			return fetch(this.baseUri + 'webhooks/' + (webhookId == null ? '' : encodeURIComponent(webhookId)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GenerateAccessLogs(appId: string, requestBody: GenerateAccessLogsBody, headersHandler?: () => {[header: string]: string}): Promise<GenerateAccessLogsResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/accesslogs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetArtifactUrl(artifactId: string, headersHandler?: () => {[header: string]: string}): Promise<GetArtifactUrlResult> {
			return fetch(this.baseUri + 'artifacts/' + (artifactId == null ? '' : encodeURIComponent(artifactId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListArtifacts(appId: string, branchName: string, jobId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListArtifactsResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/artifacts&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListJobs(appId: string, branchName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartJob(appId: string, branchName: string, requestBody: StartJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartJobResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartDeployment(appId: string, branchName: string, requestBody: StartDeploymentBody, headersHandler?: () => {[header: string]: string}): Promise<StartDeploymentResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/deployments/start', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopJob(appId: string, branchName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<StopJobResult> {
			return fetch(this.baseUri + 'apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/stop', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
