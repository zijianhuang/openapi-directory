...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApp(requestBody: CreateAppBody, headersHandler?: () => {[header: string]: string}): Promise<CreateAppResult> {
			return this.http.post('apps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListApps(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListAppsResult> {
			return this.http.get('apps?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBackendEnvironment(appId: string, requestBody: CreateBackendEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBackendEnvironmentResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListBackendEnvironments(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListBackendEnvironmentsResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBranch(appId: string, requestBody: CreateBranchBody, headersHandler?: () => {[header: string]: string}): Promise<CreateBranchResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListBranches(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListBranchesResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDeployment(appId: string, branchName: string, requestBody: CreateDeploymentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/deployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDomainAssociation(appId: string, requestBody: CreateDomainAssociationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainAssociationResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDomainAssociations(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDomainAssociationsResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateWebhook(appId: string, requestBody: CreateWebhookBody, headersHandler?: () => {[header: string]: string}): Promise<CreateWebhookResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/webhooks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListWebhooks(appId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListWebhooksResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/webhooks&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteApp(appId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteAppResult> {
			return this.http.delete('apps/' + (appId == null ? '' : encodeURIComponent(appId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApp(appId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAppResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApp(appId: string, requestBody: UpdateAppBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAppResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteBackendEnvironment(appId: string, environmentName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackendEnvironmentResult> {
			return this.http.delete('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments/' + (environmentName == null ? '' : encodeURIComponent(environmentName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBackendEnvironment(appId: string, environmentName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBackendEnvironmentResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/backendenvironments/' + (environmentName == null ? '' : encodeURIComponent(environmentName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBranch(appId: string, branchName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteBranchResult> {
			return this.http.delete('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBranch(appId: string, branchName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBranchResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBranch(appId: string, branchName: string, requestBody: UpdateBranchBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBranchResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDomainAssociation(appId: string, domainName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainAssociationResult> {
			return this.http.delete('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains/' + (domainName == null ? '' : encodeURIComponent(domainName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDomainAssociation(appId: string, domainName: string, headersHandler?: () => {[header: string]: string}): Promise<GetDomainAssociationResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains/' + (domainName == null ? '' : encodeURIComponent(domainName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDomainAssociation(appId: string, domainName: string, requestBody: UpdateDomainAssociationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainAssociationResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/domains/' + (domainName == null ? '' : encodeURIComponent(domainName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteJob(appId: string, branchName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteJobResult> {
			return this.http.delete('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetJob(appId: string, branchName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GetJobResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteWebhook(webhookId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteWebhookResult> {
			return this.http.delete('webhooks/' + (webhookId == null ? '' : encodeURIComponent(webhookId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetWebhook(webhookId: string, headersHandler?: () => {[header: string]: string}): Promise<GetWebhookResult> {
			return this.http.get('webhooks/' + (webhookId == null ? '' : encodeURIComponent(webhookId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateWebhook(webhookId: string, requestBody: UpdateWebhookBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateWebhookResult> {
			return this.http.post('webhooks/' + (webhookId == null ? '' : encodeURIComponent(webhookId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GenerateAccessLogs(appId: string, requestBody: GenerateAccessLogsBody, headersHandler?: () => {[header: string]: string}): Promise<GenerateAccessLogsResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/accesslogs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetArtifactUrl(artifactId: string, headersHandler?: () => {[header: string]: string}): Promise<GetArtifactUrlResult> {
			return this.http.get('artifacts/' + (artifactId == null ? '' : encodeURIComponent(artifactId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListArtifacts(appId: string, branchName: string, jobId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListArtifactsResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/artifacts&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListJobs(appId: string, branchName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResult> {
			return this.http.get('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartJob(appId: string, branchName: string, requestBody: StartJobBody, headersHandler?: () => {[header: string]: string}): Promise<StartJobResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartDeployment(appId: string, branchName: string, requestBody: StartDeploymentBody, headersHandler?: () => {[header: string]: string}): Promise<StartDeploymentResult> {
			return this.http.post('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/deployments/start', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopJob(appId: string, branchName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<StopJobResult> {
			return this.http.delete('apps/' + (appId == null ? '' : encodeURIComponent(appId)) + '/branches/' + (branchName == null ? '' : encodeURIComponent(branchName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/stop', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
