export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateSignalingChannel(requestBody: CreateSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSignalingChannelOutput> {
			return fetch(this.baseUri + '/createSignalingChannel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateStream(requestBody: CreateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamOutput> {
			return fetch(this.baseUri + '/createStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSignalingChannel(requestBody: DeleteSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteSignalingChannelOutput> {
			return fetch(this.baseUri + '/deleteSignalingChannel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteStream(requestBody: DeleteStreamBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteStreamOutput> {
			return fetch(this.baseUri + '/deleteStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSignalingChannel(requestBody: DescribeSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSignalingChannelOutput> {
			return fetch(this.baseUri + '/describeSignalingChannel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeStream(requestBody: DescribeStreamBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamOutput> {
			return fetch(this.baseUri + '/describeStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDataEndpoint(requestBody: GetDataEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<GetDataEndpointOutput> {
			return fetch(this.baseUri + '/getDataEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSignalingChannelEndpoint(requestBody: GetSignalingChannelEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<GetSignalingChannelEndpointOutput> {
			return fetch(this.baseUri + '/getSignalingChannelEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForStream(requestBody: ListTagsForStreamBody, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForStreamOutput> {
			return fetch(this.baseUri + '/listTagsForStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagStream(requestBody: TagStreamBody, headersHandler?: () => {[header: string]: string}): Promise<TagStreamOutput> {
			return fetch(this.baseUri + '/tagStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagStream(requestBody: UntagStreamBody, headersHandler?: () => {[header: string]: string}): Promise<UntagStreamOutput> {
			return fetch(this.baseUri + '/untagStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDataRetention(requestBody: UpdateDataRetentionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataRetentionOutput> {
			return fetch(this.baseUri + '/updateDataRetention', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateSignalingChannel(requestBody: UpdateSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSignalingChannelOutput> {
			return fetch(this.baseUri + '/updateSignalingChannel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateStream(requestBody: UpdateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateStreamOutput> {
			return fetch(this.baseUri + '/updateStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
