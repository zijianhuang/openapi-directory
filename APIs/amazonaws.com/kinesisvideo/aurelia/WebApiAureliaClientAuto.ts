...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateSignalingChannel(requestBody: CreateSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSignalingChannelOutput> {
			return this.http.post('/createSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateStream(requestBody: CreateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamOutput> {
			return this.http.post('/createStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSignalingChannel(requestBody: DeleteSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteSignalingChannelOutput> {
			return this.http.post('/deleteSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteStream(requestBody: DeleteStreamBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteStreamOutput> {
			return this.http.post('/deleteStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSignalingChannel(requestBody: DescribeSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSignalingChannelOutput> {
			return this.http.post('/describeSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeStream(requestBody: DescribeStreamBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamOutput> {
			return this.http.post('/describeStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDataEndpoint(requestBody: GetDataEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<GetDataEndpointOutput> {
			return this.http.post('/getDataEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSignalingChannelEndpoint(requestBody: GetSignalingChannelEndpointBody, headersHandler?: () => {[header: string]: string}): Promise<GetSignalingChannelEndpointOutput> {
			return this.http.post('/getSignalingChannelEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForStream(requestBody: ListTagsForStreamBody, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForStreamOutput> {
			return this.http.post('/listTagsForStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagStream(requestBody: TagStreamBody, headersHandler?: () => {[header: string]: string}): Promise<TagStreamOutput> {
			return this.http.post('/tagStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagStream(requestBody: UntagStreamBody, headersHandler?: () => {[header: string]: string}): Promise<UntagStreamOutput> {
			return this.http.post('/untagStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDataRetention(requestBody: UpdateDataRetentionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataRetentionOutput> {
			return this.http.post('/updateDataRetention', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSignalingChannel(requestBody: UpdateSignalingChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSignalingChannelOutput> {
			return this.http.post('/updateSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateStream(requestBody: UpdateStreamBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateStreamOutput> {
			return this.http.post('/updateStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
