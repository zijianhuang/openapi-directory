...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateSignalingChannel(requestBody: CreateSignalingChannelBody, headersHandler?: () => HttpHeaders): Observable<CreateSignalingChannelOutput> {
			return this.http.post<CreateSignalingChannelOutput>(this.baseUri + '/createSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateStream(requestBody: CreateStreamBody, headersHandler?: () => HttpHeaders): Observable<CreateStreamOutput> {
			return this.http.post<CreateStreamOutput>(this.baseUri + '/createStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSignalingChannel(requestBody: DeleteSignalingChannelBody, headersHandler?: () => HttpHeaders): Observable<DeleteSignalingChannelOutput> {
			return this.http.post<DeleteSignalingChannelOutput>(this.baseUri + '/deleteSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteStream(requestBody: DeleteStreamBody, headersHandler?: () => HttpHeaders): Observable<DeleteStreamOutput> {
			return this.http.post<DeleteStreamOutput>(this.baseUri + '/deleteStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSignalingChannel(requestBody: DescribeSignalingChannelBody, headersHandler?: () => HttpHeaders): Observable<DescribeSignalingChannelOutput> {
			return this.http.post<DescribeSignalingChannelOutput>(this.baseUri + '/describeSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStream(requestBody: DescribeStreamBody, headersHandler?: () => HttpHeaders): Observable<DescribeStreamOutput> {
			return this.http.post<DescribeStreamOutput>(this.baseUri + '/describeStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDataEndpoint(requestBody: GetDataEndpointBody, headersHandler?: () => HttpHeaders): Observable<GetDataEndpointOutput> {
			return this.http.post<GetDataEndpointOutput>(this.baseUri + '/getDataEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSignalingChannelEndpoint(requestBody: GetSignalingChannelEndpointBody, headersHandler?: () => HttpHeaders): Observable<GetSignalingChannelEndpointOutput> {
			return this.http.post<GetSignalingChannelEndpointOutput>(this.baseUri + '/getSignalingChannelEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSignalingChannels(MaxResults: string, NextToken: string, requestBody: ListSignalingChannelsBody, headersHandler?: () => HttpHeaders): Observable<ListSignalingChannelsOutput> {
			return this.http.post<ListSignalingChannelsOutput>(this.baseUri + '/listSignalingChannels?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListStreams(MaxResults: string, NextToken: string, requestBody: ListStreamsBody, headersHandler?: () => HttpHeaders): Observable<ListStreamsOutput> {
		 ...
		 */
		ListTagsForResource(requestBody: ListTagsForResourceBody, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceOutput> {
			return this.http.post<ListTagsForResourceOutput>(this.baseUri + '/ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForStream(requestBody: ListTagsForStreamBody, headersHandler?: () => HttpHeaders): Observable<ListTagsForStreamOutput> {
			return this.http.post<ListTagsForStreamOutput>(this.baseUri + '/listTagsForStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TagResource(requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<TagResourceOutput> {
			return this.http.post<TagResourceOutput>(this.baseUri + '/TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TagStream(requestBody: TagStreamBody, headersHandler?: () => HttpHeaders): Observable<TagStreamOutput> {
			return this.http.post<TagStreamOutput>(this.baseUri + '/tagStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => HttpHeaders): Observable<UntagResourceOutput> {
			return this.http.post<UntagResourceOutput>(this.baseUri + '/UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UntagStream(requestBody: UntagStreamBody, headersHandler?: () => HttpHeaders): Observable<UntagStreamOutput> {
			return this.http.post<UntagStreamOutput>(this.baseUri + '/untagStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDataRetention(requestBody: UpdateDataRetentionBody, headersHandler?: () => HttpHeaders): Observable<UpdateDataRetentionOutput> {
			return this.http.post<UpdateDataRetentionOutput>(this.baseUri + '/updateDataRetention', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSignalingChannel(requestBody: UpdateSignalingChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateSignalingChannelOutput> {
			return this.http.post<UpdateSignalingChannelOutput>(this.baseUri + '/updateSignalingChannel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateStream(requestBody: UpdateStreamBody, headersHandler?: () => HttpHeaders): Observable<UpdateStreamOutput> {
			return this.http.post<UpdateStreamOutput>(this.baseUri + '/updateStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
