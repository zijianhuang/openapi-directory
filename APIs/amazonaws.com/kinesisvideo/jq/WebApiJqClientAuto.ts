...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateSignalingChannel(callback: (data : CreateSignalingChannelOutput) => any, requestBody: CreateSignalingChannelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/createSignalingChannel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateStream(callback: (data : CreateStreamOutput) => any, requestBody: CreateStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/createStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSignalingChannel(callback: (data : DeleteSignalingChannelOutput) => any, requestBody: DeleteSignalingChannelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/deleteSignalingChannel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteStream(callback: (data : DeleteStreamOutput) => any, requestBody: DeleteStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/deleteStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSignalingChannel(callback: (data : DescribeSignalingChannelOutput) => any, requestBody: DescribeSignalingChannelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeSignalingChannel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeStream(callback: (data : DescribeStreamOutput) => any, requestBody: DescribeStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/describeStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDataEndpoint(callback: (data : GetDataEndpointOutput) => any, requestBody: GetDataEndpointBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getDataEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSignalingChannelEndpoint(callback: (data : GetSignalingChannelEndpointOutput) => any, requestBody: GetSignalingChannelEndpointBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getSignalingChannelEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListSignalingChannels(MaxResults: string, NextToken: string, callback: (data : ListSignalingChannelsOutput) => any, requestBody: ListSignalingChannelsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listSignalingChannels?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListStreams(MaxResults: string, NextToken: string, callback: (data : ListStreamsOutput) => any, requestBody: ListStreamsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listStreams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForResource(callback: (data : ListTagsForResourceOutput) => any, requestBody: ListTagsForResourceBody, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ListTagsForStream(callback: (data : ListTagsForStreamOutput) => any, requestBody: ListTagsForStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listTagsForStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TagResource(callback: (data : TagResourceOutput) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		TagStream(callback: (data : TagStreamOutput) => any, requestBody: TagStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/tagStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UntagResource(callback: (data : UntagResourceOutput) => any, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		UntagStream(callback: (data : UntagStreamOutput) => any, requestBody: UntagStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/untagStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDataRetention(callback: (data : UpdateDataRetentionOutput) => any, requestBody: UpdateDataRetentionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateDataRetention', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSignalingChannel(callback: (data : UpdateSignalingChannelOutput) => any, requestBody: UpdateSignalingChannelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateSignalingChannel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateStream(callback: (data : UpdateStreamOutput) => any, requestBody: UpdateStreamBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/updateStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
