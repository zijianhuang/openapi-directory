...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AbortMultipartUpload(Bucket: string, Key: string, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#uploadId&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListParts(Bucket: string, Key: string, max_parts: number, part_number_marker: number, uploadId: string, MaxParts: string, PartNumberMarker: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#uploadId&max_parts=' + max_parts + '&part_number_marker=' + part_number_marker + '&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)) + '&MaxParts=' + (MaxParts == null ? '' : encodeURIComponent(MaxParts)) + '&PartNumberMarker=' + (PartNumberMarker == null ? '' : encodeURIComponent(PartNumberMarker)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucket(Bucket: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketCors(Bucket: string, cors: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketCors(Bucket: string, cors: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketEncryption(Bucket: string, encryption: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketEncryption(Bucket: string, encryption: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketLifecycle(Bucket: string, lifecycle: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketLifecycleConfiguration(Bucket: string, lifecycle: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketPolicy(Bucket: string, policy: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketPolicy(Bucket: string, policy: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketReplication(Bucket: string, replication: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketReplication(Bucket: string, replication: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketTagging(Bucket: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketTagging(Bucket: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBucketWebsite(Bucket: string, website: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketWebsite(Bucket: string, website: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteObject(Bucket: string, Key: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeletePublicAccessBlock(Bucket: string, publicAccessBlock: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPublicAccessBlock(Bucket: string, publicAccessBlock: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketAccelerateConfiguration(Bucket: string, accelerate: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#accelerate&accelerate=' + accelerate, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketAcl(Bucket: string, acl: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#acl&acl=' + acl, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketLifecycle(Bucket: string, lifecycle: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&deprecated!&lifecycle=' + lifecycle, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketLocation(Bucket: string, location: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#location&location=' + location, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketLogging(Bucket: string, logging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#logging&logging=' + logging, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketNotificationConfiguration(Bucket: string, notification: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&notification=' + notification, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketNotification(Bucket: string, notification: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&deprecated!&notification=' + notification, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketPolicyStatus(Bucket: string, policyStatus: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policyStatus&policyStatus=' + policyStatus, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketRequestPayment(Bucket: string, requestPayment: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#requestPayment&requestPayment=' + requestPayment, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBucketVersioning(Bucket: string, versioning: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#versioning&versioning=' + versioning, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetObjectAcl(Bucket: string, Key: string, versionId: string, acl: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#acl&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&acl=' + acl, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetObjectLegalHold(Bucket: string, Key: string, versionId: string, legal_hold: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#legal-hold&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&legal_hold=' + legal_hold, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetObjectLockConfiguration(Bucket: string, object_lock: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#object-lock&object_lock=' + object_lock, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetObjectRetention(Bucket: string, Key: string, versionId: string, retention: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#retention&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&retention=' + retention, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetObjectTorrent(Bucket: string, Key: string, torrent: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#torrent&torrent=' + torrent, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListBucketAnalyticsConfigurations(Bucket: string, continuation_token: string, analytics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&analytics=' + analytics, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListBucketInventoryConfigurations(Bucket: string, continuation_token: string, inventory: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&inventory=' + inventory, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListBucketMetricsConfigurations(Bucket: string, continuation_token: string, metrics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&metrics=' + metrics, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListBuckets(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UploadPartCopy(Bucket: string, Key: string, partNumber: number, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#x-amz-copy-source&partNumber&uploadId&partNumber=' + partNumber + '&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
