export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AbortMultipartUpload(Bucket: string, Key: string, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#uploadId&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		ListParts(Bucket: string, Key: string, max_parts: number, part_number_marker: number, uploadId: string, MaxParts: string, PartNumberMarker: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#uploadId&max_parts=' + max_parts + '&part_number_marker=' + part_number_marker + '&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)) + '&MaxParts=' + (MaxParts == null ? '' : encodeURIComponent(MaxParts)) + '&PartNumberMarker=' + (PartNumberMarker == null ? '' : encodeURIComponent(PartNumberMarker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucket(Bucket: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		ListObjects(Bucket: string, delimiter: string, encoding_type: ListMultipartUploadsOutputEncodingType, marker: string, max_keys: number, prefix: string, MaxKeys: string, Marker: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '&delimiter=' + (delimiter == null ? '' : encodeURIComponent(delimiter)) + '&encoding_type=' + encoding_type + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&max_keys=' + max_keys + '&prefix=' + (prefix == null ? '' : encodeURIComponent(prefix)) + '&MaxKeys=' + (MaxKeys == null ? '' : encodeURIComponent(MaxKeys)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketCors(Bucket: string, cors: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketCors(Bucket: string, cors: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketEncryption(Bucket: string, encryption: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketEncryption(Bucket: string, encryption: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketLifecycle(Bucket: string, lifecycle: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLifecycleConfiguration(Bucket: string, lifecycle: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketPolicy(Bucket: string, policy: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketPolicy(Bucket: string, policy: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketReplication(Bucket: string, replication: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketReplication(Bucket: string, replication: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketTagging(Bucket: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketTagging(Bucket: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketWebsite(Bucket: string, website: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketWebsite(Bucket: string, website: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteObject(Bucket: string, Key: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetObject(Bucket: string, Key: string, response_cache_control: string, response_content_disposition: string, response_content_encoding: string, response_content_language: string, response_content_type: string, response_expires: Date, versionId: string, partNumber: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
		 ...
		 * @return {void} 
		 */
		DeleteObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeletePublicAccessBlock(Bucket: string, publicAccessBlock: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetPublicAccessBlock(Bucket: string, publicAccessBlock: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAccelerateConfiguration(Bucket: string, accelerate: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#accelerate&accelerate=' + accelerate, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAcl(Bucket: string, acl: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#acl&acl=' + acl, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLifecycle(Bucket: string, lifecycle: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&deprecated!&lifecycle=' + lifecycle, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLocation(Bucket: string, location: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#location&location=' + location, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLogging(Bucket: string, logging: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#logging&logging=' + logging, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketNotificationConfiguration(Bucket: string, notification: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&notification=' + notification, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketNotification(Bucket: string, notification: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&deprecated!&notification=' + notification, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketPolicyStatus(Bucket: string, policyStatus: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policyStatus&policyStatus=' + policyStatus, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketRequestPayment(Bucket: string, requestPayment: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#requestPayment&requestPayment=' + requestPayment, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketVersioning(Bucket: string, versioning: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#versioning&versioning=' + versioning, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectAcl(Bucket: string, Key: string, versionId: string, acl: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#acl&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&acl=' + acl, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectLegalHold(Bucket: string, Key: string, versionId: string, legal_hold: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#legal-hold&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&legal_hold=' + legal_hold, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectLockConfiguration(Bucket: string, object_lock: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#object-lock&object_lock=' + object_lock, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectRetention(Bucket: string, Key: string, versionId: string, retention: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#retention&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&retention=' + retention, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectTorrent(Bucket: string, Key: string, torrent: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#torrent&torrent=' + torrent, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketAnalyticsConfigurations(Bucket: string, continuation_token: string, analytics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&analytics=' + analytics, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketInventoryConfigurations(Bucket: string, continuation_token: string, inventory: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&inventory=' + inventory, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketMetricsConfigurations(Bucket: string, continuation_token: string, metrics: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&metrics=' + metrics, { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		ListBuckets(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/', { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		ListObjectVersions(Bucket: string, delimiter: string, encoding_type: ListMultipartUploadsOutputEncodingType, key_marker: string, max_keys: number, prefix: string, version_id_marker: string, MaxKeys: string, KeyMarker: string, VersionIdMarker: string, versions: boolean, headersHandler?: () => {[header: string]: string}): Promise<Response> {
		 ...
		 * @return {void} Success
		 */
		UploadPartCopy(Bucket: string, Key: string, partNumber: number, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#x-amz-copy-source&partNumber&uploadId&partNumber=' + partNumber + '&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { method: 'put', headers: headersHandler ? headersHandler() : undefined });
		}
	}
