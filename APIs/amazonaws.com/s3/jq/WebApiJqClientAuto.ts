...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AbortMultipartUpload(Bucket: string, Key: string, uploadId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#uploadId&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ListParts(Bucket: string, Key: string, max_parts: number, part_number_marker: number, uploadId: string, MaxParts: string, PartNumberMarker: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#uploadId&max_parts=' + max_parts + '&part_number_marker=' + part_number_marker + '&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)) + '&MaxParts=' + (MaxParts == null ? '' : encodeURIComponent(MaxParts)) + '&PartNumberMarker=' + (PartNumberMarker == null ? '' : encodeURIComponent(PartNumberMarker)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucket(Bucket: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ListObjects(Bucket: string, delimiter: string, encoding_type: ListMultipartUploadsOutputEncodingType, marker: string, max_keys: number, prefix: string, MaxKeys: string, Marker: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '&delimiter=' + (delimiter == null ? '' : encodeURIComponent(delimiter)) + '&encoding_type=' + encoding_type + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&max_keys=' + max_keys + '&prefix=' + (prefix == null ? '' : encodeURIComponent(prefix)) + '&MaxKeys=' + (MaxKeys == null ? '' : encodeURIComponent(MaxKeys)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketCors(Bucket: string, cors: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketCors(Bucket: string, cors: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketEncryption(Bucket: string, encryption: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketEncryption(Bucket: string, encryption: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketLifecycle(Bucket: string, lifecycle: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLifecycleConfiguration(Bucket: string, lifecycle: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketPolicy(Bucket: string, policy: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketPolicy(Bucket: string, policy: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketReplication(Bucket: string, replication: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketReplication(Bucket: string, replication: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketTagging(Bucket: string, tagging: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketTagging(Bucket: string, tagging: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketWebsite(Bucket: string, website: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketWebsite(Bucket: string, website: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteObject(Bucket: string, Key: string, versionId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetObject(Bucket: string, Key: string, response_cache_control: string, response_content_disposition: string, response_content_encoding: string, response_content_language: string, response_content_type: string, response_expires: Date, versionId: string, partNumber: number, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} 
		 */
		DeleteObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeletePublicAccessBlock(Bucket: string, publicAccessBlock: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetPublicAccessBlock(Bucket: string, publicAccessBlock: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAccelerateConfiguration(Bucket: string, accelerate: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#accelerate&accelerate=' + accelerate, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAcl(Bucket: string, acl: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#acl&acl=' + acl, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLifecycle(Bucket: string, lifecycle: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&deprecated!&lifecycle=' + lifecycle, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLocation(Bucket: string, location: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#location&location=' + location, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLogging(Bucket: string, logging: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#logging&logging=' + logging, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketNotificationConfiguration(Bucket: string, notification: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&notification=' + notification, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketNotification(Bucket: string, notification: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&deprecated!&notification=' + notification, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketPolicyStatus(Bucket: string, policyStatus: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policyStatus&policyStatus=' + policyStatus, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketRequestPayment(Bucket: string, requestPayment: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#requestPayment&requestPayment=' + requestPayment, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketVersioning(Bucket: string, versioning: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#versioning&versioning=' + versioning, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectAcl(Bucket: string, Key: string, versionId: string, acl: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#acl&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&acl=' + acl, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectLegalHold(Bucket: string, Key: string, versionId: string, legal_hold: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#legal-hold&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&legal_hold=' + legal_hold, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectLockConfiguration(Bucket: string, object_lock: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#object-lock&object_lock=' + object_lock, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectRetention(Bucket: string, Key: string, versionId: string, retention: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#retention&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&retention=' + retention, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectTorrent(Bucket: string, Key: string, torrent: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#torrent&torrent=' + torrent, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketAnalyticsConfigurations(Bucket: string, continuation_token: string, analytics: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&analytics=' + analytics, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketInventoryConfigurations(Bucket: string, continuation_token: string, inventory: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&inventory=' + inventory, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketMetricsConfigurations(Bucket: string, continuation_token: string, metrics: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&metrics=' + metrics, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		ListBuckets(callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		ListObjectVersions(Bucket: string, delimiter: string, encoding_type: ListMultipartUploadsOutputEncodingType, key_marker: string, max_keys: number, prefix: string, version_id_marker: string, MaxKeys: string, KeyMarker: string, VersionIdMarker: string, versions: boolean, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		UploadPartCopy(Bucket: string, Key: string, partNumber: number, uploadId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#x-amz-copy-source&partNumber&uploadId&partNumber=' + partNumber + '&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
