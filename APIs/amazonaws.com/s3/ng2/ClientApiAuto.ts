...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AbortMultipartUpload(Bucket: string, Key: string, uploadId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#uploadId&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListParts(Bucket: string, Key: string, max_parts: number, part_number_marker: number, uploadId: string, MaxParts: string, PartNumberMarker: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteBucket(Bucket: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListObjects(Bucket: string, delimiter: string, encoding_type: ListMultipartUploadsOutputEncodingType, marker: string, max_keys: number, prefix: string, MaxKeys: string, Marker: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAnalyticsConfiguration(Bucket: string, id: string, analytics: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&analytics=' + analytics, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketCors(Bucket: string, cors: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketCors(Bucket: string, cors: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#cors&cors=' + cors, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketEncryption(Bucket: string, encryption: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketEncryption(Bucket: string, encryption: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#encryption&encryption=' + encryption, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketInventoryConfiguration(Bucket: string, id: string, inventory: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&inventory=' + inventory, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketLifecycle(Bucket: string, lifecycle: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLifecycleConfiguration(Bucket: string, lifecycle: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&lifecycle=' + lifecycle, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketMetricsConfiguration(Bucket: string, id: string, metrics: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&id&id=' + (id == null ? '' : encodeURIComponent(id)) + '&metrics=' + metrics, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketPolicy(Bucket: string, policy: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketPolicy(Bucket: string, policy: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policy&policy=' + policy, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketReplication(Bucket: string, replication: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketReplication(Bucket: string, replication: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#replication&replication=' + replication, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketTagging(Bucket: string, tagging: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketTagging(Bucket: string, tagging: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#tagging&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBucketWebsite(Bucket: string, website: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketWebsite(Bucket: string, website: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#website&website=' + website, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteObject(Bucket: string, Key: string, versionId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetObject(Bucket: string, Key: string, response_cache_control: string, response_content_disposition: string, response_content_encoding: string, response_content_language: string, response_content_type: string, response_expires: Date, versionId: string, partNumber: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectTagging(Bucket: string, Key: string, versionId: string, tagging: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#tagging&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&tagging=' + tagging, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeletePublicAccessBlock(Bucket: string, publicAccessBlock: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetPublicAccessBlock(Bucket: string, publicAccessBlock: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#publicAccessBlock&publicAccessBlock=' + publicAccessBlock, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAccelerateConfiguration(Bucket: string, accelerate: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#accelerate&accelerate=' + accelerate, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketAcl(Bucket: string, acl: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#acl&acl=' + acl, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLifecycle(Bucket: string, lifecycle: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#lifecycle&deprecated!&lifecycle=' + lifecycle, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLocation(Bucket: string, location: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#location&location=' + location, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketLogging(Bucket: string, logging: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#logging&logging=' + logging, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketNotificationConfiguration(Bucket: string, notification: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&notification=' + notification, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketNotification(Bucket: string, notification: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#notification&deprecated!&notification=' + notification, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketPolicyStatus(Bucket: string, policyStatus: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#policyStatus&policyStatus=' + policyStatus, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketRequestPayment(Bucket: string, requestPayment: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#requestPayment&requestPayment=' + requestPayment, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetBucketVersioning(Bucket: string, versioning: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#versioning&versioning=' + versioning, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectAcl(Bucket: string, Key: string, versionId: string, acl: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#acl&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&acl=' + acl, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectLegalHold(Bucket: string, Key: string, versionId: string, legal_hold: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#legal-hold&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&legal_hold=' + legal_hold, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectLockConfiguration(Bucket: string, object_lock: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#object-lock&object_lock=' + object_lock, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectRetention(Bucket: string, Key: string, versionId: string, retention: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#retention&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&retention=' + retention, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetObjectTorrent(Bucket: string, Key: string, torrent: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#torrent&torrent=' + torrent, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketAnalyticsConfigurations(Bucket: string, continuation_token: string, analytics: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#analytics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&analytics=' + analytics, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketInventoryConfigurations(Bucket: string, continuation_token: string, inventory: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#inventory&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&inventory=' + inventory, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListBucketMetricsConfigurations(Bucket: string, continuation_token: string, metrics: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '#metrics&continuation_token=' + (continuation_token == null ? '' : encodeURIComponent(continuation_token)) + '&metrics=' + metrics, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListBuckets(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		ListObjectVersions(Bucket: string, delimiter: string, encoding_type: ListMultipartUploadsOutputEncodingType, key_marker: string, max_keys: number, prefix: string, version_id_marker: string, MaxKeys: string, KeyMarker: string, VersionIdMarker: string, versions: boolean, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		UploadPartCopy(Bucket: string, Key: string, partNumber: number, uploadId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + '/' + (Bucket == null ? '' : encodeURIComponent(Bucket)) + '/' + (Key == null ? '' : encodeURIComponent(Key)) + '#x-amz-copy-source&partNumber&uploadId&partNumber=' + partNumber + '&uploadId=' + (uploadId == null ? '' : encodeURIComponent(uploadId)), null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
	}
