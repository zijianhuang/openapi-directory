...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ConfigureAgent(profilingGroupName: string, callback: (data : ConfigureAgentResponse) => any, requestBody: ConfigureAgentBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/configureAgent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateProfilingGroup(clientToken: string, callback: (data : void) => any, requestBody: CreateProfilingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/profilingGroups#clientToken?clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteProfilingGroup(profilingGroupName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeProfilingGroup(profilingGroupName: string, callback: (data : DescribeProfilingGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateProfilingGroup(profilingGroupName: string, callback: (data : UpdateProfilingGroupResponse) => any, requestBody: UpdateProfilingGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetPolicy(profilingGroupName: string, callback: (data : GetPolicyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetProfile(endTime: Date, maxDepth: number, period: string, profilingGroupName: string, startTime: Date, callback: (data : GetProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/profile?endTime=' + endTime.toISOString() + '&maxDepth=' + maxDepth + '&period=' + (period == null ? '' : encodeURIComponent(period)) + '&startTime=' + startTime.toISOString(), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListProfileTimes(endTime: Date, maxResults: number, nextToken: string, orderBy: OrderBy, period: AggregationPeriod, profilingGroupName: string, startTime: Date, callback: (data : ListProfileTimesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/profileTimes#endTime&period&startTime?endTime=' + endTime.toISOString() + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&orderBy=' + orderBy + '&period=' + period + '&startTime=' + startTime.toISOString(), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListProfilingGroups(includeDescription: boolean, maxResults: number, nextToken: string, callback: (data : ListProfilingGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/profilingGroups?includeDescription=' + includeDescription + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PostAgentProfile(profileToken: string, profilingGroupName: string, callback: (data : void) => any, requestBody: PostAgentProfileBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/agentProfile#Content-Type?profileToken=' + (profileToken == null ? '' : encodeURIComponent(profileToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutPermission(actionGroup: ActionGroup, profilingGroupName: string, callback: (data : PutPermissionResponse) => any, requestBody: PutPermissionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RemovePermission(actionGroup: ActionGroup, profilingGroupName: string, revisionId: string, callback: (data : RemovePermissionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup + '#revisionId&revisionId=' + (revisionId == null ? '' : encodeURIComponent(revisionId)), callback, this.error, this.statusCode, headersHandler);
		}
	}
