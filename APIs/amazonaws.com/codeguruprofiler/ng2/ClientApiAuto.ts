...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ConfigureAgent(profilingGroupName: string, requestBody: ConfigureAgentBody, headersHandler?: () => HttpHeaders): Observable<ConfigureAgentResponse> {
			return this.http.post<ConfigureAgentResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/configureAgent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		CreateProfilingGroup(clientToken: string, requestBody: CreateProfilingGroupBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/profilingGroups#clientToken?clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteProfilingGroup(profilingGroupName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeProfilingGroup(profilingGroupName: string, headersHandler?: () => HttpHeaders): Observable<DescribeProfilingGroupResponse> {
			return this.http.get<DescribeProfilingGroupResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateProfilingGroup(profilingGroupName: string, requestBody: UpdateProfilingGroupBody, headersHandler?: () => HttpHeaders): Observable<UpdateProfilingGroupResponse> {
			return this.http.put<UpdateProfilingGroupResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetPolicy(profilingGroupName: string, headersHandler?: () => HttpHeaders): Observable<GetPolicyResponse> {
			return this.http.get<GetPolicyResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetProfile(endTime: Date, maxDepth: number, period: string, profilingGroupName: string, startTime: Date, headersHandler?: () => HttpHeaders): Observable<GetProfileResponse> {
			return this.http.get<GetProfileResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/profile?endTime=' + endTime.toISOString() + '&maxDepth=' + maxDepth + '&period=' + (period == null ? '' : encodeURIComponent(period)) + '&startTime=' + startTime.toISOString(), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListProfileTimes(endTime: Date, maxResults: number, nextToken: string, orderBy: OrderBy, period: AggregationPeriod, profilingGroupName: string, startTime: Date, headersHandler?: () => HttpHeaders): Observable<ListProfileTimesResponse> {
			return this.http.get<ListProfileTimesResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/profileTimes#endTime&period&startTime?endTime=' + endTime.toISOString() + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&orderBy=' + orderBy + '&period=' + period + '&startTime=' + startTime.toISOString(), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListProfilingGroups(includeDescription: boolean, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListProfilingGroupsResponse> {
			return this.http.get<ListProfilingGroupsResponse>(this.baseUri + '/profilingGroups?includeDescription=' + includeDescription + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PostAgentProfile(profileToken: string, profilingGroupName: string, requestBody: PostAgentProfileBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/agentProfile#Content-Type?profileToken=' + (profileToken == null ? '' : encodeURIComponent(profileToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutPermission(actionGroup: ActionGroup, profilingGroupName: string, requestBody: PutPermissionBody, headersHandler?: () => HttpHeaders): Observable<PutPermissionResponse> {
			return this.http.put<PutPermissionResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemovePermission(actionGroup: ActionGroup, profilingGroupName: string, revisionId: string, headersHandler?: () => HttpHeaders): Observable<RemovePermissionResponse> {
			return this.http.delete<RemovePermissionResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup + '#revisionId&revisionId=' + (revisionId == null ? '' : encodeURIComponent(revisionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
