...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ConfigureAgent(profilingGroupName: string, requestBody: ConfigureAgentBody, headersHandler?: () => {[header: string]: string}): Promise<ConfigureAgentResponse> {
			return this.http.post('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/configureAgent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateProfilingGroup(clientToken: string, requestBody: CreateProfilingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/profilingGroups#clientToken?clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteProfilingGroup(profilingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeProfilingGroup(profilingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeProfilingGroupResponse> {
			return this.http.get('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateProfilingGroup(profilingGroupName: string, requestBody: UpdateProfilingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateProfilingGroupResponse> {
			return this.http.put('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPolicy(profilingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return this.http.get('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetProfile(endTime: Date, maxDepth: number, period: string, profilingGroupName: string, startTime: Date, headersHandler?: () => {[header: string]: string}): Promise<GetProfileResponse> {
			return this.http.get('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/profile?endTime=' + endTime.toISOString() + '&maxDepth=' + maxDepth + '&period=' + (period == null ? '' : encodeURIComponent(period)) + '&startTime=' + startTime.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProfilingGroups(includeDescription: boolean, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProfilingGroupsResponse> {
			return this.http.get('/profilingGroups?includeDescription=' + includeDescription + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PostAgentProfile(profileToken: string, profilingGroupName: string, requestBody: PostAgentProfileBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/agentProfile#Content-Type?profileToken=' + (profileToken == null ? '' : encodeURIComponent(profileToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutPermission(actionGroup: ActionGroup, profilingGroupName: string, requestBody: PutPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<PutPermissionResponse> {
			return this.http.put('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemovePermission(actionGroup: ActionGroup, profilingGroupName: string, revisionId: string, headersHandler?: () => {[header: string]: string}): Promise<RemovePermissionResponse> {
			return this.http.delete('/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup + '#revisionId&revisionId=' + (revisionId == null ? '' : encodeURIComponent(revisionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
