...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateProfilingGroup(clientToken: string, requestBody: CreateProfilingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/profilingGroups#clientToken?clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteProfilingGroup(profilingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeProfilingGroup(profilingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeProfilingGroupResponse> {
			return Axios.get<DescribeProfilingGroupResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateProfilingGroup(profilingGroupName: string, requestBody: UpdateProfilingGroupBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateProfilingGroupResponse> {
			return Axios.put<UpdateProfilingGroupResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPolicy(profilingGroupName: string, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return Axios.get<GetPolicyResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListProfilingGroups(includeDescription: boolean, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProfilingGroupsResponse> {
			return Axios.get<ListProfilingGroupsResponse>(this.baseUri + '/profilingGroups?includeDescription=' + includeDescription + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PostAgentProfile(profileToken: string, profilingGroupName: string, requestBody: PostAgentProfileBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		PutPermission(actionGroup: ActionGroup, profilingGroupName: string, requestBody: PutPermissionBody, headersHandler?: () => {[header: string]: string}): Promise<PutPermissionResponse> {
			return Axios.put<PutPermissionResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemovePermission(actionGroup: ActionGroup, profilingGroupName: string, revisionId: string, headersHandler?: () => {[header: string]: string}): Promise<RemovePermissionResponse> {
			return Axios.delete<RemovePermissionResponse>(this.baseUri + '/profilingGroups/' + (profilingGroupName == null ? '' : encodeURIComponent(profilingGroupName)) + '/policy/' + actionGroup + '#revisionId&revisionId=' + (revisionId == null ? '' : encodeURIComponent(revisionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
