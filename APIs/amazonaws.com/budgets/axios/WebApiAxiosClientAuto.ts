...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBudget(requestBody: CreateBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBudgetResponse> {
			return Axios.post<CreateBudgetResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.CreateBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateNotification(requestBody: CreateNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateNotificationResponse> {
			return Axios.post<CreateNotificationResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.CreateNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSubscriber(requestBody: CreateSubscriberRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSubscriberResponse> {
			return Axios.post<CreateSubscriberResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.CreateSubscriber', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteBudget(requestBody: DeleteBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBudgetResponse> {
			return Axios.post<DeleteBudgetResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DeleteBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteNotification(requestBody: DeleteNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNotificationResponse> {
			return Axios.post<DeleteNotificationResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DeleteNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSubscriber(requestBody: DeleteSubscriberRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSubscriberResponse> {
			return Axios.post<DeleteSubscriberResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DeleteSubscriber', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeBudget(requestBody: DescribeBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBudgetResponse> {
			return Axios.post<DescribeBudgetResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeBudgetPerformanceHistory(requestBody: DescribeBudgetPerformanceHistoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBudgetPerformanceHistoryResponse> {
			return Axios.post<DescribeBudgetPerformanceHistoryResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgetPerformanceHistory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeBudgets(requestBody: DescribeBudgetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBudgetsResponse> {
			return Axios.post<DescribeBudgetsResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSubscribersForNotification(requestBody: DescribeSubscribersForNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSubscribersForNotificationResponse> {
			return Axios.post<DescribeSubscribersForNotificationResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeSubscribersForNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateBudget(requestBody: UpdateBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateBudgetResponse> {
			return Axios.post<UpdateBudgetResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.UpdateBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateNotification(requestBody: UpdateNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotificationResponse> {
			return Axios.post<UpdateNotificationResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.UpdateNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateSubscriber(requestBody: UpdateSubscriberRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSubscriberResponse> {
			return Axios.post<UpdateSubscriberResponse>(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.UpdateSubscriber', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
