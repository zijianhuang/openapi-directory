...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateBudget(callback: (data : CreateBudgetResponse) => any, requestBody: CreateBudgetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.CreateBudget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateNotification(callback: (data : CreateNotificationResponse) => any, requestBody: CreateNotificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.CreateNotification', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSubscriber(callback: (data : CreateSubscriberResponse) => any, requestBody: CreateSubscriberRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.CreateSubscriber', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteBudget(callback: (data : DeleteBudgetResponse) => any, requestBody: DeleteBudgetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DeleteBudget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteNotification(callback: (data : DeleteNotificationResponse) => any, requestBody: DeleteNotificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DeleteNotification', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSubscriber(callback: (data : DeleteSubscriberResponse) => any, requestBody: DeleteSubscriberRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DeleteSubscriber', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeBudget(callback: (data : DescribeBudgetResponse) => any, requestBody: DescribeBudgetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeBudgetPerformanceHistory(callback: (data : DescribeBudgetPerformanceHistoryResponse) => any, requestBody: DescribeBudgetPerformanceHistoryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgetPerformanceHistory', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeBudgets(callback: (data : DescribeBudgetsResponse) => any, requestBody: DescribeBudgetsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeNotificationsForBudget(callback: (data : DescribeNotificationsForBudgetResponse) => any, requestBody: DescribeNotificationsForBudgetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeNotificationsForBudget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSubscribersForNotification(callback: (data : DescribeSubscribersForNotificationResponse) => any, requestBody: DescribeSubscribersForNotificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.DescribeSubscribersForNotification', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateBudget(callback: (data : UpdateBudgetResponse) => any, requestBody: UpdateBudgetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.UpdateBudget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateNotification(callback: (data : UpdateNotificationResponse) => any, requestBody: UpdateNotificationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.UpdateNotification', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSubscriber(callback: (data : UpdateSubscriberResponse) => any, requestBody: UpdateSubscriberRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSBudgetServiceGateway.UpdateSubscriber', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
