...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBudget(requestBody: CreateBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBudgetResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.CreateBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateNotification(requestBody: CreateNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateNotificationResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.CreateNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSubscriber(requestBody: CreateSubscriberRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSubscriberResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.CreateSubscriber', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteBudget(requestBody: DeleteBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBudgetResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DeleteBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteNotification(requestBody: DeleteNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNotificationResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DeleteNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSubscriber(requestBody: DeleteSubscriberRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSubscriberResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DeleteSubscriber', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeBudget(requestBody: DescribeBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBudgetResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeBudgetPerformanceHistory(requestBody: DescribeBudgetPerformanceHistoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBudgetPerformanceHistoryResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgetPerformanceHistory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeBudgets(requestBody: DescribeBudgetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBudgetsResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DescribeBudgets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeNotificationsForBudget(requestBody: DescribeNotificationsForBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotificationsForBudgetResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DescribeNotificationsForBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSubscribersForNotification(requestBody: DescribeSubscribersForNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSubscribersForNotificationResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.DescribeSubscribersForNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateBudget(requestBody: UpdateBudgetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateBudgetResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.UpdateBudget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNotification(requestBody: UpdateNotificationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotificationResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.UpdateNotification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSubscriber(requestBody: UpdateSubscriberRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSubscriberResponse> {
			return this.http.post('/#X-Amz-Target=AWSBudgetServiceGateway.UpdateSubscriber', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
