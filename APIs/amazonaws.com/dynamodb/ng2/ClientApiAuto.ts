...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchGetItem(RequestItems: string, requestBody: BatchGetItemInput, headersHandler?: () => HttpHeaders): Observable<BatchGetItemOutput> {
			return this.http.post<BatchGetItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.BatchGetItem?RequestItems=' + (RequestItems == null ? '' : encodeURIComponent(RequestItems)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchWriteItem(requestBody: BatchWriteItemInput, headersHandler?: () => HttpHeaders): Observable<BatchWriteItemOutput> {
			return this.http.post<BatchWriteItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.BatchWriteItem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateBackup(requestBody: CreateBackupInput, headersHandler?: () => HttpHeaders): Observable<CreateBackupOutput> {
			return this.http.post<CreateBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.CreateBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateGlobalTable(requestBody: CreateGlobalTableInput, headersHandler?: () => HttpHeaders): Observable<CreateGlobalTableOutput> {
			return this.http.post<CreateGlobalTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.CreateGlobalTable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTable(requestBody: CreateTableInput, headersHandler?: () => HttpHeaders): Observable<CreateTableOutput> {
			return this.http.post<CreateTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.CreateTable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteBackup(requestBody: DeleteBackupInput, headersHandler?: () => HttpHeaders): Observable<DeleteBackupOutput> {
			return this.http.post<DeleteBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DeleteBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteItem(requestBody: DeleteItemInput, headersHandler?: () => HttpHeaders): Observable<DeleteItemOutput> {
			return this.http.post<DeleteItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DeleteItem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTable(requestBody: DeleteTableInput, headersHandler?: () => HttpHeaders): Observable<DeleteTableOutput> {
			return this.http.post<DeleteTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DeleteTable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeBackup(requestBody: DescribeBackupInput, headersHandler?: () => HttpHeaders): Observable<DescribeBackupOutput> {
			return this.http.post<DescribeBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeContinuousBackups(requestBody: DescribeContinuousBackupsInput, headersHandler?: () => HttpHeaders): Observable<DescribeContinuousBackupsOutput> {
			return this.http.post<DescribeContinuousBackupsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeContinuousBackups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeContributorInsights(requestBody: DescribeContributorInsightsInput, headersHandler?: () => HttpHeaders): Observable<DescribeContributorInsightsOutput> {
			return this.http.post<DescribeContributorInsightsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeContributorInsights', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEndpoints(requestBody: DescribeEndpointsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeEndpointsResponse> {
			return this.http.post<DescribeEndpointsResponse>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeEndpoints', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeGlobalTable(requestBody: DescribeGlobalTableInput, headersHandler?: () => HttpHeaders): Observable<DescribeGlobalTableOutput> {
			return this.http.post<DescribeGlobalTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeGlobalTableSettings(requestBody: DescribeGlobalTableSettingsInput, headersHandler?: () => HttpHeaders): Observable<DescribeGlobalTableSettingsOutput> {
			return this.http.post<DescribeGlobalTableSettingsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTableSettings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLimits(requestBody: DescribeLimitsInput, headersHandler?: () => HttpHeaders): Observable<DescribeLimitsOutput> {
			return this.http.post<DescribeLimitsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeLimits', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTable(requestBody: DescribeTableInput, headersHandler?: () => HttpHeaders): Observable<DescribeTableOutput> {
			return this.http.post<DescribeTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeTable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTableReplicaAutoScaling(requestBody: DescribeTableReplicaAutoScalingInput, headersHandler?: () => HttpHeaders): Observable<DescribeTableReplicaAutoScalingOutput> {
			return this.http.post<DescribeTableReplicaAutoScalingOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeTableReplicaAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTimeToLive(requestBody: DescribeTimeToLiveInput, headersHandler?: () => HttpHeaders): Observable<DescribeTimeToLiveOutput> {
			return this.http.post<DescribeTimeToLiveOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeTimeToLive', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetItem(requestBody: GetItemInput, headersHandler?: () => HttpHeaders): Observable<GetItemOutput> {
			return this.http.post<GetItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.GetItem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListBackups(requestBody: ListBackupsInput, headersHandler?: () => HttpHeaders): Observable<ListBackupsOutput> {
			return this.http.post<ListBackupsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListBackups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListContributorInsights(MaxResults: string, NextToken: string, requestBody: ListContributorInsightsInput, headersHandler?: () => HttpHeaders): Observable<ListContributorInsightsOutput> {
		 ...
		 */
		ListGlobalTables(requestBody: ListGlobalTablesInput, headersHandler?: () => HttpHeaders): Observable<ListGlobalTablesOutput> {
			return this.http.post<ListGlobalTablesOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListGlobalTables', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTables(Limit: string, ExclusiveStartTableName: string, requestBody: ListTablesInput, headersHandler?: () => HttpHeaders): Observable<ListTablesOutput> {
			return this.http.post<ListTablesOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListTables?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartTableName=' + (ExclusiveStartTableName == null ? '' : encodeURIComponent(ExclusiveStartTableName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsOfResource(requestBody: ListTagsOfResourceInput, headersHandler?: () => HttpHeaders): Observable<ListTagsOfResourceOutput> {
			return this.http.post<ListTagsOfResourceOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListTagsOfResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutItem(requestBody: PutItemInput, headersHandler?: () => HttpHeaders): Observable<PutItemOutput> {
			return this.http.post<PutItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.PutItem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Query(Limit: string, ExclusiveStartKey: string, requestBody: QueryInput, headersHandler?: () => HttpHeaders): Observable<QueryOutput> {
			return this.http.post<QueryOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.Query?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartKey=' + (ExclusiveStartKey == null ? '' : encodeURIComponent(ExclusiveStartKey)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RestoreTableFromBackup(requestBody: RestoreTableFromBackupInput, headersHandler?: () => HttpHeaders): Observable<RestoreTableFromBackupOutput> {
			return this.http.post<RestoreTableFromBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.RestoreTableFromBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RestoreTableToPointInTime(requestBody: RestoreTableToPointInTimeInput, headersHandler?: () => HttpHeaders): Observable<RestoreTableToPointInTimeOutput> {
			return this.http.post<RestoreTableToPointInTimeOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.RestoreTableToPointInTime', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Scan(Limit: string, ExclusiveStartKey: string, requestBody: ScanInput, headersHandler?: () => HttpHeaders): Observable<ScanOutput> {
			return this.http.post<ScanOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.Scan?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartKey=' + (ExclusiveStartKey == null ? '' : encodeURIComponent(ExclusiveStartKey)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		TransactGetItems(requestBody: TransactGetItemsInput, headersHandler?: () => HttpHeaders): Observable<TransactGetItemsOutput> {
			return this.http.post<TransactGetItemsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.TransactGetItems', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TransactWriteItems(requestBody: TransactWriteItemsInput, headersHandler?: () => HttpHeaders): Observable<TransactWriteItemsOutput> {
			return this.http.post<TransactWriteItemsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.TransactWriteItems', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateContinuousBackups(requestBody: UpdateContinuousBackupsInput, headersHandler?: () => HttpHeaders): Observable<UpdateContinuousBackupsOutput> {
			return this.http.post<UpdateContinuousBackupsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateContinuousBackups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateContributorInsights(requestBody: UpdateContributorInsightsInput, headersHandler?: () => HttpHeaders): Observable<UpdateContributorInsightsOutput> {
			return this.http.post<UpdateContributorInsightsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateContributorInsights', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateGlobalTable(requestBody: UpdateGlobalTableInput, headersHandler?: () => HttpHeaders): Observable<UpdateGlobalTableOutput> {
			return this.http.post<UpdateGlobalTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateGlobalTable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateGlobalTableSettings(requestBody: UpdateGlobalTableSettingsInput, headersHandler?: () => HttpHeaders): Observable<UpdateGlobalTableSettingsOutput> {
			return this.http.post<UpdateGlobalTableSettingsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateGlobalTableSettings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateItem(requestBody: UpdateItemInput, headersHandler?: () => HttpHeaders): Observable<UpdateItemOutput> {
			return this.http.post<UpdateItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateItem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTable(requestBody: UpdateTableInput, headersHandler?: () => HttpHeaders): Observable<UpdateTableOutput> {
			return this.http.post<UpdateTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateTable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTableReplicaAutoScaling(requestBody: UpdateTableReplicaAutoScalingInput, headersHandler?: () => HttpHeaders): Observable<UpdateTableReplicaAutoScalingOutput> {
			return this.http.post<UpdateTableReplicaAutoScalingOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateTableReplicaAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTimeToLive(requestBody: UpdateTimeToLiveInput, headersHandler?: () => HttpHeaders): Observable<UpdateTimeToLiveOutput> {
			return this.http.post<UpdateTimeToLiveOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateTimeToLive', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
