...
export namespace My_Demo_Client {
	...
	export interface BatchWriteItemInput {
		...
		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: BatchWriteItemInputReturnConsumedCapacity;
		ReturnItemCollectionMetrics?: BatchWriteItemInputReturnItemCollectionMetrics;
	}

	export enum BatchWriteItemInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }
	...
	export interface CreateTableInput {
		...
		BillingMode?: CreateTableInputBillingMode;
	...
	export enum CreateTableInputBillingMode { PROVISIONED = 0, PAY_PER_REQUEST = 1 }
	...
	export interface DeleteItemInput {
		...
		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: DeleteItemInputReturnConsumedCapacity;
		ReturnItemCollectionMetrics?: DeleteItemInputReturnItemCollectionMetrics;
	...
	export enum DeleteItemInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }

	export enum DeleteItemInputReturnItemCollectionMetrics { SIZE = 0, NONE = 1 }
	...
	export interface DescribeContributorInsightsOutput {
		TableName?: string;
		IndexName?: string;
		ContributorInsightsRuleList?: Array<ContributorInsightsRule>;
	...
	export interface GetItemInput {
		TableName: string;
		Key: Key;
		AttributesToGet?: Array<AttributeName>;
		ConsistentRead?: boolean;

		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: GetItemInputReturnConsumedCapacity;
		ProjectionExpression?: string;
		ExpressionAttributeNames?: ExpressionAttributeNameMap;
	}

	export enum GetItemInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }
	...
	export interface PutItemInput {
		...
		Expected?: ExpectedAttributeMap;
		ReturnValues?: PutItemInputReturnValues;

		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: PutItemInputReturnConsumedCapacity;
		ReturnItemCollectionMetrics?: PutItemInputReturnItemCollectionMetrics;
		ConditionalOperator?: PutItemInputConditionalOperator;
		ConditionExpression?: string;
		ExpressionAttributeNames?: ExpressionAttributeNameMap;
		ExpressionAttributeValues?: ExpressionAttributeValueMap;
	}

	export enum PutItemInputReturnValues { NONE = 0, ALL_OLD = 1, UPDATED_OLD = 2, ALL_NEW = 3, UPDATED_NEW = 4 }

	export enum PutItemInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }

	export enum PutItemInputReturnItemCollectionMetrics { SIZE = 0, NONE = 1 }

	export enum PutItemInputConditionalOperator { AND = 0, OR = 1 }
	...
	export interface QueryInput {
		...
		ConditionalOperator?: QueryInputConditionalOperator;
		ScanIndexForward?: boolean;
		ExclusiveStartKey?: Key;

		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: QueryInputReturnConsumedCapacity;
		ProjectionExpression?: string;
	...
	export enum QueryInputConditionalOperator { AND = 0, OR = 1 }

	export enum QueryInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }
	...
	export interface RestoreTableFromBackupInput {
		...
		BackupArn: string;
		BillingModeOverride?: RestoreTableFromBackupInputBillingModeOverride;
	...
	export enum RestoreTableFromBackupInputBillingModeOverride { PROVISIONED = 0, PAY_PER_REQUEST = 1 }
	...
	export interface RestoreTableToPointInTimeInput {
		...
		BillingModeOverride?: RestoreTableToPointInTimeInputBillingModeOverride;
		GlobalSecondaryIndexOverride?: Array<GlobalSecondaryIndex>;
		LocalSecondaryIndexOverride?: Array<LocalSecondaryIndex>;
	...
	export enum RestoreTableToPointInTimeInputBillingModeOverride { PROVISIONED = 0, PAY_PER_REQUEST = 1 }
	...
	export interface ScanInput {
		...
		AttributesToGet?: Array<AttributeName>;
		Limit?: number;
		Select?: ScanInputSelect;
		ScanFilter?: FilterConditionMap;
		ConditionalOperator?: ScanInputConditionalOperator;
		ExclusiveStartKey?: Key;

		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: ScanInputReturnConsumedCapacity;
	...
	export enum ScanInputSelect { ALL_ATTRIBUTES = 0, ALL_PROJECTED_ATTRIBUTES = 1, SPECIFIC_ATTRIBUTES = 2, COUNT = 3 }

	export enum ScanInputConditionalOperator { AND = 0, OR = 1 }

	export enum ScanInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }
	...
	export interface TransactGetItemsInput {
		...
		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: TransactGetItemsInputReturnConsumedCapacity;
	}

	export enum TransactGetItemsInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }
	...
	export interface TransactWriteItemsInput {
		...
		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: TransactWriteItemsInputReturnConsumedCapacity;
		ReturnItemCollectionMetrics?: TransactWriteItemsInputReturnItemCollectionMetrics;
		ClientRequestToken?: string;
	}

	export enum TransactWriteItemsInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }

	export enum TransactWriteItemsInputReturnItemCollectionMetrics { SIZE = 0, NONE = 1 }

	export interface UntagResourceInput {
		ResourceArn: string;
		TagKeys: Array<TagKeyString>;
	}
	...
	export interface UpdateContributorInsightsOutput {
		TableName?: string;
		IndexName?: string;
		ContributorInsightsStatus?: UpdateContributorInsightsOutputContributorInsightsStatus;
	}

	export enum UpdateContributorInsightsOutputContributorInsightsStatus { ENABLING = 0, ENABLED = 1, DISABLING = 2, DISABLED = 3, FAILED = 4 }
	...
	export interface UpdateGlobalTableSettingsInput {
		GlobalTableName: string;
		GlobalTableBillingMode?: UpdateGlobalTableSettingsInputGlobalTableBillingMode;
	...
	export enum UpdateGlobalTableSettingsInputGlobalTableBillingMode { PROVISIONED = 0, PAY_PER_REQUEST = 1 }
	...
	export interface UpdateItemInput {
		...
		Expected?: ExpectedAttributeMap;
		ConditionalOperator?: UpdateItemInputConditionalOperator;
		ReturnValues?: UpdateItemInputReturnValues;

		/**<p>Determines the level of detail about provisioned throughput consumption that is returned in the response:</p> <ul> <li> <p> <code>INDEXES</code> - The response includes the aggregate <code>ConsumedCapacity</code> for the operation, together with <code>ConsumedCapacity</code> for each table and secondary index that was accessed.</p> <p>Note that some operations, such as <code>GetItem</code> and <code>BatchGetItem</code>, do not access any indexes at all. In these cases, specifying <code>INDEXES</code> will only return <code>ConsumedCapacity</code> information for table(s).</p> </li> <li> <p> <code>TOTAL</code> - The response includes only the aggregate <code>ConsumedCapacity</code> for the operation.</p> </li> <li> <p> <code>NONE</code> - No <code>ConsumedCapacity</code> details are included in the response.</p> </li> </ul> */
		ReturnConsumedCapacity?: UpdateItemInputReturnConsumedCapacity;
		ReturnItemCollectionMetrics?: UpdateItemInputReturnItemCollectionMetrics;
	...
	export enum UpdateItemInputConditionalOperator { AND = 0, OR = 1 }

	export enum UpdateItemInputReturnValues { NONE = 0, ALL_OLD = 1, UPDATED_OLD = 2, ALL_NEW = 3, UPDATED_NEW = 4 }

	export enum UpdateItemInputReturnConsumedCapacity { INDEXES = 0, TOTAL = 1, NONE = 2 }

	export enum UpdateItemInputReturnItemCollectionMetrics { SIZE = 0, NONE = 1 }
	...
	export interface UpdateTableInput {
		AttributeDefinitions?: Array<AttributeDefinition>;
		TableName: string;
		BillingMode?: UpdateTableInputBillingMode;
	...
	export enum UpdateTableInputBillingMode { PROVISIONED = 0, PAY_PER_REQUEST = 1 }
	...
	export interface AttributeValue {
		...
		N?: string;
		B?: string;
		SS?: Array<StringAttributeValue>;
		NS?: Array<NumberAttributeValue>;
		BS?: Array<BinaryAttributeValue>;
		M?: MapAttributeValue;
	...
	export interface AttributeValueUpdate {
		...
		Action?: AttributeValueUpdateAction;
	}

	export enum AttributeValueUpdateAction { ADD = 0, PUT = 1, DELETE = 2 }
	...
	export interface SourceTableDetails {
		...
		ProvisionedThroughput: ProvisionedThroughput;
		ItemCount?: number;
		BillingMode?: SourceTableDetailsBillingMode;
	}

	export enum SourceTableDetailsBillingMode { PROVISIONED = 0, PAY_PER_REQUEST = 1 }
	...
	export interface BackupSummary {
		...
		BackupCreationDateTime?: Date;
		BackupExpiryDateTime?: Date;
		BackupStatus?: BackupSummaryBackupStatus;
		BackupType?: BackupSummaryBackupType;
		BackupSizeBytes?: number;
	}

	export enum BackupSummaryBackupStatus { CREATING = 0, DELETED = 1, AVAILABLE = 2 }

	export enum BackupSummaryBackupType { USER = 0, SYSTEM = 1, AWS_BACKUP = 2 }
	...
	export interface PointInTimeRecoveryDescription {
		PointInTimeRecoveryStatus?: PointInTimeRecoveryDescriptionPointInTimeRecoveryStatus;
		EarliestRestorableDateTime?: Date;
		LatestRestorableDateTime?: Date;
	}

	export enum PointInTimeRecoveryDescriptionPointInTimeRecoveryStatus { ENABLED = 0, DISABLED = 1 }
	...
	export interface ContributorInsightsSummary {
		TableName?: string;
		IndexName?: string;
		ContributorInsightsStatus?: ContributorInsightsSummaryContributorInsightsStatus;
	}

	export enum ContributorInsightsSummaryContributorInsightsStatus { ENABLING = 0, ENABLED = 1, DISABLING = 2, DISABLED = 3, FAILED = 4 }


	/**Represents attributes that are copied (projected) from the table into an index. These are in addition to the primary key attributes and index key attributes, which are automatically projected. */
	export interface Projection {
		ProjectionType?: ProjectionProjectionType;
		NonKeyAttributes?: Array<NonKeyAttributeName>;
	}
	...
	export interface SSESpecification {
		Enabled?: boolean;
		SSEType?: SSESpecificationSSEType;
		KMSMasterKeyId?: string;
	}

	export enum SSESpecificationSSEType { AES256 = 0, KMS = 1 }
	...
	export interface Delete {
		...
		ExpressionAttributeNames?: ExpressionAttributeNameMap;
		ExpressionAttributeValues?: ExpressionAttributeValueMap;
		ReturnValuesOnConditionCheckFailure?: DeleteReturnValuesOnConditionCheckFailure;
	}

	export enum DeleteReturnValuesOnConditionCheckFailure { ALL_OLD = 0, NONE = 1 }
	...
	export interface ItemCollectionMetrics {
		...
		SizeEstimateRangeGB?: Array<ItemCollectionSizeEstimateBound>;
	}
	...
	export interface TableAutoScalingDescription {
		TableName?: string;
		TableStatus?: TableAutoScalingDescriptionTableStatus;
		Replicas?: Array<ReplicaAutoScalingDescription>;
	}

	export enum TableAutoScalingDescriptionTableStatus { CREATING = 0, UPDATING = 1, DELETING = 2, ACTIVE = 3, INACCESSIBLE_ENCRYPTION_CREDENTIALS = 4, ARCHIVING = 5, ARCHIVED = 6 }
	...
	export interface ExpectedAttributeValue {
		...
		Value?: AttributeValue;
		Exists?: boolean;
		ComparisonOperator?: ExpectedAttributeValueComparisonOperator;
		AttributeValueList?: Array<AttributeValue>;
	}

	export enum ExpectedAttributeValueComparisonOperator { EQ = 0, NE = 1, IN = 2, LE = 3, LT = 4, GE = 5, GT = 6, BETWEEN = 7, NOT_NULL = 8, NULL = 9, CONTAINS = 10, NOT_CONTAINS = 11, BEGINS_WITH = 12 }
	...
	export interface Put {
		...
		ExpressionAttributeNames?: ExpressionAttributeNameMap;
		ExpressionAttributeValues?: ExpressionAttributeValueMap;
		ReturnValuesOnConditionCheckFailure?: PutReturnValuesOnConditionCheckFailure;
	}

	export enum PutReturnValuesOnConditionCheckFailure { ALL_OLD = 0, NONE = 1 }
	...
	export interface ReplicaAutoScalingDescription {
		...
		ReplicaStatus?: ReplicaAutoScalingDescriptionReplicaStatus;
	}

	export enum ReplicaAutoScalingDescriptionReplicaStatus { CREATING = 0, CREATION_FAILED = 1, UPDATING = 2, DELETING = 3, ACTIVE = 4 }
	...
	export interface ReplicaGlobalSecondaryIndexAutoScalingDescription {
		IndexName?: string;
		IndexStatus?: ReplicaGlobalSecondaryIndexAutoScalingDescriptionIndexStatus;
	...
	export enum ReplicaGlobalSecondaryIndexAutoScalingDescriptionIndexStatus { CREATING = 0, UPDATING = 1, DELETING = 2, ACTIVE = 3 }
	...
	export interface ReplicaGlobalSecondaryIndexSettingsDescription {
		IndexName: string;
		IndexStatus?: ReplicaGlobalSecondaryIndexSettingsDescriptionIndexStatus;
	...
	export enum ReplicaGlobalSecondaryIndexSettingsDescriptionIndexStatus { CREATING = 0, UPDATING = 1, DELETING = 2, ACTIVE = 3 }
	...
	export interface ReplicaSettingsDescription {
		RegionName: string;
		ReplicaStatus?: ReplicaSettingsDescriptionReplicaStatus;
	...
	export enum ReplicaSettingsDescriptionReplicaStatus { CREATING = 0, CREATION_FAILED = 1, UPDATING = 2, DELETING = 3, ACTIVE = 4 }
	...
	export interface Update {
		...
		ExpressionAttributeNames?: ExpressionAttributeNameMap;
		ExpressionAttributeValues?: ExpressionAttributeValueMap;
		ReturnValuesOnConditionCheckFailure?: UpdateReturnValuesOnConditionCheckFailure;
	}

	export enum UpdateReturnValuesOnConditionCheckFailure { ALL_OLD = 0, NONE = 1 }
	...
	export class DemoClient {
		 ...
		 */
		BatchGetItem(RequestItems: string, requestBody: BatchGetItemInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetItemOutput> {
			return Axios.post<BatchGetItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.BatchGetItem?RequestItems=' + (RequestItems == null ? '' : encodeURIComponent(RequestItems)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		BatchWriteItem(requestBody: BatchWriteItemInput, headersHandler?: () => {[header: string]: string}): Promise<BatchWriteItemOutput> {
			return Axios.post<BatchWriteItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.BatchWriteItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateBackup(requestBody: CreateBackupInput, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupOutput> {
			return Axios.post<CreateBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.CreateBackup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateGlobalTable(requestBody: CreateGlobalTableInput, headersHandler?: () => {[header: string]: string}): Promise<CreateGlobalTableOutput> {
			return Axios.post<CreateGlobalTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.CreateGlobalTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateTable(requestBody: CreateTableInput, headersHandler?: () => {[header: string]: string}): Promise<CreateTableOutput> {
			return Axios.post<CreateTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.CreateTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteBackup(requestBody: DeleteBackupInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackupOutput> {
			return Axios.post<DeleteBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DeleteBackup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteItem(requestBody: DeleteItemInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteItemOutput> {
			return Axios.post<DeleteItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DeleteItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteTable(requestBody: DeleteTableInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTableOutput> {
			return Axios.post<DeleteTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DeleteTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeBackup(requestBody: DescribeBackupInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupOutput> {
			return Axios.post<DescribeBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeBackup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeContinuousBackups(requestBody: DescribeContinuousBackupsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeContinuousBackupsOutput> {
			return Axios.post<DescribeContinuousBackupsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeContinuousBackups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeContributorInsights(requestBody: DescribeContributorInsightsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeContributorInsightsOutput> {
			return Axios.post<DescribeContributorInsightsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeContributorInsights', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEndpoints(requestBody: DescribeEndpointsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointsResponse> {
			return Axios.post<DescribeEndpointsResponse>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeEndpoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGlobalTable(requestBody: DescribeGlobalTableInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGlobalTableOutput> {
			return Axios.post<DescribeGlobalTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeGlobalTableSettings(requestBody: DescribeGlobalTableSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGlobalTableSettingsOutput> {
			return Axios.post<DescribeGlobalTableSettingsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeGlobalTableSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeLimits(requestBody: DescribeLimitsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeLimitsOutput> {
			return Axios.post<DescribeLimitsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeLimits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeTable(requestBody: DescribeTableInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTableOutput> {
			return Axios.post<DescribeTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeTableReplicaAutoScaling(requestBody: DescribeTableReplicaAutoScalingInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTableReplicaAutoScalingOutput> {
			return Axios.post<DescribeTableReplicaAutoScalingOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeTableReplicaAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeTimeToLive(requestBody: DescribeTimeToLiveInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTimeToLiveOutput> {
			return Axios.post<DescribeTimeToLiveOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.DescribeTimeToLive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetItem(requestBody: GetItemInput, headersHandler?: () => {[header: string]: string}): Promise<GetItemOutput> {
			return Axios.post<GetItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.GetItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListBackups(requestBody: ListBackupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListBackupsOutput> {
			return Axios.post<ListBackupsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListBackups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListContributorInsights(MaxResults: string, NextToken: string, requestBody: ListContributorInsightsInput, headersHandler?: () => {[header: string]: string}): Promise<ListContributorInsightsOutput> {
			return Axios.post<ListContributorInsightsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListContributorInsights?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListGlobalTables(requestBody: ListGlobalTablesInput, headersHandler?: () => {[header: string]: string}): Promise<ListGlobalTablesOutput> {
			return Axios.post<ListGlobalTablesOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListGlobalTables', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTables(Limit: string, ExclusiveStartTableName: string, requestBody: ListTablesInput, headersHandler?: () => {[header: string]: string}): Promise<ListTablesOutput> {
			return Axios.post<ListTablesOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListTables?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartTableName=' + (ExclusiveStartTableName == null ? '' : encodeURIComponent(ExclusiveStartTableName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTagsOfResource(requestBody: ListTagsOfResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsOfResourceOutput> {
			return Axios.post<ListTagsOfResourceOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.ListTagsOfResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutItem(requestBody: PutItemInput, headersHandler?: () => {[header: string]: string}): Promise<PutItemOutput> {
			return Axios.post<PutItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.PutItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Query(Limit: string, ExclusiveStartKey: string, requestBody: QueryInput, headersHandler?: () => {[header: string]: string}): Promise<QueryOutput> {
			return Axios.post<QueryOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.Query?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartKey=' + (ExclusiveStartKey == null ? '' : encodeURIComponent(ExclusiveStartKey)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RestoreTableFromBackup(requestBody: RestoreTableFromBackupInput, headersHandler?: () => {[header: string]: string}): Promise<RestoreTableFromBackupOutput> {
			return Axios.post<RestoreTableFromBackupOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.RestoreTableFromBackup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RestoreTableToPointInTime(requestBody: RestoreTableToPointInTimeInput, headersHandler?: () => {[header: string]: string}): Promise<RestoreTableToPointInTimeOutput> {
			return Axios.post<RestoreTableToPointInTimeOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.RestoreTableToPointInTime', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Scan(Limit: string, ExclusiveStartKey: string, requestBody: ScanInput, headersHandler?: () => {[header: string]: string}): Promise<ScanOutput> {
			return Axios.post<ScanOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.Scan?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartKey=' + (ExclusiveStartKey == null ? '' : encodeURIComponent(ExclusiveStartKey)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		TransactGetItems(requestBody: TransactGetItemsInput, headersHandler?: () => {[header: string]: string}): Promise<TransactGetItemsOutput> {
			return Axios.post<TransactGetItemsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.TransactGetItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		TransactWriteItems(requestBody: TransactWriteItemsInput, headersHandler?: () => {[header: string]: string}): Promise<TransactWriteItemsOutput> {
			return Axios.post<TransactWriteItemsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.TransactWriteItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		UpdateContinuousBackups(requestBody: UpdateContinuousBackupsInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateContinuousBackupsOutput> {
			return Axios.post<UpdateContinuousBackupsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateContinuousBackups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateContributorInsights(requestBody: UpdateContributorInsightsInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateContributorInsightsOutput> {
			return Axios.post<UpdateContributorInsightsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateContributorInsights', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateGlobalTable(requestBody: UpdateGlobalTableInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGlobalTableOutput> {
			return Axios.post<UpdateGlobalTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateGlobalTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateGlobalTableSettings(requestBody: UpdateGlobalTableSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGlobalTableSettingsOutput> {
			return Axios.post<UpdateGlobalTableSettingsOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateGlobalTableSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateItem(requestBody: UpdateItemInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateItemOutput> {
			return Axios.post<UpdateItemOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateTable(requestBody: UpdateTableInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateTableOutput> {
			return Axios.post<UpdateTableOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateTable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateTableReplicaAutoScaling(requestBody: UpdateTableReplicaAutoScalingInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateTableReplicaAutoScalingOutput> {
			return Axios.post<UpdateTableReplicaAutoScalingOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateTableReplicaAutoScaling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateTimeToLive(requestBody: UpdateTimeToLiveInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateTimeToLiveOutput> {
			return Axios.post<UpdateTimeToLiveOutput>(this.baseUri + '/#X-Amz-Target=DynamoDB_20120810.UpdateTimeToLive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
