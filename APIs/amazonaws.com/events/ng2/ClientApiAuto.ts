...
export namespace My_Demo_Client {
	...
	export enum PutRuleRequestState { ENABLED = 0, DISABLED = 1 }
	...
	export interface PartnerEventSourceAccount {
		...
		CreationTime?: Date;
		ExpirationTime?: Date;
		State?: PartnerEventSourceAccountState;
	}

	export enum PartnerEventSourceAccountState { PENDING = 0, ACTIVE = 1, DELETED = 2 }
	...
	export interface RunCommandTarget {
		Key: string;
		Values: Array<RunCommandTargetValue>;
	}
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		ActivateEventSource(requestBody: ActivateEventSourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ActivateEventSource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		CreateEventBus(requestBody: CreateEventBusRequest, headersHandler?: () => HttpHeaders): Observable<CreateEventBusResponse> {
			return this.http.post<CreateEventBusResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.CreateEventBus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreatePartnerEventSource(requestBody: CreatePartnerEventSourceRequest, headersHandler?: () => HttpHeaders): Observable<CreatePartnerEventSourceResponse> {
			return this.http.post<CreatePartnerEventSourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.CreatePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeactivateEventSource(requestBody: DeactivateEventSourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeactivateEventSource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEventBus(requestBody: DeleteEventBusRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteEventBus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePartnerEventSource(requestBody: DeletePartnerEventSourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeletePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRule(requestBody: DeleteRuleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeEventBus(requestBody: DescribeEventBusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeEventBusResponse> {
			return this.http.post<DescribeEventBusResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventBus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEventSource(requestBody: DescribeEventSourceRequest, headersHandler?: () => HttpHeaders): Observable<DescribeEventSourceResponse> {
			return this.http.post<DescribeEventSourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventSource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribePartnerEventSource(requestBody: DescribePartnerEventSourceRequest, headersHandler?: () => HttpHeaders): Observable<DescribePartnerEventSourceResponse> {
			return this.http.post<DescribePartnerEventSourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRule(requestBody: DescribeRuleRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRuleResponse> {
			return this.http.post<DescribeRuleResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DisableRule(requestBody: DisableRuleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DisableRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		EnableRule(requestBody: EnableRuleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.EnableRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListEventBuses(requestBody: ListEventBusesRequest, headersHandler?: () => HttpHeaders): Observable<ListEventBusesResponse> {
			return this.http.post<ListEventBusesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventBuses', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListEventSources(requestBody: ListEventSourcesRequest, headersHandler?: () => HttpHeaders): Observable<ListEventSourcesResponse> {
			return this.http.post<ListEventSourcesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventSources', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPartnerEventSourceAccounts(requestBody: ListPartnerEventSourceAccountsRequest, headersHandler?: () => HttpHeaders): Observable<ListPartnerEventSourceAccountsResponse> {
			return this.http.post<ListPartnerEventSourceAccountsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSourceAccounts', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPartnerEventSources(requestBody: ListPartnerEventSourcesRequest, headersHandler?: () => HttpHeaders): Observable<ListPartnerEventSourcesResponse> {
			return this.http.post<ListPartnerEventSourcesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSources', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListRuleNamesByTarget(requestBody: ListRuleNamesByTargetRequest, headersHandler?: () => HttpHeaders): Observable<ListRuleNamesByTargetResponse> {
			return this.http.post<ListRuleNamesByTargetResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRuleNamesByTarget', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListRules(requestBody: ListRulesRequest, headersHandler?: () => HttpHeaders): Observable<ListRulesResponse> {
			return this.http.post<ListRulesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRules', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTargetsByRule(requestBody: ListTargetsByRuleRequest, headersHandler?: () => HttpHeaders): Observable<ListTargetsByRuleResponse> {
			return this.http.post<ListTargetsByRuleResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTargetsByRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutEvents(requestBody: PutEventsRequest, headersHandler?: () => HttpHeaders): Observable<PutEventsResponse> {
			return this.http.post<PutEventsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutEvents', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutPartnerEvents(requestBody: PutPartnerEventsRequest, headersHandler?: () => HttpHeaders): Observable<PutPartnerEventsResponse> {
			return this.http.post<PutPartnerEventsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPartnerEvents', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		PutPermission(requestBody: PutPermissionRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPermission', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutRule(requestBody: PutRuleRequest, headersHandler?: () => HttpHeaders): Observable<PutRuleResponse> {
			return this.http.post<PutRuleResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutTargets(requestBody: PutTargetsRequest, headersHandler?: () => HttpHeaders): Observable<PutTargetsResponse> {
			return this.http.post<PutTargetsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutTargets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		RemovePermission(requestBody: RemovePermissionRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSEvents.RemovePermission', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		RemoveTargets(requestBody: RemoveTargetsRequest, headersHandler?: () => HttpHeaders): Observable<RemoveTargetsResponse> {
			return this.http.post<RemoveTargetsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.RemoveTargets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TestEventPattern(requestBody: TestEventPatternRequest, headersHandler?: () => HttpHeaders): Observable<TestEventPatternResponse> {
			return this.http.post<TestEventPatternResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.TestEventPattern', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
