...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		ActivateEventSource(requestBody: ActivateEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ActivateEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		CreateEventBus(requestBody: CreateEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEventBusResponse> {
			return Axios.post<CreateEventBusResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.CreateEventBus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreatePartnerEventSource(requestBody: CreatePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePartnerEventSourceResponse> {
			return Axios.post<CreatePartnerEventSourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.CreatePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeactivateEventSource(requestBody: DeactivateEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeactivateEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEventBus(requestBody: DeleteEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteEventBus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePartnerEventSource(requestBody: DeletePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeletePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRule(requestBody: DeleteRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeEventBus(requestBody: DescribeEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventBusResponse> {
			return Axios.post<DescribeEventBusResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventBus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEventSource(requestBody: DescribeEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventSourceResponse> {
			return Axios.post<DescribeEventSourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribePartnerEventSource(requestBody: DescribePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePartnerEventSourceResponse> {
			return Axios.post<DescribePartnerEventSourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeRule(requestBody: DescribeRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRuleResponse> {
			return Axios.post<DescribeRuleResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DisableRule(requestBody: DisableRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DisableRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		EnableRule(requestBody: EnableRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.EnableRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ListEventBuses(requestBody: ListEventBusesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventBusesResponse> {
			return Axios.post<ListEventBusesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventBuses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListEventSources(requestBody: ListEventSourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventSourcesResponse> {
			return Axios.post<ListEventSourcesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventSources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListPartnerEventSourceAccounts(requestBody: ListPartnerEventSourceAccountsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPartnerEventSourceAccountsResponse> {
			return Axios.post<ListPartnerEventSourceAccountsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSourceAccounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListPartnerEventSources(requestBody: ListPartnerEventSourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPartnerEventSourcesResponse> {
			return Axios.post<ListPartnerEventSourcesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListRuleNamesByTarget(requestBody: ListRuleNamesByTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRuleNamesByTargetResponse> {
			return Axios.post<ListRuleNamesByTargetResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRuleNamesByTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRules(requestBody: ListRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRulesResponse> {
			return Axios.post<ListRulesResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTargetsByRule(requestBody: ListTargetsByRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsByRuleResponse> {
			return Axios.post<ListTargetsByRuleResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTargetsByRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutEvents(requestBody: PutEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutEventsResponse> {
			return Axios.post<PutEventsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutPartnerEvents(requestBody: PutPartnerEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutPartnerEventsResponse> {
			return Axios.post<PutPartnerEventsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPartnerEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		PutPermission(requestBody: PutPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		PutRule(requestBody: PutRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRuleResponse> {
			return Axios.post<PutRuleResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutTargets(requestBody: PutTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutTargetsResponse> {
			return Axios.post<PutTargetsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.PutTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RemovePermission(requestBody: RemovePermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSEvents.RemovePermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		RemoveTargets(requestBody: RemoveTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTargetsResponse> {
			return Axios.post<RemoveTargetsResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.RemoveTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		TestEventPattern(requestBody: TestEventPatternRequest, headersHandler?: () => {[header: string]: string}): Promise<TestEventPatternResponse> {
			return Axios.post<TestEventPatternResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.TestEventPattern', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSEvents.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
