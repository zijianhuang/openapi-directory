...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptInboundCrossClusterSearchConnection(ConnectionId: string, callback: (data : AcceptInboundCrossClusterSearchConnectionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-01-01/es/ccs/inboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)) + '/accept', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		AddTags(callback: (data : void) => any, requestBody: AddTagsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/tags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociatePackage(PackageID: string, DomainName: string, callback: (data : AssociatePackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/packages/associate/' + (PackageID == null ? '' : encodeURIComponent(PackageID)) + '/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelElasticsearchServiceSoftwareUpdate(callback: (data : CancelElasticsearchServiceSoftwareUpdateResponse) => any, requestBody: CancelElasticsearchServiceSoftwareUpdateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/serviceSoftwareUpdate/cancel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateElasticsearchDomain(callback: (data : CreateElasticsearchDomainResponse) => any, requestBody: CreateElasticsearchDomainBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/domain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateOutboundCrossClusterSearchConnection(callback: (data : CreateOutboundCrossClusterSearchConnectionResponse) => any, requestBody: CreateOutboundCrossClusterSearchConnectionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/ccs/outboundConnection', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreatePackage(callback: (data : CreatePackageResponse) => any, requestBody: CreatePackageBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/packages', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteElasticsearchDomain(DomainName: string, callback: (data : DeleteElasticsearchDomainResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeElasticsearchDomain(DomainName: string, callback: (data : DescribeElasticsearchDomainResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteElasticsearchServiceRole(callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-01-01/es/role', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteInboundCrossClusterSearchConnection(ConnectionId: string, callback: (data : DeleteInboundCrossClusterSearchConnectionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-01-01/es/ccs/inboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteOutboundCrossClusterSearchConnection(ConnectionId: string, callback: (data : DeleteOutboundCrossClusterSearchConnectionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-01-01/es/ccs/outboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeletePackage(PackageID: string, callback: (data : DeletePackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-01-01/packages/' + (PackageID == null ? '' : encodeURIComponent(PackageID)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeElasticsearchDomainConfig(DomainName: string, callback: (data : DescribeElasticsearchDomainConfigResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/config', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateElasticsearchDomainConfig(DomainName: string, callback: (data : UpdateElasticsearchDomainConfigResponse) => any, requestBody: UpdateElasticsearchDomainConfigBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/config', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeElasticsearchDomains(callback: (data : DescribeElasticsearchDomainsResponse) => any, requestBody: DescribeElasticsearchDomainsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/domain-info', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeElasticsearchInstanceTypeLimits(domainName: string, InstanceType: ESPartitionInstanceType, ElasticsearchVersion: string, callback: (data : DescribeElasticsearchInstanceTypeLimitsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/instanceTypeLimits/' + (ElasticsearchVersion == null ? '' : encodeURIComponent(ElasticsearchVersion)) + '/' + InstanceType + '?domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeInboundCrossClusterSearchConnections(MaxResults: string, NextToken: string, callback: (data : DescribeInboundCrossClusterSearchConnectionsResponse) => any, requestBody: DescribeInboundCrossClusterSearchConnectionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/ccs/inboundConnection/search?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeOutboundCrossClusterSearchConnections(MaxResults: string, NextToken: string, callback: (data : DescribeOutboundCrossClusterSearchConnectionsResponse) => any, requestBody: DescribeOutboundCrossClusterSearchConnectionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/ccs/outboundConnection/search?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribePackages(MaxResults: string, NextToken: string, callback: (data : DescribePackagesResponse) => any, requestBody: DescribePackagesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/packages/describe?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeReservedElasticsearchInstanceOfferings(offeringId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : DescribeReservedElasticsearchInstanceOfferingsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/reservedInstanceOfferings?offeringId=' + (offeringId == null ? '' : encodeURIComponent(offeringId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeReservedElasticsearchInstances(reservationId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : DescribeReservedElasticsearchInstancesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/reservedInstances?reservationId=' + (reservationId == null ? '' : encodeURIComponent(reservationId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DissociatePackage(PackageID: string, DomainName: string, callback: (data : DissociatePackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/packages/dissociate/' + (PackageID == null ? '' : encodeURIComponent(PackageID)) + '/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCompatibleElasticsearchVersions(domainName: string, callback: (data : GetCompatibleElasticsearchVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/compatibleVersions?domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetUpgradeHistory(DomainName: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : GetUpgradeHistoryResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/upgradeDomain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/history&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetUpgradeStatus(DomainName: string, callback: (data : GetUpgradeStatusResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/upgradeDomain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/status', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListDomainNames(callback: (data : ListDomainNamesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/domain', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListDomainsForPackage(PackageID: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListDomainsForPackageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/packages/' + (PackageID == null ? '' : encodeURIComponent(PackageID)) + '/domains&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListElasticsearchInstanceTypes(ElasticsearchVersion: string, domainName: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListElasticsearchInstanceTypesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/instanceTypes/' + (ElasticsearchVersion == null ? '' : encodeURIComponent(ElasticsearchVersion)) + '&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListElasticsearchVersions(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListElasticsearchVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/es/versions?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListPackagesForDomain(DomainName: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListPackagesForDomainResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/packages&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		ListTags(arn: string, callback: (data : ListTagsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-01-01/tags/#arn?arn=' + (arn == null ? '' : encodeURIComponent(arn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PurchaseReservedElasticsearchInstanceOffering(callback: (data : PurchaseReservedElasticsearchInstanceOfferingResponse) => any, requestBody: PurchaseReservedElasticsearchInstanceOfferingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/purchaseReservedInstanceOffering', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RejectInboundCrossClusterSearchConnection(ConnectionId: string, callback: (data : RejectInboundCrossClusterSearchConnectionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-01-01/es/ccs/inboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)) + '/reject', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTags(callback: (data : void) => any, requestBody: RemoveTagsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/tags-removal', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartElasticsearchServiceSoftwareUpdate(callback: (data : StartElasticsearchServiceSoftwareUpdateResponse) => any, requestBody: StartElasticsearchServiceSoftwareUpdateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/serviceSoftwareUpdate/start', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpgradeElasticsearchDomain(callback: (data : UpgradeElasticsearchDomainResponse) => any, requestBody: UpgradeElasticsearchDomainBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-01-01/es/upgradeDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
