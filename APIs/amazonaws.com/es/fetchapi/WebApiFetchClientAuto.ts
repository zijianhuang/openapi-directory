export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInboundCrossClusterSearchConnection(ConnectionId: string, headersHandler?: () => {[header: string]: string}): Promise<AcceptInboundCrossClusterSearchConnectionResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/ccs/inboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)) + '/accept', { method: 'put', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		AddTags(requestBody: AddTagsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-01-01/tags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		AssociatePackage(PackageID: string, DomainName: string, headersHandler?: () => {[header: string]: string}): Promise<AssociatePackageResponse> {
			return fetch(this.baseUri + '/2015-01-01/packages/associate/' + (PackageID == null ? '' : encodeURIComponent(PackageID)) + '/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CancelElasticsearchServiceSoftwareUpdate(requestBody: CancelElasticsearchServiceSoftwareUpdateBody, headersHandler?: () => {[header: string]: string}): Promise<CancelElasticsearchServiceSoftwareUpdateResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/serviceSoftwareUpdate/cancel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateElasticsearchDomain(requestBody: CreateElasticsearchDomainBody, headersHandler?: () => {[header: string]: string}): Promise<CreateElasticsearchDomainResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/domain', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateOutboundCrossClusterSearchConnection(requestBody: CreateOutboundCrossClusterSearchConnectionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateOutboundCrossClusterSearchConnectionResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/ccs/outboundConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePackage(requestBody: CreatePackageBody, headersHandler?: () => {[header: string]: string}): Promise<CreatePackageResponse> {
			return fetch(this.baseUri + '/2015-01-01/packages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteElasticsearchDomain(DomainName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteElasticsearchDomainResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeElasticsearchDomain(DomainName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticsearchDomainResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteElasticsearchServiceRole(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-01-01/es/role', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteInboundCrossClusterSearchConnection(ConnectionId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInboundCrossClusterSearchConnectionResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/ccs/inboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteOutboundCrossClusterSearchConnection(ConnectionId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteOutboundCrossClusterSearchConnectionResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/ccs/outboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeletePackage(PackageID: string, headersHandler?: () => {[header: string]: string}): Promise<DeletePackageResponse> {
			return fetch(this.baseUri + '/2015-01-01/packages/' + (PackageID == null ? '' : encodeURIComponent(PackageID)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeElasticsearchDomainConfig(DomainName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticsearchDomainConfigResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/config', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateElasticsearchDomainConfig(DomainName: string, requestBody: UpdateElasticsearchDomainConfigBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateElasticsearchDomainConfigResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/config', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeElasticsearchDomains(requestBody: DescribeElasticsearchDomainsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticsearchDomainsResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/domain-info', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeElasticsearchInstanceTypeLimits(domainName: string, InstanceType: ESPartitionInstanceType, ElasticsearchVersion: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeElasticsearchInstanceTypeLimitsResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/instanceTypeLimits/' + (ElasticsearchVersion == null ? '' : encodeURIComponent(ElasticsearchVersion)) + '/' + InstanceType + '?domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeOutboundCrossClusterSearchConnections(MaxResults: string, NextToken: string, requestBody: DescribeOutboundCrossClusterSearchConnectionsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeOutboundCrossClusterSearchConnectionsResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/ccs/outboundConnection/search?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribePackages(MaxResults: string, NextToken: string, requestBody: DescribePackagesBody, headersHandler?: () => {[header: string]: string}): Promise<DescribePackagesResponse> {
			return fetch(this.baseUri + '/2015-01-01/packages/describe?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeReservedElasticsearchInstances(reservationId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeReservedElasticsearchInstancesResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/reservedInstances?reservationId=' + (reservationId == null ? '' : encodeURIComponent(reservationId)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DissociatePackage(PackageID: string, DomainName: string, headersHandler?: () => {[header: string]: string}): Promise<DissociatePackageResponse> {
			return fetch(this.baseUri + '/2015-01-01/packages/dissociate/' + (PackageID == null ? '' : encodeURIComponent(PackageID)) + '/' + (DomainName == null ? '' : encodeURIComponent(DomainName)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCompatibleElasticsearchVersions(domainName: string, headersHandler?: () => {[header: string]: string}): Promise<GetCompatibleElasticsearchVersionsResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/compatibleVersions?domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetUpgradeHistory(DomainName: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetUpgradeHistoryResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/upgradeDomain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/history&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetUpgradeStatus(DomainName: string, headersHandler?: () => {[header: string]: string}): Promise<GetUpgradeStatusResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/upgradeDomain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/status', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListDomainNames(headersHandler?: () => {[header: string]: string}): Promise<ListDomainNamesResponse> {
			return fetch(this.baseUri + '/2015-01-01/domain', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListDomainsForPackage(PackageID: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListDomainsForPackageResponse> {
			return fetch(this.baseUri + '/2015-01-01/packages/' + (PackageID == null ? '' : encodeURIComponent(PackageID)) + '/domains&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListElasticsearchInstanceTypes(ElasticsearchVersion: string, domainName: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListElasticsearchInstanceTypesResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/instanceTypes/' + (ElasticsearchVersion == null ? '' : encodeURIComponent(ElasticsearchVersion)) + '&domainName=' + (domainName == null ? '' : encodeURIComponent(domainName)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListElasticsearchVersions(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListElasticsearchVersionsResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/versions?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPackagesForDomain(DomainName: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPackagesForDomainResponse> {
			return fetch(this.baseUri + '/2015-01-01/domain/' + (DomainName == null ? '' : encodeURIComponent(DomainName)) + '/packages&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTags(arn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return fetch(this.baseUri + '/2015-01-01/tags/#arn?arn=' + (arn == null ? '' : encodeURIComponent(arn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PurchaseReservedElasticsearchInstanceOffering(requestBody: PurchaseReservedElasticsearchInstanceOfferingBody, headersHandler?: () => {[header: string]: string}): Promise<PurchaseReservedElasticsearchInstanceOfferingResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/purchaseReservedInstanceOffering', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RejectInboundCrossClusterSearchConnection(ConnectionId: string, headersHandler?: () => {[header: string]: string}): Promise<RejectInboundCrossClusterSearchConnectionResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/ccs/inboundConnection/' + (ConnectionId == null ? '' : encodeURIComponent(ConnectionId)) + '/reject', { method: 'put', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTags(requestBody: RemoveTagsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/2015-01-01/tags-removal', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		StartElasticsearchServiceSoftwareUpdate(requestBody: StartElasticsearchServiceSoftwareUpdateBody, headersHandler?: () => {[header: string]: string}): Promise<StartElasticsearchServiceSoftwareUpdateResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/serviceSoftwareUpdate/start', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpgradeElasticsearchDomain(requestBody: UpgradeElasticsearchDomainBody, headersHandler?: () => {[header: string]: string}): Promise<UpgradeElasticsearchDomainResponse> {
			return fetch(this.baseUri + '/2015-01-01/es/upgradeDomain', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
