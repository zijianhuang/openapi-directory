...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToOnPremisesInstances(requestBody: AddTagsToOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.AddTagsToOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		BatchGetApplicationRevisions(requestBody: BatchGetApplicationRevisionsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetApplicationRevisionsOutput> {
			return Axios.post<BatchGetApplicationRevisionsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetApplicationRevisions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetApplications(requestBody: BatchGetApplicationsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetApplicationsOutput> {
			return Axios.post<BatchGetApplicationsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetApplications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetDeploymentGroups(requestBody: BatchGetDeploymentGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentGroupsOutput> {
			return Axios.post<BatchGetDeploymentGroupsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetDeploymentInstances(requestBody: BatchGetDeploymentInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentInstancesOutput> {
			return Axios.post<BatchGetDeploymentInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetDeploymentTargets(requestBody: BatchGetDeploymentTargetsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentTargetsOutput> {
			return Axios.post<BatchGetDeploymentTargetsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetDeployments(requestBody: BatchGetDeploymentsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentsOutput> {
			return Axios.post<BatchGetDeploymentsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetOnPremisesInstances(requestBody: BatchGetOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetOnPremisesInstancesOutput> {
			return Axios.post<BatchGetOnPremisesInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		ContinueDeployment(requestBody: ContinueDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ContinueDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		CreateApplication(requestBody: CreateApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateApplicationOutput> {
			return Axios.post<CreateApplicationOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDeployment(requestBody: CreateDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentOutput> {
			return Axios.post<CreateDeploymentOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDeploymentConfig(requestBody: CreateDeploymentConfigInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentConfigOutput> {
			return Axios.post<CreateDeploymentConfigOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDeploymentGroup(requestBody: CreateDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentGroupOutput> {
			return Axios.post<CreateDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteApplication(requestBody: DeleteApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDeploymentConfig(requestBody: DeleteDeploymentConfigInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DeleteDeploymentGroup(requestBody: DeleteDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteDeploymentGroupOutput> {
			return Axios.post<DeleteDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteGitHubAccountToken(requestBody: DeleteGitHubAccountTokenInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGitHubAccountTokenOutput> {
			return Axios.post<DeleteGitHubAccountTokenOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteGitHubAccountToken', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteResourcesByExternalId(requestBody: DeleteResourcesByExternalIdInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcesByExternalIdOutput> {
			return Axios.post<DeleteResourcesByExternalIdOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteResourcesByExternalId', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterOnPremisesInstance(requestBody: DeregisterOnPremisesInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeregisterOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetApplication(requestBody: GetApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationOutput> {
			return Axios.post<GetApplicationOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetApplicationRevision(requestBody: GetApplicationRevisionInput, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationRevisionOutput> {
			return Axios.post<GetApplicationRevisionOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetApplicationRevision', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeployment(requestBody: GetDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentOutput> {
			return Axios.post<GetDeploymentOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeploymentConfig(requestBody: GetDeploymentConfigInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentConfigOutput> {
			return Axios.post<GetDeploymentConfigOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeploymentGroup(requestBody: GetDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentGroupOutput> {
			return Axios.post<GetDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeploymentInstance(requestBody: GetDeploymentInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentInstanceOutput> {
			return Axios.post<GetDeploymentInstanceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeploymentTarget(requestBody: GetDeploymentTargetInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentTargetOutput> {
			return Axios.post<GetDeploymentTargetOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOnPremisesInstance(requestBody: GetOnPremisesInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<GetOnPremisesInstanceOutput> {
			return Axios.post<GetOnPremisesInstanceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListApplicationRevisions(nextToken: string, requestBody: ListApplicationRevisionsInput, headersHandler?: () => {[header: string]: string}): Promise<ListApplicationRevisionsOutput> {
			return Axios.post<ListApplicationRevisionsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListApplicationRevisions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeploymentConfigs(nextToken: string, requestBody: ListDeploymentConfigsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentConfigsOutput> {
			return Axios.post<ListDeploymentConfigsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentConfigs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeploymentGroups(nextToken: string, requestBody: ListDeploymentGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentGroupsOutput> {
			return Axios.post<ListDeploymentGroupsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentGroups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeploymentInstances(nextToken: string, requestBody: ListDeploymentInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentInstancesOutput> {
			return Axios.post<ListDeploymentInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentInstances?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeploymentTargets(requestBody: ListDeploymentTargetsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentTargetsOutput> {
			return Axios.post<ListDeploymentTargetsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeployments(nextToken: string, requestBody: ListDeploymentsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentsOutput> {
			return Axios.post<ListDeploymentsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeployments?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListGitHubAccountTokenNames(requestBody: ListGitHubAccountTokenNamesInput, headersHandler?: () => {[header: string]: string}): Promise<ListGitHubAccountTokenNamesOutput> {
			return Axios.post<ListGitHubAccountTokenNamesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListGitHubAccountTokenNames', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListOnPremisesInstances(requestBody: ListOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<ListOnPremisesInstancesOutput> {
			return Axios.post<ListOnPremisesInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return Axios.post<ListTagsForResourceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutLifecycleEventHookExecutionStatus(requestBody: PutLifecycleEventHookExecutionStatusInput, headersHandler?: () => {[header: string]: string}): Promise<PutLifecycleEventHookExecutionStatusOutput> {
			return Axios.post<PutLifecycleEventHookExecutionStatusOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.PutLifecycleEventHookExecutionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RegisterApplicationRevision(requestBody: RegisterApplicationRevisionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.RegisterApplicationRevision', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RegisterOnPremisesInstance(requestBody: RegisterOnPremisesInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.RegisterOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromOnPremisesInstances(requestBody: RemoveTagsFromOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.RemoveTagsFromOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SkipWaitTimeForInstanceTermination(requestBody: SkipWaitTimeForInstanceTerminationInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.SkipWaitTimeForInstanceTermination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		StopDeployment(requestBody: StopDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<StopDeploymentOutput> {
			return Axios.post<StopDeploymentOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.StopDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceOutput> {
			return Axios.post<TagResourceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceOutput> {
			return Axios.post<UntagResourceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateApplication(requestBody: UpdateApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.UpdateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UpdateDeploymentGroup(requestBody: UpdateDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateDeploymentGroupOutput> {
			return Axios.post<UpdateDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.UpdateDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
