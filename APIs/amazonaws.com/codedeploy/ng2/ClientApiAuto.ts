...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToOnPremisesInstances(requestBody: AddTagsToOnPremisesInstancesInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.AddTagsToOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		BatchGetApplicationRevisions(requestBody: BatchGetApplicationRevisionsInput, headersHandler?: () => HttpHeaders): Observable<BatchGetApplicationRevisionsOutput> {
			return this.http.post<BatchGetApplicationRevisionsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetApplicationRevisions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetApplications(requestBody: BatchGetApplicationsInput, headersHandler?: () => HttpHeaders): Observable<BatchGetApplicationsOutput> {
			return this.http.post<BatchGetApplicationsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetApplications', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetDeploymentGroups(requestBody: BatchGetDeploymentGroupsInput, headersHandler?: () => HttpHeaders): Observable<BatchGetDeploymentGroupsOutput> {
			return this.http.post<BatchGetDeploymentGroupsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentGroups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetDeploymentInstances(requestBody: BatchGetDeploymentInstancesInput, headersHandler?: () => HttpHeaders): Observable<BatchGetDeploymentInstancesOutput> {
			return this.http.post<BatchGetDeploymentInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentInstances', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetDeploymentTargets(requestBody: BatchGetDeploymentTargetsInput, headersHandler?: () => HttpHeaders): Observable<BatchGetDeploymentTargetsOutput> {
			return this.http.post<BatchGetDeploymentTargetsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentTargets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetDeployments(requestBody: BatchGetDeploymentsInput, headersHandler?: () => HttpHeaders): Observable<BatchGetDeploymentsOutput> {
			return this.http.post<BatchGetDeploymentsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeployments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetOnPremisesInstances(requestBody: BatchGetOnPremisesInstancesInput, headersHandler?: () => HttpHeaders): Observable<BatchGetOnPremisesInstancesOutput> {
			return this.http.post<BatchGetOnPremisesInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.BatchGetOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		ContinueDeployment(requestBody: ContinueDeploymentInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ContinueDeployment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		CreateApplication(requestBody: CreateApplicationInput, headersHandler?: () => HttpHeaders): Observable<CreateApplicationOutput> {
			return this.http.post<CreateApplicationOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDeployment(requestBody: CreateDeploymentInput, headersHandler?: () => HttpHeaders): Observable<CreateDeploymentOutput> {
			return this.http.post<CreateDeploymentOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateDeployment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDeploymentConfig(requestBody: CreateDeploymentConfigInput, headersHandler?: () => HttpHeaders): Observable<CreateDeploymentConfigOutput> {
			return this.http.post<CreateDeploymentConfigOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDeploymentGroup(requestBody: CreateDeploymentGroupInput, headersHandler?: () => HttpHeaders): Observable<CreateDeploymentGroupOutput> {
			return this.http.post<CreateDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteApplication(requestBody: DeleteApplicationInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDeploymentConfig(requestBody: DeleteDeploymentConfigInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeleteDeploymentGroup(requestBody: DeleteDeploymentGroupInput, headersHandler?: () => HttpHeaders): Observable<DeleteDeploymentGroupOutput> {
			return this.http.post<DeleteDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteGitHubAccountToken(requestBody: DeleteGitHubAccountTokenInput, headersHandler?: () => HttpHeaders): Observable<DeleteGitHubAccountTokenOutput> {
			return this.http.post<DeleteGitHubAccountTokenOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteGitHubAccountToken', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteResourcesByExternalId(requestBody: DeleteResourcesByExternalIdInput, headersHandler?: () => HttpHeaders): Observable<DeleteResourcesByExternalIdOutput> {
			return this.http.post<DeleteResourcesByExternalIdOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeleteResourcesByExternalId', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterOnPremisesInstance(requestBody: DeregisterOnPremisesInstanceInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.DeregisterOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetApplication(requestBody: GetApplicationInput, headersHandler?: () => HttpHeaders): Observable<GetApplicationOutput> {
			return this.http.post<GetApplicationOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetApplicationRevision(requestBody: GetApplicationRevisionInput, headersHandler?: () => HttpHeaders): Observable<GetApplicationRevisionOutput> {
			return this.http.post<GetApplicationRevisionOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetApplicationRevision', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDeployment(requestBody: GetDeploymentInput, headersHandler?: () => HttpHeaders): Observable<GetDeploymentOutput> {
			return this.http.post<GetDeploymentOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeployment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDeploymentConfig(requestBody: GetDeploymentConfigInput, headersHandler?: () => HttpHeaders): Observable<GetDeploymentConfigOutput> {
			return this.http.post<GetDeploymentConfigOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDeploymentGroup(requestBody: GetDeploymentGroupInput, headersHandler?: () => HttpHeaders): Observable<GetDeploymentGroupOutput> {
			return this.http.post<GetDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDeploymentInstance(requestBody: GetDeploymentInstanceInput, headersHandler?: () => HttpHeaders): Observable<GetDeploymentInstanceOutput> {
			return this.http.post<GetDeploymentInstanceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDeploymentTarget(requestBody: GetDeploymentTargetInput, headersHandler?: () => HttpHeaders): Observable<GetDeploymentTargetOutput> {
			return this.http.post<GetDeploymentTargetOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentTarget', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetOnPremisesInstance(requestBody: GetOnPremisesInstanceInput, headersHandler?: () => HttpHeaders): Observable<GetOnPremisesInstanceOutput> {
			return this.http.post<GetOnPremisesInstanceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.GetOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListApplicationRevisions(nextToken: string, requestBody: ListApplicationRevisionsInput, headersHandler?: () => HttpHeaders): Observable<ListApplicationRevisionsOutput> {
			return this.http.post<ListApplicationRevisionsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListApplicationRevisions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListApplications(nextToken: string, requestBody: ListApplicationsInput, headersHandler?: () => HttpHeaders): Observable<ListApplicationsOutput> {
			return this.http.post<ListApplicationsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListApplications?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDeploymentConfigs(nextToken: string, requestBody: ListDeploymentConfigsInput, headersHandler?: () => HttpHeaders): Observable<ListDeploymentConfigsOutput> {
			return this.http.post<ListDeploymentConfigsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentConfigs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDeploymentGroups(nextToken: string, requestBody: ListDeploymentGroupsInput, headersHandler?: () => HttpHeaders): Observable<ListDeploymentGroupsOutput> {
			return this.http.post<ListDeploymentGroupsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentGroups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDeploymentInstances(nextToken: string, requestBody: ListDeploymentInstancesInput, headersHandler?: () => HttpHeaders): Observable<ListDeploymentInstancesOutput> {
			return this.http.post<ListDeploymentInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentInstances?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDeploymentTargets(requestBody: ListDeploymentTargetsInput, headersHandler?: () => HttpHeaders): Observable<ListDeploymentTargetsOutput> {
			return this.http.post<ListDeploymentTargetsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentTargets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDeployments(nextToken: string, requestBody: ListDeploymentsInput, headersHandler?: () => HttpHeaders): Observable<ListDeploymentsOutput> {
			return this.http.post<ListDeploymentsOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListDeployments?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListGitHubAccountTokenNames(requestBody: ListGitHubAccountTokenNamesInput, headersHandler?: () => HttpHeaders): Observable<ListGitHubAccountTokenNamesOutput> {
			return this.http.post<ListGitHubAccountTokenNamesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListGitHubAccountTokenNames', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListOnPremisesInstances(requestBody: ListOnPremisesInstancesInput, headersHandler?: () => HttpHeaders): Observable<ListOnPremisesInstancesOutput> {
			return this.http.post<ListOnPremisesInstancesOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceOutput> {
			return this.http.post<ListTagsForResourceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutLifecycleEventHookExecutionStatus(requestBody: PutLifecycleEventHookExecutionStatusInput, headersHandler?: () => HttpHeaders): Observable<PutLifecycleEventHookExecutionStatusOutput> {
			return this.http.post<PutLifecycleEventHookExecutionStatusOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.PutLifecycleEventHookExecutionStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		RegisterApplicationRevision(requestBody: RegisterApplicationRevisionInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		RegisterOnPremisesInstance(requestBody: RegisterOnPremisesInstanceInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.RegisterOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromOnPremisesInstances(requestBody: RemoveTagsFromOnPremisesInstancesInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.RemoveTagsFromOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SkipWaitTimeForInstanceTermination(requestBody: SkipWaitTimeForInstanceTerminationInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		StopDeployment(requestBody: StopDeploymentInput, headersHandler?: () => HttpHeaders): Observable<StopDeploymentOutput> {
			return this.http.post<StopDeploymentOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.StopDeployment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => HttpHeaders): Observable<TagResourceOutput> {
			return this.http.post<TagResourceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => HttpHeaders): Observable<UntagResourceOutput> {
			return this.http.post<UntagResourceOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateApplication(requestBody: UpdateApplicationInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.UpdateApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateDeploymentGroup(requestBody: UpdateDeploymentGroupInput, headersHandler?: () => HttpHeaders): Observable<UpdateDeploymentGroupOutput> {
			return this.http.post<UpdateDeploymentGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeDeploy_20141006.UpdateDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
