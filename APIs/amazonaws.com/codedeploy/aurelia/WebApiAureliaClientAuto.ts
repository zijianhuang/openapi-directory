...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToOnPremisesInstances(requestBody: AddTagsToOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.AddTagsToOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		BatchGetApplicationRevisions(requestBody: BatchGetApplicationRevisionsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetApplicationRevisionsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.BatchGetApplicationRevisions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetApplications(requestBody: BatchGetApplicationsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetApplicationsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.BatchGetApplications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetDeploymentGroups(requestBody: BatchGetDeploymentGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentGroupsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetDeploymentInstances(requestBody: BatchGetDeploymentInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentInstancesOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetDeploymentTargets(requestBody: BatchGetDeploymentTargetsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentTargetsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeploymentTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetDeployments(requestBody: BatchGetDeploymentsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetDeploymentsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.BatchGetDeployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetOnPremisesInstances(requestBody: BatchGetOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetOnPremisesInstancesOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.BatchGetOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ContinueDeployment(requestBody: ContinueDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ContinueDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateApplication(requestBody: CreateApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateApplicationOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.CreateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDeployment(requestBody: CreateDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.CreateDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDeploymentConfig(requestBody: CreateDeploymentConfigInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentConfigOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDeploymentGroup(requestBody: CreateDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentGroupOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.CreateDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApplication(requestBody: DeleteApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.DeleteApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteDeploymentConfig(requestBody: DeleteDeploymentConfigInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteDeploymentGroup(requestBody: DeleteDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteDeploymentGroupOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.DeleteDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteGitHubAccountToken(requestBody: DeleteGitHubAccountTokenInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGitHubAccountTokenOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.DeleteGitHubAccountToken', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResourcesByExternalId(requestBody: DeleteResourcesByExternalIdInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcesByExternalIdOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.DeleteResourcesByExternalId', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterOnPremisesInstance(requestBody: DeregisterOnPremisesInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.DeregisterOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetApplication(requestBody: GetApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetApplicationRevision(requestBody: GetApplicationRevisionInput, headersHandler?: () => {[header: string]: string}): Promise<GetApplicationRevisionOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetApplicationRevision', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeployment(requestBody: GetDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeploymentConfig(requestBody: GetDeploymentConfigInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentConfigOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeploymentGroup(requestBody: GetDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentGroupOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeploymentInstance(requestBody: GetDeploymentInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentInstanceOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeploymentTarget(requestBody: GetDeploymentTargetInput, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentTargetOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetDeploymentTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOnPremisesInstance(requestBody: GetOnPremisesInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<GetOnPremisesInstanceOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.GetOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListApplicationRevisions(nextToken: string, requestBody: ListApplicationRevisionsInput, headersHandler?: () => {[header: string]: string}): Promise<ListApplicationRevisionsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListApplicationRevisions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDeploymentConfigs(nextToken: string, requestBody: ListDeploymentConfigsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentConfigsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentConfigs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDeploymentGroups(nextToken: string, requestBody: ListDeploymentGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentGroupsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentGroups?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDeploymentInstances(nextToken: string, requestBody: ListDeploymentInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentInstancesOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentInstances?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDeploymentTargets(requestBody: ListDeploymentTargetsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentTargetsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListDeploymentTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDeployments(nextToken: string, requestBody: ListDeploymentsInput, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentsOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListDeployments?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGitHubAccountTokenNames(requestBody: ListGitHubAccountTokenNamesInput, headersHandler?: () => {[header: string]: string}): Promise<ListGitHubAccountTokenNamesOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListGitHubAccountTokenNames', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListOnPremisesInstances(requestBody: ListOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<ListOnPremisesInstancesOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutLifecycleEventHookExecutionStatus(requestBody: PutLifecycleEventHookExecutionStatusInput, headersHandler?: () => {[header: string]: string}): Promise<PutLifecycleEventHookExecutionStatusOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.PutLifecycleEventHookExecutionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterApplicationRevision(requestBody: RegisterApplicationRevisionInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.RegisterApplicationRevision', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RegisterOnPremisesInstance(requestBody: RegisterOnPremisesInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.RegisterOnPremisesInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RemoveTagsFromOnPremisesInstances(requestBody: RemoveTagsFromOnPremisesInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.RemoveTagsFromOnPremisesInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		SkipWaitTimeForInstanceTermination(requestBody: SkipWaitTimeForInstanceTerminationInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.SkipWaitTimeForInstanceTermination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopDeployment(requestBody: StopDeploymentInput, headersHandler?: () => {[header: string]: string}): Promise<StopDeploymentOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.StopDeployment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateApplication(requestBody: UpdateApplicationInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.UpdateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateDeploymentGroup(requestBody: UpdateDeploymentGroupInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateDeploymentGroupOutput> {
			return this.http.post('/#X-Amz-Target=CodeDeploy_20141006.UpdateDeploymentGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
