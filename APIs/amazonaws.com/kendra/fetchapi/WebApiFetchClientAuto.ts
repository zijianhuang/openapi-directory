export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDeleteDocument(requestBody: BatchDeleteDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteDocumentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.BatchDeleteDocument', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchPutDocument(requestBody: BatchPutDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchPutDocumentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.BatchPutDocument', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDataSource(requestBody: CreateDataSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.CreateDataSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateFaq(requestBody: CreateFaqRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFaqResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.CreateFaq', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateIndex(requestBody: CreateIndexRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateIndexResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.CreateIndex', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDataSource(requestBody: DeleteDataSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.DeleteDataSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteFaq(requestBody: DeleteFaqRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.DeleteFaq', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteIndex(requestBody: DeleteIndexRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.DeleteIndex', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeDataSource(requestBody: DescribeDataSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.DescribeDataSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFaq(requestBody: DescribeFaqRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFaqResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.DescribeFaq', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeIndex(requestBody: DescribeIndexRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeIndexResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.DescribeIndex', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDataSourceSyncJobs(MaxResults: string, NextToken: string, requestBody: ListDataSourceSyncJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDataSourceSyncJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.ListDataSourceSyncJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDataSources(MaxResults: string, NextToken: string, requestBody: ListDataSourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDataSourcesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.ListDataSources?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListFaqs(requestBody: ListFaqsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListFaqsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.ListFaqs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListIndices(MaxResults: string, NextToken: string, requestBody: ListIndicesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListIndicesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.ListIndices?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Query(requestBody: QueryRequest, headersHandler?: () => {[header: string]: string}): Promise<QueryResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.Query', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartDataSourceSyncJob(requestBody: StartDataSourceSyncJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartDataSourceSyncJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.StartDataSourceSyncJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		StopDataSourceSyncJob(requestBody: StopDataSourceSyncJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.StopDataSourceSyncJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		SubmitFeedback(requestBody: SubmitFeedbackRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.SubmitFeedback', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdateDataSource(requestBody: UpdateDataSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.UpdateDataSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateIndex(requestBody: UpdateIndexRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSKendraFrontendService.UpdateIndex', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
