export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateDataset(requestBody: CreateDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDataset', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDatasetGroup(requestBody: CreateDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDatasetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDatasetImportJob(requestBody: CreateDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetImportJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDatasetImportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateForecast(requestBody: CreateForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateForecastResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateForecast', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateForecastExportJob(requestBody: CreateForecastExportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateForecastExportJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateForecastExportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePredictor(requestBody: CreatePredictorRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePredictorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreatePredictor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDataset(requestBody: DeleteDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDataset', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteDatasetGroup(requestBody: DeleteDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDatasetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteDatasetImportJob(requestBody: DeleteDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDatasetImportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteForecast(requestBody: DeleteForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteForecast', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteForecastExportJob(requestBody: DeleteForecastExportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteForecastExportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeletePredictor(requestBody: DeletePredictorRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeletePredictor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeDataset(requestBody: DescribeDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDataset', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDatasetGroup(requestBody: DescribeDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDatasetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDatasetImportJob(requestBody: DescribeDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetImportJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDatasetImportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeForecast(requestBody: DescribeForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeForecastResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeForecast', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeForecastExportJob(requestBody: DescribeForecastExportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeForecastExportJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeForecastExportJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribePredictor(requestBody: DescribePredictorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePredictorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribePredictor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetAccuracyMetrics(requestBody: GetAccuracyMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccuracyMetricsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.GetAccuracyMetrics', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDatasets(MaxResults: string, NextToken: string, requestBody: ListDatasetsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListDatasets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListForecasts(MaxResults: string, NextToken: string, requestBody: ListForecastsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListForecastsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListForecasts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPredictors(MaxResults: string, NextToken: string, requestBody: ListPredictorsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPredictorsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListPredictors?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDatasetGroup(requestBody: UpdateDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDatasetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonForecast.UpdateDatasetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
