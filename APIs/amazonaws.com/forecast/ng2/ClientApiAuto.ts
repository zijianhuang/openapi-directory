...
export namespace My_Demo_Client {
	...
	export interface CreateDatasetGroupRequest {
		...
		Domain: CreateDatasetGroupRequestDomain;
		DatasetArns?: Array<Arn>;
	}

	export enum CreateDatasetGroupRequestDomain { RETAIL = 0, CUSTOM = 1, INVENTORY_PLANNING = 2, EC2_CAPACITY = 3, WORK_FORCE = 4, WEB_TRAFFIC = 5, METRICS = 6 }
	...
	export interface CreateForecastRequest {
		ForecastName: string;
		PredictorArn: string;
		ForecastTypes?: Array<ForecastType>;
	}
	...
	export interface DescribeDatasetResponse {
		DatasetArn?: string;
		DatasetName?: string;
		Domain?: DescribeDatasetResponseDomain;
		DatasetType?: DescribeDatasetResponseDatasetType;
		DataFrequency?: string;
	...
	export enum DescribeDatasetResponseDomain { RETAIL = 0, CUSTOM = 1, INVENTORY_PLANNING = 2, EC2_CAPACITY = 3, WORK_FORCE = 4, WEB_TRAFFIC = 5, METRICS = 6 }

	export enum DescribeDatasetResponseDatasetType { TARGET_TIME_SERIES = 0, RELATED_TIME_SERIES = 1, ITEM_METADATA = 2 }
	...
	export interface DescribeDatasetGroupResponse {
		...
		DatasetGroupArn?: string;
		DatasetArns?: Array<Arn>;
		Domain?: DescribeDatasetGroupResponseDomain;
		Status?: string;
		CreationTime?: Date;
		LastModificationTime?: Date;
	}

	export enum DescribeDatasetGroupResponseDomain { RETAIL = 0, CUSTOM = 1, INVENTORY_PLANNING = 2, EC2_CAPACITY = 3, WORK_FORCE = 4, WEB_TRAFFIC = 5, METRICS = 6 }
	...
	export interface DescribePredictorResponse {
		...
		DatasetImportJobArns?: Array<Arn>;
		AutoMLAlgorithmArns?: Array<Arn>;
		Status?: string;
		Message?: string;
		CreationTime?: Date;
		LastModificationTime?: Date;
	...
	export interface DatasetSummary {
		DatasetArn?: string;
		DatasetName?: string;
		DatasetType?: DatasetSummaryDatasetType;
		Domain?: DatasetSummaryDomain;
		CreationTime?: Date;
		LastModificationTime?: Date;
	}

	export enum DatasetSummaryDatasetType { TARGET_TIME_SERIES = 0, RELATED_TIME_SERIES = 1, ITEM_METADATA = 2 }

	export enum DatasetSummaryDomain { RETAIL = 0, CUSTOM = 1, INVENTORY_PLANNING = 2, EC2_CAPACITY = 3, WORK_FORCE = 4, WEB_TRAFFIC = 5, METRICS = 6 }
	...
	export class DemoClient {
		...
		CreateDataset(requestBody: CreateDatasetRequest, headersHandler?: () => HttpHeaders): Observable<CreateDatasetResponse> {
			return this.http.post<CreateDatasetResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDataset', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateDatasetGroup(requestBody: CreateDatasetGroupRequest, headersHandler?: () => HttpHeaders): Observable<CreateDatasetGroupResponse> {
			return this.http.post<CreateDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateDatasetImportJob(requestBody: CreateDatasetImportJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateDatasetImportJobResponse> {
			return this.http.post<CreateDatasetImportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateForecast(requestBody: CreateForecastRequest, headersHandler?: () => HttpHeaders): Observable<CreateForecastResponse> {
			return this.http.post<CreateForecastResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateForecast', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateForecastExportJob(requestBody: CreateForecastExportJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateForecastExportJobResponse> {
			return this.http.post<CreateForecastExportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateForecastExportJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreatePredictor(requestBody: CreatePredictorRequest, headersHandler?: () => HttpHeaders): Observable<CreatePredictorResponse> {
			return this.http.post<CreatePredictorResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreatePredictor', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DeleteDataset(requestBody: DeleteDatasetRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDataset', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		DeleteDatasetGroup(requestBody: DeleteDatasetGroupRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDatasetImportJob(requestBody: DeleteDatasetImportJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteForecast(requestBody: DeleteForecastRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteForecast', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteForecastExportJob(requestBody: DeleteForecastExportJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteForecastExportJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePredictor(requestBody: DeletePredictorRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeletePredictor', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		DescribeDataset(requestBody: DescribeDatasetRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDatasetResponse> {
			return this.http.post<DescribeDatasetResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDataset', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DescribeDatasetGroup(requestBody: DescribeDatasetGroupRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDatasetGroupResponse> {
			return this.http.post<DescribeDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DescribeDatasetImportJob(requestBody: DescribeDatasetImportJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDatasetImportJobResponse> {
			return this.http.post<DescribeDatasetImportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeForecast(requestBody: DescribeForecastRequest, headersHandler?: () => HttpHeaders): Observable<DescribeForecastResponse> {
			return this.http.post<DescribeForecastResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeForecast', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeForecastExportJob(requestBody: DescribeForecastExportJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeForecastExportJobResponse> {
			return this.http.post<DescribeForecastExportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeForecastExportJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribePredictor(requestBody: DescribePredictorRequest, headersHandler?: () => HttpHeaders): Observable<DescribePredictorResponse> {
			return this.http.post<DescribePredictorResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribePredictor', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAccuracyMetrics(requestBody: GetAccuracyMetricsRequest, headersHandler?: () => HttpHeaders): Observable<GetAccuracyMetricsResponse> {
			return this.http.post<GetAccuracyMetricsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.GetAccuracyMetrics', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListDatasetGroups(MaxResults: string, NextToken: string, requestBody: ListDatasetGroupsRequest, headersHandler?: () => HttpHeaders): Observable<ListDatasetGroupsResponse> {
			return this.http.post<ListDatasetGroupsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListDatasetGroups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListDatasets(MaxResults: string, NextToken: string, requestBody: ListDatasetsRequest, headersHandler?: () => HttpHeaders): Observable<ListDatasetsResponse> {
			return this.http.post<ListDatasetsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListDatasets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListForecastExportJobs(MaxResults: string, NextToken: string, requestBody: ListForecastExportJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListForecastExportJobsResponse> {
		 ...
		 */
		ListForecasts(MaxResults: string, NextToken: string, requestBody: ListForecastsRequest, headersHandler?: () => HttpHeaders): Observable<ListForecastsResponse> {
			return this.http.post<ListForecastsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListForecasts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPredictors(MaxResults: string, NextToken: string, requestBody: ListPredictorsRequest, headersHandler?: () => HttpHeaders): Observable<ListPredictorsResponse> {
			return this.http.post<ListPredictorsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListPredictors?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDatasetGroup(requestBody: UpdateDatasetGroupRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDatasetGroupResponse> {
			return this.http.post<UpdateDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.UpdateDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
