...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateDataset(requestBody: CreateDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetResponse> {
			return Axios.post<CreateDatasetResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDataset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDatasetGroup(requestBody: CreateDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetGroupResponse> {
			return Axios.post<CreateDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDatasetImportJob(requestBody: CreateDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetImportJobResponse> {
			return Axios.post<CreateDatasetImportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateForecast(requestBody: CreateForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateForecastResponse> {
			return Axios.post<CreateForecastResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateForecast', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateForecastExportJob(requestBody: CreateForecastExportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateForecastExportJobResponse> {
			return Axios.post<CreateForecastExportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreateForecastExportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreatePredictor(requestBody: CreatePredictorRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePredictorResponse> {
			return Axios.post<CreatePredictorResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.CreatePredictor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDataset(requestBody: DeleteDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDataset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DeleteDatasetGroup(requestBody: DeleteDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDatasetImportJob(requestBody: DeleteDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteForecast(requestBody: DeleteForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteForecast', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteForecastExportJob(requestBody: DeleteForecastExportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeleteForecastExportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePredictor(requestBody: DeletePredictorRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AmazonForecast.DeletePredictor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DescribeDataset(requestBody: DescribeDatasetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return Axios.post<DescribeDatasetResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDataset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDatasetGroup(requestBody: DescribeDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetGroupResponse> {
			return Axios.post<DescribeDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDatasetImportJob(requestBody: DescribeDatasetImportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetImportJobResponse> {
			return Axios.post<DescribeDatasetImportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeDatasetImportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeForecast(requestBody: DescribeForecastRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeForecastResponse> {
			return Axios.post<DescribeForecastResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeForecast', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeForecastExportJob(requestBody: DescribeForecastExportJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeForecastExportJobResponse> {
			return Axios.post<DescribeForecastExportJobResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribeForecastExportJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribePredictor(requestBody: DescribePredictorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePredictorResponse> {
			return Axios.post<DescribePredictorResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.DescribePredictor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetAccuracyMetrics(requestBody: GetAccuracyMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccuracyMetricsResponse> {
			return Axios.post<GetAccuracyMetricsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.GetAccuracyMetrics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDatasetGroups(MaxResults: string, NextToken: string, requestBody: ListDatasetGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetGroupsResponse> {
			return Axios.post<ListDatasetGroupsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListDatasetGroups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDatasets(MaxResults: string, NextToken: string, requestBody: ListDatasetsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetsResponse> {
			return Axios.post<ListDatasetsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListDatasets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListForecastExportJobs(MaxResults: string, NextToken: string, requestBody: ListForecastExportJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListForecastExportJobsResponse> {
			return Axios.post<ListForecastExportJobsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListForecastExportJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListForecasts(MaxResults: string, NextToken: string, requestBody: ListForecastsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListForecastsResponse> {
			return Axios.post<ListForecastsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListForecasts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListPredictors(MaxResults: string, NextToken: string, requestBody: ListPredictorsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPredictorsResponse> {
			return Axios.post<ListPredictorsResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.ListPredictors?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateDatasetGroup(requestBody: UpdateDatasetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDatasetGroupResponse> {
			return Axios.post<UpdateDatasetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonForecast.UpdateDatasetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
