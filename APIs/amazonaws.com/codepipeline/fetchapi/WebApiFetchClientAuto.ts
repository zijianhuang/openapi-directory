export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcknowledgeJob(requestBody: AcknowledgeJobInput, headersHandler?: () => {[header: string]: string}): Promise<AcknowledgeJobOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.AcknowledgeJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AcknowledgeThirdPartyJob(requestBody: AcknowledgeThirdPartyJobInput, headersHandler?: () => {[header: string]: string}): Promise<AcknowledgeThirdPartyJobOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.AcknowledgeThirdPartyJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateCustomActionType(requestBody: CreateCustomActionTypeInput, headersHandler?: () => {[header: string]: string}): Promise<CreateCustomActionTypeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.CreateCustomActionType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePipeline(requestBody: CreatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePipelineOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.CreatePipeline', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCustomActionType(requestBody: DeleteCustomActionTypeInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.DeleteCustomActionType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeletePipeline(requestBody: DeletePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.DeletePipeline', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteWebhook(requestBody: DeleteWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteWebhookOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.DeleteWebhook', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeregisterWebhookWithThirdParty(requestBody: DeregisterWebhookWithThirdPartyInput, headersHandler?: () => {[header: string]: string}): Promise<DeregisterWebhookWithThirdPartyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.DeregisterWebhookWithThirdParty', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DisableStageTransition(requestBody: DisableStageTransitionInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.DisableStageTransition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		EnableStageTransition(requestBody: EnableStageTransitionInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.EnableStageTransition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetJobDetails(requestBody: GetJobDetailsInput, headersHandler?: () => {[header: string]: string}): Promise<GetJobDetailsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.GetJobDetails', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPipeline(requestBody: GetPipelineInput, headersHandler?: () => {[header: string]: string}): Promise<GetPipelineOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.GetPipeline', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPipelineExecution(requestBody: GetPipelineExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<GetPipelineExecutionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.GetPipelineExecution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPipelineState(requestBody: GetPipelineStateInput, headersHandler?: () => {[header: string]: string}): Promise<GetPipelineStateOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.GetPipelineState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetThirdPartyJobDetails(requestBody: GetThirdPartyJobDetailsInput, headersHandler?: () => {[header: string]: string}): Promise<GetThirdPartyJobDetailsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.GetThirdPartyJobDetails', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListActionTypes(nextToken: string, requestBody: ListActionTypesInput, headersHandler?: () => {[header: string]: string}): Promise<ListActionTypesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.ListActionTypes?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPipelineExecutions(maxResults: string, nextToken: string, requestBody: ListPipelineExecutionsInput, headersHandler?: () => {[header: string]: string}): Promise<ListPipelineExecutionsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.ListPipelineExecutions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPipelines(nextToken: string, requestBody: ListPipelinesInput, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.ListPipelines?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(maxResults: string, nextToken: string, requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.ListTagsForResource?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListWebhooks(MaxResults: string, NextToken: string, requestBody: ListWebhooksInput, headersHandler?: () => {[header: string]: string}): Promise<ListWebhooksOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.ListWebhooks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PollForJobs(requestBody: PollForJobsInput, headersHandler?: () => {[header: string]: string}): Promise<PollForJobsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PollForJobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PollForThirdPartyJobs(requestBody: PollForThirdPartyJobsInput, headersHandler?: () => {[header: string]: string}): Promise<PollForThirdPartyJobsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PollForThirdPartyJobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutActionRevision(requestBody: PutActionRevisionInput, headersHandler?: () => {[header: string]: string}): Promise<PutActionRevisionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PutActionRevision', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutApprovalResult(requestBody: PutApprovalResultInput, headersHandler?: () => {[header: string]: string}): Promise<PutApprovalResultOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PutApprovalResult', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutJobFailureResult(requestBody: PutJobFailureResultInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PutJobFailureResult', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		PutJobSuccessResult(requestBody: PutJobSuccessResultInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PutJobSuccessResult', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		PutThirdPartyJobFailureResult(requestBody: PutThirdPartyJobFailureResultInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PutThirdPartyJobFailureResult', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		PutThirdPartyJobSuccessResult(requestBody: PutThirdPartyJobSuccessResultInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PutThirdPartyJobSuccessResult', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		PutWebhook(requestBody: PutWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<PutWebhookOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.PutWebhook', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterWebhookWithThirdParty(requestBody: RegisterWebhookWithThirdPartyInput, headersHandler?: () => {[header: string]: string}): Promise<RegisterWebhookWithThirdPartyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.RegisterWebhookWithThirdParty', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RetryStageExecution(requestBody: RetryStageExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<RetryStageExecutionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.RetryStageExecution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartPipelineExecution(requestBody: StartPipelineExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<StartPipelineExecutionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.StartPipelineExecution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopPipelineExecution(requestBody: StopPipelineExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<StopPipelineExecutionOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.StopPipelineExecution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdatePipeline(requestBody: UpdatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<UpdatePipelineOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodePipeline_20150709.UpdatePipeline', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
