...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ApproveSkill(requestBody: ApproveSkillRequest, headersHandler?: () => {[header: string]: string}): Promise<ApproveSkillResponse> {
			return Axios.post<ApproveSkillResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ApproveSkill', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateContactWithAddressBook(requestBody: AssociateContactWithAddressBookRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateContactWithAddressBookResponse> {
			return Axios.post<AssociateContactWithAddressBookResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.AssociateContactWithAddressBook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateDeviceWithNetworkProfile(requestBody: AssociateDeviceWithNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateDeviceWithNetworkProfileResponse> {
			return Axios.post<AssociateDeviceWithNetworkProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.AssociateDeviceWithNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateDeviceWithRoom(requestBody: AssociateDeviceWithRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateDeviceWithRoomResponse> {
			return Axios.post<AssociateDeviceWithRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.AssociateDeviceWithRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateSkillWithSkillGroup(requestBody: AssociateSkillWithSkillGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateSkillWithSkillGroupResponse> {
			return Axios.post<AssociateSkillWithSkillGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.AssociateSkillWithSkillGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateSkillWithUsers(requestBody: AssociateSkillWithUsersRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateSkillWithUsersResponse> {
			return Axios.post<AssociateSkillWithUsersResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.AssociateSkillWithUsers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAddressBook(requestBody: CreateAddressBookRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAddressBookResponse> {
			return Axios.post<CreateAddressBookResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateAddressBook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateBusinessReportSchedule(requestBody: CreateBusinessReportScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBusinessReportScheduleResponse> {
			return Axios.post<CreateBusinessReportScheduleResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateBusinessReportSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateConferenceProvider(requestBody: CreateConferenceProviderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateConferenceProviderResponse> {
			return Axios.post<CreateConferenceProviderResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateConferenceProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateContact(requestBody: CreateContactRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateContactResponse> {
			return Axios.post<CreateContactResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateContact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateGatewayGroup(requestBody: CreateGatewayGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateGatewayGroupResponse> {
			return Axios.post<CreateGatewayGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateGatewayGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateNetworkProfile(requestBody: CreateNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateNetworkProfileResponse> {
			return Axios.post<CreateNetworkProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateProfile(requestBody: CreateProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProfileResponse> {
			return Axios.post<CreateProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRoom(requestBody: CreateRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRoomResponse> {
			return Axios.post<CreateRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSkillGroup(requestBody: CreateSkillGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSkillGroupResponse> {
			return Axios.post<CreateSkillGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateSkillGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUser(requestBody: CreateUserRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserResponse> {
			return Axios.post<CreateUserResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.CreateUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteAddressBook(requestBody: DeleteAddressBookRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAddressBookResponse> {
			return Axios.post<DeleteAddressBookResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteAddressBook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteBusinessReportSchedule(requestBody: DeleteBusinessReportScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBusinessReportScheduleResponse> {
			return Axios.post<DeleteBusinessReportScheduleResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteBusinessReportSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteConferenceProvider(requestBody: DeleteConferenceProviderRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteConferenceProviderResponse> {
			return Axios.post<DeleteConferenceProviderResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteConferenceProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteContact(requestBody: DeleteContactRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteContactResponse> {
			return Axios.post<DeleteContactResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteContact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDevice(requestBody: DeleteDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDeviceResponse> {
			return Axios.post<DeleteDeviceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDeviceUsageData(requestBody: DeleteDeviceUsageDataRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDeviceUsageDataResponse> {
			return Axios.post<DeleteDeviceUsageDataResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteDeviceUsageData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteGatewayGroup(requestBody: DeleteGatewayGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteGatewayGroupResponse> {
			return Axios.post<DeleteGatewayGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteGatewayGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteNetworkProfile(requestBody: DeleteNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNetworkProfileResponse> {
			return Axios.post<DeleteNetworkProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteProfile(requestBody: DeleteProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProfileResponse> {
			return Axios.post<DeleteProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRoom(requestBody: DeleteRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRoomResponse> {
			return Axios.post<DeleteRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRoomSkillParameter(requestBody: DeleteRoomSkillParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRoomSkillParameterResponse> {
			return Axios.post<DeleteRoomSkillParameterResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteRoomSkillParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSkillAuthorization(requestBody: DeleteSkillAuthorizationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSkillAuthorizationResponse> {
			return Axios.post<DeleteSkillAuthorizationResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteSkillAuthorization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSkillGroup(requestBody: DeleteSkillGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSkillGroupResponse> {
			return Axios.post<DeleteSkillGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteSkillGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteUser(requestBody: DeleteUserRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserResponse> {
			return Axios.post<DeleteUserResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DeleteUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateContactFromAddressBook(requestBody: DisassociateContactFromAddressBookRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateContactFromAddressBookResponse> {
			return Axios.post<DisassociateContactFromAddressBookResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DisassociateContactFromAddressBook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateDeviceFromRoom(requestBody: DisassociateDeviceFromRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateDeviceFromRoomResponse> {
			return Axios.post<DisassociateDeviceFromRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DisassociateDeviceFromRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateSkillFromSkillGroup(requestBody: DisassociateSkillFromSkillGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateSkillFromSkillGroupResponse> {
			return Axios.post<DisassociateSkillFromSkillGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DisassociateSkillFromSkillGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateSkillFromUsers(requestBody: DisassociateSkillFromUsersRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateSkillFromUsersResponse> {
			return Axios.post<DisassociateSkillFromUsersResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DisassociateSkillFromUsers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateSkillGroupFromRoom(requestBody: DisassociateSkillGroupFromRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateSkillGroupFromRoomResponse> {
			return Axios.post<DisassociateSkillGroupFromRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.DisassociateSkillGroupFromRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ForgetSmartHomeAppliances(requestBody: ForgetSmartHomeAppliancesRequest, headersHandler?: () => {[header: string]: string}): Promise<ForgetSmartHomeAppliancesResponse> {
			return Axios.post<ForgetSmartHomeAppliancesResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ForgetSmartHomeAppliances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAddressBook(requestBody: GetAddressBookRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAddressBookResponse> {
			return Axios.post<GetAddressBookResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetAddressBook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetConferencePreference(requestBody: GetConferencePreferenceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConferencePreferenceResponse> {
			return Axios.post<GetConferencePreferenceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetConferencePreference', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetConferenceProvider(requestBody: GetConferenceProviderRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConferenceProviderResponse> {
			return Axios.post<GetConferenceProviderResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetConferenceProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetContact(requestBody: GetContactRequest, headersHandler?: () => {[header: string]: string}): Promise<GetContactResponse> {
			return Axios.post<GetContactResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetContact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDevice(requestBody: GetDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeviceResponse> {
			return Axios.post<GetDeviceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetGateway(requestBody: GetGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<GetGatewayResponse> {
			return Axios.post<GetGatewayResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetGatewayGroup(requestBody: GetGatewayGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<GetGatewayGroupResponse> {
			return Axios.post<GetGatewayGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetGatewayGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetNetworkProfile(requestBody: GetNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNetworkProfileResponse> {
			return Axios.post<GetNetworkProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetProfile(requestBody: GetProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<GetProfileResponse> {
			return Axios.post<GetProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRoom(requestBody: GetRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRoomResponse> {
			return Axios.post<GetRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRoomSkillParameter(requestBody: GetRoomSkillParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRoomSkillParameterResponse> {
			return Axios.post<GetRoomSkillParameterResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetRoomSkillParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSkillGroup(requestBody: GetSkillGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSkillGroupResponse> {
			return Axios.post<GetSkillGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.GetSkillGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListConferenceProviders(MaxResults: string, NextToken: string, requestBody: ListConferenceProvidersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListConferenceProvidersResponse> {
			return Axios.post<ListConferenceProvidersResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ListConferenceProviders?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeviceEvents(MaxResults: string, NextToken: string, requestBody: ListDeviceEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDeviceEventsResponse> {
			return Axios.post<ListDeviceEventsResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ListDeviceEvents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListGatewayGroups(MaxResults: string, NextToken: string, requestBody: ListGatewayGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGatewayGroupsResponse> {
			return Axios.post<ListGatewayGroupsResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ListGatewayGroups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListGateways(MaxResults: string, NextToken: string, requestBody: ListGatewaysRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGatewaysResponse> {
			return Axios.post<ListGatewaysResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ListGateways?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSkills(MaxResults: string, NextToken: string, requestBody: ListSkillsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSkillsResponse> {
			return Axios.post<ListSkillsResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ListSkills?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSmartHomeAppliances(MaxResults: string, NextToken: string, requestBody: ListSmartHomeAppliancesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSmartHomeAppliancesResponse> {
			return Axios.post<ListSmartHomeAppliancesResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ListSmartHomeAppliances?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTags(MaxResults: string, NextToken: string, requestBody: ListTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return Axios.post<ListTagsResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ListTags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutConferencePreference(requestBody: PutConferencePreferenceRequest, headersHandler?: () => {[header: string]: string}): Promise<PutConferencePreferenceResponse> {
			return Axios.post<PutConferencePreferenceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.PutConferencePreference', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutRoomSkillParameter(requestBody: PutRoomSkillParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRoomSkillParameterResponse> {
			return Axios.post<PutRoomSkillParameterResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.PutRoomSkillParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutSkillAuthorization(requestBody: PutSkillAuthorizationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutSkillAuthorizationResponse> {
			return Axios.post<PutSkillAuthorizationResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.PutSkillAuthorization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterAVSDevice(requestBody: RegisterAVSDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterAVSDeviceResponse> {
			return Axios.post<RegisterAVSDeviceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.RegisterAVSDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RejectSkill(requestBody: RejectSkillRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectSkillResponse> {
			return Axios.post<RejectSkillResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.RejectSkill', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ResolveRoom(requestBody: ResolveRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<ResolveRoomResponse> {
			return Axios.post<ResolveRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.ResolveRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RevokeInvitation(requestBody: RevokeInvitationRequest, headersHandler?: () => {[header: string]: string}): Promise<RevokeInvitationResponse> {
			return Axios.post<RevokeInvitationResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.RevokeInvitation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchAddressBooks(MaxResults: string, NextToken: string, requestBody: SearchAddressBooksRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchAddressBooksResponse> {
			return Axios.post<SearchAddressBooksResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchAddressBooks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchContacts(MaxResults: string, NextToken: string, requestBody: SearchContactsRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchContactsResponse> {
			return Axios.post<SearchContactsResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchContacts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchDevices(MaxResults: string, NextToken: string, requestBody: SearchDevicesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchDevicesResponse> {
			return Axios.post<SearchDevicesResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchDevices?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchNetworkProfiles(MaxResults: string, NextToken: string, requestBody: SearchNetworkProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchNetworkProfilesResponse> {
			return Axios.post<SearchNetworkProfilesResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchNetworkProfiles?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchProfiles(MaxResults: string, NextToken: string, requestBody: SearchProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchProfilesResponse> {
			return Axios.post<SearchProfilesResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchProfiles?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchRooms(MaxResults: string, NextToken: string, requestBody: SearchRoomsRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchRoomsResponse> {
			return Axios.post<SearchRoomsResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchRooms?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchSkillGroups(MaxResults: string, NextToken: string, requestBody: SearchSkillGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchSkillGroupsResponse> {
			return Axios.post<SearchSkillGroupsResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchSkillGroups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchUsers(MaxResults: string, NextToken: string, requestBody: SearchUsersRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchUsersResponse> {
			return Axios.post<SearchUsersResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SearchUsers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendAnnouncement(requestBody: SendAnnouncementRequest, headersHandler?: () => {[header: string]: string}): Promise<SendAnnouncementResponse> {
			return Axios.post<SendAnnouncementResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SendAnnouncement', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendInvitation(requestBody: SendInvitationRequest, headersHandler?: () => {[header: string]: string}): Promise<SendInvitationResponse> {
			return Axios.post<SendInvitationResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.SendInvitation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartDeviceSync(requestBody: StartDeviceSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<StartDeviceSyncResponse> {
			return Axios.post<StartDeviceSyncResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.StartDeviceSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartSmartHomeApplianceDiscovery(requestBody: StartSmartHomeApplianceDiscoveryRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSmartHomeApplianceDiscoveryResponse> {
			return Axios.post<StartSmartHomeApplianceDiscoveryResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.StartSmartHomeApplianceDiscovery', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAddressBook(requestBody: UpdateAddressBookRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAddressBookResponse> {
			return Axios.post<UpdateAddressBookResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateAddressBook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateBusinessReportSchedule(requestBody: UpdateBusinessReportScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateBusinessReportScheduleResponse> {
			return Axios.post<UpdateBusinessReportScheduleResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateBusinessReportSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateConferenceProvider(requestBody: UpdateConferenceProviderRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateConferenceProviderResponse> {
			return Axios.post<UpdateConferenceProviderResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateConferenceProvider', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateContact(requestBody: UpdateContactRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateContactResponse> {
			return Axios.post<UpdateContactResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateContact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDevice(requestBody: UpdateDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDeviceResponse> {
			return Axios.post<UpdateDeviceResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateGateway(requestBody: UpdateGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateGatewayResponse> {
			return Axios.post<UpdateGatewayResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateGatewayGroup(requestBody: UpdateGatewayGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateGatewayGroupResponse> {
			return Axios.post<UpdateGatewayGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateGatewayGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateNetworkProfile(requestBody: UpdateNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNetworkProfileResponse> {
			return Axios.post<UpdateNetworkProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateProfile(requestBody: UpdateProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateProfileResponse> {
			return Axios.post<UpdateProfileResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRoom(requestBody: UpdateRoomRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRoomResponse> {
			return Axios.post<UpdateRoomResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateRoom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateSkillGroup(requestBody: UpdateSkillGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSkillGroupResponse> {
			return Axios.post<UpdateSkillGroupResponse>(this.baseUri + '#X-Amz-Target=AlexaForBusiness.UpdateSkillGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
