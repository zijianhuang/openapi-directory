...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchGetTraces(NextToken: string, requestBody: BatchGetTracesBody, headersHandler?: () => HttpHeaders): Observable<BatchGetTracesResult> {
			return this.http.post<BatchGetTracesResult>(this.baseUri + '/Traces?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateGroup(requestBody: CreateGroupBody, headersHandler?: () => HttpHeaders): Observable<CreateGroupResult> {
			return this.http.post<CreateGroupResult>(this.baseUri + '/CreateGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSamplingRule(requestBody: CreateSamplingRuleBody, headersHandler?: () => HttpHeaders): Observable<CreateSamplingRuleResult> {
			return this.http.post<CreateSamplingRuleResult>(this.baseUri + '/CreateSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteGroup(requestBody: DeleteGroupBody, headersHandler?: () => HttpHeaders): Observable<DeleteGroupResult> {
			return this.http.post<DeleteGroupResult>(this.baseUri + '/DeleteGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSamplingRule(requestBody: DeleteSamplingRuleBody, headersHandler?: () => HttpHeaders): Observable<DeleteSamplingRuleResult> {
			return this.http.post<DeleteSamplingRuleResult>(this.baseUri + '/DeleteSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetEncryptionConfig(headersHandler?: () => HttpHeaders): Observable<GetEncryptionConfigResult> {
			return this.http.post<GetEncryptionConfigResult>(this.baseUri + '/EncryptionConfig', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetGroup(requestBody: GetGroupBody, headersHandler?: () => HttpHeaders): Observable<GetGroupResult> {
			return this.http.post<GetGroupResult>(this.baseUri + '/GetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetGroups(NextToken: string, requestBody: GetGroupsBody, headersHandler?: () => HttpHeaders): Observable<GetGroupsResult> {
			return this.http.post<GetGroupsResult>(this.baseUri + '/Groups?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSamplingRules(NextToken: string, requestBody: GetSamplingRulesBody, headersHandler?: () => HttpHeaders): Observable<GetSamplingRulesResult> {
			return this.http.post<GetSamplingRulesResult>(this.baseUri + '/GetSamplingRules?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSamplingStatisticSummaries(NextToken: string, requestBody: GetSamplingStatisticSummariesBody, headersHandler?: () => HttpHeaders): Observable<GetSamplingStatisticSummariesResult> {
			return this.http.post<GetSamplingStatisticSummariesResult>(this.baseUri + '/SamplingStatisticSummaries?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSamplingTargets(requestBody: GetSamplingTargetsBody, headersHandler?: () => HttpHeaders): Observable<GetSamplingTargetsResult> {
			return this.http.post<GetSamplingTargetsResult>(this.baseUri + '/SamplingTargets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetServiceGraph(NextToken: string, requestBody: GetServiceGraphBody, headersHandler?: () => HttpHeaders): Observable<GetServiceGraphResult> {
			return this.http.post<GetServiceGraphResult>(this.baseUri + '/ServiceGraph?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetTimeSeriesServiceStatistics(NextToken: string, requestBody: GetTimeSeriesServiceStatisticsBody, headersHandler?: () => HttpHeaders): Observable<GetTimeSeriesServiceStatisticsResult> {
			return this.http.post<GetTimeSeriesServiceStatisticsResult>(this.baseUri + '/TimeSeriesServiceStatistics?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetTraceGraph(NextToken: string, requestBody: GetTraceGraphBody, headersHandler?: () => HttpHeaders): Observable<GetTraceGraphResult> {
			return this.http.post<GetTraceGraphResult>(this.baseUri + '/TraceGraph?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetTraceSummaries(NextToken: string, requestBody: GetTraceSummariesBody, headersHandler?: () => HttpHeaders): Observable<GetTraceSummariesResult> {
			return this.http.post<GetTraceSummariesResult>(this.baseUri + '/TraceSummaries?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutEncryptionConfig(requestBody: PutEncryptionConfigBody, headersHandler?: () => HttpHeaders): Observable<PutEncryptionConfigResult> {
			return this.http.post<PutEncryptionConfigResult>(this.baseUri + '/PutEncryptionConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutTelemetryRecords(requestBody: PutTelemetryRecordsBody, headersHandler?: () => HttpHeaders): Observable<PutTelemetryRecordsResult> {
			return this.http.post<PutTelemetryRecordsResult>(this.baseUri + '/TelemetryRecords', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutTraceSegments(requestBody: PutTraceSegmentsBody, headersHandler?: () => HttpHeaders): Observable<PutTraceSegmentsResult> {
			return this.http.post<PutTraceSegmentsResult>(this.baseUri + '/TraceSegments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateGroup(requestBody: UpdateGroupBody, headersHandler?: () => HttpHeaders): Observable<UpdateGroupResult> {
			return this.http.post<UpdateGroupResult>(this.baseUri + '/UpdateGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSamplingRule(requestBody: UpdateSamplingRuleBody, headersHandler?: () => HttpHeaders): Observable<UpdateSamplingRuleResult> {
			return this.http.post<UpdateSamplingRuleResult>(this.baseUri + '/UpdateSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
