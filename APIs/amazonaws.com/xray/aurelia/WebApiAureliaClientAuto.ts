...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchGetTraces(NextToken: string, requestBody: BatchGetTracesBody, headersHandler?: () => {[header: string]: string}): Promise<BatchGetTracesResult> {
			return this.http.post('/Traces?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateGroup(requestBody: CreateGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateGroupResult> {
			return this.http.post('/CreateGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSamplingRule(requestBody: CreateSamplingRuleBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSamplingRuleResult> {
			return this.http.post('/CreateSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteGroup(requestBody: DeleteGroupBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteGroupResult> {
			return this.http.post('/DeleteGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSamplingRule(requestBody: DeleteSamplingRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteSamplingRuleResult> {
			return this.http.post('/DeleteSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetEncryptionConfig(headersHandler?: () => {[header: string]: string}): Promise<GetEncryptionConfigResult> {
			return this.http.post('/EncryptionConfig', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetGroup(requestBody: GetGroupBody, headersHandler?: () => {[header: string]: string}): Promise<GetGroupResult> {
			return this.http.post('/GetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetGroups(NextToken: string, requestBody: GetGroupsBody, headersHandler?: () => {[header: string]: string}): Promise<GetGroupsResult> {
			return this.http.post('/Groups?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSamplingRules(NextToken: string, requestBody: GetSamplingRulesBody, headersHandler?: () => {[header: string]: string}): Promise<GetSamplingRulesResult> {
			return this.http.post('/GetSamplingRules?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSamplingStatisticSummaries(NextToken: string, requestBody: GetSamplingStatisticSummariesBody, headersHandler?: () => {[header: string]: string}): Promise<GetSamplingStatisticSummariesResult> {
			return this.http.post('/SamplingStatisticSummaries?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSamplingTargets(requestBody: GetSamplingTargetsBody, headersHandler?: () => {[header: string]: string}): Promise<GetSamplingTargetsResult> {
			return this.http.post('/SamplingTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetServiceGraph(NextToken: string, requestBody: GetServiceGraphBody, headersHandler?: () => {[header: string]: string}): Promise<GetServiceGraphResult> {
			return this.http.post('/ServiceGraph?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTimeSeriesServiceStatistics(NextToken: string, requestBody: GetTimeSeriesServiceStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetTimeSeriesServiceStatisticsResult> {
			return this.http.post('/TimeSeriesServiceStatistics?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTraceGraph(NextToken: string, requestBody: GetTraceGraphBody, headersHandler?: () => {[header: string]: string}): Promise<GetTraceGraphResult> {
			return this.http.post('/TraceGraph?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTraceSummaries(NextToken: string, requestBody: GetTraceSummariesBody, headersHandler?: () => {[header: string]: string}): Promise<GetTraceSummariesResult> {
			return this.http.post('/TraceSummaries?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutEncryptionConfig(requestBody: PutEncryptionConfigBody, headersHandler?: () => {[header: string]: string}): Promise<PutEncryptionConfigResult> {
			return this.http.post('/PutEncryptionConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutTelemetryRecords(requestBody: PutTelemetryRecordsBody, headersHandler?: () => {[header: string]: string}): Promise<PutTelemetryRecordsResult> {
			return this.http.post('/TelemetryRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutTraceSegments(requestBody: PutTraceSegmentsBody, headersHandler?: () => {[header: string]: string}): Promise<PutTraceSegmentsResult> {
			return this.http.post('/TraceSegments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateGroup(requestBody: UpdateGroupBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateGroupResult> {
			return this.http.post('/UpdateGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSamplingRule(requestBody: UpdateSamplingRuleBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSamplingRuleResult> {
			return this.http.post('/UpdateSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
