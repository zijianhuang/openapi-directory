...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchGetTraces(NextToken: string, requestBody: BatchGetTracesBody, headersHandler?: () => {[header: string]: string}): Promise<BatchGetTracesResult> {
			return Axios.post<BatchGetTracesResult>(this.baseUri + '/Traces?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateGroup(requestBody: CreateGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateGroupResult> {
			return Axios.post<CreateGroupResult>(this.baseUri + '/CreateGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateSamplingRule(requestBody: CreateSamplingRuleBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSamplingRuleResult> {
			return Axios.post<CreateSamplingRuleResult>(this.baseUri + '/CreateSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteGroup(requestBody: DeleteGroupBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteGroupResult> {
			return Axios.post<DeleteGroupResult>(this.baseUri + '/DeleteGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteSamplingRule(requestBody: DeleteSamplingRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteSamplingRuleResult> {
			return Axios.post<DeleteSamplingRuleResult>(this.baseUri + '/DeleteSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetEncryptionConfig(headersHandler?: () => {[header: string]: string}): Promise<GetEncryptionConfigResult> {
			return Axios.post<GetEncryptionConfigResult>(this.baseUri + '/EncryptionConfig', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetGroup(requestBody: GetGroupBody, headersHandler?: () => {[header: string]: string}): Promise<GetGroupResult> {
			return Axios.post<GetGroupResult>(this.baseUri + '/GetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetGroups(NextToken: string, requestBody: GetGroupsBody, headersHandler?: () => {[header: string]: string}): Promise<GetGroupsResult> {
			return Axios.post<GetGroupsResult>(this.baseUri + '/Groups?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetSamplingRules(NextToken: string, requestBody: GetSamplingRulesBody, headersHandler?: () => {[header: string]: string}): Promise<GetSamplingRulesResult> {
			return Axios.post<GetSamplingRulesResult>(this.baseUri + '/GetSamplingRules?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetSamplingStatisticSummaries(NextToken: string, requestBody: GetSamplingStatisticSummariesBody, headersHandler?: () => {[header: string]: string}): Promise<GetSamplingStatisticSummariesResult> {
			return Axios.post<GetSamplingStatisticSummariesResult>(this.baseUri + '/SamplingStatisticSummaries?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetSamplingTargets(requestBody: GetSamplingTargetsBody, headersHandler?: () => {[header: string]: string}): Promise<GetSamplingTargetsResult> {
			return Axios.post<GetSamplingTargetsResult>(this.baseUri + '/SamplingTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetServiceGraph(NextToken: string, requestBody: GetServiceGraphBody, headersHandler?: () => {[header: string]: string}): Promise<GetServiceGraphResult> {
			return Axios.post<GetServiceGraphResult>(this.baseUri + '/ServiceGraph?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetTimeSeriesServiceStatistics(NextToken: string, requestBody: GetTimeSeriesServiceStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetTimeSeriesServiceStatisticsResult> {
			return Axios.post<GetTimeSeriesServiceStatisticsResult>(this.baseUri + '/TimeSeriesServiceStatistics?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetTraceGraph(NextToken: string, requestBody: GetTraceGraphBody, headersHandler?: () => {[header: string]: string}): Promise<GetTraceGraphResult> {
			return Axios.post<GetTraceGraphResult>(this.baseUri + '/TraceGraph?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetTraceSummaries(NextToken: string, requestBody: GetTraceSummariesBody, headersHandler?: () => {[header: string]: string}): Promise<GetTraceSummariesResult> {
			return Axios.post<GetTraceSummariesResult>(this.baseUri + '/TraceSummaries?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutEncryptionConfig(requestBody: PutEncryptionConfigBody, headersHandler?: () => {[header: string]: string}): Promise<PutEncryptionConfigResult> {
			return Axios.post<PutEncryptionConfigResult>(this.baseUri + '/PutEncryptionConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutTelemetryRecords(requestBody: PutTelemetryRecordsBody, headersHandler?: () => {[header: string]: string}): Promise<PutTelemetryRecordsResult> {
			return Axios.post<PutTelemetryRecordsResult>(this.baseUri + '/TelemetryRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutTraceSegments(requestBody: PutTraceSegmentsBody, headersHandler?: () => {[header: string]: string}): Promise<PutTraceSegmentsResult> {
			return Axios.post<PutTraceSegmentsResult>(this.baseUri + '/TraceSegments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateGroup(requestBody: UpdateGroupBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateGroupResult> {
			return Axios.post<UpdateGroupResult>(this.baseUri + '/UpdateGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateSamplingRule(requestBody: UpdateSamplingRuleBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSamplingRuleResult> {
			return Axios.post<UpdateSamplingRuleResult>(this.baseUri + '/UpdateSamplingRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
