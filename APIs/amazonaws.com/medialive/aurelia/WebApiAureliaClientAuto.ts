...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchUpdateSchedule(channelId: string, requestBody: BatchUpdateScheduleBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUpdateScheduleResponse> {
			return this.http.put('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSchedule(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteScheduleResponse> {
			return this.http.delete('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeSchedule(channelId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeScheduleResponse> {
			return this.http.get('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/channels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListChannelsResponse> {
			return this.http.get('/prod/channels?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateInput(requestBody: CreateInputBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/inputs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListInputs(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInputsResponse> {
			return this.http.get('/prod/inputs?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateInputSecurityGroup(requestBody: CreateInputSecurityGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInputSecurityGroupResponse> {
			return this.http.post('/prod/inputSecurityGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInputSecurityGroups(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInputSecurityGroupsResponse> {
			return this.http.get('/prod/inputSecurityGroups?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateMultiplex(requestBody: CreateMultiplexBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/multiplexes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListMultiplexes(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMultiplexesResponse> {
			return this.http.get('/prod/multiplexes?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateMultiplexProgram(multiplexId: string, requestBody: CreateMultiplexProgramBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateTags(resource_arn: string, requestBody: CreateTagsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListTagsForResource(resource_arn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.get('/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteChannelResponse> {
			return this.http.delete('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeChannelResponse> {
			return this.http.get('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateChannel(channelId: string, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateChannelResponse> {
			return this.http.put('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInput(inputId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInputResponse> {
			return this.http.delete('/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeInput(inputId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeInputResponse> {
			return this.http.get('/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateInput(inputId: string, requestBody: UpdateInputBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInputResponse> {
			return this.http.put('/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInputSecurityGroup(inputSecurityGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInputSecurityGroupResponse> {
			return this.http.delete('/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeInputSecurityGroup(inputSecurityGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeInputSecurityGroupResponse> {
			return this.http.get('/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateInputSecurityGroup(inputSecurityGroupId: string, requestBody: UpdateInputSecurityGroupBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInputSecurityGroupResponse> {
			return this.http.put('/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMultiplexResponse> {
			return this.http.get('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateMultiplex(multiplexId: string, requestBody: UpdateMultiplexBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateMultiplexResponse> {
			return this.http.put('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMultiplexProgram(multiplexId: string, programName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteMultiplexProgramResponse> {
			return this.http.delete('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeMultiplexProgram(multiplexId: string, programName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMultiplexProgramResponse> {
			return this.http.get('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteReservation(reservationId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteReservationResponse> {
			return this.http.delete('/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeReservation(reservationId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeReservationResponse> {
			return this.http.get('/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateReservation(reservationId: string, requestBody: UpdateReservationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateReservationResponse> {
			return this.http.put('/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTags(resource_arn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeInputDevice(inputDeviceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeInputDeviceResponse> {
			return this.http.get('/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateInputDevice(inputDeviceId: string, requestBody: UpdateInputDeviceBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInputDeviceResponse> {
			return this.http.put('/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOffering(offeringId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeOfferingResponse> {
			return this.http.get('/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListInputDevices(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInputDevicesResponse> {
			return this.http.get('/prod/inputDevices?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListReservations(channelClass: string, codec: string, maxResults: number, maximumBitrate: string, maximumFramerate: string, nextToken: string, resolution: string, resourceType: string, specialFeature: string, videoQuality: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListReservationsResponse> {
			return this.http.get('/prod/reservations?channelClass=' + (channelClass == null ? '' : encodeURIComponent(channelClass)) + '&codec=' + (codec == null ? '' : encodeURIComponent(codec)) + '&maxResults=' + maxResults + '&maximumBitrate=' + (maximumBitrate == null ? '' : encodeURIComponent(maximumBitrate)) + '&maximumFramerate=' + (maximumFramerate == null ? '' : encodeURIComponent(maximumFramerate)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&resolution=' + (resolution == null ? '' : encodeURIComponent(resolution)) + '&resourceType=' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '&specialFeature=' + (specialFeature == null ? '' : encodeURIComponent(specialFeature)) + '&videoQuality=' + (videoQuality == null ? '' : encodeURIComponent(videoQuality)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PurchaseOffering(offeringId: string, requestBody: PurchaseOfferingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)) + '/purchase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StartChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<StartChannelResponse> {
			return this.http.post('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/start', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/start', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StopChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<StopChannelResponse> {
			return this.http.post('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/stop', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StopMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/stop', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateChannelClass(channelId: string, requestBody: UpdateChannelClassBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateChannelClassResponse> {
			return this.http.put('/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/channelClass', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
