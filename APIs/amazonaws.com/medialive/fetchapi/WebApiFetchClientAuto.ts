export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchUpdateSchedule(channelId: string, requestBody: BatchUpdateScheduleBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUpdateScheduleResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSchedule(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteScheduleResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeSchedule(channelId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeScheduleResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/channels', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListChannelsResponse> {
			return fetch(this.baseUri + '/prod/channels?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateInput(requestBody: CreateInputBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/inputs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListInputs(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInputsResponse> {
			return fetch(this.baseUri + '/prod/inputs?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateInputSecurityGroup(requestBody: CreateInputSecurityGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInputSecurityGroupResponse> {
			return fetch(this.baseUri + '/prod/inputSecurityGroups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListInputSecurityGroups(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInputSecurityGroupsResponse> {
			return fetch(this.baseUri + '/prod/inputSecurityGroups?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateMultiplex(requestBody: CreateMultiplexBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/multiplexes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListMultiplexes(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMultiplexesResponse> {
			return fetch(this.baseUri + '/prod/multiplexes?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateMultiplexProgram(multiplexId: string, requestBody: CreateMultiplexProgramBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListMultiplexPrograms(maxResults: number, multiplexId: string, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMultiplexProgramsResponse> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateTags(resource_arn: string, requestBody: CreateTagsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListTagsForResource(resource_arn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteChannelResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeChannelResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateChannel(channelId: string, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateChannelResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteInput(inputId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInputResponse> {
			return fetch(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeInput(inputId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeInputResponse> {
			return fetch(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateInput(inputId: string, requestBody: UpdateInputBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInputResponse> {
			return fetch(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteInputSecurityGroup(inputSecurityGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteInputSecurityGroupResponse> {
			return fetch(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeInputSecurityGroup(inputSecurityGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeInputSecurityGroupResponse> {
			return fetch(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateInputSecurityGroup(inputSecurityGroupId: string, requestBody: UpdateInputSecurityGroupBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInputSecurityGroupResponse> {
			return fetch(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMultiplexResponse> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateMultiplex(multiplexId: string, requestBody: UpdateMultiplexBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateMultiplexResponse> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteMultiplexProgram(multiplexId: string, programName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteMultiplexProgramResponse> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeMultiplexProgram(multiplexId: string, programName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMultiplexProgramResponse> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteReservation(reservationId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteReservationResponse> {
			return fetch(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeReservation(reservationId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeReservationResponse> {
			return fetch(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateReservation(reservationId: string, requestBody: UpdateReservationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateReservationResponse> {
			return fetch(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteTags(resource_arn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeInputDevice(inputDeviceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeInputDeviceResponse> {
			return fetch(this.baseUri + '/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateInputDevice(inputDeviceId: string, requestBody: UpdateInputDeviceBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateInputDeviceResponse> {
			return fetch(this.baseUri + '/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeOffering(offeringId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeOfferingResponse> {
			return fetch(this.baseUri + '/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListInputDevices(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInputDevicesResponse> {
			return fetch(this.baseUri + '/prod/inputDevices?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListOfferings(channelClass: string, channelConfiguration: string, codec: string, duration: string, maxResults: number, maximumBitrate: string, maximumFramerate: string, nextToken: string, resolution: string, resourceType: string, specialFeature: string, videoQuality: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListOfferingsResponse> {
			return fetch(this.baseUri + '/prod/offerings?channelClass=' + (channelClass == null ? '' : encodeURIComponent(channelClass)) + '&channelConfiguration=' + (channelConfiguration == null ? '' : encodeURIComponent(channelConfiguration)) + '&codec=' + (codec == null ? '' : encodeURIComponent(codec)) + '&duration=' + (duration == null ? '' : encodeURIComponent(duration)) + '&maxResults=' + maxResults + '&maximumBitrate=' + (maximumBitrate == null ? '' : encodeURIComponent(maximumBitrate)) + '&maximumFramerate=' + (maximumFramerate == null ? '' : encodeURIComponent(maximumFramerate)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&resolution=' + (resolution == null ? '' : encodeURIComponent(resolution)) + '&resourceType=' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '&specialFeature=' + (specialFeature == null ? '' : encodeURIComponent(specialFeature)) + '&videoQuality=' + (videoQuality == null ? '' : encodeURIComponent(videoQuality)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PurchaseOffering(offeringId: string, requestBody: PurchaseOfferingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)) + '/purchase', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		StartChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<StartChannelResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/start', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		StartMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/start', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StopChannel(channelId: string, headersHandler?: () => {[header: string]: string}): Promise<StopChannelResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/stop', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		StopMultiplex(multiplexId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/stop', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateChannelClass(channelId: string, requestBody: UpdateChannelClassBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateChannelClassResponse> {
			return fetch(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/channelClass', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
