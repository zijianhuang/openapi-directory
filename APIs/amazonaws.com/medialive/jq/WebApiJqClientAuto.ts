...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchUpdateSchedule(channelId: string, callback: (data : BatchUpdateScheduleResponse) => any, requestBody: BatchUpdateScheduleBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSchedule(channelId: string, callback: (data : DeleteScheduleResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeSchedule(channelId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : DescribeScheduleResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		CreateChannel(callback: (data : void) => any, requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/channels', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListChannelsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/channels?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateInput(callback: (data : void) => any, requestBody: CreateInputBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/inputs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListInputs(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListInputsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/inputs?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateInputSecurityGroup(callback: (data : CreateInputSecurityGroupResponse) => any, requestBody: CreateInputSecurityGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/inputSecurityGroups', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListInputSecurityGroups(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListInputSecurityGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/inputSecurityGroups?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateMultiplex(callback: (data : void) => any, requestBody: CreateMultiplexBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/multiplexes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMultiplexes(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListMultiplexesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/multiplexes?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateMultiplexProgram(multiplexId: string, callback: (data : void) => any, requestBody: CreateMultiplexProgramBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMultiplexPrograms(maxResults: number, multiplexId: string, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListMultiplexProgramsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateTags(resource_arn: string, callback: (data : void) => any, requestBody: CreateTagsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListTagsForResource(resource_arn: string, callback: (data : ListTagsForResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteChannel(channelId: string, callback: (data : DeleteChannelResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeChannel(channelId: string, callback: (data : DescribeChannelResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateChannel(channelId: string, callback: (data : UpdateChannelResponse) => any, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteInput(inputId: string, callback: (data : DeleteInputResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeInput(inputId: string, callback: (data : DescribeInputResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateInput(inputId: string, callback: (data : UpdateInputResponse) => any, requestBody: UpdateInputBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteInputSecurityGroup(inputSecurityGroupId: string, callback: (data : DeleteInputSecurityGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeInputSecurityGroup(inputSecurityGroupId: string, callback: (data : DescribeInputSecurityGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateInputSecurityGroup(inputSecurityGroupId: string, callback: (data : UpdateInputSecurityGroupResponse) => any, requestBody: UpdateInputSecurityGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteMultiplex(multiplexId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeMultiplex(multiplexId: string, callback: (data : DescribeMultiplexResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateMultiplex(multiplexId: string, callback: (data : UpdateMultiplexResponse) => any, requestBody: UpdateMultiplexBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteMultiplexProgram(multiplexId: string, programName: string, callback: (data : DeleteMultiplexProgramResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeMultiplexProgram(multiplexId: string, programName: string, callback: (data : DescribeMultiplexProgramResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateMultiplexProgram(multiplexId: string, programName: string, callback: (data : UpdateMultiplexProgramResponse) => any, requestBody: UpdateMultiplexProgramBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteReservation(reservationId: string, callback: (data : DeleteReservationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeReservation(reservationId: string, callback: (data : DescribeReservationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateReservation(reservationId: string, callback: (data : UpdateReservationResponse) => any, requestBody: UpdateReservationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteTags(resource_arn: string, tagKeys: Array<__string>, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeInputDevice(inputDeviceId: string, callback: (data : DescribeInputDeviceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateInputDevice(inputDeviceId: string, callback: (data : UpdateInputDeviceResponse) => any, requestBody: UpdateInputDeviceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeOffering(offeringId: string, callback: (data : DescribeOfferingResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListInputDevices(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListInputDevicesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/inputDevices?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListOfferings(channelClass: string, channelConfiguration: string, codec: string, duration: string, maxResults: number, maximumBitrate: string, maximumFramerate: string, nextToken: string, resolution: string, resourceType: string, specialFeature: string, videoQuality: string, MaxResults: string, NextToken: string, callback: (data : ListOfferingsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/prod/offerings?channelClass=' + (channelClass == null ? '' : encodeURIComponent(channelClass)) + '&channelConfiguration=' + (channelConfiguration == null ? '' : encodeURIComponent(channelConfiguration)) + '&codec=' + (codec == null ? '' : encodeURIComponent(codec)) + '&duration=' + (duration == null ? '' : encodeURIComponent(duration)) + '&maxResults=' + maxResults + '&maximumBitrate=' + (maximumBitrate == null ? '' : encodeURIComponent(maximumBitrate)) + '&maximumFramerate=' + (maximumFramerate == null ? '' : encodeURIComponent(maximumFramerate)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&resolution=' + (resolution == null ? '' : encodeURIComponent(resolution)) + '&resourceType=' + (resourceType == null ? '' : encodeURIComponent(resourceType)) + '&specialFeature=' + (specialFeature == null ? '' : encodeURIComponent(specialFeature)) + '&videoQuality=' + (videoQuality == null ? '' : encodeURIComponent(videoQuality)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListReservations(channelClass: string, codec: string, maxResults: number, maximumBitrate: string, maximumFramerate: string, nextToken: string, resolution: string, resourceType: string, specialFeature: string, videoQuality: string, MaxResults: string, NextToken: string, callback: (data : ListReservationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} 
		 */
		PurchaseOffering(offeringId: string, callback: (data : void) => any, requestBody: PurchaseOfferingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)) + '/purchase', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartChannel(channelId: string, callback: (data : StartChannelResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/start', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		StartMultiplex(multiplexId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/start', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopChannel(channelId: string, callback: (data : StopChannelResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/stop', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		StopMultiplex(multiplexId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/stop', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateChannelClass(channelId: string, callback: (data : UpdateChannelClassResponse) => any, requestBody: UpdateChannelClassBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/channelClass', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
