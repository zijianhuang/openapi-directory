...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchUpdateSchedule(channelId: string, requestBody: BatchUpdateScheduleBody, headersHandler?: () => HttpHeaders): Observable<BatchUpdateScheduleResponse> {
			return this.http.put<BatchUpdateScheduleResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSchedule(channelId: string, headersHandler?: () => HttpHeaders): Observable<DeleteScheduleResponse> {
			return this.http.delete<DeleteScheduleResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/schedule', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeSchedule(channelId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<DescribeScheduleResponse> {
		 ...
		 * @return {void} 
		 */
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/channels', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListChannels(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListChannelsResponse> {
		 ...
		 * @return {void} 
		 */
		CreateInput(requestBody: CreateInputBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/inputs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListInputs(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListInputsResponse> {
			return this.http.get<ListInputsResponse>(this.baseUri + '/prod/inputs?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateInputSecurityGroup(requestBody: CreateInputSecurityGroupBody, headersHandler?: () => HttpHeaders): Observable<CreateInputSecurityGroupResponse> {
			return this.http.post<CreateInputSecurityGroupResponse>(this.baseUri + '/prod/inputSecurityGroups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		CreateMultiplex(requestBody: CreateMultiplexBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/multiplexes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateMultiplexProgram(multiplexId: string, requestBody: CreateMultiplexProgramBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListMultiplexPrograms(maxResults: number, multiplexId: string, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListMultiplexProgramsResponse> {
		 ...
		 * @return {void} 
		 */
		CreateTags(resource_arn: string, requestBody: CreateTagsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		ListTagsForResource(resource_arn: string, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.get<ListTagsForResourceResponse>(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteChannel(channelId: string, headersHandler?: () => HttpHeaders): Observable<DeleteChannelResponse> {
			return this.http.delete<DeleteChannelResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeChannel(channelId: string, headersHandler?: () => HttpHeaders): Observable<DescribeChannelResponse> {
			return this.http.get<DescribeChannelResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateChannel(channelId: string, requestBody: UpdateChannelBody, headersHandler?: () => HttpHeaders): Observable<UpdateChannelResponse> {
			return this.http.put<UpdateChannelResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteInput(inputId: string, headersHandler?: () => HttpHeaders): Observable<DeleteInputResponse> {
			return this.http.delete<DeleteInputResponse>(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeInput(inputId: string, headersHandler?: () => HttpHeaders): Observable<DescribeInputResponse> {
			return this.http.get<DescribeInputResponse>(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateInput(inputId: string, requestBody: UpdateInputBody, headersHandler?: () => HttpHeaders): Observable<UpdateInputResponse> {
			return this.http.put<UpdateInputResponse>(this.baseUri + '/prod/inputs/' + (inputId == null ? '' : encodeURIComponent(inputId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteInputSecurityGroup(inputSecurityGroupId: string, headersHandler?: () => HttpHeaders): Observable<DeleteInputSecurityGroupResponse> {
			return this.http.delete<DeleteInputSecurityGroupResponse>(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeInputSecurityGroup(inputSecurityGroupId: string, headersHandler?: () => HttpHeaders): Observable<DescribeInputSecurityGroupResponse> {
			return this.http.get<DescribeInputSecurityGroupResponse>(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateInputSecurityGroup(inputSecurityGroupId: string, requestBody: UpdateInputSecurityGroupBody, headersHandler?: () => HttpHeaders): Observable<UpdateInputSecurityGroupResponse> {
			return this.http.put<UpdateInputSecurityGroupResponse>(this.baseUri + '/prod/inputSecurityGroups/' + (inputSecurityGroupId == null ? '' : encodeURIComponent(inputSecurityGroupId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteMultiplex(multiplexId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeMultiplex(multiplexId: string, headersHandler?: () => HttpHeaders): Observable<DescribeMultiplexResponse> {
			return this.http.get<DescribeMultiplexResponse>(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateMultiplex(multiplexId: string, requestBody: UpdateMultiplexBody, headersHandler?: () => HttpHeaders): Observable<UpdateMultiplexResponse> {
			return this.http.put<UpdateMultiplexResponse>(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteMultiplexProgram(multiplexId: string, programName: string, headersHandler?: () => HttpHeaders): Observable<DeleteMultiplexProgramResponse> {
			return this.http.delete<DeleteMultiplexProgramResponse>(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeMultiplexProgram(multiplexId: string, programName: string, headersHandler?: () => HttpHeaders): Observable<DescribeMultiplexProgramResponse> {
			return this.http.get<DescribeMultiplexProgramResponse>(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateMultiplexProgram(multiplexId: string, programName: string, requestBody: UpdateMultiplexProgramBody, headersHandler?: () => HttpHeaders): Observable<UpdateMultiplexProgramResponse> {
			return this.http.put<UpdateMultiplexProgramResponse>(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/programs/' + (programName == null ? '' : encodeURIComponent(programName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteReservation(reservationId: string, headersHandler?: () => HttpHeaders): Observable<DeleteReservationResponse> {
			return this.http.delete<DeleteReservationResponse>(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeReservation(reservationId: string, headersHandler?: () => HttpHeaders): Observable<DescribeReservationResponse> {
			return this.http.get<DescribeReservationResponse>(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateReservation(reservationId: string, requestBody: UpdateReservationBody, headersHandler?: () => HttpHeaders): Observable<UpdateReservationResponse> {
			return this.http.put<UpdateReservationResponse>(this.baseUri + '/prod/reservations/' + (reservationId == null ? '' : encodeURIComponent(reservationId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteTags(resource_arn: string, tagKeys: Array<__string>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/prod/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeInputDevice(inputDeviceId: string, headersHandler?: () => HttpHeaders): Observable<DescribeInputDeviceResponse> {
			return this.http.get<DescribeInputDeviceResponse>(this.baseUri + '/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateInputDevice(inputDeviceId: string, requestBody: UpdateInputDeviceBody, headersHandler?: () => HttpHeaders): Observable<UpdateInputDeviceResponse> {
			return this.http.put<UpdateInputDeviceResponse>(this.baseUri + '/prod/inputDevices/' + (inputDeviceId == null ? '' : encodeURIComponent(inputDeviceId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeOffering(offeringId: string, headersHandler?: () => HttpHeaders): Observable<DescribeOfferingResponse> {
			return this.http.get<DescribeOfferingResponse>(this.baseUri + '/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListOfferings(channelClass: string, channelConfiguration: string, codec: string, duration: string, maxResults: number, maximumBitrate: string, maximumFramerate: string, nextToken: string, resolution: string, resourceType: string, specialFeature: string, videoQuality: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListOfferingsResponse> {
		 ...
		 */
		ListReservations(channelClass: string, codec: string, maxResults: number, maximumBitrate: string, maximumFramerate: string, nextToken: string, resolution: string, resourceType: string, specialFeature: string, videoQuality: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListReservationsResponse> {
		 ...
		 * @return {void} 
		 */
		PurchaseOffering(offeringId: string, requestBody: PurchaseOfferingBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/offerings/' + (offeringId == null ? '' : encodeURIComponent(offeringId)) + '/purchase', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		StartChannel(channelId: string, headersHandler?: () => HttpHeaders): Observable<StartChannelResponse> {
			return this.http.post<StartChannelResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/start', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		StartMultiplex(multiplexId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/start', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		StopChannel(channelId: string, headersHandler?: () => HttpHeaders): Observable<StopChannelResponse> {
			return this.http.post<StopChannelResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/stop', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		StopMultiplex(multiplexId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/prod/multiplexes/' + (multiplexId == null ? '' : encodeURIComponent(multiplexId)) + '/stop', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateChannelClass(channelId: string, requestBody: UpdateChannelClassBody, headersHandler?: () => HttpHeaders): Observable<UpdateChannelClassResponse> {
			return this.http.put<UpdateChannelClassResponse>(this.baseUri + '/prod/channels/' + (channelId == null ? '' : encodeURIComponent(channelId)) + '/channelClass', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
