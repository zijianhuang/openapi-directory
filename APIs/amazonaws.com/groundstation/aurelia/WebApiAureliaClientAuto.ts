...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelContact(contactId: string, headersHandler?: () => {[header: string]: string}): Promise<ContactIdResponse> {
			return this.http.delete('/contact/' + (contactId == null ? '' : encodeURIComponent(contactId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeContact(contactId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeContactResponse> {
			return this.http.get('/contact/' + (contactId == null ? '' : encodeURIComponent(contactId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateConfig(requestBody: CreateConfigBody, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return this.http.post('/config', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListConfigs(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListConfigsResponse> {
			return this.http.get('/config?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDataflowEndpointGroup(requestBody: CreateDataflowEndpointGroupBody, headersHandler?: () => {[header: string]: string}): Promise<DataflowEndpointGroupIdResponse> {
			return this.http.post('/dataflowEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDataflowEndpointGroups(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListDataflowEndpointGroupsResponse> {
			return this.http.get('/dataflowEndpointGroup?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateMissionProfile(requestBody: CreateMissionProfileBody, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return this.http.post('/missionprofile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListMissionProfiles(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMissionProfilesResponse> {
			return this.http.get('/missionprofile?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteConfig(configId: string, configType: ConfigIdResponseConfigType, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return this.http.delete('/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetConfig(configId: string, configType: ConfigIdResponseConfigType, headersHandler?: () => {[header: string]: string}): Promise<GetConfigResponse> {
			return this.http.get('/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateConfig(configId: string, configType: ConfigIdResponseConfigType, requestBody: UpdateConfigBody, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return this.http.put('/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDataflowEndpointGroup(dataflowEndpointGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<DataflowEndpointGroupIdResponse> {
			return this.http.delete('/dataflowEndpointGroup/' + (dataflowEndpointGroupId == null ? '' : encodeURIComponent(dataflowEndpointGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDataflowEndpointGroup(dataflowEndpointGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDataflowEndpointGroupResponse> {
			return this.http.get('/dataflowEndpointGroup/' + (dataflowEndpointGroupId == null ? '' : encodeURIComponent(dataflowEndpointGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteMissionProfile(missionProfileId: string, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return this.http.delete('/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMissionProfile(missionProfileId: string, headersHandler?: () => {[header: string]: string}): Promise<GetMissionProfileResponse> {
			return this.http.get('/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateMissionProfile(missionProfileId: string, requestBody: UpdateMissionProfileBody, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return this.http.put('/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMinuteUsage(requestBody: GetMinuteUsageBody, headersHandler?: () => {[header: string]: string}): Promise<GetMinuteUsageResponse> {
			return this.http.post('/minute-usage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSatellite(satelliteId: string, headersHandler?: () => {[header: string]: string}): Promise<GetSatelliteResponse> {
			return this.http.get('/satellite/' + (satelliteId == null ? '' : encodeURIComponent(satelliteId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListContacts(maxResults: string, nextToken: string, requestBody: ListContactsBody, headersHandler?: () => {[header: string]: string}): Promise<ListContactsResponse> {
			return this.http.post('/contacts?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGroundStations(maxResults: number, nextToken: string, satelliteId: string, headersHandler?: () => {[header: string]: string}): Promise<ListGroundStationsResponse> {
			return this.http.get('/groundstation?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&satelliteId=' + (satelliteId == null ? '' : encodeURIComponent(satelliteId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListSatellites(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListSatellitesResponse> {
			return this.http.get('/satellite?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReserveContact(requestBody: ReserveContactBody, headersHandler?: () => {[header: string]: string}): Promise<ContactIdResponse> {
			return this.http.post('/contact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
