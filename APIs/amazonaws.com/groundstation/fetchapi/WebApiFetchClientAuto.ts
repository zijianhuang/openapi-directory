export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelContact(contactId: string, headersHandler?: () => {[header: string]: string}): Promise<ContactIdResponse> {
			return fetch(this.baseUri + '/contact/' + (contactId == null ? '' : encodeURIComponent(contactId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeContact(contactId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeContactResponse> {
			return fetch(this.baseUri + '/contact/' + (contactId == null ? '' : encodeURIComponent(contactId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateConfig(requestBody: CreateConfigBody, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return fetch(this.baseUri + '/config', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListConfigs(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListConfigsResponse> {
			return fetch(this.baseUri + '/config?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDataflowEndpointGroup(requestBody: CreateDataflowEndpointGroupBody, headersHandler?: () => {[header: string]: string}): Promise<DataflowEndpointGroupIdResponse> {
			return fetch(this.baseUri + '/dataflowEndpointGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDataflowEndpointGroups(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListDataflowEndpointGroupsResponse> {
			return fetch(this.baseUri + '/dataflowEndpointGroup?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateMissionProfile(requestBody: CreateMissionProfileBody, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return fetch(this.baseUri + '/missionprofile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListMissionProfiles(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMissionProfilesResponse> {
			return fetch(this.baseUri + '/missionprofile?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteConfig(configId: string, configType: ConfigIdResponseConfigType, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return fetch(this.baseUri + '/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetConfig(configId: string, configType: ConfigIdResponseConfigType, headersHandler?: () => {[header: string]: string}): Promise<GetConfigResponse> {
			return fetch(this.baseUri + '/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateConfig(configId: string, configType: ConfigIdResponseConfigType, requestBody: UpdateConfigBody, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return fetch(this.baseUri + '/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDataflowEndpointGroup(dataflowEndpointGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<DataflowEndpointGroupIdResponse> {
			return fetch(this.baseUri + '/dataflowEndpointGroup/' + (dataflowEndpointGroupId == null ? '' : encodeURIComponent(dataflowEndpointGroupId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDataflowEndpointGroup(dataflowEndpointGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDataflowEndpointGroupResponse> {
			return fetch(this.baseUri + '/dataflowEndpointGroup/' + (dataflowEndpointGroupId == null ? '' : encodeURIComponent(dataflowEndpointGroupId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteMissionProfile(missionProfileId: string, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return fetch(this.baseUri + '/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMissionProfile(missionProfileId: string, headersHandler?: () => {[header: string]: string}): Promise<GetMissionProfileResponse> {
			return fetch(this.baseUri + '/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateMissionProfile(missionProfileId: string, requestBody: UpdateMissionProfileBody, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return fetch(this.baseUri + '/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetMinuteUsage(requestBody: GetMinuteUsageBody, headersHandler?: () => {[header: string]: string}): Promise<GetMinuteUsageResponse> {
			return fetch(this.baseUri + '/minute-usage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSatellite(satelliteId: string, headersHandler?: () => {[header: string]: string}): Promise<GetSatelliteResponse> {
			return fetch(this.baseUri + '/satellite/' + (satelliteId == null ? '' : encodeURIComponent(satelliteId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListGroundStations(maxResults: number, nextToken: string, satelliteId: string, headersHandler?: () => {[header: string]: string}): Promise<ListGroundStationsResponse> {
			return fetch(this.baseUri + '/groundstation?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&satelliteId=' + (satelliteId == null ? '' : encodeURIComponent(satelliteId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListSatellites(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListSatellitesResponse> {
			return fetch(this.baseUri + '/satellite?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReserveContact(requestBody: ReserveContactBody, headersHandler?: () => {[header: string]: string}): Promise<ContactIdResponse> {
			return fetch(this.baseUri + '/contact', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
