...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelContact(contactId: string, headersHandler?: () => {[header: string]: string}): Promise<ContactIdResponse> {
			return Axios.delete<ContactIdResponse>(this.baseUri + '/contact/' + (contactId == null ? '' : encodeURIComponent(contactId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeContact(contactId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeContactResponse> {
			return Axios.get<DescribeContactResponse>(this.baseUri + '/contact/' + (contactId == null ? '' : encodeURIComponent(contactId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateConfig(requestBody: CreateConfigBody, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return Axios.post<ConfigIdResponse>(this.baseUri + '/config', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListConfigs(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListConfigsResponse> {
			return Axios.get<ListConfigsResponse>(this.baseUri + '/config?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateDataflowEndpointGroup(requestBody: CreateDataflowEndpointGroupBody, headersHandler?: () => {[header: string]: string}): Promise<DataflowEndpointGroupIdResponse> {
			return Axios.post<DataflowEndpointGroupIdResponse>(this.baseUri + '/dataflowEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListDataflowEndpointGroups(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListDataflowEndpointGroupsResponse> {
			return Axios.get<ListDataflowEndpointGroupsResponse>(this.baseUri + '/dataflowEndpointGroup?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateMissionProfile(requestBody: CreateMissionProfileBody, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return Axios.post<MissionProfileIdResponse>(this.baseUri + '/missionprofile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListMissionProfiles(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMissionProfilesResponse> {
			return Axios.get<ListMissionProfilesResponse>(this.baseUri + '/missionprofile?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {ConfigIdResponse} Success
		 */
		DeleteConfig(configId: string, configType: ConfigIdResponseConfigType, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return Axios.delete<ConfigIdResponse>(this.baseUri + '/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetConfig(configId: string, configType: ConfigIdResponseConfigType, headersHandler?: () => {[header: string]: string}): Promise<GetConfigResponse> {
			return Axios.get<GetConfigResponse>(this.baseUri + '/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {ConfigIdResponse} Success
		 */
		UpdateConfig(configId: string, configType: ConfigIdResponseConfigType, requestBody: UpdateConfigBody, headersHandler?: () => {[header: string]: string}): Promise<ConfigIdResponse> {
			return Axios.put<ConfigIdResponse>(this.baseUri + '/config/' + configType + '/' + (configId == null ? '' : encodeURIComponent(configId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {DataflowEndpointGroupIdResponse} Success
		 */
		DeleteDataflowEndpointGroup(dataflowEndpointGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<DataflowEndpointGroupIdResponse> {
			return Axios.delete<DataflowEndpointGroupIdResponse>(this.baseUri + '/dataflowEndpointGroup/' + (dataflowEndpointGroupId == null ? '' : encodeURIComponent(dataflowEndpointGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetDataflowEndpointGroup(dataflowEndpointGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDataflowEndpointGroupResponse> {
			return Axios.get<GetDataflowEndpointGroupResponse>(this.baseUri + '/dataflowEndpointGroup/' + (dataflowEndpointGroupId == null ? '' : encodeURIComponent(dataflowEndpointGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {MissionProfileIdResponse} Success
		 */
		DeleteMissionProfile(missionProfileId: string, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return Axios.delete<MissionProfileIdResponse>(this.baseUri + '/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		GetMissionProfile(missionProfileId: string, headersHandler?: () => {[header: string]: string}): Promise<GetMissionProfileResponse> {
			return Axios.get<GetMissionProfileResponse>(this.baseUri + '/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {MissionProfileIdResponse} Success
		 */
		UpdateMissionProfile(missionProfileId: string, requestBody: UpdateMissionProfileBody, headersHandler?: () => {[header: string]: string}): Promise<MissionProfileIdResponse> {
			return Axios.put<MissionProfileIdResponse>(this.baseUri + '/missionprofile/' + (missionProfileId == null ? '' : encodeURIComponent(missionProfileId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetMinuteUsage(requestBody: GetMinuteUsageBody, headersHandler?: () => {[header: string]: string}): Promise<GetMinuteUsageResponse> {
			return Axios.post<GetMinuteUsageResponse>(this.baseUri + '/minute-usage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetSatellite(satelliteId: string, headersHandler?: () => {[header: string]: string}): Promise<GetSatelliteResponse> {
			return Axios.get<GetSatelliteResponse>(this.baseUri + '/satellite/' + (satelliteId == null ? '' : encodeURIComponent(satelliteId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListContacts(maxResults: string, nextToken: string, requestBody: ListContactsBody, headersHandler?: () => {[header: string]: string}): Promise<ListContactsResponse> {
			return Axios.post<ListContactsResponse>(this.baseUri + '/contacts?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListGroundStations(maxResults: number, nextToken: string, satelliteId: string, headersHandler?: () => {[header: string]: string}): Promise<ListGroundStationsResponse> {
			return Axios.get<ListGroundStationsResponse>(this.baseUri + '/groundstation?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&satelliteId=' + (satelliteId == null ? '' : encodeURIComponent(satelliteId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListSatellites(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListSatellitesResponse> {
			return Axios.get<ListSatellitesResponse>(this.baseUri + '/satellite?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {ContactIdResponse} Success
		 */
		ReserveContact(requestBody: ReserveContactBody, headersHandler?: () => {[header: string]: string}): Promise<ContactIdResponse> {
			return Axios.post<ContactIdResponse>(this.baseUri + '/contact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
