...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApi(requestBody: CreateApiBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetApis(maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetApisResponse> {
			return this.http.get('/v2/apis?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ImportApi(basepath: string, failOnWarnings: boolean, requestBody: ImportApiBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v2/apis?basepath=' + (basepath == null ? '' : encodeURIComponent(basepath)) + '&failOnWarnings=' + failOnWarnings, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateApiMapping(domainName: string, requestBody: CreateApiMappingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/domainnames/' + (domainName == null ? '' : encodeURIComponent(domainName)) + '/apimappings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetApiMappings(domainName: string, maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetApiMappingsResponse> {
			return this.http.get('/v2/domainnames/' + (domainName == null ? '' : encodeURIComponent(domainName)) + '/apimappings&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateAuthorizer(apiId: string, requestBody: CreateAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/authorizers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetAuthorizers(apiId: string, maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetAuthorizersResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/authorizers&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDeployment(apiId: string, requestBody: CreateDeploymentBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/deployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetDeployments(apiId: string, maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentsResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/deployments&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDomainName(requestBody: CreateDomainNameBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/domainnames', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetDomainNames(maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetDomainNamesResponse> {
			return this.http.get('/v2/domainnames?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateIntegration(apiId: string, requestBody: CreateIntegrationBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/integrations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetIntegrations(apiId: string, maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetIntegrationsResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/integrations&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateModel(apiId: string, requestBody: CreateModelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/models', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetModels(apiId: string, maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetModelsResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/models&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateRoute(apiId: string, requestBody: CreateRouteBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetRoutes(apiId: string, maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetRoutesResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateRouteResponse(apiId: string, routeId: string, requestBody: CreateRouteResponseBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes/' + (routeId == null ? '' : encodeURIComponent(routeId)) + '/routeresponses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetRouteResponses(apiId: string, maxResults: string, nextToken: string, routeId: string, headersHandler?: () => {[header: string]: string}): Promise<GetRouteResponsesResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes/' + (routeId == null ? '' : encodeURIComponent(routeId)) + '/routeresponses&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateStage(apiId: string, requestBody: CreateStageBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/stages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetStages(apiId: string, maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetStagesResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/stages&maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateVpcLink(requestBody: CreateVpcLinkBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/vpclinks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetVpcLinks(maxResults: string, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<GetVpcLinksResponse> {
			return this.http.get('/v2/vpclinks?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteAccessLogSettings(apiId: string, stageName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/stages/' + (stageName == null ? '' : encodeURIComponent(stageName)) + '/accesslogsettings', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteApi(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetApi(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<GetApiResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ReimportApi(apiId: string, basepath: string, failOnWarnings: boolean, requestBody: ReimportApiBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '&basepath=' + (basepath == null ? '' : encodeURIComponent(basepath)) + '&failOnWarnings=' + failOnWarnings, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteApiMapping(apiMappingId: string, domainName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/domainnames/' + (domainName == null ? '' : encodeURIComponent(domainName)) + '/apimappings/' + (apiMappingId == null ? '' : encodeURIComponent(apiMappingId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetApiMapping(apiMappingId: string, domainName: string, headersHandler?: () => {[header: string]: string}): Promise<GetApiMappingResponse> {
			return this.http.get('/v2/domainnames/' + (domainName == null ? '' : encodeURIComponent(domainName)) + '/apimappings/' + (apiMappingId == null ? '' : encodeURIComponent(apiMappingId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteAuthorizer(apiId: string, authorizerId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/authorizers/' + (authorizerId == null ? '' : encodeURIComponent(authorizerId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAuthorizer(apiId: string, authorizerId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAuthorizerResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/authorizers/' + (authorizerId == null ? '' : encodeURIComponent(authorizerId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteCorsConfiguration(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/cors', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteDeployment(apiId: string, deploymentId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/deployments/' + (deploymentId == null ? '' : encodeURIComponent(deploymentId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDeployment(apiId: string, deploymentId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDeploymentResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/deployments/' + (deploymentId == null ? '' : encodeURIComponent(deploymentId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDomainName(domainName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/domainnames/' + (domainName == null ? '' : encodeURIComponent(domainName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDomainName(domainName: string, headersHandler?: () => {[header: string]: string}): Promise<GetDomainNameResponse> {
			return this.http.get('/v2/domainnames/' + (domainName == null ? '' : encodeURIComponent(domainName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteIntegration(apiId: string, integrationId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/integrations/' + (integrationId == null ? '' : encodeURIComponent(integrationId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetIntegration(apiId: string, integrationId: string, headersHandler?: () => {[header: string]: string}): Promise<GetIntegrationResult> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/integrations/' + (integrationId == null ? '' : encodeURIComponent(integrationId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteIntegrationResponse(apiId: string, integrationId: string, integrationResponseId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/integrations/' + (integrationId == null ? '' : encodeURIComponent(integrationId)) + '/integrationresponses/' + (integrationResponseId == null ? '' : encodeURIComponent(integrationResponseId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetIntegrationResponse(apiId: string, integrationId: string, integrationResponseId: string, headersHandler?: () => {[header: string]: string}): Promise<GetIntegrationResponseResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/integrations/' + (integrationId == null ? '' : encodeURIComponent(integrationId)) + '/integrationresponses/' + (integrationResponseId == null ? '' : encodeURIComponent(integrationResponseId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteModel(apiId: string, modelId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/models/' + (modelId == null ? '' : encodeURIComponent(modelId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetModel(apiId: string, modelId: string, headersHandler?: () => {[header: string]: string}): Promise<GetModelResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/models/' + (modelId == null ? '' : encodeURIComponent(modelId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteRoute(apiId: string, routeId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes/' + (routeId == null ? '' : encodeURIComponent(routeId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetRoute(apiId: string, routeId: string, headersHandler?: () => {[header: string]: string}): Promise<GetRouteResult> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes/' + (routeId == null ? '' : encodeURIComponent(routeId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteRouteRequestParameter(apiId: string, requestParameterKey: string, routeId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes/' + (routeId == null ? '' : encodeURIComponent(routeId)) + '/requestparameters/' + (requestParameterKey == null ? '' : encodeURIComponent(requestParameterKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteRouteResponse(apiId: string, routeId: string, routeResponseId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes/' + (routeId == null ? '' : encodeURIComponent(routeId)) + '/routeresponses/' + (routeResponseId == null ? '' : encodeURIComponent(routeResponseId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetRouteResponse(apiId: string, routeId: string, routeResponseId: string, headersHandler?: () => {[header: string]: string}): Promise<GetRouteResponseResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/routes/' + (routeId == null ? '' : encodeURIComponent(routeId)) + '/routeresponses/' + (routeResponseId == null ? '' : encodeURIComponent(routeResponseId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteRouteSettings(apiId: string, routeKey: string, stageName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/stages/' + (stageName == null ? '' : encodeURIComponent(stageName)) + '/routesettings/' + (routeKey == null ? '' : encodeURIComponent(routeKey)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteStage(apiId: string, stageName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/stages/' + (stageName == null ? '' : encodeURIComponent(stageName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetStage(apiId: string, stageName: string, headersHandler?: () => {[header: string]: string}): Promise<GetStageResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/stages/' + (stageName == null ? '' : encodeURIComponent(stageName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteVpcLink(vpcLinkId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/vpclinks/' + (vpcLinkId == null ? '' : encodeURIComponent(vpcLinkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVpcLink(vpcLinkId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVpcLinkResponse> {
			return this.http.get('/v2/vpclinks/' + (vpcLinkId == null ? '' : encodeURIComponent(vpcLinkId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportApi(apiId: string, exportVersion: string, includeExtensions: boolean, outputType: string, specification: string, stageName: string, headersHandler?: () => {[header: string]: string}): Promise<ExportApiResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/exports/' + (specification == null ? '' : encodeURIComponent(specification)) + '#outputType&exportVersion=' + (exportVersion == null ? '' : encodeURIComponent(exportVersion)) + '&includeExtensions=' + includeExtensions + '&outputType=' + (outputType == null ? '' : encodeURIComponent(outputType)) + '&stageName=' + (stageName == null ? '' : encodeURIComponent(stageName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetModelTemplate(apiId: string, modelId: string, headersHandler?: () => {[header: string]: string}): Promise<GetModelTemplateResponse> {
			return this.http.get('/v2/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/models/' + (modelId == null ? '' : encodeURIComponent(modelId)) + '/template', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetTags(resource_arn: string, headersHandler?: () => {[header: string]: string}): Promise<GetTagsResponse> {
			return this.http.get('/v2/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/v2/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UntagResource(resource_arn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/v2/tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
