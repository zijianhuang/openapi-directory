export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelKeyDeletion(requestBody: CancelKeyDeletionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelKeyDeletionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.CancelKeyDeletion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ConnectCustomKeyStore(requestBody: ConnectCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<ConnectCustomKeyStoreResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ConnectCustomKeyStore', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.CreateAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateCustomKeyStore(requestBody: CreateCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCustomKeyStoreResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.CreateCustomKeyStore', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateGrant(requestBody: CreateGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateGrantResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.CreateGrant', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateKey(requestBody: CreateKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateKeyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.CreateKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Decrypt(requestBody: DecryptRequest, headersHandler?: () => {[header: string]: string}): Promise<DecryptResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.Decrypt', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlias(requestBody: DeleteAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DeleteAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteCustomKeyStore(requestBody: DeleteCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCustomKeyStoreResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DeleteCustomKeyStore', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteImportedKeyMaterial(requestBody: DeleteImportedKeyMaterialRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DeleteImportedKeyMaterial', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeCustomKeyStores(requestBody: DescribeCustomKeyStoresRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCustomKeyStoresResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DescribeCustomKeyStores', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeKey(requestBody: DescribeKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeKeyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DescribeKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DisableKey(requestBody: DisableKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DisableKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DisableKeyRotation(requestBody: DisableKeyRotationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DisableKeyRotation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DisconnectCustomKeyStore(requestBody: DisconnectCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<DisconnectCustomKeyStoreResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.DisconnectCustomKeyStore', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		EnableKey(requestBody: EnableKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.EnableKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		EnableKeyRotation(requestBody: EnableKeyRotationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.EnableKeyRotation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Encrypt(requestBody: EncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<EncryptResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.Encrypt', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GenerateDataKey(requestBody: GenerateDataKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GenerateDataKeyPair(requestBody: GenerateDataKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyPairResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyPair', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GenerateDataKeyPairWithoutPlaintext(requestBody: GenerateDataKeyPairWithoutPlaintextRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyPairWithoutPlaintextResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyPairWithoutPlaintext', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GenerateDataKeyWithoutPlaintext(requestBody: GenerateDataKeyWithoutPlaintextRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyWithoutPlaintextResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyWithoutPlaintext', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GenerateRandom(requestBody: GenerateRandomRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateRandomResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GenerateRandom', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetKeyPolicy(requestBody: GetKeyPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyPolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GetKeyPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetKeyRotationStatus(requestBody: GetKeyRotationStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyRotationStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GetKeyRotationStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetParametersForImport(requestBody: GetParametersForImportRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParametersForImportResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GetParametersForImport', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPublicKey(requestBody: GetPublicKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPublicKeyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.GetPublicKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ImportKeyMaterial(requestBody: ImportKeyMaterialRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportKeyMaterialResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ImportKeyMaterial', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListGrants(Limit: string, Marker: string, requestBody: ListGrantsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGrantsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ListGrants?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListKeyPolicies(Limit: string, Marker: string, requestBody: ListKeyPoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeyPoliciesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ListKeyPolicies?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListKeys(Limit: string, Marker: string, requestBody: ListKeysRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeysResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ListKeys?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListResourceTags(requestBody: ListResourceTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceTagsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ListResourceTags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRetirableGrants(requestBody: ListRetirableGrantsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGrantsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ListRetirableGrants', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutKeyPolicy(requestBody: PutKeyPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.PutKeyPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ReEncrypt(requestBody: ReEncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<ReEncryptResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ReEncrypt', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RetireGrant(requestBody: RetireGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.RetireGrant', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		RevokeGrant(requestBody: RevokeGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.RevokeGrant', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ScheduleKeyDeletion(requestBody: ScheduleKeyDeletionRequest, headersHandler?: () => {[header: string]: string}): Promise<ScheduleKeyDeletionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.ScheduleKeyDeletion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Sign(requestBody: SignRequest, headersHandler?: () => {[header: string]: string}): Promise<SignResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.Sign', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateAlias(requestBody: UpdateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.UpdateAlias', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateCustomKeyStore(requestBody: UpdateCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCustomKeyStoreResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.UpdateCustomKeyStore', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdateKeyDescription(requestBody: UpdateKeyDescriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.UpdateKeyDescription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		Verify(requestBody: VerifyRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=TrentService.Verify', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
