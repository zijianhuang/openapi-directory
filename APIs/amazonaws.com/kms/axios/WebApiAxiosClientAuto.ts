...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelKeyDeletion(requestBody: CancelKeyDeletionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelKeyDeletionResponse> {
			return Axios.post<CancelKeyDeletionResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CancelKeyDeletion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ConnectCustomKeyStore(requestBody: ConnectCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<ConnectCustomKeyStoreResponse> {
			return Axios.post<ConnectCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ConnectCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.CreateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		CreateCustomKeyStore(requestBody: CreateCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCustomKeyStoreResponse> {
			return Axios.post<CreateCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CreateCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateGrant(requestBody: CreateGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateGrantResponse> {
			return Axios.post<CreateGrantResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CreateGrant', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateKey(requestBody: CreateKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateKeyResponse> {
			return Axios.post<CreateKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CreateKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Decrypt(requestBody: DecryptRequest, headersHandler?: () => {[header: string]: string}): Promise<DecryptResponse> {
			return Axios.post<DecryptResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Decrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlias(requestBody: DeleteAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.DeleteAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DeleteCustomKeyStore(requestBody: DeleteCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCustomKeyStoreResponse> {
			return Axios.post<DeleteCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DeleteCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteImportedKeyMaterial(requestBody: DeleteImportedKeyMaterialRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.DeleteImportedKeyMaterial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeCustomKeyStores(requestBody: DescribeCustomKeyStoresRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCustomKeyStoresResponse> {
			return Axios.post<DescribeCustomKeyStoresResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DescribeCustomKeyStores', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeKey(requestBody: DescribeKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeKeyResponse> {
			return Axios.post<DescribeKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DescribeKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DisableKey(requestBody: DisableKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.DisableKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DisableKeyRotation(requestBody: DisableKeyRotationRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.DisableKeyRotation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DisconnectCustomKeyStore(requestBody: DisconnectCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<DisconnectCustomKeyStoreResponse> {
			return Axios.post<DisconnectCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DisconnectCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		EnableKey(requestBody: EnableKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.EnableKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		EnableKeyRotation(requestBody: EnableKeyRotationRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.EnableKeyRotation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		Encrypt(requestBody: EncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<EncryptResponse> {
			return Axios.post<EncryptResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Encrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GenerateDataKey(requestBody: GenerateDataKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyResponse> {
			return Axios.post<GenerateDataKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GenerateDataKeyPair(requestBody: GenerateDataKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyPairResponse> {
			return Axios.post<GenerateDataKeyPairResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GenerateDataKeyPairWithoutPlaintext(requestBody: GenerateDataKeyPairWithoutPlaintextRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyPairWithoutPlaintextResponse> {
			return Axios.post<GenerateDataKeyPairWithoutPlaintextResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyPairWithoutPlaintext', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GenerateDataKeyWithoutPlaintext(requestBody: GenerateDataKeyWithoutPlaintextRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyWithoutPlaintextResponse> {
			return Axios.post<GenerateDataKeyWithoutPlaintextResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyWithoutPlaintext', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GenerateRandom(requestBody: GenerateRandomRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateRandomResponse> {
			return Axios.post<GenerateRandomResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateRandom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetKeyPolicy(requestBody: GetKeyPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyPolicyResponse> {
			return Axios.post<GetKeyPolicyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetKeyPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetKeyRotationStatus(requestBody: GetKeyRotationStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyRotationStatusResponse> {
			return Axios.post<GetKeyRotationStatusResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetKeyRotationStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetParametersForImport(requestBody: GetParametersForImportRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParametersForImportResponse> {
			return Axios.post<GetParametersForImportResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetParametersForImport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetPublicKey(requestBody: GetPublicKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPublicKeyResponse> {
			return Axios.post<GetPublicKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetPublicKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ImportKeyMaterial(requestBody: ImportKeyMaterialRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportKeyMaterialResponse> {
			return Axios.post<ImportKeyMaterialResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ImportKeyMaterial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListAliases(Limit: string, Marker: string, requestBody: ListAliasesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAliasesResponse> {
			return Axios.post<ListAliasesResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListAliases?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListGrants(Limit: string, Marker: string, requestBody: ListGrantsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGrantsResponse> {
			return Axios.post<ListGrantsResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListGrants?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListKeyPolicies(Limit: string, Marker: string, requestBody: ListKeyPoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeyPoliciesResponse> {
			return Axios.post<ListKeyPoliciesResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListKeyPolicies?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListKeys(Limit: string, Marker: string, requestBody: ListKeysRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeysResponse> {
			return Axios.post<ListKeysResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListKeys?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListResourceTags(requestBody: ListResourceTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceTagsResponse> {
			return Axios.post<ListResourceTagsResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListResourceTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {ListGrantsResponse} Success
		 */
		ListRetirableGrants(requestBody: ListRetirableGrantsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGrantsResponse> {
			return Axios.post<ListGrantsResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListRetirableGrants', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		PutKeyPolicy(requestBody: PutKeyPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.PutKeyPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ReEncrypt(requestBody: ReEncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<ReEncryptResponse> {
			return Axios.post<ReEncryptResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ReEncrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RetireGrant(requestBody: RetireGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.RetireGrant', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RevokeGrant(requestBody: RevokeGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.RevokeGrant', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ScheduleKeyDeletion(requestBody: ScheduleKeyDeletionRequest, headersHandler?: () => {[header: string]: string}): Promise<ScheduleKeyDeletionResponse> {
			return Axios.post<ScheduleKeyDeletionResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ScheduleKeyDeletion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Sign(requestBody: SignRequest, headersHandler?: () => {[header: string]: string}): Promise<SignResponse> {
			return Axios.post<SignResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Sign', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateAlias(requestBody: UpdateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.UpdateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		UpdateCustomKeyStore(requestBody: UpdateCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCustomKeyStoreResponse> {
			return Axios.post<UpdateCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.UpdateCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateKeyDescription(requestBody: UpdateKeyDescriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=TrentService.UpdateKeyDescription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		Verify(requestBody: VerifyRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifyResponse> {
			return Axios.post<VerifyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Verify', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
