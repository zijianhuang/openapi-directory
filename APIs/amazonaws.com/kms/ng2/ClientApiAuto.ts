...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelKeyDeletion(requestBody: CancelKeyDeletionRequest, headersHandler?: () => HttpHeaders): Observable<CancelKeyDeletionResponse> {
			return this.http.post<CancelKeyDeletionResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CancelKeyDeletion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ConnectCustomKeyStore(requestBody: ConnectCustomKeyStoreRequest, headersHandler?: () => HttpHeaders): Observable<ConnectCustomKeyStoreResponse> {
			return this.http.post<ConnectCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ConnectCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.CreateAlias', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		CreateCustomKeyStore(requestBody: CreateCustomKeyStoreRequest, headersHandler?: () => HttpHeaders): Observable<CreateCustomKeyStoreResponse> {
			return this.http.post<CreateCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CreateCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateGrant(requestBody: CreateGrantRequest, headersHandler?: () => HttpHeaders): Observable<CreateGrantResponse> {
			return this.http.post<CreateGrantResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CreateGrant', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateKey(requestBody: CreateKeyRequest, headersHandler?: () => HttpHeaders): Observable<CreateKeyResponse> {
			return this.http.post<CreateKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.CreateKey', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Decrypt(requestBody: DecryptRequest, headersHandler?: () => HttpHeaders): Observable<DecryptResponse> {
			return this.http.post<DecryptResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Decrypt', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlias(requestBody: DeleteAliasRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.DeleteAlias', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeleteCustomKeyStore(requestBody: DeleteCustomKeyStoreRequest, headersHandler?: () => HttpHeaders): Observable<DeleteCustomKeyStoreResponse> {
			return this.http.post<DeleteCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DeleteCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteImportedKeyMaterial(requestBody: DeleteImportedKeyMaterialRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.DeleteImportedKeyMaterial', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeCustomKeyStores(requestBody: DescribeCustomKeyStoresRequest, headersHandler?: () => HttpHeaders): Observable<DescribeCustomKeyStoresResponse> {
			return this.http.post<DescribeCustomKeyStoresResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DescribeCustomKeyStores', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeKey(requestBody: DescribeKeyRequest, headersHandler?: () => HttpHeaders): Observable<DescribeKeyResponse> {
			return this.http.post<DescribeKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DescribeKey', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DisableKey(requestBody: DisableKeyRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.DisableKey', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DisableKeyRotation(requestBody: DisableKeyRotationRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.DisableKeyRotation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DisconnectCustomKeyStore(requestBody: DisconnectCustomKeyStoreRequest, headersHandler?: () => HttpHeaders): Observable<DisconnectCustomKeyStoreResponse> {
			return this.http.post<DisconnectCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.DisconnectCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		EnableKey(requestBody: EnableKeyRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.EnableKey', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		EnableKeyRotation(requestBody: EnableKeyRotationRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.EnableKeyRotation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Encrypt(requestBody: EncryptRequest, headersHandler?: () => HttpHeaders): Observable<EncryptResponse> {
			return this.http.post<EncryptResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Encrypt', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GenerateDataKey(requestBody: GenerateDataKeyRequest, headersHandler?: () => HttpHeaders): Observable<GenerateDataKeyResponse> {
			return this.http.post<GenerateDataKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKey', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GenerateDataKeyPair(requestBody: GenerateDataKeyPairRequest, headersHandler?: () => HttpHeaders): Observable<GenerateDataKeyPairResponse> {
			return this.http.post<GenerateDataKeyPairResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GenerateDataKeyPairWithoutPlaintext(requestBody: GenerateDataKeyPairWithoutPlaintextRequest, headersHandler?: () => HttpHeaders): Observable<GenerateDataKeyPairWithoutPlaintextResponse> {
			return this.http.post<GenerateDataKeyPairWithoutPlaintextResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyPairWithoutPlaintext', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GenerateDataKeyWithoutPlaintext(requestBody: GenerateDataKeyWithoutPlaintextRequest, headersHandler?: () => HttpHeaders): Observable<GenerateDataKeyWithoutPlaintextResponse> {
			return this.http.post<GenerateDataKeyWithoutPlaintextResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateDataKeyWithoutPlaintext', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GenerateRandom(requestBody: GenerateRandomRequest, headersHandler?: () => HttpHeaders): Observable<GenerateRandomResponse> {
			return this.http.post<GenerateRandomResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GenerateRandom', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetKeyPolicy(requestBody: GetKeyPolicyRequest, headersHandler?: () => HttpHeaders): Observable<GetKeyPolicyResponse> {
			return this.http.post<GetKeyPolicyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetKeyPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetKeyRotationStatus(requestBody: GetKeyRotationStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetKeyRotationStatusResponse> {
			return this.http.post<GetKeyRotationStatusResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetKeyRotationStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetParametersForImport(requestBody: GetParametersForImportRequest, headersHandler?: () => HttpHeaders): Observable<GetParametersForImportResponse> {
			return this.http.post<GetParametersForImportResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetParametersForImport', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetPublicKey(requestBody: GetPublicKeyRequest, headersHandler?: () => HttpHeaders): Observable<GetPublicKeyResponse> {
			return this.http.post<GetPublicKeyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.GetPublicKey', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ImportKeyMaterial(requestBody: ImportKeyMaterialRequest, headersHandler?: () => HttpHeaders): Observable<ImportKeyMaterialResponse> {
			return this.http.post<ImportKeyMaterialResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ImportKeyMaterial', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAliases(Limit: string, Marker: string, requestBody: ListAliasesRequest, headersHandler?: () => HttpHeaders): Observable<ListAliasesResponse> {
			return this.http.post<ListAliasesResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListAliases?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListGrants(Limit: string, Marker: string, requestBody: ListGrantsRequest, headersHandler?: () => HttpHeaders): Observable<ListGrantsResponse> {
			return this.http.post<ListGrantsResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListGrants?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListKeyPolicies(Limit: string, Marker: string, requestBody: ListKeyPoliciesRequest, headersHandler?: () => HttpHeaders): Observable<ListKeyPoliciesResponse> {
			return this.http.post<ListKeyPoliciesResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListKeyPolicies?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListKeys(Limit: string, Marker: string, requestBody: ListKeysRequest, headersHandler?: () => HttpHeaders): Observable<ListKeysResponse> {
			return this.http.post<ListKeysResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListKeys?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResourceTags(requestBody: ListResourceTagsRequest, headersHandler?: () => HttpHeaders): Observable<ListResourceTagsResponse> {
			return this.http.post<ListResourceTagsResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListResourceTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {ListGrantsResponse} Success
		 */
		ListRetirableGrants(requestBody: ListRetirableGrantsRequest, headersHandler?: () => HttpHeaders): Observable<ListGrantsResponse> {
			return this.http.post<ListGrantsResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ListRetirableGrants', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		PutKeyPolicy(requestBody: PutKeyPolicyRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.PutKeyPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ReEncrypt(requestBody: ReEncryptRequest, headersHandler?: () => HttpHeaders): Observable<ReEncryptResponse> {
			return this.http.post<ReEncryptResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ReEncrypt', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		RetireGrant(requestBody: RetireGrantRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.RetireGrant', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RevokeGrant(requestBody: RevokeGrantRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.RevokeGrant', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ScheduleKeyDeletion(requestBody: ScheduleKeyDeletionRequest, headersHandler?: () => HttpHeaders): Observable<ScheduleKeyDeletionResponse> {
			return this.http.post<ScheduleKeyDeletionResponse>(this.baseUri + '/#X-Amz-Target=TrentService.ScheduleKeyDeletion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Sign(requestBody: SignRequest, headersHandler?: () => HttpHeaders): Observable<SignResponse> {
			return this.http.post<SignResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Sign', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateAlias(requestBody: UpdateAliasRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.UpdateAlias', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateCustomKeyStore(requestBody: UpdateCustomKeyStoreRequest, headersHandler?: () => HttpHeaders): Observable<UpdateCustomKeyStoreResponse> {
			return this.http.post<UpdateCustomKeyStoreResponse>(this.baseUri + '/#X-Amz-Target=TrentService.UpdateCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateKeyDescription(requestBody: UpdateKeyDescriptionRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=TrentService.UpdateKeyDescription', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		Verify(requestBody: VerifyRequest, headersHandler?: () => HttpHeaders): Observable<VerifyResponse> {
			return this.http.post<VerifyResponse>(this.baseUri + '/#X-Amz-Target=TrentService.Verify', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
