...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelKeyDeletion(requestBody: CancelKeyDeletionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelKeyDeletionResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.CancelKeyDeletion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ConnectCustomKeyStore(requestBody: ConnectCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<ConnectCustomKeyStoreResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ConnectCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.CreateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateCustomKeyStore(requestBody: CreateCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCustomKeyStoreResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.CreateCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateGrant(requestBody: CreateGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateGrantResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.CreateGrant', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateKey(requestBody: CreateKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateKeyResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.CreateKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Decrypt(requestBody: DecryptRequest, headersHandler?: () => {[header: string]: string}): Promise<DecryptResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.Decrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAlias(requestBody: DeleteAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.DeleteAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteCustomKeyStore(requestBody: DeleteCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCustomKeyStoreResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.DeleteCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteImportedKeyMaterial(requestBody: DeleteImportedKeyMaterialRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.DeleteImportedKeyMaterial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeCustomKeyStores(requestBody: DescribeCustomKeyStoresRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCustomKeyStoresResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.DescribeCustomKeyStores', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeKey(requestBody: DescribeKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeKeyResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.DescribeKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableKey(requestBody: DisableKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.DisableKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DisableKeyRotation(requestBody: DisableKeyRotationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.DisableKeyRotation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DisconnectCustomKeyStore(requestBody: DisconnectCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<DisconnectCustomKeyStoreResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.DisconnectCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableKey(requestBody: EnableKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.EnableKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		EnableKeyRotation(requestBody: EnableKeyRotationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.EnableKeyRotation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Encrypt(requestBody: EncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<EncryptResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.Encrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GenerateDataKey(requestBody: GenerateDataKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GenerateDataKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GenerateDataKeyPair(requestBody: GenerateDataKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyPairResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GenerateDataKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GenerateDataKeyPairWithoutPlaintext(requestBody: GenerateDataKeyPairWithoutPlaintextRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyPairWithoutPlaintextResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GenerateDataKeyPairWithoutPlaintext', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GenerateDataKeyWithoutPlaintext(requestBody: GenerateDataKeyWithoutPlaintextRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateDataKeyWithoutPlaintextResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GenerateDataKeyWithoutPlaintext', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GenerateRandom(requestBody: GenerateRandomRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateRandomResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GenerateRandom', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetKeyPolicy(requestBody: GetKeyPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyPolicyResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GetKeyPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetKeyRotationStatus(requestBody: GetKeyRotationStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyRotationStatusResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GetKeyRotationStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetParametersForImport(requestBody: GetParametersForImportRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParametersForImportResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GetParametersForImport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPublicKey(requestBody: GetPublicKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPublicKeyResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.GetPublicKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ImportKeyMaterial(requestBody: ImportKeyMaterialRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportKeyMaterialResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ImportKeyMaterial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGrants(Limit: string, Marker: string, requestBody: ListGrantsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGrantsResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ListGrants?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListKeyPolicies(Limit: string, Marker: string, requestBody: ListKeyPoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeyPoliciesResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ListKeyPolicies?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListKeys(Limit: string, Marker: string, requestBody: ListKeysRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeysResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ListKeys?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResourceTags(requestBody: ListResourceTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceTagsResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ListResourceTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListRetirableGrants(requestBody: ListRetirableGrantsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGrantsResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ListRetirableGrants', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutKeyPolicy(requestBody: PutKeyPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.PutKeyPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ReEncrypt(requestBody: ReEncryptRequest, headersHandler?: () => {[header: string]: string}): Promise<ReEncryptResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ReEncrypt', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RetireGrant(requestBody: RetireGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.RetireGrant', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RevokeGrant(requestBody: RevokeGrantRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.RevokeGrant', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ScheduleKeyDeletion(requestBody: ScheduleKeyDeletionRequest, headersHandler?: () => {[header: string]: string}): Promise<ScheduleKeyDeletionResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.ScheduleKeyDeletion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Sign(requestBody: SignRequest, headersHandler?: () => {[header: string]: string}): Promise<SignResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.Sign', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateAlias(requestBody: UpdateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.UpdateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateCustomKeyStore(requestBody: UpdateCustomKeyStoreRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateCustomKeyStoreResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.UpdateCustomKeyStore', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateKeyDescription(requestBody: UpdateKeyDescriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=TrentService.UpdateKeyDescription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		Verify(requestBody: VerifyRequest, headersHandler?: () => {[header: string]: string}): Promise<VerifyResponse> {
			return this.http.post('/#X-Amz-Target=TrentService.Verify', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
