...
export namespace My_Demo_Client {
	...
	export interface StreamingDistributionConfig {
		...
		/**<p>A complex type that specifies the AWS accounts, if any, that you want to allow to create signed URLs for private content.</p> <p>If you want to require signed URLs in requests for objects in the target origin that match the <code>PathPattern</code> for this cache behavior, specify <code>true</code> for <code>Enabled</code>, and specify the applicable values for <code>Quantity</code> and <code>Items</code>. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html">Serving Private Content through CloudFront</a> in the <i> Amazon CloudFront Developer Guide</i>.</p> <p>If you don't want to require signed URLs in requests for objects that match <code>PathPattern</code>, specify <code>false</code> for <code>Enabled</code> and <code>0</code> for <code>Quantity</code>. Omit <code>Items</code>.</p> <p>To add, change, or remove one or more trusted signers, change <code>Enabled</code> to <code>true</code> (if it's currently <code>false</code>), change <code>Quantity</code> as applicable, and specify all of the trusted signers that you want to include in the updated distribution.</p> <p>For more information about updating the distribution configuration, see <a href="https://docs.aws.amazon.com/cloudfront/latest/APIReference/DistributionConfig.html">DistributionConfig</a> in the <i>Amazon CloudFront API Reference</i>.</p> */
		TrustedSigners: TrustedSigners;
		PriceClass?: StreamingDistributionConfigPriceClass;
		Enabled: boolean;
	}

	export enum StreamingDistributionConfigPriceClass { PriceClass_100 = 0, PriceClass_200 = 1, PriceClass_All = 2 }
	...
	export enum CacheBehaviorViewerProtocolPolicy { allow-all = 0, https-only = 1, redirect-to-https = 2 }
	...
	export interface DistributionSummary {
		...
		CustomErrorResponses: CustomErrorResponses;
		Comment: string;
		PriceClass: DistributionSummaryPriceClass;
		Enabled: boolean;
	...
	export enum DistributionSummaryPriceClass { PriceClass_100 = 0, PriceClass_200 = 1, PriceClass_All = 2 }

	export enum DistributionSummaryHttpVersion { http1.1 = 0, http2 = 1 }
	...
	export interface StreamingDistributionSummary {
		...
		TrustedSigners: TrustedSigners;
		Comment: string;
		PriceClass: StreamingDistributionSummaryPriceClass;
		Enabled: boolean;
	}

	export enum StreamingDistributionSummaryPriceClass { PriceClass_100 = 0, PriceClass_200 = 1, PriceClass_All = 2 }
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		ListCloudFrontOriginAccessIdentities2019_03_26(Marker: string, MaxItems: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/origin-access-identity/cloudfront?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListDistributions2019_03_26(Marker: string, MaxItems: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/distribution?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListFieldLevelEncryptionConfigs2019_03_26(Marker: string, MaxItems: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/field-level-encryption?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListFieldLevelEncryptionProfiles2019_03_26(Marker: string, MaxItems: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/field-level-encryption-profile?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListInvalidations2019_03_26(DistributionId: string, Marker: string, MaxItems: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/distribution/' + (DistributionId == null ? '' : encodeURIComponent(DistributionId)) + '/invalidation&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListPublicKeys2019_03_26(Marker: string, MaxItems: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/public-key?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListStreamingDistributions2019_03_26(Marker: string, MaxItems: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/streaming-distribution?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteCloudFrontOriginAccessIdentity2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-03-26/origin-access-identity/cloudfront/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetCloudFrontOriginAccessIdentity2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/origin-access-identity/cloudfront/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDistribution2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-03-26/distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetDistribution2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFieldLevelEncryptionConfig2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-03-26/field-level-encryption/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetFieldLevelEncryption2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/field-level-encryption/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFieldLevelEncryptionProfile2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-03-26/field-level-encryption-profile/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetFieldLevelEncryptionProfile2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/field-level-encryption-profile/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeletePublicKey2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-03-26/public-key/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetPublicKey2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/public-key/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteStreamingDistribution2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/2019-03-26/streaming-distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetStreamingDistribution2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/streaming-distribution/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetCloudFrontOriginAccessIdentityConfig2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/origin-access-identity/cloudfront/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetDistributionConfig2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/distribution/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetFieldLevelEncryptionConfig2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/field-level-encryption/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetFieldLevelEncryptionProfileConfig2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/field-level-encryption-profile/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetInvalidation2019_03_26(DistributionId: string, Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/distribution/' + (DistributionId == null ? '' : encodeURIComponent(DistributionId)) + '/invalidation/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetPublicKeyConfig2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/public-key/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GetStreamingDistributionConfig2019_03_26(Id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/streaming-distribution/' + (Id == null ? '' : encodeURIComponent(Id)) + '/config', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListDistributionsByWebACLId2019_03_26(Marker: string, MaxItems: string, WebACLId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/distributionsByWebACLId/' + (WebACLId == null ? '' : encodeURIComponent(WebACLId)) + '?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ListTagsForResource2019_03_26(Resource: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.get(this.baseUri + '/2019-03-26/tagging#Resource?Resource=' + (Resource == null ? '' : encodeURIComponent(Resource)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
	}
