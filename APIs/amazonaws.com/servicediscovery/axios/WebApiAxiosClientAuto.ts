...
export namespace My_Demo_Client {
	...
	export enum NamespaceSummaryType { DNS_PUBLIC = 0, DNS_PRIVATE = 1, HTTP = 2 }
	...
	export enum OperationFilterCondition { EQ = 0, IN = 1, BETWEEN = 2 }
	...
	export enum OperationSummaryStatus { SUBMITTED = 0, PENDING = 1, SUCCESS = 2, FAIL = 3 }
	...
	export interface ServiceFilter {
		...
		Values: Array<FilterValue>;
		Condition?: ServiceFilterCondition;
	}

	export enum ServiceFilterName { NAMESPACE_ID = 0 }

	export enum ServiceFilterCondition { EQ = 0, IN = 1, BETWEEN = 2 }
	...
	export class DemoClient {
		 ...
		 */
		CreateHttpNamespace(requestBody: CreateHttpNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHttpNamespaceResponse> {
			return Axios.post<CreateHttpNamespaceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreateHttpNamespace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreatePrivateDnsNamespace(requestBody: CreatePrivateDnsNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePrivateDnsNamespaceResponse> {
			return Axios.post<CreatePrivateDnsNamespaceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePrivateDnsNamespace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreatePublicDnsNamespace(requestBody: CreatePublicDnsNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePublicDnsNamespaceResponse> {
			return Axios.post<CreatePublicDnsNamespaceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePublicDnsNamespace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateService(requestBody: CreateServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateServiceResponse> {
			return Axios.post<CreateServiceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreateService', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteNamespace(requestBody: DeleteNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNamespaceResponse> {
			return Axios.post<DeleteNamespaceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DeleteNamespace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteService(requestBody: DeleteServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteServiceResponse> {
			return Axios.post<DeleteServiceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DeleteService', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeregisterInstance(requestBody: DeregisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterInstanceResponse> {
			return Axios.post<DeregisterInstanceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DeregisterInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DiscoverInstances(requestBody: DiscoverInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<DiscoverInstancesResponse> {
			return Axios.post<DiscoverInstancesResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DiscoverInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetInstance(requestBody: GetInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceResponse> {
			return Axios.post<GetInstanceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetInstancesHealthStatus(MaxResults: string, NextToken: string, requestBody: GetInstancesHealthStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstancesHealthStatusResponse> {
			return Axios.post<GetInstancesHealthStatusResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetInstancesHealthStatus?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetNamespace(requestBody: GetNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNamespaceResponse> {
			return Axios.post<GetNamespaceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetNamespace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetOperation(requestBody: GetOperationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationResponse> {
			return Axios.post<GetOperationResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetOperation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetService(requestBody: GetServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetServiceResponse> {
			return Axios.post<GetServiceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetService', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListInstances(MaxResults: string, NextToken: string, requestBody: ListInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListInstancesResponse> {
			return Axios.post<ListInstancesResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListInstances?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListNamespaces(MaxResults: string, NextToken: string, requestBody: ListNamespacesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListNamespacesResponse> {
			return Axios.post<ListNamespacesResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListNamespaces?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListOperations(MaxResults: string, NextToken: string, requestBody: ListOperationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOperationsResponse> {
			return Axios.post<ListOperationsResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListOperations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListServices(MaxResults: string, NextToken: string, requestBody: ListServicesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListServicesResponse> {
			return Axios.post<ListServicesResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListServices?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RegisterInstance(requestBody: RegisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterInstanceResponse> {
			return Axios.post<RegisterInstanceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.RegisterInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateInstanceCustomHealthStatus(requestBody: UpdateInstanceCustomHealthStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateInstanceCustomHealthStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UpdateService(requestBody: UpdateServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServiceResponse> {
			return Axios.post<UpdateServiceResponse>(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateService', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
