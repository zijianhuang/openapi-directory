export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateHttpNamespace(requestBody: CreateHttpNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHttpNamespaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreateHttpNamespace', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePrivateDnsNamespace(requestBody: CreatePrivateDnsNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePrivateDnsNamespaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePrivateDnsNamespace', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePublicDnsNamespace(requestBody: CreatePublicDnsNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePublicDnsNamespaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreatePublicDnsNamespace', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateService(requestBody: CreateServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateServiceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.CreateService', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteNamespace(requestBody: DeleteNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNamespaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DeleteNamespace', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteService(requestBody: DeleteServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteServiceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DeleteService', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeregisterInstance(requestBody: DeregisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DeregisterInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DiscoverInstances(requestBody: DiscoverInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<DiscoverInstancesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.DiscoverInstances', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetInstance(requestBody: GetInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetInstancesHealthStatus(MaxResults: string, NextToken: string, requestBody: GetInstancesHealthStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstancesHealthStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetInstancesHealthStatus?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetNamespace(requestBody: GetNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNamespaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetNamespace', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetOperation(requestBody: GetOperationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetOperation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetService(requestBody: GetServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetServiceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.GetService', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListInstances(MaxResults: string, NextToken: string, requestBody: ListInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListInstancesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListInstances?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListNamespaces(MaxResults: string, NextToken: string, requestBody: ListNamespacesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListNamespacesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListNamespaces?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListOperations(MaxResults: string, NextToken: string, requestBody: ListOperationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOperationsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListOperations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListServices(MaxResults: string, NextToken: string, requestBody: ListServicesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListServicesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListServices?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterInstance(requestBody: RegisterInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.RegisterInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdateInstanceCustomHealthStatus(requestBody: UpdateInstanceCustomHealthStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateInstanceCustomHealthStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateService(requestBody: UpdateServiceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServiceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Route53AutoNaming_v20170314.UpdateService', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
