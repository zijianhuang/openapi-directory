...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ListApplications(max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<Applications> {
			return this.http.get<Applications>(this.baseUri + '/applications?max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateConfigurationProfile(ApplicationId: string, requestBody: CreateConfigurationProfileBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		ListConfigurationProfiles(ApplicationId: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ConfigurationProfiles> {
		 ...
		 * @return {void} 
		 */
		CreateDeploymentStrategy(requestBody: CreateDeploymentStrategyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/deploymentstrategies', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateEnvironment(ApplicationId: string, requestBody: CreateEnvironmentBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/environments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListEnvironments(ApplicationId: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<Environments> {
		 ...
		 */
		GetApplication(ApplicationId: string, headersHandler?: () => HttpHeaders): Observable<Application> {
			return this.http.get<Application>(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteConfigurationProfile(ApplicationId: string, ConfigurationProfileId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/configurationprofiles/' + (ConfigurationProfileId == null ? '' : encodeURIComponent(ConfigurationProfileId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetConfigurationProfile(ApplicationId: string, ConfigurationProfileId: string, headersHandler?: () => HttpHeaders): Observable<ConfigurationProfile> {
			return this.http.get<ConfigurationProfile>(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/configurationprofiles/' + (ConfigurationProfileId == null ? '' : encodeURIComponent(ConfigurationProfileId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDeploymentStrategy(DeploymentStrategyId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/deployementstrategies/' + (DeploymentStrategyId == null ? '' : encodeURIComponent(DeploymentStrategyId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteEnvironment(ApplicationId: string, EnvironmentId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/environments/' + (EnvironmentId == null ? '' : encodeURIComponent(EnvironmentId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetEnvironment(ApplicationId: string, EnvironmentId: string, headersHandler?: () => HttpHeaders): Observable<Environment> {
			return this.http.get<Environment>(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/environments/' + (EnvironmentId == null ? '' : encodeURIComponent(EnvironmentId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetConfiguration(Application: string, Environment: string, Configuration: string, client_id: string, client_configuration_version: string, headersHandler?: () => HttpHeaders): Observable<Configuration> {
		 ...
		 */
		GetDeployment(ApplicationId: string, EnvironmentId: string, DeploymentNumber: number, headersHandler?: () => HttpHeaders): Observable<Deployment> {
			return this.http.get<Deployment>(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/environments/' + (EnvironmentId == null ? '' : encodeURIComponent(EnvironmentId)) + '/deployments/' + DeploymentNumber, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		StopDeployment(ApplicationId: string, EnvironmentId: string, DeploymentNumber: number, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/environments/' + (EnvironmentId == null ? '' : encodeURIComponent(EnvironmentId)) + '/deployments/' + DeploymentNumber, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDeploymentStrategy(DeploymentStrategyId: string, headersHandler?: () => HttpHeaders): Observable<DeploymentStrategy> {
			return this.http.get<DeploymentStrategy>(this.baseUri + '/deploymentstrategies/' + (DeploymentStrategyId == null ? '' : encodeURIComponent(DeploymentStrategyId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListDeployments(ApplicationId: string, EnvironmentId: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<Deployments> {
		 ...
		 * @return {void} 
		 */
		StartDeployment(ApplicationId: string, EnvironmentId: string, requestBody: StartDeploymentBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/applications/' + (ApplicationId == null ? '' : encodeURIComponent(ApplicationId)) + '/environments/' + (EnvironmentId == null ? '' : encodeURIComponent(EnvironmentId)) + '/deployments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListTagsForResource(ResourceArn: string, headersHandler?: () => HttpHeaders): Observable<ResourceTags> {
			return this.http.get<ResourceTags>(this.baseUri + '/tags/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		ValidateConfiguration(ApplicationId: string, ConfigurationProfileId: string, configuration_version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
