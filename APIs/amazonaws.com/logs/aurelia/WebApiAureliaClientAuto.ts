...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateKmsKey(requestBody: AssociateKmsKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.AssociateKmsKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CancelExportTask(requestBody: CancelExportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.CancelExportTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateExportTask(requestBody: CreateExportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateExportTaskResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.CreateExportTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLogGroup(requestBody: CreateLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.CreateLogGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateLogStream(requestBody: CreateLogStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.CreateLogStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteDestination(requestBody: DeleteDestinationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteDestination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteLogGroup(requestBody: DeleteLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteLogGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteLogStream(requestBody: DeleteLogStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteLogStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteMetricFilter(requestBody: DeleteMetricFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteMetricFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteQueryDefinition(requestBody: DeleteQueryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteQueryDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteQueryDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteRetentionPolicy(requestBody: DeleteRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteRetentionPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteSubscriptionFilter(requestBody: DeleteSubscriptionFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DeleteSubscriptionFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeDestinations(limit: string, nextToken: string, requestBody: DescribeDestinationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDestinationsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeDestinations?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeExportTasks(requestBody: DescribeExportTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExportTasksResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeExportTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLogStreams(limit: string, nextToken: string, requestBody: DescribeLogStreamsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLogStreamsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeLogStreams?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMetricFilters(limit: string, nextToken: string, requestBody: DescribeMetricFiltersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMetricFiltersResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeMetricFilters?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeQueries(requestBody: DescribeQueriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeQueriesResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeQueries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeQueryDefinitions(requestBody: DescribeQueryDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeQueryDefinitionsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeQueryDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeResourcePolicies(requestBody: DescribeResourcePoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourcePoliciesResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeResourcePolicies', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSubscriptionFilters(limit: string, nextToken: string, requestBody: DescribeSubscriptionFiltersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSubscriptionFiltersResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DescribeSubscriptionFilters?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateKmsKey(requestBody: DisassociateKmsKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.DisassociateKmsKey', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		FilterLogEvents(limit: string, nextToken: string, requestBody: FilterLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<FilterLogEventsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.FilterLogEvents?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLogEvents(limit: string, nextToken: string, requestBody: GetLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLogEventsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.GetLogEvents?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLogGroupFields(requestBody: GetLogGroupFieldsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLogGroupFieldsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.GetLogGroupFields', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLogRecord(requestBody: GetLogRecordRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLogRecordResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.GetLogRecord', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetQueryResults(requestBody: GetQueryResultsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQueryResultsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.GetQueryResults', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsLogGroup(requestBody: ListTagsLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsLogGroupResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.ListTagsLogGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutDestination(requestBody: PutDestinationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDestinationResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutDestination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutDestinationPolicy(requestBody: PutDestinationPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutDestinationPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutLogEvents(requestBody: PutLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutLogEventsResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutLogEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutMetricFilter(requestBody: PutMetricFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutMetricFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutQueryDefinition(requestBody: PutQueryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<PutQueryDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutQueryDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutRetentionPolicy(requestBody: PutRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutRetentionPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutSubscriptionFilter(requestBody: PutSubscriptionFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.PutSubscriptionFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StartQuery(requestBody: StartQueryRequest, headersHandler?: () => {[header: string]: string}): Promise<StartQueryResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.StartQuery', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopQuery(requestBody: StopQueryRequest, headersHandler?: () => {[header: string]: string}): Promise<StopQueryResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.StopQuery', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagLogGroup(requestBody: TagLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.TagLogGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		TestMetricFilter(requestBody: TestMetricFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<TestMetricFilterResponse> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.TestMetricFilter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagLogGroup(requestBody: UntagLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=Logs_20140328.UntagLogGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
