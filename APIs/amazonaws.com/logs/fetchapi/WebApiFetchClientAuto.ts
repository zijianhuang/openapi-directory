export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AssociateKmsKey(requestBody: AssociateKmsKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.AssociateKmsKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		CancelExportTask(requestBody: CancelExportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.CancelExportTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateExportTask(requestBody: CreateExportTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateExportTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.CreateExportTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		CreateLogGroup(requestBody: CreateLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.CreateLogGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		CreateLogStream(requestBody: CreateLogStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.CreateLogStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDestination(requestBody: DeleteDestinationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteDestination', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLogGroup(requestBody: DeleteLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteLogGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLogStream(requestBody: DeleteLogStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteLogStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMetricFilter(requestBody: DeleteMetricFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteMetricFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteQueryDefinition(requestBody: DeleteQueryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteQueryDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteQueryDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRetentionPolicy(requestBody: DeleteRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteRetentionPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteSubscriptionFilter(requestBody: DeleteSubscriptionFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteSubscriptionFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeExportTasks(requestBody: DescribeExportTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExportTasksResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeExportTasks', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMetricFilters(limit: string, nextToken: string, requestBody: DescribeMetricFiltersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMetricFiltersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeMetricFilters?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeQueries(requestBody: DescribeQueriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeQueriesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeQueries', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeQueryDefinitions(requestBody: DescribeQueryDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeQueryDefinitionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeQueryDefinitions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeResourcePolicies(requestBody: DescribeResourcePoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourcePoliciesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeResourcePolicies', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DisassociateKmsKey(requestBody: DisassociateKmsKeyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.DisassociateKmsKey', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		FilterLogEvents(limit: string, nextToken: string, requestBody: FilterLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<FilterLogEventsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.FilterLogEvents?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetLogEvents(limit: string, nextToken: string, requestBody: GetLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLogEventsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetLogEvents?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetLogGroupFields(requestBody: GetLogGroupFieldsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLogGroupFieldsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetLogGroupFields', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetLogRecord(requestBody: GetLogRecordRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLogRecordResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetLogRecord', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetQueryResults(requestBody: GetQueryResultsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetQueryResultsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetQueryResults', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsLogGroup(requestBody: ListTagsLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsLogGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.ListTagsLogGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutDestination(requestBody: PutDestinationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDestinationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutDestination', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutDestinationPolicy(requestBody: PutDestinationPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutDestinationPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		PutLogEvents(requestBody: PutLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutLogEventsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutLogEvents', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutMetricFilter(requestBody: PutMetricFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutMetricFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		PutQueryDefinition(requestBody: PutQueryDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<PutQueryDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutQueryDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutRetentionPolicy(requestBody: PutRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutRetentionPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		PutSubscriptionFilter(requestBody: PutSubscriptionFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutSubscriptionFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		StartQuery(requestBody: StartQueryRequest, headersHandler?: () => {[header: string]: string}): Promise<StartQueryResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.StartQuery', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopQuery(requestBody: StopQueryRequest, headersHandler?: () => {[header: string]: string}): Promise<StopQueryResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.StopQuery', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		TagLogGroup(requestBody: TagLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.TagLogGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		TestMetricFilter(requestBody: TestMetricFilterRequest, headersHandler?: () => {[header: string]: string}): Promise<TestMetricFilterResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.TestMetricFilter', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UntagLogGroup(requestBody: UntagLogGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Logs_20140328.UntagLogGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
