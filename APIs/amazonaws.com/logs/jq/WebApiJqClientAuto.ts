...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AssociateKmsKey(callback: (data : void) => any, requestBody: AssociateKmsKeyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.AssociateKmsKey', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		CancelExportTask(callback: (data : void) => any, requestBody: CancelExportTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.CancelExportTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateExportTask(callback: (data : CreateExportTaskResponse) => any, requestBody: CreateExportTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.CreateExportTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		CreateLogGroup(callback: (data : void) => any, requestBody: CreateLogGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.CreateLogGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		CreateLogStream(callback: (data : void) => any, requestBody: CreateLogStreamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.CreateLogStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDestination(callback: (data : void) => any, requestBody: DeleteDestinationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteDestination', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLogGroup(callback: (data : void) => any, requestBody: DeleteLogGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteLogGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteLogStream(callback: (data : void) => any, requestBody: DeleteLogStreamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteLogStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMetricFilter(callback: (data : void) => any, requestBody: DeleteMetricFilterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteMetricFilter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteQueryDefinition(callback: (data : DeleteQueryDefinitionResponse) => any, requestBody: DeleteQueryDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteQueryDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteResourcePolicy(callback: (data : void) => any, requestBody: DeleteResourcePolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteResourcePolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRetentionPolicy(callback: (data : void) => any, requestBody: DeleteRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteRetentionPolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteSubscriptionFilter(callback: (data : void) => any, requestBody: DeleteSubscriptionFilterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DeleteSubscriptionFilter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDestinations(limit: string, nextToken: string, callback: (data : DescribeDestinationsResponse) => any, requestBody: DescribeDestinationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeDestinations?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeExportTasks(callback: (data : DescribeExportTasksResponse) => any, requestBody: DescribeExportTasksRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeExportTasks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeLogGroups(limit: string, nextToken: string, callback: (data : DescribeLogGroupsResponse) => any, requestBody: DescribeLogGroupsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeLogGroups?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeLogStreams(limit: string, nextToken: string, callback: (data : DescribeLogStreamsResponse) => any, requestBody: DescribeLogStreamsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeLogStreams?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMetricFilters(limit: string, nextToken: string, callback: (data : DescribeMetricFiltersResponse) => any, requestBody: DescribeMetricFiltersRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeMetricFilters?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeQueries(callback: (data : DescribeQueriesResponse) => any, requestBody: DescribeQueriesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeQueries', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeQueryDefinitions(callback: (data : DescribeQueryDefinitionsResponse) => any, requestBody: DescribeQueryDefinitionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeQueryDefinitions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeResourcePolicies(callback: (data : DescribeResourcePoliciesResponse) => any, requestBody: DescribeResourcePoliciesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeResourcePolicies', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSubscriptionFilters(limit: string, nextToken: string, callback: (data : DescribeSubscriptionFiltersResponse) => any, requestBody: DescribeSubscriptionFiltersRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DescribeSubscriptionFilters?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DisassociateKmsKey(callback: (data : void) => any, requestBody: DisassociateKmsKeyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.DisassociateKmsKey', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		FilterLogEvents(limit: string, nextToken: string, callback: (data : FilterLogEventsResponse) => any, requestBody: FilterLogEventsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.FilterLogEvents?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetLogEvents(limit: string, nextToken: string, callback: (data : GetLogEventsResponse) => any, requestBody: GetLogEventsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetLogEvents?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetLogGroupFields(callback: (data : GetLogGroupFieldsResponse) => any, requestBody: GetLogGroupFieldsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetLogGroupFields', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetLogRecord(callback: (data : GetLogRecordResponse) => any, requestBody: GetLogRecordRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetLogRecord', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetQueryResults(callback: (data : GetQueryResultsResponse) => any, requestBody: GetQueryResultsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.GetQueryResults', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsLogGroup(callback: (data : ListTagsLogGroupResponse) => any, requestBody: ListTagsLogGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.ListTagsLogGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutDestination(callback: (data : PutDestinationResponse) => any, requestBody: PutDestinationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutDestination', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		PutDestinationPolicy(callback: (data : void) => any, requestBody: PutDestinationPolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutDestinationPolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutLogEvents(callback: (data : PutLogEventsResponse) => any, requestBody: PutLogEventsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutLogEvents', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		PutMetricFilter(callback: (data : void) => any, requestBody: PutMetricFilterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutMetricFilter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutQueryDefinition(callback: (data : PutQueryDefinitionResponse) => any, requestBody: PutQueryDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutQueryDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		PutResourcePolicy(callback: (data : PutResourcePolicyResponse) => any, requestBody: PutResourcePolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutResourcePolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		PutRetentionPolicy(callback: (data : void) => any, requestBody: PutRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutRetentionPolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		PutSubscriptionFilter(callback: (data : void) => any, requestBody: PutSubscriptionFilterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.PutSubscriptionFilter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartQuery(callback: (data : StartQueryResponse) => any, requestBody: StartQueryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.StartQuery', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopQuery(callback: (data : StopQueryResponse) => any, requestBody: StopQueryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.StopQuery', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		TagLogGroup(callback: (data : void) => any, requestBody: TagLogGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.TagLogGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TestMetricFilter(callback: (data : TestMetricFilterResponse) => any, requestBody: TestMetricFilterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.TestMetricFilter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UntagLogGroup(callback: (data : void) => any, requestBody: UntagLogGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Logs_20140328.UntagLogGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
