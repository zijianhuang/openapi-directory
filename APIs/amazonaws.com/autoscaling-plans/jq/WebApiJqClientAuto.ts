...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateScalingPlan(callback: (data : CreateScalingPlanResponse) => any, requestBody: CreateScalingPlanRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.CreateScalingPlan', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteScalingPlan(callback: (data : DeleteScalingPlanResponse) => any, requestBody: DeleteScalingPlanRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DeleteScalingPlan', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeScalingPlanResources(callback: (data : DescribeScalingPlanResourcesResponse) => any, requestBody: DescribeScalingPlanResourcesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DescribeScalingPlanResources', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeScalingPlans(callback: (data : DescribeScalingPlansResponse) => any, requestBody: DescribeScalingPlansRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DescribeScalingPlans', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetScalingPlanResourceForecastData(callback: (data : GetScalingPlanResourceForecastDataResponse) => any, requestBody: GetScalingPlanResourceForecastDataRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.GetScalingPlanResourceForecastData', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateScalingPlan(callback: (data : UpdateScalingPlanResponse) => any, requestBody: UpdateScalingPlanRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.UpdateScalingPlan', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
