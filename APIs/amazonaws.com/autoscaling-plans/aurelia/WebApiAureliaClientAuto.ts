...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateScalingPlan(requestBody: CreateScalingPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateScalingPlanResponse> {
			return this.http.post('/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.CreateScalingPlan', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteScalingPlan(requestBody: DeleteScalingPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteScalingPlanResponse> {
			return this.http.post('/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DeleteScalingPlan', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeScalingPlanResources(requestBody: DescribeScalingPlanResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingPlanResourcesResponse> {
			return this.http.post('/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DescribeScalingPlanResources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeScalingPlans(requestBody: DescribeScalingPlansRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingPlansResponse> {
			return this.http.post('/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DescribeScalingPlans', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetScalingPlanResourceForecastData(requestBody: GetScalingPlanResourceForecastDataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetScalingPlanResourceForecastDataResponse> {
			return this.http.post('/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.GetScalingPlanResourceForecastData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateScalingPlan(requestBody: UpdateScalingPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateScalingPlanResponse> {
			return this.http.post('/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.UpdateScalingPlan', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
