export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateScalingPlan(requestBody: CreateScalingPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateScalingPlanResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.CreateScalingPlan', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteScalingPlan(requestBody: DeleteScalingPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteScalingPlanResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DeleteScalingPlan', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeScalingPlans(requestBody: DescribeScalingPlansRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeScalingPlansResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DescribeScalingPlans', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateScalingPlan(requestBody: UpdateScalingPlanRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateScalingPlanResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.UpdateScalingPlan', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
