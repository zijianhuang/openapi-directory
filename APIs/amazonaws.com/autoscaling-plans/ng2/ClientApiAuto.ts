...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateScalingPlan(requestBody: CreateScalingPlanRequest, headersHandler?: () => HttpHeaders): Observable<CreateScalingPlanResponse> {
			return this.http.post<CreateScalingPlanResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.CreateScalingPlan', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteScalingPlan(requestBody: DeleteScalingPlanRequest, headersHandler?: () => HttpHeaders): Observable<DeleteScalingPlanResponse> {
			return this.http.post<DeleteScalingPlanResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DeleteScalingPlan', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeScalingPlanResources(requestBody: DescribeScalingPlanResourcesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeScalingPlanResourcesResponse> {
			return this.http.post<DescribeScalingPlanResourcesResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DescribeScalingPlanResources', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeScalingPlans(requestBody: DescribeScalingPlansRequest, headersHandler?: () => HttpHeaders): Observable<DescribeScalingPlansResponse> {
			return this.http.post<DescribeScalingPlansResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.DescribeScalingPlans', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetScalingPlanResourceForecastData(requestBody: GetScalingPlanResourceForecastDataRequest, headersHandler?: () => HttpHeaders): Observable<GetScalingPlanResourceForecastDataResponse> {
			return this.http.post<GetScalingPlanResourceForecastDataResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.GetScalingPlanResourceForecastData', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateScalingPlan(requestBody: UpdateScalingPlanRequest, headersHandler?: () => HttpHeaders): Observable<UpdateScalingPlanResponse> {
			return this.http.post<UpdateScalingPlanResponse>(this.baseUri + '/#X-Amz-Target=AnyScaleScalingPlannerFrontendService.UpdateScalingPlan', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
