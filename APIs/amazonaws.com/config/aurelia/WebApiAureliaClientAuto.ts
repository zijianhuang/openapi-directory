...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchGetAggregateResourceConfig(requestBody: BatchGetAggregateResourceConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetAggregateResourceConfigResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.BatchGetAggregateResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetResourceConfig(requestBody: BatchGetResourceConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetResourceConfigResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.BatchGetResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAggregationAuthorization(requestBody: DeleteAggregationAuthorizationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteAggregationAuthorization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteConfigRule(requestBody: DeleteConfigRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteConfigurationAggregator(requestBody: DeleteConfigurationAggregatorRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteConfigurationAggregator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteConfigurationRecorder(requestBody: DeleteConfigurationRecorderRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteConfigurationRecorder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteConformancePack(requestBody: DeleteConformancePackRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteDeliveryChannel(requestBody: DeleteDeliveryChannelRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteDeliveryChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteEvaluationResults(requestBody: DeleteEvaluationResultsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEvaluationResultsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteEvaluationResults', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteOrganizationConfigRule(requestBody: DeleteOrganizationConfigRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteOrganizationConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteOrganizationConformancePack(requestBody: DeleteOrganizationConformancePackRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteOrganizationConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeletePendingAggregationRequest(requestBody: DeletePendingAggregationRequestRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeletePendingAggregationRequest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteRemediationConfiguration(requestBody: DeleteRemediationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRemediationConfigurationResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteRemediationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRemediationExceptions(requestBody: DeleteRemediationExceptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRemediationExceptionsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteRemediationExceptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResourceConfig(requestBody: DeleteResourceConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteRetentionConfiguration(requestBody: DeleteRetentionConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeleteRetentionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeliverConfigSnapshot(requestBody: DeliverConfigSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeliverConfigSnapshotResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DeliverConfigSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAggregateComplianceByConfigRules(requestBody: DescribeAggregateComplianceByConfigRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAggregateComplianceByConfigRulesResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeAggregateComplianceByConfigRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAggregationAuthorizations(requestBody: DescribeAggregationAuthorizationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAggregationAuthorizationsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeAggregationAuthorizations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeComplianceByConfigRule(requestBody: DescribeComplianceByConfigRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeComplianceByConfigRuleResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeComplianceByConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeComplianceByResource(requestBody: DescribeComplianceByResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeComplianceByResourceResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeComplianceByResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigRuleEvaluationStatus(requestBody: DescribeConfigRuleEvaluationStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigRuleEvaluationStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConfigRuleEvaluationStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigRules(requestBody: DescribeConfigRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigRulesResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConfigRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigurationAggregatorSourcesStatus(requestBody: DescribeConfigurationAggregatorSourcesStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationAggregatorSourcesStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConfigurationAggregatorSourcesStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigurationAggregators(requestBody: DescribeConfigurationAggregatorsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationAggregatorsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConfigurationAggregators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigurationRecorderStatus(requestBody: DescribeConfigurationRecorderStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationRecorderStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConfigurationRecorderStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConfigurationRecorders(requestBody: DescribeConfigurationRecordersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationRecordersResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConfigurationRecorders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConformancePackCompliance(requestBody: DescribeConformancePackComplianceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConformancePackComplianceResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConformancePackCompliance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConformancePackStatus(requestBody: DescribeConformancePackStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConformancePackStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConformancePackStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConformancePacks(requestBody: DescribeConformancePacksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConformancePacksResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeConformancePacks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDeliveryChannelStatus(requestBody: DescribeDeliveryChannelStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeliveryChannelStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeDeliveryChannelStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDeliveryChannels(requestBody: DescribeDeliveryChannelsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeliveryChannelsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeDeliveryChannels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOrganizationConfigRuleStatuses(requestBody: DescribeOrganizationConfigRuleStatusesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConfigRuleStatusesResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConfigRuleStatuses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOrganizationConfigRules(requestBody: DescribeOrganizationConfigRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConfigRulesResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConfigRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOrganizationConformancePackStatuses(requestBody: DescribeOrganizationConformancePackStatusesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConformancePackStatusesResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConformancePackStatuses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOrganizationConformancePacks(requestBody: DescribeOrganizationConformancePacksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConformancePacksResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConformancePacks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribePendingAggregationRequests(requestBody: DescribePendingAggregationRequestsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePendingAggregationRequestsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribePendingAggregationRequests', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeRemediationConfigurations(requestBody: DescribeRemediationConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRemediationConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeRemediationConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeRemediationExceptions(Limit: string, NextToken: string, requestBody: DescribeRemediationExceptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRemediationExceptionsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeRemediationExceptions?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeRemediationExecutionStatus(Limit: string, NextToken: string, requestBody: DescribeRemediationExecutionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRemediationExecutionStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeRemediationExecutionStatus?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeRetentionConfigurations(requestBody: DescribeRetentionConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRetentionConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.DescribeRetentionConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAggregateComplianceDetailsByConfigRule(requestBody: GetAggregateComplianceDetailsByConfigRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAggregateComplianceDetailsByConfigRuleResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetAggregateComplianceDetailsByConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAggregateConfigRuleComplianceSummary(requestBody: GetAggregateConfigRuleComplianceSummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAggregateConfigRuleComplianceSummaryResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetAggregateConfigRuleComplianceSummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAggregateDiscoveredResourceCounts(requestBody: GetAggregateDiscoveredResourceCountsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAggregateDiscoveredResourceCountsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetAggregateDiscoveredResourceCounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAggregateResourceConfig(requestBody: GetAggregateResourceConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAggregateResourceConfigResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetAggregateResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetComplianceDetailsByConfigRule(requestBody: GetComplianceDetailsByConfigRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<GetComplianceDetailsByConfigRuleResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetComplianceDetailsByConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetComplianceDetailsByResource(requestBody: GetComplianceDetailsByResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetComplianceDetailsByResourceResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetComplianceDetailsByResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetComplianceSummaryByConfigRule(headersHandler?: () => {[header: string]: string}): Promise<GetComplianceSummaryByConfigRuleResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetComplianceSummaryByConfigRule', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetComplianceSummaryByResourceType(requestBody: GetComplianceSummaryByResourceTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<GetComplianceSummaryByResourceTypeResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetComplianceSummaryByResourceType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetConformancePackComplianceDetails(requestBody: GetConformancePackComplianceDetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConformancePackComplianceDetailsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetConformancePackComplianceDetails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetConformancePackComplianceSummary(requestBody: GetConformancePackComplianceSummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConformancePackComplianceSummaryResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetConformancePackComplianceSummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDiscoveredResourceCounts(requestBody: GetDiscoveredResourceCountsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiscoveredResourceCountsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetDiscoveredResourceCounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOrganizationConfigRuleDetailedStatus(requestBody: GetOrganizationConfigRuleDetailedStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOrganizationConfigRuleDetailedStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetOrganizationConfigRuleDetailedStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOrganizationConformancePackDetailedStatus(requestBody: GetOrganizationConformancePackDetailedStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOrganizationConformancePackDetailedStatusResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetOrganizationConformancePackDetailedStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResourceConfigHistory(limit: string, nextToken: string, requestBody: GetResourceConfigHistoryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResourceConfigHistoryResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.GetResourceConfigHistory?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAggregateDiscoveredResources(requestBody: ListAggregateDiscoveredResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAggregateDiscoveredResourcesResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.ListAggregateDiscoveredResources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDiscoveredResources(requestBody: ListDiscoveredResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDiscoveredResourcesResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.ListDiscoveredResources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutAggregationAuthorization(requestBody: PutAggregationAuthorizationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAggregationAuthorizationResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutAggregationAuthorization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutConfigRule(requestBody: PutConfigRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutConfigurationAggregator(requestBody: PutConfigurationAggregatorRequest, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationAggregatorResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutConfigurationAggregator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutConfigurationRecorder(requestBody: PutConfigurationRecorderRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutConfigurationRecorder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutConformancePack(requestBody: PutConformancePackRequest, headersHandler?: () => {[header: string]: string}): Promise<PutConformancePackResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutDeliveryChannel(requestBody: PutDeliveryChannelRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutDeliveryChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutEvaluations(requestBody: PutEvaluationsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutEvaluationsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutEvaluations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutOrganizationConfigRule(requestBody: PutOrganizationConfigRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<PutOrganizationConfigRuleResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutOrganizationConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutOrganizationConformancePack(requestBody: PutOrganizationConformancePackRequest, headersHandler?: () => {[header: string]: string}): Promise<PutOrganizationConformancePackResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutOrganizationConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutRemediationConfigurations(requestBody: PutRemediationConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRemediationConfigurationsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutRemediationConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutRemediationExceptions(requestBody: PutRemediationExceptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRemediationExceptionsResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutRemediationExceptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutResourceConfig(requestBody: PutResourceConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutRetentionConfiguration(requestBody: PutRetentionConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRetentionConfigurationResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.PutRetentionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SelectAggregateResourceConfig(MaxResults: string, NextToken: string, requestBody: SelectAggregateResourceConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<SelectAggregateResourceConfigResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.SelectAggregateResourceConfig?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SelectResourceConfig(requestBody: SelectResourceConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<SelectResourceConfigResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.SelectResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartConfigRulesEvaluation(requestBody: StartConfigRulesEvaluationRequest, headersHandler?: () => {[header: string]: string}): Promise<StartConfigRulesEvaluationResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.StartConfigRulesEvaluation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartConfigurationRecorder(requestBody: StartConfigurationRecorderRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.StartConfigurationRecorder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StartRemediationExecution(requestBody: StartRemediationExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartRemediationExecutionResponse> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.StartRemediationExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopConfigurationRecorder(requestBody: StopConfigurationRecorderRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.StopConfigurationRecorder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=StarlingDoveService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
