...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchGetAggregateResourceConfig(requestBody: BatchGetAggregateResourceConfigRequest, headersHandler?: () => HttpHeaders): Observable<BatchGetAggregateResourceConfigResponse> {
			return this.http.post<BatchGetAggregateResourceConfigResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.BatchGetAggregateResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetResourceConfig(requestBody: BatchGetResourceConfigRequest, headersHandler?: () => HttpHeaders): Observable<BatchGetResourceConfigResponse> {
			return this.http.post<BatchGetResourceConfigResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.BatchGetResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAggregationAuthorization(requestBody: DeleteAggregationAuthorizationRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		DeleteConfigRule(requestBody: DeleteConfigRuleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteConfigurationAggregator(requestBody: DeleteConfigurationAggregatorRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		DeleteConfigurationRecorder(requestBody: DeleteConfigurationRecorderRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteConfigurationRecorder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteConformancePack(requestBody: DeleteConformancePackRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDeliveryChannel(requestBody: DeleteDeliveryChannelRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteDeliveryChannel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeleteEvaluationResults(requestBody: DeleteEvaluationResultsRequest, headersHandler?: () => HttpHeaders): Observable<DeleteEvaluationResultsResponse> {
			return this.http.post<DeleteEvaluationResultsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteEvaluationResults', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteOrganizationConfigRule(requestBody: DeleteOrganizationConfigRuleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteOrganizationConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteOrganizationConformancePack(requestBody: DeleteOrganizationConformancePackRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteOrganizationConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePendingAggregationRequest(requestBody: DeletePendingAggregationRequestRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		DeleteRemediationConfiguration(requestBody: DeleteRemediationConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<DeleteRemediationConfigurationResponse> {
			return this.http.post<DeleteRemediationConfigurationResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteRemediationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRemediationExceptions(requestBody: DeleteRemediationExceptionsRequest, headersHandler?: () => HttpHeaders): Observable<DeleteRemediationExceptionsResponse> {
			return this.http.post<DeleteRemediationExceptionsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteRemediationExceptions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteResourceConfig(requestBody: DeleteResourceConfigRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRetentionConfiguration(requestBody: DeleteRetentionConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeleteRetentionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeliverConfigSnapshot(requestBody: DeliverConfigSnapshotRequest, headersHandler?: () => HttpHeaders): Observable<DeliverConfigSnapshotResponse> {
			return this.http.post<DeliverConfigSnapshotResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DeliverConfigSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAggregateComplianceByConfigRules(requestBody: DescribeAggregateComplianceByConfigRulesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAggregateComplianceByConfigRulesResponse> {
		 ...
		 */
		DescribeAggregationAuthorizations(requestBody: DescribeAggregationAuthorizationsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAggregationAuthorizationsResponse> {
		 ...
		 */
		DescribeComplianceByConfigRule(requestBody: DescribeComplianceByConfigRuleRequest, headersHandler?: () => HttpHeaders): Observable<DescribeComplianceByConfigRuleResponse> {
			return this.http.post<DescribeComplianceByConfigRuleResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeComplianceByConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeComplianceByResource(requestBody: DescribeComplianceByResourceRequest, headersHandler?: () => HttpHeaders): Observable<DescribeComplianceByResourceResponse> {
			return this.http.post<DescribeComplianceByResourceResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeComplianceByResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigRuleEvaluationStatus(requestBody: DescribeConfigRuleEvaluationStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConfigRuleEvaluationStatusResponse> {
			return this.http.post<DescribeConfigRuleEvaluationStatusResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConfigRuleEvaluationStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigRules(requestBody: DescribeConfigRulesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConfigRulesResponse> {
			return this.http.post<DescribeConfigRulesResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConfigRules', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigurationAggregatorSourcesStatus(requestBody: DescribeConfigurationAggregatorSourcesStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConfigurationAggregatorSourcesStatusResponse> {
			return this.http.post<DescribeConfigurationAggregatorSourcesStatusResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConfigurationAggregatorSourcesStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigurationAggregators(requestBody: DescribeConfigurationAggregatorsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConfigurationAggregatorsResponse> {
			return this.http.post<DescribeConfigurationAggregatorsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConfigurationAggregators', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigurationRecorderStatus(requestBody: DescribeConfigurationRecorderStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConfigurationRecorderStatusResponse> {
			return this.http.post<DescribeConfigurationRecorderStatusResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConfigurationRecorderStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConfigurationRecorders(requestBody: DescribeConfigurationRecordersRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConfigurationRecordersResponse> {
			return this.http.post<DescribeConfigurationRecordersResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConfigurationRecorders', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConformancePackCompliance(requestBody: DescribeConformancePackComplianceRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConformancePackComplianceResponse> {
			return this.http.post<DescribeConformancePackComplianceResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConformancePackCompliance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConformancePackStatus(requestBody: DescribeConformancePackStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConformancePackStatusResponse> {
			return this.http.post<DescribeConformancePackStatusResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConformancePackStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConformancePacks(requestBody: DescribeConformancePacksRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConformancePacksResponse> {
			return this.http.post<DescribeConformancePacksResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeConformancePacks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDeliveryChannelStatus(requestBody: DescribeDeliveryChannelStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDeliveryChannelStatusResponse> {
			return this.http.post<DescribeDeliveryChannelStatusResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeDeliveryChannelStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDeliveryChannels(requestBody: DescribeDeliveryChannelsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDeliveryChannelsResponse> {
			return this.http.post<DescribeDeliveryChannelsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeDeliveryChannels', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeOrganizationConfigRuleStatuses(requestBody: DescribeOrganizationConfigRuleStatusesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeOrganizationConfigRuleStatusesResponse> {
			return this.http.post<DescribeOrganizationConfigRuleStatusesResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConfigRuleStatuses', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeOrganizationConfigRules(requestBody: DescribeOrganizationConfigRulesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeOrganizationConfigRulesResponse> {
			return this.http.post<DescribeOrganizationConfigRulesResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConfigRules', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeOrganizationConformancePackStatuses(requestBody: DescribeOrganizationConformancePackStatusesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeOrganizationConformancePackStatusesResponse> {
			return this.http.post<DescribeOrganizationConformancePackStatusesResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConformancePackStatuses', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeOrganizationConformancePacks(requestBody: DescribeOrganizationConformancePacksRequest, headersHandler?: () => HttpHeaders): Observable<DescribeOrganizationConformancePacksResponse> {
			return this.http.post<DescribeOrganizationConformancePacksResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeOrganizationConformancePacks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribePendingAggregationRequests(requestBody: DescribePendingAggregationRequestsRequest, headersHandler?: () => HttpHeaders): Observable<DescribePendingAggregationRequestsResponse> {
			return this.http.post<DescribePendingAggregationRequestsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribePendingAggregationRequests', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRemediationConfigurations(requestBody: DescribeRemediationConfigurationsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRemediationConfigurationsResponse> {
			return this.http.post<DescribeRemediationConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeRemediationConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRemediationExceptions(Limit: string, NextToken: string, requestBody: DescribeRemediationExceptionsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRemediationExceptionsResponse> {
			return this.http.post<DescribeRemediationExceptionsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeRemediationExceptions?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRemediationExecutionStatus(Limit: string, NextToken: string, requestBody: DescribeRemediationExecutionStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRemediationExecutionStatusResponse> {
			return this.http.post<DescribeRemediationExecutionStatusResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeRemediationExecutionStatus?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRetentionConfigurations(requestBody: DescribeRetentionConfigurationsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRetentionConfigurationsResponse> {
			return this.http.post<DescribeRetentionConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.DescribeRetentionConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAggregateComplianceDetailsByConfigRule(requestBody: GetAggregateComplianceDetailsByConfigRuleRequest, headersHandler?: () => HttpHeaders): Observable<GetAggregateComplianceDetailsByConfigRuleResponse> {
			return this.http.post<GetAggregateComplianceDetailsByConfigRuleResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetAggregateComplianceDetailsByConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAggregateConfigRuleComplianceSummary(requestBody: GetAggregateConfigRuleComplianceSummaryRequest, headersHandler?: () => HttpHeaders): Observable<GetAggregateConfigRuleComplianceSummaryResponse> {
			return this.http.post<GetAggregateConfigRuleComplianceSummaryResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetAggregateConfigRuleComplianceSummary', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAggregateDiscoveredResourceCounts(requestBody: GetAggregateDiscoveredResourceCountsRequest, headersHandler?: () => HttpHeaders): Observable<GetAggregateDiscoveredResourceCountsResponse> {
			return this.http.post<GetAggregateDiscoveredResourceCountsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetAggregateDiscoveredResourceCounts', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAggregateResourceConfig(requestBody: GetAggregateResourceConfigRequest, headersHandler?: () => HttpHeaders): Observable<GetAggregateResourceConfigResponse> {
			return this.http.post<GetAggregateResourceConfigResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetAggregateResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetComplianceDetailsByConfigRule(requestBody: GetComplianceDetailsByConfigRuleRequest, headersHandler?: () => HttpHeaders): Observable<GetComplianceDetailsByConfigRuleResponse> {
			return this.http.post<GetComplianceDetailsByConfigRuleResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetComplianceDetailsByConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetComplianceDetailsByResource(requestBody: GetComplianceDetailsByResourceRequest, headersHandler?: () => HttpHeaders): Observable<GetComplianceDetailsByResourceResponse> {
			return this.http.post<GetComplianceDetailsByResourceResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetComplianceDetailsByResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetComplianceSummaryByConfigRule(headersHandler?: () => HttpHeaders): Observable<GetComplianceSummaryByConfigRuleResponse> {
			return this.http.post<GetComplianceSummaryByConfigRuleResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetComplianceSummaryByConfigRule', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetComplianceSummaryByResourceType(requestBody: GetComplianceSummaryByResourceTypeRequest, headersHandler?: () => HttpHeaders): Observable<GetComplianceSummaryByResourceTypeResponse> {
			return this.http.post<GetComplianceSummaryByResourceTypeResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetComplianceSummaryByResourceType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetConformancePackComplianceDetails(requestBody: GetConformancePackComplianceDetailsRequest, headersHandler?: () => HttpHeaders): Observable<GetConformancePackComplianceDetailsResponse> {
			return this.http.post<GetConformancePackComplianceDetailsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetConformancePackComplianceDetails', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetConformancePackComplianceSummary(requestBody: GetConformancePackComplianceSummaryRequest, headersHandler?: () => HttpHeaders): Observable<GetConformancePackComplianceSummaryResponse> {
			return this.http.post<GetConformancePackComplianceSummaryResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetConformancePackComplianceSummary', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDiscoveredResourceCounts(requestBody: GetDiscoveredResourceCountsRequest, headersHandler?: () => HttpHeaders): Observable<GetDiscoveredResourceCountsResponse> {
			return this.http.post<GetDiscoveredResourceCountsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetDiscoveredResourceCounts', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetOrganizationConfigRuleDetailedStatus(requestBody: GetOrganizationConfigRuleDetailedStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetOrganizationConfigRuleDetailedStatusResponse> {
			return this.http.post<GetOrganizationConfigRuleDetailedStatusResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetOrganizationConfigRuleDetailedStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetOrganizationConformancePackDetailedStatus(requestBody: GetOrganizationConformancePackDetailedStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetOrganizationConformancePackDetailedStatusResponse> {
		 ...
		 */
		GetResourceConfigHistory(limit: string, nextToken: string, requestBody: GetResourceConfigHistoryRequest, headersHandler?: () => HttpHeaders): Observable<GetResourceConfigHistoryResponse> {
			return this.http.post<GetResourceConfigHistoryResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.GetResourceConfigHistory?limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAggregateDiscoveredResources(requestBody: ListAggregateDiscoveredResourcesRequest, headersHandler?: () => HttpHeaders): Observable<ListAggregateDiscoveredResourcesResponse> {
		 ...
		 */
		ListDiscoveredResources(requestBody: ListDiscoveredResourcesRequest, headersHandler?: () => HttpHeaders): Observable<ListDiscoveredResourcesResponse> {
			return this.http.post<ListDiscoveredResourcesResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.ListDiscoveredResources', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutAggregationAuthorization(requestBody: PutAggregationAuthorizationRequest, headersHandler?: () => HttpHeaders): Observable<PutAggregationAuthorizationResponse> {
			return this.http.post<PutAggregationAuthorizationResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutAggregationAuthorization', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		PutConfigRule(requestBody: PutConfigRuleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutConfigurationAggregator(requestBody: PutConfigurationAggregatorRequest, headersHandler?: () => HttpHeaders): Observable<PutConfigurationAggregatorResponse> {
			return this.http.post<PutConfigurationAggregatorResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutConfigurationAggregator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		PutConfigurationRecorder(requestBody: PutConfigurationRecorderRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutConfigurationRecorder', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutConformancePack(requestBody: PutConformancePackRequest, headersHandler?: () => HttpHeaders): Observable<PutConformancePackResponse> {
			return this.http.post<PutConformancePackResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		PutDeliveryChannel(requestBody: PutDeliveryChannelRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutDeliveryChannel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutEvaluations(requestBody: PutEvaluationsRequest, headersHandler?: () => HttpHeaders): Observable<PutEvaluationsResponse> {
			return this.http.post<PutEvaluationsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutEvaluations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutOrganizationConfigRule(requestBody: PutOrganizationConfigRuleRequest, headersHandler?: () => HttpHeaders): Observable<PutOrganizationConfigRuleResponse> {
			return this.http.post<PutOrganizationConfigRuleResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutOrganizationConfigRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutOrganizationConformancePack(requestBody: PutOrganizationConformancePackRequest, headersHandler?: () => HttpHeaders): Observable<PutOrganizationConformancePackResponse> {
			return this.http.post<PutOrganizationConformancePackResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutOrganizationConformancePack', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutRemediationConfigurations(requestBody: PutRemediationConfigurationsRequest, headersHandler?: () => HttpHeaders): Observable<PutRemediationConfigurationsResponse> {
			return this.http.post<PutRemediationConfigurationsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutRemediationConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutRemediationExceptions(requestBody: PutRemediationExceptionsRequest, headersHandler?: () => HttpHeaders): Observable<PutRemediationExceptionsResponse> {
			return this.http.post<PutRemediationExceptionsResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutRemediationExceptions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		PutResourceConfig(requestBody: PutResourceConfigRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutRetentionConfiguration(requestBody: PutRetentionConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<PutRetentionConfigurationResponse> {
			return this.http.post<PutRetentionConfigurationResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.PutRetentionConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SelectAggregateResourceConfig(MaxResults: string, NextToken: string, requestBody: SelectAggregateResourceConfigRequest, headersHandler?: () => HttpHeaders): Observable<SelectAggregateResourceConfigResponse> {
			return this.http.post<SelectAggregateResourceConfigResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.SelectAggregateResourceConfig?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SelectResourceConfig(requestBody: SelectResourceConfigRequest, headersHandler?: () => HttpHeaders): Observable<SelectResourceConfigResponse> {
			return this.http.post<SelectResourceConfigResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.SelectResourceConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartConfigRulesEvaluation(requestBody: StartConfigRulesEvaluationRequest, headersHandler?: () => HttpHeaders): Observable<StartConfigRulesEvaluationResponse> {
			return this.http.post<StartConfigRulesEvaluationResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.StartConfigRulesEvaluation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		StartConfigurationRecorder(requestBody: StartConfigurationRecorderRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		StartRemediationExecution(requestBody: StartRemediationExecutionRequest, headersHandler?: () => HttpHeaders): Observable<StartRemediationExecutionResponse> {
			return this.http.post<StartRemediationExecutionResponse>(this.baseUri + '/#X-Amz-Target=StarlingDoveService.StartRemediationExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		StopConfigurationRecorder(requestBody: StopConfigurationRecorderRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=StarlingDoveService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
