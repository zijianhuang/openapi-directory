...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateBotVersion(name: string, requestBody: CreateBotVersionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateIntentVersion(name: string, requestBody: CreateIntentVersionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateSlotTypeVersion(name: string, requestBody: CreateSlotTypeVersionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBot(name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotAlias(name: string, botName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetBotAlias(name: string, botName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotAliasResponse> {
			return Axios.get<GetBotAliasResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutBotAlias(name: string, botName: string, requestBody: PutBotAliasBody, headersHandler?: () => {[header: string]: string}): Promise<PutBotAliasResponse> {
			return Axios.put<PutBotAliasResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotChannelAssociation(name: string, botName: string, aliasName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetBotChannelAssociation(name: string, botName: string, aliasName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotChannelAssociationResponse> {
			return Axios.get<GetBotChannelAssociationResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotVersion(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntent(name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntentVersion(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetIntent(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetIntentResponse> {
			return Axios.get<GetIntentResponse>(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteSlotType(name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteSlotTypeVersion(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/version/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUtterances(botName: string, userId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/utterances/' + (userId == null ? '' : encodeURIComponent(userId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetBot(name: string, versionoralias: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotResponse> {
			return Axios.get<GetBotResponse>(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (versionoralias == null ? '' : encodeURIComponent(versionoralias)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBotAliases(botName: string, nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotAliasesResponse> {
			return Axios.get<GetBotAliasesResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBotVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetBotVersionsResponse> {
			return Axios.get<GetBotVersionsResponse>(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBots(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotsResponse> {
			return Axios.get<GetBotsResponse>(this.baseUri + '/bots/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBuiltinIntent(signature: string, headersHandler?: () => {[header: string]: string}): Promise<GetBuiltinIntentResponse> {
			return Axios.get<GetBuiltinIntentResponse>(this.baseUri + '/builtins/intents/' + (signature == null ? '' : encodeURIComponent(signature)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBuiltinIntents(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetBuiltinIntentsResponse> {
			return Axios.get<GetBuiltinIntentsResponse>(this.baseUri + '/builtins/intents/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBuiltinSlotTypes(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetBuiltinSlotTypesResponse> {
			return Axios.get<GetBuiltinSlotTypesResponse>(this.baseUri + '/builtins/slottypes/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetExport(name: string, version: string, resourceType: GetExportResponseResourceType, exportType: GetExportResponseExportType, headersHandler?: () => {[header: string]: string}): Promise<GetExportResponse> {
			return Axios.get<GetExportResponse>(this.baseUri + '/exports/#name&version&resourceType&exportType?name=' + (name == null ? '' : encodeURIComponent(name)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&resourceType=' + resourceType + '&exportType=' + exportType, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetImport(importId: string, headersHandler?: () => {[header: string]: string}): Promise<GetImportResponse> {
			return Axios.get<GetImportResponse>(this.baseUri + '/imports/' + (importId == null ? '' : encodeURIComponent(importId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetIntentVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetIntentVersionsResponse> {
			return Axios.get<GetIntentVersionsResponse>(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetIntents(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetIntentsResponse> {
			return Axios.get<GetIntentsResponse>(this.baseUri + '/intents/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetSlotType(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetSlotTypeResponse> {
			return Axios.get<GetSlotTypeResponse>(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetSlotTypeVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetSlotTypeVersionsResponse> {
			return Axios.get<GetSlotTypeVersionsResponse>(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetSlotTypes(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetSlotTypesResponse> {
			return Axios.get<GetSlotTypesResponse>(this.baseUri + '/slottypes/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutBot(name: string, requestBody: PutBotBody, headersHandler?: () => {[header: string]: string}): Promise<PutBotResponse> {
			return Axios.put<PutBotResponse>(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutIntent(name: string, requestBody: PutIntentBody, headersHandler?: () => {[header: string]: string}): Promise<PutIntentResponse> {
			return Axios.put<PutIntentResponse>(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutSlotType(name: string, requestBody: PutSlotTypeBody, headersHandler?: () => {[header: string]: string}): Promise<PutSlotTypeResponse> {
			return Axios.put<PutSlotTypeResponse>(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		StartImport(requestBody: StartImportBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/imports/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
