...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateBotVersion(name: string, requestBody: CreateBotVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateIntentVersion(name: string, requestBody: CreateIntentVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateSlotTypeVersion(name: string, requestBody: CreateSlotTypeVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteBot(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/bots/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteBotAlias(name: string, botName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBotAlias(name: string, botName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotAliasResponse> {
			return this.http.get('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutBotAlias(name: string, botName: string, requestBody: PutBotAliasBody, headersHandler?: () => {[header: string]: string}): Promise<PutBotAliasResponse> {
			return this.http.put('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteBotChannelAssociation(name: string, botName: string, aliasName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBotChannelAssociation(name: string, botName: string, aliasName: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotChannelAssociationResponse> {
			return this.http.get('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteBotVersion(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteIntent(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/intents/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteIntentVersion(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetIntent(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetIntentResponse> {
			return this.http.get('/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteSlotType(name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/slottypes/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteSlotTypeVersion(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/version/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteUtterances(botName: string, userId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/utterances/' + (userId == null ? '' : encodeURIComponent(userId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBot(name: string, versionoralias: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotResponse> {
			return this.http.get('/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (versionoralias == null ? '' : encodeURIComponent(versionoralias)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBotAliases(botName: string, nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotAliasesResponse> {
			return this.http.get('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBotChannelAssociations(botName: string, aliasName: string, nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotChannelAssociationsResponse> {
			return this.http.get('/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBotVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetBotVersionsResponse> {
			return this.http.get('/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBots(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotsResponse> {
			return this.http.get('/bots/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBuiltinIntent(signature: string, headersHandler?: () => {[header: string]: string}): Promise<GetBuiltinIntentResponse> {
			return this.http.get('/builtins/intents/' + (signature == null ? '' : encodeURIComponent(signature)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBuiltinIntents(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetBuiltinIntentsResponse> {
			return this.http.get('/builtins/intents/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBuiltinSlotTypes(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetBuiltinSlotTypesResponse> {
			return this.http.get('/builtins/slottypes/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetExport(name: string, version: string, resourceType: GetExportResponseResourceType, exportType: GetExportResponseExportType, headersHandler?: () => {[header: string]: string}): Promise<GetExportResponse> {
			return this.http.get('/exports/#name&version&resourceType&exportType?name=' + (name == null ? '' : encodeURIComponent(name)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&resourceType=' + resourceType + '&exportType=' + exportType, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetImport(importId: string, headersHandler?: () => {[header: string]: string}): Promise<GetImportResponse> {
			return this.http.get('/imports/' + (importId == null ? '' : encodeURIComponent(importId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetIntentVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetIntentVersionsResponse> {
			return this.http.get('/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetIntents(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetIntentsResponse> {
			return this.http.get('/intents/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSlotType(name: string, version: string, headersHandler?: () => {[header: string]: string}): Promise<GetSlotTypeResponse> {
			return this.http.get('/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSlotTypeVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<GetSlotTypeVersionsResponse> {
			return this.http.get('/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSlotTypes(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => {[header: string]: string}): Promise<GetSlotTypesResponse> {
			return this.http.get('/slottypes/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetUtterancesView(botname: string, bot_versions: Array<Version>, status_type: StatusType, view: string, headersHandler?: () => {[header: string]: string}): Promise<GetUtterancesViewResponse> {
			return this.http.get('/bots/' + (botname == null ? '' : encodeURIComponent(botname)) + '/utterances#view=aggregation&bot_versions&status_type&' + bot_versions.map(z => `bot_versions=${z}`).join('&') + '&status_type=' + status_type + '&view=' + (view == null ? '' : encodeURIComponent(view)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutBot(name: string, requestBody: PutBotBody, headersHandler?: () => {[header: string]: string}): Promise<PutBotResponse> {
			return this.http.put('/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutIntent(name: string, requestBody: PutIntentBody, headersHandler?: () => {[header: string]: string}): Promise<PutIntentResponse> {
			return this.http.put('/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutSlotType(name: string, requestBody: PutSlotTypeBody, headersHandler?: () => {[header: string]: string}): Promise<PutSlotTypeResponse> {
			return this.http.put('/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartImport(requestBody: StartImportBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/imports/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
