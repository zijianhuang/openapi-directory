...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateBotVersion(name: string, callback: (data : void) => any, requestBody: CreateBotVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateIntentVersion(name: string, callback: (data : void) => any, requestBody: CreateIntentVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateSlotTypeVersion(name: string, callback: (data : void) => any, requestBody: CreateSlotTypeVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBot(name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotAlias(name: string, botName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBotAlias(name: string, botName: string, callback: (data : GetBotAliasResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PutBotAlias(name: string, botName: string, callback: (data : PutBotAliasResponse) => any, requestBody: PutBotAliasBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotChannelAssociation(name: string, botName: string, aliasName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBotChannelAssociation(name: string, botName: string, aliasName: string, callback: (data : GetBotChannelAssociationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotVersion(name: string, version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntent(name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntentVersion(name: string, version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetIntent(name: string, version: string, callback: (data : GetIntentResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteSlotType(name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteSlotTypeVersion(name: string, version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/version/' + (version == null ? '' : encodeURIComponent(version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteUtterances(botName: string, userId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/utterances/' + (userId == null ? '' : encodeURIComponent(userId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBot(name: string, versionoralias: string, callback: (data : GetBotResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (versionoralias == null ? '' : encodeURIComponent(versionoralias)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBotAliases(botName: string, nextToken: string, maxResults: number, nameContains: string, callback: (data : GetBotAliasesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBotChannelAssociations(botName: string, aliasName: string, nextToken: string, maxResults: number, nameContains: string, callback: (data : GetBotChannelAssociationsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBotVersions(name: string, nextToken: string, maxResults: number, callback: (data : GetBotVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBots(nextToken: string, maxResults: number, nameContains: string, callback: (data : GetBotsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBuiltinIntent(signature: string, callback: (data : GetBuiltinIntentResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/builtins/intents/' + (signature == null ? '' : encodeURIComponent(signature)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBuiltinIntents(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, callback: (data : GetBuiltinIntentsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/builtins/intents/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBuiltinSlotTypes(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, callback: (data : GetBuiltinSlotTypesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/builtins/slottypes/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetExport(name: string, version: string, resourceType: GetExportResponseResourceType, exportType: GetExportResponseExportType, callback: (data : GetExportResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/exports/#name&version&resourceType&exportType?name=' + (name == null ? '' : encodeURIComponent(name)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&resourceType=' + resourceType + '&exportType=' + exportType, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetImport(importId: string, callback: (data : GetImportResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/imports/' + (importId == null ? '' : encodeURIComponent(importId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetIntentVersions(name: string, nextToken: string, maxResults: number, callback: (data : GetIntentVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetIntents(nextToken: string, maxResults: number, nameContains: string, callback: (data : GetIntentsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/intents/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSlotType(name: string, version: string, callback: (data : GetSlotTypeResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSlotTypeVersions(name: string, nextToken: string, maxResults: number, callback: (data : GetSlotTypeVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSlotTypes(nextToken: string, maxResults: number, nameContains: string, callback: (data : GetSlotTypesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/slottypes/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetUtterancesView(botname: string, bot_versions: Array<Version>, status_type: StatusType, view: string, callback: (data : GetUtterancesViewResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/bots/' + (botname == null ? '' : encodeURIComponent(botname)) + '/utterances#view=aggregation&bot_versions&status_type&' + bot_versions.map(z => `bot_versions=${z}`).join('&') + '&status_type=' + status_type + '&view=' + (view == null ? '' : encodeURIComponent(view)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PutBot(name: string, callback: (data : PutBotResponse) => any, requestBody: PutBotBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutIntent(name: string, callback: (data : PutIntentResponse) => any, requestBody: PutIntentBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutSlotType(name: string, callback: (data : PutSlotTypeResponse) => any, requestBody: PutSlotTypeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		StartImport(callback: (data : void) => any, requestBody: StartImportBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/imports/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
