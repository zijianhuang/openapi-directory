...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateBotVersion(name: string, requestBody: CreateBotVersionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateIntentVersion(name: string, requestBody: CreateIntentVersionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateSlotTypeVersion(name: string, requestBody: CreateSlotTypeVersionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBot(name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotAlias(name: string, botName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBotAlias(name: string, botName: string, headersHandler?: () => HttpHeaders): Observable<GetBotAliasResponse> {
			return this.http.get<GetBotAliasResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		PutBotAlias(name: string, botName: string, requestBody: PutBotAliasBody, headersHandler?: () => HttpHeaders): Observable<PutBotAliasResponse> {
			return this.http.put<PutBotAliasResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotChannelAssociation(name: string, botName: string, aliasName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBotChannelAssociation(name: string, botName: string, aliasName: string, headersHandler?: () => HttpHeaders): Observable<GetBotChannelAssociationResponse> {
			return this.http.get<GetBotChannelAssociationResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBotVersion(name: string, version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntent(name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntentVersion(name: string, version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetIntent(name: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetIntentResponse> {
			return this.http.get<GetIntentResponse>(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteSlotType(name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteSlotTypeVersion(name: string, version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/version/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUtterances(botName: string, userId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/utterances/' + (userId == null ? '' : encodeURIComponent(userId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBot(name: string, versionoralias: string, headersHandler?: () => HttpHeaders): Observable<GetBotResponse> {
			return this.http.get<GetBotResponse>(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (versionoralias == null ? '' : encodeURIComponent(versionoralias)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBotAliases(botName: string, nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => HttpHeaders): Observable<GetBotAliasesResponse> {
			return this.http.get<GetBotAliasesResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBotChannelAssociations(botName: string, aliasName: string, nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => HttpHeaders): Observable<GetBotChannelAssociationsResponse> {
			return this.http.get<GetBotChannelAssociationsResponse>(this.baseUri + '/bots/' + (botName == null ? '' : encodeURIComponent(botName)) + '/aliases/' + (aliasName == null ? '' : encodeURIComponent(aliasName)) + '/channels/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBotVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<GetBotVersionsResponse> {
			return this.http.get<GetBotVersionsResponse>(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBots(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => HttpHeaders): Observable<GetBotsResponse> {
			return this.http.get<GetBotsResponse>(this.baseUri + '/bots/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBuiltinIntent(signature: string, headersHandler?: () => HttpHeaders): Observable<GetBuiltinIntentResponse> {
			return this.http.get<GetBuiltinIntentResponse>(this.baseUri + '/builtins/intents/' + (signature == null ? '' : encodeURIComponent(signature)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBuiltinIntents(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<GetBuiltinIntentsResponse> {
			return this.http.get<GetBuiltinIntentsResponse>(this.baseUri + '/builtins/intents/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBuiltinSlotTypes(locale: CreateBotVersionResponseLocale, signatureContains: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<GetBuiltinSlotTypesResponse> {
			return this.http.get<GetBuiltinSlotTypesResponse>(this.baseUri + '/builtins/slottypes/?locale=' + locale + '&signatureContains=' + (signatureContains == null ? '' : encodeURIComponent(signatureContains)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetExport(name: string, version: string, resourceType: GetExportResponseResourceType, exportType: GetExportResponseExportType, headersHandler?: () => HttpHeaders): Observable<GetExportResponse> {
			return this.http.get<GetExportResponse>(this.baseUri + '/exports/#name&version&resourceType&exportType?name=' + (name == null ? '' : encodeURIComponent(name)) + '&version=' + (version == null ? '' : encodeURIComponent(version)) + '&resourceType=' + resourceType + '&exportType=' + exportType, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetImport(importId: string, headersHandler?: () => HttpHeaders): Observable<GetImportResponse> {
			return this.http.get<GetImportResponse>(this.baseUri + '/imports/' + (importId == null ? '' : encodeURIComponent(importId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetIntentVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<GetIntentVersionsResponse> {
			return this.http.get<GetIntentVersionsResponse>(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetIntents(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => HttpHeaders): Observable<GetIntentsResponse> {
			return this.http.get<GetIntentsResponse>(this.baseUri + '/intents/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSlotType(name: string, version: string, headersHandler?: () => HttpHeaders): Observable<GetSlotTypeResponse> {
			return this.http.get<GetSlotTypeResponse>(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/' + (version == null ? '' : encodeURIComponent(version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSlotTypeVersions(name: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<GetSlotTypeVersionsResponse> {
			return this.http.get<GetSlotTypeVersionsResponse>(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSlotTypes(nextToken: string, maxResults: number, nameContains: string, headersHandler?: () => HttpHeaders): Observable<GetSlotTypesResponse> {
			return this.http.get<GetSlotTypesResponse>(this.baseUri + '/slottypes/?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&nameContains=' + (nameContains == null ? '' : encodeURIComponent(nameContains)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetUtterancesView(botname: string, bot_versions: Array<Version>, status_type: StatusType, view: string, headersHandler?: () => HttpHeaders): Observable<GetUtterancesViewResponse> {
			return this.http.get<GetUtterancesViewResponse>(this.baseUri + '/bots/' + (botname == null ? '' : encodeURIComponent(botname)) + '/utterances#view=aggregation&bot_versions&status_type&' + bot_versions.map(z => `bot_versions=${z}`).join('&') + '&status_type=' + status_type + '&view=' + (view == null ? '' : encodeURIComponent(view)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		PutBot(name: string, requestBody: PutBotBody, headersHandler?: () => HttpHeaders): Observable<PutBotResponse> {
			return this.http.put<PutBotResponse>(this.baseUri + '/bots/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutIntent(name: string, requestBody: PutIntentBody, headersHandler?: () => HttpHeaders): Observable<PutIntentResponse> {
			return this.http.put<PutIntentResponse>(this.baseUri + '/intents/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutSlotType(name: string, requestBody: PutSlotTypeBody, headersHandler?: () => HttpHeaders): Observable<PutSlotTypeResponse> {
			return this.http.put<PutSlotTypeResponse>(this.baseUri + '/slottypes/' + (name == null ? '' : encodeURIComponent(name)) + '/versions/$LATEST', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		StartImport(requestBody: StartImportBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/imports/', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
