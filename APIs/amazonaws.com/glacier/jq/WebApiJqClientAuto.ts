...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AbortMultipartUpload(accountId: string, vaultName: string, uploadId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CompleteMultipartUpload(accountId: string, vaultName: string, uploadId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListParts(accountId: string, vaultName: string, uploadId: string, marker: string, limit: string, callback: (data : ListPartsOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UploadMultipartPart(accountId: string, vaultName: string, uploadId: string, callback: (data : void) => any, requestBody: UploadMultipartPartBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		AbortVaultLock(accountId: string, vaultName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetVaultLock(accountId: string, vaultName: string, callback: (data : GetVaultLockOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		InitiateVaultLock(accountId: string, vaultName: string, callback: (data : void) => any, requestBody: InitiateVaultLockBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		AddTagsToVault(accountId: string, vaultName: string, operation: string, callback: (data : void) => any, requestBody: AddTagsToVaultBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CompleteVaultLock(accountId: string, vaultName: string, lockId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy/' + (lockId == null ? '' : encodeURIComponent(lockId)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateVault(accountId: string, vaultName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVault(accountId: string, vaultName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeVault(accountId: string, vaultName: string, callback: (data : DescribeVaultOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteArchive(accountId: string, vaultName: string, archiveId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/archives/' + (archiveId == null ? '' : encodeURIComponent(archiveId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVaultAccessPolicy(accountId: string, vaultName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetVaultAccessPolicy(accountId: string, vaultName: string, callback: (data : GetVaultAccessPolicyOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		SetVaultAccessPolicy(accountId: string, vaultName: string, callback: (data : void) => any, requestBody: SetVaultAccessPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVaultNotifications(accountId: string, vaultName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetVaultNotifications(accountId: string, vaultName: string, callback: (data : GetVaultNotificationsOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		SetVaultNotifications(accountId: string, vaultName: string, callback: (data : void) => any, requestBody: SetVaultNotificationsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeJob(accountId: string, vaultName: string, jobId: string, callback: (data : GlacierJobDescription) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDataRetrievalPolicy(accountId: string, callback: (data : GetDataRetrievalPolicyOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/policies/data-retrieval', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		SetDataRetrievalPolicy(accountId: string, callback: (data : void) => any, requestBody: SetDataRetrievalPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/policies/data-retrieval', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetJobOutput(accountId: string, vaultName: string, jobId: string, callback: (data : GetJobOutputOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/output', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		InitiateJob(accountId: string, vaultName: string, callback: (data : void) => any, requestBody: InitiateJobBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListJobs(accountId: string, vaultName: string, limit: string, marker: string, statuscode: string, completed: string, callback: (data : ListJobsOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&statuscode=' + (statuscode == null ? '' : encodeURIComponent(statuscode)) + '&completed=' + (completed == null ? '' : encodeURIComponent(completed)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		InitiateMultipartUpload(accountId: string, vaultName: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMultipartUploads(accountId: string, vaultName: string, marker: string, limit: string, callback: (data : ListMultipartUploadsOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListProvisionedCapacity(accountId: string, callback: (data : ListProvisionedCapacityOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/provisioned-capacity', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PurchaseProvisionedCapacity(accountId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/provisioned-capacity', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForVault(accountId: string, vaultName: string, callback: (data : ListTagsForVaultOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListVaults(accountId: string, marker: string, limit: string, callback: (data : ListVaultsOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		RemoveTagsFromVault(accountId: string, vaultName: string, operation: string, callback: (data : void) => any, requestBody: RemoveTagsFromVaultBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags#operation=remove&operation=' + (operation == null ? '' : encodeURIComponent(operation)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UploadArchive(vaultName: string, accountId: string, callback: (data : void) => any, requestBody: UploadArchiveBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/archives', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}

	export interface UploadMultipartPartBody {

		/**The data to upload. */
		body?: string;
	}

	export interface InitiateVaultLockBody {

		/**Contains the vault lock policy. */
		policy?: string;
	}

	export interface AddTagsToVaultBody {

		/**The tags to add to the vault. Each tag is composed of a key and a value. The value can be an empty string. */
		Tags?: string;
	}

	export interface SetVaultAccessPolicyBody {

		/**Contains the vault access policy. */
		policy?: string;
	}

	export interface SetVaultNotificationsBody {

		/**Represents a vault's notification configuration. */
		vaultNotificationConfig?: string;
	}

	export interface SetDataRetrievalPolicyBody {

		/**Data retrieval policy. */
		Policy?: string;
	}

	export interface InitiateJobBody {

		/**Provides options for defining a job. */
		jobParameters?: string;
	}

	export interface RemoveTagsFromVaultBody {

		/**A list of tag keys. Each corresponding tag is removed from the vault. */
		TagKeys?: Array<string>;
	}

	export interface UploadArchiveBody {
