export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AbortMultipartUpload(accountId: string, vaultName: string, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CompleteMultipartUpload(accountId: string, vaultName: string, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListParts(accountId: string, vaultName: string, uploadId: string, marker: string, limit: string, headersHandler?: () => {[header: string]: string}): Promise<ListPartsOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UploadMultipartPart(accountId: string, vaultName: string, uploadId: string, requestBody: UploadMultipartPartBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		AbortVaultLock(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVaultLock(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetVaultLockOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		AddTagsToVault(accountId: string, vaultName: string, operation: string, requestBody: AddTagsToVaultBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CompleteVaultLock(accountId: string, vaultName: string, lockId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy/' + (lockId == null ? '' : encodeURIComponent(lockId)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CreateVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), { method: 'put', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeVaultOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteArchive(accountId: string, vaultName: string, archiveId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/archives/' + (archiveId == null ? '' : encodeURIComponent(archiveId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteVaultAccessPolicy(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVaultAccessPolicy(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetVaultAccessPolicyOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetVaultAccessPolicy(accountId: string, vaultName: string, requestBody: SetVaultAccessPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteVaultNotifications(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVaultNotifications(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetVaultNotificationsOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeJob(accountId: string, vaultName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GlacierJobDescription> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDataRetrievalPolicy(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDataRetrievalPolicyOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/policies/data-retrieval', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetDataRetrievalPolicy(accountId: string, requestBody: SetDataRetrievalPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/policies/data-retrieval', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetJobOutput(accountId: string, vaultName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GetJobOutputOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/output', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		InitiateJob(accountId: string, vaultName: string, requestBody: InitiateJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		InitiateMultipartUpload(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListMultipartUploads(accountId: string, vaultName: string, marker: string, limit: string, headersHandler?: () => {[header: string]: string}): Promise<ListMultipartUploadsOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProvisionedCapacity(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<ListProvisionedCapacityOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/provisioned-capacity', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PurchaseProvisionedCapacity(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/provisioned-capacity', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListTagsForVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForVaultOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListVaults(accountId: string, marker: string, limit: string, headersHandler?: () => {[header: string]: string}): Promise<ListVaultsOutput> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UploadArchive(vaultName: string, accountId: string, requestBody: UploadArchiveBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/archives', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
