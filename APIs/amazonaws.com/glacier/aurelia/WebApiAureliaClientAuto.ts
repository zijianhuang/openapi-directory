...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AbortMultipartUpload(accountId: string, vaultName: string, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CompleteMultipartUpload(accountId: string, vaultName: string, uploadId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListParts(accountId: string, vaultName: string, uploadId: string, marker: string, limit: string, headersHandler?: () => {[header: string]: string}): Promise<ListPartsOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		UploadMultipartPart(accountId: string, vaultName: string, uploadId: string, requestBody: UploadMultipartPartBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads/' + (uploadId == null ? '' : encodeURIComponent(uploadId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		AbortVaultLock(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVaultLock(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetVaultLockOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		InitiateVaultLock(accountId: string, vaultName: string, requestBody: InitiateVaultLockBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		AddTagsToVault(accountId: string, vaultName: string, operation: string, requestBody: AddTagsToVaultBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		CompleteVaultLock(accountId: string, vaultName: string, lockId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/lock-policy/' + (lockId == null ? '' : encodeURIComponent(lockId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeVaultOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteArchive(accountId: string, vaultName: string, archiveId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/archives/' + (archiveId == null ? '' : encodeURIComponent(archiveId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteVaultAccessPolicy(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVaultAccessPolicy(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetVaultAccessPolicyOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		SetVaultAccessPolicy(accountId: string, vaultName: string, requestBody: SetVaultAccessPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/access-policy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteVaultNotifications(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVaultNotifications(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<GetVaultNotificationsOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		SetVaultNotifications(accountId: string, vaultName: string, requestBody: SetVaultNotificationsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/notification-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeJob(accountId: string, vaultName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GlacierJobDescription> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDataRetrievalPolicy(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDataRetrievalPolicyOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/policies/data-retrieval', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		SetDataRetrievalPolicy(accountId: string, requestBody: SetDataRetrievalPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/policies/data-retrieval', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetJobOutput(accountId: string, vaultName: string, jobId: string, headersHandler?: () => {[header: string]: string}): Promise<GetJobOutputOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)) + '/output', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		InitiateJob(accountId: string, vaultName: string, requestBody: InitiateJobBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListJobs(accountId: string, vaultName: string, limit: string, marker: string, statuscode: string, completed: string, headersHandler?: () => {[header: string]: string}): Promise<ListJobsOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/jobs&limit=' + (limit == null ? '' : encodeURIComponent(limit)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&statuscode=' + (statuscode == null ? '' : encodeURIComponent(statuscode)) + '&completed=' + (completed == null ? '' : encodeURIComponent(completed)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		InitiateMultipartUpload(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListMultipartUploads(accountId: string, vaultName: string, marker: string, limit: string, headersHandler?: () => {[header: string]: string}): Promise<ListMultipartUploadsOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/multipart-uploads&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListProvisionedCapacity(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<ListProvisionedCapacityOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/provisioned-capacity', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		PurchaseProvisionedCapacity(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/provisioned-capacity', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListTagsForVault(accountId: string, vaultName: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForVaultOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListVaults(accountId: string, marker: string, limit: string, headersHandler?: () => {[header: string]: string}): Promise<ListVaultsOutput> {
			return this.http.get('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + (limit == null ? '' : encodeURIComponent(limit)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		RemoveTagsFromVault(accountId: string, vaultName: string, operation: string, requestBody: RemoveTagsFromVaultBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/tags#operation=remove&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		UploadArchive(vaultName: string, accountId: string, requestBody: UploadArchiveBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/vaults/' + (vaultName == null ? '' : encodeURIComponent(vaultName)) + '/archives', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
