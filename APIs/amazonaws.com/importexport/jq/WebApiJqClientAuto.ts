...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_CancelJob(JobId: string, APIVersion: string, Operation: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Operation=CancelJob&Action=CancelJob?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateJob(JobType: CreateJobOutputJobType, Manifest: string, ManifestAddendum: string, ValidateOnly: boolean, APIVersion: string, Operation: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Operation=CreateJob&Action=CreateJob?JobType=' + JobType + '&Manifest=' + (Manifest == null ? '' : encodeURIComponent(Manifest)) + '&ManifestAddendum=' + (ManifestAddendum == null ? '' : encodeURIComponent(ManifestAddendum)) + '&ValidateOnly=' + ValidateOnly + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetShippingLabel(jobIds: Array<GenericString>, name: string, company: string, phoneNumber: string, country: string, stateOrProvince: string, city: string, postalCode: string, street1: string, street2: string, street3: string, APIVersion: string, Operation: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_GetStatus(JobId: string, APIVersion: string, Operation: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Operation=GetStatus&Action=GetStatus?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListJobs(MaxJobs: number, Marker: string, APIVersion: string, Operation: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Operation=ListJobs&Action=ListJobs?MaxJobs=' + MaxJobs + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateJob(JobId: string, Manifest: string, JobType: CreateJobOutputJobType, ValidateOnly: boolean, APIVersion: string, Operation: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
