...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_CancelJob(JobId: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_CreateJob(JobType: CreateJobOutputJobType, Manifest: string, ManifestAddendum: string, ValidateOnly: boolean, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_GetShippingLabel(jobIds: Array<GenericString>, name: string, company: string, phoneNumber: string, country: string, stateOrProvince: string, city: string, postalCode: string, street1: string, street2: string, street3: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_GetStatus(JobId: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_ListJobs(MaxJobs: number, Marker: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_UpdateJob(JobId: string, Manifest: string, JobType: CreateJobOutputJobType, ValidateOnly: boolean, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
