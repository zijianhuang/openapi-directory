...
export namespace My_Demo_Client {
	...
	export interface GetStatusOutput {
		...
		/**Specifies whether the job to initiate is an import or export job. */
		JobType?: GetStatusOutputJobType;
	...
	export enum GetStatusOutputJobType { Import = 0, Export = 1 }
	...
	export enum CreateJobInputJobType { Import = 0, Export = 1 }

	export interface GetShippingLabelInput {
		jobIds: Array<GenericString>;
	...
	export enum JobJobType { Import = 0, Export = 1 }
	...
	export enum UpdateJobInputJobType { Import = 0, Export = 1 }
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_CancelJob(JobId: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Operation=CancelJob&Action=CancelJob?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateJob(JobType: CreateJobOutputJobType, Manifest: string, ManifestAddendum: string, ValidateOnly: boolean, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Operation=CreateJob&Action=CreateJob?JobType=' + JobType + '&Manifest=' + (Manifest == null ? '' : encodeURIComponent(Manifest)) + '&ManifestAddendum=' + (ManifestAddendum == null ? '' : encodeURIComponent(ManifestAddendum)) + '&ValidateOnly=' + ValidateOnly + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetShippingLabel(jobIds: Array<GenericString>, name: string, company: string, phoneNumber: string, country: string, stateOrProvince: string, city: string, postalCode: string, street1: string, street2: string, street3: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Operation=GetShippingLabel&Action=GetShippingLabel?' + jobIds.map(z => `jobIds=${z}`).join('&') + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&company=' + (company == null ? '' : encodeURIComponent(company)) + '&phoneNumber=' + (phoneNumber == null ? '' : encodeURIComponent(phoneNumber)) + '&country=' + (country == null ? '' : encodeURIComponent(country)) + '&stateOrProvince=' + (stateOrProvince == null ? '' : encodeURIComponent(stateOrProvince)) + '&city=' + (city == null ? '' : encodeURIComponent(city)) + '&postalCode=' + (postalCode == null ? '' : encodeURIComponent(postalCode)) + '&street1=' + (street1 == null ? '' : encodeURIComponent(street1)) + '&street2=' + (street2 == null ? '' : encodeURIComponent(street2)) + '&street3=' + (street3 == null ? '' : encodeURIComponent(street3)) + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetStatus(JobId: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Operation=GetStatus&Action=GetStatus?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListJobs(MaxJobs: number, Marker: string, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Operation=ListJobs&Action=ListJobs?MaxJobs=' + MaxJobs + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateJob(JobId: string, Manifest: string, JobType: CreateJobOutputJobType, ValidateOnly: boolean, APIVersion: string, Operation: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Operation=UpdateJob&Action=UpdateJob?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&Manifest=' + (Manifest == null ? '' : encodeURIComponent(Manifest)) + '&JobType=' + JobType + '&ValidateOnly=' + ValidateOnly + '&APIVersion=' + (APIVersion == null ? '' : encodeURIComponent(APIVersion)) + '&Operation=' + (Operation == null ? '' : encodeURIComponent(Operation)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
