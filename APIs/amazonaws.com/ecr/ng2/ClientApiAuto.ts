...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchCheckLayerAvailability(requestBody: BatchCheckLayerAvailabilityRequest, headersHandler?: () => HttpHeaders): Observable<BatchCheckLayerAvailabilityResponse> {
			return this.http.post<BatchCheckLayerAvailabilityResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchCheckLayerAvailability', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchDeleteImage(requestBody: BatchDeleteImageRequest, headersHandler?: () => HttpHeaders): Observable<BatchDeleteImageResponse> {
			return this.http.post<BatchDeleteImageResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchDeleteImage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetImage(requestBody: BatchGetImageRequest, headersHandler?: () => HttpHeaders): Observable<BatchGetImageResponse> {
			return this.http.post<BatchGetImageResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchGetImage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CompleteLayerUpload(requestBody: CompleteLayerUploadRequest, headersHandler?: () => HttpHeaders): Observable<CompleteLayerUploadResponse> {
			return this.http.post<CompleteLayerUploadResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.CompleteLayerUpload', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateRepository(requestBody: CreateRepositoryRequest, headersHandler?: () => HttpHeaders): Observable<CreateRepositoryResponse> {
			return this.http.post<CreateRepositoryResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.CreateRepository', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteLifecyclePolicy(requestBody: DeleteLifecyclePolicyRequest, headersHandler?: () => HttpHeaders): Observable<DeleteLifecyclePolicyResponse> {
			return this.http.post<DeleteLifecyclePolicyResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRepository(requestBody: DeleteRepositoryRequest, headersHandler?: () => HttpHeaders): Observable<DeleteRepositoryResponse> {
			return this.http.post<DeleteRepositoryResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRepository', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRepositoryPolicy(requestBody: DeleteRepositoryPolicyRequest, headersHandler?: () => HttpHeaders): Observable<DeleteRepositoryPolicyResponse> {
			return this.http.post<DeleteRepositoryPolicyResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRepositoryPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeImageScanFindings(maxResults: string, nextToken: string, requestBody: DescribeImageScanFindingsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeImageScanFindingsResponse> {
		 ...
		 */
		DescribeImages(maxResults: string, nextToken: string, requestBody: DescribeImagesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeImagesResponse> {
			return this.http.post<DescribeImagesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DescribeImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRepositories(maxResults: string, nextToken: string, requestBody: DescribeRepositoriesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRepositoriesResponse> {
			return this.http.post<DescribeRepositoriesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DescribeRepositories?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAuthorizationToken(requestBody: GetAuthorizationTokenRequest, headersHandler?: () => HttpHeaders): Observable<GetAuthorizationTokenResponse> {
			return this.http.post<GetAuthorizationTokenResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetAuthorizationToken', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDownloadUrlForLayer(requestBody: GetDownloadUrlForLayerRequest, headersHandler?: () => HttpHeaders): Observable<GetDownloadUrlForLayerResponse> {
			return this.http.post<GetDownloadUrlForLayerResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetDownloadUrlForLayer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetLifecyclePolicy(requestBody: GetLifecyclePolicyRequest, headersHandler?: () => HttpHeaders): Observable<GetLifecyclePolicyResponse> {
			return this.http.post<GetLifecyclePolicyResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetLifecyclePolicyPreview(maxResults: string, nextToken: string, requestBody: GetLifecyclePolicyPreviewRequest, headersHandler?: () => HttpHeaders): Observable<GetLifecyclePolicyPreviewResponse> {
			return this.http.post<GetLifecyclePolicyPreviewResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetLifecyclePolicyPreview?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetRepositoryPolicy(requestBody: GetRepositoryPolicyRequest, headersHandler?: () => HttpHeaders): Observable<GetRepositoryPolicyResponse> {
			return this.http.post<GetRepositoryPolicyResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetRepositoryPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		InitiateLayerUpload(requestBody: InitiateLayerUploadRequest, headersHandler?: () => HttpHeaders): Observable<InitiateLayerUploadResponse> {
			return this.http.post<InitiateLayerUploadResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.InitiateLayerUpload', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListImages(maxResults: string, nextToken: string, requestBody: ListImagesRequest, headersHandler?: () => HttpHeaders): Observable<ListImagesResponse> {
			return this.http.post<ListImagesResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutImage(requestBody: PutImageRequest, headersHandler?: () => HttpHeaders): Observable<PutImageResponse> {
			return this.http.post<PutImageResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutImageScanningConfiguration(requestBody: PutImageScanningConfigurationRequest, headersHandler?: () => HttpHeaders): Observable<PutImageScanningConfigurationResponse> {
			return this.http.post<PutImageScanningConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImageScanningConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutImageTagMutability(requestBody: PutImageTagMutabilityRequest, headersHandler?: () => HttpHeaders): Observable<PutImageTagMutabilityResponse> {
			return this.http.post<PutImageTagMutabilityResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImageTagMutability', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutLifecyclePolicy(requestBody: PutLifecyclePolicyRequest, headersHandler?: () => HttpHeaders): Observable<PutLifecyclePolicyResponse> {
			return this.http.post<PutLifecyclePolicyResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SetRepositoryPolicy(requestBody: SetRepositoryPolicyRequest, headersHandler?: () => HttpHeaders): Observable<SetRepositoryPolicyResponse> {
			return this.http.post<SetRepositoryPolicyResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.SetRepositoryPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartImageScan(requestBody: StartImageScanRequest, headersHandler?: () => HttpHeaders): Observable<StartImageScanResponse> {
			return this.http.post<StartImageScanResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.StartImageScan', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartLifecyclePolicyPreview(requestBody: StartLifecyclePolicyPreviewRequest, headersHandler?: () => HttpHeaders): Observable<StartLifecyclePolicyPreviewResponse> {
			return this.http.post<StartLifecyclePolicyPreviewResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.StartLifecyclePolicyPreview', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UploadLayerPart(requestBody: UploadLayerPartRequest, headersHandler?: () => HttpHeaders): Observable<UploadLayerPartResponse> {
			return this.http.post<UploadLayerPartResponse>(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.UploadLayerPart', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
