export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDeleteImage(requestBody: BatchDeleteImageRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteImageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchDeleteImage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetImage(requestBody: BatchGetImageRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetImageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.BatchGetImage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CompleteLayerUpload(requestBody: CompleteLayerUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<CompleteLayerUploadResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.CompleteLayerUpload', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateRepository(requestBody: CreateRepositoryRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRepositoryResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.CreateRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteLifecyclePolicy(requestBody: DeleteLifecyclePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLifecyclePolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteLifecyclePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteRepository(requestBody: DeleteRepositoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRepositoryResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteRepositoryPolicy(requestBody: DeleteRepositoryPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRepositoryPolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DeleteRepositoryPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeImages(maxResults: string, nextToken: string, requestBody: DescribeImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImagesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DescribeImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRepositories(maxResults: string, nextToken: string, requestBody: DescribeRepositoriesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRepositoriesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.DescribeRepositories?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetAuthorizationToken(requestBody: GetAuthorizationTokenRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAuthorizationTokenResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetAuthorizationToken', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDownloadUrlForLayer(requestBody: GetDownloadUrlForLayerRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDownloadUrlForLayerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetDownloadUrlForLayer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetLifecyclePolicy(requestBody: GetLifecyclePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLifecyclePolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetLifecyclePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetLifecyclePolicyPreview(maxResults: string, nextToken: string, requestBody: GetLifecyclePolicyPreviewRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLifecyclePolicyPreviewResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetLifecyclePolicyPreview?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetRepositoryPolicy(requestBody: GetRepositoryPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRepositoryPolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.GetRepositoryPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		InitiateLayerUpload(requestBody: InitiateLayerUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<InitiateLayerUploadResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.InitiateLayerUpload', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListImages(maxResults: string, nextToken: string, requestBody: ListImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListImagesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListImages?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutImage(requestBody: PutImageRequest, headersHandler?: () => {[header: string]: string}): Promise<PutImageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutImageScanningConfiguration(requestBody: PutImageScanningConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutImageScanningConfigurationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImageScanningConfiguration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutImageTagMutability(requestBody: PutImageTagMutabilityRequest, headersHandler?: () => {[header: string]: string}): Promise<PutImageTagMutabilityResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutImageTagMutability', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutLifecyclePolicy(requestBody: PutLifecyclePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutLifecyclePolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.PutLifecyclePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SetRepositoryPolicy(requestBody: SetRepositoryPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<SetRepositoryPolicyResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.SetRepositoryPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartImageScan(requestBody: StartImageScanRequest, headersHandler?: () => {[header: string]: string}): Promise<StartImageScanResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.StartImageScan', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UploadLayerPart(requestBody: UploadLayerPartRequest, headersHandler?: () => {[header: string]: string}): Promise<UploadLayerPartResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonEC2ContainerRegistry_V20150921.UploadLayerPart', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
