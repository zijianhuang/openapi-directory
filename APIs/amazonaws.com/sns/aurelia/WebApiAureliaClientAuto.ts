...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AddPermission(TopicArn: string, Label: string, AWSAccountId: Array<delegate>, ActionName: Array<action>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=AddPermission?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&' + AWSAccountId.map(z => `AWSAccountId=${z}`).join('&') + '&' + ActionName.map(z => `ActionName=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CheckIfPhoneNumberIsOptedOut(phoneNumber: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CheckIfPhoneNumberIsOptedOut?phoneNumber=' + (phoneNumber == null ? '' : encodeURIComponent(phoneNumber)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ConfirmSubscription(TopicArn: string, Token: string, AuthenticateOnUnsubscribe: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ConfirmSubscription?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Token=' + (Token == null ? '' : encodeURIComponent(Token)) + '&AuthenticateOnUnsubscribe=' + (AuthenticateOnUnsubscribe == null ? '' : encodeURIComponent(AuthenticateOnUnsubscribe)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreatePlatformApplication(Name: string, Platform: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreatePlatformApplication?Name=' + (Name == null ? '' : encodeURIComponent(Name)) + '&Platform=' + (Platform == null ? '' : encodeURIComponent(Platform)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreatePlatformEndpoint(PlatformApplicationArn: string, Token: string, CustomUserData: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreatePlatformEndpoint?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&Token=' + (Token == null ? '' : encodeURIComponent(Token)) + '&CustomUserData=' + (CustomUserData == null ? '' : encodeURIComponent(CustomUserData)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateTopic(Name: string, Attributes: string, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreateTopic?Name=' + (Name == null ? '' : encodeURIComponent(Name)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteEndpoint(EndpointArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteEndpoint?EndpointArn=' + (EndpointArn == null ? '' : encodeURIComponent(EndpointArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeletePlatformApplication(PlatformApplicationArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeletePlatformApplication?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteTopic(TopicArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteTopic?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetEndpointAttributes(EndpointArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetEndpointAttributes?EndpointArn=' + (EndpointArn == null ? '' : encodeURIComponent(EndpointArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetPlatformApplicationAttributes(PlatformApplicationArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetPlatformApplicationAttributes?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetSMSAttributes(attributes: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetSMSAttributes?' + attributes.map(z => `attributes=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetSubscriptionAttributes(SubscriptionArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetSubscriptionAttributes?SubscriptionArn=' + (SubscriptionArn == null ? '' : encodeURIComponent(SubscriptionArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetTopicAttributes(TopicArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetTopicAttributes?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListEndpointsByPlatformApplication(PlatformApplicationArn: string, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListEndpointsByPlatformApplication?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListPhoneNumbersOptedOut(nextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListPhoneNumbersOptedOut?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListPlatformApplications(NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListPlatformApplications?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListSubscriptions(NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListSubscriptions?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListSubscriptionsByTopic(TopicArn: string, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListSubscriptionsByTopic?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListTopics(NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListTopics?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_OptInPhoneNumber(phoneNumber: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=OptInPhoneNumber?phoneNumber=' + (phoneNumber == null ? '' : encodeURIComponent(phoneNumber)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemovePermission(TopicArn: string, Label: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=RemovePermission?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetEndpointAttributes(EndpointArn: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=SetEndpointAttributes?EndpointArn=' + (EndpointArn == null ? '' : encodeURIComponent(EndpointArn)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetPlatformApplicationAttributes(PlatformApplicationArn: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
		 ...
		 * @return {void} Success
		 */
		GET_SetSMSAttributes(attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=SetSMSAttributes?attributes=' + (attributes == null ? '' : encodeURIComponent(attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetSubscriptionAttributes(SubscriptionArn: string, AttributeName: string, AttributeValue: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=SetSubscriptionAttributes?SubscriptionArn=' + (SubscriptionArn == null ? '' : encodeURIComponent(SubscriptionArn)) + '&AttributeName=' + (AttributeName == null ? '' : encodeURIComponent(AttributeName)) + '&AttributeValue=' + (AttributeValue == null ? '' : encodeURIComponent(AttributeValue)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetTopicAttributes(TopicArn: string, AttributeName: string, AttributeValue: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=SetTopicAttributes?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&AttributeName=' + (AttributeName == null ? '' : encodeURIComponent(AttributeName)) + '&AttributeValue=' + (AttributeValue == null ? '' : encodeURIComponent(AttributeValue)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_Unsubscribe(SubscriptionArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=Unsubscribe?SubscriptionArn=' + (SubscriptionArn == null ? '' : encodeURIComponent(SubscriptionArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
