...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @param {Array<delegate>} AWSAccountId The AWS account IDs of the users (principals) who will be given access to the specified actions. The users must have AWS accounts, but do not need to be signed up for this service.
		 * @param {Array<action>} ActionName <p>The action you want to allow for the specified principal(s).</p> <p>Valid values: Any Amazon SNS action name, for example <code>Publish</code>.</p>
		 * @return {void} Success
		 */
		GET_AddPermission(TopicArn: string, Label: string, AWSAccountId: Array<delegate>, ActionName: Array<action>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=AddPermission?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&' + AWSAccountId.map(z => `AWSAccountId=${z}`).join('&') + '&' + ActionName.map(z => `ActionName=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CheckIfPhoneNumberIsOptedOut(phoneNumber: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=CheckIfPhoneNumberIsOptedOut?phoneNumber=' + (phoneNumber == null ? '' : encodeURIComponent(phoneNumber)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ConfirmSubscription(TopicArn: string, Token: string, AuthenticateOnUnsubscribe: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=ConfirmSubscription?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Token=' + (Token == null ? '' : encodeURIComponent(Token)) + '&AuthenticateOnUnsubscribe=' + (AuthenticateOnUnsubscribe == null ? '' : encodeURIComponent(AuthenticateOnUnsubscribe)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @param {string} Attributes For a list of attributes, see <a href="https://docs.aws.amazon.com/sns/latest/api/API_SetPlatformApplicationAttributes.html">SetPlatformApplicationAttributes</a> 
		 * @return {void} Success
		 */
		GET_CreatePlatformApplication(Name: string, Platform: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=CreatePlatformApplication?Name=' + (Name == null ? '' : encodeURIComponent(Name)) + '&Platform=' + (Platform == null ? '' : encodeURIComponent(Platform)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @param {string} Attributes For a list of attributes, see <a href="https://docs.aws.amazon.com/sns/latest/api/API_SetEndpointAttributes.html">SetEndpointAttributes</a>.
		 * @return {void} Success
		 */
		GET_CreatePlatformEndpoint(PlatformApplicationArn: string, Token: string, CustomUserData: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=CreatePlatformEndpoint?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&Token=' + (Token == null ? '' : encodeURIComponent(Token)) + '&CustomUserData=' + (CustomUserData == null ? '' : encodeURIComponent(CustomUserData)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateTopic(Name: string, Attributes: string, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=CreateTopic?Name=' + (Name == null ? '' : encodeURIComponent(Name)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteEndpoint(EndpointArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=DeleteEndpoint?EndpointArn=' + (EndpointArn == null ? '' : encodeURIComponent(EndpointArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeletePlatformApplication(PlatformApplicationArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=DeletePlatformApplication?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteTopic(TopicArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=DeleteTopic?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetEndpointAttributes(EndpointArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=GetEndpointAttributes?EndpointArn=' + (EndpointArn == null ? '' : encodeURIComponent(EndpointArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetPlatformApplicationAttributes(PlatformApplicationArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=GetPlatformApplicationAttributes?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetSMSAttributes(attributes: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=GetSMSAttributes?' + attributes.map(z => `attributes=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetSubscriptionAttributes(SubscriptionArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=GetSubscriptionAttributes?SubscriptionArn=' + (SubscriptionArn == null ? '' : encodeURIComponent(SubscriptionArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetTopicAttributes(TopicArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=GetTopicAttributes?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListEndpointsByPlatformApplication(PlatformApplicationArn: string, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=ListEndpointsByPlatformApplication?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListPhoneNumbersOptedOut(nextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=ListPhoneNumbersOptedOut?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListPlatformApplications(NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=ListPlatformApplications?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListSubscriptions(NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=ListSubscriptions?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListSubscriptionsByTopic(TopicArn: string, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=ListSubscriptionsByTopic?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListTopics(NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=ListTopics?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_OptInPhoneNumber(phoneNumber: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=OptInPhoneNumber?phoneNumber=' + (phoneNumber == null ? '' : encodeURIComponent(phoneNumber)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @param {string} MessageAttributes Message attributes for Publish action.
		 * @return {void} Success
		 */
		GET_Publish(TopicArn: string, TargetArn: string, PhoneNumber: string, Message: string, Subject: string, MessageStructure: string, MessageAttributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=Publish?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&TargetArn=' + (TargetArn == null ? '' : encodeURIComponent(TargetArn)) + '&PhoneNumber=' + (PhoneNumber == null ? '' : encodeURIComponent(PhoneNumber)) + '&Message=' + (Message == null ? '' : encodeURIComponent(Message)) + '&Subject=' + (Subject == null ? '' : encodeURIComponent(Subject)) + '&MessageStructure=' + (MessageStructure == null ? '' : encodeURIComponent(MessageStructure)) + '&MessageAttributes=' + (MessageAttributes == null ? '' : encodeURIComponent(MessageAttributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemovePermission(TopicArn: string, Label: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=RemovePermission?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Label=' + (Label == null ? '' : encodeURIComponent(Label)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetEndpointAttributes(EndpointArn: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=SetEndpointAttributes?EndpointArn=' + (EndpointArn == null ? '' : encodeURIComponent(EndpointArn)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetPlatformApplicationAttributes(PlatformApplicationArn: string, Attributes: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=SetPlatformApplicationAttributes?PlatformApplicationArn=' + (PlatformApplicationArn == null ? '' : encodeURIComponent(PlatformApplicationArn)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetSubscriptionAttributes(SubscriptionArn: string, AttributeName: string, AttributeValue: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=SetSubscriptionAttributes?SubscriptionArn=' + (SubscriptionArn == null ? '' : encodeURIComponent(SubscriptionArn)) + '&AttributeName=' + (AttributeName == null ? '' : encodeURIComponent(AttributeName)) + '&AttributeValue=' + (AttributeValue == null ? '' : encodeURIComponent(AttributeValue)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetTopicAttributes(TopicArn: string, AttributeName: string, AttributeValue: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_Subscribe(TopicArn: string, Protocol: string, Endpoint: string, Attributes: string, ReturnSubscriptionArn: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=Subscribe?TopicArn=' + (TopicArn == null ? '' : encodeURIComponent(TopicArn)) + '&Protocol=' + (Protocol == null ? '' : encodeURIComponent(Protocol)) + '&Endpoint=' + (Endpoint == null ? '' : encodeURIComponent(Endpoint)) + '&Attributes=' + (Attributes == null ? '' : encodeURIComponent(Attributes)) + '&ReturnSubscriptionArn=' + ReturnSubscriptionArn + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		GET_Unsubscribe(SubscriptionArn: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.get(this.baseUri + '/#Action=Unsubscribe?SubscriptionArn=' + (SubscriptionArn == null ? '' : encodeURIComponent(SubscriptionArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @param {Array<TagKey>} TagKeys The list of tag keys to remove from the specified topic.
		 * @return {void} Success
		 */
