...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateAnalyzer(requestBody: CreateAnalyzerBody, headersHandler?: () => HttpHeaders): Observable<CreateAnalyzerResponse> {
			return this.http.put<CreateAnalyzerResponse>(this.baseUri + 'analyzer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAnalyzers(maxResults: number, nextToken: string, type: Type, headersHandler?: () => HttpHeaders): Observable<ListAnalyzersResponse> {
			return this.http.get<ListAnalyzersResponse>(this.baseUri + 'analyzer?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&type=' + type, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListArchiveRules(analyzerName: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListArchiveRulesResponse> {
			return this.http.get<ListArchiveRulesResponse>(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAnalyzer(analyzerName: string, clientToken: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetAnalyzer(analyzerName: string, headersHandler?: () => HttpHeaders): Observable<GetAnalyzerResponse> {
			return this.http.get<GetAnalyzerResponse>(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteArchiveRule(analyzerName: string, clientToken: string, ruleName: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetArchiveRule(analyzerName: string, ruleName: string, headersHandler?: () => HttpHeaders): Observable<GetArchiveRuleResponse> {
			return this.http.get<GetArchiveRuleResponse>(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateArchiveRule(analyzerName: string, ruleName: string, requestBody: UpdateArchiveRuleBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetAnalyzedResource(analyzerArn: string, resourceArn: string, headersHandler?: () => HttpHeaders): Observable<GetAnalyzedResourceResponse> {
			return this.http.get<GetAnalyzedResourceResponse>(this.baseUri + 'analyzed-resource#analyzerArn&resourceArn?analyzerArn=' + (analyzerArn == null ? '' : encodeURIComponent(analyzerArn)) + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetFinding(analyzerArn: string, id: string, headersHandler?: () => HttpHeaders): Observable<GetFindingResponse> {
			return this.http.get<GetFindingResponse>(this.baseUri + 'finding/' + (id == null ? '' : encodeURIComponent(id)) + '#analyzerArn?analyzerArn=' + (analyzerArn == null ? '' : encodeURIComponent(analyzerArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListAnalyzedResources(maxResults: string, nextToken: string, requestBody: ListAnalyzedResourcesBody, headersHandler?: () => HttpHeaders): Observable<ListAnalyzedResourcesResponse> {
			return this.http.post<ListAnalyzedResourcesResponse>(this.baseUri + 'analyzed-resource?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFindings(maxResults: string, nextToken: string, requestBody: ListFindingsBody, headersHandler?: () => HttpHeaders): Observable<ListFindingsResponse> {
		 ...
		 * @return {void} Success
		 */
		UpdateFindings(requestBody: UpdateFindingsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'finding', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StartResourceScan(requestBody: StartResourceScanBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'resource/scan', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
