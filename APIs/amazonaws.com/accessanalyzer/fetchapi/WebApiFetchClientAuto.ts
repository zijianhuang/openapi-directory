export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateAnalyzer(requestBody: CreateAnalyzerBody, headersHandler?: () => {[header: string]: string}): Promise<CreateAnalyzerResponse> {
			return fetch(this.baseUri + 'analyzer', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListAnalyzers(maxResults: number, nextToken: string, type: Type, headersHandler?: () => {[header: string]: string}): Promise<ListAnalyzersResponse> {
			return fetch(this.baseUri + 'analyzer?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&type=' + type, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateArchiveRule(analyzerName: string, requestBody: CreateArchiveRuleBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListArchiveRules(analyzerName: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListArchiveRulesResponse> {
			return fetch(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteAnalyzer(analyzerName: string, clientToken: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAnalyzer(analyzerName: string, headersHandler?: () => {[header: string]: string}): Promise<GetAnalyzerResponse> {
			return fetch(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteArchiveRule(analyzerName: string, clientToken: string, ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule/' + (ruleName == null ? '' : encodeURIComponent(ruleName)) + '&clientToken=' + (clientToken == null ? '' : encodeURIComponent(clientToken)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetArchiveRule(analyzerName: string, ruleName: string, headersHandler?: () => {[header: string]: string}): Promise<GetArchiveRuleResponse> {
			return fetch(this.baseUri + 'analyzer/' + (analyzerName == null ? '' : encodeURIComponent(analyzerName)) + '/archive-rule/' + (ruleName == null ? '' : encodeURIComponent(ruleName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetAnalyzedResource(analyzerArn: string, resourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetAnalyzedResourceResponse> {
			return fetch(this.baseUri + 'analyzed-resource#analyzerArn&resourceArn?analyzerArn=' + (analyzerArn == null ? '' : encodeURIComponent(analyzerArn)) + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFinding(analyzerArn: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<GetFindingResponse> {
			return fetch(this.baseUri + 'finding/' + (id == null ? '' : encodeURIComponent(id)) + '#analyzerArn?analyzerArn=' + (analyzerArn == null ? '' : encodeURIComponent(analyzerArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateFindings(requestBody: UpdateFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'finding', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		StartResourceScan(requestBody: StartResourceScanBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'resource/scan', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
