...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDetectDominantLanguage(requestBody: BatchDetectDominantLanguageRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectDominantLanguageResponse> {
			return Axios.post<BatchDetectDominantLanguageResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectDominantLanguage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDetectEntities(requestBody: BatchDetectEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectEntitiesResponse> {
			return Axios.post<BatchDetectEntitiesResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectEntities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDetectKeyPhrases(requestBody: BatchDetectKeyPhrasesRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectKeyPhrasesResponse> {
			return Axios.post<BatchDetectKeyPhrasesResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectKeyPhrases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDetectSentiment(requestBody: BatchDetectSentimentRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectSentimentResponse> {
			return Axios.post<BatchDetectSentimentResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectSentiment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDetectSyntax(requestBody: BatchDetectSyntaxRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectSyntaxResponse> {
			return Axios.post<BatchDetectSyntaxResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectSyntax', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ClassifyDocument(requestBody: ClassifyDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<ClassifyDocumentResponse> {
			return Axios.post<ClassifyDocumentResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ClassifyDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDocumentClassifier(requestBody: CreateDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDocumentClassifierResponse> {
			return Axios.post<CreateDocumentClassifierResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.CreateDocumentClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateEndpoint(requestBody: CreateEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointResponse> {
			return Axios.post<CreateEndpointResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.CreateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateEntityRecognizer(requestBody: CreateEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEntityRecognizerResponse> {
			return Axios.post<CreateEntityRecognizerResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.CreateEntityRecognizer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDocumentClassifier(requestBody: DeleteDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDocumentClassifierResponse> {
			return Axios.post<DeleteDocumentClassifierResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DeleteDocumentClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteEndpoint(requestBody: DeleteEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEndpointResponse> {
			return Axios.post<DeleteEndpointResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DeleteEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteEntityRecognizer(requestBody: DeleteEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEntityRecognizerResponse> {
			return Axios.post<DeleteEntityRecognizerResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DeleteEntityRecognizer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDocumentClassificationJob(requestBody: DescribeDocumentClassificationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentClassificationJobResponse> {
			return Axios.post<DescribeDocumentClassificationJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeDocumentClassificationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDocumentClassifier(requestBody: DescribeDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentClassifierResponse> {
			return Axios.post<DescribeDocumentClassifierResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeDocumentClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDominantLanguageDetectionJob(requestBody: DescribeDominantLanguageDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDominantLanguageDetectionJobResponse> {
			return Axios.post<DescribeDominantLanguageDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeDominantLanguageDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEndpoint(requestBody: DescribeEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointResponse> {
			return Axios.post<DescribeEndpointResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEntityRecognizer(requestBody: DescribeEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntityRecognizerResponse> {
			return Axios.post<DescribeEntityRecognizerResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeEntityRecognizer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeKeyPhrasesDetectionJob(requestBody: DescribeKeyPhrasesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeKeyPhrasesDetectionJobResponse> {
			return Axios.post<DescribeKeyPhrasesDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeKeyPhrasesDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSentimentDetectionJob(requestBody: DescribeSentimentDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSentimentDetectionJobResponse> {
			return Axios.post<DescribeSentimentDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeSentimentDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeTopicsDetectionJob(requestBody: DescribeTopicsDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTopicsDetectionJobResponse> {
			return Axios.post<DescribeTopicsDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeTopicsDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectDominantLanguage(requestBody: DetectDominantLanguageRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectDominantLanguageResponse> {
			return Axios.post<DetectDominantLanguageResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectDominantLanguage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectEntities(requestBody: DetectEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectEntitiesResponse> {
			return Axios.post<DetectEntitiesResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectEntities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectKeyPhrases(requestBody: DetectKeyPhrasesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectKeyPhrasesResponse> {
			return Axios.post<DetectKeyPhrasesResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectKeyPhrases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectSentiment(requestBody: DetectSentimentRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectSentimentResponse> {
			return Axios.post<DetectSentimentResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectSentiment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectSyntax(requestBody: DetectSyntaxRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectSyntaxResponse> {
			return Axios.post<DetectSyntaxResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectSyntax', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDocumentClassificationJobs(MaxResults: string, NextToken: string, requestBody: ListDocumentClassificationJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDocumentClassificationJobsResponse> {
			return Axios.post<ListDocumentClassificationJobsResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListDocumentClassificationJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDocumentClassifiers(MaxResults: string, NextToken: string, requestBody: ListDocumentClassifiersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDocumentClassifiersResponse> {
			return Axios.post<ListDocumentClassifiersResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListDocumentClassifiers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDominantLanguageDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListDominantLanguageDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDominantLanguageDetectionJobsResponse> {
			return Axios.post<ListDominantLanguageDetectionJobsResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListDominantLanguageDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEndpoints(requestBody: ListEndpointsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEndpointsResponse> {
			return Axios.post<ListEndpointsResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListEndpoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEntitiesDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListEntitiesDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEntitiesDetectionJobsResponse> {
			return Axios.post<ListEntitiesDetectionJobsResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListEntitiesDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEntityRecognizers(MaxResults: string, NextToken: string, requestBody: ListEntityRecognizersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEntityRecognizersResponse> {
			return Axios.post<ListEntityRecognizersResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListEntityRecognizers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListKeyPhrasesDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListKeyPhrasesDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeyPhrasesDetectionJobsResponse> {
			return Axios.post<ListKeyPhrasesDetectionJobsResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListKeyPhrasesDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSentimentDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListSentimentDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSentimentDetectionJobsResponse> {
			return Axios.post<ListSentimentDetectionJobsResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListSentimentDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartDocumentClassificationJob(requestBody: StartDocumentClassificationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartDocumentClassificationJobResponse> {
			return Axios.post<StartDocumentClassificationJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartDocumentClassificationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartEntitiesDetectionJob(requestBody: StartEntitiesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartEntitiesDetectionJobResponse> {
			return Axios.post<StartEntitiesDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartEntitiesDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartKeyPhrasesDetectionJob(requestBody: StartKeyPhrasesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartKeyPhrasesDetectionJobResponse> {
			return Axios.post<StartKeyPhrasesDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartKeyPhrasesDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartSentimentDetectionJob(requestBody: StartSentimentDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSentimentDetectionJobResponse> {
			return Axios.post<StartSentimentDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartSentimentDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartTopicsDetectionJob(requestBody: StartTopicsDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTopicsDetectionJobResponse> {
			return Axios.post<StartTopicsDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartTopicsDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopDominantLanguageDetectionJob(requestBody: StopDominantLanguageDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopDominantLanguageDetectionJobResponse> {
			return Axios.post<StopDominantLanguageDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopDominantLanguageDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopEntitiesDetectionJob(requestBody: StopEntitiesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopEntitiesDetectionJobResponse> {
			return Axios.post<StopEntitiesDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopEntitiesDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopSentimentDetectionJob(requestBody: StopSentimentDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopSentimentDetectionJobResponse> {
			return Axios.post<StopSentimentDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopSentimentDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopTrainingDocumentClassifier(requestBody: StopTrainingDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<StopTrainingDocumentClassifierResponse> {
			return Axios.post<StopTrainingDocumentClassifierResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopTrainingDocumentClassifier', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopTrainingEntityRecognizer(requestBody: StopTrainingEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<StopTrainingEntityRecognizerResponse> {
			return Axios.post<StopTrainingEntityRecognizerResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopTrainingEntityRecognizer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateEndpoint(requestBody: UpdateEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointResponse> {
			return Axios.post<UpdateEndpointResponse>(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.UpdateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
