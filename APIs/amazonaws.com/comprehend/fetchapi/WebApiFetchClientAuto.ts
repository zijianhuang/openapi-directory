export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDetectDominantLanguage(requestBody: BatchDetectDominantLanguageRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectDominantLanguageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectDominantLanguage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchDetectEntities(requestBody: BatchDetectEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectEntitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectEntities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchDetectKeyPhrases(requestBody: BatchDetectKeyPhrasesRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectKeyPhrasesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectKeyPhrases', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchDetectSentiment(requestBody: BatchDetectSentimentRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectSentimentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectSentiment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchDetectSyntax(requestBody: BatchDetectSyntaxRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDetectSyntaxResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.BatchDetectSyntax', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ClassifyDocument(requestBody: ClassifyDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<ClassifyDocumentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ClassifyDocument', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDocumentClassifier(requestBody: CreateDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDocumentClassifierResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.CreateDocumentClassifier', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEndpoint(requestBody: CreateEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.CreateEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEntityRecognizer(requestBody: CreateEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEntityRecognizerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.CreateEntityRecognizer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDocumentClassifier(requestBody: DeleteDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDocumentClassifierResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DeleteDocumentClassifier', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEndpoint(requestBody: DeleteEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DeleteEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEntityRecognizer(requestBody: DeleteEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEntityRecognizerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DeleteEntityRecognizer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDocumentClassificationJob(requestBody: DescribeDocumentClassificationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentClassificationJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeDocumentClassificationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDocumentClassifier(requestBody: DescribeDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentClassifierResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeDocumentClassifier', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDominantLanguageDetectionJob(requestBody: DescribeDominantLanguageDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDominantLanguageDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeDominantLanguageDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEndpoint(requestBody: DescribeEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEntitiesDetectionJob(requestBody: DescribeEntitiesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntitiesDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeEntitiesDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEntityRecognizer(requestBody: DescribeEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntityRecognizerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeEntityRecognizer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeKeyPhrasesDetectionJob(requestBody: DescribeKeyPhrasesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeKeyPhrasesDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeKeyPhrasesDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSentimentDetectionJob(requestBody: DescribeSentimentDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSentimentDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeSentimentDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTopicsDetectionJob(requestBody: DescribeTopicsDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTopicsDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DescribeTopicsDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectDominantLanguage(requestBody: DetectDominantLanguageRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectDominantLanguageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectDominantLanguage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectEntities(requestBody: DetectEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectEntitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectEntities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectKeyPhrases(requestBody: DetectKeyPhrasesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectKeyPhrasesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectKeyPhrases', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectSentiment(requestBody: DetectSentimentRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectSentimentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectSentiment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectSyntax(requestBody: DetectSyntaxRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectSyntaxResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.DetectSyntax', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDocumentClassificationJobs(MaxResults: string, NextToken: string, requestBody: ListDocumentClassificationJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDocumentClassificationJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListDocumentClassificationJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDocumentClassifiers(MaxResults: string, NextToken: string, requestBody: ListDocumentClassifiersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDocumentClassifiersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListDocumentClassifiers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDominantLanguageDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListDominantLanguageDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDominantLanguageDetectionJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListDominantLanguageDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEndpoints(requestBody: ListEndpointsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEndpointsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListEndpoints', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEntitiesDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListEntitiesDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEntitiesDetectionJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListEntitiesDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEntityRecognizers(MaxResults: string, NextToken: string, requestBody: ListEntityRecognizersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEntityRecognizersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListEntityRecognizers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListKeyPhrasesDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListKeyPhrasesDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListKeyPhrasesDetectionJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListKeyPhrasesDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSentimentDetectionJobs(MaxResults: string, NextToken: string, requestBody: ListSentimentDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSentimentDetectionJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListSentimentDetectionJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartDocumentClassificationJob(requestBody: StartDocumentClassificationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartDocumentClassificationJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartDocumentClassificationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartDominantLanguageDetectionJob(requestBody: StartDominantLanguageDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartDominantLanguageDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartDominantLanguageDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartEntitiesDetectionJob(requestBody: StartEntitiesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartEntitiesDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartEntitiesDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartKeyPhrasesDetectionJob(requestBody: StartKeyPhrasesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartKeyPhrasesDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartKeyPhrasesDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartSentimentDetectionJob(requestBody: StartSentimentDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSentimentDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartSentimentDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartTopicsDetectionJob(requestBody: StartTopicsDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTopicsDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StartTopicsDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopDominantLanguageDetectionJob(requestBody: StopDominantLanguageDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopDominantLanguageDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopDominantLanguageDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopEntitiesDetectionJob(requestBody: StopEntitiesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopEntitiesDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopEntitiesDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopKeyPhrasesDetectionJob(requestBody: StopKeyPhrasesDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopKeyPhrasesDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopKeyPhrasesDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopSentimentDetectionJob(requestBody: StopSentimentDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopSentimentDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopSentimentDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopTrainingDocumentClassifier(requestBody: StopTrainingDocumentClassifierRequest, headersHandler?: () => {[header: string]: string}): Promise<StopTrainingDocumentClassifierResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopTrainingDocumentClassifier', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopTrainingEntityRecognizer(requestBody: StopTrainingEntityRecognizerRequest, headersHandler?: () => {[header: string]: string}): Promise<StopTrainingEntityRecognizerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.StopTrainingEntityRecognizer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateEndpoint(requestBody: UpdateEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=Comprehend_20171127.UpdateEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
