export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.AddTags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AssociateTrialComponent(requestBody: AssociateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateTrialComponentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.AssociateTrialComponent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAlgorithm(requestBody: CreateAlgorithmInput, headersHandler?: () => {[header: string]: string}): Promise<CreateAlgorithmOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateAlgorithm', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateApp(requestBody: CreateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAppResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateApp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAutoMLJob(requestBody: CreateAutoMLJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAutoMLJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateAutoMLJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateCodeRepository(requestBody: CreateCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<CreateCodeRepositoryOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateCodeRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateCompilationJob(requestBody: CreateCompilationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCompilationJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateCompilationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDomain(requestBody: CreateDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateDomain', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEndpoint(requestBody: CreateEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEndpointConfig(requestBody: CreateEndpointConfigInput, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointConfigOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateEndpointConfig', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateExperiment(requestBody: CreateExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateExperimentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateExperiment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateFlowDefinition(requestBody: CreateFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFlowDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateFlowDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateHumanTaskUi(requestBody: CreateHumanTaskUiRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHumanTaskUiResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateHumanTaskUi', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateHyperParameterTuningJob(requestBody: CreateHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHyperParameterTuningJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateHyperParameterTuningJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateLabelingJob(requestBody: CreateLabelingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLabelingJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateLabelingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateModel(requestBody: CreateModelInput, headersHandler?: () => {[header: string]: string}): Promise<CreateModelOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateModel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateModelPackage(requestBody: CreateModelPackageInput, headersHandler?: () => {[header: string]: string}): Promise<CreateModelPackageOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateModelPackage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateMonitoringSchedule(requestBody: CreateMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMonitoringScheduleResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateMonitoringSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateNotebookInstance(requestBody: CreateNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<CreateNotebookInstanceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateNotebookInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateNotebookInstanceLifecycleConfig(requestBody: CreateNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<CreateNotebookInstanceLifecycleConfigOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateNotebookInstanceLifecycleConfig', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePresignedDomainUrl(requestBody: CreatePresignedDomainUrlRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePresignedDomainUrlResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreatePresignedDomainUrl', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePresignedNotebookInstanceUrl(requestBody: CreatePresignedNotebookInstanceUrlInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePresignedNotebookInstanceUrlOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreatePresignedNotebookInstanceUrl', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateProcessingJob(requestBody: CreateProcessingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProcessingJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateProcessingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateTrainingJob(requestBody: CreateTrainingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrainingJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrainingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateTransformJob(requestBody: CreateTransformJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTransformJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTransformJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateTrial(requestBody: CreateTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrialResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrial', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateTrialComponent(requestBody: CreateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrialComponentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrialComponent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateUserProfile(requestBody: CreateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserProfileResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateWorkteam(requestBody: CreateWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkteamResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.CreateWorkteam', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlgorithm(requestBody: DeleteAlgorithmInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteAlgorithm', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteApp(requestBody: DeleteAppRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteApp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCodeRepository(requestBody: DeleteCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteCodeRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDomain(requestBody: DeleteDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteDomain', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpoint(requestBody: DeleteEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpointConfig(requestBody: DeleteEndpointConfigInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteEndpointConfig', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteExperiment(requestBody: DeleteExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteExperimentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteExperiment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteFlowDefinition(requestBody: DeleteFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFlowDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteFlowDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteModel(requestBody: DeleteModelInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteModel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteModelPackage(requestBody: DeleteModelPackageInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteModelPackage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMonitoringSchedule(requestBody: DeleteMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteMonitoringSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteNotebookInstance(requestBody: DeleteNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteNotebookInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteNotebookInstanceLifecycleConfig(requestBody: DeleteNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteNotebookInstanceLifecycleConfig', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteTags(requestBody: DeleteTagsInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteTrial(requestBody: DeleteTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrialResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTrial', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteTrialComponent(requestBody: DeleteTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrialComponentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTrialComponent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteUserProfile(requestBody: DeleteUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteWorkteam(requestBody: DeleteWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkteamResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteWorkteam', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeAlgorithm(requestBody: DescribeAlgorithmInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeAlgorithmOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeAlgorithm', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeApp(requestBody: DescribeAppRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAppResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeApp', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeAutoMLJob(requestBody: DescribeAutoMLJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAutoMLJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeAutoMLJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeCodeRepository(requestBody: DescribeCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeCodeRepositoryOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeCodeRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeCompilationJob(requestBody: DescribeCompilationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCompilationJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeCompilationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDomain(requestBody: DescribeDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeDomain', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEndpoint(requestBody: DescribeEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEndpointConfig(requestBody: DescribeEndpointConfigInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointConfigOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeEndpointConfig', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeExperiment(requestBody: DescribeExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExperimentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeExperiment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFlowDefinition(requestBody: DescribeFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFlowDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeFlowDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeHumanTaskUi(requestBody: DescribeHumanTaskUiRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHumanTaskUiResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeHumanTaskUi', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeHyperParameterTuningJob(requestBody: DescribeHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHyperParameterTuningJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeHyperParameterTuningJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLabelingJob(requestBody: DescribeLabelingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLabelingJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeLabelingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeModel(requestBody: DescribeModelInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeModelOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeModel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeModelPackage(requestBody: DescribeModelPackageInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeModelPackageOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeModelPackage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMonitoringSchedule(requestBody: DescribeMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMonitoringScheduleResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeMonitoringSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeNotebookInstance(requestBody: DescribeNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotebookInstanceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeNotebookInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeNotebookInstanceLifecycleConfig(requestBody: DescribeNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotebookInstanceLifecycleConfigOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeNotebookInstanceLifecycleConfig', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeProcessingJob(requestBody: DescribeProcessingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeProcessingJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeProcessingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSubscribedWorkteam(requestBody: DescribeSubscribedWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSubscribedWorkteamResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeSubscribedWorkteam', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTrainingJob(requestBody: DescribeTrainingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrainingJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrainingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTransformJob(requestBody: DescribeTransformJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTransformJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTransformJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTrial(requestBody: DescribeTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrialResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrial', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTrialComponent(requestBody: DescribeTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrialComponentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrialComponent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeUserProfile(requestBody: DescribeUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserProfileResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeWorkforce(requestBody: DescribeWorkforceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkforceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeWorkforce', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeWorkteam(requestBody: DescribeWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkteamResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeWorkteam', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisassociateTrialComponent(requestBody: DisassociateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateTrialComponentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.DisassociateTrialComponent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSearchSuggestions(requestBody: GetSearchSuggestionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSearchSuggestionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.GetSearchSuggestions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListApps(MaxResults: string, NextToken: string, requestBody: ListAppsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAppsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListApps?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListAutoMLJobs(MaxResults: string, NextToken: string, requestBody: ListAutoMLJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAutoMLJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListAutoMLJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCandidatesForAutoMLJob(MaxResults: string, NextToken: string, requestBody: ListCandidatesForAutoMLJobRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCandidatesForAutoMLJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListCandidatesForAutoMLJob?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCodeRepositories(MaxResults: string, NextToken: string, requestBody: ListCodeRepositoriesInput, headersHandler?: () => {[header: string]: string}): Promise<ListCodeRepositoriesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListCodeRepositories?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCompilationJobs(MaxResults: string, NextToken: string, requestBody: ListCompilationJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCompilationJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListCompilationJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDomains(MaxResults: string, NextToken: string, requestBody: ListDomainsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDomainsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListDomains?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEndpointConfigs(MaxResults: string, NextToken: string, requestBody: ListEndpointConfigsInput, headersHandler?: () => {[header: string]: string}): Promise<ListEndpointConfigsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListEndpointConfigs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEndpoints(MaxResults: string, NextToken: string, requestBody: ListEndpointsInput, headersHandler?: () => {[header: string]: string}): Promise<ListEndpointsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListEndpoints?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListExperiments(MaxResults: string, NextToken: string, requestBody: ListExperimentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListExperimentsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListExperiments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListFlowDefinitions(MaxResults: string, NextToken: string, requestBody: ListFlowDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListFlowDefinitionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListFlowDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListHumanTaskUis(MaxResults: string, NextToken: string, requestBody: ListHumanTaskUisRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHumanTaskUisResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListHumanTaskUis?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListLabelingJobs(MaxResults: string, NextToken: string, requestBody: ListLabelingJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLabelingJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListLabelingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListLabelingJobsForWorkteam(MaxResults: string, NextToken: string, requestBody: ListLabelingJobsForWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLabelingJobsForWorkteamResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListLabelingJobsForWorkteam?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListModelPackages(MaxResults: string, NextToken: string, requestBody: ListModelPackagesInput, headersHandler?: () => {[header: string]: string}): Promise<ListModelPackagesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListModelPackages?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListModels(MaxResults: string, NextToken: string, requestBody: ListModelsInput, headersHandler?: () => {[header: string]: string}): Promise<ListModelsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListModels?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListMonitoringExecutions(MaxResults: string, NextToken: string, requestBody: ListMonitoringExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMonitoringExecutionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListMonitoringExecutions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListMonitoringSchedules(MaxResults: string, NextToken: string, requestBody: ListMonitoringSchedulesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMonitoringSchedulesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListMonitoringSchedules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListNotebookInstanceLifecycleConfigs(MaxResults: string, NextToken: string, requestBody: ListNotebookInstanceLifecycleConfigsInput, headersHandler?: () => {[header: string]: string}): Promise<ListNotebookInstanceLifecycleConfigsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListNotebookInstanceLifecycleConfigs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListNotebookInstances(MaxResults: string, NextToken: string, requestBody: ListNotebookInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<ListNotebookInstancesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListNotebookInstances?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListProcessingJobs(MaxResults: string, NextToken: string, requestBody: ListProcessingJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListProcessingJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListProcessingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSubscribedWorkteams(MaxResults: string, NextToken: string, requestBody: ListSubscribedWorkteamsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSubscribedWorkteamsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListSubscribedWorkteams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTags(MaxResults: string, NextToken: string, requestBody: ListTagsInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListTags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTrainingJobs(MaxResults: string, NextToken: string, requestBody: ListTrainingJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTrainingJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrainingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTrialComponents(MaxResults: string, NextToken: string, requestBody: ListTrialComponentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTrialComponentsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrialComponents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTrials(MaxResults: string, NextToken: string, requestBody: ListTrialsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTrialsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrials?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListUserProfiles(MaxResults: string, NextToken: string, requestBody: ListUserProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUserProfilesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListUserProfiles?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListWorkteams(MaxResults: string, NextToken: string, requestBody: ListWorkteamsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListWorkteamsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.ListWorkteams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RenderUiTemplate(requestBody: RenderUiTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<RenderUiTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.RenderUiTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Search(MaxResults: string, NextToken: string, requestBody: SearchRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.Search?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		StartMonitoringSchedule(requestBody: StartMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StartMonitoringSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StartNotebookInstance(requestBody: StartNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StartNotebookInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopAutoMLJob(requestBody: StopAutoMLJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopAutoMLJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopCompilationJob(requestBody: StopCompilationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopCompilationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopHyperParameterTuningJob(requestBody: StopHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopHyperParameterTuningJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopLabelingJob(requestBody: StopLabelingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopLabelingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopMonitoringSchedule(requestBody: StopMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopMonitoringSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopNotebookInstance(requestBody: StopNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopNotebookInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopProcessingJob(requestBody: StopProcessingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopProcessingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopTrainingJob(requestBody: StopTrainingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopTrainingJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopTransformJob(requestBody: StopTransformJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.StopTransformJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateCodeRepository(requestBody: UpdateCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateCodeRepositoryOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateCodeRepository', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDomain(requestBody: UpdateDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateDomain', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateEndpoint(requestBody: UpdateEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateEndpointWeightsAndCapacities(requestBody: UpdateEndpointWeightsAndCapacitiesInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointWeightsAndCapacitiesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateEndpointWeightsAndCapacities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateExperiment(requestBody: UpdateExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateExperimentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateExperiment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateMonitoringSchedule(requestBody: UpdateMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMonitoringScheduleResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateMonitoringSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateNotebookInstance(requestBody: UpdateNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotebookInstanceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateNotebookInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateNotebookInstanceLifecycleConfig(requestBody: UpdateNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotebookInstanceLifecycleConfigOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateNotebookInstanceLifecycleConfig', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateTrial(requestBody: UpdateTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrialResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateTrial', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateTrialComponent(requestBody: UpdateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrialComponentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateTrialComponent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateUserProfile(requestBody: UpdateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserProfileResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateUserProfile', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateWorkforce(requestBody: UpdateWorkforceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateWorkforceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateWorkforce', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateWorkteam(requestBody: UpdateWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateWorkteamResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateWorkteam', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
