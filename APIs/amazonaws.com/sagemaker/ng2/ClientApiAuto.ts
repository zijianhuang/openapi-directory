...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddTags(requestBody: AddTagsInput, headersHandler?: () => HttpHeaders): Observable<AddTagsOutput> {
			return this.http.post<AddTagsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssociateTrialComponent(requestBody: AssociateTrialComponentRequest, headersHandler?: () => HttpHeaders): Observable<AssociateTrialComponentResponse> {
			return this.http.post<AssociateTrialComponentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.AssociateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAlgorithm(requestBody: CreateAlgorithmInput, headersHandler?: () => HttpHeaders): Observable<CreateAlgorithmOutput> {
			return this.http.post<CreateAlgorithmOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateAlgorithm', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateApp(requestBody: CreateAppRequest, headersHandler?: () => HttpHeaders): Observable<CreateAppResponse> {
			return this.http.post<CreateAppResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateApp', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAutoMLJob(requestBody: CreateAutoMLJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateAutoMLJobResponse> {
			return this.http.post<CreateAutoMLJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateAutoMLJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateCodeRepository(requestBody: CreateCodeRepositoryInput, headersHandler?: () => HttpHeaders): Observable<CreateCodeRepositoryOutput> {
			return this.http.post<CreateCodeRepositoryOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateCompilationJob(requestBody: CreateCompilationJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateCompilationJobResponse> {
			return this.http.post<CreateCompilationJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateCompilationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDomain(requestBody: CreateDomainRequest, headersHandler?: () => HttpHeaders): Observable<CreateDomainResponse> {
			return this.http.post<CreateDomainResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateEndpoint(requestBody: CreateEndpointInput, headersHandler?: () => HttpHeaders): Observable<CreateEndpointOutput> {
			return this.http.post<CreateEndpointOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateEndpointConfig(requestBody: CreateEndpointConfigInput, headersHandler?: () => HttpHeaders): Observable<CreateEndpointConfigOutput> {
			return this.http.post<CreateEndpointConfigOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateEndpointConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateExperiment(requestBody: CreateExperimentRequest, headersHandler?: () => HttpHeaders): Observable<CreateExperimentResponse> {
			return this.http.post<CreateExperimentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateExperiment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateFlowDefinition(requestBody: CreateFlowDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<CreateFlowDefinitionResponse> {
			return this.http.post<CreateFlowDefinitionResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateFlowDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateHumanTaskUi(requestBody: CreateHumanTaskUiRequest, headersHandler?: () => HttpHeaders): Observable<CreateHumanTaskUiResponse> {
			return this.http.post<CreateHumanTaskUiResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateHumanTaskUi', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateHyperParameterTuningJob(requestBody: CreateHyperParameterTuningJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateHyperParameterTuningJobResponse> {
			return this.http.post<CreateHyperParameterTuningJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateHyperParameterTuningJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateLabelingJob(requestBody: CreateLabelingJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateLabelingJobResponse> {
			return this.http.post<CreateLabelingJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateLabelingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateModel(requestBody: CreateModelInput, headersHandler?: () => HttpHeaders): Observable<CreateModelOutput> {
			return this.http.post<CreateModelOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateModel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateModelPackage(requestBody: CreateModelPackageInput, headersHandler?: () => HttpHeaders): Observable<CreateModelPackageOutput> {
			return this.http.post<CreateModelPackageOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateModelPackage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateMonitoringSchedule(requestBody: CreateMonitoringScheduleRequest, headersHandler?: () => HttpHeaders): Observable<CreateMonitoringScheduleResponse> {
			return this.http.post<CreateMonitoringScheduleResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateNotebookInstance(requestBody: CreateNotebookInstanceInput, headersHandler?: () => HttpHeaders): Observable<CreateNotebookInstanceOutput> {
			return this.http.post<CreateNotebookInstanceOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateNotebookInstanceLifecycleConfig(requestBody: CreateNotebookInstanceLifecycleConfigInput, headersHandler?: () => HttpHeaders): Observable<CreateNotebookInstanceLifecycleConfigOutput> {
			return this.http.post<CreateNotebookInstanceLifecycleConfigOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreatePresignedDomainUrl(requestBody: CreatePresignedDomainUrlRequest, headersHandler?: () => HttpHeaders): Observable<CreatePresignedDomainUrlResponse> {
			return this.http.post<CreatePresignedDomainUrlResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreatePresignedDomainUrl', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreatePresignedNotebookInstanceUrl(requestBody: CreatePresignedNotebookInstanceUrlInput, headersHandler?: () => HttpHeaders): Observable<CreatePresignedNotebookInstanceUrlOutput> {
			return this.http.post<CreatePresignedNotebookInstanceUrlOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.CreatePresignedNotebookInstanceUrl', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateProcessingJob(requestBody: CreateProcessingJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateProcessingJobResponse> {
			return this.http.post<CreateProcessingJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateProcessingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTrainingJob(requestBody: CreateTrainingJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateTrainingJobResponse> {
			return this.http.post<CreateTrainingJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrainingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTransformJob(requestBody: CreateTransformJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateTransformJobResponse> {
			return this.http.post<CreateTransformJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTransformJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTrial(requestBody: CreateTrialRequest, headersHandler?: () => HttpHeaders): Observable<CreateTrialResponse> {
			return this.http.post<CreateTrialResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrial', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTrialComponent(requestBody: CreateTrialComponentRequest, headersHandler?: () => HttpHeaders): Observable<CreateTrialComponentResponse> {
			return this.http.post<CreateTrialComponentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateUserProfile(requestBody: CreateUserProfileRequest, headersHandler?: () => HttpHeaders): Observable<CreateUserProfileResponse> {
			return this.http.post<CreateUserProfileResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateWorkteam(requestBody: CreateWorkteamRequest, headersHandler?: () => HttpHeaders): Observable<CreateWorkteamResponse> {
			return this.http.post<CreateWorkteamResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.CreateWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlgorithm(requestBody: DeleteAlgorithmInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteAlgorithm', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteApp(requestBody: DeleteAppRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteApp', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCodeRepository(requestBody: DeleteCodeRepositoryInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDomain(requestBody: DeleteDomainRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpoint(requestBody: DeleteEndpointInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpointConfig(requestBody: DeleteEndpointConfigInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteEndpointConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeleteExperiment(requestBody: DeleteExperimentRequest, headersHandler?: () => HttpHeaders): Observable<DeleteExperimentResponse> {
			return this.http.post<DeleteExperimentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteExperiment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteFlowDefinition(requestBody: DeleteFlowDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<DeleteFlowDefinitionResponse> {
			return this.http.post<DeleteFlowDefinitionResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteFlowDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteModel(requestBody: DeleteModelInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteModel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteModelPackage(requestBody: DeleteModelPackageInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteModelPackage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMonitoringSchedule(requestBody: DeleteMonitoringScheduleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteNotebookInstance(requestBody: DeleteNotebookInstanceInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteNotebookInstanceLifecycleConfig(requestBody: DeleteNotebookInstanceLifecycleConfigInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeleteTags(requestBody: DeleteTagsInput, headersHandler?: () => HttpHeaders): Observable<DeleteTagsOutput> {
			return this.http.post<DeleteTagsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTrial(requestBody: DeleteTrialRequest, headersHandler?: () => HttpHeaders): Observable<DeleteTrialResponse> {
			return this.http.post<DeleteTrialResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTrial', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTrialComponent(requestBody: DeleteTrialComponentRequest, headersHandler?: () => HttpHeaders): Observable<DeleteTrialComponentResponse> {
			return this.http.post<DeleteTrialComponentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteUserProfile(requestBody: DeleteUserProfileRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DeleteWorkteam(requestBody: DeleteWorkteamRequest, headersHandler?: () => HttpHeaders): Observable<DeleteWorkteamResponse> {
			return this.http.post<DeleteWorkteamResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAlgorithm(requestBody: DescribeAlgorithmInput, headersHandler?: () => HttpHeaders): Observable<DescribeAlgorithmOutput> {
			return this.http.post<DescribeAlgorithmOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeAlgorithm', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeApp(requestBody: DescribeAppRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAppResponse> {
			return this.http.post<DescribeAppResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeApp', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAutoMLJob(requestBody: DescribeAutoMLJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAutoMLJobResponse> {
			return this.http.post<DescribeAutoMLJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeAutoMLJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCodeRepository(requestBody: DescribeCodeRepositoryInput, headersHandler?: () => HttpHeaders): Observable<DescribeCodeRepositoryOutput> {
			return this.http.post<DescribeCodeRepositoryOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCompilationJob(requestBody: DescribeCompilationJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeCompilationJobResponse> {
			return this.http.post<DescribeCompilationJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeCompilationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDomain(requestBody: DescribeDomainRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDomainResponse> {
			return this.http.post<DescribeDomainResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEndpoint(requestBody: DescribeEndpointInput, headersHandler?: () => HttpHeaders): Observable<DescribeEndpointOutput> {
			return this.http.post<DescribeEndpointOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEndpointConfig(requestBody: DescribeEndpointConfigInput, headersHandler?: () => HttpHeaders): Observable<DescribeEndpointConfigOutput> {
			return this.http.post<DescribeEndpointConfigOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeEndpointConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeExperiment(requestBody: DescribeExperimentRequest, headersHandler?: () => HttpHeaders): Observable<DescribeExperimentResponse> {
			return this.http.post<DescribeExperimentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeExperiment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeFlowDefinition(requestBody: DescribeFlowDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<DescribeFlowDefinitionResponse> {
			return this.http.post<DescribeFlowDefinitionResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeFlowDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeHumanTaskUi(requestBody: DescribeHumanTaskUiRequest, headersHandler?: () => HttpHeaders): Observable<DescribeHumanTaskUiResponse> {
			return this.http.post<DescribeHumanTaskUiResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeHumanTaskUi', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeHyperParameterTuningJob(requestBody: DescribeHyperParameterTuningJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeHyperParameterTuningJobResponse> {
			return this.http.post<DescribeHyperParameterTuningJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeHyperParameterTuningJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLabelingJob(requestBody: DescribeLabelingJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeLabelingJobResponse> {
			return this.http.post<DescribeLabelingJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeLabelingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeModel(requestBody: DescribeModelInput, headersHandler?: () => HttpHeaders): Observable<DescribeModelOutput> {
			return this.http.post<DescribeModelOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeModel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeModelPackage(requestBody: DescribeModelPackageInput, headersHandler?: () => HttpHeaders): Observable<DescribeModelPackageOutput> {
			return this.http.post<DescribeModelPackageOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeModelPackage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeMonitoringSchedule(requestBody: DescribeMonitoringScheduleRequest, headersHandler?: () => HttpHeaders): Observable<DescribeMonitoringScheduleResponse> {
			return this.http.post<DescribeMonitoringScheduleResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeNotebookInstance(requestBody: DescribeNotebookInstanceInput, headersHandler?: () => HttpHeaders): Observable<DescribeNotebookInstanceOutput> {
			return this.http.post<DescribeNotebookInstanceOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeNotebookInstanceLifecycleConfig(requestBody: DescribeNotebookInstanceLifecycleConfigInput, headersHandler?: () => HttpHeaders): Observable<DescribeNotebookInstanceLifecycleConfigOutput> {
			return this.http.post<DescribeNotebookInstanceLifecycleConfigOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeProcessingJob(requestBody: DescribeProcessingJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeProcessingJobResponse> {
			return this.http.post<DescribeProcessingJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeProcessingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSubscribedWorkteam(requestBody: DescribeSubscribedWorkteamRequest, headersHandler?: () => HttpHeaders): Observable<DescribeSubscribedWorkteamResponse> {
			return this.http.post<DescribeSubscribedWorkteamResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeSubscribedWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTrainingJob(requestBody: DescribeTrainingJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTrainingJobResponse> {
			return this.http.post<DescribeTrainingJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrainingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTransformJob(requestBody: DescribeTransformJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTransformJobResponse> {
			return this.http.post<DescribeTransformJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTransformJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTrial(requestBody: DescribeTrialRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTrialResponse> {
			return this.http.post<DescribeTrialResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrial', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTrialComponent(requestBody: DescribeTrialComponentRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTrialComponentResponse> {
			return this.http.post<DescribeTrialComponentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeUserProfile(requestBody: DescribeUserProfileRequest, headersHandler?: () => HttpHeaders): Observable<DescribeUserProfileResponse> {
			return this.http.post<DescribeUserProfileResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeWorkforce(requestBody: DescribeWorkforceRequest, headersHandler?: () => HttpHeaders): Observable<DescribeWorkforceResponse> {
			return this.http.post<DescribeWorkforceResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeWorkforce', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeWorkteam(requestBody: DescribeWorkteamRequest, headersHandler?: () => HttpHeaders): Observable<DescribeWorkteamResponse> {
			return this.http.post<DescribeWorkteamResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateTrialComponent(requestBody: DisassociateTrialComponentRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateTrialComponentResponse> {
			return this.http.post<DisassociateTrialComponentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.DisassociateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSearchSuggestions(requestBody: GetSearchSuggestionsRequest, headersHandler?: () => HttpHeaders): Observable<GetSearchSuggestionsResponse> {
			return this.http.post<GetSearchSuggestionsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.GetSearchSuggestions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAlgorithms(MaxResults: string, NextToken: string, requestBody: ListAlgorithmsInput, headersHandler?: () => HttpHeaders): Observable<ListAlgorithmsOutput> {
			return this.http.post<ListAlgorithmsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListAlgorithms?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListApps(MaxResults: string, NextToken: string, requestBody: ListAppsRequest, headersHandler?: () => HttpHeaders): Observable<ListAppsResponse> {
			return this.http.post<ListAppsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListApps?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAutoMLJobs(MaxResults: string, NextToken: string, requestBody: ListAutoMLJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListAutoMLJobsResponse> {
			return this.http.post<ListAutoMLJobsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListAutoMLJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCandidatesForAutoMLJob(MaxResults: string, NextToken: string, requestBody: ListCandidatesForAutoMLJobRequest, headersHandler?: () => HttpHeaders): Observable<ListCandidatesForAutoMLJobResponse> {
			return this.http.post<ListCandidatesForAutoMLJobResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListCandidatesForAutoMLJob?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCodeRepositories(MaxResults: string, NextToken: string, requestBody: ListCodeRepositoriesInput, headersHandler?: () => HttpHeaders): Observable<ListCodeRepositoriesOutput> {
			return this.http.post<ListCodeRepositoriesOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListCodeRepositories?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCompilationJobs(MaxResults: string, NextToken: string, requestBody: ListCompilationJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListCompilationJobsResponse> {
			return this.http.post<ListCompilationJobsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListCompilationJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDomains(MaxResults: string, NextToken: string, requestBody: ListDomainsRequest, headersHandler?: () => HttpHeaders): Observable<ListDomainsResponse> {
		 ...
		 */
		ListEndpointConfigs(MaxResults: string, NextToken: string, requestBody: ListEndpointConfigsInput, headersHandler?: () => HttpHeaders): Observable<ListEndpointConfigsOutput> {
			return this.http.post<ListEndpointConfigsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListEndpointConfigs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListEndpoints(MaxResults: string, NextToken: string, requestBody: ListEndpointsInput, headersHandler?: () => HttpHeaders): Observable<ListEndpointsOutput> {
			return this.http.post<ListEndpointsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListEndpoints?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListExperiments(MaxResults: string, NextToken: string, requestBody: ListExperimentsRequest, headersHandler?: () => HttpHeaders): Observable<ListExperimentsResponse> {
			return this.http.post<ListExperimentsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListExperiments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFlowDefinitions(MaxResults: string, NextToken: string, requestBody: ListFlowDefinitionsRequest, headersHandler?: () => HttpHeaders): Observable<ListFlowDefinitionsResponse> {
			return this.http.post<ListFlowDefinitionsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListFlowDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListHumanTaskUis(MaxResults: string, NextToken: string, requestBody: ListHumanTaskUisRequest, headersHandler?: () => HttpHeaders): Observable<ListHumanTaskUisResponse> {
			return this.http.post<ListHumanTaskUisResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListHumanTaskUis?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListHyperParameterTuningJobs(MaxResults: string, NextToken: string, requestBody: ListHyperParameterTuningJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListHyperParameterTuningJobsResponse> {
		 ...
		 */
		ListLabelingJobs(MaxResults: string, NextToken: string, requestBody: ListLabelingJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListLabelingJobsResponse> {
			return this.http.post<ListLabelingJobsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListLabelingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListLabelingJobsForWorkteam(MaxResults: string, NextToken: string, requestBody: ListLabelingJobsForWorkteamRequest, headersHandler?: () => HttpHeaders): Observable<ListLabelingJobsForWorkteamResponse> {
			return this.http.post<ListLabelingJobsForWorkteamResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListLabelingJobsForWorkteam?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListModelPackages(MaxResults: string, NextToken: string, requestBody: ListModelPackagesInput, headersHandler?: () => HttpHeaders): Observable<ListModelPackagesOutput> {
			return this.http.post<ListModelPackagesOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListModelPackages?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListModels(MaxResults: string, NextToken: string, requestBody: ListModelsInput, headersHandler?: () => HttpHeaders): Observable<ListModelsOutput> {
			return this.http.post<ListModelsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListModels?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListMonitoringExecutions(MaxResults: string, NextToken: string, requestBody: ListMonitoringExecutionsRequest, headersHandler?: () => HttpHeaders): Observable<ListMonitoringExecutionsResponse> {
			return this.http.post<ListMonitoringExecutionsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListMonitoringExecutions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListMonitoringSchedules(MaxResults: string, NextToken: string, requestBody: ListMonitoringSchedulesRequest, headersHandler?: () => HttpHeaders): Observable<ListMonitoringSchedulesResponse> {
			return this.http.post<ListMonitoringSchedulesResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListMonitoringSchedules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListNotebookInstanceLifecycleConfigs(MaxResults: string, NextToken: string, requestBody: ListNotebookInstanceLifecycleConfigsInput, headersHandler?: () => HttpHeaders): Observable<ListNotebookInstanceLifecycleConfigsOutput> {
			return this.http.post<ListNotebookInstanceLifecycleConfigsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListNotebookInstanceLifecycleConfigs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListNotebookInstances(MaxResults: string, NextToken: string, requestBody: ListNotebookInstancesInput, headersHandler?: () => HttpHeaders): Observable<ListNotebookInstancesOutput> {
			return this.http.post<ListNotebookInstancesOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListNotebookInstances?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListProcessingJobs(MaxResults: string, NextToken: string, requestBody: ListProcessingJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListProcessingJobsResponse> {
			return this.http.post<ListProcessingJobsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListProcessingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSubscribedWorkteams(MaxResults: string, NextToken: string, requestBody: ListSubscribedWorkteamsRequest, headersHandler?: () => HttpHeaders): Observable<ListSubscribedWorkteamsResponse> {
			return this.http.post<ListSubscribedWorkteamsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListSubscribedWorkteams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTags(MaxResults: string, NextToken: string, requestBody: ListTagsInput, headersHandler?: () => HttpHeaders): Observable<ListTagsOutput> {
			return this.http.post<ListTagsOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.ListTags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTrainingJobs(MaxResults: string, NextToken: string, requestBody: ListTrainingJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListTrainingJobsResponse> {
			return this.http.post<ListTrainingJobsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrainingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTrainingJobsForHyperParameterTuningJob(MaxResults: string, NextToken: string, requestBody: ListTrainingJobsForHyperParameterTuningJobRequest, headersHandler?: () => HttpHeaders): Observable<ListTrainingJobsForHyperParameterTuningJobResponse> {
		 ...
		 */
		ListTransformJobs(MaxResults: string, NextToken: string, requestBody: ListTransformJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListTransformJobsResponse> {
			return this.http.post<ListTransformJobsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListTransformJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTrialComponents(MaxResults: string, NextToken: string, requestBody: ListTrialComponentsRequest, headersHandler?: () => HttpHeaders): Observable<ListTrialComponentsResponse> {
			return this.http.post<ListTrialComponentsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrialComponents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTrials(MaxResults: string, NextToken: string, requestBody: ListTrialsRequest, headersHandler?: () => HttpHeaders): Observable<ListTrialsResponse> {
			return this.http.post<ListTrialsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrials?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListUserProfiles(MaxResults: string, NextToken: string, requestBody: ListUserProfilesRequest, headersHandler?: () => HttpHeaders): Observable<ListUserProfilesResponse> {
			return this.http.post<ListUserProfilesResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListUserProfiles?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListWorkteams(MaxResults: string, NextToken: string, requestBody: ListWorkteamsRequest, headersHandler?: () => HttpHeaders): Observable<ListWorkteamsResponse> {
			return this.http.post<ListWorkteamsResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.ListWorkteams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RenderUiTemplate(requestBody: RenderUiTemplateRequest, headersHandler?: () => HttpHeaders): Observable<RenderUiTemplateResponse> {
			return this.http.post<RenderUiTemplateResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.RenderUiTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		Search(MaxResults: string, NextToken: string, requestBody: SearchRequest, headersHandler?: () => HttpHeaders): Observable<SearchResponse> {
			return this.http.post<SearchResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.Search?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		StartMonitoringSchedule(requestBody: StartMonitoringScheduleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StartMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StartNotebookInstance(requestBody: StartNotebookInstanceInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StartNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopAutoMLJob(requestBody: StopAutoMLJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopAutoMLJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopCompilationJob(requestBody: StopCompilationJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopCompilationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopHyperParameterTuningJob(requestBody: StopHyperParameterTuningJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopHyperParameterTuningJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopLabelingJob(requestBody: StopLabelingJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopLabelingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopMonitoringSchedule(requestBody: StopMonitoringScheduleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopNotebookInstance(requestBody: StopNotebookInstanceInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopProcessingJob(requestBody: StopProcessingJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopProcessingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopTrainingJob(requestBody: StopTrainingJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopTrainingJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopTransformJob(requestBody: StopTransformJobRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopTransformJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateCodeRepository(requestBody: UpdateCodeRepositoryInput, headersHandler?: () => HttpHeaders): Observable<UpdateCodeRepositoryOutput> {
			return this.http.post<UpdateCodeRepositoryOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDomain(requestBody: UpdateDomainRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDomainResponse> {
			return this.http.post<UpdateDomainResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateEndpoint(requestBody: UpdateEndpointInput, headersHandler?: () => HttpHeaders): Observable<UpdateEndpointOutput> {
			return this.http.post<UpdateEndpointOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateEndpointWeightsAndCapacities(requestBody: UpdateEndpointWeightsAndCapacitiesInput, headersHandler?: () => HttpHeaders): Observable<UpdateEndpointWeightsAndCapacitiesOutput> {
			return this.http.post<UpdateEndpointWeightsAndCapacitiesOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateEndpointWeightsAndCapacities', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateExperiment(requestBody: UpdateExperimentRequest, headersHandler?: () => HttpHeaders): Observable<UpdateExperimentResponse> {
			return this.http.post<UpdateExperimentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateExperiment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateMonitoringSchedule(requestBody: UpdateMonitoringScheduleRequest, headersHandler?: () => HttpHeaders): Observable<UpdateMonitoringScheduleResponse> {
			return this.http.post<UpdateMonitoringScheduleResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateNotebookInstance(requestBody: UpdateNotebookInstanceInput, headersHandler?: () => HttpHeaders): Observable<UpdateNotebookInstanceOutput> {
			return this.http.post<UpdateNotebookInstanceOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateNotebookInstanceLifecycleConfig(requestBody: UpdateNotebookInstanceLifecycleConfigInput, headersHandler?: () => HttpHeaders): Observable<UpdateNotebookInstanceLifecycleConfigOutput> {
			return this.http.post<UpdateNotebookInstanceLifecycleConfigOutput>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTrial(requestBody: UpdateTrialRequest, headersHandler?: () => HttpHeaders): Observable<UpdateTrialResponse> {
			return this.http.post<UpdateTrialResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateTrial', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTrialComponent(requestBody: UpdateTrialComponentRequest, headersHandler?: () => HttpHeaders): Observable<UpdateTrialComponentResponse> {
			return this.http.post<UpdateTrialComponentResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateUserProfile(requestBody: UpdateUserProfileRequest, headersHandler?: () => HttpHeaders): Observable<UpdateUserProfileResponse> {
			return this.http.post<UpdateUserProfileResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateWorkforce(requestBody: UpdateWorkforceRequest, headersHandler?: () => HttpHeaders): Observable<UpdateWorkforceResponse> {
			return this.http.post<UpdateWorkforceResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateWorkforce', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateWorkteam(requestBody: UpdateWorkteamRequest, headersHandler?: () => HttpHeaders): Observable<UpdateWorkteamResponse> {
			return this.http.post<UpdateWorkteamResponse>(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
