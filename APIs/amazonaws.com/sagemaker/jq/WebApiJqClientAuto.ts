...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddTags(callback: (data : AddTagsOutput) => any, requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.AddTags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociateTrialComponent(callback: (data : AssociateTrialComponentResponse) => any, requestBody: AssociateTrialComponentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.AssociateTrialComponent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateAlgorithm(callback: (data : CreateAlgorithmOutput) => any, requestBody: CreateAlgorithmInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateAlgorithm', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		CreateApp(callback: (data : CreateAppResponse) => any, requestBody: CreateAppRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateApp', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateAutoMLJob(callback: (data : CreateAutoMLJobResponse) => any, requestBody: CreateAutoMLJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateAutoMLJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateCodeRepository(callback: (data : CreateCodeRepositoryOutput) => any, requestBody: CreateCodeRepositoryInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateCodeRepository', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateCompilationJob(callback: (data : CreateCompilationJobResponse) => any, requestBody: CreateCompilationJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateCompilationJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateDomain(callback: (data : CreateDomainResponse) => any, requestBody: CreateDomainRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateEndpoint(callback: (data : CreateEndpointOutput) => any, requestBody: CreateEndpointInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateEndpointConfig(callback: (data : CreateEndpointConfigOutput) => any, requestBody: CreateEndpointConfigInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateEndpointConfig', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateExperiment(callback: (data : CreateExperimentResponse) => any, requestBody: CreateExperimentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateExperiment', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateFlowDefinition(callback: (data : CreateFlowDefinitionResponse) => any, requestBody: CreateFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateFlowDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateHumanTaskUi(callback: (data : CreateHumanTaskUiResponse) => any, requestBody: CreateHumanTaskUiRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateHumanTaskUi', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateHyperParameterTuningJob(callback: (data : CreateHyperParameterTuningJobResponse) => any, requestBody: CreateHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateHyperParameterTuningJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateLabelingJob(callback: (data : CreateLabelingJobResponse) => any, requestBody: CreateLabelingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateLabelingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateModel(callback: (data : CreateModelOutput) => any, requestBody: CreateModelInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateModel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateModelPackage(callback: (data : CreateModelPackageOutput) => any, requestBody: CreateModelPackageInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateModelPackage', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateMonitoringSchedule(callback: (data : CreateMonitoringScheduleResponse) => any, requestBody: CreateMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateMonitoringSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateNotebookInstance(callback: (data : CreateNotebookInstanceOutput) => any, requestBody: CreateNotebookInstanceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateNotebookInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateNotebookInstanceLifecycleConfig(callback: (data : CreateNotebookInstanceLifecycleConfigOutput) => any, requestBody: CreateNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateNotebookInstanceLifecycleConfig', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreatePresignedDomainUrl(callback: (data : CreatePresignedDomainUrlResponse) => any, requestBody: CreatePresignedDomainUrlRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreatePresignedDomainUrl', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreatePresignedNotebookInstanceUrl(callback: (data : CreatePresignedNotebookInstanceUrlOutput) => any, requestBody: CreatePresignedNotebookInstanceUrlInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreatePresignedNotebookInstanceUrl', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateProcessingJob(callback: (data : CreateProcessingJobResponse) => any, requestBody: CreateProcessingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateProcessingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTrainingJob(callback: (data : CreateTrainingJobResponse) => any, requestBody: CreateTrainingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrainingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTransformJob(callback: (data : CreateTransformJobResponse) => any, requestBody: CreateTransformJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTransformJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTrial(callback: (data : CreateTrialResponse) => any, requestBody: CreateTrialRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrial', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTrialComponent(callback: (data : CreateTrialComponentResponse) => any, requestBody: CreateTrialComponentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateTrialComponent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateUserProfile(callback: (data : CreateUserProfileResponse) => any, requestBody: CreateUserProfileRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateUserProfile', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateWorkteam(callback: (data : CreateWorkteamResponse) => any, requestBody: CreateWorkteamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.CreateWorkteam', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAlgorithm(callback: (data : void) => any, requestBody: DeleteAlgorithmInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteAlgorithm', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DeleteApp(callback: (data : void) => any, requestBody: DeleteAppRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteApp', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteCodeRepository(callback: (data : void) => any, requestBody: DeleteCodeRepositoryInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteCodeRepository', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteDomain(callback: (data : void) => any, requestBody: DeleteDomainRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpoint(callback: (data : void) => any, requestBody: DeleteEndpointInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpointConfig(callback: (data : void) => any, requestBody: DeleteEndpointConfigInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteEndpointConfig', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteExperiment(callback: (data : DeleteExperimentResponse) => any, requestBody: DeleteExperimentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteExperiment', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteFlowDefinition(callback: (data : DeleteFlowDefinitionResponse) => any, requestBody: DeleteFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteFlowDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteModel(callback: (data : void) => any, requestBody: DeleteModelInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteModel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteModelPackage(callback: (data : void) => any, requestBody: DeleteModelPackageInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteModelPackage', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteMonitoringSchedule(callback: (data : void) => any, requestBody: DeleteMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteMonitoringSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteNotebookInstance(callback: (data : void) => any, requestBody: DeleteNotebookInstanceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteNotebookInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteNotebookInstanceLifecycleConfig(callback: (data : void) => any, requestBody: DeleteNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteNotebookInstanceLifecycleConfig', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTags(callback: (data : DeleteTagsOutput) => any, requestBody: DeleteTagsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTrial(callback: (data : DeleteTrialResponse) => any, requestBody: DeleteTrialRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTrial', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTrialComponent(callback: (data : DeleteTrialComponentResponse) => any, requestBody: DeleteTrialComponentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteTrialComponent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DeleteUserProfile(callback: (data : void) => any, requestBody: DeleteUserProfileRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteUserProfile', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteWorkteam(callback: (data : DeleteWorkteamResponse) => any, requestBody: DeleteWorkteamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DeleteWorkteam', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAlgorithm(callback: (data : DescribeAlgorithmOutput) => any, requestBody: DescribeAlgorithmInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeAlgorithm', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeApp(callback: (data : DescribeAppResponse) => any, requestBody: DescribeAppRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeApp', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAutoMLJob(callback: (data : DescribeAutoMLJobResponse) => any, requestBody: DescribeAutoMLJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeAutoMLJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCodeRepository(callback: (data : DescribeCodeRepositoryOutput) => any, requestBody: DescribeCodeRepositoryInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeCodeRepository', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCompilationJob(callback: (data : DescribeCompilationJobResponse) => any, requestBody: DescribeCompilationJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeCompilationJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDomain(callback: (data : DescribeDomainResponse) => any, requestBody: DescribeDomainRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeEndpoint(callback: (data : DescribeEndpointOutput) => any, requestBody: DescribeEndpointInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeEndpointConfig(callback: (data : DescribeEndpointConfigOutput) => any, requestBody: DescribeEndpointConfigInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeEndpointConfig', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeExperiment(callback: (data : DescribeExperimentResponse) => any, requestBody: DescribeExperimentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeExperiment', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeFlowDefinition(callback: (data : DescribeFlowDefinitionResponse) => any, requestBody: DescribeFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeFlowDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeHumanTaskUi(callback: (data : DescribeHumanTaskUiResponse) => any, requestBody: DescribeHumanTaskUiRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeHumanTaskUi', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeHyperParameterTuningJob(callback: (data : DescribeHyperParameterTuningJobResponse) => any, requestBody: DescribeHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeHyperParameterTuningJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeLabelingJob(callback: (data : DescribeLabelingJobResponse) => any, requestBody: DescribeLabelingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeLabelingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeModel(callback: (data : DescribeModelOutput) => any, requestBody: DescribeModelInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeModel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeModelPackage(callback: (data : DescribeModelPackageOutput) => any, requestBody: DescribeModelPackageInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeModelPackage', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMonitoringSchedule(callback: (data : DescribeMonitoringScheduleResponse) => any, requestBody: DescribeMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeMonitoringSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeNotebookInstance(callback: (data : DescribeNotebookInstanceOutput) => any, requestBody: DescribeNotebookInstanceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeNotebookInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeNotebookInstanceLifecycleConfig(callback: (data : DescribeNotebookInstanceLifecycleConfigOutput) => any, requestBody: DescribeNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeNotebookInstanceLifecycleConfig', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeProcessingJob(callback: (data : DescribeProcessingJobResponse) => any, requestBody: DescribeProcessingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeProcessingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSubscribedWorkteam(callback: (data : DescribeSubscribedWorkteamResponse) => any, requestBody: DescribeSubscribedWorkteamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeSubscribedWorkteam', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTrainingJob(callback: (data : DescribeTrainingJobResponse) => any, requestBody: DescribeTrainingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrainingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTransformJob(callback: (data : DescribeTransformJobResponse) => any, requestBody: DescribeTransformJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTransformJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTrial(callback: (data : DescribeTrialResponse) => any, requestBody: DescribeTrialRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrial', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTrialComponent(callback: (data : DescribeTrialComponentResponse) => any, requestBody: DescribeTrialComponentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeTrialComponent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeUserProfile(callback: (data : DescribeUserProfileResponse) => any, requestBody: DescribeUserProfileRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeUserProfile', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeWorkforce(callback: (data : DescribeWorkforceResponse) => any, requestBody: DescribeWorkforceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeWorkforce', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeWorkteam(callback: (data : DescribeWorkteamResponse) => any, requestBody: DescribeWorkteamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DescribeWorkteam', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateTrialComponent(callback: (data : DisassociateTrialComponentResponse) => any, requestBody: DisassociateTrialComponentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.DisassociateTrialComponent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSearchSuggestions(callback: (data : GetSearchSuggestionsResponse) => any, requestBody: GetSearchSuggestionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.GetSearchSuggestions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAlgorithms(MaxResults: string, NextToken: string, callback: (data : ListAlgorithmsOutput) => any, requestBody: ListAlgorithmsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListAlgorithms?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListApps(MaxResults: string, NextToken: string, callback: (data : ListAppsResponse) => any, requestBody: ListAppsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListApps?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAutoMLJobs(MaxResults: string, NextToken: string, callback: (data : ListAutoMLJobsResponse) => any, requestBody: ListAutoMLJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListAutoMLJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCandidatesForAutoMLJob(MaxResults: string, NextToken: string, callback: (data : ListCandidatesForAutoMLJobResponse) => any, requestBody: ListCandidatesForAutoMLJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListCandidatesForAutoMLJob?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCodeRepositories(MaxResults: string, NextToken: string, callback: (data : ListCodeRepositoriesOutput) => any, requestBody: ListCodeRepositoriesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListCodeRepositories?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCompilationJobs(MaxResults: string, NextToken: string, callback: (data : ListCompilationJobsResponse) => any, requestBody: ListCompilationJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListCompilationJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDomains(MaxResults: string, NextToken: string, callback: (data : ListDomainsResponse) => any, requestBody: ListDomainsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListDomains?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEndpointConfigs(MaxResults: string, NextToken: string, callback: (data : ListEndpointConfigsOutput) => any, requestBody: ListEndpointConfigsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListEndpointConfigs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEndpoints(MaxResults: string, NextToken: string, callback: (data : ListEndpointsOutput) => any, requestBody: ListEndpointsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListEndpoints?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListExperiments(MaxResults: string, NextToken: string, callback: (data : ListExperimentsResponse) => any, requestBody: ListExperimentsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListExperiments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFlowDefinitions(MaxResults: string, NextToken: string, callback: (data : ListFlowDefinitionsResponse) => any, requestBody: ListFlowDefinitionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListFlowDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListHumanTaskUis(MaxResults: string, NextToken: string, callback: (data : ListHumanTaskUisResponse) => any, requestBody: ListHumanTaskUisRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListHumanTaskUis?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListHyperParameterTuningJobs(MaxResults: string, NextToken: string, callback: (data : ListHyperParameterTuningJobsResponse) => any, requestBody: ListHyperParameterTuningJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListHyperParameterTuningJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListLabelingJobs(MaxResults: string, NextToken: string, callback: (data : ListLabelingJobsResponse) => any, requestBody: ListLabelingJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListLabelingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListLabelingJobsForWorkteam(MaxResults: string, NextToken: string, callback: (data : ListLabelingJobsForWorkteamResponse) => any, requestBody: ListLabelingJobsForWorkteamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListLabelingJobsForWorkteam?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListModelPackages(MaxResults: string, NextToken: string, callback: (data : ListModelPackagesOutput) => any, requestBody: ListModelPackagesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListModelPackages?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListModels(MaxResults: string, NextToken: string, callback: (data : ListModelsOutput) => any, requestBody: ListModelsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListModels?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMonitoringExecutions(MaxResults: string, NextToken: string, callback: (data : ListMonitoringExecutionsResponse) => any, requestBody: ListMonitoringExecutionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListMonitoringExecutions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMonitoringSchedules(MaxResults: string, NextToken: string, callback: (data : ListMonitoringSchedulesResponse) => any, requestBody: ListMonitoringSchedulesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListMonitoringSchedules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListNotebookInstanceLifecycleConfigs(MaxResults: string, NextToken: string, callback: (data : ListNotebookInstanceLifecycleConfigsOutput) => any, requestBody: ListNotebookInstanceLifecycleConfigsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListNotebookInstanceLifecycleConfigs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListNotebookInstances(MaxResults: string, NextToken: string, callback: (data : ListNotebookInstancesOutput) => any, requestBody: ListNotebookInstancesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListNotebookInstances?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListProcessingJobs(MaxResults: string, NextToken: string, callback: (data : ListProcessingJobsResponse) => any, requestBody: ListProcessingJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListProcessingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListSubscribedWorkteams(MaxResults: string, NextToken: string, callback: (data : ListSubscribedWorkteamsResponse) => any, requestBody: ListSubscribedWorkteamsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListSubscribedWorkteams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTags(MaxResults: string, NextToken: string, callback: (data : ListTagsOutput) => any, requestBody: ListTagsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListTags?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTrainingJobs(MaxResults: string, NextToken: string, callback: (data : ListTrainingJobsResponse) => any, requestBody: ListTrainingJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrainingJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTrainingJobsForHyperParameterTuningJob(MaxResults: string, NextToken: string, callback: (data : ListTrainingJobsForHyperParameterTuningJobResponse) => any, requestBody: ListTrainingJobsForHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ListTransformJobs(MaxResults: string, NextToken: string, callback: (data : ListTransformJobsResponse) => any, requestBody: ListTransformJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListTransformJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTrialComponents(MaxResults: string, NextToken: string, callback: (data : ListTrialComponentsResponse) => any, requestBody: ListTrialComponentsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrialComponents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTrials(MaxResults: string, NextToken: string, callback: (data : ListTrialsResponse) => any, requestBody: ListTrialsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListTrials?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListUserProfiles(MaxResults: string, NextToken: string, callback: (data : ListUserProfilesResponse) => any, requestBody: ListUserProfilesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListUserProfiles?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListWorkteams(MaxResults: string, NextToken: string, callback: (data : ListWorkteamsResponse) => any, requestBody: ListWorkteamsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.ListWorkteams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RenderUiTemplate(callback: (data : RenderUiTemplateResponse) => any, requestBody: RenderUiTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.RenderUiTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		Search(MaxResults: string, NextToken: string, callback: (data : SearchResponse) => any, requestBody: SearchRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.Search?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StartMonitoringSchedule(callback: (data : void) => any, requestBody: StartMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StartMonitoringSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StartNotebookInstance(callback: (data : void) => any, requestBody: StartNotebookInstanceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StartNotebookInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopAutoMLJob(callback: (data : void) => any, requestBody: StopAutoMLJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopAutoMLJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopCompilationJob(callback: (data : void) => any, requestBody: StopCompilationJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopCompilationJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopHyperParameterTuningJob(callback: (data : void) => any, requestBody: StopHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopHyperParameterTuningJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopLabelingJob(callback: (data : void) => any, requestBody: StopLabelingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopLabelingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopMonitoringSchedule(callback: (data : void) => any, requestBody: StopMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopMonitoringSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopNotebookInstance(callback: (data : void) => any, requestBody: StopNotebookInstanceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopNotebookInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopProcessingJob(callback: (data : void) => any, requestBody: StopProcessingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopProcessingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopTrainingJob(callback: (data : void) => any, requestBody: StopTrainingJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopTrainingJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopTransformJob(callback: (data : void) => any, requestBody: StopTransformJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.StopTransformJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateCodeRepository(callback: (data : UpdateCodeRepositoryOutput) => any, requestBody: UpdateCodeRepositoryInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateCodeRepository', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDomain(callback: (data : UpdateDomainResponse) => any, requestBody: UpdateDomainRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateEndpoint(callback: (data : UpdateEndpointOutput) => any, requestBody: UpdateEndpointInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateEndpointWeightsAndCapacities(callback: (data : UpdateEndpointWeightsAndCapacitiesOutput) => any, requestBody: UpdateEndpointWeightsAndCapacitiesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateEndpointWeightsAndCapacities', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateExperiment(callback: (data : UpdateExperimentResponse) => any, requestBody: UpdateExperimentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateExperiment', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateMonitoringSchedule(callback: (data : UpdateMonitoringScheduleResponse) => any, requestBody: UpdateMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateMonitoringSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateNotebookInstance(callback: (data : UpdateNotebookInstanceOutput) => any, requestBody: UpdateNotebookInstanceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateNotebookInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateNotebookInstanceLifecycleConfig(callback: (data : UpdateNotebookInstanceLifecycleConfigOutput) => any, requestBody: UpdateNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateNotebookInstanceLifecycleConfig', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateTrial(callback: (data : UpdateTrialResponse) => any, requestBody: UpdateTrialRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateTrial', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateTrialComponent(callback: (data : UpdateTrialComponentResponse) => any, requestBody: UpdateTrialComponentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateTrialComponent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateUserProfile(callback: (data : UpdateUserProfileResponse) => any, requestBody: UpdateUserProfileRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateUserProfile', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateWorkforce(callback: (data : UpdateWorkforceResponse) => any, requestBody: UpdateWorkforceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateWorkforce', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateWorkteam(callback: (data : UpdateWorkteamResponse) => any, requestBody: UpdateWorkteamRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=SageMaker.UpdateWorkteam', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
