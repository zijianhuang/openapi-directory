...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateTrialComponent(requestBody: AssociateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateTrialComponentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.AssociateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAlgorithm(requestBody: CreateAlgorithmInput, headersHandler?: () => {[header: string]: string}): Promise<CreateAlgorithmOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateAlgorithm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateApp(requestBody: CreateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAppResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAutoMLJob(requestBody: CreateAutoMLJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAutoMLJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateAutoMLJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateCodeRepository(requestBody: CreateCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<CreateCodeRepositoryOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateCompilationJob(requestBody: CreateCompilationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCompilationJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateCompilationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDomain(requestBody: CreateDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateEndpoint(requestBody: CreateEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateEndpointConfig(requestBody: CreateEndpointConfigInput, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointConfigOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateEndpointConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateExperiment(requestBody: CreateExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateExperimentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateExperiment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateFlowDefinition(requestBody: CreateFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFlowDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateFlowDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateHumanTaskUi(requestBody: CreateHumanTaskUiRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHumanTaskUiResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateHumanTaskUi', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateHyperParameterTuningJob(requestBody: CreateHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHyperParameterTuningJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateHyperParameterTuningJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLabelingJob(requestBody: CreateLabelingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLabelingJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateLabelingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateModel(requestBody: CreateModelInput, headersHandler?: () => {[header: string]: string}): Promise<CreateModelOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateModelPackage(requestBody: CreateModelPackageInput, headersHandler?: () => {[header: string]: string}): Promise<CreateModelPackageOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateModelPackage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateMonitoringSchedule(requestBody: CreateMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMonitoringScheduleResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateNotebookInstance(requestBody: CreateNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<CreateNotebookInstanceOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateNotebookInstanceLifecycleConfig(requestBody: CreateNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<CreateNotebookInstanceLifecycleConfigOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePresignedDomainUrl(requestBody: CreatePresignedDomainUrlRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePresignedDomainUrlResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreatePresignedDomainUrl', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePresignedNotebookInstanceUrl(requestBody: CreatePresignedNotebookInstanceUrlInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePresignedNotebookInstanceUrlOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreatePresignedNotebookInstanceUrl', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateProcessingJob(requestBody: CreateProcessingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProcessingJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateProcessingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTrainingJob(requestBody: CreateTrainingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrainingJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateTrainingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTransformJob(requestBody: CreateTransformJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTransformJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateTransformJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTrial(requestBody: CreateTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrialResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateTrial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTrialComponent(requestBody: CreateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrialComponentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateUserProfile(requestBody: CreateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserProfileResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateWorkteam(requestBody: CreateWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateWorkteamResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.CreateWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAlgorithm(requestBody: DeleteAlgorithmInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteAlgorithm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteApp(requestBody: DeleteAppRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteCodeRepository(requestBody: DeleteCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteDomain(requestBody: DeleteDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteEndpoint(requestBody: DeleteEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteEndpointConfig(requestBody: DeleteEndpointConfigInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteEndpointConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteExperiment(requestBody: DeleteExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteExperimentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteExperiment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteFlowDefinition(requestBody: DeleteFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFlowDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteFlowDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteModel(requestBody: DeleteModelInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteModelPackage(requestBody: DeleteModelPackageInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteModelPackage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteMonitoringSchedule(requestBody: DeleteMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteNotebookInstance(requestBody: DeleteNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteNotebookInstanceLifecycleConfig(requestBody: DeleteNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteTags(requestBody: DeleteTagsInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTrial(requestBody: DeleteTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrialResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteTrial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTrialComponent(requestBody: DeleteTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrialComponentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUserProfile(requestBody: DeleteUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteWorkteam(requestBody: DeleteWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteWorkteamResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DeleteWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAlgorithm(requestBody: DescribeAlgorithmInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeAlgorithmOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeAlgorithm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeApp(requestBody: DescribeAppRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAppResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAutoMLJob(requestBody: DescribeAutoMLJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAutoMLJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeAutoMLJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCodeRepository(requestBody: DescribeCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeCodeRepositoryOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCompilationJob(requestBody: DescribeCompilationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCompilationJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeCompilationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDomain(requestBody: DescribeDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDomainResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeEndpoint(requestBody: DescribeEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeEndpointConfig(requestBody: DescribeEndpointConfigInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointConfigOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeEndpointConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeExperiment(requestBody: DescribeExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExperimentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeExperiment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeFlowDefinition(requestBody: DescribeFlowDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFlowDefinitionResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeFlowDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeHumanTaskUi(requestBody: DescribeHumanTaskUiRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHumanTaskUiResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeHumanTaskUi', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeHyperParameterTuningJob(requestBody: DescribeHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHyperParameterTuningJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeHyperParameterTuningJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLabelingJob(requestBody: DescribeLabelingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLabelingJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeLabelingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeModel(requestBody: DescribeModelInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeModelOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeModelPackage(requestBody: DescribeModelPackageInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeModelPackageOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeModelPackage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMonitoringSchedule(requestBody: DescribeMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMonitoringScheduleResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeNotebookInstance(requestBody: DescribeNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotebookInstanceOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeNotebookInstanceLifecycleConfig(requestBody: DescribeNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotebookInstanceLifecycleConfigOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeProcessingJob(requestBody: DescribeProcessingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeProcessingJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeProcessingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSubscribedWorkteam(requestBody: DescribeSubscribedWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSubscribedWorkteamResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeSubscribedWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTrainingJob(requestBody: DescribeTrainingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrainingJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeTrainingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTransformJob(requestBody: DescribeTransformJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTransformJobResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeTransformJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTrial(requestBody: DescribeTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrialResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeTrial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTrialComponent(requestBody: DescribeTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrialComponentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeUserProfile(requestBody: DescribeUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserProfileResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkforce(requestBody: DescribeWorkforceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkforceResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeWorkforce', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkteam(requestBody: DescribeWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkteamResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DescribeWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateTrialComponent(requestBody: DisassociateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateTrialComponentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.DisassociateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSearchSuggestions(requestBody: GetSearchSuggestionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSearchSuggestionsResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.GetSearchSuggestions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RenderUiTemplate(requestBody: RenderUiTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<RenderUiTemplateResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.RenderUiTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartMonitoringSchedule(requestBody: StartMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StartMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StartNotebookInstance(requestBody: StartNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StartNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopAutoMLJob(requestBody: StopAutoMLJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopAutoMLJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopCompilationJob(requestBody: StopCompilationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopCompilationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopHyperParameterTuningJob(requestBody: StopHyperParameterTuningJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopHyperParameterTuningJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopLabelingJob(requestBody: StopLabelingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopLabelingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopMonitoringSchedule(requestBody: StopMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopNotebookInstance(requestBody: StopNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopProcessingJob(requestBody: StopProcessingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopProcessingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopTrainingJob(requestBody: StopTrainingJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopTrainingJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		StopTransformJob(requestBody: StopTransformJobRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=SageMaker.StopTransformJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UpdateCodeRepository(requestBody: UpdateCodeRepositoryInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateCodeRepositoryOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateCodeRepository', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDomain(requestBody: UpdateDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateEndpoint(requestBody: UpdateEndpointInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateEndpointWeightsAndCapacities(requestBody: UpdateEndpointWeightsAndCapacitiesInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointWeightsAndCapacitiesOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateEndpointWeightsAndCapacities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateExperiment(requestBody: UpdateExperimentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateExperimentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateExperiment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMonitoringSchedule(requestBody: UpdateMonitoringScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMonitoringScheduleResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateMonitoringSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNotebookInstance(requestBody: UpdateNotebookInstanceInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotebookInstanceOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateNotebookInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNotebookInstanceLifecycleConfig(requestBody: UpdateNotebookInstanceLifecycleConfigInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotebookInstanceLifecycleConfigOutput> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateNotebookInstanceLifecycleConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTrial(requestBody: UpdateTrialRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrialResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateTrial', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTrialComponent(requestBody: UpdateTrialComponentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrialComponentResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateTrialComponent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateUserProfile(requestBody: UpdateUserProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserProfileResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateUserProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateWorkforce(requestBody: UpdateWorkforceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateWorkforceResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateWorkforce', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateWorkteam(requestBody: UpdateWorkteamRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateWorkteamResponse> {
			return this.http.post('/#X-Amz-Target=SageMaker.UpdateWorkteam', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
