...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DescribeChangeSet(catalog: string, changeSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeChangeSetResponse> {
			return this.http.get('/DescribeChangeSet#catalog&changeSetId?catalog=' + (catalog == null ? '' : encodeURIComponent(catalog)) + '&changeSetId=' + (changeSetId == null ? '' : encodeURIComponent(changeSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeEntity(catalog: string, entityId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntityResponse> {
			return this.http.get('/DescribeEntity#catalog&entityId?catalog=' + (catalog == null ? '' : encodeURIComponent(catalog)) + '&entityId=' + (entityId == null ? '' : encodeURIComponent(entityId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListChangeSets(MaxResults: string, NextToken: string, requestBody: ListChangeSetsBody, headersHandler?: () => {[header: string]: string}): Promise<ListChangeSetsResponse> {
			return this.http.post('/ListChangeSets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListEntities(MaxResults: string, NextToken: string, requestBody: ListEntitiesBody, headersHandler?: () => {[header: string]: string}): Promise<ListEntitiesResponse> {
			return this.http.post('/ListEntities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartChangeSet(requestBody: StartChangeSetBody, headersHandler?: () => {[header: string]: string}): Promise<StartChangeSetResponse> {
			return this.http.post('/StartChangeSet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
