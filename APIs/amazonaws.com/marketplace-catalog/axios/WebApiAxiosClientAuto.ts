...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DescribeChangeSet(catalog: string, changeSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeChangeSetResponse> {
			return Axios.get<DescribeChangeSetResponse>(this.baseUri + '/DescribeChangeSet#catalog&changeSetId?catalog=' + (catalog == null ? '' : encodeURIComponent(catalog)) + '&changeSetId=' + (changeSetId == null ? '' : encodeURIComponent(changeSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeEntity(catalog: string, entityId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntityResponse> {
			return Axios.get<DescribeEntityResponse>(this.baseUri + '/DescribeEntity#catalog&entityId?catalog=' + (catalog == null ? '' : encodeURIComponent(catalog)) + '&entityId=' + (entityId == null ? '' : encodeURIComponent(entityId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListChangeSets(MaxResults: string, NextToken: string, requestBody: ListChangeSetsBody, headersHandler?: () => {[header: string]: string}): Promise<ListChangeSetsResponse> {
			return Axios.post<ListChangeSetsResponse>(this.baseUri + '/ListChangeSets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListEntities(MaxResults: string, NextToken: string, requestBody: ListEntitiesBody, headersHandler?: () => {[header: string]: string}): Promise<ListEntitiesResponse> {
			return Axios.post<ListEntitiesResponse>(this.baseUri + '/ListEntities?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartChangeSet(requestBody: StartChangeSetBody, headersHandler?: () => {[header: string]: string}): Promise<StartChangeSetResponse> {
			return Axios.post<StartChangeSetResponse>(this.baseUri + '/StartChangeSet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
