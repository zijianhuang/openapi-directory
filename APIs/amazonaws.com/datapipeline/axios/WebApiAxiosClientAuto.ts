...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ActivatePipeline(requestBody: ActivatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<ActivatePipelineOutput> {
			return Axios.post<ActivatePipelineOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.ActivatePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsOutput> {
			return Axios.post<AddTagsOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePipeline(requestBody: CreatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePipelineOutput> {
			return Axios.post<CreatePipelineOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.CreatePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeactivatePipeline(requestBody: DeactivatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<DeactivatePipelineOutput> {
			return Axios.post<DeactivatePipelineOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.DeactivatePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeletePipeline(requestBody: DeletePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=DataPipeline.DeletePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DescribeObjects(marker: string, requestBody: DescribeObjectsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeObjectsOutput> {
			return Axios.post<DescribeObjectsOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.DescribeObjects?marker=' + (marker == null ? '' : encodeURIComponent(marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePipelines(requestBody: DescribePipelinesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribePipelinesOutput> {
			return Axios.post<DescribePipelinesOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.DescribePipelines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EvaluateExpression(requestBody: EvaluateExpressionInput, headersHandler?: () => {[header: string]: string}): Promise<EvaluateExpressionOutput> {
			return Axios.post<EvaluateExpressionOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.EvaluateExpression', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPipelineDefinition(requestBody: GetPipelineDefinitionInput, headersHandler?: () => {[header: string]: string}): Promise<GetPipelineDefinitionOutput> {
			return Axios.post<GetPipelineDefinitionOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.GetPipelineDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListPipelines(marker: string, requestBody: ListPipelinesInput, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesOutput> {
			return Axios.post<ListPipelinesOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.ListPipelines?marker=' + (marker == null ? '' : encodeURIComponent(marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PollForTask(requestBody: PollForTaskInput, headersHandler?: () => {[header: string]: string}): Promise<PollForTaskOutput> {
			return Axios.post<PollForTaskOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.PollForTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutPipelineDefinition(requestBody: PutPipelineDefinitionInput, headersHandler?: () => {[header: string]: string}): Promise<PutPipelineDefinitionOutput> {
			return Axios.post<PutPipelineDefinitionOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.PutPipelineDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveTags(requestBody: RemoveTagsInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsOutput> {
			return Axios.post<RemoveTagsOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ReportTaskProgress(requestBody: ReportTaskProgressInput, headersHandler?: () => {[header: string]: string}): Promise<ReportTaskProgressOutput> {
			return Axios.post<ReportTaskProgressOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.ReportTaskProgress', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ReportTaskRunnerHeartbeat(requestBody: ReportTaskRunnerHeartbeatInput, headersHandler?: () => {[header: string]: string}): Promise<ReportTaskRunnerHeartbeatOutput> {
			return Axios.post<ReportTaskRunnerHeartbeatOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.ReportTaskRunnerHeartbeat', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		SetStatus(requestBody: SetStatusInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=DataPipeline.SetStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		SetTaskStatus(requestBody: SetTaskStatusInput, headersHandler?: () => {[header: string]: string}): Promise<SetTaskStatusOutput> {
			return Axios.post<SetTaskStatusOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.SetTaskStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ValidatePipelineDefinition(requestBody: ValidatePipelineDefinitionInput, headersHandler?: () => {[header: string]: string}): Promise<ValidatePipelineDefinitionOutput> {
			return Axios.post<ValidatePipelineDefinitionOutput>(this.baseUri + '/#X-Amz-Target=DataPipeline.ValidatePipelineDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
