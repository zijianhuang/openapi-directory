...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ActivatePipeline(requestBody: ActivatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<ActivatePipelineOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.ActivatePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePipeline(requestBody: CreatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<CreatePipelineOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.CreatePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeactivatePipeline(requestBody: DeactivatePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<DeactivatePipelineOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.DeactivatePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeletePipeline(requestBody: DeletePipelineInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=DataPipeline.DeletePipeline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeObjects(marker: string, requestBody: DescribeObjectsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeObjectsOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.DescribeObjects?marker=' + (marker == null ? '' : encodeURIComponent(marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribePipelines(requestBody: DescribePipelinesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribePipelinesOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.DescribePipelines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EvaluateExpression(requestBody: EvaluateExpressionInput, headersHandler?: () => {[header: string]: string}): Promise<EvaluateExpressionOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.EvaluateExpression', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPipelineDefinition(requestBody: GetPipelineDefinitionInput, headersHandler?: () => {[header: string]: string}): Promise<GetPipelineDefinitionOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.GetPipelineDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPipelines(marker: string, requestBody: ListPipelinesInput, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.ListPipelines?marker=' + (marker == null ? '' : encodeURIComponent(marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PollForTask(requestBody: PollForTaskInput, headersHandler?: () => {[header: string]: string}): Promise<PollForTaskOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.PollForTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutPipelineDefinition(requestBody: PutPipelineDefinitionInput, headersHandler?: () => {[header: string]: string}): Promise<PutPipelineDefinitionOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.PutPipelineDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveTags(requestBody: RemoveTagsInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ReportTaskProgress(requestBody: ReportTaskProgressInput, headersHandler?: () => {[header: string]: string}): Promise<ReportTaskProgressOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.ReportTaskProgress', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ReportTaskRunnerHeartbeat(requestBody: ReportTaskRunnerHeartbeatInput, headersHandler?: () => {[header: string]: string}): Promise<ReportTaskRunnerHeartbeatOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.ReportTaskRunnerHeartbeat', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SetStatus(requestBody: SetStatusInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=DataPipeline.SetStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		SetTaskStatus(requestBody: SetTaskStatusInput, headersHandler?: () => {[header: string]: string}): Promise<SetTaskStatusOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.SetTaskStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ValidatePipelineDefinition(requestBody: ValidatePipelineDefinitionInput, headersHandler?: () => {[header: string]: string}): Promise<ValidatePipelineDefinitionOutput> {
			return this.http.post('/#X-Amz-Target=DataPipeline.ValidatePipelineDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
