...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptInvitationResponse> {
			return this.http.post('/invitations/accept', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ArchiveFindings(requestBody: ArchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ArchiveFindingsResponse> {
			return this.http.post('/findings/archive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchGetCustomDataIdentifiers(requestBody: BatchGetCustomDataIdentifiersBody, headersHandler?: () => {[header: string]: string}): Promise<BatchGetCustomDataIdentifiersResponse> {
			return this.http.post('/custom-data-identifiers/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateClassificationJob(requestBody: CreateClassificationJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateClassificationJobResponse> {
			return this.http.post('/jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateCustomDataIdentifier(requestBody: CreateCustomDataIdentifierBody, headersHandler?: () => {[header: string]: string}): Promise<CreateCustomDataIdentifierResponse> {
			return this.http.post('/custom-data-identifiers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateFindingsFilter(requestBody: CreateFindingsFilterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFindingsFilterResponse> {
			return this.http.post('/findingsfilters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListFindingsFilters(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListFindingsFiltersResponse> {
			return this.http.get('/findingsfilters?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateInvitations(requestBody: CreateInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInvitationsResponse> {
			return this.http.post('/invitations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListMembers(maxResults: number, nextToken: string, onlyAssociated: string, headersHandler?: () => {[header: string]: string}): Promise<ListMembersResponse> {
			return this.http.get('/members?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&onlyAssociated=' + (onlyAssociated == null ? '' : encodeURIComponent(onlyAssociated)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateSampleFindings(requestBody: CreateSampleFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSampleFindingsResponse> {
			return this.http.post('/findings/sample', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteCustomDataIdentifier(id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteCustomDataIdentifierResponse> {
			return this.http.delete('/custom-data-identifiers/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCustomDataIdentifier(id: string, headersHandler?: () => {[header: string]: string}): Promise<GetCustomDataIdentifierResponse> {
			return this.http.get('/custom-data-identifiers/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteFindingsFilter(id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFindingsFilterResponse> {
			return this.http.delete('/findingsfilters/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFindingsFilter(id: string, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsFilterResponse> {
			return this.http.get('/findingsfilters/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteMember(id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteMemberResponse> {
			return this.http.delete('/members/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMember(id: string, headersHandler?: () => {[header: string]: string}): Promise<GetMemberResponse> {
			return this.http.get('/members/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBuckets(requestBody: DescribeBucketsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeBucketsResponse> {
			return this.http.post('/datasources/s3', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOrganizationConfiguration(headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConfigurationResponse> {
			return this.http.get('/admin/configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableMacie(headersHandler?: () => {[header: string]: string}): Promise<DisableMacieResponse> {
			return this.http.delete('/macie', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		EnableMacie(requestBody: EnableMacieBody, headersHandler?: () => {[header: string]: string}): Promise<EnableMacieResponse> {
			return this.http.post('/macie', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMacieSession(headersHandler?: () => {[header: string]: string}): Promise<GetMacieSessionResponse> {
			return this.http.get('/macie', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableOrganizationAdminAccount(adminAccountId: string, headersHandler?: () => {[header: string]: string}): Promise<DisableOrganizationAdminAccountResponse> {
			return this.http.delete('/admin#adminAccountId?adminAccountId=' + (adminAccountId == null ? '' : encodeURIComponent(adminAccountId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateMember(id: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMemberResponse> {
			return this.http.post('/members/disassociate/' + (id == null ? '' : encodeURIComponent(id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		EnableOrganizationAdminAccount(requestBody: EnableOrganizationAdminAccountBody, headersHandler?: () => {[header: string]: string}): Promise<EnableOrganizationAdminAccountResponse> {
			return this.http.post('/admin', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListOrganizationAdminAccounts(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListOrganizationAdminAccountsResponse> {
			return this.http.get('/admin?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBucketStatistics(requestBody: GetBucketStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetBucketStatisticsResponse> {
			return this.http.post('/datasources/s3/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetClassificationExportConfiguration(headersHandler?: () => {[header: string]: string}): Promise<GetClassificationExportConfigurationResponse> {
			return this.http.get('/classification-export-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutClassificationExportConfiguration(requestBody: PutClassificationExportConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<PutClassificationExportConfigurationResponse> {
			return this.http.put('/classification-export-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetFindingStatistics(requestBody: GetFindingStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingStatisticsResponse> {
			return this.http.post('/findings/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetFindings(requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsResponse> {
			return this.http.post('/findings/describe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetUsageStatistics(requestBody: GetUsageStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetUsageStatisticsResponse> {
			return this.http.post('/usage/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetUsageTotals(headersHandler?: () => {[header: string]: string}): Promise<GetUsageTotalsResponse> {
			return this.http.get('/usage', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListClassificationJobs(requestBody: ListClassificationJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListClassificationJobsResponse> {
			return this.http.post('/jobs/list', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListCustomDataIdentifiers(requestBody: ListCustomDataIdentifiersBody, headersHandler?: () => {[header: string]: string}): Promise<ListCustomDataIdentifiersResponse> {
			return this.http.post('/custom-data-identifiers/list', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListFindings(requestBody: ListFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ListFindingsResponse> {
			return this.http.post('/findings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TestCustomDataIdentifier(requestBody: TestCustomDataIdentifierBody, headersHandler?: () => {[header: string]: string}): Promise<TestCustomDataIdentifierResponse> {
			return this.http.post('/custom-data-identifiers/test', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UnarchiveFindings(requestBody: UnarchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<UnarchiveFindingsResponse> {
			return this.http.post('/findings/unarchive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
