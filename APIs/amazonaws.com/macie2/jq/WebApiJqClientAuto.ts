...
namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(callback: (data : AcceptInvitationResponse) => any, requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/invitations/accept', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ArchiveFindings(callback: (data : ArchiveFindingsResponse) => any, requestBody: ArchiveFindingsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/findings/archive', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		BatchGetCustomDataIdentifiers(callback: (data : BatchGetCustomDataIdentifiersResponse) => any, requestBody: BatchGetCustomDataIdentifiersBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/custom-data-identifiers/get', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateClassificationJob(callback: (data : CreateClassificationJobResponse) => any, requestBody: CreateClassificationJobBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/jobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateCustomDataIdentifier(callback: (data : CreateCustomDataIdentifierResponse) => any, requestBody: CreateCustomDataIdentifierBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/custom-data-identifiers', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateFindingsFilter(callback: (data : CreateFindingsFilterResponse) => any, requestBody: CreateFindingsFilterBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/findingsfilters', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFindingsFilters(maxResults: number, nextToken: string, callback: (data : ListFindingsFiltersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/findingsfilters?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateInvitations(callback: (data : CreateInvitationsResponse) => any, requestBody: CreateInvitationsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/invitations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateMember(callback: (data : CreateMemberResponse) => any, requestBody: CreateMemberBody, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ListMembers(maxResults: number, nextToken: string, onlyAssociated: string, callback: (data : ListMembersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/members?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&onlyAssociated=' + (onlyAssociated == null ? '' : encodeURIComponent(onlyAssociated)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateSampleFindings(callback: (data : CreateSampleFindingsResponse) => any, requestBody: CreateSampleFindingsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/findings/sample', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteCustomDataIdentifier(id: string, callback: (data : DeleteCustomDataIdentifierResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/custom-data-identifiers/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetCustomDataIdentifier(id: string, callback: (data : GetCustomDataIdentifierResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/custom-data-identifiers/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteFindingsFilter(id: string, callback: (data : DeleteFindingsFilterResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/findingsfilters/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetFindingsFilter(id: string, callback: (data : GetFindingsFilterResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/findingsfilters/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteMember(id: string, callback: (data : DeleteMemberResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/members/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetMember(id: string, callback: (data : GetMemberResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/members/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeBuckets(callback: (data : DescribeBucketsResponse) => any, requestBody: DescribeBucketsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/datasources/s3', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeClassificationJob(jobId: string, callback: (data : DescribeClassificationJobResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		DescribeOrganizationConfiguration(callback: (data : DescribeOrganizationConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/admin/configuration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DisableMacie(callback: (data : DisableMacieResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/macie', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		EnableMacie(callback: (data : EnableMacieResponse) => any, requestBody: EnableMacieBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/macie', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetMacieSession(callback: (data : GetMacieSessionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/macie', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DisableOrganizationAdminAccount(adminAccountId: string, callback: (data : DisableOrganizationAdminAccountResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/admin#adminAccountId?adminAccountId=' + (adminAccountId == null ? '' : encodeURIComponent(adminAccountId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DisassociateMember(id: string, callback: (data : DisassociateMemberResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/members/disassociate/' + (id == null ? '' : encodeURIComponent(id)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		EnableOrganizationAdminAccount(callback: (data : EnableOrganizationAdminAccountResponse) => any, requestBody: EnableOrganizationAdminAccountBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/admin', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListOrganizationAdminAccounts(maxResults: number, nextToken: string, callback: (data : ListOrganizationAdminAccountsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/admin?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBucketStatistics(callback: (data : GetBucketStatisticsResponse) => any, requestBody: GetBucketStatisticsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/datasources/s3/statistics', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetClassificationExportConfiguration(callback: (data : GetClassificationExportConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/classification-export-configuration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		PutClassificationExportConfiguration(callback: (data : PutClassificationExportConfigurationResponse) => any, requestBody: PutClassificationExportConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/classification-export-configuration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetFindingStatistics(callback: (data : GetFindingStatisticsResponse) => any, requestBody: GetFindingStatisticsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/findings/statistics', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetFindings(callback: (data : GetFindingsResponse) => any, requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/findings/describe', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetUsageStatistics(callback: (data : GetUsageStatisticsResponse) => any, requestBody: GetUsageStatisticsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/usage/statistics', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetUsageTotals(callback: (data : GetUsageTotalsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/usage', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListClassificationJobs(callback: (data : ListClassificationJobsResponse) => any, requestBody: ListClassificationJobsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/jobs/list', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCustomDataIdentifiers(callback: (data : ListCustomDataIdentifiersResponse) => any, requestBody: ListCustomDataIdentifiersBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/custom-data-identifiers/list', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFindings(callback: (data : ListFindingsResponse) => any, requestBody: ListFindingsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/findings', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TestCustomDataIdentifier(callback: (data : TestCustomDataIdentifierResponse) => any, requestBody: TestCustomDataIdentifierBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/custom-data-identifiers/test', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UnarchiveFindings(callback: (data : UnarchiveFindingsResponse) => any, requestBody: UnarchiveFindingsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/findings/unarchive', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(resourceArn: string, tagKeys: Array<__string>, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
