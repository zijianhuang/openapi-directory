...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptInvitationResponse> {
			return Axios.post<AcceptInvitationResponse>(this.baseUri + '/invitations/accept', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ArchiveFindings(requestBody: ArchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ArchiveFindingsResponse> {
			return Axios.post<ArchiveFindingsResponse>(this.baseUri + '/findings/archive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetCustomDataIdentifiers(requestBody: BatchGetCustomDataIdentifiersBody, headersHandler?: () => {[header: string]: string}): Promise<BatchGetCustomDataIdentifiersResponse> {
			return Axios.post<BatchGetCustomDataIdentifiersResponse>(this.baseUri + '/custom-data-identifiers/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateClassificationJob(requestBody: CreateClassificationJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateClassificationJobResponse> {
			return Axios.post<CreateClassificationJobResponse>(this.baseUri + '/jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateCustomDataIdentifier(requestBody: CreateCustomDataIdentifierBody, headersHandler?: () => {[header: string]: string}): Promise<CreateCustomDataIdentifierResponse> {
			return Axios.post<CreateCustomDataIdentifierResponse>(this.baseUri + '/custom-data-identifiers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateFindingsFilter(requestBody: CreateFindingsFilterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFindingsFilterResponse> {
			return Axios.post<CreateFindingsFilterResponse>(this.baseUri + '/findingsfilters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListFindingsFilters(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListFindingsFiltersResponse> {
			return Axios.get<ListFindingsFiltersResponse>(this.baseUri + '/findingsfilters?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateInvitations(requestBody: CreateInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateInvitationsResponse> {
			return Axios.post<CreateInvitationsResponse>(this.baseUri + '/invitations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateMember(requestBody: CreateMemberBody, headersHandler?: () => {[header: string]: string}): Promise<CreateMemberResponse> {
			return Axios.post<CreateMemberResponse>(this.baseUri + '/members', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListMembers(maxResults: number, nextToken: string, onlyAssociated: string, headersHandler?: () => {[header: string]: string}): Promise<ListMembersResponse> {
			return Axios.get<ListMembersResponse>(this.baseUri + '/members?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&onlyAssociated=' + (onlyAssociated == null ? '' : encodeURIComponent(onlyAssociated)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateSampleFindings(requestBody: CreateSampleFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSampleFindingsResponse> {
			return Axios.post<CreateSampleFindingsResponse>(this.baseUri + '/findings/sample', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteCustomDataIdentifier(id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteCustomDataIdentifierResponse> {
			return Axios.delete<DeleteCustomDataIdentifierResponse>(this.baseUri + '/custom-data-identifiers/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetCustomDataIdentifier(id: string, headersHandler?: () => {[header: string]: string}): Promise<GetCustomDataIdentifierResponse> {
			return Axios.get<GetCustomDataIdentifierResponse>(this.baseUri + '/custom-data-identifiers/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteFindingsFilter(id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFindingsFilterResponse> {
			return Axios.delete<DeleteFindingsFilterResponse>(this.baseUri + '/findingsfilters/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetFindingsFilter(id: string, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsFilterResponse> {
			return Axios.get<GetFindingsFilterResponse>(this.baseUri + '/findingsfilters/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteMember(id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteMemberResponse> {
			return Axios.delete<DeleteMemberResponse>(this.baseUri + '/members/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMember(id: string, headersHandler?: () => {[header: string]: string}): Promise<GetMemberResponse> {
			return Axios.get<GetMemberResponse>(this.baseUri + '/members/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeBuckets(requestBody: DescribeBucketsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeBucketsResponse> {
			return Axios.post<DescribeBucketsResponse>(this.baseUri + '/datasources/s3', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeClassificationJob(jobId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeClassificationJobResponse> {
			return Axios.get<DescribeClassificationJobResponse>(this.baseUri + '/jobs/' + (jobId == null ? '' : encodeURIComponent(jobId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeOrganizationConfiguration(headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConfigurationResponse> {
			return Axios.get<DescribeOrganizationConfigurationResponse>(this.baseUri + '/admin/configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DisableMacie(headersHandler?: () => {[header: string]: string}): Promise<DisableMacieResponse> {
			return Axios.delete<DisableMacieResponse>(this.baseUri + '/macie', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		EnableMacie(requestBody: EnableMacieBody, headersHandler?: () => {[header: string]: string}): Promise<EnableMacieResponse> {
			return Axios.post<EnableMacieResponse>(this.baseUri + '/macie', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMacieSession(headersHandler?: () => {[header: string]: string}): Promise<GetMacieSessionResponse> {
			return Axios.get<GetMacieSessionResponse>(this.baseUri + '/macie', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DisableOrganizationAdminAccount(adminAccountId: string, headersHandler?: () => {[header: string]: string}): Promise<DisableOrganizationAdminAccountResponse> {
			return Axios.delete<DisableOrganizationAdminAccountResponse>(this.baseUri + '/admin#adminAccountId?adminAccountId=' + (adminAccountId == null ? '' : encodeURIComponent(adminAccountId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DisassociateMember(id: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMemberResponse> {
			return Axios.post<DisassociateMemberResponse>(this.baseUri + '/members/disassociate/' + (id == null ? '' : encodeURIComponent(id)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		EnableOrganizationAdminAccount(requestBody: EnableOrganizationAdminAccountBody, headersHandler?: () => {[header: string]: string}): Promise<EnableOrganizationAdminAccountResponse> {
			return Axios.post<EnableOrganizationAdminAccountResponse>(this.baseUri + '/admin', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListOrganizationAdminAccounts(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListOrganizationAdminAccountsResponse> {
			return Axios.get<ListOrganizationAdminAccountsResponse>(this.baseUri + '/admin?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBucketStatistics(requestBody: GetBucketStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetBucketStatisticsResponse> {
			return Axios.post<GetBucketStatisticsResponse>(this.baseUri + '/datasources/s3/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetClassificationExportConfiguration(headersHandler?: () => {[header: string]: string}): Promise<GetClassificationExportConfigurationResponse> {
			return Axios.get<GetClassificationExportConfigurationResponse>(this.baseUri + '/classification-export-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutClassificationExportConfiguration(requestBody: PutClassificationExportConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<PutClassificationExportConfigurationResponse> {
			return Axios.put<PutClassificationExportConfigurationResponse>(this.baseUri + '/classification-export-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFindingStatistics(requestBody: GetFindingStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingStatisticsResponse> {
			return Axios.post<GetFindingStatisticsResponse>(this.baseUri + '/findings/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFindings(requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsResponse> {
			return Axios.post<GetFindingsResponse>(this.baseUri + '/findings/describe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUsageStatistics(requestBody: GetUsageStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetUsageStatisticsResponse> {
			return Axios.post<GetUsageStatisticsResponse>(this.baseUri + '/usage/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUsageTotals(headersHandler?: () => {[header: string]: string}): Promise<GetUsageTotalsResponse> {
			return Axios.get<GetUsageTotalsResponse>(this.baseUri + '/usage', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListClassificationJobs(requestBody: ListClassificationJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListClassificationJobsResponse> {
			return Axios.post<ListClassificationJobsResponse>(this.baseUri + '/jobs/list', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCustomDataIdentifiers(requestBody: ListCustomDataIdentifiersBody, headersHandler?: () => {[header: string]: string}): Promise<ListCustomDataIdentifiersResponse> {
			return Axios.post<ListCustomDataIdentifiersResponse>(this.baseUri + '/custom-data-identifiers/list', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListFindings(requestBody: ListFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ListFindingsResponse> {
			return Axios.post<ListFindingsResponse>(this.baseUri + '/findings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TestCustomDataIdentifier(requestBody: TestCustomDataIdentifierBody, headersHandler?: () => {[header: string]: string}): Promise<TestCustomDataIdentifierResponse> {
			return Axios.post<TestCustomDataIdentifierResponse>(this.baseUri + '/custom-data-identifiers/test', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UnarchiveFindings(requestBody: UnarchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<UnarchiveFindingsResponse> {
			return Axios.post<UnarchiveFindingsResponse>(this.baseUri + '/findings/unarchive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(resourceArn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
