export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelTaskExecution(requestBody: CancelTaskExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelTaskExecutionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CancelTaskExecution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAgent(requestBody: CreateAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAgentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CreateAgent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateLocationEfs(requestBody: CreateLocationEfsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationEfsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationEfs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateLocationFsxWindows(requestBody: CreateLocationFsxWindowsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationFsxWindowsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationFsxWindows', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateLocationNfs(requestBody: CreateLocationNfsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationNfsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationNfs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateLocationS3(requestBody: CreateLocationS3Request, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationS3Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationS3', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateLocationSmb(requestBody: CreateLocationSmbRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationSmbResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationSmb', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateTask(requestBody: CreateTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.CreateTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteAgent(requestBody: DeleteAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAgentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DeleteAgent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteLocation(requestBody: DeleteLocationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLocationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DeleteLocation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteTask(requestBody: DeleteTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DeleteTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeAgent(requestBody: DescribeAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAgentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeAgent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLocationEfs(requestBody: DescribeLocationEfsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationEfsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationEfs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLocationFsxWindows(requestBody: DescribeLocationFsxWindowsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationFsxWindowsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationFsxWindows', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLocationNfs(requestBody: DescribeLocationNfsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationNfsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationNfs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLocationS3(requestBody: DescribeLocationS3Request, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationS3Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationS3', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeLocationSmb(requestBody: DescribeLocationSmbRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationSmbResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationSmb', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTask(requestBody: DescribeTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTaskExecution(requestBody: DescribeTaskExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTaskExecutionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeTaskExecution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListLocations(MaxResults: string, NextToken: string, requestBody: ListLocationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLocationsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.ListLocations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTaskExecutions(MaxResults: string, NextToken: string, requestBody: ListTaskExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTaskExecutionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.ListTaskExecutions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTasks(MaxResults: string, NextToken: string, requestBody: ListTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTasksResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.ListTasks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartTaskExecution(requestBody: StartTaskExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTaskExecutionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.StartTaskExecution', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateAgent(requestBody: UpdateAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAgentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.UpdateAgent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateTask(requestBody: UpdateTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=FmrsService.UpdateTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
