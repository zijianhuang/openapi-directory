...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelTaskExecution(requestBody: CancelTaskExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelTaskExecutionResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.CancelTaskExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAgent(requestBody: CreateAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAgentResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.CreateAgent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLocationEfs(requestBody: CreateLocationEfsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationEfsResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.CreateLocationEfs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLocationFsxWindows(requestBody: CreateLocationFsxWindowsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationFsxWindowsResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.CreateLocationFsxWindows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLocationNfs(requestBody: CreateLocationNfsRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationNfsResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.CreateLocationNfs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLocationS3(requestBody: CreateLocationS3Request, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationS3Response> {
			return this.http.post('/#X-Amz-Target=FmrsService.CreateLocationS3', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLocationSmb(requestBody: CreateLocationSmbRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLocationSmbResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.CreateLocationSmb', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTask(requestBody: CreateTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTaskResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.CreateTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAgent(requestBody: DeleteAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAgentResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DeleteAgent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLocation(requestBody: DeleteLocationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLocationResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DeleteLocation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTask(requestBody: DeleteTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTaskResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DeleteTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAgent(requestBody: DescribeAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAgentResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeAgent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLocationEfs(requestBody: DescribeLocationEfsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationEfsResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeLocationEfs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLocationFsxWindows(requestBody: DescribeLocationFsxWindowsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationFsxWindowsResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeLocationFsxWindows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLocationNfs(requestBody: DescribeLocationNfsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationNfsResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeLocationNfs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLocationS3(requestBody: DescribeLocationS3Request, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationS3Response> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeLocationS3', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLocationSmb(requestBody: DescribeLocationSmbRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLocationSmbResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeLocationSmb', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTask(requestBody: DescribeTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTaskResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTaskExecution(requestBody: DescribeTaskExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTaskExecutionResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.DescribeTaskExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartTaskExecution(requestBody: StartTaskExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTaskExecutionResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.StartTaskExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateAgent(requestBody: UpdateAgentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAgentResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.UpdateAgent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTask(requestBody: UpdateTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTaskResponse> {
			return this.http.post('/#X-Amz-Target=FmrsService.UpdateTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
