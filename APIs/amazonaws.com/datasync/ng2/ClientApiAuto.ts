...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelTaskExecution(requestBody: CancelTaskExecutionRequest, headersHandler?: () => HttpHeaders): Observable<CancelTaskExecutionResponse> {
			return this.http.post<CancelTaskExecutionResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.CancelTaskExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAgent(requestBody: CreateAgentRequest, headersHandler?: () => HttpHeaders): Observable<CreateAgentResponse> {
			return this.http.post<CreateAgentResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.CreateAgent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateLocationEfs(requestBody: CreateLocationEfsRequest, headersHandler?: () => HttpHeaders): Observable<CreateLocationEfsResponse> {
			return this.http.post<CreateLocationEfsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationEfs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateLocationFsxWindows(requestBody: CreateLocationFsxWindowsRequest, headersHandler?: () => HttpHeaders): Observable<CreateLocationFsxWindowsResponse> {
			return this.http.post<CreateLocationFsxWindowsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationFsxWindows', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateLocationNfs(requestBody: CreateLocationNfsRequest, headersHandler?: () => HttpHeaders): Observable<CreateLocationNfsResponse> {
			return this.http.post<CreateLocationNfsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationNfs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateLocationS3(requestBody: CreateLocationS3Request, headersHandler?: () => HttpHeaders): Observable<CreateLocationS3Response> {
			return this.http.post<CreateLocationS3Response>(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationS3', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateLocationSmb(requestBody: CreateLocationSmbRequest, headersHandler?: () => HttpHeaders): Observable<CreateLocationSmbResponse> {
			return this.http.post<CreateLocationSmbResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.CreateLocationSmb', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTask(requestBody: CreateTaskRequest, headersHandler?: () => HttpHeaders): Observable<CreateTaskResponse> {
			return this.http.post<CreateTaskResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.CreateTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteAgent(requestBody: DeleteAgentRequest, headersHandler?: () => HttpHeaders): Observable<DeleteAgentResponse> {
			return this.http.post<DeleteAgentResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DeleteAgent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteLocation(requestBody: DeleteLocationRequest, headersHandler?: () => HttpHeaders): Observable<DeleteLocationResponse> {
			return this.http.post<DeleteLocationResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DeleteLocation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTask(requestBody: DeleteTaskRequest, headersHandler?: () => HttpHeaders): Observable<DeleteTaskResponse> {
			return this.http.post<DeleteTaskResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DeleteTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAgent(requestBody: DescribeAgentRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAgentResponse> {
			return this.http.post<DescribeAgentResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeAgent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLocationEfs(requestBody: DescribeLocationEfsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeLocationEfsResponse> {
			return this.http.post<DescribeLocationEfsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationEfs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLocationFsxWindows(requestBody: DescribeLocationFsxWindowsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeLocationFsxWindowsResponse> {
			return this.http.post<DescribeLocationFsxWindowsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationFsxWindows', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLocationNfs(requestBody: DescribeLocationNfsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeLocationNfsResponse> {
			return this.http.post<DescribeLocationNfsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationNfs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLocationS3(requestBody: DescribeLocationS3Request, headersHandler?: () => HttpHeaders): Observable<DescribeLocationS3Response> {
			return this.http.post<DescribeLocationS3Response>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationS3', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLocationSmb(requestBody: DescribeLocationSmbRequest, headersHandler?: () => HttpHeaders): Observable<DescribeLocationSmbResponse> {
			return this.http.post<DescribeLocationSmbResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeLocationSmb', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTask(requestBody: DescribeTaskRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTaskResponse> {
			return this.http.post<DescribeTaskResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTaskExecution(requestBody: DescribeTaskExecutionRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTaskExecutionResponse> {
			return this.http.post<DescribeTaskExecutionResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.DescribeTaskExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAgents(MaxResults: string, NextToken: string, requestBody: ListAgentsRequest, headersHandler?: () => HttpHeaders): Observable<ListAgentsResponse> {
			return this.http.post<ListAgentsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.ListAgents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListLocations(MaxResults: string, NextToken: string, requestBody: ListLocationsRequest, headersHandler?: () => HttpHeaders): Observable<ListLocationsResponse> {
			return this.http.post<ListLocationsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.ListLocations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForResource(MaxResults: string, NextToken: string, requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
		 ...
		 */
		ListTaskExecutions(MaxResults: string, NextToken: string, requestBody: ListTaskExecutionsRequest, headersHandler?: () => HttpHeaders): Observable<ListTaskExecutionsResponse> {
			return this.http.post<ListTaskExecutionsResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.ListTaskExecutions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTasks(MaxResults: string, NextToken: string, requestBody: ListTasksRequest, headersHandler?: () => HttpHeaders): Observable<ListTasksResponse> {
			return this.http.post<ListTasksResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.ListTasks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartTaskExecution(requestBody: StartTaskExecutionRequest, headersHandler?: () => HttpHeaders): Observable<StartTaskExecutionResponse> {
			return this.http.post<StartTaskExecutionResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.StartTaskExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateAgent(requestBody: UpdateAgentRequest, headersHandler?: () => HttpHeaders): Observable<UpdateAgentResponse> {
			return this.http.post<UpdateAgentResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.UpdateAgent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTask(requestBody: UpdateTaskRequest, headersHandler?: () => HttpHeaders): Observable<UpdateTaskResponse> {
			return this.http.post<UpdateTaskResponse>(this.baseUri + '/#X-Amz-Target=FmrsService.UpdateTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
