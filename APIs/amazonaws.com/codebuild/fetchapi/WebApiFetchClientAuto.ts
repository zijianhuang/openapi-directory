export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDeleteBuilds(requestBody: BatchDeleteBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteBuildsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchDeleteBuilds', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetBuilds(requestBody: BatchGetBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetBuildsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetBuilds', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetProjects(requestBody: BatchGetProjectsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetProjectsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetProjects', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetReportGroups(requestBody: BatchGetReportGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetReportGroupsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetReportGroups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetReports(requestBody: BatchGetReportsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetReportsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetReports', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateProject(requestBody: CreateProjectInput, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.CreateProject', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateReportGroup(requestBody: CreateReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<CreateReportGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.CreateReportGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateWebhook(requestBody: CreateWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<CreateWebhookOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.CreateWebhook', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteProject(requestBody: DeleteProjectInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteProject', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteReport(requestBody: DeleteReportInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteReportOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteReport', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteReportGroup(requestBody: DeleteReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteReportGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteReportGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcePolicyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSourceCredentials(requestBody: DeleteSourceCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteSourceCredentialsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteSourceCredentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteWebhook(requestBody: DeleteWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteWebhookOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteWebhook', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeTestCases(maxResults: string, nextToken: string, requestBody: DescribeTestCasesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTestCasesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DescribeTestCases?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetResourcePolicyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.GetResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ImportSourceCredentials(requestBody: ImportSourceCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<ImportSourceCredentialsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ImportSourceCredentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		InvalidateProjectCache(requestBody: InvalidateProjectCacheInput, headersHandler?: () => {[header: string]: string}): Promise<InvalidateProjectCacheOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.InvalidateProjectCache', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBuilds(nextToken: string, requestBody: ListBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<ListBuildsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListBuilds?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListBuildsForProject(nextToken: string, requestBody: ListBuildsForProjectInput, headersHandler?: () => {[header: string]: string}): Promise<ListBuildsForProjectOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListBuildsForProject?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCuratedEnvironmentImages(requestBody: ListCuratedEnvironmentImagesInput, headersHandler?: () => {[header: string]: string}): Promise<ListCuratedEnvironmentImagesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListCuratedEnvironmentImages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListProjects(nextToken: string, requestBody: ListProjectsInput, headersHandler?: () => {[header: string]: string}): Promise<ListProjectsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListProjects?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListReportGroups(maxResults: string, nextToken: string, requestBody: ListReportGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListReportGroupsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListReportGroups?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListReports(maxResults: string, nextToken: string, requestBody: ListReportsInput, headersHandler?: () => {[header: string]: string}): Promise<ListReportsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListReports?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListReportsForReportGroup(maxResults: string, nextToken: string, requestBody: ListReportsForReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<ListReportsForReportGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListReportsForReportGroup?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSharedProjects(maxResults: string, nextToken: string, requestBody: ListSharedProjectsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSharedProjectsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListSharedProjects?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSharedReportGroups(maxResults: string, nextToken: string, requestBody: ListSharedReportGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSharedReportGroupsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListSharedReportGroups?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSourceCredentials(requestBody: ListSourceCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSourceCredentialsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListSourceCredentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.PutResourcePolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartBuild(requestBody: StartBuildInput, headersHandler?: () => {[header: string]: string}): Promise<StartBuildOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.StartBuild', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopBuild(requestBody: StopBuildInput, headersHandler?: () => {[header: string]: string}): Promise<StopBuildOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.StopBuild', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateProject(requestBody: UpdateProjectInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateProjectOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.UpdateProject', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateReportGroup(requestBody: UpdateReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateReportGroupOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.UpdateReportGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateWebhook(requestBody: UpdateWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateWebhookOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.UpdateWebhook', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
