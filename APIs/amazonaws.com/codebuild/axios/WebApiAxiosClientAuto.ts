...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDeleteBuilds(requestBody: BatchDeleteBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchDeleteBuildsOutput> {
			return Axios.post<BatchDeleteBuildsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchDeleteBuilds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetBuilds(requestBody: BatchGetBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetBuildsOutput> {
			return Axios.post<BatchGetBuildsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetBuilds', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetProjects(requestBody: BatchGetProjectsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetProjectsOutput> {
			return Axios.post<BatchGetProjectsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetProjects', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetReportGroups(requestBody: BatchGetReportGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetReportGroupsOutput> {
			return Axios.post<BatchGetReportGroupsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetReportGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetReports(requestBody: BatchGetReportsInput, headersHandler?: () => {[header: string]: string}): Promise<BatchGetReportsOutput> {
			return Axios.post<BatchGetReportsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.BatchGetReports', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateProject(requestBody: CreateProjectInput, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectOutput> {
			return Axios.post<CreateProjectOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.CreateProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateReportGroup(requestBody: CreateReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<CreateReportGroupOutput> {
			return Axios.post<CreateReportGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.CreateReportGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateWebhook(requestBody: CreateWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<CreateWebhookOutput> {
			return Axios.post<CreateWebhookOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.CreateWebhook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteProject(requestBody: DeleteProjectInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectOutput> {
			return Axios.post<DeleteProjectOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteReport(requestBody: DeleteReportInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteReportOutput> {
			return Axios.post<DeleteReportOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteReport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteReportGroup(requestBody: DeleteReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteReportGroupOutput> {
			return Axios.post<DeleteReportGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteReportGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteResourcePolicy(requestBody: DeleteResourcePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourcePolicyOutput> {
			return Axios.post<DeleteResourcePolicyOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSourceCredentials(requestBody: DeleteSourceCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteSourceCredentialsOutput> {
			return Axios.post<DeleteSourceCredentialsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteSourceCredentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteWebhook(requestBody: DeleteWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteWebhookOutput> {
			return Axios.post<DeleteWebhookOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DeleteWebhook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeTestCases(maxResults: string, nextToken: string, requestBody: DescribeTestCasesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTestCasesOutput> {
			return Axios.post<DescribeTestCasesOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.DescribeTestCases?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetResourcePolicy(requestBody: GetResourcePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetResourcePolicyOutput> {
			return Axios.post<GetResourcePolicyOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.GetResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ImportSourceCredentials(requestBody: ImportSourceCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<ImportSourceCredentialsOutput> {
			return Axios.post<ImportSourceCredentialsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ImportSourceCredentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InvalidateProjectCache(requestBody: InvalidateProjectCacheInput, headersHandler?: () => {[header: string]: string}): Promise<InvalidateProjectCacheOutput> {
			return Axios.post<InvalidateProjectCacheOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.InvalidateProjectCache', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListBuilds(nextToken: string, requestBody: ListBuildsInput, headersHandler?: () => {[header: string]: string}): Promise<ListBuildsOutput> {
			return Axios.post<ListBuildsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListBuilds?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListBuildsForProject(nextToken: string, requestBody: ListBuildsForProjectInput, headersHandler?: () => {[header: string]: string}): Promise<ListBuildsForProjectOutput> {
			return Axios.post<ListBuildsForProjectOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListBuildsForProject?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCuratedEnvironmentImages(requestBody: ListCuratedEnvironmentImagesInput, headersHandler?: () => {[header: string]: string}): Promise<ListCuratedEnvironmentImagesOutput> {
			return Axios.post<ListCuratedEnvironmentImagesOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListCuratedEnvironmentImages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListProjects(nextToken: string, requestBody: ListProjectsInput, headersHandler?: () => {[header: string]: string}): Promise<ListProjectsOutput> {
			return Axios.post<ListProjectsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListProjects?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListReportGroups(maxResults: string, nextToken: string, requestBody: ListReportGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListReportGroupsOutput> {
			return Axios.post<ListReportGroupsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListReportGroups?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListReports(maxResults: string, nextToken: string, requestBody: ListReportsInput, headersHandler?: () => {[header: string]: string}): Promise<ListReportsOutput> {
			return Axios.post<ListReportsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListReports?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListReportsForReportGroup(maxResults: string, nextToken: string, requestBody: ListReportsForReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<ListReportsForReportGroupOutput> {
			return Axios.post<ListReportsForReportGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListReportsForReportGroup?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSharedProjects(maxResults: string, nextToken: string, requestBody: ListSharedProjectsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSharedProjectsOutput> {
			return Axios.post<ListSharedProjectsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListSharedProjects?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSharedReportGroups(maxResults: string, nextToken: string, requestBody: ListSharedReportGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSharedReportGroupsOutput> {
			return Axios.post<ListSharedReportGroupsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListSharedReportGroups?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSourceCredentials(requestBody: ListSourceCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSourceCredentialsOutput> {
			return Axios.post<ListSourceCredentialsOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.ListSourceCredentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutResourcePolicy(requestBody: PutResourcePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutResourcePolicyOutput> {
			return Axios.post<PutResourcePolicyOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.PutResourcePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartBuild(requestBody: StartBuildInput, headersHandler?: () => {[header: string]: string}): Promise<StartBuildOutput> {
			return Axios.post<StartBuildOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.StartBuild', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopBuild(requestBody: StopBuildInput, headersHandler?: () => {[header: string]: string}): Promise<StopBuildOutput> {
			return Axios.post<StopBuildOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.StopBuild', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateProject(requestBody: UpdateProjectInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateProjectOutput> {
			return Axios.post<UpdateProjectOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.UpdateProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateReportGroup(requestBody: UpdateReportGroupInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateReportGroupOutput> {
			return Axios.post<UpdateReportGroupOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.UpdateReportGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateWebhook(requestBody: UpdateWebhookInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateWebhookOutput> {
			return Axios.post<UpdateWebhookOutput>(this.baseUri + '/#X-Amz-Target=CodeBuild_20161006.UpdateWebhook', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
