...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApp(requestBody: CreateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAppResponse> {
			return Axios.post<CreateAppResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.CreateApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateReplicationJob(requestBody: CreateReplicationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateReplicationJobResponse> {
			return Axios.post<CreateReplicationJobResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.CreateReplicationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApp(requestBody: DeleteAppRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAppResponse> {
			return Axios.post<DeleteAppResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.DeleteApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteAppLaunchConfiguration(requestBody: DeleteAppLaunchConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAppLaunchConfigurationResponse> {
			return Axios.post<DeleteAppLaunchConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.DeleteAppLaunchConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteServerCatalog(requestBody: DeleteServerCatalogRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteServerCatalogResponse> {
			return Axios.post<DeleteServerCatalogResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.DeleteServerCatalog', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateConnector(requestBody: DisassociateConnectorRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateConnectorResponse> {
			return Axios.post<DisassociateConnectorResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.DisassociateConnector', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GenerateChangeSet(requestBody: GenerateChangeSetRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateChangeSetResponse> {
			return Axios.post<GenerateChangeSetResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.GenerateChangeSet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GenerateTemplate(requestBody: GenerateTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<GenerateTemplateResponse> {
			return Axios.post<GenerateTemplateResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.GenerateTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetApp(requestBody: GetAppRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAppResponse> {
			return Axios.post<GetAppResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.GetApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAppLaunchConfiguration(requestBody: GetAppLaunchConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAppLaunchConfigurationResponse> {
			return Axios.post<GetAppLaunchConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.GetAppLaunchConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAppReplicationConfiguration(requestBody: GetAppReplicationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAppReplicationConfigurationResponse> {
			return Axios.post<GetAppReplicationConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.GetAppReplicationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetConnectors(maxResults: string, nextToken: string, requestBody: GetConnectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConnectorsResponse> {
			return Axios.post<GetConnectorsResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.GetConnectors?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetServers(maxResults: string, nextToken: string, requestBody: GetServersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetServersResponse> {
			return Axios.post<GetServersResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.GetServers?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ImportServerCatalog(requestBody: ImportServerCatalogRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportServerCatalogResponse> {
			return Axios.post<ImportServerCatalogResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.ImportServerCatalog', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		LaunchApp(requestBody: LaunchAppRequest, headersHandler?: () => {[header: string]: string}): Promise<LaunchAppResponse> {
			return Axios.post<LaunchAppResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.LaunchApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListApps(requestBody: ListAppsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAppsResponse> {
			return Axios.post<ListAppsResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.ListApps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutAppLaunchConfiguration(requestBody: PutAppLaunchConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAppLaunchConfigurationResponse> {
			return Axios.post<PutAppLaunchConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.PutAppLaunchConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutAppReplicationConfiguration(requestBody: PutAppReplicationConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAppReplicationConfigurationResponse> {
			return Axios.post<PutAppReplicationConfigurationResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.PutAppReplicationConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartAppReplication(requestBody: StartAppReplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<StartAppReplicationResponse> {
			return Axios.post<StartAppReplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.StartAppReplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopAppReplication(requestBody: StopAppReplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<StopAppReplicationResponse> {
			return Axios.post<StopAppReplicationResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.StopAppReplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TerminateApp(requestBody: TerminateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<TerminateAppResponse> {
			return Axios.post<TerminateAppResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.TerminateApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateApp(requestBody: UpdateAppRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAppResponse> {
			return Axios.post<UpdateAppResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.UpdateApp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateReplicationJob(requestBody: UpdateReplicationJobRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateReplicationJobResponse> {
			return Axios.post<UpdateReplicationJobResponse>(this.baseUri + '/#X-Amz-Target=AWSServerMigrationService_V2016_10_24.UpdateReplicationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
