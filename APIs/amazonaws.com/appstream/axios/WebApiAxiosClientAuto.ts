...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateFleet(requestBody: AssociateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateFleetResult> {
			return Axios.post<AssociateFleetResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.AssociateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchAssociateUserStack(requestBody: BatchAssociateUserStackRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchAssociateUserStackResult> {
			return Axios.post<BatchAssociateUserStackResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.BatchAssociateUserStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchDisassociateUserStack(requestBody: BatchDisassociateUserStackRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDisassociateUserStackResult> {
			return Axios.post<BatchDisassociateUserStackResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.BatchDisassociateUserStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CopyImage(requestBody: CopyImageRequest, headersHandler?: () => {[header: string]: string}): Promise<CopyImageResponse> {
			return Axios.post<CopyImageResponse>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CopyImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDirectoryConfig(requestBody: CreateDirectoryConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectoryConfigResult> {
			return Axios.post<CreateDirectoryConfigResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateDirectoryConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateFleet(requestBody: CreateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFleetResult> {
			return Axios.post<CreateFleetResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateImageBuilder(requestBody: CreateImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateImageBuilderResult> {
			return Axios.post<CreateImageBuilderResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateImageBuilderStreamingURL(requestBody: CreateImageBuilderStreamingURLRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateImageBuilderStreamingURLResult> {
			return Axios.post<CreateImageBuilderStreamingURLResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateImageBuilderStreamingURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateStack(requestBody: CreateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStackResult> {
			return Axios.post<CreateStackResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateStreamingURL(requestBody: CreateStreamingURLRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamingURLResult> {
			return Axios.post<CreateStreamingURLResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateStreamingURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUsageReportSubscription(requestBody: CreateUsageReportSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUsageReportSubscriptionResult> {
			return Axios.post<CreateUsageReportSubscriptionResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateUsageReportSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUser(requestBody: CreateUserRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserResult> {
			return Axios.post<CreateUserResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.CreateUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDirectoryConfig(requestBody: DeleteDirectoryConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectoryConfigResult> {
			return Axios.post<DeleteDirectoryConfigResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteDirectoryConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteFleet(requestBody: DeleteFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFleetResult> {
			return Axios.post<DeleteFleetResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteImage(requestBody: DeleteImageRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageResult> {
			return Axios.post<DeleteImageResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteImageBuilder(requestBody: DeleteImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageBuilderResult> {
			return Axios.post<DeleteImageBuilderResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteImagePermissions(requestBody: DeleteImagePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteImagePermissionsResult> {
			return Axios.post<DeleteImagePermissionsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteImagePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteStack(requestBody: DeleteStackRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteStackResult> {
			return Axios.post<DeleteStackResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteUsageReportSubscription(requestBody: DeleteUsageReportSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUsageReportSubscriptionResult> {
			return Axios.post<DeleteUsageReportSubscriptionResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteUsageReportSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteUser(requestBody: DeleteUserRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserResult> {
			return Axios.post<DeleteUserResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DeleteUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDirectoryConfigs(requestBody: DescribeDirectoryConfigsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectoryConfigsResult> {
			return Axios.post<DescribeDirectoryConfigsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeDirectoryConfigs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeFleets(requestBody: DescribeFleetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetsResult> {
			return Axios.post<DescribeFleetsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeFleets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeImageBuilders(requestBody: DescribeImageBuildersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImageBuildersResult> {
			return Axios.post<DescribeImageBuildersResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeImageBuilders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeImagePermissions(MaxResults: string, NextToken: string, requestBody: DescribeImagePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImagePermissionsResult> {
			return Axios.post<DescribeImagePermissionsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeImagePermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeImages(MaxResults: string, NextToken: string, requestBody: DescribeImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImagesResult> {
			return Axios.post<DescribeImagesResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeImages?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSessions(requestBody: DescribeSessionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSessionsResult> {
			return Axios.post<DescribeSessionsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeStacks(requestBody: DescribeStacksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStacksResult> {
			return Axios.post<DescribeStacksResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeStacks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeUsageReportSubscriptions(requestBody: DescribeUsageReportSubscriptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUsageReportSubscriptionsResult> {
			return Axios.post<DescribeUsageReportSubscriptionsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeUsageReportSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeUserStackAssociations(requestBody: DescribeUserStackAssociationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserStackAssociationsResult> {
			return Axios.post<DescribeUserStackAssociationsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeUserStackAssociations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeUsers(requestBody: DescribeUsersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUsersResult> {
			return Axios.post<DescribeUsersResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DescribeUsers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableUser(requestBody: DisableUserRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableUserResult> {
			return Axios.post<DisableUserResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DisableUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateFleet(requestBody: DisassociateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateFleetResult> {
			return Axios.post<DisassociateFleetResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.DisassociateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableUser(requestBody: EnableUserRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableUserResult> {
			return Axios.post<EnableUserResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.EnableUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ExpireSession(requestBody: ExpireSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<ExpireSessionResult> {
			return Axios.post<ExpireSessionResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.ExpireSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssociatedFleets(requestBody: ListAssociatedFleetsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssociatedFleetsResult> {
			return Axios.post<ListAssociatedFleetsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.ListAssociatedFleets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssociatedStacks(requestBody: ListAssociatedStacksRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssociatedStacksResult> {
			return Axios.post<ListAssociatedStacksResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.ListAssociatedStacks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartFleet(requestBody: StartFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<StartFleetResult> {
			return Axios.post<StartFleetResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.StartFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartImageBuilder(requestBody: StartImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<StartImageBuilderResult> {
			return Axios.post<StartImageBuilderResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.StartImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopFleet(requestBody: StopFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<StopFleetResult> {
			return Axios.post<StopFleetResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.StopFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopImageBuilder(requestBody: StopImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<StopImageBuilderResult> {
			return Axios.post<StopImageBuilderResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.StopImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDirectoryConfig(requestBody: UpdateDirectoryConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDirectoryConfigResult> {
			return Axios.post<UpdateDirectoryConfigResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.UpdateDirectoryConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateFleet(requestBody: UpdateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetResult> {
			return Axios.post<UpdateFleetResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.UpdateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateImagePermissions(requestBody: UpdateImagePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateImagePermissionsResult> {
			return Axios.post<UpdateImagePermissionsResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.UpdateImagePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateStack(requestBody: UpdateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateStackResult> {
			return Axios.post<UpdateStackResult>(this.baseUri + '/#X-Amz-Target=PhotonAdminProxyService.UpdateStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
