...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateFleet(requestBody: AssociateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateFleetResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.AssociateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchAssociateUserStack(requestBody: BatchAssociateUserStackRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchAssociateUserStackResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.BatchAssociateUserStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchDisassociateUserStack(requestBody: BatchDisassociateUserStackRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchDisassociateUserStackResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.BatchDisassociateUserStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CopyImage(requestBody: CopyImageRequest, headersHandler?: () => {[header: string]: string}): Promise<CopyImageResponse> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CopyImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDirectoryConfig(requestBody: CreateDirectoryConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectoryConfigResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateDirectoryConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateFleet(requestBody: CreateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFleetResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateImageBuilder(requestBody: CreateImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateImageBuilderResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateImageBuilderStreamingURL(requestBody: CreateImageBuilderStreamingURLRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateImageBuilderStreamingURLResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateImageBuilderStreamingURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateStack(requestBody: CreateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStackResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateStreamingURL(requestBody: CreateStreamingURLRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamingURLResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateStreamingURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateUsageReportSubscription(requestBody: CreateUsageReportSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUsageReportSubscriptionResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateUsageReportSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateUser(requestBody: CreateUserRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.CreateUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDirectoryConfig(requestBody: DeleteDirectoryConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectoryConfigResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteDirectoryConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteFleet(requestBody: DeleteFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFleetResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteImage(requestBody: DeleteImageRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteImageBuilder(requestBody: DeleteImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteImageBuilderResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteImagePermissions(requestBody: DeleteImagePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteImagePermissionsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteImagePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteStack(requestBody: DeleteStackRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteStackResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUsageReportSubscription(requestBody: DeleteUsageReportSubscriptionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUsageReportSubscriptionResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteUsageReportSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUser(requestBody: DeleteUserRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DeleteUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDirectoryConfigs(requestBody: DescribeDirectoryConfigsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectoryConfigsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeDirectoryConfigs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeFleets(requestBody: DescribeFleetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeFleets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeImageBuilders(requestBody: DescribeImageBuildersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImageBuildersResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeImageBuilders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeImagePermissions(MaxResults: string, NextToken: string, requestBody: DescribeImagePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImagePermissionsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeImagePermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeImages(MaxResults: string, NextToken: string, requestBody: DescribeImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeImagesResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeImages?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSessions(requestBody: DescribeSessionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSessionsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeStacks(requestBody: DescribeStacksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStacksResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeStacks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeUsageReportSubscriptions(requestBody: DescribeUsageReportSubscriptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUsageReportSubscriptionsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeUsageReportSubscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeUserStackAssociations(requestBody: DescribeUserStackAssociationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserStackAssociationsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeUserStackAssociations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeUsers(requestBody: DescribeUsersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUsersResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DescribeUsers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableUser(requestBody: DisableUserRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableUserResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DisableUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateFleet(requestBody: DisassociateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateFleetResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.DisassociateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableUser(requestBody: EnableUserRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableUserResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.EnableUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ExpireSession(requestBody: ExpireSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<ExpireSessionResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.ExpireSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAssociatedFleets(requestBody: ListAssociatedFleetsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssociatedFleetsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.ListAssociatedFleets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAssociatedStacks(requestBody: ListAssociatedStacksRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssociatedStacksResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.ListAssociatedStacks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartFleet(requestBody: StartFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<StartFleetResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.StartFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartImageBuilder(requestBody: StartImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<StartImageBuilderResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.StartImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopFleet(requestBody: StopFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<StopFleetResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.StopFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopImageBuilder(requestBody: StopImageBuilderRequest, headersHandler?: () => {[header: string]: string}): Promise<StopImageBuilderResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.StopImageBuilder', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDirectoryConfig(requestBody: UpdateDirectoryConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDirectoryConfigResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.UpdateDirectoryConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateFleet(requestBody: UpdateFleetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateFleetResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.UpdateFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateImagePermissions(requestBody: UpdateImagePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateImagePermissionsResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.UpdateImagePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateStack(requestBody: UpdateStackRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateStackResult> {
			return this.http.post('/#X-Amz-Target=PhotonAdminProxyService.UpdateStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
