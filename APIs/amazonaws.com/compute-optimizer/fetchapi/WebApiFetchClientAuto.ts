export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetAutoScalingGroupRecommendations(requestBody: GetAutoScalingGroupRecommendationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAutoScalingGroupRecommendationsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetAutoScalingGroupRecommendations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetEC2InstanceRecommendations(requestBody: GetEC2InstanceRecommendationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEC2InstanceRecommendationsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEC2InstanceRecommendations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetEC2RecommendationProjectedMetrics(requestBody: GetEC2RecommendationProjectedMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEC2RecommendationProjectedMetricsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEC2RecommendationProjectedMetrics', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetEnrollmentStatus(requestBody: GetEnrollmentStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEnrollmentStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEnrollmentStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		GetRecommendationSummaries(requestBody: GetRecommendationSummariesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRecommendationSummariesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetRecommendationSummaries', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateEnrollmentStatus(requestBody: UpdateEnrollmentStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEnrollmentStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.UpdateEnrollmentStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
