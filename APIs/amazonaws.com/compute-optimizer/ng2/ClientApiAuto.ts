...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetAutoScalingGroupRecommendations(requestBody: GetAutoScalingGroupRecommendationsRequest, headersHandler?: () => HttpHeaders): Observable<GetAutoScalingGroupRecommendationsResponse> {
			return this.http.post<GetAutoScalingGroupRecommendationsResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetAutoScalingGroupRecommendations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetEC2InstanceRecommendations(requestBody: GetEC2InstanceRecommendationsRequest, headersHandler?: () => HttpHeaders): Observable<GetEC2InstanceRecommendationsResponse> {
			return this.http.post<GetEC2InstanceRecommendationsResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEC2InstanceRecommendations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetEC2RecommendationProjectedMetrics(requestBody: GetEC2RecommendationProjectedMetricsRequest, headersHandler?: () => HttpHeaders): Observable<GetEC2RecommendationProjectedMetricsResponse> {
			return this.http.post<GetEC2RecommendationProjectedMetricsResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEC2RecommendationProjectedMetrics', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetEnrollmentStatus(requestBody: GetEnrollmentStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetEnrollmentStatusResponse> {
			return this.http.post<GetEnrollmentStatusResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEnrollmentStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetRecommendationSummaries(requestBody: GetRecommendationSummariesRequest, headersHandler?: () => HttpHeaders): Observable<GetRecommendationSummariesResponse> {
			return this.http.post<GetRecommendationSummariesResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetRecommendationSummaries', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateEnrollmentStatus(requestBody: UpdateEnrollmentStatusRequest, headersHandler?: () => HttpHeaders): Observable<UpdateEnrollmentStatusResponse> {
			return this.http.post<UpdateEnrollmentStatusResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.UpdateEnrollmentStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
