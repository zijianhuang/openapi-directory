...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GetEC2InstanceRecommendations(requestBody: GetEC2InstanceRecommendationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEC2InstanceRecommendationsResponse> {
			return Axios.post<GetEC2InstanceRecommendationsResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEC2InstanceRecommendations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetEC2RecommendationProjectedMetrics(requestBody: GetEC2RecommendationProjectedMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEC2RecommendationProjectedMetricsResponse> {
			return Axios.post<GetEC2RecommendationProjectedMetricsResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEC2RecommendationProjectedMetrics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetEnrollmentStatus(requestBody: GetEnrollmentStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEnrollmentStatusResponse> {
			return Axios.post<GetEnrollmentStatusResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetEnrollmentStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRecommendationSummaries(requestBody: GetRecommendationSummariesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRecommendationSummariesResponse> {
			return Axios.post<GetRecommendationSummariesResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.GetRecommendationSummaries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateEnrollmentStatus(requestBody: UpdateEnrollmentStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEnrollmentStatusResponse> {
			return Axios.post<UpdateEnrollmentStatusResponse>(this.baseUri + '/#X-Amz-Target=ComputeOptimizerService.UpdateEnrollmentStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
