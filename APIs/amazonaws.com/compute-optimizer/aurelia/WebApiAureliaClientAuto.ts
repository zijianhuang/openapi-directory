...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GetAutoScalingGroupRecommendations(requestBody: GetAutoScalingGroupRecommendationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAutoScalingGroupRecommendationsResponse> {
			return this.http.post('/#X-Amz-Target=ComputeOptimizerService.GetAutoScalingGroupRecommendations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetEC2InstanceRecommendations(requestBody: GetEC2InstanceRecommendationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEC2InstanceRecommendationsResponse> {
			return this.http.post('/#X-Amz-Target=ComputeOptimizerService.GetEC2InstanceRecommendations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetEC2RecommendationProjectedMetrics(requestBody: GetEC2RecommendationProjectedMetricsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEC2RecommendationProjectedMetricsResponse> {
			return this.http.post('/#X-Amz-Target=ComputeOptimizerService.GetEC2RecommendationProjectedMetrics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetEnrollmentStatus(requestBody: GetEnrollmentStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEnrollmentStatusResponse> {
			return this.http.post('/#X-Amz-Target=ComputeOptimizerService.GetEnrollmentStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRecommendationSummaries(requestBody: GetRecommendationSummariesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRecommendationSummariesResponse> {
			return this.http.post('/#X-Amz-Target=ComputeOptimizerService.GetRecommendationSummaries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateEnrollmentStatus(requestBody: UpdateEnrollmentStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEnrollmentStatusResponse> {
			return this.http.post('/#X-Amz-Target=ComputeOptimizerService.UpdateEnrollmentStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
