...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociatePhoneNumbersWithVoiceConnectorGroup(voiceConnectorGroupId: string, operation: string, requestBody: AssociatePhoneNumbersWithVoiceConnectorGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AssociatePhoneNumbersWithVoiceConnectorGroupResponse> {
			return this.http.post('/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)) + '#operation=associate-phone-numbers&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateSigninDelegateGroupsWithAccount(accountId: string, operation: string, requestBody: AssociateSigninDelegateGroupsWithAccountBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateSigninDelegateGroupsWithAccountResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '#operation=associate-signin-delegate-groups&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchDeletePhoneNumber(operation: string, requestBody: BatchDeletePhoneNumberBody, headersHandler?: () => {[header: string]: string}): Promise<BatchDeletePhoneNumberResponse> {
			return this.http.post('/phone-numbers#operation=batch-delete?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchSuspendUser(accountId: string, operation: string, requestBody: BatchSuspendUserBody, headersHandler?: () => {[header: string]: string}): Promise<BatchSuspendUserResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=suspend&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchUnsuspendUser(accountId: string, operation: string, requestBody: BatchUnsuspendUserBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUnsuspendUserResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=unsuspend&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchUpdatePhoneNumber(operation: string, requestBody: BatchUpdatePhoneNumberBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUpdatePhoneNumberResponse> {
			return this.http.post('/phone-numbers#operation=batch-update?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchUpdateUser(accountId: string, requestBody: BatchUpdateUserBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUpdateUserResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAccount(requestBody: CreateAccountBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/accounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListAccounts(name: string, user_email: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListAccountsResponse> {
			return this.http.get('/accounts?name=' + (name == null ? '' : encodeURIComponent(name)) + '&user_email=' + (user_email == null ? '' : encodeURIComponent(user_email)) + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateAttendee(meetingId: string, requestBody: CreateAttendeeBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListAttendees(meetingId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListAttendeesResponse> {
			return this.http.get('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBot(accountId: string, requestBody: CreateBotBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateMeeting(requestBody: CreateMeetingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/meetings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListMeetings(next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListMeetingsResponse> {
			return this.http.get('/meetings?next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePhoneNumberOrder(requestBody: CreatePhoneNumberOrderBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/phone-number-orders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListPhoneNumberOrders(next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPhoneNumberOrdersResponse> {
			return this.http.get('/phone-number-orders?next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateProxySession(voiceConnectorId: string, requestBody: CreateProxySessionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/proxy-sessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateRoom(accountId: string, requestBody: CreateRoomBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateRoomMembership(accountId: string, roomId: string, requestBody: CreateRoomMembershipBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)) + '/memberships', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateUser(accountId: string, operation: string, requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=create&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateVoiceConnector(requestBody: CreateVoiceConnectorBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/voice-connectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListVoiceConnectors(next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListVoiceConnectorsResponse> {
			return this.http.get('/voice-connectors?next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateVoiceConnectorGroup(requestBody: CreateVoiceConnectorGroupBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/voice-connector-groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListVoiceConnectorGroups(next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListVoiceConnectorGroupsResponse> {
			return this.http.get('/voice-connector-groups?next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteAccount(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAccount(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAccountResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateAccount(accountId: string, requestBody: UpdateAccountBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAttendee(meetingId: string, attendeeId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAttendee(meetingId: string, attendeeId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAttendeeResponse> {
			return this.http.get('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteEventsConfiguration(accountId: string, botId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)) + '/events-configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetEventsConfiguration(accountId: string, botId: string, headersHandler?: () => {[header: string]: string}): Promise<GetEventsConfigurationResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)) + '/events-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutEventsConfiguration(accountId: string, botId: string, requestBody: PutEventsConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)) + '/events-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteMeeting(meetingId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetMeeting(meetingId: string, headersHandler?: () => {[header: string]: string}): Promise<GetMeetingResponse> {
			return this.http.get('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeletePhoneNumber(phoneNumberId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetPhoneNumber(phoneNumberId: string, headersHandler?: () => {[header: string]: string}): Promise<GetPhoneNumberResponse> {
			return this.http.get('/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdatePhoneNumber(phoneNumberId: string, requestBody: UpdatePhoneNumberBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePhoneNumberResponse> {
			return this.http.post('/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteProxySession(voiceConnectorId: string, proxySessionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/proxy-sessions/' + (proxySessionId == null ? '' : encodeURIComponent(proxySessionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetProxySession(voiceConnectorId: string, proxySessionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetProxySessionResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/proxy-sessions/' + (proxySessionId == null ? '' : encodeURIComponent(proxySessionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteRoom(accountId: string, roomId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetRoom(accountId: string, roomId: string, headersHandler?: () => {[header: string]: string}): Promise<GetRoomResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateRoom(accountId: string, roomId: string, requestBody: UpdateRoomBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRoomResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRoomMembership(accountId: string, roomId: string, memberId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)) + '/memberships/' + (memberId == null ? '' : encodeURIComponent(memberId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteVoiceConnector(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceConnector(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateVoiceConnector(voiceConnectorId: string, requestBody: UpdateVoiceConnectorBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateVoiceConnectorResponse> {
			return this.http.put('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteVoiceConnectorGroup(voiceConnectorGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceConnectorGroup(voiceConnectorGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorGroupResponse> {
			return this.http.get('/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateVoiceConnectorGroup(voiceConnectorGroupId: string, requestBody: UpdateVoiceConnectorGroupBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteVoiceConnectorOrigination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/origination', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceConnectorOrigination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorOriginationResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/origination', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutVoiceConnectorOrigination(voiceConnectorId: string, requestBody: PutVoiceConnectorOriginationBody, headersHandler?: () => {[header: string]: string}): Promise<PutVoiceConnectorOriginationResponse> {
			return this.http.put('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/origination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteVoiceConnectorProxy(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/programmable-numbers/proxy', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceConnectorProxy(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorProxyResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/programmable-numbers/proxy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteVoiceConnectorStreamingConfiguration(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/streaming-configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceConnectorStreamingConfiguration(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorStreamingConfigurationResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/streaming-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutVoiceConnectorStreamingConfiguration(voiceConnectorId: string, requestBody: PutVoiceConnectorStreamingConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<PutVoiceConnectorStreamingConfigurationResponse> {
			return this.http.put('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/streaming-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteVoiceConnectorTermination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVoiceConnectorTermination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorTerminationResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutVoiceConnectorTermination(voiceConnectorId: string, requestBody: PutVoiceConnectorTerminationBody, headersHandler?: () => {[header: string]: string}): Promise<PutVoiceConnectorTerminationResponse> {
			return this.http.put('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociatePhoneNumberFromUser(accountId: string, userId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociatePhoneNumberFromUserResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '#operation=disassociate-phone-number&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociatePhoneNumbersFromVoiceConnectorGroup(voiceConnectorGroupId: string, operation: string, requestBody: DisassociatePhoneNumbersFromVoiceConnectorGroupBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociatePhoneNumbersFromVoiceConnectorGroupResponse> {
			return this.http.post('/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)) + '#operation=disassociate-phone-numbers&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateSigninDelegateGroupsFromAccount(accountId: string, operation: string, requestBody: DisassociateSigninDelegateGroupsFromAccountBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateSigninDelegateGroupsFromAccountResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '#operation=disassociate-signin-delegate-groups&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAccountSettings(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAccountSettingsResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateAccountSettings(accountId: string, requestBody: UpdateAccountSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetBot(accountId: string, botId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateBot(accountId: string, botId: string, requestBody: UpdateBotBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBotResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetGlobalSettings(headersHandler?: () => {[header: string]: string}): Promise<GetGlobalSettingsResponse> {
			return this.http.get('/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGlobalSettings(requestBody: UpdateGlobalSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetPhoneNumberOrder(phoneNumberOrderId: string, headersHandler?: () => {[header: string]: string}): Promise<GetPhoneNumberOrderResponse> {
			return this.http.get('/phone-number-orders/' + (phoneNumberOrderId == null ? '' : encodeURIComponent(phoneNumberOrderId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetPhoneNumberSettings(headersHandler?: () => {[header: string]: string}): Promise<GetPhoneNumberSettingsResponse> {
			return this.http.get('/settings/phone-number', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdatePhoneNumberSettings(requestBody: UpdatePhoneNumberSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/settings/phone-number', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetRetentionSettings(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetRetentionSettingsResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/retention-settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutRetentionSettings(accountId: string, requestBody: PutRetentionSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/retention-settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetUser(accountId: string, userId: string, headersHandler?: () => {[header: string]: string}): Promise<GetUserResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateUser(accountId: string, userId: string, requestBody: UpdateUserBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetUserSettings(accountId: string, userId: string, headersHandler?: () => {[header: string]: string}): Promise<GetUserSettingsResponse> {
			return this.http.get('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateUserSettings(accountId: string, userId: string, requestBody: UpdateUserSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetVoiceConnectorLoggingConfiguration(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorLoggingConfigurationResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/logging-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutVoiceConnectorLoggingConfiguration(voiceConnectorId: string, requestBody: PutVoiceConnectorLoggingConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<PutVoiceConnectorLoggingConfigurationResponse> {
			return this.http.put('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/logging-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetVoiceConnectorTerminationHealth(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorTerminationHealthResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination/health', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		InviteUsers(accountId: string, operation: string, requestBody: InviteUsersBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListAttendeeTags(meetingId: string, attendeeId: string, headersHandler?: () => {[header: string]: string}): Promise<ListAttendeeTagsResponse> {
			return this.http.get('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)) + '/tags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListMeetingTags(meetingId: string, headersHandler?: () => {[header: string]: string}): Promise<ListMeetingTagsResponse> {
			return this.http.get('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/tags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListPhoneNumbers(status: PhoneNumberStatus, product_type: UpdatePhoneNumberRequestItemProductType, filter_name: PhoneNumberAssociationName, filter_value: string, max_results: number, next_token: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPhoneNumbersResponse> {
			return this.http.get('/phone-numbers?status=' + status + '&product_type=' + product_type + '&filter_name=' + filter_name + '&filter_value=' + (filter_value == null ? '' : encodeURIComponent(filter_value)) + '&max_results=' + max_results + '&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(arn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.get('/tags#arn?arn=' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListVoiceConnectorTerminationCredentials(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<ListVoiceConnectorTerminationCredentialsResponse> {
			return this.http.get('/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination/credentials', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		LogoutUser(accountId: string, userId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '#operation=logout&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RedactConversationMessage(accountId: string, conversationId: string, messageId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<RedactConversationMessageResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/conversations/' + (conversationId == null ? '' : encodeURIComponent(conversationId)) + '/messages/' + (messageId == null ? '' : encodeURIComponent(messageId)) + '#operation=redact&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RegenerateSecurityToken(accountId: string, botId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<RegenerateSecurityTokenResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)) + '#operation=regenerate-security-token&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ResetPersonalPIN(accountId: string, userId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<ResetPersonalPINResponse> {
			return this.http.post('/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '#operation=reset-personal-pin&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RestorePhoneNumber(phoneNumberId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<RestorePhoneNumberResponse> {
			return this.http.post('/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)) + '#operation=restore&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagMeeting(meetingId: string, operation: string, requestBody: TagMeetingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/tags#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		TagResource(operation: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/tags#operation=tag-resource?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UntagMeeting(meetingId: string, operation: string, requestBody: UntagMeetingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/tags#operation=delete&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		UntagResource(operation: string, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/tags#operation=untag-resource?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
