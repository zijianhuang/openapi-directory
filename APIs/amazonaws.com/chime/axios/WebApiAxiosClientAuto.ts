...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateSigninDelegateGroupsWithAccount(accountId: string, operation: string, requestBody: AssociateSigninDelegateGroupsWithAccountBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateSigninDelegateGroupsWithAccountResponse> {
			return Axios.post<AssociateSigninDelegateGroupsWithAccountResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '#operation=associate-signin-delegate-groups&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		BatchCreateAttendee(meetingId: string, operation: string, requestBody: BatchCreateAttendeeBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees#operation=batch-create&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		BatchCreateRoomMembership(accountId: string, roomId: string, operation: string, requestBody: BatchCreateRoomMembershipBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)) + '/memberships#operation=batch-create&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		BatchDeletePhoneNumber(operation: string, requestBody: BatchDeletePhoneNumberBody, headersHandler?: () => {[header: string]: string}): Promise<BatchDeletePhoneNumberResponse> {
			return Axios.post<BatchDeletePhoneNumberResponse>(this.baseUri + '/phone-numbers#operation=batch-delete?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchSuspendUser(accountId: string, operation: string, requestBody: BatchSuspendUserBody, headersHandler?: () => {[header: string]: string}): Promise<BatchSuspendUserResponse> {
			return Axios.post<BatchSuspendUserResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=suspend&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchUnsuspendUser(accountId: string, operation: string, requestBody: BatchUnsuspendUserBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUnsuspendUserResponse> {
			return Axios.post<BatchUnsuspendUserResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=unsuspend&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchUpdatePhoneNumber(operation: string, requestBody: BatchUpdatePhoneNumberBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUpdatePhoneNumberResponse> {
			return Axios.post<BatchUpdatePhoneNumberResponse>(this.baseUri + '/phone-numbers#operation=batch-update?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchUpdateUser(accountId: string, requestBody: BatchUpdateUserBody, headersHandler?: () => {[header: string]: string}): Promise<BatchUpdateUserResponse> {
			return Axios.post<BatchUpdateUserResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateAccount(requestBody: CreateAccountBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateAttendee(meetingId: string, requestBody: CreateAttendeeBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateBot(accountId: string, requestBody: CreateBotBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateMeeting(requestBody: CreateMeetingBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/meetings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreatePhoneNumberOrder(requestBody: CreatePhoneNumberOrderBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/phone-number-orders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateProxySession(voiceConnectorId: string, requestBody: CreateProxySessionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/proxy-sessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateRoom(accountId: string, requestBody: CreateRoomBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateRoomMembership(accountId: string, roomId: string, requestBody: CreateRoomMembershipBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)) + '/memberships', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateUser(accountId: string, operation: string, requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=create&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateVoiceConnector(requestBody: CreateVoiceConnectorBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/voice-connectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateVoiceConnectorGroup(requestBody: CreateVoiceConnectorGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/voice-connector-groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAccount(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetAccount(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAccountResponse> {
			return Axios.get<GetAccountResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateAccount(accountId: string, requestBody: UpdateAccountBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateAccountResponse> {
			return Axios.post<UpdateAccountResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteAttendee(meetingId: string, attendeeId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetAttendee(meetingId: string, attendeeId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAttendeeResponse> {
			return Axios.get<GetAttendeeResponse>(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteEventsConfiguration(accountId: string, botId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)) + '/events-configuration', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetEventsConfiguration(accountId: string, botId: string, headersHandler?: () => {[header: string]: string}): Promise<GetEventsConfigurationResponse> {
			return Axios.get<GetEventsConfigurationResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)) + '/events-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutEventsConfiguration(accountId: string, botId: string, requestBody: PutEventsConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteMeeting(meetingId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetMeeting(meetingId: string, headersHandler?: () => {[header: string]: string}): Promise<GetMeetingResponse> {
			return Axios.get<GetMeetingResponse>(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeletePhoneNumber(phoneNumberId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetPhoneNumber(phoneNumberId: string, headersHandler?: () => {[header: string]: string}): Promise<GetPhoneNumberResponse> {
			return Axios.get<GetPhoneNumberResponse>(this.baseUri + '/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdatePhoneNumber(phoneNumberId: string, requestBody: UpdatePhoneNumberBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePhoneNumberResponse> {
			return Axios.post<UpdatePhoneNumberResponse>(this.baseUri + '/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteProxySession(voiceConnectorId: string, proxySessionId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/proxy-sessions/' + (proxySessionId == null ? '' : encodeURIComponent(proxySessionId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetProxySession(voiceConnectorId: string, proxySessionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetProxySessionResponse> {
			return Axios.get<GetProxySessionResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/proxy-sessions/' + (proxySessionId == null ? '' : encodeURIComponent(proxySessionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateProxySession(voiceConnectorId: string, proxySessionId: string, requestBody: UpdateProxySessionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/proxy-sessions/' + (proxySessionId == null ? '' : encodeURIComponent(proxySessionId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteRoom(accountId: string, roomId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetRoom(accountId: string, roomId: string, headersHandler?: () => {[header: string]: string}): Promise<GetRoomResponse> {
			return Axios.get<GetRoomResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateRoom(accountId: string, roomId: string, requestBody: UpdateRoomBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRoomResponse> {
			return Axios.post<UpdateRoomResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteRoomMembership(accountId: string, roomId: string, memberId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)) + '/memberships/' + (memberId == null ? '' : encodeURIComponent(memberId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		UpdateRoomMembership(accountId: string, roomId: string, memberId: string, requestBody: UpdateRoomMembershipBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRoomMembershipResponse> {
			return Axios.post<UpdateRoomMembershipResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/rooms/' + (roomId == null ? '' : encodeURIComponent(roomId)) + '/memberships/' + (memberId == null ? '' : encodeURIComponent(memberId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceConnector(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetVoiceConnector(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorResponse> {
			return Axios.get<GetVoiceConnectorResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateVoiceConnector(voiceConnectorId: string, requestBody: UpdateVoiceConnectorBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateVoiceConnectorResponse> {
			return Axios.put<UpdateVoiceConnectorResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceConnectorGroup(voiceConnectorGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetVoiceConnectorGroup(voiceConnectorGroupId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorGroupResponse> {
			return Axios.get<GetVoiceConnectorGroupResponse>(this.baseUri + '/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateVoiceConnectorGroup(voiceConnectorGroupId: string, requestBody: UpdateVoiceConnectorGroupBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/voice-connector-groups/' + (voiceConnectorGroupId == null ? '' : encodeURIComponent(voiceConnectorGroupId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceConnectorOrigination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/origination', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetVoiceConnectorOrigination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorOriginationResponse> {
			return Axios.get<GetVoiceConnectorOriginationResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/origination', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutVoiceConnectorOrigination(voiceConnectorId: string, requestBody: PutVoiceConnectorOriginationBody, headersHandler?: () => {[header: string]: string}): Promise<PutVoiceConnectorOriginationResponse> {
			return Axios.put<PutVoiceConnectorOriginationResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/origination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceConnectorProxy(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/programmable-numbers/proxy', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetVoiceConnectorProxy(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorProxyResponse> {
			return Axios.get<GetVoiceConnectorProxyResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/programmable-numbers/proxy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutVoiceConnectorProxy(voiceConnectorId: string, requestBody: PutVoiceConnectorProxyBody, headersHandler?: () => {[header: string]: string}): Promise<PutVoiceConnectorProxyResponse> {
			return Axios.put<PutVoiceConnectorProxyResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/programmable-numbers/proxy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceConnectorStreamingConfiguration(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/streaming-configuration', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetVoiceConnectorStreamingConfiguration(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorStreamingConfigurationResponse> {
			return Axios.get<GetVoiceConnectorStreamingConfigurationResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/streaming-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceConnectorTermination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetVoiceConnectorTermination(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorTerminationResponse> {
			return Axios.get<GetVoiceConnectorTerminationResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutVoiceConnectorTermination(voiceConnectorId: string, requestBody: PutVoiceConnectorTerminationBody, headersHandler?: () => {[header: string]: string}): Promise<PutVoiceConnectorTerminationResponse> {
			return Axios.put<PutVoiceConnectorTerminationResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVoiceConnectorTerminationCredentials(voiceConnectorId: string, operation: string, requestBody: DeleteVoiceConnectorTerminationCredentialsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination/credentials#operation=delete&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DisassociateSigninDelegateGroupsFromAccount(accountId: string, operation: string, requestBody: DisassociateSigninDelegateGroupsFromAccountBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateSigninDelegateGroupsFromAccountResponse> {
			return Axios.post<DisassociateSigninDelegateGroupsFromAccountResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '#operation=disassociate-signin-delegate-groups&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAccountSettings(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetAccountSettingsResponse> {
			return Axios.get<GetAccountSettingsResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateAccountSettings(accountId: string, requestBody: UpdateAccountSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetBot(accountId: string, botId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBotResponse> {
			return Axios.get<GetBotResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateBot(accountId: string, botId: string, requestBody: UpdateBotBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBotResponse> {
			return Axios.post<UpdateBotResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/bots/' + (botId == null ? '' : encodeURIComponent(botId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetGlobalSettings(headersHandler?: () => {[header: string]: string}): Promise<GetGlobalSettingsResponse> {
			return Axios.get<GetGlobalSettingsResponse>(this.baseUri + '/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateGlobalSettings(requestBody: UpdateGlobalSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetPhoneNumberOrder(phoneNumberOrderId: string, headersHandler?: () => {[header: string]: string}): Promise<GetPhoneNumberOrderResponse> {
			return Axios.get<GetPhoneNumberOrderResponse>(this.baseUri + '/phone-number-orders/' + (phoneNumberOrderId == null ? '' : encodeURIComponent(phoneNumberOrderId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetPhoneNumberSettings(headersHandler?: () => {[header: string]: string}): Promise<GetPhoneNumberSettingsResponse> {
			return Axios.get<GetPhoneNumberSettingsResponse>(this.baseUri + '/settings/phone-number', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdatePhoneNumberSettings(requestBody: UpdatePhoneNumberSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/settings/phone-number', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetRetentionSettings(accountId: string, headersHandler?: () => {[header: string]: string}): Promise<GetRetentionSettingsResponse> {
			return Axios.get<GetRetentionSettingsResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/retention-settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutRetentionSettings(accountId: string, requestBody: PutRetentionSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/retention-settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetUser(accountId: string, userId: string, headersHandler?: () => {[header: string]: string}): Promise<GetUserResponse> {
			return Axios.get<GetUserResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateUser(accountId: string, userId: string, requestBody: UpdateUserBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserResponse> {
			return Axios.post<UpdateUserResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUserSettings(accountId: string, userId: string, headersHandler?: () => {[header: string]: string}): Promise<GetUserSettingsResponse> {
			return Axios.get<GetUserSettingsResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateUserSettings(accountId: string, userId: string, requestBody: UpdateUserSettingsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '/settings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetVoiceConnectorLoggingConfiguration(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorLoggingConfigurationResponse> {
			return Axios.get<GetVoiceConnectorLoggingConfigurationResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/logging-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetVoiceConnectorTerminationHealth(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetVoiceConnectorTerminationHealthResponse> {
			return Axios.get<GetVoiceConnectorTerminationHealthResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination/health', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		InviteUsers(accountId: string, operation: string, requestBody: InviteUsersBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListAttendeeTags(meetingId: string, attendeeId: string, headersHandler?: () => {[header: string]: string}): Promise<ListAttendeeTagsResponse> {
			return Axios.get<ListAttendeeTagsResponse>(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)) + '/tags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListMeetingTags(meetingId: string, headersHandler?: () => {[header: string]: string}): Promise<ListMeetingTagsResponse> {
			return Axios.get<ListMeetingTagsResponse>(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/tags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListTagsForResource(arn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.get<ListTagsForResourceResponse>(this.baseUri + '/tags#arn?arn=' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListVoiceConnectorTerminationCredentials(voiceConnectorId: string, headersHandler?: () => {[header: string]: string}): Promise<ListVoiceConnectorTerminationCredentialsResponse> {
			return Axios.get<ListVoiceConnectorTerminationCredentialsResponse>(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination/credentials', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		LogoutUser(accountId: string, userId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '#operation=logout&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		PutVoiceConnectorTerminationCredentials(voiceConnectorId: string, operation: string, requestBody: PutVoiceConnectorTerminationCredentialsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/voice-connectors/' + (voiceConnectorId == null ? '' : encodeURIComponent(voiceConnectorId)) + '/termination/credentials#operation=put&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ResetPersonalPIN(accountId: string, userId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<ResetPersonalPINResponse> {
			return Axios.post<ResetPersonalPINResponse>(this.baseUri + '/accounts/' + (accountId == null ? '' : encodeURIComponent(accountId)) + '/users/' + (userId == null ? '' : encodeURIComponent(userId)) + '#operation=reset-personal-pin&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RestorePhoneNumber(phoneNumberId: string, operation: string, headersHandler?: () => {[header: string]: string}): Promise<RestorePhoneNumberResponse> {
			return Axios.post<RestorePhoneNumberResponse>(this.baseUri + '/phone-numbers/' + (phoneNumberId == null ? '' : encodeURIComponent(phoneNumberId)) + '#operation=restore&operation=' + (operation == null ? '' : encodeURIComponent(operation)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		TagAttendee(meetingId: string, attendeeId: string, operation: string, requestBody: TagAttendeeBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)) + '/tags#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		TagMeeting(meetingId: string, operation: string, requestBody: TagMeetingBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/tags#operation=add&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		TagResource(operation: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/tags#operation=tag-resource?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UntagAttendee(meetingId: string, attendeeId: string, operation: string, requestBody: UntagAttendeeBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/attendees/' + (attendeeId == null ? '' : encodeURIComponent(attendeeId)) + '/tags#operation=delete&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UntagMeeting(meetingId: string, operation: string, requestBody: UntagMeetingBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/meetings/' + (meetingId == null ? '' : encodeURIComponent(meetingId)) + '/tags#operation=delete&operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(operation: string, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/tags#operation=untag-resource?operation=' + (operation == null ? '' : encodeURIComponent(operation)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
