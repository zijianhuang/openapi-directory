...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateAccessPoint(callback: (data : AccessPointDescription) => any, requestBody: CreateAccessPointBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-02-01/access-points', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAccessPoints(MaxResults: number, NextToken: string, AccessPointId: string, FileSystemId: string, callback: (data : DescribeAccessPointsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/access-points?MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&AccessPointId=' + (AccessPointId == null ? '' : encodeURIComponent(AccessPointId)) + '&FileSystemId=' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateFileSystem(callback: (data : void) => any, requestBody: CreateFileSystemBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-02-01/file-systems', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeFileSystems(MaxItems: number, Marker: string, CreationToken: string, FileSystemId: string, callback: (data : DescribeFileSystemsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/file-systems?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&CreationToken=' + (CreationToken == null ? '' : encodeURIComponent(CreationToken)) + '&FileSystemId=' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateMountTarget(callback: (data : MountTargetDescription) => any, requestBody: CreateMountTargetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-02-01/mount-targets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMountTargets(MaxItems: number, Marker: string, FileSystemId: string, MountTargetId: string, AccessPointId: string, callback: (data : DescribeMountTargetsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/mount-targets?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&FileSystemId=' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '&MountTargetId=' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '&AccessPointId=' + (AccessPointId == null ? '' : encodeURIComponent(AccessPointId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateTags(FileSystemId: string, callback: (data : void) => any, requestBody: CreateTagsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-02-01/create-tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteAccessPoint(AccessPointId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-02-01/access-points/' + (AccessPointId == null ? '' : encodeURIComponent(AccessPointId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFileSystem(FileSystemId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UpdateFileSystem(FileSystemId: string, callback: (data : void) => any, requestBody: UpdateFileSystemBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteFileSystemPolicy(FileSystemId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeFileSystemPolicy(FileSystemId: string, callback: (data : FileSystemPolicyDescription) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {FileSystemPolicyDescription} Success
		 */
		PutFileSystemPolicy(FileSystemId: string, callback: (data : FileSystemPolicyDescription) => any, requestBody: PutFileSystemPolicyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteMountTarget(MountTargetId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteTags(FileSystemId: string, callback: (data : void) => any, requestBody: DeleteTagsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-02-01/delete-tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeLifecycleConfiguration(FileSystemId: string, callback: (data : LifecycleConfigurationDescription) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/lifecycle-configuration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {LifecycleConfigurationDescription} Success
		 */
		PutLifecycleConfiguration(FileSystemId: string, callback: (data : LifecycleConfigurationDescription) => any, requestBody: PutLifecycleConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/lifecycle-configuration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMountTargetSecurityGroups(MountTargetId: string, callback: (data : DescribeMountTargetSecurityGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '/security-groups', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		ModifyMountTargetSecurityGroups(MountTargetId: string, callback: (data : void) => any, requestBody: ModifyMountTargetSecurityGroupsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '/security-groups', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTags(MaxItems: number, Marker: string, FileSystemId: string, callback: (data : DescribeTagsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListTagsForResource(ResourceId: string, MaxResults: number, NextToken: string, callback: (data : ListTagsForResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		TagResource(ResourceId: string, callback: (data : void) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		UntagResource(ResourceId: string, tagKeys: Array<TagKey>, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
	}
