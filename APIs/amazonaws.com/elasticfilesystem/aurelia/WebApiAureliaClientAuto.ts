...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateAccessPoint(requestBody: CreateAccessPointBody, headersHandler?: () => {[header: string]: string}): Promise<AccessPointDescription> {
			return this.http.post('/2015-02-01/access-points', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateFileSystem(requestBody: CreateFileSystemBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-02-01/file-systems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeFileSystems(MaxItems: number, Marker: string, CreationToken: string, FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeFileSystemsResponse> {
			return this.http.get('/2015-02-01/file-systems?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&CreationToken=' + (CreationToken == null ? '' : encodeURIComponent(CreationToken)) + '&FileSystemId=' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateMountTarget(requestBody: CreateMountTargetBody, headersHandler?: () => {[header: string]: string}): Promise<MountTargetDescription> {
			return this.http.post('/2015-02-01/mount-targets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateTags(FileSystemId: string, requestBody: CreateTagsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-02-01/create-tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAccessPoint(AccessPointId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-02-01/access-points/' + (AccessPointId == null ? '' : encodeURIComponent(AccessPointId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFileSystem(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		UpdateFileSystem(FileSystemId: string, requestBody: UpdateFileSystemBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteFileSystemPolicy(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeFileSystemPolicy(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<FileSystemPolicyDescription> {
			return this.http.get('/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutFileSystemPolicy(FileSystemId: string, requestBody: PutFileSystemPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<FileSystemPolicyDescription> {
			return this.http.put('/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteMountTarget(MountTargetId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteTags(FileSystemId: string, requestBody: DeleteTagsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-02-01/delete-tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeLifecycleConfiguration(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<LifecycleConfigurationDescription> {
			return this.http.get('/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/lifecycle-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutLifecycleConfiguration(FileSystemId: string, requestBody: PutLifecycleConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<LifecycleConfigurationDescription> {
			return this.http.put('/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/lifecycle-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMountTargetSecurityGroups(MountTargetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMountTargetSecurityGroupsResponse> {
			return this.http.get('/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '/security-groups', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		ModifyMountTargetSecurityGroups(MountTargetId: string, requestBody: ModifyMountTargetSecurityGroupsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '/security-groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeTags(MaxItems: number, Marker: string, FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResponse> {
			return this.http.get('/2015-02-01/tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(ResourceId: string, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.get('/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		TagResource(ResourceId: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} Success
		 */
		UntagResource(ResourceId: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
