...
export namespace My_Demo_Client {
	...
	export interface FileSystemDescription {
		...
		FileSystemId: string;
		CreationTime: Date;
		LifeCycleState: FileSystemDescriptionLifeCycleState;
		Name?: string;
	...
	export enum FileSystemDescriptionLifeCycleState { creating = 0, available = 1, updating = 2, deleting = 3, deleted = 4 }
	...
	export interface MountTargetDescription {
		...
		FileSystemId: string;
		SubnetId: string;
		LifeCycleState: MountTargetDescriptionLifeCycleState;
		IpAddress?: string;
	...
	export enum MountTargetDescriptionLifeCycleState { creating = 0, available = 1, updating = 2, deleting = 3, deleted = 4 }
	...
	export interface CreateFileSystemRequest {
		CreationToken: string;
		PerformanceMode?: CreateFileSystemRequestPerformanceMode;
		Encrypted?: boolean;
		KmsKeyId?: string;
		ThroughputMode?: CreateFileSystemRequestThroughputMode;
		ProvisionedThroughputInMibps?: number;
		Tags?: Array<Tag>;
	}

	export enum CreateFileSystemRequestPerformanceMode { generalPurpose = 0, maxIO = 1 }

	export enum CreateFileSystemRequestThroughputMode { bursting = 0, provisioned = 1 }
	...
	export interface UpdateFileSystemRequest {
		ThroughputMode?: UpdateFileSystemRequestThroughputMode;
		ProvisionedThroughputInMibps?: number;
	}

	export enum UpdateFileSystemRequestThroughputMode { bursting = 0, provisioned = 1 }
	...
	export class DemoClient {
		 ...
		 */
		CreateAccessPoint(requestBody: CreateAccessPointBody, headersHandler?: () => {[header: string]: string}): Promise<AccessPointDescription> {
			return Axios.post<AccessPointDescription>(this.baseUri + '/2015-02-01/access-points', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeAccessPoints(MaxResults: number, NextToken: string, AccessPointId: string, FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccessPointsResponse> {
			return Axios.get<DescribeAccessPointsResponse>(this.baseUri + '/2015-02-01/access-points?MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&AccessPointId=' + (AccessPointId == null ? '' : encodeURIComponent(AccessPointId)) + '&FileSystemId=' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateFileSystem(requestBody: CreateFileSystemBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-02-01/file-systems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeFileSystems(MaxItems: number, Marker: string, CreationToken: string, FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeFileSystemsResponse> {
			return Axios.get<DescribeFileSystemsResponse>(this.baseUri + '/2015-02-01/file-systems?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&CreationToken=' + (CreationToken == null ? '' : encodeURIComponent(CreationToken)) + '&FileSystemId=' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateMountTarget(requestBody: CreateMountTargetBody, headersHandler?: () => {[header: string]: string}): Promise<MountTargetDescription> {
			return Axios.post<MountTargetDescription>(this.baseUri + '/2015-02-01/mount-targets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeMountTargets(MaxItems: number, Marker: string, FileSystemId: string, MountTargetId: string, AccessPointId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMountTargetsResponse> {
			return Axios.get<DescribeMountTargetsResponse>(this.baseUri + '/2015-02-01/mount-targets?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&FileSystemId=' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '&MountTargetId=' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '&AccessPointId=' + (AccessPointId == null ? '' : encodeURIComponent(AccessPointId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateTags(FileSystemId: string, requestBody: CreateTagsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-02-01/create-tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAccessPoint(AccessPointId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-02-01/access-points/' + (AccessPointId == null ? '' : encodeURIComponent(AccessPointId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFileSystem(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateFileSystem(FileSystemId: string, requestBody: UpdateFileSystemBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteFileSystemPolicy(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 */
		DescribeFileSystemPolicy(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<FileSystemPolicyDescription> {
			return Axios.get<FileSystemPolicyDescription>(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {FileSystemPolicyDescription} Success
		 */
		PutFileSystemPolicy(FileSystemId: string, requestBody: PutFileSystemPolicyBody, headersHandler?: () => {[header: string]: string}): Promise<FileSystemPolicyDescription> {
			return Axios.put<FileSystemPolicyDescription>(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/policy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteMountTarget(MountTargetId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteTags(FileSystemId: string, requestBody: DeleteTagsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-02-01/delete-tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeLifecycleConfiguration(FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<LifecycleConfigurationDescription> {
			return Axios.get<LifecycleConfigurationDescription>(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/lifecycle-configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {LifecycleConfigurationDescription} Success
		 */
		PutLifecycleConfiguration(FileSystemId: string, requestBody: PutLifecycleConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<LifecycleConfigurationDescription> {
			return Axios.put<LifecycleConfigurationDescription>(this.baseUri + '/2015-02-01/file-systems/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/lifecycle-configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeMountTargetSecurityGroups(MountTargetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeMountTargetSecurityGroupsResponse> {
			return Axios.get<DescribeMountTargetSecurityGroupsResponse>(this.baseUri + '/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '/security-groups', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		ModifyMountTargetSecurityGroups(MountTargetId: string, requestBody: ModifyMountTargetSecurityGroupsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/2015-02-01/mount-targets/' + (MountTargetId == null ? '' : encodeURIComponent(MountTargetId)) + '/security-groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		DescribeTags(MaxItems: number, Marker: string, FileSystemId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResponse> {
			return Axios.get<DescribeTagsResponse>(this.baseUri + '/2015-02-01/tags/' + (FileSystemId == null ? '' : encodeURIComponent(FileSystemId)) + '/?MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListTagsForResource(ResourceId: string, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.get<ListTagsForResourceResponse>(this.baseUri + '/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		TagResource(ResourceId: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @param {Array<TagKey>} tagKeys The keys of the key:value tag pairs that you want to remove from the specified EFS resource.
		 * @return {void} Success
		 */
		UntagResource(ResourceId: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/2015-02-01/resource-tags/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
	}
	...
	export interface CreateFileSystemBody {
		...
		PerformanceMode?: CreateFileSystemBodyPerformanceMode;
		...
		ThroughputMode?: CreateFileSystemBodyThroughputMode;
	...
	export enum CreateFileSystemBodyPerformanceMode { generalPurpose = 0, maxIO = 1 }

	export enum CreateFileSystemBodyThroughputMode { bursting = 0, provisioned = 1 }

	export interface CreateMountTargetBody {
	...
	export interface UpdateFileSystemBody {
		...
		ThroughputMode?: UpdateFileSystemBodyThroughputMode;
	...
	export enum UpdateFileSystemBodyThroughputMode { bursting = 0, provisioned = 1 }

	export interface PutFileSystemPolicyBody {
	...
	export interface PutLifecycleConfigurationBody {
	...
	export interface ModifyMountTargetSecurityGroupsBody {
