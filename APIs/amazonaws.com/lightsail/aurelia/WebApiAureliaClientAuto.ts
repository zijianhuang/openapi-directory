...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AllocateStaticIp(requestBody: AllocateStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AllocateStaticIpResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.AllocateStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AttachDisk(requestBody: AttachDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachDiskResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.AttachDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AttachInstancesToLoadBalancer(requestBody: AttachInstancesToLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachInstancesToLoadBalancerResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.AttachInstancesToLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AttachLoadBalancerTlsCertificate(requestBody: AttachLoadBalancerTlsCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachLoadBalancerTlsCertificateResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.AttachLoadBalancerTlsCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AttachStaticIp(requestBody: AttachStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachStaticIpResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.AttachStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CloseInstancePublicPorts(requestBody: CloseInstancePublicPortsRequest, headersHandler?: () => {[header: string]: string}): Promise<CloseInstancePublicPortsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CloseInstancePublicPorts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CopySnapshot(requestBody: CopySnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CopySnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CopySnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateCloudFormationStack(requestBody: CreateCloudFormationStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCloudFormationStackResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateCloudFormationStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateContactMethod(requestBody: CreateContactMethodRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateContactMethodResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateContactMethod', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDisk(requestBody: CreateDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDiskResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDiskFromSnapshot(requestBody: CreateDiskFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDiskFromSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateDiskFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDiskSnapshot(requestBody: CreateDiskSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDiskSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateDiskSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDomain(requestBody: CreateDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDomainEntry(requestBody: CreateDomainEntryRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainEntryResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateDomainEntry', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateInstanceSnapshot(requestBody: CreateInstanceSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstanceSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateInstanceSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateInstances(requestBody: CreateInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstancesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateInstancesFromSnapshot(requestBody: CreateInstancesFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstancesFromSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateInstancesFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateKeyPair(requestBody: CreateKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateKeyPairResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLoadBalancer(requestBody: CreateLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLoadBalancerResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLoadBalancerTlsCertificate(requestBody: CreateLoadBalancerTlsCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLoadBalancerTlsCertificateResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateLoadBalancerTlsCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateRelationalDatabase(requestBody: CreateRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRelationalDatabaseResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateRelationalDatabaseFromSnapshot(requestBody: CreateRelationalDatabaseFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRelationalDatabaseFromSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateRelationalDatabaseFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateRelationalDatabaseSnapshot(requestBody: CreateRelationalDatabaseSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRelationalDatabaseSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.CreateRelationalDatabaseSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAlarm(requestBody: DeleteAlarmRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAlarmResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteAlarm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAutoSnapshot(requestBody: DeleteAutoSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAutoSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteAutoSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteContactMethod(requestBody: DeleteContactMethodRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteContactMethodResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteContactMethod', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDisk(requestBody: DeleteDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDiskResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDiskSnapshot(requestBody: DeleteDiskSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDiskSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteDiskSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDomain(requestBody: DeleteDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDomainEntry(requestBody: DeleteDomainEntryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainEntryResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteDomainEntry', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInstance(requestBody: DeleteInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInstanceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInstanceSnapshot(requestBody: DeleteInstanceSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInstanceSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteInstanceSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteKeyPair(requestBody: DeleteKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteKeyPairResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteKnownHostKeys(requestBody: DeleteKnownHostKeysRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteKnownHostKeysResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteKnownHostKeys', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLoadBalancer(requestBody: DeleteLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLoadBalancerResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLoadBalancerTlsCertificate(requestBody: DeleteLoadBalancerTlsCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLoadBalancerTlsCertificateResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteLoadBalancerTlsCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRelationalDatabase(requestBody: DeleteRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRelationalDatabaseResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRelationalDatabaseSnapshot(requestBody: DeleteRelationalDatabaseSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRelationalDatabaseSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DeleteRelationalDatabaseSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DetachDisk(requestBody: DetachDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<DetachDiskResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DetachDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DetachInstancesFromLoadBalancer(requestBody: DetachInstancesFromLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<DetachInstancesFromLoadBalancerResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DetachInstancesFromLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DetachStaticIp(requestBody: DetachStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<DetachStaticIpResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DetachStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableAddOn(requestBody: DisableAddOnRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableAddOnResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DisableAddOn', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DownloadDefaultKeyPair(requestBody: DownloadDefaultKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<DownloadDefaultKeyPairResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.DownloadDefaultKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableAddOn(requestBody: EnableAddOnRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableAddOnResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.EnableAddOn', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ExportSnapshot(requestBody: ExportSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<ExportSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.ExportSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetActiveNames(requestBody: GetActiveNamesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetActiveNamesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetActiveNames', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAlarms(requestBody: GetAlarmsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAlarmsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetAlarms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAutoSnapshots(requestBody: GetAutoSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAutoSnapshotsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetAutoSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetBlueprints(requestBody: GetBlueprintsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetBlueprintsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetBlueprints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetBundles(requestBody: GetBundlesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetBundlesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetBundles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCloudFormationStackRecords(requestBody: GetCloudFormationStackRecordsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCloudFormationStackRecordsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetCloudFormationStackRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetContactMethods(requestBody: GetContactMethodsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetContactMethodsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetContactMethods', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDisk(requestBody: GetDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiskResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDiskSnapshot(requestBody: GetDiskSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiskSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetDiskSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDiskSnapshots(requestBody: GetDiskSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiskSnapshotsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetDiskSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDisks(requestBody: GetDisksRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDisksResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetDisks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDomain(requestBody: GetDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDomains(requestBody: GetDomainsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetDomains', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetExportSnapshotRecords(requestBody: GetExportSnapshotRecordsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetExportSnapshotRecordsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetExportSnapshotRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstance(requestBody: GetInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstanceAccessDetails(requestBody: GetInstanceAccessDetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceAccessDetailsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstanceAccessDetails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstanceMetricData(requestBody: GetInstanceMetricDataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceMetricDataResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstanceMetricData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstancePortStates(requestBody: GetInstancePortStatesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstancePortStatesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstancePortStates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstanceSnapshot(requestBody: GetInstanceSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstanceSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstanceSnapshots(requestBody: GetInstanceSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceSnapshotsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstanceSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstanceState(requestBody: GetInstanceStateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceStateResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstanceState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstances(requestBody: GetInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstancesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetKeyPair(requestBody: GetKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyPairResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetKeyPairs(requestBody: GetKeyPairsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyPairsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetKeyPairs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLoadBalancer(requestBody: GetLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancerResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLoadBalancerMetricData(requestBody: GetLoadBalancerMetricDataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancerMetricDataResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetLoadBalancerMetricData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLoadBalancerTlsCertificates(requestBody: GetLoadBalancerTlsCertificatesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancerTlsCertificatesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetLoadBalancerTlsCertificates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLoadBalancers(requestBody: GetLoadBalancersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancersResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetLoadBalancers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOperation(requestBody: GetOperationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetOperation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOperations(requestBody: GetOperationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetOperations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOperationsForResource(requestBody: GetOperationsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationsForResourceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetOperationsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRegions(requestBody: GetRegionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRegionsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRegions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabase(requestBody: GetRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseBlueprints(requestBody: GetRelationalDatabaseBlueprintsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseBlueprintsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseBlueprints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseBundles(requestBody: GetRelationalDatabaseBundlesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseBundlesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseBundles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseEvents(requestBody: GetRelationalDatabaseEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseEventsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseLogEvents(requestBody: GetRelationalDatabaseLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseLogEventsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseLogEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseLogStreams(requestBody: GetRelationalDatabaseLogStreamsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseLogStreamsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseLogStreams', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseMasterUserPassword(requestBody: GetRelationalDatabaseMasterUserPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseMasterUserPasswordResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseMasterUserPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseMetricData(requestBody: GetRelationalDatabaseMetricDataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseMetricDataResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseMetricData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseParameters(requestBody: GetRelationalDatabaseParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseParametersResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseSnapshot(requestBody: GetRelationalDatabaseSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseSnapshotResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabaseSnapshots(requestBody: GetRelationalDatabaseSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseSnapshotsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRelationalDatabases(requestBody: GetRelationalDatabasesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabasesResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetStaticIp(requestBody: GetStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<GetStaticIpResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetStaticIps(requestBody: GetStaticIpsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetStaticIpsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.GetStaticIps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ImportKeyPair(requestBody: ImportKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportKeyPairResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.ImportKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		IsVpcPeered(requestBody: IsVpcPeeredRequest, headersHandler?: () => {[header: string]: string}): Promise<IsVpcPeeredResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.IsVpcPeered', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		OpenInstancePublicPorts(requestBody: OpenInstancePublicPortsRequest, headersHandler?: () => {[header: string]: string}): Promise<OpenInstancePublicPortsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.OpenInstancePublicPorts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PeerVpc(requestBody: PeerVpcRequest, headersHandler?: () => {[header: string]: string}): Promise<PeerVpcResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.PeerVpc', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutAlarm(requestBody: PutAlarmRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAlarmResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.PutAlarm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutInstancePublicPorts(requestBody: PutInstancePublicPortsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutInstancePublicPortsResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.PutInstancePublicPorts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RebootInstance(requestBody: RebootInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootInstanceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.RebootInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RebootRelationalDatabase(requestBody: RebootRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootRelationalDatabaseResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.RebootRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ReleaseStaticIp(requestBody: ReleaseStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<ReleaseStaticIpResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.ReleaseStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendContactMethodVerification(requestBody: SendContactMethodVerificationRequest, headersHandler?: () => {[header: string]: string}): Promise<SendContactMethodVerificationResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.SendContactMethodVerification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartInstance(requestBody: StartInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<StartInstanceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.StartInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartRelationalDatabase(requestBody: StartRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<StartRelationalDatabaseResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.StartRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopInstance(requestBody: StopInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<StopInstanceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.StopInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopRelationalDatabase(requestBody: StopRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRelationalDatabaseResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.StopRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TestAlarm(requestBody: TestAlarmRequest, headersHandler?: () => {[header: string]: string}): Promise<TestAlarmResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.TestAlarm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UnpeerVpc(requestBody: UnpeerVpcRequest, headersHandler?: () => {[header: string]: string}): Promise<UnpeerVpcResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.UnpeerVpc', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDomainEntry(requestBody: UpdateDomainEntryRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainEntryResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.UpdateDomainEntry', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateLoadBalancerAttribute(requestBody: UpdateLoadBalancerAttributeRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateLoadBalancerAttributeResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.UpdateLoadBalancerAttribute', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateRelationalDatabase(requestBody: UpdateRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRelationalDatabaseResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.UpdateRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateRelationalDatabaseParameters(requestBody: UpdateRelationalDatabaseParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRelationalDatabaseParametersResult> {
			return this.http.post('/#X-Amz-Target=Lightsail_20161128.UpdateRelationalDatabaseParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
