...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AllocateStaticIp(requestBody: AllocateStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AllocateStaticIpResult> {
			return Axios.post<AllocateStaticIpResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.AllocateStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AttachDisk(requestBody: AttachDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachDiskResult> {
			return Axios.post<AttachDiskResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.AttachDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AttachInstancesToLoadBalancer(requestBody: AttachInstancesToLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachInstancesToLoadBalancerResult> {
			return Axios.post<AttachInstancesToLoadBalancerResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.AttachInstancesToLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AttachLoadBalancerTlsCertificate(requestBody: AttachLoadBalancerTlsCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachLoadBalancerTlsCertificateResult> {
			return Axios.post<AttachLoadBalancerTlsCertificateResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.AttachLoadBalancerTlsCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AttachStaticIp(requestBody: AttachStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<AttachStaticIpResult> {
			return Axios.post<AttachStaticIpResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.AttachStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CloseInstancePublicPorts(requestBody: CloseInstancePublicPortsRequest, headersHandler?: () => {[header: string]: string}): Promise<CloseInstancePublicPortsResult> {
			return Axios.post<CloseInstancePublicPortsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CloseInstancePublicPorts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CopySnapshot(requestBody: CopySnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CopySnapshotResult> {
			return Axios.post<CopySnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CopySnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateCloudFormationStack(requestBody: CreateCloudFormationStackRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCloudFormationStackResult> {
			return Axios.post<CreateCloudFormationStackResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateCloudFormationStack', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateContactMethod(requestBody: CreateContactMethodRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateContactMethodResult> {
			return Axios.post<CreateContactMethodResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateContactMethod', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDisk(requestBody: CreateDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDiskResult> {
			return Axios.post<CreateDiskResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDiskFromSnapshot(requestBody: CreateDiskFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDiskFromSnapshotResult> {
			return Axios.post<CreateDiskFromSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateDiskFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDiskSnapshot(requestBody: CreateDiskSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDiskSnapshotResult> {
			return Axios.post<CreateDiskSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateDiskSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDomain(requestBody: CreateDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainResult> {
			return Axios.post<CreateDomainResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDomainEntry(requestBody: CreateDomainEntryRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDomainEntryResult> {
			return Axios.post<CreateDomainEntryResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateDomainEntry', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateInstanceSnapshot(requestBody: CreateInstanceSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstanceSnapshotResult> {
			return Axios.post<CreateInstanceSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateInstanceSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateInstances(requestBody: CreateInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstancesResult> {
			return Axios.post<CreateInstancesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateInstancesFromSnapshot(requestBody: CreateInstancesFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstancesFromSnapshotResult> {
			return Axios.post<CreateInstancesFromSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateInstancesFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateKeyPair(requestBody: CreateKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateKeyPairResult> {
			return Axios.post<CreateKeyPairResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateLoadBalancer(requestBody: CreateLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLoadBalancerResult> {
			return Axios.post<CreateLoadBalancerResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRelationalDatabase(requestBody: CreateRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRelationalDatabaseResult> {
			return Axios.post<CreateRelationalDatabaseResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRelationalDatabaseFromSnapshot(requestBody: CreateRelationalDatabaseFromSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRelationalDatabaseFromSnapshotResult> {
			return Axios.post<CreateRelationalDatabaseFromSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.CreateRelationalDatabaseFromSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteAlarm(requestBody: DeleteAlarmRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAlarmResult> {
			return Axios.post<DeleteAlarmResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteAlarm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteAutoSnapshot(requestBody: DeleteAutoSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAutoSnapshotResult> {
			return Axios.post<DeleteAutoSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteAutoSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteContactMethod(requestBody: DeleteContactMethodRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteContactMethodResult> {
			return Axios.post<DeleteContactMethodResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteContactMethod', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDisk(requestBody: DeleteDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDiskResult> {
			return Axios.post<DeleteDiskResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDiskSnapshot(requestBody: DeleteDiskSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDiskSnapshotResult> {
			return Axios.post<DeleteDiskSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteDiskSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDomain(requestBody: DeleteDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainResult> {
			return Axios.post<DeleteDomainResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDomainEntry(requestBody: DeleteDomainEntryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDomainEntryResult> {
			return Axios.post<DeleteDomainEntryResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteDomainEntry', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteInstance(requestBody: DeleteInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInstanceResult> {
			return Axios.post<DeleteInstanceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteInstanceSnapshot(requestBody: DeleteInstanceSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInstanceSnapshotResult> {
			return Axios.post<DeleteInstanceSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteInstanceSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteKeyPair(requestBody: DeleteKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteKeyPairResult> {
			return Axios.post<DeleteKeyPairResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteKnownHostKeys(requestBody: DeleteKnownHostKeysRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteKnownHostKeysResult> {
			return Axios.post<DeleteKnownHostKeysResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteKnownHostKeys', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteLoadBalancer(requestBody: DeleteLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLoadBalancerResult> {
			return Axios.post<DeleteLoadBalancerResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteLoadBalancerTlsCertificate(requestBody: DeleteLoadBalancerTlsCertificateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLoadBalancerTlsCertificateResult> {
			return Axios.post<DeleteLoadBalancerTlsCertificateResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteLoadBalancerTlsCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRelationalDatabase(requestBody: DeleteRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRelationalDatabaseResult> {
			return Axios.post<DeleteRelationalDatabaseResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRelationalDatabaseSnapshot(requestBody: DeleteRelationalDatabaseSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRelationalDatabaseSnapshotResult> {
			return Axios.post<DeleteRelationalDatabaseSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DeleteRelationalDatabaseSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetachDisk(requestBody: DetachDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<DetachDiskResult> {
			return Axios.post<DetachDiskResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DetachDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetachInstancesFromLoadBalancer(requestBody: DetachInstancesFromLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<DetachInstancesFromLoadBalancerResult> {
			return Axios.post<DetachInstancesFromLoadBalancerResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DetachInstancesFromLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetachStaticIp(requestBody: DetachStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<DetachStaticIpResult> {
			return Axios.post<DetachStaticIpResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DetachStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableAddOn(requestBody: DisableAddOnRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableAddOnResult> {
			return Axios.post<DisableAddOnResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DisableAddOn', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DownloadDefaultKeyPair(requestBody: DownloadDefaultKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<DownloadDefaultKeyPairResult> {
			return Axios.post<DownloadDefaultKeyPairResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.DownloadDefaultKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableAddOn(requestBody: EnableAddOnRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableAddOnResult> {
			return Axios.post<EnableAddOnResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.EnableAddOn', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ExportSnapshot(requestBody: ExportSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<ExportSnapshotResult> {
			return Axios.post<ExportSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.ExportSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetActiveNames(requestBody: GetActiveNamesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetActiveNamesResult> {
			return Axios.post<GetActiveNamesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetActiveNames', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAlarms(requestBody: GetAlarmsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAlarmsResult> {
			return Axios.post<GetAlarmsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetAlarms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAutoSnapshots(requestBody: GetAutoSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAutoSnapshotsResult> {
			return Axios.post<GetAutoSnapshotsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetAutoSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetBlueprints(requestBody: GetBlueprintsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetBlueprintsResult> {
			return Axios.post<GetBlueprintsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetBlueprints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetBundles(requestBody: GetBundlesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetBundlesResult> {
			return Axios.post<GetBundlesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetBundles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCloudFormationStackRecords(requestBody: GetCloudFormationStackRecordsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCloudFormationStackRecordsResult> {
			return Axios.post<GetCloudFormationStackRecordsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetCloudFormationStackRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetContactMethods(requestBody: GetContactMethodsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetContactMethodsResult> {
			return Axios.post<GetContactMethodsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetContactMethods', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDisk(requestBody: GetDiskRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiskResult> {
			return Axios.post<GetDiskResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetDisk', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDiskSnapshot(requestBody: GetDiskSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiskSnapshotResult> {
			return Axios.post<GetDiskSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetDiskSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDiskSnapshots(requestBody: GetDiskSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDiskSnapshotsResult> {
			return Axios.post<GetDiskSnapshotsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetDiskSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDisks(requestBody: GetDisksRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDisksResult> {
			return Axios.post<GetDisksResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetDisks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDomain(requestBody: GetDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainResult> {
			return Axios.post<GetDomainResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDomains(requestBody: GetDomainsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainsResult> {
			return Axios.post<GetDomainsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetDomains', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetExportSnapshotRecords(requestBody: GetExportSnapshotRecordsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetExportSnapshotRecordsResult> {
			return Axios.post<GetExportSnapshotRecordsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetExportSnapshotRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstance(requestBody: GetInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceResult> {
			return Axios.post<GetInstanceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstanceAccessDetails(requestBody: GetInstanceAccessDetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceAccessDetailsResult> {
			return Axios.post<GetInstanceAccessDetailsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstanceAccessDetails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstanceMetricData(requestBody: GetInstanceMetricDataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceMetricDataResult> {
			return Axios.post<GetInstanceMetricDataResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstanceMetricData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstancePortStates(requestBody: GetInstancePortStatesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstancePortStatesResult> {
			return Axios.post<GetInstancePortStatesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstancePortStates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstanceSnapshot(requestBody: GetInstanceSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceSnapshotResult> {
			return Axios.post<GetInstanceSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstanceSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstanceSnapshots(requestBody: GetInstanceSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceSnapshotsResult> {
			return Axios.post<GetInstanceSnapshotsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstanceSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstanceState(requestBody: GetInstanceStateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceStateResult> {
			return Axios.post<GetInstanceStateResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstanceState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstances(requestBody: GetInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstancesResult> {
			return Axios.post<GetInstancesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetKeyPair(requestBody: GetKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyPairResult> {
			return Axios.post<GetKeyPairResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetKeyPairs(requestBody: GetKeyPairsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetKeyPairsResult> {
			return Axios.post<GetKeyPairsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetKeyPairs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetLoadBalancer(requestBody: GetLoadBalancerRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancerResult> {
			return Axios.post<GetLoadBalancerResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetLoadBalancer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetLoadBalancerMetricData(requestBody: GetLoadBalancerMetricDataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancerMetricDataResult> {
			return Axios.post<GetLoadBalancerMetricDataResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetLoadBalancerMetricData', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetLoadBalancerTlsCertificates(requestBody: GetLoadBalancerTlsCertificatesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancerTlsCertificatesResult> {
			return Axios.post<GetLoadBalancerTlsCertificatesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetLoadBalancerTlsCertificates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetLoadBalancers(requestBody: GetLoadBalancersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLoadBalancersResult> {
			return Axios.post<GetLoadBalancersResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetLoadBalancers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOperation(requestBody: GetOperationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationResult> {
			return Axios.post<GetOperationResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetOperation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOperations(requestBody: GetOperationsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationsResult> {
			return Axios.post<GetOperationsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetOperations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOperationsForResource(requestBody: GetOperationsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationsForResourceResult> {
			return Axios.post<GetOperationsForResourceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetOperationsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRegions(requestBody: GetRegionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRegionsResult> {
			return Axios.post<GetRegionsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRegions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabase(requestBody: GetRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseResult> {
			return Axios.post<GetRelationalDatabaseResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabaseBundles(requestBody: GetRelationalDatabaseBundlesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseBundlesResult> {
			return Axios.post<GetRelationalDatabaseBundlesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseBundles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabaseEvents(requestBody: GetRelationalDatabaseEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseEventsResult> {
			return Axios.post<GetRelationalDatabaseEventsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabaseLogEvents(requestBody: GetRelationalDatabaseLogEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseLogEventsResult> {
			return Axios.post<GetRelationalDatabaseLogEventsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseLogEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabaseLogStreams(requestBody: GetRelationalDatabaseLogStreamsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseLogStreamsResult> {
			return Axios.post<GetRelationalDatabaseLogStreamsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseLogStreams', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabaseMasterUserPassword(requestBody: GetRelationalDatabaseMasterUserPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseMasterUserPasswordResult> {
			return Axios.post<GetRelationalDatabaseMasterUserPasswordResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseMasterUserPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabaseSnapshot(requestBody: GetRelationalDatabaseSnapshotRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseSnapshotResult> {
			return Axios.post<GetRelationalDatabaseSnapshotResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabaseSnapshots(requestBody: GetRelationalDatabaseSnapshotsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabaseSnapshotsResult> {
			return Axios.post<GetRelationalDatabaseSnapshotsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabaseSnapshots', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRelationalDatabases(requestBody: GetRelationalDatabasesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRelationalDatabasesResult> {
			return Axios.post<GetRelationalDatabasesResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetRelationalDatabases', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetStaticIp(requestBody: GetStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<GetStaticIpResult> {
			return Axios.post<GetStaticIpResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetStaticIps(requestBody: GetStaticIpsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetStaticIpsResult> {
			return Axios.post<GetStaticIpsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.GetStaticIps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ImportKeyPair(requestBody: ImportKeyPairRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportKeyPairResult> {
			return Axios.post<ImportKeyPairResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.ImportKeyPair', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		IsVpcPeered(requestBody: IsVpcPeeredRequest, headersHandler?: () => {[header: string]: string}): Promise<IsVpcPeeredResult> {
			return Axios.post<IsVpcPeeredResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.IsVpcPeered', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		OpenInstancePublicPorts(requestBody: OpenInstancePublicPortsRequest, headersHandler?: () => {[header: string]: string}): Promise<OpenInstancePublicPortsResult> {
			return Axios.post<OpenInstancePublicPortsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.OpenInstancePublicPorts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PeerVpc(requestBody: PeerVpcRequest, headersHandler?: () => {[header: string]: string}): Promise<PeerVpcResult> {
			return Axios.post<PeerVpcResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.PeerVpc', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutAlarm(requestBody: PutAlarmRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAlarmResult> {
			return Axios.post<PutAlarmResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.PutAlarm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutInstancePublicPorts(requestBody: PutInstancePublicPortsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutInstancePublicPortsResult> {
			return Axios.post<PutInstancePublicPortsResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.PutInstancePublicPorts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RebootInstance(requestBody: RebootInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootInstanceResult> {
			return Axios.post<RebootInstanceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.RebootInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RebootRelationalDatabase(requestBody: RebootRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootRelationalDatabaseResult> {
			return Axios.post<RebootRelationalDatabaseResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.RebootRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ReleaseStaticIp(requestBody: ReleaseStaticIpRequest, headersHandler?: () => {[header: string]: string}): Promise<ReleaseStaticIpResult> {
			return Axios.post<ReleaseStaticIpResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.ReleaseStaticIp', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendContactMethodVerification(requestBody: SendContactMethodVerificationRequest, headersHandler?: () => {[header: string]: string}): Promise<SendContactMethodVerificationResult> {
			return Axios.post<SendContactMethodVerificationResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.SendContactMethodVerification', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartInstance(requestBody: StartInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<StartInstanceResult> {
			return Axios.post<StartInstanceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.StartInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartRelationalDatabase(requestBody: StartRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<StartRelationalDatabaseResult> {
			return Axios.post<StartRelationalDatabaseResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.StartRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopInstance(requestBody: StopInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<StopInstanceResult> {
			return Axios.post<StopInstanceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.StopInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopRelationalDatabase(requestBody: StopRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRelationalDatabaseResult> {
			return Axios.post<StopRelationalDatabaseResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.StopRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResult> {
			return Axios.post<TagResourceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TestAlarm(requestBody: TestAlarmRequest, headersHandler?: () => {[header: string]: string}): Promise<TestAlarmResult> {
			return Axios.post<TestAlarmResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.TestAlarm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UnpeerVpc(requestBody: UnpeerVpcRequest, headersHandler?: () => {[header: string]: string}): Promise<UnpeerVpcResult> {
			return Axios.post<UnpeerVpcResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.UnpeerVpc', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResult> {
			return Axios.post<UntagResourceResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDomainEntry(requestBody: UpdateDomainEntryRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainEntryResult> {
			return Axios.post<UpdateDomainEntryResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.UpdateDomainEntry', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateLoadBalancerAttribute(requestBody: UpdateLoadBalancerAttributeRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateLoadBalancerAttributeResult> {
			return Axios.post<UpdateLoadBalancerAttributeResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.UpdateLoadBalancerAttribute', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRelationalDatabase(requestBody: UpdateRelationalDatabaseRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRelationalDatabaseResult> {
			return Axios.post<UpdateRelationalDatabaseResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.UpdateRelationalDatabase', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRelationalDatabaseParameters(requestBody: UpdateRelationalDatabaseParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRelationalDatabaseParametersResult> {
			return Axios.post<UpdateRelationalDatabaseParametersResult>(this.baseUri + '/#X-Amz-Target=Lightsail_20161128.UpdateRelationalDatabaseParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
