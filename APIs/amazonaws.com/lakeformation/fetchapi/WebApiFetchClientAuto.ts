export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchGrantPermissions(requestBody: BatchGrantPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGrantPermissionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.BatchGrantPermissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchRevokePermissions(requestBody: BatchRevokePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchRevokePermissionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.BatchRevokePermissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeregisterResource(requestBody: DeregisterResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.DeregisterResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeResource(requestBody: DescribeResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.DescribeResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDataLakeSettings(requestBody: GetDataLakeSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDataLakeSettingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.GetDataLakeSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GrantPermissions(requestBody: GrantPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GrantPermissionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.GrantPermissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPermissions(MaxResults: string, NextToken: string, requestBody: ListPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPermissionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.ListPermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListResources(MaxResults: string, NextToken: string, requestBody: ListResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourcesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.ListResources?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutDataLakeSettings(requestBody: PutDataLakeSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDataLakeSettingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.PutDataLakeSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterResource(requestBody: RegisterResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.RegisterResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RevokePermissions(requestBody: RevokePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<RevokePermissionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.RevokePermissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateResource(requestBody: UpdateResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSLakeFormation.UpdateResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
