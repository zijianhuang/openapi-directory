...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchGrantPermissions(requestBody: BatchGrantPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGrantPermissionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.BatchGrantPermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		BatchRevokePermissions(requestBody: BatchRevokePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchRevokePermissionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.BatchRevokePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterResource(requestBody: DeregisterResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.DeregisterResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeResource(requestBody: DescribeResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.DescribeResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDataLakeSettings(requestBody: GetDataLakeSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDataLakeSettingsResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.GetDataLakeSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GrantPermissions(requestBody: GrantPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GrantPermissionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.GrantPermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPermissions(MaxResults: string, NextToken: string, requestBody: ListPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPermissionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.ListPermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResources(MaxResults: string, NextToken: string, requestBody: ListResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourcesResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.ListResources?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutDataLakeSettings(requestBody: PutDataLakeSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDataLakeSettingsResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.PutDataLakeSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterResource(requestBody: RegisterResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.RegisterResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RevokePermissions(requestBody: RevokePermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<RevokePermissionsResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.RevokePermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateResource(requestBody: UpdateResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSLakeFormation.UpdateResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
