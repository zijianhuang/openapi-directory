...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddInstanceFleet(requestBody: AddInstanceFleetInput, headersHandler?: () => {[header: string]: string}): Promise<AddInstanceFleetOutput> {
			return Axios.post<AddInstanceFleetOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddInstanceFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddInstanceGroups(requestBody: AddInstanceGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<AddInstanceGroupsOutput> {
			return Axios.post<AddInstanceGroupsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddInstanceGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddJobFlowSteps(requestBody: AddJobFlowStepsInput, headersHandler?: () => {[header: string]: string}): Promise<AddJobFlowStepsOutput> {
			return Axios.post<AddJobFlowStepsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddJobFlowSteps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsOutput> {
			return Axios.post<AddTagsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelSteps(requestBody: CancelStepsInput, headersHandler?: () => {[header: string]: string}): Promise<CancelStepsOutput> {
			return Axios.post<CancelStepsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.CancelSteps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSecurityConfiguration(requestBody: CreateSecurityConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSecurityConfigurationOutput> {
			return Axios.post<CreateSecurityConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.CreateSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeCluster(requestBody: DescribeClusterInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterOutput> {
			return Axios.post<DescribeClusterOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeJobFlows(requestBody: DescribeJobFlowsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobFlowsOutput> {
			return Axios.post<DescribeJobFlowsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeJobFlows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSecurityConfiguration(requestBody: DescribeSecurityConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSecurityConfigurationOutput> {
			return Axios.post<DescribeSecurityConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeStep(requestBody: DescribeStepInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStepOutput> {
			return Axios.post<DescribeStepOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeStep', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetBlockPublicAccessConfiguration(requestBody: GetBlockPublicAccessConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<GetBlockPublicAccessConfigurationOutput> {
			return Axios.post<GetBlockPublicAccessConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.GetBlockPublicAccessConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetManagedScalingPolicy(requestBody: GetManagedScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetManagedScalingPolicyOutput> {
			return Axios.post<GetManagedScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.GetManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListBootstrapActions(Marker: string, requestBody: ListBootstrapActionsInput, headersHandler?: () => {[header: string]: string}): Promise<ListBootstrapActionsOutput> {
			return Axios.post<ListBootstrapActionsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListBootstrapActions?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListClusters(Marker: string, requestBody: ListClustersInput, headersHandler?: () => {[header: string]: string}): Promise<ListClustersOutput> {
			return Axios.post<ListClustersOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListClusters?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListInstanceFleets(Marker: string, requestBody: ListInstanceFleetsInput, headersHandler?: () => {[header: string]: string}): Promise<ListInstanceFleetsOutput> {
			return Axios.post<ListInstanceFleetsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListInstanceFleets?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListInstanceGroups(Marker: string, requestBody: ListInstanceGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListInstanceGroupsOutput> {
			return Axios.post<ListInstanceGroupsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListInstanceGroups?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListInstances(Marker: string, requestBody: ListInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<ListInstancesOutput> {
			return Axios.post<ListInstancesOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListInstances?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSecurityConfigurations(Marker: string, requestBody: ListSecurityConfigurationsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSecurityConfigurationsOutput> {
			return Axios.post<ListSecurityConfigurationsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListSecurityConfigurations?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSteps(Marker: string, requestBody: ListStepsInput, headersHandler?: () => {[header: string]: string}): Promise<ListStepsOutput> {
			return Axios.post<ListStepsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListSteps?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyCluster(requestBody: ModifyClusterInput, headersHandler?: () => {[header: string]: string}): Promise<ModifyClusterOutput> {
			return Axios.post<ModifyClusterOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ModifyCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		ModifyInstanceFleet(requestBody: ModifyInstanceFleetInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ModifyInstanceFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ModifyInstanceGroups(requestBody: ModifyInstanceGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ModifyInstanceGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		PutAutoScalingPolicy(requestBody: PutAutoScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutAutoScalingPolicyOutput> {
			return Axios.post<PutAutoScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.PutAutoScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutBlockPublicAccessConfiguration(requestBody: PutBlockPublicAccessConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<PutBlockPublicAccessConfigurationOutput> {
			return Axios.post<PutBlockPublicAccessConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.PutBlockPublicAccessConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutManagedScalingPolicy(requestBody: PutManagedScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutManagedScalingPolicyOutput> {
			return Axios.post<PutManagedScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.PutManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveAutoScalingPolicy(requestBody: RemoveAutoScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveAutoScalingPolicyOutput> {
			return Axios.post<RemoveAutoScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RemoveAutoScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveManagedScalingPolicy(requestBody: RemoveManagedScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveManagedScalingPolicyOutput> {
			return Axios.post<RemoveManagedScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RemoveManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveTags(requestBody: RemoveTagsInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsOutput> {
			return Axios.post<RemoveTagsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RunJobFlow(requestBody: RunJobFlowInput, headersHandler?: () => {[header: string]: string}): Promise<RunJobFlowOutput> {
			return Axios.post<RunJobFlowOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RunJobFlow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		SetTerminationProtection(requestBody: SetTerminationProtectionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.SetTerminationProtection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SetVisibleToAllUsers(requestBody: SetVisibleToAllUsersInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.SetVisibleToAllUsers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		TerminateJobFlows(requestBody: TerminateJobFlowsInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.TerminateJobFlows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
