...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddInstanceFleet(requestBody: AddInstanceFleetInput, headersHandler?: () => {[header: string]: string}): Promise<AddInstanceFleetOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.AddInstanceFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddInstanceGroups(requestBody: AddInstanceGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<AddInstanceGroupsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.AddInstanceGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddJobFlowSteps(requestBody: AddJobFlowStepsInput, headersHandler?: () => {[header: string]: string}): Promise<AddJobFlowStepsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.AddJobFlowSteps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelSteps(requestBody: CancelStepsInput, headersHandler?: () => {[header: string]: string}): Promise<CancelStepsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.CancelSteps', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSecurityConfiguration(requestBody: CreateSecurityConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSecurityConfigurationOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.CreateSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSecurityConfiguration(requestBody: DeleteSecurityConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteSecurityConfigurationOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.DeleteSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCluster(requestBody: DescribeClusterInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.DescribeCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeJobFlows(requestBody: DescribeJobFlowsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobFlowsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.DescribeJobFlows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSecurityConfiguration(requestBody: DescribeSecurityConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSecurityConfigurationOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.DescribeSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeStep(requestBody: DescribeStepInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStepOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.DescribeStep', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetBlockPublicAccessConfiguration(requestBody: GetBlockPublicAccessConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<GetBlockPublicAccessConfigurationOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.GetBlockPublicAccessConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetManagedScalingPolicy(requestBody: GetManagedScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetManagedScalingPolicyOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.GetManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListBootstrapActions(Marker: string, requestBody: ListBootstrapActionsInput, headersHandler?: () => {[header: string]: string}): Promise<ListBootstrapActionsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ListBootstrapActions?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListClusters(Marker: string, requestBody: ListClustersInput, headersHandler?: () => {[header: string]: string}): Promise<ListClustersOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ListClusters?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInstanceFleets(Marker: string, requestBody: ListInstanceFleetsInput, headersHandler?: () => {[header: string]: string}): Promise<ListInstanceFleetsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ListInstanceFleets?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInstanceGroups(Marker: string, requestBody: ListInstanceGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<ListInstanceGroupsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ListInstanceGroups?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInstances(Marker: string, requestBody: ListInstancesInput, headersHandler?: () => {[header: string]: string}): Promise<ListInstancesOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ListInstances?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListSecurityConfigurations(Marker: string, requestBody: ListSecurityConfigurationsInput, headersHandler?: () => {[header: string]: string}): Promise<ListSecurityConfigurationsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ListSecurityConfigurations?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListSteps(Marker: string, requestBody: ListStepsInput, headersHandler?: () => {[header: string]: string}): Promise<ListStepsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ListSteps?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyCluster(requestBody: ModifyClusterInput, headersHandler?: () => {[header: string]: string}): Promise<ModifyClusterOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ModifyCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyInstanceFleet(requestBody: ModifyInstanceFleetInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ModifyInstanceFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ModifyInstanceGroups(requestBody: ModifyInstanceGroupsInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.ModifyInstanceGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutAutoScalingPolicy(requestBody: PutAutoScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutAutoScalingPolicyOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.PutAutoScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutBlockPublicAccessConfiguration(requestBody: PutBlockPublicAccessConfigurationInput, headersHandler?: () => {[header: string]: string}): Promise<PutBlockPublicAccessConfigurationOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.PutBlockPublicAccessConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutManagedScalingPolicy(requestBody: PutManagedScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutManagedScalingPolicyOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.PutManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveAutoScalingPolicy(requestBody: RemoveAutoScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveAutoScalingPolicyOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.RemoveAutoScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveManagedScalingPolicy(requestBody: RemoveManagedScalingPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveManagedScalingPolicyOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.RemoveManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveTags(requestBody: RemoveTagsInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RunJobFlow(requestBody: RunJobFlowInput, headersHandler?: () => {[header: string]: string}): Promise<RunJobFlowOutput> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.RunJobFlow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SetTerminationProtection(requestBody: SetTerminationProtectionInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.SetTerminationProtection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		SetVisibleToAllUsers(requestBody: SetVisibleToAllUsersInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.SetVisibleToAllUsers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		TerminateJobFlows(requestBody: TerminateJobFlowsInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=ElasticMapReduce.TerminateJobFlows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
	}
