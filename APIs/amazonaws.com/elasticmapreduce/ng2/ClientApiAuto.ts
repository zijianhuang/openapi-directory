...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddInstanceFleet(requestBody: AddInstanceFleetInput, headersHandler?: () => HttpHeaders): Observable<AddInstanceFleetOutput> {
			return this.http.post<AddInstanceFleetOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddInstanceFleet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AddInstanceGroups(requestBody: AddInstanceGroupsInput, headersHandler?: () => HttpHeaders): Observable<AddInstanceGroupsOutput> {
			return this.http.post<AddInstanceGroupsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddInstanceGroups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AddJobFlowSteps(requestBody: AddJobFlowStepsInput, headersHandler?: () => HttpHeaders): Observable<AddJobFlowStepsOutput> {
			return this.http.post<AddJobFlowStepsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddJobFlowSteps', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		AddTags(requestBody: AddTagsInput, headersHandler?: () => HttpHeaders): Observable<AddTagsOutput> {
			return this.http.post<AddTagsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelSteps(requestBody: CancelStepsInput, headersHandler?: () => HttpHeaders): Observable<CancelStepsOutput> {
			return this.http.post<CancelStepsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.CancelSteps', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSecurityConfiguration(requestBody: CreateSecurityConfigurationInput, headersHandler?: () => HttpHeaders): Observable<CreateSecurityConfigurationOutput> {
			return this.http.post<CreateSecurityConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.CreateSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSecurityConfiguration(requestBody: DeleteSecurityConfigurationInput, headersHandler?: () => HttpHeaders): Observable<DeleteSecurityConfigurationOutput> {
			return this.http.post<DeleteSecurityConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DeleteSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCluster(requestBody: DescribeClusterInput, headersHandler?: () => HttpHeaders): Observable<DescribeClusterOutput> {
			return this.http.post<DescribeClusterOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeJobFlows(requestBody: DescribeJobFlowsInput, headersHandler?: () => HttpHeaders): Observable<DescribeJobFlowsOutput> {
			return this.http.post<DescribeJobFlowsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeJobFlows', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSecurityConfiguration(requestBody: DescribeSecurityConfigurationInput, headersHandler?: () => HttpHeaders): Observable<DescribeSecurityConfigurationOutput> {
			return this.http.post<DescribeSecurityConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeSecurityConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStep(requestBody: DescribeStepInput, headersHandler?: () => HttpHeaders): Observable<DescribeStepOutput> {
			return this.http.post<DescribeStepOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.DescribeStep', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetBlockPublicAccessConfiguration(requestBody: GetBlockPublicAccessConfigurationInput, headersHandler?: () => HttpHeaders): Observable<GetBlockPublicAccessConfigurationOutput> {
			return this.http.post<GetBlockPublicAccessConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.GetBlockPublicAccessConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetManagedScalingPolicy(requestBody: GetManagedScalingPolicyInput, headersHandler?: () => HttpHeaders): Observable<GetManagedScalingPolicyOutput> {
			return this.http.post<GetManagedScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.GetManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListBootstrapActions(Marker: string, requestBody: ListBootstrapActionsInput, headersHandler?: () => HttpHeaders): Observable<ListBootstrapActionsOutput> {
			return this.http.post<ListBootstrapActionsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListBootstrapActions?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListClusters(Marker: string, requestBody: ListClustersInput, headersHandler?: () => HttpHeaders): Observable<ListClustersOutput> {
			return this.http.post<ListClustersOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListClusters?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListInstanceFleets(Marker: string, requestBody: ListInstanceFleetsInput, headersHandler?: () => HttpHeaders): Observable<ListInstanceFleetsOutput> {
			return this.http.post<ListInstanceFleetsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListInstanceFleets?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListInstanceGroups(Marker: string, requestBody: ListInstanceGroupsInput, headersHandler?: () => HttpHeaders): Observable<ListInstanceGroupsOutput> {
			return this.http.post<ListInstanceGroupsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListInstanceGroups?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListInstances(Marker: string, requestBody: ListInstancesInput, headersHandler?: () => HttpHeaders): Observable<ListInstancesOutput> {
			return this.http.post<ListInstancesOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListInstances?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSecurityConfigurations(Marker: string, requestBody: ListSecurityConfigurationsInput, headersHandler?: () => HttpHeaders): Observable<ListSecurityConfigurationsOutput> {
			return this.http.post<ListSecurityConfigurationsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListSecurityConfigurations?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSteps(Marker: string, requestBody: ListStepsInput, headersHandler?: () => HttpHeaders): Observable<ListStepsOutput> {
			return this.http.post<ListStepsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ListSteps?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ModifyCluster(requestBody: ModifyClusterInput, headersHandler?: () => HttpHeaders): Observable<ModifyClusterOutput> {
			return this.http.post<ModifyClusterOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ModifyCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		ModifyInstanceFleet(requestBody: ModifyInstanceFleetInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ModifyInstanceFleet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		ModifyInstanceGroups(requestBody: ModifyInstanceGroupsInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.ModifyInstanceGroups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutAutoScalingPolicy(requestBody: PutAutoScalingPolicyInput, headersHandler?: () => HttpHeaders): Observable<PutAutoScalingPolicyOutput> {
			return this.http.post<PutAutoScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.PutAutoScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutBlockPublicAccessConfiguration(requestBody: PutBlockPublicAccessConfigurationInput, headersHandler?: () => HttpHeaders): Observable<PutBlockPublicAccessConfigurationOutput> {
			return this.http.post<PutBlockPublicAccessConfigurationOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.PutBlockPublicAccessConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutManagedScalingPolicy(requestBody: PutManagedScalingPolicyInput, headersHandler?: () => HttpHeaders): Observable<PutManagedScalingPolicyOutput> {
			return this.http.post<PutManagedScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.PutManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveAutoScalingPolicy(requestBody: RemoveAutoScalingPolicyInput, headersHandler?: () => HttpHeaders): Observable<RemoveAutoScalingPolicyOutput> {
			return this.http.post<RemoveAutoScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RemoveAutoScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveManagedScalingPolicy(requestBody: RemoveManagedScalingPolicyInput, headersHandler?: () => HttpHeaders): Observable<RemoveManagedScalingPolicyOutput> {
			return this.http.post<RemoveManagedScalingPolicyOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RemoveManagedScalingPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveTags(requestBody: RemoveTagsInput, headersHandler?: () => HttpHeaders): Observable<RemoveTagsOutput> {
			return this.http.post<RemoveTagsOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RunJobFlow(requestBody: RunJobFlowInput, headersHandler?: () => HttpHeaders): Observable<RunJobFlowOutput> {
			return this.http.post<RunJobFlowOutput>(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.RunJobFlow', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		SetTerminationProtection(requestBody: SetTerminationProtectionInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.SetTerminationProtection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SetVisibleToAllUsers(requestBody: SetVisibleToAllUsersInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.SetVisibleToAllUsers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		TerminateJobFlows(requestBody: TerminateJobFlowsInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=ElasticMapReduce.TerminateJobFlows', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
