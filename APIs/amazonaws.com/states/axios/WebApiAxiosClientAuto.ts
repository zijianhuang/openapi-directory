...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateActivity(requestBody: CreateActivityInput, headersHandler?: () => {[header: string]: string}): Promise<CreateActivityOutput> {
			return Axios.post<CreateActivityOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.CreateActivity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateStateMachine(requestBody: CreateStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<CreateStateMachineOutput> {
			return Axios.post<CreateStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.CreateStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteActivity(requestBody: DeleteActivityInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteActivityOutput> {
			return Axios.post<DeleteActivityOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DeleteActivity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteStateMachine(requestBody: DeleteStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteStateMachineOutput> {
			return Axios.post<DeleteStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DeleteStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeActivity(requestBody: DescribeActivityInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeActivityOutput> {
			return Axios.post<DescribeActivityOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeActivity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeExecution(requestBody: DescribeExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeExecutionOutput> {
			return Axios.post<DescribeExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeStateMachine(requestBody: DescribeStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStateMachineOutput> {
			return Axios.post<DescribeStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeStateMachineForExecution(requestBody: DescribeStateMachineForExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStateMachineForExecutionOutput> {
			return Axios.post<DescribeStateMachineForExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeStateMachineForExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetActivityTask(requestBody: GetActivityTaskInput, headersHandler?: () => {[header: string]: string}): Promise<GetActivityTaskOutput> {
			return Axios.post<GetActivityTaskOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.GetActivityTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetExecutionHistory(maxResults: string, nextToken: string, requestBody: GetExecutionHistoryInput, headersHandler?: () => {[header: string]: string}): Promise<GetExecutionHistoryOutput> {
			return Axios.post<GetExecutionHistoryOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.GetExecutionHistory?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListExecutions(maxResults: string, nextToken: string, requestBody: ListExecutionsInput, headersHandler?: () => {[header: string]: string}): Promise<ListExecutionsOutput> {
			return Axios.post<ListExecutionsOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.ListExecutions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListStateMachines(maxResults: string, nextToken: string, requestBody: ListStateMachinesInput, headersHandler?: () => {[header: string]: string}): Promise<ListStateMachinesOutput> {
			return Axios.post<ListStateMachinesOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.ListStateMachines?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return Axios.post<ListTagsForResourceOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendTaskFailure(requestBody: SendTaskFailureInput, headersHandler?: () => {[header: string]: string}): Promise<SendTaskFailureOutput> {
			return Axios.post<SendTaskFailureOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.SendTaskFailure', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendTaskHeartbeat(requestBody: SendTaskHeartbeatInput, headersHandler?: () => {[header: string]: string}): Promise<SendTaskHeartbeatOutput> {
			return Axios.post<SendTaskHeartbeatOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.SendTaskHeartbeat', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendTaskSuccess(requestBody: SendTaskSuccessInput, headersHandler?: () => {[header: string]: string}): Promise<SendTaskSuccessOutput> {
			return Axios.post<SendTaskSuccessOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.SendTaskSuccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartExecution(requestBody: StartExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<StartExecutionOutput> {
			return Axios.post<StartExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.StartExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopExecution(requestBody: StopExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<StopExecutionOutput> {
			return Axios.post<StopExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.StopExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceOutput> {
			return Axios.post<TagResourceOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceOutput> {
			return Axios.post<UntagResourceOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateStateMachine(requestBody: UpdateStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateStateMachineOutput> {
			return Axios.post<UpdateStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.UpdateStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
