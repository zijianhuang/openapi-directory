...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateActivity(requestBody: CreateActivityInput, headersHandler?: () => HttpHeaders): Observable<CreateActivityOutput> {
			return this.http.post<CreateActivityOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.CreateActivity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateStateMachine(requestBody: CreateStateMachineInput, headersHandler?: () => HttpHeaders): Observable<CreateStateMachineOutput> {
			return this.http.post<CreateStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.CreateStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteActivity(requestBody: DeleteActivityInput, headersHandler?: () => HttpHeaders): Observable<DeleteActivityOutput> {
			return this.http.post<DeleteActivityOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DeleteActivity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteStateMachine(requestBody: DeleteStateMachineInput, headersHandler?: () => HttpHeaders): Observable<DeleteStateMachineOutput> {
			return this.http.post<DeleteStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DeleteStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeActivity(requestBody: DescribeActivityInput, headersHandler?: () => HttpHeaders): Observable<DescribeActivityOutput> {
			return this.http.post<DescribeActivityOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeActivity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeExecution(requestBody: DescribeExecutionInput, headersHandler?: () => HttpHeaders): Observable<DescribeExecutionOutput> {
			return this.http.post<DescribeExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStateMachine(requestBody: DescribeStateMachineInput, headersHandler?: () => HttpHeaders): Observable<DescribeStateMachineOutput> {
			return this.http.post<DescribeStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStateMachineForExecution(requestBody: DescribeStateMachineForExecutionInput, headersHandler?: () => HttpHeaders): Observable<DescribeStateMachineForExecutionOutput> {
			return this.http.post<DescribeStateMachineForExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.DescribeStateMachineForExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetActivityTask(requestBody: GetActivityTaskInput, headersHandler?: () => HttpHeaders): Observable<GetActivityTaskOutput> {
			return this.http.post<GetActivityTaskOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.GetActivityTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetExecutionHistory(maxResults: string, nextToken: string, requestBody: GetExecutionHistoryInput, headersHandler?: () => HttpHeaders): Observable<GetExecutionHistoryOutput> {
			return this.http.post<GetExecutionHistoryOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.GetExecutionHistory?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListExecutions(maxResults: string, nextToken: string, requestBody: ListExecutionsInput, headersHandler?: () => HttpHeaders): Observable<ListExecutionsOutput> {
			return this.http.post<ListExecutionsOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.ListExecutions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListStateMachines(maxResults: string, nextToken: string, requestBody: ListStateMachinesInput, headersHandler?: () => HttpHeaders): Observable<ListStateMachinesOutput> {
			return this.http.post<ListStateMachinesOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.ListStateMachines?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceOutput> {
			return this.http.post<ListTagsForResourceOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendTaskFailure(requestBody: SendTaskFailureInput, headersHandler?: () => HttpHeaders): Observable<SendTaskFailureOutput> {
			return this.http.post<SendTaskFailureOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.SendTaskFailure', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendTaskHeartbeat(requestBody: SendTaskHeartbeatInput, headersHandler?: () => HttpHeaders): Observable<SendTaskHeartbeatOutput> {
			return this.http.post<SendTaskHeartbeatOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.SendTaskHeartbeat', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendTaskSuccess(requestBody: SendTaskSuccessInput, headersHandler?: () => HttpHeaders): Observable<SendTaskSuccessOutput> {
			return this.http.post<SendTaskSuccessOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.SendTaskSuccess', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartExecution(requestBody: StartExecutionInput, headersHandler?: () => HttpHeaders): Observable<StartExecutionOutput> {
			return this.http.post<StartExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.StartExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopExecution(requestBody: StopExecutionInput, headersHandler?: () => HttpHeaders): Observable<StopExecutionOutput> {
			return this.http.post<StopExecutionOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.StopExecution', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => HttpHeaders): Observable<TagResourceOutput> {
			return this.http.post<TagResourceOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => HttpHeaders): Observable<UntagResourceOutput> {
			return this.http.post<UntagResourceOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateStateMachine(requestBody: UpdateStateMachineInput, headersHandler?: () => HttpHeaders): Observable<UpdateStateMachineOutput> {
			return this.http.post<UpdateStateMachineOutput>(this.baseUri + '/#X-Amz-Target=AWSStepFunctions.UpdateStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
