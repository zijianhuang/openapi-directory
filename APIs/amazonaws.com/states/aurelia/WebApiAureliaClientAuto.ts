...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateActivity(requestBody: CreateActivityInput, headersHandler?: () => {[header: string]: string}): Promise<CreateActivityOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.CreateActivity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateStateMachine(requestBody: CreateStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<CreateStateMachineOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.CreateStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteActivity(requestBody: DeleteActivityInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteActivityOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.DeleteActivity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteStateMachine(requestBody: DeleteStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteStateMachineOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.DeleteStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeActivity(requestBody: DescribeActivityInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeActivityOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.DescribeActivity', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeExecution(requestBody: DescribeExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeExecutionOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.DescribeExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeStateMachine(requestBody: DescribeStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStateMachineOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.DescribeStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeStateMachineForExecution(requestBody: DescribeStateMachineForExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStateMachineForExecutionOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.DescribeStateMachineForExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetActivityTask(requestBody: GetActivityTaskInput, headersHandler?: () => {[header: string]: string}): Promise<GetActivityTaskOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.GetActivityTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetExecutionHistory(maxResults: string, nextToken: string, requestBody: GetExecutionHistoryInput, headersHandler?: () => {[header: string]: string}): Promise<GetExecutionHistoryOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.GetExecutionHistory?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListExecutions(maxResults: string, nextToken: string, requestBody: ListExecutionsInput, headersHandler?: () => {[header: string]: string}): Promise<ListExecutionsOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.ListExecutions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListStateMachines(maxResults: string, nextToken: string, requestBody: ListStateMachinesInput, headersHandler?: () => {[header: string]: string}): Promise<ListStateMachinesOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.ListStateMachines?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendTaskFailure(requestBody: SendTaskFailureInput, headersHandler?: () => {[header: string]: string}): Promise<SendTaskFailureOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.SendTaskFailure', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendTaskHeartbeat(requestBody: SendTaskHeartbeatInput, headersHandler?: () => {[header: string]: string}): Promise<SendTaskHeartbeatOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.SendTaskHeartbeat', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendTaskSuccess(requestBody: SendTaskSuccessInput, headersHandler?: () => {[header: string]: string}): Promise<SendTaskSuccessOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.SendTaskSuccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartExecution(requestBody: StartExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<StartExecutionOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.StartExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopExecution(requestBody: StopExecutionInput, headersHandler?: () => {[header: string]: string}): Promise<StopExecutionOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.StopExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateStateMachine(requestBody: UpdateStateMachineInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateStateMachineOutput> {
			return this.http.post('/#X-Amz-Target=AWSStepFunctions.UpdateStateMachine', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
