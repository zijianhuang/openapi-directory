...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateMember(networkId: string, requestBody: CreateMemberBody, headersHandler?: () => HttpHeaders): Observable<CreateMemberOutput> {
			return this.http.post<CreateMemberOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListMembers(networkId: string, name: string, status: MemberStatus, isOwned: boolean, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListMembersOutput> {
		 ...
		 */
		CreateNetwork(requestBody: CreateNetworkBody, headersHandler?: () => HttpHeaders): Observable<CreateNetworkOutput> {
			return this.http.post<CreateNetworkOutput>(this.baseUri + '/networks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListNetworks(name: string, framework: Framework, status: NetworkStatus, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListNetworksOutput> {
		 ...
		 */
		CreateNode(networkId: string, memberId: string, requestBody: CreateNodeBody, headersHandler?: () => HttpHeaders): Observable<CreateNodeOutput> {
			return this.http.post<CreateNodeOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)) + '/nodes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListNodes(networkId: string, memberId: string, status: NodeStatus, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListNodesOutput> {
		 ...
		 */
		CreateProposal(networkId: string, requestBody: CreateProposalBody, headersHandler?: () => HttpHeaders): Observable<CreateProposalOutput> {
			return this.http.post<CreateProposalOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListProposals(networkId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListProposalsOutput> {
		 ...
		 */
		DeleteMember(networkId: string, memberId: string, headersHandler?: () => HttpHeaders): Observable<DeleteMemberOutput> {
			return this.http.delete<DeleteMemberOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetMember(networkId: string, memberId: string, headersHandler?: () => HttpHeaders): Observable<GetMemberOutput> {
			return this.http.get<GetMemberOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteNode(networkId: string, memberId: string, nodeId: string, headersHandler?: () => HttpHeaders): Observable<DeleteNodeOutput> {
			return this.http.delete<DeleteNodeOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)) + '/nodes/' + (nodeId == null ? '' : encodeURIComponent(nodeId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetNode(networkId: string, memberId: string, nodeId: string, headersHandler?: () => HttpHeaders): Observable<GetNodeOutput> {
			return this.http.get<GetNodeOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)) + '/nodes/' + (nodeId == null ? '' : encodeURIComponent(nodeId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetNetwork(networkId: string, headersHandler?: () => HttpHeaders): Observable<GetNetworkOutput> {
			return this.http.get<GetNetworkOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetProposal(networkId: string, proposalId: string, headersHandler?: () => HttpHeaders): Observable<GetProposalOutput> {
			return this.http.get<GetProposalOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals/' + (proposalId == null ? '' : encodeURIComponent(proposalId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListProposalVotes(networkId: string, proposalId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListProposalVotesOutput> {
		 ...
		 */
		VoteOnProposal(networkId: string, proposalId: string, requestBody: VoteOnProposalBody, headersHandler?: () => HttpHeaders): Observable<VoteOnProposalOutput> {
			return this.http.post<VoteOnProposalOutput>(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals/' + (proposalId == null ? '' : encodeURIComponent(proposalId)) + '/votes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RejectInvitation(invitationId: string, headersHandler?: () => HttpHeaders): Observable<RejectInvitationOutput> {
			return this.http.delete<RejectInvitationOutput>(this.baseUri + '/invitations/' + (invitationId == null ? '' : encodeURIComponent(invitationId)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
