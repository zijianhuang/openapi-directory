...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateMember(networkId: string, callback: (data : CreateMemberOutput) => any, requestBody: CreateMemberBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMembers(networkId: string, name: string, status: MemberStatus, isOwned: boolean, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListMembersOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members&name=' + (name == null ? '' : encodeURIComponent(name)) + '&status=' + status + '&isOwned=' + isOwned + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateNetwork(callback: (data : CreateNetworkOutput) => any, requestBody: CreateNetworkBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/networks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListNetworks(name: string, framework: Framework, status: NetworkStatus, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListNetworksOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks?name=' + (name == null ? '' : encodeURIComponent(name)) + '&framework=' + framework + '&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateNode(networkId: string, memberId: string, callback: (data : CreateNodeOutput) => any, requestBody: CreateNodeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)) + '/nodes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListNodes(networkId: string, memberId: string, status: NodeStatus, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListNodesOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)) + '/nodes&status=' + status + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateProposal(networkId: string, callback: (data : CreateProposalOutput) => any, requestBody: CreateProposalBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListProposals(networkId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListProposalsOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteMember(networkId: string, memberId: string, callback: (data : DeleteMemberOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetMember(networkId: string, memberId: string, callback: (data : GetMemberOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteNode(networkId: string, memberId: string, nodeId: string, callback: (data : DeleteNodeOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)) + '/nodes/' + (nodeId == null ? '' : encodeURIComponent(nodeId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetNode(networkId: string, memberId: string, nodeId: string, callback: (data : GetNodeOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/members/' + (memberId == null ? '' : encodeURIComponent(memberId)) + '/nodes/' + (nodeId == null ? '' : encodeURIComponent(nodeId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetNetwork(networkId: string, callback: (data : GetNetworkOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetProposal(networkId: string, proposalId: string, callback: (data : GetProposalOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals/' + (proposalId == null ? '' : encodeURIComponent(proposalId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListInvitations(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListInvitationsOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/invitations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListProposalVotes(networkId: string, proposalId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListProposalVotesOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals/' + (proposalId == null ? '' : encodeURIComponent(proposalId)) + '/votes&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		VoteOnProposal(networkId: string, proposalId: string, callback: (data : VoteOnProposalOutput) => any, requestBody: VoteOnProposalBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/networks/' + (networkId == null ? '' : encodeURIComponent(networkId)) + '/proposals/' + (proposalId == null ? '' : encodeURIComponent(proposalId)) + '/votes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RejectInvitation(invitationId: string, callback: (data : RejectInvitationOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/invitations/' + (invitationId == null ? '' : encodeURIComponent(invitationId)), callback, this.error, this.statusCode, headersHandler);
		}
	}
