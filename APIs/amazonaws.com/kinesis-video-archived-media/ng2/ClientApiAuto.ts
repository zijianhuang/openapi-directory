...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetClip(requestBody: GetClipBody, headersHandler?: () => HttpHeaders): Observable<GetClipOutput> {
			return this.http.post<GetClipOutput>(this.baseUri + '/getClip', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDASHStreamingSessionURL(requestBody: GetDASHStreamingSessionURLBody, headersHandler?: () => HttpHeaders): Observable<GetDASHStreamingSessionURLOutput> {
			return this.http.post<GetDASHStreamingSessionURLOutput>(this.baseUri + '/getDASHStreamingSessionURL', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetHLSStreamingSessionURL(requestBody: GetHLSStreamingSessionURLBody, headersHandler?: () => HttpHeaders): Observable<GetHLSStreamingSessionURLOutput> {
			return this.http.post<GetHLSStreamingSessionURLOutput>(this.baseUri + '/getHLSStreamingSessionURL', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetMediaForFragmentList(requestBody: GetMediaForFragmentListBody, headersHandler?: () => HttpHeaders): Observable<GetMediaForFragmentListOutput> {
			return this.http.post<GetMediaForFragmentListOutput>(this.baseUri + '/getMediaForFragmentList', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
