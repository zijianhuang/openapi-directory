export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GetClip(requestBody: GetClipBody, headersHandler?: () => {[header: string]: string}): Promise<GetClipOutput> {
			return fetch(this.baseUri + '/getClip', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDASHStreamingSessionURL(requestBody: GetDASHStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}): Promise<GetDASHStreamingSessionURLOutput> {
			return fetch(this.baseUri + '/getDASHStreamingSessionURL', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetHLSStreamingSessionURL(requestBody: GetHLSStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}): Promise<GetHLSStreamingSessionURLOutput> {
			return fetch(this.baseUri + '/getHLSStreamingSessionURL', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetMediaForFragmentList(requestBody: GetMediaForFragmentListBody, headersHandler?: () => {[header: string]: string}): Promise<GetMediaForFragmentListOutput> {
			return fetch(this.baseUri + '/getMediaForFragmentList', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
