...
export namespace My_Demo_Client {
	...
	export interface ClipFragmentSelector {
		FragmentSelectorType: ClipFragmentSelectorFragmentSelectorType;

		/**<p>The range of timestamps for which to return fragments.</p> <p>The values in the ClipTimestampRange are <code>inclusive</code>. Fragments that begin before the start time but continue past it, or fragments that begin before the end time but continue past it, are included in the session. </p> */
		TimestampRange: ClipTimestampRange;
	}

	export enum ClipFragmentSelectorFragmentSelectorType { PRODUCER_TIMESTAMP = 0, SERVER_TIMESTAMP = 1 }
	...
	export interface DASHFragmentSelector {
		FragmentSelectorType?: DASHFragmentSelectorFragmentSelectorType;

		/**<p>The start and end of the timestamp range for the requested media.</p> <p>This value should not be present if <code>PlaybackType</code> is <code>LIVE</code>.</p> <note> <p>The values in the <code>DASHimestampRange</code> are inclusive. Fragments that begin before the start time but continue past it, or fragments that begin before the end time but continue past it, are included in the session.</p> </note> */
		TimestampRange?: DASHTimestampRange;
	}

	export enum DASHFragmentSelectorFragmentSelectorType { PRODUCER_TIMESTAMP = 0, SERVER_TIMESTAMP = 1 }
	...
	export interface FragmentSelector {
		FragmentSelectorType: FragmentSelectorFragmentSelectorType;

		/**The range of timestamps for which to return fragments. */
		TimestampRange: TimestampRange;
	}

	export enum FragmentSelectorFragmentSelectorType { PRODUCER_TIMESTAMP = 0, SERVER_TIMESTAMP = 1 }
	...
	export interface GetDASHStreamingSessionURLInput {
		StreamName?: string;
		StreamARN?: string;
		PlaybackMode?: GetDASHStreamingSessionURLInputPlaybackMode;
		DisplayFragmentTimestamp?: GetDASHStreamingSessionURLInputDisplayFragmentTimestamp;
		DisplayFragmentNumber?: GetDASHStreamingSessionURLInputDisplayFragmentNumber;
	...
	export enum GetDASHStreamingSessionURLInputPlaybackMode { LIVE = 0, LIVE_REPLAY = 1, ON_DEMAND = 2 }

	export enum GetDASHStreamingSessionURLInputDisplayFragmentTimestamp { ALWAYS = 0, NEVER = 1 }

	export enum GetDASHStreamingSessionURLInputDisplayFragmentNumber { ALWAYS = 0, NEVER = 1 }
	...
	export interface HLSFragmentSelector {
		FragmentSelectorType?: HLSFragmentSelectorFragmentSelectorType;

		/**<p>The start and end of the timestamp range for the requested media.</p> <p>This value should not be present if <code>PlaybackType</code> is <code>LIVE</code>.</p> <note> <p>The values in the <code>HLSTimestampRange</code> are inclusive. Fragments that begin before the start time but continue past it, or fragments that begin before the end time but continue past it, are included in the session.</p> </note> */
		TimestampRange?: HLSTimestampRange;
	}

	export enum HLSFragmentSelectorFragmentSelectorType { PRODUCER_TIMESTAMP = 0, SERVER_TIMESTAMP = 1 }
	...
	export interface GetHLSStreamingSessionURLInput {
		StreamName?: string;
		StreamARN?: string;
		PlaybackMode?: GetHLSStreamingSessionURLInputPlaybackMode;

		/**Contains the range of timestamps for the requested media, and the source of the timestamps. */
		HLSFragmentSelector?: HLSFragmentSelector;
		ContainerFormat?: GetHLSStreamingSessionURLInputContainerFormat;
		DiscontinuityMode?: GetHLSStreamingSessionURLInputDiscontinuityMode;
		DisplayFragmentTimestamp?: GetHLSStreamingSessionURLInputDisplayFragmentTimestamp;
		Expires?: number;
		MaxMediaPlaylistFragmentResults?: number;
	}

	export enum GetHLSStreamingSessionURLInputPlaybackMode { LIVE = 0, LIVE_REPLAY = 1, ON_DEMAND = 2 }

	export enum GetHLSStreamingSessionURLInputContainerFormat { FRAGMENTED_MP4 = 0, MPEG_TS = 1 }

	export enum GetHLSStreamingSessionURLInputDiscontinuityMode { ALWAYS = 0, NEVER = 1, ON_DISCONTINUITY = 2 }

	export enum GetHLSStreamingSessionURLInputDisplayFragmentTimestamp { ALWAYS = 0, NEVER = 1 }

	export interface GetMediaForFragmentListInput {
		StreamName: string;
		Fragments: Array<FragmentNumberString>;
	}
	...
	export class DemoClient {
		 ...
		 */
		GetClip(requestBody: GetClipBody, headersHandler?: () => {[header: string]: string}): Promise<GetClipOutput> {
			return this.http.post('/getClip', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetDASHStreamingSessionURL(requestBody: GetDASHStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}): Promise<GetDASHStreamingSessionURLOutput> {
			return this.http.post('/getDASHStreamingSessionURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetHLSStreamingSessionURL(requestBody: GetHLSStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}): Promise<GetHLSStreamingSessionURLOutput> {
			return this.http.post('/getHLSStreamingSessionURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetMediaForFragmentList(requestBody: GetMediaForFragmentListBody, headersHandler?: () => {[header: string]: string}): Promise<GetMediaForFragmentListOutput> {
			return this.http.post('/getMediaForFragmentList', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListFragments(MaxResults: string, NextToken: string, requestBody: ListFragmentsBody, headersHandler?: () => {[header: string]: string}): Promise<ListFragmentsOutput> {
			return this.http.post('/listFragments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}

	export interface GetClipBody {
	...
	export interface GetDASHStreamingSessionURLBody {
		...
		PlaybackMode?: GetDASHStreamingSessionURLBodyPlaybackMode;
		...
		DisplayFragmentTimestamp?: GetDASHStreamingSessionURLBodyDisplayFragmentTimestamp;
		...
		DisplayFragmentNumber?: GetDASHStreamingSessionURLBodyDisplayFragmentNumber;
	...
	export enum GetDASHStreamingSessionURLBodyPlaybackMode { LIVE = 0, LIVE_REPLAY = 1, ON_DEMAND = 2 }

	export enum GetDASHStreamingSessionURLBodyDisplayFragmentTimestamp { ALWAYS = 0, NEVER = 1 }

	export enum GetDASHStreamingSessionURLBodyDisplayFragmentNumber { ALWAYS = 0, NEVER = 1 }

	export interface GetHLSStreamingSessionURLBody {
		...
		PlaybackMode?: GetHLSStreamingSessionURLBodyPlaybackMode;
		...
		ContainerFormat?: GetHLSStreamingSessionURLBodyContainerFormat;
		...
		DiscontinuityMode?: GetHLSStreamingSessionURLBodyDiscontinuityMode;
		...
		DisplayFragmentTimestamp?: GetHLSStreamingSessionURLBodyDisplayFragmentTimestamp;
	...
	export enum GetHLSStreamingSessionURLBodyPlaybackMode { LIVE = 0, LIVE_REPLAY = 1, ON_DEMAND = 2 }

	export enum GetHLSStreamingSessionURLBodyContainerFormat { FRAGMENTED_MP4 = 0, MPEG_TS = 1 }

	export enum GetHLSStreamingSessionURLBodyDiscontinuityMode { ALWAYS = 0, NEVER = 1, ON_DISCONTINUITY = 2 }

	export enum GetHLSStreamingSessionURLBodyDisplayFragmentTimestamp { ALWAYS = 0, NEVER = 1 }

	export interface GetMediaForFragmentListBody {
	...
	export interface ListFragmentsBody {
