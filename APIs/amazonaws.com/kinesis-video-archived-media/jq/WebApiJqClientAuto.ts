...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		GetClip(callback: (data : GetClipOutput) => any, requestBody: GetClipBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getClip', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDASHStreamingSessionURL(callback: (data : GetDASHStreamingSessionURLOutput) => any, requestBody: GetDASHStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getDASHStreamingSessionURL', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetHLSStreamingSessionURL(callback: (data : GetHLSStreamingSessionURLOutput) => any, requestBody: GetHLSStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getHLSStreamingSessionURL', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetMediaForFragmentList(callback: (data : GetMediaForFragmentListOutput) => any, requestBody: GetMediaForFragmentListBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/getMediaForFragmentList', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFragments(MaxResults: string, NextToken: string, callback: (data : ListFragmentsOutput) => any, requestBody: ListFragmentsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/listFragments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
