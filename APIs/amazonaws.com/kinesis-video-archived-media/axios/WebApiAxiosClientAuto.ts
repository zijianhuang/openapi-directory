...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GetClip(requestBody: GetClipBody, headersHandler?: () => {[header: string]: string}): Promise<GetClipOutput> {
			return Axios.post<GetClipOutput>(this.baseUri + '/getClip', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDASHStreamingSessionURL(requestBody: GetDASHStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}): Promise<GetDASHStreamingSessionURLOutput> {
			return Axios.post<GetDASHStreamingSessionURLOutput>(this.baseUri + '/getDASHStreamingSessionURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetHLSStreamingSessionURL(requestBody: GetHLSStreamingSessionURLBody, headersHandler?: () => {[header: string]: string}): Promise<GetHLSStreamingSessionURLOutput> {
			return Axios.post<GetHLSStreamingSessionURLOutput>(this.baseUri + '/getHLSStreamingSessionURL', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMediaForFragmentList(requestBody: GetMediaForFragmentListBody, headersHandler?: () => {[header: string]: string}): Promise<GetMediaForFragmentListOutput> {
			return Axios.post<GetMediaForFragmentListOutput>(this.baseUri + '/getMediaForFragmentList', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
