...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApiCache(apiId: string, requestBody: CreateApiCacheBody, headersHandler?: () => {[header: string]: string}): Promise<CreateApiCacheResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApiCache(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApiCacheResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApiCache(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<GetApiCacheResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateApiKey(apiId: string, requestBody: CreateApiKeyBody, headersHandler?: () => {[header: string]: string}): Promise<CreateApiKeyResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListApiKeys(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListApiKeysResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDataSource(apiId: string, requestBody: CreateDataSourceBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDataSources(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDataSourcesResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateFunction(apiId: string, requestBody: CreateFunctionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFunctionResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListFunctions(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionsResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateGraphqlApi(requestBody: CreateGraphqlApiBody, headersHandler?: () => {[header: string]: string}): Promise<CreateGraphqlApiResponse> {
			return this.http.post('/v1/apis', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGraphqlApis(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListGraphqlApisResponse> {
			return this.http.get('/v1/apis?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListResolvers(apiId: string, typeName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListResolversResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateType(apiId: string, requestBody: CreateTypeBody, headersHandler?: () => {[header: string]: string}): Promise<CreateTypeResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteApiKey(apiId: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApiKeyResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApiKey(apiId: string, id: string, requestBody: UpdateApiKeyBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApiKeyResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDataSource(apiId: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDataSourceResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDataSource(apiId: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<GetDataSourceResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDataSource(apiId: string, name: string, requestBody: UpdateDataSourceBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataSourceResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteFunction(apiId: string, functionId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFunctionResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFunction(apiId: string, functionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateFunction(apiId: string, functionId: string, requestBody: UpdateFunctionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFunctionResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteGraphqlApi(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGraphqlApiResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetGraphqlApi(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<GetGraphqlApiResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGraphqlApi(apiId: string, requestBody: UpdateGraphqlApiBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateGraphqlApiResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResolver(apiId: string, typeName: string, fieldName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteResolverResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetResolver(apiId: string, typeName: string, fieldName: string, headersHandler?: () => {[header: string]: string}): Promise<GetResolverResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteType(apiId: string, typeName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteTypeResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateType(apiId: string, typeName: string, requestBody: UpdateTypeBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateTypeResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		FlushApiCache(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<FlushApiCacheResponse> {
			return this.http.delete('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/FlushCache', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetIntrospectionSchema(apiId: string, format: TypeDefinitionFormat, includeDirectives: boolean, headersHandler?: () => {[header: string]: string}): Promise<GetIntrospectionSchemaResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schema#format&format=' + format + '&includeDirectives=' + includeDirectives, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSchemaCreationStatus(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<GetSchemaCreationStatusResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartSchemaCreation(apiId: string, requestBody: StartSchemaCreationBody, headersHandler?: () => {[header: string]: string}): Promise<StartSchemaCreationResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetType(apiId: string, typeName: string, format: TypeDefinitionFormat, headersHandler?: () => {[header: string]: string}): Promise<GetTypeResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '#format&format=' + format, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListResolversByFunction(apiId: string, functionId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListResolversByFunctionResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTypes(apiId: string, format: TypeDefinitionFormat, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListTypesResponse> {
			return this.http.get('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types#format&format=' + format + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.delete('/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApiCache(apiId: string, requestBody: UpdateApiCacheBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApiCacheResponse> {
			return this.http.post('/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches/update', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
