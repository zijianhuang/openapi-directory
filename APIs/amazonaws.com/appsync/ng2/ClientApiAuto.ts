...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateApiCache(apiId: string, requestBody: CreateApiCacheBody, headersHandler?: () => HttpHeaders): Observable<CreateApiCacheResponse> {
			return this.http.post<CreateApiCacheResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApiCache(apiId: string, headersHandler?: () => HttpHeaders): Observable<DeleteApiCacheResponse> {
			return this.http.delete<DeleteApiCacheResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetApiCache(apiId: string, headersHandler?: () => HttpHeaders): Observable<GetApiCacheResponse> {
			return this.http.get<GetApiCacheResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateApiKey(apiId: string, requestBody: CreateApiKeyBody, headersHandler?: () => HttpHeaders): Observable<CreateApiKeyResponse> {
			return this.http.post<CreateApiKeyResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListApiKeys(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListApiKeysResponse> {
			return this.http.get<ListApiKeysResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateDataSource(apiId: string, requestBody: CreateDataSourceBody, headersHandler?: () => HttpHeaders): Observable<CreateDataSourceResponse> {
			return this.http.post<CreateDataSourceResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDataSources(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListDataSourcesResponse> {
			return this.http.get<ListDataSourcesResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateFunction(apiId: string, requestBody: CreateFunctionBody, headersHandler?: () => HttpHeaders): Observable<CreateFunctionResponse> {
			return this.http.post<CreateFunctionResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFunctions(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListFunctionsResponse> {
			return this.http.get<ListFunctionsResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateGraphqlApi(requestBody: CreateGraphqlApiBody, headersHandler?: () => HttpHeaders): Observable<CreateGraphqlApiResponse> {
			return this.http.post<CreateGraphqlApiResponse>(this.baseUri + '/v1/apis', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListGraphqlApis(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListGraphqlApisResponse> {
			return this.http.get<ListGraphqlApisResponse>(this.baseUri + '/v1/apis?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateResolver(apiId: string, typeName: string, requestBody: CreateResolverBody, headersHandler?: () => HttpHeaders): Observable<CreateResolverResponse> {
			return this.http.post<CreateResolverResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResolvers(apiId: string, typeName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListResolversResponse> {
			return this.http.get<ListResolversResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateType(apiId: string, requestBody: CreateTypeBody, headersHandler?: () => HttpHeaders): Observable<CreateTypeResponse> {
			return this.http.post<CreateTypeResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteApiKey(apiId: string, id: string, headersHandler?: () => HttpHeaders): Observable<DeleteApiKeyResponse> {
			return this.http.delete<DeleteApiKeyResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateApiKey(apiId: string, id: string, requestBody: UpdateApiKeyBody, headersHandler?: () => HttpHeaders): Observable<UpdateApiKeyResponse> {
			return this.http.post<UpdateApiKeyResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDataSource(apiId: string, name: string, headersHandler?: () => HttpHeaders): Observable<DeleteDataSourceResponse> {
			return this.http.delete<DeleteDataSourceResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetDataSource(apiId: string, name: string, headersHandler?: () => HttpHeaders): Observable<GetDataSourceResponse> {
			return this.http.get<GetDataSourceResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDataSource(apiId: string, name: string, requestBody: UpdateDataSourceBody, headersHandler?: () => HttpHeaders): Observable<UpdateDataSourceResponse> {
			return this.http.post<UpdateDataSourceResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteFunction(apiId: string, functionId: string, headersHandler?: () => HttpHeaders): Observable<DeleteFunctionResponse> {
			return this.http.delete<DeleteFunctionResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetFunction(apiId: string, functionId: string, headersHandler?: () => HttpHeaders): Observable<GetFunctionResponse> {
			return this.http.get<GetFunctionResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateFunction(apiId: string, functionId: string, requestBody: UpdateFunctionBody, headersHandler?: () => HttpHeaders): Observable<UpdateFunctionResponse> {
			return this.http.post<UpdateFunctionResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteGraphqlApi(apiId: string, headersHandler?: () => HttpHeaders): Observable<DeleteGraphqlApiResponse> {
			return this.http.delete<DeleteGraphqlApiResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetGraphqlApi(apiId: string, headersHandler?: () => HttpHeaders): Observable<GetGraphqlApiResponse> {
			return this.http.get<GetGraphqlApiResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateGraphqlApi(apiId: string, requestBody: UpdateGraphqlApiBody, headersHandler?: () => HttpHeaders): Observable<UpdateGraphqlApiResponse> {
			return this.http.post<UpdateGraphqlApiResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteResolver(apiId: string, typeName: string, fieldName: string, headersHandler?: () => HttpHeaders): Observable<DeleteResolverResponse> {
			return this.http.delete<DeleteResolverResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetResolver(apiId: string, typeName: string, fieldName: string, headersHandler?: () => HttpHeaders): Observable<GetResolverResponse> {
			return this.http.get<GetResolverResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateResolver(apiId: string, typeName: string, fieldName: string, requestBody: UpdateResolverBody, headersHandler?: () => HttpHeaders): Observable<UpdateResolverResponse> {
			return this.http.post<UpdateResolverResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteType(apiId: string, typeName: string, headersHandler?: () => HttpHeaders): Observable<DeleteTypeResponse> {
			return this.http.delete<DeleteTypeResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateType(apiId: string, typeName: string, requestBody: UpdateTypeBody, headersHandler?: () => HttpHeaders): Observable<UpdateTypeResponse> {
			return this.http.post<UpdateTypeResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		FlushApiCache(apiId: string, headersHandler?: () => HttpHeaders): Observable<FlushApiCacheResponse> {
			return this.http.delete<FlushApiCacheResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/FlushCache', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetIntrospectionSchema(apiId: string, format: TypeDefinitionFormat, includeDirectives: boolean, headersHandler?: () => HttpHeaders): Observable<GetIntrospectionSchemaResponse> {
			return this.http.get<GetIntrospectionSchemaResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schema#format&format=' + format + '&includeDirectives=' + includeDirectives, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSchemaCreationStatus(apiId: string, headersHandler?: () => HttpHeaders): Observable<GetSchemaCreationStatusResponse> {
			return this.http.get<GetSchemaCreationStatusResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		StartSchemaCreation(apiId: string, requestBody: StartSchemaCreationBody, headersHandler?: () => HttpHeaders): Observable<StartSchemaCreationResponse> {
			return this.http.post<StartSchemaCreationResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetType(apiId: string, typeName: string, format: TypeDefinitionFormat, headersHandler?: () => HttpHeaders): Observable<GetTypeResponse> {
			return this.http.get<GetTypeResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '#format&format=' + format, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListResolversByFunction(apiId: string, functionId: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListResolversByFunctionResponse> {
			return this.http.get<ListResolversByFunctionResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListTagsForResource(resourceArn: string, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.get<ListTagsForResourceResponse>(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTypes(apiId: string, format: TypeDefinitionFormat, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListTypesResponse> {
			return this.http.get<ListTypesResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types#format&format=' + format + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.delete<UntagResourceResponse>(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateApiCache(apiId: string, requestBody: UpdateApiCacheBody, headersHandler?: () => HttpHeaders): Observable<UpdateApiCacheResponse> {
			return this.http.post<UpdateApiCacheResponse>(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches/update', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
