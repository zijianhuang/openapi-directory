export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApiCache(apiId: string, requestBody: CreateApiCacheBody, headersHandler?: () => {[header: string]: string}): Promise<CreateApiCacheResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApiCache(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApiCacheResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetApiCache(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<GetApiCacheResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateApiKey(apiId: string, requestBody: CreateApiKeyBody, headersHandler?: () => {[header: string]: string}): Promise<CreateApiKeyResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListApiKeys(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListApiKeysResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDataSource(apiId: string, requestBody: CreateDataSourceBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDataSources(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDataSourcesResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateFunction(apiId: string, requestBody: CreateFunctionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFunctionResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListFunctions(apiId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListFunctionsResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateGraphqlApi(requestBody: CreateGraphqlApiBody, headersHandler?: () => {[header: string]: string}): Promise<CreateGraphqlApiResponse> {
			return fetch(this.baseUri + '/v1/apis', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListGraphqlApis(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListGraphqlApisResponse> {
			return fetch(this.baseUri + '/v1/apis?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListResolvers(apiId: string, typeName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListResolversResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateType(apiId: string, requestBody: CreateTypeBody, headersHandler?: () => {[header: string]: string}): Promise<CreateTypeResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApiKey(apiId: string, id: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteApiKeyResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApiKey(apiId: string, id: string, requestBody: UpdateApiKeyBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApiKeyResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDataSource(apiId: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDataSourceResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDataSource(apiId: string, name: string, headersHandler?: () => {[header: string]: string}): Promise<GetDataSourceResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDataSource(apiId: string, name: string, requestBody: UpdateDataSourceBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataSourceResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteFunction(apiId: string, functionId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFunctionResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFunction(apiId: string, functionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetFunctionResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateFunction(apiId: string, functionId: string, requestBody: UpdateFunctionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFunctionResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteGraphqlApi(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGraphqlApiResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetGraphqlApi(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<GetGraphqlApiResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateGraphqlApi(apiId: string, requestBody: UpdateGraphqlApiBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateGraphqlApiResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteResolver(apiId: string, typeName: string, fieldName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteResolverResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetResolver(apiId: string, typeName: string, fieldName: string, headersHandler?: () => {[header: string]: string}): Promise<GetResolverResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateResolver(apiId: string, typeName: string, fieldName: string, requestBody: UpdateResolverBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateResolverResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteType(apiId: string, typeName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteTypeResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		FlushApiCache(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<FlushApiCacheResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/FlushCache', { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetIntrospectionSchema(apiId: string, format: TypeDefinitionFormat, includeDirectives: boolean, headersHandler?: () => {[header: string]: string}): Promise<GetIntrospectionSchemaResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schema#format&format=' + format + '&includeDirectives=' + includeDirectives, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSchemaCreationStatus(apiId: string, headersHandler?: () => {[header: string]: string}): Promise<GetSchemaCreationStatusResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartSchemaCreation(apiId: string, requestBody: StartSchemaCreationBody, headersHandler?: () => {[header: string]: string}): Promise<StartSchemaCreationResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetType(apiId: string, typeName: string, format: TypeDefinitionFormat, headersHandler?: () => {[header: string]: string}): Promise<GetTypeResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '#format&format=' + format, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListResolversByFunction(apiId: string, functionId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListResolversByFunctionResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(resourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTypes(apiId: string, format: TypeDefinitionFormat, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListTypesResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types#format&format=' + format + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateApiCache(apiId: string, requestBody: UpdateApiCacheBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateApiCacheResponse> {
			return fetch(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches/update', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
