...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateApiCache(apiId: string, callback: (data : CreateApiCacheResponse) => any, requestBody: CreateApiCacheBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteApiCache(apiId: string, callback: (data : DeleteApiCacheResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetApiCache(apiId: string, callback: (data : GetApiCacheResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateApiKey(apiId: string, callback: (data : CreateApiKeyResponse) => any, requestBody: CreateApiKeyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListApiKeys(apiId: string, nextToken: string, maxResults: number, callback: (data : ListApiKeysResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateDataSource(apiId: string, callback: (data : CreateDataSourceResponse) => any, requestBody: CreateDataSourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDataSources(apiId: string, nextToken: string, maxResults: number, callback: (data : ListDataSourcesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateFunction(apiId: string, callback: (data : CreateFunctionResponse) => any, requestBody: CreateFunctionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFunctions(apiId: string, nextToken: string, maxResults: number, callback: (data : ListFunctionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateGraphqlApi(callback: (data : CreateGraphqlApiResponse) => any, requestBody: CreateGraphqlApiBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListGraphqlApis(nextToken: string, maxResults: number, callback: (data : ListGraphqlApisResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateResolver(apiId: string, typeName: string, callback: (data : CreateResolverResponse) => any, requestBody: CreateResolverBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResolvers(apiId: string, typeName: string, nextToken: string, maxResults: number, callback: (data : ListResolversResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateType(apiId: string, callback: (data : CreateTypeResponse) => any, requestBody: CreateTypeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteApiKey(apiId: string, id: string, callback: (data : DeleteApiKeyResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateApiKey(apiId: string, id: string, callback: (data : UpdateApiKeyResponse) => any, requestBody: UpdateApiKeyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/apikeys/' + (id == null ? '' : encodeURIComponent(id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDataSource(apiId: string, name: string, callback: (data : DeleteDataSourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDataSource(apiId: string, name: string, callback: (data : GetDataSourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDataSource(apiId: string, name: string, callback: (data : UpdateDataSourceResponse) => any, requestBody: UpdateDataSourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/datasources/' + (name == null ? '' : encodeURIComponent(name)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteFunction(apiId: string, functionId: string, callback: (data : DeleteFunctionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetFunction(apiId: string, functionId: string, callback: (data : GetFunctionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateFunction(apiId: string, functionId: string, callback: (data : UpdateFunctionResponse) => any, requestBody: UpdateFunctionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteGraphqlApi(apiId: string, callback: (data : DeleteGraphqlApiResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetGraphqlApi(apiId: string, callback: (data : GetGraphqlApiResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateGraphqlApi(apiId: string, callback: (data : UpdateGraphqlApiResponse) => any, requestBody: UpdateGraphqlApiBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteResolver(apiId: string, typeName: string, fieldName: string, callback: (data : DeleteResolverResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetResolver(apiId: string, typeName: string, fieldName: string, callback: (data : GetResolverResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateResolver(apiId: string, typeName: string, fieldName: string, callback: (data : UpdateResolverResponse) => any, requestBody: UpdateResolverBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '/resolvers/' + (fieldName == null ? '' : encodeURIComponent(fieldName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteType(apiId: string, typeName: string, callback: (data : DeleteTypeResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateType(apiId: string, typeName: string, callback: (data : UpdateTypeResponse) => any, requestBody: UpdateTypeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		FlushApiCache(apiId: string, callback: (data : FlushApiCacheResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/FlushCache', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetIntrospectionSchema(apiId: string, format: TypeDefinitionFormat, includeDirectives: boolean, callback: (data : GetIntrospectionSchemaResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schema#format&format=' + format + '&includeDirectives=' + includeDirectives, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSchemaCreationStatus(apiId: string, callback: (data : GetSchemaCreationStatusResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		StartSchemaCreation(apiId: string, callback: (data : StartSchemaCreationResponse) => any, requestBody: StartSchemaCreationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/schemacreation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetType(apiId: string, typeName: string, format: TypeDefinitionFormat, callback: (data : GetTypeResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types/' + (typeName == null ? '' : encodeURIComponent(typeName)) + '#format&format=' + format, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListResolversByFunction(apiId: string, functionId: string, nextToken: string, maxResults: number, callback: (data : ListResolversByFunctionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/functions/' + (functionId == null ? '' : encodeURIComponent(functionId)) + '/resolvers&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		...
		ListTagsForResource(resourceArn: string, callback: (data : ListTagsForResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		TagResource(resourceArn: string, callback: (data : TagResourceResponse) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTypes(apiId: string, format: TypeDefinitionFormat, nextToken: string, maxResults: number, callback: (data : ListTypesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/types#format&format=' + format + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, callback: (data : UntagResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateApiCache(apiId: string, callback: (data : UpdateApiCacheResponse) => any, requestBody: UpdateApiCacheBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/apis/' + (apiId == null ? '' : encodeURIComponent(apiId)) + '/ApiCaches/update', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
