export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ListProjects(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProjectsResult> {
			return fetch(this.baseUri + '/projects?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteProject(projectId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectResult> {
			return fetch(this.baseUri + '/projects/' + (projectId == null ? '' : encodeURIComponent(projectId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBundle(bundleId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBundleResult> {
			return fetch(this.baseUri + '/bundles/' + (bundleId == null ? '' : encodeURIComponent(bundleId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportBundle(bundleId: string, projectId: string, platform: Platform, headersHandler?: () => {[header: string]: string}): Promise<ExportBundleResult> {
			return fetch(this.baseUri + '/bundles/' + (bundleId == null ? '' : encodeURIComponent(bundleId)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)) + '&platform=' + platform, { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProject(projectId: string, syncFromResources: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeProjectResult> {
			return fetch(this.baseUri + '/project#projectId?projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)) + '&syncFromResources=' + syncFromResources, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportProject(projectId: string, headersHandler?: () => {[header: string]: string}): Promise<ExportProjectResult> {
			return fetch(this.baseUri + '/exports/' + (projectId == null ? '' : encodeURIComponent(projectId)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBundles(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBundlesResult> {
			return fetch(this.baseUri + '/bundles?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateProject(projectId: string, requestBody: UpdateProjectBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateProjectResult> {
			return fetch(this.baseUri + '/update#projectId?projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
