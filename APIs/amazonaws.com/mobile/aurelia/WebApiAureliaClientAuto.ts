...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ListProjects(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListProjectsResult> {
			return this.http.get('/projects?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteProject(projectId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectResult> {
			return this.http.delete('/projects/' + (projectId == null ? '' : encodeURIComponent(projectId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeBundle(bundleId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeBundleResult> {
			return this.http.get('/bundles/' + (bundleId == null ? '' : encodeURIComponent(bundleId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportBundle(bundleId: string, projectId: string, platform: Platform, headersHandler?: () => {[header: string]: string}): Promise<ExportBundleResult> {
			return this.http.post('/bundles/' + (bundleId == null ? '' : encodeURIComponent(bundleId)) + '&projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)) + '&platform=' + platform, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeProject(projectId: string, syncFromResources: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeProjectResult> {
			return this.http.get('/project#projectId?projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)) + '&syncFromResources=' + syncFromResources, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ExportProject(projectId: string, headersHandler?: () => {[header: string]: string}): Promise<ExportProjectResult> {
			return this.http.post('/exports/' + (projectId == null ? '' : encodeURIComponent(projectId)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListBundles(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListBundlesResult> {
			return this.http.get('/bundles?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateProject(projectId: string, requestBody: UpdateProjectBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateProjectResult> {
			return this.http.post('/update#projectId?projectId=' + (projectId == null ? '' : encodeURIComponent(projectId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
