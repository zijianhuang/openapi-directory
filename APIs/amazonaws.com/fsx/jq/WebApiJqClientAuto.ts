...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelDataRepositoryTask(callback: (data : CancelDataRepositoryTaskResponse) => any, requestBody: CancelDataRepositoryTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CancelDataRepositoryTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		CreateBackup(callback: (data : CreateBackupResponse) => any, requestBody: CreateBackupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateBackup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateDataRepositoryTask(callback: (data : CreateDataRepositoryTaskResponse) => any, requestBody: CreateDataRepositoryTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateDataRepositoryTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateFileSystem(callback: (data : CreateFileSystemResponse) => any, requestBody: CreateFileSystemRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateFileSystem', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateFileSystemFromBackup(callback: (data : CreateFileSystemFromBackupResponse) => any, requestBody: CreateFileSystemFromBackupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateFileSystemFromBackup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DeleteBackup(callback: (data : DeleteBackupResponse) => any, requestBody: DeleteBackupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteBackup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteFileSystem(callback: (data : DeleteFileSystemResponse) => any, requestBody: DeleteFileSystemRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteFileSystem', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DescribeBackups(MaxResults: string, NextToken: string, callback: (data : DescribeBackupsResponse) => any, requestBody: DescribeBackupsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DescribeBackups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDataRepositoryTasks(MaxResults: string, NextToken: string, callback: (data : DescribeDataRepositoryTasksResponse) => any, requestBody: DescribeDataRepositoryTasksRequest, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		DescribeFileSystems(MaxResults: string, NextToken: string, callback: (data : DescribeFileSystemsResponse) => any, requestBody: DescribeFileSystemsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DescribeFileSystems?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListTagsForResource(callback: (data : ListTagsForResourceResponse) => any, requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.ListTagsForResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.TagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UntagResource(callback: (data : UntagResourceResponse) => any, requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UntagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateFileSystem(callback: (data : UpdateFileSystemResponse) => any, requestBody: UpdateFileSystemRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UpdateFileSystem', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
