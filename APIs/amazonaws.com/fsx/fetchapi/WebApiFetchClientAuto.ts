export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelDataRepositoryTask(requestBody: CancelDataRepositoryTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelDataRepositoryTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CancelDataRepositoryTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateBackup(requestBody: CreateBackupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateBackup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDataRepositoryTask(requestBody: CreateDataRepositoryTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDataRepositoryTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateDataRepositoryTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateFileSystem(requestBody: CreateFileSystemRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFileSystemResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateFileSystem', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateFileSystemFromBackup(requestBody: CreateFileSystemFromBackupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFileSystemFromBackupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateFileSystemFromBackup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteBackup(requestBody: DeleteBackupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteBackup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteFileSystem(requestBody: DeleteFileSystemRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFileSystemResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteFileSystem', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeBackups(MaxResults: string, NextToken: string, requestBody: DescribeBackupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DescribeBackups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFileSystems(MaxResults: string, NextToken: string, requestBody: DescribeFileSystemsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFileSystemsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DescribeFileSystems?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateFileSystem(requestBody: UpdateFileSystemRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateFileSystemResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UpdateFileSystem', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
