...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelDataRepositoryTask(requestBody: CancelDataRepositoryTaskRequest, headersHandler?: () => HttpHeaders): Observable<CancelDataRepositoryTaskResponse> {
			return this.http.post<CancelDataRepositoryTaskResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CancelDataRepositoryTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateBackup(requestBody: CreateBackupRequest, headersHandler?: () => HttpHeaders): Observable<CreateBackupResponse> {
			return this.http.post<CreateBackupResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDataRepositoryTask(requestBody: CreateDataRepositoryTaskRequest, headersHandler?: () => HttpHeaders): Observable<CreateDataRepositoryTaskResponse> {
			return this.http.post<CreateDataRepositoryTaskResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateDataRepositoryTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateFileSystem(requestBody: CreateFileSystemRequest, headersHandler?: () => HttpHeaders): Observable<CreateFileSystemResponse> {
			return this.http.post<CreateFileSystemResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateFileSystem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateFileSystemFromBackup(requestBody: CreateFileSystemFromBackupRequest, headersHandler?: () => HttpHeaders): Observable<CreateFileSystemFromBackupResponse> {
			return this.http.post<CreateFileSystemFromBackupResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.CreateFileSystemFromBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DeleteBackup(requestBody: DeleteBackupRequest, headersHandler?: () => HttpHeaders): Observable<DeleteBackupResponse> {
			return this.http.post<DeleteBackupResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteFileSystem(requestBody: DeleteFileSystemRequest, headersHandler?: () => HttpHeaders): Observable<DeleteFileSystemResponse> {
			return this.http.post<DeleteFileSystemResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DeleteFileSystem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DescribeBackups(MaxResults: string, NextToken: string, requestBody: DescribeBackupsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeBackupsResponse> {
			return this.http.post<DescribeBackupsResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DescribeBackups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDataRepositoryTasks(MaxResults: string, NextToken: string, requestBody: DescribeDataRepositoryTasksRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDataRepositoryTasksResponse> {
		 ...
		 */
		DescribeFileSystems(MaxResults: string, NextToken: string, requestBody: DescribeFileSystemsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeFileSystemsResponse> {
			return this.http.post<DescribeFileSystemsResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.DescribeFileSystems?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateFileSystem(requestBody: UpdateFileSystemRequest, headersHandler?: () => HttpHeaders): Observable<UpdateFileSystemResponse> {
			return this.http.post<UpdateFileSystemResponse>(this.baseUri + '/#X-Amz-Target=AWSSimbaAPIService_v20180301.UpdateFileSystem', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
