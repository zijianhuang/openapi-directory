...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DescribeAcceleratorOfferings(requestBody: DescribeAcceleratorOfferingsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeAcceleratorOfferingsResponse> {
			return Axios.post<DescribeAcceleratorOfferingsResponse>(this.baseUri + '/describe-accelerator-offerings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAcceleratorTypes(headersHandler?: () => {[header: string]: string}): Promise<DescribeAcceleratorTypesResponse> {
			return Axios.get<DescribeAcceleratorTypesResponse>(this.baseUri + '/describe-accelerator-types', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeAccelerators(maxResults: string, nextToken: string, requestBody: DescribeAcceleratorsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeAcceleratorsResponse> {
			return Axios.post<DescribeAcceleratorsResponse>(this.baseUri + '/describe-accelerators?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(resourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return Axios.get<ListTagsForResourceResult>(this.baseUri + '/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResult> {
			return Axios.post<TagResourceResult>(this.baseUri + '/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResult> {
			return Axios.delete<UntagResourceResult>(this.baseUri + '/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
