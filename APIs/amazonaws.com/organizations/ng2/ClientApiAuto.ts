...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptHandshake(requestBody: AcceptHandshakeRequest, headersHandler?: () => HttpHeaders): Observable<AcceptHandshakeResponse> {
			return this.http.post<AcceptHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.AcceptHandshake', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		AttachPolicy(requestBody: AttachPolicyRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.AttachPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		CancelHandshake(requestBody: CancelHandshakeRequest, headersHandler?: () => HttpHeaders): Observable<CancelHandshakeResponse> {
			return this.http.post<CancelHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CancelHandshake', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAccount(requestBody: CreateAccountRequest, headersHandler?: () => HttpHeaders): Observable<CreateAccountResponse> {
			return this.http.post<CreateAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreateAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateGovCloudAccount(requestBody: CreateGovCloudAccountRequest, headersHandler?: () => HttpHeaders): Observable<CreateGovCloudAccountResponse> {
			return this.http.post<CreateGovCloudAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreateGovCloudAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateOrganization(requestBody: CreateOrganizationRequest, headersHandler?: () => HttpHeaders): Observable<CreateOrganizationResponse> {
			return this.http.post<CreateOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreateOrganization', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateOrganizationalUnit(requestBody: CreateOrganizationalUnitRequest, headersHandler?: () => HttpHeaders): Observable<CreateOrganizationalUnitResponse> {
			return this.http.post<CreateOrganizationalUnitResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreateOrganizationalUnit', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreatePolicy(requestBody: CreatePolicyRequest, headersHandler?: () => HttpHeaders): Observable<CreatePolicyResponse> {
			return this.http.post<CreatePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreatePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeclineHandshake(requestBody: DeclineHandshakeRequest, headersHandler?: () => HttpHeaders): Observable<DeclineHandshakeResponse> {
			return this.http.post<DeclineHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeclineHandshake', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteOrganization(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeleteOrganization', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteOrganizationalUnit(requestBody: DeleteOrganizationalUnitRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeleteOrganizationalUnit', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		DeletePolicy(requestBody: DeletePolicyRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeletePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterDelegatedAdministrator(requestBody: DeregisterDelegatedAdministratorRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeregisterDelegatedAdministrator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeAccount(requestBody: DescribeAccountRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAccountResponse> {
			return this.http.post<DescribeAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCreateAccountStatus(requestBody: DescribeCreateAccountStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeCreateAccountStatusResponse> {
			return this.http.post<DescribeCreateAccountStatusResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeCreateAccountStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEffectivePolicy(requestBody: DescribeEffectivePolicyRequest, headersHandler?: () => HttpHeaders): Observable<DescribeEffectivePolicyResponse> {
			return this.http.post<DescribeEffectivePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeEffectivePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeHandshake(requestBody: DescribeHandshakeRequest, headersHandler?: () => HttpHeaders): Observable<DescribeHandshakeResponse> {
			return this.http.post<DescribeHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeHandshake', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeOrganization(headersHandler?: () => HttpHeaders): Observable<DescribeOrganizationResponse> {
			return this.http.post<DescribeOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeOrganization', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeOrganizationalUnit(requestBody: DescribeOrganizationalUnitRequest, headersHandler?: () => HttpHeaders): Observable<DescribeOrganizationalUnitResponse> {
			return this.http.post<DescribeOrganizationalUnitResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeOrganizationalUnit', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribePolicy(requestBody: DescribePolicyRequest, headersHandler?: () => HttpHeaders): Observable<DescribePolicyResponse> {
			return this.http.post<DescribePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DetachPolicy(requestBody: DetachPolicyRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DetachPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DisableAWSServiceAccess(requestBody: DisableAWSServiceAccessRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DisableAWSServiceAccess', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DisablePolicyType(requestBody: DisablePolicyTypeRequest, headersHandler?: () => HttpHeaders): Observable<DisablePolicyTypeResponse> {
			return this.http.post<DisablePolicyTypeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DisablePolicyType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		EnableAWSServiceAccess(requestBody: EnableAWSServiceAccessRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.EnableAWSServiceAccess', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		EnableAllFeatures(requestBody: EnableAllFeaturesRequest, headersHandler?: () => HttpHeaders): Observable<EnableAllFeaturesResponse> {
			return this.http.post<EnableAllFeaturesResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.EnableAllFeatures', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		EnablePolicyType(requestBody: EnablePolicyTypeRequest, headersHandler?: () => HttpHeaders): Observable<EnablePolicyTypeResponse> {
			return this.http.post<EnablePolicyTypeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.EnablePolicyType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		InviteAccountToOrganization(requestBody: InviteAccountToOrganizationRequest, headersHandler?: () => HttpHeaders): Observable<InviteAccountToOrganizationResponse> {
			return this.http.post<InviteAccountToOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.InviteAccountToOrganization', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		LeaveOrganization(headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.LeaveOrganization', null, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ListAWSServiceAccessForOrganization(MaxResults: string, NextToken: string, requestBody: ListAWSServiceAccessForOrganizationRequest, headersHandler?: () => HttpHeaders): Observable<ListAWSServiceAccessForOrganizationResponse> {
			return this.http.post<ListAWSServiceAccessForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListAWSServiceAccessForOrganization?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAccounts(MaxResults: string, NextToken: string, requestBody: ListAccountsRequest, headersHandler?: () => HttpHeaders): Observable<ListAccountsResponse> {
			return this.http.post<ListAccountsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListAccounts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAccountsForParent(MaxResults: string, NextToken: string, requestBody: ListAccountsForParentRequest, headersHandler?: () => HttpHeaders): Observable<ListAccountsForParentResponse> {
		 ...
		 */
		ListChildren(MaxResults: string, NextToken: string, requestBody: ListChildrenRequest, headersHandler?: () => HttpHeaders): Observable<ListChildrenResponse> {
			return this.http.post<ListChildrenResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListChildren?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCreateAccountStatus(MaxResults: string, NextToken: string, requestBody: ListCreateAccountStatusRequest, headersHandler?: () => HttpHeaders): Observable<ListCreateAccountStatusResponse> {
			return this.http.post<ListCreateAccountStatusResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListCreateAccountStatus?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDelegatedAdministrators(MaxResults: string, NextToken: string, requestBody: ListDelegatedAdministratorsRequest, headersHandler?: () => HttpHeaders): Observable<ListDelegatedAdministratorsResponse> {
		 ...
		 */
		ListDelegatedServicesForAccount(MaxResults: string, NextToken: string, requestBody: ListDelegatedServicesForAccountRequest, headersHandler?: () => HttpHeaders): Observable<ListDelegatedServicesForAccountResponse> {
			return this.http.post<ListDelegatedServicesForAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListDelegatedServicesForAccount?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListHandshakesForAccount(MaxResults: string, NextToken: string, requestBody: ListHandshakesForAccountRequest, headersHandler?: () => HttpHeaders): Observable<ListHandshakesForAccountResponse> {
			return this.http.post<ListHandshakesForAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListHandshakesForAccount?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListHandshakesForOrganization(MaxResults: string, NextToken: string, requestBody: ListHandshakesForOrganizationRequest, headersHandler?: () => HttpHeaders): Observable<ListHandshakesForOrganizationResponse> {
			return this.http.post<ListHandshakesForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListHandshakesForOrganization?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListOrganizationalUnitsForParent(MaxResults: string, NextToken: string, requestBody: ListOrganizationalUnitsForParentRequest, headersHandler?: () => HttpHeaders): Observable<ListOrganizationalUnitsForParentResponse> {
		 ...
		 */
		ListParents(MaxResults: string, NextToken: string, requestBody: ListParentsRequest, headersHandler?: () => HttpHeaders): Observable<ListParentsResponse> {
			return this.http.post<ListParentsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListParents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListPolicies(MaxResults: string, NextToken: string, requestBody: ListPoliciesRequest, headersHandler?: () => HttpHeaders): Observable<ListPoliciesResponse> {
			return this.http.post<ListPoliciesResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListPolicies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPoliciesForTarget(MaxResults: string, NextToken: string, requestBody: ListPoliciesForTargetRequest, headersHandler?: () => HttpHeaders): Observable<ListPoliciesForTargetResponse> {
		 ...
		 */
		ListRoots(MaxResults: string, NextToken: string, requestBody: ListRootsRequest, headersHandler?: () => HttpHeaders): Observable<ListRootsResponse> {
			return this.http.post<ListRootsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListRoots?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForResource(NextToken: string, requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListTagsForResource?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTargetsForPolicy(MaxResults: string, NextToken: string, requestBody: ListTargetsForPolicyRequest, headersHandler?: () => HttpHeaders): Observable<ListTargetsForPolicyResponse> {
		 ...
		 * @return {void} Success
		 */
		MoveAccount(requestBody: MoveAccountRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.MoveAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RegisterDelegatedAdministrator(requestBody: RegisterDelegatedAdministratorRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.RegisterDelegatedAdministrator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RemoveAccountFromOrganization(requestBody: RemoveAccountFromOrganizationRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.RemoveAccountFromOrganization', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateOrganizationalUnit(requestBody: UpdateOrganizationalUnitRequest, headersHandler?: () => HttpHeaders): Observable<UpdateOrganizationalUnitResponse> {
			return this.http.post<UpdateOrganizationalUnitResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.UpdateOrganizationalUnit', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdatePolicy(requestBody: UpdatePolicyRequest, headersHandler?: () => HttpHeaders): Observable<UpdatePolicyResponse> {
			return this.http.post<UpdatePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.UpdatePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
