...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptHandshake(requestBody: AcceptHandshakeRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptHandshakeResponse> {
			return Axios.post<AcceptHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.AcceptHandshake', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		AttachPolicy(requestBody: AttachPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.AttachPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		CancelHandshake(requestBody: CancelHandshakeRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelHandshakeResponse> {
			return Axios.post<CancelHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CancelHandshake', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAccount(requestBody: CreateAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAccountResponse> {
			return Axios.post<CreateAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreateAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateOrganization(requestBody: CreateOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateOrganizationResponse> {
			return Axios.post<CreateOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreateOrganization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePolicy(requestBody: CreatePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePolicyResponse> {
			return Axios.post<CreatePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.CreatePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeclineHandshake(requestBody: DeclineHandshakeRequest, headersHandler?: () => {[header: string]: string}): Promise<DeclineHandshakeResponse> {
			return Axios.post<DeclineHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeclineHandshake', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteOrganization(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeleteOrganization', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteOrganizationalUnit(requestBody: DeleteOrganizationalUnitRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeleteOrganizationalUnit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePolicy(requestBody: DeletePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeletePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterDelegatedAdministrator(requestBody: DeregisterDelegatedAdministratorRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DeregisterDelegatedAdministrator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DescribeAccount(requestBody: DescribeAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountResponse> {
			return Axios.post<DescribeAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEffectivePolicy(requestBody: DescribeEffectivePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEffectivePolicyResponse> {
			return Axios.post<DescribeEffectivePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeEffectivePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeHandshake(requestBody: DescribeHandshakeRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHandshakeResponse> {
			return Axios.post<DescribeHandshakeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeHandshake', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeOrganization(headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationResponse> {
			return Axios.post<DescribeOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeOrganization', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeOrganizationalUnit(requestBody: DescribeOrganizationalUnitRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationalUnitResponse> {
			return Axios.post<DescribeOrganizationalUnitResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribeOrganizationalUnit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePolicy(requestBody: DescribePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePolicyResponse> {
			return Axios.post<DescribePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DescribePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DetachPolicy(requestBody: DetachPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DetachPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DisableAWSServiceAccess(requestBody: DisableAWSServiceAccessRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DisableAWSServiceAccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DisablePolicyType(requestBody: DisablePolicyTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<DisablePolicyTypeResponse> {
			return Axios.post<DisablePolicyTypeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.DisablePolicyType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		EnableAWSServiceAccess(requestBody: EnableAWSServiceAccessRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.EnableAWSServiceAccess', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		EnableAllFeatures(requestBody: EnableAllFeaturesRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableAllFeaturesResponse> {
			return Axios.post<EnableAllFeaturesResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.EnableAllFeatures', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnablePolicyType(requestBody: EnablePolicyTypeRequest, headersHandler?: () => {[header: string]: string}): Promise<EnablePolicyTypeResponse> {
			return Axios.post<EnablePolicyTypeResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.EnablePolicyType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InviteAccountToOrganization(requestBody: InviteAccountToOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<InviteAccountToOrganizationResponse> {
			return Axios.post<InviteAccountToOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.InviteAccountToOrganization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		LeaveOrganization(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.LeaveOrganization', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		ListAWSServiceAccessForOrganization(MaxResults: string, NextToken: string, requestBody: ListAWSServiceAccessForOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAWSServiceAccessForOrganizationResponse> {
			return Axios.post<ListAWSServiceAccessForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListAWSServiceAccessForOrganization?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAccounts(MaxResults: string, NextToken: string, requestBody: ListAccountsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAccountsResponse> {
			return Axios.post<ListAccountsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListAccounts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListChildren(MaxResults: string, NextToken: string, requestBody: ListChildrenRequest, headersHandler?: () => {[header: string]: string}): Promise<ListChildrenResponse> {
			return Axios.post<ListChildrenResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListChildren?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCreateAccountStatus(MaxResults: string, NextToken: string, requestBody: ListCreateAccountStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCreateAccountStatusResponse> {
			return Axios.post<ListCreateAccountStatusResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListCreateAccountStatus?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDelegatedServicesForAccount(MaxResults: string, NextToken: string, requestBody: ListDelegatedServicesForAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDelegatedServicesForAccountResponse> {
			return Axios.post<ListDelegatedServicesForAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListDelegatedServicesForAccount?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListHandshakesForAccount(MaxResults: string, NextToken: string, requestBody: ListHandshakesForAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHandshakesForAccountResponse> {
			return Axios.post<ListHandshakesForAccountResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListHandshakesForAccount?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListHandshakesForOrganization(MaxResults: string, NextToken: string, requestBody: ListHandshakesForOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHandshakesForOrganizationResponse> {
			return Axios.post<ListHandshakesForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListHandshakesForOrganization?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListOrganizationalUnitsForParent(MaxResults: string, NextToken: string, requestBody: ListOrganizationalUnitsForParentRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOrganizationalUnitsForParentResponse> {
			return Axios.post<ListOrganizationalUnitsForParentResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListOrganizationalUnitsForParent?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListParents(MaxResults: string, NextToken: string, requestBody: ListParentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListParentsResponse> {
			return Axios.post<ListParentsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListParents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListPolicies(MaxResults: string, NextToken: string, requestBody: ListPoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPoliciesResponse> {
			return Axios.post<ListPoliciesResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListPolicies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListPoliciesForTarget(MaxResults: string, NextToken: string, requestBody: ListPoliciesForTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPoliciesForTargetResponse> {
			return Axios.post<ListPoliciesForTargetResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListPoliciesForTarget?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRoots(MaxResults: string, NextToken: string, requestBody: ListRootsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRootsResponse> {
			return Axios.post<ListRootsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListRoots?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(NextToken: string, requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListTagsForResource?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTargetsForPolicy(MaxResults: string, NextToken: string, requestBody: ListTargetsForPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsForPolicyResponse> {
			return Axios.post<ListTargetsForPolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.ListTargetsForPolicy?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		MoveAccount(requestBody: MoveAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.MoveAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RegisterDelegatedAdministrator(requestBody: RegisterDelegatedAdministratorRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.RegisterDelegatedAdministrator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		RemoveAccountFromOrganization(requestBody: RemoveAccountFromOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.RemoveAccountFromOrganization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UpdateOrganizationalUnit(requestBody: UpdateOrganizationalUnitRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateOrganizationalUnitResponse> {
			return Axios.post<UpdateOrganizationalUnitResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.UpdateOrganizationalUnit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdatePolicy(requestBody: UpdatePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdatePolicyResponse> {
			return Axios.post<UpdatePolicyResponse>(this.baseUri + '/#X-Amz-Target=AWSOrganizationsV20161128.UpdatePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
