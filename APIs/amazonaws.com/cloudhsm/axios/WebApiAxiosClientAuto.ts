...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToResource(requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResponse> {
			return Axios.post<AddTagsToResourceResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateHapg(requestBody: CreateHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHapgResponse> {
			return Axios.post<CreateHapgResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.CreateHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateHsm(requestBody: CreateHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHsmResponse> {
			return Axios.post<CreateHsmResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.CreateHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateLunaClient(requestBody: CreateLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLunaClientResponse> {
			return Axios.post<CreateLunaClientResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.CreateLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteHapg(requestBody: DeleteHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteHapgResponse> {
			return Axios.post<DeleteHapgResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.DeleteHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteHsm(requestBody: DeleteHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteHsmResponse> {
			return Axios.post<DeleteHsmResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.DeleteHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteLunaClient(requestBody: DeleteLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLunaClientResponse> {
			return Axios.post<DeleteLunaClientResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.DeleteLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeHapg(requestBody: DescribeHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHapgResponse> {
			return Axios.post<DescribeHapgResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.DescribeHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeHsm(requestBody: DescribeHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHsmResponse> {
			return Axios.post<DescribeHsmResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.DescribeHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeLunaClient(requestBody: DescribeLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLunaClientResponse> {
			return Axios.post<DescribeLunaClientResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.DescribeLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetConfig(requestBody: GetConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConfigResponse> {
			return Axios.post<GetConfigResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.GetConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAvailableZones(requestBody: ListAvailableZonesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAvailableZonesResponse> {
			return Axios.post<ListAvailableZonesResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ListAvailableZones', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListHapgs(requestBody: ListHapgsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHapgsResponse> {
			return Axios.post<ListHapgsResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ListHapgs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListHsms(requestBody: ListHsmsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHsmsResponse> {
			return Axios.post<ListHsmsResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ListHsms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListLunaClients(requestBody: ListLunaClientsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLunaClientsResponse> {
			return Axios.post<ListLunaClientsResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ListLunaClients', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyHapg(requestBody: ModifyHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyHapgResponse> {
			return Axios.post<ModifyHapgResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ModifyHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyHsm(requestBody: ModifyHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyHsmResponse> {
			return Axios.post<ModifyHsmResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ModifyHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyLunaClient(requestBody: ModifyLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyLunaClientResponse> {
			return Axios.post<ModifyLunaClientResponse>(this.baseUri + '/#X-Amz-Target=CloudHsmFrontendService.ModifyLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
