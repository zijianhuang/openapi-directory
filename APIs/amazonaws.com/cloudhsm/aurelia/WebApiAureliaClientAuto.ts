...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToResource(requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateHapg(requestBody: CreateHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHapgResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.CreateHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateHsm(requestBody: CreateHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateHsmResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.CreateHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLunaClient(requestBody: CreateLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateLunaClientResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.CreateLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteHapg(requestBody: DeleteHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteHapgResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.DeleteHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteHsm(requestBody: DeleteHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteHsmResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.DeleteHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLunaClient(requestBody: DeleteLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteLunaClientResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.DeleteLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeHapg(requestBody: DescribeHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHapgResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.DescribeHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeHsm(requestBody: DescribeHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeHsmResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.DescribeHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLunaClient(requestBody: DescribeLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeLunaClientResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.DescribeLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetConfig(requestBody: GetConfigRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConfigResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.GetConfig', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAvailableZones(requestBody: ListAvailableZonesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAvailableZonesResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ListAvailableZones', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListHapgs(requestBody: ListHapgsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHapgsResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ListHapgs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListHsms(requestBody: ListHsmsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListHsmsResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ListHsms', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListLunaClients(requestBody: ListLunaClientsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListLunaClientsResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ListLunaClients', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyHapg(requestBody: ModifyHapgRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyHapgResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ModifyHapg', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyHsm(requestBody: ModifyHsmRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyHsmResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ModifyHsm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyLunaClient(requestBody: ModifyLunaClientRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyLunaClientResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.ModifyLunaClient', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResponse> {
			return this.http.post('/#X-Amz-Target=CloudHsmFrontendService.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
