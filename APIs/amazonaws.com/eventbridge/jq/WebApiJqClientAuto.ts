...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		ActivateEventSource(callback: (data : void) => any, requestBody: ActivateEventSourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ActivateEventSource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateEventBus(callback: (data : CreateEventBusResponse) => any, requestBody: CreateEventBusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.CreateEventBus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreatePartnerEventSource(callback: (data : CreatePartnerEventSourceResponse) => any, requestBody: CreatePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.CreatePartnerEventSource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeactivateEventSource(callback: (data : void) => any, requestBody: DeactivateEventSourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeactivateEventSource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEventBus(callback: (data : void) => any, requestBody: DeleteEventBusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteEventBus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeletePartnerEventSource(callback: (data : void) => any, requestBody: DeletePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeletePartnerEventSource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRule(callback: (data : void) => any, requestBody: DeleteRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeEventBus(callback: (data : DescribeEventBusResponse) => any, requestBody: DescribeEventBusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventBus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeEventSource(callback: (data : DescribeEventSourceResponse) => any, requestBody: DescribeEventSourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventSource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribePartnerEventSource(callback: (data : DescribePartnerEventSourceResponse) => any, requestBody: DescribePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribePartnerEventSource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeRule(callback: (data : DescribeRuleResponse) => any, requestBody: DescribeRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DisableRule(callback: (data : void) => any, requestBody: DisableRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.DisableRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		EnableRule(callback: (data : void) => any, requestBody: EnableRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.EnableRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEventBuses(callback: (data : ListEventBusesResponse) => any, requestBody: ListEventBusesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventBuses', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEventSources(callback: (data : ListEventSourcesResponse) => any, requestBody: ListEventSourcesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventSources', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPartnerEventSourceAccounts(callback: (data : ListPartnerEventSourceAccountsResponse) => any, requestBody: ListPartnerEventSourceAccountsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSourceAccounts', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPartnerEventSources(callback: (data : ListPartnerEventSourcesResponse) => any, requestBody: ListPartnerEventSourcesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSources', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListRuleNamesByTarget(callback: (data : ListRuleNamesByTargetResponse) => any, requestBody: ListRuleNamesByTargetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRuleNamesByTarget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListRules(callback: (data : ListRulesResponse) => any, requestBody: ListRulesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRules', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListTagsForResource(callback: (data : ListTagsForResourceResponse) => any, requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTagsForResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTargetsByRule(callback: (data : ListTargetsByRuleResponse) => any, requestBody: ListTargetsByRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTargetsByRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutEvents(callback: (data : PutEventsResponse) => any, requestBody: PutEventsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.PutEvents', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutPartnerEvents(callback: (data : PutPartnerEventsResponse) => any, requestBody: PutPartnerEventsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPartnerEvents', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		PutPermission(callback: (data : void) => any, requestBody: PutPermissionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutRule(callback: (data : PutRuleResponse) => any, requestBody: PutRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.PutRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutTargets(callback: (data : PutTargetsResponse) => any, requestBody: PutTargetsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.PutTargets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RemovePermission(callback: (data : void) => any, requestBody: RemovePermissionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.RemovePermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RemoveTargets(callback: (data : RemoveTargetsResponse) => any, requestBody: RemoveTargetsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.RemoveTargets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.TagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TestEventPattern(callback: (data : TestEventPatternResponse) => any, requestBody: TestEventPatternRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.TestEventPattern', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UntagResource(callback: (data : UntagResourceResponse) => any, requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSEvents.UntagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
