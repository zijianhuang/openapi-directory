export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		ActivateEventSource(requestBody: ActivateEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ActivateEventSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateEventBus(requestBody: CreateEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEventBusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.CreateEventBus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreatePartnerEventSource(requestBody: CreatePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePartnerEventSourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.CreatePartnerEventSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeactivateEventSource(requestBody: DeactivateEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DeactivateEventSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEventBus(requestBody: DeleteEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteEventBus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeletePartnerEventSource(requestBody: DeletePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DeletePartnerEventSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteRule(requestBody: DeleteRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DeleteRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeEventBus(requestBody: DescribeEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventBusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventBus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventSource(requestBody: DescribeEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventSourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeEventSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribePartnerEventSource(requestBody: DescribePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePartnerEventSourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribePartnerEventSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRule(requestBody: DescribeRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRuleResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DescribeRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DisableRule(requestBody: DisableRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.DisableRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		EnableRule(requestBody: EnableRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.EnableRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListEventBuses(requestBody: ListEventBusesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventBusesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventBuses', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEventSources(requestBody: ListEventSourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventSourcesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListEventSources', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPartnerEventSourceAccounts(requestBody: ListPartnerEventSourceAccountsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPartnerEventSourceAccountsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSourceAccounts', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPartnerEventSources(requestBody: ListPartnerEventSourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPartnerEventSourcesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListPartnerEventSources', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRuleNamesByTarget(requestBody: ListRuleNamesByTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRuleNamesByTargetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRuleNamesByTarget', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRules(requestBody: ListRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRulesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListRules', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTargetsByRule(requestBody: ListTargetsByRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsByRuleResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.ListTargetsByRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutEvents(requestBody: PutEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutEventsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.PutEvents', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutPartnerEvents(requestBody: PutPartnerEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutPartnerEventsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPartnerEvents', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		PutPermission(requestBody: PutPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.PutPermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		PutRule(requestBody: PutRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRuleResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.PutRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutTargets(requestBody: PutTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutTargetsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.PutTargets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RemovePermission(requestBody: RemovePermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.RemovePermission', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RemoveTargets(requestBody: RemoveTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTargetsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.RemoveTargets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TestEventPattern(requestBody: TestEventPatternRequest, headersHandler?: () => {[header: string]: string}): Promise<TestEventPatternResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.TestEventPattern', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSEvents.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
