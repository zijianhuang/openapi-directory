...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ActivateEventSource(requestBody: ActivateEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ActivateEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateEventBus(requestBody: CreateEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEventBusResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.CreateEventBus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePartnerEventSource(requestBody: CreatePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePartnerEventSourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.CreatePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeactivateEventSource(requestBody: DeactivateEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DeactivateEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteEventBus(requestBody: DeleteEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DeleteEventBus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeletePartnerEventSource(requestBody: DeletePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DeletePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteRule(requestBody: DeleteRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DeleteRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeEventBus(requestBody: DescribeEventBusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventBusResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DescribeEventBus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeEventSource(requestBody: DescribeEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventSourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DescribeEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribePartnerEventSource(requestBody: DescribePartnerEventSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePartnerEventSourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DescribePartnerEventSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeRule(requestBody: DescribeRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRuleResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DescribeRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableRule(requestBody: DisableRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.DisableRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		EnableRule(requestBody: EnableRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.EnableRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListEventBuses(requestBody: ListEventBusesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventBusesResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListEventBuses', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListEventSources(requestBody: ListEventSourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventSourcesResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListEventSources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPartnerEventSourceAccounts(requestBody: ListPartnerEventSourceAccountsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPartnerEventSourceAccountsResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListPartnerEventSourceAccounts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPartnerEventSources(requestBody: ListPartnerEventSourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPartnerEventSourcesResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListPartnerEventSources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListRuleNamesByTarget(requestBody: ListRuleNamesByTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRuleNamesByTargetResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListRuleNamesByTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListRules(requestBody: ListRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRulesResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTargetsByRule(requestBody: ListTargetsByRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsByRuleResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.ListTargetsByRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutEvents(requestBody: PutEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutEventsResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.PutEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutPartnerEvents(requestBody: PutPartnerEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutPartnerEventsResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.PutPartnerEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutPermission(requestBody: PutPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.PutPermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutRule(requestBody: PutRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRuleResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.PutRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutTargets(requestBody: PutTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutTargetsResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.PutTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemovePermission(requestBody: RemovePermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSEvents.RemovePermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RemoveTargets(requestBody: RemoveTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTargetsResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.RemoveTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TestEventPattern(requestBody: TestEventPatternRequest, headersHandler?: () => {[header: string]: string}): Promise<TestEventPatternResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.TestEventPattern', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSEvents.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
