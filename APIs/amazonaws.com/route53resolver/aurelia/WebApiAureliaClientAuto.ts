...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateResolverEndpointIpAddress(requestBody: AssociateResolverEndpointIpAddressRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateResolverEndpointIpAddressResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.AssociateResolverEndpointIpAddress', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateResolverRule(requestBody: AssociateResolverRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateResolverRuleResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.AssociateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateResolverEndpoint(requestBody: CreateResolverEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResolverEndpointResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.CreateResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateResolverRule(requestBody: CreateResolverRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResolverRuleResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.CreateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResolverEndpoint(requestBody: DeleteResolverEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResolverEndpointResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.DeleteResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResolverRule(requestBody: DeleteResolverRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResolverRuleResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.DeleteResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateResolverEndpointIpAddress(requestBody: DisassociateResolverEndpointIpAddressRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateResolverEndpointIpAddressResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.DisassociateResolverEndpointIpAddress', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateResolverRule(requestBody: DisassociateResolverRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateResolverRuleResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.DisassociateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResolverEndpoint(requestBody: GetResolverEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResolverEndpointResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.GetResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResolverRule(requestBody: GetResolverRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResolverRuleResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.GetResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResolverRuleAssociation(requestBody: GetResolverRuleAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResolverRuleAssociationResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.GetResolverRuleAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetResolverRulePolicy(requestBody: GetResolverRulePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetResolverRulePolicyResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.GetResolverRulePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutResolverRulePolicy(requestBody: PutResolverRulePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResolverRulePolicyResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.PutResolverRulePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateResolverEndpoint(requestBody: UpdateResolverEndpointRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateResolverEndpointResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.UpdateResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateResolverRule(requestBody: UpdateResolverRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateResolverRuleResponse> {
			return this.http.post('/#X-Amz-Target=Route53Resolver.UpdateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
