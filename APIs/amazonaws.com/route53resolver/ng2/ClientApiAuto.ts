...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateResolverEndpointIpAddress(requestBody: AssociateResolverEndpointIpAddressRequest, headersHandler?: () => HttpHeaders): Observable<AssociateResolverEndpointIpAddressResponse> {
			return this.http.post<AssociateResolverEndpointIpAddressResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.AssociateResolverEndpointIpAddress', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssociateResolverRule(requestBody: AssociateResolverRuleRequest, headersHandler?: () => HttpHeaders): Observable<AssociateResolverRuleResponse> {
			return this.http.post<AssociateResolverRuleResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.AssociateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateResolverEndpoint(requestBody: CreateResolverEndpointRequest, headersHandler?: () => HttpHeaders): Observable<CreateResolverEndpointResponse> {
			return this.http.post<CreateResolverEndpointResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.CreateResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateResolverRule(requestBody: CreateResolverRuleRequest, headersHandler?: () => HttpHeaders): Observable<CreateResolverRuleResponse> {
			return this.http.post<CreateResolverRuleResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.CreateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteResolverEndpoint(requestBody: DeleteResolverEndpointRequest, headersHandler?: () => HttpHeaders): Observable<DeleteResolverEndpointResponse> {
			return this.http.post<DeleteResolverEndpointResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.DeleteResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteResolverRule(requestBody: DeleteResolverRuleRequest, headersHandler?: () => HttpHeaders): Observable<DeleteResolverRuleResponse> {
			return this.http.post<DeleteResolverRuleResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.DeleteResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateResolverEndpointIpAddress(requestBody: DisassociateResolverEndpointIpAddressRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateResolverEndpointIpAddressResponse> {
			return this.http.post<DisassociateResolverEndpointIpAddressResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.DisassociateResolverEndpointIpAddress', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateResolverRule(requestBody: DisassociateResolverRuleRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateResolverRuleResponse> {
			return this.http.post<DisassociateResolverRuleResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.DisassociateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResolverEndpoint(requestBody: GetResolverEndpointRequest, headersHandler?: () => HttpHeaders): Observable<GetResolverEndpointResponse> {
			return this.http.post<GetResolverEndpointResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResolverRule(requestBody: GetResolverRuleRequest, headersHandler?: () => HttpHeaders): Observable<GetResolverRuleResponse> {
			return this.http.post<GetResolverRuleResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResolverRuleAssociation(requestBody: GetResolverRuleAssociationRequest, headersHandler?: () => HttpHeaders): Observable<GetResolverRuleAssociationResponse> {
			return this.http.post<GetResolverRuleAssociationResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverRuleAssociation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetResolverRulePolicy(requestBody: GetResolverRulePolicyRequest, headersHandler?: () => HttpHeaders): Observable<GetResolverRulePolicyResponse> {
			return this.http.post<GetResolverRulePolicyResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverRulePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResolverEndpointIpAddresses(MaxResults: string, NextToken: string, requestBody: ListResolverEndpointIpAddressesRequest, headersHandler?: () => HttpHeaders): Observable<ListResolverEndpointIpAddressesResponse> {
			return this.http.post<ListResolverEndpointIpAddressesResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListResolverEndpointIpAddresses?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResolverEndpoints(MaxResults: string, NextToken: string, requestBody: ListResolverEndpointsRequest, headersHandler?: () => HttpHeaders): Observable<ListResolverEndpointsResponse> {
		 ...
		 */
		ListResolverRuleAssociations(MaxResults: string, NextToken: string, requestBody: ListResolverRuleAssociationsRequest, headersHandler?: () => HttpHeaders): Observable<ListResolverRuleAssociationsResponse> {
			return this.http.post<ListResolverRuleAssociationsResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListResolverRuleAssociations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListResolverRules(MaxResults: string, NextToken: string, requestBody: ListResolverRulesRequest, headersHandler?: () => HttpHeaders): Observable<ListResolverRulesResponse> {
			return this.http.post<ListResolverRulesResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListResolverRules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutResolverRulePolicy(requestBody: PutResolverRulePolicyRequest, headersHandler?: () => HttpHeaders): Observable<PutResolverRulePolicyResponse> {
			return this.http.post<PutResolverRulePolicyResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.PutResolverRulePolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateResolverEndpoint(requestBody: UpdateResolverEndpointRequest, headersHandler?: () => HttpHeaders): Observable<UpdateResolverEndpointResponse> {
			return this.http.post<UpdateResolverEndpointResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.UpdateResolverEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateResolverRule(requestBody: UpdateResolverRuleRequest, headersHandler?: () => HttpHeaders): Observable<UpdateResolverRuleResponse> {
			return this.http.post<UpdateResolverRuleResponse>(this.baseUri + '/#X-Amz-Target=Route53Resolver.UpdateResolverRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
