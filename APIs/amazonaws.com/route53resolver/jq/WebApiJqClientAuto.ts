...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateResolverEndpointIpAddress(callback: (data : AssociateResolverEndpointIpAddressResponse) => any, requestBody: AssociateResolverEndpointIpAddressRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.AssociateResolverEndpointIpAddress', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssociateResolverRule(callback: (data : AssociateResolverRuleResponse) => any, requestBody: AssociateResolverRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.AssociateResolverRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateResolverEndpoint(callback: (data : CreateResolverEndpointResponse) => any, requestBody: CreateResolverEndpointRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.CreateResolverEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateResolverRule(callback: (data : CreateResolverRuleResponse) => any, requestBody: CreateResolverRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.CreateResolverRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteResolverEndpoint(callback: (data : DeleteResolverEndpointResponse) => any, requestBody: DeleteResolverEndpointRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.DeleteResolverEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteResolverRule(callback: (data : DeleteResolverRuleResponse) => any, requestBody: DeleteResolverRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.DeleteResolverRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateResolverEndpointIpAddress(callback: (data : DisassociateResolverEndpointIpAddressResponse) => any, requestBody: DisassociateResolverEndpointIpAddressRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.DisassociateResolverEndpointIpAddress', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisassociateResolverRule(callback: (data : DisassociateResolverRuleResponse) => any, requestBody: DisassociateResolverRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.DisassociateResolverRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResolverEndpoint(callback: (data : GetResolverEndpointResponse) => any, requestBody: GetResolverEndpointRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResolverRule(callback: (data : GetResolverRuleResponse) => any, requestBody: GetResolverRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResolverRuleAssociation(callback: (data : GetResolverRuleAssociationResponse) => any, requestBody: GetResolverRuleAssociationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverRuleAssociation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetResolverRulePolicy(callback: (data : GetResolverRulePolicyResponse) => any, requestBody: GetResolverRulePolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.GetResolverRulePolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResolverEndpointIpAddresses(MaxResults: string, NextToken: string, callback: (data : ListResolverEndpointIpAddressesResponse) => any, requestBody: ListResolverEndpointIpAddressesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListResolverEndpointIpAddresses?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResolverEndpoints(MaxResults: string, NextToken: string, callback: (data : ListResolverEndpointsResponse) => any, requestBody: ListResolverEndpointsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListResolverEndpoints?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResolverRuleAssociations(MaxResults: string, NextToken: string, callback: (data : ListResolverRuleAssociationsResponse) => any, requestBody: ListResolverRuleAssociationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListResolverRuleAssociations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResolverRules(MaxResults: string, NextToken: string, callback: (data : ListResolverRulesResponse) => any, requestBody: ListResolverRulesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListResolverRules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListTagsForResource(callback: (data : ListTagsForResourceResponse) => any, requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.ListTagsForResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutResolverRulePolicy(callback: (data : PutResolverRulePolicyResponse) => any, requestBody: PutResolverRulePolicyRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.PutResolverRulePolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.TagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UntagResource(callback: (data : UntagResourceResponse) => any, requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.UntagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateResolverEndpoint(callback: (data : UpdateResolverEndpointResponse) => any, requestBody: UpdateResolverEndpointRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.UpdateResolverEndpoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateResolverRule(callback: (data : UpdateResolverRuleResponse) => any, requestBody: UpdateResolverRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Route53Resolver.UpdateResolverRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
