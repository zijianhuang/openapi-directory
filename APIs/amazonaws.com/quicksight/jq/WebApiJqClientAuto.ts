...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, callback: (data : CancelIngestionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateIngestion(DataSetId: string, IngestionId: string, AwsAccountId: string, callback: (data : CreateIngestionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, callback: (data : DescribeIngestionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateDashboard(AwsAccountId: string, DashboardId: string, callback: (data : CreateDashboardResponse) => any, requestBody: CreateDashboardBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDashboard(AwsAccountId: string, DashboardId: string, version_number: number, callback: (data : DeleteDashboardResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '&version_number=' + version_number, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDashboard(AwsAccountId: string, DashboardId: string, version_number: number, alias_name: string, callback: (data : DescribeDashboardResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '&version_number=' + version_number + '&alias_name=' + (alias_name == null ? '' : encodeURIComponent(alias_name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDashboard(AwsAccountId: string, DashboardId: string, callback: (data : UpdateDashboardResponse) => any, requestBody: UpdateDashboardBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateDataSet(AwsAccountId: string, callback: (data : CreateDataSetResponse) => any, requestBody: CreateDataSetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDataSets(AwsAccountId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, callback: (data : ListDataSetsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateDataSource(AwsAccountId: string, callback: (data : CreateDataSourceResponse) => any, requestBody: CreateDataSourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDataSources(AwsAccountId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, callback: (data : ListDataSourcesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateGroup(AwsAccountId: string, Namespace: string, callback: (data : CreateGroupResponse) => any, requestBody: CreateGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListGroups(AwsAccountId: string, next_token: string, max_results: number, Namespace: string, callback: (data : ListGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateGroupMembership(MemberName: string, GroupName: string, AwsAccountId: string, Namespace: string, callback: (data : CreateGroupMembershipResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		DeleteGroupMembership(MemberName: string, GroupName: string, AwsAccountId: string, Namespace: string, callback: (data : DeleteGroupMembershipResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		CreateIAMPolicyAssignment(AwsAccountId: string, Namespace: string, callback: (data : CreateIAMPolicyAssignmentResponse) => any, requestBody: CreateIAMPolicyAssignmentBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTemplate(AwsAccountId: string, TemplateId: string, callback: (data : CreateTemplateResponse) => any, requestBody: CreateTemplateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTemplate(AwsAccountId: string, TemplateId: string, version_number: number, callback: (data : DeleteTemplateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '&version_number=' + version_number, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeTemplate(AwsAccountId: string, TemplateId: string, version_number: number, alias_name: string, callback: (data : DescribeTemplateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '&version_number=' + version_number + '&alias_name=' + (alias_name == null ? '' : encodeURIComponent(alias_name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateTemplate(AwsAccountId: string, TemplateId: string, callback: (data : UpdateTemplateResponse) => any, requestBody: UpdateTemplateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, callback: (data : CreateTemplateAliasResponse) => any, requestBody: CreateTemplateAliasBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, callback: (data : DeleteTemplateAliasResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, callback: (data : DescribeTemplateAliasResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, callback: (data : UpdateTemplateAliasResponse) => any, requestBody: UpdateTemplateAliasBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDataSet(AwsAccountId: string, DataSetId: string, callback: (data : DeleteDataSetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDataSet(AwsAccountId: string, DataSetId: string, callback: (data : DescribeDataSetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDataSet(AwsAccountId: string, DataSetId: string, callback: (data : UpdateDataSetResponse) => any, requestBody: UpdateDataSetBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDataSource(AwsAccountId: string, DataSourceId: string, callback: (data : DeleteDataSourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDataSource(AwsAccountId: string, DataSourceId: string, callback: (data : DescribeDataSourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDataSource(AwsAccountId: string, DataSourceId: string, callback: (data : UpdateDataSourceResponse) => any, requestBody: UpdateDataSourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteGroup(GroupName: string, AwsAccountId: string, Namespace: string, callback: (data : DeleteGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeGroup(GroupName: string, AwsAccountId: string, Namespace: string, callback: (data : DescribeGroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateGroup(GroupName: string, AwsAccountId: string, Namespace: string, callback: (data : UpdateGroupResponse) => any, requestBody: UpdateGroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, callback: (data : DeleteIAMPolicyAssignmentResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespace/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteUser(UserName: string, AwsAccountId: string, Namespace: string, callback: (data : DeleteUserResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeUser(UserName: string, AwsAccountId: string, Namespace: string, callback: (data : DescribeUserResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateUser(UserName: string, AwsAccountId: string, Namespace: string, callback: (data : UpdateUserResponse) => any, requestBody: UpdateUserBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteUserByPrincipalId(PrincipalId: string, AwsAccountId: string, Namespace: string, callback: (data : DeleteUserByPrincipalIdResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/user-principals/' + (PrincipalId == null ? '' : encodeURIComponent(PrincipalId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDashboardPermissions(AwsAccountId: string, DashboardId: string, callback: (data : DescribeDashboardPermissionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/permissions', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDashboardPermissions(AwsAccountId: string, DashboardId: string, callback: (data : UpdateDashboardPermissionsResponse) => any, requestBody: UpdateDashboardPermissionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/permissions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDataSetPermissions(AwsAccountId: string, DataSetId: string, callback: (data : DescribeDataSetPermissionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/permissions', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDataSetPermissions(AwsAccountId: string, DataSetId: string, callback: (data : UpdateDataSetPermissionsResponse) => any, requestBody: UpdateDataSetPermissionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/permissions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDataSourcePermissions(AwsAccountId: string, DataSourceId: string, callback: (data : DescribeDataSourcePermissionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)) + '/permissions', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDataSourcePermissions(AwsAccountId: string, DataSourceId: string, callback: (data : UpdateDataSourcePermissionsResponse) => any, requestBody: UpdateDataSourcePermissionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)) + '/permissions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, callback: (data : DescribeIAMPolicyAssignmentResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, callback: (data : UpdateIAMPolicyAssignmentResponse) => any, requestBody: UpdateIAMPolicyAssignmentBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTemplatePermissions(AwsAccountId: string, TemplateId: string, callback: (data : DescribeTemplatePermissionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/permissions', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateTemplatePermissions(AwsAccountId: string, TemplateId: string, callback: (data : UpdateTemplatePermissionsResponse) => any, requestBody: UpdateTemplatePermissionsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/permissions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDashboardEmbedUrl(AwsAccountId: string, DashboardId: string, creds_type: UserIdentityType, session_lifetime: number, undo_redo_disabled: boolean, reset_disabled: boolean, user_arn: string, callback: (data : GetDashboardEmbedUrlResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/embed-url#creds-type&creds_type=' + creds_type + '&session_lifetime=' + session_lifetime + '&undo_redo_disabled=' + undo_redo_disabled + '&reset_disabled=' + reset_disabled + '&user_arn=' + (user_arn == null ? '' : encodeURIComponent(user_arn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListDashboardVersions(AwsAccountId: string, DashboardId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, callback: (data : ListDashboardVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ListDashboards(AwsAccountId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, callback: (data : ListDashboardsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListGroupMemberships(GroupName: string, next_token: string, max_results: number, AwsAccountId: string, Namespace: string, callback: (data : ListGroupMembershipsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '/members&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListIAMPolicyAssignments(AwsAccountId: string, Namespace: string, next_token: string, max_results: number, callback: (data : ListIAMPolicyAssignmentsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListIAMPolicyAssignmentsForUser(AwsAccountId: string, UserName: string, next_token: string, max_results: number, Namespace: string, callback: (data : ListIAMPolicyAssignmentsForUserResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)) + '/iam-policy-assignments&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListIngestions(DataSetId: string, next_token: string, AwsAccountId: string, max_results: number, MaxResults: string, NextToken: string, callback: (data : ListIngestionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		ListTagsForResource(ResourceArn: string, callback: (data : ListTagsForResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', callback, this.error, this.statusCode, headersHandler);
		}
		...
		TagResource(ResourceArn: string, callback: (data : TagResourceResponse) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTemplateAliases(AwsAccountId: string, TemplateId: string, next_token: string, max_result: number, MaxResults: string, NextToken: string, callback: (data : ListTemplateAliasesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_result=' + max_result + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListTemplateVersions(AwsAccountId: string, TemplateId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, callback: (data : ListTemplateVersionsResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		ListTemplates(AwsAccountId: string, next_token: string, max_result: number, MaxResults: string, NextToken: string, callback: (data : ListTemplatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_result=' + max_result + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListUserGroups(UserName: string, AwsAccountId: string, Namespace: string, next_token: string, max_results: number, callback: (data : ListUserGroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)) + '/groups&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListUsers(AwsAccountId: string, next_token: string, max_results: number, Namespace: string, callback: (data : ListUsersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		RegisterUser(AwsAccountId: string, Namespace: string, callback: (data : RegisterUserResponse) => any, requestBody: RegisterUserBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SearchDashboards(AwsAccountId: string, MaxResults: string, NextToken: string, callback: (data : SearchDashboardsResponse) => any, requestBody: SearchDashboardsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/search/dashboards&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UntagResource(ResourceArn: string, keys: Array<TagKey>, callback: (data : UntagResourceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags#keys&' + keys.map(z => `keys=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateDashboardPublishedVersion(AwsAccountId: string, DashboardId: string, VersionNumber: number, callback: (data : UpdateDashboardPublishedVersionResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/versions/' + VersionNumber, null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
