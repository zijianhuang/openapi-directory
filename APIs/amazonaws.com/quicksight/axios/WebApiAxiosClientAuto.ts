...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelIngestionResponse> {
			return Axios.delete<CancelIngestionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateIngestion(DataSetId: string, IngestionId: string, AwsAccountId: string, headersHandler?: () => {[header: string]: string}): Promise<CreateIngestionResponse> {
			return Axios.put<CreateIngestionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIngestionResponse> {
			return Axios.get<DescribeIngestionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateDashboard(AwsAccountId: string, DashboardId: string, requestBody: CreateDashboardBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDashboardResponse> {
			return Axios.post<CreateDashboardResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDashboard(AwsAccountId: string, DashboardId: string, version_number: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteDashboardResponse> {
			return Axios.delete<DeleteDashboardResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '&version_number=' + version_number, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDashboard(AwsAccountId: string, DashboardId: string, requestBody: UpdateDashboardBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDashboardResponse> {
			return Axios.put<UpdateDashboardResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDataSet(AwsAccountId: string, requestBody: CreateDataSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSetResponse> {
			return Axios.post<CreateDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDataSource(AwsAccountId: string, requestBody: CreateDataSourceBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceResponse> {
			return Axios.post<CreateDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateGroup(AwsAccountId: string, Namespace: string, requestBody: CreateGroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateGroupResponse> {
			return Axios.post<CreateGroupResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteGroupMembership(MemberName: string, GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGroupMembershipResponse> {
			return Axios.delete<DeleteGroupMembershipResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '/members/' + (MemberName == null ? '' : encodeURIComponent(MemberName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateIAMPolicyAssignment(AwsAccountId: string, Namespace: string, requestBody: CreateIAMPolicyAssignmentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateIAMPolicyAssignmentResponse> {
			return Axios.post<CreateIAMPolicyAssignmentResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTemplate(AwsAccountId: string, TemplateId: string, requestBody: CreateTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<CreateTemplateResponse> {
			return Axios.post<CreateTemplateResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTemplate(AwsAccountId: string, TemplateId: string, version_number: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteTemplateResponse> {
			return Axios.delete<DeleteTemplateResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '&version_number=' + version_number, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateTemplate(AwsAccountId: string, TemplateId: string, requestBody: UpdateTemplateBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateTemplateResponse> {
			return Axios.put<UpdateTemplateResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, requestBody: CreateTemplateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<CreateTemplateAliasResponse> {
			return Axios.post<CreateTemplateAliasResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteTemplateAliasResponse> {
			return Axios.delete<DeleteTemplateAliasResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeTemplateAliasResponse> {
			return Axios.get<DescribeTemplateAliasResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, requestBody: UpdateTemplateAliasBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateTemplateAliasResponse> {
			return Axios.put<UpdateTemplateAliasResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDataSet(AwsAccountId: string, DataSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDataSetResponse> {
			return Axios.delete<DeleteDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeDataSet(AwsAccountId: string, DataSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSetResponse> {
			return Axios.get<DescribeDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDataSet(AwsAccountId: string, DataSetId: string, requestBody: UpdateDataSetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataSetResponse> {
			return Axios.put<UpdateDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDataSource(AwsAccountId: string, DataSourceId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDataSourceResponse> {
			return Axios.delete<DeleteDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeDataSource(AwsAccountId: string, DataSourceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSourceResponse> {
			return Axios.get<DescribeDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDataSource(AwsAccountId: string, DataSourceId: string, requestBody: UpdateDataSourceBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataSourceResponse> {
			return Axios.put<UpdateDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteGroup(GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGroupResponse> {
			return Axios.delete<DeleteGroupResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeGroup(GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeGroupResponse> {
			return Axios.get<DescribeGroupResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteUser(UserName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserResponse> {
			return Axios.delete<DeleteUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeUser(UserName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserResponse> {
			return Axios.get<DescribeUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateUser(UserName: string, AwsAccountId: string, Namespace: string, requestBody: UpdateUserBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateUserResponse> {
			return Axios.put<UpdateUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteUserByPrincipalId(PrincipalId: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserByPrincipalIdResponse> {
			return Axios.delete<DeleteUserByPrincipalIdResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/user-principals/' + (PrincipalId == null ? '' : encodeURIComponent(PrincipalId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeDashboardPermissions(AwsAccountId: string, DashboardId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDashboardPermissionsResponse> {
			return Axios.get<DescribeDashboardPermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDashboardPermissions(AwsAccountId: string, DashboardId: string, requestBody: UpdateDashboardPermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDashboardPermissionsResponse> {
			return Axios.put<UpdateDashboardPermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDataSetPermissions(AwsAccountId: string, DataSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSetPermissionsResponse> {
			return Axios.get<DescribeDataSetPermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeDataSourcePermissions(AwsAccountId: string, DataSourceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSourcePermissionsResponse> {
			return Axios.get<DescribeDataSourcePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDataSourcePermissions(AwsAccountId: string, DataSourceId: string, requestBody: UpdateDataSourcePermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDataSourcePermissionsResponse> {
			return Axios.post<UpdateDataSourcePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, requestBody: UpdateIAMPolicyAssignmentBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateIAMPolicyAssignmentResponse> {
			return Axios.put<UpdateIAMPolicyAssignmentResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeTemplatePermissions(AwsAccountId: string, TemplateId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeTemplatePermissionsResponse> {
			return Axios.get<DescribeTemplatePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateTemplatePermissions(AwsAccountId: string, TemplateId: string, requestBody: UpdateTemplatePermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateTemplatePermissionsResponse> {
			return Axios.put<UpdateTemplatePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(ResourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.get<ListTagsForResourceResponse>(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		TagResource(ResourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUsers(AwsAccountId: string, next_token: string, max_results: number, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<ListUsersResponse> {
			return Axios.get<ListUsersResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		RegisterUser(AwsAccountId: string, Namespace: string, requestBody: RegisterUserBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterUserResponse> {
			return Axios.post<RegisterUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchDashboards(AwsAccountId: string, MaxResults: string, NextToken: string, requestBody: SearchDashboardsBody, headersHandler?: () => {[header: string]: string}): Promise<SearchDashboardsResponse> {
			return Axios.post<SearchDashboardsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/search/dashboards&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(ResourceArn: string, keys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.delete<UntagResourceResponse>(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags#keys&' + keys.map(z => `keys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDashboardPublishedVersion(AwsAccountId: string, DashboardId: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<UpdateDashboardPublishedVersionResponse> {
			return Axios.put<UpdateDashboardPublishedVersionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/versions/' + VersionNumber, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
