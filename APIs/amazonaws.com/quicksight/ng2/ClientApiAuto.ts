...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, headersHandler?: () => HttpHeaders): Observable<CancelIngestionResponse> {
			return this.http.delete<CancelIngestionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateIngestion(DataSetId: string, IngestionId: string, AwsAccountId: string, headersHandler?: () => HttpHeaders): Observable<CreateIngestionResponse> {
			return this.http.put<CreateIngestionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, headersHandler?: () => HttpHeaders): Observable<DescribeIngestionResponse> {
			return this.http.get<DescribeIngestionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateDashboard(AwsAccountId: string, DashboardId: string, requestBody: CreateDashboardBody, headersHandler?: () => HttpHeaders): Observable<CreateDashboardResponse> {
			return this.http.post<CreateDashboardResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDashboard(AwsAccountId: string, DashboardId: string, version_number: number, headersHandler?: () => HttpHeaders): Observable<DeleteDashboardResponse> {
			return this.http.delete<DeleteDashboardResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '&version_number=' + version_number, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDashboard(AwsAccountId: string, DashboardId: string, version_number: number, alias_name: string, headersHandler?: () => HttpHeaders): Observable<DescribeDashboardResponse> {
			return this.http.get<DescribeDashboardResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '&version_number=' + version_number + '&alias_name=' + (alias_name == null ? '' : encodeURIComponent(alias_name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDashboard(AwsAccountId: string, DashboardId: string, requestBody: UpdateDashboardBody, headersHandler?: () => HttpHeaders): Observable<UpdateDashboardResponse> {
			return this.http.put<UpdateDashboardResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDataSet(AwsAccountId: string, requestBody: CreateDataSetBody, headersHandler?: () => HttpHeaders): Observable<CreateDataSetResponse> {
			return this.http.post<CreateDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDataSets(AwsAccountId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListDataSetsResponse> {
			return this.http.get<ListDataSetsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateDataSource(AwsAccountId: string, requestBody: CreateDataSourceBody, headersHandler?: () => HttpHeaders): Observable<CreateDataSourceResponse> {
			return this.http.post<CreateDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDataSources(AwsAccountId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListDataSourcesResponse> {
			return this.http.get<ListDataSourcesResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateGroup(AwsAccountId: string, Namespace: string, requestBody: CreateGroupBody, headersHandler?: () => HttpHeaders): Observable<CreateGroupResponse> {
			return this.http.post<CreateGroupResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListGroups(AwsAccountId: string, next_token: string, max_results: number, Namespace: string, headersHandler?: () => HttpHeaders): Observable<ListGroupsResponse> {
			return this.http.get<ListGroupsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateGroupMembership(MemberName: string, GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<CreateGroupMembershipResponse> {
			return this.http.put<CreateGroupMembershipResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '/members/' + (MemberName == null ? '' : encodeURIComponent(MemberName)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteGroupMembership(MemberName: string, GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DeleteGroupMembershipResponse> {
			return this.http.delete<DeleteGroupMembershipResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '/members/' + (MemberName == null ? '' : encodeURIComponent(MemberName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateIAMPolicyAssignment(AwsAccountId: string, Namespace: string, requestBody: CreateIAMPolicyAssignmentBody, headersHandler?: () => HttpHeaders): Observable<CreateIAMPolicyAssignmentResponse> {
			return this.http.post<CreateIAMPolicyAssignmentResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTemplate(AwsAccountId: string, TemplateId: string, requestBody: CreateTemplateBody, headersHandler?: () => HttpHeaders): Observable<CreateTemplateResponse> {
			return this.http.post<CreateTemplateResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTemplate(AwsAccountId: string, TemplateId: string, version_number: number, headersHandler?: () => HttpHeaders): Observable<DeleteTemplateResponse> {
			return this.http.delete<DeleteTemplateResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '&version_number=' + version_number, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeTemplate(AwsAccountId: string, TemplateId: string, version_number: number, alias_name: string, headersHandler?: () => HttpHeaders): Observable<DescribeTemplateResponse> {
			return this.http.get<DescribeTemplateResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '&version_number=' + version_number + '&alias_name=' + (alias_name == null ? '' : encodeURIComponent(alias_name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateTemplate(AwsAccountId: string, TemplateId: string, requestBody: UpdateTemplateBody, headersHandler?: () => HttpHeaders): Observable<UpdateTemplateResponse> {
			return this.http.put<UpdateTemplateResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, requestBody: CreateTemplateAliasBody, headersHandler?: () => HttpHeaders): Observable<CreateTemplateAliasResponse> {
			return this.http.post<CreateTemplateAliasResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, headersHandler?: () => HttpHeaders): Observable<DeleteTemplateAliasResponse> {
			return this.http.delete<DeleteTemplateAliasResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, headersHandler?: () => HttpHeaders): Observable<DescribeTemplateAliasResponse> {
			return this.http.get<DescribeTemplateAliasResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, requestBody: UpdateTemplateAliasBody, headersHandler?: () => HttpHeaders): Observable<UpdateTemplateAliasResponse> {
		 ...
		 */
		DeleteDataSet(AwsAccountId: string, DataSetId: string, headersHandler?: () => HttpHeaders): Observable<DeleteDataSetResponse> {
			return this.http.delete<DeleteDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDataSet(AwsAccountId: string, DataSetId: string, headersHandler?: () => HttpHeaders): Observable<DescribeDataSetResponse> {
			return this.http.get<DescribeDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDataSet(AwsAccountId: string, DataSetId: string, requestBody: UpdateDataSetBody, headersHandler?: () => HttpHeaders): Observable<UpdateDataSetResponse> {
			return this.http.put<UpdateDataSetResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDataSource(AwsAccountId: string, DataSourceId: string, headersHandler?: () => HttpHeaders): Observable<DeleteDataSourceResponse> {
			return this.http.delete<DeleteDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDataSource(AwsAccountId: string, DataSourceId: string, headersHandler?: () => HttpHeaders): Observable<DescribeDataSourceResponse> {
			return this.http.get<DescribeDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDataSource(AwsAccountId: string, DataSourceId: string, requestBody: UpdateDataSourceBody, headersHandler?: () => HttpHeaders): Observable<UpdateDataSourceResponse> {
			return this.http.put<UpdateDataSourceResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteGroup(GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DeleteGroupResponse> {
			return this.http.delete<DeleteGroupResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeGroup(GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DescribeGroupResponse> {
			return this.http.get<DescribeGroupResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateGroup(GroupName: string, AwsAccountId: string, Namespace: string, requestBody: UpdateGroupBody, headersHandler?: () => HttpHeaders): Observable<UpdateGroupResponse> {
			return this.http.put<UpdateGroupResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DeleteIAMPolicyAssignmentResponse> {
			return this.http.delete<DeleteIAMPolicyAssignmentResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespace/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteUser(UserName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DeleteUserResponse> {
			return this.http.delete<DeleteUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeUser(UserName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DescribeUserResponse> {
			return this.http.get<DescribeUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateUser(UserName: string, AwsAccountId: string, Namespace: string, requestBody: UpdateUserBody, headersHandler?: () => HttpHeaders): Observable<UpdateUserResponse> {
			return this.http.put<UpdateUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteUserByPrincipalId(PrincipalId: string, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DeleteUserByPrincipalIdResponse> {
			return this.http.delete<DeleteUserByPrincipalIdResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/user-principals/' + (PrincipalId == null ? '' : encodeURIComponent(PrincipalId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDashboardPermissions(AwsAccountId: string, DashboardId: string, headersHandler?: () => HttpHeaders): Observable<DescribeDashboardPermissionsResponse> {
			return this.http.get<DescribeDashboardPermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDashboardPermissions(AwsAccountId: string, DashboardId: string, requestBody: UpdateDashboardPermissionsBody, headersHandler?: () => HttpHeaders): Observable<UpdateDashboardPermissionsResponse> {
			return this.http.put<UpdateDashboardPermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDataSetPermissions(AwsAccountId: string, DataSetId: string, headersHandler?: () => HttpHeaders): Observable<DescribeDataSetPermissionsResponse> {
			return this.http.get<DescribeDataSetPermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDataSetPermissions(AwsAccountId: string, DataSetId: string, requestBody: UpdateDataSetPermissionsBody, headersHandler?: () => HttpHeaders): Observable<UpdateDataSetPermissionsResponse> {
			return this.http.post<UpdateDataSetPermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDataSourcePermissions(AwsAccountId: string, DataSourceId: string, headersHandler?: () => HttpHeaders): Observable<DescribeDataSourcePermissionsResponse> {
			return this.http.get<DescribeDataSourcePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDataSourcePermissions(AwsAccountId: string, DataSourceId: string, requestBody: UpdateDataSourcePermissionsBody, headersHandler?: () => HttpHeaders): Observable<UpdateDataSourcePermissionsResponse> {
			return this.http.post<UpdateDataSourcePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<DescribeIAMPolicyAssignmentResponse> {
			return this.http.get<DescribeIAMPolicyAssignmentResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, requestBody: UpdateIAMPolicyAssignmentBody, headersHandler?: () => HttpHeaders): Observable<UpdateIAMPolicyAssignmentResponse> {
			return this.http.put<UpdateIAMPolicyAssignmentResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTemplatePermissions(AwsAccountId: string, TemplateId: string, headersHandler?: () => HttpHeaders): Observable<DescribeTemplatePermissionsResponse> {
			return this.http.get<DescribeTemplatePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateTemplatePermissions(AwsAccountId: string, TemplateId: string, requestBody: UpdateTemplatePermissionsBody, headersHandler?: () => HttpHeaders): Observable<UpdateTemplatePermissionsResponse> {
			return this.http.put<UpdateTemplatePermissionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDashboardEmbedUrl(AwsAccountId: string, DashboardId: string, creds_type: UserIdentityType, session_lifetime: number, undo_redo_disabled: boolean, reset_disabled: boolean, user_arn: string, headersHandler?: () => HttpHeaders): Observable<GetDashboardEmbedUrlResponse> {
			return this.http.get<GetDashboardEmbedUrlResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/embed-url#creds-type&creds_type=' + creds_type + '&session_lifetime=' + session_lifetime + '&undo_redo_disabled=' + undo_redo_disabled + '&reset_disabled=' + reset_disabled + '&user_arn=' + (user_arn == null ? '' : encodeURIComponent(user_arn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListDashboardVersions(AwsAccountId: string, DashboardId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListDashboardVersionsResponse> {
		 ...
		 */
		ListDashboards(AwsAccountId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListDashboardsResponse> {
			return this.http.get<ListDashboardsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListGroupMemberships(GroupName: string, next_token: string, max_results: number, AwsAccountId: string, Namespace: string, headersHandler?: () => HttpHeaders): Observable<ListGroupMembershipsResponse> {
			return this.http.get<ListGroupMembershipsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '/members&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListIAMPolicyAssignments(AwsAccountId: string, Namespace: string, next_token: string, max_results: number, headersHandler?: () => HttpHeaders): Observable<ListIAMPolicyAssignmentsResponse> {
			return this.http.get<ListIAMPolicyAssignmentsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListIAMPolicyAssignmentsForUser(AwsAccountId: string, UserName: string, next_token: string, max_results: number, Namespace: string, headersHandler?: () => HttpHeaders): Observable<ListIAMPolicyAssignmentsForUserResponse> {
			return this.http.get<ListIAMPolicyAssignmentsForUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)) + '/iam-policy-assignments&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListIngestions(DataSetId: string, next_token: string, AwsAccountId: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListIngestionsResponse> {
			return this.http.get<ListIngestionsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListTagsForResource(ResourceArn: string, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.get<ListTagsForResourceResponse>(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		TagResource(ResourceArn: string, requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTemplateAliases(AwsAccountId: string, TemplateId: string, next_token: string, max_result: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListTemplateAliasesResponse> {
			return this.http.get<ListTemplateAliasesResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_result=' + max_result + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListTemplateVersions(AwsAccountId: string, TemplateId: string, next_token: string, max_results: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListTemplateVersionsResponse> {
		 ...
		 */
		ListTemplates(AwsAccountId: string, next_token: string, max_result: number, MaxResults: string, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListTemplatesResponse> {
			return this.http.get<ListTemplatesResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_result=' + max_result + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListUserGroups(UserName: string, AwsAccountId: string, Namespace: string, next_token: string, max_results: number, headersHandler?: () => HttpHeaders): Observable<ListUserGroupsResponse> {
			return this.http.get<ListUserGroupsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)) + '/groups&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListUsers(AwsAccountId: string, next_token: string, max_results: number, Namespace: string, headersHandler?: () => HttpHeaders): Observable<ListUsersResponse> {
			return this.http.get<ListUsersResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		RegisterUser(AwsAccountId: string, Namespace: string, requestBody: RegisterUserBody, headersHandler?: () => HttpHeaders): Observable<RegisterUserResponse> {
			return this.http.post<RegisterUserResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SearchDashboards(AwsAccountId: string, MaxResults: string, NextToken: string, requestBody: SearchDashboardsBody, headersHandler?: () => HttpHeaders): Observable<SearchDashboardsResponse> {
			return this.http.post<SearchDashboardsResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/search/dashboards&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UntagResource(ResourceArn: string, keys: Array<TagKey>, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.delete<UntagResourceResponse>(this.baseUri + '/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags#keys&' + keys.map(z => `keys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateDashboardPublishedVersion(AwsAccountId: string, DashboardId: string, VersionNumber: number, headersHandler?: () => HttpHeaders): Observable<UpdateDashboardPublishedVersionResponse> {
			return this.http.put<UpdateDashboardPublishedVersionResponse>(this.baseUri + '/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/versions/' + VersionNumber, null, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
