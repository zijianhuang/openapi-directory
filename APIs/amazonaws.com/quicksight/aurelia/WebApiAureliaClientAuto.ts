...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelIngestionResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateIngestion(DataSetId: string, IngestionId: string, AwsAccountId: string, headersHandler?: () => {[header: string]: string}): Promise<CreateIngestionResponse> {
			return this.http.put('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeIngestion(AwsAccountId: string, DataSetId: string, IngestionId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIngestionResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/ingestions/' + (IngestionId == null ? '' : encodeURIComponent(IngestionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDashboard(AwsAccountId: string, DashboardId: string, version_number: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteDashboardResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '&version_number=' + version_number, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDashboard(AwsAccountId: string, DashboardId: string, version_number: number, alias_name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDashboardResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '&version_number=' + version_number + '&alias_name=' + (alias_name == null ? '' : encodeURIComponent(alias_name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDashboard(AwsAccountId: string, DashboardId: string, requestBody: UpdateDashboardBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDashboardResponse> {
			return this.http.put('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDataSet(AwsAccountId: string, requestBody: CreateDataSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSetResponse> {
			return this.http.post('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDataSource(AwsAccountId: string, requestBody: CreateDataSourceBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDataSourceResponse> {
			return this.http.post('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGroups(AwsAccountId: string, next_token: string, max_results: number, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<ListGroupsResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteGroupMembership(MemberName: string, GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGroupMembershipResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '/members/' + (MemberName == null ? '' : encodeURIComponent(MemberName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteTemplate(AwsAccountId: string, TemplateId: string, version_number: number, headersHandler?: () => {[header: string]: string}): Promise<DeleteTemplateResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '&version_number=' + version_number, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeTemplate(AwsAccountId: string, TemplateId: string, version_number: number, alias_name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeTemplateResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '&version_number=' + version_number + '&alias_name=' + (alias_name == null ? '' : encodeURIComponent(alias_name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteTemplateAliasResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeTemplateAlias(AwsAccountId: string, TemplateId: string, AliasName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeTemplateAliasResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/aliases/' + (AliasName == null ? '' : encodeURIComponent(AliasName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDataSet(AwsAccountId: string, DataSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDataSetResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDataSet(AwsAccountId: string, DataSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSetResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDataSource(AwsAccountId: string, DataSourceId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDataSourceResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDataSource(AwsAccountId: string, DataSourceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSourceResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteGroup(GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteGroupResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeGroup(GroupName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeGroupResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/groups/' + (GroupName == null ? '' : encodeURIComponent(GroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteIAMPolicyAssignmentResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespace/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteUser(UserName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeUser(UserName: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users/' + (UserName == null ? '' : encodeURIComponent(UserName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteUserByPrincipalId(PrincipalId: string, AwsAccountId: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserByPrincipalIdResponse> {
			return this.http.delete('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/user-principals/' + (PrincipalId == null ? '' : encodeURIComponent(PrincipalId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDashboardPermissions(AwsAccountId: string, DashboardId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDashboardPermissionsResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDataSetPermissions(AwsAccountId: string, DataSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSetPermissionsResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sets/' + (DataSetId == null ? '' : encodeURIComponent(DataSetId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDataSourcePermissions(AwsAccountId: string, DataSourceId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDataSourcePermissionsResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/data-sources/' + (DataSourceId == null ? '' : encodeURIComponent(DataSourceId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeIAMPolicyAssignment(AwsAccountId: string, AssignmentName: string, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIAMPolicyAssignmentResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments/' + (AssignmentName == null ? '' : encodeURIComponent(AssignmentName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeTemplatePermissions(AwsAccountId: string, TemplateId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeTemplatePermissionsResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/templates/' + (TemplateId == null ? '' : encodeURIComponent(TemplateId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListIAMPolicyAssignments(AwsAccountId: string, Namespace: string, next_token: string, max_results: number, headersHandler?: () => {[header: string]: string}): Promise<ListIAMPolicyAssignmentsResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/iam-policy-assignments&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(ResourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.get('/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(ResourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListUsers(AwsAccountId: string, next_token: string, max_results: number, Namespace: string, headersHandler?: () => {[header: string]: string}): Promise<ListUsersResponse> {
			return this.http.get('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/namespaces/' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '/users&next_token=' + (next_token == null ? '' : encodeURIComponent(next_token)) + '&max_results=' + max_results, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UntagResource(ResourceArn: string, keys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.delete('/resources/' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '/tags#keys&' + keys.map(z => `keys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDashboardPublishedVersion(AwsAccountId: string, DashboardId: string, VersionNumber: number, headersHandler?: () => {[header: string]: string}): Promise<UpdateDashboardPublishedVersionResponse> {
			return this.http.put('/accounts/' + (AwsAccountId == null ? '' : encodeURIComponent(AwsAccountId)) + '/dashboards/' + (DashboardId == null ? '' : encodeURIComponent(DashboardId)) + '/versions/' + VersionNumber, null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
