...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateEntityToThing(callback: (data : AssociateEntityToThingResponse) => any, requestBody: AssociateEntityToThingRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.AssociateEntityToThing', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateFlowTemplate(callback: (data : CreateFlowTemplateResponse) => any, requestBody: CreateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateFlowTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSystemInstance(callback: (data : CreateSystemInstanceResponse) => any, requestBody: CreateSystemInstanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSystemTemplate(callback: (data : CreateSystemTemplateResponse) => any, requestBody: CreateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteFlowTemplate(callback: (data : DeleteFlowTemplateResponse) => any, requestBody: DeleteFlowTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteFlowTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteNamespace(callback: (data : DeleteNamespaceResponse) => any, requestBody: DeleteNamespaceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteNamespace', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSystemInstance(callback: (data : DeleteSystemInstanceResponse) => any, requestBody: DeleteSystemInstanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSystemTemplate(callback: (data : DeleteSystemTemplateResponse) => any, requestBody: DeleteSystemTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeploySystemInstance(callback: (data : DeploySystemInstanceResponse) => any, requestBody: DeploySystemInstanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeploySystemInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeprecateFlowTemplate(callback: (data : DeprecateFlowTemplateResponse) => any, requestBody: DeprecateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateFlowTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeprecateSystemTemplate(callback: (data : DeprecateSystemTemplateResponse) => any, requestBody: DeprecateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateSystemTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeNamespace(callback: (data : DescribeNamespaceResponse) => any, requestBody: DescribeNamespaceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DescribeNamespace', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DissociateEntityFromThing(callback: (data : DissociateEntityFromThingResponse) => any, requestBody: DissociateEntityFromThingRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DissociateEntityFromThing', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetEntities(callback: (data : GetEntitiesResponse) => any, requestBody: GetEntitiesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetEntities', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetFlowTemplate(callback: (data : GetFlowTemplateResponse) => any, requestBody: GetFlowTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetFlowTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetFlowTemplateRevisions(maxResults: string, nextToken: string, callback: (data : GetFlowTemplateRevisionsResponse) => any, requestBody: GetFlowTemplateRevisionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetFlowTemplateRevisions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetNamespaceDeletionStatus(callback: (data : GetNamespaceDeletionStatusResponse) => any, requestBody: GetNamespaceDeletionStatusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetNamespaceDeletionStatus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSystemInstance(callback: (data : GetSystemInstanceResponse) => any, requestBody: GetSystemInstanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSystemTemplate(callback: (data : GetSystemTemplateResponse) => any, requestBody: GetSystemTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSystemTemplateRevisions(maxResults: string, nextToken: string, callback: (data : GetSystemTemplateRevisionsResponse) => any, requestBody: GetSystemTemplateRevisionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemTemplateRevisions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetUploadStatus(callback: (data : GetUploadStatusResponse) => any, requestBody: GetUploadStatusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetUploadStatus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFlowExecutionMessages(maxResults: string, nextToken: string, callback: (data : ListFlowExecutionMessagesResponse) => any, requestBody: ListFlowExecutionMessagesRequest, headersHandler?: () => {[header: string]: string}) {
		...
		ListTagsForResource(maxResults: string, nextToken: string, callback: (data : ListTagsForResourceResponse) => any, requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.ListTagsForResource?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SearchEntities(maxResults: string, nextToken: string, callback: (data : SearchEntitiesResponse) => any, requestBody: SearchEntitiesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchEntities?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SearchFlowExecutions(maxResults: string, nextToken: string, callback: (data : SearchFlowExecutionsResponse) => any, requestBody: SearchFlowExecutionsRequest, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		SearchFlowTemplates(maxResults: string, nextToken: string, callback: (data : SearchFlowTemplatesResponse) => any, requestBody: SearchFlowTemplatesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchFlowTemplates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SearchSystemInstances(maxResults: string, nextToken: string, callback: (data : SearchSystemInstancesResponse) => any, requestBody: SearchSystemInstancesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchSystemInstances?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SearchSystemTemplates(maxResults: string, nextToken: string, callback: (data : SearchSystemTemplatesResponse) => any, requestBody: SearchSystemTemplatesRequest, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		SearchThings(maxResults: string, nextToken: string, callback: (data : SearchThingsResponse) => any, requestBody: SearchThingsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchThings?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		TagResource(callback: (data : TagResourceResponse) => any, requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.TagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UndeploySystemInstance(callback: (data : UndeploySystemInstanceResponse) => any, requestBody: UndeploySystemInstanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UndeploySystemInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		UntagResource(callback: (data : UntagResourceResponse) => any, requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UntagResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateFlowTemplate(callback: (data : UpdateFlowTemplateResponse) => any, requestBody: UpdateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UpdateFlowTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSystemTemplate(callback: (data : UpdateSystemTemplateResponse) => any, requestBody: UpdateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UpdateSystemTemplate', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UploadEntityDefinitions(callback: (data : UploadEntityDefinitionsResponse) => any, requestBody: UploadEntityDefinitionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UploadEntityDefinitions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
