export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateEntityToThing(requestBody: AssociateEntityToThingRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateEntityToThingResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.AssociateEntityToThing', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateFlowTemplate(requestBody: CreateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFlowTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateFlowTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSystemInstance(requestBody: CreateSystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSystemInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSystemTemplate(requestBody: CreateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSystemTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteFlowTemplate(requestBody: DeleteFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFlowTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteFlowTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteNamespace(requestBody: DeleteNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNamespaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteNamespace', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSystemInstance(requestBody: DeleteSystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSystemInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSystemTemplate(requestBody: DeleteSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSystemTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeploySystemInstance(requestBody: DeploySystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeploySystemInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeploySystemInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeprecateFlowTemplate(requestBody: DeprecateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeprecateFlowTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateFlowTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeprecateSystemTemplate(requestBody: DeprecateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeprecateSystemTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateSystemTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeNamespace(requestBody: DescribeNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeNamespaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DescribeNamespace', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DissociateEntityFromThing(requestBody: DissociateEntityFromThingRequest, headersHandler?: () => {[header: string]: string}): Promise<DissociateEntityFromThingResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DissociateEntityFromThing', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetEntities(requestBody: GetEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEntitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetEntities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetFlowTemplate(requestBody: GetFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFlowTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetFlowTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetNamespaceDeletionStatus(requestBody: GetNamespaceDeletionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNamespaceDeletionStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetNamespaceDeletionStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSystemInstance(requestBody: GetSystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSystemInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSystemTemplate(requestBody: GetSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSystemTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSystemTemplateRevisions(maxResults: string, nextToken: string, requestBody: GetSystemTemplateRevisionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSystemTemplateRevisionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemTemplateRevisions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetUploadStatus(requestBody: GetUploadStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUploadStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetUploadStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SearchEntities(maxResults: string, nextToken: string, requestBody: SearchEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchEntitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchEntities?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SearchSystemInstances(maxResults: string, nextToken: string, requestBody: SearchSystemInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchSystemInstancesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchSystemInstances?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SearchThings(maxResults: string, nextToken: string, requestBody: SearchThingsRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchThingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchThings?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UndeploySystemInstance(requestBody: UndeploySystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<UndeploySystemInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UndeploySystemInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateFlowTemplate(requestBody: UpdateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateFlowTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UpdateFlowTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateSystemTemplate(requestBody: UpdateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSystemTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UpdateSystemTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UploadEntityDefinitions(requestBody: UploadEntityDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<UploadEntityDefinitionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UploadEntityDefinitions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
