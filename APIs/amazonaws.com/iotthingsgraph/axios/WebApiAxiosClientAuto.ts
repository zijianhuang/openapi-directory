...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateEntityToThing(requestBody: AssociateEntityToThingRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateEntityToThingResponse> {
			return Axios.post<AssociateEntityToThingResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.AssociateEntityToThing', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateFlowTemplate(requestBody: CreateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateFlowTemplateResponse> {
			return Axios.post<CreateFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSystemInstance(requestBody: CreateSystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSystemInstanceResponse> {
			return Axios.post<CreateSystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSystemTemplate(requestBody: CreateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSystemTemplateResponse> {
			return Axios.post<CreateSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteFlowTemplate(requestBody: DeleteFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFlowTemplateResponse> {
			return Axios.post<DeleteFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteNamespace(requestBody: DeleteNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNamespaceResponse> {
			return Axios.post<DeleteNamespaceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteNamespace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSystemInstance(requestBody: DeleteSystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSystemInstanceResponse> {
			return Axios.post<DeleteSystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSystemTemplate(requestBody: DeleteSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSystemTemplateResponse> {
			return Axios.post<DeleteSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeploySystemInstance(requestBody: DeploySystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeploySystemInstanceResponse> {
			return Axios.post<DeploySystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeploySystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeprecateFlowTemplate(requestBody: DeprecateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeprecateFlowTemplateResponse> {
			return Axios.post<DeprecateFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeprecateSystemTemplate(requestBody: DeprecateSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<DeprecateSystemTemplateResponse> {
			return Axios.post<DeprecateSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeNamespace(requestBody: DescribeNamespaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeNamespaceResponse> {
			return Axios.post<DescribeNamespaceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DescribeNamespace', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DissociateEntityFromThing(requestBody: DissociateEntityFromThingRequest, headersHandler?: () => {[header: string]: string}): Promise<DissociateEntityFromThingResponse> {
			return Axios.post<DissociateEntityFromThingResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DissociateEntityFromThing', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetEntities(requestBody: GetEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEntitiesResponse> {
			return Axios.post<GetEntitiesResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetEntities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFlowTemplate(requestBody: GetFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFlowTemplateResponse> {
			return Axios.post<GetFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetNamespaceDeletionStatus(requestBody: GetNamespaceDeletionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNamespaceDeletionStatusResponse> {
			return Axios.post<GetNamespaceDeletionStatusResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetNamespaceDeletionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSystemInstance(requestBody: GetSystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSystemInstanceResponse> {
			return Axios.post<GetSystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSystemTemplate(requestBody: GetSystemTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSystemTemplateResponse> {
			return Axios.post<GetSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUploadStatus(requestBody: GetUploadStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUploadStatusResponse> {
			return Axios.post<GetUploadStatusResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetUploadStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchFlowTemplates(maxResults: string, nextToken: string, requestBody: SearchFlowTemplatesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchFlowTemplatesResponse> {
			return Axios.post<SearchFlowTemplatesResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchFlowTemplates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SearchSystemTemplates(maxResults: string, nextToken: string, requestBody: SearchSystemTemplatesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchSystemTemplatesResponse> {
			return Axios.post<SearchSystemTemplatesResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchSystemTemplates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UndeploySystemInstance(requestBody: UndeploySystemInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<UndeploySystemInstanceResponse> {
			return Axios.post<UndeploySystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UndeploySystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateFlowTemplate(requestBody: UpdateFlowTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateFlowTemplateResponse> {
			return Axios.post<UpdateFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UpdateFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UploadEntityDefinitions(requestBody: UploadEntityDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<UploadEntityDefinitionsResponse> {
			return Axios.post<UploadEntityDefinitionsResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UploadEntityDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
