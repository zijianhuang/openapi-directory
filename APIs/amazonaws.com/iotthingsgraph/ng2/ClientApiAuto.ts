...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateEntityToThing(requestBody: AssociateEntityToThingRequest, headersHandler?: () => HttpHeaders): Observable<AssociateEntityToThingResponse> {
			return this.http.post<AssociateEntityToThingResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.AssociateEntityToThing', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateFlowTemplate(requestBody: CreateFlowTemplateRequest, headersHandler?: () => HttpHeaders): Observable<CreateFlowTemplateResponse> {
			return this.http.post<CreateFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSystemInstance(requestBody: CreateSystemInstanceRequest, headersHandler?: () => HttpHeaders): Observable<CreateSystemInstanceResponse> {
			return this.http.post<CreateSystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSystemTemplate(requestBody: CreateSystemTemplateRequest, headersHandler?: () => HttpHeaders): Observable<CreateSystemTemplateResponse> {
			return this.http.post<CreateSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.CreateSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteFlowTemplate(requestBody: DeleteFlowTemplateRequest, headersHandler?: () => HttpHeaders): Observable<DeleteFlowTemplateResponse> {
			return this.http.post<DeleteFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteNamespace(requestBody: DeleteNamespaceRequest, headersHandler?: () => HttpHeaders): Observable<DeleteNamespaceResponse> {
			return this.http.post<DeleteNamespaceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteNamespace', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSystemInstance(requestBody: DeleteSystemInstanceRequest, headersHandler?: () => HttpHeaders): Observable<DeleteSystemInstanceResponse> {
			return this.http.post<DeleteSystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSystemTemplate(requestBody: DeleteSystemTemplateRequest, headersHandler?: () => HttpHeaders): Observable<DeleteSystemTemplateResponse> {
			return this.http.post<DeleteSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeleteSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeploySystemInstance(requestBody: DeploySystemInstanceRequest, headersHandler?: () => HttpHeaders): Observable<DeploySystemInstanceResponse> {
			return this.http.post<DeploySystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeploySystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeprecateFlowTemplate(requestBody: DeprecateFlowTemplateRequest, headersHandler?: () => HttpHeaders): Observable<DeprecateFlowTemplateResponse> {
			return this.http.post<DeprecateFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeprecateSystemTemplate(requestBody: DeprecateSystemTemplateRequest, headersHandler?: () => HttpHeaders): Observable<DeprecateSystemTemplateResponse> {
			return this.http.post<DeprecateSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DeprecateSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeNamespace(requestBody: DescribeNamespaceRequest, headersHandler?: () => HttpHeaders): Observable<DescribeNamespaceResponse> {
			return this.http.post<DescribeNamespaceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DescribeNamespace', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DissociateEntityFromThing(requestBody: DissociateEntityFromThingRequest, headersHandler?: () => HttpHeaders): Observable<DissociateEntityFromThingResponse> {
			return this.http.post<DissociateEntityFromThingResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.DissociateEntityFromThing', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetEntities(requestBody: GetEntitiesRequest, headersHandler?: () => HttpHeaders): Observable<GetEntitiesResponse> {
			return this.http.post<GetEntitiesResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetEntities', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetFlowTemplate(requestBody: GetFlowTemplateRequest, headersHandler?: () => HttpHeaders): Observable<GetFlowTemplateResponse> {
			return this.http.post<GetFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetFlowTemplateRevisions(maxResults: string, nextToken: string, requestBody: GetFlowTemplateRevisionsRequest, headersHandler?: () => HttpHeaders): Observable<GetFlowTemplateRevisionsResponse> {
			return this.http.post<GetFlowTemplateRevisionsResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetFlowTemplateRevisions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetNamespaceDeletionStatus(requestBody: GetNamespaceDeletionStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetNamespaceDeletionStatusResponse> {
			return this.http.post<GetNamespaceDeletionStatusResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetNamespaceDeletionStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSystemInstance(requestBody: GetSystemInstanceRequest, headersHandler?: () => HttpHeaders): Observable<GetSystemInstanceResponse> {
			return this.http.post<GetSystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSystemTemplate(requestBody: GetSystemTemplateRequest, headersHandler?: () => HttpHeaders): Observable<GetSystemTemplateResponse> {
			return this.http.post<GetSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSystemTemplateRevisions(maxResults: string, nextToken: string, requestBody: GetSystemTemplateRevisionsRequest, headersHandler?: () => HttpHeaders): Observable<GetSystemTemplateRevisionsResponse> {
			return this.http.post<GetSystemTemplateRevisionsResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetSystemTemplateRevisions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetUploadStatus(requestBody: GetUploadStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetUploadStatusResponse> {
			return this.http.post<GetUploadStatusResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.GetUploadStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFlowExecutionMessages(maxResults: string, nextToken: string, requestBody: ListFlowExecutionMessagesRequest, headersHandler?: () => HttpHeaders): Observable<ListFlowExecutionMessagesResponse> {
		 ...
		 */
		SearchEntities(maxResults: string, nextToken: string, requestBody: SearchEntitiesRequest, headersHandler?: () => HttpHeaders): Observable<SearchEntitiesResponse> {
			return this.http.post<SearchEntitiesResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchEntities?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SearchFlowExecutions(maxResults: string, nextToken: string, requestBody: SearchFlowExecutionsRequest, headersHandler?: () => HttpHeaders): Observable<SearchFlowExecutionsResponse> {
		 ...
		 */
		SearchFlowTemplates(maxResults: string, nextToken: string, requestBody: SearchFlowTemplatesRequest, headersHandler?: () => HttpHeaders): Observable<SearchFlowTemplatesResponse> {
		 ...
		 */
		SearchSystemInstances(maxResults: string, nextToken: string, requestBody: SearchSystemInstancesRequest, headersHandler?: () => HttpHeaders): Observable<SearchSystemInstancesResponse> {
			return this.http.post<SearchSystemInstancesResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchSystemInstances?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SearchSystemTemplates(maxResults: string, nextToken: string, requestBody: SearchSystemTemplatesRequest, headersHandler?: () => HttpHeaders): Observable<SearchSystemTemplatesResponse> {
		 ...
		 */
		SearchThings(maxResults: string, nextToken: string, requestBody: SearchThingsRequest, headersHandler?: () => HttpHeaders): Observable<SearchThingsResponse> {
			return this.http.post<SearchThingsResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.SearchThings?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UndeploySystemInstance(requestBody: UndeploySystemInstanceRequest, headersHandler?: () => HttpHeaders): Observable<UndeploySystemInstanceResponse> {
			return this.http.post<UndeploySystemInstanceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UndeploySystemInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateFlowTemplate(requestBody: UpdateFlowTemplateRequest, headersHandler?: () => HttpHeaders): Observable<UpdateFlowTemplateResponse> {
			return this.http.post<UpdateFlowTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UpdateFlowTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSystemTemplate(requestBody: UpdateSystemTemplateRequest, headersHandler?: () => HttpHeaders): Observable<UpdateSystemTemplateResponse> {
			return this.http.post<UpdateSystemTemplateResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UpdateSystemTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UploadEntityDefinitions(requestBody: UploadEntityDefinitionsRequest, headersHandler?: () => HttpHeaders): Observable<UploadEntityDefinitionsResponse> {
			return this.http.post<UploadEntityDefinitionsResponse>(this.baseUri + '/#X-Amz-Target=IotThingsGraphFrontEndService.UploadEntityDefinitions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
