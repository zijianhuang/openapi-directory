...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ActivateGateway(requestBody: ActivateGatewayInput, headersHandler?: () => HttpHeaders): Observable<ActivateGatewayOutput> {
			return this.http.post<ActivateGatewayOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ActivateGateway', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AddCache(requestBody: AddCacheInput, headersHandler?: () => HttpHeaders): Observable<AddCacheOutput> {
			return this.http.post<AddCacheOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddCache', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AddTagsToResource(requestBody: AddTagsToResourceInput, headersHandler?: () => HttpHeaders): Observable<AddTagsToResourceOutput> {
			return this.http.post<AddTagsToResourceOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AddUploadBuffer(requestBody: AddUploadBufferInput, headersHandler?: () => HttpHeaders): Observable<AddUploadBufferOutput> {
			return this.http.post<AddUploadBufferOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddUploadBuffer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AddWorkingStorage(requestBody: AddWorkingStorageInput, headersHandler?: () => HttpHeaders): Observable<AddWorkingStorageOutput> {
			return this.http.post<AddWorkingStorageOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddWorkingStorage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssignTapePool(requestBody: AssignTapePoolInput, headersHandler?: () => HttpHeaders): Observable<AssignTapePoolOutput> {
			return this.http.post<AssignTapePoolOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AssignTapePool', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AttachVolume(requestBody: AttachVolumeInput, headersHandler?: () => HttpHeaders): Observable<AttachVolumeOutput> {
			return this.http.post<AttachVolumeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AttachVolume', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelArchival(requestBody: CancelArchivalInput, headersHandler?: () => HttpHeaders): Observable<CancelArchivalOutput> {
			return this.http.post<CancelArchivalOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CancelArchival', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelRetrieval(requestBody: CancelRetrievalInput, headersHandler?: () => HttpHeaders): Observable<CancelRetrievalOutput> {
			return this.http.post<CancelRetrievalOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CancelRetrieval', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateCachediSCSIVolume(requestBody: CreateCachediSCSIVolumeInput, headersHandler?: () => HttpHeaders): Observable<CreateCachediSCSIVolumeOutput> {
			return this.http.post<CreateCachediSCSIVolumeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateCachediSCSIVolume', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateNFSFileShare(requestBody: CreateNFSFileShareInput, headersHandler?: () => HttpHeaders): Observable<CreateNFSFileShareOutput> {
			return this.http.post<CreateNFSFileShareOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateNFSFileShare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSMBFileShare(requestBody: CreateSMBFileShareInput, headersHandler?: () => HttpHeaders): Observable<CreateSMBFileShareOutput> {
			return this.http.post<CreateSMBFileShareOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSMBFileShare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSnapshot(requestBody: CreateSnapshotInput, headersHandler?: () => HttpHeaders): Observable<CreateSnapshotOutput> {
			return this.http.post<CreateSnapshotOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSnapshotFromVolumeRecoveryPoint(requestBody: CreateSnapshotFromVolumeRecoveryPointInput, headersHandler?: () => HttpHeaders): Observable<CreateSnapshotFromVolumeRecoveryPointOutput> {
			return this.http.post<CreateSnapshotFromVolumeRecoveryPointOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSnapshotFromVolumeRecoveryPoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateStorediSCSIVolume(requestBody: CreateStorediSCSIVolumeInput, headersHandler?: () => HttpHeaders): Observable<CreateStorediSCSIVolumeOutput> {
			return this.http.post<CreateStorediSCSIVolumeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateStorediSCSIVolume', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTapeWithBarcode(requestBody: CreateTapeWithBarcodeInput, headersHandler?: () => HttpHeaders): Observable<CreateTapeWithBarcodeOutput> {
			return this.http.post<CreateTapeWithBarcodeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateTapeWithBarcode', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTapes(requestBody: CreateTapesInput, headersHandler?: () => HttpHeaders): Observable<CreateTapesOutput> {
			return this.http.post<CreateTapesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateTapes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteAutomaticTapeCreationPolicy(requestBody: DeleteAutomaticTapeCreationPolicyInput, headersHandler?: () => HttpHeaders): Observable<DeleteAutomaticTapeCreationPolicyOutput> {
			return this.http.post<DeleteAutomaticTapeCreationPolicyOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteAutomaticTapeCreationPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteBandwidthRateLimit(requestBody: DeleteBandwidthRateLimitInput, headersHandler?: () => HttpHeaders): Observable<DeleteBandwidthRateLimitOutput> {
			return this.http.post<DeleteBandwidthRateLimitOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteBandwidthRateLimit', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteChapCredentials(requestBody: DeleteChapCredentialsInput, headersHandler?: () => HttpHeaders): Observable<DeleteChapCredentialsOutput> {
			return this.http.post<DeleteChapCredentialsOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteChapCredentials', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteFileShare(requestBody: DeleteFileShareInput, headersHandler?: () => HttpHeaders): Observable<DeleteFileShareOutput> {
			return this.http.post<DeleteFileShareOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteFileShare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteGateway(requestBody: DeleteGatewayInput, headersHandler?: () => HttpHeaders): Observable<DeleteGatewayOutput> {
			return this.http.post<DeleteGatewayOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteGateway', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSnapshotSchedule(requestBody: DeleteSnapshotScheduleInput, headersHandler?: () => HttpHeaders): Observable<DeleteSnapshotScheduleOutput> {
			return this.http.post<DeleteSnapshotScheduleOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteSnapshotSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTape(requestBody: DeleteTapeInput, headersHandler?: () => HttpHeaders): Observable<DeleteTapeOutput> {
			return this.http.post<DeleteTapeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteTape', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTapeArchive(requestBody: DeleteTapeArchiveInput, headersHandler?: () => HttpHeaders): Observable<DeleteTapeArchiveOutput> {
			return this.http.post<DeleteTapeArchiveOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteTapeArchive', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteVolume(requestBody: DeleteVolumeInput, headersHandler?: () => HttpHeaders): Observable<DeleteVolumeOutput> {
			return this.http.post<DeleteVolumeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteVolume', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAvailabilityMonitorTest(requestBody: DescribeAvailabilityMonitorTestInput, headersHandler?: () => HttpHeaders): Observable<DescribeAvailabilityMonitorTestOutput> {
			return this.http.post<DescribeAvailabilityMonitorTestOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeAvailabilityMonitorTest', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeBandwidthRateLimit(requestBody: DescribeBandwidthRateLimitInput, headersHandler?: () => HttpHeaders): Observable<DescribeBandwidthRateLimitOutput> {
			return this.http.post<DescribeBandwidthRateLimitOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeBandwidthRateLimit', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCache(requestBody: DescribeCacheInput, headersHandler?: () => HttpHeaders): Observable<DescribeCacheOutput> {
			return this.http.post<DescribeCacheOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeCache', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCachediSCSIVolumes(requestBody: DescribeCachediSCSIVolumesInput, headersHandler?: () => HttpHeaders): Observable<DescribeCachediSCSIVolumesOutput> {
			return this.http.post<DescribeCachediSCSIVolumesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeCachediSCSIVolumes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeChapCredentials(requestBody: DescribeChapCredentialsInput, headersHandler?: () => HttpHeaders): Observable<DescribeChapCredentialsOutput> {
			return this.http.post<DescribeChapCredentialsOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeChapCredentials', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeGatewayInformation(requestBody: DescribeGatewayInformationInput, headersHandler?: () => HttpHeaders): Observable<DescribeGatewayInformationOutput> {
			return this.http.post<DescribeGatewayInformationOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeGatewayInformation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeMaintenanceStartTime(requestBody: DescribeMaintenanceStartTimeInput, headersHandler?: () => HttpHeaders): Observable<DescribeMaintenanceStartTimeOutput> {
			return this.http.post<DescribeMaintenanceStartTimeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeMaintenanceStartTime', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeNFSFileShares(requestBody: DescribeNFSFileSharesInput, headersHandler?: () => HttpHeaders): Observable<DescribeNFSFileSharesOutput> {
			return this.http.post<DescribeNFSFileSharesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeNFSFileShares', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSMBFileShares(requestBody: DescribeSMBFileSharesInput, headersHandler?: () => HttpHeaders): Observable<DescribeSMBFileSharesOutput> {
			return this.http.post<DescribeSMBFileSharesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSMBFileShares', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSMBSettings(requestBody: DescribeSMBSettingsInput, headersHandler?: () => HttpHeaders): Observable<DescribeSMBSettingsOutput> {
			return this.http.post<DescribeSMBSettingsOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSMBSettings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSnapshotSchedule(requestBody: DescribeSnapshotScheduleInput, headersHandler?: () => HttpHeaders): Observable<DescribeSnapshotScheduleOutput> {
			return this.http.post<DescribeSnapshotScheduleOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSnapshotSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStorediSCSIVolumes(requestBody: DescribeStorediSCSIVolumesInput, headersHandler?: () => HttpHeaders): Observable<DescribeStorediSCSIVolumesOutput> {
			return this.http.post<DescribeStorediSCSIVolumesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeStorediSCSIVolumes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTapeArchives(Limit: string, Marker: string, requestBody: DescribeTapeArchivesInput, headersHandler?: () => HttpHeaders): Observable<DescribeTapeArchivesOutput> {
			return this.http.post<DescribeTapeArchivesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapeArchives?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTapeRecoveryPoints(Limit: string, Marker: string, requestBody: DescribeTapeRecoveryPointsInput, headersHandler?: () => HttpHeaders): Observable<DescribeTapeRecoveryPointsOutput> {
			return this.http.post<DescribeTapeRecoveryPointsOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapeRecoveryPoints?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTapes(Limit: string, Marker: string, requestBody: DescribeTapesInput, headersHandler?: () => HttpHeaders): Observable<DescribeTapesOutput> {
			return this.http.post<DescribeTapesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeUploadBuffer(requestBody: DescribeUploadBufferInput, headersHandler?: () => HttpHeaders): Observable<DescribeUploadBufferOutput> {
			return this.http.post<DescribeUploadBufferOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeUploadBuffer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeVTLDevices(Limit: string, Marker: string, requestBody: DescribeVTLDevicesInput, headersHandler?: () => HttpHeaders): Observable<DescribeVTLDevicesOutput> {
			return this.http.post<DescribeVTLDevicesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeVTLDevices?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeWorkingStorage(requestBody: DescribeWorkingStorageInput, headersHandler?: () => HttpHeaders): Observable<DescribeWorkingStorageOutput> {
			return this.http.post<DescribeWorkingStorageOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeWorkingStorage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DetachVolume(requestBody: DetachVolumeInput, headersHandler?: () => HttpHeaders): Observable<DetachVolumeOutput> {
			return this.http.post<DetachVolumeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DetachVolume', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisableGateway(requestBody: DisableGatewayInput, headersHandler?: () => HttpHeaders): Observable<DisableGatewayOutput> {
			return this.http.post<DisableGatewayOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DisableGateway', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		JoinDomain(requestBody: JoinDomainInput, headersHandler?: () => HttpHeaders): Observable<JoinDomainOutput> {
			return this.http.post<JoinDomainOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.JoinDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAutomaticTapeCreationPolicies(requestBody: ListAutomaticTapeCreationPoliciesInput, headersHandler?: () => HttpHeaders): Observable<ListAutomaticTapeCreationPoliciesOutput> {
			return this.http.post<ListAutomaticTapeCreationPoliciesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListAutomaticTapeCreationPolicies', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFileShares(Limit: string, Marker: string, requestBody: ListFileSharesInput, headersHandler?: () => HttpHeaders): Observable<ListFileSharesOutput> {
			return this.http.post<ListFileSharesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListFileShares?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListGateways(Limit: string, Marker: string, requestBody: ListGatewaysInput, headersHandler?: () => HttpHeaders): Observable<ListGatewaysOutput> {
			return this.http.post<ListGatewaysOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListGateways?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListLocalDisks(requestBody: ListLocalDisksInput, headersHandler?: () => HttpHeaders): Observable<ListLocalDisksOutput> {
			return this.http.post<ListLocalDisksOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListLocalDisks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForResource(Limit: string, Marker: string, requestBody: ListTagsForResourceInput, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceOutput> {
		 ...
		 */
		ListTapes(Limit: string, Marker: string, requestBody: ListTapesInput, headersHandler?: () => HttpHeaders): Observable<ListTapesOutput> {
			return this.http.post<ListTapesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListVolumeInitiators(requestBody: ListVolumeInitiatorsInput, headersHandler?: () => HttpHeaders): Observable<ListVolumeInitiatorsOutput> {
			return this.http.post<ListVolumeInitiatorsOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumeInitiators', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListVolumeRecoveryPoints(requestBody: ListVolumeRecoveryPointsInput, headersHandler?: () => HttpHeaders): Observable<ListVolumeRecoveryPointsOutput> {
			return this.http.post<ListVolumeRecoveryPointsOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumeRecoveryPoints', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListVolumes(Limit: string, Marker: string, requestBody: ListVolumesInput, headersHandler?: () => HttpHeaders): Observable<ListVolumesOutput> {
			return this.http.post<ListVolumesOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		NotifyWhenUploaded(requestBody: NotifyWhenUploadedInput, headersHandler?: () => HttpHeaders): Observable<NotifyWhenUploadedOutput> {
			return this.http.post<NotifyWhenUploadedOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.NotifyWhenUploaded', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RefreshCache(requestBody: RefreshCacheInput, headersHandler?: () => HttpHeaders): Observable<RefreshCacheOutput> {
			return this.http.post<RefreshCacheOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RefreshCache', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceInput, headersHandler?: () => HttpHeaders): Observable<RemoveTagsFromResourceOutput> {
			return this.http.post<RemoveTagsFromResourceOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ResetCache(requestBody: ResetCacheInput, headersHandler?: () => HttpHeaders): Observable<ResetCacheOutput> {
			return this.http.post<ResetCacheOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ResetCache', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RetrieveTapeArchive(requestBody: RetrieveTapeArchiveInput, headersHandler?: () => HttpHeaders): Observable<RetrieveTapeArchiveOutput> {
			return this.http.post<RetrieveTapeArchiveOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeArchive', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RetrieveTapeRecoveryPoint(requestBody: RetrieveTapeRecoveryPointInput, headersHandler?: () => HttpHeaders): Observable<RetrieveTapeRecoveryPointOutput> {
			return this.http.post<RetrieveTapeRecoveryPointOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeRecoveryPoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SetLocalConsolePassword(requestBody: SetLocalConsolePasswordInput, headersHandler?: () => HttpHeaders): Observable<SetLocalConsolePasswordOutput> {
			return this.http.post<SetLocalConsolePasswordOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.SetLocalConsolePassword', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SetSMBGuestPassword(requestBody: SetSMBGuestPasswordInput, headersHandler?: () => HttpHeaders): Observable<SetSMBGuestPasswordOutput> {
			return this.http.post<SetSMBGuestPasswordOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.SetSMBGuestPassword', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ShutdownGateway(requestBody: ShutdownGatewayInput, headersHandler?: () => HttpHeaders): Observable<ShutdownGatewayOutput> {
			return this.http.post<ShutdownGatewayOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ShutdownGateway', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartAvailabilityMonitorTest(requestBody: StartAvailabilityMonitorTestInput, headersHandler?: () => HttpHeaders): Observable<StartAvailabilityMonitorTestOutput> {
			return this.http.post<StartAvailabilityMonitorTestOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.StartAvailabilityMonitorTest', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartGateway(requestBody: StartGatewayInput, headersHandler?: () => HttpHeaders): Observable<StartGatewayOutput> {
			return this.http.post<StartGatewayOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.StartGateway', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateAutomaticTapeCreationPolicy(requestBody: UpdateAutomaticTapeCreationPolicyInput, headersHandler?: () => HttpHeaders): Observable<UpdateAutomaticTapeCreationPolicyOutput> {
			return this.http.post<UpdateAutomaticTapeCreationPolicyOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateAutomaticTapeCreationPolicy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateBandwidthRateLimit(requestBody: UpdateBandwidthRateLimitInput, headersHandler?: () => HttpHeaders): Observable<UpdateBandwidthRateLimitOutput> {
			return this.http.post<UpdateBandwidthRateLimitOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateBandwidthRateLimit', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateChapCredentials(requestBody: UpdateChapCredentialsInput, headersHandler?: () => HttpHeaders): Observable<UpdateChapCredentialsOutput> {
			return this.http.post<UpdateChapCredentialsOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateChapCredentials', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateGatewayInformation(requestBody: UpdateGatewayInformationInput, headersHandler?: () => HttpHeaders): Observable<UpdateGatewayInformationOutput> {
			return this.http.post<UpdateGatewayInformationOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateGatewayInformation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateGatewaySoftwareNow(requestBody: UpdateGatewaySoftwareNowInput, headersHandler?: () => HttpHeaders): Observable<UpdateGatewaySoftwareNowOutput> {
			return this.http.post<UpdateGatewaySoftwareNowOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateGatewaySoftwareNow', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateMaintenanceStartTime(requestBody: UpdateMaintenanceStartTimeInput, headersHandler?: () => HttpHeaders): Observable<UpdateMaintenanceStartTimeOutput> {
			return this.http.post<UpdateMaintenanceStartTimeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateMaintenanceStartTime', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateNFSFileShare(requestBody: UpdateNFSFileShareInput, headersHandler?: () => HttpHeaders): Observable<UpdateNFSFileShareOutput> {
			return this.http.post<UpdateNFSFileShareOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateNFSFileShare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSMBFileShare(requestBody: UpdateSMBFileShareInput, headersHandler?: () => HttpHeaders): Observable<UpdateSMBFileShareOutput> {
			return this.http.post<UpdateSMBFileShareOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSMBFileShare', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSMBSecurityStrategy(requestBody: UpdateSMBSecurityStrategyInput, headersHandler?: () => HttpHeaders): Observable<UpdateSMBSecurityStrategyOutput> {
			return this.http.post<UpdateSMBSecurityStrategyOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSMBSecurityStrategy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSnapshotSchedule(requestBody: UpdateSnapshotScheduleInput, headersHandler?: () => HttpHeaders): Observable<UpdateSnapshotScheduleOutput> {
			return this.http.post<UpdateSnapshotScheduleOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSnapshotSchedule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateVTLDeviceType(requestBody: UpdateVTLDeviceTypeInput, headersHandler?: () => HttpHeaders): Observable<UpdateVTLDeviceTypeOutput> {
			return this.http.post<UpdateVTLDeviceTypeOutput>(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateVTLDeviceType', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
