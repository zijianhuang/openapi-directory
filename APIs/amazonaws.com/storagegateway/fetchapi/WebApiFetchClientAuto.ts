export namespace My_Demo_Client {
	...
	export interface CreateNFSFileShareInput {
		 ...
		 * Maximum items: 100
		 */
		ClientList?: Array<IPV4AddressCIDR>;
	...
	export interface CreateSMBFileShareInput {
		...
		AdminUserList?: Array<FileShareUser>;
		ValidUserList?: Array<FileShareUser>;
		InvalidUserList?: Array<FileShareUser>;
	...
	export enum CreateSMBFileShareInputObjectACL { private = 0, public-read = 1, public-read-write = 2, authenticated-read = 3, bucket-owner-read = 4, bucket-owner-full-control = 5, aws-exec-read = 6 }
	...
	export interface JoinDomainOutput {
		 ...
		 */
		GatewayARN?: string;
		ActiveDirectoryStatus?: JoinDomainOutputActiveDirectoryStatus;
	}

	export enum JoinDomainOutputActiveDirectoryStatus { ACCESS_DENIED = 0, DETACHED = 1, JOINED = 2, JOINING = 3, NETWORK_ERROR = 4, TIMEOUT = 5, UNKNOWN_ERROR = 6 }
	...
	export enum UpdateNFSFileShareInputObjectACL { private = 0, public-read = 1, public-read-write = 2, authenticated-read = 3, bucket-owner-read = 4, bucket-owner-full-control = 5, aws-exec-read = 6 }
	...
	export enum UpdateSMBFileShareInputObjectACL { private = 0, public-read = 1, public-read-write = 2, authenticated-read = 3, bucket-owner-read = 4, bucket-owner-full-control = 5, aws-exec-read = 6 }
	...
	export interface UpdateSMBSecurityStrategyInput {
		 ...
		 */
		GatewayARN: string;
		SMBSecurityStrategy: UpdateSMBSecurityStrategyInputSMBSecurityStrategy;
	}

	export enum UpdateSMBSecurityStrategyInputSMBSecurityStrategy { ClientSpecified = 0, MandatorySigning = 1, MandatoryEncryption = 2 }
	...
	export interface Disk {
		 ...
		 * Maximum items: 10
		 */
		DiskAttributeList?: Array<DiskAttribute>;
	}
	...
	export enum NFSFileShareInfoObjectACL { private = 0, public-read = 1, public-read-write = 2, authenticated-read = 3, bucket-owner-read = 4, bucket-owner-full-control = 5, aws-exec-read = 6 }
	...
	export enum SMBFileShareInfoObjectACL { private = 0, public-read = 1, public-read-write = 2, authenticated-read = 3, bucket-owner-read = 4, bucket-owner-full-control = 5, aws-exec-read = 6 }
	...
	export class DemoClient {
		 ...
		 */
		ActivateGateway(requestBody: ActivateGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<ActivateGatewayOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ActivateGateway', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AddCache(requestBody: AddCacheInput, headersHandler?: () => {[header: string]: string}): Promise<AddCacheOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddCache', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AddTagsToResource(requestBody: AddTagsToResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddTagsToResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AddUploadBuffer(requestBody: AddUploadBufferInput, headersHandler?: () => {[header: string]: string}): Promise<AddUploadBufferOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddUploadBuffer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AddWorkingStorage(requestBody: AddWorkingStorageInput, headersHandler?: () => {[header: string]: string}): Promise<AddWorkingStorageOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddWorkingStorage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AssignTapePool(requestBody: AssignTapePoolInput, headersHandler?: () => {[header: string]: string}): Promise<AssignTapePoolOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AssignTapePool', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AttachVolume(requestBody: AttachVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<AttachVolumeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AttachVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CancelArchival(requestBody: CancelArchivalInput, headersHandler?: () => {[header: string]: string}): Promise<CancelArchivalOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CancelArchival', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CancelRetrieval(requestBody: CancelRetrievalInput, headersHandler?: () => {[header: string]: string}): Promise<CancelRetrievalOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CancelRetrieval', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateCachediSCSIVolume(requestBody: CreateCachediSCSIVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<CreateCachediSCSIVolumeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateCachediSCSIVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateNFSFileShare(requestBody: CreateNFSFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<CreateNFSFileShareOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateNFSFileShare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateSMBFileShare(requestBody: CreateSMBFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSMBFileShareOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSMBFileShare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateSnapshot(requestBody: CreateSnapshotInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSnapshotOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSnapshot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateSnapshotFromVolumeRecoveryPoint(requestBody: CreateSnapshotFromVolumeRecoveryPointInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSnapshotFromVolumeRecoveryPointOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSnapshotFromVolumeRecoveryPoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateStorediSCSIVolume(requestBody: CreateStorediSCSIVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<CreateStorediSCSIVolumeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateStorediSCSIVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateTapeWithBarcode(requestBody: CreateTapeWithBarcodeInput, headersHandler?: () => {[header: string]: string}): Promise<CreateTapeWithBarcodeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateTapeWithBarcode', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateTapes(requestBody: CreateTapesInput, headersHandler?: () => {[header: string]: string}): Promise<CreateTapesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateTapes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteAutomaticTapeCreationPolicy(requestBody: DeleteAutomaticTapeCreationPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteAutomaticTapeCreationPolicyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteAutomaticTapeCreationPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteBandwidthRateLimit(requestBody: DeleteBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteBandwidthRateLimitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteBandwidthRateLimit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteChapCredentials(requestBody: DeleteChapCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteChapCredentialsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteChapCredentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteFileShare(requestBody: DeleteFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteFileShareOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteFileShare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteGateway(requestBody: DeleteGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGatewayOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteGateway', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteSnapshotSchedule(requestBody: DeleteSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteSnapshotScheduleOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteSnapshotSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteTape(requestBody: DeleteTapeInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTapeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteTape', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteTapeArchive(requestBody: DeleteTapeArchiveInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTapeArchiveOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteTapeArchive', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteVolume(requestBody: DeleteVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteVolumeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeAvailabilityMonitorTest(requestBody: DescribeAvailabilityMonitorTestInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeAvailabilityMonitorTestOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeAvailabilityMonitorTest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeBandwidthRateLimit(requestBody: DescribeBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeBandwidthRateLimitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeBandwidthRateLimit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeCache(requestBody: DescribeCacheInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeCacheOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeCache', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeCachediSCSIVolumes(requestBody: DescribeCachediSCSIVolumesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeCachediSCSIVolumesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeCachediSCSIVolumes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeChapCredentials(requestBody: DescribeChapCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeChapCredentialsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeChapCredentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeGatewayInformation(requestBody: DescribeGatewayInformationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGatewayInformationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeGatewayInformation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeMaintenanceStartTime(requestBody: DescribeMaintenanceStartTimeInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceStartTimeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeMaintenanceStartTime', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeNFSFileShares(requestBody: DescribeNFSFileSharesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeNFSFileSharesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeNFSFileShares', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeSMBFileShares(requestBody: DescribeSMBFileSharesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSMBFileSharesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSMBFileShares', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeSMBSettings(requestBody: DescribeSMBSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSMBSettingsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSMBSettings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeSnapshotSchedule(requestBody: DescribeSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSnapshotScheduleOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSnapshotSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeStorediSCSIVolumes(requestBody: DescribeStorediSCSIVolumesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStorediSCSIVolumesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeStorediSCSIVolumes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeTapeArchives(Limit: string, Marker: string, requestBody: DescribeTapeArchivesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTapeArchivesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapeArchives?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeTapeRecoveryPoints(Limit: string, Marker: string, requestBody: DescribeTapeRecoveryPointsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTapeRecoveryPointsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapeRecoveryPoints?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeTapes(Limit: string, Marker: string, requestBody: DescribeTapesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTapesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeUploadBuffer(requestBody: DescribeUploadBufferInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeUploadBufferOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeUploadBuffer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeVTLDevices(Limit: string, Marker: string, requestBody: DescribeVTLDevicesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeVTLDevicesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeVTLDevices?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeWorkingStorage(requestBody: DescribeWorkingStorageInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkingStorageOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeWorkingStorage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DetachVolume(requestBody: DetachVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<DetachVolumeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DetachVolume', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DisableGateway(requestBody: DisableGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<DisableGatewayOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DisableGateway', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		JoinDomain(requestBody: JoinDomainInput, headersHandler?: () => {[header: string]: string}): Promise<JoinDomainOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.JoinDomain', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListAutomaticTapeCreationPolicies(requestBody: ListAutomaticTapeCreationPoliciesInput, headersHandler?: () => {[header: string]: string}): Promise<ListAutomaticTapeCreationPoliciesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListAutomaticTapeCreationPolicies', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListFileShares(Limit: string, Marker: string, requestBody: ListFileSharesInput, headersHandler?: () => {[header: string]: string}): Promise<ListFileSharesOutput> {
		 ...
		 */
		ListGateways(Limit: string, Marker: string, requestBody: ListGatewaysInput, headersHandler?: () => {[header: string]: string}): Promise<ListGatewaysOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListGateways?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListLocalDisks(requestBody: ListLocalDisksInput, headersHandler?: () => {[header: string]: string}): Promise<ListLocalDisksOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListLocalDisks', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListTagsForResource(Limit: string, Marker: string, requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
		 ...
		 */
		ListTapes(Limit: string, Marker: string, requestBody: ListTapesInput, headersHandler?: () => {[header: string]: string}): Promise<ListTapesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListVolumeInitiators(requestBody: ListVolumeInitiatorsInput, headersHandler?: () => {[header: string]: string}): Promise<ListVolumeInitiatorsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumeInitiators', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListVolumeRecoveryPoints(requestBody: ListVolumeRecoveryPointsInput, headersHandler?: () => {[header: string]: string}): Promise<ListVolumeRecoveryPointsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumeRecoveryPoints', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListVolumes(Limit: string, Marker: string, requestBody: ListVolumesInput, headersHandler?: () => {[header: string]: string}): Promise<ListVolumesOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		NotifyWhenUploaded(requestBody: NotifyWhenUploadedInput, headersHandler?: () => {[header: string]: string}): Promise<NotifyWhenUploadedOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.NotifyWhenUploaded', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RefreshCache(requestBody: RefreshCacheInput, headersHandler?: () => {[header: string]: string}): Promise<RefreshCacheOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RefreshCache', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RemoveTagsFromResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ResetCache(requestBody: ResetCacheInput, headersHandler?: () => {[header: string]: string}): Promise<ResetCacheOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ResetCache', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RetrieveTapeArchive(requestBody: RetrieveTapeArchiveInput, headersHandler?: () => {[header: string]: string}): Promise<RetrieveTapeArchiveOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeArchive', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		RetrieveTapeRecoveryPoint(requestBody: RetrieveTapeRecoveryPointInput, headersHandler?: () => {[header: string]: string}): Promise<RetrieveTapeRecoveryPointOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeRecoveryPoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		SetLocalConsolePassword(requestBody: SetLocalConsolePasswordInput, headersHandler?: () => {[header: string]: string}): Promise<SetLocalConsolePasswordOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.SetLocalConsolePassword', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		SetSMBGuestPassword(requestBody: SetSMBGuestPasswordInput, headersHandler?: () => {[header: string]: string}): Promise<SetSMBGuestPasswordOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.SetSMBGuestPassword', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ShutdownGateway(requestBody: ShutdownGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<ShutdownGatewayOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ShutdownGateway', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StartAvailabilityMonitorTest(requestBody: StartAvailabilityMonitorTestInput, headersHandler?: () => {[header: string]: string}): Promise<StartAvailabilityMonitorTestOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.StartAvailabilityMonitorTest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StartGateway(requestBody: StartGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<StartGatewayOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.StartGateway', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateAutomaticTapeCreationPolicy(requestBody: UpdateAutomaticTapeCreationPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateAutomaticTapeCreationPolicyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateAutomaticTapeCreationPolicy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateBandwidthRateLimit(requestBody: UpdateBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateBandwidthRateLimitOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateBandwidthRateLimit', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateChapCredentials(requestBody: UpdateChapCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateChapCredentialsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateChapCredentials', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateGatewayInformation(requestBody: UpdateGatewayInformationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGatewayInformationOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateGatewayInformation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateGatewaySoftwareNow(requestBody: UpdateGatewaySoftwareNowInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGatewaySoftwareNowOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateGatewaySoftwareNow', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateMaintenanceStartTime(requestBody: UpdateMaintenanceStartTimeInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceStartTimeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateMaintenanceStartTime', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateNFSFileShare(requestBody: UpdateNFSFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateNFSFileShareOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateNFSFileShare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateSMBFileShare(requestBody: UpdateSMBFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateSMBFileShareOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSMBFileShare', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateSMBSecurityStrategy(requestBody: UpdateSMBSecurityStrategyInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateSMBSecurityStrategyOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSMBSecurityStrategy', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateSnapshotSchedule(requestBody: UpdateSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateSnapshotScheduleOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSnapshotSchedule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateVTLDeviceType(requestBody: UpdateVTLDeviceTypeInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateVTLDeviceTypeOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateVTLDeviceType', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
