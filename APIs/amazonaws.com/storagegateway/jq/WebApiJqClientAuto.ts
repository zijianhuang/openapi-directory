...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		ActivateGateway(callback: (data : ActivateGatewayOutput) => any, requestBody: ActivateGatewayInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ActivateGateway', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AddCache(callback: (data : AddCacheOutput) => any, requestBody: AddCacheInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddCache', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AddTagsToResource(callback: (data : AddTagsToResourceOutput) => any, requestBody: AddTagsToResourceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddTagsToResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AddUploadBuffer(callback: (data : AddUploadBufferOutput) => any, requestBody: AddUploadBufferInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddUploadBuffer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AddWorkingStorage(callback: (data : AddWorkingStorageOutput) => any, requestBody: AddWorkingStorageInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AddWorkingStorage', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AssignTapePool(callback: (data : AssignTapePoolOutput) => any, requestBody: AssignTapePoolInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AssignTapePool', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		AttachVolume(callback: (data : AttachVolumeOutput) => any, requestBody: AttachVolumeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.AttachVolume', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelArchival(callback: (data : CancelArchivalOutput) => any, requestBody: CancelArchivalInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CancelArchival', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelRetrieval(callback: (data : CancelRetrievalOutput) => any, requestBody: CancelRetrievalInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CancelRetrieval', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateCachediSCSIVolume(callback: (data : CreateCachediSCSIVolumeOutput) => any, requestBody: CreateCachediSCSIVolumeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateCachediSCSIVolume', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateNFSFileShare(callback: (data : CreateNFSFileShareOutput) => any, requestBody: CreateNFSFileShareInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateNFSFileShare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSMBFileShare(callback: (data : CreateSMBFileShareOutput) => any, requestBody: CreateSMBFileShareInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSMBFileShare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSnapshot(callback: (data : CreateSnapshotOutput) => any, requestBody: CreateSnapshotInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSnapshot', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateSnapshotFromVolumeRecoveryPoint(callback: (data : CreateSnapshotFromVolumeRecoveryPointOutput) => any, requestBody: CreateSnapshotFromVolumeRecoveryPointInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateSnapshotFromVolumeRecoveryPoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateStorediSCSIVolume(callback: (data : CreateStorediSCSIVolumeOutput) => any, requestBody: CreateStorediSCSIVolumeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateStorediSCSIVolume', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTapeWithBarcode(callback: (data : CreateTapeWithBarcodeOutput) => any, requestBody: CreateTapeWithBarcodeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateTapeWithBarcode', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateTapes(callback: (data : CreateTapesOutput) => any, requestBody: CreateTapesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.CreateTapes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteAutomaticTapeCreationPolicy(callback: (data : DeleteAutomaticTapeCreationPolicyOutput) => any, requestBody: DeleteAutomaticTapeCreationPolicyInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteAutomaticTapeCreationPolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteBandwidthRateLimit(callback: (data : DeleteBandwidthRateLimitOutput) => any, requestBody: DeleteBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteBandwidthRateLimit', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteChapCredentials(callback: (data : DeleteChapCredentialsOutput) => any, requestBody: DeleteChapCredentialsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteChapCredentials', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteFileShare(callback: (data : DeleteFileShareOutput) => any, requestBody: DeleteFileShareInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteFileShare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteGateway(callback: (data : DeleteGatewayOutput) => any, requestBody: DeleteGatewayInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteGateway', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteSnapshotSchedule(callback: (data : DeleteSnapshotScheduleOutput) => any, requestBody: DeleteSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteSnapshotSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTape(callback: (data : DeleteTapeOutput) => any, requestBody: DeleteTapeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteTape', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteTapeArchive(callback: (data : DeleteTapeArchiveOutput) => any, requestBody: DeleteTapeArchiveInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteTapeArchive', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteVolume(callback: (data : DeleteVolumeOutput) => any, requestBody: DeleteVolumeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DeleteVolume', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAvailabilityMonitorTest(callback: (data : DescribeAvailabilityMonitorTestOutput) => any, requestBody: DescribeAvailabilityMonitorTestInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeAvailabilityMonitorTest', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeBandwidthRateLimit(callback: (data : DescribeBandwidthRateLimitOutput) => any, requestBody: DescribeBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeBandwidthRateLimit', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCache(callback: (data : DescribeCacheOutput) => any, requestBody: DescribeCacheInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeCache', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCachediSCSIVolumes(callback: (data : DescribeCachediSCSIVolumesOutput) => any, requestBody: DescribeCachediSCSIVolumesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeCachediSCSIVolumes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeChapCredentials(callback: (data : DescribeChapCredentialsOutput) => any, requestBody: DescribeChapCredentialsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeChapCredentials', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeGatewayInformation(callback: (data : DescribeGatewayInformationOutput) => any, requestBody: DescribeGatewayInformationInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeGatewayInformation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceStartTime(callback: (data : DescribeMaintenanceStartTimeOutput) => any, requestBody: DescribeMaintenanceStartTimeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeMaintenanceStartTime', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeNFSFileShares(callback: (data : DescribeNFSFileSharesOutput) => any, requestBody: DescribeNFSFileSharesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeNFSFileShares', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSMBFileShares(callback: (data : DescribeSMBFileSharesOutput) => any, requestBody: DescribeSMBFileSharesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSMBFileShares', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSMBSettings(callback: (data : DescribeSMBSettingsOutput) => any, requestBody: DescribeSMBSettingsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSMBSettings', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSnapshotSchedule(callback: (data : DescribeSnapshotScheduleOutput) => any, requestBody: DescribeSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeSnapshotSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeStorediSCSIVolumes(callback: (data : DescribeStorediSCSIVolumesOutput) => any, requestBody: DescribeStorediSCSIVolumesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeStorediSCSIVolumes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTapeArchives(Limit: string, Marker: string, callback: (data : DescribeTapeArchivesOutput) => any, requestBody: DescribeTapeArchivesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapeArchives?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTapeRecoveryPoints(Limit: string, Marker: string, callback: (data : DescribeTapeRecoveryPointsOutput) => any, requestBody: DescribeTapeRecoveryPointsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapeRecoveryPoints?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeTapes(Limit: string, Marker: string, callback: (data : DescribeTapesOutput) => any, requestBody: DescribeTapesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeUploadBuffer(callback: (data : DescribeUploadBufferOutput) => any, requestBody: DescribeUploadBufferInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeUploadBuffer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeVTLDevices(Limit: string, Marker: string, callback: (data : DescribeVTLDevicesOutput) => any, requestBody: DescribeVTLDevicesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeVTLDevices?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeWorkingStorage(callback: (data : DescribeWorkingStorageOutput) => any, requestBody: DescribeWorkingStorageInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DescribeWorkingStorage', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetachVolume(callback: (data : DetachVolumeOutput) => any, requestBody: DetachVolumeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DetachVolume', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisableGateway(callback: (data : DisableGatewayOutput) => any, requestBody: DisableGatewayInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.DisableGateway', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		JoinDomain(callback: (data : JoinDomainOutput) => any, requestBody: JoinDomainInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.JoinDomain', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAutomaticTapeCreationPolicies(callback: (data : ListAutomaticTapeCreationPoliciesOutput) => any, requestBody: ListAutomaticTapeCreationPoliciesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListAutomaticTapeCreationPolicies', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFileShares(Limit: string, Marker: string, callback: (data : ListFileSharesOutput) => any, requestBody: ListFileSharesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListFileShares?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListGateways(Limit: string, Marker: string, callback: (data : ListGatewaysOutput) => any, requestBody: ListGatewaysInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListGateways?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListLocalDisks(callback: (data : ListLocalDisksOutput) => any, requestBody: ListLocalDisksInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListLocalDisks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForResource(Limit: string, Marker: string, callback: (data : ListTagsForResourceOutput) => any, requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListTagsForResource?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTapes(Limit: string, Marker: string, callback: (data : ListTapesOutput) => any, requestBody: ListTapesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListVolumeInitiators(callback: (data : ListVolumeInitiatorsOutput) => any, requestBody: ListVolumeInitiatorsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumeInitiators', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListVolumeRecoveryPoints(callback: (data : ListVolumeRecoveryPointsOutput) => any, requestBody: ListVolumeRecoveryPointsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumeRecoveryPoints', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListVolumes(Limit: string, Marker: string, callback: (data : ListVolumesOutput) => any, requestBody: ListVolumesInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ListVolumes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		NotifyWhenUploaded(callback: (data : NotifyWhenUploadedOutput) => any, requestBody: NotifyWhenUploadedInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.NotifyWhenUploaded', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RefreshCache(callback: (data : RefreshCacheOutput) => any, requestBody: RefreshCacheInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RefreshCache', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RemoveTagsFromResource(callback: (data : RemoveTagsFromResourceOutput) => any, requestBody: RemoveTagsFromResourceInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RemoveTagsFromResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ResetCache(callback: (data : ResetCacheOutput) => any, requestBody: ResetCacheInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ResetCache', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RetrieveTapeArchive(callback: (data : RetrieveTapeArchiveOutput) => any, requestBody: RetrieveTapeArchiveInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeArchive', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RetrieveTapeRecoveryPoint(callback: (data : RetrieveTapeRecoveryPointOutput) => any, requestBody: RetrieveTapeRecoveryPointInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeRecoveryPoint', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SetLocalConsolePassword(callback: (data : SetLocalConsolePasswordOutput) => any, requestBody: SetLocalConsolePasswordInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.SetLocalConsolePassword', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SetSMBGuestPassword(callback: (data : SetSMBGuestPasswordOutput) => any, requestBody: SetSMBGuestPasswordInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.SetSMBGuestPassword', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ShutdownGateway(callback: (data : ShutdownGatewayOutput) => any, requestBody: ShutdownGatewayInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.ShutdownGateway', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartAvailabilityMonitorTest(callback: (data : StartAvailabilityMonitorTestOutput) => any, requestBody: StartAvailabilityMonitorTestInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.StartAvailabilityMonitorTest', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartGateway(callback: (data : StartGatewayOutput) => any, requestBody: StartGatewayInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.StartGateway', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateAutomaticTapeCreationPolicy(callback: (data : UpdateAutomaticTapeCreationPolicyOutput) => any, requestBody: UpdateAutomaticTapeCreationPolicyInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateAutomaticTapeCreationPolicy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateBandwidthRateLimit(callback: (data : UpdateBandwidthRateLimitOutput) => any, requestBody: UpdateBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateBandwidthRateLimit', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateChapCredentials(callback: (data : UpdateChapCredentialsOutput) => any, requestBody: UpdateChapCredentialsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateChapCredentials', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateGatewayInformation(callback: (data : UpdateGatewayInformationOutput) => any, requestBody: UpdateGatewayInformationInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateGatewayInformation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateGatewaySoftwareNow(callback: (data : UpdateGatewaySoftwareNowOutput) => any, requestBody: UpdateGatewaySoftwareNowInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateGatewaySoftwareNow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateMaintenanceStartTime(callback: (data : UpdateMaintenanceStartTimeOutput) => any, requestBody: UpdateMaintenanceStartTimeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateMaintenanceStartTime', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateNFSFileShare(callback: (data : UpdateNFSFileShareOutput) => any, requestBody: UpdateNFSFileShareInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateNFSFileShare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSMBFileShare(callback: (data : UpdateSMBFileShareOutput) => any, requestBody: UpdateSMBFileShareInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSMBFileShare', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSMBSecurityStrategy(callback: (data : UpdateSMBSecurityStrategyOutput) => any, requestBody: UpdateSMBSecurityStrategyInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSMBSecurityStrategy', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateSnapshotSchedule(callback: (data : UpdateSnapshotScheduleOutput) => any, requestBody: UpdateSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateSnapshotSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateVTLDeviceType(callback: (data : UpdateVTLDeviceTypeOutput) => any, requestBody: UpdateVTLDeviceTypeInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=StorageGateway_20130630.UpdateVTLDeviceType', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
