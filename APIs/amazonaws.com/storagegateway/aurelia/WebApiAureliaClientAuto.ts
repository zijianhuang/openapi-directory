...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ActivateGateway(requestBody: ActivateGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<ActivateGatewayOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ActivateGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddCache(requestBody: AddCacheInput, headersHandler?: () => {[header: string]: string}): Promise<AddCacheOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.AddCache', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddTagsToResource(requestBody: AddTagsToResourceInput, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddUploadBuffer(requestBody: AddUploadBufferInput, headersHandler?: () => {[header: string]: string}): Promise<AddUploadBufferOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.AddUploadBuffer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AddWorkingStorage(requestBody: AddWorkingStorageInput, headersHandler?: () => {[header: string]: string}): Promise<AddWorkingStorageOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.AddWorkingStorage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssignTapePool(requestBody: AssignTapePoolInput, headersHandler?: () => {[header: string]: string}): Promise<AssignTapePoolOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.AssignTapePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AttachVolume(requestBody: AttachVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<AttachVolumeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.AttachVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelArchival(requestBody: CancelArchivalInput, headersHandler?: () => {[header: string]: string}): Promise<CancelArchivalOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CancelArchival', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelRetrieval(requestBody: CancelRetrievalInput, headersHandler?: () => {[header: string]: string}): Promise<CancelRetrievalOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CancelRetrieval', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateCachediSCSIVolume(requestBody: CreateCachediSCSIVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<CreateCachediSCSIVolumeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateCachediSCSIVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateNFSFileShare(requestBody: CreateNFSFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<CreateNFSFileShareOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateNFSFileShare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSMBFileShare(requestBody: CreateSMBFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSMBFileShareOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateSMBFileShare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSnapshot(requestBody: CreateSnapshotInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSnapshotOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateSnapshot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSnapshotFromVolumeRecoveryPoint(requestBody: CreateSnapshotFromVolumeRecoveryPointInput, headersHandler?: () => {[header: string]: string}): Promise<CreateSnapshotFromVolumeRecoveryPointOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateSnapshotFromVolumeRecoveryPoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateStorediSCSIVolume(requestBody: CreateStorediSCSIVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<CreateStorediSCSIVolumeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateStorediSCSIVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTapeWithBarcode(requestBody: CreateTapeWithBarcodeInput, headersHandler?: () => {[header: string]: string}): Promise<CreateTapeWithBarcodeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateTapeWithBarcode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTapes(requestBody: CreateTapesInput, headersHandler?: () => {[header: string]: string}): Promise<CreateTapesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.CreateTapes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAutomaticTapeCreationPolicy(requestBody: DeleteAutomaticTapeCreationPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteAutomaticTapeCreationPolicyOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteAutomaticTapeCreationPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteBandwidthRateLimit(requestBody: DeleteBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteBandwidthRateLimitOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteBandwidthRateLimit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteChapCredentials(requestBody: DeleteChapCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteChapCredentialsOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteChapCredentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteFileShare(requestBody: DeleteFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteFileShareOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteFileShare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteGateway(requestBody: DeleteGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteGatewayOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSnapshotSchedule(requestBody: DeleteSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteSnapshotScheduleOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteSnapshotSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTape(requestBody: DeleteTapeInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTapeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteTape', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTapeArchive(requestBody: DeleteTapeArchiveInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteTapeArchiveOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteTapeArchive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteVolume(requestBody: DeleteVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteVolumeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DeleteVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAvailabilityMonitorTest(requestBody: DescribeAvailabilityMonitorTestInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeAvailabilityMonitorTestOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeAvailabilityMonitorTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeBandwidthRateLimit(requestBody: DescribeBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeBandwidthRateLimitOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeBandwidthRateLimit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCache(requestBody: DescribeCacheInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeCacheOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeCache', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeCachediSCSIVolumes(requestBody: DescribeCachediSCSIVolumesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeCachediSCSIVolumesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeCachediSCSIVolumes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeChapCredentials(requestBody: DescribeChapCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeChapCredentialsOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeChapCredentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeGatewayInformation(requestBody: DescribeGatewayInformationInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeGatewayInformationOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeGatewayInformation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceStartTime(requestBody: DescribeMaintenanceStartTimeInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceStartTimeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeMaintenanceStartTime', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeNFSFileShares(requestBody: DescribeNFSFileSharesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeNFSFileSharesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeNFSFileShares', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSMBFileShares(requestBody: DescribeSMBFileSharesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSMBFileSharesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeSMBFileShares', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSMBSettings(requestBody: DescribeSMBSettingsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSMBSettingsOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeSMBSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSnapshotSchedule(requestBody: DescribeSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeSnapshotScheduleOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeSnapshotSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeStorediSCSIVolumes(requestBody: DescribeStorediSCSIVolumesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStorediSCSIVolumesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeStorediSCSIVolumes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTapeArchives(Limit: string, Marker: string, requestBody: DescribeTapeArchivesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTapeArchivesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeTapeArchives?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTapeRecoveryPoints(Limit: string, Marker: string, requestBody: DescribeTapeRecoveryPointsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTapeRecoveryPointsOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeTapeRecoveryPoints?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeTapes(Limit: string, Marker: string, requestBody: DescribeTapesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeTapesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeUploadBuffer(requestBody: DescribeUploadBufferInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeUploadBufferOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeUploadBuffer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeVTLDevices(Limit: string, Marker: string, requestBody: DescribeVTLDevicesInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeVTLDevicesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeVTLDevices?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeWorkingStorage(requestBody: DescribeWorkingStorageInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeWorkingStorageOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DescribeWorkingStorage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DetachVolume(requestBody: DetachVolumeInput, headersHandler?: () => {[header: string]: string}): Promise<DetachVolumeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DetachVolume', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableGateway(requestBody: DisableGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<DisableGatewayOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.DisableGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		JoinDomain(requestBody: JoinDomainInput, headersHandler?: () => {[header: string]: string}): Promise<JoinDomainOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.JoinDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAutomaticTapeCreationPolicies(requestBody: ListAutomaticTapeCreationPoliciesInput, headersHandler?: () => {[header: string]: string}): Promise<ListAutomaticTapeCreationPoliciesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListAutomaticTapeCreationPolicies', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListFileShares(Limit: string, Marker: string, requestBody: ListFileSharesInput, headersHandler?: () => {[header: string]: string}): Promise<ListFileSharesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListFileShares?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGateways(Limit: string, Marker: string, requestBody: ListGatewaysInput, headersHandler?: () => {[header: string]: string}): Promise<ListGatewaysOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListGateways?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListLocalDisks(requestBody: ListLocalDisksInput, headersHandler?: () => {[header: string]: string}): Promise<ListLocalDisksOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListLocalDisks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(Limit: string, Marker: string, requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListTagsForResource?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTapes(Limit: string, Marker: string, requestBody: ListTapesInput, headersHandler?: () => {[header: string]: string}): Promise<ListTapesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListTapes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListVolumeInitiators(requestBody: ListVolumeInitiatorsInput, headersHandler?: () => {[header: string]: string}): Promise<ListVolumeInitiatorsOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListVolumeInitiators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListVolumeRecoveryPoints(requestBody: ListVolumeRecoveryPointsInput, headersHandler?: () => {[header: string]: string}): Promise<ListVolumeRecoveryPointsOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListVolumeRecoveryPoints', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListVolumes(Limit: string, Marker: string, requestBody: ListVolumesInput, headersHandler?: () => {[header: string]: string}): Promise<ListVolumesOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ListVolumes?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		NotifyWhenUploaded(requestBody: NotifyWhenUploadedInput, headersHandler?: () => {[header: string]: string}): Promise<NotifyWhenUploadedOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.NotifyWhenUploaded', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RefreshCache(requestBody: RefreshCacheInput, headersHandler?: () => {[header: string]: string}): Promise<RefreshCacheOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.RefreshCache', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceInput, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResetCache(requestBody: ResetCacheInput, headersHandler?: () => {[header: string]: string}): Promise<ResetCacheOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ResetCache', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RetrieveTapeArchive(requestBody: RetrieveTapeArchiveInput, headersHandler?: () => {[header: string]: string}): Promise<RetrieveTapeArchiveOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeArchive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RetrieveTapeRecoveryPoint(requestBody: RetrieveTapeRecoveryPointInput, headersHandler?: () => {[header: string]: string}): Promise<RetrieveTapeRecoveryPointOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.RetrieveTapeRecoveryPoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SetLocalConsolePassword(requestBody: SetLocalConsolePasswordInput, headersHandler?: () => {[header: string]: string}): Promise<SetLocalConsolePasswordOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.SetLocalConsolePassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SetSMBGuestPassword(requestBody: SetSMBGuestPasswordInput, headersHandler?: () => {[header: string]: string}): Promise<SetSMBGuestPasswordOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.SetSMBGuestPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ShutdownGateway(requestBody: ShutdownGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<ShutdownGatewayOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.ShutdownGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartAvailabilityMonitorTest(requestBody: StartAvailabilityMonitorTestInput, headersHandler?: () => {[header: string]: string}): Promise<StartAvailabilityMonitorTestOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.StartAvailabilityMonitorTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartGateway(requestBody: StartGatewayInput, headersHandler?: () => {[header: string]: string}): Promise<StartGatewayOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.StartGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateAutomaticTapeCreationPolicy(requestBody: UpdateAutomaticTapeCreationPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateAutomaticTapeCreationPolicyOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateAutomaticTapeCreationPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateBandwidthRateLimit(requestBody: UpdateBandwidthRateLimitInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateBandwidthRateLimitOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateBandwidthRateLimit', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateChapCredentials(requestBody: UpdateChapCredentialsInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateChapCredentialsOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateChapCredentials', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateGatewayInformation(requestBody: UpdateGatewayInformationInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGatewayInformationOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateGatewayInformation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateGatewaySoftwareNow(requestBody: UpdateGatewaySoftwareNowInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateGatewaySoftwareNowOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateGatewaySoftwareNow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMaintenanceStartTime(requestBody: UpdateMaintenanceStartTimeInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceStartTimeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateMaintenanceStartTime', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNFSFileShare(requestBody: UpdateNFSFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateNFSFileShareOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateNFSFileShare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSMBFileShare(requestBody: UpdateSMBFileShareInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateSMBFileShareOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateSMBFileShare', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSMBSecurityStrategy(requestBody: UpdateSMBSecurityStrategyInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateSMBSecurityStrategyOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateSMBSecurityStrategy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSnapshotSchedule(requestBody: UpdateSnapshotScheduleInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateSnapshotScheduleOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateSnapshotSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateVTLDeviceType(requestBody: UpdateVTLDeviceTypeInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateVTLDeviceTypeOutput> {
			return this.http.post('/#X-Amz-Target=StorageGateway_20130630.UpdateVTLDeviceType', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
