...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AbortDocumentVersionUpload(DocumentId: string, VersionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDocumentVersion(DocumentId: string, VersionId: string, fields: string, includeCustomMetadata: boolean, headersHandler?: () => {[header: string]: string}): Promise<GetDocumentVersionResponse> {
			return this.http.get('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&includeCustomMetadata=' + includeCustomMetadata, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ActivateUser(UserId: string, headersHandler?: () => {[header: string]: string}): Promise<ActivateUserResponse> {
			return this.http.post('/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/activation', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeactivateUser(UserId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/activation', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		AddResourcePermissions(ResourceId: string, requestBody: AddResourcePermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DescribeResourcePermissions(ResourceId: string, principalId: string, limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourcePermissionsResponse> {
			return this.http.get('/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions&principalId=' + (principalId == null ? '' : encodeURIComponent(principalId)) + '&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		RemoveAllResourcePermissions(ResourceId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateComment(DocumentId: string, VersionId: string, requestBody: CreateCommentBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteCustomMetadata(ResourceId: string, versionId: string, keys: Array<CustomMetadataKeyType>, deleteAll: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteCustomMetadataResponse> {
			return this.http.delete('/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/customMetadata&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&' + keys.map(z => `keys=${z}`).join('&') + '&deleteAll=' + deleteAll, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateFolder(requestBody: CreateFolderBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/api/v1/folders', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		CreateLabels(ResourceId: string, requestBody: CreateLabelsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateLabelsResponse> {
			return this.http.put('/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/labels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLabels(ResourceId: string, labels: Array<SharedLabel>, deleteAll: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteLabelsResponse> {
			return this.http.delete('/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/labels&' + labels.map(z => `labels=${z}`).join('&') + '&deleteAll=' + deleteAll, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateNotificationSubscription(OrganizationId: string, requestBody: CreateNotificationSubscriptionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateNotificationSubscriptionResponse> {
			return this.http.post('/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeNotificationSubscriptions(OrganizationId: string, marker: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotificationSubscriptionsResponse> {
			return this.http.get('/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateUser(requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/api/v1/users', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		DeleteComment(DocumentId: string, VersionId: string, CommentId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comment/' + (CommentId == null ? '' : encodeURIComponent(CommentId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocument(DocumentId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDocument(DocumentId: string, includeCustomMetadata: boolean, headersHandler?: () => {[header: string]: string}): Promise<GetDocumentResponse> {
			return this.http.get('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '&includeCustomMetadata=' + includeCustomMetadata, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteFolder(FolderId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetFolder(FolderId: string, includeCustomMetadata: boolean, headersHandler?: () => {[header: string]: string}): Promise<GetFolderResponse> {
			return this.http.get('/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '&includeCustomMetadata=' + includeCustomMetadata, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteFolderContents(FolderId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '/contents', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteNotificationSubscription(SubscriptionId: string, OrganizationId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions/' + (SubscriptionId == null ? '' : encodeURIComponent(SubscriptionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUser(UserId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeComments(DocumentId: string, VersionId: string, limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCommentsResponse> {
			return this.http.get('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comments&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeGroups(searchQuery: string, organizationId: string, marker: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeGroupsResponse> {
			return this.http.get('/api/v1/groups#searchQuery?searchQuery=' + (searchQuery == null ? '' : encodeURIComponent(searchQuery)) + '&organizationId=' + (organizationId == null ? '' : encodeURIComponent(organizationId)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRootFolders(limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRootFoldersResponse> {
			return this.http.get('/api/v1/me/root#Authentication?limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCurrentUser(headersHandler?: () => {[header: string]: string}): Promise<GetCurrentUserResponse> {
			return this.http.get('/api/v1/me#Authentication', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDocumentPath(DocumentId: string, limit: number, fields: string, marker: string, headersHandler?: () => {[header: string]: string}): Promise<GetDocumentPathResponse> {
			return this.http.get('/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/path&limit=' + limit + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFolderPath(FolderId: string, limit: number, fields: string, marker: string, headersHandler?: () => {[header: string]: string}): Promise<GetFolderPathResponse> {
			return this.http.get('/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '/path&limit=' + limit + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetResources(userId: string, collectionType: ResourceCollectionType, limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<GetResourcesResponse> {
			return this.http.get('/api/v1/resources?userId=' + (userId == null ? '' : encodeURIComponent(userId)) + '&collectionType=' + collectionType + '&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		InitiateDocumentVersionUpload(requestBody: InitiateDocumentVersionUploadBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/api/v1/documents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		 ...
		 * @return {void} 
		 */
		RemoveResourcePermission(ResourceId: string, PrincipalId: string, type: SharePrincipalType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions/' + (PrincipalId == null ? '' : encodeURIComponent(PrincipalId)) + '&type=' + type, { headers: headersHandler ? headersHandler() : undefined });
		}
	}
