...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AbortDocumentVersionUpload(DocumentId: string, VersionId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		ActivateUser(UserId: string, headersHandler?: () => HttpHeaders): Observable<ActivateUserResponse> {
			return this.http.post<ActivateUserResponse>(this.baseUri + '/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/activation', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeactivateUser(UserId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/activation', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		AddResourcePermissions(ResourceId: string, requestBody: AddResourcePermissionsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeResourcePermissions(ResourceId: string, principalId: string, limit: number, marker: string, headersHandler?: () => HttpHeaders): Observable<DescribeResourcePermissionsResponse> {
		 ...
		 * @return {void} 
		 */
		RemoveAllResourcePermissions(ResourceId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateComment(DocumentId: string, VersionId: string, requestBody: CreateCommentBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		CreateCustomMetadata(ResourceId: string, versionid: string, requestBody: CreateCustomMetadataBody, headersHandler?: () => HttpHeaders): Observable<CreateCustomMetadataResponse> {
			return this.http.put<CreateCustomMetadataResponse>(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/customMetadata&versionid=' + (versionid == null ? '' : encodeURIComponent(versionid)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteCustomMetadata(ResourceId: string, versionId: string, keys: Array<CustomMetadataKeyType>, deleteAll: boolean, headersHandler?: () => HttpHeaders): Observable<DeleteCustomMetadataResponse> {
			return this.http.delete<DeleteCustomMetadataResponse>(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/customMetadata&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&' + keys.map(z => `keys=${z}`).join('&') + '&deleteAll=' + deleteAll, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateFolder(requestBody: CreateFolderBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/api/v1/folders', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		CreateLabels(ResourceId: string, requestBody: CreateLabelsBody, headersHandler?: () => HttpHeaders): Observable<CreateLabelsResponse> {
			return this.http.put<CreateLabelsResponse>(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/labels', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteLabels(ResourceId: string, labels: Array<SharedLabel>, deleteAll: boolean, headersHandler?: () => HttpHeaders): Observable<DeleteLabelsResponse> {
			return this.http.delete<DeleteLabelsResponse>(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/labels&' + labels.map(z => `labels=${z}`).join('&') + '&deleteAll=' + deleteAll, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateNotificationSubscription(OrganizationId: string, requestBody: CreateNotificationSubscriptionBody, headersHandler?: () => HttpHeaders): Observable<CreateNotificationSubscriptionResponse> {
			return this.http.post<CreateNotificationSubscriptionResponse>(this.baseUri + '/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeNotificationSubscriptions(OrganizationId: string, marker: string, limit: number, headersHandler?: () => HttpHeaders): Observable<DescribeNotificationSubscriptionsResponse> {
			return this.http.get<DescribeNotificationSubscriptionsResponse>(this.baseUri + '/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateUser(requestBody: CreateUserBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/api/v1/users', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeUsers(organizationId: string, userIds: string, query: string, include: UserFilterType, order: OrderType, sort: UserSortType, marker: string, limit: number, fields: string, Limit: string, Marker: string, headersHandler?: () => HttpHeaders): Observable<DescribeUsersResponse> {
		 ...
		 * @return {void} 
		 */
		DeleteComment(DocumentId: string, VersionId: string, CommentId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comment/' + (CommentId == null ? '' : encodeURIComponent(CommentId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocument(DocumentId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDocument(DocumentId: string, includeCustomMetadata: boolean, headersHandler?: () => HttpHeaders): Observable<GetDocumentResponse> {
			return this.http.get<GetDocumentResponse>(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '&includeCustomMetadata=' + includeCustomMetadata, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFolder(FolderId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetFolder(FolderId: string, includeCustomMetadata: boolean, headersHandler?: () => HttpHeaders): Observable<GetFolderResponse> {
			return this.http.get<GetFolderResponse>(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '&includeCustomMetadata=' + includeCustomMetadata, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteFolderContents(FolderId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '/contents', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeFolderContents(FolderId: string, sort: ResourceSortType, order: OrderType, limit: number, marker: string, type: FolderContentType, include: string, Limit: string, Marker: string, headersHandler?: () => HttpHeaders): Observable<DescribeFolderContentsResponse> {
		 ...
		 * @return {void} Success
		 */
		DeleteNotificationSubscription(SubscriptionId: string, OrganizationId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions/' + (SubscriptionId == null ? '' : encodeURIComponent(SubscriptionId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUser(UserId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeActivities(startTime: Date, endTime: Date, organizationId: string, activityTypes: string, resourceId: string, userId: string, includeIndirectActivities: boolean, limit: number, marker: string, headersHandler?: () => HttpHeaders): Observable<DescribeActivitiesResponse> {
		 ...
		 */
		DescribeComments(DocumentId: string, VersionId: string, limit: number, marker: string, headersHandler?: () => HttpHeaders): Observable<DescribeCommentsResponse> {
			return this.http.get<DescribeCommentsResponse>(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comments&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDocumentVersions(DocumentId: string, marker: string, limit: number, include: string, fields: string, Limit: string, Marker: string, headersHandler?: () => HttpHeaders): Observable<DescribeDocumentVersionsResponse> {
		 ...
		 */
		DescribeGroups(searchQuery: string, organizationId: string, marker: string, limit: number, headersHandler?: () => HttpHeaders): Observable<DescribeGroupsResponse> {
		 ...
		 */
		DescribeRootFolders(limit: number, marker: string, headersHandler?: () => HttpHeaders): Observable<DescribeRootFoldersResponse> {
			return this.http.get<DescribeRootFoldersResponse>(this.baseUri + '/api/v1/me/root#Authentication?limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetCurrentUser(headersHandler?: () => HttpHeaders): Observable<GetCurrentUserResponse> {
			return this.http.get<GetCurrentUserResponse>(this.baseUri + '/api/v1/me#Authentication', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetDocumentPath(DocumentId: string, limit: number, fields: string, marker: string, headersHandler?: () => HttpHeaders): Observable<GetDocumentPathResponse> {
			return this.http.get<GetDocumentPathResponse>(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/path&limit=' + limit + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetFolderPath(FolderId: string, limit: number, fields: string, marker: string, headersHandler?: () => HttpHeaders): Observable<GetFolderPathResponse> {
			return this.http.get<GetFolderPathResponse>(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '/path&limit=' + limit + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetResources(userId: string, collectionType: ResourceCollectionType, limit: number, marker: string, headersHandler?: () => HttpHeaders): Observable<GetResourcesResponse> {
			return this.http.get<GetResourcesResponse>(this.baseUri + '/api/v1/resources?userId=' + (userId == null ? '' : encodeURIComponent(userId)) + '&collectionType=' + collectionType + '&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		InitiateDocumentVersionUpload(requestBody: InitiateDocumentVersionUploadBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/api/v1/documents', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RemoveResourcePermission(ResourceId: string, PrincipalId: string, type: SharePrincipalType, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions/' + (PrincipalId == null ? '' : encodeURIComponent(PrincipalId)) + '&type=' + type, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
	}
