export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AbortDocumentVersionUpload(DocumentId: string, VersionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ActivateUser(UserId: string, headersHandler?: () => {[header: string]: string}): Promise<ActivateUserResponse> {
			return fetch(this.baseUri + '/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/activation', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeactivateUser(UserId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)) + '/activation', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		AddResourcePermissions(ResourceId: string, requestBody: AddResourcePermissionsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeResourcePermissions(ResourceId: string, principalId: string, limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourcePermissionsResponse> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions&principalId=' + (principalId == null ? '' : encodeURIComponent(principalId)) + '&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RemoveAllResourcePermissions(ResourceId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		CreateCustomMetadata(ResourceId: string, versionid: string, requestBody: CreateCustomMetadataBody, headersHandler?: () => {[header: string]: string}): Promise<CreateCustomMetadataResponse> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/customMetadata&versionid=' + (versionid == null ? '' : encodeURIComponent(versionid)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteCustomMetadata(ResourceId: string, versionId: string, keys: Array<CustomMetadataKeyType>, deleteAll: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteCustomMetadataResponse> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/customMetadata&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)) + '&' + keys.map(z => `keys=${z}`).join('&') + '&deleteAll=' + deleteAll, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateFolder(requestBody: CreateFolderBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/folders', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateLabels(ResourceId: string, requestBody: CreateLabelsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateLabelsResponse> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/labels', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteLabels(ResourceId: string, labels: Array<SharedLabel>, deleteAll: boolean, headersHandler?: () => {[header: string]: string}): Promise<DeleteLabelsResponse> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/labels&' + labels.map(z => `labels=${z}`).join('&') + '&deleteAll=' + deleteAll, { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeNotificationSubscriptions(OrganizationId: string, marker: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotificationSubscriptionsResponse> {
			return fetch(this.baseUri + '/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateUser(requestBody: CreateUserBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/users', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteComment(DocumentId: string, VersionId: string, CommentId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comment/' + (CommentId == null ? '' : encodeURIComponent(CommentId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteDocument(DocumentId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDocument(DocumentId: string, includeCustomMetadata: boolean, headersHandler?: () => {[header: string]: string}): Promise<GetDocumentResponse> {
			return fetch(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '&includeCustomMetadata=' + includeCustomMetadata, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteFolder(FolderId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetFolder(FolderId: string, includeCustomMetadata: boolean, headersHandler?: () => {[header: string]: string}): Promise<GetFolderResponse> {
			return fetch(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '&includeCustomMetadata=' + includeCustomMetadata, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteFolderContents(FolderId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '/contents', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeFolderContents(FolderId: string, sort: ResourceSortType, order: OrderType, limit: number, marker: string, type: FolderContentType, include: string, Limit: string, Marker: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeFolderContentsResponse> {
			return fetch(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '/contents&sort=' + sort + '&order=' + order + '&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&type=' + type + '&include=' + (include == null ? '' : encodeURIComponent(include)) + '&Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteNotificationSubscription(SubscriptionId: string, OrganizationId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/organizations/' + (OrganizationId == null ? '' : encodeURIComponent(OrganizationId)) + '/subscriptions/' + (SubscriptionId == null ? '' : encodeURIComponent(SubscriptionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteUser(UserId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/users/' + (UserId == null ? '' : encodeURIComponent(UserId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeComments(DocumentId: string, VersionId: string, limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCommentsResponse> {
			return fetch(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/versions/' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '/comments&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRootFolders(limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRootFoldersResponse> {
			return fetch(this.baseUri + '/api/v1/me/root#Authentication?limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCurrentUser(headersHandler?: () => {[header: string]: string}): Promise<GetCurrentUserResponse> {
			return fetch(this.baseUri + '/api/v1/me#Authentication', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDocumentPath(DocumentId: string, limit: number, fields: string, marker: string, headersHandler?: () => {[header: string]: string}): Promise<GetDocumentPathResponse> {
			return fetch(this.baseUri + '/api/v1/documents/' + (DocumentId == null ? '' : encodeURIComponent(DocumentId)) + '/path&limit=' + limit + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFolderPath(FolderId: string, limit: number, fields: string, marker: string, headersHandler?: () => {[header: string]: string}): Promise<GetFolderPathResponse> {
			return fetch(this.baseUri + '/api/v1/folders/' + (FolderId == null ? '' : encodeURIComponent(FolderId)) + '/path&limit=' + limit + '&fields=' + (fields == null ? '' : encodeURIComponent(fields)) + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetResources(userId: string, collectionType: ResourceCollectionType, limit: number, marker: string, headersHandler?: () => {[header: string]: string}): Promise<GetResourcesResponse> {
			return fetch(this.baseUri + '/api/v1/resources?userId=' + (userId == null ? '' : encodeURIComponent(userId)) + '&collectionType=' + collectionType + '&limit=' + limit + '&marker=' + (marker == null ? '' : encodeURIComponent(marker)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		InitiateDocumentVersionUpload(requestBody: InitiateDocumentVersionUploadBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/documents', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RemoveResourcePermission(ResourceId: string, PrincipalId: string, type: SharePrincipalType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/api/v1/resources/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)) + '/permissions/' + (PrincipalId == null ? '' : encodeURIComponent(PrincipalId)) + '&type=' + type, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
	}
