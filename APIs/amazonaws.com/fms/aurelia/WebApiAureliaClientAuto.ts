...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateAdminAccount(requestBody: AssociateAdminAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.AssociateAdminAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteNotificationChannel(requestBody: DeleteNotificationChannelRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.DeleteNotificationChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeletePolicy(requestBody: DeletePolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.DeletePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DisassociateAdminAccount(requestBody: DisassociateAdminAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.DisassociateAdminAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetAdminAccount(requestBody: GetAdminAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAdminAccountResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.GetAdminAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetComplianceDetail(requestBody: GetComplianceDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<GetComplianceDetailResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.GetComplianceDetail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetNotificationChannel(requestBody: GetNotificationChannelRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNotificationChannelResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.GetNotificationChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPolicy(requestBody: GetPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPolicyResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.GetPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetProtectionStatus(requestBody: GetProtectionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetProtectionStatusResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.GetProtectionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListComplianceStatus(MaxResults: string, NextToken: string, requestBody: ListComplianceStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<ListComplianceStatusResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.ListComplianceStatus?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListMemberAccounts(MaxResults: string, NextToken: string, requestBody: ListMemberAccountsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMemberAccountsResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.ListMemberAccounts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPolicies(MaxResults: string, NextToken: string, requestBody: ListPoliciesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPoliciesResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.ListPolicies?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutNotificationChannel(requestBody: PutNotificationChannelRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.PutNotificationChannel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutPolicy(requestBody: PutPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutPolicyResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.PutPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AWSFMS_20180101.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
