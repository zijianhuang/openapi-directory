...
namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToResource(callback: (data : AddTagsToResourceResult) => any, requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.AddTagsToResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelCommand(callback: (data : CancelCommandResult) => any, requestBody: CancelCommandRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CancelCommand', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelMaintenanceWindowExecution(callback: (data : CancelMaintenanceWindowExecutionResult) => any, requestBody: CancelMaintenanceWindowExecutionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CancelMaintenanceWindowExecution', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateActivation(callback: (data : CreateActivationResult) => any, requestBody: CreateActivationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateActivation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateAssociation(callback: (data : CreateAssociationResult) => any, requestBody: CreateAssociationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateAssociation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateAssociationBatch(callback: (data : CreateAssociationBatchResult) => any, requestBody: CreateAssociationBatchRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateAssociationBatch', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateDocument(callback: (data : CreateDocumentResult) => any, requestBody: CreateDocumentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateDocument', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateMaintenanceWindow(callback: (data : CreateMaintenanceWindowResult) => any, requestBody: CreateMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateOpsItem(callback: (data : CreateOpsItemResponse) => any, requestBody: CreateOpsItemRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateOpsItem', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreatePatchBaseline(callback: (data : CreatePatchBaselineResult) => any, requestBody: CreatePatchBaselineRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreatePatchBaseline', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateResourceDataSync(callback: (data : CreateResourceDataSyncResult) => any, requestBody: CreateResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateResourceDataSync', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteActivation(callback: (data : DeleteActivationResult) => any, requestBody: DeleteActivationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteActivation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteAssociation(callback: (data : DeleteAssociationResult) => any, requestBody: DeleteAssociationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteAssociation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDocument(callback: (data : DeleteDocumentResult) => any, requestBody: DeleteDocumentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteDocument', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteInventory(callback: (data : DeleteInventoryResult) => any, requestBody: DeleteInventoryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteInventory', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteMaintenanceWindow(callback: (data : DeleteMaintenanceWindowResult) => any, requestBody: DeleteMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteParameter(callback: (data : DeleteParameterResult) => any, requestBody: DeleteParameterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteParameter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteParameters(callback: (data : DeleteParametersResult) => any, requestBody: DeleteParametersRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteParameters', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeletePatchBaseline(callback: (data : DeletePatchBaselineResult) => any, requestBody: DeletePatchBaselineRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeletePatchBaseline', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteResourceDataSync(callback: (data : DeleteResourceDataSyncResult) => any, requestBody: DeleteResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteResourceDataSync', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeregisterManagedInstance(callback: (data : DeregisterManagedInstanceResult) => any, requestBody: DeregisterManagedInstanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterManagedInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeregisterPatchBaselineForPatchGroup(callback: (data : DeregisterPatchBaselineForPatchGroupResult) => any, requestBody: DeregisterPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterPatchBaselineForPatchGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeregisterTargetFromMaintenanceWindow(callback: (data : DeregisterTargetFromMaintenanceWindowResult) => any, requestBody: DeregisterTargetFromMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterTargetFromMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeregisterTaskFromMaintenanceWindow(callback: (data : DeregisterTaskFromMaintenanceWindowResult) => any, requestBody: DeregisterTaskFromMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterTaskFromMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeActivations(MaxResults: string, NextToken: string, callback: (data : DescribeActivationsResult) => any, requestBody: DescribeActivationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeActivations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAssociation(callback: (data : DescribeAssociationResult) => any, requestBody: DescribeAssociationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAssociation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAssociationExecutionTargets(callback: (data : DescribeAssociationExecutionTargetsResult) => any, requestBody: DescribeAssociationExecutionTargetsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAssociationExecutionTargets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAssociationExecutions(callback: (data : DescribeAssociationExecutionsResult) => any, requestBody: DescribeAssociationExecutionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAssociationExecutions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAutomationExecutions(callback: (data : DescribeAutomationExecutionsResult) => any, requestBody: DescribeAutomationExecutionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAutomationExecutions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAutomationStepExecutions(callback: (data : DescribeAutomationStepExecutionsResult) => any, requestBody: DescribeAutomationStepExecutionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAutomationStepExecutions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAvailablePatches(callback: (data : DescribeAvailablePatchesResult) => any, requestBody: DescribeAvailablePatchesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAvailablePatches', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDocument(callback: (data : DescribeDocumentResult) => any, requestBody: DescribeDocumentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeDocument', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDocumentPermission(callback: (data : DescribeDocumentPermissionResponse) => any, requestBody: DescribeDocumentPermissionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeDocumentPermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeEffectiveInstanceAssociations(callback: (data : DescribeEffectiveInstanceAssociationsResult) => any, requestBody: DescribeEffectiveInstanceAssociationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeEffectiveInstanceAssociations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeEffectivePatchesForPatchBaseline(callback: (data : DescribeEffectivePatchesForPatchBaselineResult) => any, requestBody: DescribeEffectivePatchesForPatchBaselineRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeEffectivePatchesForPatchBaseline', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeInstanceAssociationsStatus(callback: (data : DescribeInstanceAssociationsStatusResult) => any, requestBody: DescribeInstanceAssociationsStatusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstanceAssociationsStatus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeInstanceInformation(MaxResults: string, NextToken: string, callback: (data : DescribeInstanceInformationResult) => any, requestBody: DescribeInstanceInformationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstanceInformation?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeInstancePatchStates(callback: (data : DescribeInstancePatchStatesResult) => any, requestBody: DescribeInstancePatchStatesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstancePatchStates', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeInstancePatchStatesForPatchGroup(callback: (data : DescribeInstancePatchStatesForPatchGroupResult) => any, requestBody: DescribeInstancePatchStatesForPatchGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstancePatchStatesForPatchGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeInstancePatches(callback: (data : DescribeInstancePatchesResult) => any, requestBody: DescribeInstancePatchesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstancePatches', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeInventoryDeletions(callback: (data : DescribeInventoryDeletionsResult) => any, requestBody: DescribeInventoryDeletionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInventoryDeletions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindowExecutionTaskInvocations(callback: (data : DescribeMaintenanceWindowExecutionTaskInvocationsResult) => any, requestBody: DescribeMaintenanceWindowExecutionTaskInvocationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutionTaskInvocations', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindowExecutionTasks(callback: (data : DescribeMaintenanceWindowExecutionTasksResult) => any, requestBody: DescribeMaintenanceWindowExecutionTasksRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutionTasks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindowExecutions(callback: (data : DescribeMaintenanceWindowExecutionsResult) => any, requestBody: DescribeMaintenanceWindowExecutionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindowSchedule(callback: (data : DescribeMaintenanceWindowScheduleResult) => any, requestBody: DescribeMaintenanceWindowScheduleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowSchedule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindowTargets(callback: (data : DescribeMaintenanceWindowTargetsResult) => any, requestBody: DescribeMaintenanceWindowTargetsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTargets', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindowTasks(callback: (data : DescribeMaintenanceWindowTasksResult) => any, requestBody: DescribeMaintenanceWindowTasksRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTasks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindows(callback: (data : DescribeMaintenanceWindowsResult) => any, requestBody: DescribeMaintenanceWindowsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindows', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeMaintenanceWindowsForTarget(callback: (data : DescribeMaintenanceWindowsForTargetResult) => any, requestBody: DescribeMaintenanceWindowsForTargetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowsForTarget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeOpsItems(callback: (data : DescribeOpsItemsResponse) => any, requestBody: DescribeOpsItemsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeOpsItems', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeParameters(MaxResults: string, NextToken: string, callback: (data : DescribeParametersResult) => any, requestBody: DescribeParametersRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeParameters?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribePatchBaselines(callback: (data : DescribePatchBaselinesResult) => any, requestBody: DescribePatchBaselinesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchBaselines', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribePatchGroupState(callback: (data : DescribePatchGroupStateResult) => any, requestBody: DescribePatchGroupStateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchGroupState', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribePatchGroups(callback: (data : DescribePatchGroupsResult) => any, requestBody: DescribePatchGroupsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchGroups', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribePatchProperties(callback: (data : DescribePatchPropertiesResult) => any, requestBody: DescribePatchPropertiesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchProperties', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeSessions(callback: (data : DescribeSessionsResponse) => any, requestBody: DescribeSessionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeSessions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetAutomationExecution(callback: (data : GetAutomationExecutionResult) => any, requestBody: GetAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetAutomationExecution', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCalendarState(callback: (data : GetCalendarStateResponse) => any, requestBody: GetCalendarStateRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetCalendarState', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCommandInvocation(callback: (data : GetCommandInvocationResult) => any, requestBody: GetCommandInvocationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetCommandInvocation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetConnectionStatus(callback: (data : GetConnectionStatusResponse) => any, requestBody: GetConnectionStatusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetConnectionStatus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDefaultPatchBaseline(callback: (data : GetDefaultPatchBaselineResult) => any, requestBody: GetDefaultPatchBaselineRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetDefaultPatchBaseline', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDeployablePatchSnapshotForInstance(callback: (data : GetDeployablePatchSnapshotForInstanceResult) => any, requestBody: GetDeployablePatchSnapshotForInstanceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetDeployablePatchSnapshotForInstance', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDocument(callback: (data : GetDocumentResult) => any, requestBody: GetDocumentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetDocument', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetInventory(callback: (data : GetInventoryResult) => any, requestBody: GetInventoryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetInventory', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetInventorySchema(callback: (data : GetInventorySchemaResult) => any, requestBody: GetInventorySchemaRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetInventorySchema', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetMaintenanceWindow(callback: (data : GetMaintenanceWindowResult) => any, requestBody: GetMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetMaintenanceWindowExecution(callback: (data : GetMaintenanceWindowExecutionResult) => any, requestBody: GetMaintenanceWindowExecutionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecution', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetMaintenanceWindowExecutionTask(callback: (data : GetMaintenanceWindowExecutionTaskResult) => any, requestBody: GetMaintenanceWindowExecutionTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecutionTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetMaintenanceWindowExecutionTaskInvocation(callback: (data : GetMaintenanceWindowExecutionTaskInvocationResult) => any, requestBody: GetMaintenanceWindowExecutionTaskInvocationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecutionTaskInvocation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetMaintenanceWindowTask(callback: (data : GetMaintenanceWindowTaskResult) => any, requestBody: GetMaintenanceWindowTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetOpsItem(callback: (data : GetOpsItemResponse) => any, requestBody: GetOpsItemRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetOpsItem', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetOpsSummary(callback: (data : GetOpsSummaryResult) => any, requestBody: GetOpsSummaryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetOpsSummary', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetParameter(callback: (data : GetParameterResult) => any, requestBody: GetParameterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParameter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetParameterHistory(MaxResults: string, NextToken: string, callback: (data : GetParameterHistoryResult) => any, requestBody: GetParameterHistoryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParameterHistory?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetParameters(callback: (data : GetParametersResult) => any, requestBody: GetParametersRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParameters', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetParametersByPath(MaxResults: string, NextToken: string, callback: (data : GetParametersByPathResult) => any, requestBody: GetParametersByPathRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParametersByPath?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetPatchBaseline(callback: (data : GetPatchBaselineResult) => any, requestBody: GetPatchBaselineRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetPatchBaseline', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetPatchBaselineForPatchGroup(callback: (data : GetPatchBaselineForPatchGroupResult) => any, requestBody: GetPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetPatchBaselineForPatchGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetServiceSetting(callback: (data : GetServiceSettingResult) => any, requestBody: GetServiceSettingRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetServiceSetting', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		LabelParameterVersion(callback: (data : LabelParameterVersionResult) => any, requestBody: LabelParameterVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.LabelParameterVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAssociationVersions(callback: (data : ListAssociationVersionsResult) => any, requestBody: ListAssociationVersionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListAssociationVersions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListAssociations(MaxResults: string, NextToken: string, callback: (data : ListAssociationsResult) => any, requestBody: ListAssociationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListAssociations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCommandInvocations(MaxResults: string, NextToken: string, callback: (data : ListCommandInvocationsResult) => any, requestBody: ListCommandInvocationsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListCommandInvocations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCommands(MaxResults: string, NextToken: string, callback: (data : ListCommandsResult) => any, requestBody: ListCommandsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListCommands?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListComplianceItems(callback: (data : ListComplianceItemsResult) => any, requestBody: ListComplianceItemsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListComplianceItems', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListComplianceSummaries(callback: (data : ListComplianceSummariesResult) => any, requestBody: ListComplianceSummariesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListComplianceSummaries', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDocumentVersions(callback: (data : ListDocumentVersionsResult) => any, requestBody: ListDocumentVersionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListDocumentVersions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDocuments(MaxResults: string, NextToken: string, callback: (data : ListDocumentsResult) => any, requestBody: ListDocumentsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListDocuments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListInventoryEntries(callback: (data : ListInventoryEntriesResult) => any, requestBody: ListInventoryEntriesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListInventoryEntries', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResourceComplianceSummaries(callback: (data : ListResourceComplianceSummariesResult) => any, requestBody: ListResourceComplianceSummariesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListResourceComplianceSummaries', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListResourceDataSync(callback: (data : ListResourceDataSyncResult) => any, requestBody: ListResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListResourceDataSync', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		ListTagsForResource(callback: (data : ListTagsForResourceResult) => any, requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListTagsForResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ModifyDocumentPermission(callback: (data : ModifyDocumentPermissionResponse) => any, requestBody: ModifyDocumentPermissionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ModifyDocumentPermission', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutComplianceItems(callback: (data : PutComplianceItemsResult) => any, requestBody: PutComplianceItemsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.PutComplianceItems', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutInventory(callback: (data : PutInventoryResult) => any, requestBody: PutInventoryRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.PutInventory', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutParameter(callback: (data : PutParameterResult) => any, requestBody: PutParameterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.PutParameter', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterDefaultPatchBaseline(callback: (data : RegisterDefaultPatchBaselineResult) => any, requestBody: RegisterDefaultPatchBaselineRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterDefaultPatchBaseline', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterPatchBaselineForPatchGroup(callback: (data : RegisterPatchBaselineForPatchGroupResult) => any, requestBody: RegisterPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterPatchBaselineForPatchGroup', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterTargetWithMaintenanceWindow(callback: (data : RegisterTargetWithMaintenanceWindowResult) => any, requestBody: RegisterTargetWithMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterTargetWithMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterTaskWithMaintenanceWindow(callback: (data : RegisterTaskWithMaintenanceWindowResult) => any, requestBody: RegisterTaskWithMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterTaskWithMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		RemoveTagsFromResource(callback: (data : RemoveTagsFromResourceResult) => any, requestBody: RemoveTagsFromResourceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.RemoveTagsFromResource', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ResetServiceSetting(callback: (data : ResetServiceSettingResult) => any, requestBody: ResetServiceSettingRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ResetServiceSetting', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ResumeSession(callback: (data : ResumeSessionResponse) => any, requestBody: ResumeSessionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.ResumeSession', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SendAutomationSignal(callback: (data : SendAutomationSignalResult) => any, requestBody: SendAutomationSignalRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.SendAutomationSignal', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SendCommand(callback: (data : SendCommandResult) => any, requestBody: SendCommandRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.SendCommand', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartAssociationsOnce(callback: (data : StartAssociationsOnceResult) => any, requestBody: StartAssociationsOnceRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.StartAssociationsOnce', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartAutomationExecution(callback: (data : StartAutomationExecutionResult) => any, requestBody: StartAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.StartAutomationExecution', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartSession(callback: (data : StartSessionResponse) => any, requestBody: StartSessionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.StartSession', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopAutomationExecution(callback: (data : StopAutomationExecutionResult) => any, requestBody: StopAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.StopAutomationExecution', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TerminateSession(callback: (data : TerminateSessionResponse) => any, requestBody: TerminateSessionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.TerminateSession', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateAssociation(callback: (data : UpdateAssociationResult) => any, requestBody: UpdateAssociationRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateAssociation', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateAssociationStatus(callback: (data : UpdateAssociationStatusResult) => any, requestBody: UpdateAssociationStatusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateAssociationStatus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDocument(callback: (data : UpdateDocumentResult) => any, requestBody: UpdateDocumentRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateDocument', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDocumentDefaultVersion(callback: (data : UpdateDocumentDefaultVersionResult) => any, requestBody: UpdateDocumentDefaultVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateDocumentDefaultVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateMaintenanceWindow(callback: (data : UpdateMaintenanceWindowResult) => any, requestBody: UpdateMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindow', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateMaintenanceWindowTarget(callback: (data : UpdateMaintenanceWindowTargetResult) => any, requestBody: UpdateMaintenanceWindowTargetRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTarget', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateMaintenanceWindowTask(callback: (data : UpdateMaintenanceWindowTaskResult) => any, requestBody: UpdateMaintenanceWindowTaskRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTask', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateManagedInstanceRole(callback: (data : UpdateManagedInstanceRoleResult) => any, requestBody: UpdateManagedInstanceRoleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateManagedInstanceRole', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateOpsItem(callback: (data : UpdateOpsItemResponse) => any, requestBody: UpdateOpsItemRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateOpsItem', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdatePatchBaseline(callback: (data : UpdatePatchBaselineResult) => any, requestBody: UpdatePatchBaselineRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdatePatchBaseline', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateResourceDataSync(callback: (data : UpdateResourceDataSyncResult) => any, requestBody: UpdateResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateResourceDataSync', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateServiceSetting(callback: (data : UpdateServiceSettingResult) => any, requestBody: UpdateServiceSettingRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateServiceSetting', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
