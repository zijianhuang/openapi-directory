...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToResource(requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelCommand(requestBody: CancelCommandRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelCommandResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CancelCommand', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelMaintenanceWindowExecution(requestBody: CancelMaintenanceWindowExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelMaintenanceWindowExecutionResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CancelMaintenanceWindowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateActivation(requestBody: CreateActivationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateActivationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreateActivation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAssociation(requestBody: CreateAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssociationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreateAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAssociationBatch(requestBody: CreateAssociationBatchRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssociationBatchResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreateAssociationBatch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDocument(requestBody: CreateDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDocumentResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreateDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateMaintenanceWindow(requestBody: CreateMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreateMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateOpsItem(requestBody: CreateOpsItemRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateOpsItemResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreateOpsItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePatchBaseline(requestBody: CreatePatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePatchBaselineResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreatePatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateResourceDataSync(requestBody: CreateResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceDataSyncResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.CreateResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteActivation(requestBody: DeleteActivationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteActivationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteActivation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAssociation(requestBody: DeleteAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAssociationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDocument(requestBody: DeleteDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDocumentResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInventory(requestBody: DeleteInventoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInventoryResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteInventory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMaintenanceWindow(requestBody: DeleteMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteParameter(requestBody: DeleteParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteParameterResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteParameters(requestBody: DeleteParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteParametersResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeletePatchBaseline(requestBody: DeletePatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<DeletePatchBaselineResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeletePatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResourceDataSync(requestBody: DeleteResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourceDataSyncResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeleteResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterManagedInstance(requestBody: DeregisterManagedInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterManagedInstanceResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeregisterManagedInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterPatchBaselineForPatchGroup(requestBody: DeregisterPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterPatchBaselineForPatchGroupResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeregisterPatchBaselineForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterTargetFromMaintenanceWindow(requestBody: DeregisterTargetFromMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterTargetFromMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeregisterTargetFromMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterTaskFromMaintenanceWindow(requestBody: DeregisterTaskFromMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterTaskFromMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DeregisterTaskFromMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAssociation(requestBody: DescribeAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssociationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAssociationExecutionTargets(requestBody: DescribeAssociationExecutionTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssociationExecutionTargetsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeAssociationExecutionTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAssociationExecutions(requestBody: DescribeAssociationExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssociationExecutionsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeAssociationExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAutomationExecutions(requestBody: DescribeAutomationExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAutomationExecutionsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeAutomationExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAutomationStepExecutions(requestBody: DescribeAutomationStepExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAutomationStepExecutionsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeAutomationStepExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeAvailablePatches(requestBody: DescribeAvailablePatchesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAvailablePatchesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeAvailablePatches', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDocument(requestBody: DescribeDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDocumentPermission(requestBody: DescribeDocumentPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentPermissionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeDocumentPermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeEffectiveInstanceAssociations(requestBody: DescribeEffectiveInstanceAssociationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEffectiveInstanceAssociationsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeEffectiveInstanceAssociations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeEffectivePatchesForPatchBaseline(requestBody: DescribeEffectivePatchesForPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEffectivePatchesForPatchBaselineResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeEffectivePatchesForPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeInstanceAssociationsStatus(requestBody: DescribeInstanceAssociationsStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstanceAssociationsStatusResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeInstanceAssociationsStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeInstancePatchStates(requestBody: DescribeInstancePatchStatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancePatchStatesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeInstancePatchStates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeInstancePatchStatesForPatchGroup(requestBody: DescribeInstancePatchStatesForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancePatchStatesForPatchGroupResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeInstancePatchStatesForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeInstancePatches(requestBody: DescribeInstancePatchesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancePatchesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeInstancePatches', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeInventoryDeletions(requestBody: DescribeInventoryDeletionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInventoryDeletionsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeInventoryDeletions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindowExecutionTaskInvocations(requestBody: DescribeMaintenanceWindowExecutionTaskInvocationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowExecutionTaskInvocationsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutionTaskInvocations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindowExecutionTasks(requestBody: DescribeMaintenanceWindowExecutionTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowExecutionTasksResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutionTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindowExecutions(requestBody: DescribeMaintenanceWindowExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowExecutionsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindowSchedule(requestBody: DescribeMaintenanceWindowScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowScheduleResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindowTargets(requestBody: DescribeMaintenanceWindowTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowTargetsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindowTasks(requestBody: DescribeMaintenanceWindowTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowTasksResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindows(requestBody: DescribeMaintenanceWindowsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMaintenanceWindowsForTarget(requestBody: DescribeMaintenanceWindowsForTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowsForTargetResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowsForTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOpsItems(requestBody: DescribeOpsItemsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOpsItemsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeOpsItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribePatchBaselines(requestBody: DescribePatchBaselinesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchBaselinesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribePatchBaselines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribePatchGroupState(requestBody: DescribePatchGroupStateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchGroupStateResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribePatchGroupState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribePatchGroups(requestBody: DescribePatchGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchGroupsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribePatchGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribePatchProperties(requestBody: DescribePatchPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchPropertiesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribePatchProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSessions(requestBody: DescribeSessionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSessionsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.DescribeSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAutomationExecution(requestBody: GetAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAutomationExecutionResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetAutomationExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCalendarState(requestBody: GetCalendarStateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCalendarStateResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetCalendarState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCommandInvocation(requestBody: GetCommandInvocationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCommandInvocationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetCommandInvocation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetConnectionStatus(requestBody: GetConnectionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConnectionStatusResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetConnectionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDefaultPatchBaseline(requestBody: GetDefaultPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDefaultPatchBaselineResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetDefaultPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeployablePatchSnapshotForInstance(requestBody: GetDeployablePatchSnapshotForInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeployablePatchSnapshotForInstanceResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetDeployablePatchSnapshotForInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDocument(requestBody: GetDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDocumentResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInventory(requestBody: GetInventoryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInventoryResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetInventory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInventorySchema(requestBody: GetInventorySchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInventorySchemaResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetInventorySchema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMaintenanceWindow(requestBody: GetMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMaintenanceWindowExecution(requestBody: GetMaintenanceWindowExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowExecutionResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMaintenanceWindowExecutionTask(requestBody: GetMaintenanceWindowExecutionTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowExecutionTaskResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecutionTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMaintenanceWindowExecutionTaskInvocation(requestBody: GetMaintenanceWindowExecutionTaskInvocationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowExecutionTaskInvocationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecutionTaskInvocation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMaintenanceWindowTask(requestBody: GetMaintenanceWindowTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowTaskResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOpsItem(requestBody: GetOpsItemRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOpsItemResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetOpsItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOpsSummary(requestBody: GetOpsSummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOpsSummaryResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetOpsSummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetParameter(requestBody: GetParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParameterResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetParameters(requestBody: GetParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParametersResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPatchBaseline(requestBody: GetPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPatchBaselineResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetPatchBaselineForPatchGroup(requestBody: GetPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPatchBaselineForPatchGroupResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetPatchBaselineForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetServiceSetting(requestBody: GetServiceSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<GetServiceSettingResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.GetServiceSetting', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		LabelParameterVersion(requestBody: LabelParameterVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<LabelParameterVersionResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.LabelParameterVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAssociationVersions(requestBody: ListAssociationVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssociationVersionsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListAssociationVersions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListComplianceItems(requestBody: ListComplianceItemsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListComplianceItemsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListComplianceItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListComplianceSummaries(requestBody: ListComplianceSummariesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListComplianceSummariesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListComplianceSummaries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDocumentVersions(requestBody: ListDocumentVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDocumentVersionsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListDocumentVersions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInventoryEntries(requestBody: ListInventoryEntriesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListInventoryEntriesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListInventoryEntries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResourceComplianceSummaries(requestBody: ListResourceComplianceSummariesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceComplianceSummariesResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListResourceComplianceSummaries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResourceDataSync(requestBody: ListResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceDataSyncResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ModifyDocumentPermission(requestBody: ModifyDocumentPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyDocumentPermissionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ModifyDocumentPermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutComplianceItems(requestBody: PutComplianceItemsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutComplianceItemsResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.PutComplianceItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutInventory(requestBody: PutInventoryRequest, headersHandler?: () => {[header: string]: string}): Promise<PutInventoryResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.PutInventory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutParameter(requestBody: PutParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<PutParameterResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.PutParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterDefaultPatchBaseline(requestBody: RegisterDefaultPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterDefaultPatchBaselineResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.RegisterDefaultPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterPatchBaselineForPatchGroup(requestBody: RegisterPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterPatchBaselineForPatchGroupResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.RegisterPatchBaselineForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterTargetWithMaintenanceWindow(requestBody: RegisterTargetWithMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterTargetWithMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.RegisterTargetWithMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterTaskWithMaintenanceWindow(requestBody: RegisterTaskWithMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterTaskWithMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.RegisterTaskWithMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResetServiceSetting(requestBody: ResetServiceSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetServiceSettingResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ResetServiceSetting', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResumeSession(requestBody: ResumeSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<ResumeSessionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.ResumeSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendAutomationSignal(requestBody: SendAutomationSignalRequest, headersHandler?: () => {[header: string]: string}): Promise<SendAutomationSignalResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.SendAutomationSignal', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendCommand(requestBody: SendCommandRequest, headersHandler?: () => {[header: string]: string}): Promise<SendCommandResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.SendCommand', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartAssociationsOnce(requestBody: StartAssociationsOnceRequest, headersHandler?: () => {[header: string]: string}): Promise<StartAssociationsOnceResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.StartAssociationsOnce', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartAutomationExecution(requestBody: StartAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartAutomationExecutionResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.StartAutomationExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartSession(requestBody: StartSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSessionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.StartSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopAutomationExecution(requestBody: StopAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<StopAutomationExecutionResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.StopAutomationExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TerminateSession(requestBody: TerminateSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<TerminateSessionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.TerminateSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateAssociation(requestBody: UpdateAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAssociationResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateAssociationStatus(requestBody: UpdateAssociationStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAssociationStatusResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateAssociationStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDocument(requestBody: UpdateDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDocumentResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDocumentDefaultVersion(requestBody: UpdateDocumentDefaultVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDocumentDefaultVersionResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateDocumentDefaultVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMaintenanceWindow(requestBody: UpdateMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceWindowResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMaintenanceWindowTarget(requestBody: UpdateMaintenanceWindowTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceWindowTargetResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMaintenanceWindowTask(requestBody: UpdateMaintenanceWindowTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceWindowTaskResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateManagedInstanceRole(requestBody: UpdateManagedInstanceRoleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateManagedInstanceRoleResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateManagedInstanceRole', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateOpsItem(requestBody: UpdateOpsItemRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateOpsItemResponse> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateOpsItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdatePatchBaseline(requestBody: UpdatePatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdatePatchBaselineResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdatePatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateResourceDataSync(requestBody: UpdateResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateResourceDataSyncResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateServiceSetting(requestBody: UpdateServiceSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServiceSettingResult> {
			return this.http.post('/#X-Amz-Target=AmazonSSM.UpdateServiceSetting', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
