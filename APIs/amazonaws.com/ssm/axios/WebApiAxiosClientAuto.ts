...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToResource(requestBody: AddTagsToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResult> {
			return Axios.post<AddTagsToResourceResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelCommand(requestBody: CancelCommandRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelCommandResult> {
			return Axios.post<CancelCommandResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CancelCommand', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelMaintenanceWindowExecution(requestBody: CancelMaintenanceWindowExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelMaintenanceWindowExecutionResult> {
			return Axios.post<CancelMaintenanceWindowExecutionResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CancelMaintenanceWindowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateActivation(requestBody: CreateActivationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateActivationResult> {
			return Axios.post<CreateActivationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateActivation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAssociation(requestBody: CreateAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssociationResult> {
			return Axios.post<CreateAssociationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAssociationBatch(requestBody: CreateAssociationBatchRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssociationBatchResult> {
			return Axios.post<CreateAssociationBatchResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateAssociationBatch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDocument(requestBody: CreateDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDocumentResult> {
			return Axios.post<CreateDocumentResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateMaintenanceWindow(requestBody: CreateMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateMaintenanceWindowResult> {
			return Axios.post<CreateMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateOpsItem(requestBody: CreateOpsItemRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateOpsItemResponse> {
			return Axios.post<CreateOpsItemResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateOpsItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePatchBaseline(requestBody: CreatePatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<CreatePatchBaselineResult> {
			return Axios.post<CreatePatchBaselineResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreatePatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateResourceDataSync(requestBody: CreateResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceDataSyncResult> {
			return Axios.post<CreateResourceDataSyncResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.CreateResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteActivation(requestBody: DeleteActivationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteActivationResult> {
			return Axios.post<DeleteActivationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteActivation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteAssociation(requestBody: DeleteAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAssociationResult> {
			return Axios.post<DeleteAssociationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDocument(requestBody: DeleteDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDocumentResult> {
			return Axios.post<DeleteDocumentResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteInventory(requestBody: DeleteInventoryRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInventoryResult> {
			return Axios.post<DeleteInventoryResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteInventory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteMaintenanceWindow(requestBody: DeleteMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteMaintenanceWindowResult> {
			return Axios.post<DeleteMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteParameter(requestBody: DeleteParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteParameterResult> {
			return Axios.post<DeleteParameterResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteParameters(requestBody: DeleteParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteParametersResult> {
			return Axios.post<DeleteParametersResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeletePatchBaseline(requestBody: DeletePatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<DeletePatchBaselineResult> {
			return Axios.post<DeletePatchBaselineResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeletePatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteResourceDataSync(requestBody: DeleteResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourceDataSyncResult> {
			return Axios.post<DeleteResourceDataSyncResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeleteResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeregisterManagedInstance(requestBody: DeregisterManagedInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterManagedInstanceResult> {
			return Axios.post<DeregisterManagedInstanceResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterManagedInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeregisterPatchBaselineForPatchGroup(requestBody: DeregisterPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterPatchBaselineForPatchGroupResult> {
			return Axios.post<DeregisterPatchBaselineForPatchGroupResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterPatchBaselineForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeregisterTargetFromMaintenanceWindow(requestBody: DeregisterTargetFromMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterTargetFromMaintenanceWindowResult> {
			return Axios.post<DeregisterTargetFromMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterTargetFromMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeregisterTaskFromMaintenanceWindow(requestBody: DeregisterTaskFromMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterTaskFromMaintenanceWindowResult> {
			return Axios.post<DeregisterTaskFromMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DeregisterTaskFromMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAssociation(requestBody: DescribeAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssociationResult> {
			return Axios.post<DescribeAssociationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAssociationExecutionTargets(requestBody: DescribeAssociationExecutionTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssociationExecutionTargetsResult> {
			return Axios.post<DescribeAssociationExecutionTargetsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAssociationExecutionTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAssociationExecutions(requestBody: DescribeAssociationExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssociationExecutionsResult> {
			return Axios.post<DescribeAssociationExecutionsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAssociationExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAutomationExecutions(requestBody: DescribeAutomationExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAutomationExecutionsResult> {
			return Axios.post<DescribeAutomationExecutionsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAutomationExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAutomationStepExecutions(requestBody: DescribeAutomationStepExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAutomationStepExecutionsResult> {
			return Axios.post<DescribeAutomationStepExecutionsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAutomationStepExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAvailablePatches(requestBody: DescribeAvailablePatchesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAvailablePatchesResult> {
			return Axios.post<DescribeAvailablePatchesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeAvailablePatches', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDocument(requestBody: DescribeDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentResult> {
			return Axios.post<DescribeDocumentResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDocumentPermission(requestBody: DescribeDocumentPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDocumentPermissionResponse> {
			return Axios.post<DescribeDocumentPermissionResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeDocumentPermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEffectiveInstanceAssociations(requestBody: DescribeEffectiveInstanceAssociationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEffectiveInstanceAssociationsResult> {
			return Axios.post<DescribeEffectiveInstanceAssociationsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeEffectiveInstanceAssociations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEffectivePatchesForPatchBaseline(requestBody: DescribeEffectivePatchesForPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEffectivePatchesForPatchBaselineResult> {
			return Axios.post<DescribeEffectivePatchesForPatchBaselineResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeEffectivePatchesForPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInstanceAssociationsStatus(requestBody: DescribeInstanceAssociationsStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstanceAssociationsStatusResult> {
			return Axios.post<DescribeInstanceAssociationsStatusResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstanceAssociationsStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInstanceInformation(MaxResults: string, NextToken: string, requestBody: DescribeInstanceInformationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstanceInformationResult> {
			return Axios.post<DescribeInstanceInformationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstanceInformation?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInstancePatchStates(requestBody: DescribeInstancePatchStatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancePatchStatesResult> {
			return Axios.post<DescribeInstancePatchStatesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstancePatchStates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInstancePatchStatesForPatchGroup(requestBody: DescribeInstancePatchStatesForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancePatchStatesForPatchGroupResult> {
			return Axios.post<DescribeInstancePatchStatesForPatchGroupResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstancePatchStatesForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInstancePatches(requestBody: DescribeInstancePatchesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInstancePatchesResult> {
			return Axios.post<DescribeInstancePatchesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInstancePatches', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInventoryDeletions(requestBody: DescribeInventoryDeletionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInventoryDeletionsResult> {
			return Axios.post<DescribeInventoryDeletionsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeInventoryDeletions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindowExecutionTaskInvocations(requestBody: DescribeMaintenanceWindowExecutionTaskInvocationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowExecutionTaskInvocationsResult> {
			return Axios.post<DescribeMaintenanceWindowExecutionTaskInvocationsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutionTaskInvocations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindowExecutionTasks(requestBody: DescribeMaintenanceWindowExecutionTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowExecutionTasksResult> {
			return Axios.post<DescribeMaintenanceWindowExecutionTasksResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutionTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindowExecutions(requestBody: DescribeMaintenanceWindowExecutionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowExecutionsResult> {
			return Axios.post<DescribeMaintenanceWindowExecutionsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowExecutions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindowSchedule(requestBody: DescribeMaintenanceWindowScheduleRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowScheduleResult> {
			return Axios.post<DescribeMaintenanceWindowScheduleResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowSchedule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindowTargets(requestBody: DescribeMaintenanceWindowTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowTargetsResult> {
			return Axios.post<DescribeMaintenanceWindowTargetsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindowTasks(requestBody: DescribeMaintenanceWindowTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowTasksResult> {
			return Axios.post<DescribeMaintenanceWindowTasksResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowTasks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindows(requestBody: DescribeMaintenanceWindowsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowsResult> {
			return Axios.post<DescribeMaintenanceWindowsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeMaintenanceWindowsForTarget(requestBody: DescribeMaintenanceWindowsForTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMaintenanceWindowsForTargetResult> {
			return Axios.post<DescribeMaintenanceWindowsForTargetResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeMaintenanceWindowsForTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeOpsItems(requestBody: DescribeOpsItemsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOpsItemsResponse> {
			return Axios.post<DescribeOpsItemsResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeOpsItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeParameters(MaxResults: string, NextToken: string, requestBody: DescribeParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeParametersResult> {
			return Axios.post<DescribeParametersResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeParameters?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePatchBaselines(requestBody: DescribePatchBaselinesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchBaselinesResult> {
			return Axios.post<DescribePatchBaselinesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchBaselines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePatchGroupState(requestBody: DescribePatchGroupStateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchGroupStateResult> {
			return Axios.post<DescribePatchGroupStateResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchGroupState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePatchGroups(requestBody: DescribePatchGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchGroupsResult> {
			return Axios.post<DescribePatchGroupsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePatchProperties(requestBody: DescribePatchPropertiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePatchPropertiesResult> {
			return Axios.post<DescribePatchPropertiesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribePatchProperties', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSessions(requestBody: DescribeSessionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSessionsResponse> {
			return Axios.post<DescribeSessionsResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.DescribeSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAutomationExecution(requestBody: GetAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAutomationExecutionResult> {
			return Axios.post<GetAutomationExecutionResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetAutomationExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCalendarState(requestBody: GetCalendarStateRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCalendarStateResponse> {
			return Axios.post<GetCalendarStateResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetCalendarState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCommandInvocation(requestBody: GetCommandInvocationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCommandInvocationResult> {
			return Axios.post<GetCommandInvocationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetCommandInvocation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetConnectionStatus(requestBody: GetConnectionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetConnectionStatusResponse> {
			return Axios.post<GetConnectionStatusResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetConnectionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDefaultPatchBaseline(requestBody: GetDefaultPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDefaultPatchBaselineResult> {
			return Axios.post<GetDefaultPatchBaselineResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetDefaultPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeployablePatchSnapshotForInstance(requestBody: GetDeployablePatchSnapshotForInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeployablePatchSnapshotForInstanceResult> {
			return Axios.post<GetDeployablePatchSnapshotForInstanceResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetDeployablePatchSnapshotForInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDocument(requestBody: GetDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDocumentResult> {
			return Axios.post<GetDocumentResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInventory(requestBody: GetInventoryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInventoryResult> {
			return Axios.post<GetInventoryResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetInventory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInventorySchema(requestBody: GetInventorySchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInventorySchemaResult> {
			return Axios.post<GetInventorySchemaResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetInventorySchema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMaintenanceWindow(requestBody: GetMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowResult> {
			return Axios.post<GetMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMaintenanceWindowExecution(requestBody: GetMaintenanceWindowExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowExecutionResult> {
			return Axios.post<GetMaintenanceWindowExecutionResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMaintenanceWindowExecutionTask(requestBody: GetMaintenanceWindowExecutionTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowExecutionTaskResult> {
			return Axios.post<GetMaintenanceWindowExecutionTaskResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecutionTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMaintenanceWindowExecutionTaskInvocation(requestBody: GetMaintenanceWindowExecutionTaskInvocationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowExecutionTaskInvocationResult> {
			return Axios.post<GetMaintenanceWindowExecutionTaskInvocationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowExecutionTaskInvocation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMaintenanceWindowTask(requestBody: GetMaintenanceWindowTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMaintenanceWindowTaskResult> {
			return Axios.post<GetMaintenanceWindowTaskResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetMaintenanceWindowTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOpsItem(requestBody: GetOpsItemRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOpsItemResponse> {
			return Axios.post<GetOpsItemResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetOpsItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOpsSummary(requestBody: GetOpsSummaryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOpsSummaryResult> {
			return Axios.post<GetOpsSummaryResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetOpsSummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetParameter(requestBody: GetParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParameterResult> {
			return Axios.post<GetParameterResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetParameterHistory(MaxResults: string, NextToken: string, requestBody: GetParameterHistoryRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParameterHistoryResult> {
			return Axios.post<GetParameterHistoryResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParameterHistory?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetParameters(requestBody: GetParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParametersResult> {
			return Axios.post<GetParametersResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetParametersByPath(MaxResults: string, NextToken: string, requestBody: GetParametersByPathRequest, headersHandler?: () => {[header: string]: string}): Promise<GetParametersByPathResult> {
			return Axios.post<GetParametersByPathResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetParametersByPath?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPatchBaseline(requestBody: GetPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPatchBaselineResult> {
			return Axios.post<GetPatchBaselineResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPatchBaselineForPatchGroup(requestBody: GetPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPatchBaselineForPatchGroupResult> {
			return Axios.post<GetPatchBaselineForPatchGroupResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetPatchBaselineForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetServiceSetting(requestBody: GetServiceSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<GetServiceSettingResult> {
			return Axios.post<GetServiceSettingResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.GetServiceSetting', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		LabelParameterVersion(requestBody: LabelParameterVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<LabelParameterVersionResult> {
			return Axios.post<LabelParameterVersionResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.LabelParameterVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssociationVersions(requestBody: ListAssociationVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssociationVersionsResult> {
			return Axios.post<ListAssociationVersionsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListAssociationVersions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCommandInvocations(MaxResults: string, NextToken: string, requestBody: ListCommandInvocationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCommandInvocationsResult> {
			return Axios.post<ListCommandInvocationsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListCommandInvocations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCommands(MaxResults: string, NextToken: string, requestBody: ListCommandsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCommandsResult> {
			return Axios.post<ListCommandsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListCommands?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListComplianceItems(requestBody: ListComplianceItemsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListComplianceItemsResult> {
			return Axios.post<ListComplianceItemsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListComplianceItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListComplianceSummaries(requestBody: ListComplianceSummariesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListComplianceSummariesResult> {
			return Axios.post<ListComplianceSummariesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListComplianceSummaries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDocumentVersions(requestBody: ListDocumentVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDocumentVersionsResult> {
			return Axios.post<ListDocumentVersionsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListDocumentVersions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDocuments(MaxResults: string, NextToken: string, requestBody: ListDocumentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDocumentsResult> {
			return Axios.post<ListDocumentsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListDocuments?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListInventoryEntries(requestBody: ListInventoryEntriesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListInventoryEntriesResult> {
			return Axios.post<ListInventoryEntriesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListInventoryEntries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListResourceComplianceSummaries(requestBody: ListResourceComplianceSummariesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceComplianceSummariesResult> {
			return Axios.post<ListResourceComplianceSummariesResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListResourceComplianceSummaries', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListResourceDataSync(requestBody: ListResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceDataSyncResult> {
			return Axios.post<ListResourceDataSyncResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return Axios.post<ListTagsForResourceResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyDocumentPermission(requestBody: ModifyDocumentPermissionRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyDocumentPermissionResponse> {
			return Axios.post<ModifyDocumentPermissionResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ModifyDocumentPermission', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutComplianceItems(requestBody: PutComplianceItemsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutComplianceItemsResult> {
			return Axios.post<PutComplianceItemsResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.PutComplianceItems', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutInventory(requestBody: PutInventoryRequest, headersHandler?: () => {[header: string]: string}): Promise<PutInventoryResult> {
			return Axios.post<PutInventoryResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.PutInventory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutParameter(requestBody: PutParameterRequest, headersHandler?: () => {[header: string]: string}): Promise<PutParameterResult> {
			return Axios.post<PutParameterResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.PutParameter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterDefaultPatchBaseline(requestBody: RegisterDefaultPatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterDefaultPatchBaselineResult> {
			return Axios.post<RegisterDefaultPatchBaselineResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterDefaultPatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterPatchBaselineForPatchGroup(requestBody: RegisterPatchBaselineForPatchGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterPatchBaselineForPatchGroupResult> {
			return Axios.post<RegisterPatchBaselineForPatchGroupResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterPatchBaselineForPatchGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterTargetWithMaintenanceWindow(requestBody: RegisterTargetWithMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterTargetWithMaintenanceWindowResult> {
			return Axios.post<RegisterTargetWithMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterTargetWithMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterTaskWithMaintenanceWindow(requestBody: RegisterTaskWithMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterTaskWithMaintenanceWindowResult> {
			return Axios.post<RegisterTaskWithMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.RegisterTaskWithMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResult> {
			return Axios.post<RemoveTagsFromResourceResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ResetServiceSetting(requestBody: ResetServiceSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetServiceSettingResult> {
			return Axios.post<ResetServiceSettingResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ResetServiceSetting', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ResumeSession(requestBody: ResumeSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<ResumeSessionResponse> {
			return Axios.post<ResumeSessionResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.ResumeSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendAutomationSignal(requestBody: SendAutomationSignalRequest, headersHandler?: () => {[header: string]: string}): Promise<SendAutomationSignalResult> {
			return Axios.post<SendAutomationSignalResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.SendAutomationSignal', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendCommand(requestBody: SendCommandRequest, headersHandler?: () => {[header: string]: string}): Promise<SendCommandResult> {
			return Axios.post<SendCommandResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.SendCommand', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartAssociationsOnce(requestBody: StartAssociationsOnceRequest, headersHandler?: () => {[header: string]: string}): Promise<StartAssociationsOnceResult> {
			return Axios.post<StartAssociationsOnceResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.StartAssociationsOnce', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartAutomationExecution(requestBody: StartAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartAutomationExecutionResult> {
			return Axios.post<StartAutomationExecutionResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.StartAutomationExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartSession(requestBody: StartSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartSessionResponse> {
			return Axios.post<StartSessionResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.StartSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopAutomationExecution(requestBody: StopAutomationExecutionRequest, headersHandler?: () => {[header: string]: string}): Promise<StopAutomationExecutionResult> {
			return Axios.post<StopAutomationExecutionResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.StopAutomationExecution', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TerminateSession(requestBody: TerminateSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<TerminateSessionResponse> {
			return Axios.post<TerminateSessionResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.TerminateSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAssociation(requestBody: UpdateAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAssociationResult> {
			return Axios.post<UpdateAssociationResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAssociationStatus(requestBody: UpdateAssociationStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAssociationStatusResult> {
			return Axios.post<UpdateAssociationStatusResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateAssociationStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDocument(requestBody: UpdateDocumentRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDocumentResult> {
			return Axios.post<UpdateDocumentResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateDocument', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDocumentDefaultVersion(requestBody: UpdateDocumentDefaultVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDocumentDefaultVersionResult> {
			return Axios.post<UpdateDocumentDefaultVersionResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateDocumentDefaultVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateMaintenanceWindow(requestBody: UpdateMaintenanceWindowRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceWindowResult> {
			return Axios.post<UpdateMaintenanceWindowResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindow', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateMaintenanceWindowTarget(requestBody: UpdateMaintenanceWindowTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceWindowTargetResult> {
			return Axios.post<UpdateMaintenanceWindowTargetResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateMaintenanceWindowTask(requestBody: UpdateMaintenanceWindowTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMaintenanceWindowTaskResult> {
			return Axios.post<UpdateMaintenanceWindowTaskResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateMaintenanceWindowTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateManagedInstanceRole(requestBody: UpdateManagedInstanceRoleRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateManagedInstanceRoleResult> {
			return Axios.post<UpdateManagedInstanceRoleResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateManagedInstanceRole', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateOpsItem(requestBody: UpdateOpsItemRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateOpsItemResponse> {
			return Axios.post<UpdateOpsItemResponse>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateOpsItem', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdatePatchBaseline(requestBody: UpdatePatchBaselineRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdatePatchBaselineResult> {
			return Axios.post<UpdatePatchBaselineResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdatePatchBaseline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateResourceDataSync(requestBody: UpdateResourceDataSyncRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateResourceDataSyncResult> {
			return Axios.post<UpdateResourceDataSyncResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateResourceDataSync', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateServiceSetting(requestBody: UpdateServiceSettingRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServiceSettingResult> {
			return Axios.post<UpdateServiceSettingResult>(this.baseUri + '/#X-Amz-Target=AmazonSSM.UpdateServiceSetting', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
