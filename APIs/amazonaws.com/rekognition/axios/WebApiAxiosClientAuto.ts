...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CompareFaces(requestBody: CompareFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<CompareFacesResponse> {
			return Axios.post<CompareFacesResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.CompareFaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateCollection(requestBody: CreateCollectionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCollectionResponse> {
			return Axios.post<CreateCollectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateCollection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateProject(requestBody: CreateProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectResponse> {
			return Axios.post<CreateProjectResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateProjectVersion(requestBody: CreateProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectVersionResponse> {
			return Axios.post<CreateProjectVersionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateProjectVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateStreamProcessor(requestBody: CreateStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamProcessorResponse> {
			return Axios.post<CreateStreamProcessorResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateStreamProcessor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteCollection(requestBody: DeleteCollectionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCollectionResponse> {
			return Axios.post<DeleteCollectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteCollection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteFaces(requestBody: DeleteFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFacesResponse> {
			return Axios.post<DeleteFacesResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteFaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteProject(requestBody: DeleteProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectResponse> {
			return Axios.post<DeleteProjectResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteProjectVersion(requestBody: DeleteProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectVersionResponse> {
			return Axios.post<DeleteProjectVersionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteProjectVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteStreamProcessor(requestBody: DeleteStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteStreamProcessorResponse> {
			return Axios.post<DeleteStreamProcessorResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteStreamProcessor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeCollection(requestBody: DescribeCollectionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCollectionResponse> {
			return Axios.post<DescribeCollectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DescribeCollection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeProjectVersions(MaxResults: string, NextToken: string, requestBody: DescribeProjectVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeProjectVersionsResponse> {
			return Axios.post<DescribeProjectVersionsResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DescribeProjectVersions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeProjects(MaxResults: string, NextToken: string, requestBody: DescribeProjectsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeProjectsResponse> {
			return Axios.post<DescribeProjectsResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DescribeProjects?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeStreamProcessor(requestBody: DescribeStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamProcessorResponse> {
			return Axios.post<DescribeStreamProcessorResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DescribeStreamProcessor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DetectCustomLabels(requestBody: DetectCustomLabelsRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectCustomLabelsResponse> {
			return Axios.post<DetectCustomLabelsResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectCustomLabels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DetectFaces(requestBody: DetectFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectFacesResponse> {
			return Axios.post<DetectFacesResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectFaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DetectLabels(requestBody: DetectLabelsRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectLabelsResponse> {
			return Axios.post<DetectLabelsResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectLabels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DetectModerationLabels(requestBody: DetectModerationLabelsRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectModerationLabelsResponse> {
			return Axios.post<DetectModerationLabelsResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectModerationLabels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DetectText(requestBody: DetectTextRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectTextResponse> {
			return Axios.post<DetectTextResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectText', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetCelebrityInfo(requestBody: GetCelebrityInfoRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCelebrityInfoResponse> {
			return Axios.post<GetCelebrityInfoResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetCelebrityInfo', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetCelebrityRecognition(MaxResults: string, NextToken: string, requestBody: GetCelebrityRecognitionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCelebrityRecognitionResponse> {
			return Axios.post<GetCelebrityRecognitionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetCelebrityRecognition?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetContentModeration(MaxResults: string, NextToken: string, requestBody: GetContentModerationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetContentModerationResponse> {
			return Axios.post<GetContentModerationResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetContentModeration?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetFaceDetection(MaxResults: string, NextToken: string, requestBody: GetFaceDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFaceDetectionResponse> {
			return Axios.post<GetFaceDetectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetFaceDetection?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetFaceSearch(MaxResults: string, NextToken: string, requestBody: GetFaceSearchRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFaceSearchResponse> {
			return Axios.post<GetFaceSearchResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetFaceSearch?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetLabelDetection(MaxResults: string, NextToken: string, requestBody: GetLabelDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLabelDetectionResponse> {
			return Axios.post<GetLabelDetectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetLabelDetection?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetPersonTracking(MaxResults: string, NextToken: string, requestBody: GetPersonTrackingRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPersonTrackingResponse> {
			return Axios.post<GetPersonTrackingResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetPersonTracking?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetTextDetection(MaxResults: string, NextToken: string, requestBody: GetTextDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTextDetectionResponse> {
			return Axios.post<GetTextDetectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.GetTextDetection?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		IndexFaces(requestBody: IndexFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<IndexFacesResponse> {
			return Axios.post<IndexFacesResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.IndexFaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListCollections(MaxResults: string, NextToken: string, requestBody: ListCollectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCollectionsResponse> {
			return Axios.post<ListCollectionsResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.ListCollections?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListFaces(MaxResults: string, NextToken: string, requestBody: ListFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListFacesResponse> {
			return Axios.post<ListFacesResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.ListFaces?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListStreamProcessors(MaxResults: string, NextToken: string, requestBody: ListStreamProcessorsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListStreamProcessorsResponse> {
			return Axios.post<ListStreamProcessorsResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.ListStreamProcessors?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RecognizeCelebrities(requestBody: RecognizeCelebritiesRequest, headersHandler?: () => {[header: string]: string}): Promise<RecognizeCelebritiesResponse> {
			return Axios.post<RecognizeCelebritiesResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.RecognizeCelebrities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		SearchFaces(requestBody: SearchFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchFacesResponse> {
			return Axios.post<SearchFacesResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.SearchFaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		SearchFacesByImage(requestBody: SearchFacesByImageRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchFacesByImageResponse> {
			return Axios.post<SearchFacesByImageResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.SearchFacesByImage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartCelebrityRecognition(requestBody: StartCelebrityRecognitionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartCelebrityRecognitionResponse> {
			return Axios.post<StartCelebrityRecognitionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartCelebrityRecognition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartContentModeration(requestBody: StartContentModerationRequest, headersHandler?: () => {[header: string]: string}): Promise<StartContentModerationResponse> {
			return Axios.post<StartContentModerationResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartContentModeration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartFaceDetection(requestBody: StartFaceDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartFaceDetectionResponse> {
			return Axios.post<StartFaceDetectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartFaceDetection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartFaceSearch(requestBody: StartFaceSearchRequest, headersHandler?: () => {[header: string]: string}): Promise<StartFaceSearchResponse> {
			return Axios.post<StartFaceSearchResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartFaceSearch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartLabelDetection(requestBody: StartLabelDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartLabelDetectionResponse> {
			return Axios.post<StartLabelDetectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartLabelDetection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartPersonTracking(requestBody: StartPersonTrackingRequest, headersHandler?: () => {[header: string]: string}): Promise<StartPersonTrackingResponse> {
			return Axios.post<StartPersonTrackingResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartPersonTracking', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartProjectVersion(requestBody: StartProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartProjectVersionResponse> {
			return Axios.post<StartProjectVersionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartProjectVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartStreamProcessor(requestBody: StartStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<StartStreamProcessorResponse> {
			return Axios.post<StartStreamProcessorResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartStreamProcessor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StartTextDetection(requestBody: StartTextDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTextDetectionResponse> {
			return Axios.post<StartTextDetectionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StartTextDetection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StopProjectVersion(requestBody: StopProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<StopProjectVersionResponse> {
			return Axios.post<StopProjectVersionResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StopProjectVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		StopStreamProcessor(requestBody: StopStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<StopStreamProcessorResponse> {
			return Axios.post<StopStreamProcessorResponse>(this.baseUri + '/#X-Amz-Target=RekognitionService.StopStreamProcessor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
