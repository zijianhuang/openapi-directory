export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CompareFaces(requestBody: CompareFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<CompareFacesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.CompareFaces', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateCollection(requestBody: CreateCollectionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateCollectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateCollection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateProject(requestBody: CreateProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateProject', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateProjectVersion(requestBody: CreateProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectVersionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateProjectVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateStreamProcessor(requestBody: CreateStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateStreamProcessorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.CreateStreamProcessor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteCollection(requestBody: DeleteCollectionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteCollectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteCollection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteFaces(requestBody: DeleteFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteFacesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteFaces', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteProject(requestBody: DeleteProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteProject', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteProjectVersion(requestBody: DeleteProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectVersionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteProjectVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteStreamProcessor(requestBody: DeleteStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteStreamProcessorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DeleteStreamProcessor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeCollection(requestBody: DescribeCollectionRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeCollectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DescribeCollection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeProjects(MaxResults: string, NextToken: string, requestBody: DescribeProjectsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeProjectsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DescribeProjects?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeStreamProcessor(requestBody: DescribeStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamProcessorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DescribeStreamProcessor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectCustomLabels(requestBody: DetectCustomLabelsRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectCustomLabelsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectCustomLabels', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectFaces(requestBody: DetectFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectFacesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectFaces', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectLabels(requestBody: DetectLabelsRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectLabelsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectLabels', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectModerationLabels(requestBody: DetectModerationLabelsRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectModerationLabelsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectModerationLabels', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectText(requestBody: DetectTextRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectTextResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.DetectText', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetCelebrityInfo(requestBody: GetCelebrityInfoRequest, headersHandler?: () => {[header: string]: string}): Promise<GetCelebrityInfoResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.GetCelebrityInfo', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetContentModeration(MaxResults: string, NextToken: string, requestBody: GetContentModerationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetContentModerationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.GetContentModeration?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetFaceSearch(MaxResults: string, NextToken: string, requestBody: GetFaceSearchRequest, headersHandler?: () => {[header: string]: string}): Promise<GetFaceSearchResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.GetFaceSearch?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetLabelDetection(MaxResults: string, NextToken: string, requestBody: GetLabelDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetLabelDetectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.GetLabelDetection?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPersonTracking(MaxResults: string, NextToken: string, requestBody: GetPersonTrackingRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPersonTrackingResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.GetPersonTracking?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetTextDetection(MaxResults: string, NextToken: string, requestBody: GetTextDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTextDetectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.GetTextDetection?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		IndexFaces(requestBody: IndexFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<IndexFacesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.IndexFaces', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCollections(MaxResults: string, NextToken: string, requestBody: ListCollectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCollectionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.ListCollections?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListFaces(MaxResults: string, NextToken: string, requestBody: ListFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListFacesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.ListFaces?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListStreamProcessors(MaxResults: string, NextToken: string, requestBody: ListStreamProcessorsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListStreamProcessorsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.ListStreamProcessors?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RecognizeCelebrities(requestBody: RecognizeCelebritiesRequest, headersHandler?: () => {[header: string]: string}): Promise<RecognizeCelebritiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.RecognizeCelebrities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SearchFaces(requestBody: SearchFacesRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchFacesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.SearchFaces', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SearchFacesByImage(requestBody: SearchFacesByImageRequest, headersHandler?: () => {[header: string]: string}): Promise<SearchFacesByImageResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.SearchFacesByImage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartCelebrityRecognition(requestBody: StartCelebrityRecognitionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartCelebrityRecognitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartCelebrityRecognition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartContentModeration(requestBody: StartContentModerationRequest, headersHandler?: () => {[header: string]: string}): Promise<StartContentModerationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartContentModeration', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartFaceDetection(requestBody: StartFaceDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartFaceDetectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartFaceDetection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartFaceSearch(requestBody: StartFaceSearchRequest, headersHandler?: () => {[header: string]: string}): Promise<StartFaceSearchResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartFaceSearch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartLabelDetection(requestBody: StartLabelDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartLabelDetectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartLabelDetection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartPersonTracking(requestBody: StartPersonTrackingRequest, headersHandler?: () => {[header: string]: string}): Promise<StartPersonTrackingResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartPersonTracking', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartProjectVersion(requestBody: StartProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartProjectVersionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartProjectVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartStreamProcessor(requestBody: StartStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<StartStreamProcessorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartStreamProcessor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartTextDetection(requestBody: StartTextDetectionRequest, headersHandler?: () => {[header: string]: string}): Promise<StartTextDetectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StartTextDetection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopProjectVersion(requestBody: StopProjectVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<StopProjectVersionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StopProjectVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopStreamProcessor(requestBody: StopStreamProcessorRequest, headersHandler?: () => {[header: string]: string}): Promise<StopStreamProcessorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=RekognitionService.StopStreamProcessor', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
