...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateParticipantConnection(requestBody: CreateParticipantConnectionBody, headersHandler?: () => HttpHeaders): Observable<CreateParticipantConnectionResponse> {
			return this.http.post<CreateParticipantConnectionResponse>(this.baseUri + '/participant/connection#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisconnectParticipant(requestBody: DisconnectParticipantBody, headersHandler?: () => HttpHeaders): Observable<DisconnectParticipantResponse> {
			return this.http.post<DisconnectParticipantResponse>(this.baseUri + '/participant/disconnect#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendEvent(requestBody: SendEventBody, headersHandler?: () => HttpHeaders): Observable<SendEventResponse> {
			return this.http.post<SendEventResponse>(this.baseUri + '/participant/event#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SendMessage(requestBody: SendMessageBody, headersHandler?: () => HttpHeaders): Observable<SendMessageResponse> {
			return this.http.post<SendMessageResponse>(this.baseUri + '/participant/message#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
