export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateParticipantConnection(requestBody: CreateParticipantConnectionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateParticipantConnectionResponse> {
			return fetch(this.baseUri + '/participant/connection#X-Amz-Bearer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisconnectParticipant(requestBody: DisconnectParticipantBody, headersHandler?: () => {[header: string]: string}): Promise<DisconnectParticipantResponse> {
			return fetch(this.baseUri + '/participant/disconnect#X-Amz-Bearer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SendEvent(requestBody: SendEventBody, headersHandler?: () => {[header: string]: string}): Promise<SendEventResponse> {
			return fetch(this.baseUri + '/participant/event#X-Amz-Bearer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SendMessage(requestBody: SendMessageBody, headersHandler?: () => {[header: string]: string}): Promise<SendMessageResponse> {
			return fetch(this.baseUri + '/participant/message#X-Amz-Bearer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
