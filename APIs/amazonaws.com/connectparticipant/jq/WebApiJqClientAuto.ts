...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateParticipantConnection(callback: (data : CreateParticipantConnectionResponse) => any, requestBody: CreateParticipantConnectionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/participant/connection#X-Amz-Bearer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisconnectParticipant(callback: (data : DisconnectParticipantResponse) => any, requestBody: DisconnectParticipantBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/participant/disconnect#X-Amz-Bearer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetTranscript(MaxResults: string, NextToken: string, callback: (data : GetTranscriptResponse) => any, requestBody: GetTranscriptBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/participant/transcript#X-Amz-Bearer?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SendEvent(callback: (data : SendEventResponse) => any, requestBody: SendEventBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/participant/event#X-Amz-Bearer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SendMessage(callback: (data : SendMessageResponse) => any, requestBody: SendMessageBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/participant/message#X-Amz-Bearer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
