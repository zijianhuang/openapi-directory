...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateParticipantConnection(requestBody: CreateParticipantConnectionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateParticipantConnectionResponse> {
			return this.http.post('/participant/connection#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisconnectParticipant(requestBody: DisconnectParticipantBody, headersHandler?: () => {[header: string]: string}): Promise<DisconnectParticipantResponse> {
			return this.http.post('/participant/disconnect#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendEvent(requestBody: SendEventBody, headersHandler?: () => {[header: string]: string}): Promise<SendEventResponse> {
			return this.http.post('/participant/event#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendMessage(requestBody: SendMessageBody, headersHandler?: () => {[header: string]: string}): Promise<SendMessageResponse> {
			return this.http.post('/participant/message#X-Amz-Bearer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
