...
export namespace My_Demo_Client {
	...
	export interface PutRecordOutput {
		...
		EncryptionType?: PutRecordOutputEncryptionType;
	}

	export enum PutRecordOutputEncryptionType { NONE = 0, KMS = 1 }
	...
	export interface PutRecordsOutput {
		...
		EncryptionType?: PutRecordsOutputEncryptionType;
	}

	export enum PutRecordsOutputEncryptionType { NONE = 0, KMS = 1 }
	...
	export interface StartStreamEncryptionInput {
		StreamName: string;
		EncryptionType: StartStreamEncryptionInputEncryptionType;
		KeyId: string;
	}

	export enum StartStreamEncryptionInputEncryptionType { NONE = 0, KMS = 1 }

	export interface StopStreamEncryptionInput {
		StreamName: string;
		EncryptionType: StopStreamEncryptionInputEncryptionType;
		KeyId: string;
	}

	export enum StopStreamEncryptionInputEncryptionType { NONE = 0, KMS = 1 }
	...
	export interface Consumer {
		ConsumerName: string;
		ConsumerARN: string;
		ConsumerStatus: ConsumerConsumerStatus;
		ConsumerCreationTimestamp: Date;
	}

	export enum ConsumerConsumerStatus { CREATING = 0, DELETING = 1, ACTIVE = 2 }
	...
	export interface StreamDescriptionSummary {
		StreamName: string;
		StreamARN: string;
		StreamStatus: StreamDescriptionSummaryStreamStatus;
		RetentionPeriodHours: number;
		StreamCreationTimestamp: Date;
		EnhancedMonitoring: Array<EnhancedMetrics>;
		EncryptionType?: StreamDescriptionSummaryEncryptionType;
		KeyId?: string;
		OpenShardCount: number;
		ConsumerCount?: number;
	}

	export enum StreamDescriptionSummaryStreamStatus { CREATING = 0, DELETING = 1, ACTIVE = 2, UPDATING = 3 }

	export enum StreamDescriptionSummaryEncryptionType { NONE = 0, KMS = 1 }
	...
	export enum RecordEncryptionType { NONE = 0, KMS = 1 }
	...
	export enum StartingPositionType { AT_SEQUENCE_NUMBER = 0, AFTER_SEQUENCE_NUMBER = 1, TRIM_HORIZON = 2, LATEST = 3, AT_TIMESTAMP = 4 }
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToStream(requestBody: AddTagsToStreamInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.AddTagsToStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		CreateStream(requestBody: CreateStreamInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.CreateStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DecreaseStreamRetentionPeriod(requestBody: DecreaseStreamRetentionPeriodInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DecreaseStreamRetentionPeriod', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteStream(requestBody: DeleteStreamInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeleteStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterStreamConsumer(requestBody: DeregisterStreamConsumerInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeregisterStreamConsumer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DescribeLimits(requestBody: DescribeLimitsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeLimitsOutput> {
			return Axios.post<DescribeLimitsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeLimits', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeStream(Limit: string, ExclusiveStartShardId: string, requestBody: DescribeStreamInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamOutput> {
			return Axios.post<DescribeStreamOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStream?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartShardId=' + (ExclusiveStartShardId == null ? '' : encodeURIComponent(ExclusiveStartShardId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeStreamConsumer(requestBody: DescribeStreamConsumerInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamConsumerOutput> {
			return Axios.post<DescribeStreamConsumerOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamConsumer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeStreamSummary(requestBody: DescribeStreamSummaryInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamSummaryOutput> {
			return Axios.post<DescribeStreamSummaryOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamSummary', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DisableEnhancedMonitoring(requestBody: DisableEnhancedMonitoringInput, headersHandler?: () => {[header: string]: string}): Promise<EnhancedMonitoringOutput> {
			return Axios.post<EnhancedMonitoringOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DisableEnhancedMonitoring', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {EnhancedMonitoringOutput} Success
		 */
		EnableEnhancedMonitoring(requestBody: EnableEnhancedMonitoringInput, headersHandler?: () => {[header: string]: string}): Promise<EnhancedMonitoringOutput> {
			return Axios.post<EnhancedMonitoringOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.EnableEnhancedMonitoring', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetRecords(requestBody: GetRecordsInput, headersHandler?: () => {[header: string]: string}): Promise<GetRecordsOutput> {
			return Axios.post<GetRecordsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		GetShardIterator(requestBody: GetShardIteratorInput, headersHandler?: () => {[header: string]: string}): Promise<GetShardIteratorOutput> {
			return Axios.post<GetShardIteratorOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetShardIterator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		IncreaseStreamRetentionPeriod(requestBody: IncreaseStreamRetentionPeriodInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.IncreaseStreamRetentionPeriod', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		ListShards(requestBody: ListShardsInput, headersHandler?: () => {[header: string]: string}): Promise<ListShardsOutput> {
			return Axios.post<ListShardsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListShards', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListStreamConsumers(MaxResults: string, NextToken: string, requestBody: ListStreamConsumersInput, headersHandler?: () => {[header: string]: string}): Promise<ListStreamConsumersOutput> {
			return Axios.post<ListStreamConsumersOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListStreamConsumers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListStreams(Limit: string, ExclusiveStartStreamName: string, requestBody: ListStreamsInput, headersHandler?: () => {[header: string]: string}): Promise<ListStreamsOutput> {
			return Axios.post<ListStreamsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListStreams?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartStreamName=' + (ExclusiveStartStreamName == null ? '' : encodeURIComponent(ExclusiveStartStreamName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTagsForStream(requestBody: ListTagsForStreamInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForStreamOutput> {
			return Axios.post<ListTagsForStreamOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListTagsForStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		MergeShards(requestBody: MergeShardsInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.MergeShards', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		PutRecord(requestBody: PutRecordInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordOutput> {
			return Axios.post<PutRecordOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecord', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		PutRecords(requestBody: PutRecordsInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordsOutput> {
			return Axios.post<PutRecordsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecords', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RegisterStreamConsumer(requestBody: RegisterStreamConsumerInput, headersHandler?: () => {[header: string]: string}): Promise<RegisterStreamConsumerOutput> {
			return Axios.post<RegisterStreamConsumerOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RegisterStreamConsumer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromStream(requestBody: RemoveTagsFromStreamInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RemoveTagsFromStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SplitShard(requestBody: SplitShardInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.SplitShard', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StartStreamEncryption(requestBody: StartStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StartStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopStreamEncryption(requestBody: StopStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StopStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 */
		UpdateShardCount(requestBody: UpdateShardCountInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateShardCountOutput> {
			return Axios.post<UpdateShardCountOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.UpdateShardCount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
