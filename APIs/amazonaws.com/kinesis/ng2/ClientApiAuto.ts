...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToStream(requestBody: AddTagsToStreamInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.AddTagsToStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		CreateStream(requestBody: CreateStreamInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.CreateStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DecreaseStreamRetentionPeriod(requestBody: DecreaseStreamRetentionPeriodInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DecreaseStreamRetentionPeriod', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteStream(requestBody: DeleteStreamInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeleteStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterStreamConsumer(requestBody: DeregisterStreamConsumerInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeregisterStreamConsumer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		...
		DescribeLimits(requestBody: DescribeLimitsInput, headersHandler?: () => HttpHeaders): Observable<DescribeLimitsOutput> {
			return this.http.post<DescribeLimitsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeLimits', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStream(Limit: string, ExclusiveStartShardId: string, requestBody: DescribeStreamInput, headersHandler?: () => HttpHeaders): Observable<DescribeStreamOutput> {
			return this.http.post<DescribeStreamOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStream?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartShardId=' + (ExclusiveStartShardId == null ? '' : encodeURIComponent(ExclusiveStartShardId)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStreamConsumer(requestBody: DescribeStreamConsumerInput, headersHandler?: () => HttpHeaders): Observable<DescribeStreamConsumerOutput> {
			return this.http.post<DescribeStreamConsumerOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamConsumer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeStreamSummary(requestBody: DescribeStreamSummaryInput, headersHandler?: () => HttpHeaders): Observable<DescribeStreamSummaryOutput> {
			return this.http.post<DescribeStreamSummaryOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamSummary', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisableEnhancedMonitoring(requestBody: DisableEnhancedMonitoringInput, headersHandler?: () => HttpHeaders): Observable<EnhancedMonitoringOutput> {
			return this.http.post<EnhancedMonitoringOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DisableEnhancedMonitoring', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {EnhancedMonitoringOutput} Success
		 */
		EnableEnhancedMonitoring(requestBody: EnableEnhancedMonitoringInput, headersHandler?: () => HttpHeaders): Observable<EnhancedMonitoringOutput> {
			return this.http.post<EnhancedMonitoringOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.EnableEnhancedMonitoring', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetRecords(requestBody: GetRecordsInput, headersHandler?: () => HttpHeaders): Observable<GetRecordsOutput> {
			return this.http.post<GetRecordsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetRecords', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetShardIterator(requestBody: GetShardIteratorInput, headersHandler?: () => HttpHeaders): Observable<GetShardIteratorOutput> {
			return this.http.post<GetShardIteratorOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetShardIterator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		IncreaseStreamRetentionPeriod(requestBody: IncreaseStreamRetentionPeriodInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		ListShards(requestBody: ListShardsInput, headersHandler?: () => HttpHeaders): Observable<ListShardsOutput> {
			return this.http.post<ListShardsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListShards', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListStreamConsumers(MaxResults: string, NextToken: string, requestBody: ListStreamConsumersInput, headersHandler?: () => HttpHeaders): Observable<ListStreamConsumersOutput> {
			return this.http.post<ListStreamConsumersOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListStreamConsumers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListStreams(Limit: string, ExclusiveStartStreamName: string, requestBody: ListStreamsInput, headersHandler?: () => HttpHeaders): Observable<ListStreamsOutput> {
			return this.http.post<ListStreamsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListStreams?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartStreamName=' + (ExclusiveStartStreamName == null ? '' : encodeURIComponent(ExclusiveStartStreamName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForStream(requestBody: ListTagsForStreamInput, headersHandler?: () => HttpHeaders): Observable<ListTagsForStreamOutput> {
			return this.http.post<ListTagsForStreamOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListTagsForStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		MergeShards(requestBody: MergeShardsInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.MergeShards', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		PutRecord(requestBody: PutRecordInput, headersHandler?: () => HttpHeaders): Observable<PutRecordOutput> {
			return this.http.post<PutRecordOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecord', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutRecords(requestBody: PutRecordsInput, headersHandler?: () => HttpHeaders): Observable<PutRecordsOutput> {
			return this.http.post<PutRecordsOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecords', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterStreamConsumer(requestBody: RegisterStreamConsumerInput, headersHandler?: () => HttpHeaders): Observable<RegisterStreamConsumerOutput> {
			return this.http.post<RegisterStreamConsumerOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RegisterStreamConsumer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromStream(requestBody: RemoveTagsFromStreamInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RemoveTagsFromStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SplitShard(requestBody: SplitShardInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.SplitShard', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StartStreamEncryption(requestBody: StartStreamEncryptionInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StartStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		StopStreamEncryption(requestBody: StopStreamEncryptionInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StopStreamEncryption', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UpdateShardCount(requestBody: UpdateShardCountInput, headersHandler?: () => HttpHeaders): Observable<UpdateShardCountOutput> {
			return this.http.post<UpdateShardCountOutput>(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.UpdateShardCount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
