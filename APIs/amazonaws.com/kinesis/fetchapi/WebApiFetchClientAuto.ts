export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToStream(requestBody: AddTagsToStreamInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.AddTagsToStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		CreateStream(requestBody: CreateStreamInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.CreateStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DecreaseStreamRetentionPeriod(requestBody: DecreaseStreamRetentionPeriodInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DecreaseStreamRetentionPeriod', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteStream(requestBody: DeleteStreamInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeleteStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterStreamConsumer(requestBody: DeregisterStreamConsumerInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeregisterStreamConsumer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeLimits(requestBody: DescribeLimitsInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeLimitsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeLimits', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeStreamConsumer(requestBody: DescribeStreamConsumerInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamConsumerOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamConsumer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeStreamSummary(requestBody: DescribeStreamSummaryInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeStreamSummaryOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamSummary', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisableEnhancedMonitoring(requestBody: DisableEnhancedMonitoringInput, headersHandler?: () => {[header: string]: string}): Promise<EnhancedMonitoringOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DisableEnhancedMonitoring', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		EnableEnhancedMonitoring(requestBody: EnableEnhancedMonitoringInput, headersHandler?: () => {[header: string]: string}): Promise<EnhancedMonitoringOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.EnableEnhancedMonitoring', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetRecords(requestBody: GetRecordsInput, headersHandler?: () => {[header: string]: string}): Promise<GetRecordsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetRecords', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetShardIterator(requestBody: GetShardIteratorInput, headersHandler?: () => {[header: string]: string}): Promise<GetShardIteratorOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetShardIterator', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		IncreaseStreamRetentionPeriod(requestBody: IncreaseStreamRetentionPeriodInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.IncreaseStreamRetentionPeriod', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListShards(requestBody: ListShardsInput, headersHandler?: () => {[header: string]: string}): Promise<ListShardsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListShards', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListStreams(Limit: string, ExclusiveStartStreamName: string, requestBody: ListStreamsInput, headersHandler?: () => {[header: string]: string}): Promise<ListStreamsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListStreams?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartStreamName=' + (ExclusiveStartStreamName == null ? '' : encodeURIComponent(ExclusiveStartStreamName)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForStream(requestBody: ListTagsForStreamInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForStreamOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListTagsForStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		MergeShards(requestBody: MergeShardsInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.MergeShards', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		PutRecord(requestBody: PutRecordInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecord', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutRecords(requestBody: PutRecordsInput, headersHandler?: () => {[header: string]: string}): Promise<PutRecordsOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecords', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterStreamConsumer(requestBody: RegisterStreamConsumerInput, headersHandler?: () => {[header: string]: string}): Promise<RegisterStreamConsumerOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RegisterStreamConsumer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromStream(requestBody: RemoveTagsFromStreamInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RemoveTagsFromStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		SplitShard(requestBody: SplitShardInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.SplitShard', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StartStreamEncryption(requestBody: StartStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StartStreamEncryption', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		StopStreamEncryption(requestBody: StopStreamEncryptionInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StopStreamEncryption', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateShardCount(requestBody: UpdateShardCountInput, headersHandler?: () => {[header: string]: string}): Promise<UpdateShardCountOutput> {
			return fetch(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.UpdateShardCount', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
