...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		AddTagsToStream(callback: (data : void) => any, requestBody: AddTagsToStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.AddTagsToStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		CreateStream(callback: (data : void) => any, requestBody: CreateStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.CreateStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DecreaseStreamRetentionPeriod(callback: (data : void) => any, requestBody: DecreaseStreamRetentionPeriodInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DecreaseStreamRetentionPeriod', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteStream(callback: (data : void) => any, requestBody: DeleteStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeleteStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		DeregisterStreamConsumer(callback: (data : void) => any, requestBody: DeregisterStreamConsumerInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DeregisterStreamConsumer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DescribeLimits(callback: (data : DescribeLimitsOutput) => any, requestBody: DescribeLimitsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeLimits', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeStream(Limit: string, ExclusiveStartShardId: string, callback: (data : DescribeStreamOutput) => any, requestBody: DescribeStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStream?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartShardId=' + (ExclusiveStartShardId == null ? '' : encodeURIComponent(ExclusiveStartShardId)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeStreamConsumer(callback: (data : DescribeStreamConsumerOutput) => any, requestBody: DescribeStreamConsumerInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamConsumer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeStreamSummary(callback: (data : DescribeStreamSummaryOutput) => any, requestBody: DescribeStreamSummaryInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DescribeStreamSummary', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DisableEnhancedMonitoring(callback: (data : EnhancedMonitoringOutput) => any, requestBody: DisableEnhancedMonitoringInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.DisableEnhancedMonitoring', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {EnhancedMonitoringOutput} Success
		 */
		EnableEnhancedMonitoring(callback: (data : EnhancedMonitoringOutput) => any, requestBody: EnableEnhancedMonitoringInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.EnableEnhancedMonitoring', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetRecords(callback: (data : GetRecordsOutput) => any, requestBody: GetRecordsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetRecords', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetShardIterator(callback: (data : GetShardIteratorOutput) => any, requestBody: GetShardIteratorInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.GetShardIterator', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		IncreaseStreamRetentionPeriod(callback: (data : void) => any, requestBody: IncreaseStreamRetentionPeriodInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.IncreaseStreamRetentionPeriod', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListShards(callback: (data : ListShardsOutput) => any, requestBody: ListShardsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListShards', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListStreamConsumers(MaxResults: string, NextToken: string, callback: (data : ListStreamConsumersOutput) => any, requestBody: ListStreamConsumersInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListStreamConsumers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListStreams(Limit: string, ExclusiveStartStreamName: string, callback: (data : ListStreamsOutput) => any, requestBody: ListStreamsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListStreams?Limit=' + (Limit == null ? '' : encodeURIComponent(Limit)) + '&ExclusiveStartStreamName=' + (ExclusiveStartStreamName == null ? '' : encodeURIComponent(ExclusiveStartStreamName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForStream(callback: (data : ListTagsForStreamOutput) => any, requestBody: ListTagsForStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.ListTagsForStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		MergeShards(callback: (data : void) => any, requestBody: MergeShardsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.MergeShards', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutRecord(callback: (data : PutRecordOutput) => any, requestBody: PutRecordInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecord', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutRecords(callback: (data : PutRecordsOutput) => any, requestBody: PutRecordsInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.PutRecords', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RegisterStreamConsumer(callback: (data : RegisterStreamConsumerOutput) => any, requestBody: RegisterStreamConsumerInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RegisterStreamConsumer', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		RemoveTagsFromStream(callback: (data : void) => any, requestBody: RemoveTagsFromStreamInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.RemoveTagsFromStream', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		SplitShard(callback: (data : void) => any, requestBody: SplitShardInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.SplitShard', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StartStreamEncryption(callback: (data : void) => any, requestBody: StartStreamEncryptionInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StartStreamEncryption', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		StopStreamEncryption(callback: (data : void) => any, requestBody: StopStreamEncryptionInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.StopStreamEncryption', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateShardCount(callback: (data : UpdateShardCountOutput) => any, requestBody: UpdateShardCountInput, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=Kinesis_20131202.UpdateShardCount', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
