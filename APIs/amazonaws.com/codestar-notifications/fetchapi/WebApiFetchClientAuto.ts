export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateNotificationRule(requestBody: CreateNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<CreateNotificationRuleResult> {
			return fetch(this.baseUri + '/createNotificationRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteNotificationRule(requestBody: DeleteNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteNotificationRuleResult> {
			return fetch(this.baseUri + '/deleteNotificationRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteTarget(requestBody: DeleteTargetBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteTargetResult> {
			return fetch(this.baseUri + '/deleteTarget', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeNotificationRule(requestBody: DescribeNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotificationRuleResult> {
			return fetch(this.baseUri + '/describeNotificationRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListNotificationRules(MaxResults: string, NextToken: string, requestBody: ListNotificationRulesBody, headersHandler?: () => {[header: string]: string}): Promise<ListNotificationRulesResult> {
			return fetch(this.baseUri + '/listNotificationRules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceBody, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return fetch(this.baseUri + '/listTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Subscribe(requestBody: SubscribeBody, headersHandler?: () => {[header: string]: string}): Promise<SubscribeResult> {
			return fetch(this.baseUri + '/subscribe', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		Unsubscribe(requestBody: UnsubscribeBody, headersHandler?: () => {[header: string]: string}): Promise<UnsubscribeResult> {
			return fetch(this.baseUri + '/unsubscribe', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateNotificationRule(requestBody: UpdateNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotificationRuleResult> {
			return fetch(this.baseUri + '/updateNotificationRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
