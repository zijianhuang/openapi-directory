...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateNotificationRule(requestBody: CreateNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<CreateNotificationRuleResult> {
			return this.http.post('/createNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteNotificationRule(requestBody: DeleteNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteNotificationRuleResult> {
			return this.http.post('/deleteNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTarget(requestBody: DeleteTargetBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteTargetResult> {
			return this.http.post('/deleteTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeNotificationRule(requestBody: DescribeNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotificationRuleResult> {
			return this.http.post('/describeNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListNotificationRules(MaxResults: string, NextToken: string, requestBody: ListNotificationRulesBody, headersHandler?: () => {[header: string]: string}): Promise<ListNotificationRulesResult> {
			return this.http.post('/listNotificationRules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceBody, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return this.http.post('/listTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTargets(MaxResults: string, NextToken: string, requestBody: ListTargetsBody, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsResult> {
			return this.http.post('/listTargets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Subscribe(requestBody: SubscribeBody, headersHandler?: () => {[header: string]: string}): Promise<SubscribeResult> {
			return this.http.post('/subscribe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		Unsubscribe(requestBody: UnsubscribeBody, headersHandler?: () => {[header: string]: string}): Promise<UnsubscribeResult> {
			return this.http.post('/unsubscribe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNotificationRule(requestBody: UpdateNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotificationRuleResult> {
			return this.http.post('/updateNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
