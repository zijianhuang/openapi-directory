...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateNotificationRule(requestBody: CreateNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<CreateNotificationRuleResult> {
			return Axios.post<CreateNotificationRuleResult>(this.baseUri + '/createNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteNotificationRule(requestBody: DeleteNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteNotificationRuleResult> {
			return Axios.post<DeleteNotificationRuleResult>(this.baseUri + '/deleteNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteTarget(requestBody: DeleteTargetBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteTargetResult> {
			return Axios.post<DeleteTargetResult>(this.baseUri + '/deleteTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeNotificationRule(requestBody: DescribeNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeNotificationRuleResult> {
			return Axios.post<DescribeNotificationRuleResult>(this.baseUri + '/describeNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListEventTypes(MaxResults: string, NextToken: string, requestBody: ListEventTypesBody, headersHandler?: () => {[header: string]: string}): Promise<ListEventTypesResult> {
			return Axios.post<ListEventTypesResult>(this.baseUri + '/listEventTypes?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListNotificationRules(MaxResults: string, NextToken: string, requestBody: ListNotificationRulesBody, headersHandler?: () => {[header: string]: string}): Promise<ListNotificationRulesResult> {
			return Axios.post<ListNotificationRulesResult>(this.baseUri + '/listNotificationRules?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTagsForResource(requestBody: ListTagsForResourceBody, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResult> {
			return Axios.post<ListTagsForResourceResult>(this.baseUri + '/listTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListTargets(MaxResults: string, NextToken: string, requestBody: ListTargetsBody, headersHandler?: () => {[header: string]: string}): Promise<ListTargetsResult> {
			return Axios.post<ListTargetsResult>(this.baseUri + '/listTargets?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Subscribe(requestBody: SubscribeBody, headersHandler?: () => {[header: string]: string}): Promise<SubscribeResult> {
			return Axios.post<SubscribeResult>(this.baseUri + '/subscribe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResult> {
			return Axios.post<TagResourceResult>(this.baseUri + '/tagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		Unsubscribe(requestBody: UnsubscribeBody, headersHandler?: () => {[header: string]: string}): Promise<UnsubscribeResult> {
			return Axios.post<UnsubscribeResult>(this.baseUri + '/unsubscribe', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UntagResource(requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResult> {
			return Axios.post<UntagResourceResult>(this.baseUri + '/untagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateNotificationRule(requestBody: UpdateNotificationRuleBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateNotificationRuleResult> {
			return Axios.post<UpdateNotificationRuleResult>(this.baseUri + '/updateNotificationRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
