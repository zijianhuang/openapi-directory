...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchPutMessage(requestBody: BatchPutMessageBody, headersHandler?: () => {[header: string]: string}): Promise<BatchPutMessageResponse> {
			return Axios.post<BatchPutMessageResponse>(this.baseUri + '/messages/batch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelPipelineReprocessing(pipelineName: string, reprocessingId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelPipelineReprocessingResponse> {
			return Axios.delete<CancelPipelineReprocessingResponse>(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)) + '/reprocessing/' + (reprocessingId == null ? '' : encodeURIComponent(reprocessingId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/channels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListChannels(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListChannelsResponse> {
			return Axios.get<ListChannelsResponse>(this.baseUri + '/channels?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateDataset(requestBody: CreateDatasetBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/datasets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListDatasets(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetsResponse> {
			return Axios.get<ListDatasetsResponse>(this.baseUri + '/datasets?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateDatasetContent(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetContentResponse> {
			return Axios.post<CreateDatasetContentResponse>(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDatasetContent(datasetName: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetDatasetContent(datasetName: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDatasetContentResponse> {
			return Axios.get<GetDatasetContentResponse>(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateDatastore(requestBody: CreateDatastoreBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/datastores', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListDatastores(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatastoresResponse> {
			return Axios.get<ListDatastoresResponse>(this.baseUri + '/datastores?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreatePipeline(requestBody: CreatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/pipelines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListPipelines(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesResponse> {
			return Axios.get<ListPipelinesResponse>(this.baseUri + '/pipelines?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteChannel(channelName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeChannel(channelName: string, includeStatistics: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeChannelResponse> {
			return Axios.get<DescribeChannelResponse>(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)) + '&includeStatistics=' + includeStatistics, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateChannel(channelName: string, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDataset(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeDataset(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return Axios.get<DescribeDatasetResponse>(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateDataset(datasetName: string, requestBody: UpdateDatasetBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDatastore(datastoreName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeDatastore(datastoreName: string, includeStatistics: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatastoreResponse> {
			return Axios.get<DescribeDatastoreResponse>(this.baseUri + '/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)) + '&includeStatistics=' + includeStatistics, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdateDatastore(datastoreName: string, requestBody: UpdateDatastoreBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeletePipeline(pipelineName: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribePipeline(pipelineName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribePipelineResponse> {
			return Axios.get<DescribePipelineResponse>(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		UpdatePipeline(pipelineName: string, requestBody: UpdatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/tags#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		RunPipelineActivity(requestBody: RunPipelineActivityBody, headersHandler?: () => {[header: string]: string}): Promise<RunPipelineActivityResponse> {
			return Axios.post<RunPipelineActivityResponse>(this.baseUri + '/pipelineactivities/run', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SampleChannelData(channelName: string, maxMessages: number, startTime: Date, endTime: Date, headersHandler?: () => {[header: string]: string}): Promise<SampleChannelDataResponse> {
			return Axios.get<SampleChannelDataResponse>(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)) + '/sample&maxMessages=' + maxMessages + '&startTime=' + startTime.toISOString() + '&endTime=' + endTime.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		StartPipelineReprocessing(pipelineName: string, requestBody: StartPipelineReprocessingBody, headersHandler?: () => {[header: string]: string}): Promise<StartPipelineReprocessingResponse> {
			return Axios.post<StartPipelineReprocessingResponse>(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)) + '/reprocessing', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/tags#resourceArn&tagKeys?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
	}
