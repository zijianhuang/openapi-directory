export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchPutMessage(requestBody: BatchPutMessageBody, headersHandler?: () => {[header: string]: string}): Promise<BatchPutMessageResponse> {
			return fetch(this.baseUri + '/messages/batch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CancelPipelineReprocessing(pipelineName: string, reprocessingId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelPipelineReprocessingResponse> {
			return fetch(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)) + '/reprocessing/' + (reprocessingId == null ? '' : encodeURIComponent(reprocessingId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/channels', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		ListChannels(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListChannelsResponse> {
			return fetch(this.baseUri + '/channels?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateDataset(requestBody: CreateDatasetBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/datasets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		ListDatasets(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetsResponse> {
			return fetch(this.baseUri + '/datasets?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		CreateDatasetContent(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetContentResponse> {
			return fetch(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteDatasetContent(datasetName: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetDatasetContent(datasetName: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDatasetContentResponse> {
			return fetch(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreateDatastore(requestBody: CreateDatastoreBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/datastores', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		ListDatastores(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatastoresResponse> {
			return fetch(this.baseUri + '/datastores?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		CreatePipeline(requestBody: CreatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/pipelines', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		ListPipelines(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesResponse> {
			return fetch(this.baseUri + '/pipelines?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} 
		 */
		DeleteChannel(channelName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeChannel(channelName: string, includeStatistics: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeChannelResponse> {
			return fetch(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)) + '&includeStatistics=' + includeStatistics, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdateChannel(channelName: string, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDataset(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDataset(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return fetch(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdateDataset(datasetName: string, requestBody: UpdateDatasetBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDatastore(datastoreName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDatastore(datastoreName: string, includeStatistics: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatastoreResponse> {
			return fetch(this.baseUri + '/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)) + '&includeStatistics=' + includeStatistics, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdateDatastore(datastoreName: string, requestBody: UpdateDatastoreBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} 
		 */
		DeletePipeline(pipelineName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribePipeline(pipelineName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribePipelineResponse> {
			return fetch(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		UpdatePipeline(pipelineName: string, requestBody: UpdatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		PutLoggingOptions(requestBody: PutLoggingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/logging', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/tags#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		RunPipelineActivity(requestBody: RunPipelineActivityBody, headersHandler?: () => {[header: string]: string}): Promise<RunPipelineActivityResponse> {
			return fetch(this.baseUri + '/pipelineactivities/run', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		SampleChannelData(channelName: string, maxMessages: number, startTime: Date, endTime: Date, headersHandler?: () => {[header: string]: string}): Promise<SampleChannelDataResponse> {
			return fetch(this.baseUri + '/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)) + '/sample&maxMessages=' + maxMessages + '&startTime=' + startTime.toISOString() + '&endTime=' + endTime.toISOString(), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		StartPipelineReprocessing(pipelineName: string, requestBody: StartPipelineReprocessingBody, headersHandler?: () => {[header: string]: string}): Promise<StartPipelineReprocessingResponse> {
			return fetch(this.baseUri + '/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)) + '/reprocessing', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/tags#resourceArn&tagKeys?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
	}
