...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchPutMessage(requestBody: BatchPutMessageBody, headersHandler?: () => {[header: string]: string}): Promise<BatchPutMessageResponse> {
			return this.http.post('/messages/batch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelPipelineReprocessing(pipelineName: string, reprocessingId: string, headersHandler?: () => {[header: string]: string}): Promise<CancelPipelineReprocessingResponse> {
			return this.http.delete('/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)) + '/reprocessing/' + (reprocessingId == null ? '' : encodeURIComponent(reprocessingId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateChannel(requestBody: CreateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/channels', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListChannels(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListChannelsResponse> {
			return this.http.get('/channels?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDataset(requestBody: CreateDatasetBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/datasets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListDatasets(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetsResponse> {
			return this.http.get('/datasets?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDatasetContent(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<CreateDatasetContentResponse> {
			return this.http.post('/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDatasetContent(datasetName: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDatasetContent(datasetName: string, versionId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDatasetContentResponse> {
			return this.http.get('/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/content&versionId=' + (versionId == null ? '' : encodeURIComponent(versionId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDatastore(requestBody: CreateDatastoreBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/datastores', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListDatastores(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatastoresResponse> {
			return this.http.get('/datastores?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreatePipeline(requestBody: CreatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/pipelines', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListPipelines(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListPipelinesResponse> {
			return this.http.get('/pipelines?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteChannel(channelName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeChannel(channelName: string, includeStatistics: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeChannelResponse> {
			return this.http.get('/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)) + '&includeStatistics=' + includeStatistics, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateChannel(channelName: string, requestBody: UpdateChannelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteDataset(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeDataset(datasetName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return this.http.get('/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDataset(datasetName: string, requestBody: UpdateDatasetBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeleteDatastore(datastoreName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeDatastore(datastoreName: string, includeStatistics: boolean, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatastoreResponse> {
			return this.http.get('/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)) + '&includeStatistics=' + includeStatistics, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDatastore(datastoreName: string, requestBody: UpdateDatastoreBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/datastores/' + (datastoreName == null ? '' : encodeURIComponent(datastoreName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		DeletePipeline(pipelineName: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribePipeline(pipelineName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribePipelineResponse> {
			return this.http.get('/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdatePipeline(pipelineName: string, requestBody: UpdatePipelineBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		PutLoggingOptions(requestBody: PutLoggingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.put('/logging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		ListDatasetContents(datasetName: string, nextToken: string, maxResults: number, scheduledOnOrAfter: Date, scheduledBefore: Date, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetContentsResponse> {
			return this.http.get('/datasets/' + (datasetName == null ? '' : encodeURIComponent(datasetName)) + '/contents&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults + '&scheduledOnOrAfter=' + scheduledOnOrAfter.toISOString() + '&scheduledBefore=' + scheduledBefore.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/tags#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		RunPipelineActivity(requestBody: RunPipelineActivityBody, headersHandler?: () => {[header: string]: string}): Promise<RunPipelineActivityResponse> {
			return this.http.post('/pipelineactivities/run', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SampleChannelData(channelName: string, maxMessages: number, startTime: Date, endTime: Date, headersHandler?: () => {[header: string]: string}): Promise<SampleChannelDataResponse> {
			return this.http.get('/channels/' + (channelName == null ? '' : encodeURIComponent(channelName)) + '/sample&maxMessages=' + maxMessages + '&startTime=' + startTime.toISOString() + '&endTime=' + endTime.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartPipelineReprocessing(pipelineName: string, requestBody: StartPipelineReprocessingBody, headersHandler?: () => {[header: string]: string}): Promise<StartPipelineReprocessingResponse> {
			return this.http.post('/pipelines/' + (pipelineName == null ? '' : encodeURIComponent(pipelineName)) + '/reprocessing', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/tags#resourceArn&tagKeys?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
