export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJob(requestBody: CancelJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelJobResponse> {
			return fetch(this.baseUri + '/v1/canceljob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateComputeEnvironment(requestBody: CreateComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateComputeEnvironmentResponse> {
			return fetch(this.baseUri + '/v1/createcomputeenvironment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateJobQueue(requestBody: CreateJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<CreateJobQueueResponse> {
			return fetch(this.baseUri + '/v1/createjobqueue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteComputeEnvironment(requestBody: DeleteComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteComputeEnvironmentResponse> {
			return fetch(this.baseUri + '/v1/deletecomputeenvironment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteJobQueue(requestBody: DeleteJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteJobQueueResponse> {
			return fetch(this.baseUri + '/v1/deletejobqueue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeregisterJobDefinition(requestBody: DeregisterJobDefinitionBody, headersHandler?: () => {[header: string]: string}): Promise<DeregisterJobDefinitionResponse> {
			return fetch(this.baseUri + '/v1/deregisterjobdefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeJobQueues(maxResults: string, nextToken: string, requestBody: DescribeJobQueuesBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobQueuesResponse> {
			return fetch(this.baseUri + '/v1/describejobqueues?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeJobs(requestBody: DescribeJobsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobsResponse> {
			return fetch(this.baseUri + '/v1/describejobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListJobs(maxResults: string, nextToken: string, requestBody: ListJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResponse> {
			return fetch(this.baseUri + '/v1/listjobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterJobDefinition(requestBody: RegisterJobDefinitionBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterJobDefinitionResponse> {
			return fetch(this.baseUri + '/v1/registerjobdefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SubmitJob(requestBody: SubmitJobBody, headersHandler?: () => {[header: string]: string}): Promise<SubmitJobResponse> {
			return fetch(this.baseUri + '/v1/submitjob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TerminateJob(requestBody: TerminateJobBody, headersHandler?: () => {[header: string]: string}): Promise<TerminateJobResponse> {
			return fetch(this.baseUri + '/v1/terminatejob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateComputeEnvironment(requestBody: UpdateComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateComputeEnvironmentResponse> {
			return fetch(this.baseUri + '/v1/updatecomputeenvironment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateJobQueue(requestBody: UpdateJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateJobQueueResponse> {
			return fetch(this.baseUri + '/v1/updatejobqueue', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
