...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelJob(requestBody: CancelJobBody, headersHandler?: () => HttpHeaders): Observable<CancelJobResponse> {
			return this.http.post<CancelJobResponse>(this.baseUri + '/v1/canceljob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateComputeEnvironment(requestBody: CreateComputeEnvironmentBody, headersHandler?: () => HttpHeaders): Observable<CreateComputeEnvironmentResponse> {
			return this.http.post<CreateComputeEnvironmentResponse>(this.baseUri + '/v1/createcomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateJobQueue(requestBody: CreateJobQueueBody, headersHandler?: () => HttpHeaders): Observable<CreateJobQueueResponse> {
			return this.http.post<CreateJobQueueResponse>(this.baseUri + '/v1/createjobqueue', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteComputeEnvironment(requestBody: DeleteComputeEnvironmentBody, headersHandler?: () => HttpHeaders): Observable<DeleteComputeEnvironmentResponse> {
			return this.http.post<DeleteComputeEnvironmentResponse>(this.baseUri + '/v1/deletecomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteJobQueue(requestBody: DeleteJobQueueBody, headersHandler?: () => HttpHeaders): Observable<DeleteJobQueueResponse> {
			return this.http.post<DeleteJobQueueResponse>(this.baseUri + '/v1/deletejobqueue', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeregisterJobDefinition(requestBody: DeregisterJobDefinitionBody, headersHandler?: () => HttpHeaders): Observable<DeregisterJobDefinitionResponse> {
			return this.http.post<DeregisterJobDefinitionResponse>(this.baseUri + '/v1/deregisterjobdefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeComputeEnvironments(maxResults: string, nextToken: string, requestBody: DescribeComputeEnvironmentsBody, headersHandler?: () => HttpHeaders): Observable<DescribeComputeEnvironmentsResponse> {
			return this.http.post<DescribeComputeEnvironmentsResponse>(this.baseUri + '/v1/describecomputeenvironments?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeJobDefinitions(maxResults: string, nextToken: string, requestBody: DescribeJobDefinitionsBody, headersHandler?: () => HttpHeaders): Observable<DescribeJobDefinitionsResponse> {
			return this.http.post<DescribeJobDefinitionsResponse>(this.baseUri + '/v1/describejobdefinitions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeJobQueues(maxResults: string, nextToken: string, requestBody: DescribeJobQueuesBody, headersHandler?: () => HttpHeaders): Observable<DescribeJobQueuesResponse> {
			return this.http.post<DescribeJobQueuesResponse>(this.baseUri + '/v1/describejobqueues?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeJobs(requestBody: DescribeJobsBody, headersHandler?: () => HttpHeaders): Observable<DescribeJobsResponse> {
			return this.http.post<DescribeJobsResponse>(this.baseUri + '/v1/describejobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListJobs(maxResults: string, nextToken: string, requestBody: ListJobsBody, headersHandler?: () => HttpHeaders): Observable<ListJobsResponse> {
			return this.http.post<ListJobsResponse>(this.baseUri + '/v1/listjobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterJobDefinition(requestBody: RegisterJobDefinitionBody, headersHandler?: () => HttpHeaders): Observable<RegisterJobDefinitionResponse> {
			return this.http.post<RegisterJobDefinitionResponse>(this.baseUri + '/v1/registerjobdefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SubmitJob(requestBody: SubmitJobBody, headersHandler?: () => HttpHeaders): Observable<SubmitJobResponse> {
			return this.http.post<SubmitJobResponse>(this.baseUri + '/v1/submitjob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TerminateJob(requestBody: TerminateJobBody, headersHandler?: () => HttpHeaders): Observable<TerminateJobResponse> {
			return this.http.post<TerminateJobResponse>(this.baseUri + '/v1/terminatejob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateComputeEnvironment(requestBody: UpdateComputeEnvironmentBody, headersHandler?: () => HttpHeaders): Observable<UpdateComputeEnvironmentResponse> {
			return this.http.post<UpdateComputeEnvironmentResponse>(this.baseUri + '/v1/updatecomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateJobQueue(requestBody: UpdateJobQueueBody, headersHandler?: () => HttpHeaders): Observable<UpdateJobQueueResponse> {
			return this.http.post<UpdateJobQueueResponse>(this.baseUri + '/v1/updatejobqueue', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
