...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelJob(requestBody: CancelJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelJobResponse> {
			return Axios.post<CancelJobResponse>(this.baseUri + '/v1/canceljob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateComputeEnvironment(requestBody: CreateComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateComputeEnvironmentResponse> {
			return Axios.post<CreateComputeEnvironmentResponse>(this.baseUri + '/v1/createcomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		CreateJobQueue(requestBody: CreateJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<CreateJobQueueResponse> {
			return Axios.post<CreateJobQueueResponse>(this.baseUri + '/v1/createjobqueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteComputeEnvironment(requestBody: DeleteComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteComputeEnvironmentResponse> {
			return Axios.post<DeleteComputeEnvironmentResponse>(this.baseUri + '/v1/deletecomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeleteJobQueue(requestBody: DeleteJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteJobQueueResponse> {
			return Axios.post<DeleteJobQueueResponse>(this.baseUri + '/v1/deletejobqueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DeregisterJobDefinition(requestBody: DeregisterJobDefinitionBody, headersHandler?: () => {[header: string]: string}): Promise<DeregisterJobDefinitionResponse> {
			return Axios.post<DeregisterJobDefinitionResponse>(this.baseUri + '/v1/deregisterjobdefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeComputeEnvironments(maxResults: string, nextToken: string, requestBody: DescribeComputeEnvironmentsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeComputeEnvironmentsResponse> {
			return Axios.post<DescribeComputeEnvironmentsResponse>(this.baseUri + '/v1/describecomputeenvironments?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeJobDefinitions(maxResults: string, nextToken: string, requestBody: DescribeJobDefinitionsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobDefinitionsResponse> {
			return Axios.post<DescribeJobDefinitionsResponse>(this.baseUri + '/v1/describejobdefinitions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeJobQueues(maxResults: string, nextToken: string, requestBody: DescribeJobQueuesBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobQueuesResponse> {
			return Axios.post<DescribeJobQueuesResponse>(this.baseUri + '/v1/describejobqueues?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeJobs(requestBody: DescribeJobsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobsResponse> {
			return Axios.post<DescribeJobsResponse>(this.baseUri + '/v1/describejobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListJobs(maxResults: string, nextToken: string, requestBody: ListJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResponse> {
			return Axios.post<ListJobsResponse>(this.baseUri + '/v1/listjobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		RegisterJobDefinition(requestBody: RegisterJobDefinitionBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterJobDefinitionResponse> {
			return Axios.post<RegisterJobDefinitionResponse>(this.baseUri + '/v1/registerjobdefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		SubmitJob(requestBody: SubmitJobBody, headersHandler?: () => {[header: string]: string}): Promise<SubmitJobResponse> {
			return Axios.post<SubmitJobResponse>(this.baseUri + '/v1/submitjob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		TerminateJob(requestBody: TerminateJobBody, headersHandler?: () => {[header: string]: string}): Promise<TerminateJobResponse> {
			return Axios.post<TerminateJobResponse>(this.baseUri + '/v1/terminatejob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateComputeEnvironment(requestBody: UpdateComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateComputeEnvironmentResponse> {
			return Axios.post<UpdateComputeEnvironmentResponse>(this.baseUri + '/v1/updatecomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateJobQueue(requestBody: UpdateJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateJobQueueResponse> {
			return Axios.post<UpdateJobQueueResponse>(this.baseUri + '/v1/updatejobqueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
