...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelJob(requestBody: CancelJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelJobResponse> {
			return this.http.post('/v1/canceljob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateComputeEnvironment(requestBody: CreateComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<CreateComputeEnvironmentResponse> {
			return this.http.post('/v1/createcomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateJobQueue(requestBody: CreateJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<CreateJobQueueResponse> {
			return this.http.post('/v1/createjobqueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteComputeEnvironment(requestBody: DeleteComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteComputeEnvironmentResponse> {
			return this.http.post('/v1/deletecomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteJobQueue(requestBody: DeleteJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteJobQueueResponse> {
			return this.http.post('/v1/deletejobqueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterJobDefinition(requestBody: DeregisterJobDefinitionBody, headersHandler?: () => {[header: string]: string}): Promise<DeregisterJobDefinitionResponse> {
			return this.http.post('/v1/deregisterjobdefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeComputeEnvironments(maxResults: string, nextToken: string, requestBody: DescribeComputeEnvironmentsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeComputeEnvironmentsResponse> {
			return this.http.post('/v1/describecomputeenvironments?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeJobQueues(maxResults: string, nextToken: string, requestBody: DescribeJobQueuesBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobQueuesResponse> {
			return this.http.post('/v1/describejobqueues?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeJobs(requestBody: DescribeJobsBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobsResponse> {
			return this.http.post('/v1/describejobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListJobs(maxResults: string, nextToken: string, requestBody: ListJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResponse> {
			return this.http.post('/v1/listjobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterJobDefinition(requestBody: RegisterJobDefinitionBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterJobDefinitionResponse> {
			return this.http.post('/v1/registerjobdefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SubmitJob(requestBody: SubmitJobBody, headersHandler?: () => {[header: string]: string}): Promise<SubmitJobResponse> {
			return this.http.post('/v1/submitjob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TerminateJob(requestBody: TerminateJobBody, headersHandler?: () => {[header: string]: string}): Promise<TerminateJobResponse> {
			return this.http.post('/v1/terminatejob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateComputeEnvironment(requestBody: UpdateComputeEnvironmentBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateComputeEnvironmentResponse> {
			return this.http.post('/v1/updatecomputeenvironment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateJobQueue(requestBody: UpdateJobQueueBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateJobQueueResponse> {
			return this.http.post('/v1/updatejobqueue', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
