...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AddRoleToDBCluster(DBClusterIdentifier: string, RoleArn: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier: string, TargetDBClusterSnapshotIdentifier: string, KmsKeyId: string, PreSignedUrl: string, CopyTags: boolean, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DeleteDBInstance(DBInstanceIdentifier: string, SkipFinalSnapshot: boolean, FinalDBSnapshotIdentifier: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeDBClusters(DBClusterIdentifier: string, Filters: Array<Filter>, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeDBEngineVersions(Engine: string, EngineVersion: string, DBParameterGroupFamily: string, Filters: Array<Filter>, MaxRecords: number, Marker: string, DefaultOnly: boolean, ListSupportedCharacterSets: boolean, ListSupportedTimezones: boolean, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeOrderableDBInstanceOptions(Engine: string, EngineVersion: string, DBInstanceClass: string, LicenseModel: string, Vpc: boolean, Filters: Array<Filter>, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_ModifyDBCluster(DBClusterIdentifier: string, NewDBClusterIdentifier: string, ApplyImmediately: boolean, BackupRetentionPeriod: number, DBClusterParameterGroupName: string, VpcSecurityGroupIds: Array<String>, Port: number, MasterUserPassword: string, OptionGroupName: string, PreferredBackupWindow: string, PreferredMaintenanceWindow: string, EnableIAMDatabaseAuthentication: boolean, CloudwatchLogsExportConfiguration: string, EngineVersion: string, DeletionProtection: boolean, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 * @return {void} Success
		 */
		GET_RemoveRoleFromDBCluster(DBClusterIdentifier: string, RoleArn: string, Action: string, Version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
