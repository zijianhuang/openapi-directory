...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AllocateConnectionOnInterconnect(requestBody: AllocateConnectionOnInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return Axios.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateConnectionOnInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AllocateHostedConnection(requestBody: AllocateHostedConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return Axios.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateHostedConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AllocatePrivateVirtualInterface(requestBody: AllocatePrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return Axios.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocatePrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AllocatePublicVirtualInterface(requestBody: AllocatePublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return Axios.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocatePublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AllocateTransitVirtualInterface(requestBody: AllocateTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<AllocateTransitVirtualInterfaceResult> {
			return Axios.post<AllocateTransitVirtualInterfaceResult>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateConnectionWithLag(requestBody: AssociateConnectionWithLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return Axios.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateConnectionWithLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateHostedConnection(requestBody: AssociateHostedConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return Axios.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateHostedConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AssociateVirtualInterface(requestBody: AssociateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return Axios.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmConnection(requestBody: ConfirmConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmConnectionResponse> {
			return Axios.post<ConfirmConnectionResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmPrivateVirtualInterface(requestBody: ConfirmPrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmPrivateVirtualInterfaceResponse> {
			return Axios.post<ConfirmPrivateVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmPrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmPublicVirtualInterface(requestBody: ConfirmPublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmPublicVirtualInterfaceResponse> {
			return Axios.post<ConfirmPublicVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmPublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ConfirmTransitVirtualInterface(requestBody: ConfirmTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmTransitVirtualInterfaceResponse> {
			return Axios.post<ConfirmTransitVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateBGPPeer(requestBody: CreateBGPPeerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBGPPeerResponse> {
			return Axios.post<CreateBGPPeerResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateBGPPeer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateConnection(requestBody: CreateConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return Axios.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDirectConnectGateway(requestBody: CreateDirectConnectGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayResult> {
			return Axios.post<CreateDirectConnectGatewayResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDirectConnectGatewayAssociation(requestBody: CreateDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayAssociationResult> {
			return Axios.post<CreateDirectConnectGatewayAssociationResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDirectConnectGatewayAssociationProposal(requestBody: CreateDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayAssociationProposalResult> {
			return Axios.post<CreateDirectConnectGatewayAssociationProposalResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateInterconnect(requestBody: CreateInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Interconnect> {
			return Axios.post<Interconnect>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateLag(requestBody: CreateLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return Axios.post<Lag>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePrivateVirtualInterface(requestBody: CreatePrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return Axios.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.CreatePrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePublicVirtualInterface(requestBody: CreatePublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return Axios.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.CreatePublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTransitVirtualInterface(requestBody: CreateTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTransitVirtualInterfaceResult> {
			return Axios.post<CreateTransitVirtualInterfaceResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteBGPPeer(requestBody: DeleteBGPPeerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBGPPeerResponse> {
			return Axios.post<DeleteBGPPeerResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteBGPPeer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteConnection(requestBody: DeleteConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return Axios.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDirectConnectGateway(requestBody: DeleteDirectConnectGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayResult> {
			return Axios.post<DeleteDirectConnectGatewayResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDirectConnectGatewayAssociation(requestBody: DeleteDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayAssociationResult> {
			return Axios.post<DeleteDirectConnectGatewayAssociationResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDirectConnectGatewayAssociationProposal(requestBody: DeleteDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayAssociationProposalResult> {
			return Axios.post<DeleteDirectConnectGatewayAssociationProposalResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteInterconnect(requestBody: DeleteInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInterconnectResponse> {
			return Axios.post<DeleteInterconnectResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteLag(requestBody: DeleteLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return Axios.post<Lag>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteVirtualInterface(requestBody: DeleteVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteVirtualInterfaceResponse> {
			return Axios.post<DeleteVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeConnectionLoa(requestBody: DescribeConnectionLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConnectionLoaResponse> {
			return Axios.post<DescribeConnectionLoaResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnectionLoa', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeConnections(requestBody: DescribeConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return Axios.post<Connections>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnections', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeConnectionsOnInterconnect(requestBody: DescribeConnectionsOnInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return Axios.post<Connections>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnectionsOnInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDirectConnectGatewayAssociationProposals(requestBody: DescribeDirectConnectGatewayAssociationProposalsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAssociationProposalsResult> {
			return Axios.post<DescribeDirectConnectGatewayAssociationProposalsResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociationProposals', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDirectConnectGatewayAssociations(requestBody: DescribeDirectConnectGatewayAssociationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAssociationsResult> {
			return Axios.post<DescribeDirectConnectGatewayAssociationsResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDirectConnectGatewayAttachments(requestBody: DescribeDirectConnectGatewayAttachmentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAttachmentsResult> {
			return Axios.post<DescribeDirectConnectGatewayAttachmentsResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAttachments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeHostedConnections(requestBody: DescribeHostedConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return Axios.post<Connections>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeHostedConnections', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInterconnectLoa(requestBody: DescribeInterconnectLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInterconnectLoaResponse> {
			return Axios.post<DescribeInterconnectLoaResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeInterconnectLoa', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeInterconnects(requestBody: DescribeInterconnectsRequest, headersHandler?: () => {[header: string]: string}): Promise<Interconnects> {
			return Axios.post<Interconnects>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeInterconnects', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeLags(requestBody: DescribeLagsRequest, headersHandler?: () => {[header: string]: string}): Promise<Lags> {
			return Axios.post<Lags>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeLoa(requestBody: DescribeLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<Loa> {
			return Axios.post<Loa>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLoa', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeLocations(headersHandler?: () => {[header: string]: string}): Promise<Locations> {
			return Axios.post<Locations>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLocations', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResponse> {
			return Axios.post<DescribeTagsResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeVirtualGateways(headersHandler?: () => {[header: string]: string}): Promise<VirtualGateways> {
			return Axios.post<VirtualGateways>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeVirtualGateways', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeVirtualInterfaces(requestBody: DescribeVirtualInterfacesRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterfaces> {
			return Axios.post<VirtualInterfaces>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeVirtualInterfaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateConnectionFromLag(requestBody: DisassociateConnectionFromLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return Axios.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.DisassociateConnectionFromLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListVirtualInterfaceTestHistory(requestBody: ListVirtualInterfaceTestHistoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVirtualInterfaceTestHistoryResponse> {
			return Axios.post<ListVirtualInterfaceTestHistoryResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ListVirtualInterfaceTestHistory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartBgpFailoverTest(requestBody: StartBgpFailoverTestRequest, headersHandler?: () => {[header: string]: string}): Promise<StartBgpFailoverTestResponse> {
			return Axios.post<StartBgpFailoverTestResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.StartBgpFailoverTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopBgpFailoverTest(requestBody: StopBgpFailoverTestRequest, headersHandler?: () => {[header: string]: string}): Promise<StopBgpFailoverTestResponse> {
			return Axios.post<StopBgpFailoverTestResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.StopBgpFailoverTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDirectConnectGatewayAssociation(requestBody: UpdateDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDirectConnectGatewayAssociationResult> {
			return Axios.post<UpdateDirectConnectGatewayAssociationResult>(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateLag(requestBody: UpdateLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return Axios.post<Lag>(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateVirtualInterfaceAttributes(requestBody: UpdateVirtualInterfaceAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return Axios.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateVirtualInterfaceAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
