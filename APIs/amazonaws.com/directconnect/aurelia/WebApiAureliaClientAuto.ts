...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptDirectConnectGatewayAssociationProposal(requestBody: AcceptDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptDirectConnectGatewayAssociationProposalResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.AcceptDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllocateConnectionOnInterconnect(requestBody: AllocateConnectionOnInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return this.http.post('/#X-Amz-Target=OvertureService.AllocateConnectionOnInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllocateHostedConnection(requestBody: AllocateHostedConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return this.http.post('/#X-Amz-Target=OvertureService.AllocateHostedConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllocatePrivateVirtualInterface(requestBody: AllocatePrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return this.http.post('/#X-Amz-Target=OvertureService.AllocatePrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllocatePublicVirtualInterface(requestBody: AllocatePublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return this.http.post('/#X-Amz-Target=OvertureService.AllocatePublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AllocateTransitVirtualInterface(requestBody: AllocateTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<AllocateTransitVirtualInterfaceResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.AllocateTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateConnectionWithLag(requestBody: AssociateConnectionWithLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return this.http.post('/#X-Amz-Target=OvertureService.AssociateConnectionWithLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateHostedConnection(requestBody: AssociateHostedConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return this.http.post('/#X-Amz-Target=OvertureService.AssociateHostedConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateVirtualInterface(requestBody: AssociateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return this.http.post('/#X-Amz-Target=OvertureService.AssociateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ConfirmConnection(requestBody: ConfirmConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmConnectionResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.ConfirmConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ConfirmPrivateVirtualInterface(requestBody: ConfirmPrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmPrivateVirtualInterfaceResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.ConfirmPrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ConfirmPublicVirtualInterface(requestBody: ConfirmPublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmPublicVirtualInterfaceResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.ConfirmPublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ConfirmTransitVirtualInterface(requestBody: ConfirmTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmTransitVirtualInterfaceResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.ConfirmTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateBGPPeer(requestBody: CreateBGPPeerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBGPPeerResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateBGPPeer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateConnection(requestBody: CreateConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDirectConnectGateway(requestBody: CreateDirectConnectGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateDirectConnectGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDirectConnectGatewayAssociation(requestBody: CreateDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayAssociationResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDirectConnectGatewayAssociationProposal(requestBody: CreateDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayAssociationProposalResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateInterconnect(requestBody: CreateInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Interconnect> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateLag(requestBody: CreateLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePrivateVirtualInterface(requestBody: CreatePrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreatePrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePublicVirtualInterface(requestBody: CreatePublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreatePublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTransitVirtualInterface(requestBody: CreateTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTransitVirtualInterfaceResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.CreateTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteBGPPeer(requestBody: DeleteBGPPeerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBGPPeerResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteBGPPeer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteConnection(requestBody: DeleteConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDirectConnectGateway(requestBody: DeleteDirectConnectGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteDirectConnectGateway', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDirectConnectGatewayAssociation(requestBody: DeleteDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayAssociationResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDirectConnectGatewayAssociationProposal(requestBody: DeleteDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayAssociationProposalResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInterconnect(requestBody: DeleteInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInterconnectResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLag(requestBody: DeleteLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteVirtualInterface(requestBody: DeleteVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteVirtualInterfaceResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.DeleteVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConnectionLoa(requestBody: DescribeConnectionLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConnectionLoaResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeConnectionLoa', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConnections(requestBody: DescribeConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeConnections', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeConnectionsOnInterconnect(requestBody: DescribeConnectionsOnInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeConnectionsOnInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDirectConnectGatewayAssociationProposals(requestBody: DescribeDirectConnectGatewayAssociationProposalsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAssociationProposalsResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociationProposals', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDirectConnectGatewayAssociations(requestBody: DescribeDirectConnectGatewayAssociationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAssociationsResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDirectConnectGatewayAttachments(requestBody: DescribeDirectConnectGatewayAttachmentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAttachmentsResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAttachments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDirectConnectGateways(requestBody: DescribeDirectConnectGatewaysRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewaysResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeDirectConnectGateways', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeHostedConnections(requestBody: DescribeHostedConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeHostedConnections', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeInterconnectLoa(requestBody: DescribeInterconnectLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInterconnectLoaResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeInterconnectLoa', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeInterconnects(requestBody: DescribeInterconnectsRequest, headersHandler?: () => {[header: string]: string}): Promise<Interconnects> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeInterconnects', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLags(requestBody: DescribeLagsRequest, headersHandler?: () => {[header: string]: string}): Promise<Lags> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeLags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLoa(requestBody: DescribeLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<Loa> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeLoa', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeLocations(headersHandler?: () => {[header: string]: string}): Promise<Locations> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeLocations', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeVirtualGateways(headersHandler?: () => {[header: string]: string}): Promise<VirtualGateways> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeVirtualGateways', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeVirtualInterfaces(requestBody: DescribeVirtualInterfacesRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterfaces> {
			return this.http.post('/#X-Amz-Target=OvertureService.DescribeVirtualInterfaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateConnectionFromLag(requestBody: DisassociateConnectionFromLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return this.http.post('/#X-Amz-Target=OvertureService.DisassociateConnectionFromLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListVirtualInterfaceTestHistory(requestBody: ListVirtualInterfaceTestHistoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVirtualInterfaceTestHistoryResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.ListVirtualInterfaceTestHistory', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartBgpFailoverTest(requestBody: StartBgpFailoverTestRequest, headersHandler?: () => {[header: string]: string}): Promise<StartBgpFailoverTestResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.StartBgpFailoverTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopBgpFailoverTest(requestBody: StopBgpFailoverTestRequest, headersHandler?: () => {[header: string]: string}): Promise<StopBgpFailoverTestResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.StopBgpFailoverTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=OvertureService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDirectConnectGatewayAssociation(requestBody: UpdateDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDirectConnectGatewayAssociationResult> {
			return this.http.post('/#X-Amz-Target=OvertureService.UpdateDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateLag(requestBody: UpdateLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return this.http.post('/#X-Amz-Target=OvertureService.UpdateLag', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateVirtualInterfaceAttributes(requestBody: UpdateVirtualInterfaceAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return this.http.post('/#X-Amz-Target=OvertureService.UpdateVirtualInterfaceAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
