export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptDirectConnectGatewayAssociationProposal(requestBody: AcceptDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptDirectConnectGatewayAssociationProposalResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AcceptDirectConnectGatewayAssociationProposal', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AllocateConnectionOnInterconnect(requestBody: AllocateConnectionOnInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateConnectionOnInterconnect', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connection} Success
		 */
		AllocateHostedConnection(requestBody: AllocateHostedConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateHostedConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AllocatePrivateVirtualInterface(requestBody: AllocatePrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AllocatePrivateVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		AllocatePublicVirtualInterface(requestBody: AllocatePublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AllocatePublicVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		AllocateTransitVirtualInterface(requestBody: AllocateTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<AllocateTransitVirtualInterfaceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateTransitVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connection} Success
		 */
		AssociateConnectionWithLag(requestBody: AssociateConnectionWithLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateConnectionWithLag', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connection} Success
		 */
		AssociateHostedConnection(requestBody: AssociateHostedConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateHostedConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		AssociateVirtualInterface(requestBody: AssociateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ConfirmConnection(requestBody: ConfirmConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmConnectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ConfirmPrivateVirtualInterface(requestBody: ConfirmPrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmPrivateVirtualInterfaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmPrivateVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ConfirmPublicVirtualInterface(requestBody: ConfirmPublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmPublicVirtualInterfaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmPublicVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ConfirmTransitVirtualInterface(requestBody: ConfirmTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<ConfirmTransitVirtualInterfaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmTransitVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateBGPPeer(requestBody: CreateBGPPeerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBGPPeerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateBGPPeer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connection} Success
		 */
		CreateConnection(requestBody: CreateConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateDirectConnectGateway(requestBody: CreateDirectConnectGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGateway', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateDirectConnectGatewayAssociation(requestBody: CreateDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayAssociationResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateDirectConnectGatewayAssociationProposal(requestBody: CreateDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDirectConnectGatewayAssociationProposalResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociationProposal', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateInterconnect(requestBody: CreateInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Interconnect> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateInterconnect', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Lag} Success
		 */
		CreateLag(requestBody: CreateLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateLag', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		CreatePrivateVirtualInterface(requestBody: CreatePrivateVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreatePrivateVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		CreatePublicVirtualInterface(requestBody: CreatePublicVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreatePublicVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateTransitVirtualInterface(requestBody: CreateTransitVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTransitVirtualInterfaceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.CreateTransitVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteBGPPeer(requestBody: DeleteBGPPeerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBGPPeerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteBGPPeer', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connection} Success
		 */
		DeleteConnection(requestBody: DeleteConnectionRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteDirectConnectGateway(requestBody: DeleteDirectConnectGatewayRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGateway', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteDirectConnectGatewayAssociation(requestBody: DeleteDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayAssociationResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteDirectConnectGatewayAssociationProposal(requestBody: DeleteDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDirectConnectGatewayAssociationProposalResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociationProposal', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteInterconnect(requestBody: DeleteInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInterconnectResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteInterconnect', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Lag} Success
		 */
		DeleteLag(requestBody: DeleteLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteLag', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DeleteVirtualInterface(requestBody: DeleteVirtualInterfaceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteVirtualInterfaceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteVirtualInterface', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeConnectionLoa(requestBody: DescribeConnectionLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeConnectionLoaResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnectionLoa', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeConnections(requestBody: DescribeConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnections', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connections} Success
		 */
		DescribeConnectionsOnInterconnect(requestBody: DescribeConnectionsOnInterconnectRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnectionsOnInterconnect', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeDirectConnectGatewayAssociationProposals(requestBody: DescribeDirectConnectGatewayAssociationProposalsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAssociationProposalsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociationProposals', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeDirectConnectGatewayAssociations(requestBody: DescribeDirectConnectGatewayAssociationsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAssociationsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeDirectConnectGatewayAttachments(requestBody: DescribeDirectConnectGatewayAttachmentsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewayAttachmentsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAttachments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeDirectConnectGateways(requestBody: DescribeDirectConnectGatewaysRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDirectConnectGatewaysResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGateways', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connections} Success
		 */
		DescribeHostedConnections(requestBody: DescribeHostedConnectionsRequest, headersHandler?: () => {[header: string]: string}): Promise<Connections> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeHostedConnections', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeInterconnectLoa(requestBody: DescribeInterconnectLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeInterconnectLoaResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeInterconnectLoa', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeInterconnects(requestBody: DescribeInterconnectsRequest, headersHandler?: () => {[header: string]: string}): Promise<Interconnects> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeInterconnects', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Lags} Success
		 */
		DescribeLags(requestBody: DescribeLagsRequest, headersHandler?: () => {[header: string]: string}): Promise<Lags> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Loa} Success
		 */
		DescribeLoa(requestBody: DescribeLoaRequest, headersHandler?: () => {[header: string]: string}): Promise<Loa> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLoa', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeLocations(headersHandler?: () => {[header: string]: string}): Promise<Locations> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLocations', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTagsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeTags', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeVirtualGateways(headersHandler?: () => {[header: string]: string}): Promise<VirtualGateways> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeVirtualGateways', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 */
		DescribeVirtualInterfaces(requestBody: DescribeVirtualInterfacesRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterfaces> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeVirtualInterfaces', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Connection} Success
		 */
		DisassociateConnectionFromLag(requestBody: DisassociateConnectionFromLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Connection> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.DisassociateConnectionFromLag', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListVirtualInterfaceTestHistory(requestBody: ListVirtualInterfaceTestHistoryRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVirtualInterfaceTestHistoryResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.ListVirtualInterfaceTestHistory', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StartBgpFailoverTest(requestBody: StartBgpFailoverTestRequest, headersHandler?: () => {[header: string]: string}): Promise<StartBgpFailoverTestResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.StartBgpFailoverTest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		StopBgpFailoverTest(requestBody: StopBgpFailoverTestRequest, headersHandler?: () => {[header: string]: string}): Promise<StopBgpFailoverTestResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.StopBgpFailoverTest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateDirectConnectGatewayAssociation(requestBody: UpdateDirectConnectGatewayAssociationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDirectConnectGatewayAssociationResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateDirectConnectGatewayAssociation', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {Lag} Success
		 */
		UpdateLag(requestBody: UpdateLagRequest, headersHandler?: () => {[header: string]: string}): Promise<Lag> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateLag', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		UpdateVirtualInterfaceAttributes(requestBody: UpdateVirtualInterfaceAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<VirtualInterface> {
			return fetch(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateVirtualInterfaceAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
