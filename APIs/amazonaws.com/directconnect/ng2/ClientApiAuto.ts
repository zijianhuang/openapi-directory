...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptDirectConnectGatewayAssociationProposal(requestBody: AcceptDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => HttpHeaders): Observable<AcceptDirectConnectGatewayAssociationProposalResult> {
			return this.http.post<AcceptDirectConnectGatewayAssociationProposalResult>(this.baseUri + '/#X-Amz-Target=OvertureService.AcceptDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AllocateConnectionOnInterconnect(requestBody: AllocateConnectionOnInterconnectRequest, headersHandler?: () => HttpHeaders): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateConnectionOnInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connection} Success
		 */
		AllocateHostedConnection(requestBody: AllocateHostedConnectionRequest, headersHandler?: () => HttpHeaders): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateHostedConnection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AllocatePrivateVirtualInterface(requestBody: AllocatePrivateVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<VirtualInterface> {
			return this.http.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocatePrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		AllocatePublicVirtualInterface(requestBody: AllocatePublicVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<VirtualInterface> {
			return this.http.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocatePublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AllocateTransitVirtualInterface(requestBody: AllocateTransitVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<AllocateTransitVirtualInterfaceResult> {
			return this.http.post<AllocateTransitVirtualInterfaceResult>(this.baseUri + '/#X-Amz-Target=OvertureService.AllocateTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connection} Success
		 */
		AssociateConnectionWithLag(requestBody: AssociateConnectionWithLagRequest, headersHandler?: () => HttpHeaders): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateConnectionWithLag', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connection} Success
		 */
		AssociateHostedConnection(requestBody: AssociateHostedConnectionRequest, headersHandler?: () => HttpHeaders): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateHostedConnection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		AssociateVirtualInterface(requestBody: AssociateVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<VirtualInterface> {
			return this.http.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.AssociateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ConfirmConnection(requestBody: ConfirmConnectionRequest, headersHandler?: () => HttpHeaders): Observable<ConfirmConnectionResponse> {
			return this.http.post<ConfirmConnectionResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmConnection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ConfirmPrivateVirtualInterface(requestBody: ConfirmPrivateVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<ConfirmPrivateVirtualInterfaceResponse> {
			return this.http.post<ConfirmPrivateVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmPrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ConfirmPublicVirtualInterface(requestBody: ConfirmPublicVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<ConfirmPublicVirtualInterfaceResponse> {
			return this.http.post<ConfirmPublicVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmPublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ConfirmTransitVirtualInterface(requestBody: ConfirmTransitVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<ConfirmTransitVirtualInterfaceResponse> {
			return this.http.post<ConfirmTransitVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ConfirmTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateBGPPeer(requestBody: CreateBGPPeerRequest, headersHandler?: () => HttpHeaders): Observable<CreateBGPPeerResponse> {
			return this.http.post<CreateBGPPeerResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateBGPPeer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connection} Success
		 */
		CreateConnection(requestBody: CreateConnectionRequest, headersHandler?: () => HttpHeaders): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateConnection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDirectConnectGateway(requestBody: CreateDirectConnectGatewayRequest, headersHandler?: () => HttpHeaders): Observable<CreateDirectConnectGatewayResult> {
			return this.http.post<CreateDirectConnectGatewayResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGateway', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDirectConnectGatewayAssociation(requestBody: CreateDirectConnectGatewayAssociationRequest, headersHandler?: () => HttpHeaders): Observable<CreateDirectConnectGatewayAssociationResult> {
			return this.http.post<CreateDirectConnectGatewayAssociationResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDirectConnectGatewayAssociationProposal(requestBody: CreateDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => HttpHeaders): Observable<CreateDirectConnectGatewayAssociationProposalResult> {
			return this.http.post<CreateDirectConnectGatewayAssociationProposalResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateInterconnect(requestBody: CreateInterconnectRequest, headersHandler?: () => HttpHeaders): Observable<Interconnect> {
			return this.http.post<Interconnect>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Lag} Success
		 */
		CreateLag(requestBody: CreateLagRequest, headersHandler?: () => HttpHeaders): Observable<Lag> {
			return this.http.post<Lag>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateLag', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		CreatePrivateVirtualInterface(requestBody: CreatePrivateVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<VirtualInterface> {
			return this.http.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.CreatePrivateVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		CreatePublicVirtualInterface(requestBody: CreatePublicVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<VirtualInterface> {
			return this.http.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.CreatePublicVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTransitVirtualInterface(requestBody: CreateTransitVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<CreateTransitVirtualInterfaceResult> {
			return this.http.post<CreateTransitVirtualInterfaceResult>(this.baseUri + '/#X-Amz-Target=OvertureService.CreateTransitVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteBGPPeer(requestBody: DeleteBGPPeerRequest, headersHandler?: () => HttpHeaders): Observable<DeleteBGPPeerResponse> {
			return this.http.post<DeleteBGPPeerResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteBGPPeer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connection} Success
		 */
		DeleteConnection(requestBody: DeleteConnectionRequest, headersHandler?: () => HttpHeaders): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDirectConnectGateway(requestBody: DeleteDirectConnectGatewayRequest, headersHandler?: () => HttpHeaders): Observable<DeleteDirectConnectGatewayResult> {
			return this.http.post<DeleteDirectConnectGatewayResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGateway', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDirectConnectGatewayAssociation(requestBody: DeleteDirectConnectGatewayAssociationRequest, headersHandler?: () => HttpHeaders): Observable<DeleteDirectConnectGatewayAssociationResult> {
			return this.http.post<DeleteDirectConnectGatewayAssociationResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDirectConnectGatewayAssociationProposal(requestBody: DeleteDirectConnectGatewayAssociationProposalRequest, headersHandler?: () => HttpHeaders): Observable<DeleteDirectConnectGatewayAssociationProposalResult> {
			return this.http.post<DeleteDirectConnectGatewayAssociationProposalResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteDirectConnectGatewayAssociationProposal', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteInterconnect(requestBody: DeleteInterconnectRequest, headersHandler?: () => HttpHeaders): Observable<DeleteInterconnectResponse> {
			return this.http.post<DeleteInterconnectResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Lag} Success
		 */
		DeleteLag(requestBody: DeleteLagRequest, headersHandler?: () => HttpHeaders): Observable<Lag> {
			return this.http.post<Lag>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteLag', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteVirtualInterface(requestBody: DeleteVirtualInterfaceRequest, headersHandler?: () => HttpHeaders): Observable<DeleteVirtualInterfaceResponse> {
			return this.http.post<DeleteVirtualInterfaceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DeleteVirtualInterface', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConnectionLoa(requestBody: DescribeConnectionLoaRequest, headersHandler?: () => HttpHeaders): Observable<DescribeConnectionLoaResponse> {
			return this.http.post<DescribeConnectionLoaResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnectionLoa', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConnections(requestBody: DescribeConnectionsRequest, headersHandler?: () => HttpHeaders): Observable<Connections> {
			return this.http.post<Connections>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnections', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connections} Success
		 */
		DescribeConnectionsOnInterconnect(requestBody: DescribeConnectionsOnInterconnectRequest, headersHandler?: () => HttpHeaders): Observable<Connections> {
			return this.http.post<Connections>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeConnectionsOnInterconnect', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDirectConnectGatewayAssociationProposals(requestBody: DescribeDirectConnectGatewayAssociationProposalsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDirectConnectGatewayAssociationProposalsResult> {
			return this.http.post<DescribeDirectConnectGatewayAssociationProposalsResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociationProposals', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDirectConnectGatewayAssociations(requestBody: DescribeDirectConnectGatewayAssociationsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDirectConnectGatewayAssociationsResult> {
			return this.http.post<DescribeDirectConnectGatewayAssociationsResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAssociations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDirectConnectGatewayAttachments(requestBody: DescribeDirectConnectGatewayAttachmentsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDirectConnectGatewayAttachmentsResult> {
			return this.http.post<DescribeDirectConnectGatewayAttachmentsResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGatewayAttachments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDirectConnectGateways(requestBody: DescribeDirectConnectGatewaysRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDirectConnectGatewaysResult> {
			return this.http.post<DescribeDirectConnectGatewaysResult>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeDirectConnectGateways', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connections} Success
		 */
		DescribeHostedConnections(requestBody: DescribeHostedConnectionsRequest, headersHandler?: () => HttpHeaders): Observable<Connections> {
			return this.http.post<Connections>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeHostedConnections', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeInterconnectLoa(requestBody: DescribeInterconnectLoaRequest, headersHandler?: () => HttpHeaders): Observable<DescribeInterconnectLoaResponse> {
			return this.http.post<DescribeInterconnectLoaResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeInterconnectLoa', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeInterconnects(requestBody: DescribeInterconnectsRequest, headersHandler?: () => HttpHeaders): Observable<Interconnects> {
			return this.http.post<Interconnects>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeInterconnects', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Lags} Success
		 */
		DescribeLags(requestBody: DescribeLagsRequest, headersHandler?: () => HttpHeaders): Observable<Lags> {
			return this.http.post<Lags>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Loa} Success
		 */
		DescribeLoa(requestBody: DescribeLoaRequest, headersHandler?: () => HttpHeaders): Observable<Loa> {
			return this.http.post<Loa>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLoa', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeLocations(headersHandler?: () => HttpHeaders): Observable<Locations> {
			return this.http.post<Locations>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeLocations', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeTags(requestBody: DescribeTagsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTagsResponse> {
			return this.http.post<DescribeTagsResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeVirtualGateways(headersHandler?: () => HttpHeaders): Observable<VirtualGateways> {
			return this.http.post<VirtualGateways>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeVirtualGateways', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeVirtualInterfaces(requestBody: DescribeVirtualInterfacesRequest, headersHandler?: () => HttpHeaders): Observable<VirtualInterfaces> {
			return this.http.post<VirtualInterfaces>(this.baseUri + '/#X-Amz-Target=OvertureService.DescribeVirtualInterfaces', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Connection} Success
		 */
		DisassociateConnectionFromLag(requestBody: DisassociateConnectionFromLagRequest, headersHandler?: () => HttpHeaders): Observable<Connection> {
			return this.http.post<Connection>(this.baseUri + '/#X-Amz-Target=OvertureService.DisassociateConnectionFromLag', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListVirtualInterfaceTestHistory(requestBody: ListVirtualInterfaceTestHistoryRequest, headersHandler?: () => HttpHeaders): Observable<ListVirtualInterfaceTestHistoryResponse> {
			return this.http.post<ListVirtualInterfaceTestHistoryResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.ListVirtualInterfaceTestHistory', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartBgpFailoverTest(requestBody: StartBgpFailoverTestRequest, headersHandler?: () => HttpHeaders): Observable<StartBgpFailoverTestResponse> {
			return this.http.post<StartBgpFailoverTestResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.StartBgpFailoverTest', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopBgpFailoverTest(requestBody: StopBgpFailoverTestRequest, headersHandler?: () => HttpHeaders): Observable<StopBgpFailoverTestResponse> {
			return this.http.post<StopBgpFailoverTestResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.StopBgpFailoverTest', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=OvertureService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDirectConnectGatewayAssociation(requestBody: UpdateDirectConnectGatewayAssociationRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDirectConnectGatewayAssociationResult> {
			return this.http.post<UpdateDirectConnectGatewayAssociationResult>(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateDirectConnectGatewayAssociation', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {Lag} Success
		 */
		UpdateLag(requestBody: UpdateLagRequest, headersHandler?: () => HttpHeaders): Observable<Lag> {
			return this.http.post<Lag>(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateLag', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {VirtualInterface} Success
		 */
		UpdateVirtualInterfaceAttributes(requestBody: UpdateVirtualInterfaceAttributesRequest, headersHandler?: () => HttpHeaders): Observable<VirtualInterface> {
			return this.http.post<VirtualInterface>(this.baseUri + '/#X-Amz-Target=OvertureService.UpdateVirtualInterfaceAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
