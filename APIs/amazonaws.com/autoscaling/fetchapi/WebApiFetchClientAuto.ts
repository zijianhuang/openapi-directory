export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GET_AttachInstances(InstanceIds: Array<XmlStringMaxLen19>, AutoScalingGroupName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=AttachInstances?' + InstanceIds.map(z => `InstanceIds=${z}`).join('&') + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_AttachLoadBalancerTargetGroups(AutoScalingGroupName: string, TargetGroupARNs: Array<XmlStringMaxLen511>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=AttachLoadBalancerTargetGroups?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + TargetGroupARNs.map(z => `TargetGroupARNs=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_AttachLoadBalancers(AutoScalingGroupName: string, LoadBalancerNames: Array<XmlStringMaxLen255>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=AttachLoadBalancers?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + LoadBalancerNames.map(z => `LoadBalancerNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_BatchDeleteScheduledAction(AutoScalingGroupName: string, ScheduledActionNames: Array<ResourceName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=BatchDeleteScheduledAction?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + ScheduledActionNames.map(z => `ScheduledActionNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_BatchPutScheduledUpdateGroupAction(AutoScalingGroupName: string, ScheduledUpdateGroupActions: Array<ScheduledUpdateGroupActionRequest>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=BatchPutScheduledUpdateGroupAction?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + ScheduledUpdateGroupActions.map(z => `ScheduledUpdateGroupActions=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_CompleteLifecycleAction(LifecycleHookName: string, AutoScalingGroupName: string, LifecycleActionToken: string, LifecycleActionResult: string, InstanceId: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=CompleteLifecycleAction?LifecycleHookName=' + (LifecycleHookName == null ? '' : encodeURIComponent(LifecycleHookName)) + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&LifecycleActionToken=' + (LifecycleActionToken == null ? '' : encodeURIComponent(LifecycleActionToken)) + '&LifecycleActionResult=' + (LifecycleActionResult == null ? '' : encodeURIComponent(LifecycleActionResult)) + '&InstanceId=' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_CreateOrUpdateTags(Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=CreateOrUpdateTags?' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteAutoScalingGroup(AutoScalingGroupName: string, ForceDelete: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteAutoScalingGroup?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&ForceDelete=' + ForceDelete + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteLaunchConfiguration(LaunchConfigurationName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteLaunchConfiguration?LaunchConfigurationName=' + (LaunchConfigurationName == null ? '' : encodeURIComponent(LaunchConfigurationName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteLifecycleHook(LifecycleHookName: string, AutoScalingGroupName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteLifecycleHook?LifecycleHookName=' + (LifecycleHookName == null ? '' : encodeURIComponent(LifecycleHookName)) + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteNotificationConfiguration(AutoScalingGroupName: string, TopicARN: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteNotificationConfiguration?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&TopicARN=' + (TopicARN == null ? '' : encodeURIComponent(TopicARN)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeletePolicy(AutoScalingGroupName: string, PolicyName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeletePolicy?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteScheduledAction(AutoScalingGroupName: string, ScheduledActionName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteScheduledAction?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&ScheduledActionName=' + (ScheduledActionName == null ? '' : encodeURIComponent(ScheduledActionName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteTags(Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteTags?' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAccountLimits(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAccountLimits?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeAccountLimits(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAccountLimits?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAdjustmentTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAdjustmentTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeAdjustmentTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAdjustmentTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAutoScalingGroups(AutoScalingGroupNames: Array<ResourceName>, NextToken: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAutoScalingGroups?' + AutoScalingGroupNames.map(z => `AutoScalingGroupNames=${z}`).join('&') + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAutoScalingInstances(InstanceIds: Array<XmlStringMaxLen19>, MaxRecords: number, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAutoScalingInstances?' + InstanceIds.map(z => `InstanceIds=${z}`).join('&') + '&MaxRecords=' + MaxRecords + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAutoScalingNotificationTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAutoScalingNotificationTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeAutoScalingNotificationTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAutoScalingNotificationTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeLaunchConfigurations(LaunchConfigurationNames: Array<ResourceName>, NextToken: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeLaunchConfigurations?' + LaunchConfigurationNames.map(z => `LaunchConfigurationNames=${z}`).join('&') + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeLifecycleHookTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeLifecycleHookTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeLifecycleHookTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeLifecycleHookTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeLoadBalancerTargetGroups(AutoScalingGroupName: string, NextToken: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeLoadBalancerTargetGroups?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeLoadBalancers(AutoScalingGroupName: string, NextToken: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeLoadBalancers?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeMetricCollectionTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeMetricCollectionTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeMetricCollectionTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeMetricCollectionTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeNotificationConfigurations(AutoScalingGroupNames: Array<ResourceName>, NextToken: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeNotificationConfigurations?' + AutoScalingGroupNames.map(z => `AutoScalingGroupNames=${z}`).join('&') + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribePolicies(AutoScalingGroupName: string, PolicyNames: Array<ResourceName>, PolicyTypes: Array<XmlStringMaxLen64>, NextToken: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribePolicies?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + PolicyNames.map(z => `PolicyNames=${z}`).join('&') + '&' + PolicyTypes.map(z => `PolicyTypes=${z}`).join('&') + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeScalingActivities(ActivityIds: Array<XmlString>, AutoScalingGroupName: string, MaxRecords: number, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeScalingActivities?' + ActivityIds.map(z => `ActivityIds=${z}`).join('&') + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&MaxRecords=' + MaxRecords + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeScalingProcessTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeScalingProcessTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeScalingProcessTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeScalingProcessTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeTags(Filters: Array<Filter>, NextToken: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeTags?' + Filters.map(z => `Filters=${z}`).join('&') + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeTerminationPolicyTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeTerminationPolicyTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeTerminationPolicyTypes(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeTerminationPolicyTypes?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DetachInstances(InstanceIds: Array<XmlStringMaxLen19>, AutoScalingGroupName: string, ShouldDecrementDesiredCapacity: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DetachInstances?' + InstanceIds.map(z => `InstanceIds=${z}`).join('&') + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&ShouldDecrementDesiredCapacity=' + ShouldDecrementDesiredCapacity + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DetachLoadBalancerTargetGroups(AutoScalingGroupName: string, TargetGroupARNs: Array<XmlStringMaxLen511>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DetachLoadBalancerTargetGroups?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + TargetGroupARNs.map(z => `TargetGroupARNs=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DetachLoadBalancers(AutoScalingGroupName: string, LoadBalancerNames: Array<XmlStringMaxLen255>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DetachLoadBalancers?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + LoadBalancerNames.map(z => `LoadBalancerNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DisableMetricsCollection(AutoScalingGroupName: string, Metrics: Array<XmlStringMaxLen255>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DisableMetricsCollection?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + Metrics.map(z => `Metrics=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_EnableMetricsCollection(AutoScalingGroupName: string, Metrics: Array<XmlStringMaxLen255>, Granularity: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=EnableMetricsCollection?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + Metrics.map(z => `Metrics=${z}`).join('&') + '&Granularity=' + (Granularity == null ? '' : encodeURIComponent(Granularity)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_EnterStandby(InstanceIds: Array<XmlStringMaxLen19>, AutoScalingGroupName: string, ShouldDecrementDesiredCapacity: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=EnterStandby?' + InstanceIds.map(z => `InstanceIds=${z}`).join('&') + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&ShouldDecrementDesiredCapacity=' + ShouldDecrementDesiredCapacity + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ExitStandby(InstanceIds: Array<XmlStringMaxLen19>, AutoScalingGroupName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=ExitStandby?' + InstanceIds.map(z => `InstanceIds=${z}`).join('&') + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_RecordLifecycleActionHeartbeat(LifecycleHookName: string, AutoScalingGroupName: string, LifecycleActionToken: string, InstanceId: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=RecordLifecycleActionHeartbeat?LifecycleHookName=' + (LifecycleHookName == null ? '' : encodeURIComponent(LifecycleHookName)) + '&AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&LifecycleActionToken=' + (LifecycleActionToken == null ? '' : encodeURIComponent(LifecycleActionToken)) + '&InstanceId=' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ResumeProcesses(AutoScalingGroupName: string, ScalingProcesses: Array<XmlStringMaxLen255>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=ResumeProcesses?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + ScalingProcesses.map(z => `ScalingProcesses=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_SetDesiredCapacity(AutoScalingGroupName: string, DesiredCapacity: number, HonorCooldown: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=SetDesiredCapacity?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&DesiredCapacity=' + DesiredCapacity + '&HonorCooldown=' + HonorCooldown + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_SuspendProcesses(AutoScalingGroupName: string, ScalingProcesses: Array<XmlStringMaxLen255>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=SuspendProcesses?AutoScalingGroupName=' + (AutoScalingGroupName == null ? '' : encodeURIComponent(AutoScalingGroupName)) + '&' + ScalingProcesses.map(z => `ScalingProcesses=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_TerminateInstanceInAutoScalingGroup(InstanceId: string, ShouldDecrementDesiredCapacity: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=TerminateInstanceInAutoScalingGroup?InstanceId=' + (InstanceId == null ? '' : encodeURIComponent(InstanceId)) + '&ShouldDecrementDesiredCapacity=' + ShouldDecrementDesiredCapacity + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
