...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(detectorId: string, requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptInvitationResponse> {
			return Axios.post<AcceptInvitationResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/master', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMasterAccount(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetMasterAccountResponse> {
			return Axios.get<GetMasterAccountResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/master', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ArchiveFindings(detectorId: string, requestBody: ArchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ArchiveFindingsResponse> {
			return Axios.post<ArchiveFindingsResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/archive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDetector(requestBody: CreateDetectorBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDetectorResponse> {
			return Axios.post<CreateDetectorResponse>(this.baseUri + '/detector', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDetectors(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListDetectorsResponse> {
			return Axios.get<ListDetectorsResponse>(this.baseUri + '/detector?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateFilter(detectorId: string, requestBody: CreateFilterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFilterResponse> {
			return Axios.post<CreateFilterResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateIPSet(detectorId: string, requestBody: CreateIPSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateIPSetResponse> {
			return Axios.post<CreateIPSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateMembers(detectorId: string, requestBody: CreateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<CreateMembersResponse> {
			return Axios.post<CreateMembersResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreatePublishingDestination(detectorId: string, requestBody: CreatePublishingDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<CreatePublishingDestinationResponse> {
			return Axios.post<CreatePublishingDestinationResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSampleFindings(detectorId: string, requestBody: CreateSampleFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSampleFindingsResponse> {
			return Axios.post<CreateSampleFindingsResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/create', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateThreatIntelSet(detectorId: string, requestBody: CreateThreatIntelSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThreatIntelSetResponse> {
			return Axios.post<CreateThreatIntelSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeclineInvitations(requestBody: DeclineInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeclineInvitationsResponse> {
			return Axios.post<DeclineInvitationsResponse>(this.baseUri + '/invitation/decline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDetector(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDetectorResponse> {
			return Axios.delete<DeleteDetectorResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetDetector(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDetectorResponse> {
			return Axios.get<GetDetectorResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateDetector(detectorId: string, requestBody: UpdateDetectorBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorResponse> {
			return Axios.post<UpdateDetectorResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteFilter(detectorId: string, filterName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFilterResponse> {
			return Axios.delete<DeleteFilterResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter/' + (filterName == null ? '' : encodeURIComponent(filterName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetFilter(detectorId: string, filterName: string, headersHandler?: () => {[header: string]: string}): Promise<GetFilterResponse> {
			return Axios.get<GetFilterResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter/' + (filterName == null ? '' : encodeURIComponent(filterName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateFilter(detectorId: string, filterName: string, requestBody: UpdateFilterBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFilterResponse> {
			return Axios.post<UpdateFilterResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter/' + (filterName == null ? '' : encodeURIComponent(filterName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteIPSet(detectorId: string, ipSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteIPSetResponse> {
			return Axios.delete<DeleteIPSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset/' + (ipSetId == null ? '' : encodeURIComponent(ipSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetIPSet(detectorId: string, ipSetId: string, headersHandler?: () => {[header: string]: string}): Promise<GetIPSetResponse> {
			return Axios.get<GetIPSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset/' + (ipSetId == null ? '' : encodeURIComponent(ipSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateIPSet(detectorId: string, ipSetId: string, requestBody: UpdateIPSetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateIPSetResponse> {
			return Axios.post<UpdateIPSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset/' + (ipSetId == null ? '' : encodeURIComponent(ipSetId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteInvitations(requestBody: DeleteInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteInvitationsResponse> {
			return Axios.post<DeleteInvitationsResponse>(this.baseUri + '/invitation/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteMembers(detectorId: string, requestBody: DeleteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteMembersResponse> {
			return Axios.post<DeleteMembersResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeletePublishingDestination(detectorId: string, destinationId: string, headersHandler?: () => {[header: string]: string}): Promise<DeletePublishingDestinationResponse> {
			return Axios.delete<DeletePublishingDestinationResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination/' + (destinationId == null ? '' : encodeURIComponent(destinationId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribePublishingDestination(detectorId: string, destinationId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribePublishingDestinationResponse> {
			return Axios.get<DescribePublishingDestinationResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination/' + (destinationId == null ? '' : encodeURIComponent(destinationId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteThreatIntelSet(detectorId: string, threatIntelSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteThreatIntelSetResponse> {
			return Axios.delete<DeleteThreatIntelSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset/' + (threatIntelSetId == null ? '' : encodeURIComponent(threatIntelSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetThreatIntelSet(detectorId: string, threatIntelSetId: string, headersHandler?: () => {[header: string]: string}): Promise<GetThreatIntelSetResponse> {
			return Axios.get<GetThreatIntelSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset/' + (threatIntelSetId == null ? '' : encodeURIComponent(threatIntelSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateThreatIntelSet(detectorId: string, threatIntelSetId: string, requestBody: UpdateThreatIntelSetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateThreatIntelSetResponse> {
			return Axios.post<UpdateThreatIntelSetResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset/' + (threatIntelSetId == null ? '' : encodeURIComponent(threatIntelSetId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeOrganizationConfiguration(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConfigurationResponse> {
			return Axios.get<DescribeOrganizationConfigurationResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/admin', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		UpdateOrganizationConfiguration(detectorId: string, requestBody: UpdateOrganizationConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateOrganizationConfigurationResponse> {
			return Axios.post<UpdateOrganizationConfigurationResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/admin', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableOrganizationAdminAccount(requestBody: DisableOrganizationAdminAccountBody, headersHandler?: () => {[header: string]: string}): Promise<DisableOrganizationAdminAccountResponse> {
			return Axios.post<DisableOrganizationAdminAccountResponse>(this.baseUri + '/admin/disable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateFromMasterAccount(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateFromMasterAccountResponse> {
			return Axios.post<DisassociateFromMasterAccountResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/master/disassociate', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DisassociateMembers(detectorId: string, requestBody: DisassociateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMembersResponse> {
			return Axios.post<DisassociateMembersResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/disassociate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableOrganizationAdminAccount(requestBody: EnableOrganizationAdminAccountBody, headersHandler?: () => {[header: string]: string}): Promise<EnableOrganizationAdminAccountResponse> {
			return Axios.post<EnableOrganizationAdminAccountResponse>(this.baseUri + '/admin/enable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFindings(detectorId: string, requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsResponse> {
			return Axios.post<GetFindingsResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetFindingsStatistics(detectorId: string, requestBody: GetFindingsStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsStatisticsResponse> {
			return Axios.post<GetFindingsStatisticsResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInvitationsCount(headersHandler?: () => {[header: string]: string}): Promise<GetInvitationsCountResponse> {
			return Axios.get<GetInvitationsCountResponse>(this.baseUri + '/invitation/count', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetMembers(detectorId: string, requestBody: GetMembersBody, headersHandler?: () => {[header: string]: string}): Promise<GetMembersResponse> {
			return Axios.post<GetMembersResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InviteMembers(detectorId: string, requestBody: InviteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<InviteMembersResponse> {
			return Axios.post<InviteMembersResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/invite', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListFindings(detectorId: string, MaxResults: string, NextToken: string, requestBody: ListFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ListFindingsResponse> {
			return Axios.post<ListFindingsResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartMonitoringMembers(detectorId: string, requestBody: StartMonitoringMembersBody, headersHandler?: () => {[header: string]: string}): Promise<StartMonitoringMembersResponse> {
			return Axios.post<StartMonitoringMembersResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/start', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UnarchiveFindings(detectorId: string, requestBody: UnarchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<UnarchiveFindingsResponse> {
			return Axios.post<UnarchiveFindingsResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/unarchive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateFindingsFeedback(detectorId: string, requestBody: UpdateFindingsFeedbackBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFindingsFeedbackResponse> {
			return Axios.post<UpdateFindingsFeedbackResponse>(this.baseUri + '/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/feedback', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
