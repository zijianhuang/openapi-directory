...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptInvitation(detectorId: string, requestBody: AcceptInvitationBody, headersHandler?: () => {[header: string]: string}): Promise<AcceptInvitationResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/master', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMasterAccount(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetMasterAccountResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/master', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ArchiveFindings(detectorId: string, requestBody: ArchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ArchiveFindingsResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/archive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateDetector(requestBody: CreateDetectorBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDetectorResponse> {
			return this.http.post('/detector', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDetectors(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListDetectorsResponse> {
			return this.http.get('/detector?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateFilter(detectorId: string, requestBody: CreateFilterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFilterResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListFilters(detectorId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListFiltersResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateIPSet(detectorId: string, requestBody: CreateIPSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateIPSetResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListIPSets(detectorId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListIPSetsResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateMembers(detectorId: string, requestBody: CreateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<CreateMembersResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreatePublishingDestination(detectorId: string, requestBody: CreatePublishingDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<CreatePublishingDestinationResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListPublishingDestinations(detectorId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListPublishingDestinationsResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateSampleFindings(detectorId: string, requestBody: CreateSampleFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSampleFindingsResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/create', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateThreatIntelSet(detectorId: string, requestBody: CreateThreatIntelSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateThreatIntelSetResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListThreatIntelSets(detectorId: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListThreatIntelSetsResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeclineInvitations(requestBody: DeclineInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeclineInvitationsResponse> {
			return this.http.post('/invitation/decline', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDetector(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDetectorResponse> {
			return this.http.delete('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDetector(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDetectorResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateDetector(detectorId: string, requestBody: UpdateDetectorBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteFilter(detectorId: string, filterName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFilterResponse> {
			return this.http.delete('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter/' + (filterName == null ? '' : encodeURIComponent(filterName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetFilter(detectorId: string, filterName: string, headersHandler?: () => {[header: string]: string}): Promise<GetFilterResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter/' + (filterName == null ? '' : encodeURIComponent(filterName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateFilter(detectorId: string, filterName: string, requestBody: UpdateFilterBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFilterResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/filter/' + (filterName == null ? '' : encodeURIComponent(filterName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteIPSet(detectorId: string, ipSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteIPSetResponse> {
			return this.http.delete('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset/' + (ipSetId == null ? '' : encodeURIComponent(ipSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetIPSet(detectorId: string, ipSetId: string, headersHandler?: () => {[header: string]: string}): Promise<GetIPSetResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset/' + (ipSetId == null ? '' : encodeURIComponent(ipSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateIPSet(detectorId: string, ipSetId: string, requestBody: UpdateIPSetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateIPSetResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/ipset/' + (ipSetId == null ? '' : encodeURIComponent(ipSetId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInvitations(requestBody: DeleteInvitationsBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteInvitationsResponse> {
			return this.http.post('/invitation/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMembers(detectorId: string, requestBody: DeleteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteMembersResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/delete', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeletePublishingDestination(detectorId: string, destinationId: string, headersHandler?: () => {[header: string]: string}): Promise<DeletePublishingDestinationResponse> {
			return this.http.delete('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination/' + (destinationId == null ? '' : encodeURIComponent(destinationId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribePublishingDestination(detectorId: string, destinationId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribePublishingDestinationResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination/' + (destinationId == null ? '' : encodeURIComponent(destinationId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdatePublishingDestination(detectorId: string, destinationId: string, requestBody: UpdatePublishingDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdatePublishingDestinationResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/publishingDestination/' + (destinationId == null ? '' : encodeURIComponent(destinationId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteThreatIntelSet(detectorId: string, threatIntelSetId: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteThreatIntelSetResponse> {
			return this.http.delete('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset/' + (threatIntelSetId == null ? '' : encodeURIComponent(threatIntelSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetThreatIntelSet(detectorId: string, threatIntelSetId: string, headersHandler?: () => {[header: string]: string}): Promise<GetThreatIntelSetResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset/' + (threatIntelSetId == null ? '' : encodeURIComponent(threatIntelSetId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateThreatIntelSet(detectorId: string, threatIntelSetId: string, requestBody: UpdateThreatIntelSetBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateThreatIntelSetResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/threatintelset/' + (threatIntelSetId == null ? '' : encodeURIComponent(threatIntelSetId)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOrganizationConfiguration(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationConfigurationResponse> {
			return this.http.get('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/admin', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateOrganizationConfiguration(detectorId: string, requestBody: UpdateOrganizationConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateOrganizationConfigurationResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/admin', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableOrganizationAdminAccount(requestBody: DisableOrganizationAdminAccountBody, headersHandler?: () => {[header: string]: string}): Promise<DisableOrganizationAdminAccountResponse> {
			return this.http.post('/admin/disable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateFromMasterAccount(detectorId: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateFromMasterAccountResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/master/disassociate', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateMembers(detectorId: string, requestBody: DisassociateMembersBody, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMembersResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/disassociate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableOrganizationAdminAccount(requestBody: EnableOrganizationAdminAccountBody, headersHandler?: () => {[header: string]: string}): Promise<EnableOrganizationAdminAccountResponse> {
			return this.http.post('/admin/enable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetFindings(detectorId: string, requestBody: GetFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetFindingsStatistics(detectorId: string, requestBody: GetFindingsStatisticsBody, headersHandler?: () => {[header: string]: string}): Promise<GetFindingsStatisticsResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/statistics', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInvitationsCount(headersHandler?: () => {[header: string]: string}): Promise<GetInvitationsCountResponse> {
			return this.http.get('/invitation/count', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetMembers(detectorId: string, requestBody: GetMembersBody, headersHandler?: () => {[header: string]: string}): Promise<GetMembersResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/get', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		InviteMembers(detectorId: string, requestBody: InviteMembersBody, headersHandler?: () => {[header: string]: string}): Promise<InviteMembersResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/invite', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListFindings(detectorId: string, MaxResults: string, NextToken: string, requestBody: ListFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<ListFindingsResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInvitations(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListInvitationsResponse> {
			return this.http.get('/invitation?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListOrganizationAdminAccounts(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListOrganizationAdminAccountsResponse> {
			return this.http.get('/admin?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		StartMonitoringMembers(detectorId: string, requestBody: StartMonitoringMembersBody, headersHandler?: () => {[header: string]: string}): Promise<StartMonitoringMembersResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/start', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopMonitoringMembers(detectorId: string, requestBody: StopMonitoringMembersBody, headersHandler?: () => {[header: string]: string}): Promise<StopMonitoringMembersResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/member/stop', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UnarchiveFindings(detectorId: string, requestBody: UnarchiveFindingsBody, headersHandler?: () => {[header: string]: string}): Promise<UnarchiveFindingsResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/unarchive', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateFindingsFeedback(detectorId: string, requestBody: UpdateFindingsFeedbackBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateFindingsFeedbackResponse> {
			return this.http.post('/detector/' + (detectorId == null ? '' : encodeURIComponent(detectorId)) + '/findings/feedback', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
