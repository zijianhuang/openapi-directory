export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DescribeAffectedEntities(maxResults: string, nextToken: string, requestBody: DescribeAffectedEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAffectedEntitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeAffectedEntities?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEntityAggregates(requestBody: DescribeEntityAggregatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntityAggregatesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEntityAggregates', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventAggregates(maxResults: string, nextToken: string, requestBody: DescribeEventAggregatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventAggregatesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventAggregates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventDetails(requestBody: DescribeEventDetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventDetailsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventDetails', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventDetailsForOrganization(requestBody: DescribeEventDetailsForOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventDetailsForOrganizationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventDetailsForOrganization', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventTypes(maxResults: string, nextToken: string, requestBody: DescribeEventTypesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventTypesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventTypes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventsForOrganization(maxResults: string, nextToken: string, requestBody: DescribeEventsForOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventsForOrganizationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventsForOrganization?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeHealthServiceStatusForOrganization(headersHandler?: () => {[header: string]: string}): Promise<DescribeHealthServiceStatusForOrganizationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeHealthServiceStatusForOrganization', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisableHealthServiceAccessForOrganization(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DisableHealthServiceAccessForOrganization', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		EnableHealthServiceAccessForOrganization(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.EnableHealthServiceAccessForOrganization', { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
	}
