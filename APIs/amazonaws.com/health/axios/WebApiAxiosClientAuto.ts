...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DescribeAffectedEntities(maxResults: string, nextToken: string, requestBody: DescribeAffectedEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAffectedEntitiesResponse> {
			return Axios.post<DescribeAffectedEntitiesResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeAffectedEntities?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeAffectedEntitiesForOrganization(maxResults: string, nextToken: string, requestBody: DescribeAffectedEntitiesForOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAffectedEntitiesForOrganizationResponse> {
			return Axios.post<DescribeAffectedEntitiesForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeAffectedEntitiesForOrganization?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEntityAggregates(requestBody: DescribeEntityAggregatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntityAggregatesResponse> {
			return Axios.post<DescribeEntityAggregatesResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEntityAggregates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEventAggregates(maxResults: string, nextToken: string, requestBody: DescribeEventAggregatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventAggregatesResponse> {
			return Axios.post<DescribeEventAggregatesResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventAggregates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEventDetails(requestBody: DescribeEventDetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventDetailsResponse> {
			return Axios.post<DescribeEventDetailsResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventDetails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEventDetailsForOrganization(requestBody: DescribeEventDetailsForOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventDetailsForOrganizationResponse> {
			return Axios.post<DescribeEventDetailsForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventDetailsForOrganization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEventTypes(maxResults: string, nextToken: string, requestBody: DescribeEventTypesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventTypesResponse> {
			return Axios.post<DescribeEventTypesResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventTypes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeEventsForOrganization(maxResults: string, nextToken: string, requestBody: DescribeEventsForOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventsForOrganizationResponse> {
			return Axios.post<DescribeEventsForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeEventsForOrganization?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		DescribeHealthServiceStatusForOrganization(headersHandler?: () => {[header: string]: string}): Promise<DescribeHealthServiceStatusForOrganizationResponse> {
			return Axios.post<DescribeHealthServiceStatusForOrganizationResponse>(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DescribeHealthServiceStatusForOrganization', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DisableHealthServiceAccessForOrganization(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.DisableHealthServiceAccessForOrganization', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		EnableHealthServiceAccessForOrganization(headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=AWSHealth_20160804.EnableHealthServiceAccessForOrganization', null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
	}
