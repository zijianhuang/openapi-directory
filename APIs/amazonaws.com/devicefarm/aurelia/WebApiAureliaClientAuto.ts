...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateDevicePool(requestBody: CreateDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDevicePoolResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateInstanceProfile(requestBody: CreateInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstanceProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateNetworkProfile(requestBody: CreateNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateNetworkProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateProject(requestBody: CreateProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateRemoteAccessSession(requestBody: CreateRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRemoteAccessSessionResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTestGridProject(requestBody: CreateTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTestGridProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateTestGridUrl(requestBody: CreateTestGridUrlRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTestGridUrlResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateTestGridUrl', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateUpload(requestBody: CreateUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUploadResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateVPCEConfiguration(requestBody: CreateVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVPCEConfigurationResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.CreateVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDevicePool(requestBody: DeleteDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDevicePoolResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteInstanceProfile(requestBody: DeleteInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInstanceProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteNetworkProfile(requestBody: DeleteNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNetworkProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteProject(requestBody: DeleteProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRemoteAccessSession(requestBody: DeleteRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRemoteAccessSessionResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRun(requestBody: DeleteRunRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRunResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTestGridProject(requestBody: DeleteTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTestGridProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUpload(requestBody: DeleteUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUploadResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteVPCEConfiguration(requestBody: DeleteVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteVPCEConfigurationResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.DeleteVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAccountSettings(requestBody: GetAccountSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountSettingsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetAccountSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDevice(requestBody: GetDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeviceResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeviceInstance(requestBody: GetDeviceInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeviceInstanceResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetDeviceInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDevicePool(requestBody: GetDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDevicePoolResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDevicePoolCompatibility(requestBody: GetDevicePoolCompatibilityRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDevicePoolCompatibilityResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetDevicePoolCompatibility', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetInstanceProfile(requestBody: GetInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetJob(requestBody: GetJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetNetworkProfile(requestBody: GetNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNetworkProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOfferingStatus(nextToken: string, requestBody: GetOfferingStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOfferingStatusResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetOfferingStatus?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetProject(requestBody: GetProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<GetProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRemoteAccessSession(requestBody: GetRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRemoteAccessSessionResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetRun(requestBody: GetRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRunResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetSuite(requestBody: GetSuiteRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSuiteResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetSuite', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTest(requestBody: GetTestRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTestResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTestGridProject(requestBody: GetTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTestGridProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetTestGridSession(requestBody: GetTestGridSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTestGridSessionResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetTestGridSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetUpload(requestBody: GetUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUploadResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetVPCEConfiguration(requestBody: GetVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVPCEConfigurationResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.GetVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		InstallToRemoteAccessSession(requestBody: InstallToRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<InstallToRemoteAccessSessionResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.InstallToRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListArtifacts(nextToken: string, requestBody: ListArtifactsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListArtifactsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListArtifacts?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDeviceInstances(requestBody: ListDeviceInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDeviceInstancesResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListDeviceInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDevices(nextToken: string, requestBody: ListDevicesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDevicesResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListDevices?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListInstanceProfiles(requestBody: ListInstanceProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListInstanceProfilesResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListInstanceProfiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListJobs(nextToken: string, requestBody: ListJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListJobs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListNetworkProfiles(requestBody: ListNetworkProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListNetworkProfilesResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListNetworkProfiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListOfferingPromotions(requestBody: ListOfferingPromotionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOfferingPromotionsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListOfferingPromotions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListOfferingTransactions(nextToken: string, requestBody: ListOfferingTransactionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOfferingTransactionsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListOfferingTransactions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListProjects(nextToken: string, requestBody: ListProjectsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListProjectsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListProjects?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListRemoteAccessSessions(requestBody: ListRemoteAccessSessionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRemoteAccessSessionsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListRemoteAccessSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListRuns(nextToken: string, requestBody: ListRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRunsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListRuns?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListSamples(nextToken: string, requestBody: ListSamplesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSamplesResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListSamples?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListSuites(nextToken: string, requestBody: ListSuitesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSuitesResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListSuites?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTestGridSessionActions(maxResult: string, nextToken: string, requestBody: ListTestGridSessionActionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTestGridSessionActionsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListTestGridSessionActions?maxResult=' + (maxResult == null ? '' : encodeURIComponent(maxResult)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTestGridSessions(maxResult: string, nextToken: string, requestBody: ListTestGridSessionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTestGridSessionsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListTestGridSessions?maxResult=' + (maxResult == null ? '' : encodeURIComponent(maxResult)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTests(nextToken: string, requestBody: ListTestsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTestsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListTests?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListUniqueProblems(nextToken: string, requestBody: ListUniqueProblemsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUniqueProblemsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListUniqueProblems?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListUploads(nextToken: string, requestBody: ListUploadsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUploadsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListUploads?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListVPCEConfigurations(requestBody: ListVPCEConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVPCEConfigurationsResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ListVPCEConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PurchaseOffering(requestBody: PurchaseOfferingRequest, headersHandler?: () => {[header: string]: string}): Promise<PurchaseOfferingResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.PurchaseOffering', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RenewOffering(requestBody: RenewOfferingRequest, headersHandler?: () => {[header: string]: string}): Promise<RenewOfferingResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.RenewOffering', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ScheduleRun(requestBody: ScheduleRunRequest, headersHandler?: () => {[header: string]: string}): Promise<ScheduleRunResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.ScheduleRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopJob(requestBody: StopJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopJobResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.StopJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopRemoteAccessSession(requestBody: StopRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRemoteAccessSessionResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.StopRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopRun(requestBody: StopRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRunResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.StopRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDeviceInstance(requestBody: UpdateDeviceInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDeviceInstanceResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateDeviceInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDevicePool(requestBody: UpdateDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDevicePoolResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateInstanceProfile(requestBody: UpdateInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateInstanceProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateNetworkProfile(requestBody: UpdateNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNetworkProfileResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateProject(requestBody: UpdateProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTestGridProject(requestBody: UpdateTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTestGridProjectResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateUpload(requestBody: UpdateUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUploadResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateVPCEConfiguration(requestBody: UpdateVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVPCEConfigurationResult> {
			return this.http.post('/#X-Amz-Target=DeviceFarm_20150623.UpdateVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
