...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateDevicePool(requestBody: CreateDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDevicePoolResult> {
			return Axios.post<CreateDevicePoolResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateInstanceProfile(requestBody: CreateInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateInstanceProfileResult> {
			return Axios.post<CreateInstanceProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateNetworkProfile(requestBody: CreateNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateNetworkProfileResult> {
			return Axios.post<CreateNetworkProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateProject(requestBody: CreateProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProjectResult> {
			return Axios.post<CreateProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRemoteAccessSession(requestBody: CreateRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRemoteAccessSessionResult> {
			return Axios.post<CreateRemoteAccessSessionResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTestGridProject(requestBody: CreateTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTestGridProjectResult> {
			return Axios.post<CreateTestGridProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTestGridUrl(requestBody: CreateTestGridUrlRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTestGridUrlResult> {
			return Axios.post<CreateTestGridUrlResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateTestGridUrl', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateUpload(requestBody: CreateUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUploadResult> {
			return Axios.post<CreateUploadResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateVPCEConfiguration(requestBody: CreateVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVPCEConfigurationResult> {
			return Axios.post<CreateVPCEConfigurationResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.CreateVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDevicePool(requestBody: DeleteDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDevicePoolResult> {
			return Axios.post<DeleteDevicePoolResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteInstanceProfile(requestBody: DeleteInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteInstanceProfileResult> {
			return Axios.post<DeleteInstanceProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteNetworkProfile(requestBody: DeleteNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteNetworkProfileResult> {
			return Axios.post<DeleteNetworkProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteProject(requestBody: DeleteProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProjectResult> {
			return Axios.post<DeleteProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRemoteAccessSession(requestBody: DeleteRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRemoteAccessSessionResult> {
			return Axios.post<DeleteRemoteAccessSessionResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRun(requestBody: DeleteRunRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRunResult> {
			return Axios.post<DeleteRunResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTestGridProject(requestBody: DeleteTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTestGridProjectResult> {
			return Axios.post<DeleteTestGridProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteUpload(requestBody: DeleteUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUploadResult> {
			return Axios.post<DeleteUploadResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteVPCEConfiguration(requestBody: DeleteVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteVPCEConfigurationResult> {
			return Axios.post<DeleteVPCEConfigurationResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.DeleteVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAccountSettings(requestBody: GetAccountSettingsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccountSettingsResult> {
			return Axios.post<GetAccountSettingsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetAccountSettings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDevice(requestBody: GetDeviceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeviceResult> {
			return Axios.post<GetDeviceResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetDevice', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeviceInstance(requestBody: GetDeviceInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDeviceInstanceResult> {
			return Axios.post<GetDeviceInstanceResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetDeviceInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDevicePool(requestBody: GetDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDevicePoolResult> {
			return Axios.post<GetDevicePoolResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDevicePoolCompatibility(requestBody: GetDevicePoolCompatibilityRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDevicePoolCompatibilityResult> {
			return Axios.post<GetDevicePoolCompatibilityResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetDevicePoolCompatibility', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInstanceProfile(requestBody: GetInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInstanceProfileResult> {
			return Axios.post<GetInstanceProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJob(requestBody: GetJobRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobResult> {
			return Axios.post<GetJobResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetNetworkProfile(requestBody: GetNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<GetNetworkProfileResult> {
			return Axios.post<GetNetworkProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOfferingStatus(nextToken: string, requestBody: GetOfferingStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOfferingStatusResult> {
			return Axios.post<GetOfferingStatusResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetOfferingStatus?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetProject(requestBody: GetProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<GetProjectResult> {
			return Axios.post<GetProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRemoteAccessSession(requestBody: GetRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRemoteAccessSessionResult> {
			return Axios.post<GetRemoteAccessSessionResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRun(requestBody: GetRunRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRunResult> {
			return Axios.post<GetRunResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSuite(requestBody: GetSuiteRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSuiteResult> {
			return Axios.post<GetSuiteResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetSuite', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTest(requestBody: GetTestRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTestResult> {
			return Axios.post<GetTestResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetTest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTestGridProject(requestBody: GetTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTestGridProjectResult> {
			return Axios.post<GetTestGridProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTestGridSession(requestBody: GetTestGridSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTestGridSessionResult> {
			return Axios.post<GetTestGridSessionResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetTestGridSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetUpload(requestBody: GetUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<GetUploadResult> {
			return Axios.post<GetUploadResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetVPCEConfiguration(requestBody: GetVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVPCEConfigurationResult> {
			return Axios.post<GetVPCEConfigurationResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.GetVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InstallToRemoteAccessSession(requestBody: InstallToRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<InstallToRemoteAccessSessionResult> {
			return Axios.post<InstallToRemoteAccessSessionResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.InstallToRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListArtifacts(nextToken: string, requestBody: ListArtifactsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListArtifactsResult> {
			return Axios.post<ListArtifactsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListArtifacts?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeviceInstances(requestBody: ListDeviceInstancesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDeviceInstancesResult> {
			return Axios.post<ListDeviceInstancesResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListDeviceInstances', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDevicePools(nextToken: string, requestBody: ListDevicePoolsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDevicePoolsResult> {
			return Axios.post<ListDevicePoolsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListDevicePools?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDevices(nextToken: string, requestBody: ListDevicesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDevicesResult> {
			return Axios.post<ListDevicesResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListDevices?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListInstanceProfiles(requestBody: ListInstanceProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListInstanceProfilesResult> {
			return Axios.post<ListInstanceProfilesResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListInstanceProfiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListJobs(nextToken: string, requestBody: ListJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResult> {
			return Axios.post<ListJobsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListJobs?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListNetworkProfiles(requestBody: ListNetworkProfilesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListNetworkProfilesResult> {
			return Axios.post<ListNetworkProfilesResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListNetworkProfiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListOfferingPromotions(requestBody: ListOfferingPromotionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOfferingPromotionsResult> {
			return Axios.post<ListOfferingPromotionsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListOfferingPromotions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListOfferingTransactions(nextToken: string, requestBody: ListOfferingTransactionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOfferingTransactionsResult> {
			return Axios.post<ListOfferingTransactionsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListOfferingTransactions?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListOfferings(nextToken: string, requestBody: ListOfferingsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOfferingsResult> {
			return Axios.post<ListOfferingsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListOfferings?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListProjects(nextToken: string, requestBody: ListProjectsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListProjectsResult> {
			return Axios.post<ListProjectsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListProjects?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRemoteAccessSessions(requestBody: ListRemoteAccessSessionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRemoteAccessSessionsResult> {
			return Axios.post<ListRemoteAccessSessionsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListRemoteAccessSessions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRuns(nextToken: string, requestBody: ListRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRunsResult> {
			return Axios.post<ListRunsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListRuns?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSamples(nextToken: string, requestBody: ListSamplesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSamplesResult> {
			return Axios.post<ListSamplesResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListSamples?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSuites(nextToken: string, requestBody: ListSuitesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListSuitesResult> {
			return Axios.post<ListSuitesResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListSuites?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTestGridProjects(maxResult: string, nextToken: string, requestBody: ListTestGridProjectsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTestGridProjectsResult> {
			return Axios.post<ListTestGridProjectsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListTestGridProjects?maxResult=' + (maxResult == null ? '' : encodeURIComponent(maxResult)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTestGridSessionActions(maxResult: string, nextToken: string, requestBody: ListTestGridSessionActionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTestGridSessionActionsResult> {
			return Axios.post<ListTestGridSessionActionsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListTestGridSessionActions?maxResult=' + (maxResult == null ? '' : encodeURIComponent(maxResult)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTestGridSessionArtifacts(maxResult: string, nextToken: string, requestBody: ListTestGridSessionArtifactsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTestGridSessionArtifactsResult> {
			return Axios.post<ListTestGridSessionArtifactsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListTestGridSessionArtifacts?maxResult=' + (maxResult == null ? '' : encodeURIComponent(maxResult)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTests(nextToken: string, requestBody: ListTestsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTestsResult> {
			return Axios.post<ListTestsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListTests?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUniqueProblems(nextToken: string, requestBody: ListUniqueProblemsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUniqueProblemsResult> {
			return Axios.post<ListUniqueProblemsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListUniqueProblems?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListUploads(nextToken: string, requestBody: ListUploadsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUploadsResult> {
			return Axios.post<ListUploadsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListUploads?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListVPCEConfigurations(requestBody: ListVPCEConfigurationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListVPCEConfigurationsResult> {
			return Axios.post<ListVPCEConfigurationsResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ListVPCEConfigurations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PurchaseOffering(requestBody: PurchaseOfferingRequest, headersHandler?: () => {[header: string]: string}): Promise<PurchaseOfferingResult> {
			return Axios.post<PurchaseOfferingResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.PurchaseOffering', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RenewOffering(requestBody: RenewOfferingRequest, headersHandler?: () => {[header: string]: string}): Promise<RenewOfferingResult> {
			return Axios.post<RenewOfferingResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.RenewOffering', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ScheduleRun(requestBody: ScheduleRunRequest, headersHandler?: () => {[header: string]: string}): Promise<ScheduleRunResult> {
			return Axios.post<ScheduleRunResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.ScheduleRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopJob(requestBody: StopJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopJobResult> {
			return Axios.post<StopJobResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.StopJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopRemoteAccessSession(requestBody: StopRemoteAccessSessionRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRemoteAccessSessionResult> {
			return Axios.post<StopRemoteAccessSessionResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.StopRemoteAccessSession', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopRun(requestBody: StopRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRunResult> {
			return Axios.post<StopRunResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.StopRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDeviceInstance(requestBody: UpdateDeviceInstanceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDeviceInstanceResult> {
			return Axios.post<UpdateDeviceInstanceResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateDeviceInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDevicePool(requestBody: UpdateDevicePoolRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDevicePoolResult> {
			return Axios.post<UpdateDevicePoolResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateDevicePool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateInstanceProfile(requestBody: UpdateInstanceProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateInstanceProfileResult> {
			return Axios.post<UpdateInstanceProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateInstanceProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateNetworkProfile(requestBody: UpdateNetworkProfileRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateNetworkProfileResult> {
			return Axios.post<UpdateNetworkProfileResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateNetworkProfile', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateProject(requestBody: UpdateProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateProjectResult> {
			return Axios.post<UpdateProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateTestGridProject(requestBody: UpdateTestGridProjectRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTestGridProjectResult> {
			return Axios.post<UpdateTestGridProjectResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateTestGridProject', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateUpload(requestBody: UpdateUploadRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateUploadResult> {
			return Axios.post<UpdateUploadResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateUpload', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateVPCEConfiguration(requestBody: UpdateVPCEConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVPCEConfigurationResult> {
			return Axios.post<UpdateVPCEConfigurationResult>(this.baseUri + '/#X-Amz-Target=DeviceFarm_20150623.UpdateVPCEConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
