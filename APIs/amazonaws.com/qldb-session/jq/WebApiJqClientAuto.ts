...
namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		SendCommand(callback: (data : SendCommandResult) => any, requestBody: SendCommandRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '#X-Amz-Target=QLDBSession.SendCommand', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
