...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		ListTagsForResource(ResourceType: TagResourceType, ResourceId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/tags/' + ResourceType + '/' + (ResourceId == null ? '' : encodeURIComponent(ResourceId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListHealthChecks(marker: string, maxitems: string, MaxItems: string, Marker: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/healthcheck?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&maxitems=' + (maxitems == null ? '' : encodeURIComponent(maxitems)) + '&MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListQueryLoggingConfigs(hostedzoneid: string, nexttoken: string, maxresults: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/queryloggingconfig?hostedzoneid=' + (hostedzoneid == null ? '' : encodeURIComponent(hostedzoneid)) + '&nexttoken=' + (nexttoken == null ? '' : encodeURIComponent(nexttoken)) + '&maxresults=' + (maxresults == null ? '' : encodeURIComponent(maxresults)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListReusableDelegationSets(marker: string, maxitems: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/delegationset?marker=' + (marker == null ? '' : encodeURIComponent(marker)) + '&maxitems=' + (maxitems == null ? '' : encodeURIComponent(maxitems)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListVPCAssociationAuthorizations(Id: string, nexttoken: string, maxresults: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/hostedzone/' + (Id == null ? '' : encodeURIComponent(Id)) + '/authorizevpcassociation&nexttoken=' + (nexttoken == null ? '' : encodeURIComponent(nexttoken)) + '&maxresults=' + (maxresults == null ? '' : encodeURIComponent(maxresults)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteHealthCheck(HealthCheckId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2013-04-01/healthcheck/' + (HealthCheckId == null ? '' : encodeURIComponent(HealthCheckId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetHealthCheck(HealthCheckId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/healthcheck/' + (HealthCheckId == null ? '' : encodeURIComponent(HealthCheckId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteHostedZone(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2013-04-01/hostedzone/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetHostedZone(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/hostedzone/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteQueryLoggingConfig(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2013-04-01/queryloggingconfig/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetQueryLoggingConfig(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/queryloggingconfig/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteReusableDelegationSet(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2013-04-01/delegationset/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetReusableDelegationSet(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/delegationset/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteTrafficPolicy(Id: string, Version: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2013-04-01/trafficpolicy/' + (Id == null ? '' : encodeURIComponent(Id)) + '/' + Version, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetTrafficPolicy(Id: string, Version: number, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/trafficpolicy/' + (Id == null ? '' : encodeURIComponent(Id)) + '/' + Version, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DeleteTrafficPolicyInstance(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.delete('/2013-04-01/trafficpolicyinstance/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetTrafficPolicyInstance(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/trafficpolicyinstance/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAccountLimit(Type: AccountLimitType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/accountlimit/' + Type, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetChange(Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/change/' + (Id == null ? '' : encodeURIComponent(Id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetCheckerIpRanges(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/checkeripranges', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetGeoLocation(continentcode: string, countrycode: string, subdivisioncode: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/geolocation?continentcode=' + (continentcode == null ? '' : encodeURIComponent(continentcode)) + '&countrycode=' + (countrycode == null ? '' : encodeURIComponent(countrycode)) + '&subdivisioncode=' + (subdivisioncode == null ? '' : encodeURIComponent(subdivisioncode)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetHealthCheckCount(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/healthcheckcount', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetHealthCheckLastFailureReason(HealthCheckId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/healthcheck/' + (HealthCheckId == null ? '' : encodeURIComponent(HealthCheckId)) + '/lastfailurereason', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetHealthCheckStatus(HealthCheckId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/healthcheck/' + (HealthCheckId == null ? '' : encodeURIComponent(HealthCheckId)) + '/status', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetHostedZoneCount(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/hostedzonecount', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetHostedZoneLimit(Type: HostedZoneLimitType, Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/hostedzonelimit/' + (Id == null ? '' : encodeURIComponent(Id)) + '/' + Type, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetReusableDelegationSetLimit(Type: ReusableDelegationSetLimitType, Id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/reusabledelegationsetlimit/' + (Id == null ? '' : encodeURIComponent(Id)) + '/' + Type, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetTrafficPolicyInstanceCount(headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/trafficpolicyinstancecount', { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListGeoLocations(startcontinentcode: string, startcountrycode: string, startsubdivisioncode: string, maxitems: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/geolocations?startcontinentcode=' + (startcontinentcode == null ? '' : encodeURIComponent(startcontinentcode)) + '&startcountrycode=' + (startcountrycode == null ? '' : encodeURIComponent(startcountrycode)) + '&startsubdivisioncode=' + (startsubdivisioncode == null ? '' : encodeURIComponent(startsubdivisioncode)) + '&maxitems=' + (maxitems == null ? '' : encodeURIComponent(maxitems)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListHostedZonesByName(dnsname: string, hostedzoneid: string, maxitems: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/hostedzonesbyname?dnsname=' + (dnsname == null ? '' : encodeURIComponent(dnsname)) + '&hostedzoneid=' + (hostedzoneid == null ? '' : encodeURIComponent(hostedzoneid)) + '&maxitems=' + (maxitems == null ? '' : encodeURIComponent(maxitems)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListTrafficPolicies(trafficpolicyid: string, maxitems: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/trafficpolicies?trafficpolicyid=' + (trafficpolicyid == null ? '' : encodeURIComponent(trafficpolicyid)) + '&maxitems=' + (maxitems == null ? '' : encodeURIComponent(maxitems)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		ListTrafficPolicyVersions(Id: string, trafficpolicyversion: string, maxitems: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/2013-04-01/trafficpolicies/' + (Id == null ? '' : encodeURIComponent(Id)) + '/versions&trafficpolicyversion=' + (trafficpolicyversion == null ? '' : encodeURIComponent(trafficpolicyversion)) + '&maxitems=' + (maxitems == null ? '' : encodeURIComponent(maxitems)), { headers: headersHandler ? headersHandler() : undefined });
		}
