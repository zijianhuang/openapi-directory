...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateNode(requestBody: AssociateNodeRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateNodeResponse> {
			return Axios.post<AssociateNodeResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.AssociateNode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateBackup(requestBody: CreateBackupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateBackupResponse> {
			return Axios.post<CreateBackupResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.CreateBackup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateServer(requestBody: CreateServerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateServerResponse> {
			return Axios.post<CreateServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.CreateServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteBackup(requestBody: DeleteBackupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteBackupResponse> {
			return Axios.post<DeleteBackupResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DeleteBackup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteServer(requestBody: DeleteServerRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteServerResponse> {
			return Axios.post<DeleteServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DeleteServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeBackups(MaxResults: string, NextToken: string, requestBody: DescribeBackupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeBackupsResponse> {
			return Axios.post<DescribeBackupsResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeBackups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEvents(MaxResults: string, NextToken: string, requestBody: DescribeEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventsResponse> {
			return Axios.post<DescribeEventsResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeEvents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeServers(MaxResults: string, NextToken: string, requestBody: DescribeServersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeServersResponse> {
			return Axios.post<DescribeServersResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeServers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisassociateNode(requestBody: DisassociateNodeRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateNodeResponse> {
			return Axios.post<DisassociateNodeResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DisassociateNode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ExportServerEngineAttribute(requestBody: ExportServerEngineAttributeRequest, headersHandler?: () => {[header: string]: string}): Promise<ExportServerEngineAttributeResponse> {
			return Axios.post<ExportServerEngineAttributeResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.ExportServerEngineAttribute', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(MaxResults: string, NextToken: string, requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.ListTagsForResource?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RestoreServer(requestBody: RestoreServerRequest, headersHandler?: () => {[header: string]: string}): Promise<RestoreServerResponse> {
			return Axios.post<RestoreServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.RestoreServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartMaintenance(requestBody: StartMaintenanceRequest, headersHandler?: () => {[header: string]: string}): Promise<StartMaintenanceResponse> {
			return Axios.post<StartMaintenanceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.StartMaintenance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateServer(requestBody: UpdateServerRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServerResponse> {
			return Axios.post<UpdateServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.UpdateServer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateServerEngineAttributes(requestBody: UpdateServerEngineAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateServerEngineAttributesResponse> {
			return Axios.post<UpdateServerEngineAttributesResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.UpdateServerEngineAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
