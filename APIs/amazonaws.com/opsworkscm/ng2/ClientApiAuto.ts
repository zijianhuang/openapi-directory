...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateNode(requestBody: AssociateNodeRequest, headersHandler?: () => HttpHeaders): Observable<AssociateNodeResponse> {
			return this.http.post<AssociateNodeResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.AssociateNode', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateBackup(requestBody: CreateBackupRequest, headersHandler?: () => HttpHeaders): Observable<CreateBackupResponse> {
			return this.http.post<CreateBackupResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.CreateBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		CreateServer(requestBody: CreateServerRequest, headersHandler?: () => HttpHeaders): Observable<CreateServerResponse> {
			return this.http.post<CreateServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.CreateServer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteBackup(requestBody: DeleteBackupRequest, headersHandler?: () => HttpHeaders): Observable<DeleteBackupResponse> {
			return this.http.post<DeleteBackupResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DeleteBackup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteServer(requestBody: DeleteServerRequest, headersHandler?: () => HttpHeaders): Observable<DeleteServerResponse> {
			return this.http.post<DeleteServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DeleteServer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAccountAttributes(requestBody: DescribeAccountAttributesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAccountAttributesResponse> {
			return this.http.post<DescribeAccountAttributesResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeAccountAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeBackups(MaxResults: string, NextToken: string, requestBody: DescribeBackupsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeBackupsResponse> {
			return this.http.post<DescribeBackupsResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeBackups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DescribeEvents(MaxResults: string, NextToken: string, requestBody: DescribeEventsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeEventsResponse> {
			return this.http.post<DescribeEventsResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeEvents?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeNodeAssociationStatus(requestBody: DescribeNodeAssociationStatusRequest, headersHandler?: () => HttpHeaders): Observable<DescribeNodeAssociationStatusResponse> {
			return this.http.post<DescribeNodeAssociationStatusResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeNodeAssociationStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeServers(MaxResults: string, NextToken: string, requestBody: DescribeServersRequest, headersHandler?: () => HttpHeaders): Observable<DescribeServersResponse> {
			return this.http.post<DescribeServersResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DescribeServers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateNode(requestBody: DisassociateNodeRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateNodeResponse> {
			return this.http.post<DisassociateNodeResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.DisassociateNode', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ExportServerEngineAttribute(requestBody: ExportServerEngineAttributeRequest, headersHandler?: () => HttpHeaders): Observable<ExportServerEngineAttributeResponse> {
			return this.http.post<ExportServerEngineAttributeResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.ExportServerEngineAttribute', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(MaxResults: string, NextToken: string, requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.ListTagsForResource?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RestoreServer(requestBody: RestoreServerRequest, headersHandler?: () => HttpHeaders): Observable<RestoreServerResponse> {
			return this.http.post<RestoreServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.RestoreServer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartMaintenance(requestBody: StartMaintenanceRequest, headersHandler?: () => HttpHeaders): Observable<StartMaintenanceResponse> {
			return this.http.post<StartMaintenanceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.StartMaintenance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UpdateServer(requestBody: UpdateServerRequest, headersHandler?: () => HttpHeaders): Observable<UpdateServerResponse> {
			return this.http.post<UpdateServerResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.UpdateServer', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateServerEngineAttributes(requestBody: UpdateServerEngineAttributesRequest, headersHandler?: () => HttpHeaders): Observable<UpdateServerEngineAttributesResponse> {
			return this.http.post<UpdateServerEngineAttributesResponse>(this.baseUri + '/#X-Amz-Target=OpsWorksCM_V2016_11_01.UpdateServerEngineAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
