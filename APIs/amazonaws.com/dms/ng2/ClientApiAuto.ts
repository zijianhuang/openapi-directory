...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddTagsToResource(requestBody: AddTagsToResourceMessage, headersHandler?: () => HttpHeaders): Observable<AddTagsToResourceResponse> {
			return this.http.post<AddTagsToResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ApplyPendingMaintenanceAction(requestBody: ApplyPendingMaintenanceActionMessage, headersHandler?: () => HttpHeaders): Observable<ApplyPendingMaintenanceActionResponse> {
			return this.http.post<ApplyPendingMaintenanceActionResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ApplyPendingMaintenanceAction', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateEndpoint(requestBody: CreateEndpointMessage, headersHandler?: () => HttpHeaders): Observable<CreateEndpointResponse> {
			return this.http.post<CreateEndpointResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateEventSubscription(requestBody: CreateEventSubscriptionMessage, headersHandler?: () => HttpHeaders): Observable<CreateEventSubscriptionResponse> {
			return this.http.post<CreateEventSubscriptionResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateEventSubscription', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateReplicationInstance(requestBody: CreateReplicationInstanceMessage, headersHandler?: () => HttpHeaders): Observable<CreateReplicationInstanceResponse> {
			return this.http.post<CreateReplicationInstanceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateReplicationSubnetGroup(requestBody: CreateReplicationSubnetGroupMessage, headersHandler?: () => HttpHeaders): Observable<CreateReplicationSubnetGroupResponse> {
			return this.http.post<CreateReplicationSubnetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateReplicationTask(requestBody: CreateReplicationTaskMessage, headersHandler?: () => HttpHeaders): Observable<CreateReplicationTaskResponse> {
			return this.http.post<CreateReplicationTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteCertificate(requestBody: DeleteCertificateMessage, headersHandler?: () => HttpHeaders): Observable<DeleteCertificateResponse> {
			return this.http.post<DeleteCertificateResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteCertificate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteConnection(requestBody: DeleteConnectionMessage, headersHandler?: () => HttpHeaders): Observable<DeleteConnectionResponse> {
			return this.http.post<DeleteConnectionResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteEndpoint(requestBody: DeleteEndpointMessage, headersHandler?: () => HttpHeaders): Observable<DeleteEndpointResponse> {
			return this.http.post<DeleteEndpointResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteEventSubscription(requestBody: DeleteEventSubscriptionMessage, headersHandler?: () => HttpHeaders): Observable<DeleteEventSubscriptionResponse> {
			return this.http.post<DeleteEventSubscriptionResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteEventSubscription', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteReplicationInstance(requestBody: DeleteReplicationInstanceMessage, headersHandler?: () => HttpHeaders): Observable<DeleteReplicationInstanceResponse> {
			return this.http.post<DeleteReplicationInstanceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteReplicationSubnetGroup(requestBody: DeleteReplicationSubnetGroupMessage, headersHandler?: () => HttpHeaders): Observable<DeleteReplicationSubnetGroupResponse> {
			return this.http.post<DeleteReplicationSubnetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteReplicationTask(requestBody: DeleteReplicationTaskMessage, headersHandler?: () => HttpHeaders): Observable<DeleteReplicationTaskResponse> {
			return this.http.post<DeleteReplicationTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAccountAttributes(requestBody: DescribeAccountAttributesMessage, headersHandler?: () => HttpHeaders): Observable<DescribeAccountAttributesResponse> {
			return this.http.post<DescribeAccountAttributesResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeAccountAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCertificates(MaxRecords: string, Marker: string, requestBody: DescribeCertificatesMessage, headersHandler?: () => HttpHeaders): Observable<DescribeCertificatesResponse> {
			return this.http.post<DescribeCertificatesResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeCertificates?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeConnections(MaxRecords: string, Marker: string, requestBody: DescribeConnectionsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeConnectionsResponse> {
			return this.http.post<DescribeConnectionsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeConnections?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEndpointTypes(MaxRecords: string, Marker: string, requestBody: DescribeEndpointTypesMessage, headersHandler?: () => HttpHeaders): Observable<DescribeEndpointTypesResponse> {
			return this.http.post<DescribeEndpointTypesResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpointTypes?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEndpoints(MaxRecords: string, Marker: string, requestBody: DescribeEndpointsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeEndpointsResponse> {
			return this.http.post<DescribeEndpointsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpoints?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEventCategories(requestBody: DescribeEventCategoriesMessage, headersHandler?: () => HttpHeaders): Observable<DescribeEventCategoriesResponse> {
			return this.http.post<DescribeEventCategoriesResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEventCategories', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEventSubscriptions(MaxRecords: string, Marker: string, requestBody: DescribeEventSubscriptionsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeEventSubscriptionsResponse> {
			return this.http.post<DescribeEventSubscriptionsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEventSubscriptions?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEvents(MaxRecords: string, Marker: string, requestBody: DescribeEventsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeEventsResponse> {
			return this.http.post<DescribeEventsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEvents?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeOrderableReplicationInstances(MaxRecords: string, Marker: string, requestBody: DescribeOrderableReplicationInstancesMessage, headersHandler?: () => HttpHeaders): Observable<DescribeOrderableReplicationInstancesResponse> {
			return this.http.post<DescribeOrderableReplicationInstancesResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeOrderableReplicationInstances?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribePendingMaintenanceActions(MaxRecords: string, Marker: string, requestBody: DescribePendingMaintenanceActionsMessage, headersHandler?: () => HttpHeaders): Observable<DescribePendingMaintenanceActionsResponse> {
			return this.http.post<DescribePendingMaintenanceActionsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribePendingMaintenanceActions?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRefreshSchemasStatus(requestBody: DescribeRefreshSchemasStatusMessage, headersHandler?: () => HttpHeaders): Observable<DescribeRefreshSchemasStatusResponse> {
			return this.http.post<DescribeRefreshSchemasStatusResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeRefreshSchemasStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeReplicationInstanceTaskLogs(MaxRecords: string, Marker: string, requestBody: DescribeReplicationInstanceTaskLogsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeReplicationInstanceTaskLogsResponse> {
			return this.http.post<DescribeReplicationInstanceTaskLogsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationInstanceTaskLogs?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeReplicationInstances(MaxRecords: string, Marker: string, requestBody: DescribeReplicationInstancesMessage, headersHandler?: () => HttpHeaders): Observable<DescribeReplicationInstancesResponse> {
			return this.http.post<DescribeReplicationInstancesResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationInstances?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeReplicationSubnetGroups(MaxRecords: string, Marker: string, requestBody: DescribeReplicationSubnetGroupsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeReplicationSubnetGroupsResponse> {
			return this.http.post<DescribeReplicationSubnetGroupsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationSubnetGroups?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeReplicationTaskAssessmentResults(MaxRecords: string, Marker: string, requestBody: DescribeReplicationTaskAssessmentResultsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeReplicationTaskAssessmentResultsResponse> {
		 ...
		 */
		DescribeReplicationTasks(MaxRecords: string, Marker: string, requestBody: DescribeReplicationTasksMessage, headersHandler?: () => HttpHeaders): Observable<DescribeReplicationTasksResponse> {
			return this.http.post<DescribeReplicationTasksResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationTasks?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSchemas(MaxRecords: string, Marker: string, requestBody: DescribeSchemasMessage, headersHandler?: () => HttpHeaders): Observable<DescribeSchemasResponse> {
			return this.http.post<DescribeSchemasResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeSchemas?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTableStatistics(MaxRecords: string, Marker: string, requestBody: DescribeTableStatisticsMessage, headersHandler?: () => HttpHeaders): Observable<DescribeTableStatisticsResponse> {
		 ...
		 */
		ImportCertificate(requestBody: ImportCertificateMessage, headersHandler?: () => HttpHeaders): Observable<ImportCertificateResponse> {
			return this.http.post<ImportCertificateResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ImportCertificate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForResource(requestBody: ListTagsForResourceMessage, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ModifyEndpoint(requestBody: ModifyEndpointMessage, headersHandler?: () => HttpHeaders): Observable<ModifyEndpointResponse> {
			return this.http.post<ModifyEndpointResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ModifyEventSubscription(requestBody: ModifyEventSubscriptionMessage, headersHandler?: () => HttpHeaders): Observable<ModifyEventSubscriptionResponse> {
			return this.http.post<ModifyEventSubscriptionResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyEventSubscription', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ModifyReplicationInstance(requestBody: ModifyReplicationInstanceMessage, headersHandler?: () => HttpHeaders): Observable<ModifyReplicationInstanceResponse> {
			return this.http.post<ModifyReplicationInstanceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ModifyReplicationSubnetGroup(requestBody: ModifyReplicationSubnetGroupMessage, headersHandler?: () => HttpHeaders): Observable<ModifyReplicationSubnetGroupResponse> {
			return this.http.post<ModifyReplicationSubnetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ModifyReplicationTask(requestBody: ModifyReplicationTaskMessage, headersHandler?: () => HttpHeaders): Observable<ModifyReplicationTaskResponse> {
			return this.http.post<ModifyReplicationTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RebootReplicationInstance(requestBody: RebootReplicationInstanceMessage, headersHandler?: () => HttpHeaders): Observable<RebootReplicationInstanceResponse> {
			return this.http.post<RebootReplicationInstanceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.RebootReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RefreshSchemas(requestBody: RefreshSchemasMessage, headersHandler?: () => HttpHeaders): Observable<RefreshSchemasResponse> {
			return this.http.post<RefreshSchemasResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.RefreshSchemas', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ReloadTables(requestBody: ReloadTablesMessage, headersHandler?: () => HttpHeaders): Observable<ReloadTablesResponse> {
			return this.http.post<ReloadTablesResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ReloadTables', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceMessage, headersHandler?: () => HttpHeaders): Observable<RemoveTagsFromResourceResponse> {
			return this.http.post<RemoveTagsFromResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartReplicationTask(requestBody: StartReplicationTaskMessage, headersHandler?: () => HttpHeaders): Observable<StartReplicationTaskResponse> {
			return this.http.post<StartReplicationTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartReplicationTaskAssessment(requestBody: StartReplicationTaskAssessmentMessage, headersHandler?: () => HttpHeaders): Observable<StartReplicationTaskAssessmentResponse> {
			return this.http.post<StartReplicationTaskAssessmentResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTaskAssessment', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopReplicationTask(requestBody: StopReplicationTaskMessage, headersHandler?: () => HttpHeaders): Observable<StopReplicationTaskResponse> {
			return this.http.post<StopReplicationTaskResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.StopReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TestConnection(requestBody: TestConnectionMessage, headersHandler?: () => HttpHeaders): Observable<TestConnectionResponse> {
			return this.http.post<TestConnectionResponse>(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.TestConnection', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
