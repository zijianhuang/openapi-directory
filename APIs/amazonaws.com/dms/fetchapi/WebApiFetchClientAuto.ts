export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTagsToResource(requestBody: AddTagsToResourceMessage, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.AddTagsToResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ApplyPendingMaintenanceAction(requestBody: ApplyPendingMaintenanceActionMessage, headersHandler?: () => {[header: string]: string}): Promise<ApplyPendingMaintenanceActionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ApplyPendingMaintenanceAction', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEndpoint(requestBody: CreateEndpointMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateEventSubscription(requestBody: CreateEventSubscriptionMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateEventSubscriptionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateEventSubscription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateReplicationInstance(requestBody: CreateReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateReplicationInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateReplicationSubnetGroup(requestBody: CreateReplicationSubnetGroupMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateReplicationSubnetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationSubnetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateReplicationTask(requestBody: CreateReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateReplicationTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteCertificate(requestBody: DeleteCertificateMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteCertificateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteConnection(requestBody: DeleteConnectionMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteConnectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEndpoint(requestBody: DeleteEndpointMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEventSubscription(requestBody: DeleteEventSubscriptionMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteEventSubscriptionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteEventSubscription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteReplicationInstance(requestBody: DeleteReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteReplicationInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteReplicationSubnetGroup(requestBody: DeleteReplicationSubnetGroupMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteReplicationSubnetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationSubnetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteReplicationTask(requestBody: DeleteReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteReplicationTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeAccountAttributes(requestBody: DescribeAccountAttributesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountAttributesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeAccountAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeConnections(MaxRecords: string, Marker: string, requestBody: DescribeConnectionsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeConnectionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeConnections?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEndpointTypes(MaxRecords: string, Marker: string, requestBody: DescribeEndpointTypesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointTypesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpointTypes?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEndpoints(MaxRecords: string, Marker: string, requestBody: DescribeEndpointsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpoints?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventCategories(requestBody: DescribeEventCategoriesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventCategoriesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEventCategories', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEventSubscriptions(MaxRecords: string, Marker: string, requestBody: DescribeEventSubscriptionsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventSubscriptionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEventSubscriptions?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeEvents(MaxRecords: string, Marker: string, requestBody: DescribeEventsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeEvents?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeOrderableReplicationInstances(MaxRecords: string, Marker: string, requestBody: DescribeOrderableReplicationInstancesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrderableReplicationInstancesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeOrderableReplicationInstances?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribePendingMaintenanceActions(MaxRecords: string, Marker: string, requestBody: DescribePendingMaintenanceActionsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribePendingMaintenanceActionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribePendingMaintenanceActions?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRefreshSchemasStatus(requestBody: DescribeRefreshSchemasStatusMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeRefreshSchemasStatusResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeRefreshSchemasStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeReplicationInstanceTaskLogs(MaxRecords: string, Marker: string, requestBody: DescribeReplicationInstanceTaskLogsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationInstanceTaskLogsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationInstanceTaskLogs?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeReplicationInstances(MaxRecords: string, Marker: string, requestBody: DescribeReplicationInstancesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationInstancesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationInstances?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeReplicationSubnetGroups(MaxRecords: string, Marker: string, requestBody: DescribeReplicationSubnetGroupsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationSubnetGroupsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationSubnetGroups?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeReplicationTasks(MaxRecords: string, Marker: string, requestBody: DescribeReplicationTasksMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationTasksResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationTasks?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSchemas(MaxRecords: string, Marker: string, requestBody: DescribeSchemasMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeSchemasResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.DescribeSchemas?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ImportCertificate(requestBody: ImportCertificateMessage, headersHandler?: () => {[header: string]: string}): Promise<ImportCertificateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ImportCertificate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceMessage, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ModifyEndpoint(requestBody: ModifyEndpointMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyEndpointResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyEndpoint', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ModifyEventSubscription(requestBody: ModifyEventSubscriptionMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyEventSubscriptionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyEventSubscription', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ModifyReplicationInstance(requestBody: ModifyReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyReplicationInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ModifyReplicationSubnetGroup(requestBody: ModifyReplicationSubnetGroupMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyReplicationSubnetGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationSubnetGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ModifyReplicationTask(requestBody: ModifyReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyReplicationTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RebootReplicationInstance(requestBody: RebootReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<RebootReplicationInstanceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.RebootReplicationInstance', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RefreshSchemas(requestBody: RefreshSchemasMessage, headersHandler?: () => {[header: string]: string}): Promise<RefreshSchemasResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.RefreshSchemas', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ReloadTables(requestBody: ReloadTablesMessage, headersHandler?: () => {[header: string]: string}): Promise<ReloadTablesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.ReloadTables', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceMessage, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.RemoveTagsFromResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartReplicationTask(requestBody: StartReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<StartReplicationTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartReplicationTaskAssessment(requestBody: StartReplicationTaskAssessmentMessage, headersHandler?: () => {[header: string]: string}): Promise<StartReplicationTaskAssessmentResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTaskAssessment', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopReplicationTask(requestBody: StopReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<StopReplicationTaskResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.StopReplicationTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TestConnection(requestBody: TestConnectionMessage, headersHandler?: () => {[header: string]: string}): Promise<TestConnectionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AmazonDMSv20160101.TestConnection', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
