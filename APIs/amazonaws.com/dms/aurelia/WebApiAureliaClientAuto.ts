...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddTagsToResource(requestBody: AddTagsToResourceMessage, headersHandler?: () => {[header: string]: string}): Promise<AddTagsToResourceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.AddTagsToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ApplyPendingMaintenanceAction(requestBody: ApplyPendingMaintenanceActionMessage, headersHandler?: () => {[header: string]: string}): Promise<ApplyPendingMaintenanceActionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ApplyPendingMaintenanceAction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateEndpoint(requestBody: CreateEndpointMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.CreateEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateEventSubscription(requestBody: CreateEventSubscriptionMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateEventSubscriptionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.CreateEventSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateReplicationInstance(requestBody: CreateReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateReplicationInstanceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateReplicationSubnetGroup(requestBody: CreateReplicationSubnetGroupMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateReplicationSubnetGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateReplicationTask(requestBody: CreateReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<CreateReplicationTaskResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.CreateReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteCertificate(requestBody: DeleteCertificateMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteCertificateResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DeleteCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteConnection(requestBody: DeleteConnectionMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteConnectionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DeleteConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteEndpoint(requestBody: DeleteEndpointMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteEndpointResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DeleteEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteEventSubscription(requestBody: DeleteEventSubscriptionMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteEventSubscriptionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DeleteEventSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteReplicationInstance(requestBody: DeleteReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteReplicationInstanceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteReplicationSubnetGroup(requestBody: DeleteReplicationSubnetGroupMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteReplicationSubnetGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteReplicationTask(requestBody: DeleteReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<DeleteReplicationTaskResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DeleteReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeAccountAttributes(requestBody: DescribeAccountAttributesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeAccountAttributesResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeAccountAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeCertificates(MaxRecords: string, Marker: string, requestBody: DescribeCertificatesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeCertificatesResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeCertificates?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeConnections(MaxRecords: string, Marker: string, requestBody: DescribeConnectionsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeConnectionsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeConnections?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeEndpointTypes(MaxRecords: string, Marker: string, requestBody: DescribeEndpointTypesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointTypesResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpointTypes?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeEndpoints(MaxRecords: string, Marker: string, requestBody: DescribeEndpointsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeEndpoints?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeEventCategories(requestBody: DescribeEventCategoriesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventCategoriesResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeEventCategories', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeEventSubscriptions(MaxRecords: string, Marker: string, requestBody: DescribeEventSubscriptionsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventSubscriptionsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeEventSubscriptions?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeEvents(MaxRecords: string, Marker: string, requestBody: DescribeEventsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeEvents?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeOrderableReplicationInstances(MaxRecords: string, Marker: string, requestBody: DescribeOrderableReplicationInstancesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrderableReplicationInstancesResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeOrderableReplicationInstances?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribePendingMaintenanceActions(MaxRecords: string, Marker: string, requestBody: DescribePendingMaintenanceActionsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribePendingMaintenanceActionsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribePendingMaintenanceActions?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeRefreshSchemasStatus(requestBody: DescribeRefreshSchemasStatusMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeRefreshSchemasStatusResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeRefreshSchemasStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeReplicationInstanceTaskLogs(MaxRecords: string, Marker: string, requestBody: DescribeReplicationInstanceTaskLogsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationInstanceTaskLogsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationInstanceTaskLogs?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeReplicationInstances(MaxRecords: string, Marker: string, requestBody: DescribeReplicationInstancesMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationInstancesResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationInstances?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeReplicationSubnetGroups(MaxRecords: string, Marker: string, requestBody: DescribeReplicationSubnetGroupsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationSubnetGroupsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationSubnetGroups?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeReplicationTaskAssessmentResults(MaxRecords: string, Marker: string, requestBody: DescribeReplicationTaskAssessmentResultsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationTaskAssessmentResultsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationTaskAssessmentResults?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeReplicationTasks(MaxRecords: string, Marker: string, requestBody: DescribeReplicationTasksMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeReplicationTasksResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeReplicationTasks?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeSchemas(MaxRecords: string, Marker: string, requestBody: DescribeSchemasMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeSchemasResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeSchemas?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeTableStatistics(MaxRecords: string, Marker: string, requestBody: DescribeTableStatisticsMessage, headersHandler?: () => {[header: string]: string}): Promise<DescribeTableStatisticsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.DescribeTableStatistics?MaxRecords=' + (MaxRecords == null ? '' : encodeURIComponent(MaxRecords)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ImportCertificate(requestBody: ImportCertificateMessage, headersHandler?: () => {[header: string]: string}): Promise<ImportCertificateResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ImportCertificate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListTagsForResource(requestBody: ListTagsForResourceMessage, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ModifyEndpoint(requestBody: ModifyEndpointMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyEndpointResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ModifyEndpoint', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ModifyEventSubscription(requestBody: ModifyEventSubscriptionMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyEventSubscriptionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ModifyEventSubscription', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ModifyReplicationInstance(requestBody: ModifyReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyReplicationInstanceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ModifyReplicationSubnetGroup(requestBody: ModifyReplicationSubnetGroupMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyReplicationSubnetGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ModifyReplicationTask(requestBody: ModifyReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<ModifyReplicationTaskResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ModifyReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RebootReplicationInstance(requestBody: RebootReplicationInstanceMessage, headersHandler?: () => {[header: string]: string}): Promise<RebootReplicationInstanceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.RebootReplicationInstance', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RefreshSchemas(requestBody: RefreshSchemasMessage, headersHandler?: () => {[header: string]: string}): Promise<RefreshSchemasResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.RefreshSchemas', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ReloadTables(requestBody: ReloadTablesMessage, headersHandler?: () => {[header: string]: string}): Promise<ReloadTablesResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.ReloadTables', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RemoveTagsFromResource(requestBody: RemoveTagsFromResourceMessage, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsFromResourceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.RemoveTagsFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		StartReplicationTask(requestBody: StartReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<StartReplicationTaskResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		StartReplicationTaskAssessment(requestBody: StartReplicationTaskAssessmentMessage, headersHandler?: () => {[header: string]: string}): Promise<StartReplicationTaskAssessmentResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.StartReplicationTaskAssessment', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		StopReplicationTask(requestBody: StopReplicationTaskMessage, headersHandler?: () => {[header: string]: string}): Promise<StopReplicationTaskResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.StopReplicationTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		TestConnection(requestBody: TestConnectionMessage, headersHandler?: () => {[header: string]: string}): Promise<TestConnectionResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDMSv20160101.TestConnection', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
