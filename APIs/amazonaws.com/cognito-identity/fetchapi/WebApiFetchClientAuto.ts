export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateIdentityPool(requestBody: CreateIdentityPoolInput, headersHandler?: () => {[header: string]: string}): Promise<IdentityPool> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.CreateIdentityPool', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteIdentities(requestBody: DeleteIdentitiesInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteIdentitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DeleteIdentities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteIdentityPool(requestBody: DeleteIdentityPoolInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DeleteIdentityPool', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeIdentity(requestBody: DescribeIdentityInput, headersHandler?: () => {[header: string]: string}): Promise<IdentityDescription> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeIdentityPool(requestBody: DescribeIdentityPoolInput, headersHandler?: () => {[header: string]: string}): Promise<IdentityPool> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentityPool', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetCredentialsForIdentity(requestBody: GetCredentialsForIdentityInput, headersHandler?: () => {[header: string]: string}): Promise<GetCredentialsForIdentityResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetCredentialsForIdentity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetId(requestBody: GetIdInput, headersHandler?: () => {[header: string]: string}): Promise<GetIdResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetId', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetIdentityPoolRoles(requestBody: GetIdentityPoolRolesInput, headersHandler?: () => {[header: string]: string}): Promise<GetIdentityPoolRolesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetIdentityPoolRoles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetOpenIdToken(requestBody: GetOpenIdTokenInput, headersHandler?: () => {[header: string]: string}): Promise<GetOpenIdTokenResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetOpenIdToken', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetOpenIdTokenForDeveloperIdentity(requestBody: GetOpenIdTokenForDeveloperIdentityInput, headersHandler?: () => {[header: string]: string}): Promise<GetOpenIdTokenForDeveloperIdentityResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetOpenIdTokenForDeveloperIdentity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListIdentities(requestBody: ListIdentitiesInput, headersHandler?: () => {[header: string]: string}): Promise<ListIdentitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.ListIdentities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListIdentityPools(requestBody: ListIdentityPoolsInput, headersHandler?: () => {[header: string]: string}): Promise<ListIdentityPoolsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.ListIdentityPools', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		LookupDeveloperIdentity(requestBody: LookupDeveloperIdentityInput, headersHandler?: () => {[header: string]: string}): Promise<LookupDeveloperIdentityResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.LookupDeveloperIdentity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		MergeDeveloperIdentities(requestBody: MergeDeveloperIdentitiesInput, headersHandler?: () => {[header: string]: string}): Promise<MergeDeveloperIdentitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.MergeDeveloperIdentities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SetIdentityPoolRoles(requestBody: SetIdentityPoolRolesInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.SetIdentityPoolRoles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UnlinkDeveloperIdentity(requestBody: UnlinkDeveloperIdentityInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UnlinkDeveloperIdentity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UnlinkIdentity(requestBody: UnlinkIdentityInput, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UnlinkIdentity', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateIdentityPool(requestBody: IdentityPool, headersHandler?: () => {[header: string]: string}): Promise<IdentityPool> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UpdateIdentityPool', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
