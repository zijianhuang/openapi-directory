...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateIdentityPool(requestBody: CreateIdentityPoolInput, headersHandler?: () => HttpHeaders): Observable<IdentityPool> {
			return this.http.post<IdentityPool>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.CreateIdentityPool', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteIdentities(requestBody: DeleteIdentitiesInput, headersHandler?: () => HttpHeaders): Observable<DeleteIdentitiesResponse> {
			return this.http.post<DeleteIdentitiesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DeleteIdentities', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteIdentityPool(requestBody: DeleteIdentityPoolInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DeleteIdentityPool', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeIdentity(requestBody: DescribeIdentityInput, headersHandler?: () => HttpHeaders): Observable<IdentityDescription> {
			return this.http.post<IdentityDescription>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {IdentityPool} Success
		 */
		DescribeIdentityPool(requestBody: DescribeIdentityPoolInput, headersHandler?: () => HttpHeaders): Observable<IdentityPool> {
			return this.http.post<IdentityPool>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.DescribeIdentityPool', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetCredentialsForIdentity(requestBody: GetCredentialsForIdentityInput, headersHandler?: () => HttpHeaders): Observable<GetCredentialsForIdentityResponse> {
			return this.http.post<GetCredentialsForIdentityResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetCredentialsForIdentity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetId(requestBody: GetIdInput, headersHandler?: () => HttpHeaders): Observable<GetIdResponse> {
			return this.http.post<GetIdResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetId', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetIdentityPoolRoles(requestBody: GetIdentityPoolRolesInput, headersHandler?: () => HttpHeaders): Observable<GetIdentityPoolRolesResponse> {
			return this.http.post<GetIdentityPoolRolesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetIdentityPoolRoles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetOpenIdToken(requestBody: GetOpenIdTokenInput, headersHandler?: () => HttpHeaders): Observable<GetOpenIdTokenResponse> {
			return this.http.post<GetOpenIdTokenResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetOpenIdToken', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetOpenIdTokenForDeveloperIdentity(requestBody: GetOpenIdTokenForDeveloperIdentityInput, headersHandler?: () => HttpHeaders): Observable<GetOpenIdTokenForDeveloperIdentityResponse> {
			return this.http.post<GetOpenIdTokenForDeveloperIdentityResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.GetOpenIdTokenForDeveloperIdentity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListIdentities(requestBody: ListIdentitiesInput, headersHandler?: () => HttpHeaders): Observable<ListIdentitiesResponse> {
			return this.http.post<ListIdentitiesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.ListIdentities', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListIdentityPools(requestBody: ListIdentityPoolsInput, headersHandler?: () => HttpHeaders): Observable<ListIdentityPoolsResponse> {
			return this.http.post<ListIdentityPoolsResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.ListIdentityPools', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		LookupDeveloperIdentity(requestBody: LookupDeveloperIdentityInput, headersHandler?: () => HttpHeaders): Observable<LookupDeveloperIdentityResponse> {
			return this.http.post<LookupDeveloperIdentityResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.LookupDeveloperIdentity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		MergeDeveloperIdentities(requestBody: MergeDeveloperIdentitiesInput, headersHandler?: () => HttpHeaders): Observable<MergeDeveloperIdentitiesResponse> {
			return this.http.post<MergeDeveloperIdentitiesResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.MergeDeveloperIdentities', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		SetIdentityPoolRoles(requestBody: SetIdentityPoolRolesInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		TagResource(requestBody: TagResourceInput, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		UnlinkDeveloperIdentity(requestBody: UnlinkDeveloperIdentityInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UnlinkDeveloperIdentity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UnlinkIdentity(requestBody: UnlinkIdentityInput, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UnlinkIdentity', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {IdentityPool} Success
		 */
		UpdateIdentityPool(requestBody: IdentityPool, headersHandler?: () => HttpHeaders): Observable<IdentityPool> {
			return this.http.post<IdentityPool>(this.baseUri + '/#X-Amz-Target=AWSCognitoIdentityService.UpdateIdentityPool', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
