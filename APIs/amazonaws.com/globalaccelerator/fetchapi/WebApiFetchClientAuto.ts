export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AdvertiseByoipCidr(requestBody: AdvertiseByoipCidrRequest, headersHandler?: () => {[header: string]: string}): Promise<AdvertiseByoipCidrResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.AdvertiseByoipCidr', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateAccelerator(requestBody: CreateAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAcceleratorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateAccelerator', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateEndpointGroup(requestBody: CreateEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateEndpointGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		CreateListener(requestBody: CreateListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateListenerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAccelerator(requestBody: DeleteAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpointGroup(requestBody: DeleteEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteListener(requestBody: DeleteListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteListener', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		 ...
		 */
		DeprovisionByoipCidr(requestBody: DeprovisionByoipCidrRequest, headersHandler?: () => {[header: string]: string}): Promise<DeprovisionByoipCidrResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeprovisionByoipCidr', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeAccelerator(requestBody: DescribeAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAcceleratorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeAcceleratorAttributes(requestBody: DescribeAcceleratorAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAcceleratorAttributesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAcceleratorAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeEndpointGroup(requestBody: DescribeEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		DescribeListener(requestBody: DescribeListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeListenerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListAccelerators(requestBody: ListAcceleratorsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAcceleratorsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListByoipCidrs(requestBody: ListByoipCidrsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListByoipCidrsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListByoipCidrs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListEndpointGroups(requestBody: ListEndpointGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEndpointGroupsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ListListeners(requestBody: ListListenersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListListenersResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		ProvisionByoipCidr(requestBody: ProvisionByoipCidrRequest, headersHandler?: () => {[header: string]: string}): Promise<ProvisionByoipCidrResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ProvisionByoipCidr', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateAccelerator(requestBody: UpdateAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAcceleratorResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateAcceleratorAttributes(requestBody: UpdateAcceleratorAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAcceleratorAttributesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAcceleratorAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateEndpointGroup(requestBody: UpdateEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		UpdateListener(requestBody: UpdateListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateListenerResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		 ...
		 */
		WithdrawByoipCidr(requestBody: WithdrawByoipCidrRequest, headersHandler?: () => {[header: string]: string}): Promise<WithdrawByoipCidrResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.WithdrawByoipCidr', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
