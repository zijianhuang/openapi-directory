...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AdvertiseByoipCidr(requestBody: AdvertiseByoipCidrRequest, headersHandler?: () => {[header: string]: string}): Promise<AdvertiseByoipCidrResponse> {
			return Axios.post<AdvertiseByoipCidrResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.AdvertiseByoipCidr', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAccelerator(requestBody: CreateAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAcceleratorResponse> {
			return Axios.post<CreateAcceleratorResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateEndpointGroup(requestBody: CreateEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateEndpointGroupResponse> {
			return Axios.post<CreateEndpointGroupResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateListener(requestBody: CreateListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateListenerResponse> {
			return Axios.post<CreateListenerResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAccelerator(requestBody: DeleteAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpointGroup(requestBody: DeleteEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteListener(requestBody: DeleteListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteListener', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DescribeAccelerator(requestBody: DescribeAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAcceleratorResponse> {
			return Axios.post<DescribeAcceleratorResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAcceleratorAttributes(requestBody: DescribeAcceleratorAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAcceleratorAttributesResponse> {
			return Axios.post<DescribeAcceleratorAttributesResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAcceleratorAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEndpointGroup(requestBody: DescribeEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEndpointGroupResponse> {
			return Axios.post<DescribeEndpointGroupResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeListener(requestBody: DescribeListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeListenerResponse> {
			return Axios.post<DescribeListenerResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAccelerators(requestBody: ListAcceleratorsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAcceleratorsResponse> {
			return Axios.post<ListAcceleratorsResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListByoipCidrs(requestBody: ListByoipCidrsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListByoipCidrsResponse> {
			return Axios.post<ListByoipCidrsResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListByoipCidrs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEndpointGroups(requestBody: ListEndpointGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEndpointGroupsResponse> {
			return Axios.post<ListEndpointGroupsResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListListeners(requestBody: ListListenersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListListenersResponse> {
			return Axios.post<ListListenersResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ProvisionByoipCidr(requestBody: ProvisionByoipCidrRequest, headersHandler?: () => {[header: string]: string}): Promise<ProvisionByoipCidrResponse> {
			return Axios.post<ProvisionByoipCidrResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ProvisionByoipCidr', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAccelerator(requestBody: UpdateAcceleratorRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAcceleratorResponse> {
			return Axios.post<UpdateAcceleratorResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateAcceleratorAttributes(requestBody: UpdateAcceleratorAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateAcceleratorAttributesResponse> {
			return Axios.post<UpdateAcceleratorAttributesResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAcceleratorAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateEndpointGroup(requestBody: UpdateEndpointGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateEndpointGroupResponse> {
			return Axios.post<UpdateEndpointGroupResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateListener(requestBody: UpdateListenerRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateListenerResponse> {
			return Axios.post<UpdateListenerResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		WithdrawByoipCidr(requestBody: WithdrawByoipCidrRequest, headersHandler?: () => {[header: string]: string}): Promise<WithdrawByoipCidrResponse> {
			return Axios.post<WithdrawByoipCidrResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.WithdrawByoipCidr', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
