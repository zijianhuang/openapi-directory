...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AdvertiseByoipCidr(requestBody: AdvertiseByoipCidrRequest, headersHandler?: () => HttpHeaders): Observable<AdvertiseByoipCidrResponse> {
			return this.http.post<AdvertiseByoipCidrResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.AdvertiseByoipCidr', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAccelerator(requestBody: CreateAcceleratorRequest, headersHandler?: () => HttpHeaders): Observable<CreateAcceleratorResponse> {
			return this.http.post<CreateAcceleratorResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateEndpointGroup(requestBody: CreateEndpointGroupRequest, headersHandler?: () => HttpHeaders): Observable<CreateEndpointGroupResponse> {
			return this.http.post<CreateEndpointGroupResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateListener(requestBody: CreateListenerRequest, headersHandler?: () => HttpHeaders): Observable<CreateListenerResponse> {
			return this.http.post<CreateListenerResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.CreateListener', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAccelerator(requestBody: DeleteAcceleratorRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteEndpointGroup(requestBody: DeleteEndpointGroupRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeleteEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteListener(requestBody: DeleteListenerRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		DeprovisionByoipCidr(requestBody: DeprovisionByoipCidrRequest, headersHandler?: () => HttpHeaders): Observable<DeprovisionByoipCidrResponse> {
			return this.http.post<DeprovisionByoipCidrResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DeprovisionByoipCidr', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAccelerator(requestBody: DescribeAcceleratorRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAcceleratorResponse> {
			return this.http.post<DescribeAcceleratorResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAcceleratorAttributes(requestBody: DescribeAcceleratorAttributesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAcceleratorAttributesResponse> {
			return this.http.post<DescribeAcceleratorAttributesResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeAcceleratorAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeEndpointGroup(requestBody: DescribeEndpointGroupRequest, headersHandler?: () => HttpHeaders): Observable<DescribeEndpointGroupResponse> {
			return this.http.post<DescribeEndpointGroupResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeListener(requestBody: DescribeListenerRequest, headersHandler?: () => HttpHeaders): Observable<DescribeListenerResponse> {
			return this.http.post<DescribeListenerResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.DescribeListener', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAccelerators(requestBody: ListAcceleratorsRequest, headersHandler?: () => HttpHeaders): Observable<ListAcceleratorsResponse> {
			return this.http.post<ListAcceleratorsResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListAccelerators', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListByoipCidrs(requestBody: ListByoipCidrsRequest, headersHandler?: () => HttpHeaders): Observable<ListByoipCidrsResponse> {
			return this.http.post<ListByoipCidrsResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListByoipCidrs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListEndpointGroups(requestBody: ListEndpointGroupsRequest, headersHandler?: () => HttpHeaders): Observable<ListEndpointGroupsResponse> {
			return this.http.post<ListEndpointGroupsResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListEndpointGroups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListListeners(requestBody: ListListenersRequest, headersHandler?: () => HttpHeaders): Observable<ListListenersResponse> {
			return this.http.post<ListListenersResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListListeners', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ProvisionByoipCidr(requestBody: ProvisionByoipCidrRequest, headersHandler?: () => HttpHeaders): Observable<ProvisionByoipCidrResponse> {
			return this.http.post<ProvisionByoipCidrResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.ProvisionByoipCidr', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => HttpHeaders): Observable<TagResourceResponse> {
			return this.http.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => HttpHeaders): Observable<UntagResourceResponse> {
			return this.http.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateAccelerator(requestBody: UpdateAcceleratorRequest, headersHandler?: () => HttpHeaders): Observable<UpdateAcceleratorResponse> {
			return this.http.post<UpdateAcceleratorResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAccelerator', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateAcceleratorAttributes(requestBody: UpdateAcceleratorAttributesRequest, headersHandler?: () => HttpHeaders): Observable<UpdateAcceleratorAttributesResponse> {
			return this.http.post<UpdateAcceleratorAttributesResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateAcceleratorAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateEndpointGroup(requestBody: UpdateEndpointGroupRequest, headersHandler?: () => HttpHeaders): Observable<UpdateEndpointGroupResponse> {
			return this.http.post<UpdateEndpointGroupResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateEndpointGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateListener(requestBody: UpdateListenerRequest, headersHandler?: () => HttpHeaders): Observable<UpdateListenerResponse> {
			return this.http.post<UpdateListenerResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.UpdateListener', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		WithdrawByoipCidr(requestBody: WithdrawByoipCidrRequest, headersHandler?: () => HttpHeaders): Observable<WithdrawByoipCidrResponse> {
			return this.http.post<WithdrawByoipCidrResponse>(this.baseUri + '/#X-Amz-Target=GlobalAccelerator_V20180706.WithdrawByoipCidr', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
