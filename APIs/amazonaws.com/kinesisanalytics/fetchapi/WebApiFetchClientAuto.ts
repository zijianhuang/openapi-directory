export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddApplicationCloudWatchLoggingOption(requestBody: AddApplicationCloudWatchLoggingOptionRequest, headersHandler?: () => {[header: string]: string}): Promise<AddApplicationCloudWatchLoggingOptionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.AddApplicationCloudWatchLoggingOption', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AddApplicationInput(requestBody: AddApplicationInputRequest, headersHandler?: () => {[header: string]: string}): Promise<AddApplicationInputResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.AddApplicationInput', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AddApplicationOutput(requestBody: AddApplicationOutputRequest, headersHandler?: () => {[header: string]: string}): Promise<AddApplicationOutputResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.AddApplicationOutput', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AddApplicationReferenceDataSource(requestBody: AddApplicationReferenceDataSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AddApplicationReferenceDataSourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.AddApplicationReferenceDataSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateApplication(requestBody: CreateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateApplicationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.CreateApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApplication(requestBody: DeleteApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApplicationCloudWatchLoggingOption(requestBody: DeleteApplicationCloudWatchLoggingOptionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationCloudWatchLoggingOptionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplicationCloudWatchLoggingOption', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApplicationOutput(requestBody: DeleteApplicationOutputRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationOutputResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplicationOutput', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteApplicationReferenceDataSource(requestBody: DeleteApplicationReferenceDataSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationReferenceDataSourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplicationReferenceDataSource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeApplication(requestBody: DescribeApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeApplicationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DescribeApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DiscoverInputSchema(requestBody: DiscoverInputSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<DiscoverInputSchemaResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DiscoverInputSchema', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListApplications(requestBody: ListApplicationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListApplicationsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.ListApplications', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartApplication(requestBody: StartApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<StartApplicationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.StartApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopApplication(requestBody: StopApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<StopApplicationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.StopApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.TagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.UntagResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateApplication(requestBody: UpdateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateApplicationResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.UpdateApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
