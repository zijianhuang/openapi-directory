...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddApplicationInput(requestBody: AddApplicationInputRequest, headersHandler?: () => {[header: string]: string}): Promise<AddApplicationInputResponse> {
			return Axios.post<AddApplicationInputResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.AddApplicationInput', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddApplicationInputProcessingConfiguration(requestBody: AddApplicationInputProcessingConfigurationRequest, headersHandler?: () => {[header: string]: string}): Promise<AddApplicationInputProcessingConfigurationResponse> {
			return Axios.post<AddApplicationInputProcessingConfigurationResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.AddApplicationInputProcessingConfiguration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		AddApplicationOutput(requestBody: AddApplicationOutputRequest, headersHandler?: () => {[header: string]: string}): Promise<AddApplicationOutputResponse> {
			return Axios.post<AddApplicationOutputResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.AddApplicationOutput', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateApplication(requestBody: CreateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateApplicationResponse> {
			return Axios.post<CreateApplicationResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.CreateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApplication(requestBody: DeleteApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationResponse> {
			return Axios.post<DeleteApplicationResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApplicationCloudWatchLoggingOption(requestBody: DeleteApplicationCloudWatchLoggingOptionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationCloudWatchLoggingOptionResponse> {
			return Axios.post<DeleteApplicationCloudWatchLoggingOptionResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplicationCloudWatchLoggingOption', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApplicationOutput(requestBody: DeleteApplicationOutputRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationOutputResponse> {
			return Axios.post<DeleteApplicationOutputResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplicationOutput', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteApplicationReferenceDataSource(requestBody: DeleteApplicationReferenceDataSourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteApplicationReferenceDataSourceResponse> {
			return Axios.post<DeleteApplicationReferenceDataSourceResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DeleteApplicationReferenceDataSource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeApplication(requestBody: DescribeApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeApplicationResponse> {
			return Axios.post<DescribeApplicationResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DescribeApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DiscoverInputSchema(requestBody: DiscoverInputSchemaRequest, headersHandler?: () => {[header: string]: string}): Promise<DiscoverInputSchemaResponse> {
			return Axios.post<DiscoverInputSchemaResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.DiscoverInputSchema', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListApplications(requestBody: ListApplicationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListApplicationsResponse> {
			return Axios.post<ListApplicationsResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.ListApplications', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartApplication(requestBody: StartApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<StartApplicationResponse> {
			return Axios.post<StartApplicationResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.StartApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopApplication(requestBody: StopApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<StopApplicationResponse> {
			return Axios.post<StopApplicationResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.StopApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateApplication(requestBody: UpdateApplicationRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateApplicationResponse> {
			return Axios.post<UpdateApplicationResponse>(this.baseUri + '/#X-Amz-Target=KinesisAnalytics_20150814.UpdateApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
