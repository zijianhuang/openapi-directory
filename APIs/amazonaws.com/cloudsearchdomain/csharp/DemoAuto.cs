...
namespace My.Demo.Client
{
	...
	public class SuggestResponse
	{
		...
		/// </summary>
		[System.Runtime.Serialization.DataMember()]
		public SuggestStatus Status { get; set; }
	...
	public class UploadDocumentsResponse
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> Adds { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> Deletes { get; set; }
		
		[System.Runtime.Serialization.DataMember()]
		public DocumentServiceWarning[] Warnings { get; set; }
	}
	...
	public class FieldStats
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> Missing { get; set; }
	...
	public class SearchStatus
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public System.Nullable<System.Int32> Timems { get; set; }
	...
	public class SuggestModel
	{
		...
		[System.Runtime.Serialization.DataMember()]
		public SuggestionMatch[] Suggestions { get; set; }
	}
	...
	public partial class DemoClient
	{
		...
		{
			var requestUri = "/2013-01-01/search#format=sdk&pretty=true&q?cursor=" + (cursor==null? "" : Uri.EscapeDataString(cursor))+"&expr=" + (expr==null? "" : Uri.EscapeDataString(expr))+"&facet=" + (facet==null? "" : Uri.EscapeDataString(facet))+"&fq=" + (fq==null? "" : Uri.EscapeDataString(fq))+"&highlight=" + (highlight==null? "" : Uri.EscapeDataString(highlight))+"&partial="+partial+"&q=" + (q==null? "" : Uri.EscapeDataString(q))+"&q.options=" + (q.options==null? "" : Uri.EscapeDataString(q.options))+"&q.parser=" + q.parser+"&return=" + (return==null? "" : Uri.EscapeDataString(return))+"&size="+size+"&sort=" + (sort==null? "" : Uri.EscapeDataString(sort))+"&start="+start+"&stats=" + (stats==null? "" : Uri.EscapeDataString(stats))+"&format=" + (format==null? "" : Uri.EscapeDataString(format))+"&pretty=" + (pretty==null? "" : Uri.EscapeDataString(pretty));
		...
		/// Suggest /2013-01-01/suggest#format=sdk&pretty=true&q&suggester
		/// </summary>
		/// <param name="q">Specifies the string for which you want to get suggestions.</param>
		/// <param name="suggester">Specifies the name of the suggester to use to find suggested matches.</param>
		/// <param name="size">Specifies the maximum number of suggestions to return. </param>
		/// <returns>Success</returns>
		public async Task<SuggestResponse> SuggestAsync(string q, string suggester, int size, string format, string pretty, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/2013-01-01/suggest#format=sdk&pretty=true&q&suggester?q=" + (q==null? "" : Uri.EscapeDataString(q))+"&suggester=" + (suggester==null? "" : Uri.EscapeDataString(suggester))+"&size="+size+"&format=" + (format==null? "" : Uri.EscapeDataString(format))+"&pretty=" + (pretty==null? "" : Uri.EscapeDataString(pretty));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
			...
			try
			{
				...
				{
				var serializer = new JsonSerializer();
				return serializer.Deserialize<SuggestResponse>(jsonReader);
				}
			}
			finally
			{
		...
		/// UploadDocuments /2013-01-01/documents/batch#format=sdk&Content-Type
		/// </summary>
		/// <returns>Success</returns>
		public async Task<UploadDocumentsResponse> UploadDocumentsAsync(string format, UploadDocumentsBody requestBody, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "/2013-01-01/documents/batch#format=sdk&Content-Type?format=" + (format==null? "" : Uri.EscapeDataString(format));
			...
			try
			{
				...
				{
				var serializer = new JsonSerializer();
				return serializer.Deserialize<UploadDocumentsResponse>(jsonReader);
				}
			}
			finally
			{
