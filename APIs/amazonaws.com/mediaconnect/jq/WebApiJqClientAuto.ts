...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AddFlowOutputs(flowArn: string, callback: (data : void) => any, requestBody: AddFlowOutputsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		AddFlowSources(flowArn: string, callback: (data : void) => any, requestBody: AddFlowSourcesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		AddFlowVpcInterfaces(flowArn: string, callback: (data : void) => any, requestBody: AddFlowVpcInterfacesBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/vpcInterfaces', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateFlow(callback: (data : void) => any, requestBody: CreateFlowBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/flows', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFlows(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListFlowsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/flows?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFlow(flowArn: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeFlow(flowArn: string, callback: (data : DescribeFlowResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlow(flowArn: string, callback: (data : void) => any, requestBody: UpdateFlowBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GrantFlowEntitlements(flowArn: string, callback: (data : GrantFlowEntitlementsResponse) => any, requestBody: GrantFlowEntitlementsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/entitlements', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEntitlements(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, callback: (data : ListEntitlementsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v1/entitlements?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		RemoveFlowOutput(flowArn: string, outputArn: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs/' + (outputArn == null ? '' : encodeURIComponent(outputArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlowOutput(flowArn: string, outputArn: string, callback: (data : void) => any, requestBody: UpdateFlowOutputBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs/' + (outputArn == null ? '' : encodeURIComponent(outputArn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		RemoveFlowSource(flowArn: string, sourceArn: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source/' + (sourceArn == null ? '' : encodeURIComponent(sourceArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlowSource(flowArn: string, sourceArn: string, callback: (data : void) => any, requestBody: UpdateFlowSourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source/' + (sourceArn == null ? '' : encodeURIComponent(sourceArn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		RemoveFlowVpcInterface(flowArn: string, vpcInterfaceName: string, callback: (data : RemoveFlowVpcInterfaceResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/vpcInterfaces/' + (vpcInterfaceName == null ? '' : encodeURIComponent(vpcInterfaceName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		RevokeFlowEntitlement(entitlementArn: string, flowArn: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/entitlements/' + (entitlementArn == null ? '' : encodeURIComponent(entitlementArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlowEntitlement(entitlementArn: string, flowArn: string, callback: (data : void) => any, requestBody: UpdateFlowEntitlementBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/entitlements/' + (entitlementArn == null ? '' : encodeURIComponent(entitlementArn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		StartFlow(flowArn: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/flows/start/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		StopFlow(flowArn: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/v1/flows/stop/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
