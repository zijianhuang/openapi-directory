...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		AddFlowOutputs(flowArn: string, requestBody: AddFlowOutputsBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		AddFlowSources(flowArn: string, requestBody: AddFlowSourcesBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		AddFlowVpcInterfaces(flowArn: string, requestBody: AddFlowVpcInterfacesBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/vpcInterfaces', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateFlow(requestBody: CreateFlowBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v1/flows', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		ListFlows(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListFlowsResponse> {
			return Axios.get<ListFlowsResponse>(this.baseUri + '/v1/flows?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		DescribeFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeFlowResponse> {
			return Axios.get<DescribeFlowResponse>(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlow(flowArn: string, requestBody: UpdateFlowBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RemoveFlowOutput(flowArn: string, outputArn: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs/' + (outputArn == null ? '' : encodeURIComponent(outputArn)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlowOutput(flowArn: string, outputArn: string, requestBody: UpdateFlowOutputBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs/' + (outputArn == null ? '' : encodeURIComponent(outputArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		RemoveFlowSource(flowArn: string, sourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source/' + (sourceArn == null ? '' : encodeURIComponent(sourceArn)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlowSource(flowArn: string, sourceArn: string, requestBody: UpdateFlowSourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source/' + (sourceArn == null ? '' : encodeURIComponent(sourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		RemoveFlowVpcInterface(flowArn: string, vpcInterfaceName: string, headersHandler?: () => {[header: string]: string}): Promise<RemoveFlowVpcInterfaceResponse> {
			return Axios.delete<RemoveFlowVpcInterfaceResponse>(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/vpcInterfaces/' + (vpcInterfaceName == null ? '' : encodeURIComponent(vpcInterfaceName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		RevokeFlowEntitlement(entitlementArn: string, flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/entitlements/' + (entitlementArn == null ? '' : encodeURIComponent(entitlementArn)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UpdateFlowEntitlement(entitlementArn: string, flowArn: string, requestBody: UpdateFlowEntitlementBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		StartFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v1/flows/start/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		StopFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v1/flows/stop/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), null, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
