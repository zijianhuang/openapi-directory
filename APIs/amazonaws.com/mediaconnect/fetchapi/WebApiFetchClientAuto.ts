export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddFlowOutputs(flowArn: string, requestBody: AddFlowOutputsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		AddFlowSources(flowArn: string, requestBody: AddFlowSourcesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		AddFlowVpcInterfaces(flowArn: string, requestBody: AddFlowVpcInterfacesBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/vpcInterfaces', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		CreateFlow(requestBody: CreateFlowBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ListFlows(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListFlowsResponse> {
			return fetch(this.baseUri + '/v1/flows?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		DescribeFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeFlowResponse> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateFlow(flowArn: string, requestBody: UpdateFlowBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GrantFlowEntitlements(flowArn: string, requestBody: GrantFlowEntitlementsBody, headersHandler?: () => {[header: string]: string}): Promise<GrantFlowEntitlementsResponse> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/entitlements', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEntitlements(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListEntitlementsResponse> {
			return fetch(this.baseUri + '/v1/entitlements?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RemoveFlowOutput(flowArn: string, outputArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/outputs/' + (outputArn == null ? '' : encodeURIComponent(outputArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		RemoveFlowSource(flowArn: string, sourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source/' + (sourceArn == null ? '' : encodeURIComponent(sourceArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateFlowSource(flowArn: string, sourceArn: string, requestBody: UpdateFlowSourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/source/' + (sourceArn == null ? '' : encodeURIComponent(sourceArn)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RemoveFlowVpcInterface(flowArn: string, vpcInterfaceName: string, headersHandler?: () => {[header: string]: string}): Promise<RemoveFlowVpcInterfaceResponse> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/vpcInterfaces/' + (vpcInterfaceName == null ? '' : encodeURIComponent(vpcInterfaceName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RevokeFlowEntitlement(entitlementArn: string, flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/entitlements/' + (entitlementArn == null ? '' : encodeURIComponent(entitlementArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateFlowEntitlement(entitlementArn: string, flowArn: string, requestBody: UpdateFlowEntitlementBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/' + (flowArn == null ? '' : encodeURIComponent(flowArn)) + '/entitlements/' + (entitlementArn == null ? '' : encodeURIComponent(entitlementArn)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		StartFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/start/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		StopFlow(flowArn: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/flows/stop/' + (flowArn == null ? '' : encodeURIComponent(flowArn)), { method: 'post', headers: headersHandler ? headersHandler() : undefined });
		}
