...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCluster(requestBody: CreateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.CreateCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateParameterGroup(requestBody: CreateParameterGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateParameterGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.CreateParameterGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateSubnetGroup(requestBody: CreateSubnetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSubnetGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.CreateSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DecreaseReplicationFactor(requestBody: DecreaseReplicationFactorRequest, headersHandler?: () => {[header: string]: string}): Promise<DecreaseReplicationFactorResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DecreaseReplicationFactor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteCluster(requestBody: DeleteClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteClusterResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DeleteCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteParameterGroup(requestBody: DeleteParameterGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteParameterGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DeleteParameterGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteSubnetGroup(requestBody: DeleteSubnetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSubnetGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DeleteSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeClusters(requestBody: DescribeClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeClustersResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DescribeClusters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeDefaultParameters(requestBody: DescribeDefaultParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDefaultParametersResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DescribeDefaultParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeEvents(requestBody: DescribeEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DescribeEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeParameterGroups(requestBody: DescribeParameterGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeParameterGroupsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DescribeParameterGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeParameters(requestBody: DescribeParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeParametersResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DescribeParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeSubnetGroups(requestBody: DescribeSubnetGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSubnetGroupsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.DescribeSubnetGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		IncreaseReplicationFactor(requestBody: IncreaseReplicationFactorRequest, headersHandler?: () => {[header: string]: string}): Promise<IncreaseReplicationFactorResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.IncreaseReplicationFactor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTags(requestBody: ListTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.ListTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RebootNode(requestBody: RebootNodeRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootNodeResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.RebootNode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateCluster(requestBody: UpdateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.UpdateCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateParameterGroup(requestBody: UpdateParameterGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateParameterGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.UpdateParameterGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateSubnetGroup(requestBody: UpdateSubnetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSubnetGroupResponse> {
			return this.http.post('/#X-Amz-Target=AmazonDAXV3.UpdateSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
