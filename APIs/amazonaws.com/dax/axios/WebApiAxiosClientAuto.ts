...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCluster(requestBody: CreateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResponse> {
			return Axios.post<CreateClusterResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.CreateCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateParameterGroup(requestBody: CreateParameterGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateParameterGroupResponse> {
			return Axios.post<CreateParameterGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.CreateParameterGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSubnetGroup(requestBody: CreateSubnetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateSubnetGroupResponse> {
			return Axios.post<CreateSubnetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.CreateSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DecreaseReplicationFactor(requestBody: DecreaseReplicationFactorRequest, headersHandler?: () => {[header: string]: string}): Promise<DecreaseReplicationFactorResponse> {
			return Axios.post<DecreaseReplicationFactorResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DecreaseReplicationFactor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteCluster(requestBody: DeleteClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteClusterResponse> {
			return Axios.post<DeleteClusterResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DeleteCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteParameterGroup(requestBody: DeleteParameterGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteParameterGroupResponse> {
			return Axios.post<DeleteParameterGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DeleteParameterGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSubnetGroup(requestBody: DeleteSubnetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteSubnetGroupResponse> {
			return Axios.post<DeleteSubnetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DeleteSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeClusters(requestBody: DescribeClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeClustersResponse> {
			return Axios.post<DescribeClustersResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DescribeClusters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDefaultParameters(requestBody: DescribeDefaultParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDefaultParametersResponse> {
			return Axios.post<DescribeDefaultParametersResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DescribeDefaultParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeEvents(requestBody: DescribeEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEventsResponse> {
			return Axios.post<DescribeEventsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DescribeEvents', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeParameterGroups(requestBody: DescribeParameterGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeParameterGroupsResponse> {
			return Axios.post<DescribeParameterGroupsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DescribeParameterGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeParameters(requestBody: DescribeParametersRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeParametersResponse> {
			return Axios.post<DescribeParametersResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DescribeParameters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSubnetGroups(requestBody: DescribeSubnetGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeSubnetGroupsResponse> {
			return Axios.post<DescribeSubnetGroupsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.DescribeSubnetGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		IncreaseReplicationFactor(requestBody: IncreaseReplicationFactorRequest, headersHandler?: () => {[header: string]: string}): Promise<IncreaseReplicationFactorResponse> {
			return Axios.post<IncreaseReplicationFactorResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.IncreaseReplicationFactor', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTags(requestBody: ListTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return Axios.post<ListTagsResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.ListTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RebootNode(requestBody: RebootNodeRequest, headersHandler?: () => {[header: string]: string}): Promise<RebootNodeResponse> {
			return Axios.post<RebootNodeResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.RebootNode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.post<UntagResourceResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateCluster(requestBody: UpdateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterResponse> {
			return Axios.post<UpdateClusterResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.UpdateCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateParameterGroup(requestBody: UpdateParameterGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateParameterGroupResponse> {
			return Axios.post<UpdateParameterGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.UpdateParameterGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateSubnetGroup(requestBody: UpdateSubnetGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateSubnetGroupResponse> {
			return Axios.post<UpdateSubnetGroupResponse>(this.baseUri + '/#X-Amz-Target=AmazonDAXV3.UpdateSubnetGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
