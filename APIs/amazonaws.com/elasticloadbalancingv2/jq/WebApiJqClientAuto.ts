...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AddListenerCertificates(ListenerArn: string, Certificates: Array<Certificate>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_AddTags(ResourceArns: Array<ResourceArn>, Tags: Array<Tag>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AddTags?' + ResourceArns.map(z => `ResourceArns=${z}`).join('&') + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateListener(LoadBalancerArn: string, Protocol: ProtocolEnum, Port: number, SslPolicy: string, Certificates: Array<Certificate>, DefaultActions: Array<Action>, AlpnPolicy: Array<AlpnPolicyValue>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateListener?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&Protocol=' + Protocol + '&Port=' + Port + '&SslPolicy=' + (SslPolicy == null ? '' : encodeURIComponent(SslPolicy)) + '&' + Certificates.map(z => `Certificates=${z}`).join('&') + '&' + DefaultActions.map(z => `DefaultActions=${z}`).join('&') + '&' + AlpnPolicy.map(z => `AlpnPolicy=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateRule(ListenerArn: string, Conditions: Array<RuleCondition>, Priority: number, Actions: Array<Action>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateRule?ListenerArn=' + (ListenerArn == null ? '' : encodeURIComponent(ListenerArn)) + '&' + Conditions.map(z => `Conditions=${z}`).join('&') + '&Priority=' + Priority + '&' + Actions.map(z => `Actions=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteListener(ListenerArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteListener?ListenerArn=' + (ListenerArn == null ? '' : encodeURIComponent(ListenerArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteLoadBalancer(LoadBalancerArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteLoadBalancer?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteRule(RuleArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteRule?RuleArn=' + (RuleArn == null ? '' : encodeURIComponent(RuleArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteTargetGroup(TargetGroupArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteTargetGroup?TargetGroupArn=' + (TargetGroupArn == null ? '' : encodeURIComponent(TargetGroupArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeregisterTargets(TargetGroupArn: string, Targets: Array<TargetDescription>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeregisterTargets?TargetGroupArn=' + (TargetGroupArn == null ? '' : encodeURIComponent(TargetGroupArn)) + '&' + Targets.map(z => `Targets=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeAccountLimits(Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeAccountLimits?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeListenerCertificates(ListenerArn: string, Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeListenerCertificates?ListenerArn=' + (ListenerArn == null ? '' : encodeURIComponent(ListenerArn)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeListeners(LoadBalancerArn: string, ListenerArns: Array<ListenerArn>, Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeListeners?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&' + ListenerArns.map(z => `ListenerArns=${z}`).join('&') + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeLoadBalancerAttributes(LoadBalancerArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeLoadBalancerAttributes?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeLoadBalancers(LoadBalancerArns: Array<LoadBalancerArn>, Names: Array<LoadBalancerName>, Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeLoadBalancers?' + LoadBalancerArns.map(z => `LoadBalancerArns=${z}`).join('&') + '&' + Names.map(z => `Names=${z}`).join('&') + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeRules(ListenerArn: string, RuleArns: Array<RuleArn>, Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeRules?ListenerArn=' + (ListenerArn == null ? '' : encodeURIComponent(ListenerArn)) + '&' + RuleArns.map(z => `RuleArns=${z}`).join('&') + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeSSLPolicies(Names: Array<SslPolicyName>, Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeSSLPolicies?' + Names.map(z => `Names=${z}`).join('&') + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeTags(ResourceArns: Array<ResourceArn>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeTags?' + ResourceArns.map(z => `ResourceArns=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeTargetGroupAttributes(TargetGroupArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeTargetGroupAttributes?TargetGroupArn=' + (TargetGroupArn == null ? '' : encodeURIComponent(TargetGroupArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeTargetGroups(LoadBalancerArn: string, TargetGroupArns: Array<TargetGroupArn>, Names: Array<TargetGroupName>, Marker: string, PageSize: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeTargetGroups?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&' + TargetGroupArns.map(z => `TargetGroupArns=${z}`).join('&') + '&' + Names.map(z => `Names=${z}`).join('&') + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&PageSize=' + PageSize + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeTargetHealth(TargetGroupArn: string, Targets: Array<TargetDescription>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeTargetHealth?TargetGroupArn=' + (TargetGroupArn == null ? '' : encodeURIComponent(TargetGroupArn)) + '&' + Targets.map(z => `Targets=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ModifyListener(ListenerArn: string, Port: number, Protocol: ProtocolEnum, SslPolicy: string, Certificates: Array<Certificate>, DefaultActions: Array<Action>, AlpnPolicy: Array<AlpnPolicyValue>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_ModifyLoadBalancerAttributes(LoadBalancerArn: string, Attributes: Array<LoadBalancerAttribute>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ModifyLoadBalancerAttributes?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&' + Attributes.map(z => `Attributes=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ModifyRule(RuleArn: string, Conditions: Array<RuleCondition>, Actions: Array<Action>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ModifyRule?RuleArn=' + (RuleArn == null ? '' : encodeURIComponent(RuleArn)) + '&' + Conditions.map(z => `Conditions=${z}`).join('&') + '&' + Actions.map(z => `Actions=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ModifyTargetGroupAttributes(TargetGroupArn: string, Attributes: Array<TargetGroupAttribute>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ModifyTargetGroupAttributes?TargetGroupArn=' + (TargetGroupArn == null ? '' : encodeURIComponent(TargetGroupArn)) + '&' + Attributes.map(z => `Attributes=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RegisterTargets(TargetGroupArn: string, Targets: Array<TargetDescription>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RegisterTargets?TargetGroupArn=' + (TargetGroupArn == null ? '' : encodeURIComponent(TargetGroupArn)) + '&' + Targets.map(z => `Targets=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemoveListenerCertificates(ListenerArn: string, Certificates: Array<Certificate>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_RemoveTags(ResourceArns: Array<ResourceArn>, TagKeys: Array<TagKey>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RemoveTags?' + ResourceArns.map(z => `ResourceArns=${z}`).join('&') + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetIpAddressType(LoadBalancerArn: string, IpAddressType: SetIpAddressTypeOutputIpAddressType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetIpAddressType?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&IpAddressType=' + IpAddressType + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetRulePriorities(RulePriorities: Array<RulePriorityPair>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetRulePriorities?' + RulePriorities.map(z => `RulePriorities=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetSecurityGroups(LoadBalancerArn: string, SecurityGroups: Array<SecurityGroupId>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetSecurityGroups?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&' + SecurityGroups.map(z => `SecurityGroups=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetSubnets(LoadBalancerArn: string, Subnets: Array<SubnetId>, SubnetMappings: Array<SubnetMapping>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetSubnets?LoadBalancerArn=' + (LoadBalancerArn == null ? '' : encodeURIComponent(LoadBalancerArn)) + '&' + Subnets.map(z => `Subnets=${z}`).join('&') + '&' + SubnetMappings.map(z => `SubnetMappings=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
	}
