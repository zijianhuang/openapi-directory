...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateCreatedArtifact(requestBody: AssociateCreatedArtifactRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateCreatedArtifactResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.AssociateCreatedArtifact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateDiscoveredResource(requestBody: AssociateDiscoveredResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateDiscoveredResourceResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.AssociateDiscoveredResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateProgressUpdateStream(requestBody: CreateProgressUpdateStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProgressUpdateStreamResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.CreateProgressUpdateStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteProgressUpdateStream(requestBody: DeleteProgressUpdateStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProgressUpdateStreamResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.DeleteProgressUpdateStream', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeApplicationState(requestBody: DescribeApplicationStateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeApplicationStateResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.DescribeApplicationState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeMigrationTask(requestBody: DescribeMigrationTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMigrationTaskResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.DescribeMigrationTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateCreatedArtifact(requestBody: DisassociateCreatedArtifactRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateCreatedArtifactResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.DisassociateCreatedArtifact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateDiscoveredResource(requestBody: DisassociateDiscoveredResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateDiscoveredResourceResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.DisassociateDiscoveredResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ImportMigrationTask(requestBody: ImportMigrationTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportMigrationTaskResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.ImportMigrationTask', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		NotifyApplicationState(requestBody: NotifyApplicationStateRequest, headersHandler?: () => {[header: string]: string}): Promise<NotifyApplicationStateResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.NotifyApplicationState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		NotifyMigrationTaskState(requestBody: NotifyMigrationTaskStateRequest, headersHandler?: () => {[header: string]: string}): Promise<NotifyMigrationTaskStateResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.NotifyMigrationTaskState', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutResourceAttributes(requestBody: PutResourceAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourceAttributesResult> {
			return this.http.post('/#X-Amz-Target=AWSMigrationHub.PutResourceAttributes', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
