...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateCreatedArtifact(requestBody: AssociateCreatedArtifactRequest, headersHandler?: () => HttpHeaders): Observable<AssociateCreatedArtifactResult> {
			return this.http.post<AssociateCreatedArtifactResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.AssociateCreatedArtifact', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		AssociateDiscoveredResource(requestBody: AssociateDiscoveredResourceRequest, headersHandler?: () => HttpHeaders): Observable<AssociateDiscoveredResourceResult> {
			return this.http.post<AssociateDiscoveredResourceResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.AssociateDiscoveredResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateProgressUpdateStream(requestBody: CreateProgressUpdateStreamRequest, headersHandler?: () => HttpHeaders): Observable<CreateProgressUpdateStreamResult> {
			return this.http.post<CreateProgressUpdateStreamResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.CreateProgressUpdateStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteProgressUpdateStream(requestBody: DeleteProgressUpdateStreamRequest, headersHandler?: () => HttpHeaders): Observable<DeleteProgressUpdateStreamResult> {
			return this.http.post<DeleteProgressUpdateStreamResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DeleteProgressUpdateStream', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeApplicationState(requestBody: DescribeApplicationStateRequest, headersHandler?: () => HttpHeaders): Observable<DescribeApplicationStateResult> {
			return this.http.post<DescribeApplicationStateResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DescribeApplicationState', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeMigrationTask(requestBody: DescribeMigrationTaskRequest, headersHandler?: () => HttpHeaders): Observable<DescribeMigrationTaskResult> {
			return this.http.post<DescribeMigrationTaskResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DescribeMigrationTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateCreatedArtifact(requestBody: DisassociateCreatedArtifactRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateCreatedArtifactResult> {
			return this.http.post<DisassociateCreatedArtifactResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DisassociateCreatedArtifact', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisassociateDiscoveredResource(requestBody: DisassociateDiscoveredResourceRequest, headersHandler?: () => HttpHeaders): Observable<DisassociateDiscoveredResourceResult> {
			return this.http.post<DisassociateDiscoveredResourceResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DisassociateDiscoveredResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ImportMigrationTask(requestBody: ImportMigrationTaskRequest, headersHandler?: () => HttpHeaders): Observable<ImportMigrationTaskResult> {
			return this.http.post<ImportMigrationTaskResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ImportMigrationTask', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListApplicationStates(MaxResults: string, NextToken: string, requestBody: ListApplicationStatesRequest, headersHandler?: () => HttpHeaders): Observable<ListApplicationStatesResult> {
			return this.http.post<ListApplicationStatesResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListApplicationStates?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCreatedArtifacts(MaxResults: string, NextToken: string, requestBody: ListCreatedArtifactsRequest, headersHandler?: () => HttpHeaders): Observable<ListCreatedArtifactsResult> {
			return this.http.post<ListCreatedArtifactsResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListCreatedArtifacts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDiscoveredResources(MaxResults: string, NextToken: string, requestBody: ListDiscoveredResourcesRequest, headersHandler?: () => HttpHeaders): Observable<ListDiscoveredResourcesResult> {
			return this.http.post<ListDiscoveredResourcesResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListDiscoveredResources?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListMigrationTasks(MaxResults: string, NextToken: string, requestBody: ListMigrationTasksRequest, headersHandler?: () => HttpHeaders): Observable<ListMigrationTasksResult> {
			return this.http.post<ListMigrationTasksResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListMigrationTasks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListProgressUpdateStreams(MaxResults: string, NextToken: string, requestBody: ListProgressUpdateStreamsRequest, headersHandler?: () => HttpHeaders): Observable<ListProgressUpdateStreamsResult> {
			return this.http.post<ListProgressUpdateStreamsResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListProgressUpdateStreams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		NotifyApplicationState(requestBody: NotifyApplicationStateRequest, headersHandler?: () => HttpHeaders): Observable<NotifyApplicationStateResult> {
			return this.http.post<NotifyApplicationStateResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.NotifyApplicationState', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		NotifyMigrationTaskState(requestBody: NotifyMigrationTaskStateRequest, headersHandler?: () => HttpHeaders): Observable<NotifyMigrationTaskStateResult> {
			return this.http.post<NotifyMigrationTaskStateResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.NotifyMigrationTaskState', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutResourceAttributes(requestBody: PutResourceAttributesRequest, headersHandler?: () => HttpHeaders): Observable<PutResourceAttributesResult> {
			return this.http.post<PutResourceAttributesResult>(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.PutResourceAttributes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
