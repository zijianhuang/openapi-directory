export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateCreatedArtifact(requestBody: AssociateCreatedArtifactRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateCreatedArtifactResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.AssociateCreatedArtifact', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		AssociateDiscoveredResource(requestBody: AssociateDiscoveredResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateDiscoveredResourceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.AssociateDiscoveredResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateProgressUpdateStream(requestBody: CreateProgressUpdateStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateProgressUpdateStreamResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.CreateProgressUpdateStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteProgressUpdateStream(requestBody: DeleteProgressUpdateStreamRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteProgressUpdateStreamResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DeleteProgressUpdateStream', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeApplicationState(requestBody: DescribeApplicationStateRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeApplicationStateResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DescribeApplicationState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeMigrationTask(requestBody: DescribeMigrationTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeMigrationTaskResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DescribeMigrationTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisassociateCreatedArtifact(requestBody: DisassociateCreatedArtifactRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateCreatedArtifactResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DisassociateCreatedArtifact', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DisassociateDiscoveredResource(requestBody: DisassociateDiscoveredResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateDiscoveredResourceResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.DisassociateDiscoveredResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ImportMigrationTask(requestBody: ImportMigrationTaskRequest, headersHandler?: () => {[header: string]: string}): Promise<ImportMigrationTaskResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ImportMigrationTask', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCreatedArtifacts(MaxResults: string, NextToken: string, requestBody: ListCreatedArtifactsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCreatedArtifactsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListCreatedArtifacts?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListDiscoveredResources(MaxResults: string, NextToken: string, requestBody: ListDiscoveredResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDiscoveredResourcesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListDiscoveredResources?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListMigrationTasks(MaxResults: string, NextToken: string, requestBody: ListMigrationTasksRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMigrationTasksResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListMigrationTasks?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListProgressUpdateStreams(MaxResults: string, NextToken: string, requestBody: ListProgressUpdateStreamsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListProgressUpdateStreamsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.ListProgressUpdateStreams?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		NotifyApplicationState(requestBody: NotifyApplicationStateRequest, headersHandler?: () => {[header: string]: string}): Promise<NotifyApplicationStateResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.NotifyApplicationState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		NotifyMigrationTaskState(requestBody: NotifyMigrationTaskStateRequest, headersHandler?: () => {[header: string]: string}): Promise<NotifyMigrationTaskStateResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.NotifyMigrationTaskState', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutResourceAttributes(requestBody: PutResourceAttributesRequest, headersHandler?: () => {[header: string]: string}): Promise<PutResourceAttributesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSMigrationHub.PutResourceAttributes', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
