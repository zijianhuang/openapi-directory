...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GET_BatchDeleteClusterSnapshots(Identifiers: Array<DeleteClusterSnapshotMessage>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=BatchDeleteClusterSnapshots?' + Identifiers.map(z => `Identifiers=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_BatchModifyClusterSnapshots(SnapshotIdentifierList: Array<String>, ManualSnapshotRetentionPeriod: number, Force: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=BatchModifyClusterSnapshots?' + SnapshotIdentifierList.map(z => `SnapshotIdentifierList=${z}`).join('&') + '&ManualSnapshotRetentionPeriod=' + ManualSnapshotRetentionPeriod + '&Force=' + Force + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_CancelResize(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CancelResize?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_CreateScheduledAction(ScheduledActionName: string, TargetAction: string, Schedule: string, IamRole: string, ScheduledActionDescription: string, StartTime: Date, EndTime: Date, Enable: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreateScheduledAction?ScheduledActionName=' + (ScheduledActionName == null ? '' : encodeURIComponent(ScheduledActionName)) + '&TargetAction=' + (TargetAction == null ? '' : encodeURIComponent(TargetAction)) + '&Schedule=' + (Schedule == null ? '' : encodeURIComponent(Schedule)) + '&IamRole=' + (IamRole == null ? '' : encodeURIComponent(IamRole)) + '&ScheduledActionDescription=' + (ScheduledActionDescription == null ? '' : encodeURIComponent(ScheduledActionDescription)) + '&StartTime=' + StartTime.toISOString() + '&EndTime=' + EndTime.toISOString() + '&Enable=' + Enable + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_CreateSnapshotSchedule(ScheduleDefinitions: Array<String>, ScheduleIdentifier: string, ScheduleDescription: string, Tags: Array<Tag>, DryRun: boolean, NextInvocations: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreateSnapshotSchedule?' + ScheduleDefinitions.map(z => `ScheduleDefinitions=${z}`).join('&') + '&ScheduleIdentifier=' + (ScheduleIdentifier == null ? '' : encodeURIComponent(ScheduleIdentifier)) + '&ScheduleDescription=' + (ScheduleDescription == null ? '' : encodeURIComponent(ScheduleDescription)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&DryRun=' + DryRun + '&NextInvocations=' + NextInvocations + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_CreateTags(ResourceName: string, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreateTags?ResourceName=' + (ResourceName == null ? '' : encodeURIComponent(ResourceName)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_CreateUsageLimit(ClusterIdentifier: string, FeatureType: UsageLimitFeatureType, LimitType: UsageLimitLimitType, Amount: number, Period: UsageLimitPeriod, BreachAction: UsageLimitBreachAction, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=CreateUsageLimit?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&FeatureType=' + FeatureType + '&LimitType=' + LimitType + '&Amount=' + Amount + '&Period=' + Period + '&BreachAction=' + BreachAction + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteClusterParameterGroup(ParameterGroupName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteClusterParameterGroup?ParameterGroupName=' + (ParameterGroupName == null ? '' : encodeURIComponent(ParameterGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteClusterSecurityGroup(ClusterSecurityGroupName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteClusterSecurityGroup?ClusterSecurityGroupName=' + (ClusterSecurityGroupName == null ? '' : encodeURIComponent(ClusterSecurityGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteClusterSubnetGroup(ClusterSubnetGroupName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteClusterSubnetGroup?ClusterSubnetGroupName=' + (ClusterSubnetGroupName == null ? '' : encodeURIComponent(ClusterSubnetGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteHsmConfiguration(HsmConfigurationIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteHsmConfiguration?HsmConfigurationIdentifier=' + (HsmConfigurationIdentifier == null ? '' : encodeURIComponent(HsmConfigurationIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteScheduledAction(ScheduledActionName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteScheduledAction?ScheduledActionName=' + (ScheduledActionName == null ? '' : encodeURIComponent(ScheduledActionName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteSnapshotCopyGrant(SnapshotCopyGrantName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteSnapshotCopyGrant?SnapshotCopyGrantName=' + (SnapshotCopyGrantName == null ? '' : encodeURIComponent(SnapshotCopyGrantName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteSnapshotSchedule(ScheduleIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteSnapshotSchedule?ScheduleIdentifier=' + (ScheduleIdentifier == null ? '' : encodeURIComponent(ScheduleIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteTags(ResourceName: string, TagKeys: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteTags?ResourceName=' + (ResourceName == null ? '' : encodeURIComponent(ResourceName)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteUsageLimit(UsageLimitId: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteUsageLimit?UsageLimitId=' + (UsageLimitId == null ? '' : encodeURIComponent(UsageLimitId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAccountAttributes(AttributeNames: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeAccountAttributes?' + AttributeNames.map(z => `AttributeNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeClusterDbRevisions(ClusterIdentifier: string, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeClusterDbRevisions?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeClusterParameters(ParameterGroupName: string, Source: string, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeClusterParameters?ParameterGroupName=' + (ParameterGroupName == null ? '' : encodeURIComponent(ParameterGroupName)) + '&Source=' + (Source == null ? '' : encodeURIComponent(Source)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeClusterSecurityGroups(ClusterSecurityGroupName: string, MaxRecords: number, Marker: string, TagKeys: Array<String>, TagValues: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeClusterSecurityGroups?ClusterSecurityGroupName=' + (ClusterSecurityGroupName == null ? '' : encodeURIComponent(ClusterSecurityGroupName)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&' + TagValues.map(z => `TagValues=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeClusterTracks(MaintenanceTrackName: string, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeClusterTracks?MaintenanceTrackName=' + (MaintenanceTrackName == null ? '' : encodeURIComponent(MaintenanceTrackName)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeClusters(ClusterIdentifier: string, MaxRecords: number, Marker: string, TagKeys: Array<String>, TagValues: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeClusters?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&' + TagValues.map(z => `TagValues=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeEventCategories(SourceType: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeEventCategories?SourceType=' + (SourceType == null ? '' : encodeURIComponent(SourceType)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeHsmClientCertificates(HsmClientCertificateIdentifier: string, MaxRecords: number, Marker: string, TagKeys: Array<String>, TagValues: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeHsmClientCertificates?HsmClientCertificateIdentifier=' + (HsmClientCertificateIdentifier == null ? '' : encodeURIComponent(HsmClientCertificateIdentifier)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&' + TagValues.map(z => `TagValues=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeLoggingStatus(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeLoggingStatus?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeReservedNodeOfferings(ReservedNodeOfferingId: string, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeReservedNodeOfferings?ReservedNodeOfferingId=' + (ReservedNodeOfferingId == null ? '' : encodeURIComponent(ReservedNodeOfferingId)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeReservedNodes(ReservedNodeId: string, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeReservedNodes?ReservedNodeId=' + (ReservedNodeId == null ? '' : encodeURIComponent(ReservedNodeId)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeResize(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeResize?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeSnapshotSchedules(ClusterIdentifier: string, ScheduleIdentifier: string, TagKeys: Array<String>, TagValues: Array<String>, Marker: string, MaxRecords: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeSnapshotSchedules?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&ScheduleIdentifier=' + (ScheduleIdentifier == null ? '' : encodeURIComponent(ScheduleIdentifier)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&' + TagValues.map(z => `TagValues=${z}`).join('&') + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxRecords=' + MaxRecords + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeStorage(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeStorage?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		POST_DescribeStorage(Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/#Action=DescribeStorage?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), null, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeTableRestoreStatus(ClusterIdentifier: string, TableRestoreRequestId: string, MaxRecords: number, Marker: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeTableRestoreStatus?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&TableRestoreRequestId=' + (TableRestoreRequestId == null ? '' : encodeURIComponent(TableRestoreRequestId)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeTags(ResourceName: string, ResourceType: string, MaxRecords: number, Marker: string, TagKeys: Array<String>, TagValues: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeTags?ResourceName=' + (ResourceName == null ? '' : encodeURIComponent(ResourceName)) + '&ResourceType=' + (ResourceType == null ? '' : encodeURIComponent(ResourceType)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&' + TagValues.map(z => `TagValues=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeUsageLimits(UsageLimitId: string, ClusterIdentifier: string, FeatureType: UsageLimitFeatureType, MaxRecords: number, Marker: string, TagKeys: Array<String>, TagValues: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeUsageLimits?UsageLimitId=' + (UsageLimitId == null ? '' : encodeURIComponent(UsageLimitId)) + '&ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&FeatureType=' + FeatureType + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&' + TagValues.map(z => `TagValues=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DisableLogging(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DisableLogging?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DisableSnapshotCopy(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DisableSnapshotCopy?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_EnableSnapshotCopy(ClusterIdentifier: string, DestinationRegion: string, RetentionPeriod: number, SnapshotCopyGrantName: string, ManualSnapshotRetentionPeriod: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=EnableSnapshotCopy?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&DestinationRegion=' + (DestinationRegion == null ? '' : encodeURIComponent(DestinationRegion)) + '&RetentionPeriod=' + RetentionPeriod + '&SnapshotCopyGrantName=' + (SnapshotCopyGrantName == null ? '' : encodeURIComponent(SnapshotCopyGrantName)) + '&ManualSnapshotRetentionPeriod=' + ManualSnapshotRetentionPeriod + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ModifyClusterParameterGroup(ParameterGroupName: string, Parameters: Array<Parameter>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ModifyClusterParameterGroup?ParameterGroupName=' + (ParameterGroupName == null ? '' : encodeURIComponent(ParameterGroupName)) + '&' + Parameters.map(z => `Parameters=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ModifyClusterSnapshotSchedule(ClusterIdentifier: string, ScheduleIdentifier: string, DisassociateSchedule: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ModifyClusterSnapshotSchedule?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&ScheduleIdentifier=' + (ScheduleIdentifier == null ? '' : encodeURIComponent(ScheduleIdentifier)) + '&DisassociateSchedule=' + DisassociateSchedule + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ModifyScheduledAction(ScheduledActionName: string, TargetAction: string, Schedule: string, IamRole: string, ScheduledActionDescription: string, StartTime: Date, EndTime: Date, Enable: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ModifyScheduledAction?ScheduledActionName=' + (ScheduledActionName == null ? '' : encodeURIComponent(ScheduledActionName)) + '&TargetAction=' + (TargetAction == null ? '' : encodeURIComponent(TargetAction)) + '&Schedule=' + (Schedule == null ? '' : encodeURIComponent(Schedule)) + '&IamRole=' + (IamRole == null ? '' : encodeURIComponent(IamRole)) + '&ScheduledActionDescription=' + (ScheduledActionDescription == null ? '' : encodeURIComponent(ScheduledActionDescription)) + '&StartTime=' + StartTime.toISOString() + '&EndTime=' + EndTime.toISOString() + '&Enable=' + Enable + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ModifySnapshotCopyRetentionPeriod(ClusterIdentifier: string, RetentionPeriod: number, Manual: boolean, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ModifySnapshotCopyRetentionPeriod?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&RetentionPeriod=' + RetentionPeriod + '&Manual=' + Manual + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ModifySnapshotSchedule(ScheduleIdentifier: string, ScheduleDefinitions: Array<String>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ModifySnapshotSchedule?ScheduleIdentifier=' + (ScheduleIdentifier == null ? '' : encodeURIComponent(ScheduleIdentifier)) + '&' + ScheduleDefinitions.map(z => `ScheduleDefinitions=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ModifyUsageLimit(UsageLimitId: string, Amount: number, BreachAction: UsageLimitBreachAction, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ModifyUsageLimit?UsageLimitId=' + (UsageLimitId == null ? '' : encodeURIComponent(UsageLimitId)) + '&Amount=' + Amount + '&BreachAction=' + BreachAction + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_PauseCluster(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PauseCluster?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_PurchaseReservedNodeOffering(ReservedNodeOfferingId: string, NodeCount: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PurchaseReservedNodeOffering?ReservedNodeOfferingId=' + (ReservedNodeOfferingId == null ? '' : encodeURIComponent(ReservedNodeOfferingId)) + '&NodeCount=' + NodeCount + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_RebootCluster(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=RebootCluster?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ResumeCluster(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ResumeCluster?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_RevokeClusterSecurityGroupIngress(ClusterSecurityGroupName: string, CIDRIP: string, EC2SecurityGroupName: string, EC2SecurityGroupOwnerId: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=RevokeClusterSecurityGroupIngress?ClusterSecurityGroupName=' + (ClusterSecurityGroupName == null ? '' : encodeURIComponent(ClusterSecurityGroupName)) + '&CIDRIP=' + (CIDRIP == null ? '' : encodeURIComponent(CIDRIP)) + '&EC2SecurityGroupName=' + (EC2SecurityGroupName == null ? '' : encodeURIComponent(EC2SecurityGroupName)) + '&EC2SecurityGroupOwnerId=' + (EC2SecurityGroupOwnerId == null ? '' : encodeURIComponent(EC2SecurityGroupOwnerId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_RevokeSnapshotAccess(SnapshotIdentifier: string, SnapshotClusterIdentifier: string, AccountWithRestoreAccess: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=RevokeSnapshotAccess?SnapshotIdentifier=' + (SnapshotIdentifier == null ? '' : encodeURIComponent(SnapshotIdentifier)) + '&SnapshotClusterIdentifier=' + (SnapshotClusterIdentifier == null ? '' : encodeURIComponent(SnapshotClusterIdentifier)) + '&AccountWithRestoreAccess=' + (AccountWithRestoreAccess == null ? '' : encodeURIComponent(AccountWithRestoreAccess)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_RotateEncryptionKey(ClusterIdentifier: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=RotateEncryptionKey?ClusterIdentifier=' + (ClusterIdentifier == null ? '' : encodeURIComponent(ClusterIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
