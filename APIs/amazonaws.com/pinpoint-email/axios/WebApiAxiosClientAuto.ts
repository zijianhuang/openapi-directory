...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateConfigurationSet(requestBody: CreateConfigurationSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateConfigurationSetResponse> {
			return Axios.post<CreateConfigurationSetResponse>(this.baseUri + '/v1/email/configuration-sets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListConfigurationSets(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationSetsResponse> {
			return Axios.get<ListConfigurationSetsResponse>(this.baseUri + '/v1/email/configuration-sets?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetConfigurationSetEventDestinations(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<GetConfigurationSetEventDestinationsResponse> {
			return Axios.get<GetConfigurationSetEventDestinationsResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateDedicatedIpPool(requestBody: CreateDedicatedIpPoolBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDedicatedIpPoolResponse> {
			return Axios.post<CreateDedicatedIpPoolResponse>(this.baseUri + '/v1/email/dedicated-ip-pools', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDedicatedIpPools(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListDedicatedIpPoolsResponse> {
			return Axios.get<ListDedicatedIpPoolsResponse>(this.baseUri + '/v1/email/dedicated-ip-pools?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		CreateDeliverabilityTestReport(requestBody: CreateDeliverabilityTestReportBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDeliverabilityTestReportResponse> {
			return Axios.post<CreateDeliverabilityTestReportResponse>(this.baseUri + '/v1/email/deliverability-dashboard/test', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateEmailIdentity(requestBody: CreateEmailIdentityBody, headersHandler?: () => {[header: string]: string}): Promise<CreateEmailIdentityResponse> {
			return Axios.post<CreateEmailIdentityResponse>(this.baseUri + '/v1/email/identities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEmailIdentities(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListEmailIdentitiesResponse> {
			return Axios.get<ListEmailIdentitiesResponse>(this.baseUri + '/v1/email/identities?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteConfigurationSet(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteConfigurationSetResponse> {
			return Axios.delete<DeleteConfigurationSetResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetConfigurationSet(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<GetConfigurationSetResponse> {
			return Axios.get<GetConfigurationSetResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteConfigurationSetEventDestination(ConfigurationSetName: string, EventDestinationName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteConfigurationSetEventDestinationResponse> {
			return Axios.delete<DeleteConfigurationSetEventDestinationResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations/' + (EventDestinationName == null ? '' : encodeURIComponent(EventDestinationName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteDedicatedIpPool(PoolName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDedicatedIpPoolResponse> {
			return Axios.delete<DeleteDedicatedIpPoolResponse>(this.baseUri + '/v1/email/dedicated-ip-pools/' + (PoolName == null ? '' : encodeURIComponent(PoolName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DeleteEmailIdentity(EmailIdentity: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteEmailIdentityResponse> {
			return Axios.delete<DeleteEmailIdentityResponse>(this.baseUri + '/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetEmailIdentity(EmailIdentity: string, headersHandler?: () => {[header: string]: string}): Promise<GetEmailIdentityResponse> {
			return Axios.get<GetEmailIdentityResponse>(this.baseUri + '/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetAccount(headersHandler?: () => {[header: string]: string}): Promise<GetAccountResponse> {
			return Axios.get<GetAccountResponse>(this.baseUri + '/v1/email/account', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBlacklistReports(BlacklistItemNames: Array<BlacklistItemName>, headersHandler?: () => {[header: string]: string}): Promise<GetBlacklistReportsResponse> {
			return Axios.get<GetBlacklistReportsResponse>(this.baseUri + '/v1/email/deliverability-dashboard/blacklist-report#BlacklistItemNames?' + BlacklistItemNames.map(z => `BlacklistItemNames=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetDedicatedIp(IP: string, headersHandler?: () => {[header: string]: string}): Promise<GetDedicatedIpResponse> {
			return Axios.get<GetDedicatedIpResponse>(this.baseUri + '/v1/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetDedicatedIps(PoolName: string, NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<GetDedicatedIpsResponse> {
			return Axios.get<GetDedicatedIpsResponse>(this.baseUri + '/v1/email/dedicated-ips?PoolName=' + (PoolName == null ? '' : encodeURIComponent(PoolName)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetDeliverabilityDashboardOptions(headersHandler?: () => {[header: string]: string}): Promise<GetDeliverabilityDashboardOptionsResponse> {
			return Axios.get<GetDeliverabilityDashboardOptionsResponse>(this.baseUri + '/v1/email/deliverability-dashboard', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutDeliverabilityDashboardOption(requestBody: PutDeliverabilityDashboardOptionBody, headersHandler?: () => {[header: string]: string}): Promise<PutDeliverabilityDashboardOptionResponse> {
			return Axios.put<PutDeliverabilityDashboardOptionResponse>(this.baseUri + '/v1/email/deliverability-dashboard', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDeliverabilityTestReport(ReportId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDeliverabilityTestReportResponse> {
			return Axios.get<GetDeliverabilityTestReportResponse>(this.baseUri + '/v1/email/deliverability-dashboard/test-reports/' + (ReportId == null ? '' : encodeURIComponent(ReportId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetDomainDeliverabilityCampaign(CampaignId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDomainDeliverabilityCampaignResponse> {
			return Axios.get<GetDomainDeliverabilityCampaignResponse>(this.baseUri + '/v1/email/deliverability-dashboard/campaigns/' + (CampaignId == null ? '' : encodeURIComponent(CampaignId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetDomainStatisticsReport(Domain: string, StartDate: Date, EndDate: Date, headersHandler?: () => {[header: string]: string}): Promise<GetDomainStatisticsReportResponse> {
			return Axios.get<GetDomainStatisticsReportResponse>(this.baseUri + '/v1/email/deliverability-dashboard/statistics-report/' + (Domain == null ? '' : encodeURIComponent(Domain)) + '#StartDate&EndDate&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListDeliverabilityTestReports(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListDeliverabilityTestReportsResponse> {
			return Axios.get<ListDeliverabilityTestReportsResponse>(this.baseUri + '/v1/email/deliverability-dashboard/test-reports?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		ListTagsForResource(ResourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.get<ListTagsForResourceResponse>(this.baseUri + '/v1/email/tags#ResourceArn?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		PutAccountDedicatedIpWarmupAttributes(requestBody: PutAccountDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutAccountDedicatedIpWarmupAttributesResponse> {
			return Axios.put<PutAccountDedicatedIpWarmupAttributesResponse>(this.baseUri + '/v1/email/account/dedicated-ips/warmup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutAccountSendingAttributes(requestBody: PutAccountSendingAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutAccountSendingAttributesResponse> {
			return Axios.put<PutAccountSendingAttributesResponse>(this.baseUri + '/v1/email/account/sending', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutConfigurationSetDeliveryOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetDeliveryOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetDeliveryOptionsResponse> {
			return Axios.put<PutConfigurationSetDeliveryOptionsResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/delivery-options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutConfigurationSetReputationOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetReputationOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetReputationOptionsResponse> {
			return Axios.put<PutConfigurationSetReputationOptionsResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/reputation-options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutConfigurationSetSendingOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetSendingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetSendingOptionsResponse> {
			return Axios.put<PutConfigurationSetSendingOptionsResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/sending', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutConfigurationSetTrackingOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetTrackingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetTrackingOptionsResponse> {
			return Axios.put<PutConfigurationSetTrackingOptionsResponse>(this.baseUri + '/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/tracking-options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutDedicatedIpInPool(IP: string, requestBody: PutDedicatedIpInPoolBody, headersHandler?: () => {[header: string]: string}): Promise<PutDedicatedIpInPoolResponse> {
			return Axios.put<PutDedicatedIpInPoolResponse>(this.baseUri + '/v1/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/pool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutDedicatedIpWarmupAttributes(IP: string, requestBody: PutDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutDedicatedIpWarmupAttributesResponse> {
			return Axios.put<PutDedicatedIpWarmupAttributesResponse>(this.baseUri + '/v1/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/warmup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SendEmail(requestBody: SendEmailBody, headersHandler?: () => {[header: string]: string}): Promise<SendEmailResponse> {
			return Axios.post<SendEmailResponse>(this.baseUri + '/v1/email/outbound-emails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return Axios.post<TagResourceResponse>(this.baseUri + '/v1/email/tags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(ResourceArn: string, TagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return Axios.delete<UntagResourceResponse>(this.baseUri + '/v1/email/tags#ResourceArn&TagKeys?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
	}
