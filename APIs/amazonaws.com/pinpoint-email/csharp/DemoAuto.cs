...
namespace My.Demo.Client
{
	...
	public partial class DemoClient
	{
		...
		{
			var requestUri = "/v1/email/configuration-sets?NextToken=" + (NextToken==null? "" : Uri.EscapeDataString(NextToken))+"&PageSize="+PageSize;
		...
		{
			var requestUri = "/v1/email/configuration-sets/"+ (ConfigurationSetName==null? "" : Uri.EscapeDataString(ConfigurationSetName))+"/event-destinations";
			using (var request = new HttpRequestMessage(HttpMethod.Post, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/dedicated-ip-pools?NextToken=" + (NextToken==null? "" : Uri.EscapeDataString(NextToken))+"&PageSize="+PageSize;
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/identities?NextToken=" + (NextToken==null? "" : Uri.EscapeDataString(NextToken))+"&PageSize="+PageSize;
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/configuration-sets/"+ (ConfigurationSetName==null? "" : Uri.EscapeDataString(ConfigurationSetName));
		...
		{
			var requestUri = "/v1/email/configuration-sets/"+ (ConfigurationSetName==null? "" : Uri.EscapeDataString(ConfigurationSetName))+"/event-destinations/"+ (EventDestinationName==null? "" : Uri.EscapeDataString(EventDestinationName));
			using (var request = new HttpRequestMessage(HttpMethod.Delete, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/dedicated-ip-pools/"+ (PoolName==null? "" : Uri.EscapeDataString(PoolName));
			using (var request = new HttpRequestMessage(HttpMethod.Delete, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/identities/"+ (EmailIdentity==null? "" : Uri.EscapeDataString(EmailIdentity));
			using (var request = new HttpRequestMessage(HttpMethod.Delete, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/deliverability-dashboard/blacklist-report#BlacklistItemNames?"+String.Join("&", BlacklistItemNames.Select(z => $"BlacklistItemNames={z}"));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/dedicated-ips/"+ (IP==null? "" : Uri.EscapeDataString(IP));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/dedicated-ips?PoolName=" + (PoolName==null? "" : Uri.EscapeDataString(PoolName))+"&NextToken=" + (NextToken==null? "" : Uri.EscapeDataString(NextToken))+"&PageSize="+PageSize;
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/deliverability-dashboard/test-reports/"+ (ReportId==null? "" : Uri.EscapeDataString(ReportId));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/deliverability-dashboard/campaigns/"+ (CampaignId==null? "" : Uri.EscapeDataString(CampaignId));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/deliverability-dashboard/statistics-report/"+ (Domain==null? "" : Uri.EscapeDataString(Domain))+"#StartDate&EndDate&StartDate=" + StartDate.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ")+"&EndDate=" + EndDate.ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.fffffffZ");
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/deliverability-dashboard/test-reports?NextToken=" + (NextToken==null? "" : Uri.EscapeDataString(NextToken))+"&PageSize="+PageSize;
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/tags#ResourceArn?ResourceArn=" + (ResourceArn==null? "" : Uri.EscapeDataString(ResourceArn));
			using (var request = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		{
			var requestUri = "/v1/email/configuration-sets/"+ (ConfigurationSetName==null? "" : Uri.EscapeDataString(ConfigurationSetName))+"/delivery-options";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/configuration-sets/"+ (ConfigurationSetName==null? "" : Uri.EscapeDataString(ConfigurationSetName))+"/reputation-options";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/configuration-sets/"+ (ConfigurationSetName==null? "" : Uri.EscapeDataString(ConfigurationSetName))+"/sending";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/configuration-sets/"+ (ConfigurationSetName==null? "" : Uri.EscapeDataString(ConfigurationSetName))+"/tracking-options";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/dedicated-ips/"+ (IP==null? "" : Uri.EscapeDataString(IP))+"/pool";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/dedicated-ips/"+ (IP==null? "" : Uri.EscapeDataString(IP))+"/warmup";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/identities/"+ (EmailIdentity==null? "" : Uri.EscapeDataString(EmailIdentity))+"/dkim";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/identities/"+ (EmailIdentity==null? "" : Uri.EscapeDataString(EmailIdentity))+"/feedback";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/identities/"+ (EmailIdentity==null? "" : Uri.EscapeDataString(EmailIdentity))+"/mail-from";
			using (var request = new HttpRequestMessage(HttpMethod.Put, requestUri))
			{
			using (var requestWriter = new System.IO.StringWriter())
			{
		...
		{
			var requestUri = "/v1/email/tags#ResourceArn&TagKeys?ResourceArn=" + (ResourceArn==null? "" : Uri.EscapeDataString(ResourceArn))+"&"+String.Join("&", TagKeys.Select(z => $"TagKeys={z}"));
			using (var request = new HttpRequestMessage(HttpMethod.Delete, requestUri))
			{
			if (handleHeaders != null)
			{
