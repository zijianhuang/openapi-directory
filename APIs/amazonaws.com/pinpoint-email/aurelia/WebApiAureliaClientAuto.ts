...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateConfigurationSet(requestBody: CreateConfigurationSetBody, headersHandler?: () => {[header: string]: string}): Promise<CreateConfigurationSetResponse> {
			return this.http.post('/v1/email/configuration-sets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListConfigurationSets(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationSetsResponse> {
			return this.http.get('/v1/email/configuration-sets?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetConfigurationSetEventDestinations(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<GetConfigurationSetEventDestinationsResponse> {
			return this.http.get('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDedicatedIpPool(requestBody: CreateDedicatedIpPoolBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDedicatedIpPoolResponse> {
			return this.http.post('/v1/email/dedicated-ip-pools', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDedicatedIpPools(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListDedicatedIpPoolsResponse> {
			return this.http.get('/v1/email/dedicated-ip-pools?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDeliverabilityTestReport(requestBody: CreateDeliverabilityTestReportBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDeliverabilityTestReportResponse> {
			return this.http.post('/v1/email/deliverability-dashboard/test', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateEmailIdentity(requestBody: CreateEmailIdentityBody, headersHandler?: () => {[header: string]: string}): Promise<CreateEmailIdentityResponse> {
			return this.http.post('/v1/email/identities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListEmailIdentities(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListEmailIdentitiesResponse> {
			return this.http.get('/v1/email/identities?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteConfigurationSet(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteConfigurationSetResponse> {
			return this.http.delete('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetConfigurationSet(ConfigurationSetName: string, headersHandler?: () => {[header: string]: string}): Promise<GetConfigurationSetResponse> {
			return this.http.get('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteConfigurationSetEventDestination(ConfigurationSetName: string, EventDestinationName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteConfigurationSetEventDestinationResponse> {
			return this.http.delete('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations/' + (EventDestinationName == null ? '' : encodeURIComponent(EventDestinationName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateConfigurationSetEventDestination(ConfigurationSetName: string, EventDestinationName: string, requestBody: UpdateConfigurationSetEventDestinationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateConfigurationSetEventDestinationResponse> {
			return this.http.put('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/event-destinations/' + (EventDestinationName == null ? '' : encodeURIComponent(EventDestinationName)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteDedicatedIpPool(PoolName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDedicatedIpPoolResponse> {
			return this.http.delete('/v1/email/dedicated-ip-pools/' + (PoolName == null ? '' : encodeURIComponent(PoolName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteEmailIdentity(EmailIdentity: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteEmailIdentityResponse> {
			return this.http.delete('/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetEmailIdentity(EmailIdentity: string, headersHandler?: () => {[header: string]: string}): Promise<GetEmailIdentityResponse> {
			return this.http.get('/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetAccount(headersHandler?: () => {[header: string]: string}): Promise<GetAccountResponse> {
			return this.http.get('/v1/email/account', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBlacklistReports(BlacklistItemNames: Array<BlacklistItemName>, headersHandler?: () => {[header: string]: string}): Promise<GetBlacklistReportsResponse> {
			return this.http.get('/v1/email/deliverability-dashboard/blacklist-report#BlacklistItemNames?' + BlacklistItemNames.map(z => `BlacklistItemNames=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDedicatedIp(IP: string, headersHandler?: () => {[header: string]: string}): Promise<GetDedicatedIpResponse> {
			return this.http.get('/v1/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDedicatedIps(PoolName: string, NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<GetDedicatedIpsResponse> {
			return this.http.get('/v1/email/dedicated-ips?PoolName=' + (PoolName == null ? '' : encodeURIComponent(PoolName)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDeliverabilityDashboardOptions(headersHandler?: () => {[header: string]: string}): Promise<GetDeliverabilityDashboardOptionsResponse> {
			return this.http.get('/v1/email/deliverability-dashboard', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutDeliverabilityDashboardOption(requestBody: PutDeliverabilityDashboardOptionBody, headersHandler?: () => {[header: string]: string}): Promise<PutDeliverabilityDashboardOptionResponse> {
			return this.http.put('/v1/email/deliverability-dashboard', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDeliverabilityTestReport(ReportId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDeliverabilityTestReportResponse> {
			return this.http.get('/v1/email/deliverability-dashboard/test-reports/' + (ReportId == null ? '' : encodeURIComponent(ReportId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDomainDeliverabilityCampaign(CampaignId: string, headersHandler?: () => {[header: string]: string}): Promise<GetDomainDeliverabilityCampaignResponse> {
			return this.http.get('/v1/email/deliverability-dashboard/campaigns/' + (CampaignId == null ? '' : encodeURIComponent(CampaignId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetDomainStatisticsReport(Domain: string, StartDate: Date, EndDate: Date, headersHandler?: () => {[header: string]: string}): Promise<GetDomainStatisticsReportResponse> {
			return this.http.get('/v1/email/deliverability-dashboard/statistics-report/' + (Domain == null ? '' : encodeURIComponent(Domain)) + '#StartDate&EndDate&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString(), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListDeliverabilityTestReports(NextToken: string, PageSize: number, headersHandler?: () => {[header: string]: string}): Promise<ListDeliverabilityTestReportsResponse> {
			return this.http.get('/v1/email/deliverability-dashboard/test-reports?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&PageSize=' + PageSize, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListTagsForResource(ResourceArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.get('/v1/email/tags#ResourceArn?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutAccountDedicatedIpWarmupAttributes(requestBody: PutAccountDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutAccountDedicatedIpWarmupAttributesResponse> {
			return this.http.put('/v1/email/account/dedicated-ips/warmup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutAccountSendingAttributes(requestBody: PutAccountSendingAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutAccountSendingAttributesResponse> {
			return this.http.put('/v1/email/account/sending', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutConfigurationSetDeliveryOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetDeliveryOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetDeliveryOptionsResponse> {
			return this.http.put('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/delivery-options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutConfigurationSetReputationOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetReputationOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetReputationOptionsResponse> {
			return this.http.put('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/reputation-options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutConfigurationSetSendingOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetSendingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetSendingOptionsResponse> {
			return this.http.put('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/sending', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutConfigurationSetTrackingOptions(ConfigurationSetName: string, requestBody: PutConfigurationSetTrackingOptionsBody, headersHandler?: () => {[header: string]: string}): Promise<PutConfigurationSetTrackingOptionsResponse> {
			return this.http.put('/v1/email/configuration-sets/' + (ConfigurationSetName == null ? '' : encodeURIComponent(ConfigurationSetName)) + '/tracking-options', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutDedicatedIpInPool(IP: string, requestBody: PutDedicatedIpInPoolBody, headersHandler?: () => {[header: string]: string}): Promise<PutDedicatedIpInPoolResponse> {
			return this.http.put('/v1/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/pool', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutDedicatedIpWarmupAttributes(IP: string, requestBody: PutDedicatedIpWarmupAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutDedicatedIpWarmupAttributesResponse> {
			return this.http.put('/v1/email/dedicated-ips/' + (IP == null ? '' : encodeURIComponent(IP)) + '/warmup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutEmailIdentityDkimAttributes(EmailIdentity: string, requestBody: PutEmailIdentityDkimAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutEmailIdentityDkimAttributesResponse> {
			return this.http.put('/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/dkim', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutEmailIdentityFeedbackAttributes(EmailIdentity: string, requestBody: PutEmailIdentityFeedbackAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutEmailIdentityFeedbackAttributesResponse> {
			return this.http.put('/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/feedback', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutEmailIdentityMailFromAttributes(EmailIdentity: string, requestBody: PutEmailIdentityMailFromAttributesBody, headersHandler?: () => {[header: string]: string}): Promise<PutEmailIdentityMailFromAttributesResponse> {
			return this.http.put('/v1/email/identities/' + (EmailIdentity == null ? '' : encodeURIComponent(EmailIdentity)) + '/mail-from', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		SendEmail(requestBody: SendEmailBody, headersHandler?: () => {[header: string]: string}): Promise<SendEmailResponse> {
			return this.http.post('/v1/email/outbound-emails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/v1/email/tags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(ResourceArn: string, TagKeys: Array<TagKey>, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.delete('/v1/email/tags#ResourceArn&TagKeys?ResourceArn=' + (ResourceArn == null ? '' : encodeURIComponent(ResourceArn)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
