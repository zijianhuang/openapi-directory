...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateDelegateToResource(requestBody: AssociateDelegateToResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateDelegateToResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.AssociateDelegateToResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		AssociateMemberToGroup(requestBody: AssociateMemberToGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<AssociateMemberToGroupResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.AssociateMemberToGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateAlias(requestBody: CreateAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAliasResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.CreateAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateGroup(requestBody: CreateGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateGroupResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.CreateGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateResource(requestBody: CreateResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.CreateResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CreateUser(requestBody: CreateUserRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateUserResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.CreateUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAccessControlRule(requestBody: DeleteAccessControlRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAccessControlRuleResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeleteAccessControlRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteAlias(requestBody: DeleteAliasRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteAliasResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeleteAlias', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteGroup(requestBody: DeleteGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteGroupResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeleteGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMailboxPermissions(requestBody: DeleteMailboxPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteMailboxPermissionsResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeleteMailboxPermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteResource(requestBody: DeleteResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeleteResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteRetentionPolicy(requestBody: DeleteRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRetentionPolicyResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeleteRetentionPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteUser(requestBody: DeleteUserRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteUserResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeleteUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeregisterFromWorkMail(requestBody: DeregisterFromWorkMailRequest, headersHandler?: () => {[header: string]: string}): Promise<DeregisterFromWorkMailResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DeregisterFromWorkMail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeGroup(requestBody: DescribeGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeGroupResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DescribeGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeOrganization(requestBody: DescribeOrganizationRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeOrganizationResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DescribeOrganization', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeResource(requestBody: DescribeResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DescribeResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeUser(requestBody: DescribeUserRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeUserResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DescribeUser', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateDelegateFromResource(requestBody: DisassociateDelegateFromResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateDelegateFromResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DisassociateDelegateFromResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisassociateMemberFromGroup(requestBody: DisassociateMemberFromGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<DisassociateMemberFromGroupResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.DisassociateMemberFromGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetAccessControlEffect(requestBody: GetAccessControlEffectRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAccessControlEffectResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.GetAccessControlEffect', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDefaultRetentionPolicy(requestBody: GetDefaultRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDefaultRetentionPolicyResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.GetDefaultRetentionPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMailboxDetails(requestBody: GetMailboxDetailsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetMailboxDetailsResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.GetMailboxDetails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAccessControlRules(requestBody: ListAccessControlRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAccessControlRulesResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListAccessControlRules', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListAliases(MaxResults: string, NextToken: string, requestBody: ListAliasesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAliasesResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListAliases?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGroupMembers(MaxResults: string, NextToken: string, requestBody: ListGroupMembersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGroupMembersResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListGroupMembers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListGroups(MaxResults: string, NextToken: string, requestBody: ListGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListGroupsResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListGroups?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListMailboxPermissions(MaxResults: string, NextToken: string, requestBody: ListMailboxPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListMailboxPermissionsResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListMailboxPermissions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListOrganizations(MaxResults: string, NextToken: string, requestBody: ListOrganizationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOrganizationsResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListOrganizations?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResourceDelegates(MaxResults: string, NextToken: string, requestBody: ListResourceDelegatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourceDelegatesResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListResourceDelegates?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListResources(MaxResults: string, NextToken: string, requestBody: ListResourcesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListResourcesResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListResources?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListUsers(MaxResults: string, NextToken: string, requestBody: ListUsersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListUsersResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ListUsers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutAccessControlRule(requestBody: PutAccessControlRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<PutAccessControlRuleResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.PutAccessControlRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutMailboxPermissions(requestBody: PutMailboxPermissionsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutMailboxPermissionsResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.PutMailboxPermissions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutRetentionPolicy(requestBody: PutRetentionPolicyRequest, headersHandler?: () => {[header: string]: string}): Promise<PutRetentionPolicyResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.PutRetentionPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterToWorkMail(requestBody: RegisterToWorkMailRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterToWorkMailResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.RegisterToWorkMail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResetPassword(requestBody: ResetPasswordRequest, headersHandler?: () => {[header: string]: string}): Promise<ResetPasswordResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.ResetPassword', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<TagResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateMailboxQuota(requestBody: UpdateMailboxQuotaRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateMailboxQuotaResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.UpdateMailboxQuota', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdatePrimaryEmailAddress(requestBody: UpdatePrimaryEmailAddressRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdatePrimaryEmailAddressResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.UpdatePrimaryEmailAddress', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateResource(requestBody: UpdateResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateResourceResponse> {
			return this.http.post('/#X-Amz-Target=WorkMailService.UpdateResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
