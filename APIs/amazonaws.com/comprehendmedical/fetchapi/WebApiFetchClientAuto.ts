export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DescribeEntitiesDetectionV2Job(requestBody: DescribeEntitiesDetectionV2JobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeEntitiesDetectionV2JobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeEntitiesDetectionV2Job', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeICD10CMInferenceJob(requestBody: DescribeICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeICD10CMInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeICD10CMInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribePHIDetectionJob(requestBody: DescribePHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePHIDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribePHIDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRxNormInferenceJob(requestBody: DescribeRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRxNormInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeRxNormInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectEntities(requestBody: DetectEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectEntitiesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntities', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectEntitiesV2(requestBody: DetectEntitiesV2Request, headersHandler?: () => {[header: string]: string}): Promise<DetectEntitiesV2Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntitiesV2', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DetectPHI(requestBody: DetectPHIRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectPHIResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectPHI', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		InferICD10CM(requestBody: InferICD10CMRequest, headersHandler?: () => {[header: string]: string}): Promise<InferICD10CMResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferICD10CM', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		InferRxNorm(requestBody: InferRxNormRequest, headersHandler?: () => {[header: string]: string}): Promise<InferRxNormResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferRxNorm', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEntitiesDetectionV2Jobs(requestBody: ListEntitiesDetectionV2JobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEntitiesDetectionV2JobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListEntitiesDetectionV2Jobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListICD10CMInferenceJobs(requestBody: ListICD10CMInferenceJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListICD10CMInferenceJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListICD10CMInferenceJobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListPHIDetectionJobs(requestBody: ListPHIDetectionJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPHIDetectionJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListPHIDetectionJobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRxNormInferenceJobs(requestBody: ListRxNormInferenceJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRxNormInferenceJobsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListRxNormInferenceJobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartEntitiesDetectionV2Job(requestBody: StartEntitiesDetectionV2JobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartEntitiesDetectionV2JobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartEntitiesDetectionV2Job', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartICD10CMInferenceJob(requestBody: StartICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartICD10CMInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartICD10CMInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartPHIDetectionJob(requestBody: StartPHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartPHIDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartPHIDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartRxNormInferenceJob(requestBody: StartRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartRxNormInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartRxNormInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopEntitiesDetectionV2Job(requestBody: StopEntitiesDetectionV2JobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopEntitiesDetectionV2JobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopEntitiesDetectionV2Job', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopICD10CMInferenceJob(requestBody: StopICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopICD10CMInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopICD10CMInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopPHIDetectionJob(requestBody: StopPHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopPHIDetectionJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopPHIDetectionJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopRxNormInferenceJob(requestBody: StopRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRxNormInferenceJobResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopRxNormInferenceJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
