...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DescribeEntitiesDetectionV2Job(requestBody: DescribeEntitiesDetectionV2JobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeEntitiesDetectionV2JobResponse> {
			return this.http.post<DescribeEntitiesDetectionV2JobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeEntitiesDetectionV2Job', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeICD10CMInferenceJob(requestBody: DescribeICD10CMInferenceJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeICD10CMInferenceJobResponse> {
			return this.http.post<DescribeICD10CMInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeICD10CMInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribePHIDetectionJob(requestBody: DescribePHIDetectionJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribePHIDetectionJobResponse> {
			return this.http.post<DescribePHIDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribePHIDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRxNormInferenceJob(requestBody: DescribeRxNormInferenceJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRxNormInferenceJobResponse> {
			return this.http.post<DescribeRxNormInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeRxNormInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		DetectEntities(requestBody: DetectEntitiesRequest, headersHandler?: () => HttpHeaders): Observable<DetectEntitiesResponse> {
			return this.http.post<DetectEntitiesResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntities', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DetectEntitiesV2(requestBody: DetectEntitiesV2Request, headersHandler?: () => HttpHeaders): Observable<DetectEntitiesV2Response> {
			return this.http.post<DetectEntitiesV2Response>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntitiesV2', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DetectPHI(requestBody: DetectPHIRequest, headersHandler?: () => HttpHeaders): Observable<DetectPHIResponse> {
			return this.http.post<DetectPHIResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectPHI', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		InferICD10CM(requestBody: InferICD10CMRequest, headersHandler?: () => HttpHeaders): Observable<InferICD10CMResponse> {
			return this.http.post<InferICD10CMResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferICD10CM', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		InferRxNorm(requestBody: InferRxNormRequest, headersHandler?: () => HttpHeaders): Observable<InferRxNormResponse> {
			return this.http.post<InferRxNormResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferRxNorm', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListEntitiesDetectionV2Jobs(requestBody: ListEntitiesDetectionV2JobsRequest, headersHandler?: () => HttpHeaders): Observable<ListEntitiesDetectionV2JobsResponse> {
			return this.http.post<ListEntitiesDetectionV2JobsResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListEntitiesDetectionV2Jobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListICD10CMInferenceJobs(requestBody: ListICD10CMInferenceJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListICD10CMInferenceJobsResponse> {
			return this.http.post<ListICD10CMInferenceJobsResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListICD10CMInferenceJobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPHIDetectionJobs(requestBody: ListPHIDetectionJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListPHIDetectionJobsResponse> {
			return this.http.post<ListPHIDetectionJobsResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListPHIDetectionJobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListRxNormInferenceJobs(requestBody: ListRxNormInferenceJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListRxNormInferenceJobsResponse> {
			return this.http.post<ListRxNormInferenceJobsResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListRxNormInferenceJobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartEntitiesDetectionV2Job(requestBody: StartEntitiesDetectionV2JobRequest, headersHandler?: () => HttpHeaders): Observable<StartEntitiesDetectionV2JobResponse> {
			return this.http.post<StartEntitiesDetectionV2JobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartEntitiesDetectionV2Job', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartICD10CMInferenceJob(requestBody: StartICD10CMInferenceJobRequest, headersHandler?: () => HttpHeaders): Observable<StartICD10CMInferenceJobResponse> {
			return this.http.post<StartICD10CMInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartICD10CMInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartPHIDetectionJob(requestBody: StartPHIDetectionJobRequest, headersHandler?: () => HttpHeaders): Observable<StartPHIDetectionJobResponse> {
			return this.http.post<StartPHIDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartPHIDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartRxNormInferenceJob(requestBody: StartRxNormInferenceJobRequest, headersHandler?: () => HttpHeaders): Observable<StartRxNormInferenceJobResponse> {
			return this.http.post<StartRxNormInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartRxNormInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopEntitiesDetectionV2Job(requestBody: StopEntitiesDetectionV2JobRequest, headersHandler?: () => HttpHeaders): Observable<StopEntitiesDetectionV2JobResponse> {
			return this.http.post<StopEntitiesDetectionV2JobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopEntitiesDetectionV2Job', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopICD10CMInferenceJob(requestBody: StopICD10CMInferenceJobRequest, headersHandler?: () => HttpHeaders): Observable<StopICD10CMInferenceJobResponse> {
			return this.http.post<StopICD10CMInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopICD10CMInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopPHIDetectionJob(requestBody: StopPHIDetectionJobRequest, headersHandler?: () => HttpHeaders): Observable<StopPHIDetectionJobResponse> {
			return this.http.post<StopPHIDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopPHIDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopRxNormInferenceJob(requestBody: StopRxNormInferenceJobRequest, headersHandler?: () => HttpHeaders): Observable<StopRxNormInferenceJobResponse> {
			return this.http.post<StopRxNormInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopRxNormInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
