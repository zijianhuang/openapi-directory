...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DescribeICD10CMInferenceJob(requestBody: DescribeICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeICD10CMInferenceJobResponse> {
			return Axios.post<DescribeICD10CMInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeICD10CMInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribePHIDetectionJob(requestBody: DescribePHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribePHIDetectionJobResponse> {
			return Axios.post<DescribePHIDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribePHIDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeRxNormInferenceJob(requestBody: DescribeRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRxNormInferenceJobResponse> {
			return Axios.post<DescribeRxNormInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeRxNormInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectEntities(requestBody: DetectEntitiesRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectEntitiesResponse> {
			return Axios.post<DetectEntitiesResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntities', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectEntitiesV2(requestBody: DetectEntitiesV2Request, headersHandler?: () => {[header: string]: string}): Promise<DetectEntitiesV2Response> {
			return Axios.post<DetectEntitiesV2Response>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntitiesV2', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DetectPHI(requestBody: DetectPHIRequest, headersHandler?: () => {[header: string]: string}): Promise<DetectPHIResponse> {
			return Axios.post<DetectPHIResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectPHI', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InferICD10CM(requestBody: InferICD10CMRequest, headersHandler?: () => {[header: string]: string}): Promise<InferICD10CMResponse> {
			return Axios.post<InferICD10CMResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferICD10CM', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		InferRxNorm(requestBody: InferRxNormRequest, headersHandler?: () => {[header: string]: string}): Promise<InferRxNormResponse> {
			return Axios.post<InferRxNormResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferRxNorm', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEntitiesDetectionV2Jobs(requestBody: ListEntitiesDetectionV2JobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEntitiesDetectionV2JobsResponse> {
			return Axios.post<ListEntitiesDetectionV2JobsResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListEntitiesDetectionV2Jobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRxNormInferenceJobs(requestBody: ListRxNormInferenceJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListRxNormInferenceJobsResponse> {
			return Axios.post<ListRxNormInferenceJobsResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListRxNormInferenceJobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartICD10CMInferenceJob(requestBody: StartICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartICD10CMInferenceJobResponse> {
			return Axios.post<StartICD10CMInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartICD10CMInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartPHIDetectionJob(requestBody: StartPHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartPHIDetectionJobResponse> {
			return Axios.post<StartPHIDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartPHIDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartRxNormInferenceJob(requestBody: StartRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StartRxNormInferenceJobResponse> {
			return Axios.post<StartRxNormInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartRxNormInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopICD10CMInferenceJob(requestBody: StopICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopICD10CMInferenceJobResponse> {
			return Axios.post<StopICD10CMInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopICD10CMInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopPHIDetectionJob(requestBody: StopPHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopPHIDetectionJobResponse> {
			return Axios.post<StopPHIDetectionJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopPHIDetectionJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopRxNormInferenceJob(requestBody: StopRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}): Promise<StopRxNormInferenceJobResponse> {
			return Axios.post<StopRxNormInferenceJobResponse>(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopRxNormInferenceJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
