...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DescribeEntitiesDetectionV2Job(callback: (data : DescribeEntitiesDetectionV2JobResponse) => any, requestBody: DescribeEntitiesDetectionV2JobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeEntitiesDetectionV2Job', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeICD10CMInferenceJob(callback: (data : DescribeICD10CMInferenceJobResponse) => any, requestBody: DescribeICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeICD10CMInferenceJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribePHIDetectionJob(callback: (data : DescribePHIDetectionJobResponse) => any, requestBody: DescribePHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribePHIDetectionJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeRxNormInferenceJob(callback: (data : DescribeRxNormInferenceJobResponse) => any, requestBody: DescribeRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DescribeRxNormInferenceJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		...
		DetectEntities(callback: (data : DetectEntitiesResponse) => any, requestBody: DetectEntitiesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntities', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetectEntitiesV2(callback: (data : DetectEntitiesV2Response) => any, requestBody: DetectEntitiesV2Request, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectEntitiesV2', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DetectPHI(callback: (data : DetectPHIResponse) => any, requestBody: DetectPHIRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.DetectPHI', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		InferICD10CM(callback: (data : InferICD10CMResponse) => any, requestBody: InferICD10CMRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferICD10CM', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		InferRxNorm(callback: (data : InferRxNormResponse) => any, requestBody: InferRxNormRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.InferRxNorm', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListEntitiesDetectionV2Jobs(callback: (data : ListEntitiesDetectionV2JobsResponse) => any, requestBody: ListEntitiesDetectionV2JobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListEntitiesDetectionV2Jobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListICD10CMInferenceJobs(callback: (data : ListICD10CMInferenceJobsResponse) => any, requestBody: ListICD10CMInferenceJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListICD10CMInferenceJobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListPHIDetectionJobs(callback: (data : ListPHIDetectionJobsResponse) => any, requestBody: ListPHIDetectionJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListPHIDetectionJobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListRxNormInferenceJobs(callback: (data : ListRxNormInferenceJobsResponse) => any, requestBody: ListRxNormInferenceJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.ListRxNormInferenceJobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartEntitiesDetectionV2Job(callback: (data : StartEntitiesDetectionV2JobResponse) => any, requestBody: StartEntitiesDetectionV2JobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartEntitiesDetectionV2Job', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartICD10CMInferenceJob(callback: (data : StartICD10CMInferenceJobResponse) => any, requestBody: StartICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartICD10CMInferenceJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartPHIDetectionJob(callback: (data : StartPHIDetectionJobResponse) => any, requestBody: StartPHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartPHIDetectionJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StartRxNormInferenceJob(callback: (data : StartRxNormInferenceJobResponse) => any, requestBody: StartRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StartRxNormInferenceJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopEntitiesDetectionV2Job(callback: (data : StopEntitiesDetectionV2JobResponse) => any, requestBody: StopEntitiesDetectionV2JobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopEntitiesDetectionV2Job', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopICD10CMInferenceJob(callback: (data : StopICD10CMInferenceJobResponse) => any, requestBody: StopICD10CMInferenceJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopICD10CMInferenceJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopPHIDetectionJob(callback: (data : StopPHIDetectionJobResponse) => any, requestBody: StopPHIDetectionJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopPHIDetectionJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		StopRxNormInferenceJob(callback: (data : StopRxNormInferenceJobResponse) => any, requestBody: StopRxNormInferenceJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=ComprehendMedical_20181030.StopRxNormInferenceJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
