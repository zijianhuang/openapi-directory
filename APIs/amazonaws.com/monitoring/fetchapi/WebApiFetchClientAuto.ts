export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		GET_DeleteAlarms(AlarmNames: Array<AlarmName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteAlarms?' + AlarmNames.map(z => `AlarmNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteAnomalyDetector(Namespace: string, MetricName: string, Dimensions: Array<Dimension>, Stat: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteAnomalyDetector?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Stat=' + (Stat == null ? '' : encodeURIComponent(Stat)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteDashboards(DashboardNames: Array<DashboardName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteDashboards?' + DashboardNames.map(z => `DashboardNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DeleteInsightRules(RuleNames: Array<InsightRuleName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DeleteInsightRules?' + RuleNames.map(z => `RuleNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAlarmHistory(AlarmName: string, AlarmTypes: Array<AlarmType>, HistoryItemType: HistoryItemType, StartDate: Date, EndDate: Date, MaxRecords: number, NextToken: string, ScanBy: ScanBy, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAlarmHistory?AlarmName=' + (AlarmName == null ? '' : encodeURIComponent(AlarmName)) + '&' + AlarmTypes.map(z => `AlarmTypes=${z}`).join('&') + '&HistoryItemType=' + HistoryItemType + '&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString() + '&MaxRecords=' + MaxRecords + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&ScanBy=' + ScanBy + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeAlarmsForMetric(MetricName: string, Namespace: string, Statistic: Statistic, ExtendedStatistic: string, Dimensions: Array<Dimension>, Period: number, Unit: MetricDatumUnit, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeAlarmsForMetric?MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&Statistic=' + Statistic + '&ExtendedStatistic=' + (ExtendedStatistic == null ? '' : encodeURIComponent(ExtendedStatistic)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Period=' + Period + '&Unit=' + Unit + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DescribeInsightRules(NextToken: string, MaxResults: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DescribeInsightRules?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DisableAlarmActions(AlarmNames: Array<AlarmName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DisableAlarmActions?' + AlarmNames.map(z => `AlarmNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_DisableInsightRules(RuleNames: Array<InsightRuleName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=DisableInsightRules?' + RuleNames.map(z => `RuleNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_EnableAlarmActions(AlarmNames: Array<AlarmName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=EnableAlarmActions?' + AlarmNames.map(z => `AlarmNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_EnableInsightRules(RuleNames: Array<InsightRuleName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=EnableInsightRules?' + RuleNames.map(z => `RuleNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_GetDashboard(DashboardName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=GetDashboard?DashboardName=' + (DashboardName == null ? '' : encodeURIComponent(DashboardName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_GetMetricData(MetricDataQueries: Array<MetricDataQuery>, StartTime: Date, EndTime: Date, NextToken: string, ScanBy: ScanBy, MaxDatapoints: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=GetMetricData?' + MetricDataQueries.map(z => `MetricDataQueries=${z}`).join('&') + '&StartTime=' + StartTime.toISOString() + '&EndTime=' + EndTime.toISOString() + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&ScanBy=' + ScanBy + '&MaxDatapoints=' + MaxDatapoints + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_GetMetricStatistics(Namespace: string, MetricName: string, Dimensions: Array<Dimension>, StartTime: Date, EndTime: Date, Period: number, Statistics: Array<Statistic>, ExtendedStatistics: Array<ExtendedStatistic>, Unit: MetricDatumUnit, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=GetMetricStatistics?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&StartTime=' + StartTime.toISOString() + '&EndTime=' + EndTime.toISOString() + '&Period=' + Period + '&' + Statistics.map(z => `Statistics=${z}`).join('&') + '&' + ExtendedStatistics.map(z => `ExtendedStatistics=${z}`).join('&') + '&Unit=' + Unit + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_GetMetricWidgetImage(MetricWidget: string, OutputFormat: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=GetMetricWidgetImage?MetricWidget=' + (MetricWidget == null ? '' : encodeURIComponent(MetricWidget)) + '&OutputFormat=' + (OutputFormat == null ? '' : encodeURIComponent(OutputFormat)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ListDashboards(DashboardNamePrefix: string, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=ListDashboards?DashboardNamePrefix=' + (DashboardNamePrefix == null ? '' : encodeURIComponent(DashboardNamePrefix)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_ListMetrics(Namespace: string, MetricName: string, Dimensions: Array<DimensionFilter>, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=ListMetrics?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_PutAnomalyDetector(Namespace: string, MetricName: string, Dimensions: Array<Dimension>, Stat: string, Configuration: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=PutAnomalyDetector?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Stat=' + (Stat == null ? '' : encodeURIComponent(Stat)) + '&Configuration=' + (Configuration == null ? '' : encodeURIComponent(Configuration)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_PutDashboard(DashboardName: string, DashboardBody: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=PutDashboard?DashboardName=' + (DashboardName == null ? '' : encodeURIComponent(DashboardName)) + '&DashboardBody=' + (DashboardBody == null ? '' : encodeURIComponent(DashboardBody)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_PutInsightRule(RuleName: string, RuleState: string, RuleDefinition: string, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=PutInsightRule?RuleName=' + (RuleName == null ? '' : encodeURIComponent(RuleName)) + '&RuleState=' + (RuleState == null ? '' : encodeURIComponent(RuleState)) + '&RuleDefinition=' + (RuleDefinition == null ? '' : encodeURIComponent(RuleDefinition)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_PutMetricData(Namespace: string, MetricData: Array<MetricDatum>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=PutMetricData?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&' + MetricData.map(z => `MetricData=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_SetAlarmState(AlarmName: string, StateValue: StateValue, StateReason: string, StateReasonData: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=SetAlarmState?AlarmName=' + (AlarmName == null ? '' : encodeURIComponent(AlarmName)) + '&StateValue=' + StateValue + '&StateReason=' + (StateReason == null ? '' : encodeURIComponent(StateReason)) + '&StateReasonData=' + (StateReasonData == null ? '' : encodeURIComponent(StateReasonData)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_TagResource(ResourceARN: string, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=TagResource?ResourceARN=' + (ResourceARN == null ? '' : encodeURIComponent(ResourceARN)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GET_UntagResource(ResourceARN: string, TagKeys: Array<TagKey>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#Action=UntagResource?ResourceARN=' + (ResourceARN == null ? '' : encodeURIComponent(ResourceARN)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined });
		}
	}
