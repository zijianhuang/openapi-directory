...
export namespace My_Demo_Client {
	...
	export interface GetInsightRuleReportOutput {
		KeyLabels?: Array<InsightRuleContributorKeyLabel>;
	...
	export interface CompositeAlarm {
		...
		AlarmActions?: Array<ResourceName>;
		AlarmArn?: string;
		AlarmConfigurationUpdatedTimestamp?: Date;
		AlarmDescription?: string;
		AlarmName?: string;
		AlarmRule?: string;
		InsufficientDataActions?: Array<ResourceName>;
		OKActions?: Array<ResourceName>;
		StateReason?: string;
	...
	export interface DeleteInsightRulesInput {
		RuleNames: Array<InsightRuleName>;
	}
	...
	export interface DescribeAlarmHistoryInput {
		...
		HistoryItemType?: DescribeAlarmHistoryInputHistoryItemType;
		StartDate?: Date;
		EndDate?: Date;
		MaxRecords?: number;
		NextToken?: string;
		ScanBy?: DescribeAlarmHistoryInputScanBy;
	}

	export enum DescribeAlarmHistoryInputHistoryItemType { ConfigurationUpdate = 0, StateUpdate = 1, Action = 2 }

	export enum DescribeAlarmHistoryInputScanBy { TimestampDescending = 0, TimestampAscending = 1 }

	export interface DescribeAlarmsForMetricInput {
		MetricName: string;
		Namespace: string;
		Statistic?: DescribeAlarmsForMetricInputStatistic;
	...
	export enum DescribeAlarmsForMetricInputStatistic { SampleCount = 0, Average = 1, Sum = 2, Minimum = 3, Maximum = 4 }
	...
	export interface DescribeAlarmsInput {
		...
		StateValue?: DescribeAlarmsInputStateValue;
		ActionPrefix?: string;
		MaxRecords?: number;
		NextToken?: string;
	}

	export enum DescribeAlarmsInputStateValue { OK = 0, ALARM = 1, INSUFFICIENT_DATA = 2 }
	...
	export interface GetInsightRuleReportInput {
		...
		Metrics?: Array<InsightRuleMetricName>;
		OrderBy?: string;
	}
	...
	export interface GetMetricDataInput {
		...
		EndTime: Date;
		NextToken?: string;
		ScanBy?: GetMetricDataInputScanBy;
		MaxDatapoints?: number;
	}

	export enum GetMetricDataInputScanBy { TimestampDescending = 0, TimestampAscending = 1 }
	...
	export interface InsightRuleContributor {
		Keys: Array<InsightRuleContributorKey>;
	...
	export interface MetricAlarm {
		...
		AlarmActions?: Array<ResourceName>;
		InsufficientDataActions?: Array<ResourceName>;
		StateValue?: MetricAlarmStateValue;
		StateReason?: string;
		StateReasonData?: string;
		StateUpdatedTimestamp?: Date;
		MetricName?: string;
	...
	export enum MetricAlarmStateValue { OK = 0, ALARM = 1, INSUFFICIENT_DATA = 2 }
	...
	export interface PutMetricAlarmInput {
		...
		MetricName?: string;
		Namespace?: string;
		Statistic?: PutMetricAlarmInputStatistic;
		ExtendedStatistic?: string;
		Dimensions?: Array<Dimension>;
		Period?: number;
		...
		DatapointsToAlarm?: number;
		Threshold?: number;
		ComparisonOperator: PutMetricAlarmInputComparisonOperator;
		TreatMissingData?: string;
		EvaluateLowSampleCountPercentile?: string;
		Metrics?: Array<MetricDataQuery>;
		Tags?: Array<Tag>;
	...
	export enum PutMetricAlarmInputStatistic { SampleCount = 0, Average = 1, Sum = 2, Minimum = 3, Maximum = 4 }

	export enum PutMetricAlarmInputUnit { Seconds = 0, Microseconds = 1, Milliseconds = 2, Bytes = 3, Kilobytes = 4, Megabytes = 5, Gigabytes = 6, Terabytes = 7, Bits = 8, Kilobits = 9, Megabits = 10, Gigabits = 11, Terabits = 12, Percent = 13, Count = 14, Bytes/Second = 15, Kilobytes/Second = 16, Megabytes/Second = 17, Gigabytes/Second = 18, Terabytes/Second = 19, Bits/Second = 20, Kilobits/Second = 21, Megabits/Second = 22, Gigabits/Second = 23, Terabits/Second = 24, Count/Second = 25, None = 26 }

	export enum PutMetricAlarmInputComparisonOperator { GreaterThanOrEqualToThreshold = 0, GreaterThanThreshold = 1, LessThanThreshold = 2, LessThanOrEqualToThreshold = 3, LessThanLowerOrGreaterThanUpperThreshold = 4, LessThanLowerThreshold = 5, GreaterThanUpperThreshold = 6 }
	...
	export interface SetAlarmStateInput {
		AlarmName: string;
		StateValue: SetAlarmStateInputStateValue;
		StateReason: string;
		StateReasonData?: string;
	}

	export enum SetAlarmStateInputStateValue { OK = 0, ALARM = 1, INSUFFICIENT_DATA = 2 }
	...
	export class DemoClient {
		 ...
		 * @param {Array<AlarmName>} AlarmNames The alarms to be deleted.
		 * @return {void} Success
		 */
		GET_DeleteAlarms(AlarmNames: Array<AlarmName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteAlarms?' + AlarmNames.map(z => `AlarmNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteAnomalyDetector(Namespace: string, MetricName: string, Dimensions: Array<Dimension>, Stat: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteAnomalyDetector?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Stat=' + (Stat == null ? '' : encodeURIComponent(Stat)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}

		/**
		 * Deletes all dashboards that you specify. You may specify up to 100 dashboards to delete. If there is an error during this call, no dashboards are deleted.
		 * Get /#Action=DeleteDashboards
		 * @param {Array<DashboardName>} DashboardNames The dashboards to be deleted. This parameter is required.
		 * @return {void} Success
		 */
		GET_DeleteDashboards(DashboardNames: Array<DashboardName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteDashboards?' + DashboardNames.map(z => `DashboardNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {Array<InsightRuleName>} RuleNames An array of the rule names to delete. If you need to find out the names of your rules, use <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_DescribeInsightRules.html">DescribeInsightRules</a>.
		 * @return {void} Success
		 */
		GET_DeleteInsightRules(RuleNames: Array<InsightRuleName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DeleteInsightRules?' + RuleNames.map(z => `RuleNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeAlarmHistory(AlarmName: string, AlarmTypes: Array<AlarmType>, HistoryItemType: HistoryItemType, StartDate: Date, EndDate: Date, MaxRecords: number, NextToken: string, ScanBy: ScanBy, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeAlarmHistory?AlarmName=' + (AlarmName == null ? '' : encodeURIComponent(AlarmName)) + '&' + AlarmTypes.map(z => `AlarmTypes=${z}`).join('&') + '&HistoryItemType=' + HistoryItemType + '&StartDate=' + StartDate.toISOString() + '&EndDate=' + EndDate.toISOString() + '&MaxRecords=' + MaxRecords + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&ScanBy=' + ScanBy + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {Array<AlarmName>} AlarmNames The names of the alarms to retrieve information about.
		 ...
		 * @return {void} Success
		 */
		GET_DescribeAlarms(AlarmNames: Array<AlarmName>, AlarmNamePrefix: string, AlarmTypes: Array<AlarmType>, ChildrenOfAlarmName: string, ParentsOfAlarmName: string, StateValue: StateValue, ActionPrefix: string, MaxRecords: number, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeAlarms?' + AlarmNames.map(z => `AlarmNames=${z}`).join('&') + '&AlarmNamePrefix=' + (AlarmNamePrefix == null ? '' : encodeURIComponent(AlarmNamePrefix)) + '&' + AlarmTypes.map(z => `AlarmTypes=${z}`).join('&') + '&ChildrenOfAlarmName=' + (ChildrenOfAlarmName == null ? '' : encodeURIComponent(ChildrenOfAlarmName)) + '&ParentsOfAlarmName=' + (ParentsOfAlarmName == null ? '' : encodeURIComponent(ParentsOfAlarmName)) + '&StateValue=' + StateValue + '&ActionPrefix=' + (ActionPrefix == null ? '' : encodeURIComponent(ActionPrefix)) + '&MaxRecords=' + MaxRecords + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {MetricDatumUnit} Unit The unit for the metric.
		 * @return {void} Success
		 */
		GET_DescribeAlarmsForMetric(MetricName: string, Namespace: string, Statistic: Statistic, ExtendedStatistic: string, Dimensions: Array<Dimension>, Period: number, Unit: MetricDatumUnit, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeAlarmsForMetric?MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&Statistic=' + Statistic + '&ExtendedStatistic=' + (ExtendedStatistic == null ? '' : encodeURIComponent(ExtendedStatistic)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Period=' + Period + '&Unit=' + Unit + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeAnomalyDetectors(NextToken: string, MaxResults: number, Namespace: string, MetricName: string, Dimensions: Array<Dimension>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeAnomalyDetectors?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults + '&Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeInsightRules(NextToken: string, MaxResults: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DescribeInsightRules?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}

		/**
		 * Disables the actions for the specified alarms. When an alarm's actions are disabled, the alarm actions do not execute when the alarm state changes.
		 * Get /#Action=DisableAlarmActions
		 * @param {Array<AlarmName>} AlarmNames The names of the alarms.
		 * @return {void} Success
		 */
		GET_DisableAlarmActions(AlarmNames: Array<AlarmName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DisableAlarmActions?' + AlarmNames.map(z => `AlarmNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}

		/**
		 * Disables the specified Contributor Insights rules. When rules are disabled, they do not analyze log groups and do not incur costs.
		 * Get /#Action=DisableInsightRules
		 * @param {Array<InsightRuleName>} RuleNames An array of the rule names to disable. If you need to find out the names of your rules, use <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_DescribeInsightRules.html">DescribeInsightRules</a>.
		 * @return {void} Success
		 */
		GET_DisableInsightRules(RuleNames: Array<InsightRuleName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=DisableInsightRules?' + RuleNames.map(z => `RuleNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_EnableAlarmActions(AlarmNames: Array<AlarmName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=EnableAlarmActions?' + AlarmNames.map(z => `AlarmNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}

		/**
		 * Enables the specified Contributor Insights rules. When rules are enabled, they immediately begin analyzing log data.
		 * Get /#Action=EnableInsightRules
		 * @param {Array<InsightRuleName>} RuleNames An array of the rule names to enable. If you need to find out the names of your rules, use <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_DescribeInsightRules.html">DescribeInsightRules</a>.
		 * @return {void} Success
		 */
		GET_EnableInsightRules(RuleNames: Array<InsightRuleName>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=EnableInsightRules?' + RuleNames.map(z => `RuleNames=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetDashboard(DashboardName: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetDashboard?DashboardName=' + (DashboardName == null ? '' : encodeURIComponent(DashboardName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetMetricData(MetricDataQueries: Array<MetricDataQuery>, StartTime: Date, EndTime: Date, NextToken: string, ScanBy: ScanBy, MaxDatapoints: number, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetMetricData?' + MetricDataQueries.map(z => `MetricDataQueries=${z}`).join('&') + '&StartTime=' + StartTime.toISOString() + '&EndTime=' + EndTime.toISOString() + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&ScanBy=' + ScanBy + '&MaxDatapoints=' + MaxDatapoints + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {Array<ExtendedStatistic>} ExtendedStatistics The percentile statistics. Specify values between p0.0 and p100. When calling <code>GetMetricStatistics</code>, you must specify either <code>Statistics</code> or <code>ExtendedStatistics</code>, but not both. Percentile statistics are not available for metrics when any of the metric values are negative numbers.
		 * @param {MetricDatumUnit} Unit The unit for a given metric. If you omit <code>Unit</code>, all data that was collected with any unit is returned, along with the corresponding units that were specified when the data was reported to CloudWatch. If you specify a unit, the operation returns only data data that was collected with that unit specified. If you specify a unit that does not match the data collected, the results of the operation are null. CloudWatch does not perform unit conversions.
		 * @return {void} Success
		 */
		GET_GetMetricStatistics(Namespace: string, MetricName: string, Dimensions: Array<Dimension>, StartTime: Date, EndTime: Date, Period: number, Statistics: Array<Statistic>, ExtendedStatistics: Array<ExtendedStatistic>, Unit: MetricDatumUnit, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetMetricStatistics?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&StartTime=' + StartTime.toISOString() + '&EndTime=' + EndTime.toISOString() + '&Period=' + Period + '&' + Statistics.map(z => `Statistics=${z}`).join('&') + '&' + ExtendedStatistics.map(z => `ExtendedStatistics=${z}`).join('&') + '&Unit=' + Unit + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetMetricWidgetImage(MetricWidget: string, OutputFormat: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=GetMetricWidgetImage?MetricWidget=' + (MetricWidget == null ? '' : encodeURIComponent(MetricWidget)) + '&OutputFormat=' + (OutputFormat == null ? '' : encodeURIComponent(OutputFormat)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListDashboards(DashboardNamePrefix: string, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListDashboards?DashboardNamePrefix=' + (DashboardNamePrefix == null ? '' : encodeURIComponent(DashboardNamePrefix)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListMetrics(Namespace: string, MetricName: string, Dimensions: Array<DimensionFilter>, NextToken: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=ListMetrics?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {string} Configuration <p>The configuration specifies details about how the anomaly detection model is to be trained, including time ranges to exclude when training and updating the model. You can specify as many as 10 time ranges.</p> <p>The configuration can also include the time zone to use for the metric.</p> <p>You can in</p>
		 * @return {void} Success
		 */
		GET_PutAnomalyDetector(Namespace: string, MetricName: string, Dimensions: Array<Dimension>, Stat: string, Configuration: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PutAnomalyDetector?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Stat=' + (Stat == null ? '' : encodeURIComponent(Stat)) + '&Configuration=' + (Configuration == null ? '' : encodeURIComponent(Configuration)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @param {Array<ResourceName>} AlarmActions <p>The actions to execute when this alarm transitions to the <code>ALARM</code> state from any other state. Each action is specified as an Amazon Resource Name (ARN).</p> <p>Valid Values: <code>arn:aws:sns:<i>region</i>:<i>account-id</i>:<i>sns-topic-name</i> </code> </p>
		 ...
		 * @param {Array<ResourceName>} InsufficientDataActions <p>The actions to execute when this alarm transitions to the <code>INSUFFICIENT_DATA</code> state from any other state. Each action is specified as an Amazon Resource Name (ARN).</p> <p>Valid Values: <code>arn:aws:sns:<i>region</i>:<i>account-id</i>:<i>sns-topic-name</i> </code> </p>
		 * @param {Array<ResourceName>} OKActions <p>The actions to execute when this alarm transitions to an <code>OK</code> state from any other state. Each action is specified as an Amazon Resource Name (ARN).</p> <p>Valid Values: <code>arn:aws:sns:<i>region</i>:<i>account-id</i>:<i>sns-topic-name</i> </code> </p>
		 ...
		 * @return {void} Success
		 */
		GET_PutCompositeAlarm(ActionsEnabled: boolean, AlarmActions: Array<ResourceName>, AlarmDescription: string, AlarmName: string, AlarmRule: string, InsufficientDataActions: Array<ResourceName>, OKActions: Array<ResourceName>, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PutCompositeAlarm?ActionsEnabled=' + ActionsEnabled + '&' + AlarmActions.map(z => `AlarmActions=${z}`).join('&') + '&AlarmDescription=' + (AlarmDescription == null ? '' : encodeURIComponent(AlarmDescription)) + '&AlarmName=' + (AlarmName == null ? '' : encodeURIComponent(AlarmName)) + '&AlarmRule=' + (AlarmRule == null ? '' : encodeURIComponent(AlarmRule)) + '&' + InsufficientDataActions.map(z => `InsufficientDataActions=${z}`).join('&') + '&' + OKActions.map(z => `OKActions=${z}`).join('&') + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutDashboard(DashboardName: string, DashboardBody: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PutDashboard?DashboardName=' + (DashboardName == null ? '' : encodeURIComponent(DashboardName)) + '&DashboardBody=' + (DashboardBody == null ? '' : encodeURIComponent(DashboardBody)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutInsightRule(RuleName: string, RuleState: string, RuleDefinition: string, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PutInsightRule?RuleName=' + (RuleName == null ? '' : encodeURIComponent(RuleName)) + '&RuleState=' + (RuleState == null ? '' : encodeURIComponent(RuleState)) + '&RuleDefinition=' + (RuleDefinition == null ? '' : encodeURIComponent(RuleDefinition)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutMetricAlarm(AlarmName: string, AlarmDescription: string, ActionsEnabled: boolean, OKActions: Array<ResourceName>, AlarmActions: Array<ResourceName>, InsufficientDataActions: Array<ResourceName>, MetricName: string, Namespace: string, Statistic: Statistic, ExtendedStatistic: string, Dimensions: Array<Dimension>, Period: number, Unit: MetricDatumUnit, EvaluationPeriods: number, DatapointsToAlarm: number, Threshold: number, ComparisonOperator: ComparisonOperator, TreatMissingData: string, EvaluateLowSampleCountPercentile: string, Metrics: Array<MetricDataQuery>, Tags: Array<Tag>, ThresholdMetricId: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PutMetricAlarm?AlarmName=' + (AlarmName == null ? '' : encodeURIComponent(AlarmName)) + '&AlarmDescription=' + (AlarmDescription == null ? '' : encodeURIComponent(AlarmDescription)) + '&ActionsEnabled=' + ActionsEnabled + '&' + OKActions.map(z => `OKActions=${z}`).join('&') + '&' + AlarmActions.map(z => `AlarmActions=${z}`).join('&') + '&' + InsufficientDataActions.map(z => `InsufficientDataActions=${z}`).join('&') + '&MetricName=' + (MetricName == null ? '' : encodeURIComponent(MetricName)) + '&Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&Statistic=' + Statistic + '&ExtendedStatistic=' + (ExtendedStatistic == null ? '' : encodeURIComponent(ExtendedStatistic)) + '&' + Dimensions.map(z => `Dimensions=${z}`).join('&') + '&Period=' + Period + '&Unit=' + Unit + '&EvaluationPeriods=' + EvaluationPeriods + '&DatapointsToAlarm=' + DatapointsToAlarm + '&Threshold=' + Threshold + '&ComparisonOperator=' + ComparisonOperator + '&TreatMissingData=' + (TreatMissingData == null ? '' : encodeURIComponent(TreatMissingData)) + '&EvaluateLowSampleCountPercentile=' + (EvaluateLowSampleCountPercentile == null ? '' : encodeURIComponent(EvaluateLowSampleCountPercentile)) + '&' + Metrics.map(z => `Metrics=${z}`).join('&') + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&ThresholdMetricId=' + (ThresholdMetricId == null ? '' : encodeURIComponent(ThresholdMetricId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutMetricData(Namespace: string, MetricData: Array<MetricDatum>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=PutMetricData?Namespace=' + (Namespace == null ? '' : encodeURIComponent(Namespace)) + '&' + MetricData.map(z => `MetricData=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetAlarmState(AlarmName: string, StateValue: StateValue, StateReason: string, StateReasonData: string, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=SetAlarmState?AlarmName=' + (AlarmName == null ? '' : encodeURIComponent(AlarmName)) + '&StateValue=' + StateValue + '&StateReason=' + (StateReason == null ? '' : encodeURIComponent(StateReason)) + '&StateReasonData=' + (StateReasonData == null ? '' : encodeURIComponent(StateReasonData)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_TagResource(ResourceARN: string, Tags: Array<Tag>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=TagResource?ResourceARN=' + (ResourceARN == null ? '' : encodeURIComponent(ResourceARN)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		GET_UntagResource(ResourceARN: string, TagKeys: Array<TagKey>, Action: string, Version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.get('/#Action=UntagResource?ResourceARN=' + (ResourceARN == null ? '' : encodeURIComponent(ResourceARN)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), { headers: headersHandler ? headersHandler() : undefined });
		}
	}
