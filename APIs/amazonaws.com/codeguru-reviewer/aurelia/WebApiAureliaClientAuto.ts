...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateRepository(requestBody: AssociateRepositoryBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateRepositoryResponse> {
			return this.http.post('/associations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListRepositoryAssociations(ProviderType: Array<ProviderType>, State: Array<RepositoryAssociationState>, Name: Array<Name>, Owner: Array<Owner>, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRepositoryAssociationsResponse> {
			return this.http.get('/associations?' + ProviderType.map(z => `ProviderType=${z}`).join('&') + '&' + State.map(z => `State=${z}`).join('&') + '&' + Name.map(z => `Name=${z}`).join('&') + '&' + Owner.map(z => `Owner=${z}`).join('&') + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeCodeReview(CodeReviewArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCodeReviewResponse> {
			return this.http.get('/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRecommendationFeedback(CodeReviewArn: string, RecommendationId: string, UserId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecommendationFeedbackResponse> {
			return this.http.get('/feedback/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '#RecommendationId&RecommendationId=' + (RecommendationId == null ? '' : encodeURIComponent(RecommendationId)) + '&UserId=' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRepositoryAssociation(AssociationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRepositoryAssociationResponse> {
			return this.http.get('/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateRepository(AssociationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateRepositoryResponse> {
			return this.http.delete('/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListCodeReviews(ProviderTypes: Array<ProviderType>, States: Array<JobState>, RepositoryNames: Array<Name>, Type: Type, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListCodeReviewsResponse> {
			return this.http.get('/codereviews#Type?' + ProviderTypes.map(z => `ProviderTypes=${z}`).join('&') + '&' + States.map(z => `States=${z}`).join('&') + '&' + RepositoryNames.map(z => `RepositoryNames=${z}`).join('&') + '&Type=' + Type + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListRecommendations(NextToken: string, MaxResults: number, CodeReviewArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListRecommendationsResponse> {
			return this.http.get('/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '/Recommendations?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutRecommendationFeedback(requestBody: PutRecommendationFeedbackBody, headersHandler?: () => {[header: string]: string}): Promise<PutRecommendationFeedbackResponse> {
			return this.http.put('/feedback', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
