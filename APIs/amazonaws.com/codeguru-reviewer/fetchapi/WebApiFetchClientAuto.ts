export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AssociateRepository(requestBody: AssociateRepositoryBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateRepositoryResponse> {
			return fetch(this.baseUri + '/associations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRepositoryAssociations(ProviderType: Array<ProviderType>, State: Array<RepositoryAssociationState>, Name: Array<Name>, Owner: Array<Owner>, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRepositoryAssociationsResponse> {
			return fetch(this.baseUri + '/associations?' + ProviderType.map(z => `ProviderType=${z}`).join('&') + '&' + State.map(z => `State=${z}`).join('&') + '&' + Name.map(z => `Name=${z}`).join('&') + '&' + Owner.map(z => `Owner=${z}`).join('&') + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeCodeReview(CodeReviewArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCodeReviewResponse> {
			return fetch(this.baseUri + '/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRecommendationFeedback(CodeReviewArn: string, RecommendationId: string, UserId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecommendationFeedbackResponse> {
			return fetch(this.baseUri + '/feedback/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '#RecommendationId&RecommendationId=' + (RecommendationId == null ? '' : encodeURIComponent(RecommendationId)) + '&UserId=' + (UserId == null ? '' : encodeURIComponent(UserId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeRepositoryAssociation(AssociationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRepositoryAssociationResponse> {
			return fetch(this.baseUri + '/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DisassociateRepository(AssociationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateRepositoryResponse> {
			return fetch(this.baseUri + '/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListRecommendations(NextToken: string, MaxResults: number, CodeReviewArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListRecommendationsResponse> {
			return fetch(this.baseUri + '/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '/Recommendations?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutRecommendationFeedback(requestBody: PutRecommendationFeedbackBody, headersHandler?: () => {[header: string]: string}): Promise<PutRecommendationFeedbackResponse> {
			return fetch(this.baseUri + '/feedback', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
