...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateRepository(requestBody: AssociateRepositoryBody, headersHandler?: () => {[header: string]: string}): Promise<AssociateRepositoryResponse> {
			return Axios.post<AssociateRepositoryResponse>(this.baseUri + '/associations', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListRepositoryAssociations(ProviderType: Array<ProviderType>, State: Array<RepositoryAssociationState>, Name: Array<Name>, Owner: Array<Owner>, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListRepositoryAssociationsResponse> {
			return Axios.get<ListRepositoryAssociationsResponse>(this.baseUri + '/associations?' + ProviderType.map(z => `ProviderType=${z}`).join('&') + '&' + State.map(z => `State=${z}`).join('&') + '&' + Name.map(z => `Name=${z}`).join('&') + '&' + Owner.map(z => `Owner=${z}`).join('&') + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeCodeReview(CodeReviewArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeCodeReviewResponse> {
			return Axios.get<DescribeCodeReviewResponse>(this.baseUri + '/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeRecommendationFeedback(CodeReviewArn: string, RecommendationId: string, UserId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRecommendationFeedbackResponse> {
			return Axios.get<DescribeRecommendationFeedbackResponse>(this.baseUri + '/feedback/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '#RecommendationId&RecommendationId=' + (RecommendationId == null ? '' : encodeURIComponent(RecommendationId)) + '&UserId=' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeRepositoryAssociation(AssociationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeRepositoryAssociationResponse> {
			return Axios.get<DescribeRepositoryAssociationResponse>(this.baseUri + '/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DisassociateRepository(AssociationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DisassociateRepositoryResponse> {
			return Axios.delete<DisassociateRepositoryResponse>(this.baseUri + '/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListCodeReviews(ProviderTypes: Array<ProviderType>, States: Array<JobState>, RepositoryNames: Array<Name>, Type: Type, MaxResults: number, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListCodeReviewsResponse> {
			return Axios.get<ListCodeReviewsResponse>(this.baseUri + '/codereviews#Type?' + ProviderTypes.map(z => `ProviderTypes=${z}`).join('&') + '&' + States.map(z => `States=${z}`).join('&') + '&' + RepositoryNames.map(z => `RepositoryNames=${z}`).join('&') + '&Type=' + Type + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListRecommendationFeedback(NextToken: string, MaxResults: number, CodeReviewArn: string, UserIds: Array<UserId>, RecommendationIds: Array<RecommendationId>, headersHandler?: () => {[header: string]: string}): Promise<ListRecommendationFeedbackResponse> {
			return Axios.get<ListRecommendationFeedbackResponse>(this.baseUri + '/feedback/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '/RecommendationFeedback?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults + '&' + UserIds.map(z => `UserIds=${z}`).join('&') + '&' + RecommendationIds.map(z => `RecommendationIds=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListRecommendations(NextToken: string, MaxResults: number, CodeReviewArn: string, headersHandler?: () => {[header: string]: string}): Promise<ListRecommendationsResponse> {
			return Axios.get<ListRecommendationsResponse>(this.baseUri + '/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '/Recommendations?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		PutRecommendationFeedback(requestBody: PutRecommendationFeedbackBody, headersHandler?: () => {[header: string]: string}): Promise<PutRecommendationFeedbackResponse> {
			return Axios.put<PutRecommendationFeedbackResponse>(this.baseUri + '/feedback', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
