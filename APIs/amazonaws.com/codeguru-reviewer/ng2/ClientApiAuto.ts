...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AssociateRepository(requestBody: AssociateRepositoryBody, headersHandler?: () => HttpHeaders): Observable<AssociateRepositoryResponse> {
			return this.http.post<AssociateRepositoryResponse>(this.baseUri + '/associations', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListRepositoryAssociations(ProviderType: Array<ProviderType>, State: Array<RepositoryAssociationState>, Name: Array<Name>, Owner: Array<Owner>, MaxResults: number, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListRepositoryAssociationsResponse> {
		 ...
		 */
		DescribeCodeReview(CodeReviewArn: string, headersHandler?: () => HttpHeaders): Observable<DescribeCodeReviewResponse> {
			return this.http.get<DescribeCodeReviewResponse>(this.baseUri + '/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeRecommendationFeedback(CodeReviewArn: string, RecommendationId: string, UserId: string, headersHandler?: () => HttpHeaders): Observable<DescribeRecommendationFeedbackResponse> {
			return this.http.get<DescribeRecommendationFeedbackResponse>(this.baseUri + '/feedback/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '#RecommendationId&RecommendationId=' + (RecommendationId == null ? '' : encodeURIComponent(RecommendationId)) + '&UserId=' + (UserId == null ? '' : encodeURIComponent(UserId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeRepositoryAssociation(AssociationArn: string, headersHandler?: () => HttpHeaders): Observable<DescribeRepositoryAssociationResponse> {
			return this.http.get<DescribeRepositoryAssociationResponse>(this.baseUri + '/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DisassociateRepository(AssociationArn: string, headersHandler?: () => HttpHeaders): Observable<DisassociateRepositoryResponse> {
			return this.http.delete<DisassociateRepositoryResponse>(this.baseUri + '/associations/' + (AssociationArn == null ? '' : encodeURIComponent(AssociationArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListCodeReviews(ProviderTypes: Array<ProviderType>, States: Array<JobState>, RepositoryNames: Array<Name>, Type: Type, MaxResults: number, NextToken: string, headersHandler?: () => HttpHeaders): Observable<ListCodeReviewsResponse> {
			return this.http.get<ListCodeReviewsResponse>(this.baseUri + '/codereviews#Type?' + ProviderTypes.map(z => `ProviderTypes=${z}`).join('&') + '&' + States.map(z => `States=${z}`).join('&') + '&' + RepositoryNames.map(z => `RepositoryNames=${z}`).join('&') + '&Type=' + Type + '&MaxResults=' + MaxResults + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListRecommendationFeedback(NextToken: string, MaxResults: number, CodeReviewArn: string, UserIds: Array<UserId>, RecommendationIds: Array<RecommendationId>, headersHandler?: () => HttpHeaders): Observable<ListRecommendationFeedbackResponse> {
		 ...
		 */
		ListRecommendations(NextToken: string, MaxResults: number, CodeReviewArn: string, headersHandler?: () => HttpHeaders): Observable<ListRecommendationsResponse> {
			return this.http.get<ListRecommendationsResponse>(this.baseUri + '/codereviews/' + (CodeReviewArn == null ? '' : encodeURIComponent(CodeReviewArn)) + '/Recommendations?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)) + '&MaxResults=' + MaxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		PutRecommendationFeedback(requestBody: PutRecommendationFeedbackBody, headersHandler?: () => HttpHeaders): Observable<PutRecommendationFeedbackResponse> {
			return this.http.put<PutRecommendationFeedbackResponse>(this.baseUri + '/feedback', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
