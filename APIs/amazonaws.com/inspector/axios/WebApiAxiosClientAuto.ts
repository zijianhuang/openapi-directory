...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddAttributesToFindings(requestBody: AddAttributesToFindingsRequest, headersHandler?: () => {[header: string]: string}): Promise<AddAttributesToFindingsResponse> {
			return Axios.post<AddAttributesToFindingsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.AddAttributesToFindings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAssessmentTarget(requestBody: CreateAssessmentTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssessmentTargetResponse> {
			return Axios.post<CreateAssessmentTargetResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateAssessmentTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAssessmentTemplate(requestBody: CreateAssessmentTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssessmentTemplateResponse> {
			return Axios.post<CreateAssessmentTemplateResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateAssessmentTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateExclusionsPreview(requestBody: CreateExclusionsPreviewRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateExclusionsPreviewResponse> {
			return Axios.post<CreateExclusionsPreviewResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateExclusionsPreview', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateResourceGroup(requestBody: CreateResourceGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceGroupResponse> {
			return Axios.post<CreateResourceGroupResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateResourceGroup', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAssessmentRun(requestBody: DeleteAssessmentRunRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAssessmentTarget(requestBody: DeleteAssessmentTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAssessmentTemplate(requestBody: DeleteAssessmentTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentTemplate', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		DescribeAssessmentRuns(requestBody: DescribeAssessmentRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssessmentRunsResponse> {
			return Axios.post<DescribeAssessmentRunsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentRuns', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAssessmentTargets(requestBody: DescribeAssessmentTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssessmentTargetsResponse> {
			return Axios.post<DescribeAssessmentTargetsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentTargets', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAssessmentTemplates(requestBody: DescribeAssessmentTemplatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssessmentTemplatesResponse> {
			return Axios.post<DescribeAssessmentTemplatesResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentTemplates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeCrossAccountAccessRole(headersHandler?: () => {[header: string]: string}): Promise<DescribeCrossAccountAccessRoleResponse> {
			return Axios.post<DescribeCrossAccountAccessRoleResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeCrossAccountAccessRole', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeExclusions(requestBody: DescribeExclusionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExclusionsResponse> {
			return Axios.post<DescribeExclusionsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeExclusions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeFindings(requestBody: DescribeFindingsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFindingsResponse> {
			return Axios.post<DescribeFindingsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeFindings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeResourceGroups(requestBody: DescribeResourceGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourceGroupsResponse> {
			return Axios.post<DescribeResourceGroupsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeResourceGroups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeRulesPackages(requestBody: DescribeRulesPackagesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRulesPackagesResponse> {
			return Axios.post<DescribeRulesPackagesResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeRulesPackages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetAssessmentReport(requestBody: GetAssessmentReportRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAssessmentReportResponse> {
			return Axios.post<GetAssessmentReportResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.GetAssessmentReport', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetExclusionsPreview(maxResults: string, nextToken: string, requestBody: GetExclusionsPreviewRequest, headersHandler?: () => {[header: string]: string}): Promise<GetExclusionsPreviewResponse> {
			return Axios.post<GetExclusionsPreviewResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.GetExclusionsPreview?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTelemetryMetadata(requestBody: GetTelemetryMetadataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTelemetryMetadataResponse> {
			return Axios.post<GetTelemetryMetadataResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.GetTelemetryMetadata', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssessmentRunAgents(maxResults: string, nextToken: string, requestBody: ListAssessmentRunAgentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssessmentRunAgentsResponse> {
			return Axios.post<ListAssessmentRunAgentsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentRunAgents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssessmentTargets(maxResults: string, nextToken: string, requestBody: ListAssessmentTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssessmentTargetsResponse> {
			return Axios.post<ListAssessmentTargetsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentTargets?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListAssessmentTemplates(maxResults: string, nextToken: string, requestBody: ListAssessmentTemplatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssessmentTemplatesResponse> {
			return Axios.post<ListAssessmentTemplatesResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentTemplates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListEventSubscriptions(maxResults: string, nextToken: string, requestBody: ListEventSubscriptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventSubscriptionsResponse> {
			return Axios.post<ListEventSubscriptionsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListEventSubscriptions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListExclusions(maxResults: string, nextToken: string, requestBody: ListExclusionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListExclusionsResponse> {
			return Axios.post<ListExclusionsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListExclusions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return Axios.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PreviewAgents(maxResults: string, nextToken: string, requestBody: PreviewAgentsRequest, headersHandler?: () => {[header: string]: string}): Promise<PreviewAgentsResponse> {
			return Axios.post<PreviewAgentsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.PreviewAgents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		RegisterCrossAccountAccessRole(requestBody: RegisterCrossAccountAccessRoleRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.RegisterCrossAccountAccessRole', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		RemoveAttributesFromFindings(requestBody: RemoveAttributesFromFindingsRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveAttributesFromFindingsResponse> {
			return Axios.post<RemoveAttributesFromFindingsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.RemoveAttributesFromFindings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		SetTagsForResource(requestBody: SetTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.SetTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		StartAssessmentRun(requestBody: StartAssessmentRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartAssessmentRunResponse> {
			return Axios.post<StartAssessmentRunResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.StartAssessmentRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} Success
		 */
		StopAssessmentRun(requestBody: StopAssessmentRunRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.StopAssessmentRun', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SubscribeToEvent(requestBody: SubscribeToEventRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.SubscribeToEvent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UnsubscribeFromEvent(requestBody: UnsubscribeFromEventRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.UnsubscribeFromEvent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateAssessmentTarget(requestBody: UpdateAssessmentTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/#X-Amz-Target=InspectorService.UpdateAssessmentTarget', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
	}
