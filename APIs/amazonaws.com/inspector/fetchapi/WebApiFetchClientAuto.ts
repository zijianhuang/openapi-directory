export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddAttributesToFindings(requestBody: AddAttributesToFindingsRequest, headersHandler?: () => {[header: string]: string}): Promise<AddAttributesToFindingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.AddAttributesToFindings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAssessmentTarget(requestBody: CreateAssessmentTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssessmentTargetResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.CreateAssessmentTarget', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAssessmentTemplate(requestBody: CreateAssessmentTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAssessmentTemplateResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.CreateAssessmentTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateExclusionsPreview(requestBody: CreateExclusionsPreviewRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateExclusionsPreviewResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.CreateExclusionsPreview', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateResourceGroup(requestBody: CreateResourceGroupRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateResourceGroupResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.CreateResourceGroup', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteAssessmentRun(requestBody: DeleteAssessmentRunRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentRun', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteAssessmentTarget(requestBody: DeleteAssessmentTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentTarget', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteAssessmentTemplate(requestBody: DeleteAssessmentTemplateRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentTemplate', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DescribeAssessmentRuns(requestBody: DescribeAssessmentRunsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssessmentRunsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentRuns', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeAssessmentTargets(requestBody: DescribeAssessmentTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssessmentTargetsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentTargets', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeAssessmentTemplates(requestBody: DescribeAssessmentTemplatesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAssessmentTemplatesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentTemplates', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeCrossAccountAccessRole(headersHandler?: () => {[header: string]: string}): Promise<DescribeCrossAccountAccessRoleResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeCrossAccountAccessRole', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeExclusions(requestBody: DescribeExclusionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeExclusionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeExclusions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFindings(requestBody: DescribeFindingsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeFindingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeFindings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeResourceGroups(requestBody: DescribeResourceGroupsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeResourceGroupsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeResourceGroups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRulesPackages(requestBody: DescribeRulesPackagesRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeRulesPackagesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeRulesPackages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetAssessmentReport(requestBody: GetAssessmentReportRequest, headersHandler?: () => {[header: string]: string}): Promise<GetAssessmentReportResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.GetAssessmentReport', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetExclusionsPreview(maxResults: string, nextToken: string, requestBody: GetExclusionsPreviewRequest, headersHandler?: () => {[header: string]: string}): Promise<GetExclusionsPreviewResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.GetExclusionsPreview?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetTelemetryMetadata(requestBody: GetTelemetryMetadataRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTelemetryMetadataResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.GetTelemetryMetadata', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListAssessmentRunAgents(maxResults: string, nextToken: string, requestBody: ListAssessmentRunAgentsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssessmentRunAgentsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentRunAgents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListAssessmentTargets(maxResults: string, nextToken: string, requestBody: ListAssessmentTargetsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssessmentTargetsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentTargets?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListAssessmentTemplates(maxResults: string, nextToken: string, requestBody: ListAssessmentTemplatesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListAssessmentTemplatesResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentTemplates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListEventSubscriptions(maxResults: string, nextToken: string, requestBody: ListEventSubscriptionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListEventSubscriptionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.ListEventSubscriptions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListExclusions(maxResults: string, nextToken: string, requestBody: ListExclusionsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListExclusionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.ListExclusions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.ListTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PreviewAgents(maxResults: string, nextToken: string, requestBody: PreviewAgentsRequest, headersHandler?: () => {[header: string]: string}): Promise<PreviewAgentsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.PreviewAgents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterCrossAccountAccessRole(requestBody: RegisterCrossAccountAccessRoleRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.RegisterCrossAccountAccessRole', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		RemoveAttributesFromFindings(requestBody: RemoveAttributesFromFindingsRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveAttributesFromFindingsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.RemoveAttributesFromFindings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SetTagsForResource(requestBody: SetTagsForResourceRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.SetTagsForResource', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		StartAssessmentRun(requestBody: StartAssessmentRunRequest, headersHandler?: () => {[header: string]: string}): Promise<StartAssessmentRunResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.StartAssessmentRun', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StopAssessmentRun(requestBody: StopAssessmentRunRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.StopAssessmentRun', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		SubscribeToEvent(requestBody: SubscribeToEventRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.SubscribeToEvent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UnsubscribeFromEvent(requestBody: UnsubscribeFromEventRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.UnsubscribeFromEvent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UpdateAssessmentTarget(requestBody: UpdateAssessmentTargetRequest, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/#X-Amz-Target=InspectorService.UpdateAssessmentTarget', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
	}
