...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddAttributesToFindings(requestBody: AddAttributesToFindingsRequest, headersHandler?: () => HttpHeaders): Observable<AddAttributesToFindingsResponse> {
			return this.http.post<AddAttributesToFindingsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.AddAttributesToFindings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAssessmentTarget(requestBody: CreateAssessmentTargetRequest, headersHandler?: () => HttpHeaders): Observable<CreateAssessmentTargetResponse> {
			return this.http.post<CreateAssessmentTargetResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateAssessmentTarget', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAssessmentTemplate(requestBody: CreateAssessmentTemplateRequest, headersHandler?: () => HttpHeaders): Observable<CreateAssessmentTemplateResponse> {
			return this.http.post<CreateAssessmentTemplateResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateAssessmentTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateExclusionsPreview(requestBody: CreateExclusionsPreviewRequest, headersHandler?: () => HttpHeaders): Observable<CreateExclusionsPreviewResponse> {
			return this.http.post<CreateExclusionsPreviewResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateExclusionsPreview', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateResourceGroup(requestBody: CreateResourceGroupRequest, headersHandler?: () => HttpHeaders): Observable<CreateResourceGroupResponse> {
			return this.http.post<CreateResourceGroupResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.CreateResourceGroup', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAssessmentRun(requestBody: DeleteAssessmentRunRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentRun', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAssessmentTarget(requestBody: DeleteAssessmentTargetRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentTarget', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		DeleteAssessmentTemplate(requestBody: DeleteAssessmentTemplateRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.DeleteAssessmentTemplate', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		DescribeAssessmentRuns(requestBody: DescribeAssessmentRunsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAssessmentRunsResponse> {
			return this.http.post<DescribeAssessmentRunsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentRuns', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAssessmentTargets(requestBody: DescribeAssessmentTargetsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAssessmentTargetsResponse> {
			return this.http.post<DescribeAssessmentTargetsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentTargets', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAssessmentTemplates(requestBody: DescribeAssessmentTemplatesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAssessmentTemplatesResponse> {
			return this.http.post<DescribeAssessmentTemplatesResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeAssessmentTemplates', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCrossAccountAccessRole(headersHandler?: () => HttpHeaders): Observable<DescribeCrossAccountAccessRoleResponse> {
			return this.http.post<DescribeCrossAccountAccessRoleResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeCrossAccountAccessRole', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeExclusions(requestBody: DescribeExclusionsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeExclusionsResponse> {
			return this.http.post<DescribeExclusionsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeExclusions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeFindings(requestBody: DescribeFindingsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeFindingsResponse> {
			return this.http.post<DescribeFindingsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeFindings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeResourceGroups(requestBody: DescribeResourceGroupsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeResourceGroupsResponse> {
			return this.http.post<DescribeResourceGroupsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeResourceGroups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRulesPackages(requestBody: DescribeRulesPackagesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeRulesPackagesResponse> {
			return this.http.post<DescribeRulesPackagesResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.DescribeRulesPackages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetAssessmentReport(requestBody: GetAssessmentReportRequest, headersHandler?: () => HttpHeaders): Observable<GetAssessmentReportResponse> {
			return this.http.post<GetAssessmentReportResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.GetAssessmentReport', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetExclusionsPreview(maxResults: string, nextToken: string, requestBody: GetExclusionsPreviewRequest, headersHandler?: () => HttpHeaders): Observable<GetExclusionsPreviewResponse> {
			return this.http.post<GetExclusionsPreviewResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.GetExclusionsPreview?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetTelemetryMetadata(requestBody: GetTelemetryMetadataRequest, headersHandler?: () => HttpHeaders): Observable<GetTelemetryMetadataResponse> {
			return this.http.post<GetTelemetryMetadataResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.GetTelemetryMetadata', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAssessmentRunAgents(maxResults: string, nextToken: string, requestBody: ListAssessmentRunAgentsRequest, headersHandler?: () => HttpHeaders): Observable<ListAssessmentRunAgentsResponse> {
			return this.http.post<ListAssessmentRunAgentsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentRunAgents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAssessmentTargets(maxResults: string, nextToken: string, requestBody: ListAssessmentTargetsRequest, headersHandler?: () => HttpHeaders): Observable<ListAssessmentTargetsResponse> {
			return this.http.post<ListAssessmentTargetsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentTargets?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListAssessmentTemplates(maxResults: string, nextToken: string, requestBody: ListAssessmentTemplatesRequest, headersHandler?: () => HttpHeaders): Observable<ListAssessmentTemplatesResponse> {
			return this.http.post<ListAssessmentTemplatesResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListAssessmentTemplates?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListEventSubscriptions(maxResults: string, nextToken: string, requestBody: ListEventSubscriptionsRequest, headersHandler?: () => HttpHeaders): Observable<ListEventSubscriptionsResponse> {
			return this.http.post<ListEventSubscriptionsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListEventSubscriptions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListExclusions(maxResults: string, nextToken: string, requestBody: ListExclusionsRequest, headersHandler?: () => HttpHeaders): Observable<ListExclusionsResponse> {
			return this.http.post<ListExclusionsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListExclusions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFindings(maxResults: string, nextToken: string, requestBody: ListFindingsRequest, headersHandler?: () => HttpHeaders): Observable<ListFindingsResponse> {
			return this.http.post<ListFindingsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListFindings?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceResponse> {
			return this.http.post<ListTagsForResourceResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PreviewAgents(maxResults: string, nextToken: string, requestBody: PreviewAgentsRequest, headersHandler?: () => HttpHeaders): Observable<PreviewAgentsResponse> {
			return this.http.post<PreviewAgentsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.PreviewAgents?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		RegisterCrossAccountAccessRole(requestBody: RegisterCrossAccountAccessRoleRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.RegisterCrossAccountAccessRole', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		RemoveAttributesFromFindings(requestBody: RemoveAttributesFromFindingsRequest, headersHandler?: () => HttpHeaders): Observable<RemoveAttributesFromFindingsResponse> {
			return this.http.post<RemoveAttributesFromFindingsResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.RemoveAttributesFromFindings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		SetTagsForResource(requestBody: SetTagsForResourceRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.SetTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		StartAssessmentRun(requestBody: StartAssessmentRunRequest, headersHandler?: () => HttpHeaders): Observable<StartAssessmentRunResponse> {
			return this.http.post<StartAssessmentRunResponse>(this.baseUri + '/#X-Amz-Target=InspectorService.StartAssessmentRun', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} Success
		 */
		StopAssessmentRun(requestBody: StopAssessmentRunRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.StopAssessmentRun', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		SubscribeToEvent(requestBody: SubscribeToEventRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.SubscribeToEvent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UnsubscribeFromEvent(requestBody: UnsubscribeFromEventRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.UnsubscribeFromEvent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} Success
		 */
		UpdateAssessmentTarget(requestBody: UpdateAssessmentTargetRequest, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/#X-Amz-Target=InspectorService.UpdateAssessmentTarget', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
	}
