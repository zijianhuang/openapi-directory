...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateMesh(requestBody: CreateMeshBody, headersHandler?: () => HttpHeaders): Observable<CreateMeshOutput> {
			return this.http.put<CreateMeshOutput>(this.baseUri + '/v20190125/meshes', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListMeshes(limit: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListMeshesOutput> {
			return this.http.get<ListMeshesOutput>(this.baseUri + '/v20190125/meshes?limit=' + limit + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateRoute(meshName: string, meshOwner: string, virtualRouterName: string, requestBody: CreateRouteBody, headersHandler?: () => HttpHeaders): Observable<CreateRouteOutput> {
			return this.http.put<CreateRouteOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListRoutes(limit: number, meshName: string, meshOwner: string, nextToken: string, virtualRouterName: string, headersHandler?: () => HttpHeaders): Observable<ListRoutesOutput> {
		 ...
		 */
		CreateVirtualNode(meshName: string, meshOwner: string, requestBody: CreateVirtualNodeBody, headersHandler?: () => HttpHeaders): Observable<CreateVirtualNodeOutput> {
			return this.http.put<CreateVirtualNodeOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListVirtualNodes(limit: number, meshName: string, meshOwner: string, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListVirtualNodesOutput> {
			return this.http.get<ListVirtualNodesOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes?limit=' + limit + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateVirtualRouter(meshName: string, meshOwner: string, requestBody: CreateVirtualRouterBody, headersHandler?: () => HttpHeaders): Observable<CreateVirtualRouterOutput> {
			return this.http.put<CreateVirtualRouterOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListVirtualRouters(limit: number, meshName: string, meshOwner: string, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListVirtualRoutersOutput> {
			return this.http.get<ListVirtualRoutersOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters?limit=' + limit + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateVirtualService(meshName: string, meshOwner: string, requestBody: CreateVirtualServiceBody, headersHandler?: () => HttpHeaders): Observable<CreateVirtualServiceOutput> {
			return this.http.put<CreateVirtualServiceOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListVirtualServices(limit: number, meshName: string, meshOwner: string, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListVirtualServicesOutput> {
			return this.http.get<ListVirtualServicesOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices?limit=' + limit + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteMesh(meshName: string, headersHandler?: () => HttpHeaders): Observable<DeleteMeshOutput> {
			return this.http.delete<DeleteMeshOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeMesh(meshName: string, meshOwner: string, headersHandler?: () => HttpHeaders): Observable<DescribeMeshOutput> {
			return this.http.get<DescribeMeshOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateMesh(meshName: string, requestBody: UpdateMeshBody, headersHandler?: () => HttpHeaders): Observable<UpdateMeshOutput> {
			return this.http.put<UpdateMeshOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRoute(meshName: string, meshOwner: string, routeName: string, virtualRouterName: string, headersHandler?: () => HttpHeaders): Observable<DescribeRouteOutput> {
			return this.http.get<DescribeRouteOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes/' + (routeName == null ? '' : encodeURIComponent(routeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateRoute(meshName: string, meshOwner: string, routeName: string, virtualRouterName: string, requestBody: UpdateRouteBody, headersHandler?: () => HttpHeaders): Observable<UpdateRouteOutput> {
			return this.http.put<UpdateRouteOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes/' + (routeName == null ? '' : encodeURIComponent(routeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteVirtualNode(meshName: string, meshOwner: string, virtualNodeName: string, headersHandler?: () => HttpHeaders): Observable<DeleteVirtualNodeOutput> {
			return this.http.delete<DeleteVirtualNodeOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes/' + (virtualNodeName == null ? '' : encodeURIComponent(virtualNodeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeVirtualNode(meshName: string, meshOwner: string, virtualNodeName: string, headersHandler?: () => HttpHeaders): Observable<DescribeVirtualNodeOutput> {
			return this.http.get<DescribeVirtualNodeOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes/' + (virtualNodeName == null ? '' : encodeURIComponent(virtualNodeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateVirtualNode(meshName: string, meshOwner: string, virtualNodeName: string, requestBody: UpdateVirtualNodeBody, headersHandler?: () => HttpHeaders): Observable<UpdateVirtualNodeOutput> {
			return this.http.put<UpdateVirtualNodeOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes/' + (virtualNodeName == null ? '' : encodeURIComponent(virtualNodeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteVirtualRouter(meshName: string, meshOwner: string, virtualRouterName: string, headersHandler?: () => HttpHeaders): Observable<DeleteVirtualRouterOutput> {
			return this.http.delete<DeleteVirtualRouterOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeVirtualRouter(meshName: string, meshOwner: string, virtualRouterName: string, headersHandler?: () => HttpHeaders): Observable<DescribeVirtualRouterOutput> {
			return this.http.get<DescribeVirtualRouterOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateVirtualRouter(meshName: string, meshOwner: string, virtualRouterName: string, requestBody: UpdateVirtualRouterBody, headersHandler?: () => HttpHeaders): Observable<UpdateVirtualRouterOutput> {
			return this.http.put<UpdateVirtualRouterOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteVirtualService(meshName: string, meshOwner: string, virtualServiceName: string, headersHandler?: () => HttpHeaders): Observable<DeleteVirtualServiceOutput> {
			return this.http.delete<DeleteVirtualServiceOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices/' + (virtualServiceName == null ? '' : encodeURIComponent(virtualServiceName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeVirtualService(meshName: string, meshOwner: string, virtualServiceName: string, headersHandler?: () => HttpHeaders): Observable<DescribeVirtualServiceOutput> {
			return this.http.get<DescribeVirtualServiceOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices/' + (virtualServiceName == null ? '' : encodeURIComponent(virtualServiceName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateVirtualService(meshName: string, meshOwner: string, virtualServiceName: string, requestBody: UpdateVirtualServiceBody, headersHandler?: () => HttpHeaders): Observable<UpdateVirtualServiceOutput> {
			return this.http.put<UpdateVirtualServiceOutput>(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices/' + (virtualServiceName == null ? '' : encodeURIComponent(virtualServiceName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForResource(limit: number, nextToken: string, resourceArn: string, headersHandler?: () => HttpHeaders): Observable<ListTagsForResourceOutput> {
			return this.http.get<ListTagsForResourceOutput>(this.baseUri + '/v20190125/tags#resourceArn?limit=' + limit + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<TagResourceOutput> {
			return this.http.put<TagResourceOutput>(this.baseUri + '/v20190125/tag#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UntagResource(resourceArn: string, requestBody: UntagResourceBody, headersHandler?: () => HttpHeaders): Observable<UntagResourceOutput> {
			return this.http.put<UntagResourceOutput>(this.baseUri + '/v20190125/untag#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
