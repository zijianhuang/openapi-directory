...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CreateMesh(callback: (data : CreateMeshOutput) => any, requestBody: CreateMeshBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListMeshes(limit: number, nextToken: string, callback: (data : ListMeshesOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes?limit=' + limit + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateRoute(meshName: string, meshOwner: string, virtualRouterName: string, callback: (data : CreateRouteOutput) => any, requestBody: CreateRouteBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListRoutes(limit: number, meshName: string, meshOwner: string, nextToken: string, virtualRouterName: string, callback: (data : ListRoutesOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes?limit=' + limit + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateVirtualNode(meshName: string, meshOwner: string, callback: (data : CreateVirtualNodeOutput) => any, requestBody: CreateVirtualNodeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListVirtualNodes(limit: number, meshName: string, meshOwner: string, nextToken: string, callback: (data : ListVirtualNodesOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes?limit=' + limit + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateVirtualRouter(meshName: string, meshOwner: string, callback: (data : CreateVirtualRouterOutput) => any, requestBody: CreateVirtualRouterBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListVirtualRouters(limit: number, meshName: string, meshOwner: string, nextToken: string, callback: (data : ListVirtualRoutersOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters?limit=' + limit + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateVirtualService(meshName: string, meshOwner: string, callback: (data : CreateVirtualServiceOutput) => any, requestBody: CreateVirtualServiceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListVirtualServices(limit: number, meshName: string, meshOwner: string, nextToken: string, callback: (data : ListVirtualServicesOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices?limit=' + limit + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteMesh(meshName: string, callback: (data : DeleteMeshOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeMesh(meshName: string, meshOwner: string, callback: (data : DescribeMeshOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateMesh(meshName: string, callback: (data : UpdateMeshOutput) => any, requestBody: UpdateMeshBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteRoute(meshName: string, meshOwner: string, routeName: string, virtualRouterName: string, callback: (data : DeleteRouteOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes/' + (routeName == null ? '' : encodeURIComponent(routeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeRoute(meshName: string, meshOwner: string, routeName: string, virtualRouterName: string, callback: (data : DescribeRouteOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes/' + (routeName == null ? '' : encodeURIComponent(routeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateRoute(meshName: string, meshOwner: string, routeName: string, virtualRouterName: string, callback: (data : UpdateRouteOutput) => any, requestBody: UpdateRouteBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouter/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '/routes/' + (routeName == null ? '' : encodeURIComponent(routeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteVirtualNode(meshName: string, meshOwner: string, virtualNodeName: string, callback: (data : DeleteVirtualNodeOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes/' + (virtualNodeName == null ? '' : encodeURIComponent(virtualNodeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeVirtualNode(meshName: string, meshOwner: string, virtualNodeName: string, callback: (data : DescribeVirtualNodeOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes/' + (virtualNodeName == null ? '' : encodeURIComponent(virtualNodeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateVirtualNode(meshName: string, meshOwner: string, virtualNodeName: string, callback: (data : UpdateVirtualNodeOutput) => any, requestBody: UpdateVirtualNodeBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualNodes/' + (virtualNodeName == null ? '' : encodeURIComponent(virtualNodeName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteVirtualRouter(meshName: string, meshOwner: string, virtualRouterName: string, callback: (data : DeleteVirtualRouterOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeVirtualRouter(meshName: string, meshOwner: string, virtualRouterName: string, callback: (data : DescribeVirtualRouterOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateVirtualRouter(meshName: string, meshOwner: string, virtualRouterName: string, callback: (data : UpdateVirtualRouterOutput) => any, requestBody: UpdateVirtualRouterBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualRouters/' + (virtualRouterName == null ? '' : encodeURIComponent(virtualRouterName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteVirtualService(meshName: string, meshOwner: string, virtualServiceName: string, callback: (data : DeleteVirtualServiceOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices/' + (virtualServiceName == null ? '' : encodeURIComponent(virtualServiceName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeVirtualService(meshName: string, meshOwner: string, virtualServiceName: string, callback: (data : DescribeVirtualServiceOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices/' + (virtualServiceName == null ? '' : encodeURIComponent(virtualServiceName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateVirtualService(meshName: string, meshOwner: string, virtualServiceName: string, callback: (data : UpdateVirtualServiceOutput) => any, requestBody: UpdateVirtualServiceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/meshes/' + (meshName == null ? '' : encodeURIComponent(meshName)) + '/virtualServices/' + (virtualServiceName == null ? '' : encodeURIComponent(virtualServiceName)) + '&meshOwner=' + (meshOwner == null ? '' : encodeURIComponent(meshOwner)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListTagsForResource(limit: number, nextToken: string, resourceArn: string, callback: (data : ListTagsForResourceOutput) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/v20190125/tags#resourceArn?limit=' + limit + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		TagResource(resourceArn: string, callback: (data : TagResourceOutput) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/tag#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UntagResource(resourceArn: string, callback: (data : UntagResourceOutput) => any, requestBody: UntagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + '/v20190125/untag#resourceArn?resourceArn=' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
