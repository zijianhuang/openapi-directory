...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AuthorizeCacheSecurityGroupIngress(CacheSecurityGroupName: string, EC2SecurityGroupName: string, EC2SecurityGroupOwnerId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AuthorizeCacheSecurityGroupIngress?CacheSecurityGroupName=' + (CacheSecurityGroupName == null ? '' : encodeURIComponent(CacheSecurityGroupName)) + '&EC2SecurityGroupName=' + (EC2SecurityGroupName == null ? '' : encodeURIComponent(EC2SecurityGroupName)) + '&EC2SecurityGroupOwnerId=' + (EC2SecurityGroupOwnerId == null ? '' : encodeURIComponent(EC2SecurityGroupOwnerId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_BatchApplyUpdateAction(ReplicationGroupIds: Array<String>, CacheClusterIds: Array<String>, ServiceUpdateName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=BatchApplyUpdateAction?' + ReplicationGroupIds.map(z => `ReplicationGroupIds=${z}`).join('&') + '&' + CacheClusterIds.map(z => `CacheClusterIds=${z}`).join('&') + '&ServiceUpdateName=' + (ServiceUpdateName == null ? '' : encodeURIComponent(ServiceUpdateName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_BatchStopUpdateAction(ReplicationGroupIds: Array<String>, CacheClusterIds: Array<String>, ServiceUpdateName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_CompleteMigration(ReplicationGroupId: string, Force: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CompleteMigration?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&Force=' + Force + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CopySnapshot(SourceSnapshotName: string, TargetSnapshotName: string, TargetBucket: string, KmsKeyId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CopySnapshot?SourceSnapshotName=' + (SourceSnapshotName == null ? '' : encodeURIComponent(SourceSnapshotName)) + '&TargetSnapshotName=' + (TargetSnapshotName == null ? '' : encodeURIComponent(TargetSnapshotName)) + '&TargetBucket=' + (TargetBucket == null ? '' : encodeURIComponent(TargetBucket)) + '&KmsKeyId=' + (KmsKeyId == null ? '' : encodeURIComponent(KmsKeyId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateCacheParameterGroup(CacheParameterGroupName: string, CacheParameterGroupFamily: string, Description: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateCacheParameterGroup?CacheParameterGroupName=' + (CacheParameterGroupName == null ? '' : encodeURIComponent(CacheParameterGroupName)) + '&CacheParameterGroupFamily=' + (CacheParameterGroupFamily == null ? '' : encodeURIComponent(CacheParameterGroupFamily)) + '&Description=' + (Description == null ? '' : encodeURIComponent(Description)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateCacheSecurityGroup(CacheSecurityGroupName: string, Description: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateCacheSecurityGroup?CacheSecurityGroupName=' + (CacheSecurityGroupName == null ? '' : encodeURIComponent(CacheSecurityGroupName)) + '&Description=' + (Description == null ? '' : encodeURIComponent(Description)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateCacheSubnetGroup(CacheSubnetGroupName: string, CacheSubnetGroupDescription: string, SubnetIds: Array<String>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateCacheSubnetGroup?CacheSubnetGroupName=' + (CacheSubnetGroupName == null ? '' : encodeURIComponent(CacheSubnetGroupName)) + '&CacheSubnetGroupDescription=' + (CacheSubnetGroupDescription == null ? '' : encodeURIComponent(CacheSubnetGroupDescription)) + '&' + SubnetIds.map(z => `SubnetIds=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateGlobalReplicationGroup(GlobalReplicationGroupIdSuffix: string, GlobalReplicationGroupDescription: string, PrimaryReplicationGroupId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateGlobalReplicationGroup?GlobalReplicationGroupIdSuffix=' + (GlobalReplicationGroupIdSuffix == null ? '' : encodeURIComponent(GlobalReplicationGroupIdSuffix)) + '&GlobalReplicationGroupDescription=' + (GlobalReplicationGroupDescription == null ? '' : encodeURIComponent(GlobalReplicationGroupDescription)) + '&PrimaryReplicationGroupId=' + (PrimaryReplicationGroupId == null ? '' : encodeURIComponent(PrimaryReplicationGroupId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateSnapshot(ReplicationGroupId: string, CacheClusterId: string, SnapshotName: string, KmsKeyId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateSnapshot?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&CacheClusterId=' + (CacheClusterId == null ? '' : encodeURIComponent(CacheClusterId)) + '&SnapshotName=' + (SnapshotName == null ? '' : encodeURIComponent(SnapshotName)) + '&KmsKeyId=' + (KmsKeyId == null ? '' : encodeURIComponent(KmsKeyId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DecreaseNodeGroupsInGlobalReplicationGroup(GlobalReplicationGroupId: string, NodeGroupCount: number, GlobalNodeGroupsToRemove: Array<String>, GlobalNodeGroupsToRetain: Array<String>, ApplyImmediately: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DecreaseNodeGroupsInGlobalReplicationGroup?GlobalReplicationGroupId=' + (GlobalReplicationGroupId == null ? '' : encodeURIComponent(GlobalReplicationGroupId)) + '&NodeGroupCount=' + NodeGroupCount + '&' + GlobalNodeGroupsToRemove.map(z => `GlobalNodeGroupsToRemove=${z}`).join('&') + '&' + GlobalNodeGroupsToRetain.map(z => `GlobalNodeGroupsToRetain=${z}`).join('&') + '&ApplyImmediately=' + ApplyImmediately + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DecreaseReplicaCount(ReplicationGroupId: string, NewReplicaCount: number, ReplicaConfiguration: Array<ConfigureShard>, ReplicasToRemove: Array<String>, ApplyImmediately: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DecreaseReplicaCount?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&NewReplicaCount=' + NewReplicaCount + '&' + ReplicaConfiguration.map(z => `ReplicaConfiguration=${z}`).join('&') + '&' + ReplicasToRemove.map(z => `ReplicasToRemove=${z}`).join('&') + '&ApplyImmediately=' + ApplyImmediately + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteCacheCluster(CacheClusterId: string, FinalSnapshotIdentifier: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteCacheCluster?CacheClusterId=' + (CacheClusterId == null ? '' : encodeURIComponent(CacheClusterId)) + '&FinalSnapshotIdentifier=' + (FinalSnapshotIdentifier == null ? '' : encodeURIComponent(FinalSnapshotIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteCacheParameterGroup(CacheParameterGroupName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteCacheParameterGroup?CacheParameterGroupName=' + (CacheParameterGroupName == null ? '' : encodeURIComponent(CacheParameterGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteCacheSecurityGroup(CacheSecurityGroupName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteCacheSecurityGroup?CacheSecurityGroupName=' + (CacheSecurityGroupName == null ? '' : encodeURIComponent(CacheSecurityGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteCacheSubnetGroup(CacheSubnetGroupName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteCacheSubnetGroup?CacheSubnetGroupName=' + (CacheSubnetGroupName == null ? '' : encodeURIComponent(CacheSubnetGroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteGlobalReplicationGroup(GlobalReplicationGroupId: string, RetainPrimaryReplicationGroup: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteGlobalReplicationGroup?GlobalReplicationGroupId=' + (GlobalReplicationGroupId == null ? '' : encodeURIComponent(GlobalReplicationGroupId)) + '&RetainPrimaryReplicationGroup=' + RetainPrimaryReplicationGroup + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteReplicationGroup(ReplicationGroupId: string, RetainPrimaryCluster: boolean, FinalSnapshotIdentifier: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteReplicationGroup?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&RetainPrimaryCluster=' + RetainPrimaryCluster + '&FinalSnapshotIdentifier=' + (FinalSnapshotIdentifier == null ? '' : encodeURIComponent(FinalSnapshotIdentifier)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteSnapshot(SnapshotName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteSnapshot?SnapshotName=' + (SnapshotName == null ? '' : encodeURIComponent(SnapshotName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeCacheClusters(CacheClusterId: string, MaxRecords: number, Marker: string, ShowCacheNodeInfo: boolean, ShowCacheClustersNotInReplicationGroups: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeCacheEngineVersions(Engine: string, EngineVersion: string, CacheParameterGroupFamily: string, MaxRecords: number, Marker: string, DefaultOnly: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeCacheEngineVersions?Engine=' + (Engine == null ? '' : encodeURIComponent(Engine)) + '&EngineVersion=' + (EngineVersion == null ? '' : encodeURIComponent(EngineVersion)) + '&CacheParameterGroupFamily=' + (CacheParameterGroupFamily == null ? '' : encodeURIComponent(CacheParameterGroupFamily)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&DefaultOnly=' + DefaultOnly + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeCacheParameterGroups(CacheParameterGroupName: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeCacheParameterGroups?CacheParameterGroupName=' + (CacheParameterGroupName == null ? '' : encodeURIComponent(CacheParameterGroupName)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeCacheParameters(CacheParameterGroupName: string, Source: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeCacheParameters?CacheParameterGroupName=' + (CacheParameterGroupName == null ? '' : encodeURIComponent(CacheParameterGroupName)) + '&Source=' + (Source == null ? '' : encodeURIComponent(Source)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeCacheSecurityGroups(CacheSecurityGroupName: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeCacheSecurityGroups?CacheSecurityGroupName=' + (CacheSecurityGroupName == null ? '' : encodeURIComponent(CacheSecurityGroupName)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeCacheSubnetGroups(CacheSubnetGroupName: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeCacheSubnetGroups?CacheSubnetGroupName=' + (CacheSubnetGroupName == null ? '' : encodeURIComponent(CacheSubnetGroupName)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeEngineDefaultParameters(CacheParameterGroupFamily: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeEngineDefaultParameters?CacheParameterGroupFamily=' + (CacheParameterGroupFamily == null ? '' : encodeURIComponent(CacheParameterGroupFamily)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeGlobalReplicationGroups(GlobalReplicationGroupId: string, MaxRecords: number, Marker: string, ShowMemberInfo: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeGlobalReplicationGroups?GlobalReplicationGroupId=' + (GlobalReplicationGroupId == null ? '' : encodeURIComponent(GlobalReplicationGroupId)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&ShowMemberInfo=' + ShowMemberInfo + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeReplicationGroups(ReplicationGroupId: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeReplicationGroups?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeReservedCacheNodes(ReservedCacheNodeId: string, ReservedCacheNodesOfferingId: string, CacheNodeType: string, Duration: string, ProductDescription: string, OfferingType: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeReservedCacheNodes?ReservedCacheNodeId=' + (ReservedCacheNodeId == null ? '' : encodeURIComponent(ReservedCacheNodeId)) + '&ReservedCacheNodesOfferingId=' + (ReservedCacheNodesOfferingId == null ? '' : encodeURIComponent(ReservedCacheNodesOfferingId)) + '&CacheNodeType=' + (CacheNodeType == null ? '' : encodeURIComponent(CacheNodeType)) + '&Duration=' + (Duration == null ? '' : encodeURIComponent(Duration)) + '&ProductDescription=' + (ProductDescription == null ? '' : encodeURIComponent(ProductDescription)) + '&OfferingType=' + (OfferingType == null ? '' : encodeURIComponent(OfferingType)) + '&MaxRecords=' + MaxRecords + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DescribeReservedCacheNodesOfferings(ReservedCacheNodesOfferingId: string, CacheNodeType: string, Duration: string, ProductDescription: string, OfferingType: string, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeServiceUpdates(ServiceUpdateName: string, ServiceUpdateStatus: Array<ServiceUpdateStatus>, MaxRecords: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_DescribeSnapshots(ReplicationGroupId: string, CacheClusterId: string, SnapshotName: string, SnapshotSource: string, Marker: string, MaxRecords: number, ShowNodeGroupConfig: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DescribeSnapshots?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&CacheClusterId=' + (CacheClusterId == null ? '' : encodeURIComponent(CacheClusterId)) + '&SnapshotName=' + (SnapshotName == null ? '' : encodeURIComponent(SnapshotName)) + '&SnapshotSource=' + (SnapshotSource == null ? '' : encodeURIComponent(SnapshotSource)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxRecords=' + MaxRecords + '&ShowNodeGroupConfig=' + ShowNodeGroupConfig + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DisassociateGlobalReplicationGroup(GlobalReplicationGroupId: string, ReplicationGroupId: string, ReplicationGroupRegion: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DisassociateGlobalReplicationGroup?GlobalReplicationGroupId=' + (GlobalReplicationGroupId == null ? '' : encodeURIComponent(GlobalReplicationGroupId)) + '&ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&ReplicationGroupRegion=' + (ReplicationGroupRegion == null ? '' : encodeURIComponent(ReplicationGroupRegion)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_FailoverGlobalReplicationGroup(GlobalReplicationGroupId: string, PrimaryRegion: string, PrimaryReplicationGroupId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=FailoverGlobalReplicationGroup?GlobalReplicationGroupId=' + (GlobalReplicationGroupId == null ? '' : encodeURIComponent(GlobalReplicationGroupId)) + '&PrimaryRegion=' + (PrimaryRegion == null ? '' : encodeURIComponent(PrimaryRegion)) + '&PrimaryReplicationGroupId=' + (PrimaryReplicationGroupId == null ? '' : encodeURIComponent(PrimaryReplicationGroupId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_IncreaseNodeGroupsInGlobalReplicationGroup(GlobalReplicationGroupId: string, NodeGroupCount: number, RegionalConfigurations: Array<RegionalConfiguration>, ApplyImmediately: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=IncreaseNodeGroupsInGlobalReplicationGroup?GlobalReplicationGroupId=' + (GlobalReplicationGroupId == null ? '' : encodeURIComponent(GlobalReplicationGroupId)) + '&NodeGroupCount=' + NodeGroupCount + '&' + RegionalConfigurations.map(z => `RegionalConfigurations=${z}`).join('&') + '&ApplyImmediately=' + ApplyImmediately + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_IncreaseReplicaCount(ReplicationGroupId: string, NewReplicaCount: number, ReplicaConfiguration: Array<ConfigureShard>, ApplyImmediately: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=IncreaseReplicaCount?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&NewReplicaCount=' + NewReplicaCount + '&' + ReplicaConfiguration.map(z => `ReplicaConfiguration=${z}`).join('&') + '&ApplyImmediately=' + ApplyImmediately + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListAllowedNodeTypeModifications(CacheClusterId: string, ReplicationGroupId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListAllowedNodeTypeModifications?CacheClusterId=' + (CacheClusterId == null ? '' : encodeURIComponent(CacheClusterId)) + '&ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListTagsForResource(ResourceName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListTagsForResource?ResourceName=' + (ResourceName == null ? '' : encodeURIComponent(ResourceName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ModifyCacheParameterGroup(CacheParameterGroupName: string, ParameterNameValues: Array<ParameterNameValue>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ModifyCacheParameterGroup?CacheParameterGroupName=' + (CacheParameterGroupName == null ? '' : encodeURIComponent(CacheParameterGroupName)) + '&' + ParameterNameValues.map(z => `ParameterNameValues=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ModifyCacheSubnetGroup(CacheSubnetGroupName: string, CacheSubnetGroupDescription: string, SubnetIds: Array<String>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_ModifyGlobalReplicationGroup(GlobalReplicationGroupId: string, ApplyImmediately: boolean, CacheNodeType: string, EngineVersion: string, GlobalReplicationGroupDescription: string, AutomaticFailoverEnabled: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_PurchaseReservedCacheNodesOffering(ReservedCacheNodesOfferingId: string, ReservedCacheNodeId: string, CacheNodeCount: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=PurchaseReservedCacheNodesOffering?ReservedCacheNodesOfferingId=' + (ReservedCacheNodesOfferingId == null ? '' : encodeURIComponent(ReservedCacheNodesOfferingId)) + '&ReservedCacheNodeId=' + (ReservedCacheNodeId == null ? '' : encodeURIComponent(ReservedCacheNodeId)) + '&CacheNodeCount=' + CacheNodeCount + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RebalanceSlotsInGlobalReplicationGroup(GlobalReplicationGroupId: string, ApplyImmediately: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RebalanceSlotsInGlobalReplicationGroup?GlobalReplicationGroupId=' + (GlobalReplicationGroupId == null ? '' : encodeURIComponent(GlobalReplicationGroupId)) + '&ApplyImmediately=' + ApplyImmediately + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RebootCacheCluster(CacheClusterId: string, CacheNodeIdsToReboot: Array<String>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RebootCacheCluster?CacheClusterId=' + (CacheClusterId == null ? '' : encodeURIComponent(CacheClusterId)) + '&' + CacheNodeIdsToReboot.map(z => `CacheNodeIdsToReboot=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ResetCacheParameterGroup(CacheParameterGroupName: string, ResetAllParameters: boolean, ParameterNameValues: Array<ParameterNameValue>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ResetCacheParameterGroup?CacheParameterGroupName=' + (CacheParameterGroupName == null ? '' : encodeURIComponent(CacheParameterGroupName)) + '&ResetAllParameters=' + ResetAllParameters + '&' + ParameterNameValues.map(z => `ParameterNameValues=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RevokeCacheSecurityGroupIngress(CacheSecurityGroupName: string, EC2SecurityGroupName: string, EC2SecurityGroupOwnerId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RevokeCacheSecurityGroupIngress?CacheSecurityGroupName=' + (CacheSecurityGroupName == null ? '' : encodeURIComponent(CacheSecurityGroupName)) + '&EC2SecurityGroupName=' + (EC2SecurityGroupName == null ? '' : encodeURIComponent(EC2SecurityGroupName)) + '&EC2SecurityGroupOwnerId=' + (EC2SecurityGroupOwnerId == null ? '' : encodeURIComponent(EC2SecurityGroupOwnerId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_TestFailover(ReplicationGroupId: string, NodeGroupId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=TestFailover?ReplicationGroupId=' + (ReplicationGroupId == null ? '' : encodeURIComponent(ReplicationGroupId)) + '&NodeGroupId=' + (NodeGroupId == null ? '' : encodeURIComponent(NodeGroupId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
	}
