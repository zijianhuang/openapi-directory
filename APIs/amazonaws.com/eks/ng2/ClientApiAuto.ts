...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCluster(requestBody: CreateClusterBody, headersHandler?: () => HttpHeaders): Observable<CreateClusterResponse> {
			return this.http.post<CreateClusterResponse>(this.baseUri + '/clusters', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListClusters(maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListClustersResponse> {
			return this.http.get<ListClustersResponse>(this.baseUri + '/clusters?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateFargateProfile(name: string, requestBody: CreateFargateProfileBody, headersHandler?: () => HttpHeaders): Observable<CreateFargateProfileResponse> {
			return this.http.post<CreateFargateProfileResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListFargateProfiles(name: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListFargateProfilesResponse> {
			return this.http.get<ListFargateProfilesResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		CreateNodegroup(name: string, requestBody: CreateNodegroupBody, headersHandler?: () => HttpHeaders): Observable<CreateNodegroupResponse> {
			return this.http.post<CreateNodegroupResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListNodegroups(name: string, maxResults: number, nextToken: string, headersHandler?: () => HttpHeaders): Observable<ListNodegroupsResponse> {
			return this.http.get<ListNodegroupsResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteCluster(name: string, headersHandler?: () => HttpHeaders): Observable<DeleteClusterResponse> {
			return this.http.delete<DeleteClusterResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeCluster(name: string, headersHandler?: () => HttpHeaders): Observable<DescribeClusterResponse> {
			return this.http.get<DescribeClusterResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteFargateProfile(name: string, fargateProfileName: string, headersHandler?: () => HttpHeaders): Observable<DeleteFargateProfileResponse> {
			return this.http.delete<DeleteFargateProfileResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeFargateProfile(name: string, fargateProfileName: string, headersHandler?: () => HttpHeaders): Observable<DescribeFargateProfileResponse> {
			return this.http.get<DescribeFargateProfileResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteNodegroup(name: string, nodegroupName: string, headersHandler?: () => HttpHeaders): Observable<DeleteNodegroupResponse> {
			return this.http.delete<DeleteNodegroupResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeNodegroup(name: string, nodegroupName: string, headersHandler?: () => HttpHeaders): Observable<DescribeNodegroupResponse> {
			return this.http.get<DescribeNodegroupResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeUpdate(name: string, updateId: string, nodegroupName: string, headersHandler?: () => HttpHeaders): Observable<DescribeUpdateResponse> {
			return this.http.get<DescribeUpdateResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates/' + (updateId == null ? '' : encodeURIComponent(updateId)) + '&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListUpdates(name: string, nodegroupName: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListUpdatesResponse> {
			return this.http.get<ListUpdatesResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateClusterVersion(name: string, requestBody: UpdateClusterVersionBody, headersHandler?: () => HttpHeaders): Observable<UpdateClusterVersionResponse> {
			return this.http.post<UpdateClusterVersionResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateClusterConfig(name: string, requestBody: UpdateClusterConfigBody, headersHandler?: () => HttpHeaders): Observable<UpdateClusterConfigResponse> {
			return this.http.post<UpdateClusterConfigResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/update-config', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateNodegroupConfig(name: string, nodegroupName: string, requestBody: UpdateNodegroupConfigBody, headersHandler?: () => HttpHeaders): Observable<UpdateNodegroupConfigResponse> {
			return this.http.post<UpdateNodegroupConfigResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '/update-config', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateNodegroupVersion(name: string, nodegroupName: string, requestBody: UpdateNodegroupVersionBody, headersHandler?: () => HttpHeaders): Observable<UpdateNodegroupVersionResponse> {
			return this.http.post<UpdateNodegroupVersionResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '/update-version', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
