...
export namespace My_Demo_Client {
	...
	export interface CreateNodegroupRequest {
		...
		amiType?: CreateNodegroupRequestAmiType;
	...
	export enum CreateNodegroupRequestAmiType { AL2_x86_64 = 0, AL2_x86_64_GPU = 1 }
	...
	export class DemoClient {
		...
		CreateCluster(requestBody: CreateClusterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResponse> {
			return Axios.post<CreateClusterResponse>(this.baseUri + '/clusters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListClusters(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListClustersResponse> {
			return Axios.get<ListClustersResponse>(this.baseUri + '/clusters?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateFargateProfile(name: string, requestBody: CreateFargateProfileBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFargateProfileResponse> {
			return Axios.post<CreateFargateProfileResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListFargateProfiles(name: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListFargateProfilesResponse> {
			return Axios.get<ListFargateProfilesResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		CreateNodegroup(name: string, requestBody: CreateNodegroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateNodegroupResponse> {
			return Axios.post<CreateNodegroupResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		ListNodegroups(name: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListNodegroupsResponse> {
			return Axios.get<ListNodegroupsResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteCluster(name: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteClusterResponse> {
			return Axios.delete<DeleteClusterResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeCluster(name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterResponse> {
			return Axios.get<DescribeClusterResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteFargateProfile(name: string, fargateProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFargateProfileResponse> {
			return Axios.delete<DeleteFargateProfileResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeFargateProfile(name: string, fargateProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeFargateProfileResponse> {
			return Axios.get<DescribeFargateProfileResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DeleteNodegroup(name: string, nodegroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteNodegroupResponse> {
			return Axios.delete<DeleteNodegroupResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeNodegroup(name: string, nodegroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeNodegroupResponse> {
			return Axios.get<DescribeNodegroupResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		DescribeUpdate(name: string, updateId: string, nodegroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUpdateResponse> {
			return Axios.get<DescribeUpdateResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates/' + (updateId == null ? '' : encodeURIComponent(updateId)) + '&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		ListUpdates(name: string, nodegroupName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListUpdatesResponse> {
			return Axios.get<ListUpdatesResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 */
		UpdateClusterVersion(name: string, requestBody: UpdateClusterVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterVersionResponse> {
			return Axios.post<UpdateClusterVersionResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @param {Array<TagKey>} tagKeys The keys of the tags to be removed.
		 ...
		 */
		UpdateClusterConfig(name: string, requestBody: UpdateClusterConfigBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterConfigResponse> {
			return Axios.post<UpdateClusterConfigResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/update-config', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateNodegroupConfig(name: string, nodegroupName: string, requestBody: UpdateNodegroupConfigBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateNodegroupConfigResponse> {
			return Axios.post<UpdateNodegroupConfigResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '/update-config', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 */
		UpdateNodegroupVersion(name: string, nodegroupName: string, requestBody: UpdateNodegroupVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateNodegroupVersionResponse> {
			return Axios.post<UpdateNodegroupVersionResponse>(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '/update-version', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
	...
	export interface CreateFargateProfileBody {
	...
	export interface CreateNodegroupBody {
		...
		amiType?: CreateNodegroupBodyAmiType;
	...
	export enum CreateNodegroupBodyAmiType { AL2_x86_64 = 0, AL2_x86_64_GPU = 1 }
	...
	export interface UpdateClusterVersionBody {
	...
	export interface UpdateClusterConfigBody {
	...
	export interface UpdateNodegroupConfigBody {
	...
	export interface UpdateNodegroupVersionBody {
