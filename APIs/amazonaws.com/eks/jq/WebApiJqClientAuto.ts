...
namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCluster(callback: (data : CreateClusterResponse) => any, requestBody: CreateClusterBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/clusters', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListClusters(maxResults: number, nextToken: string, callback: (data : ListClustersResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateFargateProfile(name: string, callback: (data : CreateFargateProfileResponse) => any, requestBody: CreateFargateProfileBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListFargateProfiles(name: string, maxResults: number, nextToken: string, callback: (data : ListFargateProfilesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		CreateNodegroup(name: string, callback: (data : CreateNodegroupResponse) => any, requestBody: CreateNodegroupBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListNodegroups(name: string, maxResults: number, nextToken: string, callback: (data : ListNodegroupsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteCluster(name: string, callback: (data : DeleteClusterResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeCluster(name: string, callback: (data : DescribeClusterResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteFargateProfile(name: string, fargateProfileName: string, callback: (data : DeleteFargateProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeFargateProfile(name: string, fargateProfileName: string, callback: (data : DescribeFargateProfileResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DeleteNodegroup(name: string, nodegroupName: string, callback: (data : DeleteNodegroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeNodegroup(name: string, nodegroupName: string, callback: (data : DescribeNodegroupResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeUpdate(name: string, updateId: string, nodegroupName: string, callback: (data : DescribeUpdateResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates/' + (updateId == null ? '' : encodeURIComponent(updateId)) + '&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListUpdates(name: string, nodegroupName: string, nextToken: string, maxResults: number, callback: (data : ListUpdatesResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateClusterVersion(name: string, callback: (data : UpdateClusterVersionResponse) => any, requestBody: UpdateClusterVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateClusterConfig(name: string, callback: (data : UpdateClusterConfigResponse) => any, requestBody: UpdateClusterConfigBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/update-config', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateNodegroupConfig(name: string, nodegroupName: string, callback: (data : UpdateNodegroupConfigResponse) => any, requestBody: UpdateNodegroupConfigBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '/update-config', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateNodegroupVersion(name: string, nodegroupName: string, callback: (data : UpdateNodegroupVersionResponse) => any, requestBody: UpdateNodegroupVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '/update-version', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
