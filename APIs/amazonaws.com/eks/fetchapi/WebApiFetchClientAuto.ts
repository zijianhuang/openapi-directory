export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCluster(requestBody: CreateClusterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResponse> {
			return fetch(this.baseUri + '/clusters', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListClusters(maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListClustersResponse> {
			return fetch(this.baseUri + '/clusters?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateFargateProfile(name: string, requestBody: CreateFargateProfileBody, headersHandler?: () => {[header: string]: string}): Promise<CreateFargateProfileResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListFargateProfiles(name: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListFargateProfilesResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateNodegroup(name: string, requestBody: CreateNodegroupBody, headersHandler?: () => {[header: string]: string}): Promise<CreateNodegroupResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListNodegroups(name: string, maxResults: number, nextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListNodegroupsResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteCluster(name: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteClusterResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeCluster(name: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteFargateProfile(name: string, fargateProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteFargateProfileResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeFargateProfile(name: string, fargateProfileName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeFargateProfileResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/fargate-profiles/' + (fargateProfileName == null ? '' : encodeURIComponent(fargateProfileName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteNodegroup(name: string, nodegroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteNodegroupResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeNodegroup(name: string, nodegroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeNodegroupResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeUpdate(name: string, updateId: string, nodegroupName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeUpdateResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates/' + (updateId == null ? '' : encodeURIComponent(updateId)) + '&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListUpdates(name: string, nodegroupName: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListUpdatesResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates&nodegroupName=' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UpdateClusterVersion(name: string, requestBody: UpdateClusterVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterVersionResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/updates', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateClusterConfig(name: string, requestBody: UpdateClusterConfigBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterConfigResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/update-config', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateNodegroupVersion(name: string, nodegroupName: string, requestBody: UpdateNodegroupVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateNodegroupVersionResponse> {
			return fetch(this.baseUri + '/clusters/' + (name == null ? '' : encodeURIComponent(name)) + '/node-groups/' + (nodegroupName == null ? '' : encodeURIComponent(nodegroupName)) + '/update-version', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
