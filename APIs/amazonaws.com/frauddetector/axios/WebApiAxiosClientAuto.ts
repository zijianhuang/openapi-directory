...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchCreateVariable(requestBody: BatchCreateVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchCreateVariableResult> {
			return Axios.post<BatchCreateVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchCreateVariable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		BatchGetVariable(requestBody: BatchGetVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetVariableResult> {
			return Axios.post<BatchGetVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchGetVariable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDetectorVersion(requestBody: CreateDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDetectorVersionResult> {
			return Axios.post<CreateDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateModelVersion(requestBody: CreateModelVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateModelVersionResult> {
			return Axios.post<CreateModelVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateModelVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRule(requestBody: CreateRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRuleResult> {
			return Axios.post<CreateRuleResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateRule', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateVariable(requestBody: CreateVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVariableResult> {
			return Axios.post<CreateVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateVariable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDetector(requestBody: DeleteDetectorRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDetectorResult> {
			return Axios.post<DeleteDetectorResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetector', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteDetectorVersion(requestBody: DeleteDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDetectorVersionResult> {
			return Axios.post<DeleteDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteEvent(requestBody: DeleteEventRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEventResult> {
			return Axios.post<DeleteEventResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteEvent', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRuleVersion(requestBody: DeleteRuleVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRuleVersionResult> {
			return Axios.post<DeleteRuleVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteRuleVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDetector(requestBody: DescribeDetectorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDetectorResult> {
			return Axios.post<DescribeDetectorResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeDetector', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeModelVersions(maxResults: string, nextToken: string, requestBody: DescribeModelVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeModelVersionsResult> {
			return Axios.post<DescribeModelVersionsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeModelVersions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDetectorVersion(requestBody: GetDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDetectorVersionResult> {
			return Axios.post<GetDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDetectors(maxResults: string, nextToken: string, requestBody: GetDetectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDetectorsResult> {
			return Axios.post<GetDetectorsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectors?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetExternalModels(maxResults: string, nextToken: string, requestBody: GetExternalModelsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetExternalModelsResult> {
			return Axios.post<GetExternalModelsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetExternalModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetModelVersion(requestBody: GetModelVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetModelVersionResult> {
			return Axios.post<GetModelVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModelVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetModels(maxResults: string, nextToken: string, requestBody: GetModelsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetModelsResult> {
			return Axios.post<GetModelsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOutcomes(maxResults: string, nextToken: string, requestBody: GetOutcomesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOutcomesResult> {
			return Axios.post<GetOutcomesResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetOutcomes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetPrediction(requestBody: GetPredictionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPredictionResult> {
			return Axios.post<GetPredictionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetPrediction', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetRules(maxResults: string, nextToken: string, requestBody: GetRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRulesResult> {
			return Axios.post<GetRulesResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetRules?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetVariables(maxResults: string, nextToken: string, requestBody: GetVariablesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVariablesResult> {
			return Axios.post<GetVariablesResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetVariables?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutDetector(requestBody: PutDetectorRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDetectorResult> {
			return Axios.post<PutDetectorResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutDetector', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutExternalModel(requestBody: PutExternalModelRequest, headersHandler?: () => {[header: string]: string}): Promise<PutExternalModelResult> {
			return Axios.post<PutExternalModelResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutExternalModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutModel(requestBody: PutModelRequest, headersHandler?: () => {[header: string]: string}): Promise<PutModelResult> {
			return Axios.post<PutModelResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutModel', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutOutcome(requestBody: PutOutcomeRequest, headersHandler?: () => {[header: string]: string}): Promise<PutOutcomeResult> {
			return Axios.post<PutOutcomeResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutOutcome', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDetectorVersion(requestBody: UpdateDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorVersionResult> {
			return Axios.post<UpdateDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDetectorVersionMetadata(requestBody: UpdateDetectorVersionMetadataRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorVersionMetadataResult> {
			return Axios.post<UpdateDetectorVersionMetadataResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionMetadata', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDetectorVersionStatus(requestBody: UpdateDetectorVersionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorVersionStatusResult> {
			return Axios.post<UpdateDetectorVersionStatusResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateModelVersion(requestBody: UpdateModelVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateModelVersionResult> {
			return Axios.post<UpdateModelVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateModelVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRuleMetadata(requestBody: UpdateRuleMetadataRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRuleMetadataResult> {
			return Axios.post<UpdateRuleMetadataResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleMetadata', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRuleVersion(requestBody: UpdateRuleVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRuleVersionResult> {
			return Axios.post<UpdateRuleVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateVariable(requestBody: UpdateVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVariableResult> {
			return Axios.post<UpdateVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateVariable', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
