...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchCreateVariable(requestBody: BatchCreateVariableRequest, headersHandler?: () => HttpHeaders): Observable<BatchCreateVariableResult> {
			return this.http.post<BatchCreateVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchCreateVariable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		BatchGetVariable(requestBody: BatchGetVariableRequest, headersHandler?: () => HttpHeaders): Observable<BatchGetVariableResult> {
			return this.http.post<BatchGetVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchGetVariable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDetectorVersion(requestBody: CreateDetectorVersionRequest, headersHandler?: () => HttpHeaders): Observable<CreateDetectorVersionResult> {
			return this.http.post<CreateDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateModelVersion(requestBody: CreateModelVersionRequest, headersHandler?: () => HttpHeaders): Observable<CreateModelVersionResult> {
			return this.http.post<CreateModelVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateModelVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateRule(requestBody: CreateRuleRequest, headersHandler?: () => HttpHeaders): Observable<CreateRuleResult> {
			return this.http.post<CreateRuleResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateRule', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateVariable(requestBody: CreateVariableRequest, headersHandler?: () => HttpHeaders): Observable<CreateVariableResult> {
			return this.http.post<CreateVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateVariable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDetector(requestBody: DeleteDetectorRequest, headersHandler?: () => HttpHeaders): Observable<DeleteDetectorResult> {
			return this.http.post<DeleteDetectorResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetector', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteDetectorVersion(requestBody: DeleteDetectorVersionRequest, headersHandler?: () => HttpHeaders): Observable<DeleteDetectorVersionResult> {
			return this.http.post<DeleteDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteEvent(requestBody: DeleteEventRequest, headersHandler?: () => HttpHeaders): Observable<DeleteEventResult> {
			return this.http.post<DeleteEventResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteEvent', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRuleVersion(requestBody: DeleteRuleVersionRequest, headersHandler?: () => HttpHeaders): Observable<DeleteRuleVersionResult> {
			return this.http.post<DeleteRuleVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteRuleVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDetector(requestBody: DescribeDetectorRequest, headersHandler?: () => HttpHeaders): Observable<DescribeDetectorResult> {
			return this.http.post<DescribeDetectorResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeDetector', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeModelVersions(maxResults: string, nextToken: string, requestBody: DescribeModelVersionsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeModelVersionsResult> {
			return this.http.post<DescribeModelVersionsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeModelVersions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDetectorVersion(requestBody: GetDetectorVersionRequest, headersHandler?: () => HttpHeaders): Observable<GetDetectorVersionResult> {
			return this.http.post<GetDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDetectors(maxResults: string, nextToken: string, requestBody: GetDetectorsRequest, headersHandler?: () => HttpHeaders): Observable<GetDetectorsResult> {
			return this.http.post<GetDetectorsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectors?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetExternalModels(maxResults: string, nextToken: string, requestBody: GetExternalModelsRequest, headersHandler?: () => HttpHeaders): Observable<GetExternalModelsResult> {
			return this.http.post<GetExternalModelsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetExternalModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetModelVersion(requestBody: GetModelVersionRequest, headersHandler?: () => HttpHeaders): Observable<GetModelVersionResult> {
			return this.http.post<GetModelVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModelVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetModels(maxResults: string, nextToken: string, requestBody: GetModelsRequest, headersHandler?: () => HttpHeaders): Observable<GetModelsResult> {
			return this.http.post<GetModelsResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetOutcomes(maxResults: string, nextToken: string, requestBody: GetOutcomesRequest, headersHandler?: () => HttpHeaders): Observable<GetOutcomesResult> {
			return this.http.post<GetOutcomesResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetOutcomes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetPrediction(requestBody: GetPredictionRequest, headersHandler?: () => HttpHeaders): Observable<GetPredictionResult> {
			return this.http.post<GetPredictionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetPrediction', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetRules(maxResults: string, nextToken: string, requestBody: GetRulesRequest, headersHandler?: () => HttpHeaders): Observable<GetRulesResult> {
			return this.http.post<GetRulesResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetRules?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetVariables(maxResults: string, nextToken: string, requestBody: GetVariablesRequest, headersHandler?: () => HttpHeaders): Observable<GetVariablesResult> {
			return this.http.post<GetVariablesResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetVariables?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutDetector(requestBody: PutDetectorRequest, headersHandler?: () => HttpHeaders): Observable<PutDetectorResult> {
			return this.http.post<PutDetectorResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutDetector', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutExternalModel(requestBody: PutExternalModelRequest, headersHandler?: () => HttpHeaders): Observable<PutExternalModelResult> {
			return this.http.post<PutExternalModelResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutExternalModel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutModel(requestBody: PutModelRequest, headersHandler?: () => HttpHeaders): Observable<PutModelResult> {
			return this.http.post<PutModelResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutModel', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutOutcome(requestBody: PutOutcomeRequest, headersHandler?: () => HttpHeaders): Observable<PutOutcomeResult> {
			return this.http.post<PutOutcomeResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutOutcome', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDetectorVersion(requestBody: UpdateDetectorVersionRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDetectorVersionResult> {
			return this.http.post<UpdateDetectorVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDetectorVersionMetadata(requestBody: UpdateDetectorVersionMetadataRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDetectorVersionMetadataResult> {
			return this.http.post<UpdateDetectorVersionMetadataResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionMetadata', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDetectorVersionStatus(requestBody: UpdateDetectorVersionStatusRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDetectorVersionStatusResult> {
			return this.http.post<UpdateDetectorVersionStatusResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateModelVersion(requestBody: UpdateModelVersionRequest, headersHandler?: () => HttpHeaders): Observable<UpdateModelVersionResult> {
			return this.http.post<UpdateModelVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateModelVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateRuleMetadata(requestBody: UpdateRuleMetadataRequest, headersHandler?: () => HttpHeaders): Observable<UpdateRuleMetadataResult> {
			return this.http.post<UpdateRuleMetadataResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleMetadata', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateRuleVersion(requestBody: UpdateRuleVersionRequest, headersHandler?: () => HttpHeaders): Observable<UpdateRuleVersionResult> {
			return this.http.post<UpdateRuleVersionResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateVariable(requestBody: UpdateVariableRequest, headersHandler?: () => HttpHeaders): Observable<UpdateVariableResult> {
			return this.http.post<UpdateVariableResult>(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateVariable', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
