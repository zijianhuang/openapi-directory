...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchCreateVariable(callback: (data : BatchCreateVariableResult) => any, requestBody: BatchCreateVariableRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchCreateVariable', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		BatchGetVariable(callback: (data : BatchGetVariableResult) => any, requestBody: BatchGetVariableRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchGetVariable', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateDetectorVersion(callback: (data : CreateDetectorVersionResult) => any, requestBody: CreateDetectorVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateDetectorVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateModelVersion(callback: (data : CreateModelVersionResult) => any, requestBody: CreateModelVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateModelVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateRule(callback: (data : CreateRuleResult) => any, requestBody: CreateRuleRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateRule', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateVariable(callback: (data : CreateVariableResult) => any, requestBody: CreateVariableRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateVariable', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDetector(callback: (data : DeleteDetectorResult) => any, requestBody: DeleteDetectorRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetector', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDetectorVersion(callback: (data : DeleteDetectorVersionResult) => any, requestBody: DeleteDetectorVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetectorVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteEvent(callback: (data : DeleteEventResult) => any, requestBody: DeleteEventRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteEvent', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteRuleVersion(callback: (data : DeleteRuleVersionResult) => any, requestBody: DeleteRuleVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteRuleVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeDetector(callback: (data : DescribeDetectorResult) => any, requestBody: DescribeDetectorRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeDetector', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeModelVersions(maxResults: string, nextToken: string, callback: (data : DescribeModelVersionsResult) => any, requestBody: DescribeModelVersionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeModelVersions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDetectorVersion(callback: (data : GetDetectorVersionResult) => any, requestBody: GetDetectorVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectorVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDetectors(maxResults: string, nextToken: string, callback: (data : GetDetectorsResult) => any, requestBody: GetDetectorsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectors?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetExternalModels(maxResults: string, nextToken: string, callback: (data : GetExternalModelsResult) => any, requestBody: GetExternalModelsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetExternalModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetModelVersion(callback: (data : GetModelVersionResult) => any, requestBody: GetModelVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModelVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetModels(maxResults: string, nextToken: string, callback: (data : GetModelsResult) => any, requestBody: GetModelsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetOutcomes(maxResults: string, nextToken: string, callback: (data : GetOutcomesResult) => any, requestBody: GetOutcomesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetOutcomes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetPrediction(callback: (data : GetPredictionResult) => any, requestBody: GetPredictionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetPrediction', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetRules(maxResults: string, nextToken: string, callback: (data : GetRulesResult) => any, requestBody: GetRulesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetRules?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetVariables(maxResults: string, nextToken: string, callback: (data : GetVariablesResult) => any, requestBody: GetVariablesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetVariables?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutDetector(callback: (data : PutDetectorResult) => any, requestBody: PutDetectorRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutDetector', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutExternalModel(callback: (data : PutExternalModelResult) => any, requestBody: PutExternalModelRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutExternalModel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutModel(callback: (data : PutModelResult) => any, requestBody: PutModelRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutModel', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutOutcome(callback: (data : PutOutcomeResult) => any, requestBody: PutOutcomeRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutOutcome', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDetectorVersion(callback: (data : UpdateDetectorVersionResult) => any, requestBody: UpdateDetectorVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDetectorVersionMetadata(callback: (data : UpdateDetectorVersionMetadataResult) => any, requestBody: UpdateDetectorVersionMetadataRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionMetadata', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateDetectorVersionStatus(callback: (data : UpdateDetectorVersionStatusResult) => any, requestBody: UpdateDetectorVersionStatusRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionStatus', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateModelVersion(callback: (data : UpdateModelVersionResult) => any, requestBody: UpdateModelVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateModelVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateRuleMetadata(callback: (data : UpdateRuleMetadataResult) => any, requestBody: UpdateRuleMetadataRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleMetadata', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateRuleVersion(callback: (data : UpdateRuleVersionResult) => any, requestBody: UpdateRuleVersionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleVersion', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateVariable(callback: (data : UpdateVariableResult) => any, requestBody: UpdateVariableRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateVariable', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
