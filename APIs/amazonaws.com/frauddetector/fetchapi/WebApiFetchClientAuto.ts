export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchCreateVariable(requestBody: BatchCreateVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchCreateVariableResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchCreateVariable', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		BatchGetVariable(requestBody: BatchGetVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<BatchGetVariableResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.BatchGetVariable', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDetectorVersion(requestBody: CreateDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateDetectorVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateDetectorVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateModelVersion(requestBody: CreateModelVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateModelVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateModelVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateRule(requestBody: CreateRuleRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateRuleResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateRule', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateVariable(requestBody: CreateVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateVariableResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.CreateVariable', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDetector(requestBody: DeleteDetectorRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDetectorResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetector', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteDetectorVersion(requestBody: DeleteDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteDetectorVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteDetectorVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteEvent(requestBody: DeleteEventRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteEventResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteEvent', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteRuleVersion(requestBody: DeleteRuleVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteRuleVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DeleteRuleVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDetector(requestBody: DescribeDetectorRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeDetectorResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeDetector', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeModelVersions(maxResults: string, nextToken: string, requestBody: DescribeModelVersionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeModelVersionsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.DescribeModelVersions?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDetectorVersion(requestBody: GetDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDetectorVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectorVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetDetectors(maxResults: string, nextToken: string, requestBody: GetDetectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDetectorsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetDetectors?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetExternalModels(maxResults: string, nextToken: string, requestBody: GetExternalModelsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetExternalModelsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetExternalModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetModelVersion(requestBody: GetModelVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetModelVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModelVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetModels(maxResults: string, nextToken: string, requestBody: GetModelsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetModelsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetModels?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetOutcomes(maxResults: string, nextToken: string, requestBody: GetOutcomesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOutcomesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetOutcomes?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetPrediction(requestBody: GetPredictionRequest, headersHandler?: () => {[header: string]: string}): Promise<GetPredictionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetPrediction', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetRules(maxResults: string, nextToken: string, requestBody: GetRulesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetRulesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetRules?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetVariables(maxResults: string, nextToken: string, requestBody: GetVariablesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetVariablesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.GetVariables?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutDetector(requestBody: PutDetectorRequest, headersHandler?: () => {[header: string]: string}): Promise<PutDetectorResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutDetector', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutExternalModel(requestBody: PutExternalModelRequest, headersHandler?: () => {[header: string]: string}): Promise<PutExternalModelResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutExternalModel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutModel(requestBody: PutModelRequest, headersHandler?: () => {[header: string]: string}): Promise<PutModelResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutModel', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutOutcome(requestBody: PutOutcomeRequest, headersHandler?: () => {[header: string]: string}): Promise<PutOutcomeResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.PutOutcome', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDetectorVersion(requestBody: UpdateDetectorVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDetectorVersionMetadata(requestBody: UpdateDetectorVersionMetadataRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorVersionMetadataResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionMetadata', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateDetectorVersionStatus(requestBody: UpdateDetectorVersionStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDetectorVersionStatusResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateDetectorVersionStatus', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateModelVersion(requestBody: UpdateModelVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateModelVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateModelVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateRuleMetadata(requestBody: UpdateRuleMetadataRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRuleMetadataResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleMetadata', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateRuleVersion(requestBody: UpdateRuleVersionRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateRuleVersionResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateRuleVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateVariable(requestBody: UpdateVariableRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateVariableResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSHawksNestServiceFacade.UpdateVariable', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
