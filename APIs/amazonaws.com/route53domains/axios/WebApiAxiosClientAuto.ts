...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelDomainTransferToAnotherAwsAccount(requestBody: CancelDomainTransferToAnotherAwsAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelDomainTransferToAnotherAwsAccountResponse> {
			return Axios.post<CancelDomainTransferToAnotherAwsAccountResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.CancelDomainTransferToAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CheckDomainAvailability(requestBody: CheckDomainAvailabilityRequest, headersHandler?: () => {[header: string]: string}): Promise<CheckDomainAvailabilityResponse> {
			return Axios.post<CheckDomainAvailabilityResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.CheckDomainAvailability', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CheckDomainTransferability(requestBody: CheckDomainTransferabilityRequest, headersHandler?: () => {[header: string]: string}): Promise<CheckDomainTransferabilityResponse> {
			return Axios.post<CheckDomainTransferabilityResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.CheckDomainTransferability', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteTagsForDomain(requestBody: DeleteTagsForDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsForDomainResponse> {
			return Axios.post<DeleteTagsForDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.DeleteTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableDomainAutoRenew(requestBody: DisableDomainAutoRenewRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableDomainAutoRenewResponse> {
			return Axios.post<DisableDomainAutoRenewResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.DisableDomainAutoRenew', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DisableDomainTransferLock(requestBody: DisableDomainTransferLockRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableDomainTransferLockResponse> {
			return Axios.post<DisableDomainTransferLockResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.DisableDomainTransferLock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableDomainAutoRenew(requestBody: EnableDomainAutoRenewRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableDomainAutoRenewResponse> {
			return Axios.post<EnableDomainAutoRenewResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.EnableDomainAutoRenew', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		EnableDomainTransferLock(requestBody: EnableDomainTransferLockRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableDomainTransferLockResponse> {
			return Axios.post<EnableDomainTransferLockResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.EnableDomainTransferLock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDomainDetail(requestBody: GetDomainDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainDetailResponse> {
			return Axios.post<GetDomainDetailResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.GetDomainDetail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetDomainSuggestions(requestBody: GetDomainSuggestionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainSuggestionsResponse> {
			return Axios.post<GetDomainSuggestionsResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.GetDomainSuggestions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetOperationDetail(requestBody: GetOperationDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationDetailResponse> {
			return Axios.post<GetOperationDetailResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.GetOperationDetail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListOperations(MaxItems: string, Marker: string, requestBody: ListOperationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOperationsResponse> {
			return Axios.post<ListOperationsResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ListOperations?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForDomain(requestBody: ListTagsForDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForDomainResponse> {
			return Axios.post<ListTagsForDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ListTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterDomain(requestBody: RegisterDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterDomainResponse> {
			return Axios.post<RegisterDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.RegisterDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RejectDomainTransferFromAnotherAwsAccount(requestBody: RejectDomainTransferFromAnotherAwsAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectDomainTransferFromAnotherAwsAccountResponse> {
			return Axios.post<RejectDomainTransferFromAnotherAwsAccountResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.RejectDomainTransferFromAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RenewDomain(requestBody: RenewDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<RenewDomainResponse> {
			return Axios.post<RenewDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.RenewDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ResendContactReachabilityEmail(requestBody: ResendContactReachabilityEmailRequest, headersHandler?: () => {[header: string]: string}): Promise<ResendContactReachabilityEmailResponse> {
			return Axios.post<ResendContactReachabilityEmailResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ResendContactReachabilityEmail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TransferDomain(requestBody: TransferDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDomainResponse> {
			return Axios.post<TransferDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.TransferDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TransferDomainToAnotherAwsAccount(requestBody: TransferDomainToAnotherAwsAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDomainToAnotherAwsAccountResponse> {
			return Axios.post<TransferDomainToAnotherAwsAccountResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.TransferDomainToAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDomainContact(requestBody: UpdateDomainContactRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainContactResponse> {
			return Axios.post<UpdateDomainContactResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDomainContactPrivacy(requestBody: UpdateDomainContactPrivacyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainContactPrivacyResponse> {
			return Axios.post<UpdateDomainContactPrivacyResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContactPrivacy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateDomainNameservers(requestBody: UpdateDomainNameserversRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainNameserversResponse> {
			return Axios.post<UpdateDomainNameserversResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainNameservers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateTagsForDomain(requestBody: UpdateTagsForDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTagsForDomainResponse> {
			return Axios.post<UpdateTagsForDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ViewBilling(requestBody: ViewBillingRequest, headersHandler?: () => {[header: string]: string}): Promise<ViewBillingResponse> {
			return Axios.post<ViewBillingResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ViewBilling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
