...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AcceptDomainTransferFromAnotherAwsAccount(requestBody: AcceptDomainTransferFromAnotherAwsAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<AcceptDomainTransferFromAnotherAwsAccountResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.AcceptDomainTransferFromAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CancelDomainTransferToAnotherAwsAccount(requestBody: CancelDomainTransferToAnotherAwsAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelDomainTransferToAnotherAwsAccountResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.CancelDomainTransferToAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CheckDomainAvailability(requestBody: CheckDomainAvailabilityRequest, headersHandler?: () => {[header: string]: string}): Promise<CheckDomainAvailabilityResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.CheckDomainAvailability', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		CheckDomainTransferability(requestBody: CheckDomainTransferabilityRequest, headersHandler?: () => {[header: string]: string}): Promise<CheckDomainTransferabilityResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.CheckDomainTransferability', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteTagsForDomain(requestBody: DeleteTagsForDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTagsForDomainResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.DeleteTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableDomainAutoRenew(requestBody: DisableDomainAutoRenewRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableDomainAutoRenewResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.DisableDomainAutoRenew', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DisableDomainTransferLock(requestBody: DisableDomainTransferLockRequest, headersHandler?: () => {[header: string]: string}): Promise<DisableDomainTransferLockResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.DisableDomainTransferLock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableDomainAutoRenew(requestBody: EnableDomainAutoRenewRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableDomainAutoRenewResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.EnableDomainAutoRenew', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		EnableDomainTransferLock(requestBody: EnableDomainTransferLockRequest, headersHandler?: () => {[header: string]: string}): Promise<EnableDomainTransferLockResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.EnableDomainTransferLock', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetContactReachabilityStatus(requestBody: GetContactReachabilityStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetContactReachabilityStatusResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.GetContactReachabilityStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDomainDetail(requestBody: GetDomainDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainDetailResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.GetDomainDetail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetDomainSuggestions(requestBody: GetDomainSuggestionsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetDomainSuggestionsResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.GetDomainSuggestions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetOperationDetail(requestBody: GetOperationDetailRequest, headersHandler?: () => {[header: string]: string}): Promise<GetOperationDetailResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.GetOperationDetail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDomains(MaxItems: string, Marker: string, requestBody: ListDomainsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListDomainsResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.ListDomains?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListOperations(MaxItems: string, Marker: string, requestBody: ListOperationsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListOperationsResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.ListOperations?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForDomain(requestBody: ListTagsForDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForDomainResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.ListTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RegisterDomain(requestBody: RegisterDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<RegisterDomainResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.RegisterDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RejectDomainTransferFromAnotherAwsAccount(requestBody: RejectDomainTransferFromAnotherAwsAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<RejectDomainTransferFromAnotherAwsAccountResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.RejectDomainTransferFromAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RenewDomain(requestBody: RenewDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<RenewDomainResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.RenewDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ResendContactReachabilityEmail(requestBody: ResendContactReachabilityEmailRequest, headersHandler?: () => {[header: string]: string}): Promise<ResendContactReachabilityEmailResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.ResendContactReachabilityEmail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		RetrieveDomainAuthCode(requestBody: RetrieveDomainAuthCodeRequest, headersHandler?: () => {[header: string]: string}): Promise<RetrieveDomainAuthCodeResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.RetrieveDomainAuthCode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TransferDomain(requestBody: TransferDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDomainResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.TransferDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TransferDomainToAnotherAwsAccount(requestBody: TransferDomainToAnotherAwsAccountRequest, headersHandler?: () => {[header: string]: string}): Promise<TransferDomainToAnotherAwsAccountResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.TransferDomainToAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDomainContact(requestBody: UpdateDomainContactRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainContactResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContact', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDomainContactPrivacy(requestBody: UpdateDomainContactPrivacyRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainContactPrivacyResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContactPrivacy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateDomainNameservers(requestBody: UpdateDomainNameserversRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateDomainNameserversResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainNameservers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UpdateTagsForDomain(requestBody: UpdateTagsForDomainRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTagsForDomainResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.UpdateTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ViewBilling(requestBody: ViewBillingRequest, headersHandler?: () => {[header: string]: string}): Promise<ViewBillingResponse> {
			return this.http.post('/#X-Amz-Target=Route53Domains_v20140515.ViewBilling', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
