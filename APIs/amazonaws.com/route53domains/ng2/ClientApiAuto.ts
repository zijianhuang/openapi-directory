...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AcceptDomainTransferFromAnotherAwsAccount(requestBody: AcceptDomainTransferFromAnotherAwsAccountRequest, headersHandler?: () => HttpHeaders): Observable<AcceptDomainTransferFromAnotherAwsAccountResponse> {
			return this.http.post<AcceptDomainTransferFromAnotherAwsAccountResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.AcceptDomainTransferFromAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelDomainTransferToAnotherAwsAccount(requestBody: CancelDomainTransferToAnotherAwsAccountRequest, headersHandler?: () => HttpHeaders): Observable<CancelDomainTransferToAnotherAwsAccountResponse> {
			return this.http.post<CancelDomainTransferToAnotherAwsAccountResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.CancelDomainTransferToAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CheckDomainAvailability(requestBody: CheckDomainAvailabilityRequest, headersHandler?: () => HttpHeaders): Observable<CheckDomainAvailabilityResponse> {
			return this.http.post<CheckDomainAvailabilityResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.CheckDomainAvailability', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CheckDomainTransferability(requestBody: CheckDomainTransferabilityRequest, headersHandler?: () => HttpHeaders): Observable<CheckDomainTransferabilityResponse> {
			return this.http.post<CheckDomainTransferabilityResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.CheckDomainTransferability', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTagsForDomain(requestBody: DeleteTagsForDomainRequest, headersHandler?: () => HttpHeaders): Observable<DeleteTagsForDomainResponse> {
			return this.http.post<DeleteTagsForDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.DeleteTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisableDomainAutoRenew(requestBody: DisableDomainAutoRenewRequest, headersHandler?: () => HttpHeaders): Observable<DisableDomainAutoRenewResponse> {
			return this.http.post<DisableDomainAutoRenewResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.DisableDomainAutoRenew', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DisableDomainTransferLock(requestBody: DisableDomainTransferLockRequest, headersHandler?: () => HttpHeaders): Observable<DisableDomainTransferLockResponse> {
			return this.http.post<DisableDomainTransferLockResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.DisableDomainTransferLock', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		EnableDomainAutoRenew(requestBody: EnableDomainAutoRenewRequest, headersHandler?: () => HttpHeaders): Observable<EnableDomainAutoRenewResponse> {
			return this.http.post<EnableDomainAutoRenewResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.EnableDomainAutoRenew', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		EnableDomainTransferLock(requestBody: EnableDomainTransferLockRequest, headersHandler?: () => HttpHeaders): Observable<EnableDomainTransferLockResponse> {
			return this.http.post<EnableDomainTransferLockResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.EnableDomainTransferLock', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetContactReachabilityStatus(requestBody: GetContactReachabilityStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetContactReachabilityStatusResponse> {
			return this.http.post<GetContactReachabilityStatusResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.GetContactReachabilityStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDomainDetail(requestBody: GetDomainDetailRequest, headersHandler?: () => HttpHeaders): Observable<GetDomainDetailResponse> {
			return this.http.post<GetDomainDetailResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.GetDomainDetail', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetDomainSuggestions(requestBody: GetDomainSuggestionsRequest, headersHandler?: () => HttpHeaders): Observable<GetDomainSuggestionsResponse> {
			return this.http.post<GetDomainSuggestionsResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.GetDomainSuggestions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetOperationDetail(requestBody: GetOperationDetailRequest, headersHandler?: () => HttpHeaders): Observable<GetOperationDetailResponse> {
			return this.http.post<GetOperationDetailResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.GetOperationDetail', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDomains(MaxItems: string, Marker: string, requestBody: ListDomainsRequest, headersHandler?: () => HttpHeaders): Observable<ListDomainsResponse> {
			return this.http.post<ListDomainsResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ListDomains?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListOperations(MaxItems: string, Marker: string, requestBody: ListOperationsRequest, headersHandler?: () => HttpHeaders): Observable<ListOperationsResponse> {
			return this.http.post<ListOperationsResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ListOperations?MaxItems=' + (MaxItems == null ? '' : encodeURIComponent(MaxItems)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTagsForDomain(requestBody: ListTagsForDomainRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsForDomainResponse> {
			return this.http.post<ListTagsForDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ListTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterDomain(requestBody: RegisterDomainRequest, headersHandler?: () => HttpHeaders): Observable<RegisterDomainResponse> {
			return this.http.post<RegisterDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.RegisterDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RejectDomainTransferFromAnotherAwsAccount(requestBody: RejectDomainTransferFromAnotherAwsAccountRequest, headersHandler?: () => HttpHeaders): Observable<RejectDomainTransferFromAnotherAwsAccountResponse> {
			return this.http.post<RejectDomainTransferFromAnotherAwsAccountResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.RejectDomainTransferFromAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RenewDomain(requestBody: RenewDomainRequest, headersHandler?: () => HttpHeaders): Observable<RenewDomainResponse> {
			return this.http.post<RenewDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.RenewDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ResendContactReachabilityEmail(requestBody: ResendContactReachabilityEmailRequest, headersHandler?: () => HttpHeaders): Observable<ResendContactReachabilityEmailResponse> {
			return this.http.post<ResendContactReachabilityEmailResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ResendContactReachabilityEmail', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RetrieveDomainAuthCode(requestBody: RetrieveDomainAuthCodeRequest, headersHandler?: () => HttpHeaders): Observable<RetrieveDomainAuthCodeResponse> {
			return this.http.post<RetrieveDomainAuthCodeResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.RetrieveDomainAuthCode', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TransferDomain(requestBody: TransferDomainRequest, headersHandler?: () => HttpHeaders): Observable<TransferDomainResponse> {
			return this.http.post<TransferDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.TransferDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		TransferDomainToAnotherAwsAccount(requestBody: TransferDomainToAnotherAwsAccountRequest, headersHandler?: () => HttpHeaders): Observable<TransferDomainToAnotherAwsAccountResponse> {
			return this.http.post<TransferDomainToAnotherAwsAccountResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.TransferDomainToAnotherAwsAccount', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDomainContact(requestBody: UpdateDomainContactRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDomainContactResponse> {
			return this.http.post<UpdateDomainContactResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContact', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDomainContactPrivacy(requestBody: UpdateDomainContactPrivacyRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDomainContactPrivacyResponse> {
			return this.http.post<UpdateDomainContactPrivacyResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainContactPrivacy', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateDomainNameservers(requestBody: UpdateDomainNameserversRequest, headersHandler?: () => HttpHeaders): Observable<UpdateDomainNameserversResponse> {
			return this.http.post<UpdateDomainNameserversResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateDomainNameservers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTagsForDomain(requestBody: UpdateTagsForDomainRequest, headersHandler?: () => HttpHeaders): Observable<UpdateTagsForDomainResponse> {
			return this.http.post<UpdateTagsForDomainResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.UpdateTagsForDomain', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ViewBilling(requestBody: ViewBillingRequest, headersHandler?: () => HttpHeaders): Observable<ViewBillingResponse> {
			return this.http.post<ViewBillingResponse>(this.baseUri + '/#X-Amz-Target=Route53Domains_v20140515.ViewBilling', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
