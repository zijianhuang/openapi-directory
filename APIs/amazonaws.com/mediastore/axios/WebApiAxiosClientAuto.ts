...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateContainer(requestBody: CreateContainerInput, headersHandler?: () => {[header: string]: string}): Promise<CreateContainerOutput> {
			return Axios.post<CreateContainerOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.CreateContainer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteContainer(requestBody: DeleteContainerInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteContainerOutput> {
			return Axios.post<DeleteContainerOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.DeleteContainer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteContainerPolicy(requestBody: DeleteContainerPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteContainerPolicyOutput> {
			return Axios.post<DeleteContainerPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.DeleteContainerPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteCorsPolicy(requestBody: DeleteCorsPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteCorsPolicyOutput> {
			return Axios.post<DeleteCorsPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.DeleteCorsPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteLifecyclePolicy(requestBody: DeleteLifecyclePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteLifecyclePolicyOutput> {
			return Axios.post<DeleteLifecyclePolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.DeleteLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteMetricPolicy(requestBody: DeleteMetricPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteMetricPolicyOutput> {
			return Axios.post<DeleteMetricPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.DeleteMetricPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeContainer(requestBody: DescribeContainerInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeContainerOutput> {
			return Axios.post<DescribeContainerOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.DescribeContainer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetContainerPolicy(requestBody: GetContainerPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetContainerPolicyOutput> {
			return Axios.post<GetContainerPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.GetContainerPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetCorsPolicy(requestBody: GetCorsPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetCorsPolicyOutput> {
			return Axios.post<GetCorsPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.GetCorsPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetLifecyclePolicy(requestBody: GetLifecyclePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetLifecyclePolicyOutput> {
			return Axios.post<GetLifecyclePolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.GetLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetMetricPolicy(requestBody: GetMetricPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetMetricPolicyOutput> {
			return Axios.post<GetMetricPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.GetMetricPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListContainers(MaxResults: string, NextToken: string, requestBody: ListContainersInput, headersHandler?: () => {[header: string]: string}): Promise<ListContainersOutput> {
			return Axios.post<ListContainersOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.ListContainers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return Axios.post<ListTagsForResourceOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutContainerPolicy(requestBody: PutContainerPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutContainerPolicyOutput> {
			return Axios.post<PutContainerPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.PutContainerPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutCorsPolicy(requestBody: PutCorsPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutCorsPolicyOutput> {
			return Axios.post<PutCorsPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.PutCorsPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutLifecyclePolicy(requestBody: PutLifecyclePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutLifecyclePolicyOutput> {
			return Axios.post<PutLifecyclePolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.PutLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutMetricPolicy(requestBody: PutMetricPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutMetricPolicyOutput> {
			return Axios.post<PutMetricPolicyOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.PutMetricPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartAccessLogging(requestBody: StartAccessLoggingInput, headersHandler?: () => {[header: string]: string}): Promise<StartAccessLoggingOutput> {
			return Axios.post<StartAccessLoggingOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.StartAccessLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopAccessLogging(requestBody: StopAccessLoggingInput, headersHandler?: () => {[header: string]: string}): Promise<StopAccessLoggingOutput> {
			return Axios.post<StopAccessLoggingOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.StopAccessLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceOutput> {
			return Axios.post<TagResourceOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceOutput> {
			return Axios.post<UntagResourceOutput>(this.baseUri + '/#X-Amz-Target=MediaStore_20170901.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
