...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateContainer(requestBody: CreateContainerInput, headersHandler?: () => {[header: string]: string}): Promise<CreateContainerOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.CreateContainer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteContainer(requestBody: DeleteContainerInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteContainerOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.DeleteContainer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteContainerPolicy(requestBody: DeleteContainerPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteContainerPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.DeleteContainerPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteCorsPolicy(requestBody: DeleteCorsPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteCorsPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.DeleteCorsPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteLifecyclePolicy(requestBody: DeleteLifecyclePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteLifecyclePolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.DeleteLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DeleteMetricPolicy(requestBody: DeleteMetricPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<DeleteMetricPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.DeleteMetricPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		DescribeContainer(requestBody: DescribeContainerInput, headersHandler?: () => {[header: string]: string}): Promise<DescribeContainerOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.DescribeContainer', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetContainerPolicy(requestBody: GetContainerPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetContainerPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.GetContainerPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetCorsPolicy(requestBody: GetCorsPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetCorsPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.GetCorsPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetLifecyclePolicy(requestBody: GetLifecyclePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetLifecyclePolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.GetLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		GetMetricPolicy(requestBody: GetMetricPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<GetMetricPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.GetMetricPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListContainers(MaxResults: string, NextToken: string, requestBody: ListContainersInput, headersHandler?: () => {[header: string]: string}): Promise<ListContainersOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.ListContainers?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListTagsForResource(requestBody: ListTagsForResourceInput, headersHandler?: () => {[header: string]: string}): Promise<ListTagsForResourceOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.ListTagsForResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutContainerPolicy(requestBody: PutContainerPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutContainerPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.PutContainerPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutCorsPolicy(requestBody: PutCorsPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutCorsPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.PutCorsPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutLifecyclePolicy(requestBody: PutLifecyclePolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutLifecyclePolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.PutLifecyclePolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		PutMetricPolicy(requestBody: PutMetricPolicyInput, headersHandler?: () => {[header: string]: string}): Promise<PutMetricPolicyOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.PutMetricPolicy', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StartAccessLogging(requestBody: StartAccessLoggingInput, headersHandler?: () => {[header: string]: string}): Promise<StartAccessLoggingOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.StartAccessLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		StopAccessLogging(requestBody: StopAccessLoggingInput, headersHandler?: () => {[header: string]: string}): Promise<StopAccessLoggingOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.StopAccessLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		TagResource(requestBody: TagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<TagResourceOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.TagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		UntagResource(requestBody: UntagResourceInput, headersHandler?: () => {[header: string]: string}): Promise<UntagResourceOutput> {
			return this.http.post('/#X-Amz-Target=MediaStore_20170901.UntagResource', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
