...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddTags(requestBody: AddTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		CreateTrail(requestBody: CreateTrailRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrailResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.CreateTrail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DeleteTrail(requestBody: DeleteTrailRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteTrailResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.DeleteTrail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		DescribeTrails(requestBody: DescribeTrailsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrailsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.DescribeTrails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetEventSelectors(requestBody: GetEventSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEventSelectorsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetEventSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetInsightSelectors(requestBody: GetInsightSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInsightSelectorsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetInsightSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetTrail(requestBody: GetTrailRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTrailResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetTrail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		GetTrailStatus(requestBody: GetTrailStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTrailStatusResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetTrailStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListPublicKeys(NextToken: string, requestBody: ListPublicKeysRequest, headersHandler?: () => {[header: string]: string}): Promise<ListPublicKeysResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListPublicKeys?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListTags(NextToken: string, requestBody: ListTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTagsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListTags?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		ListTrails(NextToken: string, requestBody: ListTrailsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListTrailsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListTrails?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		LookupEvents(MaxResults: string, NextToken: string, requestBody: LookupEventsRequest, headersHandler?: () => {[header: string]: string}): Promise<LookupEventsResponse> {
		 ...
		 */
		PutEventSelectors(requestBody: PutEventSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutEventSelectorsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.PutEventSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		PutInsightSelectors(requestBody: PutInsightSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutInsightSelectorsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.PutInsightSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		RemoveTags(requestBody: RemoveTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		StartLogging(requestBody: StartLoggingRequest, headersHandler?: () => {[header: string]: string}): Promise<StartLoggingResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.StartLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		StopLogging(requestBody: StopLoggingRequest, headersHandler?: () => {[header: string]: string}): Promise<StopLoggingResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.StopLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		 ...
		 */
		UpdateTrail(requestBody: UpdateTrailRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrailResponse> {
			return this.http.post('/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.UpdateTrail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
	}
