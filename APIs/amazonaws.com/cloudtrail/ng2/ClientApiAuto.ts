...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		AddTags(requestBody: AddTagsRequest, headersHandler?: () => HttpHeaders): Observable<AddTagsResponse> {
			return this.http.post<AddTagsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateTrail(requestBody: CreateTrailRequest, headersHandler?: () => HttpHeaders): Observable<CreateTrailResponse> {
			return this.http.post<CreateTrailResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.CreateTrail', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteTrail(requestBody: DeleteTrailRequest, headersHandler?: () => HttpHeaders): Observable<DeleteTrailResponse> {
			return this.http.post<DeleteTrailResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.DeleteTrail', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeTrails(requestBody: DescribeTrailsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeTrailsResponse> {
			return this.http.post<DescribeTrailsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.DescribeTrails', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetEventSelectors(requestBody: GetEventSelectorsRequest, headersHandler?: () => HttpHeaders): Observable<GetEventSelectorsResponse> {
			return this.http.post<GetEventSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetEventSelectors', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetInsightSelectors(requestBody: GetInsightSelectorsRequest, headersHandler?: () => HttpHeaders): Observable<GetInsightSelectorsResponse> {
			return this.http.post<GetInsightSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetInsightSelectors', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetTrail(requestBody: GetTrailRequest, headersHandler?: () => HttpHeaders): Observable<GetTrailResponse> {
			return this.http.post<GetTrailResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetTrail', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetTrailStatus(requestBody: GetTrailStatusRequest, headersHandler?: () => HttpHeaders): Observable<GetTrailStatusResponse> {
			return this.http.post<GetTrailStatusResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetTrailStatus', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListPublicKeys(NextToken: string, requestBody: ListPublicKeysRequest, headersHandler?: () => HttpHeaders): Observable<ListPublicKeysResponse> {
			return this.http.post<ListPublicKeysResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListPublicKeys?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTags(NextToken: string, requestBody: ListTagsRequest, headersHandler?: () => HttpHeaders): Observable<ListTagsResponse> {
			return this.http.post<ListTagsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListTags?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListTrails(NextToken: string, requestBody: ListTrailsRequest, headersHandler?: () => HttpHeaders): Observable<ListTrailsResponse> {
			return this.http.post<ListTrailsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListTrails?NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		LookupEvents(MaxResults: string, NextToken: string, requestBody: LookupEventsRequest, headersHandler?: () => HttpHeaders): Observable<LookupEventsResponse> {
		 ...
		 */
		PutEventSelectors(requestBody: PutEventSelectorsRequest, headersHandler?: () => HttpHeaders): Observable<PutEventSelectorsResponse> {
			return this.http.post<PutEventSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.PutEventSelectors', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutInsightSelectors(requestBody: PutInsightSelectorsRequest, headersHandler?: () => HttpHeaders): Observable<PutInsightSelectorsResponse> {
			return this.http.post<PutInsightSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.PutInsightSelectors', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RemoveTags(requestBody: RemoveTagsRequest, headersHandler?: () => HttpHeaders): Observable<RemoveTagsResponse> {
			return this.http.post<RemoveTagsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartLogging(requestBody: StartLoggingRequest, headersHandler?: () => HttpHeaders): Observable<StartLoggingResponse> {
			return this.http.post<StartLoggingResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.StartLogging', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StopLogging(requestBody: StopLoggingRequest, headersHandler?: () => HttpHeaders): Observable<StopLoggingResponse> {
			return this.http.post<StopLoggingResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.StopLogging', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateTrail(requestBody: UpdateTrailRequest, headersHandler?: () => HttpHeaders): Observable<UpdateTrailResponse> {
			return this.http.post<UpdateTrailResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.UpdateTrail', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
