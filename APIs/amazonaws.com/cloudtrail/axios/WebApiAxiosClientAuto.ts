...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		AddTags(requestBody: AddTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<AddTagsResponse> {
			return Axios.post<AddTagsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.AddTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateTrail(requestBody: CreateTrailRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateTrailResponse> {
			return Axios.post<CreateTrailResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.CreateTrail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeTrails(requestBody: DescribeTrailsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeTrailsResponse> {
			return Axios.post<DescribeTrailsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.DescribeTrails', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetEventSelectors(requestBody: GetEventSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetEventSelectorsResponse> {
			return Axios.post<GetEventSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetEventSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetInsightSelectors(requestBody: GetInsightSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<GetInsightSelectorsResponse> {
			return Axios.post<GetInsightSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetInsightSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTrail(requestBody: GetTrailRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTrailResponse> {
			return Axios.post<GetTrailResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetTrail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetTrailStatus(requestBody: GetTrailStatusRequest, headersHandler?: () => {[header: string]: string}): Promise<GetTrailStatusResponse> {
			return Axios.post<GetTrailStatusResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.GetTrailStatus', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutEventSelectors(requestBody: PutEventSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutEventSelectorsResponse> {
			return Axios.post<PutEventSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.PutEventSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutInsightSelectors(requestBody: PutInsightSelectorsRequest, headersHandler?: () => {[header: string]: string}): Promise<PutInsightSelectorsResponse> {
			return Axios.post<PutInsightSelectorsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.PutInsightSelectors', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RemoveTags(requestBody: RemoveTagsRequest, headersHandler?: () => {[header: string]: string}): Promise<RemoveTagsResponse> {
			return Axios.post<RemoveTagsResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.RemoveTags', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartLogging(requestBody: StartLoggingRequest, headersHandler?: () => {[header: string]: string}): Promise<StartLoggingResponse> {
			return Axios.post<StartLoggingResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.StartLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StopLogging(requestBody: StopLoggingRequest, headersHandler?: () => {[header: string]: string}): Promise<StopLoggingResponse> {
			return Axios.post<StopLoggingResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.StopLogging', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateTrail(requestBody: UpdateTrailRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateTrailResponse> {
			return Axios.post<UpdateTrailResponse>(this.baseUri + '/#X-Amz-Target=com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.UpdateTrail', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
