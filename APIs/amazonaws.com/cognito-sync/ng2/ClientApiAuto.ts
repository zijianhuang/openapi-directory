...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BulkPublish(IdentityPoolId: string, headersHandler?: () => HttpHeaders): Observable<BulkPublishResponse> {
			return this.http.post<BulkPublishResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/bulkpublish', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DeleteDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, headersHandler?: () => HttpHeaders): Observable<DeleteDatasetResponse> {
			return this.http.delete<DeleteDatasetResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, headersHandler?: () => HttpHeaders): Observable<DescribeDatasetResponse> {
			return this.http.get<DescribeDatasetResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		UpdateRecords(IdentityPoolId: string, IdentityId: string, DatasetName: string, requestBody: UpdateRecordsBody, headersHandler?: () => HttpHeaders): Observable<UpdateRecordsResponse> {
			return this.http.post<UpdateRecordsResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeIdentityPoolUsage(IdentityPoolId: string, headersHandler?: () => HttpHeaders): Observable<DescribeIdentityPoolUsageResponse> {
			return this.http.get<DescribeIdentityPoolUsageResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		DescribeIdentityUsage(IdentityPoolId: string, IdentityId: string, headersHandler?: () => HttpHeaders): Observable<DescribeIdentityUsageResponse> {
			return this.http.get<DescribeIdentityUsageResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetBulkPublishDetails(IdentityPoolId: string, headersHandler?: () => HttpHeaders): Observable<GetBulkPublishDetailsResponse> {
			return this.http.post<GetBulkPublishDetailsResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/getBulkPublishDetails', null, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetCognitoEvents(IdentityPoolId: string, headersHandler?: () => HttpHeaders): Observable<GetCognitoEventsResponse> {
			return this.http.get<GetCognitoEventsResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} Success
		 */
		SetCognitoEvents(IdentityPoolId: string, requestBody: SetCognitoEventsBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetIdentityPoolConfiguration(IdentityPoolId: string, headersHandler?: () => HttpHeaders): Observable<GetIdentityPoolConfigurationResponse> {
			return this.http.get<GetIdentityPoolConfigurationResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/configuration', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		SetIdentityPoolConfiguration(IdentityPoolId: string, requestBody: SetIdentityPoolConfigurationBody, headersHandler?: () => HttpHeaders): Observable<SetIdentityPoolConfigurationResponse> {
			return this.http.post<SetIdentityPoolConfigurationResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/configuration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDatasets(IdentityPoolId: string, IdentityId: string, nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListDatasetsResponse> {
		 ...
		 */
		ListIdentityPoolUsage(nextToken: string, maxResults: number, headersHandler?: () => HttpHeaders): Observable<ListIdentityPoolUsageResponse> {
			return this.http.get<ListIdentityPoolUsageResponse>(this.baseUri + '/identitypools?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		ListRecords(IdentityPoolId: string, IdentityId: string, DatasetName: string, lastSyncCount: number, nextToken: string, maxResults: number, syncSessionToken: string, headersHandler?: () => HttpHeaders): Observable<ListRecordsResponse> {
		 ...
		 */
		RegisterDevice(IdentityPoolId: string, IdentityId: string, requestBody: RegisterDeviceBody, headersHandler?: () => HttpHeaders): Observable<RegisterDeviceResponse> {
			return this.http.post<RegisterDeviceResponse>(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identity/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/device', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SubscribeToDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, DeviceId: string, headersHandler?: () => HttpHeaders): Observable<SubscribeToDatasetResponse> {
		 ...
		 */
		UnsubscribeFromDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, DeviceId: string, headersHandler?: () => HttpHeaders): Observable<UnsubscribeFromDatasetResponse> {
