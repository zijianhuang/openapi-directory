...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BulkPublish(IdentityPoolId: string, callback: (data : BulkPublishResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/bulkpublish', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DeleteDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, callback: (data : DeleteDatasetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, callback: (data : DescribeDatasetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		UpdateRecords(IdentityPoolId: string, IdentityId: string, DatasetName: string, callback: (data : UpdateRecordsResponse) => any, requestBody: UpdateRecordsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeIdentityPoolUsage(IdentityPoolId: string, callback: (data : DescribeIdentityPoolUsageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		DescribeIdentityUsage(IdentityPoolId: string, IdentityId: string, callback: (data : DescribeIdentityUsageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBulkPublishDetails(IdentityPoolId: string, callback: (data : GetBulkPublishDetailsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/getBulkPublishDetails', null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetCognitoEvents(IdentityPoolId: string, callback: (data : GetCognitoEventsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		SetCognitoEvents(IdentityPoolId: string, callback: (data : void) => any, requestBody: SetCognitoEventsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetIdentityPoolConfiguration(IdentityPoolId: string, callback: (data : GetIdentityPoolConfigurationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/configuration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		SetIdentityPoolConfiguration(IdentityPoolId: string, callback: (data : SetIdentityPoolConfigurationResponse) => any, requestBody: SetIdentityPoolConfigurationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/configuration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListDatasets(IdentityPoolId: string, IdentityId: string, nextToken: string, maxResults: number, callback: (data : ListDatasetsResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListIdentityPoolUsage(nextToken: string, maxResults: number, callback: (data : ListIdentityPoolUsageResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/identitypools?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ListRecords(IdentityPoolId: string, IdentityId: string, DatasetName: string, lastSyncCount: number, nextToken: string, maxResults: number, syncSessionToken: string, callback: (data : ListRecordsResponse) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 */
		RegisterDevice(IdentityPoolId: string, IdentityId: string, callback: (data : RegisterDeviceResponse) => any, requestBody: RegisterDeviceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identity/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/device', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		SubscribeToDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, DeviceId: string, callback: (data : SubscribeToDatasetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)) + '/subscriptions/' + (DeviceId == null ? '' : encodeURIComponent(DeviceId)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UnsubscribeFromDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, DeviceId: string, callback: (data : UnsubscribeFromDatasetResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)) + '/subscriptions/' + (DeviceId == null ? '' : encodeURIComponent(DeviceId)), callback, this.error, this.statusCode, headersHandler);
		}
	}
