...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BulkPublish(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<BulkPublishResponse> {
			return this.http.post('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/bulkpublish', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDatasetResponse> {
			return this.http.delete('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return this.http.get('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeIdentityPoolUsage(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIdentityPoolUsageResponse> {
			return this.http.get('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeIdentityUsage(IdentityPoolId: string, IdentityId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIdentityUsageResponse> {
			return this.http.get('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBulkPublishDetails(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBulkPublishDetailsResponse> {
			return this.http.post('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/getBulkPublishDetails', null, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCognitoEvents(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<GetCognitoEventsResponse> {
			return this.http.get('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		 ...
		 * @return {void} Success
		 */
		SetCognitoEvents(IdentityPoolId: string, requestBody: SetCognitoEventsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return this.http.post('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } });
		}
		...
		GetIdentityPoolConfiguration(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<GetIdentityPoolConfigurationResponse> {
			return this.http.get('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/configuration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetIdentityPoolConfiguration(IdentityPoolId: string, requestBody: SetIdentityPoolConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<SetIdentityPoolConfigurationResponse> {
			return this.http.post('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/configuration', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.json());
		}
		...
		ListDatasets(IdentityPoolId: string, IdentityId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetsResponse> {
			return this.http.get('/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListIdentityPoolUsage(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListIdentityPoolUsageResponse> {
			return this.http.get('/identitypools?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
