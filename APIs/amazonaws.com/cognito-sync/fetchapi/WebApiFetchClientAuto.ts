export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BulkPublish(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<BulkPublishResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/bulkpublish', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteDatasetResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeDatasetResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeIdentityPoolUsage(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIdentityPoolUsageResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeIdentityUsage(IdentityPoolId: string, IdentityId: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeIdentityUsageResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBulkPublishDetails(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<GetBulkPublishDetailsResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/getBulkPublishDetails', { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCognitoEvents(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<GetCognitoEventsResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		SetCognitoEvents(IdentityPoolId: string, requestBody: SetCognitoEventsBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/events', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetIdentityPoolConfiguration(IdentityPoolId: string, headersHandler?: () => {[header: string]: string}): Promise<GetIdentityPoolConfigurationResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/configuration', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListDatasets(IdentityPoolId: string, IdentityId: string, nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListDatasetsResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListIdentityPoolUsage(nextToken: string, maxResults: number, headersHandler?: () => {[header: string]: string}): Promise<ListIdentityPoolUsageResponse> {
			return fetch(this.baseUri + '/identitypools?nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&maxResults=' + maxResults, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		RegisterDevice(IdentityPoolId: string, IdentityId: string, requestBody: RegisterDeviceBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterDeviceResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identity/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/device', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SubscribeToDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, DeviceId: string, headersHandler?: () => {[header: string]: string}): Promise<SubscribeToDatasetResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)) + '/subscriptions/' + (DeviceId == null ? '' : encodeURIComponent(DeviceId)), { method: 'post', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		UnsubscribeFromDataset(IdentityPoolId: string, IdentityId: string, DatasetName: string, DeviceId: string, headersHandler?: () => {[header: string]: string}): Promise<UnsubscribeFromDatasetResponse> {
			return fetch(this.baseUri + '/identitypools/' + (IdentityPoolId == null ? '' : encodeURIComponent(IdentityPoolId)) + '/identities/' + (IdentityId == null ? '' : encodeURIComponent(IdentityId)) + '/datasets/' + (DatasetName == null ? '' : encodeURIComponent(DatasetName)) + '/subscriptions/' + (DeviceId == null ? '' : encodeURIComponent(DeviceId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
	}
