export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCluster(requestBody: CreateClusterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResponse> {
			return fetch(this.baseUri + '/v1/clusters', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListClusters(clusterNameFilter: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListClustersResponse> {
			return fetch(this.baseUri + '/v1/clusters?clusterNameFilter=' + (clusterNameFilter == null ? '' : encodeURIComponent(clusterNameFilter)) + '&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateConfiguration(requestBody: CreateConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateConfigurationResponse> {
			return fetch(this.baseUri + '/v1/configurations', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListConfigurations(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationsResponse> {
			return fetch(this.baseUri + '/v1/configurations?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteCluster(clusterArn: string, currentVersion: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteClusterResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '&currentVersion=' + (currentVersion == null ? '' : encodeURIComponent(currentVersion)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeCluster(clusterArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeClusterOperation(clusterOperationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterOperationResponse> {
			return fetch(this.baseUri + '/v1/operations/' + (clusterOperationArn == null ? '' : encodeURIComponent(clusterOperationArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeConfiguration(arn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationResponse> {
			return fetch(this.baseUri + '/v1/configurations/' + (arn == null ? '' : encodeURIComponent(arn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DescribeConfigurationRevision(arn: string, revision: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationRevisionResponse> {
			return fetch(this.baseUri + '/v1/configurations/' + (arn == null ? '' : encodeURIComponent(arn)) + '/revisions/' + revision, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetBootstrapBrokers(clusterArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetBootstrapBrokersResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/bootstrap-brokers', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetCompatibleKafkaVersions(clusterArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetCompatibleKafkaVersionsResponse> {
			return fetch(this.baseUri + '/v1/compatible-kafka-versions?clusterArn=' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListClusterOperations(clusterArn: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListClusterOperationsResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/operations&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListConfigurationRevisions(arn: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListConfigurationRevisionsResponse> {
			return fetch(this.baseUri + '/v1/configurations/' + (arn == null ? '' : encodeURIComponent(arn)) + '/revisions&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListKafkaVersions(maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListKafkaVersionsResponse> {
			return fetch(this.baseUri + '/v1/kafka-versions?maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ListNodes(clusterArn: string, maxResults: number, nextToken: string, MaxResults: string, NextToken: string, headersHandler?: () => {[header: string]: string}): Promise<ListNodesResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/nodes&maxResults=' + maxResults + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)) + '&MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		UpdateBrokerCount(clusterArn: string, requestBody: UpdateBrokerCountBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBrokerCountResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/nodes/count', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateBrokerStorage(clusterArn: string, requestBody: UpdateBrokerStorageBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBrokerStorageResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/nodes/storage', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateClusterConfiguration(clusterArn: string, requestBody: UpdateClusterConfigurationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterConfigurationResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/configuration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateClusterKafkaVersion(clusterArn: string, requestBody: UpdateClusterKafkaVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterKafkaVersionResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/version', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateMonitoring(clusterArn: string, requestBody: UpdateMonitoringBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateMonitoringResponse> {
			return fetch(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/monitoring', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
