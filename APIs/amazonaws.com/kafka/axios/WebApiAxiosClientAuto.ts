...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateCluster(requestBody: CreateClusterBody, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResponse> {
			return Axios.post<CreateClusterResponse>(this.baseUri + '/v1/clusters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteCluster(clusterArn: string, currentVersion: string, headersHandler?: () => {[header: string]: string}): Promise<DeleteClusterResponse> {
			return Axios.delete<DeleteClusterResponse>(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '&currentVersion=' + (currentVersion == null ? '' : encodeURIComponent(currentVersion)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeCluster(clusterArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterResponse> {
			return Axios.get<DescribeClusterResponse>(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeClusterOperation(clusterOperationArn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterOperationResponse> {
			return Axios.get<DescribeClusterOperationResponse>(this.baseUri + '/v1/operations/' + (clusterOperationArn == null ? '' : encodeURIComponent(clusterOperationArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeConfiguration(arn: string, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationResponse> {
			return Axios.get<DescribeConfigurationResponse>(this.baseUri + '/v1/configurations/' + (arn == null ? '' : encodeURIComponent(arn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		DescribeConfigurationRevision(arn: string, revision: number, headersHandler?: () => {[header: string]: string}): Promise<DescribeConfigurationRevisionResponse> {
			return Axios.get<DescribeConfigurationRevisionResponse>(this.baseUri + '/v1/configurations/' + (arn == null ? '' : encodeURIComponent(arn)) + '/revisions/' + revision, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetBootstrapBrokers(clusterArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetBootstrapBrokersResponse> {
			return Axios.get<GetBootstrapBrokersResponse>(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/bootstrap-brokers', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetCompatibleKafkaVersions(clusterArn: string, headersHandler?: () => {[header: string]: string}): Promise<GetCompatibleKafkaVersionsResponse> {
			return Axios.get<GetCompatibleKafkaVersionsResponse>(this.baseUri + '/v1/compatible-kafka-versions?clusterArn=' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		TagResource(resourceArn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		UntagResource(resourceArn: string, tagKeys: Array<__string>, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + '/v1/tags/' + (resourceArn == null ? '' : encodeURIComponent(resourceArn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		UpdateBrokerCount(clusterArn: string, requestBody: UpdateBrokerCountBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBrokerCountResponse> {
			return Axios.put<UpdateBrokerCountResponse>(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/nodes/count', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateBrokerStorage(clusterArn: string, requestBody: UpdateBrokerStorageBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateBrokerStorageResponse> {
			return Axios.put<UpdateBrokerStorageResponse>(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/nodes/storage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateClusterKafkaVersion(clusterArn: string, requestBody: UpdateClusterKafkaVersionBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterKafkaVersionResponse> {
			return Axios.put<UpdateClusterKafkaVersionResponse>(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/version', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateMonitoring(clusterArn: string, requestBody: UpdateMonitoringBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateMonitoringResponse> {
			return Axios.put<UpdateMonitoringResponse>(this.baseUri + '/v1/clusters/' + (clusterArn == null ? '' : encodeURIComponent(clusterArn)) + '/monitoring', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
