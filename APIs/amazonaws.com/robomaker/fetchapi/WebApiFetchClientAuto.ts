export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDescribeSimulationJob(requestBody: BatchDescribeSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<BatchDescribeSimulationJobResponse> {
			return fetch(this.baseUri + '/batchDescribeSimulationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CancelDeploymentJob(requestBody: CancelDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelDeploymentJobResponse> {
			return fetch(this.baseUri + '/cancelDeploymentJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CancelSimulationJob(requestBody: CancelSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelSimulationJobResponse> {
			return fetch(this.baseUri + '/cancelSimulationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CancelSimulationJobBatch(requestBody: CancelSimulationJobBatchBody, headersHandler?: () => {[header: string]: string}): Promise<CancelSimulationJobBatchResponse> {
			return fetch(this.baseUri + '/cancelSimulationJobBatch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDeploymentJob(requestBody: CreateDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentJobResponse> {
			return fetch(this.baseUri + '/createDeploymentJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateRobot(requestBody: CreateRobotBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRobotResponse> {
			return fetch(this.baseUri + '/createRobot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateRobotApplication(requestBody: CreateRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRobotApplicationResponse> {
			return fetch(this.baseUri + '/createRobotApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateRobotApplicationVersion(requestBody: CreateRobotApplicationVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRobotApplicationVersionResponse> {
			return fetch(this.baseUri + '/createRobotApplicationVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSimulationApplication(requestBody: CreateSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSimulationApplicationResponse> {
			return fetch(this.baseUri + '/createSimulationApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSimulationApplicationVersion(requestBody: CreateSimulationApplicationVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSimulationApplicationVersionResponse> {
			return fetch(this.baseUri + '/createSimulationApplicationVersion', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateSimulationJob(requestBody: CreateSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSimulationJobResponse> {
			return fetch(this.baseUri + '/createSimulationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteRobot(requestBody: DeleteRobotBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteRobotResponse> {
			return fetch(this.baseUri + '/deleteRobot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteRobotApplication(requestBody: DeleteRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteRobotApplicationResponse> {
			return fetch(this.baseUri + '/deleteRobotApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteSimulationApplication(requestBody: DeleteSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteSimulationApplicationResponse> {
			return fetch(this.baseUri + '/deleteSimulationApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeregisterRobot(requestBody: DeregisterRobotBody, headersHandler?: () => {[header: string]: string}): Promise<DeregisterRobotResponse> {
			return fetch(this.baseUri + '/deregisterRobot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeDeploymentJob(requestBody: DescribeDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeploymentJobResponse> {
			return fetch(this.baseUri + '/describeDeploymentJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeFleet(requestBody: DescribeFleetBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetResponse> {
			return fetch(this.baseUri + '/describeFleet', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRobot(requestBody: DescribeRobotBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeRobotResponse> {
			return fetch(this.baseUri + '/describeRobot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeRobotApplication(requestBody: DescribeRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeRobotApplicationResponse> {
			return fetch(this.baseUri + '/describeRobotApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSimulationApplication(requestBody: DescribeSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSimulationApplicationResponse> {
			return fetch(this.baseUri + '/describeSimulationApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSimulationJob(requestBody: DescribeSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSimulationJobResponse> {
			return fetch(this.baseUri + '/describeSimulationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeSimulationJobBatch(requestBody: DescribeSimulationJobBatchBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSimulationJobBatchResponse> {
			return fetch(this.baseUri + '/describeSimulationJobBatch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRobotApplications(maxResults: string, nextToken: string, requestBody: ListRobotApplicationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListRobotApplicationsResponse> {
			return fetch(this.baseUri + '/listRobotApplications?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListRobots(maxResults: string, nextToken: string, requestBody: ListRobotsBody, headersHandler?: () => {[header: string]: string}): Promise<ListRobotsResponse> {
			return fetch(this.baseUri + '/listRobots?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSimulationJobBatches(maxResults: string, nextToken: string, requestBody: ListSimulationJobBatchesBody, headersHandler?: () => {[header: string]: string}): Promise<ListSimulationJobBatchesResponse> {
			return fetch(this.baseUri + '/listSimulationJobBatches?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListSimulationJobs(maxResults: string, nextToken: string, requestBody: ListSimulationJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListSimulationJobsResponse> {
			return fetch(this.baseUri + '/listSimulationJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RegisterRobot(requestBody: RegisterRobotBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterRobotResponse> {
			return fetch(this.baseUri + '/registerRobot', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		RestartSimulationJob(requestBody: RestartSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<RestartSimulationJobResponse> {
			return fetch(this.baseUri + '/restartSimulationJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		StartSimulationJobBatch(requestBody: StartSimulationJobBatchBody, headersHandler?: () => {[header: string]: string}): Promise<StartSimulationJobBatchResponse> {
			return fetch(this.baseUri + '/startSimulationJobBatch', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		SyncDeploymentJob(requestBody: SyncDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<SyncDeploymentJobResponse> {
			return fetch(this.baseUri + '/syncDeploymentJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateRobotApplication(requestBody: UpdateRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRobotApplicationResponse> {
			return fetch(this.baseUri + '/updateRobotApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateSimulationApplication(requestBody: UpdateSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSimulationApplicationResponse> {
			return fetch(this.baseUri + '/updateSimulationApplication', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
