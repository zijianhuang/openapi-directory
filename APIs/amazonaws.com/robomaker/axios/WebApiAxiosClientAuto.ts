...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		BatchDescribeSimulationJob(requestBody: BatchDescribeSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<BatchDescribeSimulationJobResponse> {
			return Axios.post<BatchDescribeSimulationJobResponse>(this.baseUri + '/batchDescribeSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelDeploymentJob(requestBody: CancelDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelDeploymentJobResponse> {
			return Axios.post<CancelDeploymentJobResponse>(this.baseUri + '/cancelDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelSimulationJob(requestBody: CancelSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<CancelSimulationJobResponse> {
			return Axios.post<CancelSimulationJobResponse>(this.baseUri + '/cancelSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelSimulationJobBatch(requestBody: CancelSimulationJobBatchBody, headersHandler?: () => {[header: string]: string}): Promise<CancelSimulationJobBatchResponse> {
			return Axios.post<CancelSimulationJobBatchResponse>(this.baseUri + '/cancelSimulationJobBatch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateDeploymentJob(requestBody: CreateDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateDeploymentJobResponse> {
			return Axios.post<CreateDeploymentJobResponse>(this.baseUri + '/createDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRobot(requestBody: CreateRobotBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRobotResponse> {
			return Axios.post<CreateRobotResponse>(this.baseUri + '/createRobot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRobotApplication(requestBody: CreateRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRobotApplicationResponse> {
			return Axios.post<CreateRobotApplicationResponse>(this.baseUri + '/createRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateRobotApplicationVersion(requestBody: CreateRobotApplicationVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateRobotApplicationVersionResponse> {
			return Axios.post<CreateRobotApplicationVersionResponse>(this.baseUri + '/createRobotApplicationVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSimulationApplication(requestBody: CreateSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSimulationApplicationResponse> {
			return Axios.post<CreateSimulationApplicationResponse>(this.baseUri + '/createSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSimulationApplicationVersion(requestBody: CreateSimulationApplicationVersionBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSimulationApplicationVersionResponse> {
			return Axios.post<CreateSimulationApplicationVersionResponse>(this.baseUri + '/createSimulationApplicationVersion', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateSimulationJob(requestBody: CreateSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<CreateSimulationJobResponse> {
			return Axios.post<CreateSimulationJobResponse>(this.baseUri + '/createSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRobot(requestBody: DeleteRobotBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteRobotResponse> {
			return Axios.post<DeleteRobotResponse>(this.baseUri + '/deleteRobot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteRobotApplication(requestBody: DeleteRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteRobotApplicationResponse> {
			return Axios.post<DeleteRobotApplicationResponse>(this.baseUri + '/deleteRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeleteSimulationApplication(requestBody: DeleteSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DeleteSimulationApplicationResponse> {
			return Axios.post<DeleteSimulationApplicationResponse>(this.baseUri + '/deleteSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DeregisterRobot(requestBody: DeregisterRobotBody, headersHandler?: () => {[header: string]: string}): Promise<DeregisterRobotResponse> {
			return Axios.post<DeregisterRobotResponse>(this.baseUri + '/deregisterRobot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeDeploymentJob(requestBody: DescribeDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeDeploymentJobResponse> {
			return Axios.post<DescribeDeploymentJobResponse>(this.baseUri + '/describeDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeFleet(requestBody: DescribeFleetBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeFleetResponse> {
			return Axios.post<DescribeFleetResponse>(this.baseUri + '/describeFleet', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeRobot(requestBody: DescribeRobotBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeRobotResponse> {
			return Axios.post<DescribeRobotResponse>(this.baseUri + '/describeRobot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeRobotApplication(requestBody: DescribeRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeRobotApplicationResponse> {
			return Axios.post<DescribeRobotApplicationResponse>(this.baseUri + '/describeRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSimulationApplication(requestBody: DescribeSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSimulationApplicationResponse> {
			return Axios.post<DescribeSimulationApplicationResponse>(this.baseUri + '/describeSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSimulationJob(requestBody: DescribeSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSimulationJobResponse> {
			return Axios.post<DescribeSimulationJobResponse>(this.baseUri + '/describeSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeSimulationJobBatch(requestBody: DescribeSimulationJobBatchBody, headersHandler?: () => {[header: string]: string}): Promise<DescribeSimulationJobBatchResponse> {
			return Axios.post<DescribeSimulationJobBatchResponse>(this.baseUri + '/describeSimulationJobBatch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListDeploymentJobs(maxResults: string, nextToken: string, requestBody: ListDeploymentJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListDeploymentJobsResponse> {
			return Axios.post<ListDeploymentJobsResponse>(this.baseUri + '/listDeploymentJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRobotApplications(maxResults: string, nextToken: string, requestBody: ListRobotApplicationsBody, headersHandler?: () => {[header: string]: string}): Promise<ListRobotApplicationsResponse> {
			return Axios.post<ListRobotApplicationsResponse>(this.baseUri + '/listRobotApplications?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListRobots(maxResults: string, nextToken: string, requestBody: ListRobotsBody, headersHandler?: () => {[header: string]: string}): Promise<ListRobotsResponse> {
			return Axios.post<ListRobotsResponse>(this.baseUri + '/listRobots?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSimulationJobBatches(maxResults: string, nextToken: string, requestBody: ListSimulationJobBatchesBody, headersHandler?: () => {[header: string]: string}): Promise<ListSimulationJobBatchesResponse> {
			return Axios.post<ListSimulationJobBatchesResponse>(this.baseUri + '/listSimulationJobBatches?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListSimulationJobs(maxResults: string, nextToken: string, requestBody: ListSimulationJobsBody, headersHandler?: () => {[header: string]: string}): Promise<ListSimulationJobsResponse> {
			return Axios.post<ListSimulationJobsResponse>(this.baseUri + '/listSimulationJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RegisterRobot(requestBody: RegisterRobotBody, headersHandler?: () => {[header: string]: string}): Promise<RegisterRobotResponse> {
			return Axios.post<RegisterRobotResponse>(this.baseUri + '/registerRobot', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		RestartSimulationJob(requestBody: RestartSimulationJobBody, headersHandler?: () => {[header: string]: string}): Promise<RestartSimulationJobResponse> {
			return Axios.post<RestartSimulationJobResponse>(this.baseUri + '/restartSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		StartSimulationJobBatch(requestBody: StartSimulationJobBatchBody, headersHandler?: () => {[header: string]: string}): Promise<StartSimulationJobBatchResponse> {
			return Axios.post<StartSimulationJobBatchResponse>(this.baseUri + '/startSimulationJobBatch', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		SyncDeploymentJob(requestBody: SyncDeploymentJobBody, headersHandler?: () => {[header: string]: string}): Promise<SyncDeploymentJobResponse> {
			return Axios.post<SyncDeploymentJobResponse>(this.baseUri + '/syncDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateRobotApplication(requestBody: UpdateRobotApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateRobotApplicationResponse> {
			return Axios.post<UpdateRobotApplicationResponse>(this.baseUri + '/updateRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateSimulationApplication(requestBody: UpdateSimulationApplicationBody, headersHandler?: () => {[header: string]: string}): Promise<UpdateSimulationApplicationResponse> {
			return Axios.post<UpdateSimulationApplicationResponse>(this.baseUri + '/updateSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
