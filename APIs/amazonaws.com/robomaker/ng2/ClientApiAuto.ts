...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		BatchDescribeSimulationJob(requestBody: BatchDescribeSimulationJobBody, headersHandler?: () => HttpHeaders): Observable<BatchDescribeSimulationJobResponse> {
			return this.http.post<BatchDescribeSimulationJobResponse>(this.baseUri + '/batchDescribeSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelDeploymentJob(requestBody: CancelDeploymentJobBody, headersHandler?: () => HttpHeaders): Observable<CancelDeploymentJobResponse> {
			return this.http.post<CancelDeploymentJobResponse>(this.baseUri + '/cancelDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelSimulationJob(requestBody: CancelSimulationJobBody, headersHandler?: () => HttpHeaders): Observable<CancelSimulationJobResponse> {
			return this.http.post<CancelSimulationJobResponse>(this.baseUri + '/cancelSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelSimulationJobBatch(requestBody: CancelSimulationJobBatchBody, headersHandler?: () => HttpHeaders): Observable<CancelSimulationJobBatchResponse> {
			return this.http.post<CancelSimulationJobBatchResponse>(this.baseUri + '/cancelSimulationJobBatch', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateDeploymentJob(requestBody: CreateDeploymentJobBody, headersHandler?: () => HttpHeaders): Observable<CreateDeploymentJobResponse> {
			return this.http.post<CreateDeploymentJobResponse>(this.baseUri + '/createDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateRobot(requestBody: CreateRobotBody, headersHandler?: () => HttpHeaders): Observable<CreateRobotResponse> {
			return this.http.post<CreateRobotResponse>(this.baseUri + '/createRobot', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateRobotApplication(requestBody: CreateRobotApplicationBody, headersHandler?: () => HttpHeaders): Observable<CreateRobotApplicationResponse> {
			return this.http.post<CreateRobotApplicationResponse>(this.baseUri + '/createRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateRobotApplicationVersion(requestBody: CreateRobotApplicationVersionBody, headersHandler?: () => HttpHeaders): Observable<CreateRobotApplicationVersionResponse> {
			return this.http.post<CreateRobotApplicationVersionResponse>(this.baseUri + '/createRobotApplicationVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSimulationApplication(requestBody: CreateSimulationApplicationBody, headersHandler?: () => HttpHeaders): Observable<CreateSimulationApplicationResponse> {
			return this.http.post<CreateSimulationApplicationResponse>(this.baseUri + '/createSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSimulationApplicationVersion(requestBody: CreateSimulationApplicationVersionBody, headersHandler?: () => HttpHeaders): Observable<CreateSimulationApplicationVersionResponse> {
			return this.http.post<CreateSimulationApplicationVersionResponse>(this.baseUri + '/createSimulationApplicationVersion', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateSimulationJob(requestBody: CreateSimulationJobBody, headersHandler?: () => HttpHeaders): Observable<CreateSimulationJobResponse> {
			return this.http.post<CreateSimulationJobResponse>(this.baseUri + '/createSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRobot(requestBody: DeleteRobotBody, headersHandler?: () => HttpHeaders): Observable<DeleteRobotResponse> {
			return this.http.post<DeleteRobotResponse>(this.baseUri + '/deleteRobot', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteRobotApplication(requestBody: DeleteRobotApplicationBody, headersHandler?: () => HttpHeaders): Observable<DeleteRobotApplicationResponse> {
			return this.http.post<DeleteRobotApplicationResponse>(this.baseUri + '/deleteRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeleteSimulationApplication(requestBody: DeleteSimulationApplicationBody, headersHandler?: () => HttpHeaders): Observable<DeleteSimulationApplicationResponse> {
			return this.http.post<DeleteSimulationApplicationResponse>(this.baseUri + '/deleteSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DeregisterRobot(requestBody: DeregisterRobotBody, headersHandler?: () => HttpHeaders): Observable<DeregisterRobotResponse> {
			return this.http.post<DeregisterRobotResponse>(this.baseUri + '/deregisterRobot', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeDeploymentJob(requestBody: DescribeDeploymentJobBody, headersHandler?: () => HttpHeaders): Observable<DescribeDeploymentJobResponse> {
			return this.http.post<DescribeDeploymentJobResponse>(this.baseUri + '/describeDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeFleet(requestBody: DescribeFleetBody, headersHandler?: () => HttpHeaders): Observable<DescribeFleetResponse> {
			return this.http.post<DescribeFleetResponse>(this.baseUri + '/describeFleet', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRobot(requestBody: DescribeRobotBody, headersHandler?: () => HttpHeaders): Observable<DescribeRobotResponse> {
			return this.http.post<DescribeRobotResponse>(this.baseUri + '/describeRobot', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeRobotApplication(requestBody: DescribeRobotApplicationBody, headersHandler?: () => HttpHeaders): Observable<DescribeRobotApplicationResponse> {
			return this.http.post<DescribeRobotApplicationResponse>(this.baseUri + '/describeRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSimulationApplication(requestBody: DescribeSimulationApplicationBody, headersHandler?: () => HttpHeaders): Observable<DescribeSimulationApplicationResponse> {
			return this.http.post<DescribeSimulationApplicationResponse>(this.baseUri + '/describeSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSimulationJob(requestBody: DescribeSimulationJobBody, headersHandler?: () => HttpHeaders): Observable<DescribeSimulationJobResponse> {
			return this.http.post<DescribeSimulationJobResponse>(this.baseUri + '/describeSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeSimulationJobBatch(requestBody: DescribeSimulationJobBatchBody, headersHandler?: () => HttpHeaders): Observable<DescribeSimulationJobBatchResponse> {
			return this.http.post<DescribeSimulationJobBatchResponse>(this.baseUri + '/describeSimulationJobBatch', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListDeploymentJobs(maxResults: string, nextToken: string, requestBody: ListDeploymentJobsBody, headersHandler?: () => HttpHeaders): Observable<ListDeploymentJobsResponse> {
			return this.http.post<ListDeploymentJobsResponse>(this.baseUri + '/listDeploymentJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListRobotApplications(maxResults: string, nextToken: string, requestBody: ListRobotApplicationsBody, headersHandler?: () => HttpHeaders): Observable<ListRobotApplicationsResponse> {
			return this.http.post<ListRobotApplicationsResponse>(this.baseUri + '/listRobotApplications?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListRobots(maxResults: string, nextToken: string, requestBody: ListRobotsBody, headersHandler?: () => HttpHeaders): Observable<ListRobotsResponse> {
			return this.http.post<ListRobotsResponse>(this.baseUri + '/listRobots?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSimulationApplications(maxResults: string, nextToken: string, requestBody: ListSimulationApplicationsBody, headersHandler?: () => HttpHeaders): Observable<ListSimulationApplicationsResponse> {
			return this.http.post<ListSimulationApplicationsResponse>(this.baseUri + '/listSimulationApplications?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSimulationJobBatches(maxResults: string, nextToken: string, requestBody: ListSimulationJobBatchesBody, headersHandler?: () => HttpHeaders): Observable<ListSimulationJobBatchesResponse> {
			return this.http.post<ListSimulationJobBatchesResponse>(this.baseUri + '/listSimulationJobBatches?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListSimulationJobs(maxResults: string, nextToken: string, requestBody: ListSimulationJobsBody, headersHandler?: () => HttpHeaders): Observable<ListSimulationJobsResponse> {
			return this.http.post<ListSimulationJobsResponse>(this.baseUri + '/listSimulationJobs?maxResults=' + (maxResults == null ? '' : encodeURIComponent(maxResults)) + '&nextToken=' + (nextToken == null ? '' : encodeURIComponent(nextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RegisterRobot(requestBody: RegisterRobotBody, headersHandler?: () => HttpHeaders): Observable<RegisterRobotResponse> {
			return this.http.post<RegisterRobotResponse>(this.baseUri + '/registerRobot', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		RestartSimulationJob(requestBody: RestartSimulationJobBody, headersHandler?: () => HttpHeaders): Observable<RestartSimulationJobResponse> {
			return this.http.post<RestartSimulationJobResponse>(this.baseUri + '/restartSimulationJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		StartSimulationJobBatch(requestBody: StartSimulationJobBatchBody, headersHandler?: () => HttpHeaders): Observable<StartSimulationJobBatchResponse> {
			return this.http.post<StartSimulationJobBatchResponse>(this.baseUri + '/startSimulationJobBatch', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		SyncDeploymentJob(requestBody: SyncDeploymentJobBody, headersHandler?: () => HttpHeaders): Observable<SyncDeploymentJobResponse> {
			return this.http.post<SyncDeploymentJobResponse>(this.baseUri + '/syncDeploymentJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateRobotApplication(requestBody: UpdateRobotApplicationBody, headersHandler?: () => HttpHeaders): Observable<UpdateRobotApplicationResponse> {
			return this.http.post<UpdateRobotApplicationResponse>(this.baseUri + '/updateRobotApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateSimulationApplication(requestBody: UpdateSimulationApplicationBody, headersHandler?: () => HttpHeaders): Observable<UpdateSimulationApplicationResponse> {
			return this.http.post<UpdateSimulationApplicationResponse>(this.baseUri + '/updateSimulationApplication', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
