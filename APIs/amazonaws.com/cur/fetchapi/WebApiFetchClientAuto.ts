export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DeleteReportDefinition(requestBody: DeleteReportDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteReportDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DeleteReportDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeReportDefinitions(MaxResults: string, NextToken: string, requestBody: DescribeReportDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeReportDefinitionsResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DescribeReportDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ModifyReportDefinition(requestBody: ModifyReportDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyReportDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.ModifyReportDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		PutReportDefinition(requestBody: PutReportDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<PutReportDefinitionResponse> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.PutReportDefinition', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
