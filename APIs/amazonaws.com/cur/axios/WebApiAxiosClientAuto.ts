...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		DeleteReportDefinition(requestBody: DeleteReportDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<DeleteReportDefinitionResponse> {
			return Axios.post<DeleteReportDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DeleteReportDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeReportDefinitions(MaxResults: string, NextToken: string, requestBody: DescribeReportDefinitionsRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeReportDefinitionsResponse> {
			return Axios.post<DescribeReportDefinitionsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DescribeReportDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ModifyReportDefinition(requestBody: ModifyReportDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<ModifyReportDefinitionResponse> {
			return Axios.post<ModifyReportDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.ModifyReportDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		PutReportDefinition(requestBody: PutReportDefinitionRequest, headersHandler?: () => {[header: string]: string}): Promise<PutReportDefinitionResponse> {
			return Axios.post<PutReportDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.PutReportDefinition', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
