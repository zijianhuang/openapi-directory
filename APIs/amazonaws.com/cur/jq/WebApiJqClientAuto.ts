...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DeleteReportDefinition(callback: (data : DeleteReportDefinitionResponse) => any, requestBody: DeleteReportDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DeleteReportDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeReportDefinitions(MaxResults: string, NextToken: string, callback: (data : DescribeReportDefinitionsResponse) => any, requestBody: DescribeReportDefinitionsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DescribeReportDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ModifyReportDefinition(callback: (data : ModifyReportDefinitionResponse) => any, requestBody: ModifyReportDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.ModifyReportDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		PutReportDefinition(callback: (data : PutReportDefinitionResponse) => any, requestBody: PutReportDefinitionRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.PutReportDefinition', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
