...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		DeleteReportDefinition(requestBody: DeleteReportDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<DeleteReportDefinitionResponse> {
			return this.http.post<DeleteReportDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DeleteReportDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeReportDefinitions(MaxResults: string, NextToken: string, requestBody: DescribeReportDefinitionsRequest, headersHandler?: () => HttpHeaders): Observable<DescribeReportDefinitionsResponse> {
			return this.http.post<DescribeReportDefinitionsResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.DescribeReportDefinitions?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ModifyReportDefinition(requestBody: ModifyReportDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<ModifyReportDefinitionResponse> {
			return this.http.post<ModifyReportDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.ModifyReportDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		PutReportDefinition(requestBody: PutReportDefinitionRequest, headersHandler?: () => HttpHeaders): Observable<PutReportDefinitionResponse> {
			return this.http.post<PutReportDefinitionResponse>(this.baseUri + '/#X-Amz-Target=AWSOrigamiServiceGatewayService.PutReportDefinition', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
