...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} Success
		 */
		GET_AddClientIDToOpenIDConnectProvider(OpenIDConnectProviderArn: string, ClientID: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AddClientIDToOpenIDConnectProvider?OpenIDConnectProviderArn=' + (OpenIDConnectProviderArn == null ? '' : encodeURIComponent(OpenIDConnectProviderArn)) + '&ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_AddRoleToInstanceProfile(InstanceProfileName: string, RoleName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AddRoleToInstanceProfile?InstanceProfileName=' + (InstanceProfileName == null ? '' : encodeURIComponent(InstanceProfileName)) + '&RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_AddUserToGroup(GroupName: string, UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AddUserToGroup?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_AttachGroupPolicy(GroupName: string, PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AttachGroupPolicy?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_AttachRolePolicy(RoleName: string, PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AttachRolePolicy?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_AttachUserPolicy(UserName: string, PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=AttachUserPolicy?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ChangePassword(OldPassword: string, NewPassword: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ChangePassword?OldPassword=' + (OldPassword == null ? '' : encodeURIComponent(OldPassword)) + '&NewPassword=' + (NewPassword == null ? '' : encodeURIComponent(NewPassword)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateAccessKey(UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateAccessKey?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateAccountAlias(AccountAlias: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateAccountAlias?AccountAlias=' + (AccountAlias == null ? '' : encodeURIComponent(AccountAlias)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateGroup(Path: string, GroupName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateGroup?Path=' + (Path == null ? '' : encodeURIComponent(Path)) + '&GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateInstanceProfile(InstanceProfileName: string, Path: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateInstanceProfile?InstanceProfileName=' + (InstanceProfileName == null ? '' : encodeURIComponent(InstanceProfileName)) + '&Path=' + (Path == null ? '' : encodeURIComponent(Path)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateLoginProfile(UserName: string, Password: string, PasswordResetRequired: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateLoginProfile?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Password=' + (Password == null ? '' : encodeURIComponent(Password)) + '&PasswordResetRequired=' + PasswordResetRequired + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateOpenIDConnectProvider(Url: string, ClientIDList: Array<clientIDType>, ThumbprintList: Array<thumbprintType>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateOpenIDConnectProvider?Url=' + (Url == null ? '' : encodeURIComponent(Url)) + '&' + ClientIDList.map(z => `ClientIDList=${z}`).join('&') + '&' + ThumbprintList.map(z => `ThumbprintList=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreatePolicy(PolicyName: string, Path: string, PolicyDocument: string, Description: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreatePolicy?PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Path=' + (Path == null ? '' : encodeURIComponent(Path)) + '&PolicyDocument=' + (PolicyDocument == null ? '' : encodeURIComponent(PolicyDocument)) + '&Description=' + (Description == null ? '' : encodeURIComponent(Description)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreatePolicyVersion(PolicyArn: string, PolicyDocument: string, SetAsDefault: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreatePolicyVersion?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&PolicyDocument=' + (PolicyDocument == null ? '' : encodeURIComponent(PolicyDocument)) + '&SetAsDefault=' + SetAsDefault + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateRole(Path: string, RoleName: string, AssumeRolePolicyDocument: string, Description: string, MaxSessionDuration: number, PermissionsBoundary: string, Tags: Array<Tag>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateRole?Path=' + (Path == null ? '' : encodeURIComponent(Path)) + '&RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&AssumeRolePolicyDocument=' + (AssumeRolePolicyDocument == null ? '' : encodeURIComponent(AssumeRolePolicyDocument)) + '&Description=' + (Description == null ? '' : encodeURIComponent(Description)) + '&MaxSessionDuration=' + MaxSessionDuration + '&PermissionsBoundary=' + (PermissionsBoundary == null ? '' : encodeURIComponent(PermissionsBoundary)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateSAMLProvider(SAMLMetadataDocument: string, Name: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateSAMLProvider?SAMLMetadataDocument=' + (SAMLMetadataDocument == null ? '' : encodeURIComponent(SAMLMetadataDocument)) + '&Name=' + (Name == null ? '' : encodeURIComponent(Name)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateServiceLinkedRole(AWSServiceName: string, Description: string, CustomSuffix: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateServiceLinkedRole?AWSServiceName=' + (AWSServiceName == null ? '' : encodeURIComponent(AWSServiceName)) + '&Description=' + (Description == null ? '' : encodeURIComponent(Description)) + '&CustomSuffix=' + (CustomSuffix == null ? '' : encodeURIComponent(CustomSuffix)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateServiceSpecificCredential(UserName: string, ServiceName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateServiceSpecificCredential?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&ServiceName=' + (ServiceName == null ? '' : encodeURIComponent(ServiceName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateUser(Path: string, UserName: string, PermissionsBoundary: string, Tags: Array<Tag>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateUser?Path=' + (Path == null ? '' : encodeURIComponent(Path)) + '&UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PermissionsBoundary=' + (PermissionsBoundary == null ? '' : encodeURIComponent(PermissionsBoundary)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_CreateVirtualMFADevice(Path: string, VirtualMFADeviceName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=CreateVirtualMFADevice?Path=' + (Path == null ? '' : encodeURIComponent(Path)) + '&VirtualMFADeviceName=' + (VirtualMFADeviceName == null ? '' : encodeURIComponent(VirtualMFADeviceName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeactivateMFADevice(UserName: string, SerialNumber: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeactivateMFADevice?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&SerialNumber=' + (SerialNumber == null ? '' : encodeURIComponent(SerialNumber)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteAccessKey(UserName: string, AccessKeyId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteAccessKey?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&AccessKeyId=' + (AccessKeyId == null ? '' : encodeURIComponent(AccessKeyId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteAccountAlias(AccountAlias: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteAccountAlias?AccountAlias=' + (AccountAlias == null ? '' : encodeURIComponent(AccountAlias)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteAccountPasswordPolicy(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteAccountPasswordPolicy?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		POST_DeleteAccountPasswordPolicy(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#Action=DeleteAccountPasswordPolicy?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteGroup(GroupName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteGroup?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteGroupPolicy(GroupName: string, PolicyName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteGroupPolicy?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteInstanceProfile(InstanceProfileName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteInstanceProfile?InstanceProfileName=' + (InstanceProfileName == null ? '' : encodeURIComponent(InstanceProfileName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteLoginProfile(UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteLoginProfile?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteOpenIDConnectProvider(OpenIDConnectProviderArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteOpenIDConnectProvider?OpenIDConnectProviderArn=' + (OpenIDConnectProviderArn == null ? '' : encodeURIComponent(OpenIDConnectProviderArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeletePolicy(PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeletePolicy?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeletePolicyVersion(PolicyArn: string, VersionId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeletePolicyVersion?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&VersionId=' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteRole(RoleName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteRole?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteRolePermissionsBoundary(RoleName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteRolePermissionsBoundary?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteRolePolicy(RoleName: string, PolicyName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteRolePolicy?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteSAMLProvider(SAMLProviderArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteSAMLProvider?SAMLProviderArn=' + (SAMLProviderArn == null ? '' : encodeURIComponent(SAMLProviderArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteSSHPublicKey(UserName: string, SSHPublicKeyId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteSSHPublicKey?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&SSHPublicKeyId=' + (SSHPublicKeyId == null ? '' : encodeURIComponent(SSHPublicKeyId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteServerCertificate(ServerCertificateName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteServerCertificate?ServerCertificateName=' + (ServerCertificateName == null ? '' : encodeURIComponent(ServerCertificateName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteServiceLinkedRole(RoleName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteServiceLinkedRole?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteServiceSpecificCredential(UserName: string, ServiceSpecificCredentialId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteServiceSpecificCredential?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&ServiceSpecificCredentialId=' + (ServiceSpecificCredentialId == null ? '' : encodeURIComponent(ServiceSpecificCredentialId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteSigningCertificate(UserName: string, CertificateId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_DeleteUser(UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteUser?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteUserPermissionsBoundary(UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteUserPermissionsBoundary?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteUserPolicy(UserName: string, PolicyName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteUserPolicy?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DeleteVirtualMFADevice(SerialNumber: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DeleteVirtualMFADevice?SerialNumber=' + (SerialNumber == null ? '' : encodeURIComponent(SerialNumber)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DetachGroupPolicy(GroupName: string, PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DetachGroupPolicy?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DetachRolePolicy(RoleName: string, PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DetachRolePolicy?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_DetachUserPolicy(UserName: string, PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=DetachUserPolicy?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_EnableMFADevice(UserName: string, SerialNumber: string, AuthenticationCode1: string, AuthenticationCode2: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=EnableMFADevice?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&SerialNumber=' + (SerialNumber == null ? '' : encodeURIComponent(SerialNumber)) + '&AuthenticationCode1=' + (AuthenticationCode1 == null ? '' : encodeURIComponent(AuthenticationCode1)) + '&AuthenticationCode2=' + (AuthenticationCode2 == null ? '' : encodeURIComponent(AuthenticationCode2)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GenerateCredentialReport(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GenerateCredentialReport?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		POST_GenerateCredentialReport(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#Action=GenerateCredentialReport?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GenerateOrganizationsAccessReport(EntityPath: string, OrganizationsPolicyId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GenerateOrganizationsAccessReport?EntityPath=' + (EntityPath == null ? '' : encodeURIComponent(EntityPath)) + '&OrganizationsPolicyId=' + (OrganizationsPolicyId == null ? '' : encodeURIComponent(OrganizationsPolicyId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GenerateServiceLastAccessedDetails(Arn: string, Granularity: GetServiceLastAccessedDetailsResponseJobType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GenerateServiceLastAccessedDetails?Arn=' + (Arn == null ? '' : encodeURIComponent(Arn)) + '&Granularity=' + Granularity + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetAccessKeyLastUsed(AccessKeyId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetAccessKeyLastUsed?AccessKeyId=' + (AccessKeyId == null ? '' : encodeURIComponent(AccessKeyId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetAccountAuthorizationDetails(Filter: Array<EntityType>, MaxItems: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetAccountAuthorizationDetails?' + Filter.map(z => `Filter=${z}`).join('&') + '&MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetAccountPasswordPolicy(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetAccountPasswordPolicy?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		POST_GetAccountPasswordPolicy(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#Action=GetAccountPasswordPolicy?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetAccountSummary(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetAccountSummary?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		POST_GetAccountSummary(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#Action=GetAccountSummary?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetContextKeysForCustomPolicy(PolicyInputList: Array<policyDocumentType>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetContextKeysForCustomPolicy?' + PolicyInputList.map(z => `PolicyInputList=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetContextKeysForPrincipalPolicy(PolicySourceArn: string, PolicyInputList: Array<policyDocumentType>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_GetCredentialReport(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetCredentialReport?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		POST_GetCredentialReport(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#Action=GetCredentialReport?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), null, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetGroup(GroupName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetGroup?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetGroupPolicy(GroupName: string, PolicyName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetGroupPolicy?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetInstanceProfile(InstanceProfileName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetInstanceProfile?InstanceProfileName=' + (InstanceProfileName == null ? '' : encodeURIComponent(InstanceProfileName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetLoginProfile(UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetLoginProfile?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetOpenIDConnectProvider(OpenIDConnectProviderArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetOpenIDConnectProvider?OpenIDConnectProviderArn=' + (OpenIDConnectProviderArn == null ? '' : encodeURIComponent(OpenIDConnectProviderArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetOrganizationsAccessReport(JobId: string, MaxItems: number, Marker: string, SortKey: SortKeyType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetOrganizationsAccessReport?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&SortKey=' + SortKey + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetPolicy(PolicyArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetPolicy?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetPolicyVersion(PolicyArn: string, VersionId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetPolicyVersion?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&VersionId=' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetRole(RoleName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetRole?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetRolePolicy(RoleName: string, PolicyName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetRolePolicy?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetSAMLProvider(SAMLProviderArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetSAMLProvider?SAMLProviderArn=' + (SAMLProviderArn == null ? '' : encodeURIComponent(SAMLProviderArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetSSHPublicKey(UserName: string, SSHPublicKeyId: string, Encoding: EncodingType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetSSHPublicKey?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&SSHPublicKeyId=' + (SSHPublicKeyId == null ? '' : encodeURIComponent(SSHPublicKeyId)) + '&Encoding=' + Encoding + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetServerCertificate(ServerCertificateName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetServerCertificate?ServerCertificateName=' + (ServerCertificateName == null ? '' : encodeURIComponent(ServerCertificateName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetServiceLastAccessedDetails(JobId: string, MaxItems: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetServiceLastAccessedDetails?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetServiceLastAccessedDetailsWithEntities(JobId: string, ServiceNamespace: string, MaxItems: number, Marker: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetServiceLastAccessedDetailsWithEntities?JobId=' + (JobId == null ? '' : encodeURIComponent(JobId)) + '&ServiceNamespace=' + (ServiceNamespace == null ? '' : encodeURIComponent(ServiceNamespace)) + '&MaxItems=' + MaxItems + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetServiceLinkedRoleDeletionStatus(DeletionTaskId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetServiceLinkedRoleDeletionStatus?DeletionTaskId=' + (DeletionTaskId == null ? '' : encodeURIComponent(DeletionTaskId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetUser(UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetUser?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_GetUserPolicy(UserName: string, PolicyName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=GetUserPolicy?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListAccessKeys(UserName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListAccessKeys?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListAccountAliases(Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListAccountAliases?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListAttachedGroupPolicies(GroupName: string, PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListAttachedGroupPolicies?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListAttachedRolePolicies(RoleName: string, PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListAttachedRolePolicies?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListAttachedUserPolicies(UserName: string, PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListAttachedUserPolicies?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListEntitiesForPolicy(PolicyArn: string, EntityFilter: EntityType, PathPrefix: string, PolicyUsageFilter: PolicyUsageType, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListEntitiesForPolicy?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&EntityFilter=' + EntityFilter + '&PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&PolicyUsageFilter=' + PolicyUsageFilter + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListGroupPolicies(GroupName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListGroupPolicies?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListGroups(PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListGroups?PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListGroupsForUser(UserName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListGroupsForUser?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListInstanceProfiles(PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListInstanceProfiles?PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListInstanceProfilesForRole(RoleName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListInstanceProfilesForRole?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListMFADevices(UserName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListMFADevices?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListOpenIDConnectProviders(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListOpenIDConnectProviders?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListPolicies(Scope: PolicyScopeType, OnlyAttached: boolean, PathPrefix: string, PolicyUsageFilter: PolicyUsageType, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListPolicies?Scope=' + Scope + '&OnlyAttached=' + OnlyAttached + '&PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&PolicyUsageFilter=' + PolicyUsageFilter + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListPoliciesGrantingServiceAccess(Marker: string, Arn: string, ServiceNamespaces: Array<serviceNamespaceType>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListPoliciesGrantingServiceAccess?Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&Arn=' + (Arn == null ? '' : encodeURIComponent(Arn)) + '&' + ServiceNamespaces.map(z => `ServiceNamespaces=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListPolicyVersions(PolicyArn: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListPolicyVersions?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListRolePolicies(RoleName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListRolePolicies?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListRoleTags(RoleName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListRoleTags?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListRoles(PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListRoles?PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListSAMLProviders(Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListSAMLProviders?Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListSSHPublicKeys(UserName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListSSHPublicKeys?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListServerCertificates(PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListServerCertificates?PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListServiceSpecificCredentials(UserName: string, ServiceName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_ListSigningCertificates(UserName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListSigningCertificates?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListUserPolicies(UserName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListUserPolicies?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListUserTags(UserName: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListUserTags?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListUsers(PathPrefix: string, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListUsers?PathPrefix=' + (PathPrefix == null ? '' : encodeURIComponent(PathPrefix)) + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ListVirtualMFADevices(AssignmentStatus: AssignmentStatusType, Marker: string, MaxItems: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=ListVirtualMFADevices?AssignmentStatus=' + AssignmentStatus + '&Marker=' + (Marker == null ? '' : encodeURIComponent(Marker)) + '&MaxItems=' + MaxItems + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutGroupPolicy(GroupName: string, PolicyName: string, PolicyDocument: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=PutGroupPolicy?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&PolicyDocument=' + (PolicyDocument == null ? '' : encodeURIComponent(PolicyDocument)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutRolePermissionsBoundary(RoleName: string, PermissionsBoundary: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=PutRolePermissionsBoundary?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PermissionsBoundary=' + (PermissionsBoundary == null ? '' : encodeURIComponent(PermissionsBoundary)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutRolePolicy(RoleName: string, PolicyName: string, PolicyDocument: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=PutRolePolicy?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&PolicyDocument=' + (PolicyDocument == null ? '' : encodeURIComponent(PolicyDocument)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutUserPermissionsBoundary(UserName: string, PermissionsBoundary: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=PutUserPermissionsBoundary?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PermissionsBoundary=' + (PermissionsBoundary == null ? '' : encodeURIComponent(PermissionsBoundary)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_PutUserPolicy(UserName: string, PolicyName: string, PolicyDocument: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=PutUserPolicy?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&PolicyName=' + (PolicyName == null ? '' : encodeURIComponent(PolicyName)) + '&PolicyDocument=' + (PolicyDocument == null ? '' : encodeURIComponent(PolicyDocument)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemoveClientIDFromOpenIDConnectProvider(OpenIDConnectProviderArn: string, ClientID: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RemoveClientIDFromOpenIDConnectProvider?OpenIDConnectProviderArn=' + (OpenIDConnectProviderArn == null ? '' : encodeURIComponent(OpenIDConnectProviderArn)) + '&ClientID=' + (ClientID == null ? '' : encodeURIComponent(ClientID)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemoveRoleFromInstanceProfile(InstanceProfileName: string, RoleName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RemoveRoleFromInstanceProfile?InstanceProfileName=' + (InstanceProfileName == null ? '' : encodeURIComponent(InstanceProfileName)) + '&RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_RemoveUserFromGroup(GroupName: string, UserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=RemoveUserFromGroup?GroupName=' + (GroupName == null ? '' : encodeURIComponent(GroupName)) + '&UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_ResetServiceSpecificCredential(UserName: string, ServiceSpecificCredentialId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_ResyncMFADevice(UserName: string, SerialNumber: string, AuthenticationCode1: string, AuthenticationCode2: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_SetDefaultPolicyVersion(PolicyArn: string, VersionId: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetDefaultPolicyVersion?PolicyArn=' + (PolicyArn == null ? '' : encodeURIComponent(PolicyArn)) + '&VersionId=' + (VersionId == null ? '' : encodeURIComponent(VersionId)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_SetSecurityTokenServicePreferences(GlobalEndpointTokenVersion: GlobalEndpointTokenVersion, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=SetSecurityTokenServicePreferences?GlobalEndpointTokenVersion=' + GlobalEndpointTokenVersion + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_TagRole(RoleName: string, Tags: Array<Tag>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=TagRole?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_TagUser(UserName: string, Tags: Array<Tag>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=TagUser?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&' + Tags.map(z => `Tags=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UntagRole(RoleName: string, TagKeys: Array<tagKeyType>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UntagRole?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UntagUser(UserName: string, TagKeys: Array<tagKeyType>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UntagUser?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&' + TagKeys.map(z => `TagKeys=${z}`).join('&') + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateAccessKey(UserName: string, AccessKeyId: string, Status: StatusType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateAccessKey?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&AccessKeyId=' + (AccessKeyId == null ? '' : encodeURIComponent(AccessKeyId)) + '&Status=' + Status + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateAccountPasswordPolicy(MinimumPasswordLength: number, RequireSymbols: boolean, RequireNumbers: boolean, RequireUppercaseCharacters: boolean, RequireLowercaseCharacters: boolean, AllowUsersToChangePassword: boolean, MaxPasswordAge: number, PasswordReusePrevention: number, HardExpiry: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateAccountPasswordPolicy?MinimumPasswordLength=' + MinimumPasswordLength + '&RequireSymbols=' + RequireSymbols + '&RequireNumbers=' + RequireNumbers + '&RequireUppercaseCharacters=' + RequireUppercaseCharacters + '&RequireLowercaseCharacters=' + RequireLowercaseCharacters + '&AllowUsersToChangePassword=' + AllowUsersToChangePassword + '&MaxPasswordAge=' + MaxPasswordAge + '&PasswordReusePrevention=' + PasswordReusePrevention + '&HardExpiry=' + HardExpiry + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateAssumeRolePolicy(RoleName: string, PolicyDocument: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateAssumeRolePolicy?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&PolicyDocument=' + (PolicyDocument == null ? '' : encodeURIComponent(PolicyDocument)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateGroup(GroupName: string, NewPath: string, NewGroupName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_UpdateLoginProfile(UserName: string, Password: string, PasswordResetRequired: boolean, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_UpdateOpenIDConnectProviderThumbprint(OpenIDConnectProviderArn: string, ThumbprintList: Array<thumbprintType>, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_UpdateRole(RoleName: string, Description: string, MaxSessionDuration: number, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateRole?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Description=' + (Description == null ? '' : encodeURIComponent(Description)) + '&MaxSessionDuration=' + MaxSessionDuration + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateRoleDescription(RoleName: string, Description: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateRoleDescription?RoleName=' + (RoleName == null ? '' : encodeURIComponent(RoleName)) + '&Description=' + (Description == null ? '' : encodeURIComponent(Description)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateSAMLProvider(SAMLMetadataDocument: string, SAMLProviderArn: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateSAMLProvider?SAMLMetadataDocument=' + (SAMLMetadataDocument == null ? '' : encodeURIComponent(SAMLMetadataDocument)) + '&SAMLProviderArn=' + (SAMLProviderArn == null ? '' : encodeURIComponent(SAMLProviderArn)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateSSHPublicKey(UserName: string, SSHPublicKeyId: string, Status: StatusType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateSSHPublicKey?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&SSHPublicKeyId=' + (SSHPublicKeyId == null ? '' : encodeURIComponent(SSHPublicKeyId)) + '&Status=' + Status + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateServerCertificate(ServerCertificateName: string, NewPath: string, NewServerCertificateName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateServerCertificate?ServerCertificateName=' + (ServerCertificateName == null ? '' : encodeURIComponent(ServerCertificateName)) + '&NewPath=' + (NewPath == null ? '' : encodeURIComponent(NewPath)) + '&NewServerCertificateName=' + (NewServerCertificateName == null ? '' : encodeURIComponent(NewServerCertificateName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateServiceSpecificCredential(UserName: string, ServiceSpecificCredentialId: string, Status: StatusType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateServiceSpecificCredential?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&ServiceSpecificCredentialId=' + (ServiceSpecificCredentialId == null ? '' : encodeURIComponent(ServiceSpecificCredentialId)) + '&Status=' + Status + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UpdateSigningCertificate(UserName: string, CertificateId: string, Status: StatusType, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_UpdateUser(UserName: string, NewPath: string, NewUserName: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UpdateUser?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&NewPath=' + (NewPath == null ? '' : encodeURIComponent(NewPath)) + '&NewUserName=' + (NewUserName == null ? '' : encodeURIComponent(NewUserName)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UploadSSHPublicKey(UserName: string, SSHPublicKeyBody: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UploadSSHPublicKey?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&SSHPublicKeyBody=' + (SSHPublicKeyBody == null ? '' : encodeURIComponent(SSHPublicKeyBody)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} Success
		 */
		GET_UploadServerCertificate(Path: string, ServerCertificateName: string, CertificateBody: string, PrivateKey: string, CertificateChain: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
		 ...
		 * @return {void} Success
		 */
		GET_UploadSigningCertificate(UserName: string, CertificateBody: string, Action: string, Version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + '/#Action=UploadSigningCertificate?UserName=' + (UserName == null ? '' : encodeURIComponent(UserName)) + '&CertificateBody=' + (CertificateBody == null ? '' : encodeURIComponent(CertificateBody)) + '&Action=' + (Action == null ? '' : encodeURIComponent(Action)) + '&Version=' + (Version == null ? '' : encodeURIComponent(Version)), callback, this.error, this.statusCode, headersHandler);
		}
	}
