export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelCluster(requestBody: CancelClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelClusterResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CancelJob(requestBody: CancelJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelJobResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateAddress(requestBody: CreateAddressRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAddressResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateAddress', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateCluster(requestBody: CreateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateJob(requestBody: CreateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateJobResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeAddress(requestBody: DescribeAddressRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAddressResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeAddress', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeCluster(requestBody: DescribeClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DescribeJob(requestBody: DescribeJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetJobManifest(requestBody: GetJobManifestRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobManifestResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobManifest', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetJobUnlockCode(requestBody: GetJobUnlockCodeRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobUnlockCodeResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobUnlockCode', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSnowballUsage(requestBody: GetSnowballUsageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSnowballUsageResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSnowballUsage', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		GetSoftwareUpdates(requestBody: GetSoftwareUpdatesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSoftwareUpdatesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSoftwareUpdates', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListClusterJobs(requestBody: ListClusterJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListClusterJobsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusterJobs', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListClusters(requestBody: ListClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListClustersResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusters', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListCompatibleImages(requestBody: ListCompatibleImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCompatibleImagesResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListCompatibleImages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		ListJobs(MaxResults: string, NextToken: string, requestBody: ListJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListJobsResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateCluster(requestBody: UpdateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateCluster', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		UpdateJob(requestBody: UpdateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateJobResult> {
			return fetch(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateJob', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
	}
