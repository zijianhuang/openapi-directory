...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelCluster(callback: (data : CancelClusterResult) => any, requestBody: CancelClusterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelCluster', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CancelJob(callback: (data : CancelJobResult) => any, requestBody: CancelJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateAddress(callback: (data : CreateAddressResult) => any, requestBody: CreateAddressRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateAddress', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateCluster(callback: (data : CreateClusterResult) => any, requestBody: CreateClusterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateCluster', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		CreateJob(callback: (data : CreateJobResult) => any, requestBody: CreateJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAddress(callback: (data : DescribeAddressResult) => any, requestBody: DescribeAddressRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeAddress', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeAddresses(MaxResults: string, NextToken: string, callback: (data : DescribeAddressesResult) => any, requestBody: DescribeAddressesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeAddresses?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeCluster(callback: (data : DescribeClusterResult) => any, requestBody: DescribeClusterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeCluster', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		DescribeJob(callback: (data : DescribeJobResult) => any, requestBody: DescribeJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetJobManifest(callback: (data : GetJobManifestResult) => any, requestBody: GetJobManifestRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobManifest', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetJobUnlockCode(callback: (data : GetJobUnlockCodeResult) => any, requestBody: GetJobUnlockCodeRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobUnlockCode', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSnowballUsage(callback: (data : GetSnowballUsageResult) => any, requestBody: GetSnowballUsageRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSnowballUsage', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetSoftwareUpdates(callback: (data : GetSoftwareUpdatesResult) => any, requestBody: GetSoftwareUpdatesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSoftwareUpdates', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListClusterJobs(callback: (data : ListClusterJobsResult) => any, requestBody: ListClusterJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusterJobs', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListClusters(callback: (data : ListClustersResult) => any, requestBody: ListClustersRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusters', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListCompatibleImages(callback: (data : ListCompatibleImagesResult) => any, requestBody: ListCompatibleImagesRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListCompatibleImages', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		ListJobs(MaxResults: string, NextToken: string, callback: (data : ListJobsResult) => any, requestBody: ListJobsRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateCluster(callback: (data : UpdateClusterResult) => any, requestBody: UpdateClusterRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateCluster', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		UpdateJob(callback: (data : UpdateJobResult) => any, requestBody: UpdateJobRequest, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateJob', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
	}
