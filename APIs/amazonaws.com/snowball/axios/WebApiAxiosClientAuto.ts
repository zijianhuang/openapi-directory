...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CancelCluster(requestBody: CancelClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelClusterResult> {
			return Axios.post<CancelClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CancelJob(requestBody: CancelJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CancelJobResult> {
			return Axios.post<CancelJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateAddress(requestBody: CreateAddressRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateAddressResult> {
			return Axios.post<CreateAddressResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateAddress', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateCluster(requestBody: CreateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateClusterResult> {
			return Axios.post<CreateClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		CreateJob(requestBody: CreateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<CreateJobResult> {
			return Axios.post<CreateJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeAddress(requestBody: DescribeAddressRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeAddressResult> {
			return Axios.post<DescribeAddressResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeAddress', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeCluster(requestBody: DescribeClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeClusterResult> {
			return Axios.post<DescribeClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		DescribeJob(requestBody: DescribeJobRequest, headersHandler?: () => {[header: string]: string}): Promise<DescribeJobResult> {
			return Axios.post<DescribeJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJobManifest(requestBody: GetJobManifestRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobManifestResult> {
			return Axios.post<GetJobManifestResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobManifest', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetJobUnlockCode(requestBody: GetJobUnlockCodeRequest, headersHandler?: () => {[header: string]: string}): Promise<GetJobUnlockCodeResult> {
			return Axios.post<GetJobUnlockCodeResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobUnlockCode', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSnowballUsage(requestBody: GetSnowballUsageRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSnowballUsageResult> {
			return Axios.post<GetSnowballUsageResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSnowballUsage', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		GetSoftwareUpdates(requestBody: GetSoftwareUpdatesRequest, headersHandler?: () => {[header: string]: string}): Promise<GetSoftwareUpdatesResult> {
			return Axios.post<GetSoftwareUpdatesResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSoftwareUpdates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListClusterJobs(requestBody: ListClusterJobsRequest, headersHandler?: () => {[header: string]: string}): Promise<ListClusterJobsResult> {
			return Axios.post<ListClusterJobsResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusterJobs', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListClusters(requestBody: ListClustersRequest, headersHandler?: () => {[header: string]: string}): Promise<ListClustersResult> {
			return Axios.post<ListClustersResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusters', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		ListCompatibleImages(requestBody: ListCompatibleImagesRequest, headersHandler?: () => {[header: string]: string}): Promise<ListCompatibleImagesResult> {
			return Axios.post<ListCompatibleImagesResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListCompatibleImages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateCluster(requestBody: UpdateClusterRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateClusterResult> {
			return Axios.post<UpdateClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateCluster', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		UpdateJob(requestBody: UpdateJobRequest, headersHandler?: () => {[header: string]: string}): Promise<UpdateJobResult> {
			return Axios.post<UpdateJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateJob', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
