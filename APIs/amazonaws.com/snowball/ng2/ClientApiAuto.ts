...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 */
		CancelCluster(requestBody: CancelClusterRequest, headersHandler?: () => HttpHeaders): Observable<CancelClusterResult> {
			return this.http.post<CancelClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CancelJob(requestBody: CancelJobRequest, headersHandler?: () => HttpHeaders): Observable<CancelJobResult> {
			return this.http.post<CancelJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CancelJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateAddress(requestBody: CreateAddressRequest, headersHandler?: () => HttpHeaders): Observable<CreateAddressResult> {
			return this.http.post<CreateAddressResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateAddress', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateCluster(requestBody: CreateClusterRequest, headersHandler?: () => HttpHeaders): Observable<CreateClusterResult> {
			return this.http.post<CreateClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		CreateJob(requestBody: CreateJobRequest, headersHandler?: () => HttpHeaders): Observable<CreateJobResult> {
			return this.http.post<CreateJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.CreateJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAddress(requestBody: DescribeAddressRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAddressResult> {
			return this.http.post<DescribeAddressResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeAddress', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeAddresses(MaxResults: string, NextToken: string, requestBody: DescribeAddressesRequest, headersHandler?: () => HttpHeaders): Observable<DescribeAddressesResult> {
			return this.http.post<DescribeAddressesResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeAddresses?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeCluster(requestBody: DescribeClusterRequest, headersHandler?: () => HttpHeaders): Observable<DescribeClusterResult> {
			return this.http.post<DescribeClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		DescribeJob(requestBody: DescribeJobRequest, headersHandler?: () => HttpHeaders): Observable<DescribeJobResult> {
			return this.http.post<DescribeJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.DescribeJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetJobManifest(requestBody: GetJobManifestRequest, headersHandler?: () => HttpHeaders): Observable<GetJobManifestResult> {
			return this.http.post<GetJobManifestResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobManifest', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetJobUnlockCode(requestBody: GetJobUnlockCodeRequest, headersHandler?: () => HttpHeaders): Observable<GetJobUnlockCodeResult> {
			return this.http.post<GetJobUnlockCodeResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetJobUnlockCode', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSnowballUsage(requestBody: GetSnowballUsageRequest, headersHandler?: () => HttpHeaders): Observable<GetSnowballUsageResult> {
			return this.http.post<GetSnowballUsageResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSnowballUsage', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		GetSoftwareUpdates(requestBody: GetSoftwareUpdatesRequest, headersHandler?: () => HttpHeaders): Observable<GetSoftwareUpdatesResult> {
			return this.http.post<GetSoftwareUpdatesResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.GetSoftwareUpdates', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListClusterJobs(requestBody: ListClusterJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListClusterJobsResult> {
			return this.http.post<ListClusterJobsResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusterJobs', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListClusters(requestBody: ListClustersRequest, headersHandler?: () => HttpHeaders): Observable<ListClustersResult> {
			return this.http.post<ListClustersResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListClusters', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListCompatibleImages(requestBody: ListCompatibleImagesRequest, headersHandler?: () => HttpHeaders): Observable<ListCompatibleImagesResult> {
			return this.http.post<ListCompatibleImagesResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListCompatibleImages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		ListJobs(MaxResults: string, NextToken: string, requestBody: ListJobsRequest, headersHandler?: () => HttpHeaders): Observable<ListJobsResult> {
			return this.http.post<ListJobsResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.ListJobs?MaxResults=' + (MaxResults == null ? '' : encodeURIComponent(MaxResults)) + '&NextToken=' + (NextToken == null ? '' : encodeURIComponent(NextToken)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateCluster(requestBody: UpdateClusterRequest, headersHandler?: () => HttpHeaders): Observable<UpdateClusterResult> {
			return this.http.post<UpdateClusterResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateCluster', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 */
		UpdateJob(requestBody: UpdateJobRequest, headersHandler?: () => HttpHeaders): Observable<UpdateJobResult> {
			return this.http.post<UpdateJobResult>(this.baseUri + '/#X-Amz-Target=AWSIESnowballJobManagementService.UpdateJob', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	}
