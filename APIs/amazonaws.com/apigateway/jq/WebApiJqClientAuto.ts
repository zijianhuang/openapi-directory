...
namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateApiKey(callback: (data : void) => any, requestBody: CreateApiKeyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'apikeys', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetApiKeys(position: string, limit: number, name: string, customerId: string, includeValues: boolean, callback: (data : ApiKeys) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'apikeys?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&includeValues=' + includeValues, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateAuthorizer(restapi_id: string, callback: (data : void) => any, requestBody: CreateAuthorizerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetAuthorizers(restapi_id: string, position: string, limit: number, callback: (data : Authorizers) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateBasePathMapping(domain_name: string, callback: (data : void) => any, requestBody: CreateBasePathMappingBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetBasePathMappings(domain_name: string, position: string, limit: number, callback: (data : BasePathMappings) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateDeployment(restapi_id: string, callback: (data : void) => any, requestBody: CreateDeploymentBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDeployments(restapi_id: string, position: string, limit: number, callback: (data : Deployments) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateDocumentationPart(restapi_id: string, callback: (data : void) => any, requestBody: CreateDocumentationPartBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDocumentationParts(restapi_id: string, type: DocumentationPartType, name: string, path: string, position: string, limit: number, locationStatus: LocationStatusType, callback: (data : DocumentationParts) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts&type=' + type + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&path=' + (path == null ? '' : encodeURIComponent(path)) + '&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&locationStatus=' + locationStatus, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		ImportDocumentationParts(restapi_id: string, mode: PutMode, failonwarnings: boolean, callback: (data : DocumentationPartIds) => any, requestBody: ImportDocumentationPartsBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts&mode=' + mode + '&failonwarnings=' + failonwarnings, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateDocumentationVersion(restapi_id: string, callback: (data : void) => any, requestBody: CreateDocumentationVersionBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDocumentationVersions(restapi_id: string, position: string, limit: number, callback: (data : DocumentationVersions) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		...
		CreateDomainName(callback: (data : void) => any, requestBody: CreateDomainNameBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'domainnames', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetDomainNames(position: string, limit: number, callback: (data : DomainNames) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'domainnames?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateModel(restapi_id: string, callback: (data : void) => any, requestBody: CreateModelBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetModels(restapi_id: string, position: string, limit: number, callback: (data : Models) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateRequestValidator(restapi_id: string, callback: (data : void) => any, requestBody: CreateRequestValidatorBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetRequestValidators(restapi_id: string, position: string, limit: number, callback: (data : RequestValidators) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateResource(restapi_id: string, parent_id: string, callback: (data : void) => any, requestBody: CreateResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (parent_id == null ? '' : encodeURIComponent(parent_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateRestApi(callback: (data : void) => any, requestBody: CreateRestApiBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetRestApis(position: string, limit: number, callback: (data : RestApis) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateStage(restapi_id: string, callback: (data : void) => any, requestBody: CreateStageBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetStages(restapi_id: string, deploymentId: string, callback: (data : Stages) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages&deploymentId=' + (deploymentId == null ? '' : encodeURIComponent(deploymentId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateUsagePlan(callback: (data : void) => any, requestBody: CreateUsagePlanBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'usageplans', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetUsagePlans(position: string, keyId: string, limit: number, callback: (data : UsagePlans) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'usageplans?position=' + (position == null ? '' : encodeURIComponent(position)) + '&keyId=' + (keyId == null ? '' : encodeURIComponent(keyId)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		CreateUsagePlanKey(usageplanId: string, callback: (data : void) => any, requestBody: CreateUsagePlanKeyBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetUsagePlanKeys(usageplanId: string, position: string, limit: number, name: string, callback: (data : UsagePlanKeys) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)), callback, this.error, this.statusCode, headersHandler);
		}
		...
		CreateVpcLink(callback: (data : void) => any, requestBody: CreateVpcLinkBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'vpclinks', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetVpcLinks(position: string, limit: number, callback: (data : VpcLinks) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'vpclinks?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteApiKey(api_Key: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetApiKey(api_Key: string, includeValue: boolean, callback: (data : ApiKey) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)) + '&includeValue=' + includeValue, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteAuthorizer(restapi_id: string, authorizer_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetAuthorizer(restapi_id: string, authorizer_id: string, callback: (data : Authorizer) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		TestInvokeAuthorizer(restapi_id: string, authorizer_id: string, callback: (data : TestInvokeAuthorizerResponse) => any, requestBody: TestInvokeAuthorizerBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBasePathMapping(domain_name: string, base_path: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetBasePathMapping(domain_name: string, base_path: string, callback: (data : BasePathMapping) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteClientCertificate(clientcertificate_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetClientCertificate(clientcertificate_id: string, callback: (data : ClientCertificate) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDeployment(restapi_id: string, deployment_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDeployment(restapi_id: string, deployment_id: string, embed: Array<String>, callback: (data : Deployment) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocumentationPart(restapi_id: string, part_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDocumentationPart(restapi_id: string, part_id: string, callback: (data : DocumentationPart) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocumentationVersion(restapi_id: string, doc_version: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDocumentationVersion(restapi_id: string, doc_version: string, callback: (data : DocumentationVersion) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDomainName(domain_name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetDomainName(domain_name: string, callback: (data : DomainName) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, callback: (data : GatewayResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PutGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, callback: (data : void) => any, requestBody: PutGatewayResponseBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntegration(restapi_id: string, resource_id: string, http_method: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetIntegration(restapi_id: string, resource_id: string, http_method: string, callback: (data : Integration) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PutIntegration(restapi_id: string, resource_id: string, http_method: string, callback: (data : void) => any, requestBody: PutIntegrationBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, callback: (data : IntegrationResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PutIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, callback: (data : void) => any, requestBody: PutIntegrationResponseBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteMethod(restapi_id: string, resource_id: string, http_method: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetMethod(restapi_id: string, resource_id: string, http_method: string, callback: (data : Method) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PutMethod(restapi_id: string, resource_id: string, http_method: string, callback: (data : void) => any, requestBody: PutMethodBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		TestInvokeMethod(restapi_id: string, resource_id: string, http_method: string, callback: (data : TestInvokeMethodResponse) => any, requestBody: TestInvokeMethodBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, callback: (data : MethodResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		PutMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, callback: (data : void) => any, requestBody: PutMethodResponseBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteModel(restapi_id: string, model_name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetModel(restapi_id: string, model_name: string, flatten: boolean, callback: (data : Model) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '&flatten=' + flatten, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteRequestValidator(restapi_id: string, requestvalidator_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetRequestValidator(restapi_id: string, requestvalidator_id: string, callback: (data : RequestValidator) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteResource(restapi_id: string, resource_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetResource(restapi_id: string, resource_id: string, embed: Array<String>, callback: (data : Resource) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteRestApi(restapi_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetRestApi(restapi_id: string, callback: (data : RestApi) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {RestApi} Success
		 */
		PutRestApi(restapi_id: string, mode: PutMode, failonwarnings: boolean, parameters: string, callback: (data : RestApi) => any, requestBody: PutRestApiBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '&mode=' + mode + '&failonwarnings=' + failonwarnings + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteStage(restapi_id: string, stage_name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetStage(restapi_id: string, stage_name: string, callback: (data : Stage) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteUsagePlan(usageplanId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetUsagePlan(usageplanId: string, callback: (data : UsagePlan) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteUsagePlanKey(usageplanId: string, keyId: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetUsagePlanKey(usageplanId: string, keyId: string, callback: (data : UsagePlanKey) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVpcLink(vpclink_id: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetVpcLink(vpclink_id: string, callback: (data : VpcLink) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		FlushStageAuthorizersCache(restapi_id: string, stage_name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/authorizers', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		FlushStageCache(restapi_id: string, stage_name: string, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/data', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		GenerateClientCertificate(callback: (data : void) => any, requestBody: GenerateClientCertificateBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'clientcertificates', requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetClientCertificates(position: string, limit: number, callback: (data : ClientCertificates) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'clientcertificates?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetAccount(callback: (data : Account) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'account', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetExport(restapi_id: string, stage_name: string, export_type: string, parameters: string, callback: (data : ExportResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/exports/' + (export_type == null ? '' : encodeURIComponent(export_type)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetGatewayResponses(restapi_id: string, position: string, limit: number, callback: (data : GatewayResponses) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetModelTemplate(restapi_id: string, model_name: string, callback: (data : Template) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '/default_template', callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetResources(restapi_id: string, position: string, limit: number, embed: Array<String>, callback: (data : Resources) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&' + embed.map(z => `embed=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSdk(restapi_id: string, stage_name: string, sdk_type: string, parameters: string, callback: (data : SdkResponse) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/sdks/' + (sdk_type == null ? '' : encodeURIComponent(sdk_type)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSdkType(sdktype_id: string, callback: (data : SdkType) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'sdktypes/' + (sdktype_id == null ? '' : encodeURIComponent(sdktype_id)), callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 */
		GetSdkTypes(position: string, limit: number, callback: (data : SdkTypes) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'sdktypes?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {Tags} Success
		 */
		GetTags(resource_arn: string, position: string, limit: number, callback: (data : Tags) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		...
		TagResource(resource_arn: string, callback: (data : void) => any, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.put(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 */
		GetUsage(usageplanId: string, keyId: string, startDate: string, endDate: string, position: string, limit: number, callback: (data : Usage) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.get(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/usage#startDate&endDate&keyId=' + (keyId == null ? '' : encodeURIComponent(keyId)) + '&startDate=' + (startDate == null ? '' : encodeURIComponent(startDate)) + '&endDate=' + (endDate == null ? '' : encodeURIComponent(endDate)) + '&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, callback, this.error, this.statusCode, headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		ImportApiKeys(format: ApiKeysFormat, failonwarnings: boolean, mode: string, callback: (data : void) => any, requestBody: ImportApiKeysBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'apikeys#mode=import&format?format=' + format + '&failonwarnings=' + failonwarnings + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		ImportRestApi(failonwarnings: boolean, parameters: string, mode: string, callback: (data : void) => any, requestBody: ImportRestApiBody, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.post(this.baseUri + 'restapis#mode=import?failonwarnings=' + failonwarnings + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)) + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), requestBody, callback, this.error, this.statusCode, 'application/json;charset=UTF-8', headersHandler);
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(resource_arn: string, tagKeys: Array<String>, callback: (data : void) => any, headersHandler?: () => {[header: string]: string}) {
			this.httpClient.delete(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), callback, this.error, this.statusCode, headersHandler);
		}
	}
