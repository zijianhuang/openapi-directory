...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateApiKey(requestBody: CreateApiKeyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'apikeys', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetApiKeys(position: string, limit: number, name: string, customerId: string, includeValues: boolean, headersHandler?: () => HttpHeaders): Observable<ApiKeys> {
			return this.http.get<ApiKeys>(this.baseUri + 'apikeys?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&includeValues=' + includeValues, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateAuthorizer(restapi_id: string, requestBody: CreateAuthorizerBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetAuthorizers(restapi_id: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<Authorizers> {
			return this.http.get<Authorizers>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateBasePathMapping(domain_name: string, requestBody: CreateBasePathMappingBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBasePathMappings(domain_name: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<BasePathMappings> {
			return this.http.get<BasePathMappings>(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateDeployment(restapi_id: string, requestBody: CreateDeploymentBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDeployments(restapi_id: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<Deployments> {
			return this.http.get<Deployments>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateDocumentationPart(restapi_id: string, requestBody: CreateDocumentationPartBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDocumentationParts(restapi_id: string, type: DocumentationPartType, name: string, path: string, position: string, limit: number, locationStatus: LocationStatusType, headersHandler?: () => HttpHeaders): Observable<DocumentationParts> {
		 ...
		 */
		ImportDocumentationParts(restapi_id: string, mode: PutMode, failonwarnings: boolean, requestBody: ImportDocumentationPartsBody, headersHandler?: () => HttpHeaders): Observable<DocumentationPartIds> {
			return this.http.put<DocumentationPartIds>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts&mode=' + mode + '&failonwarnings=' + failonwarnings, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		CreateDocumentationVersion(restapi_id: string, requestBody: CreateDocumentationVersionBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDocumentationVersions(restapi_id: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<DocumentationVersions> {
			return this.http.get<DocumentationVersions>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateDomainName(requestBody: CreateDomainNameBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'domainnames', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDomainNames(position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<DomainNames> {
			return this.http.get<DomainNames>(this.baseUri + 'domainnames?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateModel(restapi_id: string, requestBody: CreateModelBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetModels(restapi_id: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<Models> {
			return this.http.get<Models>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateRequestValidator(restapi_id: string, requestBody: CreateRequestValidatorBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetRequestValidators(restapi_id: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<RequestValidators> {
			return this.http.get<RequestValidators>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateResource(restapi_id: string, parent_id: string, requestBody: CreateResourceBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (parent_id == null ? '' : encodeURIComponent(parent_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateRestApi(requestBody: CreateRestApiBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetRestApis(position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<RestApis> {
			return this.http.get<RestApis>(this.baseUri + 'restapis?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateStage(restapi_id: string, requestBody: CreateStageBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetStages(restapi_id: string, deploymentId: string, headersHandler?: () => HttpHeaders): Observable<Stages> {
			return this.http.get<Stages>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages&deploymentId=' + (deploymentId == null ? '' : encodeURIComponent(deploymentId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateUsagePlan(requestBody: CreateUsagePlanBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'usageplans', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetUsagePlans(position: string, keyId: string, limit: number, headersHandler?: () => HttpHeaders): Observable<UsagePlans> {
			return this.http.get<UsagePlans>(this.baseUri + 'usageplans?position=' + (position == null ? '' : encodeURIComponent(position)) + '&keyId=' + (keyId == null ? '' : encodeURIComponent(keyId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateUsagePlanKey(usageplanId: string, requestBody: CreateUsagePlanKeyBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetUsagePlanKeys(usageplanId: string, position: string, limit: number, name: string, headersHandler?: () => HttpHeaders): Observable<UsagePlanKeys> {
			return this.http.get<UsagePlanKeys>(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		CreateVpcLink(requestBody: CreateVpcLinkBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'vpclinks', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetVpcLinks(position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<VpcLinks> {
			return this.http.get<VpcLinks>(this.baseUri + 'vpclinks?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteApiKey(api_Key: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetApiKey(api_Key: string, includeValue: boolean, headersHandler?: () => HttpHeaders): Observable<ApiKey> {
			return this.http.get<ApiKey>(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)) + '&includeValue=' + includeValue, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteAuthorizer(restapi_id: string, authorizer_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetAuthorizer(restapi_id: string, authorizer_id: string, headersHandler?: () => HttpHeaders): Observable<Authorizer> {
			return this.http.get<Authorizer>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		TestInvokeAuthorizer(restapi_id: string, authorizer_id: string, requestBody: TestInvokeAuthorizerBody, headersHandler?: () => HttpHeaders): Observable<TestInvokeAuthorizerResponse> {
			return this.http.post<TestInvokeAuthorizerResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteBasePathMapping(domain_name: string, base_path: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetBasePathMapping(domain_name: string, base_path: string, headersHandler?: () => HttpHeaders): Observable<BasePathMapping> {
			return this.http.get<BasePathMapping>(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteClientCertificate(clientcertificate_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetClientCertificate(clientcertificate_id: string, headersHandler?: () => HttpHeaders): Observable<ClientCertificate> {
			return this.http.get<ClientCertificate>(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDeployment(restapi_id: string, deployment_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDeployment(restapi_id: string, deployment_id: string, embed: Array<String>, headersHandler?: () => HttpHeaders): Observable<Deployment> {
			return this.http.get<Deployment>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocumentationPart(restapi_id: string, part_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDocumentationPart(restapi_id: string, part_id: string, headersHandler?: () => HttpHeaders): Observable<DocumentationPart> {
			return this.http.get<DocumentationPart>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocumentationVersion(restapi_id: string, doc_version: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDocumentationVersion(restapi_id: string, doc_version: string, headersHandler?: () => HttpHeaders): Observable<DocumentationVersion> {
			return this.http.get<DocumentationVersion>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteDomainName(domain_name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetDomainName(domain_name: string, headersHandler?: () => HttpHeaders): Observable<DomainName> {
			return this.http.get<DomainName>(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, headersHandler?: () => HttpHeaders): Observable<GatewayResponse> {
			return this.http.get<GatewayResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PutGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, requestBody: PutGatewayResponseBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntegration(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetIntegration(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => HttpHeaders): Observable<Integration> {
			return this.http.get<Integration>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PutIntegration(restapi_id: string, resource_id: string, http_method: string, requestBody: PutIntegrationBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		GetIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => HttpHeaders): Observable<IntegrationResponse> {
			return this.http.get<IntegrationResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PutIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, requestBody: PutIntegrationResponseBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteMethod(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetMethod(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => HttpHeaders): Observable<Method> {
			return this.http.get<Method>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PutMethod(restapi_id: string, resource_id: string, http_method: string, requestBody: PutMethodBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		TestInvokeMethod(restapi_id: string, resource_id: string, http_method: string, requestBody: TestInvokeMethodBody, headersHandler?: () => HttpHeaders): Observable<TestInvokeMethodResponse> {
		 ...
		 * @return {void} 
		 */
		DeleteMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
		 ...
		 */
		GetMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => HttpHeaders): Observable<MethodResponse> {
			return this.http.get<MethodResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		PutMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, requestBody: PutMethodResponseBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteModel(restapi_id: string, model_name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetModel(restapi_id: string, model_name: string, flatten: boolean, headersHandler?: () => HttpHeaders): Observable<Model> {
			return this.http.get<Model>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '&flatten=' + flatten, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteRequestValidator(restapi_id: string, requestvalidator_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetRequestValidator(restapi_id: string, requestvalidator_id: string, headersHandler?: () => HttpHeaders): Observable<RequestValidator> {
			return this.http.get<RequestValidator>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteResource(restapi_id: string, resource_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetResource(restapi_id: string, resource_id: string, embed: Array<String>, headersHandler?: () => HttpHeaders): Observable<Resource> {
			return this.http.get<Resource>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteRestApi(restapi_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetRestApi(restapi_id: string, headersHandler?: () => HttpHeaders): Observable<RestApi> {
			return this.http.get<RestApi>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {RestApi} Success
		 */
		PutRestApi(restapi_id: string, mode: PutMode, failonwarnings: boolean, parameters: string, requestBody: PutRestApiBody, headersHandler?: () => HttpHeaders): Observable<RestApi> {
			return this.http.put<RestApi>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '&mode=' + mode + '&failonwarnings=' + failonwarnings + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
		 ...
		 * @return {void} 
		 */
		DeleteStage(restapi_id: string, stage_name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetStage(restapi_id: string, stage_name: string, headersHandler?: () => HttpHeaders): Observable<Stage> {
			return this.http.get<Stage>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUsagePlan(usageplanId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetUsagePlan(usageplanId: string, headersHandler?: () => HttpHeaders): Observable<UsagePlan> {
			return this.http.get<UsagePlan>(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteUsagePlanKey(usageplanId: string, keyId: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetUsagePlanKey(usageplanId: string, keyId: string, headersHandler?: () => HttpHeaders): Observable<UsagePlanKey> {
			return this.http.get<UsagePlanKey>(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		DeleteVpcLink(vpclink_id: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetVpcLink(vpclink_id: string, headersHandler?: () => HttpHeaders): Observable<VpcLink> {
			return this.http.get<VpcLink>(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {void} 
		 */
		FlushStageAuthorizersCache(restapi_id: string, stage_name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/authorizers', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		FlushStageCache(restapi_id: string, stage_name: string, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/data', { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GenerateClientCertificate(requestBody: GenerateClientCertificateBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'clientcertificates', JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetClientCertificates(position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<ClientCertificates> {
			return this.http.get<ClientCertificates>(this.baseUri + 'clientcertificates?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetAccount(headersHandler?: () => HttpHeaders): Observable<Account> {
		 ...
		 */
		GetGatewayResponses(restapi_id: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<GatewayResponses> {
			return this.http.get<GatewayResponses>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetModelTemplate(restapi_id: string, model_name: string, headersHandler?: () => HttpHeaders): Observable<Template> {
			return this.http.get<Template>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '/default_template', { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetResources(restapi_id: string, position: string, limit: number, embed: Array<String>, headersHandler?: () => HttpHeaders): Observable<Resources> {
			return this.http.get<Resources>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&' + embed.map(z => `embed=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSdk(restapi_id: string, stage_name: string, sdk_type: string, parameters: string, headersHandler?: () => HttpHeaders): Observable<SdkResponse> {
			return this.http.get<SdkResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/sdks/' + (sdk_type == null ? '' : encodeURIComponent(sdk_type)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSdkType(sdktype_id: string, headersHandler?: () => HttpHeaders): Observable<SdkType> {
			return this.http.get<SdkType>(this.baseUri + 'sdktypes/' + (sdktype_id == null ? '' : encodeURIComponent(sdktype_id)), { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 */
		GetSdkTypes(position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<SdkTypes> {
			return this.http.get<SdkTypes>(this.baseUri + 'sdktypes?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		 ...
		 * @return {Tags} Success
		 */
		GetTags(resource_arn: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<Tags> {
			return this.http.get<Tags>(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined });
		}
		...
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.put(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 */
		GetUsage(usageplanId: string, keyId: string, startDate: string, endDate: string, position: string, limit: number, headersHandler?: () => HttpHeaders): Observable<Usage> {
		 ...
		 * @return {void} 
		 */
		ImportApiKeys(format: ApiKeysFormat, failonwarnings: boolean, mode: string, requestBody: ImportApiKeysBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'apikeys#mode=import&format?format=' + format + '&failonwarnings=' + failonwarnings + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		ImportRestApi(failonwarnings: boolean, parameters: string, mode: string, requestBody: ImportRestApiBody, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.post(this.baseUri + 'restapis#mode=import?failonwarnings=' + failonwarnings + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)) + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), JSON.stringify(requestBody), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }), observe: 'response', responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(resource_arn: string, tagKeys: Array<String>, headersHandler?: () => HttpHeaders): Observable<HttpResponse<string>> {
			return this.http.delete(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '#tagKeys&' + tagKeys.map(z => `tagKeys=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined, observe: 'response', responseType: 'text' });
		}
	}
