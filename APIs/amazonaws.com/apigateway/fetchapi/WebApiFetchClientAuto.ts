export namespace My_Demo_Client {
	...
	export class DemoClient {
		...
		CreateApiKey(requestBody: CreateApiKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apikeys', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetApiKeys(position: string, limit: number, name: string, customerId: string, includeValues: boolean, headersHandler?: () => {[header: string]: string}): Promise<ApiKeys> {
			return fetch(this.baseUri + 'apikeys?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&includeValues=' + includeValues, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateAuthorizer(restapi_id: string, requestBody: CreateAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetAuthorizers(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Authorizers> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateBasePathMapping(domain_name: string, requestBody: CreateBasePathMappingBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetBasePathMappings(domain_name: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<BasePathMappings> {
			return fetch(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDeployment(restapi_id: string, requestBody: CreateDeploymentBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetDeployments(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Deployments> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDocumentationPart(restapi_id: string, requestBody: CreateDocumentationPartBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ImportDocumentationParts(restapi_id: string, mode: PutMode, failonwarnings: boolean, requestBody: ImportDocumentationPartsBody, headersHandler?: () => {[header: string]: string}): Promise<DocumentationPartIds> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts&mode=' + mode + '&failonwarnings=' + failonwarnings, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		CreateDocumentationVersion(restapi_id: string, requestBody: CreateDocumentationVersionBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetDocumentationVersions(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<DocumentationVersions> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateDomainName(requestBody: CreateDomainNameBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'domainnames', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetDomainNames(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<DomainNames> {
			return fetch(this.baseUri + 'domainnames?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateModel(restapi_id: string, requestBody: CreateModelBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetModels(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Models> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateRequestValidator(restapi_id: string, requestBody: CreateRequestValidatorBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetRequestValidators(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<RequestValidators> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateRestApi(requestBody: CreateRestApiBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetRestApis(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<RestApis> {
			return fetch(this.baseUri + 'restapis?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateStage(restapi_id: string, requestBody: CreateStageBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetStages(restapi_id: string, deploymentId: string, headersHandler?: () => {[header: string]: string}): Promise<Stages> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages&deploymentId=' + (deploymentId == null ? '' : encodeURIComponent(deploymentId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateUsagePlan(requestBody: CreateUsagePlanBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'usageplans', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetUsagePlans(position: string, keyId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<UsagePlans> {
			return fetch(this.baseUri + 'usageplans?position=' + (position == null ? '' : encodeURIComponent(position)) + '&keyId=' + (keyId == null ? '' : encodeURIComponent(keyId)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateUsagePlanKey(usageplanId: string, requestBody: CreateUsagePlanKeyBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetUsagePlanKeys(usageplanId: string, position: string, limit: number, name: string, headersHandler?: () => {[header: string]: string}): Promise<UsagePlanKeys> {
			return fetch(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		CreateVpcLink(requestBody: CreateVpcLinkBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'vpclinks', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetVpcLinks(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<VpcLinks> {
			return fetch(this.baseUri + 'vpclinks?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteApiKey(api_Key: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetApiKey(api_Key: string, includeValue: boolean, headersHandler?: () => {[header: string]: string}): Promise<ApiKey> {
			return fetch(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)) + '&includeValue=' + includeValue, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteAuthorizer(restapi_id: string, authorizer_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetAuthorizer(restapi_id: string, authorizer_id: string, headersHandler?: () => {[header: string]: string}): Promise<Authorizer> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TestInvokeAuthorizer(restapi_id: string, authorizer_id: string, requestBody: TestInvokeAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<TestInvokeAuthorizerResponse> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteBasePathMapping(domain_name: string, base_path: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetBasePathMapping(domain_name: string, base_path: string, headersHandler?: () => {[header: string]: string}): Promise<BasePathMapping> {
			return fetch(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteClientCertificate(clientcertificate_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetClientCertificate(clientcertificate_id: string, headersHandler?: () => {[header: string]: string}): Promise<ClientCertificate> {
			return fetch(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDeployment(restapi_id: string, deployment_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDeployment(restapi_id: string, deployment_id: string, embed: Array<String>, headersHandler?: () => {[header: string]: string}): Promise<Deployment> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDocumentationPart(restapi_id: string, part_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDocumentationPart(restapi_id: string, part_id: string, headersHandler?: () => {[header: string]: string}): Promise<DocumentationPart> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDocumentationVersion(restapi_id: string, doc_version: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDocumentationVersion(restapi_id: string, doc_version: string, headersHandler?: () => {[header: string]: string}): Promise<DocumentationVersion> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteDomainName(domain_name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetDomainName(domain_name: string, headersHandler?: () => {[header: string]: string}): Promise<DomainName> {
			return fetch(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, headersHandler?: () => {[header: string]: string}): Promise<GatewayResponse> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, requestBody: PutGatewayResponseBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteIntegration(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetIntegration(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<Integration> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutIntegration(restapi_id: string, resource_id: string, http_method: string, requestBody: PutIntegrationBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<IntegrationResponse> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, requestBody: PutIntegrationResponseBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteMethod(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetMethod(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<Method> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutMethod(restapi_id: string, resource_id: string, http_method: string, requestBody: PutMethodBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		TestInvokeMethod(restapi_id: string, resource_id: string, http_method: string, requestBody: TestInvokeMethodBody, headersHandler?: () => {[header: string]: string}): Promise<TestInvokeMethodResponse> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<MethodResponse> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, requestBody: PutMethodResponseBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		DeleteModel(restapi_id: string, model_name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetModel(restapi_id: string, model_name: string, flatten: boolean, headersHandler?: () => {[header: string]: string}): Promise<Model> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '&flatten=' + flatten, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteRequestValidator(restapi_id: string, requestvalidator_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetRequestValidator(restapi_id: string, requestvalidator_id: string, headersHandler?: () => {[header: string]: string}): Promise<RequestValidator> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteResource(restapi_id: string, resource_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetResource(restapi_id: string, resource_id: string, embed: Array<String>, headersHandler?: () => {[header: string]: string}): Promise<Resource> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteRestApi(restapi_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetRestApi(restapi_id: string, headersHandler?: () => {[header: string]: string}): Promise<RestApi> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		PutRestApi(restapi_id: string, mode: PutMode, failonwarnings: boolean, parameters: string, requestBody: PutRestApiBody, headersHandler?: () => {[header: string]: string}): Promise<RestApi> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '&mode=' + mode + '&failonwarnings=' + failonwarnings + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) }).then(d => d.json());
		}
		...
		DeleteStage(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetStage(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<Stage> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteUsagePlan(usageplanId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetUsagePlan(usageplanId: string, headersHandler?: () => {[header: string]: string}): Promise<UsagePlan> {
			return fetch(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteUsagePlanKey(usageplanId: string, keyId: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetUsagePlanKey(usageplanId: string, keyId: string, headersHandler?: () => {[header: string]: string}): Promise<UsagePlanKey> {
			return fetch(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		DeleteVpcLink(vpclink_id: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GetVpcLink(vpclink_id: string, headersHandler?: () => {[header: string]: string}): Promise<VpcLink> {
			return fetch(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		FlushStageAuthorizersCache(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/authorizers', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		FlushStageCache(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/data', { method: 'delete', headers: headersHandler ? headersHandler() : undefined });
		}
		...
		GenerateClientCertificate(requestBody: GenerateClientCertificateBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'clientcertificates', { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetClientCertificates(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<ClientCertificates> {
			return fetch(this.baseUri + 'clientcertificates?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetExport(restapi_id: string, stage_name: string, export_type: string, parameters: string, headersHandler?: () => {[header: string]: string}): Promise<ExportResponse> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/exports/' + (export_type == null ? '' : encodeURIComponent(export_type)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetGatewayResponses(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<GatewayResponses> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetModelTemplate(restapi_id: string, model_name: string, headersHandler?: () => {[header: string]: string}): Promise<Template> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '/default_template', { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetResources(restapi_id: string, position: string, limit: number, embed: Array<String>, headersHandler?: () => {[header: string]: string}): Promise<Resources> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&' + embed.map(z => `embed=${z}`).join('&'), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSdk(restapi_id: string, stage_name: string, sdk_type: string, parameters: string, headersHandler?: () => {[header: string]: string}): Promise<SdkResponse> {
			return fetch(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/sdks/' + (sdk_type == null ? '' : encodeURIComponent(sdk_type)) + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSdkType(sdktype_id: string, headersHandler?: () => {[header: string]: string}): Promise<SdkType> {
			return fetch(this.baseUri + 'sdktypes/' + (sdktype_id == null ? '' : encodeURIComponent(sdktype_id)), { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetSdkTypes(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<SdkTypes> {
			return fetch(this.baseUri + 'sdktypes?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		GetTags(resource_arn: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Tags> {
			return fetch(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), { method: 'put', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		GetUsage(usageplanId: string, keyId: string, startDate: string, endDate: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Usage> {
			return fetch(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/usage#startDate&endDate&keyId=' + (keyId == null ? '' : encodeURIComponent(keyId)) + '&startDate=' + (startDate == null ? '' : encodeURIComponent(startDate)) + '&endDate=' + (endDate == null ? '' : encodeURIComponent(endDate)) + '&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { method: 'get', headers: headersHandler ? headersHandler() : undefined }).then(d => d.json());
		}
		...
		ImportApiKeys(format: ApiKeysFormat, failonwarnings: boolean, mode: string, requestBody: ImportApiKeysBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'apikeys#mode=import&format?format=' + format + '&failonwarnings=' + failonwarnings + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
		...
		ImportRestApi(failonwarnings: boolean, parameters: string, mode: string, requestBody: ImportRestApiBody, headersHandler?: () => {[header: string]: string}): Promise<Response> {
			return fetch(this.baseUri + 'restapis#mode=import?failonwarnings=' + failonwarnings + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)) + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), { method: 'post', headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, body: JSON.stringify(requestBody) });
		}
