...
export namespace My_Demo_Client {
	...
	export class DemoClient {
		 ...
		 * @return {void} 
		 */
		CreateApiKey(requestBody: CreateApiKeyBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'apikeys', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetApiKeys(position: string, limit: number, name: string, customerId: string, includeValues: boolean, headersHandler?: () => {[header: string]: string}): Promise<ApiKeys> {
			return Axios.get<ApiKeys>(this.baseUri + 'apikeys?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)) + '&customerId=' + (customerId == null ? '' : encodeURIComponent(customerId)) + '&includeValues=' + includeValues, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateAuthorizer(restapi_id: string, requestBody: CreateAuthorizerBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetAuthorizers(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Authorizers> {
			return Axios.get<Authorizers>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateBasePathMapping(domain_name: string, requestBody: CreateBasePathMappingBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetBasePathMappings(domain_name: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<BasePathMappings> {
			return Axios.get<BasePathMappings>(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateDeployment(restapi_id: string, requestBody: CreateDeploymentBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetDeployments(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Deployments> {
			return Axios.get<Deployments>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateDocumentationPart(restapi_id: string, requestBody: CreateDocumentationPartBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateDocumentationVersion(restapi_id: string, requestBody: CreateDocumentationVersionBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetDocumentationVersions(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<DocumentationVersions> {
			return Axios.get<DocumentationVersions>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateDomainName(requestBody: CreateDomainNameBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'domainnames', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetDomainNames(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<DomainNames> {
			return Axios.get<DomainNames>(this.baseUri + 'domainnames?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateModel(restapi_id: string, requestBody: CreateModelBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetModels(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Models> {
			return Axios.get<Models>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateRequestValidator(restapi_id: string, requestBody: CreateRequestValidatorBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetRequestValidators(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<RequestValidators> {
			return Axios.get<RequestValidators>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateResource(restapi_id: string, parent_id: string, requestBody: CreateResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (parent_id == null ? '' : encodeURIComponent(parent_id)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		CreateRestApi(requestBody: CreateRestApiBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetRestApis(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<RestApis> {
			return Axios.get<RestApis>(this.baseUri + 'restapis?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateStage(restapi_id: string, requestBody: CreateStageBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetStages(restapi_id: string, deploymentId: string, headersHandler?: () => {[header: string]: string}): Promise<Stages> {
			return Axios.get<Stages>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages&deploymentId=' + (deploymentId == null ? '' : encodeURIComponent(deploymentId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateUsagePlan(requestBody: CreateUsagePlanBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'usageplans', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetUsagePlans(position: string, keyId: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<UsagePlans> {
			return Axios.get<UsagePlans>(this.baseUri + 'usageplans?position=' + (position == null ? '' : encodeURIComponent(position)) + '&keyId=' + (keyId == null ? '' : encodeURIComponent(keyId)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateUsagePlanKey(usageplanId: string, requestBody: CreateUsagePlanKeyBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetUsagePlanKeys(usageplanId: string, position: string, limit: number, name: string, headersHandler?: () => {[header: string]: string}): Promise<UsagePlanKeys> {
			return Axios.get<UsagePlanKeys>(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&name=' + (name == null ? '' : encodeURIComponent(name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		CreateVpcLink(requestBody: CreateVpcLinkBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'vpclinks', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetVpcLinks(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<VpcLinks> {
			return Axios.get<VpcLinks>(this.baseUri + 'vpclinks?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteApiKey(api_Key: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetApiKey(api_Key: string, includeValue: boolean, headersHandler?: () => {[header: string]: string}): Promise<ApiKey> {
			return Axios.get<ApiKey>(this.baseUri + 'apikeys/' + (api_Key == null ? '' : encodeURIComponent(api_Key)) + '&includeValue=' + includeValue, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteAuthorizer(restapi_id: string, authorizer_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetAuthorizer(restapi_id: string, authorizer_id: string, headersHandler?: () => {[header: string]: string}): Promise<Authorizer> {
			return Axios.get<Authorizer>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/authorizers/' + (authorizer_id == null ? '' : encodeURIComponent(authorizer_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteBasePathMapping(domain_name: string, base_path: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetBasePathMapping(domain_name: string, base_path: string, headersHandler?: () => {[header: string]: string}): Promise<BasePathMapping> {
			return Axios.get<BasePathMapping>(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)) + '/basepathmappings/' + (base_path == null ? '' : encodeURIComponent(base_path)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteClientCertificate(clientcertificate_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetClientCertificate(clientcertificate_id: string, headersHandler?: () => {[header: string]: string}): Promise<ClientCertificate> {
			return Axios.get<ClientCertificate>(this.baseUri + 'clientcertificates/' + (clientcertificate_id == null ? '' : encodeURIComponent(clientcertificate_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDeployment(restapi_id: string, deployment_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetDeployment(restapi_id: string, deployment_id: string, embed: Array<String>, headersHandler?: () => {[header: string]: string}): Promise<Deployment> {
			return Axios.get<Deployment>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/deployments/' + (deployment_id == null ? '' : encodeURIComponent(deployment_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocumentationPart(restapi_id: string, part_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetDocumentationPart(restapi_id: string, part_id: string, headersHandler?: () => {[header: string]: string}): Promise<DocumentationPart> {
			return Axios.get<DocumentationPart>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/parts/' + (part_id == null ? '' : encodeURIComponent(part_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDocumentationVersion(restapi_id: string, doc_version: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetDocumentationVersion(restapi_id: string, doc_version: string, headersHandler?: () => {[header: string]: string}): Promise<DocumentationVersion> {
			return Axios.get<DocumentationVersion>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/documentation/versions/' + (doc_version == null ? '' : encodeURIComponent(doc_version)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteDomainName(domain_name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetDomainName(domain_name: string, headersHandler?: () => {[header: string]: string}): Promise<DomainName> {
			return Axios.get<DomainName>(this.baseUri + 'domainnames/' + (domain_name == null ? '' : encodeURIComponent(domain_name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, headersHandler?: () => {[header: string]: string}): Promise<GatewayResponse> {
			return Axios.get<GatewayResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutGatewayResponse(restapi_id: string, response_type: GatewayResponseResponseType, requestBody: PutGatewayResponseBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses/' + response_type, JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		DeleteIntegration(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetIntegration(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<Integration> {
			return Axios.get<Integration>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutIntegration(restapi_id: string, resource_id: string, http_method: string, requestBody: PutIntegrationBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		GetIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<IntegrationResponse> {
			return Axios.get<IntegrationResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/integration/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutIntegrationResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, requestBody: PutIntegrationResponseBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteMethod(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetMethod(restapi_id: string, resource_id: string, http_method: string, headersHandler?: () => {[header: string]: string}): Promise<Method> {
			return Axios.get<Method>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutMethod(restapi_id: string, resource_id: string, http_method: string, requestBody: PutMethodBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		TestInvokeMethod(restapi_id: string, resource_id: string, http_method: string, requestBody: TestInvokeMethodBody, headersHandler?: () => {[header: string]: string}): Promise<TestInvokeMethodResponse> {
			return Axios.post<TestInvokeMethodResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		...
		GetMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, headersHandler?: () => {[header: string]: string}): Promise<MethodResponse> {
			return Axios.get<MethodResponse>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '/methods/' + (http_method == null ? '' : encodeURIComponent(http_method)) + '/responses/' + (status_code == null ? '' : encodeURIComponent(status_code)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		PutMethodResponse(restapi_id: string, resource_id: string, http_method: string, status_code: string, requestBody: PutMethodResponseBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
		 ...
		 * @return {void} 
		 */
		DeleteModel(restapi_id: string, model_name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetModel(restapi_id: string, model_name: string, flatten: boolean, headersHandler?: () => {[header: string]: string}): Promise<Model> {
			return Axios.get<Model>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '&flatten=' + flatten, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteRequestValidator(restapi_id: string, requestvalidator_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetRequestValidator(restapi_id: string, requestvalidator_id: string, headersHandler?: () => {[header: string]: string}): Promise<RequestValidator> {
			return Axios.get<RequestValidator>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/requestvalidators/' + (requestvalidator_id == null ? '' : encodeURIComponent(requestvalidator_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteResource(restapi_id: string, resource_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetResource(restapi_id: string, resource_id: string, embed: Array<String>, headersHandler?: () => {[header: string]: string}): Promise<Resource> {
			return Axios.get<Resource>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources/' + (resource_id == null ? '' : encodeURIComponent(resource_id)) + '&' + embed.map(z => `embed=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteRestApi(restapi_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetRestApi(restapi_id: string, headersHandler?: () => {[header: string]: string}): Promise<RestApi> {
			return Axios.get<RestApi>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteStage(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetStage(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<Stage> {
			return Axios.get<Stage>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteUsagePlan(usageplanId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetUsagePlan(usageplanId: string, headersHandler?: () => {[header: string]: string}): Promise<UsagePlan> {
			return Axios.get<UsagePlan>(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteUsagePlanKey(usageplanId: string, keyId: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetUsagePlanKey(usageplanId: string, keyId: string, headersHandler?: () => {[header: string]: string}): Promise<UsagePlanKey> {
			return Axios.get<UsagePlanKey>(this.baseUri + 'usageplans/' + (usageplanId == null ? '' : encodeURIComponent(usageplanId)) + '/keys/' + (keyId == null ? '' : encodeURIComponent(keyId)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		DeleteVpcLink(vpclink_id: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		...
		GetVpcLink(vpclink_id: string, headersHandler?: () => {[header: string]: string}): Promise<VpcLink> {
			return Axios.get<VpcLink>(this.baseUri + 'vpclinks/' + (vpclink_id == null ? '' : encodeURIComponent(vpclink_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		 ...
		 * @return {void} 
		 */
		FlushStageAuthorizersCache(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/authorizers', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		FlushStageCache(restapi_id: string, stage_name: string, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.delete(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/stages/' + (stage_name == null ? '' : encodeURIComponent(stage_name)) + '/cache/data', { headers: headersHandler ? headersHandler() : undefined, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		GenerateClientCertificate(requestBody: GenerateClientCertificateBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'clientcertificates', JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		...
		GetClientCertificates(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<ClientCertificates> {
			return Axios.get<ClientCertificates>(this.baseUri + 'clientcertificates?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetGatewayResponses(restapi_id: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<GatewayResponses> {
			return Axios.get<GatewayResponses>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/gatewayresponses&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetModelTemplate(restapi_id: string, model_name: string, headersHandler?: () => {[header: string]: string}): Promise<Template> {
			return Axios.get<Template>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/models/' + (model_name == null ? '' : encodeURIComponent(model_name)) + '/default_template', { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetResources(restapi_id: string, position: string, limit: number, embed: Array<String>, headersHandler?: () => {[header: string]: string}): Promise<Resources> {
			return Axios.get<Resources>(this.baseUri + 'restapis/' + (restapi_id == null ? '' : encodeURIComponent(restapi_id)) + '/resources&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit + '&' + embed.map(z => `embed=${z}`).join('&'), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetSdkType(sdktype_id: string, headersHandler?: () => {[header: string]: string}): Promise<SdkType> {
			return Axios.get<SdkType>(this.baseUri + 'sdktypes/' + (sdktype_id == null ? '' : encodeURIComponent(sdktype_id)), { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetSdkTypes(position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<SdkTypes> {
			return Axios.get<SdkTypes>(this.baseUri + 'sdktypes?position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		GetTags(resource_arn: string, position: string, limit: number, headersHandler?: () => {[header: string]: string}): Promise<Tags> {
			return Axios.get<Tags>(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)) + '&position=' + (position == null ? '' : encodeURIComponent(position)) + '&limit=' + limit, { headers: headersHandler ? headersHandler() : undefined }).then(d => d.data);
		}
		...
		TagResource(resource_arn: string, requestBody: TagResourceBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.put(this.baseUri + 'tags/' + (resource_arn == null ? '' : encodeURIComponent(resource_arn)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		ImportApiKeys(format: ApiKeysFormat, failonwarnings: boolean, mode: string, requestBody: ImportApiKeysBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'apikeys#mode=import&format?format=' + format + '&failonwarnings=' + failonwarnings + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		ImportRestApi(failonwarnings: boolean, parameters: string, mode: string, requestBody: ImportRestApiBody, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
			return Axios.post(this.baseUri + 'restapis#mode=import?failonwarnings=' + failonwarnings + '&parameters=' + (parameters == null ? '' : encodeURIComponent(parameters)) + '&mode=' + (mode == null ? '' : encodeURIComponent(mode)), JSON.stringify(requestBody), { headers: headersHandler ? Object.assign(headersHandler(), { 'Content-Type': 'application/json;charset=UTF-8' }): { 'Content-Type': 'application/json;charset=UTF-8' }, responseType: 'text' });
		}
		 ...
		 * @return {void} 
		 */
		UntagResource(resource_arn: string, tagKeys: Array<String>, headersHandler?: () => {[header: string]: string}): Promise<AxiosResponse<string>> {
